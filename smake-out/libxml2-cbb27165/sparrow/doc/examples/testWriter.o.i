# 1 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
# 1 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
# 14 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
...
# 15 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 2
...
# 16 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 2
...
# 26 "../../include/libxml/encoding.h" 2
...
# 159 "../../include/libxml/encoding.h" 2
 ...
 isolat1ToUTF8 (unsigned char *out,
      ...
      const unsigned char *in,
      int *inlen);
# 17 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 2
...
# 18 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 2
...
testXmlwriterFilename(const char *uri)
{
    ...
    if (writer == 
# 77 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                 ((void *)0)
# 77 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                     ) {
...
# 85 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                           ((void *)0)
# 85 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                                               , "ISO-8859-1", 
# 85 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                                              ((void *)0)
# 85 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
    ...
    if (tmp != 
# 113 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 113 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    rc = xmlTextWriterWriteAttribute(writer, (xmlChar *) "xml:lang",
                                     (xmlChar *) "de");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterWriteAttribute\n");
    ...
    tmp = ConvertInput("<äöü>", "ISO-8859-1");
    ...
    if (tmp != 
# 151 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 151 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);


    rc = xmlTextWriterStartElement(writer, (xmlChar *) "HEADER");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterStartElement\n");
        return;
    ...
    rc = xmlTextWriterWriteFormatElement(writer, (xmlChar *) "X_ORDER_ID",
                                         "%010d", 53535);
    if (rc < 0) {
        printf
    ...
    rc = xmlTextWriterWriteFormatElement(writer, (xmlChar *) "CUSTOMER_ID",
                                         "%d", 1010);
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterWriteFormatElement\n");
    ...
    tmp = ConvertInput("Müller", "ISO-8859-1");
    rc = xmlTextWriterWriteElement(writer, (xmlChar *) "NAME_1", tmp);
    if (rc < 0) {
        printf
    ...
    if (tmp != 
# 187 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 187 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);


    tmp = ConvertInput("Jörg", "ISO-8859-1");
    rc = xmlTextWriterWriteElement(writer, (xmlChar *) "NAME_2", tmp);
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterWriteElement\n");
        return;
    ...
    if (tmp != 
# 197 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 197 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    rc = xmlTextWriterStartElement(writer, (xmlChar *) "ENTRIES");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterStartElement\n");
        return;
    ...
    rc = xmlTextWriterStartElement(writer, (xmlChar *) "ENTRY");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterStartElement\n");
        return;
    ...
    rc = xmlTextWriterWriteElement(writer, (xmlChar *) "ARTICLE",
                                   (xmlChar *) "<Test>");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterWriteElement\n");
    ...
    rc = xmlTextWriterWriteFormatElement(writer, (xmlChar *) "ENTRY_NO", "%d",
                                         10);
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterWriteFormatElement\n");
    ...
    rc = xmlTextWriterStartElement(writer, (xmlChar *) "FOOTER");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterStartElement\n");
        return;
    ...
    rc = xmlTextWriterWriteElement(writer, (xmlChar *) "TEXT",
                                   (xmlChar *) "This is a text.");
    if (rc < 0) {
        printf
            ("testXmlwriterFilename: Error at xmlTextWriterWriteElement\n");
        return;
...
testXmlwriterMemory(const char *file)
{
    ...
    buf = xmlBufferCreate();
    if (buf == 
# 348 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 348 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) {
    ...
    if (writer == 
# 356 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                 ((void *)0)
# 356 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                     ) {
    ...
    rc = xmlTextWriterStartDocument(writer, 
# 364 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                           ((void *)0)
# 364 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                                               , "ISO-8859-1", 
# 364 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                                              ((void *)0)
# 364 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
    ...
    if (tmp != 
# 392 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 392 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 430 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 430 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 466 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 466 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 477 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 477 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    fp = fopen(file, "w");
    if (fp == 
# 604 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
             ((void *)0)
# 604 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                 ) {
...
testXmlwriterDoc(const char *file)
{
    ...
    if (writer == 
# 633 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                 ((void *)0)
# 633 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                     ) {
    ...
    rc = xmlTextWriterStartDocument(writer, 
# 641 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                           ((void *)0)
# 641 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                                               , "ISO-8859-1", 
# 641 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                                              ((void *)0)
# 641 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
    ...
    if (tmp != 
# 666 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 666 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
   ...
   "This is another comment with special chars: %s",
    ...
    if (tmp != 
# 701 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 701 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 735 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 735 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 744 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 744 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    xmlSaveFileEnc(file, doc, "ISO-8859-1");
...
testXmlwriterTree(const char *file)
{
    ...
    if (doc == 
# 886 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 886 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) {
        printf
...
# 894 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                             ((void *)0)
# 894 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                                 , (xmlChar *) "EXAMPLE", 
# 894 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                                       ((void *)0)
# 894 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
    ...
    if (node == 
# 895 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
               ((void *)0)
# 895 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                   ) {
    ...
    if (writer == 
# 905 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                 ((void *)0)
# 905 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                     ) {
    ...
    rc = xmlTextWriterStartDocument(writer, 
# 913 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                           ((void *)0)
# 913 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                                               , "ISO-8859-1", 
# 913 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
                                                              ((void *)0)
# 913 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
    ...
    if (tmp != 
# 930 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 930 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 967 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 967 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 1001 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 1001 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
    ...
    if (tmp != 
# 1010 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c" 3 4
              ((void *)0)
# 1010 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
                  ) xmlFree(tmp);
...
# 1143 "/doner/libxml2/libxml2-cbb27165/libxml2/doc/examples/testWriter.c"
xmlChar *
