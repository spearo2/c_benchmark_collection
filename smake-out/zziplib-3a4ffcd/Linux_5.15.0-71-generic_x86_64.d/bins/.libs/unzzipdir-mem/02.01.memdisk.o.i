...
# 170 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c"
    ...
    {
        int ext1 = (*(uint16_t*)((entry)->z_extras));
        char *restrict ptr1 = ((char*) (((char*) ((char*)(entry) + (4+2+2+2+2+4+4+4+4+2+2+2+2+2+4+4))) + ((zzip_size_t) (*(uint16_t*)((entry)->z_namlen)))));
        int ext2 = (*(uint16_t*)((header)->z_extras));
        char *restrict ptr2 = ((char*) (((char*) ((char*)(header) + (4+2+2+2+4+4+4+4+2+2))) + ((zzip_size_t) (*(uint16_t*)((header)->z_namlen)))));
...
# 359 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c"
ZZIP_MEM_ENTRY *
zzip_mem_disk_findfile(ZZIP_MEM_DISK * dir,
                       char *filename, ZZIP_MEM_ENTRY * after,
                       zzip_strcmp_fn_t compare)
...
zzip_mem_entry_fopen(ZZIP_MEM_DISK * dir, ZZIP_MEM_ENTRY * entry)
{
    ...
    file->zlib.opaque = 0;
    file->zlib.zalloc = 
# 411 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c" 3 4
                       0
# 411 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c"
                             ;
    file->zlib.zfree = 
# 412 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c" 3 4
                      0
# 412 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c"
                            ;
...
# 417 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c" 3 4
       inflateInit2_((
# 417 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c"
       &file->zlib
# 417 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c" 3 4
       ), (
# 417 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/zzip/../../zzip/memdisk.c"
