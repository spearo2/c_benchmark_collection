# 1 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
# 32 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
...
# 33 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 2
# 47 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
...
static int jp2_read_jp2c(opj_jp2_t *jp2, opj_cio_t *cio, unsigned int *j2k_codestream_length, unsigned int *j2k_codestream_offset);
...
# 142 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
static int jp2_read_ihdr(opj_jp2_t *jp2, opj_cio_t *cio) {
 opj_jp2_box_t box;
...
static int jp2_read_colr(opj_jp2_t *jp2, opj_cio_t *cio) {
 ...
 jp2_read_boxhdr(cinfo, cio, &box);
 do {
  if (0x636f6c72 != box.type) {
   cio_skip(cio, box.length - 8);
   jp2_read_boxhdr(cinfo, cio, &box);
  }
 } while(0x636f6c72 != box.type);
...
opj_jp2_t* jp2_create_decompress(opj_common_ptr cinfo) {
 ...
 if(jp2) {
  ...
  if(jp2->j2k == 
# 515 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
                ((void *)0)
# 515 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
                    ) {
   jp2_destroy_decompress(jp2);
   return 
# 517 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
         ((void *)0)
# 517 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
             ;
  }
 }
 return jp2;
...
opj_image_t* jp2_decode(opj_jp2_t *jp2, opj_cio_t *cio, opj_codestream_info_t *cstr_info) {
 opj_common_ptr cinfo;
 opj_image_t *image = 
# 546 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
                     ((void *)0)
# 546 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
                         ;

 if(!jp2 || !cio) {
  return 
# 549 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
        ((void *)0)
# 549 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
            ;
 }
 ...
 if(!jp2_read_struct(jp2, cio)) {
  ...
  return 
# 557 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
        ((void *)0)
# 557 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
            ;
 }
 ...
 if(!image) {
  ...
  return 
# 564 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
        ((void *)0)
# 564 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
            ;
 }
...
opj_jp2_t* jp2_create_compress(opj_common_ptr cinfo) {
 ...
 if(jp2) {
  ...
  if(jp2->j2k == 
# 590 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
                ((void *)0)
# 590 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
                    ) {
   jp2_destroy_compress(jp2);
   return 
# 592 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c" 3 4
         ((void *)0)
# 592 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/jp2.c"
             ;
  }
 }
 return jp2;
