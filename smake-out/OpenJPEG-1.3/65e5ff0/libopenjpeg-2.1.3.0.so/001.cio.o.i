# 1 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
# 32 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
...
# 33 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c" 2



opj_cio_t* opj_cio_open(opj_common_ptr cinfo, unsigned char *buffer, int length) {
 opj_cp_t *cp = 
# 37 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c" 3 4
               ((void *)0)
# 37 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
                   ;
 opj_cio_t *cio = (opj_cio_t*)malloc(sizeof(opj_cio_t));
 if(!cio) return 
# 39 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c" 3 4
                ((void *)0)
# 39 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
                    ;
 cio->cinfo = cinfo;
 if(buffer && length) {
  ...
  switch(cinfo->codec_format) {
   ...
   default:
    free(cio);
    return 
# 59 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c" 3 4
          ((void *)0)
# 59 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
              ;
  }
  ...
  if(!cio->buffer) {
   ...
   free(cio);
   return 
# 66 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c" 3 4
         ((void *)0)
# 66 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
             ;
  }
 }
 else {
  free(cio);
  return 
# 71 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c" 3 4
        ((void *)0)
# 71 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
            ;
 }
...
# 171 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/cio.c"
unsigned int cio_read(opj_cio_t *cio, int n) {
 int i;
 unsigned int v;
 v = 0;
