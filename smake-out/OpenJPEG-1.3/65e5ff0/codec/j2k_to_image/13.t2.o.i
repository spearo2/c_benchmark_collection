# 1 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
# 32 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
...
# 33 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 2
...
# 60 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
...
# 77 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
static int t2_decode_packet(opj_t2_t* t2, unsigned char *src, int len, opj_tcd_tile_t *tile,
              opj_tcp_t *tcp, opj_pi_iterator_t *pi, opj_packet_info_t *pack_info);
# 88 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
static void t2_putcommacode(opj_bio_t *bio, int n) {
 while (--n >= 0) {
  bio_write(bio, 1, 1);
 }
...
static int t2_encode_packet(opj_tcd_tile_t * tile, opj_tcp_t * tcp, opj_pi_iterator_t *pi, unsigned char *dest, int length, opj_codestream_info_t *cstr_info, int tileno) {
 ...
 opj_bio_t *bio = 
# 142 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
                 ((void *)0)
# 142 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                     ;
...
static void t2_init_seg(opj_tcd_cblk_dec_t* cblk, int index, int cblksty, int first) {
 opj_tcd_seg_t* seg;
 cblk->segs = (opj_tcd_seg_t*) realloc(cblk->segs, (index + 1) * sizeof(opj_tcd_seg_t));
 seg = &cblk->segs[index];
 seg->data = 
# 301 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
            ((void *)0)
# 301 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                ;
 seg->dataindex = 0;
 seg->numpasses = 0;
 seg->len = 0;
...
static int t2_decode_packet(opj_t2_t* t2, unsigned char *src, int len, opj_tcd_tile_t *tile,
 ...
 unsigned char *hd = 
# 333 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
                    ((void *)0)
# 333 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                        ;
 int present;

 opj_bio_t *bio = 
# 336 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
                 ((void *)0)
# 336 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                     ;
...
# 373 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
 bio = bio_create();
 ...
 for (bandno = 0; bandno < res->numbands; bandno++) {
  ...
  for (cblkno = 0; cblkno < prc->cw * prc->ch; cblkno++) {
   opj_tcd_cblk_dec_t* cblk = &prc->cblks.dec[cblkno];
   opj_tcd_seg_t *seg = 
# 528 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
                       ((void *)0)
# 528 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                           ;
...
# 568 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
...
# 596 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
                        ((void *)0)
# 596 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                            ;
 int poc;
  ...
  while (pi_next(&pi[pino])) {
   if ((cp->layer==0) || (cp->layer>=((pi[pino].layno)+1))) {
    ...
    if (cstr_info)
     ...
     pack_info = 
# 708 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
                ((void *)0)
# 708 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                    ;
...
opj_t2_t* t2_create(opj_common_ptr cinfo, opj_image_t *image, opj_cp_t *cp) {
 ...
 if(!t2) return 
# 770 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c" 3 4
               ((void *)0)
# 770 "/doner/openjpeg/openjpeg-65e5ff0/libopenjpeg/t2.c"
                   ;
 t2->cinfo = cinfo;
 t2->image = image;
 t2->cp = cp;
