# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c" 2
# 43 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
...
# 44 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 45 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c" 2
...
# 46 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c" 2

# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t1_ht_luts.h" 1
...
# 48 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c" 2
# 62 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
...
# 84 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
}
# 94 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 111 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
}
...
# 138 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
...
# 164 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 246 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 296 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 394 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 462 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 507 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 545 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 614 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 652 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 690 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 803 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 899 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 958 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
static __inline__
...
# 1026 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
...
# 1097 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
OPJ_BOOL opj_t1_ht_decode_cblk(opj_t1_t *t1,
                               ...
                               opj_mutex_t* p_manager_mutex,
                               OPJ_BOOL check_pterm);
# 1119 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
OPJ_BOOL opj_t1_ht_decode_cblk(opj_t1_t *t1,
                               opj_tcd_cblk_dec_t* cblk,
                               OPJ_UINT32 orient,
                               OPJ_UINT32 roishift,
                               ...
                               OPJ_BOOL check_pterm)
{
    ...
    stride = width;
# 1259 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
    ...
    if (cblk->Mb > 30) {
# 1305 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
        if (p_manager_mutex) {
            opj_mutex_lock(p_manager_mutex);
        }
...
# 1431 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
    ...
    for (x = 0; x < width; x += 4) {
        ...
        OPJ_UINT32 ms_val;
        OPJ_UINT32 locs;
# 1462 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
...
# 1501 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
...
# 1542 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
    ...
    for (y = 2; y < height; ) {
        ...
        for (x = 0; x < width; x += 4) {
            ...
            vlc_val = rev_advance(&vlc, qinf[0] & 0x7);
# 1815 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/ht_dec.c"
            *sip |= (((qinf[0] & 0x30) >> 4) | ((qinf[0] & 0xC0) >> 2)) << sip_shift;
