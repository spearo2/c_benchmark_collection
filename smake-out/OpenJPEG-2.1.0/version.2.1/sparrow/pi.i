# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c" 2
# 41 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
...
# 42 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c" 2
# 54 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
...
# 94 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
static void opj_pi_update_encode_poc_and_final(opj_cp_t *p_cp,
        ...
        OPJ_UINT32 p_dx_min,
        OPJ_UINT32 p_dy_min);
# 120 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
static void opj_pi_update_encode_not_poc(opj_cp_t *p_cp,
        ...
        OPJ_UINT32 p_dx_min,
        OPJ_UINT32 p_dy_min);
# 146 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
static void opj_get_encoding_parameters(const opj_image_t *p_image,
                                        ...
                                        OPJ_UINT32 * p_max_prec,
                                        OPJ_UINT32 * p_max_res);
# 178 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
...
# 199 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
...
static OPJ_BOOL opj_pi_check_next_level(OPJ_INT32 pos,
                                        ...
                                        OPJ_UINT32 pino,
                                        const OPJ_CHAR *prog);
# 237 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/pi.c"
static OPJ_BOOL opj_pi_next_lrcp(opj_pi_iterator_t * pi)
{
        ...
        for (compno = 0; compno < pi->numcomps; compno++) {
            ...
            for (resno = 0; resno < comp->numresolutions; resno++) {
                ...
                if (res->pdx + comp->numresolutions - 1 - resno < 32 &&
                        comp->dx <= (2147483647 *2U +1U) / (1u << (res->pdx + comp->numresolutions - 1 - resno))) {
                    dx = comp->dx * (1u << (res->pdx + comp->numresolutions - 1 - resno));
                    pi->dx = !pi->dx ? dx : opj_uint_min(pi->dx, dx);
                }
                if (res->pdy + comp->numresolutions - 1 - resno < 32 &&
                        comp->dy <= (2147483647 *2U +1U) / (1u << (res->pdy + comp->numresolutions - 1 - resno))) {
    ...
    *p_dy_min = 0x7fffffff;
    ...
    for (compno = 0; compno < p_image->numcomps; ++compno) {
        ...
        for (resno = 0; resno < l_tccp->numresolutions; ++resno) {
            ...
            if (l_dx <= (2147483647 *2U +1U)) {
                *p_dx_min = opj_uint_min(*p_dx_min, (OPJ_UINT32)l_dx);
            }
            if (l_dy <= (2147483647 *2U +1U)) {
        ...
        OPJ_UINT32 ** p_resolutions)
{
    ...
    *p_dy_min = 0x7fffffff;
    ...
    for (compno = 0; compno < p_image->numcomps; ++compno) {
        ...
        lResolutionPtr = p_resolutions ? p_resolutions[compno] : ((void*)0);
        ...
        for (resno = 0; resno < l_tccp->numresolutions; ++resno) {
            ...
            if (l_pdx + l_level_no < 32 &&
                    l_img_comp->dx <= (2147483647 *2U +1U) / (1u << (l_pdx + l_level_no))) {
                l_dx = l_img_comp->dx * (1u << (l_pdx + l_level_no));

                *p_dx_min = opj_uint_min(*p_dx_min, l_dx);
            }
            if (l_pdy + l_level_no < 32 &&
                    l_img_comp->dy <= (2147483647 *2U +1U) / (1u << (l_pdy + l_level_no))) {
                                        ...
                                        opj_event_mgr_t* manager)
{
    ...
    if (l_step_l <= ((2147483647 *2U +1U) / (l_tcp->numlayers + 1U))) {
        ...
        OPJ_UINT32 p_tile_no)
{
    ...
    opj_get_all_encoding_parameters(p_image, p_cp, p_tile_no, &l_tx0, &l_tx1,
                                    &l_ty0, &l_ty1, &l_dx_min, &l_dy_min, &l_max_prec, &l_max_res, ((void*)0));
        ...
        opj_event_mgr_t* manager)
{
    ...
    if (l_tcp->POC && ((((p_cp->rsiz) >= 0x0003)&&((p_cp->rsiz) <= 0x0006)) || p_t2_mode == FINAL_PASS)) {
                          ...
                          J2K_T2_MODE t2_mode)
{
    ...
    if (!(cp->m_specific_param.m_enc.m_tp_on && ((!(((cp->rsiz) >= 0x0003)&&((cp->rsiz) <= 0x0006)) &&
            !(((cp->rsiz) >= 0x0400)&&((cp->rsiz) <= ((0x0900) | (0x009b)))) &&
            (t2_mode == FINAL_PASS)) || (((cp->rsiz) >= 0x0003)&&((cp->rsiz) <= 0x0006)) || (((cp->rsiz) >= 0x0400)&&((cp->rsiz) <= ((0x0900) | (0x009b))))))) {
