# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c" 2
# 39 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c"
...
# 40 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 42 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c" 2
# 53 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c"
...
# 337 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/mqc.c"
void opj_mqc_restart_init_enc(opj_mqc_t *mqc)
{
...
static __inline__ void opj_mqc_renorme(opj_mqc_t *mqc)
{
    { do { mqc->a <<= 1; mqc->c <<= 1; mqc->ct--; if (mqc->ct == 0) { mqc->c = mqc->c; opj_mqc_byteout(mqc); mqc->c = mqc->c; mqc->ct = mqc->ct; } } while( (mqc->a & 0x8000) == 0); };
}
...
static __inline__ void opj_mqc_codemps(opj_mqc_t *mqc)
{
    { mqc->a -= (*mqc->curctx)->qeval; if ((mqc->a & 0x8000) == 0) { if (mqc->a < (*mqc->curctx)->qeval) { mqc->a = (*mqc->curctx)->qeval; } else { mqc->c += (*mqc->curctx)->qeval; } *mqc->curctx = (*mqc->curctx)->nmps; { do { mqc->a <<= 1; mqc->c <<= 1; mqc->ct--; if (mqc->ct == 0) { mqc->c = mqc->c; opj_mqc_byteout(mqc); mqc->c = mqc->c; mqc->ct = mqc->ct; } } while( (mqc->a & 0x8000) == 0); }; } else { mqc->c += (*mqc->curctx)->qeval; } };
}
...
static __inline__ void opj_mqc_codelps(opj_mqc_t *mqc)
{
    { mqc->a -= (*mqc->curctx)->qeval; if (mqc->a < (*mqc->curctx)->qeval) { mqc->c += (*mqc->curctx)->qeval; } else { mqc->a = (*mqc->curctx)->qeval; } *mqc->curctx = (*mqc->curctx)->nlps; { do { mqc->a <<= 1; mqc->c <<= 1; mqc->ct--; if (mqc->ct == 0) { mqc->c = mqc->c; opj_mqc_byteout(mqc); mqc->c = mqc->c; mqc->ct = mqc->ct; } } while( (mqc->a & 0x8000) == 0); }; };
}
...
static __inline__ void opj_mqc_encode(opj_mqc_t *mqc, OPJ_UINT32 d)
{
    if ((*mqc->curctx)->mps == d) {
        opj_mqc_codemps(mqc);
    } else {
