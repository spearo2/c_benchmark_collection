# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/cio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/cio.c" 2
# 40 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/cio.c"
...
# 41 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/cio.c" 2
...
opj_stream_t* opj_stream_create(OPJ_SIZE_T p_buffer_size,
        OPJ_BOOL l_is_input)
{
    ...
    if (l_is_input) {
        l_stream->m_status |= 0x2U;
        l_stream->m_opj_skip = opj_stream_read_skip;
        l_stream->m_opj_seek = opj_stream_read_seek;
    } else {
        l_stream->m_status |= 0x1U;
        ...
        opj_stream_read_fn p_function)
{
    ...
    if ((!l_stream) || (!(l_stream->m_status & 0x2U))) {
        return;
    }
        ...
        opj_stream_write_fn p_function)
{
    ...
    if ((!l_stream) || (!(l_stream->m_status & 0x1U))) {
        return;
    }
