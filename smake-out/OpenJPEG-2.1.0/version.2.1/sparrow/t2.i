# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c" 2
# 41 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
# 42 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c" 2
# 51 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
# 76 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
static OPJ_BOOL opj_t2_encode_packet(OPJ_UINT32 tileno,
                                     ...
                                     opj_event_mgr_t *p_manager);
# 101 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
static OPJ_BOOL opj_t2_init_seg(opj_tcd_cblk_dec_t* cblk,
                                ...
                                OPJ_UINT32 cblksty,
                                OPJ_UINT32 first);
# 167 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
static void opj_t2_putcommacode(opj_bio_t *bio, OPJ_INT32 n)
{
    while (--n >= 0) {
                               ...
                               opj_event_mgr_t *p_manager)
{
    ...
    OPJ_UINT32 pocno = (l_cp->rsiz == 0x0004) ? 2 : 1;
                               ...
                               opj_event_mgr_t *p_manager)
{
    ...
    (void)(p_cstr_index);
# 428 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
# 569 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
        }
        ++l_current_pi;

        opj_free(first_pass_failed);
    }
# 585 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
    opj_pi_destroy(l_pi, l_nb_pocs);
    *p_data_read = (OPJ_UINT32)(l_current_data - p_src);
    return 1;
}
# 599 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
opj_t2_t* opj_t2_create(opj_image_t *p_image, opj_cp_t *p_cp)
{
                                     ...
                                     opj_event_mgr_t *p_manager)
{
    ...
    OPJ_BOOL packet_empty = 0;
# 704 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
    if (tcp->csty & 0x02) {
        if (length < 6) {
...
# 804 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
# 1133 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
# 1479 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
...
# 1619 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/t2.c"
