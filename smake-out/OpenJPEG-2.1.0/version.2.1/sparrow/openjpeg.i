# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/openjpeg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/openjpeg.c" 2
# 38 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/openjpeg.c"
...
# 39 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/openjpeg.c" 2
...
static OPJ_UINT64 opj_get_data_length_from_file(void * p_user_data)
{
    ...
    fseeko(p_file,0,2);
    file_length = (OPJ_OFF_T)ftello(p_file);
    fseeko(p_file,0,0);
...
# 176 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/openjpeg.c"
...
OPJ_BOOL opj_set_decoded_components(opj_codec_t *p_codec,
        OPJ_UINT32 numcomps,
        const OPJ_UINT32* comps_indices,
        OPJ_BOOL apply_color_transforms)
{
...
# 829 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/openjpeg.c"
    }
}
...
OPJ_BOOL opj_encoder_set_extra_options(opj_codec_t *p_codec,
                                  ...
                                  OPJ_INT32 * p_dc_shift, OPJ_UINT32 pNbComp)
{
    ...
    if (((parameters->rsiz) & 0x8000)) {
        parameters->rsiz |= 0x0100;
    } else {
...
opj_stream_t* opj_stream_create_default_file_stream(
    const char *fname, OPJ_BOOL p_is_read_stream)
{
    return opj_stream_create_file_stream(fname, 0x100000,
                                         p_is_read_stream);
}
