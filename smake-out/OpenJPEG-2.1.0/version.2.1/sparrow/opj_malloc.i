# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c" 2
# 33 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c"
...
# 34 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c" 2
...
# 37 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c" 2
...
static __inline__ void *opj_aligned_alloc_n(size_t alignment, size_t size)
{
    void* ptr;
...
# 105 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c"
    return ptr;
}
static __inline__ void *opj_aligned_realloc_n(void *ptr, size_t alignment,
        size_t new_size)
{
    void *r_ptr;
...
# 189 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c"
    return r_ptr;
}
void * opj_malloc(size_t size)
{
...
void opj_aligned_free(void* ptr)
{
    ...
    free(ptr);
# 237 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/opj_malloc.c"
}
