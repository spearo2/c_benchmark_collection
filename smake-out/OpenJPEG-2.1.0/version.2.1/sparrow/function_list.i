# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/function_list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/function_list.c" 2
# 32 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/function_list.c"
...
# 33 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/function_list.c" 2
...
opj_procedure_list_t * opj_procedure_list_create()
{
    ...
    l_validation->m_procedures = (opj_procedure*)opj_calloc(10,
