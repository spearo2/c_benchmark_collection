# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c" 2
# 41 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 42 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c" 2
...
# 45 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c" 2
...
# 48 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c" 2
# 83 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 124 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
static void opj_dwt_deinterleave_h(const OPJ_INT32 * restrict a,
                                   OPJ_INT32 * restrict b,
                                   OPJ_INT32 dn,
...
static OPJ_UINT32 opj_dwt_max_resolution(opj_tcd_resolution_t* restrict r,
        OPJ_UINT32 i);
# 197 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 225 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
static void opj_dwt_deinterleave_h(const OPJ_INT32 * restrict a,
                                   OPJ_INT32 * restrict b,
                                   OPJ_INT32 dn,
                                   OPJ_INT32 sn, OPJ_INT32 cas)
{
    OPJ_INT32 i;
    OPJ_INT32 * restrict l_dest = b;
    const OPJ_INT32 * restrict l_src = a + cas;
...
# 335 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 367 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 436 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 480 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 540 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
static
                               ...
                               OPJ_SIZE_T stride)
{
    ...
    for (i = 0; i < len; ++i) {
        ...
        _mm_storeu_si128((__m128i*)(&tiledp_col[(OPJ_SIZE_T)i * stride + 0]),(_mm_load_si128((const __m128i*)(&tmp[(2*4) * i + 0]))));

        _mm_storeu_si128((__m128i*)(&tiledp_col[(OPJ_SIZE_T)i * stride + 4]),(_mm_load_si128((const __m128i*)(&tmp[(2*4) * i + 4]))));
    ...
    const OPJ_SIZE_T stride)
{
    ...
    s1n_0 = _mm_loadu_si128((const __m128i*)(in_even + 0));
    s1n_1 = _mm_loadu_si128((const __m128i*)(in_even + 4));
    d1n_0 = _mm_loadu_si128((const __m128i*)(in_odd));
    d1n_1 = _mm_loadu_si128((const __m128i*)(in_odd + 4));



    s0n_0 = _mm_sub_epi32((s1n_0),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((d1n_0),(d1n_0))),(two))),(2))));
    s0n_1 = _mm_sub_epi32((s1n_1),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((d1n_1),(d1n_1))),(two))),(2))));
    ...
    for (i = 0, j = 1; i < (len - 3); i += 2, j++) {
        ...
        s1n_0 = _mm_loadu_si128((const __m128i*)(in_even + j * stride));
        s1n_1 = _mm_loadu_si128((const __m128i*)(in_even + j * stride + 4));
        d1n_0 = _mm_loadu_si128((const __m128i*)(in_odd + j * stride));
        d1n_1 = _mm_loadu_si128((const __m128i*)(in_odd + j * stride + 4));


        s0n_0 = _mm_sub_epi32((s1n_0),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((d1c_0),(d1n_0))),(two))),(2))));
        s0n_1 = _mm_sub_epi32((s1n_1),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((d1c_1),(d1n_1))),(two))),(2))));

        _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 0)),(s0c_0));
        _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 0) + 4),(s0c_1));


        _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 1) + 0),(_mm_add_epi32((d1c_0),(_mm_srai_epi32((_mm_add_epi32((s0c_0),(s0n_0))),(1))))));

        _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 1) + 4),(_mm_add_epi32((d1c_1),(_mm_srai_epi32((_mm_add_epi32((s0c_1),(s0n_1))),(1))))));

    }

    _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 0) + 0),(s0n_0));
    _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 0) + 4),(s0n_1));

    if (len & 1) {
        __m128i tmp_len_minus_1;
        s1n_0 = _mm_loadu_si128((const __m128i*)(in_even + (OPJ_SIZE_T)((len - 1) / 2) * stride));

        tmp_len_minus_1 = _mm_sub_epi32((s1n_0),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((d1n_0),(d1n_0))),(two))),(2))));
        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1)),(tmp_len_minus_1));

        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 2)),(_mm_add_epi32((d1n_0),(_mm_srai_epi32((_mm_add_epi32((s0n_0),(tmp_len_minus_1))),(1))))));


        s1n_1 = _mm_loadu_si128((const __m128i*)(in_even + (OPJ_SIZE_T)((len - 1) / 2) * stride + 4));

        tmp_len_minus_1 = _mm_sub_epi32((s1n_1),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((d1n_1),(d1n_1))),(two))),(2))));
        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 4),(tmp_len_minus_1));


        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 2) + 4),(_mm_add_epi32((d1n_1),(_mm_srai_epi32((_mm_add_epi32((s0n_1),(tmp_len_minus_1))),(1))))));



    } else {
        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 0),(_mm_add_epi32((d1n_0),(s0n_0))));

        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 4),(_mm_add_epi32((d1n_1),(s0n_1))));
    ...
    const OPJ_SIZE_T stride)
{
    ...
    s1_0 = _mm_loadu_si128((const __m128i*)(in_even + stride));

    dc_0 = _mm_sub_epi32((_mm_loadu_si128((const __m128i*)(in_odd + 0))),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((_mm_loadu_si128((const __m128i*)(in_even + 0))),(s1_0))),(two))),(2))));

    _mm_store_si128((__m128i*)(tmp + (2*4) * 0),(_mm_add_epi32((_mm_loadu_si128((const __m128i*)(in_even + 0))),(dc_0))));

    s1_1 = _mm_loadu_si128((const __m128i*)(in_even + stride + 4));

    dc_1 = _mm_sub_epi32((_mm_loadu_si128((const __m128i*)(in_odd + 4))),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((_mm_loadu_si128((const __m128i*)(in_even + 4))),(s1_1))),(two))),(2))));

    _mm_store_si128((__m128i*)(tmp + (2*4) * 0 + 4),(_mm_add_epi32((_mm_loadu_si128((const __m128i*)(in_even + 4))),(dc_1))));


    for (i = 1, j = 1; i < (len - 2 - !(len & 1)); i += 2, j++) {

        s2_0 = _mm_loadu_si128((const __m128i*)(in_even + (j + 1) * stride));
        s2_1 = _mm_loadu_si128((const __m128i*)(in_even + (j + 1) * stride + 4));


        dn_0 = _mm_sub_epi32((_mm_loadu_si128((const __m128i*)(in_odd + j * stride))),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((s1_0),(s2_0))),(two))),(2))));

        dn_1 = _mm_sub_epi32((_mm_loadu_si128((const __m128i*)(in_odd + j * stride + 4))),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((s1_1),(s2_1))),(two))),(2))));


        _mm_store_si128((__m128i*)(tmp + (2*4) * i),(dc_0));
        _mm_store_si128((__m128i*)(tmp + (2*4) * i + 4),(dc_1));


        _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 1) + 0),(_mm_add_epi32((s1_0),(_mm_srai_epi32((_mm_add_epi32((dn_0),(dc_0))),(1))))));

        _mm_store_si128((__m128i*)(tmp + (2*4) * (i + 1) + 4),(_mm_add_epi32((s1_1),(_mm_srai_epi32((_mm_add_epi32((dn_1),(dc_1))),(1))))));
    ...
    if (!(len & 1)) {
        ...
        dn_0 = _mm_sub_epi32((_mm_loadu_si128((const __m128i*)(in_odd + (OPJ_SIZE_T)(len / 2 - 1) * stride))),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((s1_0),(s1_0))),(two))),(2))));

        dn_1 = _mm_sub_epi32((_mm_loadu_si128((const __m128i*)(in_odd + (OPJ_SIZE_T)(len / 2 - 1) * stride + 4))),(_mm_srai_epi32((_mm_add_epi32((_mm_add_epi32((s1_1),(s1_1))),(two))),(2))));



        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 2) + 0),(_mm_add_epi32((s1_0),(_mm_srai_epi32((_mm_add_epi32((dn_0),(dc_0))),(1))))));

        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 2) + 4),(_mm_add_epi32((s1_1),(_mm_srai_epi32((_mm_add_epi32((dn_1),(dc_1))),(1))))));


        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 0),(dn_0));
        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 4),(dn_1));
    } else {
        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 0),(_mm_add_epi32((s1_0),(dc_0))));
        _mm_store_si128((__m128i*)(tmp + (2*4) * (len - 1) + 4),(_mm_add_epi32((s1_1),(dc_1))));

    }

    opj_idwt53_v_final_memcpy(tiledp_col, tmp, len, stride);
}
# 775 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
static void opj_idwt53_v(const opj_dwt_t *dwt,
                         ...
                         OPJ_INT32 nb_cols)
{
# 892 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
    const OPJ_INT32 sn = dwt->sn;
    const OPJ_INT32 len = sn + dwt->dn;
    if (dwt->cas == 0) {
...
# 971 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
...
# 996 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
        fw += 8;
    }
...
# 1109 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
static
void opj_dwt_encode_and_deinterleave_h_one_row(void* rowIn,
        ...
        OPJ_BOOL even)
{
    OPJ_INT32* restrict row = (OPJ_INT32*)rowIn;
    OPJ_INT32* restrict tmp = (OPJ_INT32*)tmpIn;
...
void opj_dwt_encode_and_deinterleave_h_one_row_real(void* rowIn,
        ...
        OPJ_BOOL even)
{
    OPJ_FLOAT32* restrict row = (OPJ_FLOAT32*)rowIn;
    OPJ_FLOAT32* restrict tmp = (OPJ_FLOAT32*)tmpIn;
    const OPJ_INT32 sn = (OPJ_INT32)((width + (even ? 1 : 0)) >> 1);
    const OPJ_INT32 dn = (OPJ_INT32)(width - (OPJ_UINT32)sn);
    if (width == 1) {
        return;
    ...
    opj_dwt_deinterleave_h((OPJ_INT32 * restrict)tmp,
...
static void opj_dwt_encode_h_func(void* user_data, opj_tls_t* tls)
{
    ...
    for (j = job->min_j; j < job->max_j; j++) {
        OPJ_INT32* restrict aj = job->tiledp + j * job->w;
...
static void opj_dwt_encode_v_func(void* user_data, opj_tls_t* tls)
{
    ...
    for (j = job->min_j; j + 8 - 1 < job->max_j; j += 8) {
...
static void opj_dwt_fetch_cols_vertical_pass(const void *arrayIn,
        ...
        OPJ_UINT32 cols)
{
    const OPJ_INT32* restrict array = (const OPJ_INT32 * restrict)arrayIn;
    OPJ_INT32* restrict tmp = (OPJ_INT32 * restrict)tmpOut;
    if (cols == 8) {
        OPJ_UINT32 k;
        for (k = 0; k < height; ++k) {
            memcpy(tmp + 8 * k,
...
static __inline__ void opj_dwt_deinterleave_v_cols(
    const OPJ_INT32 * restrict src,
    OPJ_INT32 * restrict dst,
    OPJ_INT32 dn,
    OPJ_INT32 sn,
    OPJ_UINT32 stride_width,
    OPJ_INT32 cas,
    OPJ_UINT32 cols)
{
    OPJ_INT32 k;
    OPJ_INT32 i = sn;
    OPJ_INT32 * restrict l_dest = dst;
    const OPJ_INT32 * restrict l_src = src + cas * 8;
    OPJ_UINT32 c;

    for (k = 0; k < 2; k++) {
        while (i--) {
            if (cols == 8) {
                memcpy(l_dest, l_src, 8 * sizeof(OPJ_INT32));
            } else {
                c = 0;
                switch (cols) {
                case 7:
...
static void opj_dwt_encode_and_deinterleave_v(
    ...
    OPJ_UINT32 cols)
{
    OPJ_INT32* restrict array = (OPJ_INT32 * restrict)arrayIn;
    OPJ_INT32* restrict tmp = (OPJ_INT32 * restrict)tmpIn;
    ...
    if (height == 1) {
        ...
        if (i + 1 < sn) {
            ...
            for (; i + 1 < sn; i++) {
                ...
                *(__m128i*)(tmp + (1 + i * 2) * 8 + 4 * 0) = xmm_Di_0;
                *(__m128i*)(tmp + (1 + i * 2) * 8 + 4 * 1) = xmm_Di_1;
                xmm_Si_0 = xmm_Sip1_0;
                xmm_Si_1 = xmm_Sip1_1;
            }
        }
        ...
        if (i < dn) {
            ...
            for (; i < dn; i++) {
                ...
                *(__m128i*)(tmp + (i * 2) * 8 + 4 * 0) = xmm_Si_0;
                *(__m128i*)(tmp + (i * 2) * 8 + 4 * 1) = xmm_Si_1;
                xmm_Dim1_0 = xmm_Di_0;
                xmm_Dim1_1 = xmm_Di_1;
            }
        }
...
# 1561 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
    if (cols == 8) {
        opj_dwt_deinterleave_v_cols(tmp, array, (OPJ_INT32)dn, (OPJ_INT32)sn,
                                    stride_width, even ? 0 : 1, 8);
    } else {
        opj_dwt_deinterleave_v_cols(tmp, array, (OPJ_INT32)dn, (OPJ_INT32)sn,
                                   ...
                                   const OPJ_FLOAT32 cst)
{
    ...
    for (i = 0; i < end; ++i) {
        ...
        vw += 2 * (8 * sizeof(OPJ_FLOAT32) / sizeof(__m128));
    }
# 1591 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
}
...
# 1646 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
}
...
static void opj_dwt_encode_and_deinterleave_v_real(
    ...
    OPJ_UINT32 cols)
{
    OPJ_FLOAT32* restrict array = (OPJ_FLOAT32 * restrict)arrayIn;
    OPJ_FLOAT32* restrict tmp = (OPJ_FLOAT32 * restrict)tmpIn;
    ...
    opj_v8dwt_encode_step2(tmp + a * 8,
                           tmp + (b + 1) * 8,
                           (OPJ_UINT32)dn,
                           (OPJ_UINT32)opj_int_min(dn, sn - b),
                           opj_dwt_alpha);
    opj_v8dwt_encode_step2(tmp + b * 8,
                           tmp + (a + 1) * 8,
                           (OPJ_UINT32)sn,
                           (OPJ_UINT32)opj_int_min(sn, dn - a),
                           opj_dwt_beta);
    ...
    opj_v8dwt_encode_step2(tmp + b * 8,
                           ...
                           (OPJ_UINT32)opj_int_min(sn, dn - a),
                           opj_dwt_delta);
    opj_v8dwt_encode_step1(tmp + b * 8, (OPJ_UINT32)dn,
                           opj_K);
    opj_v8dwt_encode_step1(tmp + a * 8, (OPJ_UINT32)sn,
                           opj_invK);
...
static __inline__ OPJ_BOOL opj_dwt_encode_procedure(opj_thread_pool_t* tp,
        opj_tcd_tilecomp_t * tilec,
        opj_encode_and_deinterleave_v_fnptr_type p_encode_and_deinterleave_v,
        opj_encode_and_deinterleave_h_one_row_fnptr_type
        p_encode_and_deinterleave_h_one_row)
{
    ...
    if (l_data_size > ((18446744073709551615UL) / (8 * sizeof(OPJ_INT32)))) {

        return 0;
    }
    l_data_size *= 8 * sizeof(OPJ_INT32);
    ...
    while (i--) {
        ...
        if (num_threads <= 1 || rw < 2 * 8) {
            for (j = 0; j + 8 - 1 < rw; j += 8) {
        ...
        if (num_threads <= 1 || rh <= 1) {
            for (j = 0; j < rh; j++) {
                OPJ_INT32* restrict aj = tiledp + j * w;
...
static void opj_dwt_decode_v_func(void* user_data, opj_tls_t* tls)
{
    ...
    for (j = job->min_j; j + (2*4) <= job->max_j;
            j += (2*4)) {
                                    ...
                                    opj_tcd_tilecomp_t* tilec, OPJ_UINT32 numres)
{
    ...
    if (h_mem_size > ((18446744073709551615UL) / (2*4) / sizeof(OPJ_INT32))) {
    ...
    h_mem_size *= (2*4) * sizeof(OPJ_INT32);
    ...
    while (--numres) {
        ...
        if (num_threads <= 1 || rw <= 1) {
            for (j = 0; j + (2*4) <= rw;
                    j += (2*4)) {
                opj_idwt53_v(&v, &tiledp[j], (OPJ_SIZE_T)w, (2*4));
            }
            if (j < rw) {
                                     ...
                                     OPJ_INT32 win_h_x1)
{
    ...
    if (!cas) {
        if ((dn > 0) || (sn > 1)) {
# 2306 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
            i = win_l_x0;
            if (i < win_l_x1) {
                OPJ_INT32 i_max;
        ...
        if (!sn && dn == 1) {
            ...
            for (i = win_l_x0; i < win_l_x1; i++) {
                a[(1+(i)*2)] = opj_int_sub_no_overflow(a[(1+(i)*2)],
                                                   opj_int_add_no_overflow(opj_int_add_no_overflow(((i)<0?a[(0)*2]:((i)>=dn?a[(dn-1)*2]:a[(i)*2])), ((i + 1)<0?a[(0)*2]:((i + 1)>=dn?a[(dn-1)*2]:a[(i + 1)*2]))),
                                                           2) >> 2);
            }
            for (i = win_h_x0; i < win_h_x1; i++) {
                a[(i)*2] = opj_int_add_no_overflow(a[(i)*2],
                                                   opj_int_add_no_overflow(((i)<0?a[(1+(0)*2)]:((i)>=sn?a[(1+(sn-1)*2)]:a[(1+(i)*2)])), ((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=sn?a[(1+(sn-1)*2)]:a[(1+(i - 1)*2)]))) >> 1);
            }
        }
    }
}
# 2368 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
        ...
        OPJ_INT32 win_h_x1)
{
    ...
    if (!cas) {
        if ((dn > 0) || (sn > 1)) {
# 2396 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
            i = win_l_x0;
            if (i < win_l_x1) {
                OPJ_INT32 i_max;
        ...
        if (!sn && dn == 1) {
            ...
            for (i = win_l_x0; i < win_l_x1; i++) {
                for (off = 0; off < 4; off++) {
                    a[(1+(OPJ_UINT32)(i)*2)*4+off] = opj_int_sub_no_overflow(
                                            a[(1+(OPJ_UINT32)(i)*2)*4+off],
                                            opj_int_add_no_overflow(
                                                opj_int_add_no_overflow(((i)<0?a[(OPJ_UINT32)(0)*2*4+off]:((i)>=dn?a[(OPJ_UINT32)(dn-1)*2*4+off]:a[(OPJ_UINT32)(i)*2*4+off])), ((i + 1)<0?a[(OPJ_UINT32)(0)*2*4+off]:((i + 1)>=dn?a[(OPJ_UINT32)(dn-1)*2*4+off]:a[(OPJ_UINT32)(i + 1)*2*4+off]))), 2) >> 2);
                }
            }
            for (i = win_h_x0; i < win_h_x1; i++) {
                for (off = 0; off < 4; off++) {
                    a[(OPJ_UINT32)(i)*2*4+off] = opj_int_add_no_overflow(
                                            a[(OPJ_UINT32)(i)*2*4+off],
                                            opj_int_add_no_overflow(((i)<0?a[(1+(OPJ_UINT32)(0)*2)*4+off]:((i)>=sn?a[(1+(OPJ_UINT32)(sn-1)*2)*4+off]:a[(1+(OPJ_UINT32)(i)*2)*4+off])), ((i - 1)<0?a[(1+(OPJ_UINT32)(0)*2)*4+off]:((i - 1)>=sn?a[(1+(OPJ_UINT32)(sn-1)*2)*4+off]:a[(1+(OPJ_UINT32)(i - 1)*2)*4+off]))) >> 1);
                }
            }
        }
    }
    ...
    OPJ_UINT32 numres)
{
    ...
    if (h_mem_size > ((18446744073709551615UL) / (4 * sizeof(OPJ_INT32)))) {
    ...
    for (resno = 1; resno < numres; resno ++) {
        ...
        opj_dwt_get_band_coordinates(tilec, resno, 1,
                                     win_tcx0, win_tcy0, win_tcx1, win_tcy1,
                                     &win_hl_x0, ((void*)0), &win_hl_x1, ((void*)0));


        opj_dwt_get_band_coordinates(tilec, resno, 2,
                                     win_tcx0, win_tcy0, win_tcx1, win_tcy1,
                                     ((void*)0), &win_lh_y0, ((void*)0), &win_lh_y1);
...
static void opj_v8dwt_interleave_h(opj_v8dwt_t* restrict dwt,
                                   ...
                                   OPJ_UINT32 remaining_height)
{
    ...
    for (k = 0; k < 2; ++k) {
        if (remaining_height >= 8 && ((OPJ_SIZE_T) a & 0x0f) == 0 &&
...
static __inline__ void opj_v8dwt_interleave_v(opj_v8dwt_t* restrict dwt,
        OPJ_FLOAT32* restrict a,
        OPJ_UINT32 width,
        OPJ_UINT32 nb_elts_read)
{
    opj_v8_t* restrict bi = dwt->wavelet + dwt->cas;
    OPJ_UINT32 i;
...
static void opj_v8dwt_interleave_partial_v(opj_v8dwt_t* restrict dwt,
        opj_sparse_array_int32_t* sa,
        OPJ_UINT32 sa_col,
        OPJ_UINT32 nb_elts_read)
{
...
# 3141 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
static void opj_v8dwt_decode(opj_v8dwt_t* restrict dwt)
{
    OPJ_INT32 a, b;
...
# 3208 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/dwt.c"
}
...
static void opj_dwt97_decode_h_func(void* user_data, opj_tls_t* tls)
{
    ...
    aj = job->aj;
    for (j = 0; j + 8 <= job->nb_rows; j += 8) {
        OPJ_UINT32 k;
        opj_v8dwt_interleave_h(&job->h, aj, job->w, 8);
...
static void opj_dwt97_decode_v_func(void* user_data, opj_tls_t* tls)
{
    ...
    aj = job->aj;
    for (j = 0; j + 8 <= job->nb_columns; j += 8) {
        OPJ_UINT32 k;

        opj_v8dwt_interleave_v(&job->v, aj, job->w, 8);
        opj_v8dwt_decode(&job->v);

        for (k = 0; k < job->rh; ++k) {
            memcpy(&aj[k * (OPJ_SIZE_T)job->w], &job->v.wavelet[k],
                   8 * sizeof(OPJ_FLOAT32));
        }
        aj += 8;
    }
                                ...
                                OPJ_UINT32 numres)
{
    ...
    if (l_data_size > ((18446744073709551615UL) / sizeof(opj_v8_t))) {
    ...
    while (--numres) {
        ...
        if (num_threads <= 1 || rh < 2 * 8) {
            for (j = 0; j + (8 - 1) < rh; j += 8) {
                OPJ_UINT32 k;
                opj_v8dwt_interleave_h(&h, aj, w, 8);
                opj_v8dwt_decode(&h);
        ...
        if (num_threads <= 1 || rw < 2 * 8) {
            for (j = rw; j > (8 - 1); j -= 8) {
                ...
                opj_v8dwt_interleave_v(&v, aj, w, 8);
                opj_v8dwt_decode(&v);

                for (k = 0; k < rh; ++k) {
                    memcpy(&aj[k * (OPJ_SIZE_T)w], &v.wavelet[k], 8 * sizeof(OPJ_FLOAT32));
                }
                aj += 8;
            }
        } else {
...
static
OPJ_BOOL opj_dwt_decode_partial_97(opj_tcd_tilecomp_t* restrict tilec,
                                   OPJ_UINT32 numres)
{
    opj_sparse_array_int32_t* sa;
    opj_v8dwt_t h;
    ...
    for (resno = 1; resno < numres; resno ++) {
        ...
        for (j = 0; j + (8 - 1) < rh; j += 8) {
            if ((j + (8 - 1) >= win_ll_y0 && j < win_ll_y1) ||
                    (j + (8 - 1) >= win_lh_y0 + (OPJ_UINT32)v.sn &&
                     j < win_lh_y1 + (OPJ_UINT32)v.sn)) {
                opj_v8dwt_interleave_partial_h(&h, sa, j, opj_uint_min(8, rh - j));
                opj_v8dwt_decode(&h);
                if (!opj_sparse_array_int32_write(sa,
                                                  win_tr_x0, j,
                                                  win_tr_x1, j + 8,
        ...
        for (j = win_tr_x0; j < win_tr_x1; j += 8) {
            OPJ_UINT32 nb_elts = opj_uint_min(8, win_tr_x1 - j);
