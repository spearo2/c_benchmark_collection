# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c" 2
# 32 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c"
...
# 33 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c" 2
# 287 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c"
...
# 288 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c" 2
...
# 289 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c" 2
...
# 290 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c" 2
...
# 294 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c" 2
...
opj_mutex_t* opj_mutex_create(void)
{
    ...
    if (mutex != ((void*)0)) {
        if (pthread_mutex_init(&mutex->mutex, ((void*)0)) != 0) {
            opj_free(mutex);
            mutex = ((void*)0);
        }
    }
...
# 498 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c"
typedef struct {
    int key;
    void* value;
...
# 757 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/thread.c"
static opj_worker_thread_job_t* opj_thread_pool_get_next_job(
    opj_thread_pool_t* tp,
    opj_worker_thread_t* worker_thread,
    OPJ_BOOL signal_job_finished)
