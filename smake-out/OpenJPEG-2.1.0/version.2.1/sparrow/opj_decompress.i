# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
# 40 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
...
# 41 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 43 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 44 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 45 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 46 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 47 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 48 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 53 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
extern int strncasecmp (const char *__s1, const char *__s2, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__pure__)) __attribute__ ((__nonnull__ (1, 2)));
# 61 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
extern int utimes (const char *__file, const struct timeval __tvp[2])
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 62 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 63 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 64 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 67 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/opj_getopt.h" 1
...
# 68 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
extern opj_image_t* pngtoimage(const char *filename,
                               opj_cparameters_t *parameters);
# 69 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/index.h" 1
# 47 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/index.h"
int write_index_file(opj_codestream_info_t *cstr_info, char *index);
# 70 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/color.h" 1
# 41 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/color.h"
...
# 78 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2

# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/format_defs.h" 1
# 80 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/opj_string.h" 1
# 35 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/opj_string.h"
...
# 36 "/doner/openjpeg/openjpeg-version.2.1/src/bin/common/opj_string.h" 2
...
# 81 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c" 2
...
# 266 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
    fprintf(stdout, "\n");
}
...
unsigned int get_num_images(char *imgdirpath)
{
    ...
    while ((content = readdir(dir)) != ((void*)0)) {
        ...
        if (num_images == (2147483647 *2U +1U)) {
...
char get_next_file(unsigned int imageno, dircnt_t *dirptr, img_fol_t *img_fol,
                   opj_decompress_parameters *parameters)
{
    char image_filename[4096], infilename[4096],
         outfilename[4096], temp_ofname[4096];
    ...
    while ((temp_p = strtok(((void*)0), ".")) != ((void*)0)) {
...
static int infile_format(const char *fname)
{
    ...
    if (memcmp(buf, "\x00\x00\x00\x0c\x6a\x50\x20\x20\x0d\x0a\x87\x0a", 12) == 0 || memcmp(buf, "\x0d\x0a\x87\x0a", 4) == 0) {
        magic_format = 1;
        magic_s = ".jp2 or .jph";
    } else if (memcmp(buf, "\xff\x4f\xff\x51", 4) == 0) {
        magic_format = 0;
                          ...
                          opj_decompress_parameters *parameters, img_fol_t *img_fol)
{
    ...
    opj_option_t long_option[] = {
        {"ImgDir", 1, ((void*)0), 'y'},
        {"OutFor", 1, ((void*)0), 'O'},
        {"force-rgb", 0, ((void*)0), 1},
        {"upsample", 0, ((void*)0), 1},
        {"split-pnm", 0, ((void*)0), 1},
        {"threads", 1, ((void*)0), 'T'},
        {"quiet", 0, ((void*)0), 1},
        {"allow-partial", 0, ((void*)0), 1},
    };
    ...
    do {
        ...
        break;
# 910 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
        case 'T': {
...
{
# 1004 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
    struct timespec ts;
    clock_gettime(0, &ts);
    return ((OPJ_FLOAT64)ts.tv_sec + (OPJ_FLOAT64)ts.tv_nsec * 1e-9);
# 1021 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
}
...
int main(int argc, char **argv)
{
    ...
    if (getenv("USE_OPJ_SET_DECODED_RESOLUTION_FACTOR") != ((void*)0)) {
    ...
    if (img_fol.set_imgdir == 1) {
        ...
        dirptr->filename_buf = calloc((size_t) num_images, sizeof(char) * 4096);
    ...
    for (imageno = 0; imageno < num_images ; imageno++) {
        ...
        opj_stream_t *l_stream = ((void*)0);
        opj_codec_t* l_codec = ((void*)0);
        opj_codestream_index_t* cstr_index = ((void*)0);
        ...
        if (parameters.allow_partial &&
                !opj_decoder_set_strict_mode(l_codec, 0)) {
        ...
        if (!parameters.nb_tile_to_decode) {
            if (getenv("SKIP_OPJ_SET_DECODE_AREA") != ((void*)0) &&
                    parameters.DA_x0 == 0 &&
                    parameters.DA_y0 == 0 &&
                    parameters.DA_x1 == 0 &&
                    parameters.DA_y1 == 0) {
        ...
        case 16:
            ...
            break;
# 1802 "/doner/openjpeg/openjpeg-version.2.1/src/bin/jp2/opj_decompress.c"
        default:
            fprintf(stderr, "[ERROR] Outfile %s not generated\n", parameters.outfile);
            failed = 1;
        }
