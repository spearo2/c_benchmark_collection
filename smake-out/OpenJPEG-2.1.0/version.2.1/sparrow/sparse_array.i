# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/sparse_array.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/sparse_array.c" 2
# 32 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/sparse_array.c"
...
# 33 "/doner/openjpeg/openjpeg-version.2.1/src/lib/openjp2/sparse_array.c" 2
        ...
        for (x = x0; x < x1; block_x ++, x += x_incr) {
            ...
            if (is_read_op) {
                if (src_block == ((void*)0)) {
                    ...
                    const OPJ_INT32* restrict src_ptr = src_block + block_y_offset *
                                                            (OPJ_SIZE_T)block_width + block_x_offset;
                    if (buf_col_stride == 1) {
                        OPJ_INT32* restrict dest_ptr = buf + (y - y0) * (OPJ_SIZE_T)buf_line_stride
                                                           +
                                                           (x - x0) * buf_col_stride;
                        if (x_incr == 4) {
                ...
                if (buf_col_stride == 1) {
                    OPJ_INT32* restrict dest_ptr = src_block + block_y_offset *
                                                       (OPJ_SIZE_T)block_width + block_x_offset;
                    const OPJ_INT32* restrict src_ptr = buf + (y - y0) *
