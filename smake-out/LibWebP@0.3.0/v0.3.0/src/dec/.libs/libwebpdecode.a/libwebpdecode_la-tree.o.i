# 1 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
# 12 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
...
# 13 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c" 2
# 21 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
...
# 86 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
  ...
  if (!dec->is_i4x4_) {
    ...
    for (y = 0; y < 4; ++y) {
      ...
      for (x = 0; x < 4; ++x) {
        ...
        ymode = -i;
# 376 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
        top[x] = ymode;
        *modes++ = ymode;
      }
      left[y] = ymode;
...
# 539 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
void VP8ParseProba(VP8BitReader* const br, VP8Decoder* const dec) {
...
# 585 "/doner/libwebp/libwebp-v0.3.0/src/dec/tree.c"
}
