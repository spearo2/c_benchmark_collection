# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
# 11 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 12 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
...
# 13 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
...
# 14 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
...
# 16 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
...
# 17 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
...
# 18 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h" 1
# 16 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h"
# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/../webp/types.h" 1
# 17 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h" 2
...
# 32 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h" 3 4
 ((void) sizeof ((
# 32 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h"
...
# 32 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h"
 "key <= (~0U >> cc->hash_shift_)"
# 32 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h", 32, __extension__ __PRETTY_FUNCTION__); }))
# 32 "/doner/libwebp/libwebp-v0.3.0/src/enc/../utils/color_cache.h"
                                        ;
...
# 19 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
...
# 20 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 2
# 34 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
typedef struct {

  int32_t hash_to_first_index_[(1 << 18)];
...
static inline int FindMatchLength(const uint32_t* const array1,
...
void VP8LInitBackwardRefs(VP8LBackwardRefs* const refs) {
  if (refs != 
# 80 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
             ((void *)0)
# 80 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                 ) {
    refs->refs = 
# 81 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                ((void *)0)
# 81 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                    ;
    refs->size = 0;
    refs->max_size = 0;
  }
...
void VP8LClearBackwardRefs(VP8LBackwardRefs* const refs) {
  if (refs != 
# 88 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
             ((void *)0)
# 88 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                 ) {
    free(refs->refs);
...
# 95 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ((void) sizeof ((
# 95 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 refs != 
# 95 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
...
# 95 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 "refs != NULL"
# 95 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c", 95, __extension__ __PRETTY_FUNCTION__); }))
# 95 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                     ;
  refs->size = 0;
  refs->max_size = 0;
  refs->refs = (PixOrCopy*)WebPSafeMalloc((uint64_t)max_size,
                                          sizeof(*refs->refs));
  if (refs->refs == 
# 100 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                   ((void *)0)
# 100 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                       ) return 0;
...
static inline uint64_t GetPixPairHash64(const uint32_t* const argb) {
  uint64_t key = ((uint64_t)(argb[1]) << 32) | argb[0];
  key = (key * (0xc6a4a7935bd1e995ULL)) >> (64 - 18);
  return key;
}
...
static int HashChainInit(HashChain* const p, int size) {
  ...
  if (p->chain_ == 
# 117 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                  ((void *)0)
# 117 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                      ) {
    return 0;
  }
  for (i = 0; i < size; ++i) {
...
static void HashChainDelete(HashChain* const p) {
  if (p != 
# 130 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
          ((void *)0)
# 130 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
              ) {
    free(p->chain_);
    free(p);
  }
...
static void GetParamsForHashChainFindCopy(int quality, int xsize,
  ...
  const int max_window_size = (quality > 50) ? ((1 << 20) - 120)
                            : (quality > 25) ? (xsize << 8)
                            : (xsize << 4);
  
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ((void) sizeof ((
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 xsize > 0
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 "xsize > 0"
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c", 152, __extension__ __PRETTY_FUNCTION__); }))
# 152 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                  ;
  *window_size = (max_window_size > ((1 << 20) - 120)) ? ((1 << 20) - 120)
               : max_window_size;
...
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ((void) sizeof ((
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 xsize > 0
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 "xsize > 0"
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c", 175, __extension__ __PRETTY_FUNCTION__); }))
# 175 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                  ;
...
static inline void PushBackCopy(VP8LBackwardRefs* const refs, int length) {
  int size = refs->size;
  while (length >= 4096) {
    refs->refs[size++] = PixOrCopyCreateCopy(1, 4096);
    length -= 4096;
  }
  if (length > 0) {
...
static int BackwardReferencesHashChain(int xsize, int ysize,
  ...
  int window_size = ((1 << 20) - 120);
  int iter_pos = 1;
  int iter_limit = -1;

  if (hash_chain == 
# 278 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                   ((void *)0)
# 278 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                       ) return 0;
  if (use_color_cache) {
...
static inline double GetLiteralCost(const CostModel* const m, uint32_t v) {
...
static inline double GetCacheCost(const CostModel* const m, uint32_t idx) {
  const int literal_idx = 256 + 24 + idx;
  return m->literal_[literal_idx];
}

static inline double GetLengthCost(const CostModel* const m,
                                        uint32_t length) {
  int code, extra_bits_count, extra_bits_value;
  PrefixEncode(length, &code, &extra_bits_count, &extra_bits_value);
  return m->literal_[256 + code] + extra_bits_count;
}

static inline double GetDistanceCost(const CostModel* const m,
                                          uint32_t distance) {
  int code, extra_bits_count, extra_bits_value;
...
static int BackwardReferencesHashChainDistanceOnly(
  ...
  if (cost == 
# 494 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
             ((void *)0) 
# 494 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                  || cost_model == 
# 494 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                                   ((void *)0) 
# 494 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
static int BackwardReferencesHashChainFollowChosenPath(
  ...
  if (hash_chain == 
# 639 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                   ((void *)0) 
# 639 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
     ((void) sizeof ((
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
     len == maxlen
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
     ) ? 1 : 0), __extension__ ({ if (
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
     "len == maxlen"
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
     , "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c", 658, __extension__ __PRETTY_FUNCTION__); }))
# 658 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                          ;
...
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ((void) sizeof ((
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 size <= refs->max_size
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 "size <= refs->max_size"
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c", 687, __extension__ __PRETTY_FUNCTION__); }))
# 687 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                               ;
  refs->size = size;
  ok = 1;
...
# 704 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                         ((void *)0)
# 704 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                             ;
  ...
  if (dist_array == 
# 709 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                   ((void *)0)
# 709 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                       ) goto Error;
...
int VP8LGetBackwardReferences(int width, int height,
  ...
  if (refs_rle.refs == 
# 752 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                      ((void *)0) 
# 752 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                           || refs_lz77.refs == 
# 752 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                                                ((void *)0)
# 752 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 ...
 Error1:
...

  {
    ...
    if (histo == 
# 769 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
                ((void *)0)
# 769 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                    ) goto Error1;
...
# 855 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 ((void) sizeof ((
# 855 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
...
# 855 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
 "pixel_index == xsize * ysize"
# 855 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c", 855, __extension__ __PRETTY_FUNCTION__); }))
# 855 "/doner/libwebp/libwebp-v0.3.0/src/enc/backward_references.c"
                                     ;
  (void)xsize;
  (void)ysize;
...
int VP8LCalculateEstimateForCacheSize(const uint32_t* const argb,
  ...
  for (cache_bits = 0; cache_bits <= 9; ++cache_bits) {
    double cur_entropy;
    VP8LHistogram histo;
