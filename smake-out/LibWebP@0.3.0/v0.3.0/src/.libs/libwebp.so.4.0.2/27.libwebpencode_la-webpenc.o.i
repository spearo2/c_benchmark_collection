# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
# 12 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
# 13 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
...
# 14 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
...
# 15 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
...
# 16 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
...
# 18 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
...
# 19 "/doner/libwebp/libwebp-v0.3.0/src/enc/././histogram.h" 2
...
# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/./../webp/format_constants.h" 1
# 19 "/doner/libwebp/libwebp-v0.3.0/src/enc/./vp8li.h" 2
...
# 19 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
...
# 20 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 2
# 33 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
int WebPPictureInitInternal(WebPPicture* picture, int version) {
  ...
  if (picture != 
# 54 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                ((void *)0)
# 54 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                    ) {
...
# 119 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
# 166 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
static VP8Encoder* InitVP8Encoder(const WebPConfig* const config,
  ...
  const size_t cache_size = (3 * ((16 * 16) + (16 * 8)) + (6 * 16 * 16 + 12 * 16)) * sizeof(uint8_t);
  const size_t info_size = mb_w * mb_h * sizeof(VP8MBInfo);
  const size_t samples_size = (2 * top_stride +
                               16 + 16 + 16 + 8 + 1 +
                               2 * 15)
                               * sizeof(uint8_t);
  const size_t lf_stats_size =
      config->autofilter ? sizeof(LFStats) + 15 : 0;
  VP8Encoder* enc;
  uint8_t* mem;
  const uint64_t size = (uint64_t)sizeof(VP8Encoder)
                      + 15
                      + cache_size
                      + info_size
                      + preds_size
                      ...
                      + nz_size
                      + lf_stats_size;
# 222 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
  mem = (uint8_t*)WebPSafeMalloc(size, sizeof(*mem));
  if (mem == 
# 223 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
            ((void *)0)
# 223 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                ) {
    WebPEncodingSetError(picture, VP8_ENC_ERROR_OUT_OF_MEMORY);
    return 
# 225 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
          ((void *)0)
# 225 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
              ;
  }
  enc = (VP8Encoder*)mem;
  mem = (uint8_t*)((uintptr_t)((mem + sizeof(*enc)) + 15) & ~15);
  ...
  mem += nz_size;
  enc->lf_stats_ = lf_stats_size ? (LFStats*)((uintptr_t)((mem) + 15) & ~15) : 
# 248 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                                                            ((void *)0)
# 248 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                                                                ;
  mem += lf_stats_size;


  mem = (uint8_t*)((uintptr_t)((mem) + 15) & ~15);
  enc->y_top_ = (uint8_t*)mem;
  enc->uv_top_ = enc->y_top_ + top_stride;
  mem += 2 * top_stride;
  mem = (uint8_t*)((uintptr_t)((mem + 1) + 15) & ~15);
...
static int DeleteVP8Encoder(VP8Encoder* enc) {
  int ok = 1;
  if (enc != 
# 287 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
            ((void *)0)
# 287 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                ) {
...
static void StoreStats(VP8Encoder* const enc) {
  ...
  if (stats != 
# 317 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
              ((void *)0)
# 317 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                  ) {
    int i, s;
...
# 337 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
 ((void) sizeof ((
# 337 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
# 337 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
 "(int)error < VP8_ENC_ERROR_LAST"
# 337 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c", 337, __extension__ __PRETTY_FUNCTION__); }))
# 337 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                                        ;
  
# 338 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
 ((void) sizeof ((
# 338 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
# 338 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
 "(int)error >= VP8_ENC_OK"
# 338 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c", 338, __extension__ __PRETTY_FUNCTION__); }))
# 338 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                                 ;
...
int WebPReportProgress(const WebPPicture* const pic,
                       int percent, int* const percent_store) {
  if (percent_store != 
# 345 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                      ((void *)0) 
# 345 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
int WebPEncode(const WebPConfig* config, WebPPicture* pic) {
  ...
  if (pic == 
# 360 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
            ((void *)0)
# 360 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                )
    return 0;
  WebPEncodingSetError(pic, VP8_ENC_OK);
  if (config == 
# 363 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
               ((void *)0)
# 363 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                   )
  ...
  if (pic->width > 16383 || pic->height > 16383)
    return WebPEncodingSetError(pic, VP8_ENC_ERROR_BAD_DIMENSION);

  if (pic->stats != 
# 372 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                   ((void *)0)
# 372 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                       ) memset(pic->stats, 0, sizeof(*pic->stats));

  if (!config->lossless) {
    VP8Encoder* enc = 
# 375 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                     ((void *)0)
# 375 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                         ;
    if (pic->y == 
# 376 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                 ((void *)0) 
# 376 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                      || pic->u == 
# 376 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                                   ((void *)0) 
# 376 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
...
# 376 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
    ...
    if (enc == 
# 382 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
              ((void *)0)
# 382 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
                  ) return 0;
    ...
    if (pic->argb == 
# 406 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c" 3 4
                    ((void *)0) 
# 406 "/doner/libwebp/libwebp-v0.3.0/src/enc/webpenc.c"
