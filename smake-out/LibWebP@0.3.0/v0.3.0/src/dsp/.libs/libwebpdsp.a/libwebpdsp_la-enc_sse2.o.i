# 1 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
# 12 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 13 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 2
...
# 20 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 2
...
# 21 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 2
...
# 23 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 2
# 57 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
static void ITransformSSE2(const uint8_t* ref, const int16_t* in, uint8_t* dst,
                           int do_two) {
# 121 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...

  {
    ...
    if (do_two) {
      ...
      ref0 = _mm_loadl_epi64((__m128i*)&ref[0 * 16]);
      ref1 = _mm_loadl_epi64((__m128i*)&ref[1 * 16]);
      ref2 = _mm_loadl_epi64((__m128i*)&ref[2 * 16]);
      ref3 = _mm_loadl_epi64((__m128i*)&ref[3 * 16]);
    } else {

      ref0 = _mm_cvtsi32_si128(*(int*)&ref[0 * 16]);
      ref1 = _mm_cvtsi32_si128(*(int*)&ref[1 * 16]);
      ref2 = _mm_cvtsi32_si128(*(int*)&ref[2 * 16]);
      ref3 = _mm_cvtsi32_si128(*(int*)&ref[3 * 16]);
    }
    ...
    if (do_two) {
      ...
      _mm_storel_epi64((__m128i*)&dst[0 * 16], ref0);
      _mm_storel_epi64((__m128i*)&dst[1 * 16], ref1);
      _mm_storel_epi64((__m128i*)&dst[2 * 16], ref2);
      _mm_storel_epi64((__m128i*)&dst[3 * 16], ref3);
    } else {

      *((int32_t *)&dst[0 * 16]) = _mm_cvtsi128_si32(ref0);
      *((int32_t *)&dst[1 * 16]) = _mm_cvtsi128_si32(ref1);
      *((int32_t *)&dst[2 * 16]) = _mm_cvtsi128_si32(ref2);
      *((int32_t *)&dst[3 * 16]) = _mm_cvtsi128_si32(ref3);
    }
  }
}
...
static void FTransformSSE2(const uint8_t* src, const uint8_t* ref,
...

  {
    ...
    const __m128i src0 = _mm_loadl_epi64((__m128i*)&src[0 * 16]);
    const __m128i src1 = _mm_loadl_epi64((__m128i*)&src[1 * 16]);
    const __m128i src2 = _mm_loadl_epi64((__m128i*)&src[2 * 16]);
    const __m128i src3 = _mm_loadl_epi64((__m128i*)&src[3 * 16]);
    const __m128i src_0 = _mm_unpacklo_epi8(src0, zero);
    const __m128i src_1 = _mm_unpacklo_epi8(src1, zero);
    const __m128i src_2 = _mm_unpacklo_epi8(src2, zero);
    const __m128i src_3 = _mm_unpacklo_epi8(src3, zero);

    const __m128i ref0 = _mm_loadl_epi64((__m128i*)&ref[0 * 16]);
    const __m128i ref1 = _mm_loadl_epi64((__m128i*)&ref[1 * 16]);
    const __m128i ref2 = _mm_loadl_epi64((__m128i*)&ref[2 * 16]);
    const __m128i ref3 = _mm_loadl_epi64((__m128i*)&ref[3 * 16]);
    ...
    const __m128i shuf01_p =
        _mm_shufflehi_epi16(shuf01, 
# 381 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                   (((
# 381 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                   2
# 381 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                   ) << 6) | ((
# 381 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 381 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
    ...
    const __m128i shuf23_p =
        _mm_shufflehi_epi16(shuf23, 
# 383 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                   (((
# 383 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                   2
# 383 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                   ) << 6) | ((
# 383 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 383 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
    ...
    v32 = _mm_shuffle_epi32(v23, 
# 409 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                (((
# 409 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                1
# 409 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                ) << 6) | ((
# 409 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
static int SSE_Nx4SSE2(const uint8_t* a, const uint8_t* b,
  ...
  while (num_quads-- > 0) {
    ...
    const __m128i a0 = _mm_loadu_si128((__m128i*)&a[16 * 0]);
    const __m128i a1 = _mm_loadu_si128((__m128i*)&a[16 * 1]);
    const __m128i a2 = _mm_loadu_si128((__m128i*)&a[16 * 2]);
    const __m128i a3 = _mm_loadu_si128((__m128i*)&a[16 * 3]);
    const __m128i b0 = _mm_loadu_si128((__m128i*)&b[16 * 0]);
    const __m128i b1 = _mm_loadu_si128((__m128i*)&b[16 * 1]);
    const __m128i b2 = _mm_loadu_si128((__m128i*)&b[16 * 2]);
    const __m128i b3 = _mm_loadu_si128((__m128i*)&b[16 * 3]);
...
static int SSE4x4SSE2(const uint8_t* a, const uint8_t* b) {
  ...
  const __m128i a0 = _mm_loadl_epi64((__m128i*)&a[16 * 0]);
  const __m128i a1 = _mm_loadl_epi64((__m128i*)&a[16 * 1]);
  const __m128i a2 = _mm_loadl_epi64((__m128i*)&a[16 * 2]);
  const __m128i a3 = _mm_loadl_epi64((__m128i*)&a[16 * 3]);
  const __m128i b0 = _mm_loadl_epi64((__m128i*)&b[16 * 0]);
  const __m128i b1 = _mm_loadl_epi64((__m128i*)&b[16 * 1]);
  const __m128i b2 = _mm_loadl_epi64((__m128i*)&b[16 * 2]);
  const __m128i b3 = _mm_loadl_epi64((__m128i*)&b[16 * 3]);
...
# 606 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
static int TTransformSSE2(const uint8_t* inA, const uint8_t* inB,
  ...
  {
    const __m128i inA_0 = _mm_loadl_epi64((__m128i*)&inA[16 * 0]);
    const __m128i inA_1 = _mm_loadl_epi64((__m128i*)&inA[16 * 1]);
    const __m128i inA_2 = _mm_loadl_epi64((__m128i*)&inA[16 * 2]);
    const __m128i inA_3 = _mm_loadl_epi64((__m128i*)&inA[16 * 3]);
    const __m128i inB_0 = _mm_loadl_epi64((__m128i*)&inB[16 * 0]);
    const __m128i inB_1 = _mm_loadl_epi64((__m128i*)&inB[16 * 1]);
    const __m128i inB_2 = _mm_loadl_epi64((__m128i*)&inB[16 * 2]);
    const __m128i inB_3 = _mm_loadl_epi64((__m128i*)&inB[16 * 3]);
...
# 881 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      (((
# 881 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                      2
# 881 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 881 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 882 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      (((
# 882 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                      3
# 882 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 882 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 883 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      (((
# 883 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                      3
# 883 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 883 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 884 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      (((
# 884 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                      3
# 884 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 884 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 885 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      (((
# 885 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                      3
# 885 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 885 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
...
# 886 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      (((
# 886 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
                                      1
# 886 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 886 "/doner/libwebp/libwebp-v0.3.0/src/dsp/enc_sse2.c"
