# 1 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
# 1 "/doner/libwebp/libwebp-v0.3.0/examples//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
# 14 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
...
# 15 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
...
# 16 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
...
# 17 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
...
# 18 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2


# 1 "../config.h" 1
# 21 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
# 40 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
# 1 "../src/webp/decode.h" 1
# 15 "../src/webp/decode.h"
...
# 19 "../src/webp/./types.h" 2
# 16 "../src/webp/decode.h" 2
...
# 347 "../src/webp/decode.h" 3 4
                                            ((void *)0)
# 347 "../src/webp/decode.h"
                                                , width, height,
                         stride, uv_stride, 
# 348 "../src/webp/decode.h" 3 4
                                           ((void *)0)
# 348 "../src/webp/decode.h"
                                               );
}
...
extern VP8StatusCode WebPDecode(const uint8_t* data, size_t data_size,
                                      WebPDecoderConfig* config);
# 41 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/examples/./example_util.h" 1
# 14 "/doner/libwebp/libwebp-v0.3.0/examples/./example_util.h"
# 1 "../src/webp/types.h" 1
# 15 "/doner/libwebp/libwebp-v0.3.0/examples/./example_util.h" 2
# 23 "/doner/libwebp/libwebp-v0.3.0/examples/./example_util.h"
...
int ExUtilWriteFile(const char* const file_name,
                    const uint8_t* data, size_t data_size);
# 42 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/examples/./stopwatch.h" 1
# 34 "/doner/libwebp/libwebp-v0.3.0/examples/./stopwatch.h"
...
# 35 "/doner/libwebp/libwebp-v0.3.0/examples/./stopwatch.h" 2


# 36 "/doner/libwebp/libwebp-v0.3.0/examples/./stopwatch.h"
typedef struct timeval Stopwatch;

static inline double StopwatchReadAndReset(Stopwatch* watch) {
  const struct timeval old_value = *watch;
  gettimeofday(watch, 
# 40 "/doner/libwebp/libwebp-v0.3.0/examples/./stopwatch.h" 3 4
                     ((void *)0)
# 40 "/doner/libwebp/libwebp-v0.3.0/examples/./stopwatch.h"
                         );
  return watch->tv_sec - old_value.tv_sec +
      (watch->tv_usec - old_value.tv_usec) / 1000000.0;
}
# 43 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 2
...
# 60 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
typedef enum {
  PNG = 0,
  PAM,
  PPM,
...
# 196 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
static int WritePNG(FILE* out_file, const WebPDecBuffer* const buffer) {
  (void)out_file;
  (void)buffer;
  fprintf(
# 199 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
         stderr
# 199 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
               , "PNG support not compiled. Please install the libpng "
          "development package before building.\n");
  fprintf(
# 201 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
         stderr
# 201 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
...
# 234 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
 ((void) sizeof ((
# 234 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
 a != 
# 234 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
...
# 234 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
 "a != NULL"
# 234 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c", 234, __extension__ __PRETTY_FUNCTION__); }))
# 234 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                  ;
  fprintf(fout, "P5\n%d %d\n255\n", width, height);
  for (y = 0; y < height; ++y) {
...
static void SaveOutput(const WebPDecBuffer* const buffer,
  ...
  FILE* fout = 
# 294 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
              ((void *)0)
# 294 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                  ;
  ...
  if (needs_open_file) {
    ...
    if (!fout) {
      fprintf(
# 308 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
             stderr
# 308 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
  ...
  if (ok) {
    ...
    fprintf(
# 338 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
           stderr
# 338 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
...
int main(int argc, const char *argv[]) {
  const char *in_file = 
# 374 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                       ((void *)0)
# 374 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                           ;
  const char *out_file = 
# 375 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                        ((void *)0)
# 375 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                            ;
  ...
  if (!WebPInitDecoderConfig(&config)) {
    fprintf(
# 384 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
           stderr
# 384 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
  ...
  for (c = 1; c < argc; ++c) {
    if (!strcmp(argv[c], "-h") || !strcmp(argv[c], "-help")) {
      ...
      config.options.crop_left = strtol(argv[++c], 
# 417 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                                                    ((void *)0)
# 417 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                                                        , 0);
      config.options.crop_top = strtol(argv[++c], 
# 418 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                                                    ((void *)0)
# 418 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                                                        , 0);
      config.options.crop_width = strtol(argv[++c], 
# 419 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                                                    ((void *)0)
# 419 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                                                        , 0);
      config.options.crop_height = strtol(argv[++c], 
# 420 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                                                    ((void *)0)
# 420 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                                                        , 0);
    } else if (!strcmp(argv[c], "-scale") && c < argc - 2) {
      config.options.use_scaling = 1;
      config.options.scaled_width = strtol(argv[++c], 
# 423 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                                                      ((void *)0)
# 423 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                                                          , 0);
      config.options.scaled_height = strtol(argv[++c], 
# 424 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                                                      ((void *)0)
# 424 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                                                          , 0);
      ...
      VP8GetCPUInfo = 
# 429 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                     ((void *)0)
# 429 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                         ;

    } else if (argv[c][0] == '-') {
      fprintf(
# 432 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
             stderr
# 432 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                   , "Unknown option '%s'\n", argv[c]);
      Help();
      return -1;
    } else {
  ...
  if (in_file == 
# 440 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                ((void *)0)
# 440 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                    ) {
    fprintf(
# 441 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
           stderr
# 441 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                 , "missing input file!!\n");
    Help();
    return -1;
  }

  {
    ...
    size_t data_size = 0;
    const uint8_t* data = 
# 451 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
                         ((void *)0)
# 451 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                             ;
    ...
    if (bitstream->has_animation) {
      fprintf(
# 464 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
             stderr
# 464 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                   ,
    ...
    if (!ok) {
      fprintf(
# 505 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
             stderr
# 505 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
                   , "Decoding of %s failed.\n", in_file);
      fprintf(
# 506 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c" 3 4
             stderr
# 506 "/doner/libwebp/libwebp-v0.3.0/examples/dwebp.c"
