# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
# 12 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
# 13 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 2
...
# 14 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 2
...
# 15 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 2
...
# 17 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 2
...
# 18 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 2
...
# 19 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 2
# 30 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
# 36 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 3 4
 ((void) sizeof ((
# 36 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
# 36 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
 "(uint64_t)(w * h) == (uint64_t)w * h"
# 36 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c", 36, __extension__ __PRETTY_FUNCTION__); }))
# 36 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
                                             ;

  if (tmp == 
# 38 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 3 4
            ((void *)0)
# 38 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
                ) return;
  for (y = 1; y < h - 1; ++y) {
    for (x = 1; x < w - 1; ++x) {
...
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 3 4
 ((void) sizeof ((
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
 mid <= max && mid >= min
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
 "mid <= max && mid >= min"
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c" 3 4
 , "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c", 91, __extension__ __PRETTY_FUNCTION__); }))
# 91 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
                                 ;
  for (n = 0; n < nb; ++n) {
...
# 109 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
static int GetAlpha(const VP8Histogram* const histo) {
  ...
  alpha = (max_value > 1) ? (2 * 255) * last_non_zero / max_value : 0;
  return alpha;
}
...
# 234 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
...
static int MBAnalyzeBestUVMode(VP8EncIterator* const it) {
  ...
  for (mode = 0; mode < max_mode; ++mode) {
    VP8Histogram histo = { { 0 } };
    int alpha;
    VP8CollectHistogram(it->yuv_in_ + ((16 * 16)),
...
# 377 "/doner/libwebp/libwebp-v0.3.0/src/enc/analysis.c"
