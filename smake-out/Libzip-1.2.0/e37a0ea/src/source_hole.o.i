# 1 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
# 34 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 2



zip_source_t *source_hole_create(const char *, int flags, zip_error_t *);
# 61 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
...
zip_source_t *source_hole_create(const char *fname, int flags, zip_error_t *error)
{
    ...
    if (ud == 
# 98 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
             ((void *)0)
# 98 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                 ) {
        return 
# 99 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 99 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
    }
...
buffer_free(buffer_t *buffer)
{
    ...
    if (buffer == 
# 110 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                 ((void *)0)
# 110 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                     ) {
        return;
    }
...
# 130 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                  ((void *)0)
# 130 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                      ) {
        zip_error_set(error, 14, 0);
        return 
# 132 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 132 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
    ...
    if ((flags & 8) == 0) {
        if ((f = fopen(fname, "rb")) == 
# 137 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                       ((void *)0)
# 137 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                           ) {
            if (!(
# 138 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                 (*__errno_location ()) 
# 138 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                       == 
# 138 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                          2 
# 138 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                ...
                buffer_free(buffer);
                return 
# 140 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                      ((void *)0)
# 140 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                          ;
            }
        }
        else {
  ...
  fclose(f);
                return 
# 147 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                      ((void *)0)
# 147 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                          ;
            }
     fclose(f);
        }
...
buffer_new(void)
{
    ...
    if ((buffer = (buffer_t *)malloc(sizeof(*buffer))) == 
# 162 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                         ((void *)0)
# 162 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                             ) {
        return 
# 163 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 163 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
    }

    buffer->fragment = 
# 166 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                      ((void *)0)
# 166 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                          ;
    buffer->nfragments = 0;
    buffer->fragment_size = (8*1024);
    buffer->size = 0;
    buffer->offset = 0;
...
buffer_read(buffer_t *buffer, zip_uint8_t *data, zip_uint64_t length, zip_error_t *error)
{
    ...
    if (length > 
# 186 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                (9223372036854775807L)
# 186 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                             ) {
        return -1;
    }
...
# 220 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                         (*__errno_location ())
# 220 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                              );
        return -1;
    }

    if (memcmp(b, "NiH0", 4) != 0) {
        zip_error_set(error, 5, 
# 225 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                         22
# 225 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                               );
        return -1;
    }
 ...
 return -1;
    ...
    if ((buffer->nfragments > 
# 237 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                             (18446744073709551615UL)
# 237 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                     /sizeof(buffer->fragment[0]))
 || ((buffer->fragment = (zip_uint8_t **)malloc(sizeof(buffer->fragment[0]) * buffer->nfragments)) == 
# 238 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                                                                     ((void *)0)
# 238 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                                                                         )) {
        zip_error_set(error, 14, 0);
        return -1;
    }
    ...
    for (i = 0; i < buffer->nfragments; i++) {
        buffer->fragment[i] = 
# 244 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                             ((void *)0)
# 244 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                 ;
    }
    ...
    while (i < buffer->nfragments) {
        if (fread(b, 4, 1, f) != 1) {
            zip_error_set(error, 5, 
# 250 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                             (*__errno_location ())
# 250 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                  );
            return -1;
        }

        if (memcmp(b, "NiH1", 4) == 0) {
            if (buffer->fragment_size > 
# 255 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                       (18446744073709551615UL)
# 255 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                               ) {
                zip_error_set(error, 14, 0);
                return -1;
            }
            if ((buffer->fragment[i] = (zip_uint8_t *)malloc(buffer->fragment_size)) == 
# 259 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                                                       ((void *)0)
# 259 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                                                           ) {
                zip_error_set(error, 14, 0);
                return -1;
            }
            if (fread(buffer->fragment[i], buffer->fragment_size, 1, f) != 1) {
                zip_error_set(error, 5, 
# 264 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                 (*__errno_location ())
# 264 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                      );
                return -1;
            }
            i++;
        }
        else if (memcmp(b, "NiH2", 4) == 0) {
            if (fread(b, 8, 1, f) != 1) {
                zip_error_set(error, 5, 
# 271 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                 (*__errno_location ())
# 271 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                      );
                return -1;
            }
            i += get_u64(b);
            ...
            zip_error_set(error, 5, 
# 277 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                             22
# 277 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                   );
            return -1;
        }
    }
...
buffer_to_file(buffer_t *buffer, const char *fname, zip_error_t *error)
{
    ...
    if (f == 
# 306 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
            ((void *)0)
# 306 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                ) {
        zip_error_set(error, 11, 
# 307 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                         (*__errno_location ())
# 307 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                              );
        return -1;
    }
    ...
    for (i=0; i * buffer->fragment_size <buffer->size; i++) {
        if (buffer->fragment[i] == 
# 317 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                  ((void *)0) 
# 317 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                       || only_nul(buffer->fragment[i], buffer->fragment_size)) {
            nul_run++;
        }
        else {
            if (nul_run > 0) {
    ...
    if (fclose(f) != 0) {
        zip_error_set(error, 6, 
# 336 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                          (*__errno_location ())
# 336 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                               );
        return -1;
    }
...
buffer_write(buffer_t *buffer, const zip_uint8_t *data, zip_uint64_t length, zip_error_t *error)
{
    ...
    if (buffer->offset + length > buffer->nfragments * buffer->fragment_size) {
        ...
        if (fragment == 
# 362 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                       ((void *)0)
# 362 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                           ) {
            zip_error_set(error, 14, 0);
            return -1;
        }
        ...
        for (i = buffer->nfragments; i < new_capacity; i++) {
            fragment[i] = 
# 368 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                         ((void *)0)
# 368 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                             ;
        }
    ...
    if (!only_nul(data, length)) {
        ...
        while (n < length) {
            ...
            if (buffer->fragment[idx] == 
# 385 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                        ((void *)0)
# 385 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                            ) {
                if ((buffer->fragment[idx] = (zip_uint8_t *)malloc(buffer->fragment_size)) == 
# 386 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                                                             ((void *)0)
# 386 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                                                                 ) {
                    zip_error_set(error, 14, 0);
                    return -1;
                }
...
hole_free(hole_t *hole) {
    if (hole == 
# 465 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
               ((void *)0)
# 465 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                   ) {
        return;
    }
...
hole_new(const char *fname, int flags, zip_error_t *error)
{
    ...
    if (ctx == 
# 481 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 481 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ) {
        zip_error_set(error, 14, 0);
        return 
# 483 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 483 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
    }

    if ((ctx->fname = strdup(fname)) == 
# 486 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                       ((void *)0)
# 486 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                           ) {
        free(ctx);
        zip_error_set(error, 14, 0);
        return 
# 489 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 489 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
    }

    if ((ctx->in = buffer_from_file(fname, flags, error)) == 
# 492 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                                                            ((void *)0)
# 492 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                                                                ) {
        free(ctx);
        return 
# 494 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 494 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
    }

    zip_error_init(&ctx->error);
    ctx->out = 
# 498 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
              ((void *)0)
# 498 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                  ;
...
source_hole_cb(void *ud, void *data, zip_uint64_t length, zip_source_cmd_t command)
{
    ...
    switch (command) {
        ...
        case ZIP_SOURCE_COMMIT_WRITE:
            ...
            ctx->in = ctx->out;
            ctx->out = 
# 523 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                      ((void *)0)
# 523 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                          ;
            return 0;
        ...
        case ZIP_SOURCE_REMOVE:
            ...
            buffer_free(ctx->out);
            ctx->out = 
# 544 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                      ((void *)0)
# 544 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                          ;
        ...
        case ZIP_SOURCE_ROLLBACK_WRITE:
            buffer_free(ctx->out);
            ctx->out = 
# 550 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                      ((void *)0)
# 550 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                          ;
            return 0;
...
# 560 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                            ((void *)0) 
# 560 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                            : (zip_stat_t *)(data));

            if (st == 
# 562 "/doner/libzip/libzip-e37a0ea/src/source_hole.c" 3 4
                     ((void *)0)
# 562 "/doner/libzip/libzip-e37a0ea/src/source_hole.c"
                         ) {
                return -1;
            }
