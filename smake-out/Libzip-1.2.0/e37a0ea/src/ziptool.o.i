# 1 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
# 1 "/doner/libzip/libzip-e37a0ea/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
# 34 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
# 1 "../config.h" 1
# 35 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
...
# 42 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
# 51 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
# 52 "../lib/compat.h" 2
# 54 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
# 1 "../lib/zip.h" 1
# 59 "../lib/zip.h"
# 1 "../lib/zipconf.h" 1
# 16 "../lib/zipconf.h"
...
# 55 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 2
...
add(int argc, char *argv[]) {
    ...
    if ((zs=zip_source_buffer(za, argv[1], strlen(argv[1]), 0)) == 
# 87 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                  ((void *)0)
# 87 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                      ) {
 fprintf(
# 88 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 88 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 zip_source_free(zs);
 fprintf(
# 94 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 94 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
add_dir(int argc, char *argv[]) {
 ...
 fprintf(
# 104 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 104 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't add directory '%s': %s\n", argv[0], zip_strerror(za));
 return -1;
    }
    return 0;
}
...
add_file(int argc, char *argv[]) {
    zip_source_t *zs;
    zip_uint64_t start = strtoull(argv[2], 
# 113 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                          ((void *)0)
# 113 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                              , 10);
    zip_int64_t len = strtoll(argv[3], 
# 114 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                      ((void *)0)
# 114 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                          , 10);

    if (strcmp(argv[1], "/dev/stdin") == 0) {
 if ((zs=zip_source_filep(za, 
# 117 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                             stdin
# 117 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                  , start, len)) == 
# 117 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                    ((void *)0)
# 117 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
     ...
     fprintf(
# 118 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
            stderr
# 118 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                  , "can't create zip_source from stdin: %s\n", zip_strerror(za));
     return -1;
 }
    } else {
 if ((zs=zip_source_file(za, argv[1], start, len)) == 
# 122 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                     ((void *)0)
# 122 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                         ) {
     fprintf(
# 123 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
            stderr
# 123 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 zip_source_free(zs);
 fprintf(
# 130 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 130 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't add file '%s': %s\n", argv[0], zip_strerror(za));
 return -1;
    }
    return 0;
...
add_from_zip(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[2], 
# 143 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 143 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    start = strtoull(argv[3], 
# 144 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                             ((void *)0)
# 144 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                 , 10);
    len = strtoll(argv[4], 
# 145 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                          ((void *)0)
# 145 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                              , 10);
    if ((z_in[z_in_count]=zip_open(argv[1], 4, &err)) == 
# 146 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                    ((void *)0)
# 146 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                        ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 149 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 149 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't open zip archive '%s': %s\n", argv[1], zip_error_strerror(&error));
 zip_error_fini(&error);
 return -1;
    }
    if ((zs=zip_source_zip(za, z_in[z_in_count], idx, 0, start, len)) == 
# 153 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                        ((void *)0)
# 153 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                            ) {
 fprintf(
# 154 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 154 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "error creating file source from '%s' index '%" 
# 154 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                "l" "u" 
# 154 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 return -1;
    ...
    if (zip_add(za, argv[0], zs) == -1) {
 fprintf(
# 159 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 159 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't add file '%s': %s\n", argv[0], zip_strerror(za));
 zip_source_free(zs);
 zip_close(z_in[z_in_count]);
 return -1;
...
add_nul(int argc, char *argv[]) {
    zip_source_t *zs;
    zip_uint64_t length = strtoull(argv[1], 
# 171 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                           ((void *)0)
# 171 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                               , 10);

    if ((zs=source_nul(za, length)) == 
# 173 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                      ((void *)0)
# 173 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                          ) {
        fprintf(
# 174 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
               stderr
# 174 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
    ...
    if (zip_add(za, argv[0], zs) == -1) {
        zip_source_free(zs);
        fprintf(
# 180 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
               stderr
# 180 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                     , "can't add file '%s': %s\n", argv[0], zip_strerror(za));
        return -1;
    }
    return 0;
...
cat(int argc, char *argv[]) {
    ...
    int err;
    idx = strtoull(argv[0], 
# 194 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 194 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    ...
    if ((zf=zip_fopen_index(za, idx, 0)) == 
# 200 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                           ((void *)0)
# 200 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                               ) {
 fprintf(
# 201 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 201 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't open file at index '%" 
# 201 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                              "l" "u" 
# 201 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                     "': %s\n", idx, zip_strerror(za));
 ...
 if (fwrite(buf, (size_t)n, 1, 
# 205 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                              stdout
# 205 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                    ) != 1) {
     zip_fclose(zf);
     fprintf(
# 207 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
            stderr
# 207 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
# 207 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
    ...
    if (n == -1) {
 fprintf(
# 212 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 212 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't read file at index '%" 
# 212 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                              "l" "u" 
# 212 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 zip_error_init_with_code(&error, err);
 fprintf(
# 220 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 220 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't close file at index '%" 
# 220 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                               "l" "u" 
# 220 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
count_extra(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 232 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 232 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    ceflags = get_flags(argv[1]);
    if ((count=zip_file_extra_fields_count(za, idx, ceflags)) < 0) {
 fprintf(
# 235 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 235 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't get extra field count for file at index '%" 
# 235 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                   "l" "u" 
# 235 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                          "': %s\n", idx, zip_strerror(za));
...
count_extra_by_id(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 249 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 249 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 250 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                         ((void *)0)
# 250 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                             , 10);
    ceflags = get_flags(argv[2]);
    if ((count=zip_file_extra_fields_count_by_id(za, idx, eid, ceflags)) < 0) {
 fprintf(
# 253 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 253 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't get extra field count for file at index '%" 
# 253 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                   "l" "u" 
# 253 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
delete(int argc, char *argv[]) {
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 264 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 264 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    if (zip_delete(za, idx) < 0) {
 fprintf(
# 266 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 266 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't delete file at index '%" 
# 266 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                "l" "u" 
# 266 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                       "': %s\n", idx, zip_strerror(za));
...
delete_extra(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 277 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 277 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 278 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                         ((void *)0)
# 278 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                             , 10);
    geflags = get_flags(argv[2]);
    if ((zip_file_extra_field_delete(za, idx, eid, geflags)) < 0) {
 fprintf(
# 281 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 281 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't delete extra field data for file at index '%" 
# 281 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                     "l" "u" 
# 281 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                            "', extra field id '%d': %s\n", idx, eid, zip_strerror(za));
...
delete_extra_by_id(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 292 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 292 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 293 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                         ((void *)0)
# 293 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                             , 10);
    eidx = (zip_uint16_t)strtoull(argv[2], 
# 294 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                          ((void *)0)
# 294 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[3]);
    if ((zip_file_extra_field_delete_by_id(za, idx, eid, eidx, geflags)) < 0) {
 fprintf(
# 297 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 297 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't delete extra field data for file at index '%" 
# 297 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                     "l" "u" 
# 297 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                            "', extra field id '%d', extra field idx '%d': %s\n", idx, eid, eidx, zip_strerror(za));
 return -1;
    }
    return 0;
}
...
get_archive_comment(int argc, char *argv[]) {
    ...
    if ((comment=zip_get_archive_comment(za, &len, 0)) == 
# 308 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                         ((void *)0)
# 308 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                             )
...
get_extra(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 322 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 322 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    eidx = (zip_uint16_t)strtoull(argv[1], 
# 323 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                          ((void *)0)
# 323 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[2]);
    if ((efdata=zip_file_extra_field_get(za, idx, eidx, &id, &eflen, geflags)) == 
# 325 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                                 ((void *)0)
# 325 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                                     ) {
 fprintf(
# 326 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 326 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't get extra field data for file at index %" 
# 326 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                 "l" "u" 
# 326 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                        ", extra field %d, flags %u: %s\n", idx, eidx, geflags, zip_strerror(za));
 return -1;
    }
...
get_extra_by_id(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 344 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 344 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 345 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                         ((void *)0)
# 345 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                             , 10);
    eidx = (zip_uint16_t)strtoull(argv[2], 
# 346 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                          ((void *)0)
# 346 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[3]);
    if ((efdata=zip_file_extra_field_get_by_id(za, idx, eid, eidx, &eflen, geflags)) == 
# 348 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                                       ((void *)0)
# 348 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                                           ) {
 fprintf(
# 349 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 349 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't get extra field data for file at index %" 
# 349 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                 "l" "u" 
# 349 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                        ", extra field id %d, ef index %d, flags %u: %s\n", idx, eid, eidx, geflags, zip_strerror(za));
 return -1;
    }
...
get_file_comment(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 367 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 367 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    if ((comment=zip_get_file_comment(za, idx, &len, 0)) == 
# 368 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                           ((void *)0)
# 368 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                               ) {
 fprintf(
# 369 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 369 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't get comment for '%s': %s\n", zip_get_name(za, idx, 0), zip_strerror(za));
 return -1;
    } else if (len == 0)
...
get_num_entries(int argc, char *argv[]) {
    ...
    printf("%" 
# 385 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
              "l" "d" 
# 385 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                     " entr%s in archive\n", count, count == 1 ? "y" : "ies");
    return 0;
}
...
name_locate(int argc, char *argv[]) {
 ...
 fprintf(
# 396 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 396 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't find entry with name '%s' using flags '%s'\n", argv[0], argv[1]);
    } else {
 printf("name '%s' using flags '%s' found at index %" 
# 398 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                     "l" "d" 
# 398 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                            "\n", argv[0], argv[1], idx);
    }
...
print_progress(int argc, char *argv[]) {
    zip_register_progress_callback_with_state(za, 0.001, progress_callback, 
# 411 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                           ((void *)0)
# 411 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                               , 
# 411 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                                 ((void *)0)
# 411 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
zrename(int argc, char *argv[]) {
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 418 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 418 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    if (zip_rename(za, idx, argv[1]) < 0) {
 fprintf(
# 420 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 420 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't rename file at index '%" 
# 420 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                "l" "u" 
# 420 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
replace_file_contents(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 432 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 432 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    content = argv[1];
    if ((s=zip_source_buffer(za, content, strlen(content), 0)) == 
# 434 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                 ((void *)0) 
# 434 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                      ||
 zip_file_replace(za, idx, s, 0) < 0) {
 zip_source_free(s);
 fprintf(
# 437 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 437 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
set_extra(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 449 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 449 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 450 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                         ((void *)0)
# 450 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                             , 10);
    eidx = (zip_uint16_t)strtoull(argv[2], 
# 451 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                          ((void *)0)
# 451 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[3]);
 ...
 fprintf(
# 455 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 455 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't set extra field data for file at index '%" 
# 455 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                  "l" "u" 
# 455 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                         "', extra field id '%d', index '%d': %s\n", idx, eid, eidx, zip_strerror(za));
 return -1;
    }
    return 0;
}
...
set_archive_comment(int argc, char *argv[]) {
 ...
 fprintf(
# 464 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 464 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
set_file_comment(int argc, char *argv[]) {
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 473 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 473 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    if (zip_file_set_comment(za, idx, argv[1], (zip_uint16_t)strlen(argv[1]), 0) < 0) {
 fprintf(
# 475 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 475 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't set file comment at index '%" 
# 475 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                     "l" "u" 
# 475 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                            "' to '%s': %s\n", idx, argv[1], zip_strerror(za));
...
set_file_compression(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 486 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 486 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    method = get_compression_method(argv[1]);
    flags = (zip_uint32_t)strtoull(argv[2], 
# 488 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                           ((void *)0)
# 488 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                               , 10);
    if (zip_set_file_compression(za, idx, method, flags) < 0) {
 fprintf(
# 490 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 490 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't set file compression method at index '%" 
# 490 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                "l" "u" 
# 490 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
set_file_encryption(int argc, char *argv[]) {
    ...
    char *password;
    idx = strtoull(argv[0], 
# 501 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 501 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    method = get_encryption_method(argv[1]);
    password = argv[2];
    if (strlen(password) == 0) {
 password = 
# 505 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 505 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
    }
    if (zip_file_set_encryption(za, idx, method, password) < 0) {
 fprintf(
# 508 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 508 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't set file encryption method at index '%" 
# 508 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                               "l" "u" 
# 508 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                      "' to '%s': %s\n", idx, argv[1], zip_strerror(za));
...
set_file_mtime(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 519 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 519 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    mtime = (time_t)strtoull(argv[1], 
# 520 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                     ((void *)0)
# 520 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                         , 10);
    if (zip_file_set_mtime(za, idx, mtime, 0) < 0) {
 fprintf(
# 522 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 522 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't set file mtime at index '%" 
# 522 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                   "l" "u" 
# 522 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
set_file_mtime_all(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    mtime = (time_t)strtoull(argv[0], 
# 534 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                     ((void *)0)
# 534 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                         , 10);

    if ((num_entries = zip_get_num_entries(za, 0)) < 0) {
        fprintf(
# 537 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
               stderr
# 537 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 if (zip_file_set_mtime(za, idx, mtime, 0) < 0) {
     fprintf(
# 542 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
            stderr
# 542 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                  , "can't set file mtime at index '%" 
# 542 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                       "l" "u" 
# 542 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
set_password(int argc, char *argv[]) {
 ...
 fprintf(
# 553 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 553 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
zstat(int argc, char *argv[]) {
    ...
    struct zip_stat sb;
    idx = strtoull(argv[0], 
# 564 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 564 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);

    if (zip_stat_index(za, idx, stat_flags, &sb) < 0) {
 fprintf(
# 567 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 567 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "zip_stat_index failed on '%" 
# 567 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                              "l" "u" 
# 567 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                     "' failed: %s\n", idx, zip_strerror(za));
 ...
 printf("name: '%s'\n", sb.name);
    if (sb.valid & 0x0002u)
 printf("index: '%"
# 574 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                  "l" "u"
# 574 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                        "'\n", sb.index);
    if (sb.valid & 0x0004u)
 printf("size: '%"
# 576 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                 "l" "u"
# 576 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                       "'\n", sb.size);
    if (sb.valid & 0x0008u)
 printf("compressed size: '%"
# 578 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                            "l" "u"
# 578 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                  "'\n", sb.comp_size);
    if (sb.valid & 0x0010u) {
 struct tm *tpm;
...
unchange_all(int argc, char *argv[]) {
 ...
 fprintf(
# 601 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 601 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
zin_close(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 611 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 611 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
    if (idx >= z_in_count) {
 fprintf(
# 613 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 613 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "invalid argument '%" 
# 613 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                      "l" "u" 
# 613 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                             "', only %d zip sources open\n", idx, z_in_count);
 return -1;
    }
    if (zip_close(z_in[idx]) < 0) {
 fprintf(
# 617 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 617 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't close source archive: %s\n", zip_strerror(z_in[idx]));
 return -1;
    }
...
get_flags(const char *arg)
{
    zip_flags_t flags = 0;
    if (strchr(arg, 'C') != 
# 630 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 630 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               )
 flags |= 1u;
    if (strchr(arg, 'c') != 
# 632 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 632 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               )
 flags |= 512u;
    if (strchr(arg, 'd') != 
# 634 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 634 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               )
 flags |= 2u;
    if (strchr(arg, 'l') != 
# 636 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 636 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               )
 flags |= 256u;
    if (strchr(arg, 'u') != 
# 638 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 638 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               )
 flags |= 8u;
    return flags;
}
...
read_from_file(const char *archive, int flags, zip_error_t *error, zip_uint64_t offset, zip_uint64_t length)
{
 ...
 if (strcmp(archive, "/dev/stdin") == 0) {
     zaa = zip_fdopen(
# 703 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                     0
# 703 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                 , flags & ~1, &err);
 }
 else {
 ...
 if (zaa == 
# 708 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 708 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ) {
     zip_error_set(error, err, 
# 709 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                              (*__errno_location ())
# 709 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                   );
     return 
# 710 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 710 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
 }
    }
    else {
        if (length > 
# 714 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                    (9223372036854775807L)
# 714 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                 ) {
            zip_error_set(error, 18, 0);
            return 
# 716 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                  ((void *)0)
# 716 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                      ;
        }
 if ((source = zip_source_file_create(archive, offset, (zip_int64_t)length, error)) == 
# 718 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                                                      ((void *)0)
     
# 719 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
    || (zaa = zip_open_from_source(source, flags, error)) == 
# 719 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                             ((void *)0)
# 719 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                 ) {
     zip_source_free(source);
     return 
# 721 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 721 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
 }
    }
...
{
    zip_source_t *src = 
# 732 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                       ((void *)0)
# 732 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                           ;
    zip_t *zs = 
# 733 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
               ((void *)0)
# 733 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                   ;

    if (strcmp(archive, "/dev/stdin") == 0) {
 zip_error_set(error, 28, 0);
 return 
# 737 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
       ((void *)0)
# 737 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
           ;
    }

    if ((src = source_hole_create(archive, flags, error)) == 
# 740 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                            ((void *)0)
        
# 741 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
       || (zs = zip_open_from_source(src, flags, error)) == 
# 741 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                            ((void *)0)
# 741 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                ) {
        zip_source_free(src);
...
read_to_memory(const char *archive, int flags, zip_error_t *error, zip_source_t **srcp)
{
 ...
 zip_error_set(error, 28, 0);
 return 
# 758 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
       ((void *)0)
# 758 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
           ;
    }

    if (stat(archive, &st) < 0) {
 if (
# 762 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
    (*__errno_location ()) 
# 762 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
          == 
# 762 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
             2
# 762 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                   ) {
     src = zip_source_buffer_create(
# 763 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                   ((void *)0)
# 763 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                       , 0, 0, error);
 }
 else {
     zip_error_set(error, 11, 
# 766 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                      (*__errno_location ())
# 766 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                           );
     return 
# 767 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 767 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
 }
    }
    else {
...
# 773 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                        ((void *)0)
# 773 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                            ) {
     zip_error_set(error, 14, 0);
     return 
# 775 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 775 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
 }
 if ((fp=fopen(archive, "r")) == 
# 777 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                ((void *)0)
# 777 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                    ) {
     free(buf);
     zip_error_set(error, 5, 
# 779 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                      (*__errno_location ())
# 779 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                           );
     return 
# 780 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 780 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
 }
 if (fread(buf, (size_t)st.st_size, 1, fp) < 1) {
     ...
     fclose(fp);
     zip_error_set(error, 5, 
# 785 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                      (*__errno_location ())
# 785 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                           );
     return 
# 786 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 786 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ;
 }
 fclose(fp);
 src = zip_source_buffer_create(buf, (zip_uint64_t)st.st_size, 1, error);
 if (src == 
# 790 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           ((void *)0)
# 790 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               ) {
     free(buf);
 }
    }
    if (src == 
# 794 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
              ((void *)0)
# 794 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                  ) {
 return 
# 795 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
       ((void *)0)
# 795 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
           ;
    }
    zb = zip_open_from_source(src, flags, error);
    if (zb == 
# 798 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
             ((void *)0)
# 798 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                 ) {
 zip_source_free(src);
 return 
# 800 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
       ((void *)0)
# 800 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
           ;
    }
    zip_source_keep(src);
    *srcp = src;
...
source_nul_cb(void *ud, void *data, zip_uint64_t length, zip_source_cmd_t command)
{
    ...
    switch (command) {
     ...
     if (length > 
# 835 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                 (9223372036854775807L)
# 835 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                              ) {
  ...
  return -1;
        ...
        case ZIP_SOURCE_STAT: {
            zip_stat_t *st = ((length) < sizeof(zip_stat_t) ? zip_error_set((&ctx->error), 18, 0), (zip_stat_t *)
# 849 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                            ((void *)0) 
# 849 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                            : (zip_stat_t *)(data));

            if (st == 
# 851 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                     ((void *)0)
# 851 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                         ) {
                return -1;
            }
...
source_nul(zip_t *zs, zip_uint64_t length)
{
    ...
    if ((ctx = (source_nul_t *)malloc(sizeof(*ctx))) == 
# 876 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                       ((void *)0)
# 876 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                           ) {
        zip_error_set(zip_get_error(zs), 14, 0);
        return 
# 878 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
              ((void *)0)
# 878 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                  ;
    }
    ...
    if ((src = zip_source_function(zs, source_nul_cb, ctx)) == 
# 885 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                              ((void *)0)
# 885 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                                                  ) {
        free(ctx);
        return 
# 887 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
              ((void *)0)
# 887 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                  ;
    }
...
write_memory_src_to_file(const char *archive, zip_source_t *src)
{
 ...
 fprintf(
# 902 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 902 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "zip_source_stat on buffer failed: %s\n", zip_error_strerror(zip_source_error(src)));
 return -1;
    }
    if (zip_source_open(src) < 0) {
 if (zip_error_code_zip(zip_source_error(src)) == 23) {
     if (unlink(archive) < 0 && 
# 907 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                               (*__errno_location ()) 
# 907 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                     != 
# 907 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                        2
# 907 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
  ...
  fprintf(
# 908 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
         stderr
# 908 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
               , "unlink failed: %s\n", strerror(
# 908 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                 (*__errno_location ())
# 908 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 fprintf(
# 913 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 913 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "zip_source_open on buffer failed: %s\n", zip_error_strerror(zip_source_error(src)));
 return -1;
    }
    if ((buf=malloc(zst.size)) == 
# 916 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                 ((void *)0)
# 916 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                     ) {
 fprintf(
# 917 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 917 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "malloc failed: %s\n", strerror(
# 917 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                (*__errno_location ())
# 917 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 fprintf(
# 922 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 922 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "zip_source_read on buffer failed: %s\n", zip_error_strerror(zip_source_error(src)));
 zip_source_close(src);
 free(buf);
 return -1;
    }
    zip_source_close(src);
    if ((fp=fopen(archive, "wb")) == 
# 928 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                    ((void *)0)
# 928 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                        ) {
 fprintf(
# 929 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 929 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "fopen failed: %s\n", strerror(
# 929 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                               (*__errno_location ())
# 929 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 fprintf(
# 934 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 934 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "fwrite failed: %s\n", strerror(
# 934 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                (*__errno_location ())
# 934 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 return -1;
    ...
    if (fclose(fp) != 0) {
 fprintf(
# 941 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 941 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "fclose failed: %s\n", strerror(
# 941 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                                                (*__errno_location ())
# 941 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
...
dispatch(int argc, char *argv[])
{
 ...
 if (strcmp(dispatch_table[i].cmdline_name, argv[0]) == 0) {
  ...
  fprintf(
# 991 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
         stderr
# 991 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
  ...
  return 1 + dispatch_table[i].argument_count;
    ...
    fprintf(
# 1000 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
           stderr
# 1000 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                 , "unknown command '%s'\n", argv[0]);
    return -1;
}
...
usage(const char *progname, const char *reason)
{
    ...
    FILE *out;
    if (reason == 
# 1010 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                 ((void *)0)
# 1010 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                     )
 out = 
# 1011 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
      stdout
# 1011 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
            ;
    else
 out = 
# 1013 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
      stderr
# 1013 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
            ;
    fprintf(out, "usage: %s [-cegHhmnrst] [-l len] [-o offset] archive command1 [args] [command2 [args] ...]\n", progname);
    if (reason != 
# 1015 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                 ((void *)0)
# 1015 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                     ) {
 fprintf(out, "%s\n", reason);
 exit(1);
    }
...
main(int argc, char *argv[])
{
 ...
 case 'h':
     usage(prg, 
# 1090 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
               ((void *)0)
# 1090 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                   );
     break;
 case 'l':
     len = strtoull(optarg, 
# 1093 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                           ((void *)0)
# 1093 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                               , 10);
     break;
 case 'm':
 ...
 case 'n':
     ...
     break;
 case 'o':
     offset = strtoull(optarg, 
# 1102 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
                              ((void *)0)
# 1102 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                                  , 10);
     break;
 case 'r':
     stat_flags = 64u;
 ...
 flags = 1;
    ...
    if (za == 
# 1147 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
             ((void *)0)
# 1147 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
                 ) {
 fprintf(
# 1148 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 1148 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
 ...
 if (ret > 0) {
    ...
    if (zip_close(za) == -1) {
 fprintf(
# 1167 "/doner/libzip/libzip-e37a0ea/src/ziptool.c" 3 4
        stderr
# 1167 "/doner/libzip/libzip-e37a0ea/src/ziptool.c"
              , "can't close zip archive '%s': %s\n", archive, zip_strerror(za));
 return 1;
    }
