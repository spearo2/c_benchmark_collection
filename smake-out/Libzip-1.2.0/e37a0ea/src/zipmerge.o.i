# 1 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
# 35 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2

# 1 "../config.h" 1
# 42 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
# 45 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
# 52 "../lib/compat.h" 2
# 52 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
# 1 "../lib/zip.h" 1
# 59 "../lib/zip.h"
# 1 "../lib/zipconf.h" 1
# 16 "../lib/zipconf.h"
...
# 53 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 2
...
char help_head[] =
    "zipmerge" " (" "libzip" ") by Dieter Baron and Thomas Klausner\n\n";
...
# 74 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
char version_string[] = "zipmerge" " (" "libzip" " " "1.2.0a" ")\nCopyright (C) 2004-2014 Dieter Baron and Thomas Klausner\n"

  "libzip" " comes with ABSOLUTELY NO WARRANTY, to the extent permitted by law.\n";
# 85 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
int confirm;
...
main(int argc, char *argv[])
{
    ...
    while ((c=getopt(argc, argv, "hVDiIsS")) != -1) {
 switch (c) {
 case 'D':
     name_flags |= 2u;
     break;
 ...
 case 'h':
     fputs(help_head, 
# 128 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                     stdout
# 128 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                           );
     printf("usage: %s [-DhIiSsV] target-zip zip...\n", prg);
     fputs(help, 
# 130 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                stdout
# 130 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                      );
     exit(0);
 case 'V':
     fputs(version_string, 
# 133 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                          stdout
# 133 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                );
     exit(0);

 default:
     fprintf(
# 137 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
            stderr
# 137 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                  , "usage: %s [-DhIiSsV] target-zip zip...\n", prg);
     exit(2);
 }
    }
    ...
    if (argc < optind+2) {
 fprintf(
# 143 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 143 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "usage: %s [-DhIiSsV] target-zip zip...\n", prg);
 exit(2);
    }
    ...
    if ((zs=(zip_t **)malloc(sizeof(zs[0])*n)) == 
# 151 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                                 ((void *)0)
# 151 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                                     ) {
 fprintf(
# 152 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 152 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "%s: out of memory\n", prg);
 exit(1);
    }

    if ((za=zip_open(tname, 1, &err)) == 
# 156 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                                 ((void *)0)
# 156 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                                     ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 159 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 159 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
 ...
 exit(1);
    ...
    for (i=0; i<n; i++) {
 if ((zs[i]=merge_zip(za, tname, argv[i])) == 
# 165 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                             ((void *)0)
# 165 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                                 )
     exit(1);
    }
    ...
    if (zip_close(za) < 0) {
 fprintf(
# 170 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 170 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "%s: cannot write zip archive '%s': %s\n",
  ...
  zip_t *zs, const char *sname, zip_uint64_t is)
{
    ...
    if (confirm & 0x001)
 return 1;
    else if (confirm & 0x002)
 return 0;

    if (zip_stat_index(za, it, 8u, &st) < 0) {
 fprintf(
# 195 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 195 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "%s: cannot stat file %"
# 195 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                        "l" "u"
# 195 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
 ...
 fprintf(
# 200 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 200 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "%s: cannot stat file %"
# 200 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                        "l" "u"
# 200 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
 ...
 if (confirm & 0x010)
     return 1;
 else if (confirm & 0x020)
     return 0;
    }

    printf("replace '%s' (%"
# 212 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                           "l" "u"
# 212 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                 " / %08x) in `%s'\n"
    "   with '%s' (%"
# 213 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                    "l" "u"
# 213 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                          " / %08x) from `%s'? ",
    st.name, st.size, st.crc, tname,
    ss.name, ss.size, ss.crc, sname);
    fflush(
# 216 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
          stdout
# 216 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                );

    if (fgets(line, sizeof(line), 
# 218 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                 stdin
# 218 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                      ) == 
# 218 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                           ((void *)0)
# 218 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
 ...
 fprintf(
# 219 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 219 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "%s: read error from stdin: %s\n",
  prg, strerror(
# 220 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
               (*__errno_location ())
# 220 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                    ));
 return -1;
    }

    if (
# 224 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
       (__extension__ ({ int __res; if (sizeof (
# 224 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
...
merge_zip(zip_t *za, const char *tname, const char *sname)
{
    ...
    if ((zs=zip_open(sname, 0, &err)) == 
# 241 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                        ((void *)0)
# 241 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                                            ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 244 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        stderr
# 244 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
              , "%s: can't open zip archive '%s': %s\n", prg, sname, zip_error_strerror(&error));
 zip_error_fini(&error);
 return 
# 246 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
       ((void *)0)
# 246 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
           ;
    }
    ...
    if (ret < 0) {
        fprintf(
# 251 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
               stderr
# 251 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                     , "%s: cannot get number of entries for '%s': %s\n", prg, sname, zip_strerror(za));
        return 
# 252 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
              ((void *)0)
# 252 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                  ;
    }
 ...
 if ((idx=zip_name_locate(za, fname, name_flags)) >= 0) {
  ...
  break;
     ...
     case 1:
  if ((source=zip_source_zip(za, zs, i, 0, 0, 0)) == 
# 263 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                                    ((void *)0)
      
# 264 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
     || zip_replace(za, (zip_uint64_t)idx, source) < 0) {
      zip_source_free(source);
      fprintf(
# 266 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
             stderr
# 266 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                   ,
       "%s: cannot replace '%s' in `%s': %s\n",
       prg, fname, tname, zip_strerror(za));
                    zip_close(zs);
      return 
# 270 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
            ((void *)0)
# 270 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
                ;
  }
  break;
  ...
  zip_close(zs);
  return 
# 276 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        ((void *)0)
# 276 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
            ;

     default:
  fprintf(
# 279 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
         stderr
# 279 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
               , "%s: internal error: "
   "unexpected return code from confirm (%d)\n",
   prg, err);
  zip_close(zs);
  return 
# 283 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        ((void *)0)
# 283 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
            ;
     }
 }
 else {
     if ((source=zip_source_zip(za, zs, i, 0, 0, 0)) == 
# 287 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
                                                       ((void *)0)
  
# 288 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
 || zip_add(za, fname, source) < 0) {
  zip_source_free(source);
  fprintf(
# 290 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
         stderr
# 290 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
               ,
   "%s: cannot add '%s' to `%s': %s\n",
   prg, fname, tname, zip_strerror(za));
  zip_close(zs);
  return 
# 294 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c" 3 4
        ((void *)0)
# 294 "/doner/libzip/libzip-e37a0ea/src/zipmerge.c"
            ;
     }
 }
    }
