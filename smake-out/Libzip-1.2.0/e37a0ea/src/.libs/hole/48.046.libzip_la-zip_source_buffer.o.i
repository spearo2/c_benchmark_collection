# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 2
...
{
    if (za == 
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
             ((void *)0)
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                 )
 return 
# 78 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 78 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
...
zip_source_buffer_create(const void *data, zip_uint64_t len, int freep, zip_error_t *error)
{
    ...
    if (data == 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
               ((void *)0) 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                    && len > 0) {
 zip_error_set(error, 18, 0);
 return 
# 92 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 92 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }

    if ((ctx=(struct read_data *)malloc(sizeof(*ctx))) == 
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                         ((void *)0)
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                             ) {
 zip_error_set(error, 14, 0);
 return 
# 97 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 97 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }

    if ((ctx->in = buffer_new_read(data, len, freep)) == 
# 100 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                        ((void *)0)
# 100 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                            ) {
 zip_error_set(error, 14, 0);
 free(ctx);
 return 
# 103 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 103 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }

    ctx->out = 
# 106 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
              ((void *)0)
# 106 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                  ;
    ctx->mtime = time(
# 107 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                     ((void *)0)
# 107 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                         );
    zip_error_init(&ctx->error);

    if ((zs=zip_source_function_create(read_data, ctx, error)) == 
# 110 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                                 ((void *)0)
# 110 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                                     ) {
 buffer_free(ctx->in);
 free(ctx);
 return 
# 113 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 113 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }
...
read_data(void *state, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
    ...
    switch (cmd) {
     ...
     if ((ctx->out = buffer_new_write(64*1024)) == 
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                              ((void *)0)
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                                  ) {
  ...
  return -1;
     ...
     ctx->in = ctx->out;
     ctx->out = 
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
               ((void *)0)
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                   ;
     return 0;
     ...
     if (len > 
# 156 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
              (9223372036854775807L)
# 156 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                           ) {
 ...
 {
     buffer_t *empty = buffer_new_read(
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                      ((void *)0)
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                          , 0, 0);
     if (empty == 0) {
  zip_error_set(&ctx->error, 14, 0);
  return -1;
     ...
     buffer_free(ctx->out);
     ctx->out = 
# 177 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
               ((void *)0)
# 177 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                   ;
     return 0;
  ...
  return -1;
     ...
     st->valid = 0x0010u|0x0004u|0x0008u|0x0040u|0x0080u;
     ...
     return zip_source_make_command_bitmap(ZIP_SOURCE_OPEN, ZIP_SOURCE_READ, ZIP_SOURCE_CLOSE, ZIP_SOURCE_STAT, ZIP_SOURCE_ERROR, ZIP_SOURCE_FREE, ZIP_SOURCE_SEEK, ZIP_SOURCE_TELL, ZIP_SOURCE_BEGIN_WRITE, ZIP_SOURCE_COMMIT_WRITE, ZIP_SOURCE_REMOVE, ZIP_SOURCE_ROLLBACK_WRITE, ZIP_SOURCE_SEEK_WRITE, ZIP_SOURCE_TELL_WRITE, ZIP_SOURCE_WRITE, -1);
        ...
        case ZIP_SOURCE_TELL:
            if (ctx->in->offset > 
# 212 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                 (9223372036854775807L)
# 212 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                              ) {
  zip_error_set(&ctx->error, 30, 
# 213 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                         75
# 213 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                  );
  return -1;
     }
     return (zip_int64_t)ctx->in->offset;
        ...
        case ZIP_SOURCE_TELL_WRITE:
            if (ctx->out->offset > 
# 220 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                  (9223372036854775807L)
# 220 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                               ) {
  zip_error_set(&ctx->error, 30, 
# 221 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                         75
# 221 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                  );
  return -1;
     }
     ...
     if (len > 
# 227 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
              (9223372036854775807L)
# 227 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                           ) {
  zip_error_set(&ctx->error, 18, 0);
  return -1;
     }
...
{
    if (buffer == 
# 243 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                 ((void *)0)
# 243 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                     ) {
 return;
    }
...
# 264 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                             ((void *)0)
# 264 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                 ) {
 return 
# 265 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 265 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }
    ...
    buffer->fragments = 
# 273 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                       ((void *)0)
# 273 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                           ;
    buffer->size = 0;
...
buffer_new_read(const void *data, zip_uint64_t length, int free_data)
{
    ...
    if ((buffer = buffer_new(length)) == 
# 285 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                        ((void *)0)
# 285 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                            ) {
 return 
# 286 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 286 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }
    ...
    if (length > 0) {
 if ((buffer->fragments = malloc(sizeof(*(buffer->fragments)))) == 
# 292 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                                  ((void *)0)
# 292 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                                      ) {
     buffer_free(buffer);
     return 
# 294 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
           ((void *)0)
# 294 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
               ;
 }
...
buffer_new_write(zip_uint64_t fragment_size)
{
    ...
    if ((buffer = buffer_new(fragment_size)) == 
# 312 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                               ((void *)0)
# 312 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                   ) {
 return 
# 313 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 313 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }

    if ((buffer->fragments = malloc(sizeof(*(buffer->fragments)))) == 
# 316 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                                     ((void *)0)
# 316 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                                         ) {
 buffer_free(buffer);
 return 
# 318 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
       ((void *)0)
# 318 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
           ;
    }
    buffer->fragments_capacity = 1;
    buffer->nfragments = 0;
...
buffer_read(buffer_t *buffer, zip_uint8_t *data, zip_uint64_t length)
{
    ...
    length = ((length) < (buffer->size - buffer->offset) ? (length) : (buffer->size - buffer->offset));

    if (length == 0) {
 return 0;
    }
    if (length > 
# 338 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                (9223372036854775807L)
# 338 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                             ) {
 return -1;
    }
    ...
    n = 0;
    while (n < length) {
 zip_uint64_t left = ((length - n) < (buffer->fragment_size - fragment_offset) ? (length - n) : (buffer->fragment_size - fragment_offset));
...
buffer_write(buffer_t *buffer, const zip_uint8_t *data, zip_uint64_t length, zip_error_t *error)
{
 ...
 if (needed_fragments > buffer->fragments_capacity) {
  ...
  new_capacity *= 2;
     ...
     if (fragments == 
# 398 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                     ((void *)0)
# 398 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                         ) {
  zip_error_set(error, 14, 0);
  return -1;
     }
 ...
 while (buffer->nfragments < needed_fragments) {
     if ((buffer->fragments[buffer->nfragments] = malloc(buffer->fragment_size)) == 
# 408 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c" 3 4
                                                                                   ((void *)0)
# 408 "/doner/libzip/libzip-e37a0ea/lib/zip_source_buffer.c"
                                                                                       ) {
  zip_error_set(error, 14, 0);
  return -1;
     }
