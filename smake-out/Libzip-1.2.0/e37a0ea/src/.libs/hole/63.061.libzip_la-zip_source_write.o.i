# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_write.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_write.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_write.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_write.c" 2


__attribute__ ((visibility ("default"))) zip_int64_t
zip_source_write(zip_source_t *src, const void *data, zip_uint64_t length)
{
    if (!((src)->write_state == ZIP_SOURCE_WRITE_OPEN) || length > 
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_source_write.c" 3 4
                                                    (9223372036854775807L)
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_source_write.c"
                                                                 ) {
