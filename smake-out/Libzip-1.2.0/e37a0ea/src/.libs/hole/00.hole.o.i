# 1 "/doner/libzip/libzip-e37a0ea/src/hole.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/src/hole.c"
# 34 "/doner/libzip/libzip-e37a0ea/src/hole.c"
# 1 "../config.h" 1
# 35 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
# 42 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
# 49 "/doner/libzip/libzip-e37a0ea/src/hole.c" 2
...
copy_source(zip_source_t *from, zip_source_t *to)
{
    ...
    if (zip_source_open(from) < 0) {
        fprintf(
# 64 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
               stderr
# 64 "/doner/libzip/libzip-e37a0ea/src/hole.c"
    ...
    if (zip_source_begin_write(to) < 0) {
        fprintf(
# 69 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
               stderr
# 69 "/doner/libzip/libzip-e37a0ea/src/hole.c"
    ...
    while ((n = zip_source_read(from, buf, sizeof(buf))) > 0) {
        if (zip_source_write(to, buf, (zip_uint64_t)n) != n) {
            fprintf(
# 76 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
                   stderr
# 76 "/doner/libzip/libzip-e37a0ea/src/hole.c"
    ...
    if (n < 0) {
        fprintf(
# 84 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
               stderr
# 84 "/doner/libzip/libzip-e37a0ea/src/hole.c"
    ...
    if (zip_source_commit_write(to) < 0) {
        fprintf(
# 93 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
               stderr
# 93 "/doner/libzip/libzip-e37a0ea/src/hole.c"
...
# 110 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
                                                           ((void *)0)
# 110 "/doner/libzip/libzip-e37a0ea/src/hole.c"
                                                               ) {
        fprintf(
# 111 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
               stderr
# 111 "/doner/libzip/libzip-e37a0ea/src/hole.c"
...
# 128 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
                                                              ((void *)0)
# 128 "/doner/libzip/libzip-e37a0ea/src/hole.c"
                                                                  ) {
        fprintf(
# 129 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
               stderr
# 129 "/doner/libzip/libzip-e37a0ea/src/hole.c"
...
{
    fprintf(
# 141 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
           stderr
# 141 "/doner/libzip/libzip-e37a0ea/src/hole.c"
                 , "usage: %s [-du] in out\n", prg);
    fprintf(
# 142 "/doner/libzip/libzip-e37a0ea/src/hole.c" 3 4
           stderr
# 142 "/doner/libzip/libzip-e37a0ea/src/hole.c"
                 , "\nOptions:\n  -d  decompress in\n  -u  update in\n");
    exit(1);
}
