# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 2
...
zip_error_strerror(zip_error_t *err)
{
 ...
 zs = 
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 3 4
     ((void *)0)
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
         ;
 ss = buf;
    }
    else {
 ...
 default:
     ss = 
# 68 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 3 4
         ((void *)0)
# 68 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
             ;
 }
    }

    if (ss == 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 3 4
             ((void *)0)
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
                 )
 return zs;
    else {
 if ((s=(char *)malloc(strlen(ss)
         + (zs ? strlen(zs)+2 : 0) + 1)) == 
# 76 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c" 3 4
                                           ((void *)0)
# 76 "/doner/libzip/libzip-e37a0ea/lib/zip_error_strerror.c"
                                               )
     return _zip_err_str[14];
