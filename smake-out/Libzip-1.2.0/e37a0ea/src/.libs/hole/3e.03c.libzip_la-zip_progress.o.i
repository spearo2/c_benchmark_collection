# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 2
...
_zip_progress_free(zip_progress_t *progress) {
    if (progress == 
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                   ((void *)0)
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                       ) {
        return;
    }
...
_zip_progress_new(zip_t *za, double precision, zip_progress_callback callback, void (*ud_free)(void *), void *ud) {
    ...
    if (progress == 
# 82 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                   ((void *)0)
# 82 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                       ) {
        zip_error_set(&za->error, 14, 0);
        return 
# 84 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
              ((void *)0)
# 84 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                  ;
    }
...
_zip_progress_start(zip_progress_t *progress) {
    if (progress == 
# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                   ((void *)0)
# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                       ) {
        return;
    }
...
_zip_progress_subrange(zip_progress_t *progress, double start, double end) {
    if (progress == 
# 110 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                   ((void *)0)
# 110 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                       ) {
        return;
    }
...
_zip_progress_update(zip_progress_t *progress, double sub_current) {
    ...
    if (progress == 
# 124 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                   ((void *)0)
# 124 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                       ) {
        return;
    }

    current = ((((sub_current) > (0.0) ? (sub_current) : (0.0))) < (1.0) ? (((sub_current) > (0.0) ? (sub_current) : (0.0))) : (1.0)) * (progress->end - progress->start) + progress->start;
...
zip_register_progress_callback_with_state(zip_t *za, double precision, zip_progress_callback callback, void (*ud_free)(void *), void *ud) {
    zip_progress_t *progress = 
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                              ((void *)0)
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                                  ;

    if (callback != 
# 141 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                   ((void *)0)
# 141 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                       ) {
        if ((progress = _zip_progress_new(za, precision, callback, ud_free, ud)) == 
# 142 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                                                                                   ((void *)0)
# 142 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                                                                                       ) {
            return -1;
        }
    }
...
# 171 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                            ((void *)0)
# 171 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                                ) {
        zip_register_progress_callback_with_state(za, 0, 
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                                                        ((void *)0)
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                                                            , 
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                                                              ((void *)0)
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
...
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
    ...
    if ((ud = (struct legacy_ud *)malloc(sizeof(*ud))) == 
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c" 3 4
                                                         ((void *)0)
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_progress.c"
                                                             ) {
        return;
    }
