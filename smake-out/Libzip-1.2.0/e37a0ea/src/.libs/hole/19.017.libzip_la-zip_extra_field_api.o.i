# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 2
...
zip_file_extra_field_delete(zip_t *za, zip_uint64_t idx, zip_uint16_t ef_idx, zip_flags_t flags)
{
    ...
    if ((flags & (256u|512u)) == 0) {
 zip_error_set(&za->error, 18, 0);
 return -1;
    }

    if (((flags & (256u|512u)) == (256u|512u)) && (ef_idx != 
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                            (65535)
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                                               )) {
 zip_error_set(&za->error, 18, 0);
 return -1;
    }
...
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                   ((void *)0)
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                       ) == 
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                            ((void *)0)
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
...
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                             (65535)
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                                                , ef_idx, flags);
    return 0;
}
...
zip_file_extra_field_delete_by_id(zip_t *za, zip_uint64_t idx, zip_uint16_t ef_id, zip_uint16_t ef_idx, zip_flags_t flags)
{
 ...
 return -1;
    ...
    if (((flags & (256u|512u)) == (256u|512u)) && (ef_idx != 
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                            (65535)
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                                               )) {
 zip_error_set(&za->error, 18, 0);
 return -1;
    }
    ...
    if (_zip_get_dirent(za, idx, 0, 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                   ((void *)0)
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                       ) == 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                            ((void *)0)
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
...
__attribute__ ((visibility ("default"))) const zip_uint8_t *
zip_file_extra_field_get(zip_t *za, zip_uint64_t idx, zip_uint16_t ef_idx, zip_uint16_t *idp, zip_uint16_t *lenp, zip_flags_t flags)
{
 ...
 zip_error_set(&za->error, 18, 0);
 return 
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
       ((void *)0)
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
           ;
    }

    if ((de=_zip_get_dirent(za, idx, flags, &za->error)) == 
# 118 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                           ((void *)0)
# 118 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                               )
 return 
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
       ((void *)0)
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
           ;

    if (flags & 256u)
 if (_zip_read_local_ef(za, idx) < 0)
     return 
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
           ((void *)0)
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
               ;
  ...
  *lenp = ef->size;
  ...
  return empty;
    ...
    return 
# 145 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
          ((void *)0)
# 145 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
              ;
...
zip_file_extra_field_get_by_id(zip_t *za, zip_uint64_t idx, zip_uint16_t ef_id, zip_uint16_t ef_idx, zip_uint16_t *lenp, zip_flags_t flags)
{
 ...
 zip_error_set(&za->error, 18, 0);
 return 
# 157 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
       ((void *)0)
# 157 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
           ;
    }

    if ((de=_zip_get_dirent(za, idx, flags, &za->error)) == 
# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                           ((void *)0)
# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                               )
 return 
# 161 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
       ((void *)0)
# 161 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
           ;

    if (flags & 256u)
 if (_zip_read_local_ef(za, idx) < 0)
     return 
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
           ((void *)0)
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
               ;
...
__attribute__ ((visibility ("default"))) zip_int16_t
zip_file_extra_fields_count(zip_t *za, zip_uint64_t idx, zip_flags_t flags)
{
 ...
 return -1;
    ...
    if ((de=_zip_get_dirent(za, idx, flags, &za->error)) == 
# 183 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                           ((void *)0)
# 183 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                               )
 return -1;
...
zip_file_extra_fields_count_by_id(zip_t *za, zip_uint64_t idx, zip_uint16_t ef_id, zip_flags_t flags)
{
 ...
 return -1;
    ...
    if ((de=_zip_get_dirent(za, idx, flags, &za->error)) == 
# 211 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                           ((void *)0)
# 211 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                               )
 return -1;
 ...
 if (_zip_read_local_ef(za, idx) < 0)
    ...
    n = 0;
    for (ef=de->extra_fields; ef; ef=ef->next)
 if (ef->id == ef_id && (ef->flags & flags & (256u|512u)))
     n++;
...
zip_file_extra_field_set(zip_t *za, zip_uint64_t idx, zip_uint16_t ef_id, zip_uint16_t ef_idx, const zip_uint8_t *data, zip_uint16_t len, zip_flags_t flags)
{
 ...
 return -1;
    ...
    if (_zip_get_dirent(za, idx, 0, 
# 240 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                   ((void *)0)
# 240 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                       ) == 
# 240 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                            ((void *)0)
# 240 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
 ...
 return -1;
    ...
    if (((ef_id) == 0x6375 || (ef_id) == 0x7075 || (ef_id) == 0x9901 || (ef_id) == 0x0001)) {
 zip_error_set(&za->error, 18, 0);
 return -1;
    }
    ...
    ef = de->extra_fields;
    ef_prev = 
# 259 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
             ((void *)0)
# 259 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                 ;
    i = 0;
    found = 0;
 ...
 ef_prev = ef;
    ...
    if (i < ef_idx && ef_idx != 
# 274 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                               (65535)
# 274 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                  ) {
 zip_error_set(&za->error, 18, 0);
 return -1;
    }
 ...
 new_len -= ef->size + 4;
    ...
    if (new_len > 
# 293 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                 (65535)
# 293 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                               ) {
 zip_error_set(&za->error, 18, 0);
 return -1;
    }
...
# 298 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                        ((void *)0)
# 298 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                            ) {
 ...
 return -1;
    ...
    if (found) {
 if ((ef->flags & (256u|512u)) == (flags & (256u|512u))) {
     ef_new->next = ef->next;
     ef->next = 
# 306 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
               ((void *)0)
# 306 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                   ;
     _zip_ef_free(ef);
     if (ef_prev)
  ef_prev->next = ef_new;
...
_zip_file_extra_field_prepare_for_change(zip_t *za, zip_uint64_t idx)
{
 ...
 if (_zip_read_local_ef(za, idx) < 0)
    ...
    if (e->changes == 
# 351 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                     ((void *)0)
# 351 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                         ) {
        if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 352 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                      ((void *)0)
# 352 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                          ) {
            zip_error_set(&za->error, 14, 0);
            return -1;
        }
...
# 359 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c" 3 4
                                                                                   ((void *)0)
# 359 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field_api.c"
                                                                                       )
     return -1;
    }
