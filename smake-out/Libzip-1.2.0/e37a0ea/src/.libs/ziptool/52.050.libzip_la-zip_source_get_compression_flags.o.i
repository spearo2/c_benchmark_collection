# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_get_compression_flags.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_get_compression_flags.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_get_compression_flags.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_get_compression_flags.c" 2
...
{
    while (src) {
 if ((src->supports & (((zip_uint64_t)1)<<(ZIP_SOURCE_GET_COMPRESSION_FLAGS)))) {
     zip_int64_t ret = _zip_source_call(src, 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_get_compression_flags.c" 3 4
                                            ((void *)0)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_get_compression_flags.c"
                                                , 0, ZIP_SOURCE_GET_COMPRESSION_FLAGS);
     if (ret < 0) {
  return -1;
     }
     if (ret > 3) {
