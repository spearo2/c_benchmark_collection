# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 2
...
zip_set_archive_comment(zip_t *za, const char *comment, zip_uint16_t len)
{
 ...
 return -1;
    ...
    if (len > 0 && comment == 
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 3 4
                             ((void *)0)
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
                                 ) {
 ...
 return -1;
    ...
    if (len > 0) {
 if ((cstr=_zip_string_new((const zip_uint8_t *)comment, len, 0u, &za->error)) == 
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 3 4
                                                                                               ((void *)0)
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
                                                                                                   )
     return -1;
 ...
 cstr = 
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 3 4
       ((void *)0)
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
           ;

    _zip_string_free(za->comment_changes);
    za->comment_changes = 
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 3 4
                         ((void *)0)
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
                             ;

    if (((za->comment_orig && _zip_string_equal(za->comment_orig, cstr))
  || (za->comment_orig == 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 3 4
                         ((void *)0) 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
                              && cstr == 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c" 3 4
                                         ((void *)0)
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_comment.c"
