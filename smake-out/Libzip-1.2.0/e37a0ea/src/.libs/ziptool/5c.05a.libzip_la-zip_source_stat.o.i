# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c" 2
...
zip_source_stat(zip_source_t *src, zip_stat_t *st)
{
    ...
    if (st == 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c" 3 4
             ((void *)0)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c"
                 ) {
 ...
 return -1;
    ...
    if (((src)->src != 
# 51 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c" 3 4
       ((void *)0)
# 51 "/doner/libzip/libzip-e37a0ea/lib/zip_source_stat.c"
       )) {
