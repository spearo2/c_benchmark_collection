# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 2
...
_zip_new(zip_error_t *error)
{
 ...
 return 
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
       ((void *)0)
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
           ;
    }

    if ((za->names = _zip_hash_new(error)) == 
# 55 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
                                             ((void *)0)
# 55 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                                                 ) {
 free(za);
 return 
# 57 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
       ((void *)0)
# 57 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
           ;
    }

    za->src = 
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
             ((void *)0)
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                 ;
    za->open_flags = 0;
    zip_error_init(&za->error);
    za->flags = za->ch_flags = 0;
    za->default_password = 
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
                          ((void *)0)
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                              ;
    za->comment_orig = za->comment_changes = 
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
                                            ((void *)0)
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                                                ;
    za->comment_changed = 0;
    za->nentry = za->nentry_alloc = 0;
    za->entry = 
# 68 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
               ((void *)0)
# 68 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                   ;
    za->nopen_source = za->nopen_source_alloc = 0;
    za->open_source = 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
                     ((void *)0)
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                         ;
    za->progress = 
# 71 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c" 3 4
                  ((void *)0)
# 71 "/doner/libzip/libzip-e37a0ea/lib/zip_new.c"
                      ;
