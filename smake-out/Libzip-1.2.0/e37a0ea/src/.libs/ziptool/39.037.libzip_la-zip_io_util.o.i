# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 2
...
_zip_read(zip_source_t *src, zip_uint8_t *b, zip_uint64_t length, zip_error_t *error)
{
    ...
    if (length > 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                (9223372036854775807L)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                             ) {
...
zip_uint8_t *
_zip_read_data(zip_buffer_t *buffer, zip_source_t *src, size_t length, 
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                                                                      _Bool 
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                                                                           nulp, zip_error_t *error)
{
    zip_uint8_t *r;
    ...
    if (length == 0 && !nulp) {
 return 
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
       ((void *)0)
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
           ;
    }
 ...
 return 
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
       ((void *)0)
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
           ;
    }
    ...
    if (buffer) {
        ...
        if (data == 
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                   ((void *)0)
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                       ) {
            zip_error_set(error, 14, 0);
            free(r);
            return 
# 84 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                  ((void *)0)
# 84 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                      ;
        }
 ...
 if (_zip_read(src, r, length, error) < 0) {
     free(r);
     return 
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
           ((void *)0)
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
               ;
 }
    }
...
zip_string_t *
_zip_read_string(zip_buffer_t *buffer, zip_source_t *src, zip_uint16_t len, 
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                                                                           _Bool 
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                                                                                nulp, zip_error_t *error)
{
    zip_uint8_t *raw;
    zip_string_t *s;

    if ((raw=_zip_read_data(buffer, src, len, nulp, error)) == 
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                                                              ((void *)0)
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                                                                  )
 return 
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
       ((void *)0)
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
           ;
...
_zip_write(zip_t *za, const void *data, zip_uint64_t length)
{
    ...
    if ((zip_uint64_t)n != length) {
        zip_error_set(&za->error, 6, 
# 133 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c" 3 4
                                               4
# 133 "/doner/libzip/libzip-e37a0ea/lib/zip_io_util.c"
                                                    );
        return -1;
    }
