# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 2
...
{
    if (buffer == 
# 49 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                 ((void *)0)
# 49 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                     ) {
        return;
    }
...
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
_Bool

# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
_zip_buffer_eof(zip_buffer_t *buffer)
{
...
_zip_buffer_get(zip_buffer_t *buffer, zip_uint64_t length)
{
    ...
    if (data != 
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
...
_zip_buffer_get_16(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
_zip_buffer_get_32(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
_zip_buffer_get_64(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
_zip_buffer_get_8(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 128 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 128 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
   _Bool 
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
        free_data = (data == 
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                             ((void *)0)
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
    ...
    if (data == 
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        if ((data = (zip_uint8_t *)malloc(size)) == 
# 163 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                                                   ((void *)0)
# 163 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                                                       ) {
            return 
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                  ((void *)0)
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                      ;
        }
    }

    if ((buffer = (zip_buffer_t *)malloc(sizeof(*buffer))) == 
# 168 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                                                             ((void *)0)
# 168 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                                                                 ) {
        if (free_data) {
            free(data);
        }
        return 
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
              ((void *)0)
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                  ;
    }

    buffer->ok = 
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                1
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                    ;
    buffer->data = data;
    buffer->size = size;
    buffer->offset = 0;
...
_zip_buffer_new_from_source(zip_source_t *src, zip_uint64_t size, zip_uint8_t *buf, zip_error_t *error)
{
    ...
    if ((buffer = _zip_buffer_new(buf, size)) == 
# 190 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                                                ((void *)0)
# 190 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                                                    ) {
        zip_error_set(error, 14, 0);
        return 
# 192 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
              ((void *)0)
# 192 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                  ;
    }
    ...
    if (_zip_read(src, buffer->data, size, error) < 0) {
        ...
        return 
# 197 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
              ((void *)0)
# 197 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                  ;
    }
...
# 211 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
_Bool

# 212 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
_zip_buffer_ok(zip_buffer_t *buffer)
{
    return buffer->ok;
}
...
_zip_buffer_peek(zip_buffer_t *buffer, zip_uint64_t length)
{
    ...
    if (!buffer->ok || buffer->offset + length < length || buffer->offset + length > buffer->size) {
        buffer->ok = 
# 225 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                    0
# 225 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                         ;
        return 
# 226 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
              ((void *)0)
# 226 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                  ;
    }
...
_zip_buffer_put(zip_buffer_t *buffer, const void *src, size_t length)
{
    ...
    if (dst == 
# 238 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
              ((void *)0)
# 238 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                  ) {
        return -1;
    }
...
_zip_buffer_put_16(zip_buffer_t *buffer, zip_uint16_t i)
{
    ...
    if (data == 
# 252 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 252 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_put_32(zip_buffer_t *buffer, zip_uint32_t i)
{
    ...
    if (data == 
# 268 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 268 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_put_64(zip_buffer_t *buffer, zip_uint64_t i)
{
    ...
    if (data == 
# 286 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 286 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_put_8(zip_buffer_t *buffer, zip_uint8_t i)
{
    ...
    if (data == 
# 308 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
               ((void *)0)
# 308 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_set_offset(zip_buffer_t *buffer, zip_uint64_t offset)
{
    if (offset > buffer->size) {
        buffer->ok = 
# 322 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                    0
# 322 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                         ;
        return -1;
    }

    buffer->ok = 
# 326 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                1
# 326 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                    ;
...
_zip_buffer_skip(zip_buffer_t *buffer, zip_uint64_t length) {
    ...
    if (offset < buffer->offset) {
        buffer->ok = 
# 338 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c" 3 4
                    0
# 338 "/doner/libzip/libzip-e37a0ea/lib/zip_buffer.c"
                         ;
        return -1;
    }
