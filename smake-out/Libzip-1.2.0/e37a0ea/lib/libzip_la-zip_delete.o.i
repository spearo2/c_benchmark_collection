# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_delete.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_delete.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_delete.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_delete.c" 2
...
zip_delete(zip_t *za, zip_uint64_t idx)
{
 ...
 return -1;
    ...
    if ((name=_zip_get_name(za, idx, 0, &za->error)) == 
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_delete.c" 3 4
                                                       ((void *)0)
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_delete.c"
                                                           ) {
 return -1;
    }
