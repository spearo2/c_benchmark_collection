# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 2
...
zip_fdopen(int fd_orig, int _flags, int *zep)
{
    ...
    if (_flags < 0 || (_flags & ~(4|16))) {
 _zip_set_open_error(zep, 
# 51 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
                         ((void *)0)
# 51 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                             , 18);
        return 
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
               ((void *)0)
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                   ;
    }
    ...
    if ((fd=dup(fd_orig)) < 0) {
 _zip_set_open_error(zep, 
# 59 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
                         ((void *)0)
# 59 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                             , 11);
 return 
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
       ((void *)0)
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
           ;
    }

    if ((fp=fdopen(fd, "rb")) == 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
                                ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                                    ) {
 close(fd);
 _zip_set_open_error(zep, 
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
                         ((void *)0)
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                             , 11);
 return 
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
       ((void *)0)
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
           ;
    }

    zip_error_init(&error);
    if ((src = zip_source_filep_create(fp, 0, -1, &error)) == 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
                                                             ((void *)0)
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                                                                 ) {
 _zip_set_open_error(zep, &error, 0);
 zip_error_fini(&error);
 return 
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
       ((void *)0)
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
           ;
    }

    if ((za = zip_open_from_source(src, _flags, &error)) == 
# 76 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
                                                           ((void *)0)
# 76 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
                                                               ) {
 _zip_set_open_error(zep, &error, 0);
 zip_error_fini(&error);
 return 
# 79 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c" 3 4
       ((void *)0)
# 79 "/doner/libzip/libzip-e37a0ea/lib/zip_fdopen.c"
           ;
    }
