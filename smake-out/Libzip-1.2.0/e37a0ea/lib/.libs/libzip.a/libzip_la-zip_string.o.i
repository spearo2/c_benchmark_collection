# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 2
...
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                                 0
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                                       , 0);

    if (s != 
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
            ((void *)0)
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                )
...
{
    if (a == 
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
            ((void *)0) 
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                 || b == 
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                         ((void *)0)
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
...
{
    if (s == 
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
            ((void *)0)
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                )
 return;
...
_zip_string_get(zip_string_t *string, zip_uint32_t *lenp, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (string == 
# 87 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                 ((void *)0)
# 87 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                     ) {
 if (lenp)
     *lenp = 0;
 return empty;
 ...
 if (((flags & 128u)
     ...
     if (string->converted == 
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                             ((void *)0)
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                                 ) {
  if ((string->converted=_zip_cp437_to_utf8(string->raw, string->length,
         &string->converted_length, error)) == 
# 103 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                                              ((void *)0)
# 103 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                                                  )
      return 
# 104 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
            ((void *)0)
# 104 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                ;
     }
     if (lenp)
...
{
    if (s == 
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
            ((void *)0)
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                )
 return 0;
...
_zip_string_new(const zip_uint8_t *raw, zip_uint16_t length, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (length == 0)
 return 
# 135 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
       ((void *)0)
# 135 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
           ;

    switch (flags & (0u|4096u|2048u)) {
    case 0u:
 ...
 return 
# 149 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
       ((void *)0)
# 149 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
           ;
    }

    if ((s=(zip_string_t *)malloc(sizeof(*s))) == 
# 152 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                                                 ((void *)0)
# 152 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                                                     ) {
 zip_error_set(error, 14, 0);
 return 
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
       ((void *)0)
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
           ;
    }

    if ((s->raw=(zip_uint8_t *)malloc((size_t)(length+1))) == 
# 157 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                                                             ((void *)0)
# 157 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                                                                 ) {
 free(s);
 return 
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
       ((void *)0)
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
           ;
    }
    ...
    s->converted = 
# 166 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
                  ((void *)0)
# 166 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                      ;
 ...
 if (_zip_guess_encoding(s, expected_encoding) == ZIP_ENCODING_ERROR) {
     ...
     zip_error_set(error, 18, 0);
     return 
# 173 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
           ((void *)0)
# 173 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
               ;
 }
    }
...
{
    if (s == 
# 184 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c" 3 4
            ((void *)0)
# 184 "/doner/libzip/libzip-e37a0ea/lib/zip_string.c"
                )
 return 0;
