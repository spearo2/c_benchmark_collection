# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
                                      ((void *)0)
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
                                          ) {
...
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
                                  ((void *)0)
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
                                      , source, flags) == -1)
 return -1;
...
_zip_file_replace(zip_t *za, zip_uint64_t idx, const char *name, zip_source_t *source, zip_flags_t flags)
{
 ...
 return -1;
    ...
    if (idx == 
# 67 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
              (18446744073709551615UL)
# 67 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
                            ) {
 zip_int64_t i = -1;

 if (flags & 8192u)
     i = _zip_name_locate(za, name, flags, 
# 71 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
                                          ((void *)0)
# 71 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
                                              );
...
# 93 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
                              ((void *)0) 
# 93 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
...
# 94 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
                                     ((void *)0)
# 94 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
                                         ) {
            if ((za->entry[idx].changes=_zip_dirent_clone(za->entry[idx].orig)) == 
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c" 3 4
                                                                                  ((void *)0)
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_file_replace.c"
                                                                                      ) {
