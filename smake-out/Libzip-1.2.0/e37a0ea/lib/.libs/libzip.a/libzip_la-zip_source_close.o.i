# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c" 2
...
zip_source_close(zip_source_t *src)
{
    ...
    src->open_count--;
    if (src->open_count == 0) {
 _zip_source_call(src, 
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c" 3 4
                      ((void *)0)
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c"
                          , 0, ZIP_SOURCE_CLOSE);

 if (((src)->src != 
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c" 3 4
    ((void *)0)
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_source_close.c"
    )) {
