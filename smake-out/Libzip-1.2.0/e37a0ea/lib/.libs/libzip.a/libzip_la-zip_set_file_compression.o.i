# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c" 2
...
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c" 3 4
                                                 1
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
                                                     )) {
 ...
 return -1;
    ...
    old_method = (e->orig == 
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c" 3 4
                            ((void *)0) 
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
                                 ? -1 : e->orig->comp_method);
 ...
 if (e->changes) {
  ...
  e->changes = 
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c" 3 4
              ((void *)0)
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
                  ;
     }
 }
    }
        ...
        if (e->changes == 
# 79 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c" 3 4
                         ((void *)0)
# 79 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 80 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c" 3 4
                                                          ((void *)0)
# 80 "/doner/libzip/libzip-e37a0ea/lib/zip_set_file_compression.c"
                                                              ) {
