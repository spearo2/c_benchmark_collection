# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c" 2
...
zip_stat_init(zip_stat_t *st)
{
    st->valid = 0;
    st->name = 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c" 3 4
              ((void *)0)
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c"
                  ;
    st->index = 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c" 3 4
               (18446744073709551615UL)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_stat_init.c"
                             ;
    st->crc = 0;
    st->mtime = (time_t)-1;
    st->size = 0;
...
_zip_stat_merge(zip_stat_t *dst, const zip_stat_t *src, zip_error_t *error)
{
    ...
    if (src->valid & 0x0002u) {
        dst->index = src->index;
    }
    if (src->valid & 0x0004u) {
        dst->size = src->size;
    }
    if (src->valid & 0x0008u) {
        dst->comp_size = src->comp_size;
    }
    if (src->valid & 0x0010u) {
        dst->mtime = src->mtime;
    }
    if (src->valid & 0x0020u) {
        dst->crc = src->crc;
    }
    if (src->valid & 0x0040u) {
        dst->comp_method = src->comp_method;
    }
    if (src->valid & 0x0080u) {
        dst->encryption_method = src->encryption_method;
    }
    if (src->valid & 0x0100u) {
        dst->flags = src->flags;
    }
    dst->valid |= src->valid;
