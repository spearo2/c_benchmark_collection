# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 2
...
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
   _Bool 
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
        same_as_orig;
    zip_int64_t i;
...
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                                                                                       ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                                                                                           )
     return -1;
 if ((flags & (0u|4096u|2048u)) == 0u && _zip_guess_encoding(str, ZIP_ENCODING_UNKNOWN) == ZIP_ENCODING_UTF8_GUESSED)
     str->encoding = ZIP_ENCODING_UTF8_KNOWN;
    }
    else
 str = 
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
      ((void *)0)
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
          ;


    if ((i=_zip_name_locate(za, name, 0, 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                        ((void *)0)
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                            )) >= 0 && (zip_uint64_t)i != idx) {
 _zip_string_free(str);
 zip_error_set(&za->error, 10, 0);
 return -1;
    }
 ...
 same_as_orig = 
# 89 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
               0
# 89 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                    ;

    if (!same_as_orig && e->changes == 
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                      ((void *)0)
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                          ) {
 if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 92 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                               ((void *)0)
# 92 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                                   ) {
    ...
    if ((new_name = _zip_string_get(same_as_orig ? e->orig->filename : str, 
# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                                                           ((void *)0)
# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                                                               , 0, &za->error)) == 
# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                                                                                    ((void *)0)
# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
 ...
 old_str = 
# 111 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
          ((void *)0)
# 111 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
              ;
    }

    if (old_str) {
 if ((old_name = _zip_string_get(old_str, 
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                         ((void *)0)
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                             , 0, &za->error)) == 
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                                                  ((void *)0)
# 115 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
 ...
 old_name = 
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
           ((void *)0)
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
               ;
    }

    if (_zip_hash_add(za->names, new_name, idx, 0, &za->error) == 
# 124 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                                                 0
# 124 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                                                      ) {
 _zip_string_free(str);
 return -1;
    }
    if (old_name) {
 _zip_hash_delete(za->names, old_name, 
# 129 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                                      ((void *)0)
# 129 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                                          );
    }

    if (same_as_orig) {
 if (e->changes) {
     if (e->changes->changed & 0x0002u) {
  _zip_string_free(e->changes->filename);
  e->changes->changed &= ~0x0002u;
  if (e->changes->changed == 0) {
      _zip_dirent_free(e->changes);
      e->changes = 
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c" 3 4
                  ((void *)0)
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_set_name.c"
                      ;
  }
  else {
