# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c" 2



# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
...
# 116 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
zip_encoding_type_t
_zip_guess_encoding(zip_string_t *str, zip_encoding_type_t expected_encoding)
{
    ...
    if (str == 
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c" 3 4
              ((void *)0)
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
                  )
...
_zip_unicode_to_utf8(zip_uint32_t codepoint, zip_uint8_t *buf)
{
 ...
 return 1;
    ...
    if (codepoint < 0x0800) {
 buf[0] = (zip_uint8_t)(0xc0 | ((codepoint >> 6) & 0x1f));
 buf[1] = (zip_uint8_t)(0x80 | (codepoint & 0x3f));
 return 2;
    }
    if (codepoint < 0x10000) {
 buf[0] = (zip_uint8_t)(0xe0 | ((codepoint >> 12) & 0x0f));
 buf[1] = (zip_uint8_t)(0x80 | ((codepoint >> 6) & 0x3f));
 buf[2] = (zip_uint8_t)(0x80 | (codepoint & 0x3f));
 return 3;
    }
    buf[0] = (zip_uint8_t)(0xf0 | ((codepoint >> 18) & 0x07));
    buf[1] = (zip_uint8_t)(0x80 | ((codepoint >> 12) & 0x3f));
    buf[2] = (zip_uint8_t)(0x80 | ((codepoint >> 6) & 0x3f));
    buf[3] = (zip_uint8_t)(0x80 | (codepoint & 0x3f));
    return 4;
}
     ...
     zip_uint32_t *utf8_lenp, zip_error_t *error)
{
 ...
 if (utf8_lenp)
     *utf8_lenp = 0;
 return 
# 228 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c" 3 4
       ((void *)0)
# 228 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
           ;
    }
...
# 235 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c" 3 4
                                                 ((void *)0)
# 235 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
                                                     ) {
 zip_error_set(error, 14, 0);
 return 
# 237 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c" 3 4
       ((void *)0)
# 237 "/doner/libzip/libzip-e37a0ea/lib/zip_utf-8.c"
           ;
    }
