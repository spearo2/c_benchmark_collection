# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_flag.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_flag.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_flag.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_flag.c" 2
...
zip_set_archive_flag(zip_t *za, zip_flags_t flag, int value)
{
 ...
 && (za->ch_flags & 2u) == 0) {
 if (_zip_changed(za, 
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_flag.c" 3 4
                     ((void *)0)
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_set_archive_flag.c"
                         )) {
