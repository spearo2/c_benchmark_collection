# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 2
...
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip.h" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 2

struct context {
    zip_error_t error;

    
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
   _Bool 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
        end_of_input;
    
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
   _Bool 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
        end_of_stream;
    
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
   _Bool 
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
        can_store;
    
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
   _Bool 
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
        is_stored;
    
# 47 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
   _Bool 
# 47 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
        compress;
    zip_int32_t method;
...
static struct implementation implementations[] = {
    { 8, &zip_algorithm_deflate_compress, &zip_algorithm_deflate_decompress },
...
static zip_source_t *compression_source_new(zip_t *za, zip_source_t *src, zip_int32_t method, 
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                                                             _Bool 
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                                                                  compress, int compression_flags);
...
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                      _Bool 
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                           compress, int compression_flags, zip_compression_algorithm_t *algorithm);
static zip_int64_t compress_read(zip_source_t *, struct context *, void *, zip_uint64_t);

static zip_compression_algorithm_t *
get_algorithm(zip_int32_t method, 
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                 _Bool 
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                      compress) {
    size_t i;
    zip_uint16_t real_method = ((zip_uint16_t)(((method) == -1 || (method) == (-2)) ? 8 : (method)));
 ...
 if (implementations[i].method == real_method) {
  ...
  return implementations[i].decompress;
    ...
    return 
# 96 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
          ((void *)0)
# 96 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
              ;
}


# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
_Bool

# 100 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
zip_compression_method_supported(zip_int32_t method, 
# 100 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                    _Bool 
# 100 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                         compress) {
    if (method == 0) {
 return 
# 102 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       1
# 102 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }
    return get_algorithm(method, compress) != 
# 104 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                             ((void *)0)
# 104 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                 ;
}

zip_source_t *
zip_source_compress(zip_t *za, zip_source_t *src, zip_int32_t method, int compression_flags) {
    return compression_source_new(za, src, method, 
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                  1
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                      , compression_flags);
}
...
zip_source_decompress(zip_t *za, zip_source_t *src, zip_int32_t method) {
    return compression_source_new(za, src, method, 
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                  0
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                       , 0);
}


static zip_source_t *
compression_source_new(zip_t *za, zip_source_t *src, zip_int32_t method, 
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                                        _Bool 
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                                             compress, int compression_flags)
{
    struct context *ctx;
    zip_source_t *s2;
    zip_compression_algorithm_t *algorithm = 
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                            ((void *)0)
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                ;

    if (src == 
# 125 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
              ((void *)0)
# 125 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                  ) {
 zip_error_set(&za->error, 18, 0);
 return 
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       ((void *)0)
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }

    if ((algorithm = get_algorithm(method, compress)) == 
# 130 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                        ((void *)0)
# 130 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                            ) {
 zip_error_set(&za->error, 16, 0);
 return 
# 132 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       ((void *)0)
# 132 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }

    if ((ctx = context_new(method, compress, compression_flags, algorithm)) == 
# 135 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                                              ((void *)0)
# 135 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                                                  ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 137 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       ((void *)0)
# 137 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }

    if ((s2 = zip_source_layered(za, src, compress_callback, ctx)) == 
# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                                     ((void *)0)
# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                                         ) {
 context_free(ctx);
 return 
# 142 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       ((void *)0)
# 142 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }
...
context_new(zip_int32_t method, 
# 150 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                               _Bool 
# 150 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                    compress, int compression_flags, zip_compression_algorithm_t *algorithm) {
    struct context *ctx;

    if ((ctx = (struct context *)malloc(sizeof(*ctx))) == 
# 153 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                         ((void *)0)
# 153 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                             ) {
 return 
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       ((void *)0)
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }
    zip_error_init(&ctx->error);
    ctx->can_store = compress ? ((method) == -1 || (method) == (-2)) : 
# 157 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                           0
# 157 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                                ;
    ctx->algorithm = algorithm;
    ctx->method = method;
    ctx->compress = compress;

    if ((ctx->ud = ctx->algorithm->allocate(((zip_uint16_t)(((method) == -1 || (method) == (-2)) ? 8 : (method))), compression_flags, &ctx->error)) == 
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                                                                                      ((void *)0)
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                                                                                          ) {
 zip_error_fini(&ctx->error);
 free(ctx);
 return 
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       ((void *)0)
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
    }
...
context_free(struct context *ctx) {
    if (ctx == 
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
              ((void *)0)
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                  ) {
 return;
    }
...
# 189 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
   _Bool 
# 189 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
        end;
    zip_int64_t n;
    zip_uint64_t out_offset;
    zip_uint64_t out_len;

    if (zip_error_code_zip(&ctx->error) != 0) {
 return -1;
    }
...
# 204 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
         0
# 204 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
              ;
 ...
 switch (ret) {
     ...
     ctx->end_of_stream = 
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                         1
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                             ;
...
# 224 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       1
# 224 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
  break;
     }
            if (ctx->can_store && (zip_uint64_t)ctx->first_read <= out_offset) {
                ctx->is_stored = 
# 228 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                                1
# 228 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                                    ;
...
# 233 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
          1
# 233 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
              ;
     break;
...
# 242 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       1
# 242 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
  break;
     }
...
# 248 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
       1
# 248 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
           ;
  break;
     }
     else if (n == 0) {
  ctx->end_of_input = 
# 252 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                     1
# 252 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                         ;
  ...
  if (ctx->first_read >= 0) {
      ...
      ctx->can_store = 
# 261 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                      0
# 261 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                           ;
  }
  else {
      ctx->first_read = n;
...
# 276 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
          1
# 276 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
              ;
     break;
 }
    }
    ...
    if (out_offset > 0) {
 ctx->can_store = 
# 282 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                 0
# 282 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                      ;
 ctx->size += out_offset;
 return (zip_int64_t)out_offset;
    }

    return (zip_error_code_zip(&ctx->error) == 0) ? 0 : -1;
}
...
compress_callback(zip_source_t *src, void *ud, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
 ...
 ctx->size = 0;
 ctx->end_of_input = 
# 301 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                    0
# 301 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                         ;
 ctx->end_of_stream = 
# 302 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                     0
# 302 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                          ;
 ctx->is_stored = 
# 303 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c" 3 4
                 0
# 303 "/doner/libzip/libzip-e37a0ea/lib/zip_source_compress.c"
                      ;
 ctx->first_read = -1;
 ...
 return 0;
    ...
    case ZIP_SOURCE_STAT:
     ...
     if (ctx->compress) {
  st->comp_method = ctx->is_stored ? 0 : ((zip_uint16_t)(((ctx->method) == -1 || (ctx->method) == (-2)) ? 8 : (ctx->method)));
 ...
 return 0;
    ...
    case ZIP_SOURCE_SUPPORTS:
        return ((((zip_uint64_t)1)<<(ZIP_SOURCE_OPEN)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_READ)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_CLOSE)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_STAT)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_ERROR)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_FREE))) | zip_source_make_command_bitmap(ZIP_SOURCE_GET_COMPRESSION_FLAGS, -1);
