# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 2


# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
...
zip_file_set_encryption(zip_t *za, zip_uint64_t idx, zip_uint16_t method, const char *password)
{
 ...
 return -1;
    ...
    if (method != 0 && _zip_get_encryption_implementation(method, 1) == 
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                                                                                ((void *)0)
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                                                                                    ) {
 ...
 return -1;
    ...
    old_method = (e->orig == 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                            ((void *)0) 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                 ? 0 : e->orig->encryption_method);

    if (method == old_method && password == 
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                           ((void *)0)
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                               ) {
 if (e->changes) {
     if (e->changes->changed & 0x0080u) {
  explicit_bzero((e->changes->password), (strlen(e->changes->password)));
  free(e->changes->password);
  e->changes->password = (e->orig == 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                    ((void *)0) 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                         ? 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                           ((void *)0) 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
     ...
     e->changes->changed &= ~(0x0040u|0x0080u);
     if (e->changes->changed == 0) {
  _zip_dirent_free(e->changes);
  e->changes = 
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
              ((void *)0)
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                  ;
     }
 }
    }
 ...
 char *our_password = 
# 80 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                     ((void *)0)
# 80 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                         ;

 if (password) {
     if ((our_password = strdup(password)) == 
# 83 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                             ((void *)0)
# 83 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                                 ) {
  ...
  return -1;
        ...
        if (e->changes == 
# 89 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                         ((void *)0)
# 89 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                                          ((void *)0)
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                                              ) {
  if (our_password) {
      explicit_bzero((our_password), (strlen(our_password)));
  }
  free(our_password);
                zip_error_set(&za->error, 14, 0);
                return -1;
        ...
        e->changes->changed |= 0x0040u;
 if (password) {
     e->changes->password = our_password;
     e->changes->changed |= 0x0080u;
 }
 else {
     if (e->changes->changed & 0x0080u) {
  explicit_bzero((e->changes->password), (strlen(e->changes->password)));
  free(e->changes->password);
  e->changes->password = e->orig ? e->orig->password : 
# 110 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c" 3 4
                                                      ((void *)0)
# 110 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_encryption.c"
                                                          ;
  e->changes->changed &= ~0x0080u;
     }
 }
