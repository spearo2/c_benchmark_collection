# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 2
...
_zip_ef_clone(const zip_extra_field_t *ef, zip_error_t *error)
{
    ...
    head = prev = 
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                 ((void *)0)
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                     ;

    while (ef) {
        if ((def=_zip_ef_new(ef->id, ef->size, ef->data, ef->flags)) == 
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                                       ((void *)0)
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                                           ) {
            zip_error_set(error, 14, 0);
            _zip_ef_free(head);
            return 
# 51 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                  ((void *)0)
# 51 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                      ;
        }

        if (head == 
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                   ((void *)0)
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                       )
            head = def;
        if (prev)
            prev->next = def;
...
_zip_ef_delete_by_id(zip_extra_field_t *ef, zip_uint16_t id, zip_uint16_t id_idx, zip_flags_t flags)
{
    ...
    head = ef;
    prev = 
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
          ((void *)0)
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
              ;
    for (; ef; ef=(prev ? prev->next : head)) {
 if ((ef->flags & flags & (256u|512u)) && ((ef->id == id) || (id == 
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                                   (65535)
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                                                      ))) {
     if (id_idx == 
# 78 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                  (65535) 
# 78 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                      || i == id_idx) {
  ef->flags &= ~(flags & (256u|512u));
  if ((ef->flags & (256u|512u)) == 0) {
      if (prev)
   prev->next = ef->next;
      else
   head = ef->next;
      ef->next = 
# 85 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                ((void *)0)
# 85 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                    ;
      _zip_ef_free(ef);

      if (id_idx == 
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                   (65535)
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                      )
   continue;
  }
     }
...
_zip_ef_get_by_id(const zip_extra_field_t *ef, zip_uint16_t *lenp, zip_uint16_t id, zip_uint16_t id_idx, zip_flags_t flags, zip_error_t *error)
{
    ...
    i = 0;
    for (; ef; ef=ef->next) {
 if (ef->id == id && (ef->flags & flags & (256u|512u))) {
     if (i < id_idx) {
  i++;
  continue;
     }
  ...
  *lenp = ef->size;
  ...
  return empty;
    ...
    return 
# 144 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
          ((void *)0)
# 144 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
              ;
}
...
_zip_ef_merge(zip_extra_field_t *to, zip_extra_field_t *from)
{
    ...
    if (to == 
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
             ((void *)0)
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                 )
 return from;
 ...
 from->next = 
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
             ((void *)0)
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                 ;
 if (duplicate)
     _zip_ef_free(from);
 else
...
_zip_ef_new(zip_uint16_t id, zip_uint16_t size, const zip_uint8_t *data, zip_flags_t flags)
{
    ...
    if ((ef=(zip_extra_field_t *)malloc(sizeof(*ef))) == 
# 188 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                        ((void *)0)
# 188 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                            )
 return 
# 189 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
       ((void *)0)
# 189 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
           ;

    ef->next = 
# 191 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
              ((void *)0)
# 191 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                  ;
    ef->flags = flags;
    ef->id = id;
    ef->size = size;
    if (size > 0) {
 if ((ef->data=(zip_uint8_t *)_zip_memdup(data, size, 
# 196 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                     ((void *)0)
# 196 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                         )) == 
# 196 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                               ((void *)0)
# 196 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
     ...
     free(ef);
     return 
# 198 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
           ((void *)0)
# 198 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
               ;
 }
    }
    else
 ef->data = 
# 202 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
           ((void *)0)
# 202 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
               ;
...
# 208 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
_Bool

# 209 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
_zip_ef_parse(const zip_uint8_t *data, zip_uint16_t len, zip_flags_t flags, zip_extra_field_t **ef_head_p, zip_error_t *error)
{
    ...
    if ((buffer = _zip_buffer_new((zip_uint8_t *)data, len)) == 
# 214 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                               ((void *)0)
# 214 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                                   ) {
        zip_error_set(error, 14, 0);
        return 
# 216 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
              0
# 216 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                   ;
    }

    ef_head = ef = 
# 219 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                  ((void *)0)
# 219 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                      ;
 ...
 flen = _zip_buffer_get_16(buffer);
        ...
        if (ef_data == 
# 229 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                      ((void *)0)
# 229 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                          ) {
     zip_error_set(error, 21, 0);
            _zip_buffer_free(buffer);
     _zip_ef_free(ef_head);
     return 
# 233 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
           0
# 233 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                ;
        }

 if ((ef2=_zip_ef_new(fid, flen, ef_data, flags)) == 
# 236 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                    ((void *)0)
# 236 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                        ) {
     zip_error_set(error, 14, 0);
            _zip_buffer_free(buffer);
     _zip_ef_free(ef_head);
     return 
# 240 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
           0
# 240 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                ;
 }
 ...
 if (glen >= 4 || garbage == 
# 257 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                            ((void *)0) 
# 257 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                 || memcmp(garbage, "\0\0\0", glen) != 0) {
     zip_error_set(error, 21, 0);
     _zip_buffer_free(buffer);
     _zip_ef_free(ef_head);
     return 
# 261 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
           0
# 261 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                ;
 }
    }
 ...
 *ef_head_p = ef_head;
    ...
    return 
# 274 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
          1
# 274 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
              ;
}
...
_zip_ef_remove_internal(zip_extra_field_t *ef)
{
    ...
    ef_head = ef;
    prev = 
# 285 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
          ((void *)0)
# 285 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
              ;

    while (ef) {
        if (((ef->id) == 0x6375 || (ef->id) == 0x7075 || (ef->id) == 0x9901 || (ef->id) == 0x0001)) {
            next = ef->next;
            if (ef_head == ef)
                ef_head = next;
            ef->next = 
# 292 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                      ((void *)0)
# 292 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                          ;
            _zip_ef_free(ef);
            if (prev)
                prev->next = next;
...
_zip_ef_write(zip_t *za, const zip_extra_field_t *ef, zip_flags_t flags)
{
    ...
    if (buffer == 
# 329 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                 ((void *)0)
# 329 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                     ) {
 return -1;
    }
...
_zip_read_local_ef(zip_t *za, zip_uint64_t idx)
{
 ...
 return -1;
    ...
    if (e->orig == 
# 376 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                  ((void *)0) 
# 376 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                       || e->orig->local_extra_fields_read)
 return 0;

    if (e->orig->offset + 26 > 
# 379 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                              (9223372036854775807L)
# 379 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                           ) {
 zip_error_set(&za->error, 4, 
# 380 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                       27
# 380 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                            );
 return -1;
    }

    if (zip_source_seek(za->src, (zip_int64_t)(e->orig->offset + 26), 
# 384 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                                     0
# 384 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                                             ) < 0) {
 _zip_error_set_from_source(&za->error, za->src);
 return -1;
    }

    if ((buffer = _zip_buffer_new_from_source(za->src, sizeof(b), b, &za->error)) == 
# 389 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                                                                    ((void *)0)
# 389 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                                                        ) {
        return -1;
    }
 ...
 if (zip_source_seek(za->src, fname_len, 
# 408 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                        1
# 408 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                ) < 0) {
     zip_error_set(&za->error, 4, 
# 409 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                                           (*__errno_location ())
# 409 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                                                );
     return -1;
 }

 ef_raw = _zip_read_data(
# 413 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
                        ((void *)0)
# 413 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                            , za->src, ef_len, 0, &za->error);

 if (ef_raw == 
# 415 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c" 3 4
              ((void *)0)
# 415 "/doner/libzip/libzip-e37a0ea/lib/zip_extra_field.c"
                  )
     return -1;

 if (!_zip_ef_parse(ef_raw, ef_len, 256u, &ef, &za->error)) {
     free(ef_raw);
     return -1;
 }
 free(ef_raw);
