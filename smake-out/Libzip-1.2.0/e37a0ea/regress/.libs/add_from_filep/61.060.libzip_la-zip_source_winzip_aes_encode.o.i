# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 2
...
struct winzip_aes {
    ...
    zip_uint8_t data[(16+2)];
    zip_buffer_t *buffer;

    fcrypt_ctx fcrypt_ctx;
    
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
   _Bool 
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
        eof;
    zip_error_t error;
};
...
zip_source_winzip_aes_encode(zip_t *za, zip_source_t *src, zip_uint16_t encryption_method, int flags, const char *password)
{
 ...
 break;
    ...
    if (password == 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                   ((void *)0) 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                        || src == 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                  ((void *)0) 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
 ...
 return 
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
       ((void *)0)
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
           ;
    }

    if (strlen(password) > 
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                          (0x7fffffff * 2U + 1U)
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                  ) {
        zip_error_set(&za->error, 18, 0);
        return 
# 93 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
              ((void *)0)
# 93 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                  ;
    }

    if ((ctx = winzip_aes_new(mode, encryption_method, password)) == 
# 96 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                                    ((void *)0)
# 96 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                                        ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 98 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
       ((void *)0)
# 98 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
           ;
    }

    if ((s2 = zip_source_layered(za, src, winzip_aes_encrypt, ctx)) == 
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                                      ((void *)0)
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                                          ) {
 winzip_aes_free(ctx);
 return 
# 103 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
       ((void *)0)
# 103 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
           ;
    }
...
encrypt_header(zip_source_t *src, struct winzip_aes *ctx)
{
 ...
 return -1;
    ...
    if ((ctx->buffer = _zip_buffer_new(ctx->data, salt_length[ctx->mode] + 2)) == 
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                                                              ((void *)0)
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                                                                  ) {
 zip_error_set(&ctx->error, 14, 0);
 return -1;
    }
...
winzip_aes_encrypt(zip_source_t *src, void *ud, void *data, zip_uint64_t length, zip_source_cmd_t cmd)
{
 ...
 ctx->eof = 
# 143 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
           0
# 143 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                ;
 ...
 if (ctx->buffer) {
  ...
  ctx->buffer = 
# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
               ((void *)0)
# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                   ;
     }
 }
 ...
 n = (zip_uint64_t)ret;
 for (offset = 0; offset < n; offset += ((n - offset) < (
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                       (0x7fffffff * 2U + 1U)
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                       ) ? (n - offset) : (
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                       (0x7fffffff * 2U + 1U)
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                       ))) {
     _zip_fcrypt_encrypt((zip_uint8_t *)data + offset, (unsigned int)((n - offset) < (
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                                    (0x7fffffff * 2U + 1U)
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                                    ) ? (n - offset) : (
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                                    (0x7fffffff * 2U + 1U)
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
 ...
 if (n < length) {
     ctx->eof = 
# 179 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
               1
# 179 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                   ;
     _zip_fcrypt_end(ctx->data, &ctx->fcrypt_ctx);
     if ((ctx->buffer = _zip_buffer_new(ctx->data, 10)) == 
# 181 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                                   ((void *)0)
# 181 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                                       ) {
  zip_error_set(&ctx->error, 14, 0);
...
{
    if (ctx == 
# 227 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
              ((void *)0)
# 227 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                  ) {
 return;
    }
...
# 244 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                                            ((void *)0)
# 244 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                                ) {
 return 
# 245 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
       ((void *)0)
# 245 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
           ;
    }

    if ((ctx->password = strdup(password)) == 
# 248 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                                             ((void *)0)
# 248 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                                                 ) {
 free(ctx);
 return 
# 250 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
       ((void *)0)
# 250 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
           ;
    }
    ...
    ctx->buffer = 
# 255 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
                 ((void *)0)
# 255 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                     ;

    zip_error_init(&ctx->error);

    ctx->eof = 
# 259 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c" 3 4
              0
# 259 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_encode.c"
                   ;
    return ctx;
}
