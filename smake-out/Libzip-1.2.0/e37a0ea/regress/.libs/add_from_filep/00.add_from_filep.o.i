# 1 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
# 35 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 2
...
main(int argc, char *argv[])
{
    ...
    if (argc != 3) {
 fprintf(
# 58 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
        stderr
# 58 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
...
# 65 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
                                                   ((void *)0)
# 65 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
                                                       ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 68 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
        stderr
# 68 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
 ...
 return 1;
    ...
    if ((fp=fopen(file, "r")) == 
# 73 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
                                ((void *)0)
# 73 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
                                    ) {
 fprintf(
# 74 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
        stderr
# 74 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
              , "%s: can't open input file '%s': %s\n", prg,
  file, strerror(
# 75 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
                (*__errno_location ())
# 75 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
                     ));
 return 1;
    }

    if ((zs=zip_source_filep(za, fp, 0, -1)) == 
# 79 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
                                               ((void *)0)
# 79 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
                                                   ) {
 fprintf(
# 80 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
        stderr
# 80 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
...
# 85 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
                                    ((void *)0)
# 85 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
                                        )
 name = file;
 ...
 zip_source_free(zs);
 fprintf(
# 90 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
        stderr
# 90 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
 ...
 return 1;
    ...
    if (zip_close(za) == -1) {
 fprintf(
# 96 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c" 3 4
        stderr
# 96 "/doner/libzip/libzip-e37a0ea/regress/add_from_filep.c"
