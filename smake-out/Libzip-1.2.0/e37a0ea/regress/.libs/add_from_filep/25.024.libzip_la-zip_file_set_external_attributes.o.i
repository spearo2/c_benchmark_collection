# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c" 2
...
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c" 3 4
                                   ((void *)0)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
                                       ) == 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c" 3 4
                                            ((void *)0)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
 ...
 return -1;
    ...
    unchanged_opsys = (e->orig ? (zip_uint8_t)(e->orig->version_madeby>>8) : (zip_uint8_t)0x03u);
    unchanged_attributes = e->orig ? e->orig->ext_attrib : (0100666u<<16);

    changed = (opsys != unchanged_opsys || attributes != unchanged_attributes);

    if (changed) {
        if (e->changes == 
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c" 3 4
                         ((void *)0)
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c" 3 4
                                                          ((void *)0)
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
                                                              ) {
 ...
 if (e->changes->changed == 0) {
     ...
     e->changes = 
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c" 3 4
                 ((void *)0)
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_file_set_external_attributes.c"
                     ;
 }
 else {
