# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 2
...
{
    if (za == 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
             ((void *)0)
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                 ) {
        return 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
              ((void *)0)
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                  ;
    }
...
zip_source_function_create(zip_source_callback zcb, void *ud, zip_error_t *error)
{
    ...
    if ((zs=_zip_source_new(error)) == 
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
                                      ((void *)0)
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                                          )
 return 
# 57 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
       ((void *)0)
# 57 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
           ;
    ...
    zs->supports = zcb(ud, 
# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
                          ((void *)0)
# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                              , 0, ZIP_SOURCE_SUPPORTS);
    if (zs->supports < 0) {
        zs->supports = ((((zip_uint64_t)1)<<(ZIP_SOURCE_OPEN)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_READ)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_CLOSE)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_STAT)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_ERROR)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_FREE)));
    }
...
_zip_source_new(zip_error_t *error)
{
    ...
    if ((src=(zip_source_t *)malloc(sizeof(*src))) == 
# 83 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
                                                     ((void *)0)
# 83 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                                                         ) {
        zip_error_set(error, 14, 0);
 return 
# 85 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
       ((void *)0)
# 85 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
           ;
    }

    src->src = 
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
              ((void *)0)
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                  ;
    src->cb.f = 
# 89 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
               ((void *)0)
# 89 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                   ;
    src->ud = 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
             ((void *)0)
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                 ;
    src->open_count = 0;
    src->write_state = ZIP_SOURCE_WRITE_CLOSED;
    src->source_closed = 
# 93 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
                        0
# 93 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                             ;
    src->source_archive = 
# 94 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
                         ((void *)0)
# 94 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                             ;
    src->refcount = 1;
    zip_error_init(&src->error);
    src->eof = 
# 97 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c" 3 4
              0
# 97 "/doner/libzip/libzip-e37a0ea/lib/zip_source_function.c"
                   ;
