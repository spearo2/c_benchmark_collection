# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c" 2
...
zip_source_open(zip_source_t *src)
{
 ...
 return -1;
    ...
    if (((src)->open_count > 0)) {
 if ((zip_source_supports(src) & (((zip_uint64_t)1)<<(ZIP_SOURCE_SEEK))) == 0) {
 ...
 if (((src)->src != 
# 55 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c" 3 4
    ((void *)0)
# 55 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
    )) {
 ...
 if (_zip_source_call(src, 
# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c" 3 4
                          ((void *)0)
# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
                              , 0, ZIP_SOURCE_OPEN) < 0) {
     if (((src)->src != 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c" 3 4
        ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
        )) {
  zip_source_close(src->src);
    ...
    src->eof = 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c" 3 4
              0
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_source_open.c"
                   ;
