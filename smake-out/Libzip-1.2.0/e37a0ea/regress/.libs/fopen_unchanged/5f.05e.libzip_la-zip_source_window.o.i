# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 2
...
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
   _Bool 
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
        needs_seek;
};
...
{
    return _zip_source_window_new(src, start, len, 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                  ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                                                      , 0, 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                           ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
...
_zip_source_window_new(zip_source_t *src, zip_uint64_t start, zip_uint64_t length, zip_stat_t *st, zip_int8_t compression_flags, zip_t *source_archive, zip_uint64_t source_index, zip_error_t *error)
{
    ...
    if (src == 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
              ((void *)0) 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                   || start + length < start || (source_archive == 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                                   ((void *)0) 
# 72 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                                                                        && source_index != 0)) {
        ...
        return 
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
              ((void *)0)
# 74 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                  ;
    }

    if ((ctx=(struct window *)malloc(sizeof(*ctx))) == 
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                      ((void *)0)
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                                                          ) {
        zip_error_set(error, 14, 0);
        return 
# 79 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
              ((void *)0)
# 79 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                  ;
    }
    ...
    ctx->supports = (zip_source_supports(src) & (((((zip_uint64_t)1)<<(ZIP_SOURCE_OPEN)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_READ)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_CLOSE)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_STAT)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_ERROR)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_FREE))) | (((zip_uint64_t)1)<<(ZIP_SOURCE_SEEK)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_TELL)) | (((zip_uint64_t)1)<<(ZIP_SOURCE_SUPPORTS)))) | (zip_source_make_command_bitmap(ZIP_SOURCE_GET_COMPRESSION_FLAGS, ZIP_SOURCE_SUPPORTS, ZIP_SOURCE_TELL, -1));
    ctx->needs_seek = (ctx->supports & (((zip_uint64_t)1)<<(ZIP_SOURCE_SEEK))) ? 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                                                          1 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                                                                                               : 
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                                                                 0
# 90 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
    ...
    if (st) {
        if (_zip_stat_merge(&ctx->stat, st, error) < 0) {
            free(ctx);
            return 
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                  ((void *)0)
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                      ;
        }
    }
...
_zip_source_invalidate(zip_source_t *src)
{
    ...
    if (zip_error_code_zip(&src->error) == 0) {
...
window_read(zip_source_t *src, void *_ctx, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
  ...
  ctx->end += offset;
  ctx->source_archive = 
# 158 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                       ((void *)0)
# 158 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                           ;
     }
...
# 186 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                                                                  0
# 186 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                                                                          ) < 0) {
                    _zip_error_set_from_source(&ctx->error, src);
                    return -1;
                }
...
_zip_register_source(zip_t *za, zip_source_t *src)
{
    ...
    if (za->nopen_source+1 >= za->nopen_source_alloc) {
        ...
        if (open_source == 
# 271 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c" 3 4
                          ((void *)0)
# 271 "/doner/libzip/libzip-e37a0ea/lib/zip_source_window.c"
                              ) {
