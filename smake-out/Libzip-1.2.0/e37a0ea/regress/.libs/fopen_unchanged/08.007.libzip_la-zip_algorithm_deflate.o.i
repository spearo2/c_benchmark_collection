# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 2



# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
struct ctx {
    zip_error_t *error;
    
# 42 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
   _Bool 
# 42 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
        compress;
    int compression_flags;
    
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
   _Bool 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
        end_of_input;
    z_stream zstr;
};
...
static void *
allocate(
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
        _Bool 
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
             compress, int compression_flags, zip_error_t *error) {
    struct ctx *ctx;

    if ((ctx = (struct ctx *)malloc(sizeof(*ctx))) == 
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                                                     ((void *)0)
# 53 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                                                         ) {
 return 
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
       ((void *)0)
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
           ;
    }
...
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                         9
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                                           ;
    }
    ctx->end_of_input = 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                       0
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                            ;

    ctx->zstr.zalloc = 
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                      0
# 65 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                            ;
    ctx->zstr.zfree = 
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                     0
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                           ;
    ctx->zstr.opaque = 
# 67 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                      ((void *)0)
# 67 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                          ;
...
compress_allocate(zip_uint16_t method, int compression_flags, zip_error_t *error) {
    return allocate(
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                   1
# 75 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                       , compression_flags, error);
}
...
decompress_allocate(zip_uint16_t method, int compression_flags, zip_error_t *error) {
    return allocate(
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                   0
# 81 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                        , compression_flags, error);
}
...
static 
# 111 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      _Bool

# 112 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
start(void *ud) {
    struct ctx *ctx = (struct ctx *)ud;
    int ret;
    ...
    ctx->zstr.avail_in = 0;
    ctx->zstr.next_in = 
# 117 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                       ((void *)0)
# 117 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                           ;
    ctx->zstr.avail_out = 0;
    ctx->zstr.next_out = 
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                        ((void *)0)
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                            ;

    if (ctx->compress) {

 ret = 
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      deflateInit2_((
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
      &ctx->zstr
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      ),(
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
...
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
      -
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      15),(9), (0), "1.2.11", (int)sizeof(z_stream))
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                                                                                                                 ;
    }
    else {
 ret = 
# 126 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      inflateInit2_((
# 126 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
      &ctx->zstr
# 126 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      ), (
# 126 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
...
# 126 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
    ...
    if (ret != 
# 129 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
              0
# 129 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                  ) {
 zip_error_set(ctx->error, 13, ret);
 return 
# 131 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
       0
# 131 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
            ;
    }


    return 
# 135 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
          1
# 135 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
              ;
}


static 
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      _Bool

# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
end(void *ud) {
    struct ctx *ctx = (struct ctx *)ud;
    int err;
 ...
 err = inflateEnd(&ctx->zstr);
    ...
    if (err != 
# 151 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
              0
# 151 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                  ) {
 zip_error_set(ctx->error, 13, err);
 return 
# 153 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
       0
# 153 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
            ;
    }

    return 
# 156 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
          1
# 156 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
              ;
}


static 
# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
      _Bool 
# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
           input(void *ud, zip_uint8_t *data, zip_uint64_t length) {
    struct ctx *ctx = (struct ctx *)ud;

    if (length > 
# 163 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                (0x7fffffff * 2U + 1U) 
# 163 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                         || ctx->zstr.avail_in > 0) {
 zip_error_set(ctx->error, 18, 0);
 return 
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
       0
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
            ;
    }
    ...
    return 
# 171 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
          1
# 171 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
              ;
}
...
static void end_of_input(void *ud) {
    ...
    ctx->end_of_input = 
# 178 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                       1
# 178 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                           ;
}
...
process(void *ud, zip_uint8_t *data, zip_uint64_t *length) {
    ...
    ctx->zstr.avail_out = (uInt)((
# 188 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                               (0x7fffffff * 2U + 1U)
# 188 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                               ) < (*length) ? (
# 188 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                               (0x7fffffff * 2U + 1U)
# 188 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
    ...
    if (ctx->compress) {
 ret = deflate(&ctx->zstr, ctx->end_of_input ? 
# 192 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                                              4 
# 192 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                                                       : 0);
    }
    else {
 ret = inflate(&ctx->zstr, 
# 195 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
                          2
# 195 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                                      );
    }
    ...
    *length = *length - ctx->zstr.avail_out;
    ...
    switch (ret) {
    case 
# 201 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
        0
# 201 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
            :
 return ZIP_COMPRESSION_OK;

    case 
# 204 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
        1
# 204 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                    :
 return ZIP_COMPRESSION_END;

    case 
# 207 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c" 3 4
        (-5)
# 207 "/doner/libzip/libzip-e37a0ea/lib/zip_algorithm_deflate.c"
                   :
