# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c" 2
...
zip_source_seek_write(zip_source_t *src, zip_int64_t offset, int whence)
{
    ...
    if (!((src)->write_state == ZIP_SOURCE_WRITE_OPEN) || (whence != 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c" 3 4
                                                      0 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c"
                                                               && whence != 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c" 3 4
                                                                            1 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek_write.c"
