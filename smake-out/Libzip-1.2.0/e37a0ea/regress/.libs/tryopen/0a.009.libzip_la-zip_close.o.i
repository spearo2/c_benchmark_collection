# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 2
...
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 2
...
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
...
zip_close(zip_t *za)
{
    ...
    if (za == 
# 68 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
             ((void *)0)
# 68 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                 )
 return -1;
 ...
 return 0;
    ...
    if ((filelist=(zip_filelist_t *)malloc(sizeof(filelist[0])*(size_t)survivors)) == 
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                                     ((void *)0)
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                                         )
 return -1;
 ...
 new_data = (((entry)->source != 
# 136 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
            ((void *)0)
# 136 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
            ) || ((entry)->changes && ((entry)->changes->changed & (0x0001u))) || ((entry)->changes && ((entry)->changes->changed & (0x0040u))));


 if (entry->changes == 
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                      ((void *)0)
# 139 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                          ) {
     if ((entry->changes=_zip_dirent_clone(entry->orig)) == 
# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                           ((void *)0)
# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                               ) {
 ...
 if (new_data) {
     ...
     zs = 
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
         ((void *)0)
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
             ;
     if (!((entry)->source != 
# 163 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
         ((void *)0)
# 163 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
         )) {
  if ((zs=_zip_source_zip_new(za, za, i, 8u, 0, 0, 
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                ((void *)0)
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                    )) == 
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                          ((void *)0)
# 164 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
  ...
  zip_source_free(zs);
     ...
     de->bitflags &= (zip_uint16_t)~0x0008u;
     if (_zip_dirent_write(za, de, 256u) < 0) {
  error = 1;
  break;
     }
  ...
  break;
     ...
     if (zip_source_seek(za->src, (zip_int64_t)offset, 
# 193 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                      0
# 193 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                              ) < 0) {
  _zip_error_set_from_source(&za->error, za->src);
  error = 1;
  break;
...
# 242 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
   _Bool 
# 242 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
        needs_recompress, needs_decompress, needs_crc, needs_compress, needs_reencrypt, needs_decrypt, needs_encrypt;
 ...
 return -1;
    ...
    if ((st.valid & 0x0040u) == 0) {
 st.valid |= 0x0040u;
 st.comp_method = 0;
    }

    if (((de->comp_method) == -1 || (de->comp_method) == (-2)) && st.comp_method != 0)
 de->comp_method = st.comp_method;
    else if (de->comp_method == 0 && (st.valid & 0x0004u)) {
 st.valid |= 0x0008u;
 ...
 if ((st.valid & 0x0008u) == 0) {
     zip_uint64_t max_size;

     switch (((zip_uint16_t)(((de->comp_method) == -1 || (de->comp_method) == (-2)) ? 8 : (de->comp_method)))) {
     case 12:
 ...
 return -1;
    ...
    needs_recompress = st.comp_method != ((zip_uint16_t)(((de->comp_method) == -1 || (de->comp_method) == (-2)) ? 8 : (de->comp_method)));
    needs_decompress = needs_recompress && (st.comp_method != 0);
    needs_crc = (st.comp_method == 0) || needs_decompress;
    needs_compress = needs_recompress && (de->comp_method != 0);

    needs_reencrypt = needs_recompress || (de->changed & 0x0080u) || (de->encryption_method != st.encryption_method);
    needs_decrypt = needs_reencrypt && (st.encryption_method != 0);
    needs_encrypt = needs_reencrypt && (de->encryption_method != 0);
 ...
 if ((impl = _zip_get_encryption_implementation(st.encryption_method, 0)) == 
# 338 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                                           ((void *)0)
# 338 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                                               ) {
     zip_error_set(&za->error, 24, 0);
     zip_source_free(src_final);
     return -1;
 }
 if ((src_tmp = impl(za, src_final, st.encryption_method, 0, za->default_password)) == 
# 343 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                                                     ((void *)0)
# 343 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                                                         ) {
 ...
 src_final = src_tmp;
    ...
    if (needs_decompress) {
 if ((src_tmp = zip_source_decompress(za, src_final, st.comp_method)) == 
# 354 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                        ((void *)0)
# 354 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                            ) {
     zip_source_free(src_final);
     return -1;
 }
 ...
 src_final = src_tmp;
    ...
    if (needs_crc) {
 if ((src_tmp = zip_source_crc(za, src_final, 0)) == 
# 364 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                    ((void *)0)
# 364 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                        ) {
     zip_source_free(src_final);
     return -1;
 }
 ...
 src_final = src_tmp;
    ...
    if (needs_compress) {
 if ((src_tmp = zip_source_compress(za, src_final, de->comp_method, de->compression_level)) == 
# 374 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                                              ((void *)0)
# 374 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                                                  ) {
     zip_source_free(src_final);
     return -1;
 }
 ...
 zip_encryption_implementation impl;
 const char *password = 
# 386 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                       ((void *)0)
# 386 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                           ;
 ...
 if ((impl = _zip_get_encryption_implementation(de->encryption_method, 1)) == 
# 394 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                                            ((void *)0)
# 394 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                                                ) {
     zip_error_set(&za->error, 24, 0);
     zip_source_free(src_final);
     return -1;
 }
 if ((src_tmp = impl(za, src_final, de->encryption_method, 1, password)) == 
# 399 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                                                          ((void *)0)
# 399 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                                                              ) {
 ...
 _zip_error_set_from_source(&za->error, za->src);
    ...
    if (zip_source_seek_write(za->src, offstart, 
# 438 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                                0
# 438 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                        ) < 0) {
 _zip_error_set_from_source(&za->error, za->src);
 return -1;
    }

    if ((st.valid & (0x0040u|0x0020u|0x0004u)) != (0x0040u|0x0020u|0x0004u)) {
 zip_error_set(&za->error, 20, 0);
 return -1;
    }

    if ((de->changed & 0x0020u) == 0) {
        if (st.valid & 0x0010u)
    ...
    _zip_dirent_set_version_needed(de, (flags & 1024) != 0);
 ...
 return -1;
    ...
    if (zip_source_seek_write(za->src, offend, 
# 470 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c" 3 4
                                              0
# 470 "/doner/libzip/libzip-e37a0ea/lib/zip_close.c"
                                                      ) < 0) {
 _zip_error_set_from_source(&za->error, za->src);
 return -1;
    }
