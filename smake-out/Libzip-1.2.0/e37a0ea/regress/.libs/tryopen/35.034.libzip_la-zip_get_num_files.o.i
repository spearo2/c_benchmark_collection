# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c"
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c"
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c" 2
...
{
    if (za == 
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c" 3 4
             ((void *)0)
# 43 "/doner/libzip/libzip-e37a0ea/lib/zip_get_num_files.c"
                 )
 return -1;

    if (za->nentry > 0x7fffffff) {
