# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c" 2
...
_zip_name_locate(zip_t *za, const char *fname, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (za == 
# 57 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c" 3 4
             ((void *)0)
# 57 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c"
                 )
 return -1;

    if (fname == 
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c" 3 4
                ((void *)0)
# 60 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c"
                    ) {
 zip_error_set(error, 18, 0);
 return -1;
    }

    if (flags & (1u|2u|4096u)) {

 cmp = (flags & 1u) ? strcasecmp : strcmp;
 ...
 for (i=0; i<za->nentry; i++) {
     ...
     if (fn == 
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c" 3 4
              ((void *)0)
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_name_locate.c"
                  )
  continue;
