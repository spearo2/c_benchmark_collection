# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 2
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 2
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
...
{
    while (entry != 
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                   ((void *)0)
# 70 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                       ) {
...
{
    zip_uint64_t value = 5381;

    if (name == 
# 84 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
               ((void *)0)
# 84 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                   ) {
 return 0;
    }

    while (*name != 0) {
 value = (zip_uint64_t)(((value * 33) + (zip_uint8_t)*name) % 0x100000000ul);
 name++;
    }
...
static 
# 98 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
      _Bool

# 99 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
hash_resize(zip_hash_t *hash, zip_uint32_t new_size, zip_error_t *error)
{
 ...
 return 
# 104 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
       1
# 104 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
           ;
    }

    if ((new_table = (zip_hash_entry_t**)calloc(new_size, sizeof(zip_hash_entry_t *))) == 
# 107 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                                                                                         ((void *)0)
# 107 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                                                                                             ) {
 zip_error_set(error, 14, 0);
 return 
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
       0
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
            ;
    }
 ...
 for (i = 0; i < hash->table_size; i++) {
  ...
  entry = next;
    ...
    return 
# 134 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
          1
# 134 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
              ;
}
...
size_for_capacity(zip_uint64_t capacity) {
    double needed_size = capacity / .75;
    zip_uint32_t v;

    if (needed_size > 
# 143 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                     (4294967295U)
# 143 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                                   ) {
 v = 
# 144 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
    (4294967295U)
# 144 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                  ;
    }
    else {
...
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                                                            ((void *)0)
# 174 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                                                                ) {
        zip_error_set(error, 14, 0);
        return 
# 176 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
              ((void *)0)
# 176 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                  ;
    }
    ...
    hash->nentries = 0;
    hash->table = 
# 181 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                 ((void *)0)
# 181 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                     ;
...
_zip_hash_free(zip_hash_t *hash)
{
    ...
    if (hash == 
# 192 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
               ((void *)0)
# 192 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                   ) {
 return;
    }

    if (hash->table != 
# 196 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                      ((void *)0)
# 196 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                          ) {
 for (i=0; i<hash->table_size; i++) {
     if (hash->table[i] != 
# 198 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                          ((void *)0)
# 198 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                              ) {
...
# 209 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
_Bool

# 210 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
_zip_hash_add(zip_hash_t *hash, const zip_uint8_t *name, zip_uint64_t index, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (hash == 
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
               ((void *)0) 
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                    || name == 
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                               ((void *)0) 
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
...
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
 ...
 return 
# 217 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
       0
# 217 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
            ;
    }

    if (hash->table_size == 0) {
 if (!hash_resize(hash, 256, error)) {
     return 
# 222 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
           0
# 222 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                ;
 }
    }
    ...
    for (entry = hash->table[table_index]; entry != 
# 229 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                                                   ((void *)0)
# 229 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                                                       ; entry = entry->next) {
        if (entry->hash_value == hash_value && strcmp((const char *)name, (const char *)entry->name) == 0) {
            if (((flags & 8u) && entry->orig_index != -1) || entry->current_index != -1) {
                zip_error_set(error, 10, 0);
                return 
# 233 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                      0
# 233 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                           ;
            }
            else {
                break;
    ...
    if (entry == 
# 241 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                ((void *)0)
# 241 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                    ) {
        if ((entry = (zip_hash_entry_t *)malloc(sizeof(zip_hash_entry_t))) == 
# 242 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                                                                             ((void *)0)
# 242 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                                                                                 ) {
            zip_error_set(error, 14, 0);
            return 
# 244 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                  0
# 244 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                       ;
        }
        entry->name = name;
        ...
        entry->orig_index = -1;
        hash->nentries++;
 if (hash->nentries > hash->table_size * .75 && hash->table_size < 0x80000000ul) {
     if (!hash_resize(hash, hash->table_size * 2, error)) {
  return 
# 254 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
        0
# 254 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
             ;
     }
 }
    }
    ...
    return 
# 264 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
          1
# 264 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
              ;
}
...
# 269 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
_Bool

# 270 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
_zip_hash_delete(zip_hash_t *hash, const zip_uint8_t *name, zip_error_t *error)
{
    ...
    if (hash == 
# 275 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
               ((void *)0) 
# 275 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                    || name == 
# 275 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                               ((void *)0)
# 275 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
 ...
 zip_error_set(error, 18, 0);
 return 
# 277 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
       0
# 277 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
            ;
    }
 ...
 previous = 
# 283 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
           ((void *)0)
# 283 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
               ;
 ...
 while (entry) {
  ...
  if (entry->orig_index == -1) {
   ...
   hash->table[index] = entry->next;
      ...
      free(entry);
      hash->nentries--;
      if (hash->nentries < hash->table_size * .01 && hash->table_size > 256) {
   if (!hash_resize(hash, hash->table_size / 2, error)) {
       return 
# 298 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
             0
# 298 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                  ;
   }
      }
  }
  ...
  return 
# 305 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
        1
# 305 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
            ;
     }
     previous = entry;
     entry = entry->next;
    ...
    return 
# 313 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
          0
# 313 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
               ;
}
...
_zip_hash_lookup(zip_hash_t *hash, const zip_uint8_t *name, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (hash == 
# 324 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
               ((void *)0) 
# 324 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                    || name == 
# 324 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                               ((void *)0)
# 324 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
 ...
 hash_value = hash_string(name);
 index = hash_value % hash->table_size;
 for (entry = hash->table[index]; entry != 
# 332 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                                          ((void *)0)
# 332 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                                              ; entry = entry->next) {
...
# 354 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
_Bool

# 355 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
_zip_hash_reserve_capacity(zip_hash_t *hash, zip_uint64_t capacity, zip_error_t *error)
{
    ...
    if (capacity == 0) {
 return 
# 360 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
       1
# 360 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
           ;
    }
    ...
    if (new_size <= hash->table_size) {
 return 
# 366 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
       1
# 366 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
           ;
    }

    if (!hash_resize(hash, new_size, error)) {
        return 
# 370 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
              0
# 370 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                   ;
    }

    return 
# 373 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
          1
# 373 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
              ;
}



# 377 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
_Bool

# 378 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
_zip_hash_revert(zip_hash_t *hash, zip_error_t *error)
{
    zip_uint32_t i;
    zip_hash_entry_t *entry, *previous;
    ...
    for (i = 0; i < hash->table_size; i++) {
        previous = 
# 384 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
                  ((void *)0)
# 384 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                      ;
        entry = hash->table[i];
        while (entry) {
            if (entry->orig_index == -1) {
 ...
 while (hash->nentries < new_size * .01 && new_size > 256) {
     new_size /= 2;
 }
 if (!hash_resize(hash, new_size, error)) {
     return 
# 415 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
           0
# 415 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
                ;
 }
    }

    return 
# 419 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c" 3 4
          1
# 419 "/doner/libzip/libzip-e37a0ea/lib/zip_hash.c"
              ;
}
