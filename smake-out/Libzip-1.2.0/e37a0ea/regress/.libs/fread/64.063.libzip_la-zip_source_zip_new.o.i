# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 2
...
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
   _Bool 
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
        partial_data, needs_crc, needs_decrypt, needs_decompress;

    if (za == 
# 47 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
             ((void *)0)
# 47 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                 )
 return 
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 48 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;

    if (srcza == 
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                ((void *)0) 
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                     || srcidx >= srcza->nentry) {
 zip_error_set(&za->error, 18, 0);
 return 
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 52 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;
    }

    if ((flags & 8u) == 0
 && (((srcza->entry+srcidx)->source != 
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
    ((void *)0)
# 56 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
    ) || srcza->entry[srcidx].deleted)) {
 zip_error_set(&za->error, 15, 0);
 return 
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 58 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;
    }

    if (zip_stat_index(srcza, srcidx, flags|8u, &st) < 0) {
 zip_error_set(&za->error, 20, 0);
 return 
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;
    }
 ...
 flags |= 4u;
    ...
    if ((start > 0 || len > 0) && (flags & 4u)) {
 zip_error_set(&za->error, 18, 0);
 return 
# 71 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 71 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;
    }
 ...
 zip_error_set(&za->error, 18, 0);
 return 
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;
    }
 ...
 len = st.size - start;
    ...
    needs_decrypt = ((flags & 32u) == 0) && (st.encryption_method != 0);
    needs_decompress = ((flags & 4u) == 0) && (st.comp_method != 0);

    needs_crc = ((flags & 4u) == 0 || st.comp_method == 0) && !partial_data;

    if (needs_decrypt) {
        if (password == 
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                       ((void *)0)
# 91 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                           ) {
            password = za->default_password;
        }
 if (password == 
# 94 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                ((void *)0)
# 94 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                    ) {
     zip_error_set(&za->error, 26, 0);
     return 
# 96 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 96 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
    }

    if (st.comp_size == 0) {
 return zip_source_buffer(za, 
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                             ((void *)0)
# 101 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                                 , 0, 0);
    }
 ...
 st2.comp_method = 0;
 st2.mtime = st.mtime;
 st2.valid = 0x0004u|0x0008u|0x0040u|0x0010u;

 if ((src = _zip_source_window_new(srcza->src, start, len, &st2, 0, srcza, srcidx, &za->error)) == 
# 113 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                                                                                                  ((void *)0)
# 113 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                                                                                                      ) {
     return 
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
    }
    else {
 ...
 if ((de = _zip_get_dirent(srcza, srcidx, flags, &za->error)) == 
# 120 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                                                                ((void *)0)
# 120 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                                                                    ) {
     return 
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
 if ((src = _zip_source_window_new(srcza->src, 0, st.comp_size, &st, (de->bitflags >> 1) & 3, srcza, srcidx, &za->error)) == 
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                                                                                                                            ((void *)0)
# 123 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                                                                                                                                ) {
     return 
# 124 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 124 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
    }
 ...
 zip_source_free(src);
 return 
# 130 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 130 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
           ;
    }
 ...
 if ((enc_impl = _zip_get_encryption_implementation(st.encryption_method, 0)) == 
# 138 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
                                                                                               ((void *)0)
# 138 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
                                                                                                   ) {
     zip_error_set(&za->error, 24, 0);
     return 
# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 140 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
 ...
 zip_source_free(src);
 if (s2 == 
# 145 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 145 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
              ) {
     return 
# 146 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 146 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
 ...
 zip_source_free(src);
 if (s2 == 
# 153 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 153 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
              ) {
     return 
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 154 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
 ...
 zip_source_free(src);
 if (s2 == 
# 161 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 161 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
              ) {
     return 
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 162 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
 ...
 zip_source_free(src);
 if (s2 == 
# 170 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 170 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
              ) {
     return 
# 171 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 171 "/doner/libzip/libzip-e37a0ea/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
