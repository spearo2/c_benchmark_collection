# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 2

# 1 "/doner/libzip/libzip-e37a0ea/lib/gladman-fcrypt.h" 1
# 47 "/doner/libzip/libzip-e37a0ea/lib/gladman-fcrypt.h"
# 1 "./gladman-fcrypt/fileenc.h" 1
# 41 "./gladman-fcrypt/fileenc.h"
# 1 "./gladman-fcrypt/aes.h" 1
# 50 "./gladman-fcrypt/aes.h"
# 1 "../config.h" 1
# 51 "./gladman-fcrypt/aes.h" 2

typedef zip_uint8_t aes_08t;
typedef zip_uint32_t aes_32t;
# 71 "./gladman-fcrypt/aes.h"
typedef unsigned int aes_fret;
# 80 "./gladman-fcrypt/aes.h"
typedef struct
{ aes_32t k_sch[(4 * 16)];
    aes_32t n_rnd;
    aes_32t n_blk;
...
# 42 "./gladman-fcrypt/fileenc.h" 2
# 1 "./gladman-fcrypt/hmac.h" 1
# 39 "./gladman-fcrypt/hmac.h"
# 1 "/usr/include/memory.h" 1 3 4
# 40 "./gladman-fcrypt/hmac.h" 2

# 1 "./gladman-fcrypt/sha1.h" 1
# 39 "./gladman-fcrypt/sha1.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 40 "./gladman-fcrypt/sha1.h" 2
# 51 "./gladman-fcrypt/sha1.h"
# 1 "../config.h" 1
# 52 "./gladman-fcrypt/sha1.h" 2
...
# 42 "./gladman-fcrypt/hmac.h" 2
# 55 "./gladman-fcrypt/hmac.h"
typedef struct
{ unsigned char key[64];
    sha1_ctx ctx[1];
    unsigned int klen;
} hmac_ctx;
# 43 "./gladman-fcrypt/fileenc.h" 2
# 1 "./gladman-fcrypt/pwd2key.h" 1
# 44 "./gladman-fcrypt/fileenc.h" 2
# 84 "./gladman-fcrypt/fileenc.h"
typedef struct
...
int _zip_fcrypt_end(unsigned char mac[],
               fcrypt_ctx cx[1]);
# 48 "/doner/libzip/libzip-e37a0ea/lib/gladman-fcrypt.h" 2
# 41 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 2
...
zip_source_winzip_aes_decode(zip_t *za, zip_source_t *src, zip_uint16_t em, int flags, const char *password)
{
 ...
 break;
    ...
    if (password == 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                   ((void *)0) 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                        || src == 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                  ((void *)0) 
# 86 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
 ...
 return 
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 88 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }
    if (flags & 1) {
 zip_error_set(&za->error, 24, 0);
 return 
# 92 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 92 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }

    if (strlen(password) > 
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                          (0x7fffffff * 2U + 1U)
# 95 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                  ) {
        zip_error_set(&za->error, 18, 0);
        return 
# 97 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
              ((void *)0)
# 97 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                  ;
    }
 ...
 return 
# 102 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 102 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }

    aux_length = 2 + salt_length[mode] + 10;

    if ((st.valid & 0x0008u) == 0 || st.comp_size < aux_length) {
 zip_error_set(&za->error, 28, 0);
 return 
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 109 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }

    if ((ctx = winzip_aes_new(mode, password)) == 
# 112 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                                 ((void *)0)
# 112 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                                     ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 114 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }

    ctx->data_length = st.comp_size - aux_length;

    if ((s2 = zip_source_layered(za, src, winzip_aes_decrypt, ctx)) == 
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                                                      ((void *)0)
# 119 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                                                          ) {
 winzip_aes_free(ctx);
 return 
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 121 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }
...
{
    zip_uint8_t header[(16+2)];
    zip_uint8_t password_verification[2];
    unsigned int headerlen;
    zip_int64_t n;

    headerlen = 2 + salt_length[ctx->mode];
 ...
 return -1;
    ...
    if (memcmp(password_verification, header + salt_length[ctx->mode], 2) != 0) {
...
static 
# 159 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
      _Bool

# 160 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
verify_hmac(zip_source_t *src, struct winzip_aes *ctx)
{
    unsigned char computed[10], from_file[10];
    if (zip_source_read(src, from_file, 10) < 10) {
 _zip_error_set_from_source(&ctx->error, src);
 return 
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       0
# 165 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
            ;
    }

    _zip_fcrypt_end(computed, &ctx->fcrypt_ctx);

    if (memcmp(from_file, computed, 10) != 0) {
 zip_error_set(&ctx->error, 7, 0);
 return 
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       0
# 172 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
            ;
    }

    return 
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
          1
# 175 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
              ;
}
...
winzip_aes_decrypt(zip_source_t *src, void *ud, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
 ...
 for (offset = 0; offset < total; offset += ((total - offset) < (
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                           (0x7fffffff * 2U + 1U)
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                           ) ? (total - offset) : (
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                           (0x7fffffff * 2U + 1U)
# 215 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                           ))) {
     _zip_fcrypt_decrypt((zip_uint8_t *)data + offset, (unsigned int)((total - offset) < (
# 216 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                                                    (0x7fffffff * 2U + 1U)
# 216 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                                                    ) ? (total - offset) : (
# 216 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                                                    (0x7fffffff * 2U + 1U)
# 216 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
...
{
    if (ctx == 
# 259 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
              ((void *)0)
# 259 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                  ) {
 return;
    }

    explicit_bzero((&ctx->fcrypt_ctx), (sizeof(ctx->fcrypt_ctx)));
    explicit_bzero((ctx->password), (strlen(ctx->password)));
    free(ctx->password);
...
winzip_aes_new(unsigned int mode, const char *password) {
    ...
    if ((ctx = (struct winzip_aes *)malloc(sizeof(*ctx))) == 
# 275 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                                            ((void *)0)
# 275 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                                                ) {
 return 
# 276 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 276 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }

    if ((ctx->password = strdup(password)) == 
# 279 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
                                             ((void *)0)
# 279 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
                                                 ) {
 free(ctx);
 return 
# 281 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c" 3 4
       ((void *)0)
# 281 "/doner/libzip/libzip-e37a0ea/lib/zip_source_winzip_aes_decode.c"
           ;
    }
