# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 2
...
zip_source_seek(zip_source_t *src, zip_int64_t offset, int whence)
{
    ...
    if (!((src)->open_count > 0) || (whence != 
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
                                                      0 
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
                                                               && whence != 
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
                                                                            1 
# 46 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
...
zip_source_seek_compute_offset(zip_uint64_t offset, zip_uint64_t length, void *data, zip_uint64_t data_length, zip_error_t *error)
{
    ...
    zip_source_args_seek_t *args = ((data_length) < sizeof(zip_source_args_seek_t) ? zip_error_set((error), 18, 0), (zip_source_args_seek_t *)
# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
                                  ((void *)0) 
# 62 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
                                  : (zip_source_args_seek_t *)(data));

    if (args == 
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
               ((void *)0)
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
                   ) {
        return -1;
    }
    ...
    switch (args->whence) {
        case 
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
            1
# 69 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
                    :
            new_offset = (zip_int64_t)offset + args->offset;
            break;

        case 
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
            2
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
                    :
            new_offset = (zip_int64_t)length + args->offset;
            break;

        case 
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c" 3 4
            0
# 77 "/doner/libzip/libzip-e37a0ea/lib/zip_source_seek.c"
                    :
