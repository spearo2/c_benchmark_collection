# 1 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
# 34 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
# 1 "../config.h" 1
# 35 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
...
# 52 "../lib/compat.h" 2
# 48 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
# 1 "../lib/zip.h" 1
# 59 "../lib/zip.h"
# 1 "../lib/zipconf.h" 1
# 16 "../lib/zipconf.h"
...
# 49 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 2
...
main(int argc, char *argv[])
{
 ...
 default:
     fprintf(
# 84 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 3 4
            stderr
# 84 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
                  , usage, argv[0]);
     return 1;
 }
    }
...
# 92 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 3 4
(*__errno_location ()) 
# 92 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
      = 0;

 if ((z=zip_open(fname, flags, &ze)) != 
# 94 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 3 4
                                       ((void *)0)
# 94 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
                                           ) {
     count = zip_get_num_entries(z, 0);
     printf("opening '%s' succeeded, %"
# 96 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 3 4
                                      "l" "u"
# 96 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
                                            " entries\n", fname, count);
     zip_close(z);
     continue;
 }
 ...
 if (zip_error_get_sys_type(ze) == 1)
     printf("/%d", 
# 103 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 3 4
                  (*__errno_location ())
# 103 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
                       );
 printf("\n");
 error++;
    }
    ...
    if (error > 0)
 fprintf(
# 109 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c" 3 4
        stderr
# 109 "/doner/libzip/libzip-e37a0ea/regress/tryopen.c"
              , "%d errors\n", error);
