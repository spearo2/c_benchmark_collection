# 1 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
# 34 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 2
...
main(int argc, char *argv[])
{
    ...
    if (argc != 4) {
        fprintf(
# 55 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
               stderr
# 55 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
                     , "usage: %s archive index offset\n", prg);
        return 1;
    }

    archive = argv[1];
    index = strtoull(argv[2], 
# 60 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
                             ((void *)0)
# 60 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
                                 , 10);
    offset = (zip_int64_t)strtoull(argv[3], 
# 61 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
                                           ((void *)0)
# 61 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
                                               , 10);

    if ((z=zip_open(archive, 0, &ze)) == 
# 63 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
                                        ((void *)0)
# 63 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
                                            ) {
 zip_error_t error;
 zip_error_init_with_code(&error, ze);
 fprintf(
# 66 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
        stderr
# 66 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
              , "%s: can't open zip archive '%s': %s\n", prg, archive, zip_error_strerror(&error));
 zip_error_fini(&error);
 return 1;
    }

    if ((zf=zip_fopen_index(z, index, 0)) == 
# 71 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
                                            ((void *)0)
# 71 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
                                                ) {
 fprintf(
# 72 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
        stderr
# 72 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
              , "%s: can't open file in archive '%s': %s\n", prg, archive, zip_error_strerror(zip_file_get_error(zf)));
 zip_close(z);
 return 1;
    }

    if (zip_fseek(zf, offset, 
# 77 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
                             0
# 77 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
                                     ) < 0) {
 fprintf(
# 78 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
        stderr
# 78 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
              , "%s: zip_fseek failed: %s\n", prg, zip_error_strerror(zip_file_get_error(zf)));
 zip_close(z);
 return 1;
    }
 ...
 printf("%.*s", (int)n, b);
    ...
    if (n < 0) {
 fprintf(
# 87 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
        stderr
# 87 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
              , "%s: zip_fread failed: %s\n", prg, zip_error_strerror(zip_file_get_error(zf)));
 zip_close(z);
 return 1;
    }
    ...
    if (zip_close(z) == -1) {
        fprintf(
# 93 "/doner/libzip/libzip-e37a0ea/regress/fseek.c" 3 4
               stderr
# 93 "/doner/libzip/libzip-e37a0ea/regress/fseek.c"
