# 1 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
# 1 "/doner/libzip/libzip-e37a0ea/regress//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
# 34 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
# 1 "../config.h" 1
# 35 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 2
...
# 39 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 2
...
# 41 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 2
...
# 48 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 2
...
main(int argc, char *argv[])
{
 ...
 switch (c) {
            ...
            default:
                fprintf(
# 86 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                       stderr
# 86 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                             , "usage: %s [-v] archive\n", prg);
                return 1;
 }
    }
    ...
    if (argc-optind != 1) {
        fprintf(
# 93 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
               stderr
# 93 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                     , "usage: %s [-v] archive\n", prg);
        return 1;
    }
...
# 99 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                                        ((void *)0)
# 99 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                                            ) {
 zip_error_t error;
 zip_error_init_with_code(&error, ze);
 fprintf(
# 102 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
        stderr
# 102 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
 ...
 return 1;
    ...
    fail += do_read(z, 
# 112 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                      ((void *)0)
# 112 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                          , 0, WHEN_OPEN, 18, 0);
...
# 124 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                               ((void *)0)
# 124 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                                   );

    zs = zip_source_buffer(z, "asdf", 4, 0);
    if ((idx = zip_name_locate(z, "storedok", 0)) < 0) {
        fprintf(
# 128 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
               stderr
# 128 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
        ...
        if (zip_replace(z, (zip_uint64_t)idx, zs) < 0) {
            fprintf(
# 133 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                   stderr
# 133 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
    ...
    if ((idx = zip_name_locate(z, "storedok", 0)) < 0) {
        fprintf(
# 142 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
               stderr
# 142 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                     , "%s: can't locate 'storedok' in zip archive '%s': %s\n", prg, archive, zip_strerror(z));
        fail++;
    }
    else {
        if (zip_delete(z, (zip_uint64_t)idx) < 0) {
            fprintf(
# 147 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                   stderr
# 147 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                         , "%s: can't replace 'storedok' in zip archive '%s': %s\n", prg, archive, zip_strerror(z));
            fail++;
        }
        else {
    ...
    if (zip_file_add(z, "new_file", zs, 0) < 0) {
        fprintf(
# 157 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
               stderr
# 157 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
    ...
    if (zip_close(z) == -1) {
        fprintf(
# 166 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
               stderr
# 166 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
...
# 190 "/doner/libzip/libzip-e37a0ea/regress/fread.c" 3 4
                                         ((void *)0)
# 190 "/doner/libzip/libzip-e37a0ea/regress/fread.c"
                                             ) {
 when_got = WHEN_OPEN;
