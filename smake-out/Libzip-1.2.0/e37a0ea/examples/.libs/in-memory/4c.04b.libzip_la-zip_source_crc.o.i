# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
...
# 36 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 2
...
# 38 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 2
...
# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 2
...
zip_source_crc(zip_t *za, zip_source_t *src, int validate)
{
    ...
    if (src == 
# 59 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
              ((void *)0)
# 59 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
                  ) {
 zip_error_set(&za->error, 18, 0);
 return 
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
       ((void *)0)
# 61 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
           ;
    }

    if ((ctx=(struct crc_context *)malloc(sizeof(*ctx))) == 
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
                                                           ((void *)0)
# 64 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
                                                               ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
       ((void *)0)
# 66 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
           ;
    }
...
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
                                     ((void *)0)
# 73 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
                                         , 0);
    ctx->size = 0;
...
crc_read(zip_source_t *src, void *_ctx, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
            ...
            if (n == 0) {
                if (ctx->crc_position == ctx->position) {
                    ...
                    if (ctx->validate) {
                        ...
                        if ((st.valid & 0x0020u) && st.crc != ctx->crc) {
                            zip_error_set(&ctx->error, 7, 0);
                            return -1;
                        }
                        if ((st.valid & 0x0004u) && st.size != ctx->size) {
  ...
  for (i = ctx->crc_position - ctx->position; i < (zip_uint64_t)n; i += nn) {
      nn = ((
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
          (0x7fffffff * 2U + 1U)
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
          ) < ((zip_uint64_t)n-i) ? (
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
          (0x7fffffff * 2U + 1U)
# 127 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
  ...
  st->valid |= 0x0004u|0x0020u|0x0008u|0x0040u|0x0080u;;
     }
            return 0;
        }
...
# 180 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
                                          ((void *)0) 
# 180 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
                                          : (zip_source_args_seek_t *)(data));

     if (args == 
# 182 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c" 3 4
                ((void *)0)
# 182 "/doner/libzip/libzip-e37a0ea/lib/zip_source_crc.c"
                    ) {
  return -1;
     }
