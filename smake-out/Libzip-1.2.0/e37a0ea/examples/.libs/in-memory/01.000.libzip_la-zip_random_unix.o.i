# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
# 34 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
...
# 35 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c" 2
...
# 37 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c" 2


_Bool

# 40 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
zip_random(zip_uint8_t *buffer, zip_uint16_t length)
{
    int fd;

    if ((fd = open("/dev/urandom", 
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c" 3 4
                                  00
# 44 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
                                          )) < 0) {
 return 
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c" 3 4
       0
# 45 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
            ;
    }
 ...
 close(fd);
 return 
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c" 3 4
       0
# 50 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
            ;
    }

    close(fd);
    return 
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c" 3 4
          1
# 54 "/doner/libzip/libzip-e37a0ea/lib/zip_random_unix.c"
              ;
}
