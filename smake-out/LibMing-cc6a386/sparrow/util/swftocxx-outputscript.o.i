# 1 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-cc6a386/util/outputscript.c"
# 21 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
# 22 "/doner/libming/libming-cc6a386/util/outputscript.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 40 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 3 4
typedef __builtin_va_list __gnuc_va_list;
# 99 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 23 "/doner/libming/libming-cc6a386/util/outputscript.c" 2
...
# 24 "/doner/libming/libming-cc6a386/util/outputscript.c" 2
...
# 26 "/doner/libming/libming-cc6a386/util/outputscript.c" 2
# 1 "/doner/libming/libming-cc6a386/util/decompile.h" 1
# 28 "/doner/libming/libming-cc6a386/util/decompile.h"
...
# 29 "/doner/libming/libming-cc6a386/util/decompile.h" 2
...
# 27 "/doner/libming/libming-cc6a386/util/outputscript.c" 2
...
# 28 "/doner/libming/libming-cc6a386/util/outputscript.c" 2
...
# 29 "/doner/libming/libming-cc6a386/util/outputscript.c" 2

extern char *swftargetfile;
# 115 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
# 249 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
__builtin_va_start(
# 249 "/doner/libming/libming-cc6a386/util/outputscript.c"
ap
# 249 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
,
# 249 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
for(i=0;i<nparam;i++) {
 fmt = 
# 252 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
      __builtin_va_arg(
# 252 "/doner/libming/libming-cc6a386/util/outputscript.c"
      ap
# 252 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
      ,
# 252 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
# 252 "/doner/libming/libming-cc6a386/util/outputscript.c"
                       ;
 p = 
# 253 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
    __builtin_va_arg(
# 253 "/doner/libming/libming-cc6a386/util/outputscript.c"
    ap
# 253 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
    ,
# 253 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
# 259 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
__builtin_va_end(
# 259 "/doner/libming/libming-cc6a386/util/outputscript.c"
ap
# 259 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
)
# 259 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
newobj (char *varname, char *obj)
{
  ...
  if (varname)
  {
    ...
    sprintf (buf, "SWF" "%s* %s = " "new" " " "SWF" "%s", obj, varname, obj);
...
outputSWF_MATRIX (SWF_MATRIX * matrix, char *fname)
{
 ...
 angle = 90;
    ...
    {
      angle = atan (c / a) * 180 / 
# 330 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                  3.14159265358979323846
# 330 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                      ;
...
outputSWF_CLIPACTIONS (SWF_CLIPACTIONS * clipactions, char *sname)
{
  ...
  {
    printf ("%s(%s(\"%s\"),%s);\n\n", methodcall (sname, "addAction"), newobj (
# 451 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                                                              ((void *)0)
# 451 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                                                  , "Action"),
...
# 479 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                            ((void *)0)
# 479 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                ;
  ...
  switch (fillstyle->FillStyleType)
    ...
    case 0x10:
      ...
      printf ("" "SWF" "Fill" "* " "%s = %s(" "" "%s,SWFFILL_LINEAR_GRADIENT);\n",
    ...
    case 0x12:
      sprintf (gname, "%s_g%d", parentname, i);
      outputSWF_GRADIENT (&fillstyle->Gradient, gname);
      printf ("" "SWF" "Fill" "* " "%s = %s(" "" "%s,SWFFILL_RADIAL_GRADIENT);\n",
       fname, methodcall (parentname, "addGradientFill"), gname);
      if (shapeBounds)
        prepareSWF_MATRIX(&fillstyle->GradientMatrix, shapeBounds);
      outputSWF_MATRIX (&fillstyle->GradientMatrix, fname);
...
# 601 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                    ((void *)0)
# 601 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                        )
      outputSWF_LINESTYLE (&(linestylearray->LineStyles[i]), parentname, i);
    else if(linestylearray->LineStyles2 != 
# 603 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                          ((void *)0)
# 603 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                              )
...
outputSWF_SHAPERECORD (SWF_SHAPERECORD * shaperec, char *parentname)
{
      ...
      if (shaperec->EndShape.EndOfShape == 0)
 {
  ...
  outputSWF_FILLSTYLEARRAY_new (&(shaperec->StyleChange.FillStyles), parentname,
# 657 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                                                               ((void *)0)
# 657 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                                                   );
      }
...
outputSWF_DEFINEBUTTON2 (SWF_Parserstruct * pblock)
{
  ...
  {
    printf ("%s(%s(\"%s\"),%s);\n\n", methodcall (bname, "addAction"), newobj (
# 875 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                                                              ((void *)0)
# 875 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                                                  , "Action"),
...
# 974 "/doner/libming/libming-cc6a386/util/outputscript.c"
  if (sblock->AutoSize)
    {
      if (notFirst)
 printf (" | ");
  ...
  if (sblock->HasFont)
    {
      ...
      while (fi)
      {
       ...
       if (fi->fontcodeID==sblock->FontID)
       {
        ...
        {
# 1035 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
static void saveFontInfo(int id,int numglyph,int *codetable,UI16 *ct16)
{
  ...
  {
   if (
# 1125 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
      ((void *)0) 
# 1125 "/doner/libming/libming-cc6a386/util/outputscript.c"
           != (fi->fontcodeptr=malloc(numglyph * sizeof(int))))
   {
    int i;
...
outputSWF_DEFINEFONT2 (SWF_Parserstruct * pblock)
{
  ...
  if (sblock->FontFlagsHasLayout || sblock->NumGlyphs)
  {
   printf ("//" " font name: %s" "" "\n", sblock->FontName);
   printf ("%s(\"font%d.fdb\" );\n", newobj (fname, "Font"), sblock->FontID);
   saveFontInfo(sblock->FontID,sblock->NumGlyphs,sblock->CodeTable,
# 1151 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                                                  ((void *)0)
# 1151 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                                      );
  }
  else
  {
...
outputSWF_DEFINEFONT3 (SWF_Parserstruct * pblock)
{
  ...
  if (sblock->FontFlagsHasLayout || sblock->NumGlyphs)
  {
   printf ("//" " font name: %s" "" "\n", sblock->FontName);
   printf ("%s(\"font%d.fdb\" );\n", newobj (fname, "Font"), sblock->FontID);
   saveFontInfo(sblock->FontID,sblock->NumGlyphs,
# 1171 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                                ((void *)0)
# 1171 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                    ,sblock->CodeTable);
  }
  else
  {
...
outputSWF_DEFINEFONTINFO (SWF_Parserstruct * pblock)
{
  ...
  saveFontInfo(sblock->FontID,sblock->nGlyph,
# 1187 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                            ((void *)0)
# 1187 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                ,sblock->CodeTable);
}
...
outputSWF_DEFINEFONTINFO2(SWF_Parserstruct * pblock)
{
  ...
  printf ("%s(\"%s.fdb\" );\n", newobj (fname, "Font"), sblock->FontName);
  saveFontInfo(sblock->FontID,sblock->nGlyph,
# 1198 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                            ((void *)0)
# 1198 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                ,sblock->CodeTable);
}
...
# 1335 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                                                     ((void *)0)
# 1335 "/doner/libming/libming-cc6a386/util/outputscript.c"
                                                         );
  }
  spritenum = 0;
...
outputSWF_DOACTION (SWF_Parserstruct * pblock)
{
  ...
  printf ("%s(%s(\"%s\") );\n", methodcall (spritenum?spritename:"m", "add"),
   newobj (
# 1492 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
          ((void *)0)
# 1492 "/doner/libming/libming-cc6a386/util/outputscript.c"
              , "Action"), decompile5Action(sblock->numActions,sblock->Actions,0));
}
...
outputSWF_PLACEOBJECT2 (SWF_Parserstruct * pblock)
{
  ...
  if( sblock->PlaceFlagHasCharacter ) {
    ...
    if(sblock->Depth)
    {
     printf ("" "SWF" "DisplayItem" "* " "%s%d = %s(" "" "%s)"";""\n", "i" , sblock->Depth,
...
outputSWF_PROTECT (SWF_Parserstruct * pblock)
{
  ...
  if( sblock->Password == 
# 1683 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                         ((void *)0) 
# 1683 "/doner/libming/libming-cc6a386/util/outputscript.c"
                              ) {
   printf ("%s();\n",
...
outputSWF_INITACTION (SWF_Parserstruct * pblock)
{
  ...
  printf ("%s(%s(",
          methodcall (spritenum?spritename:"m", "add"),
          newobj (
# 1793 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                 ((void *)0)
# 1793 "/doner/libming/libming-cc6a386/util/outputscript.c"
                     , "InitAction"));
  ...
  printf ("%s(\"%s\")));\n",
          newobj (
# 1798 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                 ((void *)0)
# 1798 "/doner/libming/libming-cc6a386/util/outputscript.c"
                     , "Action"),
...
# 1942 "/doner/libming/libming-cc6a386/util/outputscript.c"
...
# 1960 "/doner/libming/libming-cc6a386/util/outputscript.c"
  if( npending )
...
{
 if( swftargetfile == 
# 1980 "/doner/libming/libming-cc6a386/util/outputscript.c" 3 4
                     ((void *)0) 
# 1980 "/doner/libming/libming-cc6a386/util/outputscript.c"
                          ) {
# 1990 "/doner/libming/libming-cc6a386/util/outputscript.c"
 if( m->version > 5 ) {
