# 1 "/doner/libming/libming-cc6a386/util/read.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-cc6a386/util/read.c"
# 23 "/doner/libming/libming-cc6a386/util/read.c"
...
# 24 "/doner/libming/libming-cc6a386/util/read.c" 2
...
# 25 "/doner/libming/libming-cc6a386/util/read.c" 2
...
# 26 "/doner/libming/libming-cc6a386/util/read.c" 2
...
# 27 "/doner/libming/libming-cc6a386/util/read.c" 2
...
# 29 "/doner/libming/libming-cc6a386/util/read.c" 2
...
# 170 "/doner/libming/libming-cc6a386/util/read.c"
  return data.d;
}
...
void _dumpBytes(FILE *f, int length, int restore)
{
 ...
 putchar('.');
  ...
  if(restore) {
 fseek(f,offset, 
# 409 "/doner/libming/libming-cc6a386/util/read.c" 3 4
                0
# 409 "/doner/libming/libming-cc6a386/util/read.c"
                        );
   fileOffset = offset;
  }
}
