# 1 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
# 22 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
# 1 "../../src/libming.h" 1
# 32 "../../src/libming.h"
...
# 76 "../../src/libming.h" 2
# 23 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 2
...
# 24 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 2
...
# 25 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 2
...
# 26 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 2
...
# 27 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 2
...
# 105 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
int readMP3Header(SWFInput input, struct mp3_header *mp3h)
{
 int frameSync, br, sr;
...
# 134 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 3 4
                          1
# 134 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
                                  );
  return -1;
 }
 ...
 {
  SWFInput_seek(input, -4, 
# 140 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 3 4
                          1
# 140 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
                                  );
  return -1;
 }
 return 1;
...
# 170 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 3 4
                                 1
# 170 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
                                         );
 return frameLen;
}
...
# 189 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 3 4
                         1
# 189 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
                                 );
  start++;
 }
...
# 196 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 3 4
                            0
# 196 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
                                    );
...
# 229 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
int getMP3Samples(SWFInput input, int flags, int *wanted)
{
...
unsigned int getMP3Duration(SWFInput input)
{
 ...
 SWFInput_seek(input, start, 
# 278 "/doner/libming/libming-cc6a386/src/blocks/mp3.c" 3 4
                            0
# 278 "/doner/libming/libming-cc6a386/src/blocks/mp3.c"
                                    );
