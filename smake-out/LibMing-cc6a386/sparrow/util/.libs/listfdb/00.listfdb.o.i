# 1 "/doner/libming/libming-cc6a386/util/listfdb.c"
...
# 2 "/doner/libming/libming-cc6a386/util/listfdb.c" 2
...
# 3 "/doner/libming/libming-cc6a386/util/listfdb.c" 2
...
# 5 "/doner/libming/libming-cc6a386/util/listfdb.c" 2
...
# 6 "/doner/libming/libming-cc6a386/util/listfdb.c" 2
...
void dumpBytes(FILE *f, int length)
{
  ...
  break;
    ...
    if(j==length)
    {
      for(k=i+1; k<16; ++k)
 {fputs("   ",
# 193 "/doner/libming/libming-cc6a386/util/listfdb.c" 3 4
stdout
# 193 "/doner/libming/libming-cc6a386/util/listfdb.c"
);};
    ...
    {fputs("   ",
# 200 "/doner/libming/libming-cc6a386/util/listfdb.c" 3 4
   stdout
# 200 "/doner/libming/libming-cc6a386/util/listfdb.c"
   );};
...
int printShapeRec(FILE *f, int *lineBits, int *fillBits, int shapeType)
{
  ...
  if(type==0)
  {
    ...
    {
      {fputs(indent(),
# 283 "/doner/libming/libming-cc6a386/util/listfdb.c" 3 4
     stdout
# 283 "/doner/libming/libming-cc6a386/util/listfdb.c"
     );fputs("EndShape",
# 283 "/doner/libming/libming-cc6a386/util/listfdb.c" 3 4
     stdout
# 283 "/doner/libming/libming-cc6a386/util/listfdb.c"
...
# 347 "/doner/libming/libming-cc6a386/util/listfdb.c"
