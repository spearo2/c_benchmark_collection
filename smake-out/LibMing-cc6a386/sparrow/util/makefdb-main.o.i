# 1 "/doner/libming/libming-cc6a386/util/main.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-cc6a386/util/main.c"
# 21 "/doner/libming/libming-cc6a386/util/main.c"
...
# 22 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 23 "/doner/libming/libming-cc6a386/util/main.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 24 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 25 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 26 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 27 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 28 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 31 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 35 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 36 "/doner/libming/libming-cc6a386/util/main.c" 2

# 1 "../src/ming_config.h" 1
# 38 "/doner/libming/libming-cc6a386/util/main.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 42 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 45 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 46 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 47 "/doner/libming/libming-cc6a386/util/main.c" 2
...
void dumpBuffer(unsigned char *buf, int length);
# 48 "/doner/libming/libming-cc6a386/util/main.c" 2
...
# 49 "/doner/libming/libming-cc6a386/util/main.c" 2
...
char *filename;
char tmp_name[
# 54 "/doner/libming/libming-cc6a386/util/main.c" 3 4
             4096
# 54 "/doner/libming/libming-cc6a386/util/main.c"
                     ];
FILE *tempfile;
char *swftargetfile=
# 56 "/doner/libming/libming-cc6a386/util/main.c" 3 4
                   ((void *)0)
# 56 "/doner/libming/libming-cc6a386/util/main.c"
                       ;
struct Movie m;
int verbose = 0;
...
# 91 "/doner/libming/libming-cc6a386/util/main.c" 3 4
 (*__errno_location ())
# 91 "/doner/libming/libming-cc6a386/util/main.c"
 )); } while(0);
 }
 ...
 outbuffer=
# 109 "/doner/libming/libming-cc6a386/util/main.c" 3 4
          ((void *)0)
# 109 "/doner/libming/libming-cc6a386/util/main.c"
              ;
 do{
  ...
  switch(err){
   case 
# 117 "/doner/libming/libming-cc6a386/util/main.c" 3 4
       (-4)
# 117 "/doner/libming/libming-cc6a386/util/main.c"
                  :
    do { if(_SWF_error) _SWF_error(("Not enough memory.\n")); } while(0);
    break;
   case 
# 120 "/doner/libming/libming-cc6a386/util/main.c" 3 4
       (-5)
# 120 "/doner/libming/libming-cc6a386/util/main.c"
                  :
    do { if(_SWF_warn) _SWF_warn(("resizing outbuffer..\n")); } while(0);
    outsize*=2;
    continue;
   case 
# 124 "/doner/libming/libming-cc6a386/util/main.c" 3 4
       (-3)
# 124 "/doner/libming/libming-cc6a386/util/main.c"
                   :
    do { if(_SWF_error) _SWF_error(("Data corrupted. Couldn't uncompress.\n")); } while(0);
    break;
   case 
# 127 "/doner/libming/libming-cc6a386/util/main.c" 3 4
       0
# 127 "/doner/libming/libming-cc6a386/util/main.c"
           :
    break;
   default:
...
# 134 "/doner/libming/libming-cc6a386/util/main.c" 3 4
               (-5)
# 134 "/doner/libming/libming-cc6a386/util/main.c"
                          );
...
static void usage(char *prog)
{
 ...
 fprintf(
# 158 "/doner/libming/libming-cc6a386/util/main.c" 3 4
        stderr
# 158 "/doner/libming/libming-cc6a386/util/main.c"
              ,"%s: [-v] inputfile\n", prog);
 fprintf(
# 159 "/doner/libming/libming-cc6a386/util/main.c" 3 4
        stderr
# 159 "/doner/libming/libming-cc6a386/util/main.c"
              ,"<inputfile> should be a swf files containing font blocks (DEFINEFONT2).\n");
 fprintf(
# 160 "/doner/libming/libming-cc6a386/util/main.c" 3 4
        stderr
# 160 "/doner/libming/libming-cc6a386/util/main.c"
 ...
 *compressed = (first == ('C')) ? 1 : 0;
 ...
 m.soundStreamFmt = -1;
 m.fonts = 
# 193 "/doner/libming/libming-cc6a386/util/main.c" 3 4
          ((void *)0)
# 193 "/doner/libming/libming-cc6a386/util/main.c"
              ;
 m.numFonts = 0;
 if (*compressed)
 {
  ...
  f = tempfile;
  fseek(f,8,
# 206 "/doner/libming/libming-cc6a386/util/main.c" 3 4
           0
# 206 "/doner/libming/libming-cc6a386/util/main.c"
                   );
...
static void readMovie(FILE *f)
{
 ...
 for (;;)
 {
  ...
  fseek(f, nextFrame, 
# 287 "/doner/libming/libming-cc6a386/util/main.c" 3 4
                     0
# 287 "/doner/libming/libming-cc6a386/util/main.c"
                             );
  fileOffset = ftell(f);
 }
 putchar ('\n');
...
main (int argc, char *argv[])
{
 ...
 setbuf(
# 308 "/doner/libming/libming-cc6a386/util/main.c" 3 4
       stdout
# 308 "/doner/libming/libming-cc6a386/util/main.c"
             , 
# 308 "/doner/libming/libming-cc6a386/util/main.c" 3 4
               ((void *)0)
# 308 "/doner/libming/libming-cc6a386/util/main.c"
 ...
 {
  fprintf(
# 341 "/doner/libming/libming-cc6a386/util/main.c" 3 4
         stderr
# 341 "/doner/libming/libming-cc6a386/util/main.c"
