# 1 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
# 22 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
...
# 23 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 2
...
# 24 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 2
...
# 26 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 2
# 1 "../../src/libming.h" 1
# 33 "../../src/libming.h"
...
# 76 "../../src/libming.h" 2
# 27 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 2
...
# 28 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 2
...
# 29 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 2
...
static inline int readAudioHdr(FLVStream *flv, FLVTag *tag)
{
 ...
 if(ichar == 
# 34 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1)
# 34 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               )
  return -1;
...
static inline int readVideoHdr(FLVStream *flv, FLVTag *tag)
{
 ...
 ichar = SWFInput_getChar(flv->input);
 if(ichar == 
# 47 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1)
# 47 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               )
  return -1;
...
{
 if(flv == 
# 57 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
          ((void *)0) 
# 57 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               || tag == 
# 57 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                         ((void *)0)
# 57 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
...
# 60 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                                         0
# 60 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                                                 );
...
FLVStream *FLVStream_fromInput(SWFInput input)
{
 ...
 if(!input)
  return 
# 77 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
        ((void *)0)
# 77 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
            ;

 ichar = SWFInput_getChar(input);
 if(ichar == 
# 80 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1) 
# 80 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                || ichar != 'F')
  return 
# 81 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
        ((void *)0)
# 81 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
            ;

 ichar = SWFInput_getChar(input);
 if(ichar == 
# 84 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1) 
# 84 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                || ichar != 'L')
  return 
# 85 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
        ((void *)0)
# 85 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
            ;

 ichar = SWFInput_getChar(input);
 if(ichar == 
# 88 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1) 
# 88 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                || ichar != 'V')
  return 
# 89 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
        ((void *)0)
# 89 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
            ;

 flv = (FLVStream *)malloc(sizeof(FLVStream));
 if(flv == 
# 92 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
          ((void *)0)
# 92 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
              )
  return 
# 93 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
         ((void *)0)
# 93 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
             ;
 flv->input = input;

 ichar = SWFInput_getChar(input);
 if(ichar != 
# 97 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1)
# 97 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               )
  flv->version = ichar;
 ...
 ichar = SWFInput_getChar(input);
 if(ichar != 
# 103 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1)
# 103 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               )
 {
  if(ichar & 0x04)
   flv->has_audio = 1;
...
# 120 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                       0
# 120 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                               );
}
...
int FLVStream_nextTag(FLVStream *flv, FLVTag *tag, FLVTag *prev)
{
 ...
 if(prev == 
# 128 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
           ((void *)0)
# 128 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               )
  SWFInput_seek(flv->input, flv->offset, 
# 129 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                        0
# 129 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                                );
 else
 {
  unsigned long off;
...
# 137 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                0
# 137 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                        );
 }
 ...
 ichar = SWFInput_getChar(flv->input);
 if(ichar == 
# 145 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
            (-1)
# 145 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               )
  return -1;
...
unsigned int FLVStream_getDuration(FLVStream *flv, int type)
{
 ...
 FLVTag tag, *p_tag = 
# 192 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                     ((void *)0)
# 192 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                         ;
...
int FLVStream_getNumFrames(FLVStream *flv, int type)
{
 int numFrames = 0;
 FLVTag tag, *p_tag = 
# 209 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                     ((void *)0)
# 209 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                         ;
...
SWFInput FLVTag_getPayloadInput(FLVTag *tag)
{
 ...
 SWFInput input;
 if(tag == 
# 224 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
          ((void *)0) 
# 224 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
               || tag->stream == 
# 224 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                 ((void *)0)
# 224 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
  ...
  return 
# 225 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
        ((void *)0)
# 225 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
            ;
...
# 234 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                 0
# 234 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                         );
 }
...
# 240 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                     0
# 240 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                             );
 }
 else
 {
...
# 245 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                                     0
# 245 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                                             );
 }
...
{
 FLVTag tag, *p_tag = 
# 253 "/doner/libming/libming-cc6a386/src/blocks/flv.c" 3 4
                     ((void *)0)
# 253 "/doner/libming/libming-cc6a386/src/blocks/flv.c"
                         ;
