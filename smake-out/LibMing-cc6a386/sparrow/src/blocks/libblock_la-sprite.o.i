# 1 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
# 22 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
...
# 23 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 2
...
# 76 "../../src/libming.h" 2
# 25 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 2
# 1 "/doner/libming/libming-cc6a386/src/blocks/sprite.h" 1
# 32 "/doner/libming/libming-cc6a386/src/blocks/sprite.h"
# 1 "../../src/ming.h" 1
# 33 "/doner/libming/libming-cc6a386/src/blocks/sprite.h" 2
...
# 26 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 2
...
# 27 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 2
...
completeSWFSprite(SWFBlock block)
{
 ...
 if ( !(block->swfVersion) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "block->swfVersion", "/doner/libming/libming-cc6a386/src/blocks/sprite.c",58); } while(0);;
 for ( i=0; i<sprite->nBlocks; ++i )
 {
...
destroySWFSprite(SWFSprite sprite)
{
 ...
 if ( sprite->blocks != 
# 86 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 3 4
                       ((void *)0) 
# 86 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
                            )
  free(sprite->blocks);
...
newSWFSprite()
{
 ...
 sprite->nBlocks = 0;
 sprite->blocks = 
# 126 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 3 4
                 ((void *)0)
# 126 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
                     ;
 sprite->frames = 0;
 sprite->totalFrames = 0;
 sprite->grid = 
# 129 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 3 4
               ((void *)0)
# 129 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
                   ;
 sprite->initAction = 
# 130 "/doner/libming/libming-cc6a386/src/blocks/sprite.c" 3 4
                     ((void *)0)
# 130 "/doner/libming/libming-cc6a386/src/blocks/sprite.c"
                         ;
 return sprite;
}
