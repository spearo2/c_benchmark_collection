# 1 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
# 1 "/doner/jasper/jasper-dee1b64/src/appl//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
# 74 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
...
# 75 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 2
...
# 76 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 2
...
# 77 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 2
...
# 78 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 2
...
# 79 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 2
...
# 81 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 2
# 95 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
typedef struct {
...
int main(int argc, char **argv)
{
 ...
 if (!(cmdopts = cmdopts_parse(argc, argv))) {
  fprintf(
# 176 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 176 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "error: cannot parse command line\n");
  exit(
# 177 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
      1
# 177 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                  );
 }
 ...
 if (cmdopts->version) {
  printf("%s\n", "1.900.16");
  fprintf(
# 182 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 182 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "libjasper %s\n", jas_getversion());
  exit(
# 183 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
      0
# 183 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                  );
 }
 ...
 if (cmdopts->infile) {
  ...
  if (!(in = jas_stream_fopen(cmdopts->infile, "rb"))) {
   fprintf(
# 199 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
          stderr
# 199 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                , "error: cannot open input image file %s\n",
     cmdopts->infile);
   exit(
# 201 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 201 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
 } else {
  ...
  if (!(in = jas_stream_fdopen(0, "rb"))) {
   fprintf(
# 206 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
          stderr
# 206 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                , "error: cannot open standard input\n");
   exit(
# 207 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 207 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
 }
 ...
 if (cmdopts->outfile) {
  ...
  if (!(out = jas_stream_fopen(cmdopts->outfile, "w+b"))) {
   fprintf(
# 215 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
          stderr
# 215 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                , "error: cannot open output image file %s\n",
     cmdopts->outfile);
   exit(
# 217 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 217 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
 } else {
  ...
  if (!(out = jas_stream_fdopen(1, "w+b"))) {
   fprintf(
# 222 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
          stderr
# 222 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                , "error: cannot open standard output\n");
   exit(
# 223 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 223 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
 }
 ...
 if (cmdopts->infmt < 0) {
  if ((cmdopts->infmt = jas_image_getfmt(in)) < 0) {
   fprintf(
# 229 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
          stderr
# 229 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                , "error: input image has unknown format\n");
   exit(
# 230 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 230 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
 }
 ...
 if (!(image = jas_image_decode(in, cmdopts->infmt, cmdopts->inopts))) {
  fprintf(
# 237 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 237 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "error: cannot load image data\n");
  exit(
# 238 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
      1
# 238 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                  );
 }
 jas_tmr_stop(&dectmr);
 ...
 if (cmdopts->srgb) {
  ...
  if (!(outprof = jas_cmprof_createfromclrspc((((4) << 8) | (1))))) {
   ...
   exit(
# 264 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 264 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
  if (!(newimage = jas_image_chclrspc(image, outprof, 0))) {
   jas_eprintf("cannot convert to sRGB\n");
   exit(
# 268 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       1
# 268 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   );
  }
 ...
 if (jas_image_encode(image, out, cmdopts->outfmt, cmdopts->outopts)) {
  fprintf(
# 278 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 278 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "error: cannot encode image\n");
  exit(
# 279 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
      1
# 279 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                  );
 }
 ...
 if (cmdopts->verbose) {
  fprintf(
# 286 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 286 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "decoding time = %f\n", dectime);
  fprintf(
# 287 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 287 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "encoding time = %f\n", enctime);
 }
 ...
 if (jas_stream_close(out)) {
  fprintf(
# 295 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 295 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "error: cannot close output image file\n");
  exit(
# 296 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
      1
# 296 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                  );
 }
 ...
 return 
# 304 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
       0
# 304 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                   ;
}
...
cmdopts_t *cmdopts_parse(int argc, char **argv)
{
 ...
 if (!(cmdopts = malloc(sizeof(cmdopts_t)))) {
  fprintf(
# 356 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 356 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "error: insufficient memory\n");
  exit(
# 357 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
      1
# 357 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                  );
 }
...
# 377 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
                                                   (-1)
# 377 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                                                      ) {
  switch (c) {
  case CMDOPT_HELP:
   cmdusage();
  ...
  case CMDOPT_INFMT:
   if ((cmdopts->infmt = jas_image_strtofmt(jas_optarg)) < 0) {
    fprintf(
# 396 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
           stderr
# 396 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
  ...
  case CMDOPT_OUTFMT:
   if ((cmdopts->outfmt = jas_image_strtofmt(jas_optarg)) < 0) {
    fprintf(
# 410 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
           stderr
# 410 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
 ...
 while (jas_optind < argc) {
  fprintf(
# 434 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 434 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               ,
 ...
 if (cmdopts->outfmt < 0 && cmdopts->outfile) {
  if ((cmdopts->outfmt = jas_image_fmtfromname(cmdopts->outfile)) < 0) {
   fprintf(
# 446 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
          stderr
# 446 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                ,
 ...
 if (cmdopts->outfmt < 0) {
  fprintf(
# 452 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 452 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
...
{
 fprintf(
# 484 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 484 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
              , "JasPer Transcoder (Version %s).\n",
   "1.900.16");
 fprintf(
# 486 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 486 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
              , "%s\n", "Copyright (c) 2001-2006 Michael David Adams.\n" "Copyright (c) 1999-2000 Image Power, Inc. and the University of\n" "  British Columbia.\n" "All rights reserved.\n");
 fprintf(
# 487 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 487 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
...
void cmdusage()
{
 ...
 cmdinfo();
 fprintf(
# 520 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 520 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
              , "usage: %s [options]\n", cmdname);
 for (i = 0, s = helpinfo[i]; s; ++i, s = helpinfo[i]) {
  fprintf(
# 522 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 522 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "%s", s);
 }
 fprintf(
# 524 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 524 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
 ...
 for (fmtid = 0;; ++fmtid) {
  ...
  fprintf(
# 529 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
         stderr
# 529 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
               , "    %-5s    %s\n", fmtinfo->name,
    fmtinfo->desc);
 }
 exit(
# 532 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
     1
# 532 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                 );
}
...
{
 fprintf(
# 537 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 537 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
              ,
   "For more information on how to use this command, type:\n");
 fprintf(
# 539 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
        stderr
# 539 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
              , "    %s --help\n", cmdname);
 exit(
# 540 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c" 3 4
     1
# 540 "/doner/jasper/jasper-dee1b64/src/appl/jasper.c"
                 );
}
