# 1 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
# 18 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
...
# 19 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 2
...
# 20 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 2
# 1 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jdct.h" 1
# 36 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jdct.h"
typedef short DCTELEM;
typedef unsigned short UDCTELEM;
typedef unsigned int UDCTELEM2;
# 64 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jdct.h"
...
# 105 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jdct.h"
...
extern void jpeg_idct_1x1
    (j_decompress_ptr cinfo, jpeg_component_info * compptr, JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
                                                                     ;
# 21 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 2
# 1 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jsimddct.h" 1
# 41 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jsimddct.h"
...
extern void jsimd_idct_float (j_decompress_ptr cinfo, jpeg_component_info * compptr, JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
                                                          ...
                                                          ;
# 22 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 2
...
typedef void (*convsamp_method_ptr) (JSAMPARRAY sample_data, JDIMENSION start_col, DCTELEM * workspace)
                                      ...
                                      ;
typedef void (*float_convsamp_method_ptr) (JSAMPARRAY sample_data, JDIMENSION start_col, float *workspace)
...
typedef void (*quantize_method_ptr) (JCOEFPTR coef_block, DCTELEM * divisors, DCTELEM * workspace)
                                      ...
                                      ;
typedef void (*float_quantize_method_ptr) (JCOEFPTR coef_block, float * divisors, float * workspace)
...
# 166 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
static int
...
# 209 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
static void
...
# 223 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 3 4
                                 ((void *)0)
# 223 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
                                     )
...
# 234 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 3 4
                                   ((void *)0)
# 234 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
                                       ) {
 fdct->divisors[qtblno] = (DCTELEM *)
   (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
          (64 * 4) * ((size_t) sizeof(DCTELEM)));
      }
 ...
 if (fdct->divisors[qtblno] == 
# 270 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 3 4
                              ((void *)0)
# 270 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
                                  ) {
   fdct->divisors[qtblno] = (DCTELEM *)
     (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
     (64 * 4) * ((size_t) sizeof(DCTELEM)));
 ...
 for (i = 0; i < 64; i++) {
   if(!compute_reciprocal(
    ...
    case JDCT_FLOAT:
      {
# 298 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
 float * fdtbl;
 int row, col;
...
# 305 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 3 4
                                    ((void *)0)
# 305 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
                                        ) {
...
# 410 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
static void
...
convsamp_float (JSAMPARRAY sample_data, JDIMENSION start_col, float * workspace)
{
  ...
  for (elemr = 0; elemr < 8; elemr++) {
    ...
    *workspaceptr++ = (float)(((int) (*elemptr++)) - 128);
    *workspaceptr++ = (float)(((int) (*elemptr++)) - 128);
# 474 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
  }
}
...
# 541 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
void
jinit_forward_dct (j_compress_ptr cinfo)
{
  ...
  if (cinfo->dct_method == JDCT_FLOAT)
    fdct->float_workspace = (float *)
      (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
      ((size_t) sizeof(float)) * 64);
  else

    fdct->workspace = (DCTELEM *)
      (*cinfo->mem->alloc_small) ((j_common_ptr) cinfo, 1,
      ((size_t) sizeof(DCTELEM)) * 64);


  for (i = 0; i < 4; i++) {
    fdct->divisors[i] = 
# 637 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 3 4
                       ((void *)0)
# 637 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
                           ;

    fdct->float_divisors[i] = 
# 639 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c" 3 4
                             ((void *)0)
# 639 "/doner/libjpeg/libjpeg-4f24016/libjpeg-turbo/jcdctmgr.c"
                                 ;
