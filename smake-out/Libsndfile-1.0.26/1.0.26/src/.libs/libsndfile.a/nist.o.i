...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/nist.c"
# 26 "/doner/libsndfile/src/nist.c"
...
# 27 "/doner/libsndfile/src/nist.c" 2
...
# 29 "/doner/libsndfile/src/nist.c" 2
...
# 30 "/doner/libsndfile/src/nist.c" 2
...
# 31 "/doner/libsndfile/src/nist.c" 2
...
# 32 "/doner/libsndfile/src/nist.c" 2
...
# 34 "/doner/libsndfile/src/nist.c" 2
...
# 35 "/doner/libsndfile/src/nist.c" 2
...
# 36 "/doner/libsndfile/src/nist.c" 2
# 46 "/doner/libsndfile/src/nist.c"
...
# 177 "/doner/libsndfile/src/nist.c" 3 4
                                                         ((void *)0)
# 177 "/doner/libsndfile/src/nist.c"
                                                             )
  sscanf (cptr, "channel_count -i %d", &(psf->sf.channels)) ;

 if ((cptr = strstr (psf_header, "sample_rate -i ")) != 
# 180 "/doner/libsndfile/src/nist.c" 3 4
                                                       ((void *)0)
# 180 "/doner/libsndfile/src/nist.c"
                                                           )
  sscanf (cptr, "sample_rate -i %d", &(psf->sf.samplerate)) ;

 if ((cptr = strstr (psf_header, "sample_count -i ")) != 
# 183 "/doner/libsndfile/src/nist.c" 3 4
                                                        ((void *)0)
# 183 "/doner/libsndfile/src/nist.c"
                                                            )
...
# 188 "/doner/libsndfile/src/nist.c" 3 4
                                                          ((void *)0)
# 188 "/doner/libsndfile/src/nist.c"
                                                              )
...
# 233 "/doner/libsndfile/src/nist.c" 3 4
                                 0
# 233 "/doner/libsndfile/src/nist.c"
                                         ) ;
...
{ const char *end_str ;
 ...
 psf_fseek (psf, 0, 
# 320 "/doner/libsndfile/src/nist.c" 3 4
                   0
# 320 "/doner/libsndfile/src/nist.c"
                           ) ;
...
# 371 "/doner/libsndfile/src/nist.c" 3 4
                          0
# 371 "/doner/libsndfile/src/nist.c"
                                  ) ;
