...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/rf64.c"
# 28 "/doner/libsndfile/src/rf64.c"
...
# 29 "/doner/libsndfile/src/rf64.c" 2
...
# 31 "/doner/libsndfile/src/rf64.c" 2
...
# 32 "/doner/libsndfile/src/rf64.c" 2
...
# 33 "/doner/libsndfile/src/rf64.c" 2
...
# 34 "/doner/libsndfile/src/rf64.c" 2
...
# 36 "/doner/libsndfile/src/rf64.c" 2
...
# 37 "/doner/libsndfile/src/rf64.c" 2
...
# 38 "/doner/libsndfile/src/rf64.c" 2
...
# 39 "/doner/libsndfile/src/rf64.c" 2
# 73 "/doner/libsndfile/src/rf64.c"
...
# 88 "/doner/libsndfile/src/rf64.c" 3 4
                                                  ((void *)0)
# 88 "/doner/libsndfile/src/rf64.c"
                                                      )
...
# 175 "/doner/libsndfile/src/rf64.c" 3 4
                                     ((void *)0)
# 175 "/doner/libsndfile/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
...
# 303 "/doner/libsndfile/src/rf64.c" 3 4
                                     1
# 303 "/doner/libsndfile/src/rf64.c"
                                             ) ;
   ...
   default :
     ...
     if (
# 318 "/doner/libsndfile/src/rf64.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 318 "/doner/libsndfile/src/rf64.c"
        (marker >> 24) & 0xFF
# 318 "/doner/libsndfile/src/rf64.c" 3 4
...
# 319 "/doner/libsndfile/src/rf64.c"
     && 
# 319 "/doner/libsndfile/src/rf64.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 319 "/doner/libsndfile/src/rf64.c"
        (marker >> 8) & 0xFF
# 319 "/doner/libsndfile/src/rf64.c" 3 4
...
# 362 "/doner/libsndfile/src/rf64.c" 3 4
                                 0
# 362 "/doner/libsndfile/src/rf64.c"
                                         ) ;
 ...
 psf_fseek (psf, psf->dataoffset, 
# 375 "/doner/libsndfile/src/rf64.c" 3 4
                                 0
# 375 "/doner/libsndfile/src/rf64.c"
                                         ) ;
...
{ WAV_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 491 "/doner/libsndfile/src/rf64.c" 3 4
                                     ((void *)0)
# 491 "/doner/libsndfile/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
...
{ sf_count_t current ;
 ...
 if ((wpriv = psf->container_data) == 
# 605 "/doner/libsndfile/src/rf64.c" 3 4
                                     ((void *)0)
# 605 "/doner/libsndfile/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
 ...
 psf->headindex = 0 ;
 psf_fseek (psf, 0, 
# 627 "/doner/libsndfile/src/rf64.c" 3 4
                   0
# 627 "/doner/libsndfile/src/rf64.c"
                           ) ;
...
# 662 "/doner/libsndfile/src/rf64.c" 3 4
                          ((void *)0)
# 662 "/doner/libsndfile/src/rf64.c"
                              )
  wav_write_bext_chunk (psf) ;

 if (psf->cart_16k != 
# 665 "/doner/libsndfile/src/rf64.c" 3 4
                     ((void *)0)
# 665 "/doner/libsndfile/src/rf64.c"
                         )
  wav_write_cart_chunk (psf) ;
# 715 "/doner/libsndfile/src/rf64.c"
 if (wpriv->rf64_downgrade && (psf->filelength < ((sf_count_t) 0xffffffff)))
 ...
 if ((! (has_data)))
  psf_fseek (psf, psf->dataoffset, 
# 732 "/doner/libsndfile/src/rf64.c" 3 4
                                  0
# 732 "/doner/libsndfile/src/rf64.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 734 "/doner/libsndfile/src/rf64.c" 3 4
                          0
# 734 "/doner/libsndfile/src/rf64.c"
                                  ) ;
...
{ WAV_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 755 "/doner/libsndfile/src/rf64.c" 3 4
                                     ((void *)0)
# 755 "/doner/libsndfile/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
