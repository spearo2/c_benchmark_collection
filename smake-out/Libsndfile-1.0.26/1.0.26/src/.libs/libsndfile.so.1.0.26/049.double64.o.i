# 1 "/doner/libsndfile/src/double64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/double64.c"
# 19 "/doner/libsndfile/src/double64.c"
...
# 20 "/doner/libsndfile/src/double64.c" 2
...
# 22 "/doner/libsndfile/src/double64.c" 2
...
# 23 "/doner/libsndfile/src/double64.c" 2
...
# 24 "/doner/libsndfile/src/double64.c" 2
...
# 25 "/doner/libsndfile/src/double64.c" 2
...
# 26 "/doner/libsndfile/src/double64.c" 2
...
# 28 "/doner/libsndfile/src/double64.c" 2
...
# 29 "/doner/libsndfile/src/double64.c" 2
...
# 30 "/doner/libsndfile/src/double64.c" 2
# 47 "/doner/libsndfile/src/double64.c"
enum
{ DOUBLE_UNKNOWN = 0x00,
...
# 283 "/doner/libsndfile/src/double64.c"
double
...
{ while (--count >= 0)
 { double tmp = scale * src [count] ;
  ...
  if (0 == 0 && tmp > 32767.0)
   ...
   dest [count] = 
# 502 "/doner/libsndfile/src/double64.c" 3 4
                 (-0x7fff - 1) 
# 502 "/doner/libsndfile/src/double64.c"
                          ;
  else
...
{ while (--count >= 0)
 { float tmp = scale * src [count] ;
  ...
  if (0 == 0 && tmp > (1.0 * 0x7fffffff))
   ...
   dest [count] = 
# 523 "/doner/libsndfile/src/double64.c" 3 4
                 (-0x7fffffff - 1) 
# 523 "/doner/libsndfile/src/double64.c"
                         ;
  else
   dest [count] = lrint (tmp) ;
  } ;
