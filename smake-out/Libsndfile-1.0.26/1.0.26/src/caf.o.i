...
# 20 "/doner/libsndfile/src/caf.c" 2
...
# 22 "/doner/libsndfile/src/caf.c" 2
...
# 23 "/doner/libsndfile/src/caf.c" 2
...
# 24 "/doner/libsndfile/src/caf.c" 2
...
# 25 "/doner/libsndfile/src/caf.c" 2
...
# 26 "/doner/libsndfile/src/caf.c" 2
...
# 27 "/doner/libsndfile/src/caf.c" 2
...
# 29 "/doner/libsndfile/src/caf.c" 2
...
# 30 "/doner/libsndfile/src/caf.c" 2
...
# 31 "/doner/libsndfile/src/caf.c" 2
...
# 32 "/doner/libsndfile/src/caf.c" 2
# 77 "/doner/libsndfile/src/caf.c"
typedef struct
{ uint8_t srate [8] ;
 uint32_t fmt_id ;
 uint32_t fmt_flags ;
...
# 117 "/doner/libsndfile/src/caf.c" 3 4
                                                                ((void *)0)
# 117 "/doner/libsndfile/src/caf.c"
                                                                    )
...
# 157 "/doner/libsndfile/src/caf.c" 3 4
                                                                 ((void *)0)
# 157 "/doner/libsndfile/src/caf.c"
                                                                     )
    return SFE_MALLOC_FAILED ;
 ...
 { case SF_FORMAT_PCM_S8 :
  ...
  case SF_FORMAT_ALAC_32 :
     if (psf->file.mode == SFM_READ)
      ...
      error = alac_init (psf, 
# 205 "/doner/libsndfile/src/caf.c" 3 4
                             ((void *)0)
# 205 "/doner/libsndfile/src/caf.c"
                                 ) ;
     break ;
...
# 230 "/doner/libsndfile/src/caf.c" 3 4
                                    ((void *)0)
# 230 "/doner/libsndfile/src/caf.c"
                                        )
  return SFE_INTERNAL ;
...
{ int format = SF_FORMAT_CAF ;
 ...
 { CAF_PRIVATE *pcaf ;
  ...
  if ((pcaf = psf->container_data) != 
# 257 "/doner/libsndfile/src/caf.c" 3 4
                                     ((void *)0)
# 257 "/doner/libsndfile/src/caf.c"
                                         )
...
{ CAF_PRIVATE *pcaf ;
 ...
 if ((pcaf = psf->container_data) == 
# 344 "/doner/libsndfile/src/caf.c" 3 4
                                    ((void *)0)
# 344 "/doner/libsndfile/src/caf.c"
                                        )
  return SFE_INTERNAL ;
 ...
 { marker = 0 ;
  ...
  { case ((uint32_t) (('p') | (('e') << 8) | (('a') << 16) | (((uint32_t) ('k')) << 24))) :
    ...
    if ((psf->peak_info = peak_info_calloc (psf->sf.channels)) == 
# 411 "/doner/libsndfile/src/caf.c" 3 4
                                                                 ((void *)0)
# 411 "/doner/libsndfile/src/caf.c"
                                                                     )
     return SFE_MALLOC_FAILED ;
...
# 427 "/doner/libsndfile/src/caf.c" 3 4
                                                              "l" "d" 
# 427 "/doner/libsndfile/src/caf.c"
                                                                     "   %g\n", k, position, value) ;
...
# 528 "/doner/libsndfile/src/caf.c" 3 4
                                 0
# 528 "/doner/libsndfile/src/caf.c"
                                         ) ;
...
{ BUF_UNION ubuf ;
 ...
 if ((pcaf = psf->container_data) == 
# 551 "/doner/libsndfile/src/caf.c" 3 4
                                    ((void *)0)
# 551 "/doner/libsndfile/src/caf.c"
                                        )
  return SFE_INTERNAL ;
 ...
 psf->headindex = 0 ;
 psf_fseek (psf, 0, 
# 573 "/doner/libsndfile/src/caf.c" 3 4
                   0
# 573 "/doner/libsndfile/src/caf.c"
                           ) ;
 ...
 if (psf->peak_info != 
# 696 "/doner/libsndfile/src/caf.c" 3 4
                      ((void *)0)
# 696 "/doner/libsndfile/src/caf.c"
                          )
 { int k ;
 ...
 if (append_free_block)
 {
  ...
  while (free_len < 0)
   free_len += 0x1000 ;
  psf_binheader_writef (psf, "Em8z", ((uint32_t) (('f') | (('r') << 8) | (('e') << 16) | (((uint32_t) ('e')) << 24))), free_len, (int) free_len) ;
  } ;
 ...
 if (current < psf->dataoffset)
  psf_fseek (psf, psf->dataoffset, 
# 726 "/doner/libsndfile/src/caf.c" 3 4
                                  0
# 726 "/doner/libsndfile/src/caf.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 728 "/doner/libsndfile/src/caf.c" 3 4
                          0
# 728 "/doner/libsndfile/src/caf.c"
                                  ) ;
...
# 750 "/doner/libsndfile/src/caf.c" 3 4
                                         ((void *)0)
# 750 "/doner/libsndfile/src/caf.c"
                                             )
...
# 755 "/doner/libsndfile/src/caf.c" 3 4
                                                   ((void *)0)
# 755 "/doner/libsndfile/src/caf.c"
                                                       )
   return SFE_MALLOC_FAILED ;
...
{ int indx ;
 ...
 if (chunk_info->data == 
# 797 "/doner/libsndfile/src/caf.c" 3 4
                        ((void *)0)
# 797 "/doner/libsndfile/src/caf.c"
                            )
...
# 804 "/doner/libsndfile/src/caf.c" 3 4
                                                   0
# 804 "/doner/libsndfile/src/caf.c"
                                                           ) ;
 ...
 psf_fseek (psf, pos, 
# 806 "/doner/libsndfile/src/caf.c" 3 4
                     0
# 806 "/doner/libsndfile/src/caf.c"
                             ) ;
