# 1 "/doner/libsndfile/src/chanmap.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/chanmap.c"
# 25 "/doner/libsndfile/src/chanmap.c"
...
# 26 "/doner/libsndfile/src/chanmap.c" 2
...
# 28 "/doner/libsndfile/src/chanmap.c" 2
...
# 29 "/doner/libsndfile/src/chanmap.c" 2
...
# 30 "/doner/libsndfile/src/chanmap.c" 2
...
# 32 "/doner/libsndfile/src/chanmap.c" 2
...
# 33 "/doner/libsndfile/src/chanmap.c" 2
...
# 34 "/doner/libsndfile/src/chanmap.c" 2


static const AIFF_CAF_CHANNEL_MAP zero_chan [] =
{ { (0 << 16) | 0, 
# 37 "/doner/libsndfile/src/chanmap.c" 3 4
                  ((void *)0)
# 37 "/doner/libsndfile/src/chanmap.c"
                      , "Use channel descriptions." },
 { (1 << 16) | 0, 
# 38 "/doner/libsndfile/src/chanmap.c" 3 4
                 ((void *)0)
# 38 "/doner/libsndfile/src/chanmap.c"
                     , "Use channel bitmap." }
} ;
...
{ { (110 << 16) | 6, 
# 150 "/doner/libsndfile/src/chanmap.c" 3 4
                    ((void *)0)
# 150 "/doner/libsndfile/src/chanmap.c"
...
{ { (125 << 16) | 7, six_channel_mpeg_61a, "MPEG 6.1 A (L, R, C, LFE, Ls, Rs, Cs)" },
 { (140 << 16) | 7, 
# 167 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 167 "/doner/libsndfile/src/chanmap.c"
                       , "AudioUnit 7.0 (L, R, Ls, Rs, C, Rls, Rrs)" },
 { (142 << 16) | 7, six_channel_aac_61, "AAC 6.1 (C, L, R, Ls, Rs, Cs, Lfe)" },
 { (143 << 16) | 7, 
# 169 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 169 "/doner/libsndfile/src/chanmap.c"
...
{ { (111 << 16) | 8, 
# 174 "/doner/libsndfile/src/chanmap.c" 3 4
                    ((void *)0)
# 174 "/doner/libsndfile/src/chanmap.c"
                        ,
 ...
 { (112 << 16) | 8, 
# 179 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 179 "/doner/libsndfile/src/chanmap.c"
                       ,
 ...
 { (126 << 16) | 8, 
# 184 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 184 "/doner/libsndfile/src/chanmap.c"
                       , "MPEG 7.1 A (L, R, C, LFE, Ls, Rs, Lc, Rc)" },
 { (127 << 16) | 8, 
# 185 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 185 "/doner/libsndfile/src/chanmap.c"
                       , "MPEG 7.1 B (C, Lc, Rc, L, R, Ls, Rs, LFE)" },
 { (128 << 16) | 8, 
# 186 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 186 "/doner/libsndfile/src/chanmap.c"
                       , "MPEG 7.1 C (L, R, C, LFE, Ls, R, Rls, Rrs)" },
 { (129 << 16) | 8, 
# 187 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 187 "/doner/libsndfile/src/chanmap.c"
                       , "Emagic Default 7.1 (L, R, Ls, Rs, C, LFE, Lc, Rc)" },
 { (130 << 16) | 8, 
# 188 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 188 "/doner/libsndfile/src/chanmap.c"
                       ,

  "SMPTE DTV (L, R, C, LFE, Ls, Rs, Lt, Rt)"
  },
 { (144 << 16) | 8, 
# 192 "/doner/libsndfile/src/chanmap.c" 3 4
                   ((void *)0)
# 192 "/doner/libsndfile/src/chanmap.c"
                       , "AAC octagonal (C, L, R, Ls, Rs, Rls, Rrs, Cs)" }
} ;
# 208 "/doner/libsndfile/src/chanmap.c"
typedef struct
...
# 238 "/doner/libsndfile/src/chanmap.c" 3 4
                                 ((void *)0)
# 238 "/doner/libsndfile/src/chanmap.c"
                                     )
...
{ const AIFF_CAF_CHANNEL_MAP * curr_map ;
 ...
 if (channels < 0 || channels >= ((int) (sizeof (map) / sizeof ((map) [0]))))
  return 
# 252 "/doner/libsndfile/src/chanmap.c" 3 4
        ((void *)0) 
# 252 "/doner/libsndfile/src/chanmap.c"
             ;
 ...
 return 
# 261 "/doner/libsndfile/src/chanmap.c" 3 4
       ((void *)0) 
# 261 "/doner/libsndfile/src/chanmap.c"
            ;
}
