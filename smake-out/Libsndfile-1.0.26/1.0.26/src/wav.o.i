...
# 21 "/doner/libsndfile/src/wav.c" 2
...
# 23 "/doner/libsndfile/src/wav.c" 2
...
# 24 "/doner/libsndfile/src/wav.c" 2
...
# 25 "/doner/libsndfile/src/wav.c" 2
...
# 26 "/doner/libsndfile/src/wav.c" 2
...
# 27 "/doner/libsndfile/src/wav.c" 2
...
# 28 "/doner/libsndfile/src/wav.c" 2
...
# 30 "/doner/libsndfile/src/wav.c" 2
...
# 31 "/doner/libsndfile/src/wav.c" 2
...
# 32 "/doner/libsndfile/src/wav.c" 2
# 1 "/doner/libsndfile/src/wav_w64.h" 1
# 29 "/doner/libsndfile/src/wav_w64.h"
enum
{
...
# 284 "/doner/libsndfile/src/wav_w64.h"
...
# 33 "/doner/libsndfile/src/wav.c" 2
# 121 "/doner/libsndfile/src/wav.c"
enum
{ HAVE_RIFF = 0x01,
 HAVE_WAVE = 0x02,
 HAVE_fmt = 0x04,
...
# 179 "/doner/libsndfile/src/wav.c"
...
# 206 "/doner/libsndfile/src/wav.c" 3 4
                                                  ((void *)0)
# 206 "/doner/libsndfile/src/wav.c"
                                                      )
...
# 259 "/doner/libsndfile/src/wav.c" 3 4
                                                                 ((void *)0)
# 259 "/doner/libsndfile/src/wav.c"
                                                                     )
    return SFE_MALLOC_FAILED ;
...
{ WAV_PRIVATE *wpriv ;
 ...
 if (psf->is_pipe == 0 && psf->filelength > 0xffffffffl)
  psf_log_printf (psf, "Warning : filelength > 0xffffffff. This is bad!!!!\n") ;

 if ((wpriv = psf->container_data) == 
# 338 "/doner/libsndfile/src/wav.c" 3 4
                                     ((void *)0)
# 338 "/doner/libsndfile/src/wav.c"
                                         )
  return SFE_INTERNAL ;
...
# 464 "/doner/libsndfile/src/wav.c" 3 4
                                     1
# 464 "/doner/libsndfile/src/wav.c"
                                             ) ;
   ...
   case (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))) :
     ...
     if ((psf->peak_info = peak_info_calloc (psf->sf.channels)) == 
# 505 "/doner/libsndfile/src/wav.c" 3 4
                                                                  ((void *)0)
# 505 "/doner/libsndfile/src/wav.c"
                                                                      )
      return SFE_MALLOC_FAILED ;
...
# 527 "/doner/libsndfile/src/wav.c" 3 4
                                                         "l" "d" 
# 527 "/doner/libsndfile/src/wav.c"
                                                                "   %g\n",
...
# 702 "/doner/libsndfile/src/wav.c" 3 4
                                 0
# 702 "/doner/libsndfile/src/wav.c"
                                         ) ;
 ...
 psf_fseek (psf, psf->dataoffset, 
# 715 "/doner/libsndfile/src/wav.c" 3 4
                                 0
# 715 "/doner/libsndfile/src/wav.c"
                                         ) ;
...
{ WAV_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 947 "/doner/libsndfile/src/wav.c" 3 4
                                     ((void *)0)
# 947 "/doner/libsndfile/src/wav.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { case SF_FORMAT_PCM_U8 :
  ...
  case SF_FORMAT_ALAW :
   ...
   break ;
# 1056 "/doner/libsndfile/src/wav.c"
  default : return SFE_UNIMPLEMENTED ;
  } ;
...
{ sf_count_t current ;
 ...
 psf->headindex = 0 ;
 psf_fseek (psf, 0, 
# 1090 "/doner/libsndfile/src/wav.c" 3 4
                   0
# 1090 "/doner/libsndfile/src/wav.c"
                           ) ;
# 1100 "/doner/libsndfile/src/wav.c"
 ...
 if (psf->peak_info != 
# 1128 "/doner/libsndfile/src/wav.c" 3 4
                      ((void *)0) 
# 1128 "/doner/libsndfile/src/wav.c"
                           && psf->peak_info->peak_loc == SF_PEAK_START)
...
# 1130 "/doner/libsndfile/src/wav.c" 3 4
                                           ((void *)0)
# 1130 "/doner/libsndfile/src/wav.c"
                                               )) ;
...
# 1135 "/doner/libsndfile/src/wav.c" 3 4
                          ((void *)0)
# 1135 "/doner/libsndfile/src/wav.c"
                              )
  wav_write_bext_chunk (psf) ;

 if (psf->cart_16k != 
# 1138 "/doner/libsndfile/src/wav.c" 3 4
                     ((void *)0)
# 1138 "/doner/libsndfile/src/wav.c"
                         )
  wav_write_cart_chunk (psf) ;

 if (psf->instrument != 
# 1141 "/doner/libsndfile/src/wav.c" 3 4
                       ((void *)0)
# 1141 "/doner/libsndfile/src/wav.c"
                           )
 { int tmp ;
 ...
 if (! has_data)
  psf_fseek (psf, psf->dataoffset, 
# 1189 "/doner/libsndfile/src/wav.c" 3 4
                                  0
# 1189 "/doner/libsndfile/src/wav.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 1191 "/doner/libsndfile/src/wav.c" 3 4
                          0
# 1191 "/doner/libsndfile/src/wav.c"
                                  ) ;
...
# 1211 "/doner/libsndfile/src/wav.c" 3 4
                               0
# 1211 "/doner/libsndfile/src/wav.c"
                                       ) ;
 else
  psf->dataend = psf_fseek (psf, 0, 
# 1213 "/doner/libsndfile/src/wav.c" 3 4
                                   2
# 1213 "/doner/libsndfile/src/wav.c"
                                           ) ;
 ...
 if (psf->peak_info != 
# 1219 "/doner/libsndfile/src/wav.c" 3 4
                      ((void *)0) 
# 1219 "/doner/libsndfile/src/wav.c"
                           && psf->peak_info->peak_loc == SF_PEAK_END)
 { psf_binheader_writef (psf, "m4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "44", 1, time (
# 1221 "/doner/libsndfile/src/wav.c" 3 4
                                           ((void *)0)
# 1221 "/doner/libsndfile/src/wav.c"
                                               )) ;
  for (k = 0 ; k < psf->sf.channels ; k++)
...
{ WAV_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 1332 "/doner/libsndfile/src/wav.c" 3 4
                                     ((void *)0)
# 1332 "/doner/libsndfile/src/wav.c"
                                         )
  return SFE_INTERNAL ;
...
# 1367 "/doner/libsndfile/src/wav.c" 3 4
                                 1
# 1367 "/doner/libsndfile/src/wav.c"
                                         ) - 4 ;
...
# 1425 "/doner/libsndfile/src/wav.c" 3 4
                                                                              1
# 1425 "/doner/libsndfile/src/wav.c"
                                                                                      )) ;
     return 0 ;
  ...
  { case (((uint32_t) (('I') | (('S') << 8) | (('F') << 16) | (((uint32_t) ('T')) << 24)))) :
   ...
   case (((uint32_t) (('I') | (('T') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))) :
     ...
     if (chunk_size >= ((int) sizeof (buffer)) || chunk_size >= chunk_length)
   ...
   case (((uint32_t) (('l') | (('a') << 8) | (('b') << 16) | (((uint32_t) ('l')) << 24)))) :
     { int mark_id ;
      ...
      chunk_size -= 4 ;
      chunk_size += (chunk_size & 1) ;
      if (chunk_size < 1 || chunk_size >= ((int) sizeof (buffer)) || chunk_size >= chunk_length)
      { psf_log_printf (psf, "  *** %M : %u (too big)\n", chunk, chunk_size) ;
       psf_binheader_readf (psf, "j", chunk_length) ;
       break ;
       } ;
 ...
 current_pos = psf_fseek (psf, 0, 
# 1541 "/doner/libsndfile/src/wav.c" 3 4
                                 1
# 1541 "/doner/libsndfile/src/wav.c"
                                         ) - current_pos ;
...
# 1598 "/doner/libsndfile/src/wav.c" 3 4
                                                   ((void *)0)
# 1598 "/doner/libsndfile/src/wav.c"
                                                       )
  return SFE_MALLOC_FAILED ;
...
# 1717 "/doner/libsndfile/src/wav.c"
static int
...
# 1748 "/doner/libsndfile/src/wav.c" 3 4
                                                            ((void *)0)
# 1748 "/doner/libsndfile/src/wav.c"
                                                                )
  return SFE_MALLOC_FAILED ;
...
# 1787 "/doner/libsndfile/src/wav.c" 3 4
                                                     ((void *)0)
# 1787 "/doner/libsndfile/src/wav.c"
                                                         )
...
{ SF_BROADCAST_INFO_16K *b ;
 ...
 if (psf->broadcast_16k == 
# 1821 "/doner/libsndfile/src/wav.c" 3 4
                          ((void *)0)
# 1821 "/doner/libsndfile/src/wav.c"
                              )
  return -1 ;
...
# 1873 "/doner/libsndfile/src/wav.c" 3 4
                                           ((void *)0)
# 1873 "/doner/libsndfile/src/wav.c"
                                               )
 { psf->error = SFE_MALLOC_FAILED ;
  return psf->error ;
  } ;
...
{ SF_CART_INFO_16K *c ;
 ...
 if (psf->cart_16k == 
# 1916 "/doner/libsndfile/src/wav.c" 3 4
                     ((void *)0)
# 1916 "/doner/libsndfile/src/wav.c"
                         )
  return -1 ;
...
{ int indx ;
 ...
 if (chunk_info->data == 
# 2081 "/doner/libsndfile/src/wav.c" 3 4
                        ((void *)0)
# 2081 "/doner/libsndfile/src/wav.c"
                            )
...
# 2088 "/doner/libsndfile/src/wav.c" 3 4
                                                   0
# 2088 "/doner/libsndfile/src/wav.c"
                                                           ) ;
 ...
 psf_fseek (psf, pos, 
# 2090 "/doner/libsndfile/src/wav.c" 3 4
                     0
# 2090 "/doner/libsndfile/src/wav.c"
                             ) ;
