# 1 "/doner/libsndfile/src/broadcast.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/broadcast.c"
# 20 "/doner/libsndfile/src/broadcast.c"
...
# 21 "/doner/libsndfile/src/broadcast.c" 2
...
# 23 "/doner/libsndfile/src/broadcast.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 143 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 3 4
typedef long int ptrdiff_t;
# 321 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 3 4
typedef int wchar_t;
# 24 "/doner/libsndfile/src/broadcast.c" 2
...
# 25 "/doner/libsndfile/src/broadcast.c" 2
...
# 29 "/doner/libsndfile/src/common.h" 2
...
# 35 "/doner/libsndfile/src/common.h" 2
...
# 27 "/doner/libsndfile/src/broadcast.c" 2
...
{ if (info == 
# 33 "/doner/libsndfile/src/broadcast.c" 3 4
             ((void *)0)
# 33 "/doner/libsndfile/src/broadcast.c"
                 )
  return 0 ;

 return 
# 36 "/doner/libsndfile/src/broadcast.c" 3 4
       __builtin_offsetof (
# 36 "/doner/libsndfile/src/broadcast.c"
       SF_BROADCAST_INFO
# 36 "/doner/libsndfile/src/broadcast.c" 3 4
       , 
# 36 "/doner/libsndfile/src/broadcast.c"
...
{ size_t len ;
 ...
 if (info == 
# 48 "/doner/libsndfile/src/broadcast.c" 3 4
            ((void *)0)
# 48 "/doner/libsndfile/src/broadcast.c"
                )
  return SF_FALSE ;
...
# 61 "/doner/libsndfile/src/broadcast.c" 3 4
                          ((void *)0)
# 61 "/doner/libsndfile/src/broadcast.c"
                              )
 { if ((psf->broadcast_16k = broadcast_var_alloc ()) == 
# 62 "/doner/libsndfile/src/broadcast.c" 3 4
                                                       ((void *)0)
# 62 "/doner/libsndfile/src/broadcast.c"
                                                           )
...
# 69 "/doner/libsndfile/src/broadcast.c" 3 4
                                  __builtin_offsetof (
# 69 "/doner/libsndfile/src/broadcast.c"
                                  SF_BROADCAST_INFO
# 69 "/doner/libsndfile/src/broadcast.c" 3 4
                                  , 
# 69 "/doner/libsndfile/src/broadcast.c"
...
# 71 "/doner/libsndfile/src/broadcast.c" 3 4
                                                                                                                                    __builtin_offsetof (
# 71 "/doner/libsndfile/src/broadcast.c"
                                                                                                                                    SF_BROADCAST_INFO
# 71 "/doner/libsndfile/src/broadcast.c" 3 4
                                                                                                                                    , 
# 71 "/doner/libsndfile/src/broadcast.c"
...
{ size_t size ;
 ...
 if (psf->broadcast_16k == 
# 100 "/doner/libsndfile/src/broadcast.c" 3 4
                          ((void *)0)
# 100 "/doner/libsndfile/src/broadcast.c"
                              )
  return SF_FALSE ;
...
{ char chnstr [16] ;
 int count, width ;
# 136 "/doner/libsndfile/src/broadcast.c"
 ...
 count = snprintf (added_history, added_history_max,
       ...
       psfinfo->samplerate, width, chnstr, "libsndfile", "1.0.26") ;
