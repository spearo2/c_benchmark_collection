# 1 "/doner/libsndfile/programs/sndfile-concat.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/programs/sndfile-concat.c"
# 33 "/doner/libsndfile/programs/sndfile-concat.c"
...
# 34 "/doner/libsndfile/programs/sndfile-concat.c" 2
...
# 35 "/doner/libsndfile/programs/sndfile-concat.c" 2
...
# 36 "/doner/libsndfile/programs/sndfile-concat.c" 2
...
# 37 "/doner/libsndfile/programs/sndfile-concat.c" 2
...
# 39 "/doner/libsndfile/programs/sndfile-concat.c" 2
...
# 41 "/doner/libsndfile/programs/sndfile-concat.c" 2
...
# 86 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                                                    ((void *)0)
# 86 "/doner/libsndfile/programs/sndfile-concat.c"
                                                        )
 { printf ("\nError : Malloc failed.\n\n") ;
  exit (1) ;
  } ;
...
# 93 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                                                                ((void *)0)
# 93 "/doner/libsndfile/programs/sndfile-concat.c"
                                                                    )
...
# 101 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                                                                  ((void *)0)
# 101 "/doner/libsndfile/programs/sndfile-concat.c"
                                                                      )
  { printf ("\nError : failed to open file '%s'.\n\n", argv [k]) ;
   exit (1) ;
   } ;
...
# 112 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                                                                 ((void *)0)
# 112 "/doner/libsndfile/programs/sndfile-concat.c"
                                                                     )
 { printf ("\nError : Not able to open input file %s.\n", outfilename) ;
  puts (sf_strerror (
# 114 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                    ((void *)0)
# 114 "/doner/libsndfile/programs/sndfile-concat.c"
                        )) ;
  exit (1) ;
  } ;
...
{ static double data [(1 << 16)] ;
 ...
 sf_seek (wfile, 0, 
# 143 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                   2
# 143 "/doner/libsndfile/programs/sndfile-concat.c"
                           ) ;
...
{ static int data [(1 << 16)] ;
 ...
 sf_seek (wfile, 0, 
# 161 "/doner/libsndfile/programs/sndfile-concat.c" 3 4
                   2
# 161 "/doner/libsndfile/programs/sndfile-concat.c"
                           ) ;
