# 1 "/doner/libsndfile/programs/sndfile-deinterleave.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/programs/sndfile-deinterleave.c"
# 33 "/doner/libsndfile/programs/sndfile-deinterleave.c"
...
# 34 "/doner/libsndfile/programs/sndfile-deinterleave.c" 2
...
# 35 "/doner/libsndfile/programs/sndfile-deinterleave.c" 2
...
# 36 "/doner/libsndfile/programs/sndfile-deinterleave.c" 2
# 1 "../src/sndfile.h" 1
# 33 "../src/sndfile.h"
...
# 37 "/doner/libsndfile/programs/sndfile-deinterleave.c" 2
...
# 39 "/doner/libsndfile/programs/sndfile-deinterleave.c" 2
...
# 82 "/doner/libsndfile/programs/sndfile-deinterleave.c" 3 4
                                                              ((void *)0)
# 82 "/doner/libsndfile/programs/sndfile-deinterleave.c"
                                                                  )
 { printf ("\nError : Not able to open input file '%s'\n%s\n", argv [1], sf_strerror (
# 83 "/doner/libsndfile/programs/sndfile-deinterleave.c" 3 4
                                                                                     ((void *)0)
# 83 "/doner/libsndfile/programs/sndfile-deinterleave.c"
                                                                                         )) ;
  exit (1) ;
  } ;
...
# 96 "/doner/libsndfile/programs/sndfile-deinterleave.c" 3 4
                                        ((void *)0)
# 96 "/doner/libsndfile/programs/sndfile-deinterleave.c"
                                            )
  ext [0] = 0 ;
 else
...
# 111 "/doner/libsndfile/programs/sndfile-deinterleave.c" 3 4
                                                                      ((void *)0)
# 111 "/doner/libsndfile/programs/sndfile-deinterleave.c"
                                                                          )
  { printf ("Not able to open output file '%s'\n%s\n", filename, sf_strerror (
# 112 "/doner/libsndfile/programs/sndfile-deinterleave.c" 3 4
                                                                             ((void *)0)
# 112 "/doner/libsndfile/programs/sndfile-deinterleave.c"
                                                                                 )) ;
   exit (1) ;
   } ;
 ...
 for (ch = 0 ; ch < 16 ; ch++)
  if (state.outfile [ch] != 
# 138 "/doner/libsndfile/programs/sndfile-deinterleave.c" 3 4
                           ((void *)0)
# 138 "/doner/libsndfile/programs/sndfile-deinterleave.c"
                               )
