# 1 "/doner/libsndfile/programs/sndfile-salvage.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/programs/sndfile-salvage.c"
# 33 "/doner/libsndfile/programs/sndfile-salvage.c"
...
# 34 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 35 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 36 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 37 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 38 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 39 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 40 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 41 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 42 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 43 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 46 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 48 "/doner/libsndfile/programs/sndfile-salvage.c" 2
...
# 97 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                            00
# 97 "/doner/libsndfile/programs/sndfile-salvage.c"
                                    )) < 0)
 { printf ("Error : Not able to open file '%s' : %s\n", broken_wav, strerror (
# 98 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                                             (*__errno_location ())
# 98 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                                                  )) ;
  exit (1) ;
  } ;
...
# 108 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                           ((void *)0)
# 108 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                               )
 { printf ("sf_open ('%s') failed : %s\n", broken_wav, sf_strerror (
# 109 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                                   ((void *)0)
# 109 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                                       )) ;
  exit (1) ;
  } ;
 sf_close (sndfile) ;
...
# 116 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                   "l" "d" 
# 116 "/doner/libsndfile/programs/sndfile-salvage.c"
                                          "\n", data_offset) ;
...
# 159 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                           ((void *)0)
# 159 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                               )
 { printf ("sf_open ('%s') failed : %s\n", broken_wav, sf_strerror (
# 160 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                                   ((void *)0)
# 160 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                                       )) ;
  exit (1) ;
  } ;

 lseek_or_die (fd, data_offset, 
# 164 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                               0
# 164 "/doner/libsndfile/programs/sndfile-salvage.c"
                                       ) ;
...
# 180 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                           (*__errno_location ())
# 180 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                )) ;
  exit (1) ;
  } ;
...
# 199 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                                (*__errno_location ())
# 199 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                                     )) ;
  exit (1) ;
  } ;
...
{ char buffer [8192], *cptr ;
 ...
 lseek_or_die (fd, 0, 
# 232 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                     0
# 232 "/doner/libsndfile/programs/sndfile-salvage.c"
                             ) ;
...
# 237 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                                  (*__errno_location ())
# 237 "/doner/libsndfile/programs/sndfile-salvage.c"
                                                       )) ;
  exit (1) ;
  } ;
...
# 268 "/doner/libsndfile/programs/sndfile-salvage.c" 3 4
                                             "l" "d" 
# 268 "/doner/libsndfile/programs/sndfile-salvage.c"
