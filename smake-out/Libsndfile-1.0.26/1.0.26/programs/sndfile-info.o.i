# 1 "/doner/libsndfile/programs/sndfile-info.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/programs/sndfile-info.c"
# 33 "/doner/libsndfile/programs/sndfile-info.c"
...
# 34 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 35 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 36 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 37 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 38 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 39 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 41 "/doner/libsndfile/programs/sndfile-info.c" 2
...
# 43 "/doner/libsndfile/programs/sndfile-info.c" 2
...
{ printf ("Usage :\n  %s <file> ...\n", progname) ;
 ...
 printf ("Using %s.\n\n", sf_version_string ()) ;
# 137 "/doner/libsndfile/programs/sndfile-info.c"
 exit (1) ;
}
...
generate_duration_str (SF_INFO *sfinfo)
{
 ...
 if (sfinfo->samplerate < 1)
  return 
# 204 "/doner/libsndfile/programs/sndfile-info.c" 3 4
        ((void *)0) 
# 204 "/doner/libsndfile/programs/sndfile-info.c"
             ;
...
# 226 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                                                      ((void *)0)
# 226 "/doner/libsndfile/programs/sndfile-info.c"
                                                          )
 { printf ("Error : Not able to open input file %s.\n", filename) ;
  fflush (
# 228 "/doner/libsndfile/programs/sndfile-info.c" 3 4
         stdout
# 228 "/doner/libsndfile/programs/sndfile-info.c"
               ) ;
  memset (data, 0, sizeof (data)) ;
  sf_command (file, SFC_GET_LOG_INFO, strbuffer, (1 << 16)) ;
  puts (strbuffer) ;
  puts (sf_strerror (
# 232 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                    ((void *)0)
# 232 "/doner/libsndfile/programs/sndfile-info.c"
                        )) ;
  return ;
  } ;
 ...
 if (sfinfo.frames == 0x7FFFFFFFFFFFFFFFLL)
  ...
  printf ("Frames      : %" 
# 246 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                           "l" "d" 
# 246 "/doner/libsndfile/programs/sndfile-info.c"
                                  "\n", sfinfo.frames) ;
...
{ SNDFILE *file ;
 ...
 if ((file = sf_open (filename, SFM_READ, &sfinfo)) == 
# 292 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                                                      ((void *)0)
# 292 "/doner/libsndfile/programs/sndfile-info.c"
                                                          )
 { printf ("Error : Not able to open input file %s.\n", filename) ;
  fflush (
# 294 "/doner/libsndfile/programs/sndfile-info.c" 3 4
         stdout
# 294 "/doner/libsndfile/programs/sndfile-info.c"
               ) ;
  memset (data, 0, sizeof (data)) ;
  puts (sf_strerror (
# 296 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                    ((void *)0)
# 296 "/doner/libsndfile/programs/sndfile-info.c"
                        )) ;
  return 1 ;
  } ;
...
{ SNDFILE *file ;
 ...
 if ((file = sf_open (filename, SFM_READ, &sfinfo)) == 
# 332 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                                                      ((void *)0)
# 332 "/doner/libsndfile/programs/sndfile-info.c"
                                                          )
 { printf ("Error : Not able to open input file %s.\n", filename) ;
  fflush (
# 334 "/doner/libsndfile/programs/sndfile-info.c" 3 4
         stdout
# 334 "/doner/libsndfile/programs/sndfile-info.c"
               ) ;
  memset (data, 0, sizeof (data)) ;
  puts (sf_strerror (
# 336 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                    ((void *)0)
# 336 "/doner/libsndfile/programs/sndfile-info.c"
                        )) ;
  return 1 ;
  } ;
...
# 358 "/doner/libsndfile/programs/sndfile-info.c"
...
{ SNDFILE *file ;
 ...
 if ((file = sf_open (filename, SFM_READ, &sfinfo)) == 
# 387 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                                                      ((void *)0)
# 387 "/doner/libsndfile/programs/sndfile-info.c"
                                                          )
 { printf ("Error : Not able to open input file %s.\n", filename) ;
  fflush (
# 389 "/doner/libsndfile/programs/sndfile-info.c" 3 4
         stdout
# 389 "/doner/libsndfile/programs/sndfile-info.c"
               ) ;
  memset (data, 0, sizeof (data)) ;
  puts (sf_strerror (
# 391 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                    ((void *)0)
# 391 "/doner/libsndfile/programs/sndfile-info.c"
                        )) ;
  return 1 ;
  } ;

 if ((channel_map = calloc (sfinfo.channels, sizeof (int))) == 
# 395 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                                                              ((void *)0)
# 395 "/doner/libsndfile/programs/sndfile-info.c"
                                                                  )
...
{ SNDFILE *file ;
 ...
 if ((file = sf_open (filename, SFM_READ, &sfinfo)) == 
# 464 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                                                      ((void *)0)
# 464 "/doner/libsndfile/programs/sndfile-info.c"
                                                          )
 { printf ("Error : Not able to open input file %s.\n", filename) ;
  fflush (
# 466 "/doner/libsndfile/programs/sndfile-info.c" 3 4
         stdout
# 466 "/doner/libsndfile/programs/sndfile-info.c"
               ) ;
  memset (data, 0, sizeof (data)) ;
  puts (sf_strerror (
# 468 "/doner/libsndfile/programs/sndfile-info.c" 3 4
                    ((void *)0)
# 468 "/doner/libsndfile/programs/sndfile-info.c"
                        )) ;
  return 1 ;
  } ;
