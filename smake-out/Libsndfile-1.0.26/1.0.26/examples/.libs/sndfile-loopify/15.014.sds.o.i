...
# 20 "/doner/libsndfile/src/sds.c" 2
...
# 22 "/doner/libsndfile/src/sds.c" 2
...
# 23 "/doner/libsndfile/src/sds.c" 2
...
# 24 "/doner/libsndfile/src/sds.c" 2
...
# 25 "/doner/libsndfile/src/sds.c" 2
...
# 26 "/doner/libsndfile/src/sds.c" 2
...
# 27 "/doner/libsndfile/src/sds.c" 2
...
# 29 "/doner/libsndfile/src/sds.c" 2
...
# 30 "/doner/libsndfile/src/sds.c" 2
...
# 31 "/doner/libsndfile/src/sds.c" 2
# 47 "/doner/libsndfile/src/sds.c"
...
{ SDS_PRIVATE *psds ;
 ...
 { if (sds_write_header (psf, SF_FALSE))
  ...
  psf_fseek (psf, 0x15, 
# 130 "/doner/libsndfile/src/sds.c" 3 4
                                  0
# 130 "/doner/libsndfile/src/sds.c"
                                          ) ;
  } ;
...
# 154 "/doner/libsndfile/src/sds.c" 3 4
                                                 ((void *)0)
# 154 "/doner/libsndfile/src/sds.c"
                                                     )
...
{ unsigned char channel, bitwidth, loop_type, byte ;
 ...
 for (blockcount = 0 ; bytesread < psf->filelength ; blockcount++)
 {
  ...
  psf_fseek (psf, 127 - 2, 
# 289 "/doner/libsndfile/src/sds.c" 3 4
                                     1
# 289 "/doner/libsndfile/src/sds.c"
                                             ) ;
  bytesread += 127 - 2 ;
  } ;
 ...
 psf_fseek (psf, 0x15, 
# 331 "/doner/libsndfile/src/sds.c" 3 4
                                 0
# 331 "/doner/libsndfile/src/sds.c"
                                         ) ;
...
{ SDS_PRIVATE *psds ;
 ...
 if ((psds = (SDS_PRIVATE *) psf->codec_data) == 
# 343 "/doner/libsndfile/src/sds.c" 3 4
                                                ((void *)0)
# 343 "/doner/libsndfile/src/sds.c"
                                                    )
 { psf_log_printf (psf, "*** Bad psf->codec_data ptr.\n") ;
  return SFE_INTERNAL ;
  } ;
 ...
 { int current_count = psds->write_count ;
  ...
  psf_fseek (psf, -1 * 127, 
# 362 "/doner/libsndfile/src/sds.c" 3 4
                                      1
# 362 "/doner/libsndfile/src/sds.c"
                                              ) ;
 ...
 if (psf->is_pipe == SF_FALSE)
  psf_fseek (psf, 0, 
# 373 "/doner/libsndfile/src/sds.c" 3 4
                    0
# 373 "/doner/libsndfile/src/sds.c"
                            ) ;
...
# 411 "/doner/libsndfile/src/sds.c" 3 4
                          0
# 411 "/doner/libsndfile/src/sds.c"
                                  ) ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 561 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 561 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
...
{ SDS_PRIVATE *psds ;
 ...
 if (psf->codec_data == 
# 584 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 584 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 602 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 602 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 634 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 634 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
# 690 "/doner/libsndfile/src/sds.c" 3 4
                                ((void *)0)
# 690 "/doner/libsndfile/src/sds.c"
                                    )
...
# 720 "/doner/libsndfile/src/sds.c" 3 4
                                   0
# 720 "/doner/libsndfile/src/sds.c"
                                           ) != file_offset)
  ...
  case SFM_WRITE :
   ...
   if (psf_fseek (psf, file_offset, 
# 738 "/doner/libsndfile/src/sds.c" 3 4
                                   0
# 738 "/doner/libsndfile/src/sds.c"
                                           ) != file_offset)
   { psf->error = SFE_SEEK_FAILED ;
    return ((sf_count_t) -1) ;
    } ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 903 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 903 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ SDS_PRIVATE *psds ;
 ...
 if (psf->codec_data == 
# 927 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 927 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
 psds->total_written += len ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 946 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 946 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
 psds->total_written += len ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 979 "/doner/libsndfile/src/sds.c" 3 4
                       ((void *)0)
# 979 "/doner/libsndfile/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
 psds->total_written += len ;
