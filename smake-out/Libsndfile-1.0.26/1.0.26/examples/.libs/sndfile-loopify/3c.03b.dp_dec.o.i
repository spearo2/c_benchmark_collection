# 1 "/doner/libsndfile/src/ALAC/dp_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/ALAC/dp_dec.c"
# 30 "/doner/libsndfile/src/ALAC/dp_dec.c"
...
# 31 "/doner/libsndfile/src/ALAC/dp_dec.c" 2

# 1 "/doner/libsndfile/src/ALAC/dplib.h" 1
# 32 "/doner/libsndfile/src/ALAC/dplib.h"
...
# 33 "/doner/libsndfile/src/ALAC/dplib.h" 2
...
# 33 "/doner/libsndfile/src/ALAC/dp_dec.c" 2
...
# 34 "/doner/libsndfile/src/ALAC/dp_dec.c" 2
# 43 "/doner/libsndfile/src/ALAC/dp_dec.c"
static inline int32_t __attribute__ ((always_inline))
...
unpc_block (const int32_t * pc1, int32_t * out, int32_t num, int16_t * coefs, int32_t numactive, uint32_t chanbits, uint32_t denshift)
{
 ...
 if (numactive == 31)
 {
  ...
  int32_t prev ;
# 85 "/doner/libsndfile/src/ALAC/dp_dec.c"
  prev = out [0] ;
  for (j = 1 ; j < num ; j++)
  {
   del = pc1 [j] + prev ;
