...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/aiff.c"
# 20 "/doner/libsndfile/src/aiff.c"
...
# 21 "/doner/libsndfile/src/aiff.c" 2
...
# 23 "/doner/libsndfile/src/aiff.c" 2
...
# 24 "/doner/libsndfile/src/aiff.c" 2
...
# 25 "/doner/libsndfile/src/aiff.c" 2
...
# 26 "/doner/libsndfile/src/aiff.c" 2
...
# 27 "/doner/libsndfile/src/aiff.c" 2
...
# 28 "/doner/libsndfile/src/aiff.c" 2
...
# 30 "/doner/libsndfile/src/aiff.c" 2
...
# 31 "/doner/libsndfile/src/aiff.c" 2
...
# 32 "/doner/libsndfile/src/aiff.c" 2
# 1 "/doner/libsndfile/src/chanmap.h" 1
# 19 "/doner/libsndfile/src/chanmap.h"
typedef struct
{
...
# 33 "/doner/libsndfile/src/aiff.c" 2
# 116 "/doner/libsndfile/src/aiff.c"
enum
{ HAVE_FORM = 0x01,
 HAVE_AIFF = 0x02,
 HAVE_AIFC = 0x04,
...
# 243 "/doner/libsndfile/src/aiff.c" 3 4
                                                                 ((void *)0)
# 243 "/doner/libsndfile/src/aiff.c"
                                                                     )
...
# 254 "/doner/libsndfile/src/aiff.c" 3 4
                                  0
# 254 "/doner/libsndfile/src/aiff.c"
                                          ) ;
  } ;
...
# 265 "/doner/libsndfile/src/aiff.c" 3 4
                                                                 ((void *)0)
# 265 "/doner/libsndfile/src/aiff.c"
                                                                     )
    return SFE_MALLOC_FAILED ;
...
# 395 "/doner/libsndfile/src/aiff.c" 3 4
                                     ((void *)0)
# 395 "/doner/libsndfile/src/aiff.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { unsigned marker ;
  ...
  { case (((uint32_t) (('F') | (('O') << 8) | (('R') << 16) | (((uint32_t) ('M')) << 24)))) :
   ...
   case (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))) :
     ...
     if ((psf->peak_info = peak_info_calloc (psf->sf.channels)) == 
# 487 "/doner/libsndfile/src/aiff.c" 3 4
                                                                  ((void *)0)
# 487 "/doner/libsndfile/src/aiff.c"
                                                                      )
      return SFE_MALLOC_FAILED ;
...
# 510 "/doner/libsndfile/src/aiff.c" 3 4
                                                           "l" "d" 
# 510 "/doner/libsndfile/src/aiff.c"
                                                                  "   %g\n",
...
# 561 "/doner/libsndfile/src/aiff.c" 3 4
                                                       0
# 561 "/doner/libsndfile/src/aiff.c"
                                                               ) ;
     break ;
   ...
   case (((uint32_t) (('I') | (('N') << 8) | (('S') << 16) | (((uint32_t) ('T')) << 24)))) :
     ...
     { unsigned char bytes [6] ;
      ...
      if (psf->instrument == 
# 704 "/doner/libsndfile/src/aiff.c" 3 4
                            ((void *)0) 
# 704 "/doner/libsndfile/src/aiff.c"
...
# 704 "/doner/libsndfile/src/aiff.c"
   ...
   case (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))) :
     ...
     { unsigned short mark_id, n = 0 ;
      ...
      if (paiff->markstr != 
# 775 "/doner/libsndfile/src/aiff.c" 3 4
                           ((void *)0)
# 775 "/doner/libsndfile/src/aiff.c"
                               )
      ...
      if (paiff->markstr == 
# 780 "/doner/libsndfile/src/aiff.c" 3 4
                           ((void *)0)
# 780 "/doner/libsndfile/src/aiff.c"
                               )
       return SFE_MALLOC_FAILED ;
...
{ AIFF_PRIVATE *paiff = psf->container_data ;
 ...
 if (paiff != 
# 921 "/doner/libsndfile/src/aiff.c" 3 4
             ((void *)0) 
# 921 "/doner/libsndfile/src/aiff.c"
                  && paiff->markstr != 
# 921 "/doner/libsndfile/src/aiff.c" 3 4
                                       ((void *)0)
# 921 "/doner/libsndfile/src/aiff.c"
 ...
 { free (paiff->markstr) ;
  paiff->markstr = 
# 923 "/doner/libsndfile/src/aiff.c" 3 4
                  ((void *)0) 
# 923 "/doner/libsndfile/src/aiff.c"
                       ;
  } ;
...
aiff_rewrite_header (SF_PRIVATE *psf)
{
 ...
 psf_fseek (psf, 0, 
# 1100 "/doner/libsndfile/src/aiff.c" 3 4
                   0
# 1100 "/doner/libsndfile/src/aiff.c"
                           ) ;
...
# 1120 "/doner/libsndfile/src/aiff.c" 3 4
                                            ((void *)0)
# 1120 "/doner/libsndfile/src/aiff.c"
                                                )) ;
 ...
 psf_fseek (psf, 0, 
# 1133 "/doner/libsndfile/src/aiff.c" 3 4
                   0
# 1133 "/doner/libsndfile/src/aiff.c"
                           ) ;
...
{ sf_count_t current ;
 ...
 if ((paiff = psf->container_data) == 
# 1148 "/doner/libsndfile/src/aiff.c" 3 4
                                     ((void *)0)
# 1148 "/doner/libsndfile/src/aiff.c"
                                         )
  return SFE_INTERNAL ;
...
# 1170 "/doner/libsndfile/src/aiff.c" 3 4
                           0
# 1170 "/doner/libsndfile/src/aiff.c"
                                   ) ;
  return 0 ;
  } ;
 ...
 psf->headindex = 0 ;
 psf_fseek (psf, 0, 
# 1341 "/doner/libsndfile/src/aiff.c" 3 4
                   0
# 1341 "/doner/libsndfile/src/aiff.c"
                           ) ;
 ...
 if (psf->instrument != 
# 1367 "/doner/libsndfile/src/aiff.c" 3 4
                       ((void *)0)
# 1367 "/doner/libsndfile/src/aiff.c"
                           )
 { MARK_ID_POS m [4] ;
  INST_CHUNK ch ;
  unsigned short ct = 0 ;
 ...
 if (psf->peak_info != 
# 1429 "/doner/libsndfile/src/aiff.c" 3 4
                      ((void *)0) 
# 1429 "/doner/libsndfile/src/aiff.c"
                           && psf->peak_info->peak_loc == SF_PEAK_START)
 { psf_binheader_writef (psf, "Em4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "E44", 1, time (
# 1431 "/doner/libsndfile/src/aiff.c" 3 4
                                            ((void *)0)
# 1431 "/doner/libsndfile/src/aiff.c"
                                                )) ;
  for (k = 0 ; k < psf->sf.channels ; k++)
 ...
 if (! has_data)
  psf_fseek (psf, psf->dataoffset, 
# 1456 "/doner/libsndfile/src/aiff.c" 3 4
                                  0
# 1456 "/doner/libsndfile/src/aiff.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 1458 "/doner/libsndfile/src/aiff.c" 3 4
                          0
# 1458 "/doner/libsndfile/src/aiff.c"
                                  ) ;
...
# 1471 "/doner/libsndfile/src/aiff.c" 3 4
                                  2
# 1471 "/doner/libsndfile/src/aiff.c"
                                          ) ;
 ...
 if (psf->peak_info != 
# 1479 "/doner/libsndfile/src/aiff.c" 3 4
                      ((void *)0) 
# 1479 "/doner/libsndfile/src/aiff.c"
                           && psf->peak_info->peak_loc == SF_PEAK_END)
 { psf_binheader_writef (psf, "Em4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "E44", 1, time (
# 1481 "/doner/libsndfile/src/aiff.c" 3 4
                                            ((void *)0)
# 1481 "/doner/libsndfile/src/aiff.c"
                                                )) ;
  for (k = 0 ; k < psf->sf.channels ; k++)
   psf_binheader_writef (psf, "Eft8", (float) psf->peak_info->peaks [k].value, psf->peak_info->peaks [k].position) ;
  } ;
...
{ AIFF_PRIVATE *paiff ;
 ...
 if ((paiff = psf->container_data) == 
# 1544 "/doner/libsndfile/src/aiff.c" 3 4
                                     ((void *)0)
# 1544 "/doner/libsndfile/src/aiff.c"
                                         )
  return SFE_INTERNAL ;
...
# 1590 "/doner/libsndfile/src/aiff.c"
static int
...
# 1697 "/doner/libsndfile/src/aiff.c" 3 4
                                                            ((void *)0)
# 1697 "/doner/libsndfile/src/aiff.c"
                                                                )
  return SFE_MALLOC_FAILED ;
...
# 1725 "/doner/libsndfile/src/aiff.c" 3 4
                                                                ((void *)0)
# 1725 "/doner/libsndfile/src/aiff.c"
                                                                    )
  return 0 ;
...
# 1735 "/doner/libsndfile/src/aiff.c" 3 4
                             ((void *)0)
# 1735 "/doner/libsndfile/src/aiff.c"
                                 )
...
# 1740 "/doner/libsndfile/src/aiff.c" 3 4
                                                   ((void *)0)
# 1740 "/doner/libsndfile/src/aiff.c"
                                                       )
   return SFE_MALLOC_FAILED ;
...
{ sf_count_t pos ;
 ...
 if (chunk_info->data == 
# 1782 "/doner/libsndfile/src/aiff.c" 3 4
                        ((void *)0)
# 1782 "/doner/libsndfile/src/aiff.c"
                            )
...
# 1789 "/doner/libsndfile/src/aiff.c" 3 4
                                                   0
# 1789 "/doner/libsndfile/src/aiff.c"
                                                           ) ;
 ...
 psf_fseek (psf, pos, 
# 1791 "/doner/libsndfile/src/aiff.c" 3 4
                     0
# 1791 "/doner/libsndfile/src/aiff.c"
                             ) ;
