# 1 "/doner/libsndfile/examples/sndfile-loopify.c"
# 1 "/doner/libsndfile/examples//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/examples/sndfile-loopify.c"
# 40 "/doner/libsndfile/examples/sndfile-loopify.c"
...
# 41 "/doner/libsndfile/examples/sndfile-loopify.c" 2
...
# 42 "/doner/libsndfile/examples/sndfile-loopify.c" 2
...
# 43 "/doner/libsndfile/examples/sndfile-loopify.c" 2
...
# 44 "/doner/libsndfile/examples/sndfile-loopify.c" 2
...
# 46 "/doner/libsndfile/examples/sndfile-loopify.c" 2
...
# 48 "/doner/libsndfile/examples/sndfile-loopify.c" 2
...
{ const char *progname, *infilename, *outfilename ;
 SNDFILE *infile = 
# 72 "/doner/libsndfile/examples/sndfile-loopify.c" 3 4
                   ((void *)0)
# 72 "/doner/libsndfile/examples/sndfile-loopify.c"
                       , *outfile = 
# 72 "/doner/libsndfile/examples/sndfile-loopify.c" 3 4
                                    ((void *)0) 
# 72 "/doner/libsndfile/examples/sndfile-loopify.c"
 ...
 if ((infile = sf_open (infilename, SFM_READ, &in_sfinfo)) == 
# 100 "/doner/libsndfile/examples/sndfile-loopify.c" 3 4
                                                             ((void *)0)
# 100 "/doner/libsndfile/examples/sndfile-loopify.c"
                                                                 )
 { printf ("Not able to open input file %s.\n", infilename) ;
  puts (sf_strerror (
# 102 "/doner/libsndfile/examples/sndfile-loopify.c" 3 4
                    ((void *)0)
# 102 "/doner/libsndfile/examples/sndfile-loopify.c"
                        )) ;
  return 1 ;
  } ;
 ...
 if ((outfile = sf_open (outfilename, SFM_WRITE, &out_sfinfo)) == 
# 108 "/doner/libsndfile/examples/sndfile-loopify.c" 3 4
                                                                 ((void *)0)
# 108 "/doner/libsndfile/examples/sndfile-loopify.c"
                                                                     )
 { printf ("Not able to open output file %s : %s\n", outfilename, sf_strerror (
# 109 "/doner/libsndfile/examples/sndfile-loopify.c" 3 4
                                                                              ((void *)0)
# 109 "/doner/libsndfile/examples/sndfile-loopify.c"
                                                                                  )) ;
  return 1 ;
  } ;
...
{ static int data [(1 << 14)] ;
 int frames, readcount ;

 frames = (1 << 14) / channels ;
 readcount = frames ;
