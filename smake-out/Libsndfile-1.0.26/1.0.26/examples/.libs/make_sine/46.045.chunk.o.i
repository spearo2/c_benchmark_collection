# 1 "/doner/libsndfile/src/chunk.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/chunk.c"
# 20 "/doner/libsndfile/src/chunk.c"
...
# 21 "/doner/libsndfile/src/chunk.c" 2
...
# 23 "/doner/libsndfile/src/chunk.c" 2
...
# 24 "/doner/libsndfile/src/chunk.c" 2
...
# 26 "/doner/libsndfile/src/chunk.c" 2
...
# 27 "/doner/libsndfile/src/chunk.c" 2
...
# 28 "/doner/libsndfile/src/chunk.c" 2
...
{ const READ_CHUNKS * pchk = &psf->rchunks ;
 ...
 if (idx < 0)
  return 
# 51 "/doner/libsndfile/src/chunk.c" 3 4
        ((void *)0) 
# 51 "/doner/libsndfile/src/chunk.c"
             ;

 if (psf->iterator == 
# 53 "/doner/libsndfile/src/chunk.c" 3 4
                     ((void *)0)
# 53 "/doner/libsndfile/src/chunk.c"
                         )
 { psf->iterator = calloc (1, sizeof (SF_CHUNK_ITERATOR)) ;
  if (psf->iterator == 
# 55 "/doner/libsndfile/src/chunk.c" 3 4
                      ((void *)0)
# 55 "/doner/libsndfile/src/chunk.c"
                          )
   return 
# 56 "/doner/libsndfile/src/chunk.c" 3 4
         ((void *)0) 
# 56 "/doner/libsndfile/src/chunk.c"
              ;
  } ;
...
{ int64_t hash = iterator->hash ;
 ...
 return 
# 106 "/doner/libsndfile/src/chunk.c" 3 4
       ((void *)0) 
# 106 "/doner/libsndfile/src/chunk.c"
            ;
}
...
{ if (pchk->count == 0)
 ...
 { READ_CHUNK * old_ptr = pchk->chunks ;
  ...
  if (pchk->chunks == 
# 123 "/doner/libsndfile/src/chunk.c" 3 4
                     ((void *)0)
# 123 "/doner/libsndfile/src/chunk.c"
                         )
  { pchk->chunks = old_ptr ;
...
{ union
 ...
 { WRITE_CHUNK * old_ptr = pchk->chunks ;
  ...
  if (pchk->chunks == 
# 235 "/doner/libsndfile/src/chunk.c" 3 4
                     ((void *)0)
# 235 "/doner/libsndfile/src/chunk.c"
                         )
  { pchk->chunks = old_ptr ;
   return SFE_MALLOC_FAILED ;
   } ;
