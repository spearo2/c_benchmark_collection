...
# 20 "/doner/libsndfile/src/paf.c" 2
...
# 22 "/doner/libsndfile/src/paf.c" 2
...
# 23 "/doner/libsndfile/src/paf.c" 2
...
# 24 "/doner/libsndfile/src/paf.c" 2
...
# 25 "/doner/libsndfile/src/paf.c" 2
...
# 26 "/doner/libsndfile/src/paf.c" 2
...
# 27 "/doner/libsndfile/src/paf.c" 2
...
# 29 "/doner/libsndfile/src/paf.c" 2
...
# 30 "/doner/libsndfile/src/paf.c" 2
...
# 31 "/doner/libsndfile/src/paf.c" 2
# 52 "/doner/libsndfile/src/paf.c"
typedef struct
{ int version ;
 int endianness ;
 int samplerate ;
...
# 339 "/doner/libsndfile/src/paf.c"
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 416 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 416 "/doner/libsndfile/src/paf.c"
                           )
...
# 434 "/doner/libsndfile/src/paf.c" 3 4
                                                                   0
# 434 "/doner/libsndfile/src/paf.c"
                                                                           ) ;
  ...
  case SFM_WRITE :
    ...
    psf_fseek (psf, psf->dataoffset + newblock * ppaf24->blocksize, 
# 449 "/doner/libsndfile/src/paf.c" 3 4
                                                                   0
# 449 "/doner/libsndfile/src/paf.c"
                                                                           ) ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 467 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 467 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 546 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 546 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 568 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 568 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 586 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 586 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 614 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 614 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 715 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 715 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 740 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 740 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 767 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 767 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 798 "/doner/libsndfile/src/paf.c" 3 4
                       ((void *)0)
# 798 "/doner/libsndfile/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
