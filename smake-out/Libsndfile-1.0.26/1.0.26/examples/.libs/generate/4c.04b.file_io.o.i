# 1 "/doner/libsndfile/src/file_io.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/file_io.c"
# 35 "/doner/libsndfile/src/file_io.c"
...
# 36 "/doner/libsndfile/src/file_io.c" 2
...
# 38 "/doner/libsndfile/src/file_io.c" 2
...
# 39 "/doner/libsndfile/src/file_io.c" 2
...
# 42 "/doner/libsndfile/src/file_io.c" 2
...
# 49 "/doner/libsndfile/src/file_io.c" 2
...
# 50 "/doner/libsndfile/src/file_io.c" 2
...
# 51 "/doner/libsndfile/src/file_io.c" 2
...
# 52 "/doner/libsndfile/src/file_io.c" 2
...
# 54 "/doner/libsndfile/src/file_io.c" 2
...
# 55 "/doner/libsndfile/src/file_io.c" 2
# 67 "/doner/libsndfile/src/file_io.c"
...
psf_fopen (SF_PRIVATE *psf)
{
 ...
 if (psf->file.filedes == -1)
  psf_log_syserr (psf, 
# 92 "/doner/libsndfile/src/file_io.c" 3 4
                      (*__errno_location ())
# 92 "/doner/libsndfile/src/file_io.c"
                           ) ;
...
{ int retval ;
 ...
 if ((retval = psf_close_fd (psf->file.filedes)) == -1)
  psf_log_syserr (psf, 
# 110 "/doner/libsndfile/src/file_io.c" 3 4
                      (*__errno_location ())
# 110 "/doner/libsndfile/src/file_io.c"
                           ) ;
...
psf_open_rsrc (SF_PRIVATE *psf)
{
 ...
 if (psf->rsrc.filedes == -1)
  psf_log_syserr (psf, 
# 163 "/doner/libsndfile/src/file_io.c" 3 4
                      (*__errno_location ())
# 163 "/doner/libsndfile/src/file_io.c"
                           ) ;
...
{ sf_count_t filelen ;
 ...
 if (filelen == -1)
 { psf_log_syserr (psf, 
# 180 "/doner/libsndfile/src/file_io.c" 3 4
                       (*__errno_location ())
# 180 "/doner/libsndfile/src/file_io.c"
                            ) ;
  return (sf_count_t) -1 ;
  } ;
...
{ sf_count_t current_pos, new_position ;
 ...
 switch (whence)
 { case 
# 268 "/doner/libsndfile/src/file_io.c" 3 4
       0 
# 268 "/doner/libsndfile/src/file_io.c"
                :
    offset += psf->fileoffset ;
    break ;

  case 
# 272 "/doner/libsndfile/src/file_io.c" 3 4
      2 
# 272 "/doner/libsndfile/src/file_io.c"
               :
    ...
    { new_position = lseek (psf->file.filedes, offset, whence) ;
     ...
     if (new_position < 0)
      psf_log_syserr (psf, 
# 277 "/doner/libsndfile/src/file_io.c" 3 4
                          (*__errno_location ())
# 277 "/doner/libsndfile/src/file_io.c"
                               ) ;
    ...
    whence = 
# 286 "/doner/libsndfile/src/file_io.c" 3 4
            0 
# 286 "/doner/libsndfile/src/file_io.c"
                     ;
    offset = lseek (psf->file.filedes, 0, 
# 287 "/doner/libsndfile/src/file_io.c" 3 4
                                         2
# 287 "/doner/libsndfile/src/file_io.c"
                                                 ) + offset ;
    break ;

  case 
# 290 "/doner/libsndfile/src/file_io.c" 3 4
      1 
# 290 "/doner/libsndfile/src/file_io.c"
               :

    offset += current_pos ;
    whence = 
# 293 "/doner/libsndfile/src/file_io.c" 3 4
            0 
# 293 "/doner/libsndfile/src/file_io.c"
                     ;
    break ;
 ...
 if (new_position < 0)
  psf_log_syserr (psf, 
# 308 "/doner/libsndfile/src/file_io.c" 3 4
                      (*__errno_location ())
# 308 "/doner/libsndfile/src/file_io.c"
                           ) ;
...
{ sf_count_t total = 0 ;
 ...
 while (items > 0)
 {
  ...
  if (count == -1)
  { if (
# 336 "/doner/libsndfile/src/file_io.c" 3 4
       (*__errno_location ()) 
# 336 "/doner/libsndfile/src/file_io.c"
             == 
# 336 "/doner/libsndfile/src/file_io.c" 3 4
                4
# 336 "/doner/libsndfile/src/file_io.c"
   ...
   psf_log_syserr (psf, 
# 339 "/doner/libsndfile/src/file_io.c" 3 4
                       (*__errno_location ())
# 339 "/doner/libsndfile/src/file_io.c"
                            ) ;
   break ;
   } ;
...
{ sf_count_t total = 0 ;
 ...
 while (items > 0)
 {
  ...
  if (count == -1)
  { if (
# 380 "/doner/libsndfile/src/file_io.c" 3 4
       (*__errno_location ()) 
# 380 "/doner/libsndfile/src/file_io.c"
             == 
# 380 "/doner/libsndfile/src/file_io.c" 3 4
                4
# 380 "/doner/libsndfile/src/file_io.c"
   ...
   psf_log_syserr (psf, 
# 383 "/doner/libsndfile/src/file_io.c" 3 4
                       (*__errno_location ())
# 383 "/doner/libsndfile/src/file_io.c"
                            ) ;
   break ;
   } ;
...
# 410 "/doner/libsndfile/src/file_io.c" 3 4
                                   1
# 410 "/doner/libsndfile/src/file_io.c"
                                           ) ;

 if (pos == ((sf_count_t) -1))
 { psf_log_syserr (psf, 
# 413 "/doner/libsndfile/src/file_io.c" 3 4
                       (*__errno_location ())
# 413 "/doner/libsndfile/src/file_io.c"
                            ) ;
  return -1 ;
  } ;
...
# 427 "/doner/libsndfile/src/file_io.c" 3 4
                                      (*__errno_location ()) 
# 427 "/doner/libsndfile/src/file_io.c"
                                            == 
# 427 "/doner/libsndfile/src/file_io.c" 3 4
                                               4
# 427 "/doner/libsndfile/src/file_io.c"
...
{ sf_count_t k = 0 ;
 ...
 { count = read (psf->file.filedes, &(buffer [k]), 1) ;
  ...
  if (count == -1)
  { if (
# 442 "/doner/libsndfile/src/file_io.c" 3 4
       (*__errno_location ()) 
# 442 "/doner/libsndfile/src/file_io.c"
             == 
# 442 "/doner/libsndfile/src/file_io.c" 3 4
                4
# 442 "/doner/libsndfile/src/file_io.c"
   ...
   psf_log_syserr (psf, 
# 445 "/doner/libsndfile/src/file_io.c" 3 4
                       (*__errno_location ())
# 445 "/doner/libsndfile/src/file_io.c"
                            ) ;
   break ;
   } ;
...
{ struct stat statbuf ;
 ...
 { psf_log_syserr (psf, 
# 466 "/doner/libsndfile/src/file_io.c" 3 4
                       (*__errno_location ())
# 466 "/doner/libsndfile/src/file_io.c"
                            ) ;
 ...
 if (
# 471 "/doner/libsndfile/src/file_io.c" 3 4
    ((((
# 471 "/doner/libsndfile/src/file_io.c"
    statbuf.st_mode
# 471 "/doner/libsndfile/src/file_io.c" 3 4
    )) & 0170000) == (0010000)) 
# 471 "/doner/libsndfile/src/file_io.c"
...
{
# 488 "/doner/libsndfile/src/file_io.c"
 struct stat statbuf ;
...
{ int retval ;
 ...
 if (retval == -1)
  psf_log_syserr (psf, 
# 511 "/doner/libsndfile/src/file_io.c" 3 4
                      (*__errno_location ())
# 511 "/doner/libsndfile/src/file_io.c"
                           ) ;
...
{ int fd, oflag, mode ;
 ...
 { case SFM_READ :
    oflag = 
# 555 "/doner/libsndfile/src/file_io.c" 3 4
           00 
# 555 "/doner/libsndfile/src/file_io.c"
                    | 0 ;
    mode = 0 ;
    break ;
  ...
  case SFM_WRITE :
    oflag = 
# 560 "/doner/libsndfile/src/file_io.c" 3 4
           01 
# 560 "/doner/libsndfile/src/file_io.c"
                    | 
# 560 "/doner/libsndfile/src/file_io.c" 3 4
                      0100 
# 560 "/doner/libsndfile/src/file_io.c"
...
# 560 "/doner/libsndfile/src/file_io.c"
                                        | 0 ;
    mode = 
# 561 "/doner/libsndfile/src/file_io.c" 3 4
          0400 
# 561 "/doner/libsndfile/src/file_io.c"
                  | 
# 561 "/doner/libsndfile/src/file_io.c" 3 4
                    0200 
# 561 "/doner/libsndfile/src/file_io.c"
...
# 561 "/doner/libsndfile/src/file_io.c"
  ...
  case SFM_RDWR :
    oflag = 
# 565 "/doner/libsndfile/src/file_io.c" 3 4
           02 
# 565 "/doner/libsndfile/src/file_io.c"
                  | 
# 565 "/doner/libsndfile/src/file_io.c" 3 4
                    0100 
# 565 "/doner/libsndfile/src/file_io.c"
                            | 0 ;
    mode = 
# 566 "/doner/libsndfile/src/file_io.c" 3 4
          0400 
# 566 "/doner/libsndfile/src/file_io.c"
                  | 
# 566 "/doner/libsndfile/src/file_io.c" 3 4
                    0200 
# 566 "/doner/libsndfile/src/file_io.c"
