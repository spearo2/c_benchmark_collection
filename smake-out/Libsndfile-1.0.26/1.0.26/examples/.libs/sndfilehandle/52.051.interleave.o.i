# 1 "/doner/libsndfile/src/interleave.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/src/interleave.c"
# 19 "/doner/libsndfile/src/interleave.c"
...
# 25 "/doner/libsndfile/src/sfendian.h" 2
...
# 20 "/doner/libsndfile/src/interleave.c" 2
...
# 22 "/doner/libsndfile/src/interleave.c" 2
...
# 24 "/doner/libsndfile/src/interleave.c" 2
...
# 25 "/doner/libsndfile/src/interleave.c" 2
...
# 111 "/doner/libsndfile/src/interleave.c" 3 4
                             0
# 111 "/doner/libsndfile/src/interleave.c"
                                     ) != offset)
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 158 "/doner/libsndfile/src/interleave.c" 3 4
                             0
# 158 "/doner/libsndfile/src/interleave.c"
                                     ) != offset)
  { psf->error = SFE_INTERLEAVE_SEEK ;
   return 0 ;
   } ;
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 207 "/doner/libsndfile/src/interleave.c" 3 4
                             0
# 207 "/doner/libsndfile/src/interleave.c"
                                     ) != offset)
  { psf->error = SFE_INTERLEAVE_SEEK ;
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 256 "/doner/libsndfile/src/interleave.c" 3 4
                             0
# 256 "/doner/libsndfile/src/interleave.c"
                                     ) != offset)
  { psf->error = SFE_INTERLEAVE_SEEK ;
   return 0 ;
   } ;
