...
# 31 "/doner/libsndfile/src/sd2.c" 2
...
# 33 "/doner/libsndfile/src/sd2.c" 2
...
# 34 "/doner/libsndfile/src/sd2.c" 2
...
# 35 "/doner/libsndfile/src/sd2.c" 2
...
# 36 "/doner/libsndfile/src/sd2.c" 2
...
# 38 "/doner/libsndfile/src/sd2.c" 2
...
# 39 "/doner/libsndfile/src/sd2.c" 2
...
# 40 "/doner/libsndfile/src/sd2.c" 2
# 53 "/doner/libsndfile/src/sd2.c"
enum
{ RSRC_STR = 111,
 RSRC_BIN
} ;
...
{ int subformat, error = 0, valid ;
 ...
 { psf->rsrc.mode = psf->file.mode ;
  ...
  psf->write_header = 
# 141 "/doner/libsndfile/src/sd2.c" 3 4
                     ((void *)0) 
# 141 "/doner/libsndfile/src/sd2.c"
                          ;
  } ;
...
# 161 "/doner/libsndfile/src/sd2.c" 3 4
                                 0
# 161 "/doner/libsndfile/src/sd2.c"
                                         ) ;
...
{ SD2_RSRC rsrc ;
 ...
 write_marker (rsrc.rsrc_data, 0x52, ((uint32_t) (('S') | (('d') << 8) | (('2') << 16) | (((uint32_t) ('f')) << 24)))) ;
 write_marker (rsrc.rsrc_data, 0x56, ((uint32_t) (('l') | (('s') << 8) | (('f') << 16) | (((uint32_t) ('1')) << 24)))) ;
 ...
 rsrc.str_count = 3 ;
 write_marker (rsrc.rsrc_data, rsrc.type_offset, ((uint32_t) (('S') | (('T') << 8) | (('R') << 16) | (((uint32_t) (' ')) << 24)))) ;
 write_short (rsrc.rsrc_data, rsrc.type_offset + 4, rsrc.str_count - 1) ;
 write_short (rsrc.rsrc_data, rsrc.type_offset + 6, 0x12) ;


 write_marker (rsrc.rsrc_data, rsrc.type_offset + 8, ((uint32_t) (('s') | (('d') << 8) | (('M') << 16) | (((uint32_t) ('L')) << 24)))) ;
...
# 606 "/doner/libsndfile/src/sd2.c" 3 4
                                     ((void *)0)
# 606 "/doner/libsndfile/src/sd2.c"
                                         , 10) ;
  else if (rsrc_id == 1001 && rsrc->sample_rate == 0)
   rsrc->sample_rate = strtol (value, 
# 608 "/doner/libsndfile/src/sd2.c" 3 4
                                     ((void *)0)
# 608 "/doner/libsndfile/src/sd2.c"
                                         , 10) ;
  else if (rsrc_id == 1002 && rsrc->channels == 0)
   rsrc->channels = strtol (value, 
# 610 "/doner/libsndfile/src/sd2.c" 3 4
                                  ((void *)0)
# 610 "/doner/libsndfile/src/sd2.c"
                                      , 10) ;
  } ;
