...
# 28 "/doner/libsndfile/src/voc.c" 2
...
# 30 "/doner/libsndfile/src/voc.c" 2
...
# 31 "/doner/libsndfile/src/voc.c" 2
...
# 32 "/doner/libsndfile/src/voc.c" 2
...
# 34 "/doner/libsndfile/src/voc.c" 2
...
# 35 "/doner/libsndfile/src/voc.c" 2
...
# 36 "/doner/libsndfile/src/voc.c" 2
# 44 "/doner/libsndfile/src/voc.c"
enum
{ VOC_TERMINATOR = 0,
 VOC_SOUND_DATA = 1,
...
# 103 "/doner/libsndfile/src/voc.c"
int
...
{ sf_count_t current ;
 ...
 psf->headindex = 0 ;
 psf_fseek (psf, 0, 
# 441 "/doner/libsndfile/src/voc.c" 3 4
                   0
# 441 "/doner/libsndfile/src/voc.c"
                           ) ;
...
# 524 "/doner/libsndfile/src/voc.c" 3 4
                          0
# 524 "/doner/libsndfile/src/voc.c"
                                  ) ;
...
voc_close (SF_PRIVATE *psf)
{
 if (psf->file.mode == SFM_WRITE || psf->file.mode == SFM_RDWR)
 {
  ...
  psf_fseek (psf, 0, 
# 539 "/doner/libsndfile/src/voc.c" 3 4
                    2
# 539 "/doner/libsndfile/src/voc.c"
                            ) ;
