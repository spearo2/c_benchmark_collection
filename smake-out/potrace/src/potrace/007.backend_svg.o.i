# 1 "/doner/potrace/source/src/backend_svg.c"
...
# 9 "/doner/potrace/source/src/backend_svg.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 10 "/doner/potrace/source/src/backend_svg.c" 2
...
# 11 "/doner/potrace/source/src/backend_svg.c" 2
...
# 12 "/doner/potrace/source/src/backend_svg.c" 2
...
# 14 "/doner/potrace/source/src/backend_svg.c" 2
...
# 15 "/doner/potrace/source/src/backend_svg.c" 2
...
# 16 "/doner/potrace/source/src/backend_svg.c" 2
# 1 "/doner/potrace/source/src/backend_svg.h" 1
# 12 "/doner/potrace/source/src/backend_svg.h"
...
# 17 "/doner/potrace/source/src/backend_svg.c" 2
# 1 "/doner/potrace/source/src/lists.h" 1
# 18 "/doner/potrace/source/src/backend_svg.c" 2



# 1 "../config.h" 1
# 22 "/doner/potrace/source/src/backend_svg.c" 2
...
# 64 "/doner/potrace/source/src/backend_svg.c" 3 4
 __builtin_va_start(
# 64 "/doner/potrace/source/src/backend_svg.c"
 args
# 64 "/doner/potrace/source/src/backend_svg.c" 3 4
 ,
# 64 "/doner/potrace/source/src/backend_svg.c"
...
# 67 "/doner/potrace/source/src/backend_svg.c" 3 4
 __builtin_va_end(
# 67 "/doner/potrace/source/src/backend_svg.c"
 args
# 67 "/doner/potrace/source/src/backend_svg.c" 3 4
 )
# 67 "/doner/potrace/source/src/backend_svg.c"
  ...
  p = buf;
  while ((q = strchr(p, ' ')) != 
# 70 "/doner/potrace/source/src/backend_svg.c" 3 4
                                ((void *)0)
# 70 "/doner/potrace/source/src/backend_svg.c"
                                    ) {
    *q = 0;
    shiptoken(fout, p);
    p = q+1;
...
int page_svg(FILE *fout, potrace_path_t *plist, imginfo_t *imginfo) {
  ...
  fprintf(fout, "Created by ""potrace"" ""1.11"", written by Peter Selinger 2001-2013\n");
  fprintf(fout, "</metadata>\n");
