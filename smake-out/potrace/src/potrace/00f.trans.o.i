# 1 "/doner/potrace/source/src/trans.c"
...
# 8 "/doner/potrace/source/src/trans.c" 2
...
# 9 "/doner/potrace/source/src/trans.c" 2

# 1 "/doner/potrace/source/src/trans.h" 1
# 9 "/doner/potrace/source/src/trans.h"
...
# 10 "/doner/potrace/source/src/trans.h" 2
...
# 11 "/doner/potrace/source/src/trans.c" 2
# 1 "/doner/potrace/source/src/bbox.h" 1
# 11 "/doner/potrace/source/src/bbox.h"
struct interval_s {
  double min, max;
};
...
# 12 "/doner/potrace/source/src/trans.c" 2
...
void trans_rotate(trans_t *r, double alpha) {
  ...
  s = sin(alpha/180*
# 23 "/doner/potrace/source/src/trans.c" 3 4
                   3.14159265358979323846
# 23 "/doner/potrace/source/src/trans.c"
                       );
  c = cos(alpha/180*
# 24 "/doner/potrace/source/src/trans.c" 3 4
                   3.14159265358979323846
# 24 "/doner/potrace/source/src/trans.c"
                       );
  ...
  o0 = - ((x0)<(0) ? (x0) : (0)) - ((y0)<(0) ? (y0) : (0));
  o1 = - ((x1)<(0) ? (x1) : (0)) - ((y1)<(0) ? (y1) : (0));
