# 1 "/doner/potrace/source/src/backend_pdf.c"
...
# 1 "<command-line>" 2
# 1 "/doner/potrace/source/src/backend_pdf.c"
# 9 "/doner/potrace/source/src/backend_pdf.c"
...
# 10 "/doner/potrace/source/src/backend_pdf.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 11 "/doner/potrace/source/src/backend_pdf.c" 2
...
# 12 "/doner/potrace/source/src/backend_pdf.c" 2
...
# 13 "/doner/potrace/source/src/backend_pdf.c" 2
...
# 14 "/doner/potrace/source/src/backend_pdf.c" 2
...
# 14 "/doner/potrace/source/src/main.h" 2
...
# 16 "/doner/potrace/source/src/main.h" 2
...
# 16 "/doner/potrace/source/src/backend_pdf.c" 2
# 1 "/doner/potrace/source/src/backend_pdf.h" 1
# 12 "/doner/potrace/source/src/backend_pdf.h"
...
# 17 "/doner/potrace/source/src/backend_pdf.c" 2
...
# 18 "/doner/potrace/source/src/backend_pdf.c" 2
# 1 "/doner/potrace/source/src/lists.h" 1
# 19 "/doner/potrace/source/src/backend_pdf.c" 2




# 1 "../config.h" 1
# 24 "/doner/potrace/source/src/backend_pdf.c" 2
...
static inline void intarray_init(intarray_t *ar) {
  ar->size = 0;
  ar->data = 
# 39 "/doner/potrace/source/src/backend_pdf.c" 3 4
            ((void *)0)
# 39 "/doner/potrace/source/src/backend_pdf.c"
                ;
}
...
static inline void intarray_term(intarray_t *ar) {
  ...
  ar->size = 0;
  ar->data = 
# 45 "/doner/potrace/source/src/backend_pdf.c" 3 4
            ((void *)0)
# 45 "/doner/potrace/source/src/backend_pdf.c"
                ;
}
...
# 86 "/doner/potrace/source/src/backend_pdf.c"
...
# 96 "/doner/potrace/source/src/backend_pdf.c" 3 4
 __builtin_va_start(
# 96 "/doner/potrace/source/src/backend_pdf.c"
 args
# 96 "/doner/potrace/source/src/backend_pdf.c" 3 4
 ,
# 96 "/doner/potrace/source/src/backend_pdf.c"
...
# 99 "/doner/potrace/source/src/backend_pdf.c" 3 4
 __builtin_va_end(
# 99 "/doner/potrace/source/src/backend_pdf.c"
 args
# 99 "/doner/potrace/source/src/backend_pdf.c" 3 4
 )
# 99 "/doner/potrace/source/src/backend_pdf.c"
...
# 110 "/doner/potrace/source/src/backend_pdf.c" 3 4
 __builtin_va_start(
# 110 "/doner/potrace/source/src/backend_pdf.c"
 args
# 110 "/doner/potrace/source/src/backend_pdf.c" 3 4
 ,
# 110 "/doner/potrace/source/src/backend_pdf.c"
...
# 113 "/doner/potrace/source/src/backend_pdf.c" 3 4
 __builtin_va_end(
# 113 "/doner/potrace/source/src/backend_pdf.c"
 args
# 113 "/doner/potrace/source/src/backend_pdf.c" 3 4
 )
# 113 "/doner/potrace/source/src/backend_pdf.c"
...
static int render0(potrace_path_t *plist) {
  ...
  for (p=plist; p!=
# 232 "/doner/potrace/source/src/backend_pdf.c" 3 4
 ((void *)0)
# 232 "/doner/potrace/source/src/backend_pdf.c"
 ; p=p->next) {
    pdf_path(&p->curve);
    ship("h\n");
    if (p->next == 
# 235 "/doner/potrace/source/src/backend_pdf.c" 3 4
                  ((void *)0) 
# 235 "/doner/potrace/source/src/backend_pdf.c"
                       || p->next->sign == '+') {
      ship("f\n");
    }
  }
...
static int render0_opaque(potrace_path_t *plist) {
  ...
  for (p=plist; p!=
# 246 "/doner/potrace/source/src/backend_pdf.c" 3 4
 ((void *)0)
# 246 "/doner/potrace/source/src/backend_pdf.c"
 ; p=p->next) {
    pdf_path(&p->curve);
    ship("h\n");
...
int init_pdf(FILE *fout)
{
 ...
 shipclear("2 0 obj\n"
  "<</Creator"
  "(""potrace"" ""1.11"", written by Peter Selinger 2001-2013)>>\n"
  "endobj\n");
