# 1 "/doner/potrace/source/src/progress_bar.c"
...
# 9 "/doner/potrace/source/src/progress_bar.c" 2
...
# 10 "/doner/potrace/source/src/progress_bar.c" 2
...
# 11 "/doner/potrace/source/src/progress_bar.c" 2
...
# 12 "/doner/potrace/source/src/progress_bar.c" 2
...
# 14 "/doner/potrace/source/src/progress_bar.c" 2
...
# 15 "/doner/potrace/source/src/progress_bar.c" 2
...
static void vt100_progress(double d, void *data) {
  ...
  if (d >= p->dnext) {
    ...
    fprintf(
# 43 "/doner/potrace/source/src/progress_bar.c" 3 4
           stderr
# 43 "/doner/potrace/source/src/progress_bar.c"
                 , "%-21s |%-40s| %d%% ""\033[G""", p->name, b+40-tick, perc);
    fflush(
# 44 "/doner/potrace/source/src/progress_bar.c" 3 4
          stderr
# 44 "/doner/potrace/source/src/progress_bar.c"
                );
...
static int init_vt100_progress(potrace_progress_t *prog, const char *filename, int count) {
  ...
  if (count != 0) {
    ...
    s = filename;
    if ((q = strrchr(s, '/')) != 
# 68 "/doner/potrace/source/src/progress_bar.c" 3 4
                                ((void *)0)
# 68 "/doner/potrace/source/src/progress_bar.c"
                                    ) {
      s = q+1;
    }
    len = strlen(s);
...
static void term_vt100_progress(potrace_progress_t *prog) {
  fprintf(
# 96 "/doner/potrace/source/src/progress_bar.c" 3 4
         stderr
# 96 "/doner/potrace/source/src/progress_bar.c"
               , "\n");
  fflush(
# 97 "/doner/potrace/source/src/progress_bar.c" 3 4
        stderr
# 97 "/doner/potrace/source/src/progress_bar.c"
              );
  free(prog->data);
  return;
}
...
static void simplified_progress(double d, void *data) {
  ...
  if (d >= p->dnext) {
    ...
    while (p->n < tick) {
      fputc('=', 
# 130 "/doner/potrace/source/src/progress_bar.c" 3 4
                stderr
# 130 "/doner/potrace/source/src/progress_bar.c"
                      );
      p->n++;
    }
    fflush(
# 133 "/doner/potrace/source/src/progress_bar.c" 3 4
          stderr
# 133 "/doner/potrace/source/src/progress_bar.c"
                );
    p->dnext = (tick+0.995) / 40.0;
  }
}
...
static int init_simplified_progress(potrace_progress_t *prog, const char *filename, int count) {
  ...
  if (count != 0) {
    ...
    s = filename;
    if ((q = strrchr(s, '/')) != 
# 159 "/doner/potrace/source/src/progress_bar.c" 3 4
                                ((void *)0)
# 159 "/doner/potrace/source/src/progress_bar.c"
                                    ) {
      s = q+1;
    }
    len = strlen(s);
  ...
  fprintf(
# 173 "/doner/potrace/source/src/progress_bar.c" 3 4
         stderr
# 173 "/doner/potrace/source/src/progress_bar.c"
               , "%-21s |", buf);
...
static void term_simplified_progress(potrace_progress_t *prog) {
  ...
  fprintf(
# 191 "/doner/potrace/source/src/progress_bar.c" 3 4
         stderr
# 191 "/doner/potrace/source/src/progress_bar.c"
               , "| 100%%\n");
  fflush(
# 192 "/doner/potrace/source/src/progress_bar.c" 3 4
        stderr
# 192 "/doner/potrace/source/src/progress_bar.c"
              );
  free(p);
  return;
}
