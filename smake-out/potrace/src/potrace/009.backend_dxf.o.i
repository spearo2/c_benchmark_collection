# 1 "/doner/potrace/source/src/backend_dxf.c"
...
# 8 "/doner/potrace/source/src/backend_dxf.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 9 "/doner/potrace/source/src/backend_dxf.c" 2
...
# 10 "/doner/potrace/source/src/backend_dxf.c" 2
...
# 11 "/doner/potrace/source/src/backend_dxf.c" 2
...
# 13 "/doner/potrace/source/src/backend_dxf.c" 2
# 1 "/doner/potrace/source/src/backend_dxf.h" 1
# 12 "/doner/potrace/source/src/backend_dxf.h"
int page_dxf(FILE *fout, potrace_path_t *plist, imginfo_t *imginfo);
# 14 "/doner/potrace/source/src/backend_dxf.c" 2

# 1 "/doner/potrace/source/src/lists.h" 1
# 16 "/doner/potrace/source/src/backend_dxf.c" 2




# 1 "../config.h" 1
# 21 "/doner/potrace/source/src/backend_dxf.c" 2
# 31 "/doner/potrace/source/src/backend_dxf.c"
...
# 81 "/doner/potrace/source/src/backend_dxf.c" 3 4
 __builtin_va_start(
# 81 "/doner/potrace/source/src/backend_dxf.c"
 args
# 81 "/doner/potrace/source/src/backend_dxf.c" 3 4
 ,
# 81 "/doner/potrace/source/src/backend_dxf.c"
...
# 83 "/doner/potrace/source/src/backend_dxf.c" 3 4
 __builtin_va_end(
# 83 "/doner/potrace/source/src/backend_dxf.c"
 args
# 83 "/doner/potrace/source/src/backend_dxf.c" 3 4
 )
# 83 "/doner/potrace/source/src/backend_dxf.c"
...
# 144 "/doner/potrace/source/src/backend_dxf.c"
...
int page_dxf(FILE *fout, potrace_path_t *plist, imginfo_t *imginfo) {
  ...
  ship_comment(fout, "DXF data, created by ""potrace"" ""1.11"", written by Peter Selinger 2001-2013");
  ...
  for (p=plist; p!=
# 268 "/doner/potrace/source/src/backend_dxf.c" 3 4
 ((void *)0)
# 268 "/doner/potrace/source/src/backend_dxf.c"
 ; p=p->next) {
