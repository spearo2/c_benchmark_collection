# 1 "/doner/potrace/source/src/backend_pgm.c"
...
# 1 "<command-line>" 2
# 1 "/doner/potrace/source/src/backend_pgm.c"
# 11 "/doner/potrace/source/src/backend_pgm.c"
...
# 12 "/doner/potrace/source/src/backend_pgm.c" 2

# 1 "/doner/potrace/source/src/backend_pgm.h" 1
# 9 "/doner/potrace/source/src/backend_pgm.h"
...
# 10 "/doner/potrace/source/src/backend_pgm.h" 2
...
# 12 "/doner/potrace/source/src/backend_pgm.h" 2
...
# 13 "/doner/potrace/source/src/backend_pgm.h" 2

int page_pgm(FILE *fout, potrace_path_t *plist, imginfo_t *imginfo);
# 14 "/doner/potrace/source/src/backend_pgm.c" 2

# 1 "/doner/potrace/source/src/lists.h" 1
# 16 "/doner/potrace/source/src/backend_pgm.c" 2
...
# 17 "/doner/potrace/source/src/backend_pgm.c" 2
# 1 "/doner/potrace/source/src/render.h" 1
# 11 "/doner/potrace/source/src/render.h"
struct render_s {
  greymap_t *gm;
  double x0, y0, x1, y1;
  int x0i, y0i, x1i, y1i;
...
# 18 "/doner/potrace/source/src/backend_pgm.c" 2
...
# 1 "../config.h" 1
# 24 "/doner/potrace/source/src/backend_pgm.c" 2
...
int page_pgm(FILE *fout, potrace_path_t *plist, imginfo_t *imginfo) {
  ...
  trans_t t;
  int mode;
  char *comment = "created by ""potrace"" ""1.11"", written by Peter Selinger 2001-2013";
  ...
  for (p=plist; p!=
# 90 "/doner/potrace/source/src/backend_pgm.c" 3 4
 ((void *)0)
# 90 "/doner/potrace/source/src/backend_pgm.c"
 ; p=p->next) {
  ...
  mode = imginfo->width * imginfo->height < 0 ? 4 : 3;
