# 1 "/doner/potrace/source/src/backend_eps.c"
...
# 1 "<command-line>" 2
# 1 "/doner/potrace/source/src/backend_eps.c"
# 11 "/doner/potrace/source/src/backend_eps.c"
...
# 12 "/doner/potrace/source/src/backend_eps.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 13 "/doner/potrace/source/src/backend_eps.c" 2
...
# 14 "/doner/potrace/source/src/backend_eps.c" 2
...
# 15 "/doner/potrace/source/src/backend_eps.c" 2
...
# 16 "/doner/potrace/source/src/backend_eps.c" 2
...
# 18 "/doner/potrace/source/src/backend_eps.c" 2
...
# 19 "/doner/potrace/source/src/backend_eps.c" 2
# 1 "/doner/potrace/source/src/main.h" 1
# 10 "/doner/potrace/source/src/main.h"
# 1 "../config.h" 1
# 11 "/doner/potrace/source/src/main.h" 2



# 1 "/doner/potrace/source/src/progress_bar.h" 1
# 14 "/doner/potrace/source/src/progress_bar.h"
...
# 15 "/doner/potrace/source/src/main.h" 2

# 1 "/doner/potrace/source/src/trans.h" 1
# 12 "/doner/potrace/source/src/trans.h"
struct trans_s {
  double bb[2];
  double orig[2];
  double x[2];
...
# 17 "/doner/potrace/source/src/main.h" 2
...
# 58 "/doner/potrace/source/src/main.h"
struct backend_s;
...
struct info_s {
  ...
  double sy;
  double stretch;
  dim_t lmar_d, rmar_d, tmar_d, bmar_d;
  double angle;
...
struct imginfo_s {
  ...
  double width;
  double height;
  double lmar, rmar, tmar, bmar;
  trans_t trans;
};
typedef struct imginfo_s imginfo_t;
# 20 "/doner/potrace/source/src/backend_eps.c" 2
# 1 "/doner/potrace/source/src/backend_eps.h" 1
# 12 "/doner/potrace/source/src/backend_eps.h"
...
# 21 "/doner/potrace/source/src/backend_eps.c" 2
# 1 "/doner/potrace/source/src/flate.h" 1
# 9 "/doner/potrace/source/src/flate.h"
...
# 22 "/doner/potrace/source/src/backend_eps.c" 2
# 1 "/doner/potrace/source/src/lists.h" 1
# 23 "/doner/potrace/source/src/backend_eps.c" 2



# 1 "../config.h" 1
# 27 "/doner/potrace/source/src/backend_eps.c" 2
...
typedef int color_t;
# 48 "/doner/potrace/source/src/backend_eps.c"
...
# 58 "/doner/potrace/source/src/backend_eps.c" 3 4
 __builtin_va_start(
# 58 "/doner/potrace/source/src/backend_eps.c"
 args
# 58 "/doner/potrace/source/src/backend_eps.c" 3 4
 ,
# 58 "/doner/potrace/source/src/backend_eps.c"
...
# 61 "/doner/potrace/source/src/backend_eps.c" 3 4
 __builtin_va_end(
# 61 "/doner/potrace/source/src/backend_eps.c"
 args
# 61 "/doner/potrace/source/src/backend_eps.c" 3 4
 )
# 61 "/doner/potrace/source/src/backend_eps.c"
...
# 72 "/doner/potrace/source/src/backend_eps.c" 3 4
 __builtin_va_start(
# 72 "/doner/potrace/source/src/backend_eps.c"
 args
# 72 "/doner/potrace/source/src/backend_eps.c" 3 4
 ,
# 72 "/doner/potrace/source/src/backend_eps.c"
...
# 75 "/doner/potrace/source/src/backend_eps.c" 3 4
 __builtin_va_end(
# 75 "/doner/potrace/source/src/backend_eps.c"
 args
# 75 "/doner/potrace/source/src/backend_eps.c" 3 4
 )
# 75 "/doner/potrace/source/src/backend_eps.c"
...
# 202 "/doner/potrace/source/src/backend_eps.c"
...
static int eps_path_short(privcurve_t *curve) {
  int i, i1;
  long int *bq = 
# 228 "/doner/potrace/source/src/backend_eps.c" 3 4
                ((void *)0)
# 228 "/doner/potrace/source/src/backend_eps.c"
                    ;
  long int *aq = 
# 229 "/doner/potrace/source/src/backend_eps.c" 3 4
                ((void *)0)
# 229 "/doner/potrace/source/src/backend_eps.c"
                    ;
  point_t *v = 
# 230 "/doner/potrace/source/src/backend_eps.c" 3 4
              ((void *)0)
# 230 "/doner/potrace/source/src/backend_eps.c"
                  ;
  dpoint_t *q = 
# 231 "/doner/potrace/source/src/backend_eps.c" 3 4
               ((void *)0)
# 231 "/doner/potrace/source/src/backend_eps.c"
                   ;
  double M;
  int m = curve->n;

  if ((bq = (long int *)malloc((m)*sizeof(long int))) == 
# 235 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 235 "/doner/potrace/source/src/backend_eps.c"
 ) goto malloc_error;
  if ((aq = (long int *)malloc((m)*sizeof(long int))) == 
# 236 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 236 "/doner/potrace/source/src/backend_eps.c"
 ) goto malloc_error;
  if ((v = (point_t *)malloc((m)*sizeof(point_t))) == 
# 237 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 237 "/doner/potrace/source/src/backend_eps.c"
 ) goto malloc_error;
  if ((q = (dpoint_t *)malloc((m)*sizeof(dpoint_t))) == 
# 238 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 238 "/doner/potrace/source/src/backend_eps.c"
 ) goto malloc_error;
  ...
  for (i=0; i<m; i++) {
    i1 = mod(i+1,m);
    M = ((10)>(((((v[i1].x-v[i].x)>0 ? (v[i1].x-v[i].x) : -(v[i1].x-v[i].x)))>(((v[i1].y-v[i].y)>0 ? (v[i1].y-v[i].y) : -(v[i1].y-v[i].y))) ? (((v[i1].x-v[i].x)>0 ? (v[i1].x-v[i].x) : -(v[i1].x-v[i].x))) : (((v[i1].y-v[i].y)>0 ? (v[i1].y-v[i].y) : -(v[i1].y-v[i].y))))) ? (10) : (((((v[i1].x-v[i].x)>0 ? (v[i1].x-v[i].x) : -(v[i1].x-v[i].x)))>(((v[i1].y-v[i].y)>0 ? (v[i1].y-v[i].y) : -(v[i1].y-v[i].y))) ? (((v[i1].x-v[i].x)>0 ? (v[i1].x-v[i].x) : -(v[i1].x-v[i].x))) : (((v[i1].y-v[i].y)>0 ? (v[i1].y-v[i].y) : -(v[i1].y-v[i].y))))));
  ...
  for (i=0; i<m; i++) {
    i1 = mod(i+1,m);
    M = ((10)>(((((((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x)))>(((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y))) ? (((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x))) : (((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y)))))>(((((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x)))>(((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))) ? (((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x))) : (((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))))) ? (((((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x)))>(((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y))) ? (((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x))) : (((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y))))) : (((((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x)))>(((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))) ? (((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x))) : (((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))))))) ? (10) : (((((((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x)))>(((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y))) ? (((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x))) : (((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y)))))>(((((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x)))>(((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))) ? (((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x))) : (((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))))) ? (((((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x)))>(((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y))) ? (((q[i].x-v[i].x)>0 ? (q[i].x-v[i].x) : -(q[i].x-v[i].x))) : (((q[i].y-v[i].y)>0 ? (q[i].y-v[i].y) : -(q[i].y-v[i].y))))) : (((((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x)))>(((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))) ? (((v[i].x-q[i1].x)>0 ? (v[i].x-q[i1].x) : -(v[i].x-q[i1].x))) : (((v[i].y-q[i1].y)>0 ? (v[i].y-q[i1].y) : -(v[i].y-q[i1].y))))))))
                                                     ;
    if (curve->tag[i] == 1) {
...
static void eps_jaggy(potrace_path_t *plist) {
  ...
  ship(".9 setgray\n");
  for (p=plist; p!=
# 324 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 324 "/doner/potrace/source/src/backend_eps.c"
 ; p=p->next) {
 ...
 if (pt[i].x != cur.x && pt[i].y != cur.y) {
    ...
    if (p->next == 
# 351 "/doner/potrace/source/src/backend_eps.c" 3 4
                  ((void *)0) 
# 351 "/doner/potrace/source/src/backend_eps.c"
                       || p->next->sign == '+') {
      ship("fill\n");
    }
  }
...
static int render0(potrace_path_t *plist) {
  ...
  if (info.longcoding) {
    ...
    for (p=plist; p!=
# 451 "/doner/potrace/source/src/backend_eps.c" 3 4
   ((void *)0)
# 451 "/doner/potrace/source/src/backend_eps.c"
   ; p=p->next) {
      eps_path(p->priv->fcurve);
      ship("closepath\n");
      if (p->next == 
# 454 "/doner/potrace/source/src/backend_eps.c" 3 4
                    ((void *)0) 
# 454 "/doner/potrace/source/src/backend_eps.c"
                         || p->next->sign == '+') {
 ship("fill\n");
      }
    }
    ...
    for (p=plist; p!=
# 459 "/doner/potrace/source/src/backend_eps.c" 3 4
   ((void *)0)
# 459 "/doner/potrace/source/src/backend_eps.c"
   ; p=p->next) {
      eps_path(p->priv->fcurve);
      if (p->next == 
# 461 "/doner/potrace/source/src/backend_eps.c" 3 4
                    ((void *)0) 
# 461 "/doner/potrace/source/src/backend_eps.c"
                         || p->next->sign == '+') {
 ship("b\n");
      } else {
 ship("z\n");
...
static int render0_opaque(potrace_path_t *plist) {
  ...
  if (info.longcoding) {
    for (p=plist; p!=
# 476 "/doner/potrace/source/src/backend_eps.c" 3 4
   ((void *)0)
# 476 "/doner/potrace/source/src/backend_eps.c"
   ; p=p->next) {
      eps_path(p->priv->fcurve);
      ship("closepath\n");
    ...
    for (p=plist; p!=
# 483 "/doner/potrace/source/src/backend_eps.c" 3 4
   ((void *)0)
# 483 "/doner/potrace/source/src/backend_eps.c"
   ; p=p->next) {
      eps_path(p->priv->fcurve);
      ship(p->sign=='+' ? "b\n" : "w\n");
    }
...
static int render1(potrace_path_t *plist) {
  ...
  for (p=plist; p!=
# 498 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 498 "/doner/potrace/source/src/backend_eps.c"
 ; p=p->next) {
...
static int render2(potrace_path_t *plist) {
  ...
  for (p=plist; p!=
# 546 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 546 "/doner/potrace/source/src/backend_eps.c"
 ; p=p->next) {

    eps_polygon(&p->priv->curve, 0x000000);
    eps_L(&p->priv->curve, 0x000000);
...
static int render_debug(potrace_path_t *plist) {
  ...
  count = -1;
  for (p=plist; p!=
# 593 "/doner/potrace/source/src/backend_eps.c" 3 4
 ((void *)0)
# 593 "/doner/potrace/source/src/backend_eps.c"
 ; p=p->next) {
    count++;
    ...
    if (info.param->opticurve) {
      ...
      eps_polygon(&p->priv->ocurve, 0x008000);
...
static int eps_init(imginfo_t *imginfo) {
  ...
  shipcom("%%%%Creator: ""potrace"" ""1.11"", written by Peter Selinger 2001-2013\n");
