# 1 "/doner/potrace/source/src/bbox.c"
...
# 8 "/doner/potrace/source/src/bbox.c" 2
...
# 9 "/doner/potrace/source/src/bbox.c" 2
...
# 9 "/doner/potrace/source/src/bbox.h" 2
...
# 11 "/doner/potrace/source/src/bbox.c" 2

# 1 "/doner/potrace/source/src/lists.h" 1
# 13 "/doner/potrace/source/src/bbox.c" 2
...
static void bezier_limits(double x0, double x1, double x2, double x3, interval_t *i) {
  double a, b, c, d, r;
  double t, x;
# 73 "/doner/potrace/source/src/bbox.c"
  extend(i, x3);
...
void path_limits(potrace_path_t *path, dpoint_t dir, interval_t *i) {
  ...
  if (path == 
# 138 "/doner/potrace/source/src/bbox.c" 3 4
             ((void *)0)
# 138 "/doner/potrace/source/src/bbox.c"
                 ) {
    interval(i, 0, 0);
    return;
  }
  ...
  for (p=path; p!=
# 147 "/doner/potrace/source/src/bbox.c" 3 4
 ((void *)0)
# 147 "/doner/potrace/source/src/bbox.c"
 ; p=p->next) {
