# 1 "/doner/potrace/source/src/flate.c"
...
# 1 "<command-line>" 2
# 1 "/doner/potrace/source/src/flate.c"
# 26 "/doner/potrace/source/src/flate.c"
# 1 "../config.h" 1
# 27 "/doner/potrace/source/src/flate.c" 2
...
# 30 "/doner/potrace/source/src/flate.c" 2
...
# 31 "/doner/potrace/source/src/flate.c" 2
...
# 32 "/doner/potrace/source/src/flate.c" 2
...
# 33 "/doner/potrace/source/src/flate.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 36 "/doner/potrace/source/src/flate.c" 2
...
# 39 "/doner/potrace/source/src/flate.c" 2
# 1 "/doner/potrace/source/src/lzw.h" 1
# 11 "/doner/potrace/source/src/lzw.h"
struct lzw_stream_s {
  char *next_in;
  int avail_in;
  char *next_out;
...
int pdf_xship(FILE *f, int filter, char *s, int len) {
 ...
 int n=0;
  ...
  if (filter && !fstate) {
    ...
    c_stream.zalloc = 
# 71 "/doner/potrace/source/src/flate.c" 3 4
                     0
# 71 "/doner/potrace/source/src/flate.c"
                           ;
    c_stream.zfree = 
# 72 "/doner/potrace/source/src/flate.c" 3 4
                    0
# 72 "/doner/potrace/source/src/flate.c"
                          ;
    c_stream.opaque = 
# 73 "/doner/potrace/source/src/flate.c" 3 4
                     0
# 73 "/doner/potrace/source/src/flate.c"
                           ;
    err = 
# 74 "/doner/potrace/source/src/flate.c" 3 4
         deflateInit_((
# 74 "/doner/potrace/source/src/flate.c"
         &c_stream
# 74 "/doner/potrace/source/src/flate.c" 3 4
         ), (
# 74 "/doner/potrace/source/src/flate.c"
...
# 74 "/doner/potrace/source/src/flate.c"
                                  ;
    if (err != 
# 75 "/doner/potrace/source/src/flate.c" 3 4
              0
# 75 "/doner/potrace/source/src/flate.c"
                  ) {
      fprintf(
# 76 "/doner/potrace/source/src/flate.c" 3 4
             stderr
# 76 "/doner/potrace/source/src/flate.c"
                   , "deflateInit: %s (%d)\n", c_stream.msg, err);
      exit(1);
    }
    c_stream.avail_in = 0;
    ...
    do {
      ...
      c_stream.avail_out = 1000;

      err = deflate(&c_stream, 
# 88 "/doner/potrace/source/src/flate.c" 3 4
                              4
# 88 "/doner/potrace/source/src/flate.c"
                                      );
      if (err != 
# 89 "/doner/potrace/source/src/flate.c" 3 4
                0 
# 89 "/doner/potrace/source/src/flate.c"
                     && err != 
# 89 "/doner/potrace/source/src/flate.c" 3 4
                               1
# 89 "/doner/potrace/source/src/flate.c"
 ...
 fprintf(
# 90 "/doner/potrace/source/src/flate.c" 3 4
        stderr
# 90 "/doner/potrace/source/src/flate.c"
              , "deflate: %s (%d)\n", c_stream.msg, err);
 exit(1);
      }
      n += fwrite(outbuf, 1, 1000 -c_stream.avail_out, f);
    } while (err != 
# 94 "/doner/potrace/source/src/flate.c" 3 4
                   1
# 94 "/doner/potrace/source/src/flate.c"
                               );
  ...
  do {
    ...
    err = deflate(&c_stream, 
# 111 "/doner/potrace/source/src/flate.c" 3 4
                            0
# 111 "/doner/potrace/source/src/flate.c"
                                      );
    if (err != 
# 112 "/doner/potrace/source/src/flate.c" 3 4
              0
# 112 "/doner/potrace/source/src/flate.c"
                  ) {
      fprintf(
# 113 "/doner/potrace/source/src/flate.c" 3 4
             stderr
# 113 "/doner/potrace/source/src/flate.c"
                   , "deflate: %s (%d)\n", c_stream.msg, err);
      exit(1);
    }
    n += fwrite(outbuf, 1, 1000 -c_stream.avail_out, f);
...
int flate_xship(FILE *f, int filter, char *s, int len) {
  ...
  if (filter && !fstate) {
    ...
    c_stream.zalloc = 
# 135 "/doner/potrace/source/src/flate.c" 3 4
                     0
# 135 "/doner/potrace/source/src/flate.c"
                           ;
    c_stream.zfree = 
# 136 "/doner/potrace/source/src/flate.c" 3 4
                    0
# 136 "/doner/potrace/source/src/flate.c"
                          ;
    c_stream.opaque = 
# 137 "/doner/potrace/source/src/flate.c" 3 4
                     0
# 137 "/doner/potrace/source/src/flate.c"
                           ;
    err = 
# 138 "/doner/potrace/source/src/flate.c" 3 4
         deflateInit_((
# 138 "/doner/potrace/source/src/flate.c"
         &c_stream
# 138 "/doner/potrace/source/src/flate.c" 3 4
         ), (
# 138 "/doner/potrace/source/src/flate.c"
...
# 138 "/doner/potrace/source/src/flate.c"
                                  ;
    if (err != 
# 139 "/doner/potrace/source/src/flate.c" 3 4
              0
# 139 "/doner/potrace/source/src/flate.c"
                  ) {
      fprintf(
# 140 "/doner/potrace/source/src/flate.c" 3 4
             stderr
# 140 "/doner/potrace/source/src/flate.c"
                   , "deflateInit: %s (%d)\n", c_stream.msg, err);
      exit(1);
    }
    c_stream.avail_in = 0;
    ...
    do {
      ...
      err = deflate(&c_stream, 
# 153 "/doner/potrace/source/src/flate.c" 3 4
                              4
# 153 "/doner/potrace/source/src/flate.c"
                                      );
      if (err != 
# 154 "/doner/potrace/source/src/flate.c" 3 4
                0 
# 154 "/doner/potrace/source/src/flate.c"
                     && err != 
# 154 "/doner/potrace/source/src/flate.c" 3 4
                               1
# 154 "/doner/potrace/source/src/flate.c"
 ...
 fprintf(
# 155 "/doner/potrace/source/src/flate.c" 3 4
        stderr
# 155 "/doner/potrace/source/src/flate.c"
              , "deflate: %s (%d)\n", c_stream.msg, err);
 exit(1);
      }
      n += a85write(f, outbuf, 1000 -c_stream.avail_out);
    } while (err != 
# 159 "/doner/potrace/source/src/flate.c" 3 4
                   1
# 159 "/doner/potrace/source/src/flate.c"
                               );
  ...
  do {
    ...
    err = deflate(&c_stream, 
# 178 "/doner/potrace/source/src/flate.c" 3 4
                            0
# 178 "/doner/potrace/source/src/flate.c"
                                      );
    if (err != 
# 179 "/doner/potrace/source/src/flate.c" 3 4
              0
# 179 "/doner/potrace/source/src/flate.c"
                  ) {
      fprintf(
# 180 "/doner/potrace/source/src/flate.c" 3 4
             stderr
# 180 "/doner/potrace/source/src/flate.c"
                   , "deflate: %s (%d)\n", c_stream.msg, err);
      exit(1);
    }
    n += a85write(f, outbuf, 1000 -c_stream.avail_out);
...
# 206 "/doner/potrace/source/src/flate.c"
int lzw_xship(FILE *f, int filter, char *str, int len) {
  static int fstate = 0;
  static lzw_stream_t *s = 
# 208 "/doner/potrace/source/src/flate.c" 3 4
                          ((void *)0)
# 208 "/doner/potrace/source/src/flate.c"
                              ;
  char outbuf[1000];
  int err;
  int n=0;
  ...
  if (filter && !fstate) {
    ...
    s = lzw_init();
    if (s == 
# 219 "/doner/potrace/source/src/flate.c" 3 4
            ((void *)0)
# 219 "/doner/potrace/source/src/flate.c"
                ) {
      fprintf(
# 220 "/doner/potrace/source/src/flate.c" 3 4
             stderr
# 220 "/doner/potrace/source/src/flate.c"
                   , "lzw_init: %s\n", strerror(
# 220 "/doner/potrace/source/src/flate.c" 3 4
                                                (*__errno_location ())
# 220 "/doner/potrace/source/src/flate.c"
    ...
    do {
      ...
      err = lzw_compress(s, 1);
      if (err) {
 fprintf(
# 236 "/doner/potrace/source/src/flate.c" 3 4
        stderr
# 236 "/doner/potrace/source/src/flate.c"
              , "lzw_compress: %s\n", strerror(
# 236 "/doner/potrace/source/src/flate.c" 3 4
                                               (*__errno_location ())
# 236 "/doner/potrace/source/src/flate.c"
 ...
 exit(1);
      ...
      n += a85write(f, outbuf, 1000 - s->avail_out);
    } while (s->avail_out == 0);
    ...
    lzw_free(s);
    s = 
# 245 "/doner/potrace/source/src/flate.c" 3 4
       ((void *)0)
# 245 "/doner/potrace/source/src/flate.c"
           ;
  ...
  do {
    ...
    err = lzw_compress(s, 0);
    if (err) {
      fprintf(
# 264 "/doner/potrace/source/src/flate.c" 3 4
             stderr
# 264 "/doner/potrace/source/src/flate.c"
                   , "lzw_compress: %s\n", strerror(
# 264 "/doner/potrace/source/src/flate.c" 3 4
                                                    (*__errno_location ())
# 264 "/doner/potrace/source/src/flate.c"
