# 1 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
# 1 "/doner/libzip/libzip-1.1.2/examples//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
# 34 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
...
# 35 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 2
...
# 36 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 2
...
# 41 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 2
...
get_data(void **datap, size_t *sizep, const char *archive)
{
 ...
 if (
# 50 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
    (*__errno_location ()) 
# 50 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
          != 
# 50 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
             2
# 50 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
     ...
     fprintf(
# 51 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
            stderr
# 51 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                  , "can't stat %s: %s\n", archive, strerror(
# 51 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                             (*__errno_location ())
# 51 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 *datap = 
# 55 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
         ((void *)0)
# 55 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
             ;
 *sizep = 0;
...
# 61 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                ((void *)0)
# 61 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                                    ) {
 fprintf(
# 62 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 62 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "can't allocate buffer\n");
 return -1;
    }

    if ((fp=fopen(archive, "r")) == 
# 66 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                   ((void *)0)
# 66 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                       ) {
 free(*datap);
 fprintf(
# 68 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 68 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "can't open %s: %s\n", archive, strerror(
# 68 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                         (*__errno_location ())
# 68 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 free(*datap);
 fprintf(
# 74 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 74 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "can't read %s: %s\n", archive, strerror(
# 74 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                         (*__errno_location ())
# 74 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
...
use_data(void *data, size_t size, const char *archive)
{
    ...
    if (data == 
# 99 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
               ((void *)0)
# 99 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                   ) {
 if (remove(archive) < 0 && 
# 100 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                           (*__errno_location ()) 
# 100 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                 != 
# 100 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                    2
# 100 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
     ...
     fprintf(
# 101 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
            stderr
# 101 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                  , "can't remove %s: %s\n", archive, strerror(
# 101 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                               (*__errno_location ())
# 101 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
...
# 107 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                      ((void *)0)
# 107 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                          ) {
 fprintf(
# 108 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 108 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "can't open %s: %s\n", archive, strerror(
# 108 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                         (*__errno_location ())
# 108 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 fprintf(
# 112 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 112 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "can't write %s: %s\n", archive, strerror(
# 112 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                          (*__errno_location ())
# 112 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 return -1;
    ...
    if (fclose(fp) < 0) {
 fprintf(
# 117 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 117 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "can't write %s: %s\n", archive, strerror(
# 117 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                          (*__errno_location ())
# 117 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
...
main(int argc, char *argv[])
{
    ...
    if (argc < 2) {
 fprintf(
# 136 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 136 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
              , "usage: %s archive\n", argv[0]);
 return 1;
    }
    archive = argv[1];
...
# 148 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                                  ((void *)0)
# 148 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                                                      ) {
 fprintf(
# 149 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 149 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
...
# 156 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                      ((void *)0)
# 156 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                                          ) {
 fprintf(
# 157 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 157 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 return 1;
    ...
    if (zip_close(za) < 0) {
 fprintf(
# 172 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
        stderr
# 172 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 data = 
# 181 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
       ((void *)0)
# 181 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
           ;
    }
    else {
 zip_stat_t zst;
 ...
 if (zip_source_stat(src, &zst) < 0) {
     fprintf(
# 187 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
            stderr
# 187 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 if (zip_source_open(src) < 0) {
     fprintf(
# 194 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
            stderr
# 194 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                  , "can't open source: %s\n", zip_error_strerror(zip_source_error(src)));
     return 1;
 }
 if ((data = malloc(size)) == 
# 197 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                             ((void *)0)
# 197 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                                 ) {
     fprintf(
# 198 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
            stderr
# 198 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
                  , "malloc failed: %s\n", strerror(
# 198 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
                                                    (*__errno_location ())
# 198 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
 ...
 if ((zip_uint64_t)zip_source_read(src, data, size) < size) {
     fprintf(
# 203 "/doner/libzip/libzip-1.1.2/examples/in-memory.c" 3 4
            stderr
# 203 "/doner/libzip/libzip-1.1.2/examples/in-memory.c"
