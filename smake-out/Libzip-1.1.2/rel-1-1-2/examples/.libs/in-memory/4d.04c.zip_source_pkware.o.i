# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 2
    ...
    zip_uint16_t em, int flags, const char *password)
{
    ...
    if (password == 
# 66 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
                   ((void *)0) 
# 66 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
                        || src == 
# 66 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
                                  ((void *)0) 
# 66 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
 ...
 return 
# 68 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
       ((void *)0)
# 68 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
           ;
    }
    if (flags & 1) {
 zip_error_set(&za->error, 24, 0);
 return 
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
       ((void *)0)
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
           ;
    }

    if ((ctx=(struct trad_pkware *)malloc(sizeof(*ctx))) == 
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
                                                           ((void *)0)
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
                                                               ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
       ((void *)0)
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
           ;
    }
    ...
    ctx->key[2] = 878082192;
    decrypt(ctx, 
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
                ((void *)0)
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
                    , (const zip_uint8_t *)password, strlen(password), 1);

    if ((s2=zip_source_layered(za, src, pkware_decrypt, ctx)) == 
# 87 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
                                                                ((void *)0)
# 87 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
                                                                    ) {
 pkware_free(ctx);
 return 
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c" 3 4
       ((void *)0)
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_source_pkware.c"
           ;
    }
