# 1 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c" 2
...
zip_get_num_entries(zip_t *za, zip_flags_t flags)
{
    ...
    if (za == 
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c" 3 4
             ((void *)0)
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c"
                 )
 return -1;
...
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c" 3 4
                                     ((void *)0)
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_get_num_entries.c"
                                         )
     --n;
