# 1 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 2
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 2
...
{
    if (buffer == 
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                 ((void *)0)
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                     ) {
        return;
    }
...
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
_Bool

# 62 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
_zip_buffer_eof(zip_buffer_t *buffer)
{
...
_zip_buffer_get(zip_buffer_t *buffer, zip_uint64_t length)
{
    ...
    if (!buffer->ok || buffer->offset + length < length || buffer->offset + length > buffer->size) {
        buffer->ok = 
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                    0
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                         ;
        return 
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
              ((void *)0)
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                  ;
    }
...
_zip_buffer_get_16(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
_zip_buffer_get_32(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 102 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 102 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
_zip_buffer_get_64(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 115 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 115 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
_zip_buffer_get_8(zip_buffer_t *buffer)
{
    ...
    if (data == 
# 129 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 129 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return 0;
    }
...
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
   _Bool 
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
        free_data = (data == 
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                             ((void *)0)
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
    ...
    if (data == 
# 150 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 150 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        if ((data = (zip_uint8_t *)malloc(size)) == 
# 151 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                                                   ((void *)0)
# 151 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                                                       ) {
            return 
# 152 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                  ((void *)0)
# 152 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                      ;
        }
    }

    if ((buffer = (zip_buffer_t *)malloc(sizeof(*buffer))) == 
# 156 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                                                             ((void *)0)
# 156 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                                                                 ) {
        if (free_data) {
            free(data);
        }
        return 
# 160 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
              ((void *)0)
# 160 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                  ;
    }

    buffer->ok = 
# 163 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                1
# 163 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                    ;
    buffer->data = data;
    buffer->size = size;
    buffer->offset = 0;
...
# 178 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                                                ((void *)0)
# 178 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                                                    ) {
        zip_error_set(error, 14, 0);
        return 
# 180 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
              ((void *)0)
# 180 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                  ;
    }
    ...
    if (_zip_read(src, buffer->data, size, error) < 0) {
        ...
        return 
# 185 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
              ((void *)0)
# 185 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                  ;
    }
...
# 199 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
_Bool

# 200 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
_zip_buffer_ok(zip_buffer_t *buffer)
{
    return buffer->ok;
}
...
_zip_buffer_put(zip_buffer_t *buffer, const void *src, size_t length)
{
    ...
    if (dst == 
# 211 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
              ((void *)0)
# 211 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                  ) {
        return -1;
    }
...
_zip_buffer_put_16(zip_buffer_t *buffer, zip_uint16_t i)
{
    ...
    if (data == 
# 225 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 225 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_put_32(zip_buffer_t *buffer, zip_uint32_t i)
{
    ...
    if (data == 
# 241 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 241 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_put_64(zip_buffer_t *buffer, zip_uint64_t i)
{
    ...
    if (data == 
# 259 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 259 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_put_8(zip_buffer_t *buffer, zip_uint8_t i)
{
    ...
    if (data == 
# 281 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
               ((void *)0)
# 281 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                   ) {
        return -1;
    }
...
_zip_buffer_set_offset(zip_buffer_t *buffer, zip_uint64_t offset)
{
    if (offset > buffer->size) {
        buffer->ok = 
# 295 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                    0
# 295 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                         ;
        return -1;
    }

    buffer->ok = 
# 299 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                1
# 299 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                    ;
...
_zip_buffer_skip(zip_buffer_t *buffer, zip_uint64_t length) {
    ...
    if (offset < buffer->offset) {
        buffer->ok = 
# 311 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c" 3 4
                    0
# 311 "/doner/libzip/libzip-1.1.2/lib/zip_buffer.c"
                         ;
        return -1;
    }
