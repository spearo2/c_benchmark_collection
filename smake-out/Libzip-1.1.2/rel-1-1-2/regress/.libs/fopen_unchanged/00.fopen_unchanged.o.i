# 1 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
# 35 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
...
# 36 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 2
...
# 41 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 2
...
main(int argc, char *argv[])
{
    ...
    if (argc != 2) {
 fprintf(
# 54 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
        stderr
# 54 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
              , "usage: %s archive\n", argv[0]);
 return 1;
    }
...
# 60 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
                                                   ((void *)0)
# 60 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
                                                       ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 63 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
        stderr
# 63 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
              , "can't open zip archive '%s': %s\n", archive, zip_error_strerror(&error));
 zip_error_fini(&error);
 return 1;
    }

    if ((zs=zip_source_buffer(za, teststr, strlen(teststr), 0)) == 
# 68 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
                                                                  ((void *)0)
# 68 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
                                                                      ) {
 fprintf(
# 69 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
        stderr
# 69 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
 ...
 fprintf(
# 74 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
        stderr
# 74 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
 ...
 return 1;
    ...
    if (zip_fopen(za, file, 8u) == 
# 80 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
                                                ((void *)0)
# 80 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
                                                    ) {
 fprintf(
# 81 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
        stderr
# 81 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
              , "can't zip_fopen file '%s': %s\n", file, zip_strerror(za));
 (void)zip_discard(za);
 return 1;
    }
    ...
    if (zip_close(za) == -1) {
 fprintf(
# 87 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c" 3 4
        stderr
# 87 "/doner/libzip/libzip-1.1.2/regress/fopen_unchanged.c"
