# 1 "/doner/libzip/libzip-1.1.2/lib/zip_fread.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_fread.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_fread.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_fread.c" 2
...
zip_fread(zip_file_t *zf, void *outbuf, zip_uint64_t toread)
{
 ...
 return -1;
    ...
    if (toread > 
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_fread.c" 3 4
                (9223372036854775807L)
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_fread.c"
                             ) {
