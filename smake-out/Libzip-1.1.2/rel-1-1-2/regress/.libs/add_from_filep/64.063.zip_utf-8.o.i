# 1 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c" 2



# 40 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
...
# 116 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
zip_encoding_type_t
_zip_guess_encoding(zip_string_t *str, zip_encoding_type_t expected_encoding)
{
    ...
    if (str == 
# 123 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c" 3 4
              ((void *)0)
# 123 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
                  )
     ...
     zip_uint32_t *utf8_lenp, zip_error_t *error)
{
 ...
 if (utf8_lenp)
     *utf8_lenp = 0;
 return 
# 228 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c" 3 4
       ((void *)0)
# 228 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
           ;
    }
...
# 235 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c" 3 4
                                                 ((void *)0)
# 235 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
                                                     ) {
 zip_error_set(error, 14, 0);
 return 
# 237 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c" 3 4
       ((void *)0)
# 237 "/doner/libzip/libzip-1.1.2/lib/zip_utf-8.c"
           ;
    }
