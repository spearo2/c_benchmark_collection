# 1 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c" 2
...
zip_stat_init(zip_stat_t *st)
{
    st->valid = 0;
    st->name = 
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c" 3 4
              ((void *)0)
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c"
                  ;
    st->index = 
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c" 3 4
               (18446744073709551615UL)
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_stat_init.c"
                             ;
    st->crc = 0;
    st->mtime = (time_t)-1;
    st->size = 0;
