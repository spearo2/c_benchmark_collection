# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 2
...
# 47 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
   _Bool 
# 47 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
        needs_seek;
};
...
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                                                  ((void *)0)
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                                                      , &za->error);
}
...
_zip_source_window_new(zip_source_t *src, zip_uint64_t start, zip_uint64_t length, zip_stat_t *st, zip_error_t *error)
{
    ...
    if (src == 
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
              ((void *)0) 
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                   || start + length < start) {
        zip_error_set(error, 18, 0);
        return 
# 67 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
              ((void *)0)
# 67 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                  ;
    }

    if ((ctx=(struct window *)malloc(sizeof(*ctx))) == 
# 70 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                                                      ((void *)0)
# 70 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                                                          ) {
        zip_error_set(error, 14, 0);
        return 
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
              ((void *)0)
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                  ;
    }
    ...
    ctx->supports = (zip_source_supports(src) & (((1<<(ZIP_SOURCE_OPEN)) | (1<<(ZIP_SOURCE_READ)) | (1<<(ZIP_SOURCE_CLOSE)) | (1<<(ZIP_SOURCE_STAT)) | (1<<(ZIP_SOURCE_ERROR)) | (1<<(ZIP_SOURCE_FREE))) | (1<<(ZIP_SOURCE_SEEK)) | (1<<(ZIP_SOURCE_TELL)) | (1<<(ZIP_SOURCE_SUPPORTS)))) | (zip_source_make_command_bitmap(ZIP_SOURCE_SUPPORTS, ZIP_SOURCE_TELL, -1));
    ctx->needs_seek = (ctx->supports & (1<<(ZIP_SOURCE_SEEK))) ? 
# 80 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                                                                                          1 
# 80 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                                                                                               : 
# 80 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                                                                                                 0
# 80 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
    ...
    if (st) {
        if (_zip_stat_merge(&ctx->stat, st, error) < 0) {
            free(ctx);
            return 
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                  ((void *)0)
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                      ;
        }
    }
...
# 160 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                                                                  0
# 160 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                                                                          ) < 0) {
                    _zip_error_set_from_source(&ctx->error, src);
                    return -1;
                }
...
_zip_register_source(zip_t *za, zip_source_t *src)
{
    ...
    if (za->nopen_source+1 >= za->nopen_source_alloc) {
        ...
        if (open_source == 
# 242 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c" 3 4
                          ((void *)0)
# 242 "/doner/libzip/libzip-1.1.2/lib/zip_source_window.c"
                              ) {
