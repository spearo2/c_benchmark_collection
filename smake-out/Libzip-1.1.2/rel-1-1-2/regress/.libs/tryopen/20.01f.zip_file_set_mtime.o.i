# 1 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 2
...
# 41 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 3 4
                                   ((void *)0)
# 41 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
                                       ) == 
# 41 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 3 4
                                            ((void *)0)
# 41 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
    ...
    changed = e->orig == 
# 51 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 3 4
                        ((void *)0) 
# 51 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
                             || mtime != e->orig->last_mod;

    if (changed) {
        if (e->changes == 
# 54 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 3 4
                         ((void *)0)
# 54 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 55 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 3 4
                                                          ((void *)0)
# 55 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
                                                              ) {
  ...
  _zip_dirent_free(e->changes);
                e->changes = 
# 68 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c" 3 4
                            ((void *)0)
# 68 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_mtime.c"
                                ;
            }
        }
    }
