# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 2
...
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
                                                      0 
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
                                                               && whence != 
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
                                                                            1 
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
...
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
                                  ((void *)0) 
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
                                  : (zip_source_args_seek_t *)(data));

    if (args == 
# 64 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
               ((void *)0)
# 64 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
                   ) {
        return -1;
    }
    ...
    switch (args->whence) {
        case 
# 69 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
            1
# 69 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
                    :
            new_offset = (zip_int64_t)offset + args->offset;
            break;

        case 
# 73 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
            2
# 73 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
                    :
            new_offset = (zip_int64_t)length + args->offset;
            break;

        case 
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c" 3 4
            0
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_source_seek.c"
                    :
