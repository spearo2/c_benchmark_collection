# 1 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 2
...
# 40 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 2
...
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 2
# 57 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
...
zip_close(zip_t *za)
{
    ...
    if (za == 
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
             ((void *)0)
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                 )
 return -1;
...
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                                                     ((void *)0)
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                                                         )
 return -1;
...
# 137 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
            ((void *)0)
# 137 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
            ) || ((entry)->changes && ((entry)->changes->changed & (0x0001u))));


 if (entry->changes == 
# 140 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                      ((void *)0)
# 140 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                          ) {
     if ((entry->changes=_zip_dirent_clone(entry->orig)) == 
# 141 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                           ((void *)0)
# 141 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                               ) {
 ...
 if (new_data) {
     ...
     zs = 
# 163 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
         ((void *)0)
# 163 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
             ;
     if (!((entry)->source != 
# 164 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
         ((void *)0)
# 164 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
         )) {
  if ((zs=_zip_source_zip_new(za, za, i, 8u, 0, 0, 
# 165 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                                ((void *)0)
# 165 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                                    )) == 
# 165 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                                          ((void *)0)
# 165 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
  ...
  zip_source_free(zs);
     ...
     de->bitflags &= (zip_uint16_t)~0x0008;
...
# 194 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                      0
# 194 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                              ) < 0) {
  _zip_error_set_from_source(&za->error, za->src);
  error = 1;
  break;
...
add_data(zip_t *za, zip_source_t *src, zip_dirent_t *de)
{
 ...
 if ((st.valid & 0x0008u) == 0) {
     if (( ((de->comp_method == 8 || ((de->comp_method) == -1 || (de->comp_method) == (-2))) && st.size > 4293656963u)
    || (de->comp_method != 0 && de->comp_method != 8 && !((de->comp_method) == -1 || (de->comp_method) == (-2)))))
  flags |= 1024;
 }
 else
 ...
 return -1;
    ...
    if (st.comp_method == 0 || (((de->comp_method) == -1 || (de->comp_method) == (-2)) && st.comp_method != de->comp_method)) {
 zip_source_t *s_store, *s_crc;
 zip_compression_implementation comp_impl;

 if (st.comp_method != 0) {
     if ((comp_impl=_zip_get_compression_implementation(st.comp_method)) == 
# 294 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                                           ((void *)0)
# 294 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                                               ) {
  zip_error_set(&za->error, 16, 0);
  return -1;
     }
     if ((s_store=comp_impl(za, src, st.comp_method, 0)) == 
# 298 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                                          ((void *)0)
# 298 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                                              ) {
 ...
 if (s_crc == 
# 311 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
             ((void *)0)
# 311 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                 ) {
     return -1;
 }

 if (de->comp_method != 0 && ((st.valid & 0x0004u) == 0 || st.size != 0)) {
     if ((comp_impl=_zip_get_compression_implementation(de->comp_method)) == 
# 316 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                                            ((void *)0)
# 316 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                                                ) {
  zip_error_set(&za->error, 16, 0);
  zip_source_free(s_crc);
  return -1;
     }
     s2 = comp_impl(za, s_crc, de->comp_method, 1);
     zip_source_free(s_crc);
     if (s2 == 
# 323 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
              ((void *)0)
# 323 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                  ) {
  return -1;
     }
 }
...
# 354 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                                0
# 354 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                        ) < 0) {
 _zip_error_set_from_source(&za->error, za->src);
 return -1;
    }
...
# 385 "/doner/libzip/libzip-1.1.2/lib/zip_close.c" 3 4
                                              0
# 385 "/doner/libzip/libzip-1.1.2/lib/zip_close.c"
                                                      ) < 0) {
 _zip_error_set_from_source(&za->error, za->src);
 return -1;
    }
