# 1 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c" 2
...
_zip_unchange_data(zip_entry_t *ze)
{
 ...
 ze->source = 
# 42 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c" 3 4
             ((void *)0)
# 42 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c"
                 ;
    }

    if (ze->changes != 
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c" 3 4
                      ((void *)0) 
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c"
 ...
 if (ze->changes->changed == 0) {
     ...
     ze->changes = 
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c" 3 4
                  ((void *)0)
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_unchange_data.c"
                      ;
 }
    }
