# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 2
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 2
...
# 40 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 2
# 67 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
struct read_file {
    zip_error_t error;
    zip_int64_t supports;
...
{
    if (za == 
# 93 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
             ((void *)0)
# 93 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                 )
 return 
# 94 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
       ((void *)0)
# 94 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
           ;
...
{
    if (file == 
# 103 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
               ((void *)0) 
# 103 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                    || length < -1) {
 zip_error_set(error, 18, 0);
 return 
# 105 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
       ((void *)0)
# 105 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
           ;
    }

    return _zip_source_file_or_p(
# 108 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                ((void *)0)
# 108 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                    , file, start, length, 
# 108 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                           ((void *)0)
# 108 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
...
_zip_source_file_or_p(const char *fname, FILE *file, zip_uint64_t start, zip_int64_t len, const zip_stat_t *st, zip_error_t *error)
{
    ...
    if (file == 
# 118 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
               ((void *)0) 
# 118 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                    && fname == 
# 118 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                ((void *)0)
# 118 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
 ...
 zip_error_set(error, 18, 0);
 return 
# 120 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
       ((void *)0)
# 120 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
           ;
    }

    if ((ctx=(struct read_file *)malloc(sizeof(struct read_file))) == 
# 123 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                                     ((void *)0)
# 123 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                         ) {
 zip_error_set(error, 14, 0);
 return 
# 125 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
       ((void *)0)
# 125 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
           ;
    }

    ctx->fname = 
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                ((void *)0)
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                    ;
    if (fname) {
 if ((ctx->fname=strdup(fname)) == 
# 130 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                  ((void *)0)
# 130 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                      ) {
     zip_error_set(error, 14, 0);
     free(ctx);
     return 
# 133 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
           ((void *)0)
# 133 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
               ;
 }
    }
    ctx->f = file;
 ...
 memcpy(&ctx->st, st, sizeof(ctx->st));
        ctx->st.name = 
# 141 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                      ((void *)0)
# 141 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                          ;
 ...
 zip_stat_init(&ctx->st);
    ...
    ctx->tmpname = 
# 148 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                  ((void *)0)
# 148 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                      ;
    ctx->fout = 
# 149 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
               ((void *)0)
# 149 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                   ;

    zip_error_init(&ctx->error);

    ctx->supports = ((1<<(ZIP_SOURCE_OPEN)) | (1<<(ZIP_SOURCE_READ)) | (1<<(ZIP_SOURCE_CLOSE)) | (1<<(ZIP_SOURCE_STAT)) | (1<<(ZIP_SOURCE_ERROR)) | (1<<(ZIP_SOURCE_FREE))) | zip_source_make_command_bitmap(ZIP_SOURCE_SUPPORTS, ZIP_SOURCE_TELL, -1);
    if (ctx->fname) {
 struct stat sb;

 if (stat(ctx->fname, &sb) < 0 || 
# 157 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                 ((((
# 157 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                 sb.st_mode
# 157 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                 )) & 0170000) == (0100000))
# 157 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                    ) {
            ctx->supports = ((((1<<(ZIP_SOURCE_OPEN)) | (1<<(ZIP_SOURCE_READ)) | (1<<(ZIP_SOURCE_CLOSE)) | (1<<(ZIP_SOURCE_STAT)) | (1<<(ZIP_SOURCE_ERROR)) | (1<<(ZIP_SOURCE_FREE))) | (1<<(ZIP_SOURCE_SEEK)) | (1<<(ZIP_SOURCE_TELL)) | (1<<(ZIP_SOURCE_SUPPORTS))) | (1<<(ZIP_SOURCE_BEGIN_WRITE)) | (1<<(ZIP_SOURCE_COMMIT_WRITE)) | (1<<(ZIP_SOURCE_ROLLBACK_WRITE)) | (1<<(ZIP_SOURCE_WRITE)) | (1<<(ZIP_SOURCE_SEEK_WRITE)) | (1<<(ZIP_SOURCE_TELL_WRITE)) | (1<<(ZIP_SOURCE_REMOVE)));
 }
    }
    else if (fseeko(ctx->f, 0, 
# 161 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                              1
# 161 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                      ) == 0) {
        ctx->supports = (((1<<(ZIP_SOURCE_OPEN)) | (1<<(ZIP_SOURCE_READ)) | (1<<(ZIP_SOURCE_CLOSE)) | (1<<(ZIP_SOURCE_STAT)) | (1<<(ZIP_SOURCE_ERROR)) | (1<<(ZIP_SOURCE_FREE))) | (1<<(ZIP_SOURCE_SEEK)) | (1<<(ZIP_SOURCE_TELL)) | (1<<(ZIP_SOURCE_SUPPORTS)));
    }

    if ((zs=zip_source_function_create(read_file, ctx, error)) == 
# 165 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                                 ((void *)0)
# 165 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                     ) {
 free(ctx->fname);
 free(ctx);
 return 
# 168 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
       ((void *)0)
# 168 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
           ;
    }
...
# 183 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                      ((void *)0)
# 183 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                          ) {
 ...
 return -1;
    ...
    mask = umask((
# 189 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                0100 
# 189 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                | 
# 189 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                ((0400|0200|0100) >> 3) 
# 189 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
...
# 191 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                  (*__errno_location ())
# 191 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                       );
 umask(mask);
        free(temp);
        return -1;
...
# 198 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                   ((void *)0)
# 198 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                       ) {
        zip_error_set(&ctx->error, 12, 
# 199 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                  (*__errno_location ())
# 199 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                       );
        close(tfd);
        (void)remove(temp);
        free(temp);
...
# 214 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
    ctx->fout = tfp;
    ctx->tmpname = temp;
...
read_file(void *state, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
    ...
    switch (cmd) {
        case ZIP_SOURCE_BEGIN_WRITE:
            if (ctx->fname == 
# 234 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                             ((void *)0)
# 234 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                 ) {
     ...
     mode_t mask;
            ...
            if (fclose(ctx->fout) < 0) {
                ctx->fout = 
# 244 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                           ((void *)0)
# 244 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                               ;
                zip_error_set(&ctx->error, 6, 
# 245 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                        (*__errno_location ())
# 245 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                             );
            }
            ctx->fout = 
# 247 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                       ((void *)0)
# 247 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                           ;
            if (rename(ctx->tmpname, ctx->fname) < 0) {
                zip_error_set(&ctx->error, 2, 
# 249 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                         (*__errno_location ())
# 249 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                              );
                return -1;
            }
     mask = umask(022);
     ...
     free(ctx->tmpname);
     ctx->tmpname = 
# 257 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                   ((void *)0)
# 257 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                       ;
            return 0;
 }
        ...
        case ZIP_SOURCE_CLOSE:
            if (ctx->fname) {
                fclose(ctx->f);
                ctx->f = 
# 264 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                        ((void *)0)
# 264 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                            ;
            }
            return 0;
...
# 281 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                       ((void *)0)
# 281 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                           ) {
                    zip_error_set(&ctx->error, 11, 
# 282 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                           (*__errno_location ())
# 282 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                );
                    return -1;
                }
            }
...
# 288 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                    0
# 288 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                            , &ctx->error) < 0) {
                    return -1;
                }
            }
        ...
        case ZIP_SOURCE_READ:
            ...
            if (n > 
# 306 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                   (18446744073709551615UL)
# 306 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                           )
                n = 
# 307 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                   (18446744073709551615UL)
# 307 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                           ;

            if ((i=fread(buf, 1, (size_t)n, ctx->f)) == 0) {
                if (ferror(ctx->f)) {
                    zip_error_set(&ctx->error, 5, 
# 311 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                           (*__errno_location ())
# 311 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                );
                    return -1;
                }
            }
...
# 321 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                         (*__errno_location ())
# 321 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                              );
                return -1;
            }
            return 0;
        ...
        case ZIP_SOURCE_ROLLBACK_WRITE:
            if (ctx->fout) {
                fclose(ctx->fout);
                ctx->fout = 
# 329 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                           ((void *)0)
# 329 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                               ;
            }
            (void)remove(ctx->tmpname);
     free(ctx->tmpname);
            ctx->tmpname = 
# 333 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                          ((void *)0)
# 333 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                              ;
            return 0;
...
# 339 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                   ((void *)0) 
# 339 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                   : (zip_source_args_seek_t *)(data));

     if (args == 
# 341 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                ((void *)0)
# 341 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                    )
  return -1;
            ...
            switch (args->whence) {
                case 
# 347 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                    0
# 347 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                            :
                    new_current = args->offset;
                    break;

                case 
# 351 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                    2
# 351 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                            :
                    if (ctx->end == 0) {
                        if (_zip_fseek(ctx->f, args->offset, 
# 353 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                            2
# 353 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                    , &ctx->error) < 0) {
                            return -1;
                        }
                        if ((new_current = ftello(ctx->f)) < 0) {
                            zip_error_set(&ctx->error, 4, 
# 357 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                                   (*__errno_location ())
# 357 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                        );
                            return -1;
                        }
                        need_seek = 0;
                    ...
                    break;
                case 
# 366 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                    1
# 366 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                            :
            ...
            if (need_seek) {
                if (_zip_fseek_u(ctx->f, ctx->current, 
# 383 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                      0
# 383 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                              , &ctx->error) < 0) {
                    return -1;
                }
            }
...
# 393 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                  ((void *)0) 
# 393 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                  : (zip_source_args_seek_t *)(data));
            if (args == 
# 394 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                       ((void *)0)
# 394 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                           ) {
                return -1;
            }
  ...
  if (err != 0) {
                    zip_error_set(&ctx->error, 5, 
# 421 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                           (*__errno_location ())
# 421 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                                );
      return -1;
  }
  ...
  zip_stat_init(st);
  st->mtime = fst.
# 428 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                 st_mtim.tv_sec
# 428 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                         ;
  st->valid |= 0x0010u;
  if (ctx->end != 0) {
...
# 434 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                       0170000
# 434 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                             ) == 
# 434 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                  0100000
# 434 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
...
# 453 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                       (*__errno_location ())
# 453 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                            );
                return -1;
            }
            return ret;
     ...
     clearerr(ctx->fout);
            ...
            if (ret != len || ferror(ctx->fout)) {
                zip_error_set(&ctx->error, 6, 
# 466 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                                        (*__errno_location ())
# 466 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                                             );
                return -1;
            }
...
{
    if (offset > 
# 483 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                (9223372036854775807L)
# 483 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                             ) {
 zip_error_set(error, 4, 
# 484 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                  75
# 484 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                           );
 return -1;
    }
...
{
    if (offset > 
# 494 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                (9223372036854775807L) 
# 494 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                              || offset < 
# 494 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
...
# 494 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
 ...
 zip_error_set(error, 4, 
# 495 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                  75
# 495 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                           );
 return -1;
    }
    if (fseeko(f, (off_t)offset, whence) < 0) {
 zip_error_set(error, 4, 
# 499 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c" 3 4
                                  (*__errno_location ())
# 499 "/doner/libzip/libzip-1.1.2/lib/zip_source_filep.c"
                                       );
 return -1;
    }
    return 0;
