# 1 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c" 2
...
zip_set_file_compression(zip_t *za, zip_uint64_t idx, zip_int32_t method, zip_uint32_t flags)
{
 ...
 return -1;
    ...
    old_method = (e->orig == 
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c" 3 4
                            ((void *)0) 
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
 ...
 if (e->changes) {
  ...
  e->changes = 
# 70 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c" 3 4
              ((void *)0)
# 70 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
                  ;
     }
 }
    }
        ...
        if (e->changes == 
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c" 3 4
                         ((void *)0)
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 76 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c" 3 4
                                                          ((void *)0)
# 76 "/doner/libzip/libzip-1.1.2/lib/zip_set_file_compression.c"
                                                              ) {
