# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_call.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_call.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_call.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_call.c" 2
...
_zip_source_call(zip_source_t *src, void *data, zip_uint64_t length, zip_source_cmd_t command)
{
    ...
    if ((src->supports & (1<<(command))) == 0) {
        zip_error_set(&src->error, 28, 0);
        return -1;
    }

    if (src->src == 
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_source_call.c" 3 4
                   ((void *)0)
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_source_call.c"
                       ) {
