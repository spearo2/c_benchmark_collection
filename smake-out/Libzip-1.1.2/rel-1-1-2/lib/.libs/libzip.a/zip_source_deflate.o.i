# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 2
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 2
...
# 63 "/doner/libzip/libzip-1.1.2/lib/zip.h" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 2

struct deflate {
    zip_error_t error;

    
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
   _Bool 
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
        eof;
    
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
   _Bool 
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
        can_store;
    
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
   _Bool 
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
        is_stored;
    int mem_level;
    zip_uint64_t size;
...
zip_source_deflate(zip_t *za, zip_source_t *src, zip_int32_t cm, int flags)
{
    ...
    if (src == 
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
              ((void *)0) 
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                   || (cm != 8 && !((cm) == -1 || (cm) == (-2)))) {
 zip_error_set(&za->error, 18, 0);
 return 
# 67 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
       ((void *)0)
# 67 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
           ;
    }

    if ((ctx=(struct deflate *)malloc(sizeof(*ctx))) == 
# 70 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                                                       ((void *)0)
# 70 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                                           ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
       ((void *)0)
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
           ;
    }

    zip_error_init(&ctx->error);
    ctx->eof = 
# 76 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
              0
# 76 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                   ;
    ctx->is_stored = 
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                    0
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                         ;
    ctx->can_store = ((cm) == -1 || (cm) == (-2));
    if (flags & 1) {
 ctx->mem_level = 
# 80 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                 9
# 80 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                              ;
    }
    ...
    ? deflate_compress : deflate_decompress),
          ctx)) == 
# 86 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                  ((void *)0)
# 86 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                      ) {
 deflate_free(ctx);
 return 
# 88 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
       ((void *)0)
# 88 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
           ;
    }
...
compress_read(zip_source_t *src, struct deflate *ctx, void *data, zip_uint64_t len)
{
 ...
 return 0;
    ...
    out_offset = 0;
    out_len = (uInt)((
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                   (0x7fffffff * 2U + 1U)
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                   ) < (len) ? (
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                   (0x7fffffff * 2U + 1U)
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
...
# 117 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                                     4 
# 117 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                              : 0);

 switch (ret) {
        case 
# 120 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
            1
# 120 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                        :
            if (ctx->can_store && ctx->zstr.total_in <= ctx->zstr.total_out) {
                ctx->is_stored = 
# 122 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                                1
# 122 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                    ;
 ...
 case 
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     0
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
         :
  ...
  if (out_offset < len) {
      out_len = (uInt)((
# 134 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                     (0x7fffffff * 2U + 1U)
# 134 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                     ) < (len-out_offset) ? (
# 134 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                     (0x7fffffff * 2U + 1U)
# 134 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
      ...
      ctx->zstr.avail_out = out_len;
                    ...
                    ctx->can_store = 
# 139 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                                    0
# 139 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                         ;
      end = 1;
  }
     }
 ...
 case 
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-5)
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                :
  ...
  if ((n=zip_source_read(src, ctx->buffer, sizeof(ctx->buffer))) < 0) {
      ...
      ctx->eof = 
# 160 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                1
# 160 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                    ;
      ...
      ctx->size = ctx->zstr.total_in;
                    ...
                    if (ctx->zstr.total_in > 0) {
                        ...
                        ctx->can_store = 
# 167 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                                        0
# 167 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                             ;
                    }
 ...
 case 
# 175 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     2
# 175 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                :
 case 
# 176 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-3)
# 176 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                 :
 case 
# 177 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-2)
# 177 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                   :
 case 
# 178 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-4)
# 178 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                :
 ...
 ctx->can_store = 
# 187 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                 0
# 187 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                      ;
...
decompress_read(zip_source_t *src, struct deflate *ctx, void *data, zip_uint64_t len)
{
 ...
 return 0;
    ...
    out_offset = 0;
    out_len = (uInt)((
# 210 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                   (0x7fffffff * 2U + 1U)
# 210 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                   ) < (len) ? (
# 210 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                   (0x7fffffff * 2U + 1U)
# 210 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
...
# 216 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                          2
# 216 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                      );

 switch (ret) {
 case 
# 219 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     0
# 219 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
         :
     if (ctx->zstr.avail_out == 0) {
  out_offset += out_len;
  if (out_offset < len) {
      out_len = (uInt)((
# 223 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                     (0x7fffffff * 2U + 1U)
# 223 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                     ) < (len-out_offset) ? (
# 223 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                     (0x7fffffff * 2U + 1U)
# 223 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
 ...
 case 
# 233 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     1
# 233 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                 :
     ctx->eof = 1;
     end = 1;
     break;
 ...
 case 
# 238 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-5)
# 238 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                :
     if (ctx->zstr.avail_in == 0) {
  if (ctx->eof) {
      end = 1;
 ...
 case 
# 260 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     2
# 260 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                :
 case 
# 261 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-3)
# 261 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                 :
 case 
# 262 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-2)
# 262 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                   :
 case 
# 263 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
     (-4)
# 263 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                :
            zip_error_set(&ctx->error, 13, ret);
     end = 1;
     break;
...
deflate_compress(zip_source_t *src, void *ud, void *data, zip_uint64_t len, zip_source_cmd_t cmd)
{
 ...
 ctx->zstr.zalloc = 
# 287 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                   0
# 287 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                         ;
 ctx->zstr.zfree = 
# 288 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                  0
# 288 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                        ;
 ctx->zstr.opaque = 
# 289 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                   ((void *)0)
# 289 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                       ;
 ctx->zstr.avail_in = 0;
 ctx->zstr.next_in = 
# 291 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                    ((void *)0)
# 291 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                        ;
 ctx->zstr.avail_out = 0;
 ctx->zstr.next_out = 
# 293 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                     ((void *)0)
# 293 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                         ;


 if ((ret=
# 296 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
         deflateInit2_((
# 296 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
         &ctx->zstr
# 296 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
         ),(9),(8),(
# 296 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
...
# 296 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
 ...
 return 0;
    ...
    case ZIP_SOURCE_STAT:
     ...
     st->comp_method = ctx->is_stored ? 0 : 8;
     st->valid |= 0x0040u;
     if (ctx->eof) {
 ...
 return 0;
    ...
    case ZIP_SOURCE_SUPPORTS:
        return ((1<<(ZIP_SOURCE_OPEN)) | (1<<(ZIP_SOURCE_READ)) | (1<<(ZIP_SOURCE_CLOSE)) | (1<<(ZIP_SOURCE_STAT)) | (1<<(ZIP_SOURCE_ERROR)) | (1<<(ZIP_SOURCE_FREE)));
     ...
     zip_uint64_t len, zip_source_cmd_t cmd)
{
    ...
    switch (cmd) {
        case ZIP_SOURCE_OPEN:
            ...
            ctx->zstr.zalloc = 
# 361 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                              0
# 361 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                    ;
            ctx->zstr.zfree = 
# 362 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                             0
# 362 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                   ;
            ctx->zstr.opaque = 
# 363 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                              ((void *)0)
# 363 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                                  ;
            ctx->zstr.next_in = (Bytef *)ctx->buffer;
            ctx->zstr.avail_in = (uInt)n;
            ...
            if ((ret=
# 368 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                    inflateInit2_((
# 368 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
                    &ctx->zstr
# 368 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c" 3 4
                    ), (
# 368 "/doner/libzip/libzip-1.1.2/lib/zip_source_deflate.c"
