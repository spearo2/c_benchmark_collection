# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c" 2
...
zip_source_open(zip_source_t *src)
{
 ...
 return -1;
    ...
    if (((src)->open_count > 0)) {
 if ((zip_source_supports(src) & (1<<(ZIP_SOURCE_SEEK))) == 0) {
 ...
 if (((src)->src != 
# 55 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c" 3 4
    ((void *)0)
# 55 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c"
    )) {
...
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c" 3 4
                          ((void *)0)
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c"
                              , 0, ZIP_SOURCE_OPEN) < 0) {
     if (((src)->src != 
# 63 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c" 3 4
        ((void *)0)
# 63 "/doner/libzip/libzip-1.1.2/lib/zip_source_open.c"
        )) {
