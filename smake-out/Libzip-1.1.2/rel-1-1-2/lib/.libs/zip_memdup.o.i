# 1 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c" 2
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c" 2
...
_zip_memdup(const void *mem, size_t len, zip_error_t *error)
{
    ...
    if (len == 0)
 return 
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c" 3 4
       ((void *)0)
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c"
           ;
 ...
 return 
# 51 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c" 3 4
       ((void *)0)
# 51 "/doner/libzip/libzip-1.1.2/lib/zip_memdup.c"
           ;
    }
