# 1 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 2
...
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                                   ((void *)0)
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                                       ) == 
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                                            ((void *)0)
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
 ...
 return -1;
    ...
    if (len > 0 && comment == 
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                             ((void *)0)
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                                 ) {
...
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                                                                                    ((void *)0)
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                                                                                        )
     return -1;
 ...
 cstr = 
# 68 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
       ((void *)0)
# 68 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
           ;
 ...
 e->changes->comment = 
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                      ((void *)0)
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                          ;
 ...
 changed = (cstr != 
# 81 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                   ((void *)0)
# 81 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                       );

    if (changed) {
        if (e->changes == 
# 84 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                         ((void *)0)
# 84 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                                                          ((void *)0)
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                                                              ) {
 ...
 if (e->changes && e->changes->changed == 0) {
     ...
     e->changes = 
# 98 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c" 3 4
                 ((void *)0)
# 98 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_comment.c"
                     ;
 }
    }
