# 1 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 2
...
zip_dir_add(zip_t *za, const char *name, zip_flags_t flags)
{
 ...
 return -1;
    ...
    if (name == 
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 3 4
               ((void *)0)
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
                   ) {
 ...
 return -1;
    ...
    s = 
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 3 4
       ((void *)0)
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
           ;
    len = strlen(name);

    if (name[len-1] != '/') {
 if ((s=(char *)malloc(len+2)) == 
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 3 4
                                 ((void *)0)
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
                                     ) {
...
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 3 4
                                     ((void *)0)
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
                                         , 0, 0)) == 
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 3 4
                                                     ((void *)0)
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
...
# 79 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c" 3 4
                               (18446744073709551615UL)
# 79 "/doner/libzip/libzip-1.1.2/lib/zip_dir_add.c"
