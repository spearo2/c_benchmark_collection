# 1 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 2
...
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
   _Bool 
# 46 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
        same_as_orig;
    zip_int64_t i;
...
# 63 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                                                                                       ((void *)0)
# 63 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                                                                                           )
     return -1;
 ...
 str = 
# 69 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
      ((void *)0)
# 69 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
          ;


    if ((i=_zip_name_locate(za, name, 0, 
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                        ((void *)0)
# 72 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
 ...
 same_as_orig = 
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
               0
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                    ;

    if (!same_as_orig && e->changes == 
# 91 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                      ((void *)0)
# 91 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                          ) {
 if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 92 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                               ((void *)0)
# 92 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                                   ) {
...
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                                                           ((void *)0)
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                                                               , 0, &za->error)) == 
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                                                                                    ((void *)0)
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
 ...
 old_str = 
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
          ((void *)0)
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
              ;
    }

    if (old_str) {
 if ((old_name = _zip_string_get(old_str, 
# 115 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                         ((void *)0)
# 115 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                             , 0, &za->error)) == 
# 115 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                                                  ((void *)0)
# 115 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
 ...
 old_name = 
# 121 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
           ((void *)0)
# 121 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
               ;
    }

    if (_zip_hash_add(za->names, new_name, idx, 0, &za->error) == 
# 124 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                                                 0
# 124 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                                                      ) {
 _zip_string_free(str);
 return -1;
    }
...
# 129 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                                      ((void *)0)
# 129 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                                          );
    }
 ...
 if (e->changes) {
  ...
  if (e->changes->changed == 0) {
      ...
      e->changes = 
# 139 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c" 3 4
                  ((void *)0)
# 139 "/doner/libzip/libzip-1.1.2/lib/zip_set_name.c"
                      ;
  }
  else {
