# 1 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
# 35 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
# 1 "../config.h" 1
# 36 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 40 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 41 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 42 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 47 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
FTSENT *fts_read (FTS *);
int fts_set (FTS *, FTSENT *, int) __attribute__ ((__nothrow__ , __leaf__));
# 213 "/usr/include/fts.h" 3 4

# 50 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 52 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
# 339 "../lib/zipint.h" 3 4
   _Bool 
# 339 "../lib/zipint.h"
        local_extra_fields_read;
    
# 340 "../lib/zipint.h" 3 4
   _Bool 
# 340 "../lib/zipint.h"
        cloned;
...
# 431 "../lib/zipint.h" 3 4
   _Bool 
# 431 "../lib/zipint.h"
        ok;
    
# 432 "../lib/zipint.h" 3 4
   _Bool 
# 432 "../lib/zipint.h"
        free_data;
...
# 59 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
# 1 "../lib/zip.h" 1
# 60 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
# 1 "/doner/libzip/libzip-1.1.2/src/compat.h" 1
# 61 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 2
...
char help_head[] =
    "zipcmp" " (" "libzip" ") by Dieter Baron and Thomas Klausner\n\n";
...
# 111 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
char version_string[] = "zipcmp" " (" "libzip" " " "1.1.2" ")\nCopyright (C) 2003-2015 Dieter Baron and Thomas Klausner\n"

  "libzip" " comes with ABSOLUTELY NO WARRANTY, to the extent permitted by law.\n";
...
main(int argc, char * const argv[])
{
    ...
    while ((c=getopt(argc, argv, "hVipqtv")) != -1) {
 switch (c) {
 case 'i':
     ignore_case = 1;
     break;
 ...
 case 'h':
     fputs(help_head, 
# 176 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                     stdout
# 176 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                           );
     printf("usage: %s [-hipqtVv] archive1 archive2\n", prg);
     fputs(help, 
# 178 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                stdout
# 178 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                      );
     exit(0);
 case 'V':
     fputs(version_string, 
# 181 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                          stdout
# 181 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                );
     exit(0);

 default:
     fprintf(
# 185 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
            stderr
# 185 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                  , "usage: %s [-hipqtVv] archive1 archive2\n", prg);
     exit(2);
 }
    }
    ...
    if (argc != optind+2) {
 fprintf(
# 191 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 191 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "usage: %s [-hipqtVv] archive1 archive2\n", prg);
 exit(2);
    }
...
compare_zip(char * const zn[])
{
 ...
 a[i].name = zn[i];
 a[i].entry = 
# 210 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
             ((void *)0)
# 210 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                 ;
 a[i].nentry = 0;
 a[i].za = 
# 212 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
          ((void *)0)
# 212 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              ;
 a[i].comment = 
# 213 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
               ((void *)0)
# 213 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                   ;
 ...
 qsort(a[i].entry, a[i].nentry, sizeof(a[i].entry[0]), entry_cmp);
    ...
    n[0] = a[0].nentry;
    n[1] = a[1].nentry;
    res = compare_list(zn, (const void **)e, n, sizeof(e[i][0]), entry_cmp, paranoid ? entry_paranoia_checks : 
# 239 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                                                              ((void *)0)
# 239 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                                                                                                  , entry_print);
...
compute_crc(const char *fname)
{
    FILE *f;
    uLong crc = crc32(0L, 
# 272 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                         0
# 272 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                               , 0);
    size_t n;
    Bytef buffer[8192];
    ...
    if ((f=fopen(fname, "r")) == 
# 277 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                ((void *)0)
# 277 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                    ) {
 fprintf(
# 278 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 278 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "%s: can't open %s: %s\n", prg, fname, strerror(
# 278 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                (*__errno_location ())
# 278 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
 ...
 crc = crc32(crc, buffer, (unsigned int)n);
    ...
    if (ferror(f)) {
 fprintf(
# 287 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 287 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "%s: read error on %s: %s\n", prg, fname, strerror(
# 287 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                   (*__errno_location ())
# 287 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
is_directory(const char *name)
{
 ...
 return 0;
    ...
    return 
# 307 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
          ((((
# 307 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
          st.st_mode
# 307 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
          )) & 0170000) == (0040000))
# 307 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
list_directory(const char *name, struct archive *a)
{
    ...
    char * const names[2] = { (char *)name, 
# 319 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                           ((void *)0) 
# 319 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                                };


    if ((fts = fts_open(names, 
# 322 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                              0x0004
# 322 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                         |
# 322 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                          0x0002
# 322 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
# 322 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
 ...
 fprintf(
# 323 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 323 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
# 323 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
 ...
 switch (ent->fts_info) {
 case 
# 334 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     1
# 334 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
          :
 case 
# 335 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     5
# 335 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
            :
 case 
# 336 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     6
# 336 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
           :
 case 
# 337 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     3
# 337 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                :
 case 
# 338 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     12
# 338 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
           :
 case 
# 339 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     11
# 339 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
             :
     break;

 case 
# 342 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     2
# 342 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
           :
 case 
# 343 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     4
# 343 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
            :
 case 
# 344 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     7
# 344 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
            :
 case 
# 345 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     10
# 345 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
           :
 case 
# 346 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     13
# 346 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
               :
 ...
 case 
# 351 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
     8
# 351 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
          :
     if (a->nentry >= nalloc) {
  nalloc += 16;
  if (nalloc > 
# 354 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
              (18446744073709551615UL)
# 354 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                      /sizeof(a->entry[0])) {
      fprintf(
# 355 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
             stderr
# 355 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                   , "%s: malloc failure\n", prg);
      exit(1);
  }
  a->entry = realloc(a->entry, sizeof(a->entry[0])*nalloc);
  if (a->entry == 
# 359 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                 ((void *)0)
# 359 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                     ) {
      fprintf(
# 360 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
             stderr
# 360 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                   , "%s: malloc failure\n", prg);
      exit(1);
  }
     }
  ...
  return -1;
    ...
    if (fts_close(fts)) {
 fprintf(
# 379 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 379 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
list_zip(const char *name, struct archive *a)
{
    ...
    if ((za=zip_open(name, paranoid ? 4 : 0, &err)) == 
# 396 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                  ((void *)0)
# 396 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                                                      ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 399 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 399 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "%s: cannot open zip archive '%s': %s\n", prg, name, zip_error_strerror(&error));
 ...
 return -1;
    ...
    if (a->nentry == 0)
 a->entry = 
# 408 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
           ((void *)0)
# 408 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
               ;
    else {
 if ((a->nentry > 
# 410 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                 (18446744073709551615UL)
# 410 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                         /sizeof(a->entry[0])) || (a->entry=(struct entry *)malloc(sizeof(a->entry[0]) * a->nentry)) == 
# 410 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                                                                        ((void *)0)
# 410 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                                                                                                            ) {
     fprintf(
# 411 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
            stderr
# 411 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                  , "%s: malloc failure\n", prg);
     exit(1);
 }
 ...
 for (i=0; i<a->nentry; i++) {
  ...
  a->entry[i].n_extra_fields = 0;
     ...
     a->comment = zip_get_archive_comment(za, &length, 0);
            ...
            a->comment = 
# 439 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                        ((void *)0)
# 439 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                            ;
            a->comment_length = 0;
        }
    }
...
comment_compare(const char *c1, size_t l1, const char *c2, size_t l2) {
 ...
 return 0;
    ...
    if (c1 == 
# 456 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
             ((void *)0) 
# 456 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                  || c2 == 
# 456 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                           ((void *)0)
# 456 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
      ...
      void (*print)(const void *))
{
    ...
    int j, c;
    int diff;
# 487 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
    i[0] = i[1] = 0;
    diff = 0;
 ...
 if (c == 0) {
  ...
  diff |= check(name, l[0], l[1]);
     (i[0]++, l[0]=((const char *)l[0])+size);
     (i[1]++, l[1]=((const char *)l[1])+size);
 }
 else if (c < 0) {
     do { if (header_done==0 && verbose) { printf("--- %s\n+++ %s\n", name[0], name[1]); header_done = 1; } if (verbose) { printf("%c ", (0)?'+':'-'); print(l[0]); } diff = 1; } while (0);
     (i[0]++, l[0]=((const char *)l[0])+size);
 }
 else {
     do { if (header_done==0 && verbose) { printf("--- %s\n+++ %s\n", name[0], name[1]); header_done = 1; } if (verbose) { printf("%c ", (1)?'+':'-'); print(l[1]); } diff = 1; } while (0);
     (i[1]++, l[1]=((const char *)l[1])+size);
 }
    }
    ...
    for (j=0; j<2; j++) {
 while (i[j]<n[j]) {
     do { if (header_done==0 && verbose) { printf("--- %s\n+++ %s\n", name[0], name[1]); header_done = 1; } if (verbose) { printf("%c ", (j)?'+':'-'); print(l[j]); } diff = 1; } while (0);
     (i[j]++, l[j]=((const char *)l[j])+size);
 }
    }
...
ef_read(zip_t *za, zip_uint64_t idx, struct entry *e)
{
    ...
    if ((n_local = zip_file_extra_fields_count(za, idx, 256u)) < 0
        || (n_central = zip_file_extra_fields_count(za, idx, 512u)) < 0) {
        return -1;
    }

    e->n_extra_fields = (zip_uint16_t)(n_local + n_central);

    if ((e->extra_fields=(struct ef *)malloc(sizeof(e->extra_fields[0])*e->n_extra_fields)) == 
# 532 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                                              ((void *)0)
# 532 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                                                                                  )
 return -1;

    for (i=0; i<n_local; i++) {
 e->extra_fields[i].name = e->name;
 e->extra_fields[i].data = zip_file_extra_field_get(za, idx, i, &e->extra_fields[i].id, &e->extra_fields[i].size, 256u);
 if (e->extra_fields[i].data == 
# 538 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                               ((void *)0)
# 538 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                   )
     return -1;
 e->extra_fields[i].flags = 256u;
    }
    for (; i<e->n_extra_fields; i++) {
 e->extra_fields[i].name = e->name;
 e->extra_fields[i].data=zip_file_extra_field_get(za, idx, (zip_uint16_t)(i-n_local), &e->extra_fields[i].id, &e->extra_fields[i].size, 512u);
 if (e->extra_fields[i].data == 
# 545 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                               ((void *)0)
# 545 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                   )
     return -1;
 e->extra_fields[i].flags = 512u;
    }
...
ef_compare(char *const name[2], const struct entry *e1, const struct entry *e2)
{
    ...
    return compare_list(name, (const void **)ef, n, sizeof(struct ef), ef_order, 
# 567 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                                                                ((void *)0)
# 567 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                                                                    , ef_print);
}
...
ef_print(const void *p)
{
    ...
    printf("                    %s  ", ef->name);
    printf("%04x %c <", ef->id, ef->flags == 256u ? 'l' : 'c');
    for (i=0; i<ef->size; i++)
...
# 693 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                           ((void *)0)
# 693 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                               ) {
 fprintf(
# 694 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 694 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "%s: cannot open file %" 
# 694 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                         "l" "u" 
# 694 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
 ...
 return -1;
    ...
    ncrc = (zip_uint32_t)crc32(0, 
# 698 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                                 ((void *)0)
# 698 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                     , 0);
    nsize = 0;
 ...
 ncrc = (zip_uint32_t)crc32(ncrc, (const Bytef *)buf, (unsigned int)n);
    ...
    if (n < 0) {
 fprintf(
# 707 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 707 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
# 707 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
 ...
 return -1;
    ...
    if (nsize != size) {
 fprintf(
# 715 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 715 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "%s: file %" 
# 715 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                             "l" "u" 
# 715 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
...
# 715 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
 ...
 return -2;
    ...
    if (ncrc != crc) {
 fprintf(
# 719 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
        stderr
# 719 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
              , "%s: file %" 
# 719 "/doner/libzip/libzip-1.1.2/src/zipcmp.c" 3 4
                             "l" "u" 
# 719 "/doner/libzip/libzip-1.1.2/src/zipcmp.c"
                                    ": unexpected length %x (should be %x)\n", prg, idx, ncrc, crc);
 return -2;
    }
