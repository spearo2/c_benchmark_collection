# 1 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 2
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 2
...
_zip_hash_new(zip_uint16_t table_size, zip_error_t *error)
{
 ...
 return 
# 58 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
       ((void *)0)
# 58 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
           ;
    }

    if ((hash=(zip_hash_t *)malloc(sizeof(zip_hash_t))) == 
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                                                          ((void *)0)
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                                                              ) {
 zip_error_set(error, 14, 0);
 return 
# 63 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
       ((void *)0)
# 63 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
           ;
    }
    hash->table_size = table_size;
    if ((hash->table=(zip_hash_entry_t**)calloc(table_size, sizeof(zip_hash_entry_t *))) == 
# 66 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                                                                                           ((void *)0)
# 66 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                                                                                               ) {
 free(hash);
 zip_error_set(error, 14, 0);
 return 
# 69 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
       ((void *)0)
# 69 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
           ;
    }
...
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                     ((void *)0)
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                         );
}
...
_zip_hash_free(zip_hash_t *hash)
{
    ...
    if (hash == 
# 91 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
               ((void *)0)
# 91 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                   ) {
 return;
    }
 ...
 if (hash->table[i] != 
# 96 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                      ((void *)0)
# 96 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                          ) {
...
_hash_string(const zip_uint8_t *name, zip_uint16_t size)
{
    ...
    if (name == 
# 110 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
               ((void *)0)
# 110 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                   )
 return 0;

    while (*name != 0) {
 value = (zip_uint16_t)(((value * 33) + (zip_uint8_t)*name) % size);
 name++;
    }
...
# 122 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
_Bool

# 123 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
_zip_hash_add(zip_hash_t *hash, const zip_uint8_t *name, zip_uint64_t index, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (hash == 
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
               ((void *)0) 
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                    || name == 
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                               ((void *)0) 
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
...
# 128 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
 ...
 return 
# 130 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
       0
# 130 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
            ;
    }

    hash_value = _hash_string(name, hash->table_size);
    for (entry = hash->table[hash_value]; entry != 
# 134 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                                                  ((void *)0)
# 134 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                                                      ; entry = entry->next) {
 if (strcmp((const char *)name, (const char *)entry->name) == 0) {
     if (((flags & 8u) && entry->orig_index != -1) || entry->current_index != -1) {
  zip_error_set(error, 10, 0);
  return 
# 138 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
        0
# 138 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
             ;
     }
     else {
  break;
    ...
    if (entry == 
# 146 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                ((void *)0)
# 146 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                    ) {
 if ((entry=(zip_hash_entry_t *)malloc(sizeof(zip_hash_entry_t))) == 
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                                                                    ((void *)0)
# 147 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                                                                        ) {
     zip_error_set(error, 14, 0);
     return 
# 149 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
           0
# 149 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                ;
 }
 entry->name = name;
 ...
 entry->orig_index = (zip_int64_t)index;
    ...
    return 
# 162 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
          1
# 162 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
              ;
}



# 166 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
_Bool

# 167 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
_zip_hash_delete(zip_hash_t *hash, const zip_uint8_t *name, zip_error_t *error)
{
    ...
    if (hash == 
# 172 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
               ((void *)0) 
# 172 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                    || name == 
# 172 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                               ((void *)0)
# 172 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
 ...
 zip_error_set(error, 18, 0);
 return 
# 174 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
       0
# 174 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
            ;
    }

    hash_value = _hash_string(name, hash->table_size);
    previous = 
# 178 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
              ((void *)0)
# 178 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                  ;
 ...
 if (strcmp((const char *)name, (const char *)entry->name) == 0) {
  ...
  entry->current_index = -1;
     ...
     return 
# 194 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
           1
# 194 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
               ;
 }
 previous = entry;
 entry = entry->next;
    ...
    return 
# 201 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
          0
# 201 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
               ;
}
...
_zip_hash_lookup(zip_hash_t *hash, const zip_uint8_t *name, zip_flags_t flags, zip_error_t *error)
{
    ...
    if (hash == 
# 211 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
               ((void *)0) 
# 211 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                    || name == 
# 211 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                               ((void *)0)
# 211 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
 ...
 return -1;
    ...
    hash_value = _hash_string(name, hash->table_size);
    for (entry = hash->table[hash_value]; entry != 
# 217 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
                                                  ((void *)0)
# 217 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
                                                      ; entry = entry->next) {
 if (strcmp((const char *)name, (const char *)entry->name) == 0) {
     if (flags & 8u) {
  if (entry->orig_index != -1) {
...
_zip_hash_revert(zip_hash_t *hash)
{
    ...
    for (i = 0; i < hash->table_size; i++) {
 previous = 
# 244 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c" 3 4
           ((void *)0)
# 244 "/doner/libzip/libzip-1.1.2/lib/zip_hash.c"
               ;
 entry = hash->table[i];
 while (entry) {
     if (entry->orig_index == -1) {
