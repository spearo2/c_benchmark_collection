# 1 "/doner/libzip/libzip-1.1.2/src/hole.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/src/hole.c"
# 34 "/doner/libzip/libzip-1.1.2/src/hole.c"
# 1 "../config.h" 1
# 35 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
# 40 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
# 42 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
# 49 "/doner/libzip/libzip-1.1.2/src/hole.c" 2
...
copy_source(zip_source_t *from, zip_source_t *to)
{
    ...
    if (zip_source_open(from) < 0) {
        fprintf(
# 64 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
               stderr
# 64 "/doner/libzip/libzip-1.1.2/src/hole.c"
                     , "%s: can't open source for reading: %s\n", prg, zip_error_strerror(zip_source_error(from)));
        return -1;
    }

    if (zip_source_begin_write(to) < 0) {
        fprintf(
# 69 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
               stderr
# 69 "/doner/libzip/libzip-1.1.2/src/hole.c"
                     , "%s: can't open source for writing: %s\n", prg, zip_error_strerror(zip_source_error(to)));
    ...
    while ((n = zip_source_read(from, buf, sizeof(buf))) > 0) {
        if (zip_source_write(to, buf, (zip_uint64_t)n) != n) {
            fprintf(
# 76 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
                   stderr
# 76 "/doner/libzip/libzip-1.1.2/src/hole.c"
                         , "%s: can't write to source: %s\n", prg, zip_error_strerror(zip_source_error(to)));
            zip_source_close(from);
    ...
    if (n < 0) {
        fprintf(
# 84 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
               stderr
# 84 "/doner/libzip/libzip-1.1.2/src/hole.c"
                     , "%s: can't read from source: %s\n", prg, zip_error_strerror(zip_source_error(from)));
        zip_source_close(from);
        zip_source_rollback_write(to);
        return -1;
    }
    ...
    if (zip_source_commit_write(to) < 0) {
        fprintf(
# 93 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
               stderr
# 93 "/doner/libzip/libzip-1.1.2/src/hole.c"
                     , "%s: can't commit source: %s\n", prg, zip_error_strerror(zip_source_error(to)));
        zip_source_rollback_write(to);
        return -1;
    }
...
open_compressed(const char *fname, int flags)
{
    ...
    if ((src = source_hole_create(fname, flags, &error)) == 
# 110 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
                                                           ((void *)0)
# 110 "/doner/libzip/libzip-1.1.2/src/hole.c"
                                                               ) {
        fprintf(
# 111 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
               stderr
# 111 "/doner/libzip/libzip-1.1.2/src/hole.c"
                     , "%s: can't open compressed file %s: %s\n", prg, fname, zip_error_strerror(&error));
...
open_file(const char *fname)
{
    ...
    if ((src = zip_source_file_create(fname, 0, 0, &error)) == 
# 128 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
                                                              ((void *)0)
# 128 "/doner/libzip/libzip-1.1.2/src/hole.c"
                                                                  ) {
        fprintf(
# 129 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
               stderr
# 129 "/doner/libzip/libzip-1.1.2/src/hole.c"
...
{
    fprintf(
# 141 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
           stderr
# 141 "/doner/libzip/libzip-1.1.2/src/hole.c"
                 , "usage: %s [-du] in out\n", prg);
    fprintf(
# 142 "/doner/libzip/libzip-1.1.2/src/hole.c" 3 4
           stderr
# 142 "/doner/libzip/libzip-1.1.2/src/hole.c"
                 , "\nOptions:\n  -d  decompress in\n  -u  update in\n");
    exit(1);
}
...
main(int argc, char **argv)
{
    ...
    if (compress) {
        to = open_compressed(argv[optind+1], 1);
    }
    else {
