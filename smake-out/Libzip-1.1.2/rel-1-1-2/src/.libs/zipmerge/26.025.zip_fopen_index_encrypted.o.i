# 1 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 2
...
# 50 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
                                                                          ((void *)0)
# 50 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
                                                                              )
 return 
# 51 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 51 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
           ;
 ...
 zip_source_free(src);
 return 
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
           ;
    }

    if ((zf=_zip_file_new(za)) == 
# 59 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
                                 ((void *)0)
# 59 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
                                     ) {
 zip_source_free(src);
 return 
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
           ;
    }
...
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
                                                             ((void *)0)
# 75 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
                                                                 ) {
 zip_error_set(&za->error, 14, 0);
 return 
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
       ((void *)0)
# 77 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
           ;
    }
    ...
    zf->eof = 0;
    zf->src = 
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c" 3 4
             ((void *)0)
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_fopen_index_encrypted.c"
                 ;
