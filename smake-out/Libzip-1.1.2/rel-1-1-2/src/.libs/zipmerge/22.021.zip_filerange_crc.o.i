# 1 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c" 2
...
_zip_filerange_crc(zip_source_t *src, zip_uint64_t start, zip_uint64_t len, uLong *crcp, zip_error_t *error)
{
    ...
    *crcp = crc32(0L, 
# 47 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c" 3 4
                     0
# 47 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
                           , 0);

    if (start > 
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c" 3 4
               (9223372036854775807L)
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
                            ) {
 zip_error_set(error, 4, 
# 50 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c" 3 4
                                  27
# 50 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
                                       );
 return -1;
    }

    if (zip_source_seek(src, (zip_int64_t)start, 
# 54 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c" 3 4
                                                0
# 54 "/doner/libzip/libzip-1.1.2/lib/zip_filerange_crc.c"
                                                        ) != 0) {
