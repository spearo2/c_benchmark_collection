# 1 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 2
...
# 59 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                           ((void *)0)
# 59 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                               ) {
     if ((orig_name=_zip_get_name(za, idx, 8u, &za->error)) == 
# 60 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                                                                            ((void *)0)
# 60 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                                                                ) {
  return -1;
     }

     i = _zip_name_locate(za, orig_name, 0, 
# 64 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                                           ((void *)0)
# 64 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                               );
  ...
  return -1;
     ...
     orig_name = 
# 71 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                ((void *)0)
# 71 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                    ;
 }

 if ((changed_name=_zip_get_name(za, idx, 0, &za->error)) == 
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                                                            ((void *)0)
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                                                ) {
     return -1;
 }
...
# 79 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                                                                                        0
# 79 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                                                                             ) {
  return -1;
     }
 }
 if (_zip_hash_delete(za->names, (const zip_uint8_t *)changed_name, &za->error) == 
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                                                                                  0
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                                                                       ) {
     _zip_hash_delete(za->names, (const zip_uint8_t *)orig_name, 
# 84 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                                                                ((void *)0)
# 84 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                                                    );
     return -1;
 }
    }
...
# 90 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c" 3 4
                            ((void *)0)
# 90 "/doner/libzip/libzip-1.1.2/lib/zip_unchange.c"
                                ;
