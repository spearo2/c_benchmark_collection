# 1 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c" 2
...
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c" 3 4
                                   ((void *)0)
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
                                       ) == 
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c" 3 4
                                            ((void *)0)
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
 ...
 return -1;
    ...
    if (changed) {
        if (e->changes == 
# 60 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c" 3 4
                         ((void *)0)
# 60 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
                             ) {
            if ((e->changes=_zip_dirent_clone(e->orig)) == 
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c" 3 4
                                                          ((void *)0)
# 61 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
                                                              ) {
 ...
 if (e->changes->changed == 0) {
     ...
     e->changes = 
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c" 3 4
                 ((void *)0)
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_file_set_external_attributes.c"
                     ;
 }
 else {
