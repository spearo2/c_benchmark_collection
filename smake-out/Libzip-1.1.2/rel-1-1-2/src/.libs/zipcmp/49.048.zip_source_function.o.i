# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 2
...
{
    if (za == 
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
             ((void *)0)
# 43 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                 ) {
        return 
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
              ((void *)0)
# 44 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                  ;
    }
...
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
                                      ((void *)0)
# 56 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                                          )
 return 
# 57 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
       ((void *)0)
# 57 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
           ;
    ...
    zs->supports = zcb(ud, 
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
                          ((void *)0)
# 62 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                              , 0, ZIP_SOURCE_SUPPORTS);
    if (zs->supports < 0) {
        zs->supports = ((1<<(ZIP_SOURCE_OPEN)) | (1<<(ZIP_SOURCE_READ)) | (1<<(ZIP_SOURCE_CLOSE)) | (1<<(ZIP_SOURCE_STAT)) | (1<<(ZIP_SOURCE_ERROR)) | (1<<(ZIP_SOURCE_FREE)));
    }
...
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
                                                     ((void *)0)
# 83 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                                                         ) {
        zip_error_set(error, 14, 0);
 return 
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
       ((void *)0)
# 85 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
           ;
    }

    src->src = 
# 88 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
              ((void *)0)
# 88 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                  ;
    src->cb.f = 
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
               ((void *)0)
# 89 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                   ;
    src->ud = 
# 90 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
             ((void *)0)
# 90 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                 ;
    src->open_count = 0;
    src->write_state = ZIP_SOURCE_WRITE_CLOSED;
    src->source_closed = 
# 93 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
                        0
# 93 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                             ;
    src->source_archive = 
# 94 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c" 3 4
                         ((void *)0)
# 94 "/doner/libzip/libzip-1.1.2/lib/zip_source_function.c"
                             ;
    src->refcount = 1;
