# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 2
...
_zip_source_zip_new(zip_t *za, zip_t *srcza, zip_uint64_t srcidx, zip_flags_t flags, zip_uint64_t start, zip_uint64_t len, const char *password)
{
    ...
    if (za == 
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
             ((void *)0)
# 49 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                 )
 return 
# 50 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 50 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;

    if (srcza == 
# 52 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                ((void *)0) 
# 52 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                     || srcidx >= srcza->nentry) {
 zip_error_set(&za->error, 18, 0);
 return 
# 54 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 54 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;
    }

    if ((flags & 8u) == 0
 && (((srcza->entry+srcidx)->source != 
# 58 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
    ((void *)0)
# 58 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
    ) || srcza->entry[srcidx].deleted)) {
 zip_error_set(&za->error, 15, 0);
 return 
# 60 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 60 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;
    }
 ...
 return 
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 65 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;
    }
 ...
 zip_error_set(&za->error, 18, 0);
 return 
# 73 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 73 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;
    }
 ...
 zip_error_set(&za->error, 18, 0);
 return 
# 79 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 79 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;
    }

    enc_impl = 
# 82 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
              ((void *)0)
# 82 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                  ;
    if (((flags & 32u) == 0) && (st.encryption_method != 0)) {
 if (password == 
# 84 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                ((void *)0)
# 84 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                    ) {
     zip_error_set(&za->error, 26, 0);
     return 
# 86 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 86 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
 if ((enc_impl=_zip_get_encryption_implementation(st.encryption_method)) == 
# 88 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                                                                           ((void *)0)
# 88 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                                                                               ) {
     zip_error_set(&za->error, 24, 0);
     return 
# 90 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 90 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
    }

    comp_impl = 
# 94 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
               ((void *)0)
# 94 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                   ;
    if ((flags & 4u) == 0) {
 if (st.comp_method != 0) {
     if ((comp_impl=_zip_get_compression_implementation(st.comp_method)) == 
# 97 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                                                                           ((void *)0)
# 97 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                                                                               ) {
  zip_error_set(&za->error, 16, 0);
  return 
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
        ((void *)0)
# 99 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
            ;
     }
 }
    }
 ...
 return 
# 105 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 105 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;

    if (st.comp_size == 0) {
 return zip_source_buffer(za, 
# 108 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                             ((void *)0)
# 108 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                                 , 0, 0);
    }

    if (start+len > 0 && enc_impl == 
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                                    ((void *)0) 
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                                         && comp_impl == 
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                                                         ((void *)0)
# 111 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
 ...
 if ((src = _zip_source_window_new(srcza->src, offset+start, st2.size, &st2, &za->error)) == 
# 120 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                                                                                            ((void *)0)
# 120 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                                                                                                ) {
     return 
# 121 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 121 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
    }
    else {
 if ((src = _zip_source_window_new(srcza->src, offset, st.comp_size, &st, &za->error)) == 
# 125 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
                                                                                         ((void *)0)
# 125 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
                                                                                             ) {
     return 
# 126 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 126 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
    }
 ...
 zip_source_free(src);
 return 
# 132 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
       ((void *)0)
# 132 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
           ;
    }
 ...
 zip_source_free(src);
 if (s2 == 
# 140 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 140 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
              ) {
     return 
# 141 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 141 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
 ...
 zip_source_free(src);
 if (s2 == 
# 148 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 148 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
              ) {
     return 
# 149 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 149 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
    if (((flags & 4u) == 0 || st.comp_method == 0) && (len == 0 || len == st.comp_size)) {

 s2 = zip_source_crc(za, src, 1);
 zip_source_free(src);
 if (s2 == 
# 157 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 157 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
              ) {
     return 
# 158 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 158 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
 ...
 zip_source_free(src);
 if (s2 == 
# 166 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
          ((void *)0)
# 166 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
              ) {
     return 
# 167 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c" 3 4
           ((void *)0)
# 167 "/doner/libzip/libzip-1.1.2/lib/zip_source_zip_new.c"
               ;
 }
 src = s2;
    }
