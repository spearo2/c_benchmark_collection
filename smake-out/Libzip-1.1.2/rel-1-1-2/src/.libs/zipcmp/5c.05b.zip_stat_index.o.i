# 1 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
...
# 36 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c" 2
...
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c" 3 4
                                             ((void *)0)
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
                                                 )) == 
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c" 3 4
                                                       ((void *)0)
# 45 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
...
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c" 3 4
                                                ((void *)0)
# 48 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
                                                    )
 return -1;
...
# 53 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c" 3 4
   ((void *)0)
# 53 "/doner/libzip/libzip-1.1.2/lib/zip_stat_index.c"
   )) {
 ...
 if (de->bitflags & 0x0001) {
  ...
  st->encryption_method = 0xffff;
     }
     else
  st->encryption_method = 1;
 }
 else
     st->encryption_method = 0;
 st->valid = 0x0020u|0x0004u|0x0010u
