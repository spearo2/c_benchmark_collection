# 1 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
# 1 "/doner/libzip/libzip-1.1.2/src//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
# 34 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
# 1 "../config.h" 1
# 35 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
...
# 40 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
...
# 42 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
# 51 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
__attribute__ ((visibility ("default"))) zip_error_t *zip_source_error(zip_source_t *src);
...
# 54 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
# 1 "/doner/libzip/libzip-1.1.2/src/compat.h" 1
# 55 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 2
...
# 86 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                  ((void *)0)
# 86 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                      ) {
 fprintf(
# 87 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 87 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 zip_source_free(zs);
 fprintf(
# 93 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 93 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
add_dir(int argc, char *argv[]) {
 ...
 fprintf(
# 103 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 103 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 112 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                          ((void *)0)
# 112 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                              , 10);
    zip_int64_t len = strtoll(argv[3], 
# 113 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                      ((void *)0)
# 113 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                          , 10);

    if (strcmp(argv[1], "/dev/stdin") == 0) {
 if ((zs=zip_source_filep(za, 
# 116 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                             stdin
# 116 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                  , start, len)) == 
# 116 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                    ((void *)0)
# 116 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
     ...
     fprintf(
# 117 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
            stderr
# 117 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                  , "can't create zip_source from stdin: %s\n", zip_strerror(za));
     return -1;
 }
    } else {
 if ((zs=zip_source_file(za, argv[1], start, len)) == 
# 121 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                     ((void *)0)
# 121 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                         ) {
     fprintf(
# 122 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
            stderr
# 122 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 zip_source_free(zs);
 fprintf(
# 129 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 129 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't add file '%s': %s\n", argv[0], zip_strerror(za));
 return -1;
    }
    return 0;
...
add_from_zip(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[2], 
# 142 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 142 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    start = strtoull(argv[3], 
# 143 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                             ((void *)0)
# 143 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                 , 10);
    len = strtoll(argv[4], 
# 144 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                          ((void *)0)
# 144 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                              , 10);
    if ((z_in[z_in_count]=zip_open(argv[1], 4, &err)) == 
# 145 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                    ((void *)0)
# 145 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                        ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 148 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 148 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't open zip archive '%s': %s\n", argv[1], zip_error_strerror(&error));
 zip_error_fini(&error);
 return -1;
    }
    if ((zs=zip_source_zip(za, z_in[z_in_count], idx, 0, start, len)) == 
# 152 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                        ((void *)0)
# 152 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                            ) {
 fprintf(
# 153 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 153 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 153 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 return -1;
    ...
    if (zip_add(za, argv[0], zs) == -1) {
 fprintf(
# 158 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 158 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't add file '%s': %s\n", argv[0], zip_strerror(za));
 zip_source_free(zs);
 zip_close(z_in[z_in_count]);
 return -1;
...
# 170 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                           ((void *)0)
# 170 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                               , 10);

    if ((zs=source_nul(za, length)) == 
# 172 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                      ((void *)0)
# 172 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                          ) {
        fprintf(
# 173 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
               stderr
# 173 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
    ...
    if (zip_add(za, argv[0], zs) == -1) {
        zip_source_free(zs);
        fprintf(
# 179 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
               stderr
# 179 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                     , "can't add file '%s': %s\n", argv[0], zip_strerror(za));
        return -1;
    }
    return 0;
...
cat(int argc, char *argv[]) {
    ...
    int err;
    idx = strtoull(argv[0], 
# 193 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 193 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
...
# 199 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                           ((void *)0)
# 199 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                               ) {
 fprintf(
# 200 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 200 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 204 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                              stdout
# 204 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                    ) != 1) {
     zip_fclose(zf);
     fprintf(
# 206 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
            stderr
# 206 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 206 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 zip_fclose(zf);
 fprintf(
# 212 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 212 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 212 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 zip_error_init_with_code(&error, err);
 fprintf(
# 219 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 219 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
count_extra(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 231 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 231 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    ceflags = get_flags(argv[1]);
    if ((count=zip_file_extra_fields_count(za, idx, ceflags)) < 0) {
 fprintf(
# 234 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 234 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
count_extra_by_id(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 248 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 248 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 249 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                         ((void *)0)
# 249 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                             , 10);
    ceflags = get_flags(argv[2]);
    if ((count=zip_file_extra_fields_count_by_id(za, idx, eid, ceflags)) < 0) {
 fprintf(
# 252 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 252 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't get extra field count for file at index '%" 
# 252 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                   "l" "u" 
# 252 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
delete(int argc, char *argv[]) {
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 263 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 263 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    if (zip_delete(za, idx) < 0) {
 fprintf(
# 265 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 265 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
delete_extra(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 276 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 276 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 277 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                         ((void *)0)
# 277 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                             , 10);
    geflags = get_flags(argv[2]);
    if ((zip_file_extra_field_delete(za, idx, eid, geflags)) < 0) {
 fprintf(
# 280 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 280 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
delete_extra_by_id(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 291 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 291 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 292 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                         ((void *)0)
# 292 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                             , 10);
    eidx = (zip_uint16_t)strtoull(argv[2], 
# 293 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                          ((void *)0)
# 293 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[3]);
    if ((zip_file_extra_field_delete_by_id(za, idx, eid, eidx, geflags)) < 0) {
 fprintf(
# 296 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 296 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't delete extra field data for file at index '%" 
# 296 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                     "l" "u" 
# 296 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 307 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                         ((void *)0)
# 307 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                             )
...
get_extra(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 321 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 321 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    eidx = (zip_uint16_t)strtoull(argv[1], 
# 322 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                          ((void *)0)
# 322 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[2]);
    if ((efdata=zip_file_extra_field_get(za, idx, eidx, &id, &eflen, geflags)) == 
# 324 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                                 ((void *)0)
# 324 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                                     ) {
 fprintf(
# 325 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 325 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
get_extra_by_id(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 343 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 343 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 344 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                         ((void *)0)
# 344 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                             , 10);
    eidx = (zip_uint16_t)strtoull(argv[2], 
# 345 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                          ((void *)0)
# 345 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[3]);
    if ((efdata=zip_file_extra_field_get_by_id(za, idx, eid, eidx, &eflen, geflags)) == 
# 347 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                                       ((void *)0)
# 347 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                                           ) {
 fprintf(
# 348 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 348 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't get extra field data for file at index %" 
# 348 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                 "l" "u" 
# 348 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
get_file_comment(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 366 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 366 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    if ((comment=zip_get_file_comment(za, idx, &len, 0)) == 
# 367 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                           ((void *)0)
# 367 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                               ) {
 fprintf(
# 368 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 368 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
get_num_entries(int argc, char *argv[]) {
    ...
    printf("%" 
# 384 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
              "l" "d" 
# 384 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                     " entr%s in archive\n", count, count == 1 ? "y" : "ies");
    return 0;
}
...
name_locate(int argc, char *argv[]) {
 ...
 fprintf(
# 395 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 395 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't find entry with name '%s' using flags '%s'\n", argv[0], argv[1]);
    } else {
 printf("name '%s' using flags '%s' found at index %" 
# 397 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                     "l" "d" 
# 397 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                            "\n", argv[0], argv[1], idx);
    }
...
zrename(int argc, char *argv[]) {
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 406 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 406 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    if (zip_rename(za, idx, argv[1]) < 0) {
 fprintf(
# 408 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 408 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
replace_file_contents(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 420 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 420 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    content = argv[1];
    if ((s=zip_source_buffer(za, content, strlen(content), 0)) == 
# 422 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                                 ((void *)0) 
# 422 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                      ||
 zip_file_replace(za, idx, s, 0) < 0) {
 zip_source_free(s);
 fprintf(
# 425 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 425 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
set_extra(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 437 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 437 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    eid = (zip_uint16_t)strtoull(argv[1], 
# 438 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                         ((void *)0)
# 438 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                             , 10);
    eidx = (zip_uint16_t)strtoull(argv[2], 
# 439 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                          ((void *)0)
# 439 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                              , 10);
    geflags = get_flags(argv[3]);
 ...
 fprintf(
# 443 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 443 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
set_archive_comment(int argc, char *argv[]) {
 ...
 fprintf(
# 452 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 452 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
set_file_comment(int argc, char *argv[]) {
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 461 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 461 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    if (zip_file_set_comment(za, idx, argv[1], (zip_uint16_t)strlen(argv[1]), 0) < 0) {
 fprintf(
# 463 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 463 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
set_file_compression(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 474 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 474 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    method = get_compression_method(argv[1]);
    flags = (zip_uint32_t)strtoull(argv[2], 
# 476 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                           ((void *)0)
# 476 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                               , 10);
    if (zip_set_file_compression(za, idx, method, flags) < 0) {
 fprintf(
# 478 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 478 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
set_file_mtime(int argc, char *argv[]) {
    ...
    zip_uint64_t idx;
    idx = strtoull(argv[0], 
# 489 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 489 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    mtime = (time_t)strtoull(argv[1], 
# 490 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                     ((void *)0)
# 490 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                         , 10);
    if (zip_file_set_mtime(za, idx, mtime, 0) < 0) {
 fprintf(
# 492 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 492 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 504 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                     ((void *)0)
# 504 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                         , 10);

    if ((num_entries = zip_get_num_entries(za, 0)) < 0) {
        fprintf(
# 507 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
               stderr
# 507 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 if (zip_file_set_mtime(za, idx, mtime, 0) < 0) {
     fprintf(
# 512 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
            stderr
# 512 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                  , "can't set file mtime at index '%" 
# 512 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                       "l" "u" 
# 512 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
set_password(int argc, char *argv[]) {
 ...
 fprintf(
# 523 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 523 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "can't set default password to `%s'", argv[0]);
 return -1;
    }
    return 0;
}
...
zstat(int argc, char *argv[]) {
    ...
    struct zip_stat sb;
    idx = strtoull(argv[0], 
# 534 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 534 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);

    if (zip_stat_index(za, idx, stat_flags, &sb) < 0) {
 fprintf(
# 537 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 537 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 537 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 printf("name: '%s'\n", sb.name);
    if (sb.valid & 0x0002u)
 printf("index: '%"
# 544 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                  "l" "u"
# 544 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                        "'\n", sb.index);
    if (sb.valid & 0x0004u)
 printf("size: '%"
# 546 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                 "l" "u"
# 546 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                       "'\n", sb.size);
    if (sb.valid & 0x0008u)
 printf("compressed size: '%"
# 548 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                            "l" "u"
# 548 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                  "'\n", sb.comp_size);
    if (sb.valid & 0x0010u) {
 struct tm *tpm;
...
unchange_all(int argc, char *argv[]) {
 ...
 fprintf(
# 571 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 571 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
zin_close(int argc, char *argv[]) {
    ...
    idx = strtoull(argv[0], 
# 581 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 581 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               , 10);
    if (idx >= z_in_count) {
 fprintf(
# 583 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 583 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "invalid argument '%" 
# 583 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                      "l" "u" 
# 583 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 fprintf(
# 587 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 587 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
get_flags(const char *arg)
{
    zip_flags_t flags = 0;
    if (strchr(arg, 'C') != 
# 600 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 600 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               )
 flags |= 1u;
    if (strchr(arg, 'c') != 
# 602 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 602 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               )
 flags |= 512u;
    if (strchr(arg, 'd') != 
# 604 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 604 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               )
 flags |= 2u;
    if (strchr(arg, 'l') != 
# 606 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 606 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               )
 flags |= 256u;
    if (strchr(arg, 'u') != 
# 608 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                           ((void *)0)
# 608 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                               )
 flags |= 8u;
    return flags;
}
...
read_hole(const char *archive, int flags, int *err)
{
    zip_error_t error;
    zip_source_t *src = 
# 648 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                       ((void *)0)
# 648 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                           ;
    zip_t *zs = 
# 649 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
               ((void *)0)
# 649 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                   ;

    zip_error_init(&error);

    if ((src = source_hole_create(archive, flags, &error)) == 
# 653 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                             ((void *)0)
        
# 654 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
       || (zs = zip_open_from_source(src, flags, &error)) == 
# 654 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                             ((void *)0)
# 654 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                 ) {
        zip_source_free(src);
...
# 657 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
       (*__errno_location ()) 
# 657 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
read_to_memory(const char *archive, int flags, int *err, zip_source_t **srcp)
{
 ...
 if (
# 673 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
    (*__errno_location ()) 
# 673 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
          == 
# 673 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
             2
# 673 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 674 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                   ((void *)0)
# 674 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                       , 0, 0, &error);
 }
 else {
     *err = 11;
     return 
# 678 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
           ((void *)0)
# 678 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
               ;
 }
    }
    else {
...
# 684 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                        ((void *)0)
# 684 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                            ) {
     *err = 14;
     return 
# 686 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
           ((void *)0)
# 686 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
               ;
 }
 if ((fp=fopen(archive, "r")) == 
# 688 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                ((void *)0)
# 688 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                    ) {
     free(buf);
     *err = 5;
     return 
# 691 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
           ((void *)0)
# 691 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
               ;
 }
 if (fread(buf, (size_t)st.st_size, 1, fp) < 1) {
     ...
     *err = 5;
     return 
# 697 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
           ((void *)0)
# 697 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
               ;
 }
 fclose(fp);
 src = zip_source_buffer_create(buf, (zip_uint64_t)st.st_size, 1, &error);
 if (src == 
# 701 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
           ((void *)0)
# 701 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
               ) {
     free(buf);
 }
    }
    if (src == 
# 705 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
              ((void *)0)
# 705 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                  ) {
 *err = zip_error_code_zip(&error);
 
# 707 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
(*__errno_location ()) 
# 707 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
      = zip_error_code_system(&error);
 return 
# 708 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
       ((void *)0)
# 708 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
           ;
    }
    zb = zip_open_from_source(src, flags, &error);
    if (zb == 
# 711 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
             ((void *)0)
# 711 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                 ) {
 *err = zip_error_code_zip(&error);
 
# 713 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
(*__errno_location ()) 
# 713 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
      = zip_error_code_system(&error);
 zip_source_free(src);
 return 
# 715 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
       ((void *)0)
# 715 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
           ;
    }
    zip_source_keep(src);
    *srcp = src;
...
source_nul_cb(void *ud, void *data, zip_uint64_t length, zip_source_cmd_t command)
{
    ...
    switch (command) {
     ...
     if (length > 
# 750 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                 (9223372036854775807L)
# 750 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                              ) {
...
# 764 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                            ((void *)0) 
# 764 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                            : (zip_stat_t *)(data));

            if (st == 
# 766 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                     ((void *)0)
# 766 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                         ) {
                return -1;
            }
...
# 791 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                       ((void *)0)
# 791 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                           ) {
        zip_error_set(zip_get_error(zs), 14, 0);
        return 
# 793 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
              ((void *)0)
# 793 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                  ;
    }
...
# 800 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                              ((void *)0)
# 800 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                                                  ) {
        free(ctx);
        return 
# 802 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
              ((void *)0)
# 802 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                  ;
    }
...
write_memory_src_to_file(const char *archive, zip_source_t *src)
{
 ...
 fprintf(
# 817 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 817 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 if (zip_error_code_zip(zip_source_error(src)) == 23) {
     if (unlink(archive) < 0 && 
# 822 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                               (*__errno_location ()) 
# 822 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                     != 
# 822 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                        2
# 822 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
  ...
  fprintf(
# 823 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
         stderr
# 823 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
               , "unlink failed: %s\n", strerror(
# 823 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                 (*__errno_location ())
# 823 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 fprintf(
# 828 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 828 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "zip_source_open on buffer failed: %s\n", zip_error_strerror(zip_source_error(src)));
 return -1;
    }
    if ((buf=malloc(zst.size)) == 
# 831 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                 ((void *)0)
# 831 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                     ) {
 fprintf(
# 832 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 832 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "malloc failed: %s\n", strerror(
# 832 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                (*__errno_location ())
# 832 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 fprintf(
# 837 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 837 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
# 843 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                    ((void *)0)
# 843 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                                        ) {
 fprintf(
# 844 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 844 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "fopen failed: %s\n", strerror(
# 844 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                               (*__errno_location ())
# 844 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 fprintf(
# 849 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 849 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "fwrite failed: %s\n", strerror(
# 849 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                (*__errno_location ())
# 849 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 return -1;
    ...
    if (fclose(fp) != 0) {
 fprintf(
# 856 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 856 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
              , "fclose failed: %s\n", strerror(
# 856 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                                                (*__errno_location ())
# 856 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
...
dispatch(int argc, char *argv[])
{
 ...
 if (strcmp(dispatch_table[i].cmdline_name, argv[0]) == 0) {
  ...
  fprintf(
# 904 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
         stderr
# 904 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
  ...
  return 1 + dispatch_table[i].argument_count;
    ...
    fprintf(
# 913 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
           stderr
# 913 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                 , "unknown command '%s'\n", argv[0]);
    return -1;
}
...
usage(const char *progname, const char *reason)
{
    ...
    FILE *out;
    if (reason == 
# 923 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                 ((void *)0)
# 923 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                     )
 out = 
# 924 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
      stdout
# 924 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
            ;
    else
 out = 
# 926 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
      stderr
# 926 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
            ;
    fprintf(out, "usage: %s [-cegHhmnrst] archive command1 [args] [command2 [args] ...]\n", progname);
    if (reason != 
# 928 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
                 ((void *)0)
# 928 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                     ) {
 fprintf(out, "%s\n", reason);
 exit(1);
    }
...
main(int argc, char *argv[])
{
 ...
 case 'h':
     usage(prg, 
# 993 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
               ((void *)0)
# 993 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                   );
     break;
 case 'm':
 ...
 flags = 1;
    ...
    if (za == 
# 1041 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
             ((void *)0)
# 1041 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
                 ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 1044 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 1044 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
 ...
 if (ret > 0) {
    ...
    if (zip_close(za) == -1) {
 fprintf(
# 1062 "/doner/libzip/libzip-1.1.2/src/ziptool.c" 3 4
        stderr
# 1062 "/doner/libzip/libzip-1.1.2/src/ziptool.c"
