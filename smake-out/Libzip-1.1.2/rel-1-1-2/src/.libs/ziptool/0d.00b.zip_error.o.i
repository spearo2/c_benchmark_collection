# 1 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
# 34 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
...
# 35 "/doner/libzip/libzip-1.1.2/lib/zip_error.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/lib/zip_error.c" 2
...
zip_error_fini(zip_error_t *err)
{
    free(err->str);
    err->str = 
# 55 "/doner/libzip/libzip-1.1.2/lib/zip_error.c" 3 4
              ((void *)0)
# 55 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
                  ;
}
...
zip_error_init(zip_error_t *err)
{
    ...
    err->sys_err = 0;
    err->str = 
# 64 "/doner/libzip/libzip-1.1.2/lib/zip_error.c" 3 4
              ((void *)0)
# 64 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
                  ;
}
...
zip_error_init_with_code(zip_error_t *error, int ze)
{
    ...
    case 1:
 error->sys_err = 
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_error.c" 3 4
                 (*__errno_location ())
# 74 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
                      ;
 break;
...
{
    if (err == 
# 96 "/doner/libzip/libzip-1.1.2/lib/zip_error.c" 3 4
              ((void *)0)
# 96 "/doner/libzip/libzip-1.1.2/lib/zip_error.c"
                  )
 return;
