# 1 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
# 35 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
...
# 36 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 37 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 38 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 39 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 40 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2

# 1 "../config.h" 1
# 42 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 45 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 52 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
# 1 "/doner/libzip/libzip-1.1.2/src/compat.h" 1
# 53 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 2
...
# 74 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
char version_string[] = "zipmerge" " (" "libzip" " " "1.1.2" ")\nCopyright (C) 2004-2014 Dieter Baron and Thomas Klausner\n"

  "libzip" " comes with ABSOLUTELY NO WARRANTY, to the extent permitted by law.\n";
# 85 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
int confirm;
...
main(int argc, char *argv[])
{
 ...
 case 'h':
     fputs(help_head, 
# 128 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                     stdout
# 128 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                           );
     printf("usage: %s [-DhIiSsV] target-zip zip...\n", prg);
     fputs(help, 
# 130 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                stdout
# 130 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                      );
     exit(0);
 case 'V':
     fputs(version_string, 
# 133 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                          stdout
# 133 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                );
     exit(0);

 default:
     fprintf(
# 137 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
            stderr
# 137 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
    ...
    if (argc < optind+2) {
 fprintf(
# 143 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 143 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
              , "usage: %s [-DhIiSsV] target-zip zip...\n", prg);
 exit(2);
    }
...
# 151 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                                 ((void *)0)
# 151 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                                     ) {
 fprintf(
# 152 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 152 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
              , "%s: out of memory\n", prg);
 exit(1);
    }

    if ((za=zip_open(tname, 1, &err)) == 
# 156 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                                 ((void *)0)
# 156 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                                     ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 159 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 159 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
...
# 165 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                             ((void *)0)
# 165 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                                 )
     exit(1);
    }
    ...
    if (zip_close(za) < 0) {
 fprintf(
# 170 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 170 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
  ...
  zip_t *zs, const char *sname, zip_uint64_t is)
{
 ...
 fprintf(
# 195 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 195 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
              , "%s: cannot stat file %"
# 195 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                        "l" "u"
# 195 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
 ...
 fprintf(
# 200 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 200 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
              , "%s: cannot stat file %"
# 200 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                        "l" "u"
# 200 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
 ...
 if (confirm & 0x010)
    ...
    printf("replace '%s' (%"
# 212 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                           "l" "u"
# 212 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                 " / %08x) in `%s'\n"
    "   with '%s' (%"
# 213 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                    "l" "u"
# 213 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                          " / %08x) from `%s'? ",
    st.name, st.size, st.crc, tname,
    ss.name, ss.size, ss.crc, sname);
    fflush(
# 216 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
          stdout
# 216 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                );

    if (fgets(line, sizeof(line), 
# 218 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                 stdin
# 218 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                      ) == 
# 218 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                           ((void *)0)
# 218 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
 ...
 fprintf(
# 219 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 219 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
              , "%s: read error from stdin: %s\n",
  prg, strerror(
# 220 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
               (*__errno_location ())
# 220 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                    ));
 return -1;
    }

    if (
# 224 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
       (__extension__ ({ int __res; if (sizeof (
# 224 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
...
# 241 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                        ((void *)0)
# 241 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                                            ) {
 zip_error_t error;
 zip_error_init_with_code(&error, err);
 fprintf(
# 244 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        stderr
# 244 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
              , "%s: can't open zip archive '%s': %s\n", prg, sname, zip_error_strerror(&error));
 zip_error_fini(&error);
 return 
# 246 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
       ((void *)0)
# 246 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
           ;
    }
    ...
    if (ret < 0) {
        fprintf(
# 251 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
               stderr
# 251 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                     , "%s: cannot get number of entries for '%s': %s\n", prg, sname, zip_strerror(za));
        return 
# 252 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
              ((void *)0)
# 252 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                  ;
    }
...
# 263 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                                    ((void *)0)
      
# 264 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
     || zip_replace(za, (zip_uint64_t)idx, source) < 0) {
      zip_source_free(source);
      fprintf(
# 266 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
             stderr
# 266 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                   ,
       "%s: cannot replace '%s' in `%s': %s\n",
       prg, fname, tname, zip_strerror(za));
                    zip_close(zs);
      return 
# 270 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
            ((void *)0)
# 270 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
                ;
  }
  break;
  ...
  zip_close(zs);
  return 
# 276 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        ((void *)0)
# 276 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
            ;

     default:
  fprintf(
# 279 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
         stderr
# 279 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
               , "%s: internal error: "
   "unexpected return code from confirm (%d)\n",
   prg, err);
  zip_close(zs);
  return 
# 283 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        ((void *)0)
# 283 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
            ;
     }
 }
 else {
     if ((source=zip_source_zip(za, zs, i, 0, 0, 0)) == 
# 287 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
                                                       ((void *)0)
  
# 288 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
 || zip_add(za, fname, source) < 0) {
  zip_source_free(source);
  fprintf(
# 290 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
         stderr
# 290 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
               ,
   "%s: cannot add '%s' to `%s': %s\n",
   prg, fname, tname, zip_strerror(za));
  zip_close(zs);
  return 
# 294 "/doner/libzip/libzip-1.1.2/src/zipmerge.c" 3 4
        ((void *)0)
# 294 "/doner/libzip/libzip-1.1.2/src/zipmerge.c"
            ;
     }
 }
    }
