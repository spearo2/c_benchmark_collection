# 1 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
# 31 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
...
# 32 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2
...
# 33 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 36 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2
# 45 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
# 1 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.h" 1
# 46 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2
...
# 47 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2
# 105 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
...
# 106 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2
...
# 108 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 2
# 165 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
struct line_entry {
...
get_line_subseg (segT seg, subsegT subseg, bfd_boolean create_p)
{
  ...
  if (s == 
# 251 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
          ((void *)0)
# 251 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
              )
    {
      if (!create_p)
 return 
# 254 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
       ((void *)0)
# 254 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
           ;

      s = ((struct line_seg *) xmalloc (sizeof (struct line_seg)));
      s->next = 
# 257 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
               ((void *)0)
# 257 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                   ;
      s->seg = seg;
      s->head = 
# 259 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
               ((void *)0)
# 259 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                   ;
      *last_seg_ptr = s;
      last_seg_ptr = &s->next;
      ((segment_info_type *) ((void) stdoutput, (seg)->userdata))->dwarf2_line_seg = s;
    }
  ((void) ((seg == s->seg) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 264, __PRETTY_FUNCTION__), 0)));

  for (pss = &s->head; (lss = *pss) != 
# 266 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                                      ((void *)0) 
# 266 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                                           ; pss = &lss->next)
    {
 ...
 break;
  ...
  lss->subseg = subseg;
  lss->head = 
# 277 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
             ((void *)0)
# 277 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                 ;
  lss->ptail = &lss->head;
...
dwarf2_gen_line_info_1 (symbolS *label, struct dwarf2_line_info *loc)
{
  ...
  e->next = 
# 295 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
           ((void *)0)
# 295 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
               ;
  e->label = label;
  e->loc = *loc;
  ...
  if (*input_line_pointer == '"')
    {
      s_app_file (0);
      return 
# 576 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
            ((void *)0)
# 576 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                ;
    }
  ...
  if (filename == 
# 581 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                 ((void *)0)
# 581 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                     )
    return 
# 582 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
          ((void *)0)
# 582 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
              ;
  ...
  if (num < 1)
    {
      ...
      return 
# 588 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
            ((void *)0)
# 588 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                ;
    }
  ...
  if (num < (int) files_in_use && files[num].filename != 0)
    {
      ...
      return 
# 598 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
            ((void *)0)
# 598 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                ;
    }
...
last_frag_for_seg (segT seg)
{
  ...
  while (f->frch_next != 
# 767 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                        ((void *)0)
# 767 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                            )
    f = f->frch_next;
...
get_frag_fix (fragS *frag, segT seg)
{
  ...
  as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 847, __PRETTY_FUNCTION__);
}
...
# 891 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
static int
...
emit_inc_line_addr (int line_delta, addressT addr_delta, char *p, int len)
{
  ...
  ((void) (((offsetT) addr_delta >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 959, __PRETTY_FUNCTION__), 0)));
 ...
 *p++ = DW_LNS_const_add_pc;
  ...
  *p++ = DW_LNS_advance_pc;
  ...
  ((void) ((p == end) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1040, __PRETTY_FUNCTION__), 0)));
}
...
# 1059 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
static int
     ...
     char *p, int len)
{
  ...
  ((void) (((offsetT) addr_delta >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1098, __PRETTY_FUNCTION__), 0)));


  ((void) ((len == size_fixed_inc_line_addr (line_delta, addr_delta)) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1101, __PRETTY_FUNCTION__), 0)));
  ...
  if (addr_delta > 50000)
    {
      ...
      ((void) ((pexp->X_op == O_subtract) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1122, __PRETTY_FUNCTION__), 0)));
  ...
  ((void) ((p == end) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1150, __PRETTY_FUNCTION__), 0)));
}
...
# 1176 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                                         ((void *)0)
# 1176 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                                             );
}
...
dwarf2dbg_convert_frag (fragS *frag)
{
  ...
  if (linkrelax)
    {
# 1234 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
  ...
  ((void) ((frag->fr_var >= (int) frag->fr_subtype) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1246, __PRETTY_FUNCTION__), 0)));
...
process_entries (segT seg, struct line_entry *e)
{
  ...
  fragS *last_frag = 
# 1273 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                    ((void *)0)
# 1273 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                        , *frag;
  addressT last_frag_ofs = 0, frag_ofs;
  symbolS *last_lab = 
# 1275 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                     ((void *)0)
# 1275 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                         , *lab;
  struct line_entry *next;
  ...
  if (flag_dwarf_sections)
    {
      char * name;
      const char * sec_name;
# 1295 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
      sec_name = ((void) stdoutput, (seg)->name);
      if (strcmp (sec_name, ".text") != 0)
 {
   name = concat (".debug_line", sec_name, (char *) 
# 1298 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                                                   ((void *)0)
# 1298 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                                                       );
 ...
 out_opcode (DW_LNS_set_epilogue_begin);
      ...
      if (last_frag == 
# 1365 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                      ((void *)0)
# 1365 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                          )
 {
   out_set_addr (lab);
  ...
  for (i = 1; i < files_in_use; ++i)
    {
      ...
      if (files[i].filename == 
# 1423 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                              ((void *)0)
# 1423 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                                  )
 {
    ...
    segT line_seg __attribute__ ((__unused__)))
{
  ...
  if (all_segs->next == 
# 1713 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                       ((void *)0)
# 1713 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                           )
    {
  ...
  symbolS *name_sym, symbolS *comp_dir_sym, symbolS *producer_sym)
{
  ...
  if (all_segs->next == 
# 1770 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                       ((void *)0)
# 1770 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                           )
    {
        ...
        symbolS **producer_sym)
{
  ...
  *name_sym = symbol_temp_new_now ();
  if (files_in_use == 0)
    as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1830, __PRETTY_FUNCTION__);
  if (files[1].dir)
    {
  ...
  *producer_sym = symbol_temp_new_now ();
  sprintf (producer, "GNU AS %s", "2.29.1");
...
# 1880 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
void
dwarf2_finish (void)
{
  segT line_seg;
...
# 1890 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                                   ((void *)0) 
# 1890 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                                        || !seg_not_empty_p (info_seg);

  line_seg = bfd_get_section_by_name (stdoutput, ".debug_line");
  empty_debug_line = line_seg == 
# 1893 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                                ((void *)0) 
# 1893 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
  ...
  for (s = all_segs; s; s = s->next)
    {
      ...
      while ((lss = lss->next) != 
# 1920 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                                 ((void *)0)
# 1920 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                                     )
 {
   *ptail = lss->head;
   ptail = lss->ptail;
  ...
  if (emit_other_sections)
    {
      ...
      ((void) ((all_segs) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c", 1940, __PRETTY_FUNCTION__), 0)));
      ...
      if (all_segs->next == 
# 1960 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
                           ((void *)0)
# 1960 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                               )
 ranges_seg = 
# 1961 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c" 3 4
             ((void *)0)
# 1961 "/doner/binutils/binutils-7a31b38/gas/dwarf2dbg.c"
                 ;
      else
 {
