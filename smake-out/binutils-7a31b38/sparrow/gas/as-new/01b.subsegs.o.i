# 1 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
# 23 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
...
# 24 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 2
...
subsegs_begin (void)
{
  ...
  frchain_now = 
# 43 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
               ((void *)0)
# 43 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                   ;
  frag_now = &dummy_frag;
}
# 57 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
void
...
subseg_set_rest (segT seg, subsegT subseg)
{
  ...
  mri_common_symbol = 
# 80 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
                     ((void *)0)
# 80 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                         ;

  if (frag_now && frchain_now)
    frchain_now->frch_frag_now = frag_now;

  ((void) ((frchain_now == 0 || frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/subsegs.c", 85, __PRETTY_FUNCTION__), 0)))
                                         ;
  ...
  for (frcP = *(lastPP = &seginfo->frchainP);
       frcP != 
# 95 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
              ((void *)0)
# 95 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                  ;
  ...
  if (frcP == 
# 100 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
             ((void *)0) 
# 100 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                  || frcP->frch_subseg != subseg)
    {
      ...
      newP->fix_root = 
# 106 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
                      ((void *)0)
# 106 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                          ;
      newP->fix_tail = 
# 107 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
                      ((void *)0)
# 107 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                          ;
      ...
      newP->frch_cfi_data = 
# 114 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
                           ((void *)0)
# 114 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                               ;
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/subsegs.c", 126, __PRETTY_FUNCTION__), 0)));
}
# 144 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
segT
...
subseg_set (segT secptr, subsegT subseg)
{
  if (! (secptr == now_seg && subseg == now_subseg))
    subseg_set_rest (secptr, subseg);
  mri_common_symbol = 
# 202 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
                     ((void *)0)
# 202 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                         ;
}
...
section_symbol (segT sec)
{
  ...
  if (seginfo == 0)
    as_abort ("/doner/binutils/binutils-7a31b38/gas/subsegs.c", 216, __PRETTY_FUNCTION__);
  if (seginfo->sym)
    return seginfo->sym;
  ...
  if (! 1 || symbol_table_frozen)
  ...
  else
    {
      ...
      if (s == 
# 235 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
              ((void *)0)
   
# 236 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
...
subsegs_print_statistics (FILE *file)
{
  ...
  if (stdoutput == 
# 301 "/doner/binutils/binutils-7a31b38/gas/subsegs.c" 3 4
                  ((void *)0)
# 301 "/doner/binutils/binutils-7a31b38/gas/subsegs.c"
                      )
    return;
