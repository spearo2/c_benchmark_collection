# 1 "/doner/binutils/binutils-7a31b38/gas/depend.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/depend.c"
# 21 "/doner/binutils/binutils-7a31b38/gas/depend.c"
...
# 22 "/doner/binutils/binutils-7a31b38/gas/depend.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/gas/depend.c" 2


static char * dep_file = 
# 25 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                        ((void *)0)
# 25 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                            ;
...
# 34 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                                      ((void *)0)
# 34 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                                          ;
...
register_dependency (const char *filename)
{
  ...
  if (dep_file == 
# 61 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                 ((void *)0)
# 61 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                     )
    return;

  for (dep = dep_chain; dep != 
# 64 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                              ((void *)0)
# 64 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                                  ; dep = dep->next)
    {
...
# 147 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                                  ((void *)0)
# 147 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                                      , string);
...
print_dependencies (void)
{
  ...
  if (dep_file == 
# 188 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                 ((void *)0)
# 188 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                     )
    return;

  f = fopen (dep_file, "w");
  if (f == 
# 192 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
          ((void *)0)
# 192 "/doner/binutils/binutils-7a31b38/gas/depend.c"
              )
    {
  ...
  for (dep = dep_chain; dep != 
# 200 "/doner/binutils/binutils-7a31b38/gas/depend.c" 3 4
                              ((void *)0)
# 200 "/doner/binutils/binutils-7a31b38/gas/depend.c"
                                  ; dep = dep->next)
