# 1 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
# 21 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
...
# 22 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 2
...
# 25 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 2
# 62 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
...
int macro_nest;
# 99 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
...
input_scrub_reinit (void)
{
  ...
  logical_input_file = 
# 141 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                      ((void *)0)
# 141 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                          ;
...
{
  ((void) ((strlen (("\n")) == (1)) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/input-scrub.c", 212, __PRETTY_FUNCTION__), 0)));
  ((void) ((strlen (("\0")) == (1) || (("\0")[0] == '\0' && (1) == 1)) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/input-scrub.c", 213, __PRETTY_FUNCTION__), 0)))
                                                 ;

  physical_input_file = 
# 216 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                       ((void *)0)
# 216 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                           ;
  next_saved_file = 
# 217 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                   ((void *)0)
# 217 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                       ;
  input_scrub_reinit ();
  do_scrub_begin (0);
}
...
input_scrub_include_sb (sb *from, char *position, int is_expansion)
{
  ...
  ++macro_nest;
# 277 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
  next_saved_file = input_scrub_push (position);
...
input_scrub_next_buffer (char **bufp)
{
      ...
      if (sb_index >= from_sb.len)
 {
   ...
   --macro_nest;
   partial_where = 
# 330 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                  ((void *)0)
# 330 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                      ;
   partial_size = 0;
   if (next_saved_file != 
# 332 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                         ((void *)0)
# 332 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                             )
...
# 404 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
 ((void *)0)
# 404 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
 ); };


  partial_where = 
# 407 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                 ((void *)0)
# 407 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                     ;
  if (next_saved_file)
    *bufp = input_scrub_pop (next_saved_file);
...
# 420 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                                ((void *)0)
# 420 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                                    );
}
...
# 442 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
int
   ...
   int flags)
{
  switch (flags)
    ...
    case 1:
      if (line_number != -1)
 as_abort ("/doner/binutils/binutils-7a31b38/gas/input-scrub.c", 453, __PRETTY_FUNCTION__);
      break;
    case 1 << 1:
    case 1 << 2:
      ...
      break;
    default:
      as_abort ("/doner/binutils/binutils-7a31b38/gas/input-scrub.c", 460, __PRETTY_FUNCTION__);
    }
  ...
  if (line_number >= 0)
  ...
  else if (line_number == -1 && fname && !*fname && (flags & (1 << 2)))
    {
      ...
      fname = 
# 469 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
             ((void *)0)
# 469 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                 ;
    }

  if (fname
      && (logical_input_file == 
# 473 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                               ((void *)0)
   
# 474 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
...
# 495 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                           ((void *)0)
      
# 496 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
     && (linep == 
# 496 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                  ((void *)0) 
# 496 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                       || logical_input_line >= 0))
    {
      if (linep != 
# 498 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                  ((void *)0)
# 498 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                      )
 *linep = logical_input_line;
      return logical_input_file;
    }
  else if (physical_input_file != 
# 502 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                                 ((void *)0)
# 502 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                                     )
    {
      if (linep != 
# 504 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                  ((void *)0)
# 504 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                      )
 *linep = physical_input_line;
    ...
    {
      if (linep != 
# 510 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
                  ((void *)0)
# 510 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                      )
 *linep = 0;
      return 
# 512 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c" 3 4
            ((void *)0)
# 512 "/doner/binutils/binutils-7a31b38/gas/input-scrub.c"
                ;
    }
}
