# 1 "/doner/binutils/binutils-7a31b38/gas/hash.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/hash.c"
# 30 "/doner/binutils/binutils-7a31b38/gas/hash.c"
...
# 31 "/doner/binutils/binutils-7a31b38/gas/hash.c" 2
...
# 32 "/doner/binutils/binutils-7a31b38/gas/hash.c" 2
...
# 33 "/doner/binutils/binutils-7a31b38/gas/hash.c" 2
...
# 67 "/doner/binutils/binutils-7a31b38/gas/hash.c"
};
...
hash_new_sized (unsigned long size)
{
  ...
  ret->size = size;
# 106 "/doner/binutils/binutils-7a31b38/gas/hash.c"
  return ret;
}
...
# 133 "/doner/binutils/binutils-7a31b38/gas/hash.c"
      ...
      struct hash_entry ***plist, unsigned long *phash)
{
  ...
  if (phash != 
# 159 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
              ((void *)0)
# 159 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                  )
    *phash = hash;
  ...
  if (plist != 
# 165 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
              ((void *)0)
# 165 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                  )
    *plist = list;

  prev = 
# 168 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
        ((void *)0)
# 168 "/doner/binutils/binutils-7a31b38/gas/hash.c"
            ;
  for (p = *list; p != 
# 169 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                      ((void *)0)
# 169 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                          ; p = p->next)
    {
      ...
      if (p->hash == hash)
 {
   ...
   if (strncmp (p->string, key, len) == 0 && p->string[len] == '\0')
     {
       if (prev != 
# 183 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                  ((void *)0)
# 183 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                      )
  {
    prev->next = p->next;
    p->next = *list;
  ...
  return 
# 197 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
        ((void *)0)
# 197 "/doner/binutils/binutils-7a31b38/gas/hash.c"
            ;
}
...
hash_insert (struct hash_control *table, const char *key, void *val)
{
  ...
  if (p != 
# 213 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 213 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              )
    return "exists";
  ...
  *list = p;
  ...
  return 
# 228 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
        ((void *)0)
# 228 "/doner/binutils/binutils-7a31b38/gas/hash.c"
            ;
}
...
hash_jam (struct hash_control *table, const char *key, void *val)
{
  ...
  p = hash_lookup (table, key, strlen (key), &list, &hash);
  if (p != 
# 243 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 243 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              )
    {
  ...
  return 
# 266 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
        ((void *)0)
# 266 "/doner/binutils/binutils-7a31b38/gas/hash.c"
            ;
}
...
# 279 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                            ((void *)0)
# 279 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                                                , 
# 279 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                                  ((void *)0)
# 279 "/doner/binutils/binutils-7a31b38/gas/hash.c"
  ...
  if (p == 
# 280 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 280 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              )
    return 
# 281 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 281 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              ;
...
hash_find (struct hash_control *table, const char *key)
{
  ...
  p = hash_lookup (table, key, strlen (key), 
# 302 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                            ((void *)0)
# 302 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                                                , 
# 302 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                                  ((void *)0)
# 302 "/doner/binutils/binutils-7a31b38/gas/hash.c"
  ...
  if (p == 
# 303 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 303 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              )
    return 
# 304 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 304 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              ;
...
# 317 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                   ((void *)0)
# 317 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                                       , 
# 317 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                         ((void *)0)
# 317 "/doner/binutils/binutils-7a31b38/gas/hash.c"
  ...
  if (p == 
# 318 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 318 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              )
    return 
# 319 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 319 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              ;
...
# 333 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                                   ((void *)0)
# 333 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                                                       );
  if (p == 
# 334 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 334 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              )
    return 
# 335 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
          ((void *)0)
# 335 "/doner/binutils/binutils-7a31b38/gas/hash.c"
              ;

  if (p != *list)
    as_abort ("/doner/binutils/binutils-7a31b38/gas/hash.c", 338, __PRETTY_FUNCTION__);
...
# 365 "/doner/binutils/binutils-7a31b38/gas/hash.c" 3 4
                                    ((void *)0)
# 365 "/doner/binutils/binutils-7a31b38/gas/hash.c"
                                        ; p = p->next)
 (*pfn) (p->string, p->data);
    }
}
...
{
# 409 "/doner/binutils/binutils-7a31b38/gas/hash.c"
}
