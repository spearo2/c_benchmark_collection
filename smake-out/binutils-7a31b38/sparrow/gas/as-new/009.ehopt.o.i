# 1 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
# 22 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
...
# 23 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 2
...
# 25 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 2
...
# 31 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 2
# 92 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
struct cie_info
{
...
get_cie_info (struct cie_info *info)
{
  ...
  offset = 4;
  while (f != 
# 128 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
             ((void *)0) 
# 128 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                  && offset >= f->fr_fix)
    {
      offset -= f->fr_fix;
      f = f->fr_next;
  ...
  if (f == 
# 133 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
          ((void *)0)
      
# 134 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
     || f->fr_fix - offset < 4
  ...
  offset += 4;
  while (f != 
# 144 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
             ((void *)0) 
# 144 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                  && offset >= f->fr_fix)
    {
      offset -= f->fr_fix;
      f = f->fr_next;
  ...
  if (f == 
# 149 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
          ((void *)0)
      
# 150 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
     || f->fr_fix - offset < 1
  ...
  while (1)
    {
      while (f != 
# 160 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
                 ((void *)0) 
# 160 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                      && offset >= f->fr_fix)
 {
   offset -= f->fr_fix;
   f = f->fr_next;
      ...
      if (f == 
# 165 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
              ((void *)0)
# 165 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                  )
 return 0;
 ...
 break;
  ...
  ++offset;
  while (f != 
# 181 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
             ((void *)0) 
# 181 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                  && offset >= f->fr_fix)
    {
      offset -= f->fr_fix;
      f = f->fr_next;
  ...
  if (f == 
# 186 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
          ((void *)0)
# 186 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
              )
    return 0;
  ...
  if (augmentation[0] == '\0')
  ...
  else if (strcmp (augmentation, "eh") == 0)
    {
      ...
      while (fix != 
# 198 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
                   ((void *)0)
      
# 199 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
     && (fix->fx_frag != f || fix->fx_where != offset))
 fix = fix->fx_next;
      if (fix == 
# 201 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
                ((void *)0)
# 201 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                    )
 offset += 4;
      else
 offset += fix->fx_size;
      while (f != 
# 205 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
                 ((void *)0) 
# 205 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                      && offset >= f->fr_fix)
 {
   offset -= f->fr_fix;
   f = f->fr_next;
      ...
      if (f == 
# 210 "/doner/binutils/binutils-7a31b38/gas/ehopt.c" 3 4
              ((void *)0)
# 210 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
                  )
 return 0;
    }
...
# 255 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
int
check_eh_frame (expressionS *exp, unsigned int *pnbytes)
{
  ...
  switch (d->state)
    ...
    case state_idle:
      if (*pnbytes == 4)
 {
# 317 "/doner/binutils/binutils-7a31b38/gas/ehopt.c"
...
eh_frame_estimate_size_before_relax (fragS *frag)
{
  ...
  ((void) ((ca > 0) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/ehopt.c", 479, __PRETTY_FUNCTION__), 0)));
  diff /= ca;
  if (diff < 0x40)
    ret = 0;
  else if (diff < 0x100)
...
eh_frame_convert_frag (fragS *frag)
{
  ...
  ((void) ((ca > 0) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/ehopt.c", 526, __PRETTY_FUNCTION__), 0)));
  diff /= ca;
  switch (frag->fr_subtype & 7)
    {
    case 0:
      ((void) ((diff < 0x40) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/ehopt.c", 531, __PRETTY_FUNCTION__), 0)));
      loc4_frag->fr_literal[loc4_fix] = DW_CFA_advance_loc | diff;
      break;

    case 1:
      ((void) ((diff < 0x100) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/ehopt.c", 536, __PRETTY_FUNCTION__), 0)));
      loc4_frag->fr_literal[loc4_fix] = DW_CFA_advance_loc1;
      frag->fr_literal[frag->fr_fix] = diff;
      break;

    case 2:
      ((void) ((diff < 0x10000) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/ehopt.c", 542, __PRETTY_FUNCTION__), 0)));
