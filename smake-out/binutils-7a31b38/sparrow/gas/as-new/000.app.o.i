# 1 "/doner/binutils/binutils-7a31b38/gas/app.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/app.c"
# 27 "/doner/binutils/binutils-7a31b38/gas/app.c"
...
# 28 "/doner/binutils/binutils-7a31b38/gas/app.c" 2
# 59 "/doner/binutils/binutils-7a31b38/gas/app.c"
static char lex[256];
static const char symbol_chars[] =
"$._ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
# 94 "/doner/binutils/binutils-7a31b38/gas/app.c"
...
# 176 "/doner/binutils/binutils-7a31b38/gas/app.c"
  if (lex['/'] == 0)
    lex['/'] = 6;
# 209 "/doner/binutils/binutils-7a31b38/gas/app.c"
}
...
app_push (void)
{
  ...
  if (saved_input == 
# 258 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                    ((void *)0)
# 258 "/doner/binutils/binutils-7a31b38/gas/app.c"
                        )
    saved->saved_input = 
# 259 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                        ((void *)0)
# 259 "/doner/binutils/binutils-7a31b38/gas/app.c"
                            ;
  else
    {
  ...
  state = 0;
  saved_input = 
# 278 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
               ((void *)0)
# 278 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   ;
  add_newlines = 0;
...
# 295 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                           ((void *)0)
# 295 "/doner/binutils/binutils-7a31b38/gas/app.c"
                               )
    saved_input = 
# 296 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                 ((void *)0)
# 296 "/doner/binutils/binutils-7a31b38/gas/app.c"
                     ;
  else
    {
      ((void) ((saved->saved_input_len <= sizeof (input_buffer)) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/app.c", 299, __PRETTY_FUNCTION__), 0)));
...
# 355 "/doner/binutils/binutils-7a31b38/gas/app.c"
size_t
...
# 450 "/doner/binutils/binutils-7a31b38/gas/app.c"
  if (saved_input != 
# 450 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                    ((void *)0)
# 450 "/doner/binutils/binutils-7a31b38/gas/app.c"
                        )
    {
...
# 486 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        ((void *)0)
# 486 "/doner/binutils/binutils-7a31b38/gas/app.c"
...
# 486 "/doner/binutils/binutils-7a31b38/gas/app.c"
    ...
    if (ch == 
# 488 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
             (-1)
# 488 "/doner/binutils/binutils-7a31b38/gas/app.c"
                )
      {
...
# 499 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                   ((void *)0)
# 499 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 499 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                   (-1) 
# 499 "/doner/binutils/binutils-7a31b38/gas/app.c"
  ...
  ;
       ...
       if (ch == 
# 502 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                (-1)
# 502 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   )
  {
    as_warn (gettext ("end of file in comment"));
    goto fromeof;
 ...
 case 4:
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 519 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       ((void *)0)
# 519 "/doner/binutils/binutils-7a31b38/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 519 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       (-1) 
# 519 "/doner/binutils/binutils-7a31b38/gas/app.c"
       : * (unsigned char *) (from++))));
   if (ch == 
# 520 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1)
# 520 "/doner/binutils/binutils-7a31b38/gas/app.c"
               )
     goto fromeof;
   else if (ch >= '0' && ch <= '9')
     do { *to++ = (ch); if (to >= toend) goto tofull; } while (0);
     ...
     {
       while (ch != 
# 526 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                   (-1) 
# 526 "/doner/binutils/binutils-7a31b38/gas/app.c"
                       && (lex[ch] == 2))
  ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 527 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
      ((void *)0)
# 527 "/doner/binutils/binutils-7a31b38/gas/app.c"
      , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 527 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
      (-1) 
# 527 "/doner/binutils/binutils-7a31b38/gas/app.c"
  ...
  {
    while (ch != 
# 537 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                (-1) 
# 537 "/doner/binutils/binutils-7a31b38/gas/app.c"
                    && ch != '\n')
      ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 538 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
          ((void *)0)
# 538 "/doner/binutils/binutils-7a31b38/gas/app.c"
          , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 538 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
          (-1) 
# 538 "/doner/binutils/binutils-7a31b38/gas/app.c"
 ...
 case 5:
  ...
  if (to >= toend)
   ...
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 575 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       ((void *)0)
# 575 "/doner/binutils/binutils-7a31b38/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 575 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       (-1) 
# 575 "/doner/binutils/binutils-7a31b38/gas/app.c"
       : * (unsigned char *) (from++))));
   if (ch == 
# 576 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1)
# 576 "/doner/binutils/binutils-7a31b38/gas/app.c"
               )
     {
 ...
 case 6:
   state = 5;
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 617 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       ((void *)0)
# 617 "/doner/binutils/binutils-7a31b38/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 617 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       (-1) 
# 617 "/doner/binutils/binutils-7a31b38/gas/app.c"
   ...
   switch (ch)
     ...
     case 
# 628 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
         (-1)
# 628 "/doner/binutils/binutils-7a31b38/gas/app.c"
            :
       as_warn (gettext ("end of file in string; '%c' inserted"), quotechar);
       do { *to++ = (quotechar); if (to >= toend) goto tofull; } while (0);
       continue;
   ...
   do { *to++ = (ch); if (to >= toend) goto tofull; } while (0);
   continue;
# 711 "/doner/binutils/binutils-7a31b38/gas/app.c"
 }
      ...
      ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 716 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
          ((void *)0)
# 716 "/doner/binutils/binutils-7a31b38/gas/app.c"
          , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 716 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
          (-1) 
# 716 "/doner/binutils/binutils-7a31b38/gas/app.c"
          : * (unsigned char *) (from++))));
# 741 "/doner/binutils/binutils-7a31b38/gas/app.c"
    recycle:
# 825 "/doner/binutils/binutils-7a31b38/gas/app.c"
      if (ch == 
# 825 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
               (-1)
# 825 "/doner/binutils/binutils-7a31b38/gas/app.c"
                  )
 {
 ...
 case 2:
   do
     {
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 841 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           ((void *)0)
# 841 "/doner/binutils/binutils-7a31b38/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 841 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           (-1) 
# 841 "/doner/binutils/binutils-7a31b38/gas/app.c"
   ...
   while (ch != 
# 843 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
               (-1) 
# 843 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   && (lex[ch] == 2));
   if (ch == 
# 844 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1)
# 844 "/doner/binutils/binutils-7a31b38/gas/app.c"
               )
     goto fromeof;
...
# 874 "/doner/binutils/binutils-7a31b38/gas/app.c"
   if ((lex[ch] == 4)
       || ch == '/'
       || (lex[ch] == 3)
       || (lex[ch] == 14))
       ...
       else
  {
    ...
    state = 3;
       ...
       break;
     default:
       { as_fatal (gettext ("Case value %ld unexpected at line %d of file \"%s\"\n"), (long) state, 962, "/doner/binutils/binutils-7a31b38/gas/app.c"); };
     }
   break;

 case 6:
   ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 967 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        ((void *)0)
# 967 "/doner/binutils/binutils-7a31b38/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 967 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        (-1) 
# 967 "/doner/binutils/binutils-7a31b38/gas/app.c"
       ...
       for (;;)
  {
    do
      {
        ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 974 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
             ((void *)0)
# 974 "/doner/binutils/binutils-7a31b38/gas/app.c"
             , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 974 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
             (-1) 
# 974 "/doner/binutils/binutils-7a31b38/gas/app.c"
             : * (unsigned char *) (from++))));
        if (ch2 != 
# 975 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                  (-1) 
# 975 "/doner/binutils/binutils-7a31b38/gas/app.c"
                      && (lex[ch2] == 10))
   add_newlines++;
      }
    while (ch2 != 
# 978 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                 (-1) 
# 978 "/doner/binutils/binutils-7a31b38/gas/app.c"
                     && ch2 != '*');

    while (ch2 == '*')
      ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 981 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           ((void *)0)
# 981 "/doner/binutils/binutils-7a31b38/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 981 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           (-1) 
# 981 "/doner/binutils/binutils-7a31b38/gas/app.c"
    ...
    if (ch2 == 
# 983 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
              (-1) 
# 983 "/doner/binutils/binutils-7a31b38/gas/app.c"
                  || ch2 == '/')
      break;
    ...
    (*--from = (ch2));
       ...
       if (ch2 == 
# 991 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                 (-1)
# 991 "/doner/binutils/binutils-7a31b38/gas/app.c"
                    )
...
# 1012 "/doner/binutils/binutils-7a31b38/gas/app.c"
   else
     {
       if (ch2 != 
# 1014 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                 (-1)
# 1014 "/doner/binutils/binutils-7a31b38/gas/app.c"
                    )
  (*--from = (ch2));
       if (state == 9 || state == 10)
  state = 3;
   ...
   if (state == 10)
     {
       ...
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1033 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           ((void *)0)
# 1033 "/doner/binutils/binutils-7a31b38/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1033 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           (-1) 
# 1033 "/doner/binutils/binutils-7a31b38/gas/app.c"
 ...
 case 11:
# 1056 "/doner/binutils/binutils-7a31b38/gas/app.c"
   if (state == 10)
     {
   ...
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1064 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       ((void *)0)
# 1064 "/doner/binutils/binutils-7a31b38/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1064 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
       (-1) 
# 1064 "/doner/binutils/binutils-7a31b38/gas/app.c"
       : * (unsigned char *) (from++))));
   if (ch == 
# 1065 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1)
# 1065 "/doner/binutils/binutils-7a31b38/gas/app.c"
               )
     {
   ...
   if (ch == '\\')
     {
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1072 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           ((void *)0)
# 1072 "/doner/binutils/binutils-7a31b38/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1072 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           (-1) 
# 1072 "/doner/binutils/binutils-7a31b38/gas/app.c"
           : * (unsigned char *) (from++))));
       if (ch == 
# 1073 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                (-1)
# 1073 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   )
  {
...
# 1084 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            ((void *)0)
# 1084 "/doner/binutils/binutils-7a31b38/gas/app.c"
            , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1084 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1) 
# 1084 "/doner/binutils/binutils-7a31b38/gas/app.c"
            : * (unsigned char *) (from++))))) != '\'')
     {
       ...
       if (ch != 
# 1089 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                (-1)
# 1089 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   )
  (*--from = (ch));
 ...
 case 14:
   ...
   do { *to++ = (ch); if (to >= toend) goto tofull; } while (0);
   break;
# 1177 "/doner/binutils/binutils-7a31b38/gas/app.c"
 case 5:
   ...
   if (ch == '/')
     {
       ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1184 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            ((void *)0)
# 1184 "/doner/binutils/binutils-7a31b38/gas/app.c"
            , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1184 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1) 
# 1184 "/doner/binutils/binutils-7a31b38/gas/app.c"
...
# 1191 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                      (-1)
# 1191 "/doner/binutils/binutils-7a31b38/gas/app.c"
                         )
  {
    (*--from = (ch2));
  }
  ...
  {
    ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1205 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        ((void *)0)
# 1205 "/doner/binutils/binutils-7a31b38/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1205 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        (-1) 
# 1205 "/doner/binutils/binutils-7a31b38/gas/app.c"
       ...
       while (ch != 
# 1207 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                   (-1) 
# 1207 "/doner/binutils/binutils-7a31b38/gas/app.c"
                       && (lex[ch] == 2));

       if (ch == 
# 1209 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                (-1)
# 1209 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   )
  {
       ...
       if (ch < '0' || ch > '9' || state != 0 || startch != '#')
  {
    ...
    while (ch != 
# 1219 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                (-1) 
# 1219 "/doner/binutils/binutils-7a31b38/gas/app.c"
                    && !(lex[ch] == 10))
      ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1220 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
          ((void *)0)
# 1220 "/doner/binutils/binutils-7a31b38/gas/app.c"
          , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1220 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
          (-1) 
# 1220 "/doner/binutils/binutils-7a31b38/gas/app.c"
          : * (unsigned char *) (from++))));
    if (ch == 
# 1221 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
             (-1)
# 1221 "/doner/binutils/binutils-7a31b38/gas/app.c"
                )
      {
        as_warn (gettext ("end of file in comment; newline inserted"));
        do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
...
# 1264 "/doner/binutils/binutils-7a31b38/gas/app.c"
   if (strchr (i386_comment_chars, ch) == 
# 1264 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                                       ((void *)0)
       
# 1265 "/doner/binutils/binutils-7a31b38/gas/app.c"
      && (! 0
    || (ch != '!' && ch != '*')))
     goto de_fault;
   if (0
 ...
 case 4:
# 1297 "/doner/binutils/binutils-7a31b38/gas/app.c"
   do
     {
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1299 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           ((void *)0)
# 1299 "/doner/binutils/binutils-7a31b38/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1299 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
           (-1) 
# 1299 "/doner/binutils/binutils-7a31b38/gas/app.c"
   ...
   while (ch != 
# 1301 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
               (-1) 
# 1301 "/doner/binutils/binutils-7a31b38/gas/app.c"
                   && !(lex[ch] == 10));
   if (ch == 
# 1302 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
            (-1)
# 1302 "/doner/binutils/binutils-7a31b38/gas/app.c"
               )
     as_warn (gettext ("end of file in comment; newline inserted"));
   state = 0;
   do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
   break;
# 1328 "/doner/binutils/binutils-7a31b38/gas/app.c"
 case 1:
   if (state == 10)
     {
...
# 1365 "/doner/binutils/binutils-7a31b38/gas/app.c"
   if (state == 3)
     state = 9;
   ...
   if (to + 1 < toend
       && mri_state == 
# 1371 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                      ((void *)0)



       
# 1375 "/doner/binutils/binutils-7a31b38/gas/app.c"
      )
     {
       char *s;
       ptrdiff_t len;
       ...
       if (len > 0)
  {
    ...
    if (to >= toend)
      goto tofull;
    ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1409 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        ((void *)0)
# 1409 "/doner/binutils/binutils-7a31b38/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1409 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
        (-1) 
# 1409 "/doner/binutils/binutils-7a31b38/gas/app.c"
 ...
 de_fault:
  ...
  state = 3;
   ...
   else if (state == 10)
     {
       if (ch == '\\')
  {
# 1446 "/doner/binutils/binutils-7a31b38/gas/app.c"
    if (to + 1 >= toend)
      {
 ...
 tofull:
  ...
  if (fromend > from)
    ...
    saved_input = 
# 1479 "/doner/binutils/binutils-7a31b38/gas/app.c" 3 4
                 ((void *)0)
# 1479 "/doner/binutils/binutils-7a31b38/gas/app.c"
                     ;
