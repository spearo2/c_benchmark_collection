# 1 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
# 26 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
...
# 27 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 2
...
# 28 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 2
...
# 29 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 2




# 32 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
int preprocess = 0;
# 44 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
static FILE *f_in;
   ...
   int pre)
{
  ...
  ((void) ((filename != 0) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/input-file.c", 125, __PRETTY_FUNCTION__), 0)));
  if (filename[0])
    {
  ...
  else
    {
      ...
      f_in = 
# 134 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
            stdin
# 134 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                 ;
  ...
  if (f_in == 
# 139 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
             ((void *)0)
# 139 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                 )
    {
      as_bad (gettext ("can't open %s for reading: %s"),
       file_name, xstrerror (
# 142 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
                            (*__errno_location ())
# 142 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                                 ));
      return;
    }
  ...
  if (ferror (f_in))
    {
      as_bad (gettext ("can't read from %s: %s"),
       file_name, xstrerror (
# 151 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
                            (*__errno_location ())
# 151 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                                 ));

      fclose (f_in);
      f_in = 
# 154 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
            ((void *)0)
# 154 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                ;
      return;
    }
  ...
  if (feof (f_in))
    {
      fclose (f_in);
      f_in = 
# 162 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
            ((void *)0)
# 162 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                ;
      return;
    }
  ((void) ((c != 
# 165 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
 (-1)
# 165 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
 ) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/input-file.c", 165, __PRETTY_FUNCTION__), 0)));
...
input_file_close (void)
{
  ...
  if (f_in != 
# 206 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
             ((void *)0)
# 206 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                 )
    fclose (f_in);
...
# 224 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
                                                              (*__errno_location ())
# 224 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                                                                   ));
  return size;
}
...
# 252 "/doner/binutils/binutils-7a31b38/gas/input-file.c" 3 4
                                                        (*__errno_location ())
# 252 "/doner/binutils/binutils-7a31b38/gas/input-file.c"
                                                             ));
