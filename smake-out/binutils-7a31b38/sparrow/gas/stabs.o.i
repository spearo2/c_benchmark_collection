# 1 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
# 21 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
...
# 22 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 2
...
# 25 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 2
...
# 31 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 2
...
# 53 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
static bfd_boolean in_dot_func_p = 0;


static const char *current_function_label;
# 82 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
unsigned int
get_stab_string_offset (const char *string, const char *stabstr_secname)
{
  ...
  if (! 1)
    as_abort ("/doner/binutils/binutils-7a31b38/gas/stabs.c", 93, __PRETTY_FUNCTION__);
...
# 175 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
static void
         ...
         const char * stabstr_secname)
{
  ...
  int other;
  int desc;
# 195 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
  if (what != 's')
    {
      string = "";
...
# 278 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
  if (listing)
    {
      switch (type)
 {
      ...
      else
 {
   ...
   emit_expr (&exp, 4);
  ...
  else
    {
      ...
      as_abort ("/doner/binutils/binutils-7a31b38/gas/stabs.c", 390, __PRETTY_FUNCTION__);
...
# 432 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                                                             ((void *)0)
# 432 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                                                                 );
      if (saved_secname)
 {
   free (saved_secname);
...
# 484 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
void
  ...
  if (use_gnu_debug_info_extensions)
    {
      ...
      dir2 = concat (dir, "/", 
# 497 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                              ((void *)0)
# 497 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                                  );
...
generate_asm_file (int type, const char *file)
{
  ...
  if (last_file != 
# 519 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                  ((void *)0)
      
# 520 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
  ...
  while (tmp < file_endp)
    {
      ...
      if (bslash != 
# 550 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                   ((void *)0)
# 550 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                       )
 *bufp++ = '\\';
    }
  ...
  if (last_file != 
# 562 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                  ((void *)0)
# 562 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                      )
    free (last_file);
...
# 582 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                          ((void *)0)
# 582 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                              ;
  ...
  if (prev_file == 
# 592 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                  ((void *)0)
# 592 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                      )
    {
...
# 667 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                              (*__errno_location ())
# 667 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                                   ));
       ...
       const char *startlabname)
{
  ...
  if (asprintf (&buf, "\"\",%d,0,0,%s-%s", N_FUN, sym, startlabname) == -1)
    as_fatal ("%s", xstrerror (
# 693 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                              (*__errno_location ())
# 693 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                                   ));
...
# 701 "/doner/binutils/binutils-7a31b38/gas/stabs.c" 3 4
                          ((void *)0)
# 701 "/doner/binutils/binutils-7a31b38/gas/stabs.c"
                              ;
}
