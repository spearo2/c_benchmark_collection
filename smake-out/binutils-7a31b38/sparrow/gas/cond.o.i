# 1 "/doner/binutils/binutils-7a31b38/gas/cond.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/cond.c"
# 21 "/doner/binutils/binutils-7a31b38/gas/cond.c"
...
# 22 "/doner/binutils/binutils-7a31b38/gas/cond.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/gas/cond.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gas/cond.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/gas/cond.c" 2
...
# 61 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                                 ((void *)0)
# 61 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                                                     ;
...
s_ifdef (int test_defined)
{
  ...
  if (cframe.dead_tree)
  ...
  else
    {
      ...
      is_defined =
 symbolP != 
# 104 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
           ((void *)0)
 
# 105 "/doner/binutils/binutils-7a31b38/gas/cond.c"
...
# 117 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                   ((void *)0)
   
# 118 "/doner/binutils/binutils-7a31b38/gas/cond.c"
...
s_if (int arg)
{
  ...
  int t;
  char *stop = 
# 130 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
              ((void *)0)
# 130 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                  ;
  char stopc = 0;
  ...
  if (current_cframe != 
# 139 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                       ((void *)0) 
# 139 "/doner/binutils/binutils-7a31b38/gas/cond.c"
 ...
 as_bad (gettext ("non-constant expression in \".if\" statement"));
  ...
  switch ((operatorT) arg)
    ...
    default:
      as_abort ("/doner/binutils/binutils-7a31b38/gas/cond.c", 161, __PRETTY_FUNCTION__);
      return;
    }
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 174 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                   ((void *)0)
   
# 175 "/doner/binutils/binutils-7a31b38/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
s_ifb (int test_blank)
{
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 211 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                   ((void *)0)
   
# 212 "/doner/binutils/binutils-7a31b38/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
{
  char *stop = 
# 263 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
              ((void *)0)
# 263 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                  ;
  char stopc = 0;
  char *s1, *s2;
  int len1, len2;
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 291 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                   ((void *)0)
   
# 292 "/doner/binutils/binutils-7a31b38/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
{
  if (current_cframe == 
# 304 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                       ((void *)0)
# 304 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                           )
    {
  ...
  if (current_cframe == 
# 327 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                       ((void *)0) 
# 327 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                            || current_cframe->ignoring)
    {
      while (! is_end_of_line[(unsigned char) *input_line_pointer])
 ++input_line_pointer;
      ...
      if (current_cframe == 
# 332 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                           ((void *)0)
# 332 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                               )
 return;
    }
  else
 ...
 case O_gt: t = operand.X_add_number > 0; break;
 default:
   as_abort ("/doner/binutils/binutils-7a31b38/gas/cond.c", 356, __PRETTY_FUNCTION__);
   return;
 }
...
# 364 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                            ((void *)0)
   
# 365 "/doner/binutils/binutils-7a31b38/gas/cond.c"
...
s_endif (int arg __attribute__ ((__unused__)))
{
  ...
  if (current_cframe == 
# 381 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                       ((void *)0)
# 381 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                           )
    {
   ...
   && current_cframe->ignoring
   && (current_cframe->previous_cframe == 
# 389 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                         ((void *)0)
       
# 390 "/doner/binutils/binutils-7a31b38/gas/cond.c"
      || ! current_cframe->previous_cframe->ignoring))
 listing_list (1);
...
{
  if (current_cframe == 
# 410 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                       ((void *)0)
# 410 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                           )
    {
 ...
 current_cframe->dead_tree | !current_cframe->ignoring;
      ...
      if (((listing & 32) != 0)
   && (current_cframe->previous_cframe == 
# 433 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                         ((void *)0)
       
# 434 "/doner/binutils/binutils-7a31b38/gas/cond.c"
      || ! current_cframe->previous_cframe->ignoring))
 {
   if (! current_cframe->ignoring)
     listing_list (1);
...
s_ifeqs (int arg)
{
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 485 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                   ((void *)0)
   
# 486 "/doner/binutils/binutils-7a31b38/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
# 507 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                          ((void *)0)
# 507 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                              ) && (current_cframe->ignoring);
    }
 ...
 || s[0] == 'I')
  ...
  return (current_cframe != 
# 523 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                           ((void *)0)
# 523 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                               ) && (current_cframe->ignoring);
}
...
# 533 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                                       ((void *)0) 
# 533 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                                            && current_cframe->ignoring;
...
{
  if (current_cframe != 
# 545 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                       ((void *)0) 
# 545 "/doner/binutils/binutils-7a31b38/gas/cond.c"
...
# 568 "/doner/binutils/binutils-7a31b38/gas/cond.c" 3 4
                          ((void *)0) 
# 568 "/doner/binutils/binutils-7a31b38/gas/cond.c"
                               && current_cframe->macro_nest >= nest)
    {
      struct conditional_frame *hold;
