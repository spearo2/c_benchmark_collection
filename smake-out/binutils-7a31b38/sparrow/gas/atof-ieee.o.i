# 1 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
# 21 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
# 1 "./as.h" 1
# 37 "./as.h"
...
# 22 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 2


extern FLONUM_TYPE generic_floating_point_number;
# 41 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
...
# 159 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
char *
atof_ieee (char *str,
    int what_kind,
...
# 181 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 3 4
                                      ((void *)0)
# 181 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
                                          ;
  generic_floating_point_number.leader = 
# 182 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 3 4
                                        ((void *)0)
# 182 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
                                            ;
  ...
  switch (what_kind)
    ...
    default:
      ...
      return (
# 225 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 3 4
             ((void *)0)
# 225 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
                 );
    }
  ...
  if (atof_generic (&return_value, ".", EXP_CHARS,
      &generic_floating_point_number))
    {
      make_invalid_floating_point_number (words);
      return 
# 235 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 3 4
            ((void *)0)
# 235 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
                ;
    }
...
gen_to_words (LITTLENUM_TYPE *words, int precision, long exponent_bits)
{
 ...
 {
# 303 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
   words[0] = 0xffff;
   words[1] = 0xc000;
   words[2] = 0;
   words[3] = 0;
 ...
 {
# 344 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
   words[0] = 0x7fff;
   words[1] = 0x8000;
   words[2] = 0;
   words[3] = 0;
 ...
 {
# 385 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
   words[0] = 0xffff;
   words[1] = 0x8000;
   words[2] = 0;
   words[3] = 0;
...
# 413 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
 ...
 *lp++ = next_bits ((16));
  ...
  *lp++ = word1;
  ...
  if (next_bits (1))
    {
      unsigned long carry;
# 632 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
      ...
      if (precision == 5 && exponent_bits == 15)
 {
   ...
   if (lp == words)
     {
# 654 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
       lp[1] |= 1 << ((16) - 1);
     }
 }
...
# 711 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
const char *
...
# 722 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 3 4
                                 ((void *)0)
# 722 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
                                     )
    {
      switch (type)
 {
...
# 773 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
  else if (type == 'f')
    prec = 2;
  else if (type == 'd')
    prec = 4;
  ...
  ((void) ((prec <= 6) ? 0 : (as_abort ("/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c", 784, __PRETTY_FUNCTION__), 0)));
      ...
      for (wordP = words + prec; prec --;)
 {
  ...
  return 
# 809 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c" 3 4
        ((void *)0)
# 809 "/doner/binutils/binutils-7a31b38/gas/config/atof-ieee.c"
            ;
}
