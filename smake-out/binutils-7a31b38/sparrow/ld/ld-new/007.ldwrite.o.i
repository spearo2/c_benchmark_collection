# 1 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
# 22 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
...
# 23 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 25 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 27 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 29 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 30 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 33 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
# 1 "./ldgram.h" 1
# 50 "./ldgram.h"
  enum yytokentype
  {
...
int yyparse (void);
# 34 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
# 35 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 2
...
build_link_order (lang_statement_union_type *statement)
{
 ...
 do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-7a31b38/ld/ldwrite.c",51); } while (0);
 ...
 if (link_order == 
# 59 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                  ((void *)0)
# 59 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                      )
...
# 93 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
   ((void *)0)
# 93 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
   ; s = (lang_input_statement_type *) s->next)
    {
      if (s->the_bfd != 
# 95 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                       ((void *)0)
# 95 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                           )
        {
  ...
  switch (statement->data_statement.type)
   ...
   break;
    ...
    case 286:
      break;
    default:
      ld_abort ("/doner/binutils/binutils-7a31b38/ld/ldwrite.c", 134, __PRETTY_FUNCTION__);
    }
       }
   }

 do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-7a31b38/ld/ldwrite.c",139); } while (0);
 switch (statement->data_statement.type)
   {
   case 282:
   case 283:
  ...
  ((*((link_info.output_bfd)->xvec->bfd_putx32)) ((value),((link_order->u.data.contents + (big_endian ? 4 : 0)))))
   ...
   case 286:
     ...
     break;
   default:
     ld_abort ("/doner/binutils/binutils-7a31b38/ld/ldwrite.c", 182, __PRETTY_FUNCTION__);
   }
 ...
 do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-7a31b38/ld/ldwrite.c",197); } while (0);
 ...
 link_order = bfd_new_link_order (link_info.output_bfd, output_section);
 if (link_order == 
# 205 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                  ((void *)0)
# 205 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                      )
   einfo (gettext ("%P%F: bfd_new_link_order failed\n"));
 ...
 if (rs->name == 
# 217 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                ((void *)0)
# 217 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                    )
   {
 ...
 if (i->sec_info_type != 4
     && (i->flags & 0x8000) == 0)
   {
     ...
     do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-7a31b38/ld/ldwrite.c",248); } while (0);
  ...
  do { if (!(i->output_section == output_section)) info_assert("/doner/binutils/binutils-7a31b38/ld/ldwrite.c",271); } while (0);
       }
 ...
 do { if (!(statement->padding_statement.output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-7a31b38/ld/ldwrite.c",286); } while (0)
                          ;
...
clone_section (bfd *abfd, asection *s, const char *name, int *count)
{
   ...
   || strcmp (name, "$GDB_SYMBOLS$") == 0)
 {
   ...
   return 
# 366 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
         ((void *)0)
# 366 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
             ;
 }
      tname[5] = 0;
    }
...
# 371 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                                                                   ((void *)0)
      
# 372 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
     || (n = bfd_make_section_anyway (abfd, sname)) == 
# 372 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                                                       ((void *)0)
      
# 373 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
     || (h = bfd_link_hash_lookup (link_info.hash,
        sname, 1, 1, 0)) == 
# 374 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                                     ((void *)0)
# 374 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                                         )
    {
      einfo (gettext ("%F%P: clone section failed: %E\n"));

      return 
# 378 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
            ((void *)0)
# 378 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                ;
    }
  free (tname);
...
# 450 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
static void
split_sections (bfd *abfd, struct bfd_link_info *info)
{
  ...
  for (original_sec = abfd->sections;
       ...
       original_sec = original_sec->next, nsecs--)
    {
      ...
      for (l = 
# 472 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
              ((void *)0)
# 472 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
...
# 472 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                                                              ; p = l->next)
 {
  ...
  thisrelocs = sec->reloc_count;
   ...
   if (l != 
# 498 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
           ((void *)0)
       
# 499 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
    ...
    || (thissize + sec_size >= config.split_by_file))
       && !unsplittable_name (cursor->name))
     {
       ...
       l->next = 
# 516 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c" 3 4
                ((void *)0)
# 516 "/doner/binutils/binutils-7a31b38/ld/ldwrite.c"
                    ;
       l = p;
