# 1 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
# 22 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
...
# 23 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 2
...
# 25 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 2
...
# 28 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 2
...
# 131 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
                                      ((void *)0)
# 131 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                                          ;
...
# 137 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
                                     ((void *)0)
# 137 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                                         ;


static add_file_t *addfiles_list = 
# 140 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
                                  ((void *)0)
# 140 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                                      ;
...
record_add_file (const char *file, addfile_enum_t type)
{
  ...
  if (!newfile)
    return LDPS_ERR;
  newfile->next = 
# 175 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
                 ((void *)0)
# 175 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                     ;
  newfile->name = file;
  newfile->type = type;
...
parse_symdefstr (const char *str, struct ld_plugin_symbol *sym)
{
 ...
 return LDPS_ERR;
    ...
    sym->version = 
# 242 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
                  ((void *)0)
# 242 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                      ;
  if (colon5 && colon5[1])
    {
  ...
  if (!strncmp ("fatal", opt, 5))
    {
      ...
      fflush (
# 330 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
             ((void *)0)
# 330 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                 );
    }
  else if (!strncmp ("error", opt, 5))
    {
      ...
      fflush (
# 335 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
             ((void *)0)
# 335 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                 );
    }
  else if (!strncmp ("warning", opt, 7))
    {
      ...
      fflush (
# 340 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
             ((void *)0)
# 340 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                 );
    }
...
onload (struct ld_plugin_tv *tv)
{
      ...
      if (!tv_register_claim_file)
 {
   ...
   fflush (
# 459 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
          ((void *)0)
# 459 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_all_symbols_read)
 {
   ...
   fflush (
# 469 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
          ((void *)0)
# 469 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_cleanup)
 {
   ...
   fflush (
# 479 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
          ((void *)0)
# 479 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
              );
   return LDPS_ERR;
 }
...
# 575 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
                                                               ((void *)0)
# 575 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
                                                                   ;
 ...
 return rv;
  ...
  fflush (
# 657 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
         ((void *)0)
# 657 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
             );
...
oncleanup (void)
{
  ...
  fflush (
# 666 "/doner/binutils/binutils-7a31b38/ld/testplug2.c" 3 4
         ((void *)0)
# 666 "/doner/binutils/binutils-7a31b38/ld/testplug2.c"
             );
  return cleanup_ret;
}
