# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
# 19 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
...
# 20 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 2
...
# 21 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 22 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 2
...
# 72 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                       ((void *)0)
# 72 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                           ;
  struct elf_segment_map **last_load = 
# 73 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                      ((void *)0)
# 73 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                          ;
  bfd_boolean moved_headers = 0;
  int sizeof_headers;

  if (info != 
# 77 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
             ((void *)0) 
# 77 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                  && info->user_phdrs)
  ...
  if (info != 
# 82 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
             ((void *)0)
# 82 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                 )
  ...
  else
    {
      ...
      for (seg = *m; seg != 
# 91 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                           ((void *)0)
# 91 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                               ; seg = seg->next)
 sizeof_headers += bed->s->sizeof_phdr;
    }

  while (*m != 
# 95 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
              ((void *)0)
# 95 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                  )
    {
      ...
      if (seg->p_type == 1)
 {
  ...
  {
# 132 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
    struct elf_segment_map *newseg;
    asection *sec;
    struct bfd_elf_section_data *secdata;

    do { if (!(!seg->p_size_valid)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c",136); } while (0);

    secdata = bfd_zalloc (abfd, sizeof *secdata);
    if (secdata == 
# 139 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                  ((void *)0)
# 139 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                      )
      return 0;

    sec = bfd_zalloc (abfd, sizeof *sec);
    if (sec == 
# 143 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
              ((void *)0)
# 143 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                  )
      return 0;
    ...
    newseg = bfd_alloc (abfd,
       ...
       * sizeof (asection *)));
    if (newseg == 
# 163 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                 ((void *)0)
# 163 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                     )
      return 0;
    memcpy (newseg, seg,
   ...
   last_load = m;
   if (first_load == 
# 176 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                    ((void *)0)
# 176 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                        )
     {
       if (!executable)
  goto next;
...
nacl_modify_program_headers (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (info != 
# 239 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
             ((void *)0) 
# 239 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                  && info->user_phdrs)
  ...
  while (*m != 
# 245 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
              ((void *)0)
# 245 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                  )
    {
 ...
 break;
  ...
  if (*m != 
# 254 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
           ((void *)0)
# 254 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
               )
    {
      struct elf_segment_map **first_load_seg = m;
      Elf_Internal_Phdr *first_load_phdr = p;
      struct elf_segment_map **next_load_seg = 
# 258 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                              ((void *)0)
# 258 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                                  ;
      Elf_Internal_Phdr *next_load_phdr = 
# 259 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                         ((void *)0)
# 259 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                             ;
      ...
      while (*m != 
# 267 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                  ((void *)0)
# 267 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                      )
 {
   ...
   ++p;
      ...
      if (next_load_seg != 
# 283 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                          ((void *)0)
# 283 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                              )
 {
...
# 323 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                       ((void *)0)
# 323 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                           ; seg = seg->next)
    if (seg->p_type == 1
 && seg->count > 1
 && seg->sections[seg->count - 1]->owner == 
# 326 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                           ((void *)0)
# 326 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                               )
      {
 ...
 do { if (!(sec->flags & 0x100000)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c",335); } while (0);
 do { if (!(sec->flags & 0x010)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c",336); } while (0);
 do { if (!(sec->size > 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c",337); } while (0);

 fill = abfd->arch_info->fill (sec->size, ((abfd)->xvec->byteorder == BFD_ENDIAN_BIG), 1);

 if (fill == 
# 341 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
            ((void *)0)
     
# 342 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
    || bfd_seek (abfd, sec->filepos, 
# 342 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c" 3 4
                                     0
# 342 "/doner/binutils/binutils-7a31b38/bfd/elf-nacl.c"
                                             ) != 0
