# 1 "/doner/binutils/binutils-7a31b38/bfd/format.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/format.c"
# 46 "/doner/binutils/binutils-7a31b38/bfd/format.c"
...
# 47 "/doner/binutils/binutils-7a31b38/bfd/format.c" 2
...
# 48 "/doner/binutils/binutils-7a31b38/bfd/format.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 49 "/doner/binutils/binutils-7a31b38/bfd/format.c" 2


extern const size_t _bfd_target_vector_entries;
# 91 "/doner/binutils/binutils-7a31b38/bfd/format.c"
bfd_boolean
bfd_check_format (bfd *abfd, bfd_format format)
{
  return bfd_check_format_matches (abfd, format, 
# 94 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                                ((void *)0)
# 94 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                                    );
}
...
# 119 "/doner/binutils/binutils-7a31b38/bfd/format.c"
static bfd_boolean
bfd_preserve_save (bfd *abfd, struct bfd_preserve *preserve)
{
  ...
  if (preserve->marker == 
# 131 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                         ((void *)0)
# 131 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                             )
    return 0;
...
{
  abfd->tdata.any = 
# 143 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                   ((void *)0)
# 143 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                       ;
...
bfd_preserve_restore (bfd *abfd, struct bfd_preserve *preserve)
{
  ...
  preserve->marker = 
# 168 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                    ((void *)0)
# 168 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                        ;
}
...
bfd_preserve_finish (bfd *abfd __attribute__ ((__unused__)), struct bfd_preserve *preserve)
{
  ...
  preserve->marker = 
# 182 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                    ((void *)0)
# 182 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                        ;
}
# 205 "/doner/binutils/binutils-7a31b38/bfd/format.c"
bfd_boolean
...
# 213 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                      ((void *)0)
# 213 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                          ;
  ...
  if (matching != 
# 219 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                 ((void *)0)
# 219 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                     )
    *matching = 
# 220 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
               ((void *)0)
# 220 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                   ;
  ...
  if (matching != 
# 232 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                 ((void *)0) 
# 232 "/doner/binutils/binutils-7a31b38/bfd/format.c"
...
# 232 "/doner/binutils/binutils-7a31b38/bfd/format.c"
 ...
 return 0;
  ...
  save_targ = abfd->xvec;
  preserve.marker = 
# 245 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                   ((void *)0)
# 245 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                       ;
...
# 250 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                       0
# 250 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                               ) != 0)
 goto err_ret;
      ...
      if (right_targ)
 goto ok_ret;
# 270 "/doner/binutils/binutils-7a31b38/bfd/format.c"
 ...
 goto err_unrecog;
  ...
  right_targ = 
# 276 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
              ((void *)0)
# 276 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                  ;
  ar_right_targ = 
# 277 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                 ((void *)0)
# 277 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                     ;
  match_targ = 
# 278 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
              ((void *)0)
# 278 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                  ;
  best_match = 256;
  best_count = 0;
  match_count = 0;
...
# 284 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                             ((void *)0)
# 284 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                                 ; target++)
    {
 ...
 continue;
      ...
      if (bfd_seek (abfd, (file_ptr) 0, 
# 302 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                       0
# 302 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                               ) != 0)
 goto err_ret;
      ...
      if (temp)
 {
   ...
   match_targ = temp;
   if (preserve.marker != 
# 325 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                         ((void *)0)
# 325 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                             )
...
# 401 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                       ((void *)0)
# 401 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                           )
 {
   int i = match_count;
      ...
      for (i = 0; i < match_count; i++)
 {
  ...
  if (preserve.marker != 
# 438 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                        ((void *)0)
# 438 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                            )
      ...
      if (match_targ != right_targ)
 {
   bfd_reinit (abfd);
   if (bfd_seek (abfd, (file_ptr) 0, 
# 450 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                    0
# 450 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                            ) != 0)
     goto err_ret;
   match_targ = (((abfd)->xvec->_bfd_check_format[(int) ((abfd)->format)]) (abfd));
   do { if (!(match_targ != 
# 453 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
  ((void *)0)
# 453 "/doner/binutils/binutils-7a31b38/bfd/format.c"
  )) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/format.c",453); } while (0);
 }
 ...
 free (matching_vector);
      if (preserve.marker != 
# 481 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                            ((void *)0)
# 481 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                )
 bfd_preserve_restore (abfd, &preserve);
      return 0;
    }
...
# 494 "/doner/binutils/binutils-7a31b38/bfd/format.c" 3 4
                                    ((void *)0)
# 494 "/doner/binutils/binutils-7a31b38/bfd/format.c"
                                        ;
...
# 520 "/doner/binutils/binutils-7a31b38/bfd/format.c"
bfd_boolean
...
# 558 "/doner/binutils/binutils-7a31b38/bfd/format.c"
const char *
