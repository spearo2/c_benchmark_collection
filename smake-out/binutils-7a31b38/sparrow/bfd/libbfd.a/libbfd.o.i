# 1 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
# 22 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
...
# 23 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 2
# 46 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
bfd_boolean
...
bfd_nullvoidptr (bfd *ignore __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 
# 69 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
        ((void *)0)
# 69 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
            ;
}
...
{
  *relptr = 
# 118 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
           ((void *)0)
# 118 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
               ;
  return 0;
}
...
_bfd_nocore_core_file_failing_command (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 
# 147 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
        ((void *)0)
# 147 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
            ;
}
...
bfd_malloc (bfd_size_type size)
{
  ...
  if (size != sz
      ...
      || ((signed long) sz) < 0)
    {
      ...
      return 
# 190 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0)
# 190 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                ;
    }

  ptr = malloc (sz);
  if (ptr == 
# 194 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0) 
# 194 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                 && sz != 0)
    bfd_set_error (bfd_error_no_memory);
...
bfd_malloc2 (bfd_size_type nmemb, bfd_size_type size)
{
  if ((nmemb | size) >= (((bfd_size_type) 1) << (8 * sizeof (bfd_size_type) / 2))
      ...
      && nmemb > ~(bfd_size_type) 0 / size)
    {
      bfd_set_error (bfd_error_no_memory);
      return 
# 210 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0)
# 210 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                ;
    }
...
bfd_realloc (void *ptr, bfd_size_type size)
{
  ...
  if (ptr == 
# 224 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0)
# 224 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                )
  ...
  if (size != sz
      ...
      || ((signed long) sz) < 0)
    {
      bfd_set_error (bfd_error_no_memory);
      return 
# 232 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0)
# 232 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                ;
    }
  ...
  if (ret == 
# 237 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0) 
# 237 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                 && sz != 0)
    bfd_set_error (bfd_error_no_memory);
...
bfd_realloc2 (void *ptr, bfd_size_type nmemb, bfd_size_type size)
{
  if ((nmemb | size) >= (((bfd_size_type) 1) << (8 * sizeof (bfd_size_type) / 2))
      ...
      && nmemb > ~(bfd_size_type) 0 / size)
    {
      bfd_set_error (bfd_error_no_memory);
      return 
# 253 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0)
# 253 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                ;
    }
...
bfd_realloc_or_free (void *ptr, bfd_size_type size)
{
  ...
  if (ret == 
# 267 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0) 
# 267 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                 && ptr != 
# 267 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
                           ((void *)0)
# 267 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
...
bfd_zmalloc (bfd_size_type size)
{
  ...
  if (ptr != 
# 280 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0) 
# 280 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                 && size > 0)
...
bfd_zmalloc2 (bfd_size_type nmemb, bfd_size_type size)
{
  ...
  if (ptr != 
# 294 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
            ((void *)0)
# 294 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                )
    {
...
# 318 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
bfd_boolean
...
# 494 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
bfd_vma
...
bfd_put_bits (bfd_uint64_t data, void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/libbfd.c", 747, __PRETTY_FUNCTION__);
...
bfd_get_bits (const void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/libbfd.c", 768, __PRETTY_FUNCTION__);
       ...
       bfd_size_type count)
{
 ...
 (dgettext ("bfd", "%B: unable to get decompressed section %A"),
  ...
  if (offset + count < count
      || offset + count > sz
      || (abfd->my_archive != 
# 816 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
                             ((void *)0)
   
# 817 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
...
# 825 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
                                                0
# 825 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                                                        ) != 0
...
{
# 885 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
  _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/libbfd.c", 885, __PRETTY_FUNCTION__);
       ...
       bfd_size_type count)
{
  ...
  if (bfd_seek (abfd, section->filepos + offset, 
# 903 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
                                                0
# 903 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                                                        ) != 0
...
# 922 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
unsigned int
bfd_log2 (bfd_vma x)
{
        ...
        const char *func)
{
  ...
  if (~(size_t) func & ~mask)
    {
      fflush (
# 958 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
             stdout
# 958 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                   );
 ...
 fprintf (
# 963 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
         stderr
# 963 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
               , dgettext ("bfd", "Deprecated %s called at %s line %d in %s\n"),
   what, file, line, func);
      else
 fprintf (
# 966 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
         stderr
# 966 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
               , dgettext ("bfd", "Deprecated %s called\n"), what);
      fflush (
# 967 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
             stderr
# 967 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                   );
      mask |= ~(size_t) func;
    }
}
         ...
         const bfd_byte * const end)
{
 ...
 break;
  ...
  if (length_return != 
# 1030 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c" 3 4
                      ((void *)0)
# 1030 "/doner/binutils/binutils-7a31b38/bfd/libbfd.c"
                          )
