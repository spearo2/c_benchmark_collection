# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
# 21 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
...
# 22 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 2
...
bfd_elf_set_obj_attr_contents (bfd *abfd, bfd_byte *contents, bfd_vma size)
{
 ...
 vendor_set_obj_attr_contents (abfd, p, vendor_size, vendor);
  ...
  if (size != my_size)
    _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c", 225, __PRETTY_FUNCTION__);
}
    ...
    list = list->next)
 {
   ...
   switch (in_attr->type & ((1 << 0) | (1 << 1)))
     ...
     case (1 << 0) | (1 << 1):
       ...
       break;
     default:
       _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c", 389, __PRETTY_FUNCTION__);
     }
 }
    }
}
...
_bfd_elf_obj_attrs_arg_type (bfd *abfd, int vendor, unsigned int tag)
{
  switch (vendor)
    ...
    case 1:
      ...
      break;
    default:
      _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c", 424, __PRETTY_FUNCTION__);
    }
}
...
_bfd_elf_parse_attributes (bfd *abfd, Elf_Internal_Shdr * hdr)
{
      ...
      while (len > 0 && p < p_end - 4)
 {
   ...
   if (section_len <= 4)
     {
       _bfd_error_handler (dgettext ("bfd", "%B: error: attribute section length too small: %ld"),
      abfd, section_len);
       break;
     }
   section_len -= 4;
  ...
  case Tag_File:
   ...
   case (1 << 0):
     ...
     break;
   default:
     _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c", 551, __PRETTY_FUNCTION__);
   }
      }
    break;
  case Tag_Section:
...
# 581 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
bfd_boolean
...
_bfd_elf_merge_unknown_attribute_low (bfd *ibfd, bfd *obfd, int tag)
{
  ...
  obj_attribute *out_attr;
  bfd *err_bfd = 
# 634 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                ((void *)0)
# 634 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                    ;
...
# 640 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                                                ((void *)0)
# 640 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                                                    )
    err_bfd = obfd;
  else if (in_attr[tag].i != 0 || in_attr[tag].s != 
# 642 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                                                   ((void *)0)
# 642 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                                                       )
    err_bfd = ibfd;

  if (err_bfd != 
# 645 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                ((void *)0)
# 645 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                    )
    result
  ...
  if (in_attr[tag].i != out_attr[tag].i
      || (in_attr[tag].s == 
# 651 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                           ((void *)0)
# 651 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                               ) != (out_attr[tag].s == 
# 651 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                                                        ((void *)0)
# 651 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
      ...
      || (in_attr[tag].s != 
# 652 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                           ((void *)0) 
# 652 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                                && out_attr[tag].s != 
# 652 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                                                      ((void *)0)
   
# 653 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
  && strcmp (in_attr[tag].s, out_attr[tag].s) != 0))
    {
      out_attr[tag].i = 0;
      out_attr[tag].s = 
# 656 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                       ((void *)0)
# 656 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                           ;
    }
...
_bfd_elf_merge_unknown_attribute_list (bfd *ibfd, bfd *obfd)
{
  ...
  for (; in_list || out_list; )
    {
      bfd *err_bfd = 
# 680 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                    ((void *)0)
# 680 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                        ;
      ...
      else
 {
   ...
   if (in_list->attr.i != out_list->attr.i
       || (in_list->attr.s == 
# 711 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                             ((void *)0)
# 711 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
                                 ) != (out_list->attr.s == 
# 711 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c" 3 4
                                                           ((void *)0)
# 711 "/doner/binutils/binutils-7a31b38/bfd/elf-attrs.c"
