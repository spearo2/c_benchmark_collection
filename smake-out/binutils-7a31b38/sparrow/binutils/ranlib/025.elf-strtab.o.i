# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
# 22 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
...
# 23 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 2
...
# 28 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 2
    ...
    const char *string)
{
  ...
  if (entry == 
# 69 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 69 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                  )
    entry = (struct bfd_hash_entry *)
        bfd_hash_allocate (table, sizeof (struct elf_strtab_hash_entry));
  if (entry == 
# 72 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 72 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                  )
    return 
# 73 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
          ((void *)0)
# 73 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
              ;
...
_bfd_elf_strtab_init (void)
{
  ...
  if (table == 
# 101 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 101 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                  )
    return 
# 102 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
          ((void *)0)
# 102 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
              ;
  ...
  if (!bfd_hash_table_init (&table->table, elf_strtab_hash_newfunc,
       sizeof (struct elf_strtab_hash_entry)))
    {
      free (table);
      return 
# 108 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
            ((void *)0)
# 108 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                ;
    }
  ...
  if (table->array == 
# 117 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
                     ((void *)0)
# 117 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                         )
    {
      free (table);
      return 
# 120 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
            ((void *)0)
# 120 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                ;
    }

  table->array[0] = 
# 123 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
                   ((void *)0)
# 123 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                       ;
       ...
       bfd_boolean copy)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",153); } while (0);
  entry = (struct elf_strtab_hash_entry *)
   bfd_hash_lookup (&tab->table, str, 1, copy);

  if (entry == 
# 157 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 157 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                  )
    return (size_t) -1;
  ...
  if (entry->len == 0)
    {
      ...
      do { if (!(entry->len > 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",165); } while (0);
      if (tab->size == tab->alloced)
 {
   ...
   if (tab->array == 
# 172 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
                    ((void *)0)
# 172 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                        )
     return (size_t) -1;
 }
...
_bfd_elf_strtab_addref (struct elf_strtab_hash *tab, size_t idx)
{
  if (idx == 0 || idx == (size_t) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",187); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",188); } while (0);
...
_bfd_elf_strtab_delref (struct elf_strtab_hash *tab, size_t idx)
{
  if (idx == 0 || idx == (size_t) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",197); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",198); } while (0);
  do { if (!(tab->array[idx]->refcount > 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",199); } while (0);
  --tab->array[idx]->refcount;
}
...
_bfd_elf_strtab_save (struct elf_strtab_hash *tab)
{
  ...
  if (save == 
# 234 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
             ((void *)0)
# 234 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                 )
    return save;
...
_bfd_elf_strtab_restore (struct elf_strtab_hash *tab, void *buf)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",251); } while (0);
  do { if (!(save->size <= curr_size)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",252); } while (0);
  tab->size = save->size;
...
_bfd_elf_strtab_offset (struct elf_strtab_hash *tab, size_t idx)
{
  ...
  if (idx == 0)
    return 0;
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",280); } while (0);
  do { if (!(tab->sec_size)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",281); } while (0);
  entry = tab->array[idx];
  do { if (!(entry->refcount > 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",283); } while (0);
  entry->refcount--;
...
_bfd_elf_strtab_emit (register bfd *abfd, struct elf_strtab_hash *tab)
{
  ...
  for (i = 1; i < tab->size; ++i)
    {
      ...
      do { if (!(tab->array[i]->refcount == 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",302); } while (0);
      len = tab->array[i]->len;
      if ((int) len < 0)
 continue;
 ...
 return 0;
  ...
  do { if (!(off == tab->sec_size)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c",314); } while (0);
  return 1;
}
...
_bfd_elf_strtab_finalize (struct elf_strtab_hash *tab)
{
  ...
  if (array == 
# 369 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 369 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
                  )
    goto alloc_failure;
...
# 404 "/doner/binutils/binutils-7a31b38/bfd/elf-strtab.c"
      e = *--a;
      e->len += 1;
      while (--a >= array)
 {
