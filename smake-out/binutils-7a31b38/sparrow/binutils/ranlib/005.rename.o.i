# 1 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
# 21 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
...
# 22 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 2
...
# 27 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 2
...
# 34 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
...
simple_copy (const char *from, const char *to)
{
  ...
  fromfd = open (from, 
# 49 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                      00 
# 49 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                               | 0);
  if (fromfd < 0)
    return -1;

  tofd = open (to, 
# 53 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                  0100 
# 53 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                          | 
# 53 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                            01 
# 53 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
...
# 53 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
  ...
  if (tofd < 0)
    {
      saved = 
# 59 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
             (*__errno_location ())
# 59 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                  ;
      close (fromfd);
      
# 61 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
     (*__errno_location ()) 
# 61 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
           = saved;
      return -1;
    }
 ...
 {
   saved = 
# 68 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
          (*__errno_location ())
# 68 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
               ;
   close (fromfd);
   close (tofd);
   
# 71 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
  (*__errno_location ()) 
# 71 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
        = saved;
   return -1;
 }
    }
  saved = 
# 75 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
         (*__errno_location ())
# 75 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
              ;
  close (fromfd);
  close (tofd);
  if (nread < 0)
...
# 80 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
     (*__errno_location ()) 
# 80 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
           = saved;
      return -1;
    }
  return 0;
...
set_times (const char *destination, const struct stat *statbuf)
{
...

  {
    ...
    tb.actime = statbuf->
# 99 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                        st_atim.tv_sec
# 99 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                                ;
    tb.modtime = statbuf->
# 100 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                         st_mtim.tv_sec
# 100 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                                 ;
    result = utime (destination, &tb);
# 119 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
  }

  if (result != 0)
    non_fatal (gettext ("%s: cannot set time: %s"), destination, strerror (
# 122 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                                                                   (*__errno_location ())
# 122 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                                                                        ));
}
# 137 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
int
smart_rename (const char *from, const char *to, int preserve_dates __attribute__ ((__unused__)))
{
  ...
  exists = lstat (to, &s) == 0;
# 163 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
  if (! exists
      || (!
# 164 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
          ((((
# 164 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
          s.st_mode
# 164 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
          )) & 0170000) == (0120000))
   
# 165 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
  && 
# 165 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
     ((((
# 165 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
     s.st_mode
# 165 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
...
# 166 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
  && (s.st_mode & 
# 166 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                  0200
# 166 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                         )
   && s.st_nlink == 1)
      ...
      if (ret == 0)
 {
   if (exists)
     {
# 187 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
      ...
      else
 {
   ...
   non_fatal (gettext ("unable to rename '%s'; reason: %s"), to, strerror (
# 195 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                                                                   (*__errno_location ())
# 195 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                                                                        ));
   unlink (from);
 }
    }
  else
    {
      ...
      if (ret != 0)
 non_fatal (gettext ("unable to copy file '%s'; reason: %s"), to, strerror (
# 203 "/doner/binutils/binutils-7a31b38/binutils/rename.c" 3 4
                                                                    (*__errno_location ())
# 203 "/doner/binutils/binutils-7a31b38/binutils/rename.c"
                                                                         ));
