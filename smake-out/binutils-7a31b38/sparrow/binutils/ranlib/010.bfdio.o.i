# 1 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
# 24 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
# 25 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 2
...
# 27 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 28 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 2
# 43 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
file_ptr
  ...
  if (file)
    {
      int fd = fileno (file);
      int old = fcntl (fd, 
# 76 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                          1
# 76 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                                 , 0);
      if (old >= 0)
 fcntl (fd, 
# 78 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
           2
# 78 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                  , old | 
# 78 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                          1
# 78 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
{
# 120 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
# 176 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
bfd_size_type
bfd_bread (void *ptr, bfd_size_type size, bfd *abfd)
{
  ...
  if (abfd->arelt_data != 
# 183 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                         ((void *)0)
# 183 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                             )
    {
...
# 220 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
     (*__errno_location ()) 
# 220 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
           = 
# 220 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
             28
# 220 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
  ...
  if (abfd->iovec)
    {
      ...
      while (parent_bfd->my_archive != 
# 237 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                                      ((void *)0)
      
# 238 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
bfd_seek (bfd *abfd, file_ptr position, int direction)
{
  ...
  do { if (!(direction == 
# 288 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
 0 
# 288 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
 || direction == 
# 288 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
 1
# 288 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
 )) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/bfdio.c",288); } while (0);

  if (direction == 
# 290 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                  1 
# 290 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                           && position == 0)
    return 0;

  if (abfd->my_archive == 
# 293 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                         ((void *)0) 
# 293 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                              || ((abfd->my_archive)->is_thin_archive))
    {
      if (direction == 
# 295 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                      0 
# 295 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                               && (bfd_vma) position == abfd->where)
 return 0;
    }
  else
    {
# 311 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
    }

  file_position = position;
  if (direction == 
# 314 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                  0
# 314 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                          )
    {
      bfd *parent_bfd = abfd;

      while (parent_bfd->my_archive != 
# 318 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                                      ((void *)0)
      
# 319 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
     && !((parent_bfd->my_archive)->is_thin_archive))
        {
  ...
  if (result != 0)
    {
      int hold_errno = 
# 333 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                      (*__errno_location ())
# 333 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                           ;
      ...
      if (hold_errno == 
# 340 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                       22
# 340 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                             )
...
# 345 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
  (*__errno_location ()) 
# 345 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
        = hold_errno;
 }
    }
  else
    {
      ...
      if (direction == 
# 351 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                      0
# 351 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                              )
 abfd->where = position;
      else
 abfd->where += position;
...
# 372 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
long
bfd_get_mtime (bfd *abfd)
{
  ...
  if (abfd->iovec == 
# 380 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                    ((void *)0)
# 380 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                        )
    return 0;
  ...
  abfd->mtime = buf.
# 386 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                   st_mtim.tv_sec
# 386 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                           ;
  return buf.
# 387 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
            st_mtim.tv_sec
# 387 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                    ;
}
# 423 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
ufile_ptr
bfd_get_size (bfd *abfd)
{
  ...
  if (abfd->iovec == 
# 428 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                    ((void *)0)
# 428 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                        )
    return 0;
...
# 451 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
ufile_ptr
bfd_get_file_size (bfd *abfd)
{
  if (abfd->my_archive != 
# 454 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                         ((void *)0)
      
# 455 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
     && !((abfd->my_archive)->is_thin_archive))
    return (((struct areltdata *)((abfd)->arelt_data))->parsed_size);

  return bfd_get_size (abfd);
}
# 477 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
void *
          ...
          void **map_addr, bfd_size_type *map_len)
{
  ...
  if (abfd->iovec == 
# 484 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                    ((void *)0)
# 484 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                        )
    return ret;
      ...
      if (newsize > oldsize)
        {
          ...
          if (bim->buffer == 
# 529 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                            ((void *)0)
# 529 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                                )
            {
              bim->size = 0;
              return 0;
...
memory_bseek (bfd *abfd, file_ptr position, int direction)
{
  ...
  if (direction == 
# 556 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                  0
# 556 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                          )
    nwhere = position;
  else
...
# 564 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
     (*__errno_location ()) 
# 564 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
           = 
# 564 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
             22
# 564 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
          ...
          if (newsize > oldsize)
            {
              bim->buffer = (bfd_byte *) bfd_realloc_or_free (bim->buffer, newsize);
              if (bim->buffer == 
# 582 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                                ((void *)0)
# 582 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                                    )
                {
                  
# 584 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                 (*__errno_location ()) 
# 584 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                       = 
# 584 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                         22
# 584 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
# 594 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
         (*__errno_location ()) 
# 594 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
               = 
# 594 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                 22
# 594 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
...
memory_bclose (struct bfd *abfd)
{
  ...
  if (bim->buffer != 
# 607 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                    ((void *)0)
# 607 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                        )
    free (bim->buffer);
  free (bim);
  abfd->iostream = 
# 610 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c" 3 4
                  ((void *)0)
# 610 "/doner/binutils/binutils-7a31b38/bfd/bfdio.c"
                      ;
