# 1 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
# 21 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
...
# 22 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
# 23 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
# 27 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
# 29 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
# 36 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
plugin_data_struct;
# 37 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 38 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
# 39 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
...
# 40 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 2
# 112 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
...
# 117 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
 __builtin_va_start(
# 117 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
 args
# 117 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
 ,
# 117 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
...
# 121 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
 __builtin_va_end(
# 121 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
 args
# 121 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
 )
# 121 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
...
try_claim (bfd *abfd)
{
  ...
  if (!bfd_plugin_open_input (abfd, &file))
    return 0;
  file.handle = abfd;
  off_t cur_offset = lseek (file.fd, 0, 
# 202 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                       1
# 202 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                               );
  claim_file (&file, &claimed);
  lseek (file.fd, cur_offset, 
# 204 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                             0
# 204 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                     );
  return claimed;
}
...
# 219 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                0x00002
# 219 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                        );
  if (!plugin_handle)
    {
...
bfd_plugin_set_plugin (const char *p)
{
  plugin_name = p;
  has_plugin = p != 
# 281 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                   ((void *)0)
# 281 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                       ;
}
...
# 298 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                       ((void *)0)
# 298 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                           ;
  return 0;
}
...
# 335 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                            ((void *)0)
# 335 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                )
    return found;

  plugin_dir = concat ("/usr/local/bin", "/../lib/bfd-plugins", 
# 338 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                                     ((void *)0)
# 338 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                                         );
  ...
  free (plugin_dir);
  plugin_dir = 
# 343 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
              ((void *)0)
# 343 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                  ;
  ...
  while ((ent = readdir (d)))
    {
      ...
      full_name = concat (p, "/", ent->d_name, 
# 355 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                              ((void *)0)
# 355 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                                  );
      if (stat(full_name, &s) == 0 && 
# 356 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                     ((((
# 356 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                     s.st_mode
# 356 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                     )) & 0170000) == (0100000))
# 356 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
...
bfd_plugin_object_p (bfd *abfd)
{
  ...
  if (abfd->plugin_format == bfd_plugin_unknown && !load_plugin (abfd))
    return 
# 381 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
          ((void *)0)
# 381 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
              ;

  return abfd->plugin_format == bfd_plugin_yes ? abfd->xvec : 
# 383 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                                                             ((void *)0)
# 383 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                                                                 ;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",393); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",406); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",419); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",426); } while (0);
  return 1;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",433); } while (0);
  return 
# 434 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
        ((void *)0)
# 434 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
            ;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",440); } while (0);
  return 0;
}
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",447); } while (0);
  return 0;
}
...
bfd_plugin_get_symtab_upper_bound (bfd *abfd)
{
  ...
  do { if (!(nsyms >= 0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",457); } while (0);
...
convert_flags (const struct ld_plugin_symbol *sym)
{
 switch (sym->def)
   ...
   default:
     do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",477); } while (0);
     return 0;
   }
}
    ...
    asymbol **alocation)
{
  ...
  for (i = 0; i < nsyms; i++)
    {
      ...
      do { if (!(s)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",500); } while (0);
      alocation[i] = s;
 ...
 case LDPK_WEAKDEF:
   ...
   break;
 default:
   do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",521); } while (0);
 }
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",536); } while (0);
}
...
bfd_plugin_make_empty_symbol (bfd *abfd)
{
  ...
  if (new_symbol == 
# 553 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
                   ((void *)0)
# 553 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
                       )
    return new_symbol;
...
{
  do { if (!(0)) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/plugin.c",563); } while (0);
  return 0;
}
...
# 623 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
 ((void *)0)
# 623 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
     ,

  
# 625 "/doner/binutils/binutils-7a31b38/bfd/plugin.c" 3 4
 ((void *)0)

# 626 "/doner/binutils/binutils-7a31b38/bfd/plugin.c"
};
