# 1 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
# 33 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
...
# 34 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 2
...
# 35 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 36 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 2
# 50 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
const char *
  ...
  if (abfd->format != bfd_core)
    {
      ...
      return 
# 56 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
            ((void *)0)
# 56 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
                ;
    }
  return ((*((abfd)->xvec->_core_file_failing_command)) (abfd));
}
# 73 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
int
...
# 97 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
int
...
# 123 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
bfd_boolean
...
# 157 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
bfd_boolean
generic_core_file_matches_executable_p (bfd *core_bfd, bfd *exec_bfd)
{
  ...
  if (exec_bfd == 
# 164 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
                 ((void *)0) 
# 164 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
                      || core_bfd == 
# 164 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
                                     ((void *)0)
# 164 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
  ...
  if (core == 
# 173 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
             ((void *)0)
# 173 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
                 )
    return 1;

  exec = ((char *) (exec_bfd)->filename);
  if (exec == 
# 177 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
             ((void *)0)
# 177 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
                 )
    return 1;

  last_slash = strrchr (core, '/');
  if (last_slash != 
# 181 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
                   ((void *)0)
# 181 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
                       )
    core = last_slash + 1;

  last_slash = strrchr (exec, '/');
  if (last_slash != 
# 185 "/doner/binutils/binutils-7a31b38/bfd/corefile.c" 3 4
                   ((void *)0)
# 185 "/doner/binutils/binutils-7a31b38/bfd/corefile.c"
                       )
    exec = last_slash + 1;
