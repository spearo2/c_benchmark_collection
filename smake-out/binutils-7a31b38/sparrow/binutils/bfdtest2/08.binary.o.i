# 1 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
# 35 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
...
# 36 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 2
...
# 37 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 2
...
# 38 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 39 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 2
  ...
  if (abfd->target_defaulted)
    {
      ...
      return 
# 66 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
            ((void *)0)
# 66 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                ;
    }
  ...
  if (bfd_stat (abfd, &statbuf) < 0)
    {
      ...
      return 
# 75 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
            ((void *)0)
# 75 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                ;
    }
  ...
  if (sec == 
# 81 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
            ((void *)0)
# 81 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                )
    return 
# 82 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
          ((void *)0)
# 82 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
              ;
  sec->vma = 0;
...
# 105 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
                             0
# 105 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                                     ) != 0
...
mangle_name (bfd *abfd, char *suffix)
{
  ...
  if (buf == 
# 133 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
            ((void *)0)
# 133 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                )
    return "";
...
binary_canonicalize_symtab (bfd *abfd, asymbol **alocation)
{
  ...
  if (syms == 
# 157 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
             ((void *)0)
# 157 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                 )
    return -1;
  ...
  syms[0].section = sec;
  syms[0].udata.p = 
# 166 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
                   ((void *)0)
# 166 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                       ;
  ...
  syms[1].section = sec;
  syms[1].udata.p = 
# 174 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
                   ((void *)0)
# 174 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                       ;
  ...
  syms[2].udata.p = 
# 182 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
                   ((void *)0)
# 182 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                       ;

  for (i = 0; i < 3; i++)
    *alocation++ = syms++;
  *alocation = 
# 186 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
              ((void *)0)
# 186 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                  ;

  return 3;
}
# 198 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
static void
...
# 221 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
static bfd_boolean
...
# 243 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
                                   ((void *)0)
# 243 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                                       ; s = s->next)
 if (((s->flags
     ...
     && (! found_low || s->lma < low))
   {
     ...
     found_low = 1;
      ...
      for (s = abfd->sections; s != 
# 255 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
                                   ((void *)0)
# 255 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
                                       ; s = s->next)
 {
...
# 323 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
...
# 371 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
 ((void *)0)
# 371 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
     ,

  
# 373 "/doner/binutils/binutils-7a31b38/bfd/binary.c" 3 4
 ((void *)0)

# 374 "/doner/binutils/binutils-7a31b38/bfd/binary.c"
};
