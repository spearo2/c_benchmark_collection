# 1 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
# 43 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
...
# 44 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 2
...
# 45 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 46 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 2
...
# 47 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 2
...
# 48 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 2
...
# 51 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 2
# 61 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
...
bfd_cache_max_open (void)
{
  if (max_open_files == 0)
    {
      int max;
# 97 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
      struct rlimit rlim;

      if (getrlimit (
# 99 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                    RLIMIT_NOFILE
# 99 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                                 , &rlim) == 0
   && rlim.rlim_cur != (rlim_t) 
# 100 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                               ((__rlim_t) -1)
# 100 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                                            )
 max = rlim.rlim_cur / 8;
      else
 ...
 max = sysconf (
# 105 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
               _SC_OPEN_MAX
# 105 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                           ) / 8;
...
# 125 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                            ((void *)0)
# 125 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                                ;
...
{
  if (bfd_last_cache == 
# 132 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                       ((void *)0)
# 132 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                           )
    {
      abfd->lru_next = abfd;
      abfd->lru_prev = abfd;
  ...
  if (abfd == bfd_last_cache)
    {
      ...
      if (abfd == bfd_last_cache)
 bfd_last_cache = 
# 158 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                 ((void *)0)
# 158 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                     ;
    }
}
...
bfd_cache_delete (bfd *abfd)
{
  ...
  abfd->iostream = 
# 179 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                  ((void *)0)
# 179 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                      ;
  --open_files;
...
close_one (void)
{
  ...
  if (bfd_last_cache == 
# 193 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                       ((void *)0)
# 193 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                           )
    to_kill = 
# 194 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
             ((void *)0)
# 194 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                 ;
  else
    {
    ...
    to_kill = to_kill->lru_prev)
 {
   if (to_kill == bfd_last_cache)
     {
       to_kill = 
# 203 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                ((void *)0)
# 203 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                    ;
       break;
     }
 }
  ...
  if (to_kill == 
# 209 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                ((void *)0)
# 209 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                    )
    {
...
# 237 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
static FILE *
bfd_cache_lookup_worker (bfd *abfd, enum cache_flag flag)
{
  bfd *orig_bfd = abfd;
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/cache.c", 242, __PRETTY_FUNCTION__);

  while (abfd->my_archive != 
# 244 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                            ((void *)0)
  
# 245 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
 && !((abfd->my_archive)->is_thin_archive))
    abfd = abfd->my_archive;

  if (abfd->iostream != 
# 248 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                       ((void *)0)
# 248 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                           )
    {
      ...
      if (abfd != bfd_last_cache)
 {
  ...
  if (flag & CACHE_NO_OPEN)
    return 
# 260 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 260 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              ;

  if (bfd_open_file (abfd) == 
# 262 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                             ((void *)0)
# 262 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                                 )
    ;
  else if (!(flag & CACHE_NO_SEEK)
    && _bfd_real_fseek ((FILE *) abfd->iostream,
          abfd->where, 
# 266 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                      0
# 266 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                              ) != 0
  ...
  return 
# 275 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
        ((void *)0)
# 275 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
            ;
}
...
cache_btell (struct bfd *abfd)
{
  ...
  if (f == 
# 282 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 282 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              )
    return abfd->where;
...
# 290 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
           1 
# 290 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
           ? CACHE_NO_SEEK : CACHE_NORMAL));
  if (f == 
# 291 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 291 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              )
    return -1;
  return _bfd_real_fseek (f, offset, whence);
}
# 303 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
static file_ptr
cache_bread_1 (struct bfd *abfd, void *buf, file_ptr nbytes)
{
  FILE *f;
  file_ptr nread;
# 317 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
  if (nbytes == 0)
    return 0;

  f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, CACHE_NORMAL));
  if (f == 
# 321 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 321 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              )
    return 0;
# 337 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
...
# 381 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
...
cache_bwrite (struct bfd *abfd, const void *where, file_ptr nbytes)
{
  ...
  if (f == 
# 397 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 397 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              )
    return 0;
...
cache_bflush (struct bfd *abfd)
{
  ...
  if (f == 
# 420 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 420 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              )
    return 0;
  sts = fflush (f);
  if (sts < 0)
...
cache_bstat (struct bfd *abfd, struct stat *sb)
{
  ...
  if (f == 
# 434 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
          ((void *)0)
# 434 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
              )
    return -1;
             ...
             bfd_size_type *map_len __attribute__ ((__unused__)))
{
  ...
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/cache.c", 455, __PRETTY_FUNCTION__);
  ...
  else
    {
      ...
      if (f == 
# 465 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
              ((void *)0)
# 465 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                  )
 return ret;
      ...
      if (abfd->my_archive != 
# 472 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                             ((void *)0)
   
# 473 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
  && !((abfd->my_archive)->is_thin_archive))
        offset += abfd->origin;
...
# 512 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
bfd_boolean
bfd_cache_init (bfd *abfd)
{
  do { if (!(abfd->iostream != 
# 515 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
 ((void *)0)
# 515 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
 )) bfd_assert("/doner/binutils/binutils-7a31b38/bfd/cache.c",515); } while (0);
...
# 543 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
bfd_boolean
bfd_cache_close (bfd *abfd)
{
  ...
  if (abfd->iostream == 
# 549 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                       ((void *)0)
# 549 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                           )
...
# 572 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
bfd_boolean
...
# 577 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                          ((void *)0)
# 577 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                              )
    ret &= bfd_cache_close (bfd_last_cache);

  return ret;
}
# 598 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
FILE *
  ...
  if (open_files >= bfd_cache_max_open ())
    {
      if (! close_one ())
 return 
# 606 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
       ((void *)0)
# 606 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
           ;
    }
      ...
      if (abfd->opened_once)
 {
   abfd->iostream = _bfd_real_fopen (abfd->filename, "r+");
   if (abfd->iostream == 
# 620 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                        ((void *)0)
# 620 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                            )
     abfd->iostream = _bfd_real_fopen (abfd->filename, "w+");
 }
      else
 {
# 646 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
   struct stat s;
  ...
  if (abfd->iostream == 
# 657 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
                       ((void *)0)
# 657 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
                           )
    bfd_set_error (bfd_error_system_call);
  else
    {
 ...
 return 
# 662 "/doner/binutils/binutils-7a31b38/bfd/cache.c" 3 4
       ((void *)0)
# 662 "/doner/binutils/binutils-7a31b38/bfd/cache.c"
           ;
    }
