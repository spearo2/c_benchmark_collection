# 1 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
# 27 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
...
# 28 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 2
...
# 29 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 30 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 2
...
# 31 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 2
...
_bfd_archive_64_bit_slurp_armap (bfd *abfd)
{
  ...
  char *stringend;
  bfd_byte *raw_armap = 
# 47 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                       ((void *)0)
# 47 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                           ;
  carsym *carsyms;
  bfd_size_type amt;

  ardata->symdefs = 
# 51 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                   ((void *)0)
# 51 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                       ;
...
# 60 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                                      1
# 60 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                                              ) != 0)
    return 0;
  ...
  if (mapdata == 
# 74 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                ((void *)0)
# 74 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                    )
    return 0;
 ...
 bfd_set_error (bfd_error_malformed_archive);
  ...
  if (ardata->symdefs == 
# 99 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                        ((void *)0)
# 99 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                            )
    return 0;
  ...
  if (raw_armap == 
# 107 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                  ((void *)0)
# 107 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                      )
     ...
     int stridx)
{
  ...
  _bfd_ar_spacepad (hdr.ar_date, sizeof (hdr.ar_date), "%ld",
                    time (
# 180 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                         ((void *)0)
# 180 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                             ));
  ...
  for (current = arch->archive_head;
       current != 
# 204 "/doner/binutils/binutils-7a31b38/bfd/archive64.c" 3 4
                 ((void *)0) 
# 204 "/doner/binutils/binutils-7a31b38/bfd/archive64.c"
                      && count < symbol_count;
