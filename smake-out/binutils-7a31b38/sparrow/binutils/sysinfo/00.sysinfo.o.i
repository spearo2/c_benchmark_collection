# 1 "/doner/binutils/binutils-7a31b38/binutils/sysinfo.c"
...
yybackup:
  ...
  if (yychar <= 0)
    ...
    {
      yytoken = (0 <= (yychar) && (yychar) <= 263 ? yytranslate[yychar] : 2);
      ;
    }
  ...
  yyn += yytoken;
  if (yyn < 0 || 38 < yyn || yycheck[yyn] != yytoken)
    goto yydefault;
  yyn = yytable[yyn];
  if (yyn <= 0)
    {
...
# 1743 "sysinfo.c"
  ...
  *++yyvsp = yyval;
...

  {
    ...
    yystate = (0 <= yyi && yyi <= 38 && yycheck[yyi] == *yyssp
               ? yytable[yyi]
               : yydefgoto[yylhs]);
  }
...
yyerrlab:
  ...
  yytoken = yychar == (-2) ? (-2) : (0 <= (yychar) && (yychar) <= 263 ? yytranslate[yychar] : 2);
