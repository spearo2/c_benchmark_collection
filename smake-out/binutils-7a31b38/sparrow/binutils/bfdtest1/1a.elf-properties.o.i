# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
# 26 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
...
# 27 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 2
...
# 28 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 29 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 2
...
# 30 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 2
...
_bfd_elf_get_property (bfd *abfd, unsigned int type, unsigned int datasz)
{
  ...
  if (((abfd)->xvec->flavour) != bfd_target_elf_flavour)
    {
      ...
      _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-properties.c", 41, __PRETTY_FUNCTION__);
    }
 ...
 break;
  ...
  if (p == 
# 63 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
          ((void *)0)
# 63 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
              )
    {
      _bfd_error_handler (dgettext ("bfd", "%B: out of memory in _bfd_elf_get_property"),
     abfd);
      _exit (
# 67 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
            1
# 67 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                        );
    }
  memset (p, 0, sizeof (*p));
...
# 110 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                          ((void *)0)
# 110 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                              ;
   return 0;
 }
      ...
      if (type >= 0xc0000000)
 {
       ...
       if (kind == property_corrupt)
  {
    ...
    (((abfd) -> tdata.elf_obj_data) -> properties) = 
# 131 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                           ((void *)0)
# 131 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                               ;
    return 0;
  }
      ...
      else
 {
       ...
       if (datasz != align_size)
  {
    ...
    (((abfd) -> tdata.elf_obj_data) -> properties) = 
# 149 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                           ((void *)0)
# 149 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                               ;
    return 0;
  }
       ...
       if (datasz != 0)
  {
    ...
    (((abfd) -> tdata.elf_obj_data) -> properties) = 
# 167 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                           ((void *)0)
# 167 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                               ;
    return 0;
  }
       prop = _bfd_elf_get_property (abfd, type, datasz);
...
# 204 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                 ((void *)0) 
# 204 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                      ? aprop->pr_type : bprop->pr_type;

  if (bed->merge_gnu_properties != 
# 206 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                  ((void *)0)
      
# 207 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
     && pr_type >= 0xc0000000
      && pr_type < 0xe0000000)
  ...
  switch (pr_type)
    ...
    case 1:
      if (aprop != 
# 214 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                  ((void *)0) 
# 214 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                       && bprop != 
# 214 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                   ((void *)0)
# 214 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                       )
 {
   ...
   break;
    ...
    case 2:
      ...
      return aprop == 
# 228 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                     ((void *)0)
# 228 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                         ;

    default:

      _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-properties.c", 232, __PRETTY_FUNCTION__);
    }
         ...
         unsigned int type)
{
 ...
 break;
  ...
  return 
# 260 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
        ((void *)0)
# 260 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
            ;
}
        ...
        elf_property_list **listp)
{
      ...
      if (p->property.pr_kind == property_remove)
 {
  ...
  for (p = *listp; p != 
# 290 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                       ((void *)0)
# 290 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                           ; p = p->next)
    if (elf_merge_gnu_properties (info, abfd, 
# 291 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                             ((void *)0)
# 291 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                                 , &p->property))
      {
 ...
 if (pr->pr_kind != property_unknown)
   _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-properties.c", 297, __PRETTY_FUNCTION__);
...
{
  bfd *abfd, *first_pbfd = 
# 309 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                          ((void *)0)
# 309 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                              ;
  elf_property_list *list;
  asection *sec;
...
# 319 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                       ((void *)0)
# 319 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                           ; abfd = abfd->link.next)
    if (((abfd)->xvec->flavour) == bfd_target_elf_flavour
 && (abfd->flags & 0x40) == 0
 && (((abfd) -> tdata.elf_obj_data) -> properties) != 
# 322 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                            ((void *)0)
# 322 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                )
      {
 has_properties = 1;
 ...
 if ((elf_machine_code
  ...
  if (!has_properties)
    return 
# 341 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
          ((void *)0)
# 341 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
              ;


  for (abfd = info->input_bfds; abfd != 
# 344 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                       ((void *)0)
# 344 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                           ; abfd = abfd->link.next)
    if (abfd != first_pbfd && (abfd->flags & 0x40) == 0)
      {
 elf_property_list *null_ptr = 
# 347 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                              ((void *)0)
# 347 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                  ;
 ...
 if (((abfd)->xvec->flavour) == bfd_target_elf_flavour)
   {
     ...
     if (list != 
# 357 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                ((void *)0)
  
# 358 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
 && (elf_machine_code
      == ((const struct elf_backend_data *) ((abfd)->xvec)->backend_data)->elf_machine_code))
   ...
   list = 
# 363 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
         ((void *)0)
# 363 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
             ;
 ...
 if (first_pbfd != 
# 368 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                  ((void *)0)
# 368 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                      )
   elf_merge_gnu_property_list (info, first_pbfd, listp);

 if (list != 
# 371 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
            ((void *)0)
# 371 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                )
   {
  ...
  if (first_pbfd != 
# 382 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                   ((void *)0)
# 382 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                       )
    {
      unsigned int size;
      unsigned int descsz;
...
# 411 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
                                             ((void *)0)
# 411 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
                                                 )
 {
   ...
   sec->output_section = (&_bfd_std_section[2]);
   return 
# 416 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
         ((void *)0)
# 416 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
             ;
 }


      descsz = 
# 420 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
              __builtin_offsetof (
# 420 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
              Elf_External_Note
# 420 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
              , 
# 420 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
...
# 420 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
    ...
    list != 
# 424 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
           ((void *)0)
# 424 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
               ;
    list = list->next)
 {
   ...
   size = (size + (align_size - 1)) & ~(align_size - 1);
      ...
      for (list = (((first_pbfd) -> tdata.elf_obj_data) -> properties);
    list != 
# 445 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c" 3 4
           ((void *)0)
# 445 "/doner/binutils/binutils-7a31b38/bfd/elf-properties.c"
               ;
    list = list->next)
 {
  ...
  default:
    ...
    _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-properties.c", 463, __PRETTY_FUNCTION__);
  ...
  case 8:
    ...
    break;
     ...
     default:
       ...
       _bfd_abort ("/doner/binutils/binutils-7a31b38/bfd/elf-properties.c", 482, __PRETTY_FUNCTION__);
     }
