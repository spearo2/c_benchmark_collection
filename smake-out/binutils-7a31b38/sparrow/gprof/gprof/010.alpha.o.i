# 1 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
# 29 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
...
# 30 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
...
# 31 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 32 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
...
# 33 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
...
# 34 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
...
# 35 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
...
# 36 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 2
# 81 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
static Sym indirect_child;

void alpha_find_call (Sym *, bfd_vma, bfd_vma);
# 92 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
void
...
# 99 "/doner/binutils/binutils-7a31b38/gprof/alpha.c" 3 4
                            ((void *)0)
# 99 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
                                )
    {
      sym_init (&indirect_child);
      indirect_child.name = gettext ("<indirect child>");
      indirect_child.cg.prop.fract = 1.0;
      indirect_child.cg.cyc.head = &indirect_child;
    }

  if (debug_level & ((1<<8))) {printf (gettext ("[find_call] %s: 0x%lx to 0x%lx\n"), parent->name, (unsigned long) p_lowpc, (unsigned long) p_highpc);}
 ...
 {
 case 0x1aU << 26:
# 125 "/doner/binutils/binutils-7a31b38/gprof/alpha.c"
   if ((insn & (3 << 14)) == 1U << 14
       || (insn & (3 << 14)) == 3U << 14)
     {
       if (debug_level & ((1<<8))) {printf (gettext ("[find_call] 0x%lx: jsr%s <indirect_child>\n"), (unsigned long) pc, ((insn & (3 << 14)) == 1U << 14 ? "" : "_coroutine"));}
 ...
 case 0x34U << 26:
   if (debug_level & ((1<<8))) {printf (gettext ("[find_call] 0x%lx: bsr"), (unsigned long) pc);}
                                                                 ;
