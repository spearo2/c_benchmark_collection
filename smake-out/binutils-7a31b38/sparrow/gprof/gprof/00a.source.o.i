# 1 "/doner/binutils/binutils-7a31b38/gprof/source.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/source.c"
# 22 "/doner/binutils/binutils-7a31b38/gprof/source.c"
...
# 23 "/doner/binutils/binutils-7a31b38/gprof/source.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gprof/source.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/gprof/source.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 27 "/doner/binutils/binutils-7a31b38/gprof/source.c" 2




bfd_boolean create_annotation_files = 0;
...
annotate_source (Source_File *sf, unsigned int max_width,
     ...
     void *arg)
{
  static bfd_boolean first_file = 1;
...
# 134 "/doner/binutils/binutils-7a31b38/gprof/source.c"
   if (name_only)
     {
 ...
 {
   if (
# 161 "/doner/binutils/binutils-7a31b38/gprof/source.c" 3 4
      (*__errno_location ()) 
# 161 "/doner/binutils/binutils-7a31b38/gprof/source.c"
            == 
# 161 "/doner/binutils/binutils-7a31b38/gprof/source.c" 3 4
               2
# 161 "/doner/binutils/binutils-7a31b38/gprof/source.c"
     ...
     fprintf (
# 162 "/doner/binutils/binutils-7a31b38/gprof/source.c" 3 4
             stderr
# 162 "/doner/binutils/binutils-7a31b38/gprof/source.c"
                   , gettext ("%s: could not locate `%s'\n"),
       whoami, sf->name);
   else
     perror (sf->name);
  ...
  ofp = 
# 171 "/doner/binutils/binutils-7a31b38/gprof/source.c" 3 4
       stdout
# 171 "/doner/binutils/binutils-7a31b38/gprof/source.c"
             ;
...
# 189 "/doner/binutils/binutils-7a31b38/gprof/source.c"
      if (filename)
 ++filename;
      else
 filename = sf->name;
      ...
      strcat (fname, "-ann");
# 214 "/doner/binutils/binutils-7a31b38/gprof/source.c"
      ofp = fopen (fname, "w");
      ...
      if (!ofp)
 {
  ...
  if (ofp == 
# 225 "/doner/binutils/binutils-7a31b38/gprof/source.c" 3 4
            stdout
# 225 "/doner/binutils/binutils-7a31b38/gprof/source.c"
                  )
    {
      if (first_file)
 first_file = 0;
