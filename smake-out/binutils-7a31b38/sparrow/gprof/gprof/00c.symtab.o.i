# 1 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
# 22 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
...
# 23 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 25 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 2
...
# 27 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 2
...
# 28 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 2
...
# 60 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
static int
...
symtab_finalize (Sym_Table *tab)
{
      ...
      else
 {
  ...
  if (tab->len > 0 && dst[-1].end_addr == 0)
    dst[-1].end_addr
      = core_text_sect->vma + ((core_text_sect)->size) - 1;
...
# 171 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
   ;
}
...
dbg_sym_lookup (Sym_Table *sym_tab, bfd_vma address)
{
  ...
  fprintf (
# 183 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 3 4
          stderr
# 183 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
  ...
  for (low = 0, high = sym_tab->len - 1; low != high;)
    {
      ...
      fprintf (
# 191 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 3 4
              stderr
# 191 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
                    , "[dbg_sym_lookup] low=0x%lx, mid=0x%lx, high=0x%lx\n",
        low, mid, high);
      fprintf (
# 193 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 3 4
              stderr
# 193 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
 ...
 low = mid + 1;
  ...
  fprintf (
# 206 "/doner/binutils/binutils-7a31b38/gprof/symtab.c" 3 4
          stderr
# 206 "/doner/binutils/binutils-7a31b38/gprof/symtab.c"
