# 1 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
# 1 "/doner/binutils/binutils-7a31b38/gprof//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
# 22 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
# 1 "/doner/binutils/binutils-7a31b38/gprof/gprof.h" 1
# 33 "/doner/binutils/binutils-7a31b38/gprof/gprof.h"
# 1 "../bfd/sysdep.h" 1
# 29 "../bfd/sysdep.h"
# 1 "../bfd/config.h" 1
# 30 "../bfd/sysdep.h" 2
...
# 185 "../bfd/sysdep.h" 2
# 34 "/doner/binutils/binutils-7a31b38/gprof/gprof.h" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 35 "/doner/binutils/binutils-7a31b38/gprof/gprof.h" 2
...
# 1 "/doner/binutils/binutils-7a31b38/gprof/gconfig.h" 1
# 42 "/doner/binutils/binutils-7a31b38/gprof/gprof.h" 2
# 101 "/doner/binutils/binutils-7a31b38/gprof/gprof.h"
typedef enum
  {
...
extern bfd_boolean bsd_style_output;
extern bfd_boolean demangle;
extern bfd_boolean ignore_direct_calls;
extern bfd_boolean ignore_static_funcs;
extern bfd_boolean ignore_zeros;
extern bfd_boolean line_granularity;
extern bfd_boolean print_descriptions;
extern bfd_boolean print_path;
extern bfd_boolean ignore_non_functions;
extern bfd_boolean inline_file_names;

extern File_Format file_format;

extern bfd_boolean first_output;

extern void done (int status) __attribute__ ((__noreturn__));
# 23 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
...
# 24 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2

# 1 "/doner/binutils/binutils-7a31b38/gprof/search_list.h" 1
# 33 "/doner/binutils/binutils-7a31b38/gprof/search_list.h"
...
# 26 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/source.h" 1
# 25 "/doner/binutils/binutils-7a31b38/gprof/source.h"
...
# 59 "/doner/binutils/binutils-7a31b38/gprof/source.h"
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    void (*annote) (char *, unsigned int, int, void * arg),
    void * arg);
# 27 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/symtab.h" 1
# 37 "/doner/binutils/binutils-7a31b38/gprof/symtab.h"
typedef struct sym
  {
...
# 28 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/hist.h" 1
# 25 "/doner/binutils/binutils-7a31b38/gprof/hist.h"
...
# 56 "/doner/binutils/binutils-7a31b38/gprof/hist.h"
extern void hist_clip_symbol_address (bfd_vma *p_lowpc, bfd_vma *p_highpc);
# 29 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/corefile.h" 1
# 25 "/doner/binutils/binutils-7a31b38/gprof/corefile.h"
struct function_map
{
  char * function_name;
  char * file_name;
...
# 30 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
...
# 31 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2
...
# 32 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 2


# 33 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
bfd *core_bfd;
...
{
  fprintf (
# 62 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
          stderr
# 62 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                , gettext ("%s: unable to parse mapping file %s.\n"), whoami, filename);
  done (1);
}
...
read_function_mappings (const char *filename)
{
  ...
  if (!file)
    {
      fprintf (
# 90 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 90 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
      ...
      if (!strncmp (dummy, "No symbols in ", 14))
 {
   matches = fscanf (file, "\n");
   if (matches == 
# 109 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                 (-1)
# 109 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    )
     parse_error (filename);
   continue;
 }
      ...
      if (!strncmp (dummy, "No symbols in ", 14))
 {
   matches = fscanf (file, "\n");
   if (matches == 
# 143 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                 (-1)
# 143 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    )
     parse_error (filename);
   continue;
 }
...
core_init (const char * aout_name)
{
  ...
  if (!bfd_check_format (core_bfd, bfd_object))
    {
      fprintf (
# 192 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 192 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , gettext ("%s: %s: not in executable format\n"), whoami, aout_name);
      done (1);
    }
 ...
 {
   fprintf (
# 203 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
           stderr
# 203 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                 , gettext ("%s: can't find .text section in %s\n"),
     whoami, aout_name);
   done (1);
 }
    }
  ...
  if (core_sym_bytes < 0)
    {
      fprintf (
# 215 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 215 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , "%s: %s: %s\n", whoami, aout_name,
  ...
  if (core_num_syms < 0)
    {
      fprintf (
# 225 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 225 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , "%s: %s: %s\n", whoami, aout_name,
        bfd_errmsg (bfd_get_error ()));
      done (1);
    }
...
# 230 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
               ((void *)0)
# 230 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
               , &synthsyms))
                           ;
  if (synth_count > 0)
    {
...
{
  core_text_space = malloc (((core_text_sect)->size));

  if (!core_text_space)
    {
      fprintf (
# 278 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 278 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , gettext ("%s: ran out room for %lu bytes of text space\n"),
        whoami, (unsigned long) ((core_text_sect)->size));
      done (1);
    }

  if (!bfd_get_section_contents (cbfd, core_text_sect, core_text_space,
     0, ((core_text_sect)->size)))
    {
  ...
  if (!core_text_space)
    fprintf (
# 292 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
            stderr
# 292 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                  , gettext ("%s: can't do -c\n"), whoami);
}
...
find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
  ...
  switch (bfd_get_arch (core_bfd))
    ...
    default:
      fprintf (
# 335 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 335 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , gettext ("%s: -c not supported on architecture %s\n"),
...
core_sym_class (asymbol *sym)
{
  ...
  if (sym->section == 
# 356 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                     ((void *)0) 
# 356 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                          || (sym->flags & (1 << 2)) != 0)
    return 0;
...
# 438 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
  sym_prefix = ((core_bfd)->xvec->symbol_leading_char);
...
# 466 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
     ((void *)0)
# 466 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
     ))
...
num_of_syms_in (FILE * f)
{
  ...
  while (!feof (f) && fgets (buf, (1024) - 1, f))
        ...
        if (type == 't' || type == 'T')
   {
     ...
     if (++num >= 
# 506 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                 (0x7fffffff * 2U + 1U) 
# 506 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                          / sizeof (Sym))
       return -1U;
   }
    }
...
core_create_syms_from (const char * sym_table_file)
{
  ...
  if (!f)
    {
      fprintf (
# 527 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 527 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
  ...
  if (symtab.len == 0)
    {
      fprintf (
# 536 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 536 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , gettext ("%s: file `%s' has no symbols\n"), whoami, sym_table_file);
      done (1);
    }
  else if (symtab.len == -1U)
    {
      fprintf (
# 541 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 541 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , gettext ("%s: file `%s' has too many symbols\n"),
        whoami, sym_table_file);
      done (1);
    }
  ...
  if (fseek (f, 0, 
# 551 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                  0
# 551 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                          ) != 0)
    {
 ...
 continue;
      ...
      sscanf (address, "%" "l" "x", &(symtab.limit->addr) );

      symtab.limit->name = (char *) xmalloc (strlen (name) + 1);
      strcpy ((char *) symtab.limit->name, name);
      symtab.limit->mapped = 0;
      symtab.limit->is_func = 1;
      symtab.limit->is_bb_head = 1;
...
# 601 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                               ((void *)0)
# 601 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                                   ;
      ...
      if (symbol_map_count != 0)
 {
   ...
   found = (struct function_map *) bsearch
     (core_syms[i]->name, symbol_map, symbol_map_count,
      ...
      if (found == 
# 636 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                  ((void *)0) 
# 636 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                       || found->is_first)
 ++symtab.len;
    }
  ...
  if (symtab.len == 0)
    {
      fprintf (
# 642 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 642 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    , gettext ("%s: file `%s' has no symbols\n"), whoami, a_out_name);
      done (1);
    }
 ...
 continue;
      ...
      if (sym_sec)
 symtab.limit->addr += ((void) sym_sec->owner, (sym_sec)->vma);
...
# 727 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
   }
      }
 ...
 symtab.limit->is_static = 1;
      ...
      min_vma = ((symtab.limit->addr) < (min_vma) ? (symtab.limit->addr) : (min_vma));
      if (sym_sec)
 max_vma = ((((void) sym_sec->owner, (sym_sec)->vma) + ((sym_sec)->size) - 1) > (max_vma) ? (((void) sym_sec->owner, (sym_sec)->vma) + ((sym_sec)->size) - 1) : (max_vma))
...
# 788 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
  prev_name_len = 
# 788 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                 4096
# 788 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                         ;
  prev_filename_len = 
# 789 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                     4096
# 789 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                             ;
  ...
  vma_high = core_text_sect->vma + ((core_text_sect)->size);
  for (vma = core_text_sect->vma; vma < vma_high; vma += min_insn_size)
   ...
   || (prev_line_num == dummy.line_num
       && prev_name != 
# 802 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
                      ((void *)0)
       
# 803 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
...
# 860 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
  prev = 0;
      ...
      else
 {
  ...
  if ((unsigned int) (ltab.limit - ltab.base) != ltab.len)
    {
      fprintf (
# 908 "/doner/binutils/binutils-7a31b38/gprof/corefile.c" 3 4
              stderr
# 908 "/doner/binutils/binutils-7a31b38/gprof/corefile.c"
                    ,
        gettext ("%s: somebody miscounted: ltab.len=%d instead of %ld\n"),
