# 1 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
# 24 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
...
# 25 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 26 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 28 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 29 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 30 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
GMON_Record_Tag;
# 31 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 32 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 33 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 34 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
# 35 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 2
...
bfd_boolean bb_annotate_all_lines = 0;
...
fskip_string (FILE *fp)
{
  ...
  while ((ch = fgetc (fp)) != 
# 109 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 3 4
                             (-1)
# 109 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
                                )
    {
      if (ch == '\0')
 break;
...
bb_read_rec (FILE *ifp, const char *filename)
{
  ...
  if (gmon_io_read_32 (ifp, &nblocks))
    {
      fprintf (
# 128 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 3 4
              stderr
# 128 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
 ...
 {
   static bfd_boolean user_warned = 0;

   if (!user_warned)
     {
       user_warned = 1;
       fprintf (
# 195 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 3 4
               stderr
# 195 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
                     ,
  gettext ("%s: warning: ignoring basic-block exec counts (use -l or --line)\n"),
         whoami);
     }
 }
    }
...
print_exec_counts (void)
{
      ...
      if (sym->ncalls > 0 || ! ignore_zeros)
 {
   ...
   printf (gettext ("%s:%d: (%s:0x%lx) %lu executions\n"),
    sym->file ? sym->file->name : gettext ("<unknown>"), sym->line_num,
...
# 319 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
static void
annotate_with_count (char *buf, unsigned int width, int line_num, void * arg)
{
  ...
  b = 
# 328 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 3 4
     ((void *)0)
# 328 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
         ;
      ...
      if (bb_table_length > 0)
 {
   ...
   for (i = 0; i < table_len; ++i)
    ...
    break;
      ...
      fprintf (ofp, gettext ("\nExecution Summary:\n\n"));
      fprintf (ofp, gettext ("%9ld   Executable lines in this file\n"),
        num_executable_lines);
      fprintf (ofp, gettext ("%9ld   Lines executed\n"), num_lines_executed);
      fprintf (ofp, gettext ("%9.2f   Percent of the file executed\n"),
        num_executable_lines
        ? 100.0 * num_lines_executed / (double) num_executable_lines
        : 100.0);
      fprintf (ofp, gettext ("\n%9lu   Total number of line executions\n"),
        sf->ncalls);
      fprintf (ofp, gettext ("%9.2f   Average executions per line\n"),
        num_executable_lines
        ? (double) sf->ncalls / (double) num_executable_lines
        : 0.0);

      if (ofp != 
# 582 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c" 3 4
                stdout
# 582 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.c"
                      )
 fclose (ofp);
    }
}
