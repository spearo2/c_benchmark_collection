# 1 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
# 22 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
...
# 23 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "./../include/binary-io.h" 1
# 24 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
# 25 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 26 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
# 27 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/cg_arcs.h" 1
# 30 "/doner/binutils/binutils-7a31b38/gprof/cg_arcs.h"
typedef struct arc
  {
    Sym *parent;
    Sym *child;
...
# 28 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.h" 1
# 25 "/doner/binutils/binutils-7a31b38/gprof/basic_blocks.h"
...
# 29 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
# 30 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/call_graph.h" 1
# 25 "/doner/binutils/binutils-7a31b38/gprof/call_graph.h"
...
# 31 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.h" 1
# 29 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.h"
...
# 32 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/gmon_out.h" 1
# 32 "/doner/binutils/binutils-7a31b38/gprof/gmon_out.h"
struct gmon_hdr
  {
    char cookie[4];
    char version[4];
...
GMON_Record_Tag;
# 33 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/gmon.h" 1
# 125 "/doner/binutils/binutils-7a31b38/gprof/gmon.h"
struct tostruct
  {
    char *selfpc;
    int count;
...
# 34 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-7a31b38/gprof/hertz.h" 1
# 30 "/doner/binutils/binutils-7a31b38/gprof/hertz.h"
extern int hertz (void);
# 35 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
# 36 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
# 37 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 2
...
gmon_get_ptr_size (void)
{
  ...
  switch (size)
    ...
    default:
      fprintf (
# 83 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
              stderr
# 83 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
...
gmon_out_read (const char *filename)
{
  ...
  if (strcmp (filename, "-") == 0)
    {
      ifp = 
# 302 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
           stdin
# 302 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                ;
      ;
    }
  else
      ...
      if (!ifp)
 {
  ...
  if (fread (&ghdr, sizeof (struct gmon_hdr), 1, ifp) != 1)
    {
      fprintf (
# 318 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
              stderr
# 318 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
 ...
 {
   fprintf (
# 328 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
           stderr
# 328 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
 ...
 {
   fprintf (
# 338 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
           stderr
# 338 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                 ,
      ...
      while (fread (&tag, sizeof (tag), 1, ifp) == 1)
 {
   switch (tag)
     ...
     default:
       fprintf (
# 368 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
               stderr
# 368 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                     ,
 ...
 unsigned int ncnt;
      ...
      if (fseek (ifp, 0, 
# 401 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
                        0
# 401 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                                ) < 0)
 {
   perror (filename);
   done (1);
 ...
 bad_gmon_file:
          fprintf (
# 414 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
                  stderr
# 414 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                        , gettext ("%s: file too short to be a gmon file\n"),
     filename);
   done (1);
 }
      ...
      if (version == 0x00051879)
 {
   ...
   if (!histograms)
     ...
     {
       fprintf (
# 435 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
               stderr
# 435 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                     ,
      ...
      else
 {
   ...
   if (file_format == FF_BSD44)
     {
       fprintf (
# 457 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
               stderr
# 457 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                     , gettext ("%s: file `%s' has bad magic cookie\n"),
         whoami, filename);
       done (1);
     }
...
# 475 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
                                  0
# 475 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                                          ) < 0)
 {
   perror (filename);
   done (1);
 ...
 {
   fprintf (
# 487 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
           stderr
# 487 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
 ...
 {
   fprintf (
# 516 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
           stderr
# 516 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                 ,
      ...
      for (i = 0; i < hist_num_bins; ++i)
 {
   if (fread (raw_bin_count, sizeof (raw_bin_count), 1, ifp) != 1)
     {
       fprintf (
# 529 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
               stderr
# 529 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                     ,
   ...
   if (hz == 0)
     {
       hz = 1;
       fprintf (
# 562 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
               stderr
# 562 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
    ...
    {
      fprintf (
# 568 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
              stderr
# 568 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
  ...
  if (ifp != 
# 573 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
            stdin
# 573 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                 )
    fclose (ifp);
...
gmon_out_write (const char *filename)
{
      ...
      for (sym = symtab.base; sym < symtab.limit; ++sym)
 {
          ...
          arc->child->addr, arc->count))
  {
    ...
    {
      fprintf (
# 748 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c" 3 4
              stderr
# 748 "/doner/binutils/binutils-7a31b38/gprof/gmon_io.c"
                    , gettext ("%s: don't know how to deal with file format %d\n"),
        whoami, file_format);
      done (1);
    }
