# 1 "/home/ca99c52/lib/memcasecmp.c"
# 1 "/home/ca99c52//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/lib/memcasecmp.c"
# 20 "/home/ca99c52/lib/memcasecmp.c"
# 1 "./lib/config.h" 1
# 21 "/home/ca99c52/lib/memcasecmp.c" 2

# 1 "/home/ca99c52/lib/memcasecmp.h" 1
# 20 "/home/ca99c52/lib/memcasecmp.h"
...
# 21 "/home/ca99c52/lib/memcasecmp.h" 2


# 22 "/home/ca99c52/lib/memcasecmp.h"
int memcasecmp (const void *vs1, const void *vs2, size_t n) __attribute__ ((__pure__));
# 23 "/home/ca99c52/lib/memcasecmp.c" 2
...
# 36 "./lib/ctype.h" 2 3
# 25 "/home/ca99c52/lib/memcasecmp.c" 2
# 1 "./lib/limits.h" 1
# 22 "./lib/limits.h"
...
# 28 "./lib/limits.h" 2 3
# 26 "/home/ca99c52/lib/memcasecmp.c" 2
...
# 31 "/home/ca99c52/lib/memcasecmp.c"
int
  ...
  for (i = 0; i < n; i++)
    {
      ...
      int U2 = toupper (u2);
      int diff = (
# 43 "/home/ca99c52/lib/memcasecmp.c" 3 4
                 (0x7f * 2 + 1) 
# 43 "/home/ca99c52/lib/memcasecmp.c"
                           <= 0x7fffffff ? U1 - U2
                  : U1 < U2 ? -1 : U2 < U1);
      if (diff)
        return diff;
