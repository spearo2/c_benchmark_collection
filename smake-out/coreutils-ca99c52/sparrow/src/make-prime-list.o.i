# 1 "/home/ca99c52/src/make-prime-list.c"
# 1 "/home/ca99c52//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/src/make-prime-list.c"
# 20 "/home/ca99c52/src/make-prime-list.c"
# 1 "./lib/config.h" 1
# 21 "/home/ca99c52/src/make-prime-list.c" 2
...
# 28 "./lib/limits.h" 2 3
# 23 "/home/ca99c52/src/make-prime-list.c" 2
...
# 24 "/home/ca99c52/src/make-prime-list.c" 2
# 1 "./lib/inttypes.h" 1
# 25 "./lib/inttypes.h"
...
extern int _gl_cxxalias_dummy;
# 25 "/home/ca99c52/src/make-prime-list.c" 2
# 1 "./lib/stdio.h" 1
# 20 "./lib/stdio.h"
...
extern int _gl_cxxalias_dummy;
# 26 "/home/ca99c52/src/make-prime-list.c" 2
# 1 "./lib/string.h" 1
# 20 "./lib/string.h"
...
extern int _gl_cxxalias_dummy;
# 27 "/home/ca99c52/src/make-prime-list.c" 2
# 1 "./lib/stdlib.h" 1
# 20 "./lib/stdlib.h"
...
extern int _gl_cxxalias_dummy;
# 28 "/home/ca99c52/src/make-prime-list.c" 2
...
# 29 "/home/ca99c52/src/make-prime-list.c" 2
# 43 "/home/ca99c52/src/make-prime-list.c"
...
xalloc (size_t s)
{
  ...
  fprintf (
# 167 "/home/ca99c52/src/make-prime-list.c" 3 4
          stderr
# 167 "/home/ca99c52/src/make-prime-list.c"
                , "Virtual memory exhausted.\n");
  exit (
# 168 "/home/ca99c52/src/make-prime-list.c" 3 4
       1
# 168 "/home/ca99c52/src/make-prime-list.c"
                   );
}
...
main (int argc, char **argv)
{
  ...
  if (argc != 2)
    {
      fprintf (
# 184 "/home/ca99c52/src/make-prime-list.c" 3 4
              stderr
# 184 "/home/ca99c52/src/make-prime-list.c"
                    , "Usage: %s LIMIT\n"
               "Produces a list of odd primes <= LIMIT\n", argv[0]);
      return 
# 186 "/home/ca99c52/src/make-prime-list.c" 3 4
            1
# 186 "/home/ca99c52/src/make-prime-list.c"
                        ;
    }
  limit = atoi (argv[1]);
  if (limit < 3)
    return 
# 190 "/home/ca99c52/src/make-prime-list.c" 3 4
          0
# 190 "/home/ca99c52/src/make-prime-list.c"
                      ;
  ...
  if (ferror (
# 223 "/home/ca99c52/src/make-prime-list.c" 3 4
             stdout
# 223 "/home/ca99c52/src/make-prime-list.c"
                   ) + fclose (
# 223 "/home/ca99c52/src/make-prime-list.c" 3 4
                               stdout
# 223 "/home/ca99c52/src/make-prime-list.c"
    ...
    {
      fprintf (
# 225 "/home/ca99c52/src/make-prime-list.c" 3 4
              stderr
# 225 "/home/ca99c52/src/make-prime-list.c"
                    , "write error: %s\n", strerror (
# 225 "/home/ca99c52/src/make-prime-list.c" 3 4
                                                     (*__errno_location ())
# 225 "/home/ca99c52/src/make-prime-list.c"
      ...
      return 
# 226 "/home/ca99c52/src/make-prime-list.c" 3 4
            1
# 226 "/home/ca99c52/src/make-prime-list.c"
                        ;
    }

  return 
# 229 "/home/ca99c52/src/make-prime-list.c" 3 4
        0
# 229 "/home/ca99c52/src/make-prime-list.c"
                    ;
}
