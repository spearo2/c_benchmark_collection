...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/lib/mkdir-p.c"
# 21 "/home/ca99c52/lib/mkdir-p.c"
# 1 "./lib/config.h" 1
# 22 "/home/ca99c52/lib/mkdir-p.c" 2

# 1 "/home/ca99c52/lib/mkdir-p.h" 1
# 21 "/home/ca99c52/lib/mkdir-p.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdbool.h" 1 3 4
# 22 "/home/ca99c52/lib/mkdir-p.h" 2
# 1 "./lib/sys/types.h" 1
# 20 "./lib/sys/types.h"
...
# 29 "./lib/sys/types.h" 2 3
# 23 "/home/ca99c52/lib/mkdir-p.h" 2


# 24 "/home/ca99c52/lib/mkdir-p.h"
struct savewd;

# 25 "/home/ca99c52/lib/mkdir-p.h" 3 4
_Bool 
# 25 "/home/ca99c52/lib/mkdir-p.h"
...
# 35 "/home/ca99c52/lib/mkdir-p.h" 3 4
                      _Bool 
# 35 "/home/ca99c52/lib/mkdir-p.h"
                           preserve_existing);
# 24 "/home/ca99c52/lib/mkdir-p.c" 2
...
# 26 "/home/ca99c52/lib/mkdir-p.c" 2
# 1 "./lib/sys/stat.h" 1
# 25 "./lib/sys/stat.h"
...
extern int _gl_cxxalias_dummy;
# 27 "/home/ca99c52/lib/mkdir-p.c" 2
# 1 "./lib/unistd.h" 1
# 21 "./lib/unistd.h"
...
# 28 "/home/ca99c52/lib/mkdir-p.c" 2
...
# 30 "/home/ca99c52/lib/mkdir-p.c" 2


# 1 "/home/ca99c52/lib/dirchownmod.h" 1
# 1 "./lib/sys/types.h" 1
# 20 "./lib/sys/types.h"
       
# 21 "./lib/sys/types.h" 3
# 2 "/home/ca99c52/lib/dirchownmod.h" 2
int dirchownmod (int, char const *, mode_t, uid_t, gid_t, mode_t, mode_t);
# 33 "/home/ca99c52/lib/mkdir-p.c" 2
# 1 "/home/ca99c52/lib/dirname.h" 1
# 23 "/home/ca99c52/lib/dirname.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
...
# 44 "/home/ca99c52/lib/dirname.h" 3
                                  __attribute__ ((__pure__))
# 44 "/home/ca99c52/lib/dirname.h"
                                                    ;
size_t dir_len (char const *file) 
# 45 "/home/ca99c52/lib/dirname.h" 3
                                 __attribute__ ((__pure__))
# 45 "/home/ca99c52/lib/dirname.h"
                                                   ;
char *last_component (char const *file) 
# 46 "/home/ca99c52/lib/dirname.h" 3
                                       __attribute__ ((__pure__))
# 46 "/home/ca99c52/lib/dirname.h"
                                                         ;
...
# 34 "/home/ca99c52/lib/mkdir-p.c" 2
# 1 "/home/ca99c52/lib/error.h" 1
# 52 "/home/ca99c52/lib/error.h"
...
# 35 "/home/ca99c52/lib/mkdir-p.c" 2
...
# 36 "/home/ca99c52/lib/mkdir-p.c" 2
# 1 "/home/ca99c52/lib/mkancesdirs.h" 1
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
# 2 "/home/ca99c52/lib/mkancesdirs.h" 2
struct savewd;
ptrdiff_t mkancesdirs (char *, struct savewd *,
                       int (*) (char const *, char const *, void *), void *);
# 37 "/home/ca99c52/lib/mkdir-p.c" 2
# 1 "/home/ca99c52/lib/savewd.h" 1
# 24 "/home/ca99c52/lib/savewd.h"
# 1 "./lib/sys/types.h" 1
# 20 "./lib/sys/types.h"
       
# 21 "./lib/sys/types.h" 3
# 25 "/home/ca99c52/lib/savewd.h" 2
...
inline int 
# 123 "/home/ca99c52/lib/savewd.h" 3
                 __attribute__ ((__pure__))

# 124 "/home/ca99c52/lib/savewd.h"
...
# 147 "/home/ca99c52/lib/savewd.h"
int savewd_process_files (int n_files, char **file,
                          int (*act) (char *, struct savewd *, void *),
                          void *options);


# 38 "/home/ca99c52/lib/mkdir-p.c" 2
# 84 "/home/ca99c52/lib/mkdir-p.c"

# 84 "/home/ca99c52/lib/mkdir-p.c" 3 4
_Bool

# 85 "/home/ca99c52/lib/mkdir-p.c"
make_dir_parents (char *dir,
                  struct savewd *wd,
...
# 94 "/home/ca99c52/lib/mkdir-p.c" 3 4
                 _Bool 
# 94 "/home/ca99c52/lib/mkdir-p.c"
                      preserve_existing)
{
          ...
          if (prefix_len < 0)
            {
              if (prefix_len < -1)
                return 
# 109 "/home/ca99c52/lib/mkdir-p.c" 3 4
                      1
# 109 "/home/ca99c52/lib/mkdir-p.c"
                          ;
              mkdir_errno = 
# 110 "/home/ca99c52/lib/mkdir-p.c" 3 4
                           (*__errno_location ())
# 110 "/home/ca99c52/lib/mkdir-p.c"
                                ;
            }
        }
...
# 121 "/home/ca99c52/lib/mkdir-p.c" 3 4
         _Bool 
# 121 "/home/ca99c52/lib/mkdir-p.c"
              keep_owner = owner == (uid_t) -1 && group == (gid_t) -1;
          
# 122 "/home/ca99c52/lib/mkdir-p.c" 3 4
         _Bool 
# 122 "/home/ca99c52/lib/mkdir-p.c"
              keep_special_mode_bits =
            ((mode_bits & (
# 123 "/home/ca99c52/lib/mkdir-p.c" 3 4
                          04000 
# 123 "/home/ca99c52/lib/mkdir-p.c"
                                  | 
# 123 "/home/ca99c52/lib/mkdir-p.c" 3 4
                                    02000
# 123 "/home/ca99c52/lib/mkdir-p.c"
...
# 123 "/home/ca99c52/lib/mkdir-p.c"
          ...
          if (! keep_owner)
            mkdir_mode &= ~ (
# 126 "/home/ca99c52/lib/mkdir-p.c" 3 4
                            ((0400|0200|0100) >> 3) 
# 126 "/home/ca99c52/lib/mkdir-p.c"
                                    | 
# 126 "/home/ca99c52/lib/mkdir-p.c" 3 4
                                      (((0400|0200|0100) >> 3) >> 3)
# 126 "/home/ca99c52/lib/mkdir-p.c"
            ...
            mkdir_mode &= ~ (
# 128 "/home/ca99c52/lib/mkdir-p.c" 3 4
                            (0200 >> 3) 
# 128 "/home/ca99c52/lib/mkdir-p.c"
                                    | 
# 128 "/home/ca99c52/lib/mkdir-p.c" 3 4
                                      ((0200 >> 3) >> 3)
# 128 "/home/ca99c52/lib/mkdir-p.c"
...
# 134 "/home/ca99c52/lib/mkdir-p.c" 3 4
             _Bool 
# 134 "/home/ca99c52/lib/mkdir-p.c"
                  umask_must_be_ok = (mode & mode_bits & 
# 134 "/home/ca99c52/lib/mkdir-p.c" 3
...
# 134 "/home/ca99c52/lib/mkdir-p.c"
            ...
            {
              mkdir_errno = 
# 143 "/home/ca99c52/lib/mkdir-p.c" 3 4
                           (*__errno_location ())
# 143 "/home/ca99c52/lib/mkdir-p.c"
                                ;
              mkdir_mode = -1;
            }
          ...
          if (preserve_existing)
            {
              ...
              if (mkdir_errno == 0
                  || (mkdir_errno != 
# 151 "/home/ca99c52/lib/mkdir-p.c" 3 4
                                    2 
# 151 "/home/ca99c52/lib/mkdir-p.c"
                                           && make_ancestor
                      && stat (dir + prefix_len, &st) == 0
                      && 
# 153 "/home/ca99c52/lib/mkdir-p.c" 3 4
                        ((((
# 153 "/home/ca99c52/lib/mkdir-p.c"
                        st.st_mode
# 153 "/home/ca99c52/lib/mkdir-p.c" 3 4
                        )) & 0170000) == (0040000))
# 153 "/home/ca99c52/lib/mkdir-p.c"
                ...
                return 
# 154 "/home/ca99c52/lib/mkdir-p.c" 3 4
                      1
# 154 "/home/ca99c52/lib/mkdir-p.c"
                          ;
            }
          else
            {
              ...
              if (chdir_result < -1)
                return 
# 163 "/home/ca99c52/lib/mkdir-p.c" 3 4
                      1
# 163 "/home/ca99c52/lib/mkdir-p.c"
                          ;
              else
                {
                  
# 166 "/home/ca99c52/lib/mkdir-p.c" 3 4
                 _Bool 
# 166 "/home/ca99c52/lib/mkdir-p.c"
                  ...
                  if (dirchownmod (open_result[0], subdir, mkdir_mode,
                      ...
                      == 0)
                    return 
# 171 "/home/ca99c52/lib/mkdir-p.c" 3 4
                          1
# 171 "/home/ca99c52/lib/mkdir-p.c"
                              ;

                  if (mkdir_errno == 0
                      || (mkdir_errno != 
# 174 "/home/ca99c52/lib/mkdir-p.c" 3 4
                                        2 
# 174 "/home/ca99c52/lib/mkdir-p.c"
                                               && make_ancestor
                          && 
# 175 "/home/ca99c52/lib/mkdir-p.c" 3 4
                            (*__errno_location ()) 
# 175 "/home/ca99c52/lib/mkdir-p.c"
                                  != 
# 175 "/home/ca99c52/lib/mkdir-p.c" 3 4
                                     20
# 175 "/home/ca99c52/lib/mkdir-p.c"
                    ...
                    {
                      error (0, 
# 177 "/home/ca99c52/lib/mkdir-p.c" 3 4
                               (*__errno_location ())
# 177 "/home/ca99c52/lib/mkdir-p.c"
                                    ,
                             ...
                             quote (dir));
                      return 
# 182 "/home/ca99c52/lib/mkdir-p.c" 3 4
                            0
# 182 "/home/ca99c52/lib/mkdir-p.c"
                                 ;
                    }
                }
            }
  ...
  return 
# 190 "/home/ca99c52/lib/mkdir-p.c" 3 4
        0
# 190 "/home/ca99c52/lib/mkdir-p.c"
             ;
}
