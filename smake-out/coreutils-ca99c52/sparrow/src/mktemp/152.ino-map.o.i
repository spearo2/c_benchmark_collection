...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/lib/ino-map.c"
# 20 "/home/ca99c52/lib/ino-map.c"
# 1 "./lib/config.h" 1
# 21 "/home/ca99c52/lib/ino-map.c" 2
...
# 22 "/home/ca99c52/lib/ino-map.c" 2
...
# 28 "./lib/limits.h" 2 3
# 27 "/home/ca99c52/lib/ino-map.c" 2
# 1 "./lib/stdlib.h" 1
# 20 "./lib/stdlib.h"
...
extern int _gl_cxxalias_dummy;
# 28 "/home/ca99c52/lib/ino-map.c" 2




# 31 "/home/ca99c52/lib/ino-map.c"
struct ino_map_ent
{
  ino_t ino;
  size_t mapped_ino;
...
static 
# 72 "/home/ca99c52/lib/ino-map.c" 3 4
      _Bool

# 73 "/home/ca99c52/lib/ino-map.c"
...
# 90 "/home/ca99c52/lib/ino-map.c" 3 4
                                                            ((void *)0)
# 90 "/home/ca99c52/lib/ino-map.c"
                                                                ,
      ...
      if (! im->map)
        {
          free (im);
          return 
# 95 "/home/ca99c52/lib/ino-map.c" 3 4
                ((void *)0)
# 95 "/home/ca99c52/lib/ino-map.c"
                    ;
        }
      im->next_mapped_ino = next_mapped_ino;
      im->probe = 
# 98 "/home/ca99c52/lib/ino-map.c" 3 4
                 ((void *)0)
# 98 "/home/ca99c52/lib/ino-map.c"
                     ;
    }
...
ino_map_insert (struct ino_map *im, ino_t ino)
{
  ...
  if (ent != probe)
  ...
  else
    {
      ...
      im->probe = 
# 157 "/home/ca99c52/lib/ino-map.c" 3 4
                 ((void *)0)
# 157 "/home/ca99c52/lib/ino-map.c"
                     ;
