# 1 "/home/ca99c52/lib/cycle-check.c"
# 1 "/home/ca99c52//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/lib/cycle-check.c"
# 20 "/home/ca99c52/lib/cycle-check.c"
# 1 "./lib/config.h" 1
# 21 "/home/ca99c52/lib/cycle-check.c" 2
...
# 25 "/home/ca99c52/lib/cycle-check.h" 2
...
# 27 "/home/ca99c52/lib/cycle-check.h" 2
...
# 23 "/home/ca99c52/lib/cycle-check.c" 2

# 1 "./lib/sys/types.h" 1
# 20 "./lib/sys/types.h"
       
# 21 "./lib/sys/types.h" 3
# 25 "/home/ca99c52/lib/cycle-check.c" 2
# 1 "./lib/sys/stat.h" 1
# 25 "./lib/sys/stat.h"
       
# 26 "./lib/sys/stat.h" 3
# 26 "/home/ca99c52/lib/cycle-check.c" 2
# 1 "./lib/stdio.h" 1
# 20 "./lib/stdio.h"
...
extern int _gl_cxxalias_dummy;
# 27 "/home/ca99c52/lib/cycle-check.c" 2
# 1 "./lib/stdlib.h" 1
# 20 "./lib/stdlib.h"
...
extern int _gl_cxxalias_dummy;
# 28 "/home/ca99c52/lib/cycle-check.c" 2
...
# 31 "/home/ca99c52/lib/cycle-check.c" 2
...
# 36 "/home/ca99c52/lib/cycle-check.c"
static 
# 36 "/home/ca99c52/lib/cycle-check.c" 3 4
      _Bool

# 37 "/home/ca99c52/lib/cycle-check.c"
...
# 57 "/home/ca99c52/lib/cycle-check.c"

# 57 "/home/ca99c52/lib/cycle-check.c" 3 4
_Bool

# 58 "/home/ca99c52/lib/cycle-check.c"
cycle_check (struct cycle_check_state *state, struct stat const *sb)
{
  
# 60 "/home/ca99c52/lib/cycle-check.c" 3 4
 ((void) sizeof ((
# 60 "/home/ca99c52/lib/cycle-check.c"
 state->magic == 9827862
# 60 "/home/ca99c52/lib/cycle-check.c" 3 4
...
# 60 "/home/ca99c52/lib/cycle-check.c"
 "state->magic == 9827862"
# 60 "/home/ca99c52/lib/cycle-check.c" 3 4
 , "/home/ca99c52/lib/cycle-check.c", 60, __extension__ __PRETTY_FUNCTION__); }))
# 60 "/home/ca99c52/lib/cycle-check.c"
                                  ;
  ...
  if (state->chdir_counter && ((*sb).st_ino == (state->dev_ino).st_ino && (*sb).st_dev == (state->dev_ino).st_dev))
    return 
# 66 "/home/ca99c52/lib/cycle-check.c" 3 4
          1
# 66 "/home/ca99c52/lib/cycle-check.c"
              ;
  ...
  if (is_zero_or_power_of_two (++(state->chdir_counter)))
    {
      ...
      if (state->chdir_counter == 0)
        return 
# 78 "/home/ca99c52/lib/cycle-check.c" 3 4
              1
# 78 "/home/ca99c52/lib/cycle-check.c"
                  ;
  ...
  return 
# 84 "/home/ca99c52/lib/cycle-check.c" 3 4
        0
# 84 "/home/ca99c52/lib/cycle-check.c"
             ;
}
