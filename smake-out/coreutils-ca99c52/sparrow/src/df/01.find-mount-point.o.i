# 1 "/home/ca99c52/src/find-mount-point.c"
# 1 "/home/ca99c52//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/src/find-mount-point.c"
# 17 "/home/ca99c52/src/find-mount-point.c"
# 1 "./lib/config.h" 1
# 18 "/home/ca99c52/src/find-mount-point.c" 2
# 1 "./lib/sys/types.h" 1
# 20 "./lib/sys/types.h"
...
# 29 "./lib/sys/types.h" 2 3
# 19 "/home/ca99c52/src/find-mount-point.c" 2
...
# 21 "/home/ca99c52/src/find-mount-point.c" 2
...
# 22 "/home/ca99c52/src/find-mount-point.c" 2
...
# 24 "/home/ca99c52/src/find-mount-point.c" 2
# 1 "./lib/xgetcwd.h" 1
# 17 "./lib/xgetcwd.h"
extern char *xgetcwd (void);
# 25 "/home/ca99c52/src/find-mount-point.c" 2
...
# 26 "/home/ca99c52/src/find-mount-point.c" 2
...
find_mount_point (char const *file, struct stat const *file_stat)
{
  ...
  char *mp = 
# 36 "/home/ca99c52/src/find-mount-point.c" 3 4
            ((void *)0)
# 36 "/home/ca99c52/src/find-mount-point.c"
                ;

  if (save_cwd (&cwd) != 0)
    {
      error (0, 
# 40 "/home/ca99c52/src/find-mount-point.c" 3 4
               (*__errno_location ())
# 40 "/home/ca99c52/src/find-mount-point.c"
                    , gettext ("cannot get current directory"));
      return 
# 41 "/home/ca99c52/src/find-mount-point.c" 3 4
            ((void *)0)
# 41 "/home/ca99c52/src/find-mount-point.c"
                ;
    }

  if (
# 44 "/home/ca99c52/src/find-mount-point.c" 3 4
     ((((
# 44 "/home/ca99c52/src/find-mount-point.c"
     file_stat->st_mode
# 44 "/home/ca99c52/src/find-mount-point.c" 3 4
     )) & 0170000) == (0040000))
# 44 "/home/ca99c52/src/find-mount-point.c"
...

    {
      ...
      if (chdir (file) < 0)
        {
          error (0, 
# 50 "/home/ca99c52/src/find-mount-point.c" 3 4
                   (*__errno_location ())
# 50 "/home/ca99c52/src/find-mount-point.c"
                        , gettext ("cannot change to directory %s"), quotearg_style (shell_escape_always_quoting_style, file));
          return 
# 51 "/home/ca99c52/src/find-mount-point.c" 3 4
                ((void *)0)
# 51 "/home/ca99c52/src/find-mount-point.c"
                    ;
        }
    }
  else

    {
      ...
      char *dir;
      do { dir = 
# 59 "/home/ca99c52/src/find-mount-point.c" 3 4
     (__extension__ ({ const char *__old = (
# 59 "/home/ca99c52/src/find-mount-point.c"
     xdir
# 59 "/home/ca99c52/src/find-mount-point.c" 3 4
...
# 59 "/home/ca99c52/src/find-mount-point.c"
     ; } while (0);
      ...
      if (chdir (dir) < 0)
        {
          error (0, 
# 64 "/home/ca99c52/src/find-mount-point.c" 3 4
                   (*__errno_location ())
# 64 "/home/ca99c52/src/find-mount-point.c"
                        , gettext ("cannot change to directory %s"), quotearg_style (shell_escape_always_quoting_style, dir));
          return 
# 65 "/home/ca99c52/src/find-mount-point.c" 3 4
                ((void *)0)
# 65 "/home/ca99c52/src/find-mount-point.c"
                    ;
        }
      ...
      if (stat (".", &last_stat) < 0)
        {
          error (0, 
# 70 "/home/ca99c52/src/find-mount-point.c" 3 4
                   (*__errno_location ())
# 70 "/home/ca99c52/src/find-mount-point.c"
                        , gettext ("cannot stat current directory (now %s)"),
  ...
  while (
# 79 "/home/ca99c52/src/find-mount-point.c" 3 4
        1
# 79 "/home/ca99c52/src/find-mount-point.c"
            )
    {
      struct stat st;
      if (stat ("..", &st) < 0)
        {
          error (0, 
# 84 "/home/ca99c52/src/find-mount-point.c" 3 4
                   (*__errno_location ())
# 84 "/home/ca99c52/src/find-mount-point.c"
      ...
      if (chdir ("..") < 0)
        {
          error (0, 
# 92 "/home/ca99c52/src/find-mount-point.c" 3 4
                   (*__errno_location ())
# 92 "/home/ca99c52/src/find-mount-point.c"
                        , gettext ("cannot change to directory %s"), quotearg_style (shell_escape_always_quoting_style, ".."));
          goto done;
        }
      last_stat = st;
    }
  ...
  {
    int save_errno = 
# 104 "/home/ca99c52/src/find-mount-point.c" 3 4
                    (*__errno_location ())
# 104 "/home/ca99c52/src/find-mount-point.c"
                         ;
    if (restore_cwd (&cwd) != 0)
      ((!!sizeof (struct { _Static_assert (
# 106 "/home/ca99c52/src/find-mount-point.c" 3 4
     1
# 106 "/home/ca99c52/src/find-mount-point.c"
     , "verify_expr (" "1" ", " "(error (1, (*__errno_location ()), gettext (\"failed to return to initial working directory\")), assume (false))" ")"); int _gl_dummy; })) ? ((error (
# 106 "/home/ca99c52/src/find-mount-point.c" 3 4
     1
# 106 "/home/ca99c52/src/find-mount-point.c"
     , 
...
# 109 "/home/ca99c52/src/find-mount-point.c" 3 4
   (*__errno_location ()) 
# 109 "/home/ca99c52/src/find-mount-point.c"
         = save_errno;
  }
