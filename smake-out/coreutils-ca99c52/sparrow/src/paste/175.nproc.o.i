...
# 32 "<command-line>" 2
# 1 "/home/ca99c52/lib/nproc.c"
# 20 "/home/ca99c52/lib/nproc.c"
# 1 "./lib/config.h" 1
# 21 "/home/ca99c52/lib/nproc.c" 2
# 1 "/home/ca99c52/lib/nproc.h" 1
# 32 "/home/ca99c52/lib/nproc.h"
enum nproc_query
{
  NPROC_ALL,
  NPROC_CURRENT,
...
# 21 "./lib/sys/types.h" 3
# 35 "/home/ca99c52/lib/nproc.c" 2
# 45 "/home/ca99c52/lib/nproc.c"
    ...
    if (sched_getaffinity (0, sizeof (set), &set) == 0)
      {
        ...
        count = 
# 134 "/home/ca99c52/lib/nproc.c" 3 4
               __sched_cpucount (sizeof (cpu_set_t), 
# 134 "/home/ca99c52/lib/nproc.c"
               &set
# 134 "/home/ca99c52/lib/nproc.c" 3 4
               )
# 134 "/home/ca99c52/lib/nproc.c"
                               ;
# 143 "/home/ca99c52/lib/nproc.c"
        if (count > 0)
          return count;
      }
  }
# 196 "/home/ca99c52/lib/nproc.c"
  return 0;
}
  ...
  if (query == NPROC_CURRENT_OVERRIDABLE)
    {
      ...
      if (envvalue != 
# 210 "/home/ca99c52/lib/nproc.c" 3 4
                     ((void *)0)
# 210 "/home/ca99c52/lib/nproc.c"
                         )
        {
          ...
          if (c_isdigit (*envvalue))
            {
              char *endptr = 
# 217 "/home/ca99c52/lib/nproc.c" 3 4
                            ((void *)0)
# 217 "/home/ca99c52/lib/nproc.c"
                                ;
              unsigned long int value = strtoul (envvalue, &endptr, 10);

              if (endptr != 
# 220 "/home/ca99c52/lib/nproc.c" 3 4
                           ((void *)0)
# 220 "/home/ca99c52/lib/nproc.c"
                               )
                {
  ...
  if (query == NPROC_CURRENT)
    {
...

      {
        ...
        long int nprocs = sysconf (
# 261 "/home/ca99c52/lib/nproc.c" 3 4
                                  _SC_NPROCESSORS_ONLN
# 261 "/home/ca99c52/lib/nproc.c"
                                                      );
        if (nprocs > 0)
          return nprocs;
      }
  ...
  else
    {

      {
        ...
        long int nprocs = sysconf (
# 272 "/home/ca99c52/lib/nproc.c" 3 4
                                  _SC_NPROCESSORS_CONF
# 272 "/home/ca99c52/lib/nproc.c"
                                                      );
