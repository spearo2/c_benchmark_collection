# 1 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
# 21 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
# 22 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
...
# 23 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
...
void dumpBuffer(unsigned char *buf, int length);
# 25 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/decompile.h" 1
# 31 "/doner/libming/libming-ming-0_4_6/util/decompile.h"
struct _stack;
...
# 26 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/swfoutput.h" 1
# 25 "/doner/libming/libming-ming-0_4_6/util/swfoutput.h"
...
# 1 "/doner/libming/libming-ming-0_4_6/util/outputdecl.h" 1
# 22 "/doner/libming/libming-ming-0_4_6/util/outputdecl.h"
...
# 32 "/doner/libming/libming-ming-0_4_6/util/swfoutput.h" 2
# 27 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
# 1 "../src/abctypes.h" 1
# 23 "../src/abctypes.h"
typedef enum {
 __add = 0xa0,
...
# 28 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 31 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2
...
# 32 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 2


# 33 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
extern const char *blockName (SWFBlocktype header);

extern int verbose;

extern struct Movie m;
# 46 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
# 143 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
__builtin_va_start(
# 143 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
ap
# 143 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
,
# 143 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
# 226 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
void
...
{
# 305 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
{
# 351 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
  ++INDENT;
...
# 576 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
                                    ((void *)0)
# 576 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                                        )
      outputSWF_LINESTYLE (&(linestylearray->LineStyles[i]),"",0);
    else if(linestylearray->LineStyles2 != 
# 578 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
                                          ((void *)0)
# 578 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                                              )
...
outputSWF_MORPHLINESTYLES (SWF_MORPHLINESTYLES * linestylearray)
{
  ...
  {
    if(linestylearray->LineStyles != 
# 636 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
                                    ((void *)0)
# 636 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                                        )
      outputSWF_MORPHLINESTYLE (&(linestylearray->LineStyles[i]),"");
    else if(linestylearray->LineStyles2 != 
# 638 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
                                          ((void *)0)
# 638 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                                              )
...
# 998 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
# 1540 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
                                                        ((void *)0)
# 1540 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                                                            );
  }
  --INDENT;
...
# 1795 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
...
# 1848 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
  if( sblock->PlaceFlagHasClipActions )
 outputSWF_CLIPACTIONS (&(sblock->ClipActions));
...
outputSWF_UNKNOWNBLOCK(SWF_Parserstruct *pblock)
{
  ...
  if(sblock->Data == 
# 2868 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
                    ((void *)0)
# 2868 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                        )
 return;
...
outputBlock (int type, SWF_Parserstruct * blockp, FILE* stream)
{
  ...
  if(blockp == 
# 2907 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c" 3 4
              ((void *)0)
# 2907 "/doner/libming/libming-ming-0_4_6/util/outputtxt.c"
                  )
 return;
