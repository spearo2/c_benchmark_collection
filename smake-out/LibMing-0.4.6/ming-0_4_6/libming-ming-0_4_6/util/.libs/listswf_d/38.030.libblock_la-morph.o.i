# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c" 2

# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.h"
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.h" 2
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c" 2
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c" 2
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c" 2
...
void SWFOutput_writeMorphLineStyles2(SWFOutput out,
                SWFLineStyle *lines1, int nLines1,
                SWFLineStyle *lines2, int nLines2);
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c" 2
...
completeSWFMorphBlock(SWFBlock block)
{
 ...
 if(shape_version != SWFShape_getVersion(shape2))
  do { if(_SWF_error) _SWF_error(("SWFMorph: shape versions must match\n")); } while(0);

 if(shape_version == 4)
  ((SWFBlock)(morph))->type = SWF_DEFINEMORPHSHAPE2;


 SWFOutput_writeUInt16(out, (((SWFCharacter)(morph))->id));
 SWFOutput_writeRect(out, ((SWFCharacter)(shape1))->bounds);
 SWFOutput_byteAlign(out);
 SWFOutput_writeRect(out, ((SWFCharacter)(shape2))->bounds);
 SWFOutput_byteAlign(out);
 ...
 if(shape_version == 4)
 {
  ...
  if(flags != SWFShape_getFlags(shape2))
   do { if(_SWF_warn) _SWF_warn(("SWFMorph: shape flags do not match. Using flags of first shape\n")); } while(0);

  SWFOutput_writeUInt8(out, flags);
 }

 patch = SWFOutput_getCurPos(out);
 SWFOutput_writeUInt32(out, 0);
...
# 159 "/doner/libming/libming-ming-0_4_6/src/blocks/morph.c"
 free(morph);
}
...
newSWFMorphShape()
{
 ...
 ((SWFBlock)(morph))->type = SWF_DEFINEMORPHSHAPE;
 ((SWFBlock)(morph))->writeBlock = writeSWFMorphBlockToStream;
 ((SWFBlock)(morph))->complete = completeSWFMorphBlock;
 ((SWFBlock)(morph))->dtor = (destroySWFBlockMethod) destroySWFMorph;

 (((SWFCharacter)(morph))->id) = ++SWF_gNumCharacters;

 morph->out = newSWFOutput();

 morph->shape1 = newSWFShape();
 ((SWFBlock)(morph->shape1))->type = SWF_END;

 morph->shape2 = newSWFShape();
 ((SWFBlock)(morph->shape2))->type = SWF_END;
