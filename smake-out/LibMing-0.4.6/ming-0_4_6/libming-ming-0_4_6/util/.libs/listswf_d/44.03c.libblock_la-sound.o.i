# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2

# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/outputblock.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/outputblock.h"
# 1 "../../src/ming.h" 1
# 56 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/outputblock.h" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 30 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 31 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 2
...
{
 if ((sound->flags&0xf0) == (0<<4) ||
   (sound->flags&0xf0) == (3<<4))
 {
  int sampleCount = SWFInput_length(sound->input);

  if ((sound->flags & 0x02) == (1<<1))
   sampleCount /= 2;

  if ((sound->flags & 0x01) == (1<<0))
   sampleCount /= 2;

  return sampleCount;
 }
 else if ((sound->flags&0xf0) == (1<<4))
 {
  int filesize, channels, nbits;
  int bitsize, blocksize, n, res, m;

  if ( !((sound->flags & 0x02) == (1<<1)) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "(sound->flags & 0x02) == (1<<1)", "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c",72); } while(0);;

  filesize = SWFInput_length(sound->input);

  if ((sound->flags&0x01) == (0<<0))
   channels = 1;
  else if ((sound->flags & 0x01) == (1<<0))
   channels = 2;
  else
   channels = 1;
 ...
 else if ((sound->flags&0xf0) == (2<<4))
 {
  int pos = SWFInput_tell(sound->input);
  int samples = -1;
  getMP3Samples(sound->input, sound->flags, &samples);
  SWFInput_seek(sound->input, pos, 
# 102 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 3 4
                                  0
# 102 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
                                          );
  return samples;
 }
 else
 {
  do { if(_SWF_warn) _SWF_warn(("SWFSound: can't determine sampleCount\n")); } while(0);
  return 0;
 }
}
...
writeSWFSoundToStream(SWFBlock block, SWFByteOutputMethod method, void *data)
{
 ...
 methodWriteUInt16((((SWFCharacter)(sound))->id), method, data);
...
# 177 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
void
...
# 217 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
SWFSound
...
newSWFSound_fromInput(SWFInput input, byte flags)
{
 ...
 (((SWFCharacter)(sound))->id) = ++SWF_gNumCharacters;
 ...
 if((sound->flags&0xf0) == (2<<4))
 {
  if(getMP3Flags(input, &sound->flags) < 0)
  {
   free(sound);
   return 
# 258 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c" 3 4
         ((void *)0)
# 258 "/doner/libming/libming-ming-0_4_6/src/blocks/sound.c"
             ;
  }
 }
 sound->soundStream = 0;
 sound->seekSamples = 1663;
 sound->freeInput = ((BOOL)0);
 return sound;
}
