# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
# 1 "../../src/libming.h" 1
# 32 "../../src/libming.h"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 2
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 2
...
# 105 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
int readMP3Header(SWFInput input, struct mp3_header *mp3h)
{
 int frameSync, br, sr;
 ...
 SWFInput_readBits(input, 3);
 do { if(SWFInput_eof(input)) return 0; } while(0);;
 SWFInput_byteAlign(input);
 if((frameSync & 0x7ff) != 0x7ff)
 {
  SWFInput_seek(input, -4, 
# 134 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 3 4
                          1
# 134 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
                                  );
  return -1;
 }
 ...
 {
  SWFInput_seek(input, -4, 
# 140 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 3 4
                          1
# 140 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
                                  );
  return -1;
 }
 return 1;
...
int nextMP3Frame(SWFInput input)
{
 ...
 if(mp3h.samplingRate == 0 || mp3h.bitrate == 0)
  do { if(_SWF_error) _SWF_error(("invalid mp3 file\n")); } while(0);
 if(mp3h.version == 3)
 {
 ...
 SWFInput_seek(input, frameLen-4, 
# 170 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 3 4
                                 1
# 170 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
                                         );
 return frameLen;
}
...
# 189 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 3 4
                         1
# 189 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
                                 );
  start++;
 }
 ...
 SWFInput_seek(input, start, 
# 196 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 3 4
                            0
# 196 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
                                    );
 if (mp3h.channelMode == 3 )
  channels = (0<<0);
 else
  channels = (1<<0);
 ...
 *flags =
  (2<<4) | rate | (1<<1) | channels;
 return start;
}
# 229 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
int getMP3Samples(SWFInput input, int flags, int *wanted)
{
...
unsigned int getMP3Duration(SWFInput input)
{
 ...
 SWFInput_seek(input, start, 
# 278 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c" 3 4
                            0
# 278 "/doner/libming/libming-ming-0_4_6/src/blocks/mp3.c"
                                    );
