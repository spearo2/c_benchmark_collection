# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 2

# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.h"
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.h" 2
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 2
...
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 2
...
# 85 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
static int
...
skipJpegBlock(SWFInput input)
{
 ...
 SWFInput_seek(input, length-2, 
# 118 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
                               1
# 118 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
                                       );
...
methodWriteJpegFile(SWFInput input, SWFByteOutputMethod method, void *data)
{
 ...
 if ( (c = SWFInput_getChar(input)) != 0xFF )
  do { if(_SWF_error) _SWF_error(("Initial Jpeg marker not found!")); } while(0);

 if ( (c = SWFInput_getChar(input)) != 0xD8 )
  do { if(_SWF_error) _SWF_error(("Jpeg SOI not found!")); } while(0);
# 144 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
 method(0xFF, data);
 method(0xD8, data);

 for ( ;; )
 {
  if ( SWFInput_getChar(input) != 0xFF )
   do { if(_SWF_error) _SWF_error(("Jpeg marker not found where expected!")); } while(0);

  switch ( c = SWFInput_getChar(input) )
  {
   case 0xD9:
    do { if(_SWF_error) _SWF_error(("Unexpected end of Jpeg file (EOI found)!")); } while(0);
   ...
   case 0xC1:
   case 0xC2:
# 182 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
    dumpJpegBlock((unsigned char)c, input, method, data);
    break;
  ...
  if ( SWFInput_eof(input) )
   do { if(_SWF_error) _SWF_error(("Unexpected end of Jpeg file (EOF found)!")); } while(0);
 }

 if ( c != 0xDA )
  do { if(_SWF_error) _SWF_error(("SOS block not found in Jpeg file!")); } while(0);


 method(0xFF, data);
 method((unsigned char)c, data);

 while ( (c = SWFInput_getChar(input)) != 
# 211 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
                                         (-1) 
# 211 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
                                             )
  method((unsigned char)c, data);
}
...
writeSWFJpegBitmapToMethod(SWFBlock block, SWFByteOutputMethod method, void *data)
{
 ...
 methodWriteUInt16((((SWFCharacter)(jpeg))->id), method, data);
...
writeSWFJpegWithAlphaToMethod(SWFBlock block, SWFByteOutputMethod method, void *data)
{
 ...
 while ( (c = SWFInput_getChar(jpeg->alpha)) != 
# 240 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
                                               (-1) 
# 240 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
                                                   )
  method((unsigned char)c, data);
}
...
{
 free(((SWFCharacter)(jpegBitmap))->bounds);
...
scanJpegFile(SWFInput input)
{
 ...
 if (
# 272 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 272 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == info)
  return 
# 273 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 273 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;
 ...
 if ( SWFInput_getChar(input) != 0xD8 )
  do { if(_SWF_error) _SWF_error(("Jpeg SOI not found!")); } while(0);
 ...
 for ( ;; )
 {
  ...
  switch ( c = SWFInput_getChar(input) )
  {
   ...
   case 0xC2:
    do { if(_SWF_error) _SWF_error(("Only baseline (frame 0) jpegs are supported!")); } while(0);

   case 0xC0:
   case 0xC1:
# 320 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
    ...
    SWFInput_seek(input, l, 
# 328 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
                           1
# 328 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
                                   );
...
# 360 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
                        2
# 360 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
                                );
...
newSWFJpegBitmap_fromInput(SWFInput input)
{
 ...
 if (
# 381 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 381 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == jpeg)
  return 
# 382 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 382 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;

 SWFCharacterInit((SWFCharacter)jpeg);

 (((SWFCharacter)(jpeg))->id) = ++SWF_gNumCharacters;

 ((SWFBlock)(jpeg))->writeBlock = writeSWFJpegBitmapToMethod;
 ((SWFBlock)(jpeg))->complete = completeSWFJpegBitmap;
 ((SWFBlock)(jpeg))->dtor = (destroySWFBlockMethod) destroySWFJpegBitmap;
 ((SWFBlock)(jpeg))->type = SWF_DEFINEBITSJPEG2;
 ...
 if (
# 398 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 398 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == info)
 {
  free (jpeg);
  return 
# 401 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 401 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;
 }
 ...
 if (
# 407 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 407 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == temp_rect)
 {
  free(info);
  free(jpeg);
  return 
# 411 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 411 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;
 }

 ((SWFCharacter)(jpeg))->bounds = temp_rect;
...
newSWFJpegBitmap(FILE *f)
{
 ...
 if (
# 441 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 441 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == jpeg)
  return 
# 442 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 442 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;

 ((SWFBlock)(jpeg))->dtor = (destroySWFBlockMethod) destroySWFJpegBitmap_andInputs;
 return jpeg;
}
...
newSWFJpegWithAlpha_fromInput(SWFInput input, SWFInput alpha)
{
 ...
 if (
# 462 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 462 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == jpeg)
  return 
# 463 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 463 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;
 ...
 ((SWFBlock)(jpeg))->writeBlock = writeSWFJpegWithAlphaToMethod;
 ((SWFBlock)(jpeg))->complete = completeSWFJpegBitmap;
 ((SWFBlock)(jpeg))->dtor = (destroySWFBlockMethod) destroySWFJpegBitmap;
 ((SWFBlock)(jpeg))->type = SWF_DEFINEBITSJPEG3;
 ...
 if (
# 480 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 480 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == info)
 {
  free (jpeg);
  return 
# 483 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 483 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;
 }
 ...
 if (
# 489 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 489 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == temp_rect)
 {
  free(info);
  free(jpeg);
  return 
# 493 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 493 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;
 }
 ...
 if ( (alen = SWFInput_length(alpha)) == -1 )
  do { if(_SWF_error) _SWF_error(("couldn't get alpha file length!")); } while(0);
...
newSWFJpegWithAlpha(FILE *f, FILE *alpha)
{
 ...
 if (
# 529 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
    ((void *)0) 
# 529 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
         == jpeg)
  return 
# 530 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c" 3 4
        ((void *)0)
# 530 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.c"
            ;

 ((SWFBlock)(jpeg))->dtor = (destroySWFBlockMethod) destroySWFJpegAlpha_andInputs;
 return jpeg;
}
