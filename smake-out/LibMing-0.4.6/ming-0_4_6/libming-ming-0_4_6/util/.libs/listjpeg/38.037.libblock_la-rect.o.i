# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c" 2

# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.h"
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.h" 2
# 1 "../../src/libming.h" 1
# 33 "../../src/libming.h"
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c" 2


int
SWFRect_numBits(SWFRect rect)
{
 return 5 + 4*((((((SWFOutput_numSBits(rect->minX))>(SWFOutput_numSBits(rect->maxX)))?(SWFOutput_numSBits(rect->minX)):(SWFOutput_numSBits(rect->maxX))))>((((SWFOutput_numSBits(rect->minY))>(SWFOutput_numSBits(rect->maxY)))?(SWFOutput_numSBits(rect->minY)):(SWFOutput_numSBits(rect->maxY)))))?((((SWFOutput_numSBits(rect->minX))>(SWFOutput_numSBits(rect->maxX)))?(SWFOutput_numSBits(rect->minX)):(SWFOutput_numSBits(rect->maxX)))):((((SWFOutput_numSBits(rect->minY))>(SWFOutput_numSBits(rect->maxY)))?(SWFOutput_numSBits(rect->minY)):(SWFOutput_numSBits(rect->maxY)))))
...
{
 int nBits = ((((((SWFOutput_numSBits(rect->minX))>(SWFOutput_numSBits(rect->maxX)))?(SWFOutput_numSBits(rect->minX)):(SWFOutput_numSBits(rect->maxX))))>((((SWFOutput_numSBits(rect->minY))>(SWFOutput_numSBits(rect->maxY)))?(SWFOutput_numSBits(rect->minY)):(SWFOutput_numSBits(rect->maxY)))))?((((SWFOutput_numSBits(rect->minX))>(SWFOutput_numSBits(rect->maxX)))?(SWFOutput_numSBits(rect->minX)):(SWFOutput_numSBits(rect->maxX)))):((((SWFOutput_numSBits(rect->minY))>(SWFOutput_numSBits(rect->maxY)))?(SWFOutput_numSBits(rect->minY)):(SWFOutput_numSBits(rect->maxY)))))


                                     ;

 if(nBits>=32)
  do { if(_SWF_error) _SWF_error(("SWFRect too large for file format")); } while(0);
...
newSWFRect(int minX, int maxX, int minY, int maxY)
{
 ...
 if (
# 70 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c" 3 4
    ((void *)0) 
# 70 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c"
         == rect)
  return 
# 71 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c" 3 4
        ((void *)0)
# 71 "/doner/libming/libming-ming-0_4_6/src/blocks/rect.c"
            ;

 rect->minX = (((minX)<(maxX))?(minX):(maxX));
 rect->maxX = (((minX)>(maxX))?(minX):(maxX));
 rect->minY = (((minY)<(maxY))?(minY):(maxY));
 rect->maxY = (((minY)>(maxY))?(minY):(maxY));
