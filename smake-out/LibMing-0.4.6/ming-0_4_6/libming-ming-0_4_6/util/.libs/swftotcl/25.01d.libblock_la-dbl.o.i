# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.h"
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.h" 2
...
# 34 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.h" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 2
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 2


# 1 "../../src/ming_config.h" 1
# 31 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 2
             ...
             SWFByteOutputMethod method, void *data)
{
 ...
 methodWriteUInt16((((SWFCharacter)(dbl))->id), method, data);
...
newSWFDBLBitmap_fromInput(SWFInput input)
{
 ...
 if (
# 72 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
    ((void *)0) 
# 72 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
         == dbl)
  return 
# 73 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
        ((void *)0)
# 73 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
            ;

 SWFCharacterInit((SWFCharacter)dbl);

 (((SWFCharacter)(dbl))->id) = ++SWF_gNumCharacters;

 ((SWFBlock)(dbl))->writeBlock = writeSWFDBLBitmapToMethod;
 ((SWFBlock)(dbl))->complete = completeSWFDBLBitmap;
 ((SWFBlock)(dbl))->dtor = (destroySWFBlockMethod) destroySWFCharacter;
 ...
 {
  do { if(_SWF_error) _SWF_error(("File is not a DBL file!")); } while(0);
 }
 ...
 {
  case 1:
   ((SWFBlock)(dbl))->type = SWF_DEFINELOSSLESS;
   break;
  case 2:
   ((SWFBlock)(dbl))->type = SWF_DEFINELOSSLESS2;
   break;
  default:
   do { if(_SWF_error) _SWF_error(("Unexpected DBL type byte!")); } while(0);
 }

 if ( version == 'l' )
 {
  ((SWFBlock)(dbl))->length = SWFInput_getUInt32_BE(input);
  ((SWFBlock)(dbl))->length += 2;
 }
 else
 {


  ((SWFBlock)(dbl))->length = SWFInput_getUInt16_BE(input);
  ((SWFBlock)(dbl))->length += 2;
 }
 ...
 SWFInput_seek(input, -5, 
# 127 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
                         1
# 127 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
                                 );

 ((SWFCharacter)(dbl))->bounds = newSWFRect(0, width, 0, height);
...
{
 if ( bitmap->data != 
# 158 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
                     ((void *)0) 
# 158 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
                          )
 {
  free(bitmap->data);
 }
...
newSWFDBLBitmapData_fromData(dblData data)
{
 ...
 if (
# 178 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
    ((void *)0) 
# 178 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
         == dbl)
  return 
# 179 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
        ((void *)0)
# 179 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
            ;
 ...
 ((SWFBlock)(dbl))->writeBlock = writeSWFDBLBitmapDataToMethod;
 ((SWFBlock)(dbl))->complete = completeSWFDBLBitmap;
 ((SWFBlock)(dbl))->dtor = (destroySWFBlockMethod) destroySWFDBLBitmapData;
 ...
 ((SWFBlock)(dbl))->length = data->length;
 ((SWFBlock)(dbl))->length += 7;
 if(dbl->format == 3)
  ((SWFBlock)(dbl))->length++;

 ((SWFCharacter)(dbl))->bounds = newSWFRect(0, dbl->width, 0, dbl->height);
...
{
 if ( bitmap->input != 
# 217 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
                      ((void *)0) 
# 217 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
                           )
...
newSWFDBLBitmap(FILE* f)
{
 ...
 SWFDBLBitmap dbl = 
# 231 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
                   ((void *)0)
# 231 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
                       ;


 if (
# 234 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
    ((void *)0) 
# 234 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
         == input)
  return 
# 235 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
        ((void *)0)
# 235 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
            ;
 ...
 if (
# 240 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
    ((void *)0) 
# 240 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
         == dbl)
  return 
# 241 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c" 3 4
        ((void *)0)
# 241 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.c"
            ;

 ((SWFBlock)(dbl))->dtor = (destroySWFBlockMethod) destroySWFDBLBitmap_andInputs;
 return dbl;
}
