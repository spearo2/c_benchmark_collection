# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.h" 1
# 34 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.h"
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c" 2
...
# 69 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
void SWFGradient_setSpreadMode(SWFGradient gradient, GradientSpreadMode mode)
{
...
# 92 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
void SWFGradient_setFocalPoint(SWFGradient gradient, float focalPoint)
{
...
# 125 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
void
...
SWFOutput_writeGradientAsFilter(SWFOutput out, SWFGradient gradient)
{
 ...
 if(nGrads > 8)
 {
  do { if(_SWF_warn) _SWF_warn(("Can't write more than 8 control points for filter gradients\n")); } while(0);
  nGrads = 8;
 }

 SWFOutput_writeUInt8(out, nGrads);
...
SWFGradientMatrix_update(SWFMatrix matrix, SWFRect bounds)
{
 ...
 SWFMatrix tmp;
 if(bounds == 
# 178 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c" 3 4
             ((void *)0)
# 178 "/doner/libming/libming-ming-0_4_6/src/blocks/gradient.c"
                 )
  return;
...
{
 int i;
 int nGrads = ((((((gradient1->nGrads)<(gradient2->nGrads))?(gradient1->nGrads):(gradient2->nGrads)))<(8))?((((gradient1->nGrads)<(gradient2->nGrads))?(gradient1->nGrads):(gradient2->nGrads))):(8));
