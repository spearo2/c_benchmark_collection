# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/float.h" 1 3 4
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
...
# 30 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
# 1 "../../src/libming.h" 1
# 35 "../../src/libming.h"
# 1 "../../src/ming.h" 1
# 36 "../../src/libming.h" 2
...
# 31 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.h" 1
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.h"
...
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 2
...
newSWFMatrix(double a, double b, double c, double d, int x, int y)
{
 ...
 if (
# 45 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 3 4
    ((void *)0) 
# 45 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
         == m)
  return 
# 46 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 3 4
        ((void *)0)
# 46 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
            ;
...
SWFMatrix_dup(SWFMatrix matrix)
{
 ...
 if (
# 137 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 3 4
    ((void *)0) 
# 137 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
         == m)
  return 
# 138 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 3 4
        ((void *)0)
# 138 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
            ;
...
SWFMatrix_numBits(SWFMatrix matrix)
{
 ...
 {
  bits += 5 + 2*(((SWFOutput_numSBits((int)matrix->scaleX))>(SWFOutput_numSBits((int)matrix->scaleY)))?(SWFOutput_numSBits((int)matrix->scaleX)):(SWFOutput_numSBits((int)matrix->scaleY)))
                                             ;
 }

 if ( matrix->rotate0 != 0 || matrix->rotate1 != 0 )
 {
  bits += 5 + 2*(((SWFOutput_numSBits((int)matrix->rotate0))>(SWFOutput_numSBits((int)matrix->rotate1)))?(SWFOutput_numSBits((int)matrix->rotate0)):(SWFOutput_numSBits((int)matrix->rotate1)))
                                              ;
 }

 if ( matrix->translateX != 0 || matrix->translateY != 0 )
 {
  bits += 2*(((SWFOutput_numSBits(matrix->translateX))>(SWFOutput_numSBits(matrix->translateY)))?(SWFOutput_numSBits(matrix->translateX)):(SWFOutput_numSBits(matrix->translateY)))
                                          ;
 }
...
SWFOutput_writeMatrix(SWFOutput out, SWFMatrix matrix)
{
 ...
 {
  int xScale = (int)floor(matrix->scaleX * (1<<16));
  int yScale = (int)floor(matrix->scaleY * (1<<16));

  SWFOutput_writeBits(out, 1, 1);
  nBits = (((SWFOutput_numSBits(xScale))>(SWFOutput_numSBits(yScale)))?(SWFOutput_numSBits(xScale)):(SWFOutput_numSBits(yScale)));
  if(nBits >= 32)
   do { if(_SWF_error) _SWF_error(("SWFMatrix_scale: number is to big. " " Requested %i bits\n"), nBits); } while(0)
                                    ;
 ...
 {
  int rot0 = (int)floor(matrix->rotate0 * (1<<16));
  int rot1 = (int)floor(matrix->rotate1 * (1<<16));

  SWFOutput_writeBits(out, 1, 1);
  nBits = (((SWFOutput_numSBits(rot0))>(SWFOutput_numSBits(rot1)))?(SWFOutput_numSBits(rot0)):(SWFOutput_numSBits(rot1)));
  if(nBits >= 32)
   do { if(_SWF_error) _SWF_error(("SWFMatrix_rotate: number is to big. " " Requested %i bits\n"), nBits); } while(0)
                                    ;
 ...
 if ( matrix->translateX != 0 || matrix->translateY != 0 )
 {
  nBits = (((SWFOutput_numSBits(matrix->translateX))>(SWFOutput_numSBits(matrix->translateY)))?(SWFOutput_numSBits(matrix->translateX)):(SWFOutput_numSBits(matrix->translateY)))
                                         ;

  if(nBits >= 32)
   do { if(_SWF_error) _SWF_error(("SWFMatrix_translate: number is to big. " " Requested %i bits\n"), nBits); } while(0)
                                    ;
 }
 else
  nBits = 0;
...
SWFMatrix_apply(SWFMatrix m, double *x, double *y, int xlate)
{
 ...
 if ( m == 
# 250 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 3 4
          ((void *)0) 
# 250 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
               )
  return;
...
{
 double r = degrees * 
# 299 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c" 3 4
                     3.14159265358979323846
# 299 "/doner/libming/libming-ming-0_4_6/src/blocks/matrix.c"
                         /180;
