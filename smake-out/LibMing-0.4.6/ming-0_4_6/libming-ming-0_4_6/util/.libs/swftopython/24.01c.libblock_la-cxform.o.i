# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.h"
# 1 "../../src/ming.h" 1
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.h" 2
...
# 34 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.h" 2
...
# 35 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.h" 2



void SWFOutput_writeCXform(SWFOutput out, SWFCXform cXform, SWFBlocktype shapetype);
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/cxform.c" 2
...
SWFOutput_writeCXform(SWFOutput out, SWFCXform cXform, SWFBlocktype type)
{
 ...
 if ( hasAdd )
 {
  nBits = (((nBits)>(SWFOutput_numSBits(cXform->rAdd)))?(nBits):(SWFOutput_numSBits(cXform->rAdd)));
  nBits = (((nBits)>(SWFOutput_numSBits(cXform->gAdd)))?(nBits):(SWFOutput_numSBits(cXform->gAdd)));
  nBits = (((nBits)>(SWFOutput_numSBits(cXform->bAdd)))?(nBits):(SWFOutput_numSBits(cXform->bAdd)));

  if ( type == SWF_PLACEOBJECT2 )
   nBits = (((nBits)>(SWFOutput_numSBits(cXform->aAdd)))?(nBits):(SWFOutput_numSBits(cXform->aAdd)));
 }

 if ( hasMult )
 {
  nBits = (((nBits)>(SWFOutput_numSBits(cXform->rMult)))?(nBits):(SWFOutput_numSBits(cXform->rMult)));
  nBits = (((nBits)>(SWFOutput_numSBits(cXform->gMult)))?(nBits):(SWFOutput_numSBits(cXform->gMult)));
  nBits = (((nBits)>(SWFOutput_numSBits(cXform->bMult)))?(nBits):(SWFOutput_numSBits(cXform->bMult)));

  if ( type == SWF_PLACEOBJECT2 )
   nBits = (((nBits)>(SWFOutput_numSBits(cXform->aMult)))?(nBits):(SWFOutput_numSBits(cXform->aMult)));
 }

 if ( nBits>=16 )
  do { if(_SWF_error) _SWF_error(("color transform data out of scale")); } while(0);
