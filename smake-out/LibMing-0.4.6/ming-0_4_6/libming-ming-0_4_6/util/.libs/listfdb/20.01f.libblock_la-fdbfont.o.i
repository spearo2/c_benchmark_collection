# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 30 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
# 34 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 35 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 2
...
{
 SWFInput_byteAlign(input);
 if ( (*numFillBits = SWFInput_readBits(input, 4)) != 1 )
  do { if(_SWF_error) _SWF_error(("FdbFont read glyph: bad file format (was expecting fill bits = 1)\n")); } while(0);

 if ( (*numLineBits = SWFInput_readBits(input, 4)) > 0 )
  do { if(_SWF_error) _SWF_error(("FdbFont read glyph: bad file format (was expecting line bits = 0)\n")); } while(0);
}
...
{
 if ( style & 1 )
  if ( SWFInput_readBits(input, numFillBits) != 0 )
   do { if(_SWF_warn) _SWF_warn(("SWFFont_getShape: bad file format (was expecting fill0 = 0)\n")); } while(0);
 if ( style & 2 )
  if ( SWFInput_readBits(input, numFillBits) != 1 )
   do { if(_SWF_warn) _SWF_warn(("SWFFont_getShape: bad file format (was expecting fill1 = 1)\n")); } while(0);
 if ( style & 4 )
  if ( SWFInput_readBits(input, numLineBits) != 0 )
   do { if(_SWF_warn) _SWF_warn(("SWFFont_getShape: bad file format (was expecting line = 0)\n")); } while(0);
}
...
static inline int readFontLayout(SWFInput input, SWFFont font)
{
 ...
 if ( font->kernCount > 0 )
 {
  ...
  font->kernTable.k = 
# 203 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 3 4
                     ((void *)0)
# 203 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
                         ;
...
static inline int checkFdbHeader(SWFInput input)
{
 ...
 if(f != 'f' || d != 'd' || b != 'b' || z != '0')
 {
  do { if(_SWF_warn) _SWF_warn(("loadSWFFont: not a fdb file\n")); } while(0);
  return -1;
 }
...
SWFFont loadSWFFontFromInput(SWFInput input)
{
 ...
 if(input == 
# 240 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 3 4
            ((void *)0)
# 240 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
                )
  return 
# 241 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 3 4
        ((void *)0)
# 241 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
            ;

 if(checkFdbHeader(input) < 0)
  return 
# 244 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 3 4
        ((void *)0)
# 244 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
            ;
 ...
 {
  for (i=0; i < nGlyphs; ++i)
   SWFInput_getUInt32(input);
  SWFInput_getUInt32(input);
 }
 else
 {
  for(i=0; i < nGlyphs; ++i)
   SWFInput_getUInt16(input);
  SWFInput_getUInt16(input);
 }
...
SWFFont loadSWFFont_fromFdbFile(FILE *file)
{
 ...
 SWFFont font;
 if ( file == 
# 301 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 3 4
             ((void *)0) 
# 301 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
                  )
  return 
# 302 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c" 3 4
        ((void *)0)
# 302 "/doner/libming/libming-ming-0_4_6/src/blocks/fdbfont.c"
            ;
