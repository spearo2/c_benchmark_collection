# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c"
# 19 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c"
...
# 20 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 2
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 21 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 2
...
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 2
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 2
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 2

static inline int isValidGridChar(SWFCharacter c)
{
 switch(((SWFBlock)(c))->type)
 {
  case SWF_DEFINEBUTTON:
  case SWF_DEFINEBUTTON2:
  case SWF_DEFINESPRITE:
...
newSWFScalingGrid(SWFCharacter c, int x, int y, int w, int h)
{
 ...
 {
  do { if(_SWF_warn) _SWF_warn(("ScalingGrid only available for buttons and sprites/movieclips\n")); } while(0);
  return 
# 76 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c" 3 4
        ((void *)0)
# 76 "/doner/libming/libming-ming-0_4_6/src/blocks/scalinggrid.c"
            ;
 }

 grid = (SWFScalingGrid)malloc(sizeof(struct SWFScalingGrid_s));

        SWFBlockInit(((SWFBlock)(grid)));
        ((SWFBlock)(grid))->type = SWF_DEFINESCALINGGRID;
        ((SWFBlock)(grid))->writeBlock = writeSWFScalingGridToMethod;
        ((SWFBlock)(grid))->complete = completeSWFScalingGrid;
        ((SWFBlock)(grid))->dtor = (destroySWFBlockMethod) destroySWFScalingGrid;
