# 1 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c"
...
# 8 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 2
...
# 9 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/../src/blocks/input.h" 1
# 13 "/doner/libming/libming-ming-0_4_6/util/../src/blocks/input.h"
# 1 "../src/ming.h" 1
# 56 "../src/ming.h"
...
# 14 "/doner/libming/libming-ming-0_4_6/util/../src/blocks/input.h" 2
...
# 10 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/../src/blocks/output.h" 1
# 34 "/doner/libming/libming-ming-0_4_6/util/../src/blocks/output.h"
...
# 11 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 1
# 33 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h"
...
# 34 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 2

# 1 "/doner/libming/libming-ming-0_4_6/util/../src/ming.h" 1
# 36 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/../src/ming_config.h" 1
# 37 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 2

# 1 "/doner/libming/libming-ming-0_4_6/util/../src/gc.h" 1
# 27 "/doner/libming/libming-ming-0_4_6/util/../src/gc.h"
...
# 39 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 2
# 1 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 1
# 40 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 2
...
# 75 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h"
...
# 76 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 2
# 98 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h"
...
PrintGifError(int UNUSED_errorCode __attribute__((__unused__)))
{
 ...
 fprintf(
# 108 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h" 3 4
        stderr
# 108 "/doner/libming/libming-ming-0_4_6/util/../src/libming.h"
              , "\nGIF-LIB error but no GifErrorString support.\n");

}
# 12 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 2
...
void writeADPCMData(short *samples, int stereo, int sample_count, SWFOutput output) {
  int nBits = 4;
  int iSignBit = 1 << (nBits-1);
  const int* piIndexTable = ppiIndexTables[nBits-2];

  int iValPred[2] = {0, 0};
  int iIndex[2] = {0, 0};
  int iStep[2] = {0, 0};

  int iSampleCount = sample_count;
  int iChannelCount = 1 + stereo;

  short* psSample = samples;
 ...
 SWFOutput_writeSBits(output, (int)sSample, 16);
 iValPred[c] = sSample;
 ...
 if (iSign)
   iDiff = (-iDiff);
# 131 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c"
 iDelta = 0;
...
, argv[0], argv[0]);
  ...
  if (!fp_in) {
    fprintf(
# 199 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 3 4
           stderr
# 199 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c"
                 , "file '%s' cannot open.\n", argv[1]);
    exit(1);
  }
  ...
  if (!fp_out) {
    fprintf(
# 204 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c" 3 4
           stderr
# 204 "/doner/libming/libming-ming-0_4_6/util/raw2adpcm.c"
                 , "file '%s' cannnot open.\n", argv[2]);
    exit(1);
  }
  bits16 = 1;
