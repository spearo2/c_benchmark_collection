# 1 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
...
# 2 "/doner/libming/libming-ming-0_4_6/util/listmp3.c" 2
...
# 3 "/doner/libming/libming-ming-0_4_6/util/listmp3.c" 2
# 25 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
...
# 58 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
void skipBytes(FILE *f, int length)
{
  for(; length>0; --length)
    if(fgetc(f) == 
# 61 "/doner/libming/libming-ming-0_4_6/util/listmp3.c" 3 4
                  (-1)
# 61 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
                     )
      return;
}
...
void printMP3Headers(FILE *f)
{
  ...
  for(;;)
  {
    ...
    if((flags = fgetc(f)) == 
# 77 "/doner/libming/libming-ming-0_4_6/util/listmp3.c" 3 4
                            (-1)
# 77 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
                               )
      break;
...
# 87 "/doner/libming/libming-ming-0_4_6/util/listmp3.c" 3 4
                                     (-1)
# 87 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
                                        );
    }

    if(flags == 
# 90 "/doner/libming/libming-ming-0_4_6/util/listmp3.c" 3 4
               (-1)
# 90 "/doner/libming/libming-ming-0_4_6/util/listmp3.c"
                  )
      break;
