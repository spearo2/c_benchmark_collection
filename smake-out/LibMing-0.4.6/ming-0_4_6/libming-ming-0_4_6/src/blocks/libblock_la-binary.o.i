# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c"
# 19 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c"
...
# 20 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c" 2
...
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c" 2
...
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c" 2
...
# 64 "/doner/libming/libming-ming-0_4_6/src/blocks/binary.c"
SWFBinaryData newSWFBinaryData(unsigned char *blob, int length)
{
        SWFBinaryData data = (SWFBinaryData)malloc(sizeof(struct SWFBinaryData_s));

       SWFCharacterInit((SWFCharacter)data);
        ((SWFBlock)(data))->type = SWF_DEFINEBINARYDATA;
        ((SWFBlock)(data))->writeBlock = writeSWFBinaryDataToMethod;
        ((SWFBlock)(data))->complete = completeSWFBinaryData;
        ((SWFBlock)(data))->dtor = (destroySWFBlockMethod) destroySWFBinaryData;
