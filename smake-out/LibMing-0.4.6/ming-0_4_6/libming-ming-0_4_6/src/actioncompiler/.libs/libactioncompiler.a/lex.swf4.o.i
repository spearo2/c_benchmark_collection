# 1 "/doner/libming/libming-ming-0_4_6/src/actioncompiler/lex.swf4.c"
...
YY_BUFFER_STATE swf4_scan_string ( const char *yy_str );
YY_BUFFER_STATE swf4_scan_bytes ( const char *bytes, int len );
...
# 10 "./swf4compiler.flex" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/actioncompiler/swf4compiler.tab.h" 1
# 44 "/doner/libming/libming-ming-0_4_6/src/actioncompiler/swf4compiler.tab.h"
...
# 274 "/doner/libming/libming-ming-0_4_6/src/actioncompiler/swf4compiler.tab.h"
union YYSTYPE
{
# 20 "./swf4compiler.y"
...
# 11 "./swf4compiler.flex" 2

int swf4debug;

static const char *lexBuffer = 
# 14 "./swf4compiler.flex" 3 4
                              ((void *)0)
# 14 "./swf4compiler.flex"
                                  ;
...
static void unescape(char *buf)
{
 ...
 if ( *r == '\\' )
 {
  ...
  switch(*r)
  {
   ...
   case 'x' :
   case 'u' : fprintf(
# 64 "./swf4compiler.flex" 3 4
                     stderr
# 64 "./swf4compiler.flex"
...
{
  swf4restart(
# 79 "./swf4compiler.flex" 3 4
           ((void *)0)
# 79 "./swf4compiler.flex"
               );
...
# 1289 "lex.swf4.c"
# 96 "./swf4compiler.flex"
# 104 "./swf4compiler.flex"
 static void yyunput ( int c, char *buf_ptr );

 void do_unput4(const char c) { yyunput( c, (swf4text) ); }
# 1303 "lex.swf4.c"
# 1304 "lex.swf4.c"
# 1320 "lex.swf4.c"
...
void * swf4get_extra ( void );

void swf4set_extra ( void * user_defined );

FILE *swf4get_in ( void );

void swf4set_in ( FILE * _in_str );

FILE *swf4get_out ( void );

void swf4set_out ( FILE * _out_str );
...
void swf4set_lineno ( int _line_number );
# 1359 "lex.swf4.c"
...
# 1511 "lex.swf4.c"
   ...
   (yy_buffer_stack)[(yy_buffer_stack_top)] =
    swf4_create_buffer( swf4in, 16384 );
  }
...
yy_find_action:
  ...
  (swf4text) = yy_bp; swf4leng = (int) (yy_cp - yy_bp); (yy_hold_char) = *yy_cp; *yy_cp = '\0'; (yy_c_buf_p) = yy_cp;;
...
# 115 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup(swf4text);
     return 343; }
 break;
case 2:

# 117 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup(swf4text);
     return 343; }
 break;
case 3:

# 119 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup("1");
     return 343; }
 break;
case 4:

# 121 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup("0");
     return 343; }
 break;
case 5:

# 123 "./swf4compiler.flex"
{ count(); return 258; }
 break;
case 6:

# 124 "./swf4compiler.flex"
{ count(); return 260; }
 break;
case 7:

# 125 "./swf4compiler.flex"
{ count(); return 262; }
 break;
case 8:

# 126 "./swf4compiler.flex"
{ count(); return 259; }
 break;
case 9:

# 127 "./swf4compiler.flex"
{ count(); return 261; }
 break;
case 10:

# 128 "./swf4compiler.flex"
{ count(); return 264; }
 break;
case 11:

# 129 "./swf4compiler.flex"
{ count(); return 263; }
 break;
case 12:

# 130 "./swf4compiler.flex"
{ count(); return 266; }
 break;

case 13:

# 133 "./swf4compiler.flex"
{ count(); return 268; }
 break;
case 14:

# 134 "./swf4compiler.flex"
{ count(); return 267; }
 break;
case 15:

# 135 "./swf4compiler.flex"
{ count(); return 269; }
 break;
case 16:

# 136 "./swf4compiler.flex"
{ count(); return 270; }
 break;
case 17:

# 137 "./swf4compiler.flex"
{ count(); return 271; }
 break;
case 18:

# 138 "./swf4compiler.flex"
{ count(); return 272; }
 break;
case 19:

# 139 "./swf4compiler.flex"
{ count(); return 273; }
 break;
case 20:

# 140 "./swf4compiler.flex"
{ count(); return 274; }
 break;
case 21:

# 141 "./swf4compiler.flex"
{ count(); return 275; }
 break;
case 22:

# 142 "./swf4compiler.flex"
{ count(); return 276; }
 break;
case 23:

# 143 "./swf4compiler.flex"
{ count(); return 277; }
 break;
case 24:

# 144 "./swf4compiler.flex"
{ count(); return 278; }
 break;
case 25:

# 145 "./swf4compiler.flex"
{ count(); return 279; }
 break;
case 26:

# 146 "./swf4compiler.flex"
{ count(); return 280; }
 break;
case 27:

# 147 "./swf4compiler.flex"
{ count(); return 281; }
 break;
case 28:

# 148 "./swf4compiler.flex"
{ count(); return 282; }
 break;
case 29:

# 149 "./swf4compiler.flex"
{ count(); return 283; }
 break;
case 30:

# 150 "./swf4compiler.flex"
{ count(); return 284; }
 break;
case 31:

# 151 "./swf4compiler.flex"
{ count(); return 286; }
 break;
case 32:

# 153 "./swf4compiler.flex"
{ count(); return 287; }
 break;

case 33:

# 156 "./swf4compiler.flex"
{ count(); return 288; }
 break;
case 34:

# 157 "./swf4compiler.flex"
{ count(); return 289; }
 break;
case 35:

# 158 "./swf4compiler.flex"
{ count(); return 290; }
 break;
case 36:

# 159 "./swf4compiler.flex"
{ count(); return 291; }
 break;
case 37:

# 160 "./swf4compiler.flex"
{ count(); return 292; }
 break;
case 38:

# 161 "./swf4compiler.flex"
{ count(); return 293; }
 break;
case 39:

# 162 "./swf4compiler.flex"
{ count(); return 294; }
 break;
case 40:

# 163 "./swf4compiler.flex"
{ count(); return 295; }
 break;
case 41:

# 164 "./swf4compiler.flex"
{ count(); return 296; }
 break;
case 42:

# 165 "./swf4compiler.flex"
{ count(); return 297; }
 break;

case 43:

# 168 "./swf4compiler.flex"
{ count(); return 340; }
 break;
case 44:

# 171 "./swf4compiler.flex"
{ count(); return 265; }
 break;
case 45:

# 173 "./swf4compiler.flex"
{ count(); (yy_start) = 1 + 2 *(1); return 298; }
 break;


case 46:

# 177 "./swf4compiler.flex"
{ count(); return 299; }
 break;
case 47:

# 178 "./swf4compiler.flex"
{ count(); return 338; }
 break;
case 48:

# 179 "./swf4compiler.flex"
{ count(); return 300; }
 break;
case 49:

# 180 "./swf4compiler.flex"
{ count(); return 301; }
 break;
case 50:

# 181 "./swf4compiler.flex"
{ count(); return 302; }
 break;
case 51:

# 182 "./swf4compiler.flex"
{ count(); return 303; }
 break;
case 52:

# 183 "./swf4compiler.flex"
{ count(); return 304; }
 break;
case 53:

# 184 "./swf4compiler.flex"
{ count(); return 305; }
 break;
case 54:

# 185 "./swf4compiler.flex"
{ count(); return 306; }
 break;
case 55:

# 186 "./swf4compiler.flex"
{ count(); return 307; }
 break;
case 56:

# 187 "./swf4compiler.flex"
{ count(); return 308; }
 break;
case 57:

# 188 "./swf4compiler.flex"
{ count(); return 309; }
 break;
case 58:

# 189 "./swf4compiler.flex"
{ count(); return 310; }
 break;
case 59:

# 190 "./swf4compiler.flex"
{ count(); return 311; }
 break;
case 60:

# 191 "./swf4compiler.flex"
{ count(); return 312; }
 break;
case 61:

# 192 "./swf4compiler.flex"
{ count(); return 339; }
 break;
case 62:

# 193 "./swf4compiler.flex"
{ count(); return 313; }
 break;
case 63:

# 194 "./swf4compiler.flex"
{ count(); return 314; }
 break;
case 64:

# 195 "./swf4compiler.flex"
{ count(); return 315; }
 break;
case 65:

# 196 "./swf4compiler.flex"
{ count(); return 316; }
 break;
case 66:

# 197 "./swf4compiler.flex"
{ count(); return 317; }
 break;
case 67:

# 198 "./swf4compiler.flex"
{ count(); return 336; }
 break;
case 68:

# 199 "./swf4compiler.flex"
{ count(); return 337; }
 break;
case 69:

# 200 "./swf4compiler.flex"
{ count(); return 318; }
 break;
case 70:

# 201 "./swf4compiler.flex"
{ count(); return 319; }
 break;
case 71:

# 202 "./swf4compiler.flex"
{ count(); return 320; }
 break;
case 72:

# 203 "./swf4compiler.flex"
{ count(); return 321; }
 break;
case 73:

# 204 "./swf4compiler.flex"
{ count(); return 322; }
 break;
case 74:

# 205 "./swf4compiler.flex"
{ count(); return 323; }
 break;
case 75:

# 206 "./swf4compiler.flex"
{ count(); return 324; }
 break;
case 76:

# 207 "./swf4compiler.flex"
{ count(); return 325; }
 break;
case 77:

# 208 "./swf4compiler.flex"
{ count(); return 326; }
 break;
case 78:

# 209 "./swf4compiler.flex"
{ count(); return 327; }
 break;
case 79:

# 210 "./swf4compiler.flex"
{ count(); return 328; }
 break;
case 80:

# 211 "./swf4compiler.flex"
{ count(); return 329; }
 break;
case 81:

# 212 "./swf4compiler.flex"
{ count(); return 330; }
 break;
case 82:

# 213 "./swf4compiler.flex"
{ count(); return 331; }
 break;
case 83:

# 214 "./swf4compiler.flex"
{ count(); return 332; }
 break;
case 84:

# 215 "./swf4compiler.flex"
{ count(); return 333; }
 break;
case 85:

# 216 "./swf4compiler.flex"
{ count(); return 334; }
 break;
case 86:

# 217 "./swf4compiler.flex"
{ count(); return 335; }
 break;

case 87:

# 220 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup(swf4text);
     return 344; }
 break;
case 88:

# 223 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup(swf4text);
     return 345; }
 break;
case 89:

# 226 "./swf4compiler.flex"
{ count(); swf4lval.str = strdup(swf4text);
     return 345; }
 break;
case 90:
...
# 239 "./swf4compiler.flex"
{ count(); swf4lval.str = 
# 239 "./swf4compiler.flex" 3 4
                         ((void *)0)
# 239 "./swf4compiler.flex"
                             ;
...
# 243 "./swf4compiler.flex"
{ count(); swf4lval.str = 
# 243 "./swf4compiler.flex" 3 4
                         ((void *)0)
# 243 "./swf4compiler.flex"
                             ;
     warning("Unterminated string!");
...
# 247 "./swf4compiler.flex"
{ count(); comment(); }
 break;
case 95:

# 248 "./swf4compiler.flex"
{ count(); comment1(); }
 break;
case 96:

# 249 "./swf4compiler.flex"
{ count(); }
 break;
case 97:

# 251 "./swf4compiler.flex"
{ count(); return 352; }
 break;
case 98:

# 252 "./swf4compiler.flex"
{ count(); return 353; }
 break;
case 99:

# 253 "./swf4compiler.flex"
{ count(); return '<'; }
 break;
case 100:

# 254 "./swf4compiler.flex"
{ count(); return '>'; }
 break;
case 101:

# 255 "./swf4compiler.flex"
{ count(); return 347; }
 break;
case 102:

# 256 "./swf4compiler.flex"
{ count(); return 348; }
 break;
case 103:

# 257 "./swf4compiler.flex"
{ count(); return 346; }
 break;
case 104:

# 258 "./swf4compiler.flex"
{ count(); return 349; }
 break;
case 105:

# 259 "./swf4compiler.flex"
{ count(); return 350; }
 break;
case 106:

# 260 "./swf4compiler.flex"
{ count(); return 351; }
 break;
case 107:

# 261 "./swf4compiler.flex"
{ count(); return 356; }
 break;
case 108:

# 262 "./swf4compiler.flex"
{ count(); return 355; }
 break;
case 109:

# 263 "./swf4compiler.flex"
{ count(); return 354; }
 break;
case 110:

# 264 "./swf4compiler.flex"
{ count(); return 357; }
 break;
case 111:

# 265 "./swf4compiler.flex"
{ count(); return 358; }
 break;
case 112:

# 266 "./swf4compiler.flex"
{ count(); return 359; }
 break;
case 113:

# 267 "./swf4compiler.flex"
{ count(); return 360; }
 break;
case 114:

# 268 "./swf4compiler.flex"
{ count(); return 361; }
 break;
case 115:

# 270 "./swf4compiler.flex"
{ count(); return ';'; }
 break;
case 116:

# 271 "./swf4compiler.flex"
{ count(); return '='; }
 break;
case 117:

# 272 "./swf4compiler.flex"
{ count(); return '+'; }
 break;
case 118:

# 273 "./swf4compiler.flex"
{ count(); return '-'; }
 break;
case 119:

# 274 "./swf4compiler.flex"
{ count(); return '&'; }
 break;
case 120:

# 275 "./swf4compiler.flex"
{ count(); return '*'; }
 break;
case 121:

# 276 "./swf4compiler.flex"
{ count(); return '/'; }
 break;
case 122:

# 277 "./swf4compiler.flex"
{ count(); return '!'; }
 break;
case 123:

# 278 "./swf4compiler.flex"
{ count(); return '('; }
 break;
case 124:

# 279 "./swf4compiler.flex"
{ count(); return ')'; }
 break;
case 125:

# 280 "./swf4compiler.flex"
{ count(); return '['; }
 break;
case 126:

# 281 "./swf4compiler.flex"
{ count(); return ']'; }
 break;
case 127:

# 282 "./swf4compiler.flex"
{ count(); return '{'; }
 break;
case 128:

# 283 "./swf4compiler.flex"
{ count(); return '}'; }
 break;
case 129:

# 284 "./swf4compiler.flex"
{ count(); return ','; }
 break;
case 130:

# 285 "./swf4compiler.flex"
{ count(); return '.'; }
 break;
case 131:

# 286 "./swf4compiler.flex"
{ count(); return '?'; }
 break;
case 132:

# 287 "./swf4compiler.flex"
{ count(); return ':'; }
 break;
case 133:


# 289 "./swf4compiler.flex"
{ count(); column = 0;
     strcpy(szLine, swf4text + 1);
     ++sLineNumber; do { int yyless_macro_arg = (1); ; *yy_cp = (yy_hold_char); (yy_c_buf_p) = yy_cp = yy_bp + yyless_macro_arg - 0; (swf4text) = yy_bp; swf4leng = (int) (yy_cp - yy_bp); (yy_hold_char) = *yy_cp; *yy_cp = '\0'; (yy_c_buf_p) = yy_cp;; } while ( 0 ); }
 break;
case 134:

# 293 "./swf4compiler.flex"
printf( "Unrecognized character: %s\n", swf4text );
 break;
case 135:

# 295 "./swf4compiler.flex"
do { if (fwrite( swf4text, (size_t) swf4leng, 1, swf4out )) {} } while (0);
 break;
# 2291 "lex.swf4.c"
case (136 + 0 + 1):
case (136 + 1 + 1):
 ...
 case 136:
  ...
  int yy_amount_of_matched_text = (int) (yy_cp - (swf4text)) - 1;
...
# 2315 "lex.swf4.c"
   ...
   (yy_buffer_stack)[(yy_buffer_stack_top)]->yy_input_file = swf4in;
...
# 2327 "lex.swf4.c"
  if ( (yy_c_buf_p) <= &(yy_buffer_stack)[(yy_buffer_stack_top)]->yy_ch_buf[(yy_n_chars)] )
   ...
   (yy_c_buf_p) = (swf4text) + yy_amount_of_matched_text;
...
# 2344 "lex.swf4.c"
   ...
   case 1:
    ...
    if ( swf4wrap( ) )
     {
# 2381 "lex.swf4.c"
     (yy_c_buf_p) = (swf4text) + 0;

     yy_act = (136 + (((yy_start) - 1) / 2) + 1);
     goto do_action;
     }
   ...
   case 0:
    (yy_c_buf_p) =
     (swf4text) + yy_amount_of_matched_text;
...
static int yy_get_next_buffer (void)
{
 ...
 number_to_move = (int) ((yy_c_buf_p) - (swf4text) - 1);
...
# 2507 "lex.swf4.c"
 ...
 if (((yy_n_chars) + number_to_move) > (yy_buffer_stack)[(yy_buffer_stack_top)]->yy_buf_size) {
  ...
  (yy_buffer_stack)[(yy_buffer_stack_top)]->yy_ch_buf = (char *) swf4realloc(
 ...
 (swf4text) = &(yy_buffer_stack)[(yy_buffer_stack_top)]->yy_ch_buf[0];
    ...
    static yy_state_type yy_get_previous_state (void)
{
 ...
 for ( yy_cp = (swf4text) + 0; yy_cp < (yy_c_buf_p); ++yy_cp )
  {
 ...
 *(yy_c_buf_p) = (yy_hold_char);
 ...
 if ( *(yy_c_buf_p) == 0 )
   ...
   *(yy_c_buf_p) = '\0';
   ...
   {
   int offset = (int) ((yy_c_buf_p) - (swf4text));
   ++(yy_c_buf_p);
...
# 2749 "lex.swf4.c"
 ...
 swf4_init_buffer( ( (yy_buffer_stack) ? (yy_buffer_stack)[(yy_buffer_stack_top)] : 
# 2755 "lex.swf4.c" 3 4
                ((void *)0)
# 2755 "lex.swf4.c"
                ), input_file );
...
{
     (yy_n_chars) = (yy_buffer_stack)[(yy_buffer_stack_top)]->yy_n_chars;
 (swf4text) = (yy_c_buf_p) = (yy_buffer_stack)[(yy_buffer_stack_top)]->yy_buf_pos;
 swf4in = (yy_buffer_stack)[(yy_buffer_stack_top)]->yy_input_file;
 (yy_hold_char) = *(yy_c_buf_p);
}
    ...
    YY_BUFFER_STATE swf4_create_buffer (FILE * file, int size )
{
 ...
 b->yy_ch_buf = (char *) swf4alloc( (yy_size_t) (b->yy_buf_size + 2) );
 if ( ! b->yy_ch_buf )
  yy_fatal_error( "out of dynamic memory in yy_create_buffer()" );
...
# 2944 "lex.swf4.c"
 ...
 swf4_delete_buffer(( (yy_buffer_stack) ? (yy_buffer_stack)[(yy_buffer_stack_top)] : 
# 2947 "lex.swf4.c" 3 4
                 ((void *)0)
# 2947 "lex.swf4.c"
                 ) );
...
# 3047 "lex.swf4.c"
YY_BUFFER_STATE swf4_scan_string (const char * yystr )
{

 return swf4_scan_bytes( yystr, (int) strlen(yystr) );
}
# 3060 "lex.swf4.c"
YY_BUFFER_STATE swf4_scan_bytes (const char * yybytes, int _yybytes_len )
{
 YY_BUFFER_STATE b;
 char *buf;
 yy_size_t n;
...
void swf4set_debug (int _bdebug )
{
        swf4_flex_debug = _bdebug ;
}
...
loop:
   ...
   while ((c = getinput()) != '*' && c != 
# 344 "./swf4compiler.flex" 3 4
                                         (-1)
# 344 "./swf4compiler.flex"
                                            )
   {
      if(column < 1023)
         msgline[column] = c;
  ...
  countline();
   ...
   if ((c1 = getinput()) != '/' && c != 
# 362 "./swf4compiler.flex" 3 4
                                       (-1)
# 362 "./swf4compiler.flex"
                                          )
   {
   ...
   if (c != 
# 370 "./swf4compiler.flex" 3 4
           (-1)
# 370 "./swf4compiler.flex"
              )
      if (swf4debug) putchar(c);


   if (c1 != 
# 374 "./swf4compiler.flex" 3 4
            (-1)
# 374 "./swf4compiler.flex"
               )
...
static void comment1(void)
{
   ...
   while ((c = getinput()) != '\n' && c != 
# 385 "./swf4compiler.flex" 3 4
                                          (-1)
# 385 "./swf4compiler.flex"
                                             )
   {
      if (swf4debug) putchar(c);
