# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
# 21 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
...
# 22 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2

# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.h"
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.h" 2
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/jpeg.h" 1
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.h" 1
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/dbl.h"
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2
...
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 2
# 41 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
...
int SWFBitmap_getWidth(SWFBitmap b)
{
 return SWFRect_getWidth(((SWFCharacter)(b))->bounds);
}


int SWFBitmap_getHeight(SWFBitmap b)
{
 return SWFRect_getHeight(((SWFCharacter)(b))->bounds);
}
...
SWFBitmap newSWFBitmap_fromInput(SWFInput input)
{
 ...
 if(c1 == 'G' && c2 == 'I')
  ...
  do { if(_SWF_error) _SWF_error(("GIF images must be translated into DBL files for now")); } while(0);
 ...
 if(c2 == 'P' && c3 == 'N')
  ...
  do { if(_SWF_error) _SWF_error(("PNG images must be translated into DBL files for now")); } while(0);


 do { if(_SWF_error) _SWF_error(("Unrecognised file type")); } while(0);

 return 
# 93 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
       ((void *)0)
# 93 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
           ;
}
                                  ...
                                  unsigned short width, unsigned short height)
{
 ...
 switch(srcFmt)
 {
  case SWF_RAWIMG_ARGB:
   ...
   break;
  default:
   do { if(_SWF_warn) _SWF_warn(("newSWFBitmap_fromRawImg: unknown img format\n")); } while(0);
   return 
# 115 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
         ((void *)0)
# 115 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
             ;
 }
 ...
 outsize = ((insize) + ((insize) >> 12) + ((insize) >> 14) + 11);
 image.data = (unsigned char*) malloc(outsize);


 if (
# 128 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
    ((void *)0) 
# 128 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
         == image.data)
  return 
# 129 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
        ((void *)0)
# 129 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
            ;

 ret = compress2(image.data, &outsize, (Bytef *)tmp, insize, 9);
 if(ret != 
# 132 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
          0
# 132 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
              )
 {
  free(image.data);
  return 
# 135 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
        ((void *)0)
# 135 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
            ;
 }
 ...
 if (
# 142 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
    ((void *)0) 
# 142 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
         == return_data)
 {
  free(image.data);
  return 
# 145 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c" 3 4
        ((void *)0)
# 145 "/doner/libming/libming-ming-0_4_6/src/blocks/bitmap.c"
            ;
 }
