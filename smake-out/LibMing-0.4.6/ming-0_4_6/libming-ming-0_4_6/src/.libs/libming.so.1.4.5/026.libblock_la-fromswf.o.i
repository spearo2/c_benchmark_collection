# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
# 1 "../../src/ming_config.h" 1
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
...
# 26 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.h" 1
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.h"
# 1 "../../src/ming.h" 1
# 34 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.h" 2
...
# 35 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.h" 2
...
# 36 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.h" 2
...
# 27 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
...
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
...
# 34 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
...
# 35 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 39 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 2



# 41 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
static void
writeSWFPrebuiltClipToMethod(SWFBlock block, SWFByteOutputMethod method, void *data)
{
 ...
 methodWriteUInt16((((SWFCharacter)(clip))->id), method, data);
...
newSWFPrebuiltClip()
{
 ...
 ((SWFBlock)(clip))->type = SWF_PREBUILTCLIP;
 ((SWFBlock)(clip))->writeBlock = writeSWFPrebuiltClipToMethod;
 ((SWFBlock)(clip))->complete = completeSWFPrebuiltClip;
 ((SWFBlock)(clip))->dtor = (destroySWFBlockMethod) destroySWFPrebuiltClip;
...
newSWFPrebuilt()
{
 ...
 ((SWFBlock)(data))->type = SWF_PREBUILT;
 ((SWFBlock)(data))->writeBlock = writeSWFPrebuiltToMethod;
 ((SWFBlock)(data))->complete = completeSWFPrebuilt;
 ((SWFBlock)(data))->dtor = (destroySWFBlockMethod) destroySWFPrebuilt;
...
{ struct swfile *res = (struct swfile *)malloc(sizeof(struct swfile));
 ...
 if(memcmp(res->vers, "FWS", 3) && memcmp(res->vers, "CWS", 3))
  do { if(_SWF_error) _SWF_error(("input not a SWF stream\n")); } while(0);
...
# 289 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 3 4
 inflateInit_((
# 289 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
 &z
# 289 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 3 4
...
# 289 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
                ;
  inflate(&z, 
# 290 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 3 4
             4
# 290 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
                     );
  inflateEnd(&z);
...
static int drop_tag(TAG tp)
{
 switch(tp->type)
 {
  case SWF_FILEATTRIBUTES:
  case SWF_METADATA:
  case SWF_DEFINESCENEANDFRAMEDATA:
   return 1;
  default:
   return 0;
 }
...
{ int id;
 ...
 switch(tp->type)
 {
  ...
  case SWF_DEFINEBUTTONSOUND:
   ...
   break;
  default:
   do { if(_SWF_error) _SWF_error(("unknown tag %d\n"), tp->type); } while(0);
 }
 switch(tp->type)
 { case SWF_END:
  case SWF_SHOWFRAME:
...
{ TAG tp;
 ...
 if(sp->datptr != sp->datend)
  do { if(_SWF_error) _SWF_error(("consistency check: file size wrong in sprite\n")); } while(0);
}
...
{ unsigned short id;
 ...
 { id = change_id(tp);
  ...
  printf("%s:%d: UNEXPEDCED %x\n", "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c", 784, cod);
}
...
{ unsigned short id;
 ...
 { id = change_id(tp);
  ...
  printf("%s:%d: UNEXPEDCED %x\n", "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c", 846, cod);
}
...
# 999 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
 shape(tp, 3);
}
...
{ SWFPrebuiltClip clip;
 ...
 swf = openswf(input);
 if ( ! swf ) return 
# 1287 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 3 4
                    ((void *)0)
# 1287 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
                        ;
 ...
 (((SWFCharacter)(clip))->id) = SWF_gNumCharacters++;
 return clip;
}
...
{ FILE *fp;
 ...
 if(!(fp = fopen(filename, "rb")))
  return 
# 1338 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c" 3 4
        ((void *)0)
# 1338 "/doner/libming/libming-ming-0_4_6/src/blocks/fromswf.c"
            ;
