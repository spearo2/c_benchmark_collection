# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c"
# 23 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c"
...
# 24 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 2
...
# 25 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 2


# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.h" 1
# 32 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.h"
# 1 "../../src/ming.h" 1
# 45 "../../src/ming.h"
...
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.h" 2
...
# 28 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 2
# 1 "/doner/libming/libming-ming-0_4_6/src/blocks/font.h" 1
# 33 "/doner/libming/libming-ming-0_4_6/src/blocks/font.h"
...
# 29 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 2
...
# 30 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 2
...
finishBrowserFont(SWFBrowserFont font)
{
 unsigned int i;
 SWFOutput out;
 if ( !(((SWFBlock)(font))->swfVersion) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "((SWFBlock)(font))->swfVersion", "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c",55); } while(0);;

 out = newSWFOutput();
 font->out = out;

 SWFOutput_writeUInt16(out, (((SWFCharacter)(font))->id));
 if(((SWFBlock)(font))->swfVersion > 5)
  SWFOutput_writeUInt8(out, (1<<2));
 else
...
completeSWFBrowserFont(SWFBlock block)
{
 ...
 if(font->out == 
# 82 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 3 4
                ((void *)0)
# 82 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c"
                    )
...
newSWFBrowserFont(const char *name)
{
 ...
 ((SWFBlock)(font))->writeBlock = writeSWFBrowserFontToMethod;
 ((SWFBlock)(font))->complete = completeSWFBrowserFont;
 ((SWFBlock)(font))->dtor = (destroySWFBlockMethod) destroySWFBrowserFont;

 ((SWFBlock)(font))->type = SWF_BROWSERFONT;
 (((SWFCharacter)(font))->id) = ++SWF_gNumCharacters;
 font->out = 
# 118 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 3 4
            ((void *)0)
# 118 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c"
                ;
...
{
 if(font->out == 
# 127 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c" 3 4
                ((void *)0)
# 127 "/doner/libming/libming-ming-0_4_6/src/blocks/browserfont.c"
                    )
  finishBrowserFont(font);
