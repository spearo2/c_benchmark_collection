# 1 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
# 27 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
...
# 30 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
...
# 31 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
...
# 32 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
...
# 35 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
...
# 42 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
# 1 "../libtiff/tiffio.h" 1
# 43 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 2
# 53 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
...
main(int argc, char* argv[])
{
 ...
 if (out == 
# 119 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
           ((void *)0)
# 119 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
               )
  return (-2);
 ...
 for (; optind < argc-1; optind++) {
  ...
  if (in != 
# 124 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
           ((void *)0)
# 124 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
               ) {
   do {
    if (!tiffcvt(in, out) ||
...
# 223 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
...
# 332 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
...
# 380 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
static int
...
# 429 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
    if (no_alpha)
    {
...
# 546 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
   ((void *)0)

# 547 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
};
...
{
 char buf[
# 552 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
         8192
# 552 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
               ];
 int i;

 setbuf(
# 555 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
       stderr
# 555 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
             , buf);
        fprintf(
# 556 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
               stderr
# 556 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 557 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
                        ((void *)0)
# 557 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
                            ; i++)
  fprintf(
# 558 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c" 3 4
         stderr
# 558 "/doner/libtiff/libtiff-2c00d31/libtiff/tools/tiff2rgba.c"
               , "%s\n", stuff[i]);
 exit(code);
}
