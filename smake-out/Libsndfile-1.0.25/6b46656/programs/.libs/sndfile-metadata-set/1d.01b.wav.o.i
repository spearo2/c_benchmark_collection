# 1 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
# 20 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
...
# 21 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 23 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 24 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 25 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 26 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 27 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 28 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 30 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 31 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
...
# 32 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/src/wav_w64.h" 1
# 29 "/doner/libsndfile/libsndfile-6b46656/src/wav_w64.h"
enum
{
...
# 278 "/doner/libsndfile/libsndfile-6b46656/src/wav_w64.h"
...
# 33 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 2
# 121 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
enum
{ HAVE_RIFF = 0x01,
 HAVE_WAVE = 0x02,
 HAVE_fmt = 0x04,
...
# 179 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
...
{ WAV_PRIVATE * wpriv ;
 ...
 if ((wpriv = calloc (1, sizeof (WAV_PRIVATE))) == 
# 206 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                  ((void *)0)
# 206 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                      )
...
# 259 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                                 ((void *)0)
# 259 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                                     )
    return SFE_MALLOC_FAILED ;
...
{ WAV_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 338 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                     ((void *)0)
# 338 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         )
  return SFE_INTERNAL ;
 ...
 psf->rwf_endian = (marker == (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24))))) ? SF_ENDIAN_LITTLE : SF_ENDIAN_BIG ;
 ...
 { size_t jump = chunk_size & 1 ;
  ...
  switch (marker)
  { case (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))) :
   case (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('X')) << 24)))) :
     if (parsestage)
     ...
     if (psf->fileoffset > 0 && psf->filelength > RIFFsize + 8)
     {
      ...
      if (marker == (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))))
       psf_log_printf (psf, "RIFF : %u\n", RIFFsize) ;
      else
       psf_log_printf (psf, "RIFX : %u\n", RIFFsize) ;
      }
     else if (psf->filelength < RIFFsize + 2 * ((int) sizeof (marker)))
     { if (marker == (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))))
       psf_log_printf (psf, "RIFF : %u (should be %D)\n", RIFFsize, psf->filelength - 2 * ((int) sizeof (marker))) ;
      else
       psf_log_printf (psf, "RIFX : %u (should be %D)\n", RIFFsize, psf->filelength - 2 * ((int) sizeof (marker))) ;

      RIFFsize = psf->filelength - 2 * ((int) sizeof (RIFFsize)) ;
      }
     else
     { if (marker == (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))))
       psf_log_printf (psf, "RIFF : %u\n", RIFFsize) ;
     ...
     if (marker != (((uint32_t) (('W') | (('A') << 8) | (('V') << 16) | (((uint32_t) ('E')) << 24)))))
   ...
   case (((uint32_t) (('f') | (('m') << 8) | (('t') << 16) | (((uint32_t) (' ')) << 24)))) :
   ...
   case (((uint32_t) (('d') | (('a') << 8) | (('t') << 16) | (((uint32_t) ('a')) << 24)))) :
     ...
     psf_fseek (psf, psf->datalength, 
# 460 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                     1
# 460 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                             ) ;
   ...
   case (((uint32_t) (('f') | (('a') << 8) | (('c') << 16) | (((uint32_t) ('t')) << 24)))) :
     if ((parsestage & (HAVE_RIFF | HAVE_WAVE)) != (HAVE_RIFF | HAVE_WAVE))
     ...
     if (chunk_size > ((int) sizeof (fact_chunk)))
      psf_binheader_readf (psf, "j", (int) (chunk_size - ((int) sizeof (fact_chunk)))) ;
   ...
   case (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))) :
     ...
     if ((psf->peak_info = peak_info_calloc (psf->sf.channels)) == 
# 501 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                                  ((void *)0)
# 501 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                                      )
      return SFE_MALLOC_FAILED ;
     ...
     { float value ;
      ...
      snprintf (buffer, sizeof (buffer), "    %2d   %-12" 
# 523 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                         "l" "d" 
# 523 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                                "   %g\n",
   ...
   case (((uint32_t) (('c') | (('u') << 8) | (('e') << 16) | (((uint32_t) (' ')) << 24)))) :
   ...
   case (((uint32_t) (('s') | (('m') << 8) | (('p') << 16) | (((uint32_t) ('l')) << 24)))) :
     parsestage |= HAVE_other ;
   ...
   case (((uint32_t) (('a') | (('c') << 8) | (('i') << 16) | (((uint32_t) ('d')) << 24)))) :
     parsestage |= HAVE_other ;
   ...
   case (((uint32_t) (('I') | (('N') << 8) | (('F') << 16) | (((uint32_t) ('O')) << 24)))) :
   case (((uint32_t) (('L') | (('I') << 8) | (('S') << 16) | (((uint32_t) ('T')) << 24)))) :
     parsestage |= HAVE_other ;
   ...
   case (((uint32_t) (('b') | (('e') << 8) | (('x') << 16) | (((uint32_t) ('t')) << 24)))) :
   ...
   case (((uint32_t) (('P') | (('A') << 8) | (('D') << 16) | (((uint32_t) (' ')) << 24)))) :
   ...
   case (((uint32_t) (('c') | (('a') << 8) | (('r') << 16) | (((uint32_t) ('t')) << 24)))):
     if ((error = wav_read_cart_chunk (psf, chunk_size)))
      return error ;
     break ;

   case (((uint32_t) (('i') | (('X') << 8) | (('M') << 16) | (((uint32_t) ('L')) << 24)))) :
   case (((uint32_t) (('s') | (('t') << 8) | (('r') << 16) | (((uint32_t) ('c')) << 24)))) :
   case (((uint32_t) (('a') | (('f') << 8) | (('s') << 16) | (((uint32_t) ('p')) << 24)))) :
   case (((uint32_t) (('c') | (('l') << 8) | (('m') << 16) | (((uint32_t) (' ')) << 24)))) :
   case (((uint32_t) (('e') | (('l') << 8) | (('m') << 16) | (((uint32_t) ('o')) << 24)))) :
   case (((uint32_t) (('l') | (('e') << 8) | (('v') << 16) | (((uint32_t) ('l')) << 24)))) :
   case (((uint32_t) (('p') | (('l') << 8) | (('s') << 16) | (((uint32_t) ('t')) << 24)))) :
   case (((uint32_t) (('m') | (('i') << 8) | (('n') << 16) | (((uint32_t) ('f')) << 24)))) :
   case (((uint32_t) (('e') | (('l') << 8) | (('m') << 16) | (((uint32_t) ('1')) << 24)))) :
   case (((uint32_t) (('r') | (('e') << 8) | (('g') << 16) | (((uint32_t) ('n')) << 24)))) :
   case (((uint32_t) (('o') | (('v') << 8) | (('w') << 16) | (((uint32_t) ('f')) << 24)))) :
   case (((uint32_t) (('i') | (('n') << 8) | (('s') << 16) | (((uint32_t) ('t')) << 24)))) :
   case (((uint32_t) (('A') | (('F') << 8) | (('A') << 16) | (((uint32_t) ('n')) << 24)))) :
   case (((uint32_t) (('u') | (('m') << 8) | (('i') << 16) | (((uint32_t) ('d')) << 24)))) :
   case (((uint32_t) (('S') | (('y') << 8) | (('L') << 16) | (((uint32_t) ('p')) << 24)))) :
   case (((uint32_t) (('C') | (('r') << 8) | (('8') << 16) | (((uint32_t) ('r')) << 24)))) :
   case (((uint32_t) (('J') | (('U') << 8) | (('N') << 16) | (((uint32_t) ('K')) << 24)))) :
   case (((uint32_t) (('_') | (('P') << 8) | (('M') << 16) | (((uint32_t) ('X')) << 24)))) :
   case (((uint32_t) (('D') | (('I') << 8) | (('S') << 16) | (((uint32_t) ('P')) << 24)))) :
   case (((uint32_t) (('M') | (('E') << 8) | (('X') << 16) | (((uint32_t) ('T')) << 24)))) :
   case (((uint32_t) (('F') | (('L') << 8) | (('L') << 16) | (((uint32_t) ('R')) << 24)))) :
     psf_log_printf (psf, "%M : %u\n", marker, chunk_size) ;
     psf_binheader_readf (psf, "j", chunk_size) ;
     break ;
  ...
  if (psf_ftell (psf) >= psf->filelength - ((int) sizeof (chunk_size)))
...
# 675 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                 0
# 675 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         ) ;
 ...
 if (psf->is_pipe == 0)
 {
  ...
  if (marker == (((uint32_t) (('w') | (('v') << 8) | (('p') << 16) | (((uint32_t) ('k')) << 24)))) || marker == (((uint32_t) (('O') | (('g') << 8) | (('g') << 16) | (((uint32_t) ('S')) << 24)))))
   return SFE_WAV_WVPK_DATA ;
  } ;


 psf_fseek (psf, psf->dataoffset, 
# 688 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                 0
# 688 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         ) ;
...
{ int subformat, fmt_size, add_fact_chunk = 0 ;
 ...
 if (add_fact_chunk)
  psf_binheader_writef (psf, "tm48", (((uint32_t) (('f') | (('a') << 8) | (('c') << 16) | (((uint32_t) ('t')) << 24)))), 4, psf->sf.frames) ;
...
{ WAV_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 920 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                     ((void *)0)
# 920 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { case SF_FORMAT_PCM_U8 :
  ...
  case SF_FORMAT_ALAW :
   ...
   add_fact_chunk = SF_TRUE ;
   break ;
# 1033 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
  default : return SFE_UNIMPLEMENTED ;
  } ;
...
{ sf_count_t current ;
 ...
 psf->headindex = 0 ;
 psf_fseek (psf, 0, 
# 1068 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                   0
# 1068 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                           ) ;
# 1078 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
 if (psf->endian == SF_ENDIAN_LITTLE)
  psf_binheader_writef (psf, "etm8", (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))), (psf->filelength < 8) ? 8 : psf->filelength - 8) ;
 else
  psf_binheader_writef (psf, "Etm8", (((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('X')) << 24)))), (psf->filelength < 8) ? 8 : psf->filelength - 8) ;


 psf_binheader_writef (psf, "mm", (((uint32_t) (('W') | (('A') << 8) | (('V') << 16) | (((uint32_t) ('E')) << 24)))), (((uint32_t) (('f') | (('m') << 8) | (('t') << 16) | (((uint32_t) (' ')) << 24))))) ;
 ...
 if (psf->peak_info != 
# 1106 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                      ((void *)0) 
# 1106 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                           && psf->peak_info->peak_loc == SF_PEAK_START)
 { psf_binheader_writef (psf, "m4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "44", 1, time (
# 1108 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                           ((void *)0)
# 1108 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                               )) ;
...
# 1113 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                          ((void *)0)
# 1113 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                              )
  wav_write_bext_chunk (psf) ;

 if (psf->cart_16k != 
# 1116 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                     ((void *)0)
# 1116 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                         )
  wav_write_cart_chunk (psf) ;

 if (psf->instrument != 
# 1119 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                       ((void *)0)
# 1119 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                           )
 { int tmp ;
  double dtune = (double) (0x40000000) / 25.0 ;

  psf_binheader_writef (psf, "m4", (((uint32_t) (('s') | (('m') << 8) | (('p') << 16) | (((uint32_t) ('l')) << 24)))), 9 * 4 + psf->instrument->loop_count * 6 * 4) ;
  psf_binheader_writef (psf, "44", 0, 0) ;
  tmp = (int) (1.0e9 / psf->sf.samplerate) ;
 ...
 if (psf->headindex + 16 < psf->dataoffset)
 {
  ...
  psf_binheader_writef (psf, "m4z", (((uint32_t) (('P') | (('A') << 8) | (('D') << 16) | (((uint32_t) (' ')) << 24)))), k, make_size_t (k)) ;
  } ;

 psf_binheader_writef (psf, "tm8", (((uint32_t) (('d') | (('a') << 8) | (('t') << 16) | (((uint32_t) ('a')) << 24)))), psf->datalength) ;
 ...
 if (! has_data)
  psf_fseek (psf, psf->dataoffset, 
# 1167 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                  0
# 1167 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 1169 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                          0
# 1169 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                  ) ;
...
{ int k ;
 ...
 if (psf->dataend > 0)
  psf_fseek (psf, psf->dataend, 
# 1189 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                               0
# 1189 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                       ) ;
 else
  psf->dataend = psf_fseek (psf, 0, 
# 1191 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                   2
# 1191 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                           ) ;


 if (psf->peak_info != 
# 1194 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                      ((void *)0) 
# 1194 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                           && psf->peak_info->peak_loc == SF_PEAK_END)
 { psf_binheader_writef (psf, "m4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "44", 1, time (
# 1196 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                           ((void *)0)
# 1196 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                               )) ;
  for (k = 0 ; k < psf->sf.channels ; k++)
...
{ int k, prev_head_index, saved_head_index ;
 ...
 psf_binheader_writef (psf, "m4m", (((uint32_t) (('L') | (('I') << 8) | (('S') << 16) | (((uint32_t) ('T')) << 24)))), 0xBADBAD, (((uint32_t) (('I') | (('N') << 8) | (('F') << 16) | (((uint32_t) ('O')) << 24))))) ;
 ...
 { if (psf->strings.data [k].type == 0)
  ...
  { case SF_STR_SOFTWARE :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('S') << 8) | (('F') << 16) | (((uint32_t) ('T')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_TITLE :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('N') << 8) | (('A') << 16) | (((uint32_t) ('M')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_COPYRIGHT :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('C') << 8) | (('O') << 16) | (((uint32_t) ('P')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_ARTIST :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('T')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_COMMENT :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('C') << 8) | (('M') << 16) | (((uint32_t) ('T')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_DATE :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('C') << 8) | (('R') << 16) | (((uint32_t) ('D')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_GENRE :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('G') << 8) | (('N') << 16) | (((uint32_t) ('R')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_ALBUM :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('P') << 8) | (('R') << 16) | (((uint32_t) ('D')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_TRACKNUMBER :
    psf_binheader_writef (psf, "ms", (((uint32_t) (('I') | (('T') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;
...
static int
wav_command (SF_PRIVATE *psf, int command, void * UNUSED_data __attribute__ ((unused)), int datasize)
{ WAV_PRIVATE *wpriv ;

 if ((wpriv = psf->container_data) == 
# 1307 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                     ((void *)0)
# 1307 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         )
  return SFE_INTERNAL ;
...
{ sf_count_t current_pos ;
 ...
 current_pos = psf_fseek (psf, 0, 
# 1342 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                 1
# 1342 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         ) - 4 ;
 ...
 if (psf->headindex + chunk_length > ((int) sizeof (psf->header)))
 ...
 { bytesread += psf_binheader_readf (psf, "m", &chunk) ;
  ...
  switch (chunk)
  { case (((uint32_t) (('a') | (('d') << 8) | (('t') << 16) | (((uint32_t) ('l')) << 24)))) :
   case (((uint32_t) (('I') | (('N') << 8) | (('F') << 16) | (((uint32_t) ('O')) << 24)))) :

     psf_log_printf (psf, "  %M\n", chunk) ;
     continue ;

   case (((uint32_t) (('e') | (('x') << 8) | (('i') << 16) | (((uint32_t) ('f')) << 24)))) :
     psf_log_printf (psf, "  %M\n", chunk) ;
...
# 1396 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                                              1
# 1396 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                                                      )) ;
     return 0 ;
  ...
  switch (chunk)
  { case (((uint32_t) (('I') | (('S') << 8) | (('F') << 16) | (((uint32_t) ('T')) << 24)))) :
   case (((uint32_t) (('I') | (('C') << 8) | (('O') << 16) | (((uint32_t) ('P')) << 24)))) :
   case (((uint32_t) (('I') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('L')) << 24)))) :
   case (((uint32_t) (('I') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('T')) << 24)))) :
   case (((uint32_t) (('I') | (('C') << 8) | (('M') << 16) | (((uint32_t) ('T')) << 24)))) :
   case (((uint32_t) (('I') | (('C') << 8) | (('R') << 16) | (((uint32_t) ('D')) << 24)))) :
   case (((uint32_t) (('I') | (('E') << 8) | (('N') << 16) | (((uint32_t) ('G')) << 24)))) :
   case (((uint32_t) (('I') | (('G') << 8) | (('N') << 16) | (((uint32_t) ('R')) << 24)))) :
   case (((uint32_t) (('I') | (('N') << 8) | (('A') << 16) | (((uint32_t) ('M')) << 24)))) :
   case (((uint32_t) (('I') | (('P') << 8) | (('R') << 16) | (((uint32_t) ('D')) << 24)))) :
   case (((uint32_t) (('I') | (('S') << 8) | (('B') << 16) | (((uint32_t) ('J')) << 24)))) :
   case (((uint32_t) (('I') | (('S') << 8) | (('R') << 16) | (((uint32_t) ('C')) << 24)))) :
   case (((uint32_t) (('I') | (('A') << 8) | (('U') << 16) | (((uint32_t) ('T')) << 24)))) :
   case (((uint32_t) (('I') | (('T') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))) :
     bytesread += psf_binheader_readf (psf, "4", &dword) ;
     dword += (dword & 1) ;
     if (dword >= ((int) sizeof (buffer)))
   ...
   case (((uint32_t) (('l') | (('a') << 8) | (('b') << 16) | (((uint32_t) ('l')) << 24)))) :
     { int mark_id ;

      bytesread += psf_binheader_readf (psf, "44", &dword, &mark_id) ;
      dword -= 4 ;
      dword += (dword & 1) ;
      if (dword < 1 || dword >= ((int) sizeof (buffer)))
      { psf_log_printf (psf, "  *** %M : %d (too big)\n", chunk, dword) ;
       psf_binheader_readf (psf, "j", dword) ;
       break ;
       } ;
   ...
   case (((uint32_t) (('D') | (('I') << 8) | (('S') << 16) | (((uint32_t) ('P')) << 24)))) :
   case (((uint32_t) (('l') | (('t') << 8) | (('x') << 16) | (((uint32_t) ('t')) << 24)))) :
   case (((uint32_t) (('n') | (('o') << 8) | (('t') << 16) | (((uint32_t) ('e')) << 24)))) :
     bytesread += psf_binheader_readf (psf, "4", &dword) ;
     dword += (dword & 1) ;
 ...
 current_pos = psf_fseek (psf, 0, 
# 1506 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                 1
# 1506 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                         ) - current_pos ;
...
{ char buffer [512] ;
 ...
 if ((psf->instrument = psf_instrument_alloc ()) == 
# 1560 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                   ((void *)0)
# 1560 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                       )
  return SFE_MALLOC_FAILED ;
...
# 1675 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
static int
...
# 1706 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                            ((void *)0)
# 1706 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                                )
  return SFE_MALLOC_FAILED ;
...
wav_read_bext_chunk (SF_PRIVATE *psf, uint32_t chunksize)
{
 ...
 if ((psf->broadcast_16k = broadcast_var_alloc ()) == 
# 1745 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                     ((void *)0)
# 1745 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                         )
 ...
 if (chunksize > 602)
 {
  ...
  b->coding_history_size = chunksize - 602 ;
...
{ SF_BROADCAST_INFO_16K *b ;
 ...
 if (psf->broadcast_16k == 
# 1779 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                          ((void *)0)
# 1779 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                              )
  return -1 ;

 b = psf->broadcast_16k ;

 psf_binheader_writef (psf, "m4", (((uint32_t) (('b') | (('e') << 8) | (('x') << 16) | (((uint32_t) ('t')) << 24)))), 602 + b->coding_history_size) ;
...
{ SF_CART_INFO_16K *c ;
 ...
 if ((psf->cart_16k = cart_var_alloc ()) == 
# 1831 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                           ((void *)0)
# 1831 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                               )
 { psf->error = SFE_MALLOC_FAILED ;
  return psf->error ;
  } ;
 ...
 for (k = 0 ; k < ((int) (sizeof (c->post_timers) / sizeof ((c->post_timers) [0]))) ; k++)
 ...
 if (chunksize > 2048)
 {
  c->tag_text_size = chunksize - 2048 ;
...
{ SF_CART_INFO_16K *c ;
 ...
 if (psf->cart_16k == 
# 1874 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                     ((void *)0)
# 1874 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                         )
  return -1 ;

 c = psf->cart_16k ;
 psf_binheader_writef (psf, "m4", (((uint32_t) (('c') | (('a') << 8) | (('r') << 16) | (((uint32_t) ('t')) << 24)))), 2048 + c->tag_text_size) ;
...
{ uint32_t marker, dword, vmajor = -1, vminor = -1, bytesread = 0 ;
 ...
 while (bytesread < length)
 {
  ...
  switch (marker)
  {
   ...
   case (((uint32_t) (('e') | (('v') << 8) | (('e') << 16) | (((uint32_t) ('r')) << 24)))) :
   ...
   case (((uint32_t) (('o') | (('l') << 8) | (('y') << 16) | (((uint32_t) ('m')) << 24)))) :
    bytesread += psf_binheader_readf (psf, "4", &dword) ;
    psf_log_printf (psf, "%M : %u\n", marker, dword) ;
    dword += (dword & 1) ;
    bytesread += psf_binheader_readf (psf, "j", dword) ;
   ...
   case (((uint32_t) (('e') | (('m') << 8) | (('n') << 16) | (((uint32_t) ('t')) << 24)))) :
   case (((uint32_t) (('e') | (('m') << 8) | (('d') << 16) | (((uint32_t) ('l')) << 24)))) :
   case (((uint32_t) (('e') | (('c') << 8) | (('o') << 16) | (((uint32_t) ('r')) << 24)))) :
   case (((uint32_t) (('e') | (('t') << 8) | (('i') << 16) | (((uint32_t) ('m')) << 24)))) :
   case (((uint32_t) (('e') | (('r') << 8) | (('e') << 16) | (((uint32_t) ('l')) << 24)))) :
   case (((uint32_t) (('e') | (('u') << 8) | (('c') << 16) | (((uint32_t) ('m')) << 24)))) :
    bytesread += psf_binheader_readf (psf, "4", &dword) ;
    ...
    if (marker == (((uint32_t) (('e') | (('m') << 8) | (('d') << 16) | (((uint32_t) ('l')) << 24)))) && dword == strlen (buf) )
...
{ int indx ;
 ...
 if (chunk_info->data == 
# 2034 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                        ((void *)0)
# 2034 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                            )
...
# 2041 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                                                   0
# 2041 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                                                           ) ;
 ...
 psf_fseek (psf, pos, 
# 2043 "/doner/libsndfile/libsndfile-6b46656/src/wav.c" 3 4
                     0
# 2043 "/doner/libsndfile/libsndfile-6b46656/src/wav.c"
                             ) ;
