# 1 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
# 1 "/doner/libsndfile/libsndfile-6b46656/programs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
# 34 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
...
# 35 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2
...
# 36 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2
...
# 37 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2
...
# 38 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2
...
# 39 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2
...
enum
{ SF_SEEK_SET = 
# 603 "../src/sndfile.h" 3 4
               0
# 603 "../src/sndfile.h"
                       ,
 SF_SEEK_CUR = 
# 604 "../src/sndfile.h" 3 4
              1
# 604 "../src/sndfile.h"
                      ,
 SF_SEEK_END = 
# 605 "../src/sndfile.h" 3 4
              2
...
# 41 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2

# 1 "/doner/libsndfile/libsndfile-6b46656/programs/common.h" 1
# 37 "/doner/libsndfile/libsndfile-6b46656/programs/common.h"
typedef struct
{ const char * title ;
...
# 43 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 2
...
{ static double data [4096], max ;
 ...
 { sf_command (infile, SFC_SET_NORM_DOUBLE, 
# 65 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                                           ((void *)0)
# 65 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                                               , SF_FALSE) ;
...
{ SF_BROADCAST_INFO_2K binfo ;
 ...
 if (info->description != 
# 143 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
((void *)0)
# 143 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
) { memset (binfo.description, 0, sizeof (binfo.description)) ; memcpy (binfo.description, info->description, ((strlen (info->description)) < (sizeof (binfo.description)) ? (strlen (info->description)) : (sizeof (binfo.description)))) ; } ; ;
 if (info->originator != 
# 144 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
((void *)0)
# 144 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
) { memset (binfo.originator, 0, sizeof (binfo.originator)) ; memcpy (binfo.originator, info->originator, ((strlen (info->originator)) < (sizeof (binfo.originator)) ? (strlen (info->originator)) : (sizeof (binfo.originator)))) ; } ; ;
 if (info->originator_reference != 
# 145 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
((void *)0)
# 145 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
) { memset (binfo.originator_reference, 0, sizeof (binfo.originator_reference)) ; memcpy (binfo.originator_reference, info->originator_reference, ((strlen (info->originator_reference)) < (sizeof (binfo.originator_reference)) ? (strlen (info->originator_reference)) : (sizeof (binfo.originator_reference)))) ; } ; ;
 if (info->origination_date != 
# 146 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
((void *)0)
# 146 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
) { memset (binfo.origination_date, 0, sizeof (binfo.origination_date)) ; memcpy (binfo.origination_date, info->origination_date, ((strlen (info->origination_date)) < (sizeof (binfo.origination_date)) ? (strlen (info->origination_date)) : (sizeof (binfo.origination_date)))) ; } ; ;
 if (info->origination_time != 
# 147 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
((void *)0)
# 147 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
) { memset (binfo.origination_time, 0, sizeof (binfo.origination_time)) ; memcpy (binfo.origination_time, info->origination_time, ((strlen (info->origination_time)) < (sizeof (binfo.origination_time)) ? (strlen (info->origination_time)) : (sizeof (binfo.origination_time)))) ; } ; ;
 if (info->umid != 
# 148 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
((void *)0)
# 148 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
) { memset (binfo.umid, 0, sizeof (binfo.umid)) ; memcpy (binfo.umid, info->umid, ((strlen (info->umid)) < (sizeof (binfo.umid)) ? (strlen (info->umid)) : (sizeof (binfo.umid)))) ; } ; ;


 if (info->time_ref != 
# 151 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                      ((void *)0)
# 151 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                          )
 ...
 if (info->coding_history != 
# 159 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                            ((void *)0)
# 159 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                                )
 { if (info->coding_hist_append)
  { int slen = strlen (binfo.coding_history) ;

   while (slen > 1 && 
# 163 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                     ((*__ctype_b_loc ())[(int) ((
# 163 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                     binfo.coding_history [slen - 1]
# 163 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
...
# 163 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
  ...
  { size_t slen = ((strlen (info->coding_history)) < (sizeof (binfo.coding_history)) ? (strlen (info->coding_history)) : (sizeof (binfo.coding_history))) ;
...
{
 if (info->title != 
# 188 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                   ((void *)0)
# 188 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                       )
  sf_set_string (outfile, SF_STR_TITLE, info->title) ;

 if (info->copyright != 
# 191 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                       ((void *)0)
# 191 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                           )
  sf_set_string (outfile, SF_STR_COPYRIGHT, info->copyright) ;

 if (info->artist != 
# 194 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                    ((void *)0)
# 194 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                        )
  sf_set_string (outfile, SF_STR_ARTIST, info->artist) ;

 if (info->comment != 
# 197 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                     ((void *)0)
# 197 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                         )
  sf_set_string (outfile, SF_STR_COMMENT, info->comment) ;

 if (info->date != 
# 200 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                  ((void *)0)
# 200 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                      )
  sf_set_string (outfile, SF_STR_DATE, info->date) ;

 if (info->album != 
# 203 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                   ((void *)0)
# 203 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                       )
  sf_set_string (outfile, SF_STR_ALBUM, info->album) ;

 if (info->license != 
# 206 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                     ((void *)0)
# 206 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                         )
...
{ SNDFILE *infile = 
# 215 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                   ((void *)0)
# 215 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                       , *outfile = 
# 215 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                                    ((void *)0) 
# 215 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
 ...
 if (filenames [1] == 
# 223 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                     ((void *)0)
# 223 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                         )
 ...
 if (infile == 
# 233 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
              ((void *)0)
# 233 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                  )
 ...
 if (outfile == 
# 239 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
               ((void *)0)
# 239 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                   )
...
cleanup_exit :
 ...
 if (outfile != 
# 264 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
               ((void *)0) 
# 264 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                    && outfile != infile)
  sf_close (outfile) ;

 if (infile != 
# 267 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
              ((void *)0)
# 267 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                  )
  sf_close (infile) ;
...
{ char buffer [16], *cptr ;
 ...
 if ((cptr = strrchr (str, '.')) == 
# 326 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                                   ((void *)0)
# 326 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                                       )
  return 0 ;
 ...
 for (k = 0 ; buffer [k] ; k++)
  buffer [k] = 
# 333 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
              (__extension__ ({ int __res; if (sizeof (
# 333 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
              (buffer [k])
# 333 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
...
{ SF_FORMAT_INFO info ;
 ...
 { info.format = format_map [k].format ;
  sf_command (
# 359 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
             ((void *)0)
# 359 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                 , SFC_GET_FORMAT_INFO, &info, sizeof (info)) ;
  printf ("        %-10s : %s\n", format_map [k].ext, info.name == 
# 360 "/doner/libsndfile/libsndfile-6b46656/programs/common.c" 3 4
                                                                  ((void *)0) 
# 360 "/doner/libsndfile/libsndfile-6b46656/programs/common.c"
                                                                       ? "????" : info.name) ;
  } ;
