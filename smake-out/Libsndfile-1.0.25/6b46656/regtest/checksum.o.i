# 1 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c"
# 1 "/doner/libsndfile/libsndfile-6b46656/regtest//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c"
# 23 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c"
# 1 "../src/sfconfig.h" 1
# 36 "../src/sfconfig.h"
# 1 "../src/config.h" 1
# 37 "../src/sfconfig.h" 2
# 24 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2
...
# 26 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2
...
# 27 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2
...
# 28 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2
...
# 29 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2
...
# 31 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2

# 1 "/doner/libsndfile/libsndfile-6b46656/regtest/regtest.h" 1
# 19 "/doner/libsndfile/libsndfile-6b46656/regtest/regtest.h"
...
# 33 "/doner/libsndfile/libsndfile-6b46656/regtest/checksum.c" 2
...
{ int start ;
 ...
 start = start * 999983 + info->channels ;
 start = start * 999983 + info->format ;
...
{ int k, count ;
 ...
 do
 { count = (int) sf_read_short (file, data.s, ((int) (sizeof (data.s)) / (sizeof ((data.s) [0])))) ;
  for (k = 0 ; k < count ; k++)
   start = start * 999983 + data.s [k] ;
  }
 while (count > 0) ;
...
{ int k, count ;
 ...
 do
 { count = (int) sf_read_int (file, data.i, ((int) (sizeof (data.i)) / (sizeof ((data.i) [0])))) ;
  for (k = 0 ; k < count ; k++)
   start = start * 999983 + data.i [k] ;
  }
 while (count > 0) ;
...
{ int k, count ;
 ...
 do
 { count = (int) sf_read_float (file, data.f, ((int) (sizeof (data.f)) / (sizeof ((data.f) [0])))) ;
  for (k = 0 ; k < count ; k++)
   start = start * 999983 + lrintf (0x7FFFFFFF * data.f [k]) ;
  }
 while (count > 0) ;
