# 1 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
# 33 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
...
# 34 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 2
...
# 35 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 2
...
# 36 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 2
...
# 37 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 2
...
# 39 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 2
...
{ SF_FORMAT_INFO info ;
 ...
 buffer [0] = 0 ;
 sf_command (
# 49 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 3 4
            ((void *)0)
# 49 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
 ...
 sf_command (
# 56 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 3 4
            ((void *)0)
# 56 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
                , SFC_GET_FORMAT_MAJOR_COUNT, &major_count, sizeof (int)) ;
 sf_command (
# 57 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 3 4
            ((void *)0)
# 57 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
                , SFC_GET_FORMAT_SUBTYPE_COUNT, &subtype_count, sizeof (int)) ;

 sfinfo.channels = 1 ;
 for (m = 0 ; m < major_count ; m++)
 { info.format = m ;
  sf_command (
# 62 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 3 4
             ((void *)0)
# 62 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
                 , SFC_GET_FORMAT_MAJOR, &info, sizeof (info)) ;
  ...
  { info.format = s ;
   sf_command (
# 69 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c" 3 4
              ((void *)0)
# 69 "/doner/libsndfile/libsndfile-6b46656/examples/list_formats.c"
                  , SFC_GET_FORMAT_SUBTYPE, &info, sizeof (info)) ;
