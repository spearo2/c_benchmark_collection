# 1 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c"
# 19 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c"
...
# 20 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c" 2
...
# 22 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c" 2
...
# 24 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c" 2
...
# 25 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c" 2
...
# 26 "/doner/libsndfile/libsndfile-6b46656/src/pcm.c" 2
...
{ unsigned char *ucptr ;
 ...
 while (--count >= 0)
 { ucptr -= 3 ;
  dest [count] = (((ucptr) [0] << 24) + ((ucptr) [1] << 16) + ((ucptr) [2] << 8)) ;
   } ;
}
...
{ unsigned char *ucptr ;
 ...
 while (--count >= 0)
 { ucptr -= 3 ;
  dest [count] = (((ucptr) [0] << 8) + ((ucptr) [1] << 16) + ((ucptr) [2] << 24)) ;
  } ;
}
...
{ unsigned char *ucptr ;
 ...
 while (--count >= 0)
 { ucptr -= 3 ;
  value = (((ucptr) [0] << 8) + ((ucptr) [1] << 16) + ((ucptr) [2] << 24)) ;
  dest [count] = ((float) value) * normfact ;
  } ;
}
