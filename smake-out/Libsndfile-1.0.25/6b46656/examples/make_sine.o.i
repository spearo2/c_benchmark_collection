# 1 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
# 33 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
...
# 34 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 2
...
# 35 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 2
...
# 36 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 2
...
# 37 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 2
...
# 39 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 2
# 50 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
int
main (void)
{ SNDFILE *file ;
 SF_INFO sfinfo ;
 ...
 if (! (buffer = malloc (2 * (44100 * 4) * sizeof (int))))
 ...
 { for (k = 0 ; k < (44100 * 4) ; k++)
   buffer [k] = (1.0 * 0x7F000000) * sin ((344.0 / 44100) * 2 * k * 
# 76 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 3 4
                                                    3.14159265358979323846
# 76 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
                                                        ) ;
  }
 else if (sfinfo.channels == 2)
 { for (k = 0 ; k < (44100 * 4) ; k++)
  { buffer [2 * k] = (1.0 * 0x7F000000) * sin ((344.0 / 44100) * 2 * k * 
# 80 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 3 4
                                                         3.14159265358979323846
# 80 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
                                                             ) ;
   buffer [2 * k + 1] = (1.0 * 0x7F000000) * sin ((466.0 / 44100) * 2 * k * 
# 81 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c" 3 4
                                                             3.14159265358979323846
# 81 "/doner/libsndfile/libsndfile-6b46656/examples/make_sine.c"
                                                                 ) ;
   } ;
  }
 else
 ...
 if (sf_write_int (file, buffer, sfinfo.channels * (44100 * 4)) !=
           sfinfo.channels * (44100 * 4))
