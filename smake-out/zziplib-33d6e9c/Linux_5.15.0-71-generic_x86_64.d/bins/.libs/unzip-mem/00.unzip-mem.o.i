# 1 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"
# 1 "<built-in>"
# 1 "<command-line>"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 9 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2
...
# 11 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2
...
# 12 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2
...
# 13 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2
...
# 14 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2
# 22 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"
...
# 23 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2


# 1 "/usr/include/fnmatch.h" 1 3 4
# 56 "/usr/include/fnmatch.h" 3 4
extern int fnmatch (const char *__pattern, const char *__name, int __flags);
# 26 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 2
# 53 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"
...
# 125 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 3 4
                               ((void *)0)
# 125 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"
                                   , 0);
...
static void zzip_mem_entry_direntry_done (void)
{
 ...
 verbose:
    ...
    (long) sum_usize, exp, (long) sum_csize, exp,
    (long) (100 - (sum_csize*100/sum_usize)), (long) sum_files,
    sum_files == 1 ? "file" : "files");
}

static void zzip_mem_entry_direntry(ZZIP_MEM_ENTRY* entry)
{
    char* name = ((entry)->zz_name);
    zzip_off_t usize = ((entry)->zz_usize);
    zzip_off_t csize = ((entry)->zz_csize);
    int compr = ((entry)->zz_compr);
    time_t mtime = entry->zz_mktime;
    long crc32 = entry->zz_crc32;
    const char* comment = ((entry)->zz_comment);
    char exp = ' ';
 ...
 printf("%8li%c %s %8li%c%3li%%  %s  %8lx  %s %s\n",
        (long) usize, exp, comprlevel[compr], (long) csize, exp,
        (long) (100 - (csize*100/usize)),
        _zzip_ctime(&mtime), crc32, name, comment);
    } else {
 printf(" %8li%c %s   %s %s\n",
        (long) usize, exp, _zzip_ctime(&mtime), name, comment);
    }
}
...
{
    zzip_mem_entry_direntry_start ();
    { ZZIP_MEM_ENTRY* entry = ((disk)->list);
    for (; entry ; entry = (!(entry)?(disk)->list:(entry)->zz_next))
 zzip_mem_entry_direntry (entry); };
    zzip_mem_entry_direntry_done ();
}
...
static void zzip_mem_entry_pipefiles(ZZIP_MEM_DISK* disk, char* filespec)
{
    ZZIP_MEM_ENTRY* entry = 0;
    while ((entry = zzip_mem_disk_findmatch(disk, filespec, entry, 0, 0)))
 zzip_mem_entry_pipe (disk, entry, 
# 293 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 3 4
                                  stdout
# 293 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"
                                        );
}
...
static void zzip_mem_entry_pipeall(ZZIP_MEM_DISK* disk)
{
    ...
    for (; entry ; entry = (!(entry)?(disk)->list:(entry)->zz_next))
 zzip_mem_entry_pipe (disk, entry, 
# 300 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c" 3 4
                                  stdout
# 300 "/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"
                                        );
}
...
main (int argc, char ** argv)
{
 ...
 return 0;
    ...
    {
 printf ("/home/yuntong/vulnfix/zz/zziplib/Linux_5.15.0-71-generic_x86_64.d/bins/../../bins/unzip-mem.c"" version ""zziplib"" ""0.13.62""\n");
 return 0;
    }
