# 1 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
# 66 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
...
# 67 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
...
# 69 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
...
# 70 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
...
# 71 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
# 1 "../../../src/libjasper/include/jasper/jas_string.h" 1
# 89 "../../../src/libjasper/include/jasper/jas_string.h"
char *jas_strdup(const char *);
# 72 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
...
# 73 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
...
# 75 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
# 1 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.h" 1
# 65 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.h"
typedef struct {
 int cmpt;
} pgx_enc_t;
# 76 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 2
...
# 83 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
                                         _Bool 
# 83 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
                                              bigendian, int prec,
  uint_fast32_t val);
static uint_fast32_t pgx_inttoword(int_fast32_t val, int prec, 
# 85 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
                                                              _Bool 
# 85 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
                                                                   sgnd);
...
# 98 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
_Bool 
# 98 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
     sgnd;
 int prec;
 pgx_enc_t encbuf;
 ...
 hdr.magic = 0x5047;
 hdr.bigendian = 
# 136 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
                1
# 136 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
                    ;
 hdr.sgnd = sgnd;
 hdr.prec = prec;
 hdr.width = width;
...
static int pgx_putword(jas_stream_t *out, 
# 207 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
                                         _Bool 
# 207 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
                                              bigendian, int prec,
  uint_fast32_t val)
{
 int i;
...
# 218 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
     (-1)
# 218 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
...
# 225 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c" 3 4
                                                            _Bool 
# 225 "/doner/jasper/jasper-b9be3d9/src/libjasper/pgx/pgx_enc.c"
                                                                 sgnd)
{
 uint_fast32_t ret;
