# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
# 13 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
...
# 14 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 2
...
# 15 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 2
# 23 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
static void
exampleFunc(const char *filename) {
    ...
    if (ctxt == 
# 30 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 3 4
               ((void *)0)
# 30 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
                   ) {
        fprintf(
# 31 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 3 4
               stderr
# 31 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
                     , "Failed to allocate parser context\n");
 return;
    }

    doc = xmlCtxtReadFile(ctxt, filename, 
# 35 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 3 4
                                         ((void *)0)
# 35 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
                                             , XML_PARSE_DTDVALID);

    if (doc == 
# 37 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 3 4
              ((void *)0)
# 37 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
                  ) {
        fprintf(
# 38 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 3 4
               stderr
# 38 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
                     , "Failed to parse %s\n", filename);
    } else {

        if (ctxt->valid == 0)
     fprintf(
# 42 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c" 3 4
            stderr
# 42 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/parse2.c"
