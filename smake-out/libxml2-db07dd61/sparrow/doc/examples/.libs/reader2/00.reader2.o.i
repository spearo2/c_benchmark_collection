# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
# 15 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
...
# 16 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 2
...
typedef void ( *xmlTextReaderErrorFunc)(void *arg,
 ...
 void
     xmlTextReaderGetErrorHandler(xmlTextReaderPtr reader,
      xmlTextReaderErrorFunc *f,
      void **arg);
# 17 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 2
# 26 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
static void
processNode(xmlTextReaderPtr reader) {
    ...
    if (name == 
# 31 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
               ((void *)0)
# 31 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                   )
 name = (xmlChar *) "--";
    ...
    if (value == 
# 42 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
                ((void *)0)
# 42 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                    )
 printf("\n");
    else {
...
# 68 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
                                       ((void *)0)
# 68 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                                           ,
                 XML_PARSE_DTDATTR |
   XML_PARSE_NOENT |
   XML_PARSE_DTDVALID);
    if (reader != 
# 72 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
                 ((void *)0)
# 72 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                     ) {
 ...
 if (xmlTextReaderIsValid(reader) != 1) {
     fprintf(
# 82 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
            stderr
# 82 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                  , "Document %s does not validate\n", filename);
 }
        xmlFreeTextReader(reader);
        if (ret != 0) {
            fprintf(
# 86 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
                   stderr
# 86 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                         , "%s : failed to parse\n", filename);
        }
    } else {
        fprintf(
# 89 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c" 3 4
               stderr
# 89 "/doner/libxml2/libxml2-db07dd61/libxml2/doc/examples/reader2.c"
                     , "Unable to open %s\n", filename);
    }
}
