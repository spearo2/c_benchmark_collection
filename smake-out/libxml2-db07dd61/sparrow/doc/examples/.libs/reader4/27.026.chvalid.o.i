# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
# 14 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
...
# 15 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c" 2
# 25 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
...
# 167 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
int
xmlCharInRange__internal_alias (unsigned int val, const xmlChRangeGroup *rptr) {
    ...
    if (rptr == 
# 173 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c" 3 4
               ((void *)0)
# 173 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
                   ) return(0);
    if (val < 0x10000) {
...
# 225 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
int
...
# 240 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
int
xmlIsBlank__internal_alias(unsigned int ch) {
    return((((ch) < 0x100) ? ((((ch)) == 0x20) || ((0x9 <= ((ch))) && (((ch)) <= 0xa)) || (((ch)) == 0xd)) : 0));
}
# 255 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
int
...
# 300 "/doner/libxml2/libxml2-db07dd61/libxml2/chvalid.c"
int
