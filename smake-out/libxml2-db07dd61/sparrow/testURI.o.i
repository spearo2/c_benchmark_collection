# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
# 9 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
...
int xmlNop(void);
# 10 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 2
...
# 12 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 14 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 2
...
# 16 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 2
...
# 17 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 2


static const char *base = 
# 19 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                         ((void *)0)
# 19 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                             ;
static int escape = 0;
static int debug = 0;
...
static void handleURI(const char *str) {
    ...
    xmlURIPtr uri;
    xmlChar *res = 
# 26 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                  ((void *)0)
# 26 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                      , *parsed = 
# 26 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                                  ((void *)0)
# 26 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
    ...
    if (base == 
# 30 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
               ((void *)0)
# 30 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                   ) {
 ...
 if (ret != 0)
  ...
  xmlPrintURI(
# 55 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
             stdout
# 55 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                   , uri);
  printf("\n");
     }
 }
 ...
 if (res != 
# 61 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
           ((void *)0)
# 61 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
               ) {
     printf("%s\n", (char *) res);
 }
 else
    ...
    if (res != 
# 67 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
              ((void *)0)
# 67 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                  )
 xmlFree(res);
    if (parsed != 
# 69 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                 ((void *)0)
# 69 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                     )
 xmlFree(parsed);
    xmlFreeURI(uri);
}
...
# 77 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                                     ((void *)0)
# 77 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                                         ) &&
 ((!strcmp(argv[arg], "-base")) || (!strcmp(argv[arg], "--base")))) {
 arg++;
 base = argv[arg];
 if (base != 
# 81 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
            ((void *)0)
# 81 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                )
     arg++;
    }
    if ((argc > arg) && (argv[arg] != 
# 84 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                                     ((void *)0)
# 84 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                                         ) &&
 ...
 escape++;
    ...
    if ((argc > arg) && (argv[arg] != 
# 89 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                                     ((void *)0)
# 89 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                                         ) &&
 ...
 debug++;
    ...
    if (argv[arg] == 
# 94 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                    ((void *)0)
# 94 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                        ) {
 char str[1024];
...
# 101 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                                          stdin
# 101 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                                               ) == 
# 101 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                                                    ((void *)0)
# 101 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
 ...
 while (argv[arg] != 
# 117 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c" 3 4
                    ((void *)0)
# 117 "/doner/libxml2/libxml2-db07dd61/libxml2/testURI.c"
                        ) {
     handleURI(argv[arg]);
     arg++;
 }
