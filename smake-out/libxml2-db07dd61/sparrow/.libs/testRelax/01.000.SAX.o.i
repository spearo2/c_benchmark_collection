# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
# 12 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
...
# 13 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 2
...
# 15 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 2
...
# 1 "./include/libxml/xmlerror.h" 1
# 22 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 2
# 41 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
...
initxmlDefaultSAXHandler(xmlSAXHandlerV1 *hdlr, int warning)
{
 ...
 return;
    ...
    if (warning == 0)
 hdlr->warning = 
# 72 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                ((void *)0)
# 72 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                    ;
    else
...
# 90 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
void
inithtmlDefaultSAXHandler(xmlSAXHandlerV1 *hdlr)
{
    if(hdlr->initialized == 1)
 return;
    ...
    hdlr->internalSubset = xmlSAX2InternalSubset__internal_alias;
    hdlr->externalSubset = 
# 97 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                          ((void *)0)
# 97 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                              ;
    hdlr->isStandalone = 
# 98 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                        ((void *)0)
# 98 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                            ;
    hdlr->hasInternalSubset = 
# 99 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                             ((void *)0)
# 99 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                 ;
    hdlr->hasExternalSubset = 
# 100 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                             ((void *)0)
# 100 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                 ;
    hdlr->resolveEntity = 
# 101 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                         ((void *)0)
# 101 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                             ;
    hdlr->getEntity = xmlSAX2GetEntity__internal_alias;
    hdlr->getParameterEntity = 
# 103 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                              ((void *)0)
# 103 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                  ;
    hdlr->entityDecl = 
# 104 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                      ((void *)0)
# 104 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                          ;
    hdlr->attributeDecl = 
# 105 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                         ((void *)0)
# 105 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                             ;
    hdlr->elementDecl = 
# 106 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                       ((void *)0)
# 106 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                           ;
    hdlr->notationDecl = 
# 107 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                        ((void *)0)
# 107 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                            ;
    hdlr->unparsedEntityDecl = 
# 108 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                              ((void *)0)
# 108 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                  ;
    hdlr->setDocumentLocator = xmlSAX2SetDocumentLocator__internal_alias;
    hdlr->startDocument = xmlSAX2StartDocument__internal_alias;
    hdlr->endDocument = xmlSAX2EndDocument__internal_alias;
    ...
    hdlr->endElement = xmlSAX2EndElement__internal_alias;
    hdlr->reference = 
# 114 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                     ((void *)0)
# 114 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                         ;
    hdlr->characters = xmlSAX2Characters__internal_alias;
    hdlr->cdataBlock = xmlSAX2CDataBlock__internal_alias;
...
# 137 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
void
initdocbDefaultSAXHandler(xmlSAXHandlerV1 *hdlr)
{
    if(hdlr->initialized == 1)
 return;
    ...
    hdlr->internalSubset = xmlSAX2InternalSubset__internal_alias;
    hdlr->externalSubset = 
# 144 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                          ((void *)0)
# 144 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                              ;
    hdlr->isStandalone = xmlSAX2IsStandalone__internal_alias;
    hdlr->hasInternalSubset = xmlSAX2HasInternalSubset__internal_alias;
    hdlr->hasExternalSubset = xmlSAX2HasExternalSubset__internal_alias;
    ...
    hdlr->getEntity = xmlSAX2GetEntity__internal_alias;
    hdlr->getParameterEntity = 
# 150 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                              ((void *)0)
# 150 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                  ;
    hdlr->entityDecl = xmlSAX2EntityDecl__internal_alias;
    hdlr->attributeDecl = 
# 152 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                         ((void *)0)
# 152 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                             ;
    hdlr->elementDecl = 
# 153 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                       ((void *)0)
# 153 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                           ;
    hdlr->notationDecl = 
# 154 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                        ((void *)0)
# 154 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                            ;
    hdlr->unparsedEntityDecl = 
# 155 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                              ((void *)0)
# 155 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                  ;
    hdlr->setDocumentLocator = xmlSAX2SetDocumentLocator__internal_alias;
    hdlr->startDocument = xmlSAX2StartDocument__internal_alias;
    hdlr->endDocument = xmlSAX2EndDocument__internal_alias;
    ...
    hdlr->characters = xmlSAX2Characters__internal_alias;
    hdlr->cdataBlock = 
# 163 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                      ((void *)0)
# 163 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                          ;
    hdlr->ignorableWhitespace = xmlSAX2IgnorableWhitespace__internal_alias;
    hdlr->processingInstruction = 
# 165 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 3 4
                                 ((void *)0)
# 165 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c"
                                     ;
    hdlr->comment = xmlSAX2Comment__internal_alias;
    hdlr->warning = xmlParserWarning__internal_alias;
    hdlr->error = xmlParserError__internal_alias;
...
# 1 "./include/libxml/xmlerror.h" 1
# 48 "/doner/libxml2/libxml2-db07dd61/libxml2/elfgcchack.h" 2
# 180 "/doner/libxml2/libxml2-db07dd61/libxml2/SAX.c" 2
