# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
# 9 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
...
int xmlNop(void);
# 10 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 2
...
# 12 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 2
...
# 14 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 2
...
testRegexpFile(const char *filename) {
    xmlRegexpPtr comp = 
# 38 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                       ((void *)0)
# 38 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                           ;
    FILE *input;
    ...
    if (input == 
# 44 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                ((void *)0)
# 44 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                    ) {
...
# 49 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                                            ((void *)0)
# 49 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                                                ) {
 ...
 if (len >= 0) {
  ...
  if (comp != 
# 62 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
             ((void *)0)
# 62 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 ) {
      xmlRegFreeRegexp(comp);
      comp = 
# 64 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
            ((void *)0)
# 64 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                ;
  }
  printf("Regexp: %s\n", pattern) ;
  comp = xmlRegexpCompile((const xmlChar *) pattern);
  if (comp == 
# 68 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
             ((void *)0)
# 68 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 ) {
      printf("   failed to compile\n");
      break;
  }
     } else if (comp == 
# 72 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                       ((void *)0)
# 72 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                           ) {
  printf("Regexp: %s\n", expression) ;
  comp = xmlRegexpCompile((const xmlChar *) expression);
  if (comp == 
# 75 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
             ((void *)0)
# 75 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 ) {
      printf("   failed to compile\n");
      break;
  }
     } else if (comp != 
# 79 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                       ((void *)0)
# 79 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                           ) {
  testRegexp(comp, expression);
    ...
    fclose(input);
    if (comp != 
# 85 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
               ((void *)0)
# 85 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                   )
 xmlRegFreeRegexp(comp);
}
...
runFileTest(xmlExpCtxtPtr ctxt, const char *filename) {
    xmlExpNodePtr expr = 
# 92 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                        ((void *)0)
# 92 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                            , sub;
    FILE *input;
    char expression[5000];
    int len;
    ...
    input = fopen(filename, "r");
    if (input == 
# 98 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                ((void *)0)
# 98 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                    ) {
        (*(__xmlGenericError()))((*(__xmlGenericErrorContext())),
  "Cannot open %s for reading\n", filename);
 return;
    ...
    while (fgets(expression, 4500, input) != 
# 103 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                                            ((void *)0)
# 103 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                                                ) {
 len = strlen(expression);
 len--;
 while ((len >= 0) &&
 ...
 if (len >= 0) {
  ...
  if (expr != 
# 116 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
             ((void *)0)
# 116 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 ) {
      ...
      expr = 
# 121 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
            ((void *)0)
# 121 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                ;
  }
  printf("Expression: %s\n", str) ;
  expr = xmlExpParse(ctxt, str);
  if (expr == 
# 125 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
             ((void *)0)
# 125 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 ) {
      printf("   parsing Failed\n");
      break;
  }
     } else if (expr != 
# 129 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                       ((void *)0)
# 129 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                           ) {
         int expect = -1;
  int nodes1, nodes2;
  ...
  if (sub == 
# 140 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
            ((void *)0)
# 140 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                ) {
      printf("   parsing Failed\n");
      break;
  } else {
   ...
   nodes1 += xmlExpCtxtNbNodes(ctxt) - nodes2;
    ...
    if (expr != 
# 175 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
               ((void *)0)
# 175 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                   ) {
 xmlExpFree(ctxt, expr);
 if (xmlExpCtxtNbNodes(ctxt) != 0)
     printf(" Parse/free of Expression leaked %d\n",
...
testReduce(xmlExpCtxtPtr ctxt, xmlExpNodePtr expr, const char *tst) {
    ...
    if (sub == 
# 191 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
              ((void *)0)
# 191 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                  ) {
 ...
 return;
    ...
    if (deriv == 
# 199 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                ((void *)0)
# 199 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                    ) {
...
exprDebug(xmlExpCtxtPtr ctxt, xmlExpNodePtr expr) {
    ...
    if (expr == 
# 225 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
               ((void *)0)
# 225 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                   ) {
 ...
 for (i = 0;i < ret;i++) {
     ...
     if (deriv == 
# 243 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                 ((void *)0)
# 243 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                     ) {
...
static void usage(const char *name) {
    fprintf(
# 259 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 259 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "Usage: %s [flags]\n", name);
    fprintf(
# 260 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 260 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "Testing tool for libxml2 string and pattern regexps\n");
    fprintf(
# 261 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 261 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "   --debug: switch on debugging\n");
    fprintf(
# 262 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 262 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "   --repeat: loop on the operation\n");

    fprintf(
# 264 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 264 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "   --expr: test xmlExp and not xmlRegexp\n");

    fprintf(
# 266 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 266 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "   --input filename: use the given filename for regexp\n");
    fprintf(
# 267 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
           stderr
# 267 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                 , "   --input filename: use the given filename for exp\n");
}

int main(int argc, char **argv) {
    xmlRegexpPtr comp = 
# 271 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                       ((void *)0)
# 271 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                           ;

    xmlExpNodePtr expr = 
# 273 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                        ((void *)0)
# 273 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                            ;
    int use_exp = 0;
    xmlExpCtxtPtr ctxt = 
# 275 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                        ((void *)0)
# 275 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                            ;

    const char *pattern = 
# 277 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                         ((void *)0)
# 277 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                             ;
    char *filename = 
# 278 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                    ((void *)0)
# 278 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                        ;
    int i;
 ...
 if ((!strcmp(argv[i], "-debug")) || (!strcmp(argv[i], "--debug"))) {
     ...
     fprintf(
# 310 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
            stderr
# 310 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                  , "Unknown option %s\n", argv[i]);
     usage(argv[0]);
 }
    }
...
# 317 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                        ((void *)0)
# 317 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                            );


    if (filename != 
# 320 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                   ((void *)0)
# 320 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                       ) {
     ...
     for (i = 1; i < argc ; i++) {
      ...
      (data == 1)) {
      if (pattern == 
# 337 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                    ((void *)0)
# 337 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                        ) {
   pattern = argv[i];
   printf("Testing expr %s:\n", pattern);
   expr = xmlExpParse(ctxt, pattern);
   if (expr == 
# 341 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
              ((void *)0)
# 341 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                  ) {
       printf("   failed to compile\n");
       break;
   }
   ...
   testReduce(ctxt, expr, argv[i]);
     ...
     if (expr != 
# 353 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                ((void *)0)
# 353 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                    ) {
  xmlExpFree(ctxt, expr);
  expr = 
# 355 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
        ((void *)0)
# 355 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
            ;
     }
 } else
     ...
     for (i = 1; i < argc ; i++) {
      ...
      data = 1;
           ...
           (data == 1)) {
      if (pattern == 
# 365 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                    ((void *)0)
# 365 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                        ) {
   pattern = argv[i];
   printf("Testing %s:\n", pattern);
   comp = xmlRegexpCompile((const xmlChar *) pattern);
   if (comp == 
# 369 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
              ((void *)0)
# 369 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                  ) {
       printf("   failed to compile\n");
       break;
   }
   if (debug)
       xmlRegexpPrint(
# 374 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                     stdout
# 374 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                           , comp);
      } else {
   testRegexp(comp, argv[i]);
     ...
     if (comp != 
# 380 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
                ((void *)0)
# 380 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                    )
  xmlRegFreeRegexp(comp);
        }
    }
    ...
    if (ctxt != 
# 385 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c" 3 4
               ((void *)0)
# 385 "/doner/libxml2/libxml2-db07dd61/libxml2/testRegexp.c"
                   ) {
