# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
# 9 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
...
int xmlNop(void);
# 10 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
# 14 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
# 17 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
# 25 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
# 28 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
# 31 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
# 37 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
typedef int (* xmlShellCmd) (xmlShellCtxtPtr ctxt,
 ...
 xmlShell (xmlDocPtr doc,
     ...
     xmlShellReadlineFunc input,
     FILE *output);
# 45 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
typedef enum {
 ...
 int
      ...
      xmlDocPtr doc,
      xmlNodePtr elem);
# 46 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 2
...
int main(int argc, char **argv) {
    ...
    int files = 0;
    xmlRelaxNGPtr schema = 
# 60 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                          ((void *)0)
# 60 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                              ;
 ...
 if (argv[i][0] != '-') {
     if (schema == 
# 84 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                  ((void *)0)
# 84 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                      ) {
  xmlRelaxNGParserCtxtPtr ctxt;
  ...
  if (memory) {
   ...
   break;
      if ((fd = open(argv[i], 
# 94 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                             00
# 94 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                                     )) < 0)
   break;
      base = mmap(
# 96 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                 ((void *)0)
# 96 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                     , info.st_size, 
# 96 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                                     0x1
# 96 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
...
# 97 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
          0x01
# 97 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                    , fd, 0) ;
      if (base == (void *) 
# 98 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                          ((void *) -1)
# 98 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                                    )
   break;
...
# 106 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
      stderr
# 106 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
            );
...
# 117 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
      stderr
# 117 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
            );
      schema = xmlRelaxNGParse(ctxt);
      xmlRelaxNGFreeParserCtxt(ctxt);
  }
  if (schema == 
# 121 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
               ((void *)0)
# 121 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                   ) {
  ...
  if (debug)
      xmlRelaxNGDump(
# 129 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                    stdout
# 129 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                          , schema);

  if (tree)
      xmlRelaxNGDumpTree(
# 132 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                        stdout
# 132 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                              , schema);
...
# 137 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                           ((void *)0)
# 137 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                               ,0);

  if (doc == 
# 139 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
            ((void *)0)
# 139 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                ) {
      fprintf(
# 140 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
             stderr
# 140 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                   , "Could not parse %s\n", argv[i]);
  } else {
...
# 149 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
      stderr
# 149 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
            );
   ...
   printf("%s validation generated an internal error\n",
    ...
    if (schema != 
# 166 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c" 3 4
                 ((void *)0)
# 166 "/doner/libxml2/libxml2-db07dd61/libxml2/testRelax.c"
                     )
