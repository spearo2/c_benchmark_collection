# 1 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
# 19 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
...
# 20 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 2
# 1 "../bfd/bfd.h" 1
# 44 "../bfd/bfd.h"
...
# 21 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 2
...
# 22 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 2

static char ftypelet (unsigned long);
static void setst (unsigned long, char *);
# 106 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
void
mode_string (unsigned long mode, char *str)
{
  str[0] = ftypelet ((unsigned long) mode);
  str[1] = (mode & 
# 110 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  0400
# 110 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'r' : '-';
  str[2] = (mode & 
# 111 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  0200
# 111 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'w' : '-';
  str[3] = (mode & 
# 112 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  0100
# 112 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'x' : '-';
  str[4] = (mode & 
# 113 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  (0400 >> 3)
# 113 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'r' : '-';
  str[5] = (mode & 
# 114 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  (0200 >> 3)
# 114 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'w' : '-';
  str[6] = (mode & 
# 115 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  (0100 >> 3)
# 115 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'x' : '-';
  str[7] = (mode & 
# 116 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  ((0400 >> 3) >> 3)
# 116 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'r' : '-';
  str[8] = (mode & 
# 117 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  ((0200 >> 3) >> 3)
# 117 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'w' : '-';
  str[9] = (mode & 
# 118 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
                  ((0100 >> 3) >> 3)
# 118 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                         ) != 0 ? 'x' : '-';
  setst ((unsigned long) mode, str);
}
# 181 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
static char
ftypelet (unsigned long bits)
{
  if (
# 184 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     ((((
# 184 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
     bits
# 184 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     )) & 0170000) == (0040000))
# 184 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
    ...
    return 'd';
  if (
# 186 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     ((((
# 186 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
     bits
# 186 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     )) & 0170000) == (0120000))
# 186 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
    ...
    return 'l';
  if (
# 188 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     ((((
# 188 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
     bits
# 188 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     )) & 0170000) == (0060000))
# 188 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
    ...
    return 'b';
  if (
# 190 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     ((((
# 190 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
     bits
# 190 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     )) & 0170000) == (0020000))
# 190 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
    ...
    return 'c';
  if (
# 192 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     ((((
# 192 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
     bits
# 192 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     )) & 0170000) == (0140000))
# 192 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
    ...
    return 's';
  if (
# 194 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     ((((
# 194 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
     bits
# 194 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
     )) & 0170000) == (0010000))
# 194 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
    ...
    return 'p';
# 209 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
  return '-';
}
...
setst (unsigned long bits __attribute__ ((__unused__)), char *chars __attribute__ ((__unused__)))
{
  ...
  if (bits & 
# 219 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
            04000
# 219 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                   )
    {
      if (chars[3] != 'x')
 ...
 chars[3] = 's';
  ...
  if (bits & 
# 229 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
            02000
# 229 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                   )
    {
      if (chars[6] != 'x')
 ...
 chars[6] = 's';
  ...
  if (bits & 
# 239 "/doner/binutils/binutils-515f23e/binutils/filemode.c" 3 4
            01000
# 239 "/doner/binutils/binutils-515f23e/binutils/filemode.c"
                   )
    {
      if (chars[9] != 'x')
