# 1 "/doner/binutils/binutils-515f23e/binutils/size.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/binutils/size.c"
# 31 "/doner/binutils/binutils-515f23e/binutils/size.c"
...
# 32 "/doner/binutils/binutils-515f23e/binutils/size.c" 2
# 1 "../bfd/bfd.h" 1
# 44 "../bfd/bfd.h"
...
# 33 "/doner/binutils/binutils-515f23e/binutils/size.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/binutils/size.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 35 "/doner/binutils/binutils-515f23e/binutils/size.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/binutils/size.c" 2
...
static char *target = 
# 77 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                     ((void *)0)
# 77 "/doner/binutils/binutils-515f23e/binutils/size.c"
                         ;
...
usage (FILE *stream, int status)
{
  ...
  fprintf (stream, gettext (" Displays the sizes of sections inside binary files\n"));
  fprintf (stream, gettext (" If no input file(s) are specified, a.out is assumed\n"));
  fprintf (stream, gettext (" The options are:\n  -A|-B|-G  --format={sysv|berkeley|gnu}  Select output style (default is %s)\n  -o|-d|-x  --radix={8|10|16}         Display numbers in octal, decimal or hex\n  -t        --totals                  Display the total sizes (Berkeley only)\n  -f                                  Ignored.\n            --common                  Display total size for *COM* syms\n            --target=<bfdname>        Set the binary file format\n            @<file>                   Read options from <file>\n  -h|-H|-?  --help                    Display this information\n  -v|-V     --version                 Display the program's version\n\n")
# 101 "/doner/binutils/binutils-515f23e/binutils/size.c"
    ,
...
{
  {"common", 0, &show_common, 1},
  {"format", 1, 0, (200)},
  {"radix", 1, 0, ((200) + 1)},
  {"target", 1, 0, (((200) + 1) + 1)},
  {"totals", 0, &show_totals, 1},
...
main (int argc, char **argv)
{
  ...
  setlocale (
# 139 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
            5
# 139 "/doner/binutils/binutils-515f23e/binutils/size.c"
                       , "");

  setlocale (
# 141 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
            0
# 141 "/doner/binutils/binutils-515f23e/binutils/size.c"
                    , "");
  ...
  while ((c = getopt_long (argc, argv, "ABGHhVvdfotx", long_options,
      (int *) 0)) != 
# 156 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                    (-1)
# 156 "/doner/binutils/binutils-515f23e/binutils/size.c"
                       )
    switch (c)
      {
      case (200):
 switch (*optarg)
   ...
   case 'g':
     ...
     break;
   default:
     non_fatal (gettext ("invalid argument to --format: %s"), optarg);
     usage (
# 176 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
           stderr
# 176 "/doner/binutils/binutils-515f23e/binutils/size.c"
                 , 1);
   }
 break;
 ...
 switch (temp)
   ...
   case 16:
     ...
     break;
   default:
     non_fatal (gettext ("Invalid radix: %s\n"), optarg);
     usage (
# 203 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
           stderr
# 203 "/doner/binutils/binutils-515f23e/binutils/size.c"
                 , 1);
   }
 break;
 ...
 break;
      case 'f':
# 241 "/doner/binutils/binutils-515f23e/binutils/size.c"
 break;
      case 0:
 break;
      case 'h':
      ...
      case '?':
 usage (
# 247 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
       stderr
# 247 "/doner/binutils/binutils-515f23e/binutils/size.c"
             , 1);
      }
  ...
  if (show_help)
    usage (
# 253 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
          stdout
# 253 "/doner/binutils/binutils-515f23e/binutils/size.c"
                , 0);
 ...
 rprint_number (col_width, total);
      putchar(sep_char);
      fputs ("(TOTALS)\n", 
# 280 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                          stdout
# 280 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                );
    }
...
{
  asymbol **syms = 
# 291 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                  ((void *)0)
# 291 "/doner/binutils/binutils-515f23e/binutils/size.c"
                      ;
  long storage, symcount;

  common_size = 0;
  if ((bfd_get_file_flags (abfd) & (0x2 | 0x40 | 0x10)) != 0x10)
    return;
  ...
  if (bfd_check_format_matches (abfd, bfd_core, &matching))
    {
      ...
      print_sizes (abfd);
      fputs (" (core file", 
# 350 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                           stdout
# 350 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                 );
...
{
  bfd *arfile = (bfd *) 
# 371 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                       ((void *)0)
# 371 "/doner/binutils/binutils-515f23e/binutils/size.c"
                           ;
  bfd *last_arfile = (bfd *) 
# 372 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                            ((void *)0)
# 372 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                ;
  ...
  for (;;)
    {
      ...
      if (arfile == 
# 379 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                   ((void *)0)
# 379 "/doner/binutils/binutils-515f23e/binutils/size.c"
                       )
 {
   ...
   break;
      ...
      if (last_arfile != 
# 391 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                        ((void *)0)
# 391 "/doner/binutils/binutils-515f23e/binutils/size.c"
                            )
 {
  ...
  if (last_arfile != 
# 403 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                    ((void *)0)
# 403 "/doner/binutils/binutils-515f23e/binutils/size.c"
                        )
    bfd_close (last_arfile);
}
...
display_file (char *filename)
{
  ...
  if (file == 
# 419 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
             ((void *)0)
# 419 "/doner/binutils/binutils-515f23e/binutils/size.c"
                 )
    {
...
size_number (bfd_size_type num)
{
  ...
  sprintf (buffer, (radix == decimal ? "%" 
# 444 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                                          "l" "u"
      
# 445 "/doner/binutils/binutils-515f23e/binutils/size.c"
     : radix == octal ? "0%" 
# 445 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                             "l" "o" 
# 445 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                    : "0x%" 
# 445 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
...
rprint_number (int width, bfd_size_type num)
{
  ...
  sprintf (buffer, (radix == decimal ? "%" 
# 456 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                                          "l" "u"
      
# 457 "/doner/binutils/binutils-515f23e/binutils/size.c"
     : radix == octal ? "0%" 
# 457 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                             "l" "o" 
# 457 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                    : "0x%" 
# 457 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
...
static void
berkeley_or_gnu_sum (bfd *abfd __attribute__ ((__unused__)), sec_ptr sec,
...
print_berkeley_or_gnu_format (bfd *abfd)
{
  ...
  bfd_map_over_sections (abfd, berkeley_or_gnu_sum, 
# 501 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                                                   ((void *)0)
# 501 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                                       );
 ...
 puts ("      text       data        bss      total filename");
  ...
  putchar (sep_char);
  fputs (bfd_get_filename (abfd), 
# 536 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                                 stdout
# 536 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                       );
...
static void
sysv_internal_sizer (bfd *file __attribute__ ((__unused__)), sec_ptr sec,
       void *ignore __attribute__ ((__unused__)))
{
...
static void
sysv_internal_printer (bfd *file __attribute__ ((__unused__)), sec_ptr sec,
         void *ignore __attribute__ ((__unused__)))
{
  flagword flags = bfd_section_flags (sec);
  if (flags == 0)
...
print_sysv_format (bfd *file)
{
  ...
  svi_maxvma = 0;
  svi_namelen = 0;
  bfd_map_over_sections (file, sysv_internal_sizer, 
# 614 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                                                   ((void *)0)
# 614 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                                       );
  if (show_common)
    {
 ...
 svi_namelen = sizeof ("*COM*") - 1;
  ...
  bfd_map_over_sections (file, sysv_internal_printer, 
# 640 "/doner/binutils/binutils-515f23e/binutils/size.c" 3 4
                                                     ((void *)0)
# 640 "/doner/binutils/binutils-515f23e/binutils/size.c"
                                                         );
  if (show_common)
    {
      svi_total += common_size;
