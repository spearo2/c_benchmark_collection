# 1 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
# 21 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
# 1 "/doner/binutils/binutils-515f23e/binutils/config.h" 1
# 22 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
# 34 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
# 1 "../bfd/bfd.h" 1
# 44 "../bfd/bfd.h"
...
# 35 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
extern char *make_qualified_name (struct archive_info *,
      struct archive_info *,
      const char *);
# 36 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2

# 1 "./../include/elf/common.h" 1
# 39 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 40 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 41 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 43 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 45 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 46 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2
...
# 74 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 2


# 75 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
...
update_gnu_property (const char *file_name, FILE *file)
{
  ...
  if (elf_header.e_machine != 3
    ...
    {
      error (gettext ("%s: Not an i386 nor x86-64 ELF file\n"), file_name);
      return 0;
    }

  if (fstat (fileno (file), &st_buf) < 0)
    {
      error (gettext ("%s: stat () failed\n"), file_name);
      return 1;
    }

  map = mmap (
# 103 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
             ((void *)0)
# 103 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                 , st_buf.st_size, 
# 103 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                   0x1 
# 103 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
...
# 104 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
      0x01
# 104 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                , fileno (file), 0);
  if (map == 
# 105 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
            ((void *) -1)
# 105 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      )
    {
      error (gettext ("%s: mmap () failed\n"), file_name);
      return 0;
    }
 ...
 {
   phdrs[i].p_type = byte_get (phdrs32[i].p_type, sizeof (phdrs32[i].p_type));
   phdrs[i].p_offset = byte_get (phdrs32[i].p_offset, sizeof (phdrs32[i].p_offset));
   phdrs[i].p_vaddr = byte_get (phdrs32[i].p_vaddr, sizeof (phdrs32[i].p_vaddr));
   phdrs[i].p_paddr = byte_get (phdrs32[i].p_paddr, sizeof (phdrs32[i].p_paddr));
   phdrs[i].p_filesz = byte_get (phdrs32[i].p_filesz, sizeof (phdrs32[i].p_filesz));
   phdrs[i].p_memsz = byte_get (phdrs32[i].p_memsz, sizeof (phdrs32[i].p_memsz));
   phdrs[i].p_flags = byte_get (phdrs32[i].p_flags, sizeof (phdrs32[i].p_flags));
   phdrs[i].p_align = byte_get (phdrs32[i].p_align, sizeof (phdrs32[i].p_align));
 }
    }
  else
    {
 ...
 = (Elf64_External_Phdr *) (map + elf_header.e_phoff);
      for (i = 0; i < elf_header.e_phnum; i++)
 {
   phdrs[i].p_type = byte_get (phdrs64[i].p_type, sizeof (phdrs64[i].p_type));
   phdrs[i].p_offset = byte_get (phdrs64[i].p_offset, sizeof (phdrs64[i].p_offset));
   phdrs[i].p_vaddr = byte_get (phdrs64[i].p_vaddr, sizeof (phdrs64[i].p_vaddr));
   phdrs[i].p_paddr = byte_get (phdrs64[i].p_paddr, sizeof (phdrs64[i].p_paddr));
   phdrs[i].p_filesz = byte_get (phdrs64[i].p_filesz, sizeof (phdrs64[i].p_filesz));
   phdrs[i].p_memsz = byte_get (phdrs64[i].p_memsz, sizeof (phdrs64[i].p_memsz));
   phdrs[i].p_flags = byte_get (phdrs64[i].p_flags, sizeof (phdrs64[i].p_flags));
   phdrs[i].p_align = byte_get (phdrs64[i].p_align, sizeof (phdrs64[i].p_align));
 }
    }
 ...
 while (p < buf + size)
   {
     ...
     if (
# 161 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
        __builtin_offsetof (
# 161 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
        Elf_External_Note
# 161 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
        , 
# 161 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
...
# 161 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
  ...
  goto out;
     ...
     in.type = byte_get (xnp->type, sizeof (xnp->type));
     in.namesz = byte_get (xnp->namesz, sizeof (xnp->namesz));
  ...
  goto out;
     ...
     in.descsz = byte_get (xnp->descsz, sizeof (xnp->descsz));
     in.descdata = p + (((bfd_vma) (
# 177 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                      __builtin_offsetof (
# 177 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      Elf_External_Note
# 177 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                      , 
# 177 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
...
# 177 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      + (in.namesz)) + (((align)) - 1)) & ~ (bfd_vma) (((align)) -1));
  ...
  do
   ...
   goto out;
      ...
      ptr += (((bfd_vma) (datasz) + ((align) - 1)) & ~ (bfd_vma) ((align) -1));
    }
  while ((ptr_end - ptr) >= 8);
       }

     p += (((bfd_vma) ((((bfd_vma) (
# 240 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
         __builtin_offsetof (
# 240 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
         Elf_External_Note
# 240 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
         , 
# 240 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
...
# 240 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
         + ((in.namesz))) + ((((align))) - 1)) & ~ (bfd_vma) ((((align))) -1)) + (in.descsz)) + (((align)) - 1)) & ~ (bfd_vma) (((align)) -1));
   }
      }

 out:
  if (ret != 0)
    error (gettext ("%s: Invalid PT_NOTE segment\n"), file_name);
...
elf_x86_feature (const char *feature, int enable)
{
  ...
  if (strcasecmp (feature, "ibt") == 0)
    ...
    {
      error (gettext ("Unknown x86 feature: %s\n"), feature);
      return -1;
    }
...
update_elf_header (const char *file_name, FILE *file)
{
  ...
  if (elf_header.e_ident[6] != 1)
    {
      error
 (gettext ("%s: Unsupported EI_VERSION: %d is not %d\n"),
  file_name, elf_header.e_ident[6],
  1);
      return 0;
    }
  ...
  if (input_elf_class != ELF_CLASS_BOTH
    ...
    {
      error
 (gettext ("%s: Unmatched input EI_CLASS: %d is not %d\n"),
  ...
  if (output_elf_class != ELF_CLASS_BOTH
    ...
    {
      error
 (gettext ("%s: Unmatched output EI_CLASS: %d is not %d\n"),
  ...
  if (input_elf_machine != -1 && machine != input_elf_machine)
    {
      error
 (gettext ("%s: Unmatched e_machine: %d is not %d\n"),
  ...
  if (input_elf_type != -1 && type != input_elf_type)
    {
      error
 (gettext ("%s: Unmatched e_type: %d is not %d\n"),
  file_name, type, input_elf_type);
      return 0;
    }

  osabi = elf_header.e_ident[7];


  if (input_elf_osabi != -1 && osabi != input_elf_osabi)
    {
      error
 (gettext ("%s: Unmatched EI_OSABI: %d is not %d\n"),
  file_name, osabi, input_elf_osabi);
      return 0;
    }

  abiversion = elf_header.e_ident[8];
  ...
  if (input_elf_abiversion != -1
    ...
    {
      error
 (gettext ("%s: Unmatched EI_ABIVERSION: %d is not %d\n"),
 ...
 byte_put (ehdr32.e_machine, output_elf_machine, sizeof (ehdr32.e_machine));
      if (output_elf_type != -1)
 byte_put (ehdr32.e_type, output_elf_type, sizeof (ehdr32.e_type));
      if (output_elf_osabi != -1)
 ehdr32.e_ident[7] = output_elf_osabi;
      if (output_elf_abiversion != -1)
 ehdr32.e_ident[8] = output_elf_abiversion;
      status = fwrite (&ehdr32, sizeof (ehdr32), 1, file) == 1;
      break;
    case 2:
      if (output_elf_machine != -1)
 byte_put (ehdr64.e_machine, output_elf_machine, sizeof (ehdr64.e_machine));
      if (output_elf_type != -1)
 byte_put (ehdr64.e_type, output_elf_type, sizeof (ehdr64.e_type));
      if (output_elf_osabi != -1)
 ehdr64.e_ident[7] = output_elf_osabi;
      if (output_elf_abiversion != -1)
 ehdr64.e_ident[8] = output_elf_abiversion;
      status = fwrite (&ehdr64, sizeof (ehdr64), 1, file) == 1;
      break;
    }

  if (status != 1)
    error (gettext ("%s: Failed to update ELF header: %s\n"),
        file_name, strerror (
# 430 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                            (*__errno_location ())
# 430 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                 ));
...
get_file_header (FILE * file)
{
  ...
  switch (elf_header.e_ident[4])
    ...
    case 1:
      if (fread (ehdr32.e_type, sizeof (ehdr32) - 16,
   1, file) != 1)
 return 0;
    ...
    case 2:
      ...
      if (sizeof (bfd_vma) < 8)
 {
   error (gettext ("This executable has been built without support for a\n64 bit data type and so it cannot process 64 bit ELF files.\n")
                                                               );
   return 0;
 }

      if (fread (ehdr64.e_type, sizeof (ehdr64) - 16,
   1, file) != 1)
 return 0;
...
process_object (const char *file_name, FILE *file)
{
  ...
  if (! get_file_header (file))
    {
      error (gettext ("%s: Failed to read ELF header\n"), file_name);
      return 1;
    }


  if (fseek (file, offset, 
# 545 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                          0
# 545 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                  ) != 0)
    {
      error (gettext ("%s: Failed to seek to ELF header\n"), file_name);
    }
...
# 561 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
  _Bool 
# 561 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
       is_thin_archive)
{
  ...
  arch.file_name = 
# 570 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                  ((void *)0)
# 570 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      ;
  arch.file = 
# 571 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
             ((void *)0)
# 571 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                 ;
  arch.index_array = 
# 572 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                    ((void *)0)
# 572 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                        ;
  arch.sym_table = 
# 573 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                  ((void *)0)
# 573 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      ;
  arch.longnames = 
# 574 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                  ((void *)0)
# 574 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      ;
...
# 579 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                         ((void *)0)
# 579 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                             ;
  nested_arch.file = 
# 580 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                    ((void *)0)
# 580 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                        ;
  nested_arch.index_array = 
# 581 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                           ((void *)0)
# 581 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                               ;
  nested_arch.sym_table = 
# 582 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                         ((void *)0)
# 582 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                             ;
  nested_arch.longnames = 
# 583 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                         ((void *)0)
# 583 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                             ;

  if (fstat (fileno (file), &statbuf) < 0
      || setup_archive (&arch, file_name, file, statbuf.st_size,
   is_thin_archive, 
# 587 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                   0
# 587 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                        ) != 0)
    {
      ret = 1;
      goto out;
...
# 602 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                              0
# 602 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                                      ) != 0)
        {
...
# 628 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                                      ((void *)0)
# 628 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                                          , 10);
      ...
      if (name == 
# 633 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                 ((void *)0)
# 633 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                     )
 {
   ...
   break;
      ...
      if (qualified_name == 
# 642 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                           ((void *)0)
# 642 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                               )
 {
   error (gettext ("%s: bad archive file name\n"), file_name);
   free (name);
   ...
   free (name);
          if (member_file_name == 
# 657 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                 ((void *)0)
# 657 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                     )
            {
       free (qualified_name);
              ret = 1;
          ...
          if (member_file == 
# 665 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                            ((void *)0)
# 665 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                )
            {
...
# 692 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
      0
# 692 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
              ) != 0)
            {
 ...
 out:
  if (nested_arch.file != 
# 716 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                         ((void *)0)
# 716 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                             )
...
check_file (const char *file_name, struct stat *statbuf_p)
{
  ...
  if (statbuf_p == 
# 729 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                  ((void *)0)
# 729 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                      )
    statbuf_p = &statbuf;
  ...
  if (stat (file_name, statbuf_p) < 0)
    {
      if (
# 734 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
         (*__errno_location ()) 
# 734 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
               == 
# 734 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                  2
# 734 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
 ...
 error (gettext ("Could not locate '%s'.  System error message: %s\n"),
     file_name, strerror (
# 738 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                         (*__errno_location ())
# 738 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                              ));
      return 1;
    }
# 756 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
  if (! 
# 756 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
       ((((
# 756 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
       statbuf_p->st_mode
# 756 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
...
# 772 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                            ((void *)0)
# 772 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                ))
    return 1;

  file = fopen (file_name, "r+b");
  if (file == 
# 776 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
             ((void *)0)
# 776 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                 )
    {
      error (gettext ("Input file '%s' is not readable\n"), file_name);
      return 1;
...
# 791 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                           0
# 791 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                                );
  else if (memcmp (armag, "!<thin>\012", 8) == 0)
    ret = process_archive (file_name, file, 
# 793 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                           1
# 793 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                               );
  else
    {
      rewind (file);
...
elf_machine (const char *mach)
{
  ...
  error (gettext ("Unknown machine type: %s\n"), mach);
...
{
  {"input-mach", 1, 0, OPTION_INPUT_MACH},
  {"output-mach", 1, 0, OPTION_OUTPUT_MACH},
  {"input-type", 1, 0, OPTION_INPUT_TYPE},
  {"output-type", 1, 0, OPTION_OUTPUT_TYPE},
  {"input-osabi", 1, 0, OPTION_INPUT_OSABI},
  {"output-osabi", 1, 0, OPTION_OUTPUT_OSABI},
  {"input-abiversion", 1, 0, OPTION_INPUT_ABIVERSION},
  {"output-abiversion", 1, 0, OPTION_OUTPUT_ABIVERSION},

  {"enable-x86-feature",
   1, 0, OPTION_ENABLE_X86_FEATURE},
  {"disable-x86-feature",
   1, 0, OPTION_DISABLE_X86_FEATURE},
...
{
  unsigned int i;
  char *osabi = concat (osabis[0].name, 
# 938 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                       ((void *)0)
# 938 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                           );

  for (i = 1; i < (sizeof (osabis) / sizeof ((osabis)[0])); i++)
    osabi = reconcat (osabi, osabi, "|", osabis[i].name, 
# 941 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                                                        ((void *)0)
# 941 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                                            );

  fprintf (stream, gettext ("Usage: %s <option(s)> elffile(s)\n"),
    program_name);
  fprintf (stream, gettext (" Update the ELF header of ELF files\n"));
  fprintf (stream, gettext (" The options are:\n"));
  fprintf (stream, gettext ("  --input-mach [none|i386|iamcu|l1om|k1om|x86_64]\n                              Set input machine type\n  --output-mach [none|i386|iamcu|l1om|k1om|x86_64]\n                              Set output machine type\n  --input-type [none|rel|exec|dyn]\n                              Set input file type\n  --output-type [none|rel|exec|dyn]\n                              Set output file type\n  --input-osabi [%s]\n                              Set input OSABI\n  --output-osabi [%s]\n                              Set output OSABI\n  --input-abiversion [0-255]  Set input ABIVERSION\n  --output-abiversion [0-255] Set output ABIVERSION\n")
# 961 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                                       ,
    osabi, osabi);

  fprintf (stream, gettext ("  --enable-x86-feature [ibt|shstk|lam_u48|lam_u57]\n                              Enable x86 feature\n  --disable-x86-feature [ibt|shstk|lam_u48|lam_u57]\n                              Disable x86 feature\n")
...
main (int argc, char ** argv)
{
  ...
  setlocale (
# 988 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
            5
# 988 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                       , "");

  setlocale (
# 990 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
            0
# 990 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                    , "");
  ...
  while ((c = getopt_long (argc, argv, "hv",
      options, (int *) 0)) != 
# 997 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
                             (-1)
# 997 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                                )
    {
      switch (c)
 {
 ...
 case OPTION_INPUT_ABIVERSION:
   ...
   if (*end != '\0'
     ...
     {
       error (gettext ("Invalid ABIVERSION: %s\n"), optarg);
       return 1;
     }
   break;
 ...
 case 'h':
   usage (
# 1078 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
         stdout
# 1078 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
               , 0);
 ...
 default:
   usage (
# 1085 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
         stderr
# 1085 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
               , 1);
 }
    }
  ...
  && ! disable_x86_features
   ...
   && output_elf_abiversion == -1))
    usage (
# 1098 "/doner/binutils/binutils-515f23e/binutils/elfedit.c" 3 4
          stderr
# 1098 "/doner/binutils/binutils-515f23e/binutils/elfedit.c"
                , 1);
