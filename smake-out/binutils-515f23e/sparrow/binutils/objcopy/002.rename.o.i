# 1 "/doner/binutils/binutils-515f23e/binutils/rename.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/binutils/rename.c"
# 21 "/doner/binutils/binutils-515f23e/binutils/rename.c"
...
# 22 "/doner/binutils/binutils-515f23e/binutils/rename.c" 2
# 1 "../bfd/bfd.h" 1
# 44 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-515f23e/binutils/rename.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/binutils/rename.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/binutils/rename.c" 2
# 37 "/doner/binutils/binutils-515f23e/binutils/rename.c"

# 37 "/doner/binutils/binutils-515f23e/binutils/rename.c"
static int
simple_copy (int fromfd, const char *to,
      struct stat *target_stat __attribute__ ((__unused__)))
{
  int tofd, nread;
  int saved;
  char buf[8192];
  ...
  if (fromfd < 0
      || lseek (fromfd, 0, 
# 46 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                          0
# 46 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                                  ) != 0)
    return -1;

  tofd = open (to, 
# 49 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                  01 
# 49 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                           | 
# 49 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                             01000 
# 49 "/doner/binutils/binutils-515f23e/binutils/rename.c"
  ...
  if (tofd < 0)
    {
      saved = 
# 52 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
             (*__errno_location ())
# 52 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                  ;
      close (fromfd);
      
# 54 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
     (*__errno_location ()) 
# 54 "/doner/binutils/binutils-515f23e/binutils/rename.c"
           = saved;
      return -1;
    }
 ...
 {
   saved = 
# 62 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
          (*__errno_location ())
# 62 "/doner/binutils/binutils-515f23e/binutils/rename.c"
               ;
   close (fromfd);
   close (tofd);
   
# 65 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
  (*__errno_location ()) 
# 65 "/doner/binutils/binutils-515f23e/binutils/rename.c"
        = saved;
   return -1;
 }
    }
  ...
  saved = 
# 70 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
         (*__errno_location ())
# 70 "/doner/binutils/binutils-515f23e/binutils/rename.c"
              ;
  ...
  if (target_stat != 
# 75 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                    ((void *)0)
# 75 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                        )
...
# 83 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
     (*__errno_location ()) 
# 83 "/doner/binutils/binutils-515f23e/binutils/rename.c"
           = saved;
      return -1;
    }
  return 0;
}
# 105 "/doner/binutils/binutils-515f23e/binutils/rename.c"
static inline long int get_stat_atime_ns (struct stat const *) __attribute__ ((__unused__));
static inline long int get_stat_mtime_ns (struct stat const *) __attribute__ ((__unused__));


static inline long int
get_stat_atime_ns (struct stat const *st __attribute__ ((__unused__)))
{
...
static inline long int
get_stat_mtime_ns (struct stat const *st __attribute__ ((__unused__)))
{
...
set_times (const char *destination, const struct stat *statbuf)
{
  ...
  result = utimensat (
# 176 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                     -100
# 176 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                             , destination, times, 0);
# 199 "/doner/binutils/binutils-515f23e/binutils/rename.c"
  if (result != 0)
    non_fatal (gettext ("%s: cannot set time: %s"), destination, strerror (
# 200 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                                                                   (*__errno_location ())
# 200 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                                                                        ));
}
...
# 211 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                                _Bool 
# 211 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                                     preserve_dates)
{
  int ret = 0;
  ...
  if (to != from)
    {
      ...
      if (ret != 0)
 non_fatal (gettext ("unable to copy file '%s'; reason: %s"),
     to, strerror (
# 220 "/doner/binutils/binutils-515f23e/binutils/rename.c" 3 4
                  (*__errno_location ())
# 220 "/doner/binutils/binutils-515f23e/binutils/rename.c"
                       ));
      unlink (from);
    }
