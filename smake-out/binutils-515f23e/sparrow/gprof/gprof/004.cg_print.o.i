# 1 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 27 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
# 33 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 2
...
print_header (void)
{
  if (first_output)
    first_output = 
# 67 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
                  0
# 67 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                       ;
  else
    printf ("\f\n");
 ...
 printf (dgettext ("gprof", "\t\t     Call graph (explanation follows)\n\n"));
      else
 printf (dgettext ("gprof", "\t\t\tCall graph\n\n"));
    }
  ...
  if (print_time > 0.0)
    printf (dgettext ("gprof", " for %.2f%% of %.2f seconds\n\n"),
     100.0 / print_time, print_time / hz);
  else
    {
      printf (dgettext ("gprof", " no time propagated\n\n"));
  ...
  if (bsd_style_output)
    {
      printf ("%6.6s %5.5s %7.7s %11.11s %7.7s/%-7.7s     %-8.8s\n",
       "", "", "", "", dgettext ("gprof", "called"), dgettext ("gprof", "total"), dgettext ("gprof", "parents"));
      printf ("%-6.6s %5.5s %7.7s %11.11s %7.7s+%-7.7s %-8.8s\t%5.5s\n",
       dgettext ("gprof", "index"),

       dgettext ("gprof", "%time"),
       dgettext ("gprof", "self"), dgettext ("gprof", "descendants"), dgettext ("gprof", "called"), dgettext ("gprof", "self"),
       dgettext ("gprof", "name"), dgettext ("gprof", "index"));
      printf ("%6.6s %5.5s %7.7s %11.11s %7.7s/%-7.7s     %-8.8s\n",
       "", "", "", "", dgettext ("gprof", "called"), dgettext ("gprof", "total"), dgettext ("gprof", "children"));
      printf ("\n");
    }
  else
    {
      printf (dgettext ("gprof", "index %% time    self  children    called     name\n"));
    }
}
...
{
  char buf[
# 118 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
          8192
# 118 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                ];
  ...
  printf (dgettext ("gprof", " <cycle %d as a whole> [%d]\n"), cyc->cg.cyc.num, cyc->cg.index);
}
...
sort_members (Sym *cyc)
{
  ...
  for (doing = todo; doing != 
# 173 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
                             ((void *)0)
# 173 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                                 ; doing = todo)
    {
 ...
 {
   if (cmp_member (doing, prev->cg.cyc.next) == 1)
     break;
 }
...
# 224 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
static int
...
sort_parents (Sym * child)
{
 ...
 {
   if (cmp_arc (arc, prev->next_parent) != 1)
     break;
 }
...
print_parents (Sym *child)
{
  ...
  if (!child->cg.parents)
    {
      printf (bsd_style_output
       ? dgettext ("gprof", "%6.6s %5.5s %7.7s %11.11s %7.7s %7.7s     <spontaneous>\n")
       : dgettext ("gprof", "%6.6s %5.5s %7.7s %7.7s %7.7s %7.7s     <spontaneous>\n"),
       "", "", "", "", "", "");
      return;
    }
...
sort_children (Sym *parent)
{
 ...
 {
   if (cmp_arc (arc, prev->next_child) != -1)
     break;
 }
...
{
  char buf[
# 472 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
          8192
# 472 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                ];
...
cg_print (Sym ** timesortsym)
{
  ...
  if (print_descriptions && bsd_style_output)
    bsd_callg_blurb (
# 509 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
                    stdout
# 509 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                          );
 ...
 printf ("\n");
  ...
  if (print_descriptions && !bsd_style_output)
    fsf_callg_blurb (
# 549 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
                    stdout
# 549 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                          );
}
...
cg_print_index (void)
{
 ...
 continue;
  ...
  printf ("\f\n");
  printf (dgettext ("gprof", "Index by function name\n\n"));
  sym_index = (todo + 2) / 3;
      ...
      for (j = i; j < todo; j += sym_index)
 {
  ...
  {
    printf ("%6.6s ", buf);
    sprintf (buf, dgettext ("gprof", "<cycle %d>"), sym->cg.cyc.num);
    printf ("%-19.19s", buf);
  }
       else
  {
...
# 776 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
void
  ...
  for (sym_index = 0; sym_index < used / 80; sym_index++)
    {
      ...
      if (sym->nuses == 5)
 break;
# 884 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
      arc = sym->cg.children;
...
# 986 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
static void
      ...
      unsigned long *unplaced_arc_count)
{
 ...
 continue;
      ...
      if ((! all && (double)tmp_arcs / (double)total_arcs > 0.99)
 ...
 continue;
      ...
      if (sym->next == 
# 1183 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
                      ((void *)0)
   
# 1184 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
  && sym->prev == 
# 1184 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
                  ((void *)0)
# 1184 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
                      )
 continue;
...
cg_print_file_ordering (void)
{
 ...
 printf ("%s\n", symtab.base[sym_index].name);
  ...
  last = 
# 1264 "/doner/binutils/binutils-515f23e/gprof/cg_print.c" 3 4
        ((void *)0)
# 1264 "/doner/binutils/binutils-515f23e/gprof/cg_print.c"
            ;
