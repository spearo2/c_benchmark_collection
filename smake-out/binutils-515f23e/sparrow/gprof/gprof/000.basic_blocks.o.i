# 1 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
# 24 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
...
# 25 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
GMON_Record_Tag;
# 31 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 33 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 2
...
# 42 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
_Bool 
# 42 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
    bb_annotate_all_lines = 
# 42 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                            0
# 42 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
...
fskip_string (FILE *fp)
{
  ...
  while ((ch = fgetc (fp)) != 
# 109 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                             (-1)
# 109 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                                )
    {
      if (ch == '\0')
 break;
...
bb_read_rec (FILE *ifp, const char *filename)
{
  ...
  if (gmon_io_read_32 (ifp, &nblocks))
    {
      fprintf (
# 128 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
              stderr
# 128 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                    , dgettext ("gprof", "%s: %s: unexpected end of file\n"),
        whoami, filename);
      done (1);
    }

  nblocks = ((*((core_bfd)->xvec->bfd_getx32)) ((bfd_byte *) & nblocks));
      ...
      if (gmon_file_version == 0)
 {
   ...
   if ((fread (&ncalls, sizeof (ncalls), 1, ifp) != 1)
       ...
       || (fskip_string (ifp), 
# 147 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                              0
# 147 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                                   )
       || (fskip_string (ifp), 
# 148 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                              0
# 148 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                                   )
   ...
   if (sym)
     {
       ...
       if (debug_level & ((1<<11))) {printf ("[bb_read_rec] 0x%lx->0x%lx (%s:%d) cnt=%lu\n", (unsigned long) addr, (unsigned long) sym->addr, sym->name, sym->line_num, (unsigned long) ncalls);}
 ...
 {
   static 
# 190 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
         _Bool 
# 190 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
              user_warned = 
# 190 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                            0
# 190 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
   ...
   if (!user_warned)
     {
       user_warned = 
# 194 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                    1
# 194 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                        ;
       fprintf (
# 195 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
               stderr
# 195 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                     ,
  dgettext ("gprof", "%s: warning: ignoring basic-block exec counts (use -l or --line)\n"),
         whoami);
     }
 }
    }
...
print_exec_counts (void)
{
  ...
  if (first_output)
    first_output = 
# 257 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                  0
# 257 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                       ;
  else
    printf ("\f\n");
      ...
      if (sym->ncalls > 0 || ! ignore_zeros)
 {
   ...
   printf (dgettext ("gprof", "%s:%d: (%s:0x%lx) %lu executions\n"),
    sym->file ? sym->file->name : dgettext ("gprof", "<unknown>"), sym->line_num,
    sym->name, (unsigned long) sym->addr, sym->ncalls);
 }

      for (j = 0; j < 10 && sym->bb_addr[j]; j ++)
 {
...
# 319 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
static void
annotate_with_count (char *buf, unsigned int width, int line_num, void *arg)
{
  ...
  b = 
# 328 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
     ((void *)0)
# 328 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
         ;
      ...
      if (bb_table_length > 0)
 {
   ...
   for (i = 0; i < table_len; ++i)
    ...
    break;
      ...
      fprintf (ofp, dgettext ("gprof", "\nExecution Summary:\n\n"));
      fprintf (ofp, dgettext ("gprof", "%9ld   Executable lines in this file\n"),
        num_executable_lines);
      fprintf (ofp, dgettext ("gprof", "%9ld   Lines executed\n"), num_lines_executed);
      fprintf (ofp, dgettext ("gprof", "%9.2f   Percent of the file executed\n"),
        num_executable_lines
        ? 100.0 * num_lines_executed / (double) num_executable_lines
        : 100.0);
      fprintf (ofp, dgettext ("gprof", "\n%9lu   Total number of line executions\n"),
        sf->ncalls);
      fprintf (ofp, dgettext ("gprof", "%9.2f   Average executions per line\n"),
        num_executable_lines
        ? (double) sf->ncalls / (double) num_executable_lines
        : 0.0);

      if (ofp != 
# 582 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c" 3 4
                stdout
# 582 "/doner/binutils/binutils-515f23e/gprof/basic_blocks.c"
                      )
 fclose (ofp);
    }
}
