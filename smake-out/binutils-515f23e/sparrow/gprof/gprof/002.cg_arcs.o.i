# 1 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
# 29 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
...
# 30 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 33 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.h" 1
# 34 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.h"
extern void cg_dfn (Sym * root);
# 37 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 38 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 39 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
# 40 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 2
...
arc_lookup (Sym *parent, Sym *child)
{
  ...
  if (debug_level & ((1<<9))) {printf ("[arc_lookup] parent %s child %s\n", parent->name, child->name);}
                                  ;
...
arc_add (Sym *parent, Sym *child, unsigned long count)
{
  ...
  if (debug_level & ((1<<4))) {printf ("[arc_add] %lu arcs from %s to %s\n", count, parent->name, child->name);}
                                        ;
  ...
  if (arc)
    {
      ...
      if (debug_level & ((1<<4))) {printf ("[tally] hit %lu += %lu\n", arc->count, count);}
                             ;
      arc->count += count;
      return;
    }
...
propagate_time (Sym *parent)
{
      ...
      if (child->cg.cyc.head != child)
 {
   ...
   if (parent->cg.top_order <= child->cg.top_order)
     {
       fprintf (
# 192 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
               stderr
# 192 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
      ...
      else
 {
   if (parent->cg.top_order <= child->cg.top_order)
     {
       fprintf (
# 200 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
               stderr
# 200 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                     , "[propagate] toporder botches\n");
       continue;
     }
 }
...
cycle_link (void)
{
      ...
      if (!(sym->cg.cyc.head == sym && sym->cg.cyc.next != 0))
 {
   continue;
      ...
      sym_init (cyc);
      cyc->cg.print_flag = 
# 311 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
                          1
# 311 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                              ;
      cyc->cg.top_order = 0;
      cyc->cg.cyc.num = num;
      cyc->cg.cyc.head = cyc;
      cyc->cg.cyc.next = sym;
      if (debug_level & ((1<<2))) {printf ("[cycle_link] "); print_name (sym); printf (" is the head of cycle %d\n", num);}
...
# 359 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
static void
  ...
  if (child == head)
    {
      ...
      child->cg.print_flag = 
# 369 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
                            0
# 369 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                                 ;
  ...
  * (((double) arc->count) / ((double) child->ncalls));
  ...
  else
    {
      ...
      head->cg.print_flag = 
# 397 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
                           0
# 397 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                                ;
...
# 437 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
static void
propagate_flags (Sym **symbols)
{
      ...
      if (child->cg.cyc.head != old_head)
 {
   ...
   inherit_flags (child);
      ...
      if (debug_level & ((1<<10))) {printf ("[prop_flags] "); print_name (child); printf ("inherits print-flag %d and prop-fract %f\n", child->cg.print_flag, child->cg.prop.fract);}
      ...
      if (!child->cg.print_flag)
 {
   ...
   if (sym_lookup (&syms[INCL_GRAPH], child->addr)
    ...
    && !sym_lookup (&syms[EXCL_GRAPH], child->addr)))
     {
       child->cg.print_flag = 
# 474 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
                             1
# 474 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                                 ;
     }
 }
      else
 {
   ...
   if (!sym_lookup (&syms[INCL_GRAPH], child->addr)
     ...
     {
       child->cg.print_flag = 
# 487 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
                             0
# 487 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                                  ;
     }
 }
...
# 537 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
static int
...
# 620 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c" 3 4
                             0
# 620 "/doner/binutils/binutils-515f23e/gprof/cg_arcs.c"
                                  ;
      parent->cg.top_order = 0;
      parent->cg.cyc.num = 0;
