# 1 "/doner/binutils/binutils-515f23e/gprof/vax.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/vax.c"
# 29 "/doner/binutils/binutils-515f23e/gprof/vax.c"
...
# 30 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 32 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
...
# 33 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/vax.c" 2
# 47 "/doner/binutils/binutils-515f23e/gprof/vax.c"
enum opermodes
  {
...
# 71 "/doner/binutils/binutils-515f23e/gprof/vax.c"
...
vax_operandmode (unsigned char *modep)
{
  ...
  switch ((*modep >> 4) & 0xf)
    ...
    case 7:
      return autodec;
    case 8:
      return usesreg != 0xf ? autoinc : immediate;
    case 9:
      return usesreg != 0xf ? autoincdef : absolute;
    case 10:
      return usesreg != 0xf ? bytedisp : byterel;
    case 11:
      return usesreg != 0xf ? bytedispdef : bytereldef;
    case 12:
      return usesreg != 0xf ? worddisp : wordrel;
    case 13:
      return usesreg != 0xf ? worddispdef : wordreldef;
    case 14:
      return usesreg != 0xf ? longdisp : longrel;
    case 15:
      return usesreg != 0xf ? longdispdef : longreldef;
    }
...
vax_offset (unsigned char *modep)
{
  ...
  switch (mode)
    ...
    default:
      fprintf (
# 219 "/doner/binutils/binutils-515f23e/gprof/vax.c" 3 4
              stderr
# 219 "/doner/binutils/binutils-515f23e/gprof/vax.c"
                    , "[reladdr] not relative address\n");
      return 0;
    case byterel:
      return 1 + ((((bfd_signed_vma) *(const bfd_byte *) (modep) & 0xff) ^ 0x80) - 0x80);
    case wordrel:
      return 2 + ((*((core_bfd)->xvec->bfd_getx_signed_16)) (modep));
    case longrel:
      return 4 + ((*((core_bfd)->xvec->bfd_getx_signed_32)) (modep));
    }
}
...
vax_find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
  ...
  bfd_vma pc, destpc;
  static 
# 240 "/doner/binutils/binutils-515f23e/gprof/vax.c" 3 4
        _Bool 
# 240 "/doner/binutils/binutils-515f23e/gprof/vax.c"
             inited = 
# 240 "/doner/binutils/binutils-515f23e/gprof/vax.c" 3 4
                      0
# 240 "/doner/binutils/binutils-515f23e/gprof/vax.c"
  ...
  if (!inited)
    {
      inited = 
# 244 "/doner/binutils/binutils-515f23e/gprof/vax.c" 3 4
              1
# 244 "/doner/binutils/binutils-515f23e/gprof/vax.c"
                  ;
  ...
  if (debug_level & ((1<<8))) {printf ("[findcall] %s: 0x%lx to 0x%lx\n", parent->name, (unsigned long) p_lowpc, (unsigned long) p_highpc);}
  ...
  for (pc = p_lowpc; pc < p_highpc; pc += length)
    {
     ...
     + pc - core_text_sect->vma);
      if ((*instructp & 0xff) == 0xfb)
 {




   if (debug_level & ((1<<8))) {printf ("[findcall]\t0x%lx:calls", (unsigned long) pc);}
                                                               ;
   ...
   if (debug_level & ((1<<8))) {printf ("\tfirst operand is %s", vax_operandname (firstmode)); printf ("\tsecond operand is %s\n", vax_operandname (mode));}
   ...
   switch (mode)
     ...
     case wordreldef:
     case longreldef:
# 297 "/doner/binutils/binutils-515f23e/gprof/vax.c"
       ...
       if (hist_check_address (destpc))
  {
    ...
    if (child)
      {
        if (debug_level & ((1<<8))) {printf ("[findcall]\tdestpc 0x%lx", (unsigned long) destpc); printf (" child->name %s", child->name); printf (" child->addr 0x%lx\n", (unsigned long) child->addr);;}
    ...
    goto botched;
     ...
     botched:
       ...
       if (debug_level & ((1<<8))) {printf ("[findcall]\tbut it's a botch\n");};
       length = 1;
       continue;
     }
 }
