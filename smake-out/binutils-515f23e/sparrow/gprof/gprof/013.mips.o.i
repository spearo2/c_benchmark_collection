# 1 "/doner/binutils/binutils-515f23e/gprof/mips.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/mips.c"
# 29 "/doner/binutils/binutils-515f23e/gprof/mips.c"
...
# 30 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 32 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
# 33 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/mips.c" 2
...
mips_find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
  ...
  Sym *child;
  static 
# 48 "/doner/binutils/binutils-515f23e/gprof/mips.c" 3 4
        _Bool 
# 48 "/doner/binutils/binutils-515f23e/gprof/mips.c"
             inited = 
# 48 "/doner/binutils/binutils-515f23e/gprof/mips.c" 3 4
                      0
# 48 "/doner/binutils/binutils-515f23e/gprof/mips.c"
  ...
  if (!inited)
    {
      inited = 
# 52 "/doner/binutils/binutils-515f23e/gprof/mips.c" 3 4
              1
# 52 "/doner/binutils/binutils-515f23e/gprof/mips.c"
                  ;
  ...
  for (pc = p_lowpc; pc < p_highpc; pc += 4)
    {
      op = ((*((core_bfd)->xvec->bfd_getx32)) (((unsigned char *)core_text_space + pc - core_text_sect->vma)))
                                                             ;
      if ((op & 0xfc000000) == 0x0c000000)
 {


   if (debug_level & ((1<<8))) {printf (dgettext ("gprof", "[find_call] 0x%lx: jal"), (unsigned long) pc);}
                                                                 ;
      ...
      else if ((op & 0xfc00f83f) == 0x0000f809)
 {
   ...
   if (debug_level & ((1<<8))) {printf (dgettext ("gprof", "[find_call] 0x%lx: jalr\n"), (unsigned long) pc);}
                                                                    ;
