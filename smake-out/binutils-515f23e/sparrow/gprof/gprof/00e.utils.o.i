# 1 "/doner/binutils/binutils-515f23e/gprof/utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/utils.c"
# 29 "/doner/binutils/binutils-515f23e/gprof/utils.c"
...
# 30 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
cplus_demangle_print_callback (int options,
                               struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 31 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 33 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/gprof/utils.c" 2
...
print_name_only (Sym *self)
{
 ...
 {
   demangled = bfd_demangle (core_bfd, name, (1 << 1) | (1 << 0));
   if (demangled)
     name = demangled;
 }
      printf ("%s", name);
      ...
      if ((line_granularity || inline_file_names) && self->file)
 {
       ...
       else
  {
   ...
   free (buf);
      ...
      free (demangled);
      if (debug_level & ((1<<1))) {printf ("{%d} ", self->cg.top_order);};
      if (debug_level & ((1<<10))) {printf ("%4.0f%% ", 100.0 * self->cg.prop.fract);};
    }
  return size;
}
...
print_name (Sym *self)
{
  ...
  if (self->cg.cyc.num != 0)
    {
      printf (dgettext ("gprof", " <cycle %d>"), self->cg.cyc.num);
    }
  if (self->cg.index != 0)
    {
