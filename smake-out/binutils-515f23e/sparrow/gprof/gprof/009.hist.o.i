# 1 "/doner/binutils/binutils-515f23e/gprof/hist.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/hist.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/hist.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 26 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
GMON_Record_Tag;
# 30 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/utils.h" 1
# 23 "/doner/binutils/binutils-515f23e/gprof/utils.h"
extern int print_name_only (Sym * self);
extern void print_name (Sym * self);
# 33 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/hist.c" 2
...
# 39 "/doner/binutils/binutils-515f23e/gprof/hist.c"
...
# 89 "/doner/binutils/binutils-515f23e/gprof/hist.c"
static void
         ...
         int first)
{
  ...
  if (gmon_io_read_vma (ifp, &record->lowpc)
    ...
    {
      fprintf (
# 106 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
              stderr
# 106 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                    , dgettext ("gprof", "%s: %s: unexpected end of file\n"),
        whoami, filename);
 ...
 {
   fprintf (
# 133 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
           stderr
# 133 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                 ,
     dgettext ("gprof", "%s: dimension unit changed between histogram records\n" "%s: from '%s'\n" "%s: to '%s'\n")
 ...
 {
   fprintf (
# 143 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
           stderr
# 143 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                 ,
     dgettext ("gprof", "%s: dimension abbreviation changed between histogram records\n" "%s: from '%c'\n" "%s: to '%c'\n")
 ...
 {
   fprintf (
# 157 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
           stderr
# 157 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                 ,
     dgettext ("gprof", "%s: different scales in histogram records"),
     whoami);
   done (1);
 }
    }
...
hist_read_rec (FILE * ifp, const char *filename)
{
 ...
 {
   fprintf (
# 194 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
           stderr
# 194 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                 ,
     dgettext ("gprof", "%s: overlapping histogram records\n"),
     whoami);
   done (1);
 }
  ...
  if (debug_level & ((1<<6))) {printf ("[hist_read_rec] n_lowpc 0x%lx n_highpc 0x%lx ncnt %u\n", (unsigned long) record->lowpc, (unsigned long) record->highpc, record->num_bins);}
 ...
 {
   fprintf (
# 228 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
           stderr
# 228 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                 ,
    dgettext ("gprof", "%s: %s: unexpected EOF after reading %u of %u samples\n"),
     whoami, filename, i, record->num_bins);
   done (1);
 }
      record->sample[i] += ((*((core_bfd)->xvec->bfd_getx16)) ((bfd_byte *) & count[0]));
      if (debug_level & ((1<<6))) {printf ("[hist_read_rec] 0x%lx: %u\n", (unsigned long) (record->lowpc + i * (record->highpc - record->lowpc) / record->num_bins), record->sample[i]);}
...
hist_write_hist (FILE * ofp, const char *filename)
{
   ...
   || gmon_io_write (ofp, &hist_dimension_abbrev, 1))
 {
   perror (filename);
      ...
      for (i = 0; i < record->num_bins; ++i)
 {
   ((*((core_bfd)->xvec->bfd_putx16)) (((bfd_vma) record->sample[i]),((bfd_byte *) &count[0])));
...
# 291 "/doner/binutils/binutils-515f23e/gprof/hist.c"
static void
scale_and_align_entries (void)
{
      ...
      if (r)
 {
   ...
   bin_of_code = ((sym->hist.scaled_addr + (offset_to_code / sizeof(UNIT)) - r->lowpc)
       / hist_scale);
   if (bin_of_entry < bin_of_code)
     {
       if (debug_level & ((1<<6))) {printf ("[scale_and_align_entries] pushing 0x%lx to 0x%lx\n", (unsigned long) sym->hist.scaled_addr, (unsigned long) (sym->hist.scaled_addr + (offset_to_code / sizeof(UNIT))));}



                           ;
       sym->hist.scaled_addr += (offset_to_code / sizeof(UNIT));
     }
 }
    }
}
# 360 "/doner/binutils/binutils-515f23e/gprof/hist.c"
static void
hist_assign_samples_1 (histogram *r)
{
 ...
 continue;
      ...
      if (debug_level & ((1<<6))) {printf ( "[assign_samples] bin_low_pc=0x%lx, bin_high_pc=0x%lx, bin_count=%u\n", (unsigned long) (sizeof (UNIT) * bin_low_pc), (unsigned long) (sizeof (UNIT) * bin_high_pc), bin_count);}
      ...
      for (j = k - 1; j < symtab.len; k = ++j)
 {
   ...
   overlap =
     ((bin_high_pc) < (sym_high_pc) ? (bin_high_pc) : (sym_high_pc)) - ((bin_low_pc) > (sym_low_pc) ? (bin_low_pc) : (sym_low_pc));
   if (overlap > 0)
     {
       if (debug_level & ((1<<6))) {printf ( "[assign_samples] [0x%lx,0x%lx) %s gets %f ticks %ld overlap\n", (unsigned long) symtab.base[j].addr, (unsigned long) (sizeof (UNIT) * sym_high_pc), symtab.base[j].name, overlap * count_time / hist_scale, (long) overlap);}
  ...
  if (debug_level & ((1<<6))) {printf ("[assign_samples] total_time %f\n", total_time);}
                   ;
}
...
print_header (int prefix)
{
  ...
  sprintf (unit, dgettext ("gprof", "%c%c/call"), prefix, hist_dimension_abbrev);

  if (bsd_style_output)
    {
      printf (dgettext ("gprof", "\ngranularity: each sample hit covers %ld byte(s)"),
       (long) hist_scale * (long) sizeof (UNIT));
      if (total_time > 0.0)
 {
   printf (dgettext ("gprof", " for %.2f%% of %.2f %s\n\n"),
  ...
  if (total_time <= 0.0)
    {
      printf (dgettext ("gprof", " no time accumulated\n\n"));
  ...
  printf ("%5.5s %10.10s %8.8s %8.8s %8.8s %8.8s  %-8.8s\n",
   "%  ", dgettext ("gprof", "cumulative"), dgettext ("gprof", "self  "), "", dgettext ("gprof", "self  "), dgettext ("gprof", "total "),
   "");
  printf ("%5.5s %9.9s  %8.8s %8.8s %8.8s %8.8s  %-8.8s\n",
   dgettext ("gprof", "time"), hist_dimension, hist_dimension, dgettext ("gprof", "calls"), unit, unit,
   dgettext ("gprof", "name"));
}
...
hist_print (void)
{
  ...
  if (first_output)
    first_output = 
# 574 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
                  0
# 574 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                       ;
  else
    printf ("\f\n");
      ...
      if (print_descriptions)
 {
   printf (dgettext ("gprof", "\n\n\nflat profile:\n"));
   flat_blurb (
# 585 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
              stdout
# 585 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                    );
 }
    }
  else
    {
      printf (dgettext ("gprof", "Flat profile:\n"));
    }
      ...
      if (top_dog && top_dog->ncalls != 0 && top_time > 0.0)
 {
   ...
   for (log_scale = 0; log_scale < (sizeof (SItab) / sizeof ((SItab)[0])); log_scale ++)
     {
 ...
 print_line (time_sorted_syms[sym_index], SItab[log_scale].scale);
  ...
  if (print_descriptions && !bsd_style_output)
    flat_blurb (
# 666 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
               stdout
# 666 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                     );
}
...
# 688 "/doner/binutils/binutils-515f23e/gprof/hist.c"
void
hist_clip_symbol_address (bfd_vma *p_lowpc, bfd_vma *p_highpc)
{
  ...
  for (i = 0; i < num_histograms; ++i)
    {
      ...
      common_low = (((histograms[i].lowpc)>(*p_lowpc)) ? (histograms[i].lowpc) : (*p_lowpc));
      common_high = (((histograms[i].highpc)<(*p_highpc)) ? (histograms[i].highpc) : (*p_highpc));
      ...
      if (common_low < common_high)
 {
   if (found)
     {
       fprintf (
# 710 "/doner/binutils/binutils-515f23e/gprof/hist.c" 3 4
               stderr
# 710 "/doner/binutils/binutils-515f23e/gprof/hist.c"
                     ,
         dgettext ("gprof", "%s: found a symbol that covers " "several histogram records")
                                ,
    whoami);
       done (1);
     }
