# 1 "/doner/binutils/binutils-515f23e/gprof/source.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/source.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/source.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/source.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gprof/source.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gprof/source.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 27 "/doner/binutils/binutils-515f23e/gprof/source.c" 2





# 31 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
_Bool 
# 31 "/doner/binutils/binutils-515f23e/gprof/source.c"
    create_annotation_files = 
# 31 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
                              0
# 31 "/doner/binutils/binutils-515f23e/gprof/source.c"
...
{
  static 
# 96 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
        _Bool 
# 96 "/doner/binutils/binutils-515f23e/gprof/source.c"
             first_file = 
# 96 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
                          1
# 96 "/doner/binutils/binutils-515f23e/gprof/source.c"
...
# 98 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
 _Bool 
# 98 "/doner/binutils/binutils-515f23e/gprof/source.c"
      new_line;
  char buf[8192];
  char *fname;
  ...
  if ((((((sf->name)[0]) == '/') || ((((sf->name)[0]) == '\\') && (0))) || ((sf->name)[0] && ((sf->name)[1] == ':') && (0))))
    sle = 0;

  name_only = 0;
  while (
# 113 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
        1
# 113 "/doner/binutils/binutils-515f23e/gprof/source.c"
            )
    {
      if (debug_level & ((1<<13))) {printf ("[annotate_source]: looking for %s, trying %s\n", sf->name, fname);}
                         ;
...
# 136 "/doner/binutils/binutils-515f23e/gprof/source.c"
   if (name_only)
     {
 ...
 {
   if (
# 165 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
      (*__errno_location ()) 
# 165 "/doner/binutils/binutils-515f23e/gprof/source.c"
            == 
# 165 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
               2
# 165 "/doner/binutils/binutils-515f23e/gprof/source.c"
     ...
     fprintf (
# 166 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
             stderr
# 166 "/doner/binutils/binutils-515f23e/gprof/source.c"
                   , dgettext ("gprof", "%s: could not locate `%s'\n"),
       whoami, sf->name);
   else
     perror (sf->name);
  ...
  ofp = 
# 175 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
       stdout
# 175 "/doner/binutils/binutils-515f23e/gprof/source.c"
             ;
...
# 193 "/doner/binutils/binutils-515f23e/gprof/source.c"
      if (filename)
 ++filename;
      else
 filename = sf->name;

      fname = xmalloc (strlen (filename) + strlen ("-ann") + 1);
      strcpy (fname, filename);
      strcat (fname, "-ann");
# 219 "/doner/binutils/binutils-515f23e/gprof/source.c"
      ofp = fopen (fname, "w");
      ...
      if (!ofp)
 {
  ...
  if (ofp == 
# 232 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
            stdout
# 232 "/doner/binutils/binutils-515f23e/gprof/source.c"
                  )
    {
      if (first_file)
 first_file = 
# 235 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
             0
# 235 "/doner/binutils/binutils-515f23e/gprof/source.c"
                  ;
      else
 fputc ('\n', ofp);
      ...
      if (first_output)
 first_output = 
# 240 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
               0
# 240 "/doner/binutils/binutils-515f23e/gprof/source.c"
                    ;
      else
 fprintf (ofp, "\f\n");

      fprintf (ofp, dgettext ("gprof", "*** File %s:\n"), sf->name);
    }

  annotation = (char *) xmalloc (max_width + 1);
  line_num = 1;
  new_line = 
# 249 "/doner/binutils/binutils-515f23e/gprof/source.c" 3 4
            1
# 249 "/doner/binutils/binutils-515f23e/gprof/source.c"
                ;
