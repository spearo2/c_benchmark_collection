# 1 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 27 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 2


# 33 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
bfd *core_bfd;
...
static 
# 48 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
      _Bool 
# 48 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
           get_src_info
...
{
  fprintf (
# 61 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
          stderr
# 61 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                , dgettext ("gprof", "%s: unable to parse mapping file %s.\n"), whoami, filename);
  done (1);
}
...
read_function_mappings (const char *filename)
{
  ...
  if (!file)
    {
      fprintf (
# 89 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 89 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: could not open %s.\n"), whoami, filename);
      done (1);
    }
      ...
      if (!strncmp (dummy, "No symbols in ", 14))
 {
   matches = fscanf (file, "\n");
   if (matches == 
# 108 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                 (-1)
# 108 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    )
     parse_error (filename);
   continue;
 }
      ...
      if (!strncmp (dummy, "No symbols in ", 14))
 {
   matches = fscanf (file, "\n");
   if (matches == 
# 142 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                 (-1)
# 142 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    )
     parse_error (filename);
   continue;
 }
...
core_init (const char * aout_name)
{
  ...
  core_bfd->flags |= 0x8000;

  if (!bfd_check_format (core_bfd, bfd_object))
    {
      fprintf (
# 193 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 193 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: %s: not in executable format\n"), whoami, aout_name);
      done (1);
    }
 ...
 {
   fprintf (
# 204 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
           stderr
# 204 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                 , dgettext ("gprof", "%s: can't find .text section in %s\n"),
     whoami, aout_name);
   done (1);
 }
    }
  ...
  core_sym_bytes = ((*((core_bfd)->xvec->_bfd_get_symtab_upper_bound)) (core_bfd));
  if (core_sym_bytes < 0)
    {
      fprintf (
# 216 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 216 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , "%s: %s: %s\n", whoami, aout_name,
  ...
  core_num_syms = ((*((core_bfd)->xvec->_bfd_canonicalize_symtab)) (core_bfd, core_syms));

  if (core_num_syms < 0)
    {
      fprintf (
# 226 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 226 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , "%s: %s: %s\n", whoami, aout_name,
        bfd_errmsg (bfd_get_error ()));
      done (1);
    }

  synth_count = ((*((core_bfd)->xvec->_bfd_get_synthetic_symtab)) (core_bfd, core_num_syms, core_syms, 0, 
# 231 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
               ((void *)0)
# 231 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
               , &synthsyms))
                           ;
  if (synth_count > 0)
    {
...
core_get_text_space (bfd *cbfd)
{
  ...
  if (!core_text_space)
    {
      fprintf (
# 278 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 278 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: ran out room for %lu bytes of text space\n"),
  ...
  if (!core_text_space)
    fprintf (
# 292 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
            stderr
# 292 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                  , dgettext ("gprof", "%s: can't do -c\n"), whoami);
}
...
find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
  ...
  switch (bfd_get_arch (core_bfd))
    ...
    default:
      fprintf (
# 331 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 331 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: -c not supported on architecture %s\n"),
        whoami, bfd_printable_name(core_bfd));


      ignore_direct_calls = 
# 335 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                           0
# 335 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                                ;
    }
}
...
core_sym_class (asymbol *sym)
{
  ...
  if (sym->section == 
# 352 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                     ((void *)0) 
# 352 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                          || (sym->flags & (1 << 2)) != 0)
    return 0;



  if (ignore_static_funcs && (sym->flags & (1 << 0)))
    {
      if (debug_level & ((1<<7))) {printf ("[core_sym_class] %s: not a function\n", sym->name);}
                    ;
      return 0;
    }

  ((*((core_bfd)->xvec->_bfd_get_symbol_info)) (core_bfd,sym,&syminfo));
  i = syminfo.type;
  ...
  if (i != 't')
    {
      ...
      if (debug_level & ((1<<7))) {printf ("[core_sym_class] %s is of class %c\n", sym->name, i);}
                       ;
      return 0;
    }
      ...
      while (*name == '.')
 {
   ...
   if (strlen (name) > strlen (".clone.")
       && strncmp (name, ".clone.", strlen (".clone.")) == 0)
     name += strlen (".clone.") - 1;

   else if (strlen (name) > strlen (".constprop.")
       && strncmp (name, ".constprop.", strlen (".constprop.")) == 0)
     name += strlen (".constprop.") - 1;

   for (name++; *name; name++)
     if (digit_seen && *name == '.')
       break;
     else if ((_sch_istable[(*name) & 0xff] & (unsigned short)(_sch_isdigit)))
       digit_seen = 1;
     else
       return 0;
 }
    }
# 434 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
  ...
  if (ignore_non_functions && (sym->flags & (1 << 3)) == 0)
    return 0;
...
static 
# 456 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
      _Bool

# 457 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
       ...
       int *line_num)
{
  ...
  if (((*((core_bfd)->xvec->_bfd_find_nearest_line)) (core_bfd, core_syms, core_text_sect, addr - core_text_sect->vma, &fname, &func_name, (unsigned int *) &l, 
# 463 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
     ((void *)0)
# 463 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
     ))


      && fname && func_name && l)
    {
      if (debug_level & ((1<<7))) {printf ("[get_src_info] 0x%lx -> %s:%d (%s)\n", (unsigned long) addr, fname, l, func_name);}
                                                    ;
      *filename = fname;
      *name = func_name;
      *line_num = l;
      return 
# 473 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
            1
# 473 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                ;
    }
  else
    {
      if (debug_level & ((1<<7))) {printf ("[get_src_info] no info for 0x%lx (%s:%d,%s)\n", (unsigned long) addr, fname ? fname : "<unknown>", l, func_name ? func_name : "<unknown>");}


                                              ;
      return 
# 481 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
            0
# 481 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                 ;
    }
}
...
num_of_syms_in (FILE * f)
{
  ...
  while (!feof (f) && fgets (buf, (1024) - 1, f))
    {
      if (sscanf (buf, "%" "1023" "s %c %" "1023" "s", address, &type, name) == 3)
        if (type == 't' || type == 'T')
   {

     if (++num >= 
# 503 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                 (0x7fffffff * 2U + 1U) 
# 503 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                          / sizeof (Sym))
       return -1U;
   }
    }
...
core_create_syms_from (const char * sym_table_file)
{
  ...
  if (!f)
    {
      fprintf (
# 524 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 524 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
  ...
  if (symtab.len == 0)
    {
      fprintf (
# 533 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 533 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: file `%s' has no symbols\n"), whoami, sym_table_file);
      done (1);
    }
  else if (symtab.len == -1U)
    {
      fprintf (
# 538 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 538 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: file `%s' has too many symbols\n"),
        whoami, sym_table_file);
      done (1);
    }
  ...
  if (fseek (f, 0, 
# 548 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                  0
# 548 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                          ) != 0)
    {
 ...
 continue;
      ...
      uint64_t addr;
      sscanf (address, "%" 
# 564 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                          "l" "x"
# 564 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                                , &addr);
      ...
      symtab.limit->is_func = 
# 570 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                             1
# 570 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                                 ;
      symtab.limit->is_bb_head = 
# 571 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                                1
# 571 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                                    ;
      symtab.limit->is_static = (type == 't');
      min_vma = ((symtab.limit->addr) < (min_vma) ? (symtab.limit->addr) : (min_vma));
      max_vma = ((symtab.limit->addr) > (max_vma) ? (symtab.limit->addr) : (max_vma));
...
# 600 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                               ((void *)0)
# 600 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                                   ;
      ...
      if (symbol_map_count != 0)
 {
   ...
   found = (struct function_map *) bsearch
     (core_syms[i]->name, symbol_map, symbol_map_count,
      ...
      if (found == 
# 634 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                  ((void *)0) 
# 634 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                       || found->is_first)
 ++symtab.len;
    }
  ...
  if (symtab.len == 0)
    {
      fprintf (
# 640 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 640 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    , dgettext ("gprof", "%s: file `%s' has no symbols\n"), whoami, a_out_name);
      done (1);
    }
  ...
  for (i = 0; i < core_num_syms; ++i)
    {
      ...
      if (!cxxclass)
 {
   if (debug_level & ((1<<7))) {printf ("[core_create_function_syms] rejecting: 0x%lx %s\n", (unsigned long) core_syms[i]->value, core_syms[i]->name);}
...
# 725 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
   }
      }

      symtab.limit->is_func = (!core_has_func_syms
          || (core_syms[i]->flags & (1 << 3)) != 0);
      symtab.limit->is_bb_head = 
# 730 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                                1
# 730 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                                    ;

      if (cxxclass == 't')
 symtab.limit->is_static = 
# 733 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                          1
# 733 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                              ;
      ...
      min_vma = ((symtab.limit->addr) < (min_vma) ? (symtab.limit->addr) : (min_vma));
      if (sym_sec)
 max_vma = ((bfd_section_vma (sym_sec) + bfd_section_size (sym_sec) - 1) > (max_vma) ? (bfd_section_vma (sym_sec) + bfd_section_size (sym_sec) - 1) : (max_vma))

                 ;
      else
 max_vma = ((symtab.limit->addr) > (max_vma) ? (symtab.limit->addr) : (max_vma));

      if (debug_level & ((1<<7))) {printf ("[core_create_function_syms] %ld %s 0x%lx\n", (long) (symtab.limit - symtab.base), symtab.limit->name, (unsigned long) symtab.limit->addr);}
...
# 786 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
  prev_name_len = 1024;
  ...
  for (vma = core_text_sect->vma; vma < vma_high; vma += min_insn_size)
   ...
   || (prev_line_num == dummy.line_num
       && prev_name != 
# 800 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
                      ((void *)0)
       
# 801 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
      ...
      if (len >= prev_filename_len)
 {
   ...
   prev_filename = (char *) xmalloc (prev_filename_len);
      ...
      min_vma = ((vma) < (min_vma) ? (vma) : (min_vma));
      max_vma = ((vma) > (max_vma) ? (vma) : (max_vma));
    }
...
# 858 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
  prev = 0;
      ...
      else
 {
   sym = sym_lookup(&symtab, ltab.limit->addr);
     ...
     ltab.limit->is_static = sym->is_static;
      ...
      if (debug_level & ((1<<7))) {printf ("[core_create_line_syms] %lu %s 0x%lx\n", (unsigned long) (ltab.limit - ltab.base), ltab.limit->name, (unsigned long) ltab.limit->addr);}
  ...
  if ((unsigned int) (ltab.limit - ltab.base) != ltab.len)
    {
      fprintf (
# 906 "/doner/binutils/binutils-515f23e/gprof/corefile.c" 3 4
              stderr
# 906 "/doner/binutils/binutils-515f23e/gprof/corefile.c"
                    ,
        dgettext ("gprof", "%s: somebody miscounted: ltab.len=%d instead of %ld\n"),
