# 1 "/doner/binutils/binutils-515f23e/gprof/aarch64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/aarch64.c"
# 34 "/doner/binutils/binutils-515f23e/gprof/aarch64.c"
...
# 35 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 37 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
# 38 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
# 39 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
# 40 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
# 41 "/doner/binutils/binutils-515f23e/gprof/aarch64.c" 2
...
aarch64_find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
 ...
 {
   if (debug_level & ((1<<8))) {printf ("[find_call] 0x%lx: bl", (unsigned long) pc);}
                                                             ;
   ...
   if (hist_check_address (dest_pc))
     {
       ...
       if (child)
  {
    if (debug_level & ((1<<8))) {printf ("\tdest_pc=0x%lx, (name=%s, addr=0x%lx)\n", (unsigned long) dest_pc, child->name, (unsigned long) child->addr);}
