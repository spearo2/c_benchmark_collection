# 1 "/doner/binutils/binutils-515f23e/gprof/i386.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/i386.c"
# 29 "/doner/binutils/binutils-515f23e/gprof/i386.c"
...
# 30 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 32 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
# 33 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/i386.c" 2
...
i386_find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
 ...
 {
   if (debug_level & ((1<<8))) {printf ("[findcall]\t0x%lx:call", (unsigned long) pc);}
                                                              ;
   ...
   destpc = ((*((core_bfd)->xvec->bfd_getx32)) (instructp + 1)) + pc + 5;
       ...
       if (child && child->addr == destpc)
  {
    ...
    if (debug_level & ((1<<8))) {printf ("\tdestpc 0x%lx (%s)\n", (unsigned long) destpc, child->name);}
