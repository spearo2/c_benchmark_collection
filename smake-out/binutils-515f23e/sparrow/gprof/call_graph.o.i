# 1 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 25 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
GMON_Record_Tag;
# 31 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 2
...
cg_tally (bfd_vma from_pc, bfd_vma self_pc, unsigned long count)
{
  ...
  if (child == 
# 42 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 3 4
              ((void *)0) 
# 42 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
                   || parent == 
# 42 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 3 4
                                ((void *)0)
# 42 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
    ...
    return;
# 54 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
  ...
  if (sym_id_arc_is_present (&syms[INCL_ARCS], parent, child)
   ...
   && !sym_id_arc_is_present (&syms[EXCL_ARCS], parent, child)))
    {
      child->ncalls += count;
      if (debug_level & ((1<<4))) {printf (dgettext ("gprof", "[cg_tally] arc from %s to %s traversed %lu times\n"), parent->name, child->name, count);}
...
cg_read_rec (FILE *ifp, const char *filename)
{
  ...
  if (gmon_io_read_vma (ifp, &from_pc)
    ...
    {
      fprintf (
# 89 "/doner/binutils/binutils-515f23e/gprof/call_graph.c" 3 4
              stderr
# 89 "/doner/binutils/binutils-515f23e/gprof/call_graph.c"
                    , dgettext ("gprof", "%s: %s: unexpected end of file\n"),
        whoami, filename);
      done (1);
    }

  if (debug_level & ((1<<6))) {printf ("[cg_read_rec] frompc 0x%lx selfpc 0x%lx count %lu\n", (unsigned long) from_pc, (unsigned long) self_pc, (unsigned long) count);}
...
cg_write_arcs (FILE *ofp, const char *filename)
{
      ...
      for (arc = sym->cg.children; arc; arc = arc->next_child)
 {
   ...
   if (debug_level & ((1<<6))) {printf ("[cg_write_arcs] frompc 0x%lx selfpc 0x%lx count %lu\n", (unsigned long) arc->parent->addr, (unsigned long) arc->child->addr, arc->count);}
