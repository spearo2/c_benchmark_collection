# 1 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 27 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 2
...
# 45 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
   _Bool 
# 45 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
        has_right;
...
static void parse_id
  (struct sym_id *);
static 
# 56 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
      _Bool 
# 56 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
           match
  (Sym *, Sym *);
static void extend_match
  (struct match *, Sym *, Sym_Table *, 
# 59 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                      _Bool
# 59 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                          );
...
{
  0, "<non-existent-file>", 0, 0, 0, 
# 85 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                    ((void *)0)

# 86 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
};
...
# 117 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
static void
      ...
      if (colon > spec)
 {
   ...
   if (!sym->file)
     sym->file = &non_existent_file;
      ...
      if (strlen (spec))
 {
   if ((_sch_istable[(spec[0]) & 0xff] & (unsigned short)(_sch_isdigit)))
      ...
      if (strchr (spec, '.'))
 {
   ...
   if (!sym->file)
     sym->file = &non_existent_file;
      ...
      else if ((_sch_istable[(*spec) & 0xff] & (unsigned short)(_sch_isdigit)))
 {
   sym->line_num = atoi (spec);
 }
      else if (strlen (spec))
...
parse_id (struct sym_id *id)
{
  ...
  if (debug_level & ((1<<12))) {printf ("[parse_id] %s -> ", id->spec);};
  ...
  if (slash)
    {
      ...
      *slash = '\0';
      id->has_right = 
# 184 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                     1
# 184 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                         ;
    }
...
static 
# 221 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
      _Bool

# 222 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
match (Sym *pattern, Sym *sym)
{
  if (pattern->file && pattern->file != sym->file)
    return 
# 225 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
          0
# 225 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
               ;
  if (pattern->line_num && pattern->line_num != sym->line_num)
    return 
# 227 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
          0
# 227 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
               ;
  if (pattern->name)
    {
 ...
 return 
# 234 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
       0
# 234 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
            ;
    }
  return 
# 236 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
        1
# 236 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
            ;
}
...
# 241 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                                        _Bool 
# 241 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                                             second_pass)
{
...
# 275 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
void
sym_id_parse (void)
{
  Sym *sym, *left, *right;
      ...
      for (id = id_list; id; id = id->next)
 {
   if (match (&id->left.sym, sym))
     extend_match (&id->left, sym, &syms[id->which_table], 
# 292 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                                          0
# 292 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                                               );

   if (id->has_right && match (&id->right.sym, sym))
     extend_match (&id->right, sym, &right_ids, 
# 295 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                               0
# 295 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                                    );
 }
    }
      ...
      for (id = id_list; id; id = id->next)
 {
   if (match (&id->left.sym, sym))
     extend_match (&id->left, sym, &syms[id->which_table], 
# 323 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                                          1
# 323 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                                              );

   if (id->has_right && match (&id->right.sym, sym))
     extend_match (&id->right, sym, &right_ids, 
# 326 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
                                               1
# 326 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                                   );
 }
    }
      ...
      if (id->has_right)
 {
  ...
  {
    if (debug_level & ((1<<12))) {printf ( "[sym_id_parse]: arc %s:%s(%lx-%lx) -> %s:%s(%lx-%lx) to %s\n", left->file ? left->file->name : "*", left->name ? left->name : "*", (unsigned long) left->addr, (unsigned long) left->end_addr, right->file ? right->file->name : "*", right->name ? right->name : "*", (unsigned long) right->addr, (unsigned long) right->end_addr, table_name[id->which_table]);}
# 350 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
                                 ;
  ...
  for (tab = &syms[0]; tab < &syms[NUM_TABLES]; ++tab)
    {
      if (debug_level & ((1<<12))) {printf ("[sym_id_parse] syms[%s]:\n", table_name[tab - &syms[0]]);}
                                   ;
      symtab_finalize (tab);
    }
}
# 374 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"

# 374 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
_Bool

# 375 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
sym_id_arc_is_present (Sym_Table *sym_tab, Sym *from, Sym *to)
{
  ...
  for (sym = sym_tab->base; sym < sym_tab->limit; ++sym)
   ...
   && arc_lookup (sym, to))
 return 
# 383 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
       1
# 383 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
           ;
    }

  return 
# 386 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c" 3 4
        0
# 386 "/doner/binutils/binutils-515f23e/gprof/sym_ids.c"
             ;
}
