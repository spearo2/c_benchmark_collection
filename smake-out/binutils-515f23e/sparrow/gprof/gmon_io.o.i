# 1 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
# 22 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
...
# 23 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
# 1 "./../include/binary-io.h" 1
# 24 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 26 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/gmon_out.h" 1
# 32 "/doner/binutils/binutils-515f23e/gprof/gmon_out.h"
struct gmon_hdr
  {
    char cookie[4];
    char version[4];
...
GMON_Record_Tag;
# 33 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/gmon.h" 1
# 125 "/doner/binutils/binutils-515f23e/gprof/gmon.h"
struct tostruct
  {
    char *selfpc;
    int count;
...
# 36 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 2
...
gmon_get_ptr_size (void)
{
  ...
  switch (size)
    ...
    default:
      fprintf (
# 81 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
              stderr
# 81 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                    , dgettext ("gprof", "%s: address size has unexpected value of %u\n"),
        whoami, size);
      done (1);
    }
}
...
gmon_io_read_32 (FILE *ifp, unsigned int *valp)
{
  ...
  if (fread (buf, 1, 4, ifp) != 4)
    return 1;
  *valp = ((*((core_bfd)->xvec->bfd_getx32)) (buf));
  return 0;
}
...
gmon_io_read_64 (FILE *ifp, uint64_t *valp)
{
  ...
  if (fread (buf, 1, 8, ifp) != 8)
    return 1;
  *valp = ((*((core_bfd)->xvec->bfd_getx64)) (buf));
  return 0;
}
...
gmon_io_write_32 (FILE *ofp, unsigned int val)
{
  ...
  ((*((core_bfd)->xvec->bfd_putx32)) (((bfd_vma) val),(buf)));
...
gmon_io_write_64 (FILE *ofp, uint64_t val)
{
  ...
  ((*((core_bfd)->xvec->bfd_putx64)) (((bfd_vma) val), (buf)));
...
gmon_out_read (const char *filename)
{
  ...
  if (strcmp (filename, "-") == 0)
    {
      ifp = 
# 282 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
           stdin
# 282 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                ;
      ;
    }
  else
      ...
      if (!ifp)
 {
  ...
  if (fread (&ghdr, sizeof (struct gmon_hdr), 1, ifp) != 1)
    {
      fprintf (
# 298 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
              stderr
# 298 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                    , dgettext ("gprof", "%s: file too short to be a gmon file\n"),
        filename);
      done (1);
    }

  if ((file_format == FF_MAGIC)
      || (file_format == FF_AUTO && !strncmp (&ghdr.cookie[0], "gmon", 4)))
    {
      if (file_format == FF_MAGIC && strncmp (&ghdr.cookie[0], "gmon", 4))
 {
   fprintf (
# 308 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
           stderr
# 308 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                 , dgettext ("gprof", "%s: file `%s' has bad magic cookie\n"),
     whoami, filename);
   done (1);
 }


      gmon_file_version = ((*((core_bfd)->xvec->bfd_getx32)) ((bfd_byte *) ghdr.version));

      if (gmon_file_version != 1 && gmon_file_version != 0)
 {
   fprintf (
# 318 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
           stderr
# 318 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                 ,
     dgettext ("gprof", "%s: file `%s' has unsupported version %d\n"),
      ...
      while (fread (&tag, sizeof (tag), 1, ifp) == 1)
 {
   switch (tag)
     ...
     default:
       fprintf (
# 348 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
               stderr
# 348 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                     ,
         dgettext ("gprof", "%s: %s: found bad tag %d (file corrupted?)\n"),
         whoami, filename, tag);
       done (1);
     }
 }
 ...
 unsigned int ncnt;
      ...
      if (fseek (ifp, 0, 
# 381 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
                        0
# 381 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                                ) < 0)
 {
   perror (filename);
   done (1);
 ...
 bad_gmon_file:
          fprintf (
# 394 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
                  stderr
# 394 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                        , dgettext ("gprof", "%s: file too short to be a gmon file\n"),
     filename);
   done (1);
 }
      ...
      if (version == 0x00051879)
 {
   ...
   if (!histograms)
     ...
     {
       fprintf (
# 415 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
               stderr
# 415 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                     ,
         dgettext ("gprof", "%s: profiling rate incompatible with first gmon file\n"),
         filename);
       done (1);
     }
   ...
   switch (gmon_get_ptr_size ())
     {
     case ptr_32bit:
       header_size = (4 + 4 + 4 + 4 + 4 + (3 * 4));
       break;

     case ptr_64bit:
       header_size = (8 + 8 + 4 + 4 + 4 + (3 * 4));
       break;
     }
 }
      else
 {
   ...
   if (file_format == FF_BSD44)
     {
       fprintf (
# 437 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
               stderr
# 437 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                     , dgettext ("gprof", "%s: file `%s' has bad magic cookie\n"),
         whoami, filename);
       done (1);
     }
   ...
   switch (gmon_get_ptr_size ())
     ...
     case ptr_64bit:
      ...
      if (fseek (ifp, header_size, 
# 455 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
                                  0
# 455 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                                          ) < 0)
 {
   perror (filename);
   done (1);
 ...
 {
   fprintf (
# 467 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
           stderr
# 467 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                 , dgettext ("gprof", "%s: incompatible with first gmon file\n"),
     filename);
   done (1);
 }
      ...
      if (!histograms)
 {
   ...
   memset (histograms->sample, 0,
    hist_num_bins * sizeof (int));
      ...
      if (debug_level & ((1<<6))) {printf ("[gmon_out_read] lowpc 0x%lx highpc 0x%lx ncnt %d\n", (unsigned long) tmp.low_pc, (unsigned long) tmp.high_pc, tmp.ncnt); printf ("[gmon_out_read] samp_bytes %d hist_num_bins %d\n", samp_bytes, hist_num_bins);}
 ...
 {
   fprintf (
# 496 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
           stderr
# 496 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                 ,
     dgettext ("gprof", "%s: file '%s' does not appear to be in gmon.out format\n"),
     whoami, filename);
   done (1);
 }
      ...
      for (i = 0; i < hist_num_bins; ++i)
 {
   if (fread (raw_bin_count, sizeof (raw_bin_count), 1, ifp) != 1)
     {
       fprintf (
# 509 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
               stderr
# 509 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                     ,
         dgettext ("gprof", "%s: unexpected EOF after reading %d/%d bins\n"),
         whoami, --i, hist_num_bins);
       done (1);
     }

   histograms->sample[i]
     += ((*((core_bfd)->xvec->bfd_getx16)) ((bfd_byte *) raw_bin_count));
 }
      ...
      while (gmon_read_raw_arc (ifp, &from_pc, &self_pc, &count) == 0)
 {
   ...
   if (debug_level & ((1<<6))) {printf ("[gmon_out_read] frompc 0x%lx selfpc 0x%lx count %lu\n", (unsigned long) from_pc, (unsigned long) self_pc, count);}
   ...
   if (hz == 0)
     {
       hz = 1;
       fprintf (
# 542 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
               stderr
# 542 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                     , dgettext ("gprof", "time is in ticks, not seconds\n"));
     }
 }
    }
  else
    {
      fprintf (
# 548 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
              stderr
# 548 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                    , dgettext ("gprof", "%s: don't know how to deal with file format %d\n"),
        whoami, file_format);
      done (1);
    }

  if (ifp != 
# 553 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
            stdin
# 553 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                 )
    fclose (ifp);

  if (output_style & (1<<5))
    {
      printf (dgettext ("gprof", "File `%s' (version %d) contains:\n"),
       filename, gmon_file_version);
      printf (nhist == 1 ?
       dgettext ("gprof", "\t%d histogram record\n") :
       dgettext ("gprof", "\t%d histogram records\n"), nhist);
      printf (narcs == 1 ?
       dgettext ("gprof", "\t%d call-graph record\n") :
       dgettext ("gprof", "\t%d call-graph records\n"), narcs);
      printf (nbbs == 1 ?
       dgettext ("gprof", "\t%d basic-block count record\n") :
       dgettext ("gprof", "\t%d basic-block count records\n"), nbbs);
      first_output = 
# 569 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
                    0
# 569 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                         ;
    }
}
...
gmon_out_write (const char *filename)
{
  ...
  if (file_format == FF_AUTO || file_format == FF_MAGIC)
    {
      ...
      memcpy (&ghdr.cookie[0], "gmon", 4);
      ((*((core_bfd)->xvec->bfd_putx32)) (((bfd_vma) 1),((bfd_byte *) ghdr.version)));
   ...
   || hz != hertz())
 {
   ...
   switch (gmon_get_ptr_size ())
     {
     case ptr_32bit:
       hdrsize = (4 + 4 + 4 + 4 + 4 + (3 * 4));
       break;

     case ptr_64bit:
       hdrsize = (8 + 8 + 4 + 4 + 4 + (3 * 4));
       break;
     }
 }
      else
          ...
          * sizeof (UNIT) + hdrsize))
 {
   ...
   || hz != hertz())
 {
          if (gmon_io_write_32 (ofp, 0x00051879)
 ...
 {
   ((*((core_bfd)->xvec->bfd_putx16)) (((bfd_vma) histograms->sample[i]),((bfd_byte *) &raw_bin_count[0])))
                                       ;
      ...
      for (sym = symtab.base; sym < symtab.limit; ++sym)
 {
          ...
          arc->child->addr, arc->count))
  {
    perror (filename);
       ...
       if (debug_level & ((1<<6))) {printf ("[dumpsum] frompc 0x%lx selfpc 0x%lx count %lu\n", (unsigned long) arc->parent->addr, (unsigned long) arc->child->addr, arc->count);}
    ...
    {
      fprintf (
# 728 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c" 3 4
              stderr
# 728 "/doner/binutils/binutils-515f23e/gprof/gmon_io.c"
                    , dgettext ("gprof", "%s: don't know how to deal with file format %d\n"),
        whoami, file_format);
      done (1);
    }
