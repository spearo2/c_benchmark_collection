# 1 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
# 29 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
...
# 30 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void *arg);
# 33 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 2
...
static 
# 47 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
      _Bool 
# 47 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
           is_numbered (Sym *);
static 
# 48 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
      _Bool 
# 48 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
           is_busy (Sym *);
...
DFN_Stack *dfn_stack = 
# 53 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
                      ((void *)0)
# 53 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
                          ;
int dfn_maxdepth = 0;
int dfn_depth = 0;
int dfn_counter = 0;
...
static 
# 62 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
      _Bool

# 63 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
is_numbered (Sym *child)
{
  return child->cg.top_order != 0 && child->cg.top_order != -1;
}
...
static 
# 72 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
      _Bool

# 73 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
is_busy (Sym *child)
{
  if (child->cg.top_order == 0)
    {
      return 
# 77 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
            0
# 77 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
                 ;
    }
  return 
# 79 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
        1
# 79 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
            ;
}
# 89 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
static void
find_cycle (Sym *child)
{
      ...
      if (child->cg.cyc.head != child && child->cg.cyc.head == head)
 {
  ...
  if (cycle_top <= 0)
    {
      fprintf (
# 111 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
              stderr
# 111 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
  ...
  if (cycle_top == dfn_depth)
    {
      ...
      if (debug_level & ((1<<1))) {printf ("[find_cycle] "); print_name (child); printf ("\n");}
      ...
      for (tail = head; tail->cg.cyc.next; tail = tail->cg.cyc.next)
 {
   ...
   if (debug_level & ((1<<1))) {printf ("[find_cycle] tail "); print_name (tail); printf ("\n");}
      ...
      if (head->cg.cyc.head != head)
 {
   ...
   if (debug_level & ((1<<1))) {printf ("[find_cycle] new cyclehead "); print_name (head); printf ("\n");}
      ...
      for (cycle_index = cycle_top + 1; cycle_index <= dfn_depth; ++cycle_index)
 {
   ...
   if (child->cg.cyc.head == child)
     {
       ...
       if (debug_level & ((1<<1))) {printf ("[find_cycle] glomming "); print_name (child); printf (" onto "); print_name (head); printf ("\n");}
       ...
       for (tail = child; tail->cg.cyc.next; tail = tail->cg.cyc.next)
  {
    ...
    if (debug_level & ((1<<1))) {printf ("[find_cycle] and its tail "); print_name (tail->cg.cyc.next); printf (" onto "); print_name (head); printf ("\n");}
     ...
     {
       fprintf (
# 200 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c" 3 4
               stderr
# 200 "/doner/binutils/binutils-515f23e/gprof/cg_dfn.c"
...
pre_visit (Sym *parent)
{
  ...
  if (debug_level & ((1<<1))) {printf ("[pre_visit]\t\t%d:", dfn_depth); print_name (parent); printf ("\n");}
...
post_visit (Sym *parent)
{
  ...
  if (debug_level & ((1<<1))) {printf ("[post_visit]\t%d: ", dfn_depth); print_name (parent); printf ("\n");}
      ...
      for (member = parent; member; member = member->cg.cyc.next)
 {
   ...
   if (debug_level & ((1<<1))) {printf ("[post_visit]\t\tmember "); print_name (member); printf ("-> cg.top_order = %d\n", dfn_counter);}
    ...
    {
      if (debug_level & ((1<<1))) {printf ("[post_visit]\t\tis part of a cycle\n");};
    }
  --dfn_depth;
}
...
cg_dfn (Sym *parent)
{
  ...
  if (debug_level & ((1<<1))) {printf ("[dfn] dfn( "); print_name (parent); printf (")\n");}
