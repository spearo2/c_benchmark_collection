# 1 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
# 21 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
...
# 22 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 2
...
extern void init_disassemble_info (struct disassemble_info *dinfo, void *stream,
       fprintf_ftype fprintf_func,
       fprintf_styled_ftype fprintf_styled_func);
# 23 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 2




# 28 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
int
      ...
      struct disassemble_info *info)
{
  ...
  if (memaddr < info->buffer_vma
    ...
    return 
# 45 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
          5
# 45 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
             ;
...
{
  if (status != 
# 59 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
               5
# 59 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
                  )
  ...
  else
    {
     ...
     dgettext ("opcodes", "Address 0x%" 
# 67 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
    "l" "x" 
# 67 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
    " is out of bounds.\n"),
     (uint64_t) memaddr);
    }
}
# 79 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
void
generic_print_address (bfd_vma addr, struct disassemble_info *info)
{
  (*info->fprintf_func) (info->stream, "0x%08" 
# 82 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
                                              "l" "x"
# 82 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
                                                    , (uint64_t) addr);
}
...
{
  return 
# 91 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
        ((void *)0)
# 91 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
            ;
}
...
# 96 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
_Bool

# 97 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
generic_symbol_is_valid (asymbol * sym __attribute__ ((__unused__)),
    struct disassemble_info *info __attribute__ ((__unused__)))
{
  return 
# 100 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c" 3 4
        1
# 100 "/doner/binutils/binutils-515f23e/opcodes/dis-buf.c"
            ;
}
