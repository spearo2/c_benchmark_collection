# 1 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
# 21 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
...
# 22 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 2


# 28 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
...
get_libdeps (int fd)
{
  ...
  lseek (fd, 8, 
# 106 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
                       0
# 106 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                               );
  for (;;)
    {
      ...
      if (len != sizeof (ah))
 break;
      mlen = strtoul (ah.ar_size, 
# 112 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
                                 ((void *)0)
# 112 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                                     , 10);
      if (!mlen || strncmp (ah.ar_name, "__.LIBDEP/ ", sizeof ("__.LIBDEP/ ")-1))
 {
   lseek (fd, mlen, 
# 115 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
                   1
# 115 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                           );
   continue;
 }
 ...
 return LDPS_ERR;
      lr->next = 
# 124 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
                ((void *)0)
# 124 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                    ;
...
str2vec (char *in)
{
  ...
  s = in;
  while (
# 146 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 146 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
        (unsigned char) *s
# 146 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
...
# 146 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
  ...
  i = 0;
  sq = 
# 160 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
      ((void *)0)
# 160 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
          ;
  dq = 
# 161 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
      ((void *)0)
# 161 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
          ;
  res[0] = first;
  for (s = first; *s; s++)
    {
      if (*s == '\\')
 {
   memmove (s, s+1, end-s-1);
      ...
      if (
# 170 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
         ((*__ctype_b_loc ())[(int) ((
# 170 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
         (unsigned char) *s
# 170 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
         ))] & (unsigned short int) _ISspace)
# 170 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                                     )
 {
   ...
   *s++ = '\0';
   while (
# 175 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
         ((*__ctype_b_loc ())[(int) ((
# 175 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
         (unsigned char) *s
# 175 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
         ))] & (unsigned short int) _ISspace)
# 175 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
   ...
   if (sq)
     {
       ...
       s--;
       sq = 
# 187 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
           ((void *)0)
# 187 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
               ;
     }
   else
     {
   ...
   if (dq)
     {
       ...
       s--;
       dq = 
# 202 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
           ((void *)0)
# 202 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
               ;
     }
   else
     {
  ...
  res[++i] = 
# 210 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
            ((void *)0)
# 210 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                ;
  return res;
}
  ...
  if (rv == LDPS_OK)
    {
      ...
      if (tv_message) (*tv_message) (LDPL_INFO, "got deps for library %s: %s",
    file->name, lr->line);
      fflush (
# 252 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
             ((void *)0)
# 252 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                 );
    }
   ...
   for (i = 0; vec[i]; i++)
     {
       if (vec[i][0] != '-')
  {
    if (tv_message) (*tv_message) (LDPL_WARNING, "ignoring libdep argument %s",
         vec[i]);
    fflush (
# 279 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
           ((void *)0)
# 279 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
               );
    continue;
  }
       if (vec[i][1] == 'l')
       ...
       else
  {
    if (tv_message) (*tv_message) (LDPL_WARNING, "ignoring libdep argument %s",
         vec[i]);
    fflush (
# 290 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
           ((void *)0)
# 290 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
               );
  }
       if (rv != LDPS_OK)
  break;
  ...
  line_tail = 
# 299 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
             ((void *)0)
# 299 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                 ;
  return rv;
}
  ...
  if (prevfile)
    {
      free (prevfile);
      prevfile = 
# 310 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
                ((void *)0)
# 310 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                    ;
    }
  if (line_head)
    {
      ...
      while ((lr = line_head))
 {
   ...
   free (lr);
      ...
      line_tail = 
# 320 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
                 ((void *)0)
# 320 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
                     ;
    }
  return LDPS_OK;
}
...
onload (struct ld_plugin_tv *tv)
{
  ...
  fflush (
# 354 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c" 3 4
         ((void *)0)
# 354 "/doner/binutils/binutils-515f23e/ld/libdep_plugin.c"
             );
  return LDPS_OK;
}
