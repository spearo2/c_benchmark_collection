# 1 "/doner/binutils/binutils-515f23e/ld/mri.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/mri.c"
# 26 "/doner/binutils/binutils-515f23e/ld/mri.c"
...
# 27 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 28 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
extern ctf_dict_t *ctf_arc_open_by_name_sections (const ctf_archive_t *,
        ...
        const ctf_sect_t *,
        const char *, int *);
# 30 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
extern void lang_add_version_string
  (void);
# 33 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
# 1 "./ldgram.h" 1
# 50 "./ldgram.h"
  enum yytokentype
  {
...
int yyparse (void);
# 36 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/ld/mri.c" 2
   ...
   etree_type *subalign)
{
  ...
  (*ptr)->vma = vma;
  (*ptr)->next = 
# 91 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                ((void *)0)
# 91 "/doner/binutils/binutils-515f23e/ld/mri.c"
                    ;
  (*ptr)->ok_to_load = 0;
  (*ptr)->alias = zalias;
  (*ptr)->align = align;
...
mri_draw_tree (void)
{
  ...
  if (address != 
# 131 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                ((void *)0)
# 131 "/doner/binutils/binutils-515f23e/ld/mri.c"
                    )
    {
      ...
      if (order == 
# 136 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                  ((void *)0)
# 136 "/doner/binutils/binutils-515f23e/ld/mri.c"
                      )
 order = address;

      for (alist = address;
    alist != 
# 140 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
            ((void *)0)
# 140 "/doner/binutils/binutils-515f23e/ld/mri.c"
                ;
    alist = alist->next)
 {
   int done = 0;

   for (olist = order; done == 0 && olist != 
# 145 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                            ((void *)0)
# 145 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                                ; olist = olist->next)
     {
  ...
  if (only_load != 
# 164 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                  ((void *)0)
# 164 "/doner/binutils/binutils-515f23e/ld/mri.c"
                      )
    {
      ...
      if (order == 
# 169 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                  ((void *)0)
# 169 "/doner/binutils/binutils-515f23e/ld/mri.c"
                      )
 order = only_load;
 ...
 ptr->ok_to_load = 1;
  ...
  if (order != 
# 188 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
              ((void *)0)
# 188 "/doner/binutils/binutils-515f23e/ld/mri.c"
                  )
    {
      ...
      while (p)
 {
   ...
   if (base == 0)
     base = p->vma ? p->vma : exp_nameop (259, ".");

   lang_enter_output_section_statement (p->name, base,
     p->ok_to_load ? normal_section : noload_section, 0,
     align, subalign, 
# 214 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                     ((void *)0)
# 214 "/doner/binutils/binutils-515f23e/ld/mri.c"
                         , 0, 0);
   base = 0;
   tmp = (struct wildcard_list *) xmalloc (sizeof *tmp);
   tmp->next = 
# 217 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
              ((void *)0)
# 217 "/doner/binutils/binutils-515f23e/ld/mri.c"
                  ;
   tmp->spec.name = p->name;
   tmp->spec.exclude_name_list = 
# 219 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                ((void *)0)
# 219 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                    ;
   tmp->spec.sorted = none;
   tmp->spec.section_flag_list = 
# 221 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                ((void *)0)
# 221 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                    ;
   lang_add_wild (
# 222 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                 ((void *)0)
# 222 "/doner/binutils/binutils-515f23e/ld/mri.c"
                     , tmp, 
# 222 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                            0
# 222 "/doner/binutils/binutils-515f23e/ld/mri.c"
  ...
  tmp = (struct wildcard_list *) xmalloc (sizeof *tmp);
  tmp->next = 
# 229 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
             ((void *)0)
# 229 "/doner/binutils/binutils-515f23e/ld/mri.c"
                 ;
  tmp->spec.name = aptr->name;
  tmp->spec.exclude_name_list = 
# 231 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                               ((void *)0)
# 231 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                   ;
  tmp->spec.sorted = none;
  tmp->spec.section_flag_list = 
# 233 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                               ((void *)0)
# 233 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                   ;
  lang_add_wild (
# 234 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                ((void *)0)
# 234 "/doner/binutils/binutils-515f23e/ld/mri.c"
                    , tmp, 
# 234 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                           0
# 234 "/doner/binutils/binutils-515f23e/ld/mri.c"
...
# 237 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                                       ((void *)0)
# 237 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                                           , 
# 237 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                                             ((void *)0)
# 237 "/doner/binutils/binutils-515f23e/ld/mri.c"
...
{
  base = 0;
  lang_add_input_file (name, lang_input_file_is_file_enum, 
# 250 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                                          ((void *)0)
# 250 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                                              );
}
  ...
  if (!is)
    {
      ...
      if (is == 
# 271 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
               ((void *)0)
# 271 "/doner/binutils/binutils-515f23e/ld/mri.c"
                   )
 ld_abort ("/doner/binutils/binutils-515f23e/ld/mri.c", 272, __PRETTY_FUNCTION__);
    }
...
# 288 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                   ((void *)0)
# 288 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                       , 
# 288 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                         ((void *)0)
# 288 "/doner/binutils/binutils-515f23e/ld/mri.c"
    ...
    einfo (gettext ("%F%P: unknown format type %s\n"), name);
}
...
# 297 "/doner/binutils/binutils-515f23e/ld/mri.c" 3 4
                                             0
# 297 "/doner/binutils/binutils-515f23e/ld/mri.c"
                                                  ));
}
