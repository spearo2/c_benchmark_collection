# 1 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
# 22 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
...
# 23 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
extern ctf_dict_t *ctf_arc_open_by_name_sections (const ctf_archive_t *,
        ...
        const ctf_sect_t *,
        const char *, int *);
# 27 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
extern void lang_add_version_string
  (void);
# 32 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
# 1 "/doner/binutils/binutils-515f23e/ld/ldwrite.h" 1
# 21 "/doner/binutils/binutils-515f23e/ld/ldwrite.h"
extern void ldwrite (void);
# 33 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
# 1 "./ldgram.h" 1
# 50 "./ldgram.h"
  enum yytokentype
  {
...
int yyparse (void);
# 35 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
# 36 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 2
...
build_link_order (lang_statement_union_type *statement)
{
 ...
 do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-515f23e/ld/ldwrite.c",51); } while (0);

 if (!((output_section->flags & 0x100) != 0
       || ((output_section->flags & 0x2) != 0
    && (output_section->flags & 0x400))))
   break;

 link_order = bfd_new_link_order (link_info.output_bfd, output_section);
 if (link_order == 
# 59 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                  ((void *)0)
# 59 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                      )
   einfo (gettext ("%F%P: bfd_new_link_order failed\n"));

 link_order->type = bfd_data_link_order;
 link_order->offset = statement->data_statement.output_offset;
 link_order->u.data.contents = (bfd_byte *) xmalloc ((8));
 ...
 if (!bfd_big_endian (link_info.output_bfd)
  ...
  break;
       default:
  ld_abort ("/doner/binutils/binutils-515f23e/ld/ldwrite.c", 99, __PRETTY_FUNCTION__);
       }
   }

 do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-515f23e/ld/ldwrite.c",103); } while (0);
 switch (statement->data_statement.type)
   {
   case 283:
   case 284:
     if (sizeof (bfd_vma) >= (8))
       ((*((link_info.output_bfd)->xvec->bfd_putx64)) ((value), (link_order->u.data.contents)))
                                 ;
     else
       {
  bfd_vma high;

  if (statement->data_statement.type == 283)
    high = 0;
  else if ((value & 0x80000000) == 0)
    high = 0;
  else
    high = (bfd_vma) -1;
  ((*((link_info.output_bfd)->xvec->bfd_putx32)) ((high),((link_order->u.data.contents + (link_info.big_endian ? 0 : 4)))))

                                          ;
  ((*((link_info.output_bfd)->xvec->bfd_putx32)) ((value),((link_order->u.data.contents + (link_info.big_endian ? 4 : 0)))))
     ...
     break;
   case 285:
     ((*((link_info.output_bfd)->xvec->bfd_putx32)) ((value),(link_order->u.data.contents)))
                               ;
     link_order->size = (4);
     break;
   case 286:
     ((*((link_info.output_bfd)->xvec->bfd_putx16)) ((value),(link_order->u.data.contents)))
                               ;
     link_order->size = (2);
     break;
   case 287:
     ((void) (*((bfd_byte *) (link_order->u.data.contents)) = (value) & 0xff))
                                     ;
     link_order->size = (1);
     break;
   default:
     ld_abort ("/doner/binutils/binutils-515f23e/ld/ldwrite.c", 146, __PRETTY_FUNCTION__);
   }
 ...
 do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-515f23e/ld/ldwrite.c",161); } while (0);
 ...
 link_order = bfd_new_link_order (link_info.output_bfd, output_section);
 if (link_order == 
# 169 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                  ((void *)0)
# 169 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                      )
   einfo (gettext ("%F%P: bfd_new_link_order failed\n"));
 ...
 if (rs->name == 
# 181 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                ((void *)0)
# 181 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                    )
   {
 ...
 if (i->sec_info_type != 4
     && (i->flags & 0x8000) == 0)
   {
     ...
     do { if (!(output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-515f23e/ld/ldwrite.c",212); } while (0);
    ...
    || ((output_section->flags & 0x2) != 0
     ...
     link_order = bfd_new_link_order (link_info.output_bfd,
          output_section);
     if (link_order == 
# 221 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                      ((void *)0)
# 221 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                          )
       einfo (gettext ("%F%P: bfd_new_link_order failed\n"));
  ...
  do { if (!(i->output_section == output_section)) info_assert("/doner/binutils/binutils-515f23e/ld/ldwrite.c",237); } while (0);
       }
 ...
 do { if (!(statement->padding_statement.output_section->owner == link_info.output_bfd)) info_assert("/doner/binutils/binutils-515f23e/ld/ldwrite.c",252); } while (0)
                          ;
 ...
 link_order = bfd_new_link_order (link_info.output_bfd,
      output_section);
 if (link_order == 
# 262 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                  ((void *)0)
# 262 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                      )
   einfo (gettext ("%F%P: bfd_new_link_order failed\n"));
 link_order->type = bfd_data_link_order;
...
static 
# 281 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
      _Bool

# 282 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
unsplittable_name (const char *name)
{
 ...
 return 
# 290 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
       1
# 290 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
           ;
    }
  else if (strcmp (name, "$GDB_STRINGS$") == 0)
    return 
# 293 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
          1
# 293 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
              ;
  return 
# 294 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
        0
# 294 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
             ;
}
...
clone_section (bfd *abfd, asection *s, const char *name, int *count)
{
  ...
  while (len && (_sch_istable[(tname[len-1]) & 0xff] & (unsigned short)(_sch_isdigit)))
    len--;
 ...
 {
   einfo (gettext ("%F%P: cannot create split section name for %s\n"), name);

   return 
# 334 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
         ((void *)0)
# 334 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
             ;
 }
      tname[5] = 0;
    }

  if ((sname = bfd_get_unique_section_name (abfd, tname, count)) == 
# 339 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                                                                   ((void *)0)
      
# 340 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
     || (n = bfd_make_section_anyway (abfd, sname)) == 
# 340 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                                                       ((void *)0)
      
# 341 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
     || (h = bfd_link_hash_lookup (link_info.hash,
        sname, 
# 342 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
              1
# 342 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                  , 
# 342 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                    1
# 342 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
...
# 342 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
    ...
    {
      einfo (gettext ("%F%P: clone section failed: %E\n"));

      return 
# 346 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
            ((void *)0)
# 346 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                ;
    }
  free (tname);
  ...
  ((*((abfd)->xvec->_bfd_copy_private_section_data)) (abfd, s, abfd, n));

  return n;
}
# 418 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
static void
split_sections (bfd *abfd, struct bfd_link_info *info)
{
  ...
  for (original_sec = abfd->sections;
       ...
       original_sec = original_sec->next, nsecs--)
    {
      ...
      for (l = 
# 440 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
              ((void *)0)
# 440 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                  , p = cursor->map_head.link_order; p != 
# 440 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                                                          ((void *)0)
# 440 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                                                              ; p = l->next)
 {
  ...
  thisrelocs = sec->reloc_count;
   ...
   if (l != 
# 466 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
           ((void *)0)
       
# 467 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
    ...
    || (thissize + sec_size >= config.split_by_file))
       && !unsplittable_name (cursor->name))
     {
       ...
       l->next = 
# 484 "/doner/binutils/binutils-515f23e/ld/ldwrite.c" 3 4
                ((void *)0)
# 484 "/doner/binutils/binutils-515f23e/ld/ldwrite.c"
                    ;
       l = p;
...
ldwrite (void)
{
 ...
 einfo (gettext ("%F%P: final link failed: %E\n"));
      else
 xexit (1);
    }
}
