# 1 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
# 22 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
...
# 23 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
extern ctf_dict_t *ctf_arc_open_by_name_sections (const ctf_archive_t *,
        ...
        const ctf_sect_t *,
        const char *, int *);
# 27 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
extern void lang_add_version_string
  (void);
# 31 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
# 1 "./ldgram.h" 1
# 50 "./ldgram.h"
  enum yytokentype
  {
...
int yyparse (void);
# 33 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
extern void ldctor_build_sets
  (void);
# 35 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 2
...
# 43 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
_Bool 
# 43 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
    constructors_sorted;


struct set_info *sets;
# 55 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
void
        ...
        bfd_vma value)
{
  ...
  for (p = sets; p != 
# 66 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                     ((void *)0)
# 66 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                         ; p = p->next)
    if (p->h == h)
      break;

  if (p == 
# 70 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
          ((void *)0)
# 70 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
              )
    {
      ...
      p->count = 0;
      p->elements = 
# 78 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                   ((void *)0)
# 78 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                       ;
    }
  else
    {
      if (p->reloc != reloc)
 {
   einfo (gettext ("%X%P: different relocs used in set %s\n"),
   h->root.string);
   return;
 }
# 96 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
      if (p->elements != 
# 96 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                        ((void *)0)
   
# 97 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
  && section->owner != 
# 97 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                       ((void *)0)
   
# 98 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
  && p->elements->section->owner != 
# 98 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                                    ((void *)0)
   
# 99 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
  && strcmp (bfd_get_target (section->owner),
       bfd_get_target (p->elements->section->owner)) != 0)
 {
   einfo (gettext ("%X%P: different object file formats composing set %s\n"),
   h->root.string);
   return;
 }
    }
  ...
  e->u.next = 
# 109 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
             ((void *)0)
# 109 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                 ;
  e->name = name;
  e->section = section;
  e->value = value;

  for (epp = &p->elements; *epp != 
# 114 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                                  ((void *)0)
# 114 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                                      ; epp = &(*epp)->u.next)
    ;
  *epp = e;
...
ctor_prio (const char *name)
{
  ...
  if (name[1] != 'I' && name[1] != 'D')
    return -1;
  if (!(_sch_istable[(name[3]) & 0xff] & (unsigned short)(_sch_isdigit)))
    return -1;
...
ctor_cmp (const void *p1, const void *p2)
{
  ...
  n1 = pe1->name;
  if (n1 == 
# 163 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
           ((void *)0)
# 163 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
               )
    n1 = "";
  n2 = pe2->name;
  if (n2 == 
# 166 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
           ((void *)0)
# 166 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
               )
    n2 = "";
...
{
  static 
# 198 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
        _Bool 
# 198 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
             called;
  
# 199 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
 _Bool 
# 199 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
      header_printed;
  struct set_info *p;
  ...
  if (called)
    return;
  called = 
# 206 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
          1
# 206 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
              ;

  if (constructors_sorted)
    {
      for (p = sets; p != 
# 210 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                         ((void *)0)
# 210 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                             ; p = p->next)
 {
   int c, i;
   ...
   if (p->elements == 
# 216 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                     ((void *)0)
# 216 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                         )
     continue;

   c = 0;
   for (e = p->elements; e != 
# 220 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                             ((void *)0)
# 220 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                                 ; e = e->u.next)
     ++c;
   ...
   i = 0;
   for (e = p->elements; e != 
# 226 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                             ((void *)0)
# 226 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                                 ; e = enext)
     {
       array[i] = e;
       enext = e->u.next;
   ...
   array[i]->u.next = 
# 240 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                     ((void *)0)
# 240 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                         ;
  ...
  header_printed = 
# 249 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                  0
# 249 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                       ;
  for (p = sets; p != 
# 250 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                     ((void *)0)
# 250 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                         ; p = p->next)
    {
      struct set_element *e;
      reloc_howto_type *howto;
 ...
 continue;
# 273 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
      howto = bfd_reloc_type_lookup (link_info.output_bfd, p->reloc);
      if (howto == 
# 274 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                  ((void *)0)
# 274 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                      )
 {
   if (((&link_info)->type == type_relocatable))
     {
       einfo (gettext ("%X%P: %s does not support reloc %s for set %s\n"),
...
# 287 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                                     ((void *)0)
# 287 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                                         )
     howto = bfd_reloc_type_lookup (p->elements->section->owner,
        p->reloc);
   if (howto == 
# 290 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
               ((void *)0)
# 290 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                   )
     {

       if (p->elements->section->owner == 
# 293 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                                         ((void *)0)
# 293 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                                             )
  einfo (gettext ("%X%P: special section %s does not support reloc %s for set %s\n"),
  ...
  einfo (gettext ("%X%P: %s does not support reloc %s for set %s\n"),
      ...
      switch (reloc_size)
 {
 case 1: size = 287; break;
 case 2: size = 286; break;
 case 4: size = 285; break;
 case 8:
   ...
   break;
 default:
   einfo (gettext ("%X%P: unsupported size %d for set %s\n"),
...
# 329 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
          0
# 329 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
               ));
      lang_add_assignment (exp_assign (p->h->root.string,
           exp_nameop (259, "."),
           
# 332 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
          0
# 332 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
               ));
      lang_add_data (size, exp_intop (p->count));

      for (e = p->elements; e != 
# 335 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                                ((void *)0)
# 335 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                                    ; e = e->u.next)
 {
   if (config.map_file != 
# 337 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                         ((void *)0)
# 337 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                             )
     {
       int len;
       ...
       if (!header_printed)
  {
    minfo (gettext ("\nSet                 Symbol\n\n"));
    header_printed = 
# 344 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                    1
# 344 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                        ;
  }
       ...
       if (len >= 19)
  {
    ...
    len = 0;
       ...
       if (e->name != 
# 357 "/doner/binutils/binutils-515f23e/ld/ldctor.c" 3 4
                     ((void *)0)
# 357 "/doner/binutils/binutils-515f23e/ld/ldctor.c"
                         )
  minfo ("%pT\n", e->name);
       else
