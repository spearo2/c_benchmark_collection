# 1 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
# 22 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
...
# 23 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 2
...
# 44 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
 _Bool 
# 44 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
      claimed;
...
static 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
      _Bool 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
...
# 127 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                         ;
static 
# 128 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
      _Bool 
# 128 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
...
# 128 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                               ;
static 
# 129 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
      _Bool 
# 129 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
...
# 129 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                        ;
static 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
      _Bool 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
           dumpresolutions = 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                             0
# 130 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                  ;
static 
# 131 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
      _Bool 
# 131 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
...
# 134 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                      ((void *)0)
# 134 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                          ;
...
# 140 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                     ((void *)0)
# 140 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                         ;


static add_file_t *addfiles_list = 
# 143 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                  ((void *)0)
# 143 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                      ;
...
record_add_file (const char *file, addfile_enum_t type)
{
  ...
  if (!newfile)
    return LDPS_ERR;
  newfile->next = 
# 178 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                 ((void *)0)
# 178 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                     ;
  newfile->name = file;
  newfile->type = type;
...
parse_symdefstr (const char *str, struct ld_plugin_symbol *sym)
{
 ...
 return LDPS_ERR;
    ...
    sym->version = 
# 248 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                  ((void *)0)
# 248 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                      ;
  if (colon5 && colon5[1])
    {
...
# 311 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                         _Bool 
# 311 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                              yesno)
{
  if (!strcmp ("claimfile", whichhook))
  ...
  else if (!strcmp ("allsymbolsreadsilent", whichhook))
    {
      register_allsymbolsread_hook = yesno;
      allsymbolsread_silent = 
# 320 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                             1
# 320 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                 ;
    }
  ...
  if (!strncmp ("fatal", opt, 5))
    {
      ...
      fflush (
# 336 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
             ((void *)0)
# 336 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                 );
    }
  else if (!strncmp ("error", opt, 5))
    {
      ...
      fflush (
# 341 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
             ((void *)0)
# 341 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                 );
    }
  else if (!strncmp ("warning", opt, 7))
    {
      ...
      fflush (
# 346 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
             ((void *)0)
# 346 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                 );
    }
...
# 353 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                      1
# 353 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                          );
  else if (!strncmp ("noregister", opt, 10))
    return set_register_hook (opt + 10, 
# 355 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                       0
# 355 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                            );
    ...
    dumpresolutions = 
# 367 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                     1
# 367 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                         ;
  else
    return LDPS_ERR;
  return LDPS_OK;
...
onload (struct ld_plugin_tv *tv)
{
      ...
      if (!tv_register_claim_file)
 {
   ...
   fflush (
# 468 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
          ((void *)0)
# 468 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_all_symbols_read)
 {
   ...
   fflush (
# 478 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
          ((void *)0)
# 478 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_cleanup)
 {
   ...
   fflush (
# 488 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
          ((void *)0)
# 488 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
              );
   return LDPS_ERR;
 }
...
# 526 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
 _Bool 
# 526 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
      islib;
  ...
  *claimed = (claimfile != 0);
  if (claimfile)
    {
      claimfile->claimed = 
# 555 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                          1
# 555 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                              ;
      claimfile->file = *file;
...
# 584 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
                                                               ((void *)0)
# 584 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
                                                                   ;
 ...
 return rv;
  ...
  fflush (
# 666 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
         ((void *)0)
# 666 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
             );
...
oncleanup (void)
{
  ...
  fflush (
# 675 "/doner/binutils/binutils-515f23e/ld/testplug2.c" 3 4
         ((void *)0)
# 675 "/doner/binutils/binutils-515f23e/ld/testplug2.c"
             );
  return cleanup_ret;
}
