# 1 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/testplug.c"
# 21 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 22 "/doner/binutils/binutils-515f23e/ld/testplug.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-515f23e/ld/testplug.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/ld/testplug.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/ld/testplug.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/ld/testplug.c" 2


# 30 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 44 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
 _Bool 
# 44 "/doner/binutils/binutils-515f23e/ld/testplug.c"
      claimed;
...
static 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
      _Bool 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 127 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                          ;
static 
# 128 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
      _Bool 
# 128 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 128 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                               ;
static 
# 129 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
      _Bool 
# 129 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 129 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                        ;
static 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
      _Bool 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug.c"
           dumpresolutions = 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                             0
# 130 "/doner/binutils/binutils-515f23e/ld/testplug.c"
...
# 133 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                      ((void *)0)
# 133 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                          ;
...
# 139 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                     ((void *)0)
# 139 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                         ;


static add_file_t *addfiles_list = 
# 142 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                  ((void *)0)
# 142 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                      ;
...
record_read_length (const char *length)
{
  ...
  tmp = length;
  while (*tmp != '\0' && 
# 178 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                        ((*__ctype_b_loc ())[(int) ((
# 178 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                        *tmp
# 178 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
...
record_add_file (const char *file, addfile_enum_t type)
{
  ...
  if (!newfile)
    return LDPS_ERR;
  newfile->next = 
# 196 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                 ((void *)0)
# 196 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                     ;
  newfile->name = file;
  newfile->type = type;
...
parse_symdefstr (const char *str, struct ld_plugin_symbol *sym)
{
 ...
 return LDPS_ERR;
    ...
    sym->version = 
# 266 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                  ((void *)0)
# 266 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                      ;
  if (colon5 && colon5[1])
    {
...
# 329 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                         _Bool 
# 329 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                              yesno)
{
...
# 351 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                      1
# 351 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                          );
  else if (!strncmp ("noregister", opt, 10))
    return set_register_hook (opt + 10, 
# 353 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                       0
# 353 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                            );
    ...
    dumpresolutions = 
# 367 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                     1
# 367 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                         ;
  else
    return LDPS_ERR;
  return LDPS_OK;
...
dump_tv_tag (size_t n, struct ld_plugin_tv *tv)
{
  ...
  for (tag = 0; tag < (sizeof (tag_names) / sizeof ((tag_names)[0])); tag++)
    if (tag_names[tag].tag == tv->tv_tag)
      break;
  sprintf (unknownbuf, "unknown tag #%d", tv->tv_tag);
  name = (tag < (sizeof (tag_names) / sizeof ((tag_names)[0]))) ? tag_names[tag].name : unknownbuf;
  switch (tv->tv_tag)
    {
      case LDPT_OPTION:
      case LDPT_OUTPUT_NAME:
 if (tv_message) (*tv_message) (LDPL_INFO, "tv[%d]: %s '%s'", n, name,
      tv->tv_u.tv_string);
        break;
 ...
 if (tv_message) (*tv_message) (LDPL_INFO, "tv[%d]: %s func@0x%p", n, name,
      ...
      default:
 if (tv_message) (*tv_message) (LDPL_INFO, "tv[%d]: %s value %W (%d)", n, name,
...
onload (struct ld_plugin_tv *tv)
{
  ...
  fflush (
# 517 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
         ((void *)0)
# 517 "/doner/binutils/binutils-515f23e/ld/testplug.c"
             );
  if (tv_message) (*tv_message) (LDPL_INFO, "Hello from testplugin.");
      ...
      if (!tv_register_claim_file)
 {
   ...
   fflush (
# 531 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
          ((void *)0)
# 531 "/doner/binutils/binutils-515f23e/ld/testplug.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_all_symbols_read)
 {
   ...
   fflush (
# 541 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
          ((void *)0)
# 541 "/doner/binutils/binutils-515f23e/ld/testplug.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_cleanup)
 {
   ...
   fflush (
# 551 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
          ((void *)0)
# 551 "/doner/binutils/binutils-515f23e/ld/testplug.c"
              );
   return LDPS_ERR;
 }
  ...
  fflush (
# 556 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
         ((void *)0)
# 556 "/doner/binutils/binutils-515f23e/ld/testplug.c"
             );
  return onload_ret;
}
  ...
  if (bytes_to_read_before_claim > 0)
    {
      ...
      if (buffer == 
# 571 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                   ((void *)0)
# 571 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                       )
        return LDPS_ERR;
 ...
 break;
  ...
  if (tv_message) (*tv_message) (LDPL_INFO, "hook called: claim_file %s [@%ld/%ld] %s",
       file->name, (long)file->offset, (long)file->filesize,
       claimfile ? "CLAIMED" : "not claimed");
  fflush (
# 591 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
         ((void *)0)
# 591 "/doner/binutils/binutils-515f23e/ld/testplug.c"
             );
  ...
  *claimed = (claimfile != 0);
  if (claimfile)
    {
      claimfile->claimed = 
# 598 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                          1
# 598 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                              ;
      claimfile->file = *file;
...
# 627 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
                                                               ((void *)0)
# 627 "/doner/binutils/binutils-515f23e/ld/testplug.c"
                                                                   ;
 ...
 return rv;
  ...
  fflush (
# 664 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
         ((void *)0)
# 664 "/doner/binutils/binutils-515f23e/ld/testplug.c"
             );
...
oncleanup (void)
{
  ...
  fflush (
# 673 "/doner/binutils/binutils-515f23e/ld/testplug.c" 3 4
         ((void *)0)
# 673 "/doner/binutils/binutils-515f23e/ld/testplug.c"
             );
  return cleanup_ret;
}
