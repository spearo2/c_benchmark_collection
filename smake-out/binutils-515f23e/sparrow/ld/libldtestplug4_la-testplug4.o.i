# 1 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
# 22 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
...
# 23 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 2
...
# 44 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
 _Bool 
# 44 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
      claimed;
...
static 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
      _Bool 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
           register_claimfile_hook = 
# 127 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                     1
# 127 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                         ;
static 
# 128 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
      _Bool 
# 128 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
...
# 128 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                               ;
static 
# 129 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
      _Bool 
# 129 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
...
# 129 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                        ;
static 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
      _Bool 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
           dumpresolutions = 
# 130 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                             0
# 130 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                  ;
static 
# 131 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
      _Bool 
# 131 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
           allsymbolsread_silent = 
# 131 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                   0
# 131 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                        ;
...
static claim_file_t *claimfiles_list = 
# 134 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                      ((void *)0)
# 134 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                          ;
...
static claim_file_t *last_claimfile = 
# 140 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                     ((void *)0)
# 140 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                         ;


static add_file_t *addfiles_list = 
# 143 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                  ((void *)0)
# 143 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                      ;
...
record_add_file (const char *file, addfile_enum_t type)
{
  ...
  if (!newfile)
    return LDPS_ERR;
  newfile->next = 
# 178 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                 ((void *)0)
# 178 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                     ;
  newfile->name = file;
  newfile->type = type;
...
parse_symdefstr (const char *str, struct ld_plugin_symbol *sym)
{
  ...
  colon5 = strchr (colon2+1, ':');
  if (!colon5)
    return LDPS_ERR;
  colon5 = strchr (colon5+1, ':');
  if (!colon5)
    return LDPS_ERR;
  colon5 = strchr (colon5+1, ':');
 ...
 return LDPS_ERR;
    ...
    sym->version = 
# 248 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                  ((void *)0)
# 248 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                      ;
  if (colon5 && colon5[1])
    {
...
static enum ld_plugin_status
set_register_hook (const char *whichhook, 
# 311 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                         _Bool 
# 311 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                              yesno)
{
  if (!strcmp ("claimfile", whichhook))
  ...
  else if (!strcmp ("allsymbolsreadsilent", whichhook))
    {
      register_allsymbolsread_hook = yesno;
      allsymbolsread_silent = 
# 320 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                             1
# 320 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                 ;
    }
...
parse_option (const char *opt)
{
  if (!strncmp ("fatal", opt, 5))
    {
      if (tv_message) (*tv_message) (LDPL_FATAL, "Fatal error");
      fflush (
# 336 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
             ((void *)0)
# 336 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                 );
    }
  else if (!strncmp ("error", opt, 5))
    {
      if (tv_message) (*tv_message) (LDPL_ERROR, "Error");
      fflush (
# 341 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
             ((void *)0)
# 341 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                 );
    }
  else if (!strncmp ("warning", opt, 7))
    {
      if (tv_message) (*tv_message) (LDPL_WARNING, "Warning");
      fflush (
# 346 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
             ((void *)0)
# 346 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                 );
    }
    ...
    return set_register_hook (opt + 8, 
# 353 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                      1
# 353 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                          );
  else if (!strncmp ("noregister", opt, 10))
    return set_register_hook (opt + 10, 
# 355 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                       0
# 355 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                            );
    ...
    dumpresolutions = 
# 367 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                     1
# 367 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                         ;
  else
    return LDPS_ERR;
  return LDPS_OK;
...
parse_tv_tag (struct ld_plugin_tv *tv)
{
 ...
 tv_register_claim_file_v2 = tv->tv_u.tv_register_claim_file_v2;
 break;
 ...
 tv_add_symbols = tv->tv_u.tv_add_symbols;
 break;
      case LDPT_GET_SYMBOLS:
 tv_get_symbols = tv->tv_u.tv_get_symbols;
 break;
      case LDPT_GET_SYMBOLS_V2:
 tv_get_symbols_v2 = tv->tv_u.tv_get_symbols;
 break;
      case LDPT_ADD_INPUT_FILE:
 tv_add_input_file = tv->tv_u.tv_add_input_file;
 break;
      case LDPT_MESSAGE:
 tv_message = tv->tv_u.tv_message;
 break;
      case LDPT_GET_INPUT_FILE:
 tv_get_input_file = tv->tv_u.tv_get_input_file;
 break;
      case LDPT_GET_VIEW:
 tv_get_view = tv->tv_u.tv_get_view;
 break;
      case LDPT_RELEASE_INPUT_FILE:
 tv_release_input_file = tv->tv_u.tv_release_input_file;
 break;
...
onload (struct ld_plugin_tv *tv)
{
 ...
 {
   if (tv_message) (*tv_message) (LDPL_FATAL, "No register_claim_file hook");
   fflush (
# 468 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
          ((void *)0)
# 468 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
              );
   return LDPS_ERR;
 }
 ...
 {
   if (tv_message) (*tv_message) (LDPL_FATAL, "No register_all_symbols_read hook");
   fflush (
# 478 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
          ((void *)0)
# 478 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
              );
   return LDPS_ERR;
 }
 ...
 {
   if (tv_message) (*tv_message) (LDPL_FATAL, "No register_cleanup hook");
   fflush (
# 488 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
          ((void *)0)
# 488 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
              );
   return LDPS_ERR;
 }
  ...
  if (onload_ret == LDPS_OK
      && (record_claim_file ("pr20070b.c", 248) != LDPS_OK
   ...
   || record_claim_file ("libpr20070.a", 248) != LDPS_OK
   || record_claimed_file_symbol ("def::0:0:0") != LDPS_OK
   || record_claimed_file_symbol ("weakdef::1:0:0") != LDPS_OK
   || record_claimed_file_symbol ("undef::2:0:0") != LDPS_OK
   || record_claimed_file_symbol ("weakundef::3:0:0") != LDPS_OK
...
# 532 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
 _Bool 
# 532 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
      islib;
  ...
  *claimed = (claimfile != 0);
  if (claimfile)
    {
      claimfile->claimed = 
# 561 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                          1
# 561 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                              ;
      claimfile->file = *file;
...
onall_symbols_read (void)
{
  ...
  claim_file_t *claimfile = dumpresolutions ? claimfiles_list : 
# 590 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
                                                               ((void *)0)
# 590 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
                                                                   ;
  ...
  if (! allsymbolsread_silent)
    if (tv_message) (*tv_message) (LDPL_INFO, "hook called: all symbols read.");
 ...
 return LDPS_ERR;
      ...
      if (rv != LDPS_OK)
 return rv;
      if (tv_message) (*tv_message) (LDPL_INFO, "Input: %s (%s)", file.name,
    claimfile->file.name);
 ...
 return rv;
      ...
      if (file.filesize != 248
   || 248 < (sizeof ("/* The first line of this file must match the expectation of") - 1)
   || memcmp (view, "/* The first line of this file must match the expectation of", (sizeof ("/* The first line of this file must match the expectation of") - 1)) != 0)
 {
   char result[(sizeof ("/* The first line of this file must match the expectation of") - 1) + 1];
   memcpy (result, view, sizeof (result));
   result[(sizeof ("/* The first line of this file must match the expectation of") - 1)] = '\0';
   if (tv_message) (*tv_message) (LDPL_INFO, "Incorrect view:");
   if (tv_message) (*tv_message) (LDPL_INFO, "  Expect: " "/* The first line of this file must match the expectation of");
   if (tv_message) (*tv_message) (LDPL_INFO, "  Result: %s", result);
 }
 ...
 if (tv_message) (*tv_message) (LDPL_INFO, "Sym: '%s%s%s' Resolution: %s",
 ...
 {
   if (tv_message) (*tv_message) (LDPL_FATAL, "Unreleased file descriptor on: %s",
        claimfile->file.name);
   free (filename);
   return LDPS_ERR;
 }
 ...
 return rv;
  ...
  fflush (
# 672 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
         ((void *)0)
# 672 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
             );
...
oncleanup (void)
{
  if (tv_message) (*tv_message) (LDPL_INFO, "hook called: cleanup.");
  fflush (
# 681 "/doner/binutils/binutils-515f23e/ld/testplug4.c" 3 4
         ((void *)0)
# 681 "/doner/binutils/binutils-515f23e/ld/testplug4.c"
             );
  return cleanup_ret;
}
