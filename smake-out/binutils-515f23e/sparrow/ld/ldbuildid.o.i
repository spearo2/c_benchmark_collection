# 1 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
# 21 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
...
# 22 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 2
# 1 "./../include/md5.h" 1
# 31 "./../include/md5.h"
...
# 25 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 2
# 1 "./../include/sha1.h" 1
# 25 "./../include/sha1.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 26 "./../include/sha1.h" 2
...
# 26 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
_Bool

# 35 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
validate_build_id_style (const char *style)
{
  if ((strcmp ((style), ("md5")) == 0) || (strcmp ((style), ("sha1")) == 0)
      || (strcmp ((style), ("uuid")) == 0) || (startswith (style, "0x")))
    return 
# 39 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
          1
# 39 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
              ;

  return 
# 41 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
        0
# 41 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
             ;
}
...
{
  if (strcmp ((style), ("md5")) == 0 || strcmp ((style), ("uuid")) == 0)
    return 128 / 8;
  ...
  if (startswith (style, "0x"))
    {
      ...
      do
 {
   if ((_sch_istable[(id[0]) & 0xff] & (unsigned short)(_sch_isxdigit)) && (_sch_istable[(id[1]) & 0xff] & (unsigned short)(_sch_isxdigit)))
     {
       ++size;
       id += 2;
     }
...
{
  if ((_sch_istable[(xdigit) & 0xff] & (unsigned short)(_sch_isdigit)))
    return xdigit - '0';

  if ((_sch_istable[(xdigit) & 0xff] & (unsigned short)(_sch_isupper)))
    return xdigit - 'A' + 0xa;

  if ((_sch_istable[(xdigit) & 0xff] & (unsigned short)(_sch_islower)))
    return xdigit - 'a' + 0xa;
...
# 96 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
_Bool

# 97 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
     ...
     int size __attribute__ ((__unused__)))
{
 ...
 return 
# 109 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
       0
# 109 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
            ;
 ...
 return 
# 118 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
       0
# 118 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
            ;
...
# 125 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
                                    00
# 125 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
                                            );

      if (fd < 0)
 return 
# 128 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
       0
# 128 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
            ;
      n = read (fd, id_bits, size);
      close (fd);
      if (n < size)
 return 
# 132 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
       0
# 132 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
            ;
# 157 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
    }
      ...
      do
 {
  ...
  return 
# 181 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c" 3 4
        1
# 181 "/doner/binutils/binutils-515f23e/ld/ldbuildid.c"
            ;
}
