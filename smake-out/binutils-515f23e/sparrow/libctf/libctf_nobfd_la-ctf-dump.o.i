# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
# 20 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 21 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 2
...
ctf_dump_append (ctf_dump_state_t *state, char *str)
{
  ...
  if ((cdi = malloc (sizeof (struct ctf_dump_item))) == 
# 58 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                                       ((void *)0)
# 58 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                                           )
    return (ctf_set_errno (state->cds_fp, 
# 59 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                         12
# 59 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                               ));
...
ctf_dump_free (ctf_dump_state_t *state)
{
  ...
  if (state == 
# 71 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
              ((void *)0)
# 71 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                  )
    return;

  for (cdi = ((void *)(((ctf_list_t *)(&state->cds_items))->l_next)); cdi != 
# 74 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                                      ((void *)0)
# 74 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                                          ;
       cdi = next_cdi)
    {
      free (cdi->cdi_item);
      next_cdi = ((void *)(((ctf_list_t *)(cdi))->l_next));
      free (cdi);
    }
}
# 90 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
static char *
ctf_dump_format_type (ctf_dict_t *fp, ctf_id_t id, int flag)
{
  ctf_id_t new_id;
  char *str = 
# 94 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
             ((void *)0)
# 94 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                 , *bit = 
# 94 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                          ((void *)0)
# 94 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
...
# 94 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
   ...
   if (id == 0 || ctf_errno (fp) == ECTF_NONREPRESENTABLE)
     {
       ...
       str = ctf_str_append_noerr (str, " (type not represented in CTF)");
       return str;
     }
 ...
 goto oom;
      str = ctf_str_append_noerr (str, bit);
      free (bit);
      bit = 
# 135 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
           ((void *)0)
# 135 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
               ;

      if (buf[0] != '\0')
 str = ctf_str_append_noerr (str, buf);

      free (buf);
      buf = 
# 141 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
           ((void *)0)
# 141 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
               ;
      ...
      if (unsliced_kind != 8 && ctf_type_encoding (fp, id, &ep) == 0)
 {
   if ((ssize_t) ep.cte_bits != ctf_type_size (fp, id) * 8
       && flag & 0x4)
     {
  ...
  goto oom;
       ...
       free (bit);
       bit = 
# 158 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
            ((void *)0)
# 158 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                ;
     }
  ...
  goto oom;
       ...
       free (bit);
       bit = 
# 174 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
            ((void *)0)
# 174 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                ;
     }
   ...
   free (bit);
   bit = 
# 181 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
        ((void *)0)
# 181 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
            ;
 }
      ...
      if (kind != 5 && size >= 0)
 {
   ...
   free (bit);
   bit = 
# 192 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
        ((void *)0)
# 192 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
            ;
 }
      ...
      if (align >= 0)
 {
   ...
   free (bit);
   bit = 
# 204 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
        ((void *)0)
# 204 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
            ;
 }

      if (nonroot_trailer[0] != 0)
 str = ctf_str_append_noerr (str, nonroot_trailer);
 ...
 new_id = ctf_type_reference (fp, id);
      if (new_id != ((ctf_id_t) -1L))
 str = ctf_str_append_noerr (str, " -> ");
    }
  while (new_id != ((ctf_id_t) -1L));

  if (ctf_errno (fp) != ECTF_NOTREF)
    {
      free (str);
      return 
# 234 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
            ((void *)0)
# 234 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                ;
    }
 ...
 oom:
  ctf_set_errno (fp, 
# 240 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                    (*__errno_location ())
# 240 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                         );
 err:
  ctf_err_warn (fp, 1, 0, dgettext ("libctf", "cannot format name dumping type 0x%lx"), id);
  free (buf);
  free (str);
  free (bit);
  return 
# 246 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
        ((void *)0)
# 246 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
            ;
}
...
# 264 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                            (*__errno_location ())
# 264 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                 ));
}
      ...
      const char *sect, uint32_t off, uint32_t nextoff)
{
 ...
 err:
  return (ctf_set_errno (fp, 
# 284 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                            (*__errno_location ())
# 284 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                 ));
}
...
ctf_dump_header (ctf_dict_t *fp, ctf_dump_state_t *state)
{
  char *str;
  char *flagstr = 
# 292 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                 ((void *)0)
# 292 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                     ;
  const ctf_header_t *hp = fp->ctf_header;
  const char *vertab[] =
    {
     
# 296 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
    ((void *)0)
# 296 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
        , "CTF_VERSION_1",
     "CTF_VERSION_1_UPGRADED_3 (latest format, version 1 type "
     "boundaries)",
     "CTF_VERSION_2",
     "CTF_VERSION_3", 
# 300 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                     ((void *)0)
    
# 301 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
   };
  const char *verstr = 
# 302 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                      ((void *)0)
# 302 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                          ;
  ...
  if (hp->cth_preamble.ctp_version <= 4)
    verstr = vertab[hp->cth_preamble.ctp_version];

  if (verstr == 
# 311 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
               ((void *)0)
# 311 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                   )
  ...
  verstr) < 0)
    goto err;
  ctf_dump_append (state, str);
# 326 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
  if (fp->ctf_openflags > 0)
    {
      if (asprintf (&flagstr, "%s%s%s%s%s%s%s",
      fp->ctf_openflags & 0x1
      ? "CTF_F_COMPRESS": "",
      (fp->ctf_openflags & 0x1)
      && (fp->ctf_openflags & ~0x1)
      ? ", " : "",
      fp->ctf_openflags & 0x2
      ? "CTF_F_NEWFUNCINFO" : "",
      (fp->ctf_openflags & (0x1 | 0x2))
      && (fp->ctf_openflags & ~(0x1 | 0x2))
      ? ", " : "",
      fp->ctf_openflags & 0x4
      ? "CTF_F_IDXSORTED" : "",
      fp->ctf_openflags & (0x1 | 0x2
      | 0x4)
      && (fp->ctf_openflags & ~(0x1 | 0x2
 ...
 err:
  free (flagstr);
  return (ctf_set_errno (fp, 
# 401 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                            (*__errno_location ())
# 401 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                 ));
}
  ...
  void *arg)
{
  ...
  if (asprintf (&str, "%s -> ", name) < 0)
    return (ctf_set_errno (state->cds_fp, 
# 415 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                         (*__errno_location ())
# 415 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                              ));

  if ((typestr = ctf_dump_format_type (state->cds_fp, info->ctb_type,
           1 | 0x2)) == 
# 418 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                          ((void *)0)
# 418 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                              )
    {
      free (str);
      return 0;
  ...
  str = ctf_str_append_noerr (str, typestr);
  free (typestr);
...
ctf_dump_objts (ctf_dict_t *fp, ctf_dump_state_t *state, int functions)
{
  ...
  ctf_id_t id;
  ctf_next_t *i = 
# 438 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                 ((void *)0)
# 438 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                     ;
  char *str = 
# 439 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
             ((void *)0)
# 439 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                 ;

  if ((functions && fp->ctf_funcidx_names)
      || (!functions && fp->ctf_objtidx_names))
    str = ctf_str_append_noerr (str, dgettext ("libctf", "Section is indexed.\n"));
  else if (fp->ctf_symtab.cts_data == 
# 444 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                     ((void *)0)
# 444 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                         )
    str = ctf_str_append_noerr (str, dgettext ("libctf", "No symbol table.\n"));

  while ((id = ctf_symbol_next (fp, &i, &name, functions)) != ((ctf_id_t) -1L))
    {
      char *typestr = 
# 449 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                     ((void *)0)
# 449 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                         ;
 ...
 str = xstrdup ("");
      ...
      if ((typestr = ctf_dump_format_type (state->cds_fp, id,
        1 | 0x2)) == 
# 462 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                       ((void *)0)
# 462 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                           )
 {
   ctf_dump_append (state, str);
   continue;
    ...
    oom:
      ctf_set_errno (fp, 
# 474 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                        12
# 474 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                              );
      ctf_next_destroy (i);
      return -1;
    }
...
ctf_dump_var (const char *name, ctf_id_t type, void *arg)
{
  ...
  if (asprintf (&str, "%s -> ", name) < 0)
    return (ctf_set_errno (state->cds_fp, 
# 490 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                         (*__errno_location ())
# 490 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                              ));

  if ((typestr = ctf_dump_format_type (state->cds_fp, type,
           1 | 0x2)) == 
# 493 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                          ((void *)0)
# 493 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                              )
    {
      free (str);
      return 0;
   ...
   int depth, void *arg)
{
  ...
  char *typestr = 
# 512 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                 ((void *)0)
# 512 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                     ;
  char *bit = 
# 513 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
             ((void *)0)
# 513 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                 ;
  ...
  if (asprintf (&bit, "%s%*s", state->cdm_toplevel_indent, (depth-1)*4, "") < 0)
    goto oom;
  *state->cdm_str = ctf_str_append_noerr (*state->cdm_str, bit);
  free (bit);

  if ((typestr = ctf_dump_format_type (state->cdm_fp, id,
           1 | 0x4
           | 0x8)) == 
# 526 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                           ((void *)0)
# 526 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                               )
    return -1;
  ...
  *state->cdm_str = ctf_str_append_noerr (*state->cdm_str, bit);
  ...
  free (bit);
  typestr = 
# 535 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
           ((void *)0)
# 535 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
               ;
  bit = 
# 536 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
       ((void *)0)
# 536 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
           ;
 ...
 oom:
  free (typestr);
  free (bit);
  return (ctf_set_errno (state->cdm_fp, 
# 543 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                       (*__errno_location ())
# 543 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                            ));
}
...
# 568 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                                         ((void *)0) 
# 568 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                                              };


  if (asprintf (&indent, "    %*s", type_hex_digits (id), "") < 0)
    return (ctf_set_errno (state->cds_fp, 
# 572 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                         12
# 572 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                               ));


  if ((str = ctf_dump_format_type (state->cds_fp, id,
       flag | 0x2)) == 
# 576 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                              ((void *)0)
# 576 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                  )
    goto err;
  str = ctf_str_append_noerr (str, "\n");
  ...
  if (ctf_type_kind (state->cds_fp, id) == 6
      || ctf_type_kind (state->cds_fp, id) == 7)
    {
      if ((ctf_type_visit (state->cds_fp, id, ctf_dump_member, &membstate)) < 0)
 {
   ...
   dgettext ("libctf", "cannot visit members dumping type 0x%lx"), id);
   goto err;
 }
    }
  ...
  if (ctf_type_kind (state->cds_fp, id) == 8)
    {
      int enum_count = ctf_member_count (state->cds_fp, id);
      ctf_next_t *it = 
# 604 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                      ((void *)0)
# 604 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                          ;
      int i = 0;
      ...
      &it, &value)) != 
# 611 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                      ((void *)0)
# 611 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                          )
 {
   i++;
   ...
   str = ctf_str_append_noerr (str, indent);
 ...
 {
   ctf_err_warn (state->cds_fp, 1, ctf_errno (state->cds_fp),
   dgettext ("libctf", "cannot visit enumerands dumping type 0x%lx"), id);
   goto err;
 }
    }
 ...
 oom:
  ...
  free (str);
  return ctf_set_errno (state->cds_fp, 
# 657 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                      12
# 657 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                            );
}
...
{
  const char *s = fp->ctf_str[0].cts_strs;

  for (; s < fp->ctf_str[0].cts_strs +
  fp->ctf_str[0].cts_len;)
    {
      char *str;
      if (asprintf (&str, "0x%lx: %s",
      (unsigned long) (s - fp->ctf_str[0].cts_strs),
      s) < 0)
 return (ctf_set_errno (fp, 
# 674 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                           (*__errno_location ())
# 674 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                ));
      ctf_dump_append (state, str);
      s += strlen (s) + 1;
    }
...
# 692 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
char *
...
# 698 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                           ((void *)0)
# 698 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                               ;

  if (*statep == 
# 700 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                ((void *)0)
# 700 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                    )
    {
      ...
      if ((*statep = malloc (sizeof (struct ctf_dump_state))) == 
# 708 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                                                                ((void *)0)
# 708 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                                                                    )
 {
   ctf_set_errno (fp, 
# 710 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                     12
# 710 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                           );
   goto end;
 }
      state = *statep;
      ...
      if (state->cds_sect != sect)
 {
  ...
  if (state->cds_current == 
# 767 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                           ((void *)0)
# 767 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                               )
    state->cds_current = ((void *)(((ctf_list_t *)(&state->cds_items))->l_next));
  else
    state->cds_current = ((void *)(((ctf_list_t *)(state->cds_current))->l_next));

  if (state->cds_current == 
# 772 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                           ((void *)0)
# 772 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                               )
    goto end;
  ...
  if (func)
    {
      ...
      str = 
# 781 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
           ((void *)0)
# 781 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
               ;
      for (line = state->cds_current->cdi_item; line && *line; )
 {
   ...
   str = ctf_str_append_noerr (str, ret);
   str = ctf_str_append_noerr (str, "\n");
   if (ret != line)
     free (ret);
 ...
 {
   ctf_set_errno (fp, 
# 816 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
                     12
# 816 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
                           );
   return str;
 }
    }
  ...
  ctf_set_errno (fp, 0);
  *statep = 
# 828 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
           ((void *)0)
# 828 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
               ;
  return 
# 829 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c" 3 4
        ((void *)0)
# 829 "/doner/binutils/binutils-515f23e/libctf/ctf-dump.c"
            ;
}
