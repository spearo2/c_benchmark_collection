# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
# 20 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 21 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 2
...
# 42 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
                            ((void *)0)
# 42 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
                                ;
  const char *s;
  ...
  if (extract_label_info (fp, &ctlp, &num_labels) < 0)
    return 
# 47 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
          ((void *)0)
# 47 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
              ;
  ...
  if (num_labels == 0)
    {
      ...
      return 
# 52 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
            ((void *)0)
# 52 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
                ;
    }

  if ((s = ctf_strraw (fp, (ctlp + num_labels - 1)->ctl_label)) == 
# 55 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
                                                                  ((void *)0)
# 55 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
                                                                      )
...
{
  const ctf_lblent_t *ctlp = 
# 66 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
                            ((void *)0)
# 66 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
                                ;
  uint32_t i;
  uint32_t num_labels = 0;
  ctf_lblinfo_t linfo;
  ...
  for (i = 0; i < num_labels; i++, ctlp++)
    {
      if ((lname = ctf_strraw (fp, ctlp->ctl_label)) == 
# 81 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
                                                       ((void *)0)
# 81 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
                                                           )
 {
  ...
  if (strcmp (lname, ((linfo_cb_arg_t *) arg)->lca_name) == 0)
    {
      ...
      if (((linfo_cb_arg_t *) arg)->lca_info != 
# 114 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c" 3 4
                                               ((void *)0)
# 114 "/doner/binutils/binutils-515f23e/libctf/ctf-labels.c"
                                                   )
