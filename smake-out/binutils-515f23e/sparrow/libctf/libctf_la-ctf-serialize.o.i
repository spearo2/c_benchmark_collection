# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
# 20 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 21 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 2
...
# 22 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 2
# 40 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
ctf_symtab_skippable (ctf_link_sym_t *sym)
{
  ...
  return (sym->st_name == 
# 73 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                         ((void *)0) 
# 73 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                              || sym->st_name[0] == 0
   || sym->st_shndx == 0
   || strcmp (sym->st_name, "_START_") == 0
   || strcmp (sym->st_name, "_END_") == 0
   || (sym->st_type == 1 && sym->st_shndx == 0xFFF1
       && sym->st_value == 0));
}
# 91 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
__attribute__((__nonnull__ (1,3,4,5,6,7,8)))
static int
...
{
  ctf_next_t *i = 
# 97 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                 ((void *)0)
# 97 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                     ;
  const void *name;
  const void *ctf_sym;
  ctf_dynhash_t *linker_known = 
# 100 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                               ((void *)0)
# 100 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                   ;
  int err;
  int beyond_max = 0;
  ...
  *padsize = 0;
  ...
  if (!(flags & 0x4))
    {
# 121 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
      if (!symfp->ctf_dynsyms)
 return 0;

      if ((linker_known = ctf_dynhash_create (ctf_hash_string, ctf_hash_eq_string,
           
# 125 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
          ((void *)0)
# 125 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
              , 
# 125 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                ((void *)0)
# 125 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
# 126 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                           12
# 126 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                 ));
           ...
           &name, &ctf_sym)) == 0)
 {
   ...
   if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 144, "!sym->st_nameidx_set", !!(!sym->st_nameidx_set))), 0))
     return -1;
   ...
   if (ctf_dynhash_cinsert (linker_known, name, ctf_sym) < 0)
     {
       ...
       return (ctf_set_errno (fp, 
# 150 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                 12
# 150 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                       ));
     }
 }
      if (err != ECTF_NEXT_END)
 {
   ctf_err_warn (fp, 0, err, dgettext ("libctf", "iterating over linker-known symbols during " "serialization")
                      );
   ctf_dynhash_destroy (linker_known);
  ...
  while ((err = ctf_dynhash_cnext (symhash, &i, &name, 
# 162 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                      ((void *)0)
# 162 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                          )) == 0)
    {
      ctf_link_sym_t *sym;
      ...
      if (!(flags & 0x4))
 {
   ...
   if ((sym = ctf_dynhash_lookup (symfp->ctf_dynsyms, name)) == 
# 170 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                               ((void *)0)
# 170 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                   )
     {
   ...
   if ((flags & 0x1)
       && sym->st_type != 2)
     {
       ctf_err_warn (fp, 1, 0, dgettext ("libctf", "symbol %s (%x) added to CTF as a " "function but is of type %x.  " "The symbol type lookup tables " "are probably corrupted")
     ...
     && sym->st_type != 1)
     {
       ctf_err_warn (fp, 1, 0, dgettext ("libctf", "symbol %s (%x) added to CTF as a " "data object but is of type %x.  " "The symbol type lookup tables " "are probably corrupted")
 ...
 (*max)++;
  ...
  if (err != ECTF_NEXT_END)
    {
      ctf_err_warn (fp, 0, err, dgettext ("libctf", "iterating over CTF symtypetab during " "serialization")
                      );
      ctf_dynhash_destroy (linker_known);
      return (ctf_set_errno (fp, err));
    }
  ...
  if (!(flags & 0x4))
    {
      while ((err = ctf_dynhash_cnext (linker_known, &i, 
# 227 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                        ((void *)0)
# 227 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                            , &ctf_sym)) == 0)
 {
   ctf_link_sym_t *sym = (ctf_link_sym_t *) ctf_sym;
   ...
   if (sym->st_symidx > *max)
     beyond_max++;
      ...
      if (err != ECTF_NEXT_END)
 {
   ctf_err_warn (fp, 0, err, dgettext ("libctf", "iterating over linker-known symbols " "during CTF serialization")
                                     );
   ctf_dynhash_destroy (linker_known);
   return (ctf_set_errno (fp, err));
 }
   ...
   uint32_t outmax, int size, int flags)
{
      ...
      if (!(flags & 0x4))
 {
   ...
   if (((flags & 0x1)
        && this_link_sym->st_type != 2)
       || (!(flags & 0x1)
    && this_link_sym->st_type != 1))
     continue;
   ...
   if ((this_link_sym->st_type == 2)
       && (ctf_dynhash_lookup (fp->ctf_objthash, sym_name)))
     continue;

   if ((this_link_sym->st_type == 1)
 ...
 sym_name = nameidx[i];
      ...
      if ((type = ctf_dynhash_lookup (symhash, sym_name)) == 
# 330 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                            ((void *)0)
# 330 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                )
 {
   if (flags & 0x2)
     *dpp++ = 0;
   continue;
      ...
      if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 337, "(((char *) dpp) - (char *) dp) < size", !!((((char *) dpp) - (char *) dp) < size))), 0))
 return -1;
      ...
      *dpp++ = (ctf_id_t) (uintptr_t) type;
      ...
      if ((flags & 0x2) && idx[i]->st_symidx == outmax)
 break;
    }
         ...
         const char **idx, uint32_t nidx, int size, int flags)
{
  ...
  if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 375, "!(flags & CTF_SYMTYPETAB_EMIT_PAD)", !!(!(flags & 0x2)))), 0))
    return -1;
      ...
      if (!(flags & 0x4))
 {
   ...
   if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 390, "this_link_sym != NULL", !!(this_link_sym != 
# 390 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
       ((void *)0)
# 390 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
       ))), 0))
     return -1;
 ...
 sym_name = idx[i];
      ...
      if ((type = ctf_dynhash_lookup (symhash, sym_name)) == 
# 422 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                            ((void *)0)
# 422 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                )
 continue;

      ctf_str_add_ref (fp, sym_name, dpp++);

      if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 427, "(((char *) dpp) - (char *) dp) <= size", !!((((char *) dpp) - (char *) dp) <= size))), 0))
 return -1;
    }
...
# 444 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                    ((void *)0)
# 444 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                        ; dvd = nvd)
    {
...
# 452 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                               ((void *)0)
   
# 453 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
  && type == dvd->dvd_type)
...
# 480 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
  s->sort_syms = 1;
  if (fp->ctf_flags & 0x0008)
    {
      s->filter_syms = !(fp->ctf_link_flags & 0x10);
      if (!s->filter_syms)
 s->sort_syms = 0;
    }
 ...
 s->symfp = fp;
  ...
  if (!s->filter_syms)
    ...
    hdr->cth_preamble.ctp_flags |= 0x4;

  if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 505, "(s->filter_syms && s->symfp) || (!s->filter_syms && !s->symfp && ((s->symflags & CTF_SYMTYPETAB_FORCE_INDEXED) != 0))", !!((s->filter_syms && s->symfp) || (!s->filter_syms && !s->symfp && ((s->symflags & 0x4) != 0))))), 0)
  ...
  ctf_dprintf ("Function symtypetab: %i functions, max %i, unpadded size %i, "
        ...
        (int) *funcidx_size);
# 545 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
  *objt_size = objt_unpadsize;
  if (!(s->symflags & 0x4)
      && ((objt_padsize + objt_unpadsize) * .75
   > objt_padsize))
    {
  ...
  *func_size = func_unpadsize;
  if (!(s->symflags & 0x4)
      && ((func_padsize + func_unpadsize) * .75
   > func_padsize))
    {
      ...
      size_t funcidx_size)
{
  ...
  size_t nsymtypes = 0;
  const char **sym_name_order = 
# 584 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                               ((void *)0)
# 584 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                   ;
  int err;
  ...
  if ((objtidx_size != 0) || (funcidx_size != 0))
    {
      ctf_next_t *i = 
# 591 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                     ((void *)0)
# 591 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                         ;
      void *symname;
      const char **walk;
 ...
 nsymtypes = ctf_dynhash_elements (fp->ctf_objthash)
   + ctf_dynhash_elements (fp->ctf_funchash);
      ...
      if ((sym_name_order = calloc (nsymtypes, sizeof (const char *))) == 
# 606 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                                         ((void *)0)
# 606 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                             )
 goto oom;
   ...
   if (s->symfp->ctf_dynsyms)
     {
       while ((err = ctf_dynhash_next_sorted (s->symfp->ctf_dynsyms, &i,
           &symname, 
# 616 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                    ((void *)0)
# 616 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                        ,
           ctf_dynhash_sort_by_name,
           
# 618 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
          ((void *)0)
# 618 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
              )) == 0)
...
# 626 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                             ((void *)0)
# 626 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                 ;
...
# 634 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
      ((void *)0)
# 634 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
          , sort_fun, 
# 634 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                      ((void *)0)
# 634 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
# 640 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
      ((void *)0)
# 640 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
          , sort_fun, 
# 640 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                      ((void *)0)
# 640 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
# 655 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                              ((void *)0)
# 655 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                  ,
      s->symfp->ctf_dynsymmax + 1, s->maxobjt,
      objt_size, s->symflags | 0x2) < 0)
 goto err;
    }
  else
    {
      ...
      if (emit_symtypetab (fp, s->symfp, (uint32_t *) t, 
# 663 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                        ((void *)0)
# 663 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                            ,
  ...
  if ((funcidx_size == 0) && s->symfp && s->symfp->ctf_dynsymidx)
    {
      ...
      if (emit_symtypetab (fp, s->symfp, (uint32_t *) t,
      s->symfp->ctf_dynsymidx, 
# 675 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                              ((void *)0)
# 675 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                  ,
      s->symfp->ctf_dynsymmax + 1, s->maxfunc,
      func_size, s->symflags | 0x1
      | 0x2) < 0)
 goto err;
    }
  else
    {
      ...
      if (emit_symtypetab (fp, s->symfp, (uint32_t *) t, 
# 684 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                        ((void *)0)
# 684 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                            , sym_name_order,
 ...
 oom:
  ctf_set_errno (fp, 
# 712 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                    11
# 712 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                          );
  goto err;
symerr:
  ctf_err_warn (fp, 0, err, dgettext ("libctf", "error serializing symtypetabs"));
 err:
  free (sym_name_order);
  return -1;
}
...
ctf_type_sect_size (ctf_dict_t *fp)
{
  ...
  for (type_size = 0, dtd = ((void *)(((ctf_list_t *)(&fp->ctf_dtdefs))->l_next));
       dtd != 
# 733 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
             ((void *)0)
# 733 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                 ; dtd = ((void *)(((ctf_list_t *)(dtd))->l_next)))
    {
      uint32_t kind = ((fp)->ctf_dictops->ctfo_get_kind(dtd->dtd_data.ctt_info));
      uint32_t vlen = ((fp)->ctf_dictops->ctfo_get_vlen(dtd->dtd_data.ctt_info));
      ...
      if (kind == 6 || kind == 7)
 {
   size_t lsize = (((uint64_t)(&dtd->dtd_data)->ctt_lsizehi) << 32 | (&dtd->dtd_data)->ctt_lsizelo);

   if (lsize <= 0xfffffffe)
     type_ctt_size = lsize;
 }

      if (type_ctt_size != 0xffffffff)
...
ctf_emit_type_sect (ctf_dict_t *fp, unsigned char **tptr)
{
  ...
  for (dtd = ((void *)(((ctf_list_t *)(&fp->ctf_dtdefs))->l_next));
       dtd != 
# 797 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
             ((void *)0)
# 797 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                 ; dtd = ((void *)(((ctf_list_t *)(dtd))->l_next)))
    {
      uint32_t kind = ((fp)->ctf_dictops->ctfo_get_kind(dtd->dtd_data.ctt_info));
      uint32_t vlen = ((fp)->ctf_dictops->ctfo_get_vlen(dtd->dtd_data.ctt_info));
 ...
 len = sizeof (ctf_type_t);
      ...
      copied = (ctf_stype_t *) t;
      if (copied->ctt_name
   && (name = ctf_strraw (fp, copied->ctt_name)) != 
# 826 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                   ((void *)0)
# 826 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                       )
 {
  ...
  if (type_ctt_size < 536870912)
    {
      ...
      t_vlen[i].ctm_offset = (((uint64_t)(&dtd_vlen[i])->ctlm_offsethi) << 32 | (&dtd_vlen[i])->ctlm_offsetlo);
...
# 951 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
int
ctf_serialize (ctf_dict_t *fp)
{
  ...
  size_t nvars;
  unsigned char *buf = 
# 967 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                      ((void *)0)
# 967 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                          , *newbuf;
  ...
  if (!(fp->ctf_flags & 0x0004))
    return 0;
# 986 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
  if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 986, "fp->ctf_str_num_refs == 0", !!(fp->ctf_str_num_refs == 0))), 0))
    return -1;
# 996 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
  memset (&hdr, 0, sizeof (hdr));
  hdr.cth_preamble.ctp_magic = 0xdff2;
  hdr.cth_preamble.ctp_version = 4;



  hdr.cth_preamble.ctp_flags = (0x2 | 0x8);

  if (ctf_symtypetab_sect_sizes (fp, &symstate, &hdr, &objt_size, &func_size,
     &objtidx_size, &funcidx_size) < 0)
    return -1;

  for (nvars = 0, dvd = ((void *)(((ctf_list_t *)(&fp->ctf_dvdefs))->l_next));
       dvd != 
# 1009 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
             ((void *)0)
# 1009 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                 ; dvd = ((void *)(((ctf_list_t *)(dvd))->l_next)), nvars++);
...
# 1028 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                  ((void *)0)
# 1028 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                      )
    return (ctf_set_errno (fp, 
# 1029 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                              11
# 1029 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                    ));
  ...
  if ((fp->ctf_flags & 0x0001) && (fp->ctf_parname != 
# 1035 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                         ((void *)0)
# 1035 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                             ))
    ctf_str_add_ref (fp, fp->ctf_parname, &hdrp->cth_parname);
  if (fp->ctf_cuname != 
# 1037 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                       ((void *)0)
# 1037 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                           )
...
# 1044 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ((void) sizeof ((
# 1044 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
# 1044 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 "t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_varoff"
# 1044 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 , "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 1044, __extension__ __PRETTY_FUNCTION__); }))
# 1044 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                             ;
  ...
  for (i = 0, dvd = ((void *)(((ctf_list_t *)(&fp->ctf_dvdefs))->l_next)); dvd != 
# 1050 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                           ((void *)0)
# 1050 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                               ;
       dvd = ((void *)(((ctf_list_t *)(dvd))->l_next)), i++)
    {
...
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ((void) sizeof ((
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 i == nvars
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
...
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 "i == nvars"
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 , "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 1058, __extension__ __PRETTY_FUNCTION__); }))
# 1058 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                    ;
...
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ((void) sizeof ((
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_typeoff
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_typeoff
...
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 "t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_typeoff"
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 , "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 1062, __extension__ __PRETTY_FUNCTION__); }))
# 1062 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                              ;
...
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ((void) sizeof ((
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_stroff
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_stroff
...
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
 "t == (unsigned char *) buf + sizeof (ctf_header_t) + hdr.cth_stroff"
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
 , "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 1066, __extension__ __PRETTY_FUNCTION__); }))
# 1066 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                             ;
  ...
  if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c", 1071, "num_missed_str_refs == 0", !!(num_missed_str_refs == 0))), 0))
    goto err;
  ...
  if (strtab.cts_strs == 
# 1080 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                        ((void *)0)
# 1080 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                            )
    goto oom;
  ...
  if ((newbuf = ctf_realloc (fp, buf, buf_size + strtab.cts_len)) == 
# 1089 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                                    ((void *)0)
# 1089 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                        )
    {
  ...
  if ((nfp = ctf_simple_open_internal ((char *) buf, buf_size, 
# 1104 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                              ((void *)0)
# 1104 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                                  , 0,
           0, 
# 1105 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
             ((void *)0)
# 1105 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                 , 0, fp->ctf_syn_ext_strtab,
           1, &err)) == 
# 1106 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                       ((void *)0)
# 1106 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                           )
    {
      free (buf);
      return (ctf_set_errno (fp, err));
  ...
  nfp->ctf_flags |= fp->ctf_flags & ~0x0004;
  if (nfp->ctf_dynbase == 
# 1118 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                         ((void *)0)
# 1118 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                             )
    nfp->ctf_dynbase = buf;
  ...
  fp->ctf_dthash = 
# 1172 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                  ((void *)0)
# 1172 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                      ;
  ...
  fp->ctf_str_atoms = 
# 1177 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                     ((void *)0)
# 1177 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                         ;
  fp->ctf_prov_strtab = 
# 1178 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                       ((void *)0)
# 1178 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                           ;
  fp->ctf_str_pending_ref = 
# 1179 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                           ((void *)0)
# 1179 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                               ;
  memset (&fp->ctf_dtdefs, 0, sizeof (ctf_list_t));
  memset (&fp->ctf_errs_warnings, 0, sizeof (ctf_list_t));
  fp->ctf_add_processing = 
# 1182 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                          ((void *)0)
# 1182 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                              ;
  fp->ctf_ptrtab = 
# 1183 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                  ((void *)0)
# 1183 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                      ;
  fp->ctf_pptrtab = 
# 1184 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                   ((void *)0)
# 1184 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                       ;
  fp->ctf_funcidx_names = 
# 1185 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                         ((void *)0)
# 1185 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                             ;
  fp->ctf_objtidx_names = 
# 1186 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                         ((void *)0)
# 1186 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                             ;
  fp->ctf_funcidx_sxlate = 
# 1187 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                          ((void *)0)
# 1187 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                              ;
  fp->ctf_objtidx_sxlate = 
# 1188 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                          ((void *)0)
# 1188 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                              ;
  fp->ctf_objthash = 
# 1189 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                    ((void *)0)
# 1189 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                        ;
  fp->ctf_funchash = 
# 1190 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                    ((void *)0)
# 1190 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                        ;
  fp->ctf_dynsyms = 
# 1191 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                   ((void *)0)
# 1191 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                       ;
  fp->ctf_dynsymidx = 
# 1192 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                     ((void *)0)
# 1192 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                         ;
  fp->ctf_link_inputs = 
# 1193 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                       ((void *)0)
# 1193 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                           ;
  fp->ctf_link_outputs = 
# 1194 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                        ((void *)0)
# 1194 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                            ;
  fp->ctf_syn_ext_strtab = 
# 1195 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                          ((void *)0)
# 1195 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                              ;
  fp->ctf_link_in_cu_mapping = 
# 1196 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                              ((void *)0)
# 1196 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                  ;
  fp->ctf_link_out_cu_mapping = 
# 1197 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                               ((void *)0)
# 1197 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                   ;
  fp->ctf_link_type_mapping = 
# 1198 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                             ((void *)0)
# 1198 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                 ;
  fp->ctf_dedup_atoms = 
# 1199 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                       ((void *)0)
# 1199 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                           ;
  fp->ctf_dedup_atoms_alloc = 
# 1200 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                             ((void *)0)
# 1200 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                 ;
  fp->ctf_parent_unreffed = 1;

  fp->ctf_dvhash = 
# 1203 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                  ((void *)0)
# 1203 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                      ;
  ...
  fp->ctf_structs.ctn_writable = 
# 1208 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                ((void *)0)
# 1208 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                    ;
  fp->ctf_unions.ctn_writable = 
# 1209 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                               ((void *)0)
# 1209 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                   ;
  fp->ctf_enums.ctn_writable = 
# 1210 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                              ((void *)0)
# 1210 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                  ;
  fp->ctf_names.ctn_writable = 
# 1211 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                              ((void *)0)
# 1211 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                  ;
...
oom:
  free (buf);
  return (ctf_set_errno (fp, 
# 1224 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                            11
# 1224 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                  ));
err:
  free (buf);
  return -1;
}
# 1239 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
int
ctf_gzwrite (ctf_dict_t *fp, gzFile fd)
{
 ...
 return (ctf_set_errno (fp, 
# 1251 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                           (*__errno_location ())
# 1251 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                ));
      resid -= len;
      buf += len;
    }
  ...
  while (resid != 0)
    {
      if ((len = gzwrite (fd, buf, resid)) <= 0)
 return (ctf_set_errno (fp, 
# 1261 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                           (*__errno_location ())
# 1261 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                ));
      resid -= len;
      buf += len;
    }
...
ctf_write_mem (ctf_dict_t *fp, size_t *size, size_t threshold)
{
  ...
  flip_endian = getenv ("LIBCTF_WRITE_FOREIGN_ENDIAN") != 
# 1285 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                         ((void *)0)
# 1285 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                             ;
  uncompressed = (fp->ctf_size < threshold);

  if (ctf_serialize (fp) < 0)
    return 
# 1289 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
          ((void *)0)
# 1289 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
              ;
...
# 1295 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                        ((void *)0)
# 1295 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                            )
    {
      ctf_set_errno (fp, 
# 1297 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                        12
# 1297 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                              );
      ctf_err_warn (fp, 0, 0, dgettext ("libctf", "ctf_write_mem: cannot allocate %li bytes"),
      (unsigned long) (compress_len + sizeof (struct ctf_header)));
      return 
# 1300 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
            ((void *)0)
# 1300 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                ;
    }
  ...
  *size = sizeof (struct ctf_header);
  ...
  src = fp->ctf_buf;
  flipped = 
# 1314 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
           ((void *)0)
# 1314 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
               ;

  if (flip_endian)
    {
      if ((flipped = malloc (fp->ctf_size)) == 
# 1318 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                              ((void *)0)
# 1318 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                  )
 {
   ctf_set_errno (fp, 
# 1320 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                     12
# 1320 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                           );
   ctf_err_warn (fp, 0, 0, dgettext ("libctf", "ctf_write_mem: cannot allocate %li bytes"),
   (unsigned long) (fp->ctf_size + sizeof (struct ctf_header)));
   return 
# 1323 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
         ((void *)0)
# 1323 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
             ;
 }
      ctf_flip_header (hp);
      ...
      if (ctf_flip (fp, fp->ctf_header, flipped, 1) < 0)
 {
   ...
   free (flipped);
   return 
# 1331 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
         ((void *)0)
# 1331 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
             ;
 }
      src = flipped;
    }
     ...
     src, fp->ctf_size)) != 0)
 {
   ...
   ctf_err_warn (fp, 0, 0, dgettext ("libctf", "zlib deflate err: %s"), zError (rc));
   free (buf);
   return 
# 1349 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
         ((void *)0)
# 1349 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
             ;
 }
      *size += compress_len;
    }
...
ctf_compress_write (ctf_dict_t *fp, int fd)
{
  ...
  if ((buf = ctf_write_mem (fp, &tmp, 0)) == 
# 1371 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                            ((void *)0)
# 1371 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                )
    return -1;
 ...
 {
   err = ctf_set_errno (fp, 
# 1381 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                           (*__errno_location ())
# 1381 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                );
   ctf_err_warn (fp, 0, 0, dgettext ("libctf", "ctf_compress_write: error writing"));
   goto ret;
 }
      buf_len -= len;
      bp += len;
...
ctf_write (ctf_dict_t *fp, int fd)
{
  ...
  if ((buf = ctf_write_mem (fp, &tmp, (size_t) -1)) == 
# 1405 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                                                      ((void *)0)
# 1405 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                                          )
    return -1;
 ...
 {
   err = ctf_set_errno (fp, 
# 1415 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c" 3 4
                           (*__errno_location ())
# 1415 "/doner/binutils/binutils-515f23e/libctf/ctf-serialize.c"
                                );
   ctf_err_warn (fp, 0, 0, dgettext ("libctf", "ctf_compress_write: error writing"));
   goto ret;
 }
