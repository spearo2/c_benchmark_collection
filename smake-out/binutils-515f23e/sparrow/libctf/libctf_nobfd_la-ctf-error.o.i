# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
# 20 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 21 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 22 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 2
# 39 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
static const union _ctf_errlist_t
{
  __extension__ struct
  {

char ctf_errstrECTF_FMT [sizeof ("File is not in CTF or ELF format.")]; char ctf_errstrECTF_BFDERR [sizeof ("BFD error.")]; char ctf_errstrECTF_CTFVERS [sizeof ("CTF dict version is too new for libctf.")]; char ctf_errstrECTF_BFD_AMBIGUOUS [sizeof ("Ambiguous BFD target.")]; char ctf_errstrECTF_SYMTAB [sizeof ("Symbol table uses invalid entry size.")]; char ctf_errstrECTF_SYMBAD [sizeof ("Symbol table data buffer is not valid.")]; char ctf_errstrECTF_STRBAD [sizeof ("String table data buffer is not valid.")]; char ctf_errstrECTF_CORRUPT [sizeof ("File data structure corruption detected.")]; char ctf_errstrECTF_NOCTFDATA [sizeof ("File does not contain CTF data.")]; char ctf_errstrECTF_NOCTFBUF [sizeof ("Buffer does not contain CTF data.")]; char ctf_errstrECTF_NOSYMTAB [sizeof ("Symbol table information is not available.")]; char ctf_errstrECTF_NOPARENT [sizeof ("The parent CTF dictionary is unavailable.")]; char ctf_errstrECTF_DMODEL [sizeof ("Data model mismatch.")]; char ctf_errstrECTF_LINKADDEDLATE [sizeof ("File added to link too late.")]; char ctf_errstrECTF_ZALLOC [sizeof ("Failed to allocate (de)compression buffer.")]; char ctf_errstrECTF_DECOMPRESS [sizeof ("Failed to decompress CTF data.")]; char ctf_errstrECTF_STRTAB [sizeof ("External string table is not available.")]; char ctf_errstrECTF_BADNAME [sizeof ("String name offset is corrupt.")]; char ctf_errstrECTF_BADID [sizeof ("Invalid type identifier.")]; char ctf_errstrECTF_NOTSOU [sizeof ("Type is not a struct or union.")]; char ctf_errstrECTF_NOTENUM [sizeof ("Type is not an enum.")]; char ctf_errstrECTF_NOTSUE [sizeof ("Type is not a struct, union, or enum.")]; char ctf_errstrECTF_NOTINTFP [sizeof ("Type is not an integer, float, or enum.")]; char ctf_errstrECTF_NOTARRAY [sizeof ("Type is not an array.")]; char ctf_errstrECTF_NOTREF [sizeof ("Type does not reference another type.")]; char ctf_errstrECTF_NAMELEN [sizeof ("Buffer is too small to hold type name.")]; char ctf_errstrECTF_NOTYPE [sizeof ("No type found corresponding to name.")]; char ctf_errstrECTF_SYNTAX [sizeof ("Syntax error in type name.")]; char ctf_errstrECTF_NOTFUNC [sizeof ("Symbol table entry or type is not a function.")]; char ctf_errstrECTF_NOFUNCDAT [sizeof ("No function information available for function.")]; char ctf_errstrECTF_NOTDATA [sizeof ("Symbol table entry does not refer to a data object.")]; char ctf_errstrECTF_NOTYPEDAT [sizeof ("No type information available for symbol.")]; char ctf_errstrECTF_NOLABEL [sizeof ("No label found corresponding to name.")]; char ctf_errstrECTF_NOLABELDATA [sizeof ("File does not contain any labels.")]; char ctf_errstrECTF_NOTSUP [sizeof ("Feature not supported.")]; char ctf_errstrECTF_NOENUMNAM [sizeof ("Enum element name not found.")]; char ctf_errstrECTF_NOMEMBNAM [sizeof ("Member name not found.")]; char ctf_errstrECTF_RDONLY [sizeof ("CTF container is read-only.")]; char ctf_errstrECTF_DTFULL [sizeof ("CTF type is full (no more members allowed).")]; char ctf_errstrECTF_FULL [sizeof ("CTF container is full.")]; char ctf_errstrECTF_DUPLICATE [sizeof ("Duplicate member or variable name.")]; char ctf_errstrECTF_CONFLICT [sizeof ("Conflicting type is already defined.")]; char ctf_errstrECTF_OVERROLLBACK [sizeof ("Attempt to roll back past a ctf_update.")]; char ctf_errstrECTF_COMPRESS [sizeof ("Failed to compress CTF data.")]; char ctf_errstrECTF_ARCREATE [sizeof ("Error creating CTF archive.")]; char ctf_errstrECTF_ARNNAME [sizeof ("Name not found in CTF archive.")]; char ctf_errstrECTF_SLICEOVERFLOW [sizeof ("Overflow of type bitness or offset in slice.")]; char ctf_errstrECTF_DUMPSECTUNKNOWN [sizeof ("Unknown section number in dump.")]; char ctf_errstrECTF_DUMPSECTCHANGED [sizeof ("Section changed in middle of dump.")]; char ctf_errstrECTF_NOTYET [sizeof ("Feature not yet implemented.")]; char ctf_errstrECTF_INTERNAL [sizeof ("Internal error: assertion failure.")]; char ctf_errstrECTF_NONREPRESENTABLE [sizeof ("Type not representable in CTF.")]; char ctf_errstrECTF_NEXT_END [sizeof ("End of iteration.")]; char ctf_errstrECTF_NEXT_WRONGFUN [sizeof ("Wrong iteration function called.")]; char ctf_errstrECTF_NEXT_WRONGFP [sizeof ("Iteration entity changed in mid-iterate.")]; char ctf_errstrECTF_FLAGS [sizeof ("CTF header contains flags unknown to libctf.")]; char ctf_errstrECTF_NEEDSBFD [sizeof ("This feature needs a libctf with BFD support.")]; char ctf_errstrECTF_INCOMPLETE [sizeof ("Type is not a complete type.")]; char ctf_errstrECTF_NONAME [sizeof ("Type name must not be empty.")];
...
[ECTF_FMT - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_FMT
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_CTFVERS
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_BFD_AMBIGUOUS - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_DMODEL
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_LINKADDEDLATE - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_ZALLOC
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_DECOMPRESS - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_NOLABEL
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_NOLABELDATA - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_CONFLICT
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_OVERROLLBACK - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_ARNNAME
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_SLICEOVERFLOW - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_SLICEOVERFLOW
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_DUMPSECTUNKNOWN - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_DUMPSECTUNKNOWN
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_DUMPSECTCHANGED - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_DUMPSECTCHANGED
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_NOTYET - 1000] = 
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_INTERNAL
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_NONREPRESENTABLE - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_NONREPRESENTABLE
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_NEXT_END - 1000] = 
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_NEXT_END
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_NEXT_WRONGFUN - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_NEXT_WRONGFUN
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_NEXT_WRONGFP - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
, 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
ctf_errstrECTF_NEEDSBFD
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
)
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
, [ECTF_INCOMPLETE - 1000] = 
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c" 3 4
__builtin_offsetof (
# 62 "/doner/binutils/binutils-515f23e/libctf/ctf-error.c"
union _ctf_errlist_t
...
ctf_errmsg (int error)
{
  ...
  if (error >= 1000 && (error - 1000) < (ECTF_NONAME - 1000 + 1))
    str = _ctf_errlist.str + _ctf_erridx[error - 1000];
  else
    str = (const char *) strerror (error);

  return (str ? dgettext ("libctf", str) : dgettext ("libctf", "Unknown error"));
}
