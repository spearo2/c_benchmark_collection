# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
# 20 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 21 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 2




# 26 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
const char *
ctf_strraw_explicit (ctf_dict_t *fp, uint32_t name, ctf_strs_t *strtab)
{
  ctf_strs_t *ctsp = &fp->ctf_str[((name) >> 31)];

  if ((((name) >> 31) == 0) && (strtab != 
# 31 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                          ((void *)0)
# 31 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                              ))
    ctsp = strtab;
...
# 38 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                  ((void *)0)
# 38 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                      )
  ...
  if (ctsp->cts_strs != 
# 52 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                       ((void *)0) 
# 52 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                            && ((name) & 0x7fffffff) < ctsp->cts_len)
    return (ctsp->cts_strs + ((name) & 0x7fffffff));


  return 
# 56 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
        ((void *)0)
# 56 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
            ;
}
...
{
  return ctf_strraw_explicit (fp, name, 
# 64 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                       ((void *)0)
# 64 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                           );
}
...
ctf_strptr (ctf_dict_t *fp, uint32_t name)
{
  ...
  return (s != 
# 73 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
              ((void *)0) 
# 73 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                   ? s : "(?)");
}
...
ctf_str_purge_atom_refs (ctf_str_atom_t *atom)
{
  ...
  for (ref = ((void *)(((ctf_list_t *)(&atom->csa_refs))->l_next)); ref != 
# 82 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                    ((void *)0)
# 82 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                        ; ref = next)
    {
      next = ((void *)(((ctf_list_t *)(ref))->l_next));
...
ctf_str_create_atoms (ctf_dict_t *fp)
{
  ...
  if (!fp->ctf_str_atoms)
    return -
# 108 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
           12
# 108 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                 ;
...
# 113 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
          ((void *)0)
# 113 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
              , 
# 113 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                ((void *)0)
# 113 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
...
# 120 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
      ((void *)0)
# 120 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
          );
  if (!fp->ctf_str_pending_ref)
    goto oom_str_pending_ref;

  
# 124 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
 (*__errno_location ()) 
# 124 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
       = 0;
  ctf_str_add (fp, "");
  if (
# 126 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
     (*__errno_location ()) 
# 126 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
           == 
# 126 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
              12
# 126 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
 ...
 oom_str_add:
  ...
  fp->ctf_prov_strtab = 
# 133 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                       ((void *)0)
# 133 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                           ;
 oom_str_pending_ref:
  ctf_dynset_destroy (fp->ctf_str_pending_ref);
  fp->ctf_str_pending_ref = 
# 136 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                           ((void *)0)
# 136 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                               ;
 oom_prov_strtab:
  ctf_dynhash_destroy (fp->ctf_str_atoms);
  fp->ctf_str_atoms = 
# 139 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                     ((void *)0)
# 139 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                         ;
  return -
# 140 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
         12
# 140 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
               ;
}
...
# 161 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
static ctf_str_atom_t *
ctf_str_add_ref_internal (ctf_dict_t *fp, const char *str,
     int flags, uint32_t *ref)
{
  char *newstr = 
# 165 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                ((void *)0)
# 165 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                    ;
  ctf_str_atom_t *atom = 
# 166 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                        ((void *)0)
# 166 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                            ;
  ctf_str_atom_ref_t *aref = 
# 167 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                            ((void *)0)
# 167 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                ;
  ...
  if (flags & 0x1)
    {
      if ((aref = malloc (sizeof (struct ctf_str_atom_ref))) == 
# 173 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                               ((void *)0)
# 173 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                                   )
 return 
# 174 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
       ((void *)0)
# 174 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
           ;
      aref->caf_ref = ref;
    }
      ...
      if (flags & 0x1)
 {
  ...
  if ((atom = malloc (sizeof (struct ctf_str_atom))) == 
# 189 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                       ((void *)0)
# 189 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                           )
    goto oom;
  memset (atom, 0, sizeof (struct ctf_str_atom));

  if ((newstr = strdup (str)) == 
# 193 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                ((void *)0)
# 193 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                    )
    goto oom;
 ...
 oom:
  ...
  free (newstr);
  ctf_set_errno (fp, 
# 232 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                    12
# 232 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                          );
  return 
# 233 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
        ((void *)0)
# 233 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
            ;
}
...
ctf_str_add (ctf_dict_t *fp, const char *str)
{
  ...
  atom = ctf_str_add_ref_internal (fp, str, 0x2, 0);
  if (!atom)
    return 0;
...
ctf_str_add_ref (ctf_dict_t *fp, const char *str, uint32_t *ref)
{
  ...
  atom = ctf_str_add_ref_internal (fp, str, 0x1
       | 0x2, ref);
  if (!atom)
    return 0;
...
ctf_str_add_pending (ctf_dict_t *fp, const char *str, uint32_t *ref)
{
  ...
  atom = ctf_str_add_ref_internal (fp, str, 0x4
       | 0x2, ref);
  if (!atom)
    return 0;
...
# 301 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                              12
# 301 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                    ));
...
ctf_str_add_external (ctf_dict_t *fp, const char *str, uint32_t offset)
{
  ...
  atom->csa_external_offset = ((offset) | ((unsigned int) 1) << 31);

  if (!fp->ctf_syn_ext_strtab)
    fp->ctf_syn_ext_strtab = ctf_dynhash_create (ctf_hash_integer,
       ctf_hash_eq_integer,
       
# 327 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
      ((void *)0)
# 327 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
          , 
# 327 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
            ((void *)0)
# 327 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
  ...
  if (!fp->ctf_syn_ext_strtab)
    {
      ctf_set_errno (fp, 
# 330 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                        12
# 330 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                              );
      return 0;
    }
  ...
  if (ctf_dynhash_insert (fp->ctf_syn_ext_strtab,
     ...
     (void *) atom->csa_str) < 0)
    {
      ...
      ctf_set_errno (fp, 
# 341 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                        12
# 341 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                              );
      return 0;
    }
...
ctf_str_remove_ref (ctf_dict_t *fp, const char *str, uint32_t *ref)
{
  ...
  ctf_str_atom_t *atom = 
# 353 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                        ((void *)0)
# 353 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                            ;
  ...
  for (aref = ((void *)(((ctf_list_t *)(&atom->csa_refs))->l_next)); aref != 
# 359 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                      ((void *)0)
# 359 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                          ; aref = anext)
    {
      anext = ((void *)(((ctf_list_t *)(aref))->l_next));
      if (aref->caf_ref == ref)
 {
...
static int
ctf_str_rollback_atom (void *key __attribute__ ((__unused__)), void *value, void *arg)
{
...
static void
ctf_str_purge_one_atom_refs (void *key __attribute__ ((__unused__)), void *value,
...
ctf_str_purge_refs (ctf_dict_t *fp)
{
  if (fp->ctf_str_num_refs > 0)
    ctf_dynhash_iter (fp->ctf_str_atoms, ctf_str_purge_one_atom_refs, 
# 407 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                                     ((void *)0)
# 407 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                                         );
...
ctf_str_update_refs (ctf_str_atom_t *refs, uint32_t value)
{
  ...
  for (ref = ((void *)(((ctf_list_t *)(&refs->csa_refs))->l_next)); ref != 
# 417 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                    ((void *)0)
# 417 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                        ;
       ref = ((void *)(((ctf_list_t *)(ref))->l_next)))
      *(ref->caf_ref) = value;
}
...
static void
ctf_str_count_strtab (void *key __attribute__ ((__unused__)), void *value,
       void *arg)
{
  ctf_str_atom_t *atom = (ctf_str_atom_t *) value;
  ctf_strtab_write_state_t *s = (ctf_strtab_write_state_t *) arg;
# 454 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
  if (s->nullstr == atom)
    {
      s->strtab_count++;
      return;
...
static void
ctf_str_populate_sorttab (void *key __attribute__ ((__unused__)), void *value,
    void *arg)
{
  ctf_str_atom_t *atom = (ctf_str_atom_t *) value;
  ctf_strtab_write_state_t *s = (ctf_strtab_write_state_t *) arg;
...
ctf_str_write_strtab (ctf_dict_t *fp)
{
  ...
  if (!nullstr)
    {
      ctf_err_warn (fp, 0, ECTF_INTERNAL, dgettext ("libctf", "null string not found in strtab"));
      strtab.cts_strs = 
# 519 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                       ((void *)0)
# 519 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                           ;
      return strtab;
    }
  ...
  if ((strtab.cts_strs = malloc (strtab.cts_len)) == 
# 543 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                                                    ((void *)0)
# 543 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                                        )
    goto oom_sorttab;
  ...
  if (!any_external)
    {
      ...
      fp->ctf_syn_ext_strtab = 
# 573 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c" 3 4
                              ((void *)0)
# 573 "/doner/binutils/binutils-515f23e/libctf/ctf-string.c"
                                  ;
    }
