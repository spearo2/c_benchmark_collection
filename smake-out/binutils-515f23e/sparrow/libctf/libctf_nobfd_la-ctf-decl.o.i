# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
# 40 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 41 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 2
...
ctf_decl_fini (ctf_decl_t *cd)
{
  ...
  for (i = CTF_PREC_BASE; i < CTF_PREC_MAX; i++)
    {
      for (cdp = ((void *)(((ctf_list_t *)(&cd->cd_nodes[i]))->l_next)); cdp != 
# 65 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                                                         ((void *)0)
# 65 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                                                             ; cdp = ndp)
 {
   ndp = ((void *)(((ctf_list_t *)(cdp))->l_next));
   free (cdp);
 }
    }
  free (cd->cd_buf);
...
# 85 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                                            ((void *)0)
# 85 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                                                )
    {
  ...
  switch (kind = ((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)))
    {
    case 4:
      ...
      if (ctf_strptr (fp, tp->ctt_name)[0] == '\0')
 {
  ...
  if ((cdp = malloc (sizeof (ctf_decl_node_t))) == 
# 137 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                                                  ((void *)0)
# 137 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                                                      )
    {
      cd->cd_err = 
# 139 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                  11
# 139 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                        ;
      return;
    }
  ...
  if (((void *)(((ctf_list_t *)(&cd->cd_nodes[prec]))->l_next)) == 
# 147 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                                            ((void *)0)
# 147 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                                                )
...
# 175 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
 __builtin_va_start(
# 175 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
 ap
# 175 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
 ,
# 175 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
...
# 177 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
 __builtin_va_end(
# 177 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
 ap
# 177 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
 )
# 177 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
  ...
  if (n > 0)
    {
      char *newbuf;
      if ((newbuf = ctf_str_append (cd->cd_buf, str)) != 
# 182 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                                                        ((void *)0)
# 182 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                                                            )
 cd->cd_buf = newbuf;
    }
  ...
  if (n < 0 || cd->cd_buf == 
# 187 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                            ((void *)0)
# 187 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                                )
    {
      free (cd->cd_buf);
      cd->cd_buf = 
# 190 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
                  ((void *)0)
# 190 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                      ;
      cd->cd_enomem = 1;
    }
...
char *ctf_decl_buf (ctf_decl_t *cd)
{
  char *buf = cd->cd_buf;
  cd->cd_buf = 
# 200 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c" 3 4
              ((void *)0)
# 200 "/doner/binutils/binutils-515f23e/libctf/ctf-decl.c"
                  ;
  return buf;
}
