# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
# 20 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
# 1 "./ctf-impl.h" 1
# 23 "./ctf-impl.h"
# 1 "./config.h" 1
# 24 "./ctf-impl.h" 2
...
# 796 "./ctf-impl.h" 2
# 21 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 2
...
# 22 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 2





# 26 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
int
...
{
  if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-types.c", 44, "n < LCTF_INFO_VLEN (fp, tp->ctt_info)", !!(n < ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info))))), 0))
    return -1;


  if (tp->ctt_size == 0xffffffff)
    {
      ctf_lmember_t *lmp = (ctf_lmember_t *) vlen;

      if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-types.c", 52, "(n + 1) * sizeof (ctf_lmember_t) <= vbytes", !!((n + 1) * sizeof (ctf_lmember_t) <= vbytes))), 0))
 return -1;
...
{
  ctf_next_t *i = 
# 74 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                 ((void *)0)
# 74 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                     ;
  ssize_t offset;
  const char *name;
  ctf_id_t membtype;
  ...
  if (!i)
    {
      ...
      if ((type = ctf_type_resolve (fp, type)) == ((ctf_id_t) -1L))
 return -1;

      if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 118 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                ((void *)0)
# 118 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                    )
 return -1;

      if ((i = ctf_next_create ()) == 
# 121 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 121 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         )
 return ctf_set_errno (ofp, 
# 122 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                           12
# 122 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                 );
      i->cu.ctn_fp = ofp;
      i->ctn_tp = tp;

      ctf_get_ctt_size (fp, tp, &size, &increment);
      kind = ((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info));
      ...
      if (kind != 6 && kind != 7)
 {
   ...
   return (ctf_set_errno (ofp, ECTF_NOTSOU));
      ...
      if ((dtd = ctf_dynamic_type (fp, type)) != 
# 135 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                ((void *)0)
# 135 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                    )
 {
      ...
      else
 {
   ...
   i->ctn_size = ((fp)->ctf_dictops->ctfo_get_vbytes(fp, kind, size, vlen));;
 }
  ...
  if ((fp = ctf_get_dict (ofp, type)) == 
# 159 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                        ((void *)0)
# 159 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                            )
    return (ctf_set_errno (ofp, ECTF_NOPARENT));

  max_vlen = ((fp)->ctf_dictops->ctfo_get_vlen(i->ctn_tp->ctt_info));
 ...
 *membtype = memb.ctlm_type;
      offset = (unsigned long) (((uint64_t)(&memb)->ctlm_offsethi) << 32 | (&memb)->ctlm_offsetlo);

      if (membname[0] == 0
   && (ctf_type_kind (fp, memb.ctlm_type) == 6
       || ctf_type_kind (fp, memb.ctlm_type) == 7))
      ...
      if (ctf_errno (fp) != ECTF_NEXT_END)
 {
   ctf_next_destroy (i);
   *it = 
# 217 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
        ((void *)0)
# 217 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
            ;
   i->ctn_type = 0;
   ...
   return ret;
      ...
      if (!__builtin_expect ((ctf_assert_internal (fp, "/doner/binutils/binutils-515f23e/libctf/ctf-types.c", 223, "(i->ctn_next == NULL)", !!((i->ctn_next == 
# 223 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 223 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
          )))), 0))
        return (ctf_set_errno (ofp, ctf_errno (fp)));
 ...
 end_iter:
  ctf_next_destroy (i);
  *it = 
# 235 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
       ((void *)0)
# 235 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
           ;
...
{
  ctf_next_t *i = 
# 245 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                 ((void *)0)
# 245 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                     ;
  const char *name;
  int val;

  while ((name = ctf_enum_next (fp, type, &i, &val)) != 
# 249 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                       ((void *)0)
# 249 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                           )
    {
      int rc;
  ...
  if (!i)
    {
      ...
      if ((type = ctf_type_resolve_unsliced (fp, type)) == ((ctf_id_t) -1L))
 return 
# 283 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
       ((void *)0)
# 283 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
           ;

      if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 285 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                ((void *)0)
# 285 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                    )
 return 
# 286 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
       ((void *)0)
# 286 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
           ;

      if ((i = ctf_next_create ()) == 
# 288 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 288 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         )
 {
   ctf_set_errno (ofp, 
# 290 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                      12
# 290 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                            );
   return 
# 291 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
         ((void *)0)
# 291 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
             ;
 }
      i->cu.ctn_fp = ofp;

      (void) ctf_get_ctt_size (fp, tp, 
# 295 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                      ((void *)0)
# 295 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                          ,
          &i->ctn_increment);
      kind = ((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info));
      ...
      if (kind != 8)
 {
   ...
   return 
# 303 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
         ((void *)0)
# 303 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
             ;
 }

      dtd = ctf_dynamic_type (fp, type);
      i->ctn_iter_fun = (void (*) (void)) ctf_enum_next;
      i->ctn_n = ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info));

      if (dtd == 
# 310 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                ((void *)0)
# 310 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                    )
  ...
  if ((void (*) (void)) ctf_enum_next != i->ctn_iter_fun)
    {
      ...
      return 
# 322 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 322 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                ;
    }
  ...
  if (ofp != i->cu.ctn_fp)
    {
      ...
      return 
# 328 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 328 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                ;
    }


  if ((fp = ctf_get_dict (ofp, type)) == 
# 332 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                        ((void *)0)
# 332 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                            )
    {
      ctf_set_errno (ofp, ECTF_NOPARENT);
      return 
# 335 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 335 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                ;
    }
 ...
 end_iter:
  ctf_next_destroy (i);
  *it = 
# 351 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
       ((void *)0)
# 351 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
           ;
  ctf_set_errno (ofp, ECTF_NEXT_END);
  return 
# 353 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
        ((void *)0)
# 353 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
            ;
}
# 363 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
int
ctf_type_iter (ctf_dict_t *fp, ctf_type_f *func, void *arg)
{
  ctf_next_t *i = 
# 366 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                 ((void *)0)
# 366 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                     ;
  ctf_id_t type;

  while ((type = ctf_type_next (fp, &i, 
# 369 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                       ((void *)0)
# 369 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                           , 0)) != ((ctf_id_t) -1L))
    {
      int rc;
...
# 391 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
int
ctf_type_iter_all (ctf_dict_t *fp, ctf_type_all_f *func, void *arg)
{
  ctf_next_t *i = 
# 394 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                 ((void *)0)
# 394 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                     ;
  ctf_id_t type;
  int flag;

  while ((type = ctf_type_next (fp, &i, &flag, 1)) != ((ctf_id_t) -1L))
    {
      int rc;
...
# 421 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
ctf_id_t
ctf_type_next (ctf_dict_t *fp, ctf_next_t **it, int *flag, int want_hidden)
{
  ...
  if (!i)
    {
      if ((i = ctf_next_create ()) == 
# 428 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 428 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         )
 return ctf_set_errno (fp, 
# 429 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                          12
# 429 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                );
  ...
  while (i->ctn_type <= fp->ctf_typemax)
    {
      const ctf_type_t *tp = ((fp->ctf_flags & 0x0002) ? &(ctf_dtd_lookup (fp, (fp->ctf_flags & 0x0001 ? ((i->ctn_type) | (fp->ctf_parmax+1)) : (i->ctn_type)))->dtd_data) : (ctf_type_t *)((uintptr_t)(fp)->ctf_buf + (fp)->ctf_txlate[(i->ctn_type)]));

      if ((!want_hidden) && (!((fp)->ctf_dictops->ctfo_get_root(tp->ctt_info))))
 {
   i->ctn_type++;
   continue;
 }
      ...
      if (flag)
 *flag = ((fp)->ctf_dictops->ctfo_get_root(tp->ctt_info));
      return (fp->ctf_flags & 0x0001 ? ((i->ctn_type++) | (fp->ctf_parmax+1)) : (i->ctn_type++));
    }
  ctf_next_destroy (i);
  *it = 
# 458 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
       ((void *)0)
# 458 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
           ;
...
{
  ctf_next_t *i = 
# 468 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                 ((void *)0)
# 468 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                     ;
  ctf_id_t type;
  const char *name;

  while ((type = ctf_variable_next (fp, &i, &name)) != ((ctf_id_t) -1L))
    {
      int rc;
...
ctf_variable_next (ctf_dict_t *fp, ctf_next_t **it, const char **name)
{
  ...
  if ((fp->ctf_flags & 0x0001) && (fp->ctf_parent == 
# 496 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                        ((void *)0)
# 496 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                            ))
  ...
  if (!i)
    {
      if ((i = ctf_next_create ()) == 
# 501 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 501 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         )
 return ctf_set_errno (fp, 
# 502 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                          12
# 502 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                );

      i->cu.ctn_fp = fp;
      i->ctn_iter_fun = (void (*) (void)) ctf_variable_next;
      if (fp->ctf_flags & 0x0002)
 i->u.ctn_dvd = ((void *)(((ctf_list_t *)(&fp->ctf_dvdefs))->l_next));
      *it = i;
    }
 ...
 goto end_iter;
  ...
  else
    {
      ...
      if (i->u.ctn_dvd == 
# 529 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                         ((void *)0)
# 529 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                             )
 goto end_iter;

      *name = i->u.ctn_dvd->dvd_name;
      id = i->u.ctn_dvd->dvd_type;
      i->u.ctn_dvd = ((void *)(((ctf_list_t *)(i->u.ctn_dvd))->l_next));
      return id;
    }
 ...
 end_iter:
  ctf_next_destroy (i);
  *it = 
# 540 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
       ((void *)0)
# 540 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
           ;
  return ctf_set_errno (fp, ECTF_NEXT_END);
}
# 555 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
ctf_id_t
ctf_type_resolve (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  while ((tp = ctf_lookup_by_id (&fp, type)) != 
# 565 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                               ((void *)0)
# 565 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                   )
    {
      switch (((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)))
 {
 case 10:
 case 11:
 case 12:
 case 13:
   if (tp->ctt_type == type || tp->ctt_type == otype
       || tp->ctt_type == prev)
     {
       ctf_err_warn (ofp, 0, ECTF_CORRUPT, dgettext ("libctf", "type %lx cycle detected"),
       otype);
...
ctf_type_resolve_unsliced (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 607 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 607 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return ((ctf_id_t) -1L);

  if ((((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info))) == 14)
    {
      ctf_id_t ret;

      if ((ret = ctf_type_reference (fp, type)) == ((ctf_id_t) -1L))
 return (ctf_set_errno (ofp, ctf_errno (fp)));
      return ret;
    }
  return type;
...
{
    if ((fp->ctf_flags & 0x0001) && ((type) <= fp->ctf_parmax))
...
ctf_type_aname (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if (fp == 
# 669 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
           ((void *)0) 
# 669 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                && type == ((ctf_id_t) -1L))
    return 
# 670 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 670 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
              ;
  ...
  if (cd.cd_err != 0)
    {
      ...
      return 
# 679 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 679 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                ;
    }
  ...
  for (prec = CTF_PREC_BASE; prec < CTF_PREC_MAX; prec++)
    {
      for (cdp = ((void *)(((ctf_list_t *)(&cd.cd_nodes[prec]))->l_next));
    cdp != 
# 699 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 699 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
              ; cdp = ((void *)(((ctf_list_t *)(cdp))->l_next)))
 {
   ctf_dict_t *rfp = fp;
       ...
       if (name[0] == '\0')
  {
    ...
    ctf_decl_fini (&cd);
    return 
# 725 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 725 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
              ;
  }
  ...
  ctf_funcinfo_t fi;
  ctf_id_t *argv = 
# 740 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                  ((void *)0)
# 740 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                      ;

  if (ctf_func_type_info (rfp, cdp->cd_type, &fi) < 0)
    goto err;

  if ((argv = calloc (fi.ctc_argc, sizeof (ctf_id_t *))) == 
# 745 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                           ((void *)0)
# 745 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                               )
    {
      ctf_set_errno (rfp, 
# 747 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                         (*__errno_location ())
# 747 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                              );
      goto err;
    }
  ...
  for (i = 0; i < fi.ctc_argc; i++)
    {
      ...
      if (arg == 
# 760 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                ((void *)0)
# 760 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                    )
        goto err;
  ...
  ctf_decl_fini (&cd);
  return 
# 781 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
        ((void *)0)
# 781 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
            ;
       }
       break;
     case 6:
  ...
  switch (ctf_type_kind_forwarded (fp, cdp->cd_type))
    ...
    default:
      ...
      ctf_decl_fini (&cd);
      return 
# 809 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 809 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                ;
    }
  break;
       }
     ...
     case 0:
       if (name[0] == '\0')
  ctf_decl_sprintf (&cd, dgettext ("libctf", "(nonrepresentable type)"));
       else
  ctf_decl_sprintf (&cd, dgettext ("libctf", "(nonrepresentable type %s)"),
      name);
       break;
     }
 ...
 ctf_decl_sprintf (&cd, ")");
  ...
  if (cd.cd_enomem)
    (void) ctf_set_errno (fp, 
# 839 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                             12
# 839 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                   );
...
ctf_type_lname (ctf_dict_t *fp, ctf_id_t type, char *buf, size_t len)
{
  ...
  if (str == 
# 856 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 856 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                )
    return ((ctf_id_t) -1L);
...
ctf_type_name (ctf_dict_t *fp, ctf_id_t type, char *buf, size_t len)
{
  ...
  return (rv >= 0 && (size_t) rv < len ? buf : 
# 876 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                              ((void *)0)
# 876 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                  );
}
...
ctf_type_name_raw (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 890 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 890 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return 
# 891 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 891 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
              ;
...
ctf_type_aname_raw (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if (name != 
# 907 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
             ((void *)0)
# 907 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                 )
    return strdup (name);

  return 
# 910 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
        ((void *)0)
# 910 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
            ;
}
...
ctf_type_size (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 927 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 927 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
  ...
  switch (((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)))
    ...
    case 4:
      ...
      if ((size = ctf_get_ctt_size (fp, tp, 
# 948 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                           ((void *)0)
# 948 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                               , 
# 948 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                 ((void *)0)
# 948 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
 ...
 return -1;
    ...
    default:
      return (ctf_get_ctt_size (fp, tp, 
# 962 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                       ((void *)0)
# 962 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                           , 
# 962 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                             ((void *)0)
# 962 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
...
ctf_type_align (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 981 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 981 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
 ...
 ctf_dtdef_t *dtd;
 unsigned char *vlen;
 uint32_t i = 0, n = ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info));
 ssize_t size, increment, vbytes;

 ctf_get_ctt_size (fp, tp, &size, &increment);

 if ((dtd = ctf_dynamic_type (fp, type)) != 
# 1010 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                           ((void *)0)
# 1010 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                               )
   {
     vlen = dtd->dtd_vlen;
 ...
 else
   {
     ...
     vbytes = ((fp)->ctf_dictops->ctfo_get_vbytes(fp, kind, size, n));
   }
 ...
 for (; n != 0; n--, i++)
   {
     ...
     align = ((align) > ((size_t) am) ? (align) : ((size_t) am));
   }
 return align;
      }
    ...
    default:
      return (ctf_get_ctt_size (fp, tp, 
# 1045 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                       ((void *)0)
# 1045 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                           , 
# 1045 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                             ((void *)0)
# 1045 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
...
ctf_type_kind_unsliced (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1056 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1056 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;

  return (((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)));
}
...
ctf_type_kind (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if (kind == 14)
    {
      if ((type = ctf_type_reference (fp, type)) == ((ctf_id_t) -1L))
 return -1;
...
ctf_type_kind_forwarded (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1097 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1097 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
...
ctf_type_reference (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1112 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1112 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return ((ctf_id_t) -1L);
 ...
 if ((dtd = ctf_dynamic_type (ofp, type)) == 
# 1129 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1129 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
   {
     ssize_t increment;

     (void) ctf_get_ctt_size (fp, tp, 
# 1133 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 1133 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         , &increment);
...
# 1154 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
ctf_id_t
ctf_type_pointer (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if (ctf_lookup_by_id (&fp, type) == 
# 1160 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 1160 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         )
    return ((ctf_id_t) -1L);

  if ((ntype = fp->ctf_ptrtab[((type) & (fp->ctf_parmax))]) != 0)
    return (((fp->ctf_flags & 0x0001) ? ((ntype) | (fp->ctf_parmax+1)) : (ntype)));

  if ((type = ctf_type_resolve (fp, type)) == ((ctf_id_t) -1L))
    return (ctf_set_errno (ofp, ECTF_NOTYPE));

  if (ctf_lookup_by_id (&fp, type) == 
# 1169 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                     ((void *)0)
# 1169 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                         )
    return (ctf_set_errno (ofp, ECTF_NOTYPE));
...
ctf_type_encoding (ctf_dict_t *fp, ctf_id_t type, ctf_encoding_t *ep)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1190 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1190 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;

  if ((dtd = ctf_dynamic_type (ofp, type)) != 
# 1193 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                             ((void *)0)
# 1193 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                 )
    vlen = dtd->dtd_vlen;
  else
    {
      ctf_get_ctt_size (fp, tp, 
# 1197 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                               ((void *)0)
# 1197 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                   , &increment);
  ...
  switch (((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)))
    ...
    case 1:
      ...
      ep->cte_offset = (((data) & 0x00ff0000) >> 16);
      ep->cte_bits = (((data) & 0x0000ffff));
      break;
    case 2:
      data = *(const uint32_t *) vlen;
      ep->cte_format = (((data) & 0xff000000) >> 24);
       ...
       ctf_id_t rtype)
{
  ...
  if (((ltype) <= lfp->ctf_parmax) && lfp->ctf_parent != 
# 1260 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                           ((void *)0)
# 1260 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                               )
    lfp = lfp->ctf_parent;

  if (((rtype) <= rfp->ctf_parmax) && rfp->ctf_parent != 
# 1263 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                                           ((void *)0)
# 1263 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                               )
    rfp = rfp->ctf_parent;
   ...
   ctf_dict_t *rfp, ctf_id_t rtype)
{
  ...
  if (ltp != 
# 1303 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0) 
# 1303 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                 && rtp != 
# 1303 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                           ((void *)0)
# 1303 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
...
ctf_member_count (ctf_dict_t *fp, ctf_id_t type)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1367 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1367 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
  ...
  return ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info));
}
   ...
   ctf_membinfo_t *mip)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1394 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1394 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
  ...
  n = ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info));
  if ((dtd = ctf_dynamic_type (fp, type)) != 
# 1404 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1404 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    {
      vlen = dtd->dtd_vlen;
      vbytes = dtd->dtd_vlen_alloc;
 ...
 {
   mip->ctm_offset += (unsigned long) (((uint64_t)(&memb)->ctlm_offsethi) << 32 | (&memb)->ctlm_offsetlo);
   return 0;
 }
...
ctf_array_info (ctf_dict_t *fp, ctf_id_t type, ctf_arinfo_t *arp)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1456 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1456 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;

  if (((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)) != 4)
    return (ctf_set_errno (ofp, ECTF_NOTARRAY));

  if ((dtd = ctf_dynamic_type (ofp, type)) != 
# 1462 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                             ((void *)0)
# 1462 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                 )
    ap = (const ctf_array_t *) dtd->dtd_vlen;
  else
    {
      ctf_get_ctt_size (fp, tp, 
# 1466 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                               ((void *)0)
# 1466 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                   , &increment);
...
ctf_enum_name (ctf_dict_t *fp, ctf_id_t type, int value)
{
  ...
  if ((type = ctf_type_resolve_unsliced (fp, type)) == ((ctf_id_t) -1L))
    return 
# 1490 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 1490 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
              ;

  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1492 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1492 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return 
# 1493 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
          ((void *)0)
# 1493 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
              ;

  if (((fp)->ctf_dictops->ctfo_get_kind(tp->ctt_info)) != 8)
    {
      ctf_set_errno (ofp, ECTF_NOTENUM);
      return 
# 1498 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
            ((void *)0)
# 1498 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                ;
    }

  ctf_get_ctt_size (fp, tp, 
# 1501 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                           ((void *)0)
# 1501 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                               , &increment);

  if ((dtd = ctf_dynamic_type (ofp, type)) == 
# 1503 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                             ((void *)0)
# 1503 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                 )
    ep = (const ctf_enum_t *) ((uintptr_t) tp + increment);
  else
    ep = (const ctf_enum_t *) dtd->dtd_vlen;

  for (n = ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info)); n != 0; n--, ep++)
    {
 ...
 return (ctf_strptr (fp, ep->cte_name));
  ...
  return 
# 1515 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
        ((void *)0)
# 1515 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
            ;
}
...
ctf_enum_value (ctf_dict_t *fp, ctf_id_t type, const char *name, int *valp)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1534 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1534 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
  ...
  ctf_get_ctt_size (fp, tp, 
# 1543 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                           ((void *)0)
# 1543 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                               , &increment);

  if ((dtd = ctf_dynamic_type (ofp, type)) == 
# 1545 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                             ((void *)0)
# 1545 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                 )
    ep = (const ctf_enum_t *) ((uintptr_t) tp + increment);
  else
    ep = (const ctf_enum_t *) dtd->dtd_vlen;
 ...
 {
   if (valp != 
# 1554 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
              ((void *)0)
# 1554 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                  )
     *valp = ep->cte_value;
   return 0;
 }
...
ctf_func_type_info (ctf_dict_t *fp, ctf_id_t type, ctf_funcinfo_t *fip)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1580 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1580 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
  ...
  fip->ctc_flags = 0;
  fip->ctc_argc = ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info));

  if ((dtd = ctf_dynamic_type (fp, type)) == 
# 1593 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1593 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
...
ctf_func_type_args (ctf_dict_t *fp, ctf_id_t type, uint32_t argc, ctf_id_t *argv)
{
  ...
  if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1625 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1625 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    return -1;
  ...
  if ((dtd = ctf_dynamic_type (fp, type)) == 
# 1630 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1630 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    args = (uint32_t *) ((uintptr_t) tp + increment);
  else
    args = (uint32_t *) dtd->dtd_vlen;

  for (argc = ((argc) < (f.ctc_argc) ? (argc) : (f.ctc_argc)); argc != 0; argc--)
    *argv++ = *args++;
   ...
   void *arg, const char *name, unsigned long offset, int depth)
{
  ...
  if (!nonrepresentable)
    if ((tp = ctf_lookup_by_id (&fp, type)) == 
# 1669 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                              ((void *)0)
# 1669 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                  )
      return -1;
  ...
  if (nonrepresentable || (kind != 6 && kind != 7))
    return 0;
  ...
  n = ((fp)->ctf_dictops->ctfo_get_vlen(tp->ctt_info));
  if ((dtd = ctf_dynamic_type (fp, type)) != 
# 1684 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c" 3 4
                                            ((void *)0)
# 1684 "/doner/binutils/binutils-515f23e/libctf/ctf-types.c"
                                                )
    {
      vlen = dtd->dtd_vlen;
      vbytes = dtd->dtd_vlen_alloc;
