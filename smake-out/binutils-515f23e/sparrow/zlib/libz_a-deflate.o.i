# 1 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
# 52 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
# 1 "/doner/binutils/binutils-515f23e/zlib/deflate.h" 1
# 16 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
# 1 "/doner/binutils/binutils-515f23e/zlib/zutil.h" 1
# 22 "/doner/binutils/binutils-515f23e/zlib/zutil.h"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 23 "/doner/binutils/binutils-515f23e/zlib/zutil.h" 2



# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 27 "/doner/binutils/binutils-515f23e/zlib/zutil.h" 2
...
# 29 "/doner/binutils/binutils-515f23e/zlib/zutil.h" 2
...
# 30 "/doner/binutils/binutils-515f23e/zlib/zutil.h" 2
# 39 "/doner/binutils/binutils-515f23e/zlib/zutil.h"
...
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 47 "/doner/binutils/binutils-515f23e/zlib/zutil.h" 2
# 56 "/doner/binutils/binutils-515f23e/zlib/zutil.h"
extern char * const z_errmsg[10];
# 194 "/doner/binutils/binutils-515f23e/zlib/zutil.h"
    extern uLong adler32_combine64 (uLong, uLong, off_t);
    extern uLong crc32_combine64 (uLong, uLong, off_t);
# 260 "/doner/binutils/binutils-515f23e/zlib/zutil.h"
   voidpf zcalloc (voidpf opaque, unsigned items, unsigned size)
                                                   ;
   void zcfree (voidpf opaque, voidpf ptr);
# 17 "/doner/binutils/binutils-515f23e/zlib/deflate.h" 2
# 68 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
...
typedef struct internal_state {
    ...
    Bytef *window;
# 129 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
    ulg window_size;
    ...
    uInt max_lazy_match;
# 188 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
    int level;
    int strategy;
    ...
    uInt lit_bufsize;
# 242 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
    uInt sym_next;
    uInt sym_end;
...
# 294 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
...
void _tr_stored_block (deflate_state *s, charf *buf, ulg stored_len, int last)
                                                  ;
# 317 "/doner/binutils/binutils-515f23e/zlib/deflate.h"
  extern const uch _length_code[];
  extern const uch _dist_code[];
# 53 "/doner/binutils/binutils-515f23e/zlib/deflate.c" 2

const char deflate_copyright[] =
   " deflate 1.2.12 Copyright 1995-2022 Jean-loup Gailly and Mark Adler ";
# 66 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
typedef enum {
    need_more,
    block_done,
    finish_started,
...
# 120 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 204 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
    ...
    int stream_size;
{
    deflate_state *s;
    int wrap = 1;
    static const char my_version[] = "1.2.12";
...
# 366 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 693 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 804 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1204 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1276 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
    ...
    IPos cur_match;
{
    ...
    Posf *prev = s->prev;
    uInt wmask = s->w_mask;
# 1302 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1370 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1522 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1574 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
        ;
...
# 1612 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1685 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
...
# 1750 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
        if (left) {
            if (left > len)
                left = len;
...
# 1872 "/doner/binutils/binutils-515f23e/zlib/deflate.c"
    ...
    int flush;
{
    ...
    for (;;) {
        ...
        if (s->match_length >= 3) {
            ...
            { uch len = (uch)(s->match_length - 3); ush dist = (ush)(s->strstart - s->match_start); s->sym_buf[s->sym_next++] = dist; s->sym_buf[s->sym_next++] = dist >> 8; s->sym_buf[s->sym_next++] = len; dist--; s->dyn_ltree[_length_code[len]+256 +1].fc.freq++; s->dyn_dtree[((dist) < 256 ? _dist_code[dist] : _dist_code[256+((dist)>>7)])].fc.freq++; bflush = (s->sym_next == s->sym_end); }
                                                               ;
    ...
    int flush;
{
    ...
    for (;;) {
        ...
        if (s->prev_length >= 3 && s->match_length <= s->prev_length) {
            ...
            { uch len = (uch)(s->prev_length - 3); ush dist = (ush)(s->strstart -1 - s->prev_match); s->sym_buf[s->sym_next++] = dist; s->sym_buf[s->sym_next++] = dist >> 8; s->sym_buf[s->sym_next++] = len; dist--; s->dyn_ltree[_length_code[len]+256 +1].fc.freq++; s->dyn_dtree[((dist) < 256 ? _dist_code[dist] : _dist_code[256+((dist)>>7)])].fc.freq++; bflush = (s->sym_next == s->sym_end); }
                                                              ;
    ...
    int flush;
{
    ...
    for (;;) {
        ...
        if (s->match_length >= 3) {
            ...
            { uch len = (uch)(s->match_length - 3); ush dist = (ush)(1); s->sym_buf[s->sym_next++] = dist; s->sym_buf[s->sym_next++] = dist >> 8; s->sym_buf[s->sym_next++] = len; dist--; s->dyn_ltree[_length_code[len]+256 +1].fc.freq++; s->dyn_dtree[((dist) < 256 ? _dist_code[dist] : _dist_code[256+((dist)>>7)])].fc.freq++; bflush = (s->sym_next == s->sym_end); };
