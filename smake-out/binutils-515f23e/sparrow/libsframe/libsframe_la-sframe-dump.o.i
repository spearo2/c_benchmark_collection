# 1 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
# 20 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
...
# 21 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 2
...
# 22 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 2
# 1 "/doner/binutils/binutils-515f23e/libsframe/sframe-impl.h" 1
# 23 "/doner/binutils/binutils-515f23e/libsframe/sframe-impl.h"
...
# 24 "/doner/binutils/binutils-515f23e/libsframe/sframe-impl.h" 2
...
# 31 "/doner/binutils/binutils-515f23e/libsframe/sframe-impl.h" 2



# 33 "/doner/binutils/binutils-515f23e/libsframe/sframe-impl.h"
...
# 25 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 2
...
static 
# 30 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
      _Bool

# 31 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
is_sframe_abi_arch_aarch64 (sframe_decoder_ctx *sfd_ctx)
{
  
# 33 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
 _Bool 
# 33 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
      aarch64_p = 
# 33 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
                  0
# 33 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
  ...
  if (abi_arch == 1
      || abi_arch == 2)
    aarch64_p = 
# 38 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
               1
# 38 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
                   ;
...
dump_sframe_header (sframe_decoder_ctx *sfd_ctx)
{
  ...
  char *flags_str;
  const char *ver_str = 
# 49 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
                       ((void *)0)
# 49 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
                           ;
 ...
 "SFRAME_F_FRAME_POINTER" };
  ...
  flags_str = (char*) calloc (sizeof (char), 50);
  if (flags)
    {
      if (flags & 0x1)
       ...
       uint64_t sec_addr)
{
  ...
  int fde_type_addrmask_p = ((((func_info) >> 4) & 0x1)
        == 1);
  const char *fde_type_marker
    = (fde_type_addrmask_p ? "[m]" : "   ");

  printf ("\n    func idx [%d]: pc = 0x%"
# 132 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
                                        "l" "x" 
# 132 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
                                               ", size = %d bytes",
   funcidx,
   func_start_pc_vma,
   func_size);
  ...
  for (j = 0; j < num_fres; j++)
    {
     ...
     : func_start_pc_vma + fre.fre_start_addr);
      ...
      printf ("\n");
      printf ("    %016"
# 162 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c" 3 4
                       "l" "x"
# 162 "/doner/binutils/binutils-515f23e/libsframe/sframe-dump.c"
                             , fre_start_pc_vma);
