# 1 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
# 25 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
# 1 "/doner/binutils/binutils-515f23e/libiberty/./config.h" 1
# 26 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 2
...
# 35 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
   ...
   int flags)
{
  ...
  if ((flags & 1) != 0)
    {
      if (pex != 
# 48 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                ((void *)0)
# 48 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                    )
 {
   *errmsg_fmt = (char *) "pexecute already in progress";
   *errmsg_arg = 
# 51 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                ((void *)0)
# 51 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                    ;
   return -1;
 }
    ...
    {
      if (pex == 
# 59 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                ((void *)0)
# 59 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                    )
 {
   *errmsg_fmt = (char *) "pexecute not in progress";
   *errmsg_arg = 
# 62 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                ((void *)0)
# 62 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                    ;
   return -1;
 }
    }
  ...
  errmsg = pex_run (pex,
      (((flags & 2) != 0 ? 0x1 : 0)
       | ((flags & 4) != 0 ? 0x2 : 0)),
      program, argv, 
# 70 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                    ((void *)0)
# 70 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                        , 
# 70 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                          ((void *)0)
# 70 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                              , &err);
  if (errmsg != 
# 71 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
               ((void *)0)
# 71 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                   )
    {
      *errmsg_fmt = (char *) errmsg;
      *errmsg_arg = 
# 74 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
                   ((void *)0)
# 74 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                       ;
      return -1;
    }
...
pwait (int pid, int *status, int flags __attribute__ ((__unused__)))
{
  ...
  if (pex == 
# 90 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
            ((void *)0) 
# 90 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
                 || pid < 0 || pid >= idx)
    return -1;
  ...
  if (pid + 1 == idx)
    {
      pex_free (pex);
      pex = 
# 119 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c" 3 4
           ((void *)0)
# 119 "/doner/binutils/binutils-515f23e/libiberty/./pexecute.c"
               ;
      idx = 0;
    }
