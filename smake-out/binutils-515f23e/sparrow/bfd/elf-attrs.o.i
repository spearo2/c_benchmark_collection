# 1 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
# 21 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
...
# 22 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 2
...
static 
# 42 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
      _Bool

# 43 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
is_default_attr (obj_attribute *attr)
{
  if (((attr->type) & (1 << 3)))
    return 
# 46 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
          1
# 46 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
              ;
  if (((attr->type) & (1 << 0)) && attr->i != 0)
    return 
# 48 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
          0
# 48 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
               ;
  if (((attr->type) & (1 << 1)) && attr->s && *attr->s)
    return 
# 50 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
          0
# 50 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
               ;
  if (((attr->type) & (1 << 2)))
    return 
# 52 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
          0
# 52 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
               ;

  return 
# 54 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
        1
# 54 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
            ;
}
...
bfd_elf_set_obj_attr_contents (bfd *abfd, bfd_byte *contents, bfd_vma size)
{
 ...
 vendor_set_obj_attr_contents (abfd, p, vendor_size, vendor);
  ...
  if (size != my_size)
    _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/elf-attrs.c", 227, __PRETTY_FUNCTION__);
}
...
elf_attr_strdup (bfd *abfd, const char *s, const char *end)
{
  ...
  if (p != 
# 318 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
          ((void *)0)
# 318 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
              )
    {
      memcpy (p, s, len);
      p[len] = 0;
...
{
  return elf_attr_strdup (abfd, s, 
# 329 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                  ((void *)0)
# 329 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                      );
}
...
bfd_elf_add_obj_attr_string (bfd *abfd, int vendor, unsigned int tag,
        const char *s)
{
  elf_add_obj_attr_string (abfd, vendor, tag, s, 
# 348 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                ((void *)0)
# 348 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                    );
}
...
{
  elf_add_obj_attr_int_string (abfd, vendor, tag, i, s, 
# 368 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                       ((void *)0)
# 368 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                           );
}
    ...
    list = list->next)
 {
   ...
   switch (in_attr->type & ((1 << 0) | (1 << 1)))
     ...
     case (1 << 0) | (1 << 1):
       ...
       break;
     default:
       _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/elf-attrs.c", 420, __PRETTY_FUNCTION__);
     }
 }
    }
}
...
_bfd_elf_obj_attrs_arg_type (bfd *abfd, int vendor, unsigned int tag)
{
  switch (vendor)
    ...
    case 1:
      ...
      break;
    default:
      _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/elf-attrs.c", 455, __PRETTY_FUNCTION__);
    }
}
...
_bfd_elf_parse_attributes (bfd *abfd, Elf_Internal_Shdr * hdr)
{
      ...
      while (p_end - p >= 4)
 {
   ...
   if (section_len <= 4)
     {
       _bfd_error_handler
  (dgettext ("bfd", "%pB: error: attribute section length too small: %ld"),
   ...
   while (section_len > 0)
     {
       ...
       orig_p = p;
       tag = _bfd_safe_read_leb128 (abfd, &p, 
# 543 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                             0
# 543 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                  , p_end);
       if (p_end - p >= 4)
  {
    ...
    while (p < end)
      {
        ...
        tag = _bfd_safe_read_leb128 (abfd, &p, 
# 567 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                              0
# 567 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                   , end);
        type = _bfd_elf_obj_attrs_arg_type (abfd, vendor, tag);
        switch (type & ((1 << 0) | (1 << 1)))
   {
   case (1 << 0) | (1 << 1):
     val = _bfd_safe_read_leb128 (abfd, &p, 
# 572 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                           0
# 572 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                , end);
   ...
   case (1 << 0):
     val = _bfd_safe_read_leb128 (abfd, &p, 
# 589 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                           0
# 589 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                , end);
     bfd_elf_add_obj_attr_int (abfd, vendor, tag, val);
     break;
   default:
     _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/elf-attrs.c", 593, __PRETTY_FUNCTION__);
   }
      }
    break;
  case Tag_Section:
...
# 622 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"

# 622 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
_Bool

# 623 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
_bfd_elf_merge_object_attributes (bfd *ibfd, struct bfd_link_info *info)
{
      ...
      if (in_attr->i > 0 && strcmp (in_attr->s, "gnu") != 0)
 {
  ...
  (dgettext ("bfd", "error: %pB: object has vendor-specific contents that " "must be processed by the '%s' toolchain")
   ...
   ibfd, in_attr->s);
   return 
# 647 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
         0
# 647 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
              ;
 }
   ...
   || (in_attr->i != 0 && strcmp (in_attr->s, out_attr->s) != 0))
 {
   ...
   return 
# 659 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
         0
# 659 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
              ;
 }
    }

  return 
# 663 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
        1
# 663 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
            ;
}
...
# 670 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
_Bool

# 671 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
_bfd_elf_merge_unknown_attribute_low (bfd *ibfd, bfd *obfd, int tag)
{
  obj_attribute *in_attr;
  obj_attribute *out_attr;
  bfd *err_bfd = 
# 675 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                ((void *)0)
# 675 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                    ;
  
# 676 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
 _Bool 
# 676 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
      result = 
# 676 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
               1
# 676 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
  ...
  if (out_attr[tag].i != 0 || out_attr[tag].s != 
# 681 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                ((void *)0)
# 681 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                    )
    err_bfd = obfd;
  else if (in_attr[tag].i != 0 || in_attr[tag].s != 
# 683 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                   ((void *)0)
# 683 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                                       )
    err_bfd = ibfd;

  if (err_bfd != 
# 686 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                ((void *)0)
# 686 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                    )
    result
  ...
  if (in_attr[tag].i != out_attr[tag].i
      || (in_attr[tag].s == 
# 692 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                           ((void *)0)
# 692 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                               ) != (out_attr[tag].s == 
# 692 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                        ((void *)0)
# 692 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
      ...
      || (in_attr[tag].s != 
# 693 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                           ((void *)0) 
# 693 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                && out_attr[tag].s != 
# 693 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                      ((void *)0)
   
# 694 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
  && strcmp (in_attr[tag].s, out_attr[tag].s) != 0))
    {
      out_attr[tag].i = 0;
      out_attr[tag].s = 
# 697 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                       ((void *)0)
# 697 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                           ;
    }
...
# 707 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
_Bool

# 708 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
...
# 713 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
 _Bool 
# 713 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
      result = 
# 713 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
               1
# 713 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
  ...
  for (; in_list || out_list; )
    {
      bfd *err_bfd = 
# 721 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                    ((void *)0)
# 721 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                        ;
      ...
      else
 {
   ...
   if (in_list->attr.i != out_list->attr.i
       || (in_list->attr.s == 
# 752 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                             ((void *)0)
# 752 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
                                 ) != (out_list->attr.s == 
# 752 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c" 3 4
                                                           ((void *)0)
# 752 "/doner/binutils/binutils-515f23e/bfd/elf-attrs.c"
