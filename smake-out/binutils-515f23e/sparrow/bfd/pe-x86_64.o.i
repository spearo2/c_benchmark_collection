# 1 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
# 24 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
...
# 25 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
# 72 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
extern 
# 72 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
      _Bool 
# 72 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
...
static 
# 76 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
      _Bool

# 77 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
pex64_link_add_symbols (bfd *abfd, struct bfd_link_info *info)
{
  if (((info)->type == type_pde)
      && bfd_get_flavour (info->output_bfd) == bfd_target_elf_flavour)
    {
      ...
      hi = bfd_link_hash_lookup (info->hash, "__ImageBase", 
# 87 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
                                                           1
# 87 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
                                                               , 
# 87 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
                                                                 0
# 87 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
...
# 88 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
    0
# 88 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
         );
...
# 94 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
       1
# 94 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
           , 
# 94 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 3 4
             0
# 94 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c"
...
# 125 "/doner/binutils/binutils-515f23e/bfd/peicode.h"
...
{
  struct external_filehdr *filehdr_src = (struct external_filehdr *) src;
...
# 228 "/doner/binutils/binutils-515f23e/bfd/peicode.h"
  scnhdr_int->s_nreloc = ((*((abfd)->xvec->bfd_h_getx16)) (scnhdr_ext->s_nreloc));
...
# 313 "/doner/binutils/binutils-515f23e/bfd/peicode.h"
  ...
  if ((internal_f->f_flags & 0x0200) == 0)
    abfd->flags |= 0x08;
# 352 "/doner/binutils/binutils-515f23e/bfd/peicode.h"
...
# 2920 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
                          ;
  file_ptr old_sofar;
# 2941 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
...
# 3084 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
  {

    target_index = 1;
    for (current = abfd->sections; current != 
# 3087 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
                                             ((void *)0)
# 3087 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
...
# 3103 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
       ...
       current = current->next)
    {
# 3130 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
      if (!(current->flags & 0x100))
 continue;

      current->rawsize = current->size;
# 3144 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
      if ((abfd->flags & 0x2) != 0)
 {
   ...
   sofar = ((((bfd_vma) (sofar) + ((bfd_vma) 1 << current->alignment_power) - 1) >= (bfd_vma) (sofar)) ? (((bfd_vma) (sofar) + (((bfd_vma) 1 << current->alignment_power) - 1)) & ~ (bfd_vma) (((bfd_vma) 1 << current->alignment_power)-1)) : ~ (bfd_vma) 0);
...
# 3252 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
...
# 3431 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
static 
...
# 3557 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
      internal_f.f_nscns++;
...
# 3630 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
 ...
 section.s_vaddr = 0;
      ...
      section.s_paddr = 0;
# 3665 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
      if (current->size == 0
 ...
 hasrelocs = 
# 3678 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
            1
# 3678 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
                ;
...
# 3746 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
 {
...
static const bfd_coff_backend_data bfd_coff_std_swap_table __attribute__ ((__unused__)) =
{
  ...
  _bfd_pex64_only_swap_filehdr_out, _bfd_pex64i_swap_aouthdr_out,
  _bfd_pex64i_swap_scnhdr_out,
  20, (24 + 196 + 5 * 4), 40, 18, 18, 10, (4 + 2), 18,
...
# 5620 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
...
coff_bigobj_swap_filehdr_in (bfd * abfd, void * src, void * dst)
{
  ...
  filehdr_dst->f_magic = ((*((abfd)->xvec->bfd_h_getx16)) (filehdr_src->Machine));
  filehdr_dst->f_nscns = ((*((abfd)->xvec->bfd_h_getx32)) (filehdr_src->NumberOfSections));
  filehdr_dst->f_timdat = ((*((abfd)->xvec->bfd_h_getx32)) (filehdr_src->TimeDateStamp));
  filehdr_dst->f_symptr =
    ((*((abfd)->xvec->bfd_h_getx32)) (filehdr_src->PointerToSymbolTable));
  filehdr_dst->f_nsyms = ((*((abfd)->xvec->bfd_h_getx32)) (filehdr_src->NumberOfSymbols));
  filehdr_dst->f_opthdr = 0;
  filehdr_dst->f_flags = 0;


  if (((*((abfd)->xvec->bfd_h_getx16)) (filehdr_src->Sig1)) != 0x0000
      || ((*((abfd)->xvec->bfd_h_getx16)) (filehdr_src->Sig2)) != 0xffff
      || ((*((abfd)->xvec->bfd_h_getx16)) (filehdr_src->Version)) != 2
...
coff_bigobj_swap_filehdr_out (bfd *abfd, void * in, void * out)
{
  ...
  ((*((abfd)->xvec->bfd_h_putx16)) (0x0000, filehdr_out->Sig1));
  ((*((abfd)->xvec->bfd_h_putx16)) (0xffff, filehdr_out->Sig2));
  ((*((abfd)->xvec->bfd_h_putx16)) (2, filehdr_out->Version));
  memcpy (filehdr_out->ClassID, header_bigobj_classid, 16);
  ((*((abfd)->xvec->bfd_h_putx16)) (filehdr_in->f_magic, filehdr_out->Machine));
  ((*((abfd)->xvec->bfd_h_putx32)) (filehdr_in->f_nscns, filehdr_out->NumberOfSections));
  ((*((abfd)->xvec->bfd_h_putx32)) (filehdr_in->f_timdat, filehdr_out->TimeDateStamp));
  ((*((abfd)->xvec->bfd_h_putx32)) (filehdr_in->f_symptr, filehdr_out->PointerToSymbolTable))
                                          ;
  ((*((abfd)->xvec->bfd_h_putx32)) (filehdr_in->f_nsyms, filehdr_out->NumberOfSymbols));

  return (((const bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_filhsz);
}

static void
coff_bigobj_swap_sym_in (bfd * abfd, void * ext1, void * in1)
{
  struct external_SYMBOL_EX *ext = (struct external_SYMBOL_EX *) ext1;
  ...
  do { if (!(sizeof (in->n_scnum) >= 4)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/coffcode.h",5701); } while (0);
  in->n_scnum = ((*((abfd)->xvec->bfd_h_getx32)) (ext->e_scnum));
  in->n_type = ((*((abfd)->xvec->bfd_h_getx16)) (ext->e_type));
  in->n_sclass = ((bfd_vma) *(const bfd_byte *) (ext->e_sclass) & 0xff);
  in->n_numaux = ((bfd_vma) *(const bfd_byte *) (ext->e_numaux) & 0xff);
}
...
coff_bigobj_swap_sym_out (bfd * abfd, void * inp, void * extp)
{
  ...
  struct external_SYMBOL_EX *ext = (struct external_SYMBOL_EX *) extp;
  ...
  ((*((abfd)->xvec->bfd_h_putx32)) (in->n_scnum, ext->e_scnum));

  ((*((abfd)->xvec->bfd_h_putx16)) (in->n_type, ext->e_type));
  ((void) (*((bfd_byte *) (ext->e_sclass)) = (in->n_sclass) & 0xff));
  ((void) (*((bfd_byte *) (ext->e_numaux)) = (in->n_numaux) & 0xff));
...
coff_bigobj_swap_aux_in (bfd *abfd,
    ...
    void * in1)
{
  union external_AUX_SYMBOL_EX *ext = (union external_AUX_SYMBOL_EX *) ext1;
      ...
      if (numaux > 1)
 {
   if (indx == 0)
     memcpy (in->x_file.x_n.x_fname, ext->File.Name,
      numaux * sizeof (union external_AUX_SYMBOL_EX));
 }
      else
 memcpy (in->x_file.x_n.x_fname, ext->File.Name, sizeof (ext->File.Name));
    ...
    case 106:
      if (type == 0)
 {
   in->x_scn.x_scnlen = ((*((abfd)->xvec->bfd_h_getx32)) (ext->Section.Length));
   in->x_scn.x_nreloc =
     ((*((abfd)->xvec->bfd_h_getx16)) (ext->Section.NumberOfRelocations));
   in->x_scn.x_nlinno =
     ((*((abfd)->xvec->bfd_h_getx16)) (ext->Section.NumberOfLinenumbers));
   in->x_scn.x_checksum = ((*((abfd)->xvec->bfd_h_getx32)) (ext->Section.Checksum));
   in->x_scn.x_associated = ((*((abfd)->xvec->bfd_h_getx16)) (ext->Section.Number))
     | (((*((abfd)->xvec->bfd_h_getx16)) (ext->Section.HighNumber)) << 16);
   in->x_scn.x_comdat = ((bfd_vma) *(const bfd_byte *) (ext->Section.Selection) & 0xff);
   return;
 }
      break;

    default:
      in->x_sym.x_tagndx.u32 = ((*((abfd)->xvec->bfd_h_getx32)) (ext->Sym.WeakDefaultSymIndex));
     ...
     void * extp)
{
  ...
  union external_AUX_SYMBOL_EX *ext = (union external_AUX_SYMBOL_EX *) extp;
  ...
  switch (in_class)
    ...
    case 106:
      if (type == 0)
 {
   ((*((abfd)->xvec->bfd_h_putx32)) (in->x_scn.x_scnlen, ext->Section.Length));
   ((*((abfd)->xvec->bfd_h_putx16)) (in->x_scn.x_nreloc, ext->Section.NumberOfRelocations))
                                       ;
   ((*((abfd)->xvec->bfd_h_putx16)) (in->x_scn.x_nlinno, ext->Section.NumberOfLinenumbers))
                                       ;
   ((*((abfd)->xvec->bfd_h_putx32)) (in->x_scn.x_checksum, ext->Section.Checksum));
   ((*((abfd)->xvec->bfd_h_putx16)) (in->x_scn.x_associated & 0xffff, ext->Section.Number))
                          ;
   ((*((abfd)->xvec->bfd_h_putx16)) ((in->x_scn.x_associated >> 16), ext->Section.HighNumber))
                              ;
   ((void) (*((bfd_byte *) (ext->Section.Selection)) = (in->x_scn.x_comdat) & 0xff));
   return 18;
 }
      break;
    }

  ((*((abfd)->xvec->bfd_h_putx32)) (in->x_sym.x_tagndx.u32, ext->Sym.WeakDefaultSymIndex));
  ((*((abfd)->xvec->bfd_h_putx32)) (1, ext->Sym.WeakSearchType));
...
{
  coff_bigobj_swap_aux_in, coff_bigobj_swap_sym_in, _bfd_pex64i_swap_lineno_in,
  coff_bigobj_swap_aux_out, coff_bigobj_swap_sym_out,
  _bfd_pex64i_swap_lineno_out, coff_swap_reloc_out,
  coff_bigobj_swap_filehdr_out, _bfd_pex64i_swap_aouthdr_out,
  _bfd_pex64i_swap_scnhdr_out,
  (14 * 4), (24 + 196 + 5 * 4), 40, 20, 20,
   10, (4 + 2), 20,
  
# 5848 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
 1
# 5848 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
     ,
  (
# 5849 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
 1
# 5849 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
 ), bfd_coff_set_long_section_names_allowed,
  (2),
  
# 5851 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
 0
# 5851 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
      ,
  2,
  1U << 31,
  coff_bigobj_swap_filehdr_in, _bfd_pex64i_swap_aouthdr_in, coff_swap_scnhdr_in,
  coff_swap_reloc_in, coff_bad_format_hook, coff_set_arch_mach_hook,
  pe_mkobject_hook, styp_to_sec_flags, coff_set_alignment_hook,
  coff_slurp_symbol_table, symname_in_debug_hook, 0,
  coff_print_aux, dummy_reloc16_extra_cases, dummy_reloc16_estimate,
...
# 5860 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
 ((void *)0)
# 5860 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
                      , coff_pe_amd64_relocate_section, coff_amd64_rtype_to_howto,
  
# 5861 "/doner/binutils/binutils-515f23e/bfd/coffcode.h" 3 4
 ((void *)0)
# 5861 "/doner/binutils/binutils-515f23e/bfd/coffcode.h"
                   , _bfd_generic_link_add_one_symbol,
  coff_link_output_has_begun, _bfd_pex64i_final_link_postscript,
  pex64_bfd_print_pdata
};
...
# 1006 "/doner/binutils/binutils-515f23e/bfd/coff-x86_64.c" 3 4
 1
# 1006 "/doner/binutils/binutils-515f23e/bfd/coff-x86_64.c"
                                   ,
...
# 1045 "/doner/binutils/binutils-515f23e/bfd/coff-x86_64.c" 3 4
 ((void *)0)
# 1045 "/doner/binutils/binutils-515f23e/bfd/coff-x86_64.c"
     ,

  &bigobj_swap_table
};
# 105 "/doner/binutils/binutils-515f23e/bfd/pe-x86_64.c" 2
