# 1 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
# 55 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
...
# 56 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 2
...
# 57 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 2
...
# 58 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 2
...
# 59 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 2
...
# 60 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 2




# 63 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
...
# 83 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
...
static 
# 102 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 103 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
verilog_set_arch_mach (bfd *abfd, enum bfd_architecture arch, unsigned long mach)
{
  ...
  return 
# 109 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
        1
# 109 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
}
...
static 
# 114 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 115 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
         ...
         bfd_size_type bytes_to_do)
{
  ...
  if (entry == 
# 125 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
              ((void *)0)
# 125 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                  )
    return 
# 126 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
          0
# 126 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
               ;
  ...
  if (bytes_to_do
      ...
      && (section->flags & 0x2))
    {
      ...
      if (data == 
# 135 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                 ((void *)0)
# 135 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                     )
 return 
# 136 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
       0
# 136 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
      ...
      if (tdata->tail != 
# 145 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                        ((void *)0)
   
# 146 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
  && entry->where >= tdata->tail->where)
 {
   tdata->tail->next = entry;
   entry->next = 
# 149 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                ((void *)0)
# 149 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                    ;
   tdata->tail = entry;
 }
      else
 {
   ...
   for (look = &tdata->head;
        *look != 
# 157 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                ((void *)0) 
# 157 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
   ...
   *look = entry;
   if (entry->next == 
# 162 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                     ((void *)0)
# 162 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                         )
     tdata->tail = entry;
 }
    }
  return 
# 166 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
        1
# 166 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
}

static 
# 169 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 170 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
verilog_write_address (bfd *abfd, bfd_vma address)
{
  ...
  *dst++ = '@';
  ...
  if (address >= (bfd_vma)1 << 32)
    {
      dst[1] = digs[((address >> 56)) & 0xf]; dst[0] = digs[(((address >> 56)) >> 4) & 0xf];;
      dst += 2;
      dst[1] = digs[((address >> 48)) & 0xf]; dst[0] = digs[(((address >> 48)) >> 4) & 0xf];;
      dst += 2;
      dst[1] = digs[((address >> 40)) & 0xf]; dst[0] = digs[(((address >> 40)) >> 4) & 0xf];;
      dst += 2;
      dst[1] = digs[((address >> 32)) & 0xf]; dst[0] = digs[(((address >> 32)) >> 4) & 0xf];;
      dst += 2;
    }
...
static 
# 210 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 211 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
        ...
        const bfd_byte *end)
{
  ...
  if (((end - data) * 2)
      + ((end - data) / VerilogDataWidth)
      + 2
      > (long) sizeof (buffer))
    {

      return 
# 227 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
            0
# 227 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                 ;
    }
      ...
      for (src = data; src < end;)
 {
  ...
  else if ((VerilogDataEndianness == BFD_ENDIAN_UNKNOWN && bfd_little_endian (abfd))
      ...
      for (src = data; src < (end - VerilogDataWidth); src += VerilogDataWidth)
 {
   for (i = VerilogDataWidth - 1; i >= 0; i--)
     {
       dst[1] = digs[(src[i]) & 0xf]; dst[0] = digs[((src[i]) >> 4) & 0xf];;
       dst += 2;
     }
   *dst++ = ' ';
 }
 ...
 {
   -- end;
   dst[1] = digs[(*end) & 0xf]; dst[0] = digs[((*end) >> 4) & 0xf];;
   dst += 2;
 }
...
static 
# 294 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 295 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
  ...
  if (list->where % VerilogDataWidth)
    {
      ...
      return 
# 306 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
            0
# 306 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                 ;
    }
 ...
 return 
# 320 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
       0
# 320 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
  ...
  return 
# 326 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
        1
# 326 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
}

static 
# 329 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 330 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
verilog_write_object_contents (bfd *abfd)
{
  ...
  while (list != (verilog_data_list_type *) 
# 338 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                                           ((void *)0)
# 338 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                                               )
    {
      if (! verilog_write_section (abfd, tdata, list))
 return 
# 341 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
       0
# 341 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
      list = list->next;
    }
  return 
# 344 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
        1
# 344 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
}
...
{
  static 
# 352 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
        _Bool 
# 352 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
             inited = 
# 352 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
                      0
# 352 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
  ...
  if (! inited)
    {
      inited = 
# 356 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
              1
# 356 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                  ;
      hex_init ();
    }
}
...
static 
# 363 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
      _Bool

# 364 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
verilog_mkobject (bfd *abfd)
{
  ...
  if (tdata == 
# 371 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
              ((void *)0)
# 371 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                  )
    return 
# 372 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
          0
# 372 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
               ;

  abfd->tdata.verilog_data = tdata;
  tdata->head = 
# 375 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
               ((void *)0)
# 375 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                   ;
  tdata->tail = 
# 376 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
               ((void *)0)
# 376 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                   ;

  return 
# 378 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
        1
# 378 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
            ;
}
# 409 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
...
# 424 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
 1
# 424 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
                                   ,
...
# 461 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
 ((void *)0)
# 461 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
     ,

  
# 463 "/doner/binutils/binutils-515f23e/bfd/verilog.c" 3 4
 ((void *)0)

# 464 "/doner/binutils/binutils-515f23e/bfd/verilog.c"
};
