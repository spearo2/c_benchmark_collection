# 1 "/doner/binutils/binutils-515f23e/bfd/pex64igen.c"
        ...
        void * in1)
{
      ...
      if (ext->x_file.x_fname[0] == 0)
 {
   ...
   in->x_file.x_n.x_n.x_offset = ((*((abfd)->xvec->bfd_h_getx32)) (ext->x_file.x_n.x_offset));
 }
      else
 memcpy (in->x_file.x_n.x_fname, ext->x_file.x_fname, 18);
      return;
      ...
      if (type == 0)
 {
   ...
   in->x_scn.x_comdat = ((bfd_vma) *(const bfd_byte *) (ext->x_scn.x_comdat) & 0xff);
   return;
 }
      break;
    }

  in->x_sym.x_tagndx.u32 = ((*((abfd)->xvec->bfd_h_getx32)) (ext->x_sym.x_tagndx));
  ...
  if (in_class == 100 || in_class == 101 || (((unsigned long) (type) & 0x30) == ((unsigned long) (2) << 4))
      || ((in_class) == 10 || (in_class) == 12 || (in_class) == 15))
    {
      ...
      in->x_sym.x_fcnary.x_fcn.x_endndx.u32 = ((*((abfd)->xvec->bfd_h_getx32)) (ext->x_sym.x_fcnary.x_fcn.x_endndx));
    }
  else
    {
         ...
         void * extp)
{
      ...
      if (in->x_file.x_n.x_fname[0] == 0)
 {
   ...
   ((*((abfd)->xvec->bfd_h_putx32)) (in->x_file.x_n.x_n.x_offset, ext->x_file.x_n.x_offset));
 }
      else
      ...
      if (type == 0)
 {
   ...
   ((void) (*((bfd_byte *) (ext->x_scn.x_comdat)) = (in->x_scn.x_comdat) & 0xff));
   return 18;
 }
      break;
    }

  ((*((abfd)->xvec->bfd_h_putx32)) (in->x_sym.x_tagndx.u32, ext->x_sym.x_tagndx));
  ...
  if (in_class == 100 || in_class == 101 || (((unsigned long) (type) & 0x30) == ((unsigned long) (2) << 4))
      || ((in_class) == 10 || (in_class) == 12 || (in_class) == 15))
    {
      ...
      ((*((abfd)->xvec->bfd_h_putx32)) (in->x_sym.x_fcnary.x_fcn.x_endndx.u32, ext->x_sym.x_fcnary.x_fcn.x_endndx));
    }
  else
    {
...
# 474 "peXXigen.c"
  ...
  a->MajorLinkerVersion = ((bfd_vma) *(const bfd_byte *) (aouthdr_ext->vstamp) & 0xff);
  a->MinorLinkerVersion = ((bfd_vma) *(const bfd_byte *) (aouthdr_ext->vstamp + 1) & 0xff);
  ...
  unsigned idx;
  for (idx = 0;
       idx < a->NumberOfRvaAndSizes && idx < 16;
       idx++)
    {

      int size = ((*((abfd)->xvec->bfd_h_getx32)) (src->DataDirectory[idx][1]));
      int vma = size ? ((*((abfd)->xvec->bfd_h_getx32)) (src->DataDirectory[idx][0])) : 0;
...
# 699 "peXXigen.c"
  ...
  if (extra->MajorLinkerVersion || extra->MinorLinkerVersion)
    {
      ((void) (*((bfd_byte *) (aouthdr_out->standard.vstamp)) = (extra->MajorLinkerVersion) & 0xff))
                                     ;
      ((void) (*((bfd_byte *) (aouthdr_out->standard.vstamp + 1)) = (extra->MinorLinkerVersion) & 0xff))
                                         ;
    }
  else
    {
      ...
      ((*((abfd)->xvec->bfd_h_putx16)) ((((short) (241500000 / 1000000)) / 100 + (((short) (241500000 / 1000000)) % 100) * 256), aouthdr_out->standard.vstamp))
                               ;
    }
...
_bfd_pex64i_only_swap_filehdr_out (bfd * abfd, void * in, void * out)
{
  ...
  memcpy (filehdr_in->pe.dos_message, ((abfd)->tdata.pe_obj_data)->dos_message,
  ...
  if ((((abfd)->tdata.pe_obj_data)->timestamp) == -1)
    {
      time_t now;
 ...
 now = (time_t) strtoll (source_date_epoch, 
# 850 "peXXigen.c" 3 4
                                           ((void *)0)
# 850 "peXXigen.c"
                                               , 10);
...
# 852 "peXXigen.c"
      ...
      ((*((abfd)->xvec->bfd_h_putx32)) (now, filehdr_out->f_timdat));
    }
  else
    ((*((abfd)->xvec->bfd_h_putx32)) (((abfd)->tdata.pe_obj_data)->timestamp, filehdr_out->f_timdat));
...
_bfd_pex64i_swap_scnhdr_out (bfd * abfd, void * in, void * out)
{
  ...
  ss = scnhdr_int->s_vaddr - ((abfd)->tdata.pe_obj_data)->pe_opthdr.ImageBase;
  if (scnhdr_int->s_vaddr < ((abfd)->tdata.pe_obj_data)->pe_opthdr.ImageBase)
    _bfd_error_handler (dgettext ("bfd", "%pB:%.8s: section below image base"),
  ...
  ((*((abfd)->xvec->bfd_h_putx32)) (ss, scnhdr_ext->s_vaddr));
  ...
  if ((scnhdr_int->s_flags & 0x00000080) != 0)
    {
      if ((startswith ((abfd)->xvec->name, "pei-")))
 {
  ...
  while (num_names --)
    {
      ...
      entry_end = rsrc_print_resource_entries (file, abfd, indent + 1, 
# 2416 "peXXigen.c" 3 4
                                                                      1
# 2416 "peXXigen.c"
                                                                          ,
...
static char * debug_type_names[17] =
{
  "Unknown",
  "COFF",
  "CodeView",
...
# 2617 "peXXigen.c"
      ...
      if (idd.Type == 2)
 {
   ...
   fprintf (file, dgettext ("bfd", "(format %c%c%c%c signature %s age %ld pdb %s)\n"),
...
# 2890 "peXXigen.c"
 ...
 fprintf (file, "%sTERMINAL_SERVICE_AWARE\n", indent);
  ...
  if ((((const bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_print_pdata))
    ((((const bfd_coff_backend_data *) (abfd)->xvec->backend_data)->_bfd_coff_print_pdata) (abfd, vfile));
  else
...
# 2985 "peXXigen.c"
  ...
  size = ope->pe_opthdr.DataDirectory[6].Size;
  if (size != 0)
    {
                        ...
                        )
 {
   ...
   if (addr < section->vma
       ...
       || section->size - dataoff < size)
     {
       ...
       _bfd_error_handler
  (dgettext ("bfd", "%pB: Data Directory (%lx bytes at %" 
# 3040 "peXXigen.c" 3 4
  "l" "x" 
# 3040 "peXXigen.c"
  ") " "extends across section boundary at %" 
# 3040 "peXXigen.c" 3 4
  "l" "x"
# 3040 "peXXigen.c"
  )
...
# 3084 "peXXigen.c"
     ...
     {
       _bfd_error_handler (dgettext ("bfd", "%pB: failed to read " "debug data section")
                             , obfd);
       return 
# 3092 "peXXigen.c" 3 4
             0
...
# 3459 "peXXigen.c"
  ...
  highest_data = rsrc_parse_entries (abfd, & table->names, 
# 3472 "peXXigen.c" 3 4
                                                          1
# 3472 "peXXigen.c"
                                                              , data,
  ...
  highest_data = rsrc_parse_entries (abfd, & table->ids, 
# 3476 "peXXigen.c" 3 4
                                                        0
# 3476 "peXXigen.c"
                                                             , highest_data,
...
# 3615 "peXXigen.c"
    ...
    {
      do { if (!(entry->is_name)) bfd_assert("peXXigen.c",3618); } while (0);
      rsrc_write_entry (data, next_entry, entry);
      next_entry += 8;
    }
  do { if (!(i == 0)) bfd_assert("peXXigen.c",3622); } while (0);
  do { if (!(entry == 
# 3623 "peXXigen.c" 3 4
 ((void *)0)
# 3623 "peXXigen.c"
 )) bfd_assert("peXXigen.c",3623); } while (0);
...
# 3626 "peXXigen.c"
       ...
       i--, entry = entry->next_entry)
    {
      do { if (!(! entry->is_name)) bfd_assert("peXXigen.c",3629); } while (0);
      rsrc_write_entry (data, next_entry, entry);
      next_entry += 8;
    }
  do { if (!(i == 0)) bfd_assert("peXXigen.c",3633); } while (0);
  do { if (!(entry == 
# 3634 "peXXigen.c" 3 4
 ((void *)0)
# 3634 "peXXigen.c"
 )) bfd_assert("peXXigen.c",3634); } while (0);
  do { if (!(nt == next_entry)) bfd_assert("peXXigen.c",3635); } while (0);
}
...
# 3679 "peXXigen.c" 3 4
         _Bool 
# 3679 "peXXigen.c"
              is_name, rsrc_entry * a, rsrc_entry * b)
{
  signed int res;
  bfd_byte * astring;
  unsigned int alen;
      ...
      rsrc_entry * b __attribute__ ((__unused__)))
{
  ...
  do { if (!(! a->is_dir)) bfd_assert("peXXigen.c",3858); } while (0);
  astring = a->value.leaf->data;

  do { if (!(! b->is_dir)) bfd_assert("peXXigen.c",3861); } while (0);
...
# 3907 "peXXigen.c"
      ...
      else
 {
  ...
  do { if (!(nstring - new_data == (signed) (a->value.leaf->size + copy_needed))) bfd_assert("peXXigen.c",3938); } while (0);
...
rsrc_merge (struct rsrc_entry * a, struct rsrc_entry * b)
{
  ...
  do { if (!(a->is_dir)) bfd_assert("peXXigen.c",4152); } while (0);
  do { if (!(b->is_dir)) bfd_assert("peXXigen.c",4153); } while (0);
  ...
  rsrc_sort_entries (& adir->names, 
# 4179 "peXXigen.c" 3 4
                                   1
# 4179 "peXXigen.c"
                                       , adir);
  rsrc_sort_entries (& adir->ids, 
# 4180 "peXXigen.c" 3 4
                                 0
# 4180 "peXXigen.c"
                                      , adir);
...
# 4253 "peXXigen.c"
  ...
  goto end;
   ...
   do { if (!(rsrc_sec->size > 0)) bfd_assert("peXXigen.c",4257); } while (0);
      ...
      if ((data - p) > rsrc_sizes [num_resource_sets])
 {
  ...
  do { if (!(num_resource_sets == num_input_rsrc)) bfd_assert("peXXigen.c",4299); } while (0);
...
# 4315 "peXXigen.c"
  ...
  do { if (!(indx == num_resource_sets)) bfd_assert("peXXigen.c",4320); } while (0);
# 4330 "peXXigen.c"
...
# 4337 "peXXigen.c"
  ...
  rsrc_sort_entries (& new_table.names, 
# 4342 "peXXigen.c" 3 4
                                       1
# 4342 "peXXigen.c"
                                           , & new_table);
...
# 4346 "peXXigen.c"
  ...
  rsrc_sort_entries (& new_table.ids, 
# 4351 "peXXigen.c" 3 4
                                     0
# 4351 "peXXigen.c"
                                          , & new_table);
...
# 4398 "peXXigen.c"
                   ;
# 4408 "peXXigen.c"
  h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (".idata$2"), (
# 4408 "peXXigen.c" 3 4
      0
# 4408 "peXXigen.c"
      ), (
...
# 4428 "peXXigen.c"
      ...
      h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (".idata$4"), (
# 4431 "peXXigen.c" 3 4
          0
# 4431 "peXXigen.c"
          ), (
...
# 4448 "peXXigen.c"
      ...
      h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (".idata$5"), (
# 4453 "peXXigen.c" 3 4
          0
# 4453 "peXXigen.c"
          ), (
...
# 4469 "peXXigen.c"
      ...
      h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, (".idata$6"), (
# 4472 "peXXigen.c" 3 4
          0
# 4472 "peXXigen.c"
          ), (
...
# 4489 "peXXigen.c"
    ...
    {
      h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, ("__IAT_start__"), (
# 4494 "peXXigen.c" 3 4
          0
# 4494 "peXXigen.c"
          ), (
...
# 4500 "peXXigen.c"
                                                   )
 {
   ...
   h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, ("__IAT_end__"), (
# 4509 "peXXigen.c" 3 4
       0
# 4509 "peXXigen.c"
       ), (
...
# 4531 "peXXigen.c"
  ...
  h1 = ((struct coff_link_hash_entry *) bfd_link_hash_lookup (&(((struct coff_link_hash_table *) ((info)->hash)))->root, ((bfd_get_symbol_leading_char (abfd) != 0 ? "__tls_used" : "_tls_used")), (
# 4536 "peXXigen.c" 3 4
      0
# 4536 "peXXigen.c"
      ), (
