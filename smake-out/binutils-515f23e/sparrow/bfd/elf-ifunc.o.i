# 1 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
# 21 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
...
# 22 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 2




# 33 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
_Bool

# 34 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
_bfd_elf_create_ifunc_sections (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (htab->irelifunc != 
# 41 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                        ((void *)0) 
# 41 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                             || htab->iplt != 
# 41 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                                              ((void *)0)
# 41 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
    ...
    return 
# 42 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
          1
# 42 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
              ;
  ...
  if ((((info)->type == type_dll) || ((info)->type == type_pie)))
    {
      ...
      s = bfd_make_section_with_flags (abfd, rel_sec,
           flags | 0x8);
      if (s == 
# 64 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 65 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
  || !bfd_set_section_alignment (s, bed->s->log_file_align))
 return 
# 66 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
       0
# 66 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            ;
      htab->irelifunc = s;
    }
  else
    {
      ...
      if (s == 
# 74 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 75 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
  || !bfd_set_section_alignment (s, bed->plt_alignment))
 return 
# 76 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
       0
# 76 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            ;
      htab->iplt = s;
     ...
     ? ".rela.iplt" : ".rel.iplt"),
           flags | 0x8);
      if (s == 
# 83 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 84 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
  || !bfd_set_section_alignment (s, bed->s->log_file_align))
 return 
# 85 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
       0
# 85 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            ;
      htab->irelplt = s;
 ...
 s = bfd_make_section_with_flags (abfd, ".igot", flags);
      if (s == 
# 94 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 95 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
  || !bfd_set_section_alignment (s, bed->s->log_file_align))
 return 
# 96 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
       0
# 96 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            ;
      htab->igotplt = s;
    }

  return 
# 100 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
        1
# 100 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            ;
}
...
# 106 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
_Bool

# 107 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
...
# 113 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
       _Bool 
# 113 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            avoid_plt)
{
...
# 121 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
 _Bool 
# 121 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
      use_plt = !avoid_plt || h->plt.refcount > 0;
  
# 122 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
 _Bool 
# 122 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
      need_dynreloc = !use_plt || (((info)->type == type_dll) || ((info)->type == type_pie));
# 136 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
  if (!need_dynreloc
 ...
 (dgettext ("bfd", "%F%P: dynamic STT_GNU_IFUNC symbol `%s' with pointer " "equality in `%pB' can not be used when making an " "executable; recompile with -fPIE and relink with -pie\n")
  ...
  h->root.u.def.section->owner);
      ...
      return 
# 150 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
            0
# 150 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                 ;
    }
...
# 161 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
     _Bool 
# 161 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
          keep = 
# 161 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                 0
# 161 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                      ;
      for (p = *head; p != 
# 162 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                          ((void *)0)
# 162 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                              ; p = p->next)
 if (p->count)
   {
     h->non_got_ref = 1;
     ...
     keep = 
# 167 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
           1
# 167 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
               ;
     if (p->pc_count)
       {

  use_plt = 
# 171 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
           1
# 171 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
               ;
  ...
  if (h->plt.refcount <= 0 && h->got.refcount <= 0)
    {
      ...
      *head = 
# 185 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
             ((void *)0)
# 185 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                 ;
      return 
# 186 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
            1
# 186 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                ;
    }
  ...
  if (!h->ref_regular)
    {
      if (h->plt.refcount > 0
   || h->got.refcount > 0)
 _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c", 195, __PRETTY_FUNCTION__);
      h->got = htab->init_got_offset;
      h->plt = htab->init_plt_offset;
      *head = 
# 198 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
             ((void *)0)
# 198 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                 ;
      return 
# 199 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
            1
# 199 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                ;
    }
 ...
 keep:
  ...
  if (htab->splt != 
# 211 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                   ((void *)0)
# 211 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                       )
    {
      plt = htab->splt;
      gotplt = htab->sgotplt;
 ...
 plt->size += plt_header_size;
  ...
  if (!need_dynreloc || !h->non_got_ref)
    *head = 
# 254 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
           ((void *)0)
# 254 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
               ;


  p = *head;
  if (p != 
# 258 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
          ((void *)0)
# 258 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
              )
    {
      ...
      do
 {
   ...
   p = p->next;
      ...
      while (p != 
# 266 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                 ((void *)0)
# 266 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                     );
...
# 276 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                            ((void *)0)
# 276 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                                )
...
# 300 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
  if (use_plt
      && (h->got.refcount <= 0
   ...
   || ((info)->type == type_pie)
   || htab->sgot == 
# 308 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                   ((void *)0)
# 308 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                       ))
    {
   ...
   if (need_dynreloc)
     {
       ...
       if (htab->splt != 
# 338 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
                        ((void *)0)
# 338 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
                            )
  ...
  return 
# 349 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c" 3 4
        1
# 349 "/doner/binutils/binutils-515f23e/bfd/elf-ifunc.c"
            ;
}
