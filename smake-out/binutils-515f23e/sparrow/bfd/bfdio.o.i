# 1 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
# 24 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
# 25 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 2
# 48 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
file_ptr
  ...
  if (file)
    {
      int fd = fileno (file);
      int old = fcntl (fd, 
# 81 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                          1
# 81 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                                 , 0);
      if (old >= 0)
 fcntl (fd, 
# 83 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
           2
# 83 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                  , old | 
# 83 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                          1
# 83 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
{
# 178 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
# 244 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
bfd_size_type
...
# 251 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 252 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
  ...
  if (element_bfd->arelt_data != 
# 261 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                                ((void *)0)
      
# 262 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
     && element_bfd->my_archive != 
# 262 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                                   ((void *)0)
      
# 263 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 ...
 size = maxbytes - (abfd->where - offset);
  ...
  if (abfd->iovec == 
# 276 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 276 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    {
      bfd_set_error (bfd_error_invalid_operation);
      return -1;
...
# 301 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
bfd_size_type
bfd_bwrite (const void *ptr, bfd_size_type size, bfd *abfd)
{
  ...
  while (abfd->my_archive != 
# 306 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 307 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
    abfd = abfd->my_archive;

  if (abfd->iovec == 
# 310 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 310 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    {
      bfd_set_error (bfd_error_invalid_operation);
      return -1;
...
# 322 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
     (*__errno_location ()) 
# 322 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
           = 
# 322 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
             28
# 322 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
# 340 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
file_ptr
bfd_tell (bfd *abfd)
{
  ufile_ptr offset = 0;
  ...
  while (abfd->my_archive != 
# 346 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 347 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
    {
      offset += abfd->origin;
      abfd = abfd->my_archive;
  ...
  if (abfd->iovec == 
# 354 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 354 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    return 0;
...
# 373 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
int
bfd_flush (bfd *abfd)
{
  while (abfd->my_archive != 
# 376 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 377 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
    abfd = abfd->my_archive;

  if (abfd->iovec == 
# 380 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 380 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    return 0;

  return abfd->iovec->bflush (abfd);
}
# 398 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
int
bfd_stat (bfd *abfd, struct stat *statbuf)
{
  ...
  while (abfd->my_archive != 
# 403 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 404 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
    abfd = abfd->my_archive;

  if (abfd->iovec == 
# 407 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 407 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    {
      bfd_set_error (bfd_error_invalid_operation);
      return -1;
...
# 431 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
int
bfd_seek (bfd *abfd, file_ptr position, int direction)
{
  ...
  while (abfd->my_archive != 
# 437 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 438 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
    {
      offset += abfd->origin;
      abfd = abfd->my_archive;
  ...
  if (abfd->iovec == 
# 445 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 445 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    {
      bfd_set_error (bfd_error_invalid_operation);
      return -1;
  ...
  do { if (!(direction == 
# 454 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
 0 
# 454 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 || direction == 
# 454 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
 1
# 454 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 )) bfd_assert("/doner/binutils/binutils-515f23e/bfd/bfdio.c",454); } while (0);

  if (direction != 
# 456 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                  1
# 456 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                          )
    position += offset;
  ...
  if (result != 0)
    {
      ...
      if (
# 464 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
         (*__errno_location ()) 
# 464 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
               == 
# 464 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                  22
# 464 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 ...
 bfd_set_error (bfd_error_system_call);
  ...
  else
    {
      ...
      if (direction == 
# 472 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                      1
# 472 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                              )
 abfd->where += position;
      else
 abfd->where = position;
...
# 494 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
long
bfd_get_mtime (bfd *abfd)
{
  ...
  abfd->mtime = buf.
# 505 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                   st_mtim.tv_sec
# 505 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                           ;
  return buf.
# 506 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
            st_mtim.tv_sec
# 506 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                    ;
}
# 544 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
ufile_ptr
bfd_get_size (bfd *abfd)
{


  if (abfd->size <= 1 || ((abfd)->direction == write_direction || (abfd)->direction == both_direction))
    {
      struct stat buf;
...
# 582 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
ufile_ptr
bfd_get_file_size (bfd *abfd)
{
  ...
  if (abfd->my_archive != 
# 588 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                         ((void *)0)
      
# 589 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
     && !bfd_is_thin_archive (abfd->my_archive))
    {
      struct areltdata *adata = (struct areltdata *) abfd->arelt_data;
      if (adata != 
# 592 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                  ((void *)0)
# 592 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                      )
 {
   archive_size = adata->parsed_size;


   if (adata->arch_header != 
# 597 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
       
# 598 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
# 627 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
void *
...
{
  while (abfd->my_archive != 
# 632 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                            ((void *)0)
  
# 633 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
 && !bfd_is_thin_archive (abfd->my_archive))
    {
      offset += abfd->origin;
      abfd = abfd->my_archive;
  ...
  if (abfd->iovec == 
# 640 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                    ((void *)0)
# 640 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                        )
    {
      bfd_set_error (bfd_error_invalid_operation);
      return (void *) -1;
...
memory_bwrite (bfd *abfd, const void *ptr, file_ptr size)
{
      ...
      if (newsize > oldsize)
 {
   ...
   if (bim->buffer == 
# 688 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                     ((void *)0)
# 688 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                         )
     {
       bim->size = 0;
       return 0;
...
memory_bseek (bfd *abfd, file_ptr position, int direction)
{
  ...
  if (direction == 
# 715 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                  0
# 715 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                          )
    nwhere = position;
  else
...
# 723 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
     (*__errno_location ()) 
# 723 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
           = 
# 723 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
             22
# 723 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
   ...
   if (newsize > oldsize)
     {
       bim->buffer = (bfd_byte *) bfd_realloc_or_free (bim->buffer, newsize);
       if (bim->buffer == 
# 741 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                         ((void *)0)
# 741 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                             )
  {
    
# 743 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
   (*__errno_location ()) 
# 743 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
         = 
# 743 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
           22
# 743 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
# 753 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
  (*__errno_location ()) 
# 753 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
        = 
# 753 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
          22
# 753 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
...
memory_bclose (struct bfd *abfd)
{
  ...
  free (bim);
  abfd->iostream = 
# 768 "/doner/binutils/binutils-515f23e/bfd/bfdio.c" 3 4
                  ((void *)0)
# 768 "/doner/binutils/binutils-515f23e/bfd/bfdio.c"
                      ;
