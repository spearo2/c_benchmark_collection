# 1 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
# 27 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
...
# 28 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
_Bool

# 38 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
_bfd_archive_64_bit_slurp_armap (bfd *abfd)
{
  ...
  char *stringend;
  bfd_byte *raw_armap = 
# 47 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                       ((void *)0)
# 47 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                           ;
  carsym *carsyms;
  bfd_size_type amt;
  ufile_ptr filesize;
  ...
  ardata->symdefs = 
# 52 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                   ((void *)0)
# 52 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                       ;
  ...
  if (i == 0)
    return 
# 57 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          1
# 57 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
              ;
  if (i != 16)
    return 
# 59 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 59 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;

  if (bfd_seek (abfd, (file_ptr) - 16, 
# 61 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                                      1
# 61 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                                              ) != 0)
    return 
# 62 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 62 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;
  ...
  if (! startswith (nextname, "/SYM64/         "))
    {
      abfd->has_armap = 
# 70 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                       0
# 70 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                            ;
      return 
# 71 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
            1
# 71 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                ;
    }

  mapdata = (struct areltdata *) ((*((abfd)->xvec->_bfd_read_ar_hdr_fn)) (abfd));
  if (mapdata == 
# 75 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                ((void *)0)
# 75 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                    )
    return 
# 76 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 76 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;
  ...
  if (filesize != 0 && parsed_size > filesize)
    {
      ...
      return 
# 84 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
            0
# 84 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                 ;
    }
 ...
 bfd_set_error (bfd_error_malformed_archive);
      return 
# 91 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
            0
# 91 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                 ;
    }
  ...
  if (
      ...
      || amt <= stringsize)
    {
      bfd_set_error (bfd_error_malformed_archive);
      return 
# 111 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
            0
# 111 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                 ;
    }
  ardata->symdefs = (struct carsym *) bfd_alloc (abfd, amt);
  if (ardata->symdefs == 
# 114 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                        ((void *)0)
# 114 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                            )
    return 
# 115 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 115 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;
  ...
  if (raw_armap == 
# 120 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                  ((void *)0)
      
# 121 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
 ...
 ++stringbase;
  ...
  abfd->has_armap = 
# 145 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                   1
# 145 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                       ;
  bfd_release (abfd, raw_armap);

  return 
# 148 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
        1
# 148 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
            ;

 release_symdefs:
  bfd_release (abfd, ardata->symdefs);
  return 
# 152 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
        0
# 152 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
             ;
}
...
# 159 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
_Bool

# 160 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
     ...
     int stridx)
{
  ...
  if (!_bfd_ar_sizepad (hdr.ar_size, sizeof (hdr.ar_size), mapsize))
    return 
# 188 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 188 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;
  _bfd_ar_spacepad (hdr.ar_date, sizeof (hdr.ar_date), "%ld",
      time (
# 190 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
           ((void *)0)
# 190 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ));
  ...
  if (bfd_bwrite (&hdr, sizeof (struct ar_hdr), arch)
      != sizeof (struct ar_hdr))
    return 
# 201 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 201 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;

  bfd_putb64 ((bfd_vma) symbol_count, buf);
  if (bfd_bwrite (buf, 8, arch) != 8)
    return 
# 205 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
          0
# 205 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
               ;
  ...
  for (current = arch->archive_head;
       current != 
# 214 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
                 ((void *)0) 
# 214 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                      && count < symbol_count;
    ...
    count++)
 {
   ...
   if (bfd_bwrite (buf, 8, arch) != 8)
     return 
# 226 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
           0
# 226 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
                ;
 }
 ...
 return 
# 243 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
       0
# 243 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
            ;
    }
 ...
 return 
# 251 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
       0
# 251 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
            ;
      --padding;
    }

  return 
# 255 "/doner/binutils/binutils-515f23e/bfd/archive64.c" 3 4
        1
# 255 "/doner/binutils/binutils-515f23e/bfd/archive64.c"
            ;
}
