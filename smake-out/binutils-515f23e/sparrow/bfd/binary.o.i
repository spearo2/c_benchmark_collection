# 1 "/doner/binutils/binutils-515f23e/bfd/binary.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/binary.c"
# 35 "/doner/binutils/binutils-515f23e/bfd/binary.c"
...
# 36 "/doner/binutils/binutils-515f23e/bfd/binary.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/bfd/binary.c" 2
...
# 38 "/doner/binutils/binutils-515f23e/bfd/binary.c" 2
...
# 39 "/doner/binutils/binutils-515f23e/bfd/binary.c" 2
...
static 
# 46 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
      _Bool

# 47 "/doner/binutils/binutils-515f23e/bfd/binary.c"
binary_mkobject (bfd *abfd __attribute__ ((__unused__)))
{
  return 
# 49 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
        1
# 49 "/doner/binutils/binutils-515f23e/bfd/binary.c"
            ;
}
  ...
  if (abfd->target_defaulted)
    {
      ...
      return 
# 66 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
            ((void *)0)
# 66 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                ;
    }
  ...
  if (bfd_stat (abfd, &statbuf) < 0)
    {
      ...
      return 
# 75 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
            ((void *)0)
# 75 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                ;
    }
  ...
  if (sec == 
# 81 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
            ((void *)0)
# 81 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                )
    return 
# 82 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
          ((void *)0)
# 82 "/doner/binutils/binutils-515f23e/bfd/binary.c"
              ;
  sec->vma = 0;
...
static 
# 98 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
      _Bool

# 99 "/doner/binutils/binutils-515f23e/bfd/binary.c"
...
# 105 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                                                0
# 105 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                                                        ) != 0
      || bfd_bread (location, count, abfd) != count)
    return 
# 107 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
          0
# 107 "/doner/binutils/binutils-515f23e/bfd/binary.c"
               ;
  return 
# 108 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
        1
# 108 "/doner/binutils/binutils-515f23e/bfd/binary.c"
            ;
}
...
mangle_name (bfd *abfd, char *suffix)
{
  ...
  if (buf == 
# 133 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
            ((void *)0)
# 133 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                )
    return "";
...
binary_canonicalize_symtab (bfd *abfd, asymbol **alocation)
{
  ...
  asymbol *syms;
  unsigned int i;
  size_t amt = 3 * sizeof (asymbol);

  syms = (asymbol *) bfd_alloc (abfd, amt);
  if (syms == 
# 157 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
             ((void *)0)
# 157 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                 )
    return -1;
  ...
  syms[0].section = sec;
  syms[0].udata.p = 
# 166 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                   ((void *)0)
# 166 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                       ;
  ...
  syms[1].section = sec;
  syms[1].udata.p = 
# 174 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                   ((void *)0)
# 174 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                       ;
  ...
  syms[2].udata.p = 
# 182 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                   ((void *)0)
# 182 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                       ;

  for (i = 0; i < 3; i++)
    *alocation++ = syms++;
  *alocation = 
# 186 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
              ((void *)0)
# 186 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                  ;

  return 3;
}
# 198 "/doner/binutils/binutils-515f23e/bfd/binary.c"
static void
...
# 222 "/doner/binutils/binutils-515f23e/bfd/binary.c"
static 
# 222 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
      _Bool

# 223 "/doner/binutils/binutils-515f23e/bfd/binary.c"
        ...
        bfd_size_type size)
{
  if (size == 0)
    return 
# 230 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
          1
# 230 "/doner/binutils/binutils-515f23e/bfd/binary.c"
              ;

  if (! abfd->output_has_begun)
    {
      
# 234 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
     _Bool 
# 234 "/doner/binutils/binutils-515f23e/bfd/binary.c"
          found_low;
      bfd_vma low;
      asection *s;
      ...
      found_low = 
# 241 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                 0
# 241 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                      ;
      low = 0;
      for (s = abfd->sections; s != 
# 243 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                                   ((void *)0)
# 243 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                                       ; s = s->next)
 if (((s->flags
       & (0x100 | 0x2 | 0x1 | 0x200))
      == (0x100 | 0x2 | 0x1))
     ...
     && (! found_low || s->lma < low))
   {
     low = s->lma;
     found_low = 
# 251 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                1
# 251 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                    ;
   }

      for (s = abfd->sections; s != 
# 254 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                                   ((void *)0)
# 254 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                                       ; s = s->next)
 {
...
# 282 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
                              1
# 282 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                                  ;
    }
  ...
  if ((sec->flags & (0x2 | 0x1)) == 0)
    return 
# 289 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
          1
# 289 "/doner/binutils/binutils-515f23e/bfd/binary.c"
              ;
  if ((sec->flags & 0x200) != 0)
    return 
# 291 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
          1
# 291 "/doner/binutils/binutils-515f23e/bfd/binary.c"
              ;
...
# 326 "/doner/binutils/binutils-515f23e/bfd/binary.c"
...
# 339 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
 1
# 339 "/doner/binutils/binutils-515f23e/bfd/binary.c"
                                   ,
  ...
  _bfd_archive_close_and_cleanup, _bfd_free_cached_info, _bfd_generic_new_section_hook, binary_get_section_contents, _bfd_generic_get_section_contents_in_window,
...
# 375 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
 ((void *)0)
# 375 "/doner/binutils/binutils-515f23e/bfd/binary.c"
     ,

  
# 377 "/doner/binutils/binutils-515f23e/bfd/binary.c" 3 4
 ((void *)0)

# 378 "/doner/binutils/binutils-515f23e/bfd/binary.c"
};
