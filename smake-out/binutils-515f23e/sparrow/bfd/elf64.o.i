# 1 "/doner/binutils/binutils-515f23e/bfd/elf64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/elf64.c"
# 23 "/doner/binutils/binutils-515f23e/bfd/elf64.c"
...
# 269 "/doner/binutils/binutils-515f23e/bfd/elfcode.h"
  ...
  if (no_section_header)
    ((*((abfd)->xvec->bfd_h_putx64)) (0, dst->e_shoff));
  else
...
# 800 "/doner/binutils/binutils-515f23e/bfd/elfcode.h"
  ...
  else
    {
      ...
      if (filesize != 0
   && i_ehdrp->e_phnum > filesize / sizeof (Elf64_External_Phdr))
 goto got_wrong_format_error;
...
# 1059 "/doner/binutils/binutils-515f23e/bfd/elfcode.h"
...
long
bfd_elf64_slurp_symbol_table (bfd *abfd, asymbol **symptrs, 
...
# 1551 "/doner/binutils/binutils-515f23e/bfd/elfcode.h"
  ...
  do { if (!(entsize == sizeof (Elf64_External_Rel) || entsize == sizeof (Elf64_External_Rela))) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elfcode.h",1556); } while (0)
                                                ;
...
# 1851 "/doner/binutils/binutils-515f23e/bfd/elfcode.h"
  ...
  x_phdrs = (Elf64_External_Phdr *) bfd_malloc (amt);
  if (x_phdrs == 
...
# 23 "/doner/binutils/binutils-515f23e/bfd/elf64.c" 2
