# 1 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
# 22 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
...
# 23 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 2
    ...
    const char *string)
{
  ...
  if (entry == 
# 69 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 69 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                  )
    entry = (struct bfd_hash_entry *)
 bfd_hash_allocate (table, sizeof (struct elf_strtab_hash_entry));
  if (entry == 
# 72 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 72 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                  )
    return 
# 73 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
          ((void *)0)
# 73 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
              ;
...
_bfd_elf_strtab_init (void)
{
  ...
  if (table == 
# 101 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 101 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                  )
    return 
# 102 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
          ((void *)0)
# 102 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
              ;
  ...
  if (!bfd_hash_table_init (&table->table, elf_strtab_hash_newfunc,
       sizeof (struct elf_strtab_hash_entry)))
    {
      free (table);
      return 
# 108 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
            ((void *)0)
# 108 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                ;
    }
  ...
  if (table->array == 
# 117 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
                     ((void *)0)
# 117 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                         )
    {
      free (table);
      return 
# 120 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
            ((void *)0)
# 120 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                ;
    }

  table->array[0] = 
# 123 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
                   ((void *)0)
# 123 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                       ;
...
# 144 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
      _Bool 
# 144 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
           copy)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",153); } while (0);
  entry = (struct elf_strtab_hash_entry *)
   bfd_hash_lookup (&tab->table, str, 
# 155 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
                                     1
# 155 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                                         , copy);

  if (entry == 
# 157 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 157 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                  )
    return (size_t) -1;
  ...
  if (entry->len == 0)
    {
      ...
      do { if (!(entry->len > 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",165); } while (0);
      if (tab->size == tab->alloced)
 {
   ...
   if (tab->array == 
# 172 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
                    ((void *)0)
# 172 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                        )
     return (size_t) -1;
 }
...
_bfd_elf_strtab_addref (struct elf_strtab_hash *tab, size_t idx)
{
  if (idx == 0 || idx == (size_t) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",187); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",188); } while (0);
...
_bfd_elf_strtab_delref (struct elf_strtab_hash *tab, size_t idx)
{
  if (idx == 0 || idx == (size_t) -1)
    return;
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",197); } while (0);
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",198); } while (0);
  do { if (!(tab->array[idx]->refcount > 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",199); } while (0);
  --tab->array[idx]->refcount;
}
...
_bfd_elf_strtab_save (struct elf_strtab_hash *tab)
{
  ...
  if (save == 
# 234 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
             ((void *)0)
# 234 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                 )
    return save;
...
_bfd_elf_strtab_restore (struct elf_strtab_hash *tab, void *buf)
{
  ...
  do { if (!(tab->sec_size == 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",251); } while (0);
  save_size = 1;
  if (save != 
# 253 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
             ((void *)0)
# 253 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                 )
    save_size = save->size;
  do { if (!(save_size <= curr_size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",255); } while (0);
  tab->size = save_size;
...
_bfd_elf_strtab_offset (struct elf_strtab_hash *tab, size_t idx)
{
  ...
  if (idx == 0)
    return 0;
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",289); } while (0);
  do { if (!(tab->sec_size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",290); } while (0);
  entry = tab->array[idx];
  do { if (!(entry->refcount > 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",292); } while (0);
  entry->refcount--;
       ...
       bfd_size_type *offset)
{
  if (idx == 0)
    return 
# 302 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
          ((void *)0)
# 302 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
              ;
  do { if (!(idx < tab->size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",303); } while (0);
  do { if (!(tab->sec_size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",304); } while (0);
  if (tab->array[idx]->refcount == 0)
    return 
# 306 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
          ((void *)0)
# 306 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
              ;
  if (offset)
...
# 312 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
_Bool

# 313 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
_bfd_elf_strtab_emit (register bfd *abfd, struct elf_strtab_hash *tab)
{
  ...
  if (bfd_bwrite ("", 1, abfd) != 1)
    return 
# 319 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
          0
# 319 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
               ;
  ...
  for (i = 1; i < tab->size; ++i)
    {
      ...
      do { if (!(tab->array[i]->refcount == 0)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",326); } while (0);
      len = tab->array[i]->len;
      if ((int) len < 0)
 continue;
 ...
 return 
# 333 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
       0
# 333 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
            ;

      off += len;
    }

  do { if (!(off == tab->sec_size)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-strtab.c",338); } while (0);
  return 
# 339 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
        1
# 339 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
            ;
}
...
_bfd_elf_strtab_finalize (struct elf_strtab_hash *tab)
{
  ...
  if (array == 
# 395 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c" 3 4
              ((void *)0)
# 395 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
                  )
    goto alloc_failure;
...
# 430 "/doner/binutils/binutils-515f23e/bfd/elf-strtab.c"
      e = *--a;
      e->len += 1;
      while (--a >= array)
 {
