# 1 "/doner/binutils/binutils-515f23e/bfd/cache.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/cache.c"
# 43 "/doner/binutils/binutils-515f23e/bfd/cache.c"
...
# 44 "/doner/binutils/binutils-515f23e/bfd/cache.c" 2
...
# 45 "/doner/binutils/binutils-515f23e/bfd/cache.c" 2
...
# 46 "/doner/binutils/binutils-515f23e/bfd/cache.c" 2
...
# 47 "/doner/binutils/binutils-515f23e/bfd/cache.c" 2
...
# 50 "/doner/binutils/binutils-515f23e/bfd/cache.c" 2
# 60 "/doner/binutils/binutils-515f23e/bfd/cache.c"
...
bfd_cache_max_open (void)
{
  if (max_open_files == 0)
    {
      int max;
# 96 "/doner/binutils/binutils-515f23e/bfd/cache.c"
      struct rlimit rlim;

      if (getrlimit (
# 98 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                    RLIMIT_NOFILE
# 98 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                                 , &rlim) == 0
   && rlim.rlim_cur != (rlim_t) 
# 99 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                               ((__rlim_t) -1)
# 99 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                                            )
 max = rlim.rlim_cur / 8;
      else
 ...
 max = sysconf (
# 104 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
               _SC_OPEN_MAX
# 104 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                           ) / 8;
...
static bfd *bfd_last_cache = 
# 124 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                            ((void *)0)
# 124 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                                ;
...
{
  if (bfd_last_cache == 
# 131 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                       ((void *)0)
# 131 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                           )
    {
      abfd->lru_next = abfd;
      abfd->lru_prev = abfd;
  ...
  if (abfd == bfd_last_cache)
    {
      ...
      if (abfd == bfd_last_cache)
 bfd_last_cache = 
# 157 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                 ((void *)0)
# 157 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                     ;
    }
}
...
static 
# 163 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
      _Bool

# 164 "/doner/binutils/binutils-515f23e/bfd/cache.c"
bfd_cache_delete (bfd *abfd)
{
  
# 166 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
 _Bool 
# 166 "/doner/binutils/binutils-515f23e/bfd/cache.c"
      ret;

  if (fclose ((FILE *) abfd->iostream) == 0)
    ret = 
# 169 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
         1
# 169 "/doner/binutils/binutils-515f23e/bfd/cache.c"
             ;
  else
    {
      ret = 
# 172 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
           0
# 172 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                ;
  ...
  abfd->iostream = 
# 178 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                  ((void *)0)
# 178 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                      ;
  --open_files;
  abfd->flags |= 0x200000;
...
static 
# 188 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
      _Bool

# 189 "/doner/binutils/binutils-515f23e/bfd/cache.c"
close_one (void)
{
  register bfd *to_kill;

  if (bfd_last_cache == 
# 193 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                       ((void *)0)
# 193 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                           )
    to_kill = 
# 194 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
             ((void *)0)
# 194 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                 ;
  else
    {
    ...
    to_kill = to_kill->lru_prev)
 {
   if (to_kill == bfd_last_cache)
     {
       to_kill = 
# 203 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                ((void *)0)
# 203 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                    ;
       break;
     }
 }
  ...
  if (to_kill == 
# 209 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                ((void *)0)
# 209 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                    )
    {

      return 
# 212 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
            1
# 212 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                ;
    }
...
# 237 "/doner/binutils/binutils-515f23e/bfd/cache.c"
static FILE *
bfd_cache_lookup_worker (bfd *abfd, enum cache_flag flag)
{
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/cache.c", 241, __PRETTY_FUNCTION__);

  if (abfd->my_archive != 
# 243 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                         ((void *)0)
      
# 244 "/doner/binutils/binutils-515f23e/bfd/cache.c"
     && !bfd_is_thin_archive (abfd->my_archive))
    _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/cache.c", 245, __PRETTY_FUNCTION__);

  if (abfd->iostream != 
# 247 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                       ((void *)0)
# 247 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                           )
    {
      ...
      if (abfd != bfd_last_cache)
 {
  ...
  if (flag & CACHE_NO_OPEN)
    return 
# 259 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 259 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              ;

  if (bfd_open_file (abfd) == 
# 261 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                             ((void *)0)
# 261 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                                 )
    ;
  else if (!(flag & CACHE_NO_SEEK)
    && _bfd_real_fseek ((FILE *) abfd->iostream,
          abfd->where, 
# 265 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                      0
# 265 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                              ) != 0
  ...
  return 
# 274 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
        ((void *)0)
# 274 "/doner/binutils/binutils-515f23e/bfd/cache.c"
            ;
}
...
cache_btell (struct bfd *abfd)
{
  ...
  if (f == 
# 281 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 281 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              )
    return abfd->where;
...
{
  FILE *f = ((abfd) == bfd_last_cache ? (FILE *) (bfd_last_cache->iostream) : bfd_cache_lookup_worker (abfd, whence != 
# 289 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
           1 
# 289 "/doner/binutils/binutils-515f23e/bfd/cache.c"
           ? CACHE_NO_SEEK : CACHE_NORMAL));
  if (f == 
# 290 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 290 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              )
    return -1;
  return _bfd_real_fseek (f, offset, whence);
}
# 302 "/doner/binutils/binutils-515f23e/bfd/cache.c"
static file_ptr
cache_bread_1 (FILE *f, void *buf, file_ptr nbytes)
{
  file_ptr nread;
# 320 "/doner/binutils/binutils-515f23e/bfd/cache.c"
...
cache_bread (struct bfd *abfd, void *buf, file_ptr nbytes)
{
  ...
  if (f == 
# 344 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 344 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              )
    return -1;
...
# 369 "/doner/binutils/binutils-515f23e/bfd/cache.c"
...
cache_bwrite (struct bfd *abfd, const void *from, file_ptr nbytes)
{
  ...
  if (f == 
# 385 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 385 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              )
    return 0;
...
cache_bflush (struct bfd *abfd)
{
  ...
  if (f == 
# 408 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 408 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              )
    return 0;
  sts = fflush (f);
  if (sts < 0)
...
cache_bstat (struct bfd *abfd, struct stat *sb)
{
  ...
  if (f == 
# 422 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          ((void *)0)
# 422 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              )
    return -1;
      ...
      bfd_size_type *map_len __attribute__ ((__unused__)))
{
  ...
  if ((abfd->flags & 0x800) != 0)
    _bfd_abort ("/doner/binutils/binutils-515f23e/bfd/cache.c", 443, __PRETTY_FUNCTION__);
  ...
  else
    {
      ...
      if (f == 
# 453 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
              ((void *)0)
# 453 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                  )
 return ret;
...
# 495 "/doner/binutils/binutils-515f23e/bfd/cache.c"

# 495 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
_Bool

# 496 "/doner/binutils/binutils-515f23e/bfd/cache.c"
bfd_cache_init (bfd *abfd)
{
  do { if (!(abfd->iostream != 
# 498 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
 ((void *)0)
# 498 "/doner/binutils/binutils-515f23e/bfd/cache.c"
 )) bfd_assert("/doner/binutils/binutils-515f23e/bfd/cache.c",498); } while (0);
  if (open_files >= bfd_cache_max_open ())
    {
      if (! close_one ())
 return 
# 502 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
       0
# 502 "/doner/binutils/binutils-515f23e/bfd/cache.c"
            ;
    }
  ...
  ++open_files;
  return 
# 508 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
        1
# 508 "/doner/binutils/binutils-515f23e/bfd/cache.c"
            ;
}
# 526 "/doner/binutils/binutils-515f23e/bfd/cache.c"

# 526 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
_Bool

# 527 "/doner/binutils/binutils-515f23e/bfd/cache.c"
bfd_cache_close (bfd *abfd)
{

  if (abfd->iovec != &cache_iovec)
    return 
# 531 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          1
# 531 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              ;

  if (abfd->iostream == 
# 533 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                       ((void *)0)
# 533 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                           )

    return 
# 535 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
          1
# 535 "/doner/binutils/binutils-515f23e/bfd/cache.c"
              ;

  return bfd_cache_delete (abfd);
}
# 555 "/doner/binutils/binutils-515f23e/bfd/cache.c"

# 555 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
_Bool

# 556 "/doner/binutils/binutils-515f23e/bfd/cache.c"
bfd_cache_close_all (void)
{
  
# 558 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
 _Bool 
# 558 "/doner/binutils/binutils-515f23e/bfd/cache.c"
      ret = 
# 558 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
            1
# 558 "/doner/binutils/binutils-515f23e/bfd/cache.c"
  ...
  while (bfd_last_cache != 
# 560 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                          ((void *)0)
# 560 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                              )
    ret &= bfd_cache_close (bfd_last_cache);

  return ret;
}
# 581 "/doner/binutils/binutils-515f23e/bfd/cache.c"
FILE *
bfd_open_file (bfd *abfd)
{
  abfd->cacheable = 
# 584 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                   1
# 584 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                       ;
  ...
  if (open_files >= bfd_cache_max_open ())
    {
      if (! close_one ())
 return 
# 589 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
       ((void *)0)
# 589 "/doner/binutils/binutils-515f23e/bfd/cache.c"
           ;
    }
  ...
  switch (abfd->direction)
    ...
    case read_direction:
    case no_direction:
      abfd->iostream = _bfd_real_fopen (bfd_get_filename (abfd), "r");
      break;
    case both_direction:
      ...
      if (abfd->opened_once)
 {
   abfd->iostream = _bfd_real_fopen (bfd_get_filename (abfd),
         "r+");
   if (abfd->iostream == 
# 604 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                        ((void *)0)
# 604 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                            )
     abfd->iostream = _bfd_real_fopen (bfd_get_filename (abfd),
           "w+");
 }
 ...
 {
# 631 "/doner/binutils/binutils-515f23e/bfd/cache.c"
   struct stat s;
   ...
   abfd->iostream = _bfd_real_fopen (bfd_get_filename (abfd),
         "w+");
   abfd->opened_once = 
# 638 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                      1
# 638 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                          ;
 }
      break;
    }
  ...
  if (abfd->iostream == 
# 643 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
                       ((void *)0)
# 643 "/doner/binutils/binutils-515f23e/bfd/cache.c"
                           )
    bfd_set_error (bfd_error_system_call);
  else
    {
 ...
 return 
# 648 "/doner/binutils/binutils-515f23e/bfd/cache.c" 3 4
       ((void *)0)
# 648 "/doner/binutils/binutils-515f23e/bfd/cache.c"
           ;
    }
