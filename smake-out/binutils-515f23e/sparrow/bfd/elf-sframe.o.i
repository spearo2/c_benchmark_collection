# 1 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
# 21 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
...
# 22 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 2




static 
# 30 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
      _Bool

# 31 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
          ...
          unsigned int func_idx)
{
  ...
  return 
# 37 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        0
# 37 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
             ;
}
...
{
  if (func_idx < sfd_info->sfd_fde_count)
    sfd_info->sfd_func_bfdinfo[func_idx].func_deleted_p = 
# 47 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                                         1
# 47 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                                             ;
}
...
sframe_decoder_get_func_r_offset (struct sframe_dec_info *sfd_info,
      unsigned int func_idx)
{
  do { if (!(func_idx < sfd_info->sfd_fde_count)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",56); } while (0);
  unsigned int func_r_offset
    = sfd_info->sfd_func_bfdinfo[func_idx].func_r_offset;

  do { if (!(func_r_offset)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",60); } while (0);
...
sframe_decoder_get_func_reloc_index (struct sframe_dec_info *sfd_info,
         unsigned int func_idx)
{
  do { if (!(func_idx < sfd_info->sfd_fde_count)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",81); } while (0);
...
static 
# 99 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
      _Bool

# 100 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
      ...
      struct elf_reloc_cookie *cookie)
{
  ...
  if (sfd_info->sfd_func_bfdinfo == 
# 114 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                   ((void *)0)
# 114 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                       )
    return 
# 115 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          0
# 115 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
               ;
  memset (sfd_info->sfd_func_bfdinfo, 0, func_bfdinfo_size);


  if ((sec->flags & 0x100000) && cookie->rels == 
# 119 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                                          ((void *)0)
# 119 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                                              )
    return 
# 120 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          1
# 120 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
              ;

  for (i = 0; i < fde_count; i++)
    {
      cookie->rel = cookie->rels + i;
      do { if (!(cookie->rel < cookie->relend)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",125); } while (0);
  ...
  do { if (!(cookie->rel == cookie->relend)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",134); } while (0);

  return 
# 136 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        1
# 136 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;
}
...
sframe_read_value (bfd *abfd, bfd_byte *contents, unsigned int offset,
     unsigned int width)
{
  do { if (!(contents && offset)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",145); } while (0);


  do { if (!(width == 4)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",148); } while (0);

  unsigned char *buf = contents + offset;
  bfd_vma value = ((*((abfd)->xvec->bfd_getx_signed_32)) (buf));
  return value;
}
...
# 159 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
_Bool

# 160 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
_bfd_elf_sframe_present (struct bfd_link_info *info)
{
  asection *sframe = bfd_get_section_by_name (info->output_bfd, ".sframe");

  if (sframe == 
# 164 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
               ((void *)0)
# 164 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                   )
    return 
# 165 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          0
# 165 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
               ;


  for (sframe = sframe->map_head.s; sframe != 
# 168 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                             ((void *)0)
# 168 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                                 ; sframe = sframe->map_head.s)
    ...
    if (sframe->size > sizeof (sframe_header))
      return 
# 174 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            1
# 174 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                ;
  return 
# 175 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        0
# 175 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
             ;
}
...
# 184 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
_Bool

# 185 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
_bfd_elf_parse_sframe (bfd *abfd,
         struct bfd_link_info *info __attribute__ ((__unused__)),
         asection *sec, struct elf_reloc_cookie *cookie)
{
  bfd_byte *sfbuf = 
# 189 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                   ((void *)0)
# 189 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                       ;
  struct sframe_dec_info *sfd_info;
  ...
  if (sec->size == 0
      ...
      || sec->sec_info_type != 0)
    {
      ...
      return 
# 200 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            0
# 200 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                 ;
    }
  ...
  if (bfd_is_abs_section (sec->output_section))
    {
      ...
      return 
# 207 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            0
# 207 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                 ;
    }
  ...
  ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info = sfd_info;
  sec->sec_info_type = 7;
...
fail_no_free:
  _bfd_error_handler
   (dgettext ("bfd", "error in %pB(%pA); no .sframe will be created"),
    abfd, sec);
  return 
# 242 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        0
# 242 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
             ;
success:
  free (sfbuf);
  return 
# 245 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        1
# 245 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;
}
...
# 254 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
_Bool

# 255 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
_bfd_elf_discard_section_sframe
   (asection *sec,
    
# 257 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
   _Bool 
# 257 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
        (*reloc_symbol_deleted_p) (bfd_vma, void *),
    struct elf_reloc_cookie *cookie)
{
  
# 260 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
 _Bool 
# 260 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
      changed;
  
# 261 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
 _Bool 
# 261 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
      keep;
  unsigned int i;
  ...
  changed = 
# 267 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
           0
# 267 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                ;


  keep = 
# 270 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        0
# 270 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
             ;

  sfd_info = (struct sframe_dec_info *) ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->sec_info;



  if ((sec->flags & 0x100000) == 0 || cookie->rels != 
# 276 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                                               ((void *)0)
# 276 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                                                   )
    {
   ...
   if (!keep)
     {
       ...
       changed = 
# 290 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                1
# 290 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                    ;
     }
 }
    }
...
# 300 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
_Bool

# 301 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
    ...
    struct bfd_link_info *info)
{
  ...
  if (!cfsec)
    return 
# 308 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          0
# 308 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
               ;

  (((abfd) -> tdata.elf_obj_data) -> o->sframe) = cfsec;

  return 
# 312 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        1
# 312 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;
}
...
# 318 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
_Bool

# 319 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
          ...
          bfd_byte *contents)
{
  ...
  if (sec->sec_info_type != 7)
    return 
# 340 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          0
# 340 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
               ;
  ...
  if (sfd_ctx == 
# 353 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                ((void *)0) 
# 353 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                     || sfe_info == 
# 353 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                    ((void *)0)
# 353 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
    ...
    return 
# 354 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          0
# 354 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
               ;

  if (htab->sfe_info.sfe_ctx == 
# 356 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                               ((void *)0)
# 356 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                   )
    {
      ...
      if (!sfd_ctx_abi_arch)
 return 
# 364 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
       0
# 364 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;

      htab->sfe_info.sfe_ctx = sframe_encode (2,
           0,
           sfd_ctx_abi_arch,
      ...
      if (htab->sfe_info.sfe_ctx == 
# 373 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                   ((void *)0)
# 373 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                       )
 return 
# 374 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
       0
# 374 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;
    }
  sfe_ctx = sfe_info->sfe_ctx;

  if (sfe_info->sframe_section == 
# 378 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                                 ((void *)0)
# 378 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                     )
    {
 ...
 return 
# 391 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
       0
# 391 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;
    }
  ...
  if (sframe_decoder_get_abi_arch (sfd_ctx)
    ...
    {
      _bfd_error_handler
 (dgettext ("bfd", "input SFrame sections with different abi prevent .sframe" " generation")
                 );
      return 
# 402 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            0
# 402 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                 ;
    }
  ...
  if (dctx_version != 2 || dctx_version != ectx_version)
    {
      _bfd_error_handler
 (dgettext ("bfd", "input SFrame sections with different format versions prevent" " .sframe generation")
                         );
      return 
# 413 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            0
# 413 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                 ;
    }
...
# 433 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
     _Bool 
# 433 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
          pltn_reloc_by_hand = 
# 433 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                               0
# 433 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
        ...
        &rep_block_size))
 {
       ...
       else
  {
    ...
    do { if (!(num_fidx <= 2)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",463); } while (0);
   ...
   = r_offset + (i * sizeof (sframe_func_desc_entry));
        pltn_reloc_by_hand = 
# 476 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
                            1
# 476 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                                ;
      }
  }
  ...
  address += sframe_read_value (abfd, contents,
   ...
   cur_fidx++;
   do { if (!(!err)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",498); } while (0);
 }
      ...
      for (j = 0; j < num_fres; j++)
 {
   ...
   if (!sframe_decoder_get_fre (sfd_ctx, i, j, &fre))
     {
      ...
      &fre);
       do { if (!(!err)) bfd_assert("/doner/binutils/binutils-515f23e/bfd/elf-sframe.c",509); } while (0);
     }
 }
    }
  ...
  return 
# 516 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
        1
# 516 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
            ;
}
...
# 523 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
_Bool

# 524 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
_bfd_elf_write_section_sframe (bfd *abfd, struct bfd_link_info *info)
{
  
# 526 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
 _Bool 
# 526 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
      retval = 
# 526 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
               1
# 526 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
  ...
  if (sec == 
# 541 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            ((void *)0)
# 541 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                )
    return 
# 542 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
          1
# 542 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
              ;
  ...
  if (!bfd_set_section_contents (abfd, sec->output_section, contents,
     ...
     sec->size))
    retval = 
# 550 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c" 3 4
            0
# 550 "/doner/binutils/binutils-515f23e/bfd/elf-sframe.c"
                 ;
  else if (!((info)->type == type_relocatable))
    {
      Elf_Internal_Shdr *hdr = &((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_hdr;
