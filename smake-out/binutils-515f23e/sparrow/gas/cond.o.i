# 1 "/doner/binutils/binutils-515f23e/gas/cond.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/cond.c"
# 21 "/doner/binutils/binutils-515f23e/gas/cond.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/cond.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/cond.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/cond.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/cond.c" 2
...
static struct conditional_frame *current_cframe = 
# 63 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                                 ((void *)0)
# 63 "/doner/binutils/binutils-515f23e/gas/cond.c"
                                                     ;
...
s_ifdef (int test_defined)
{
  ...
  if (!( lex_type[(unsigned char) (*name)] & (2) ) && *name != '"')
    {
      as_bad (gettext ("invalid identifier for \".ifdef\""));
      __extension__ ({ struct obstack *__o = (&cond_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = (0))); });
      ignore_rest_of_line ();
      return;
    }
  ...
  if (cframe.dead_tree)
  ...
  else
    {
      ...
      is_defined =
 symbolP != 
# 106 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
           ((void *)0)
 
# 107 "/doner/binutils/binutils-515f23e/gas/cond.c"
...
s_if (int arg)
{
  ...
  int t;
  char *stop = 
# 132 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
              ((void *)0)
# 132 "/doner/binutils/binutils-515f23e/gas/cond.c"
                  ;
  char stopc = 0;
  ...
  if (current_cframe != 
# 141 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                       ((void *)0) 
# 141 "/doner/binutils/binutils-515f23e/gas/cond.c"
 ...
 as_bad (gettext ("non-constant expression in \".if\" statement"));
    }
  ...
  switch ((operatorT) arg)
    ...
    default:
      as_abort ("/doner/binutils/binutils-515f23e/gas/cond.c", 163, __PRETTY_FUNCTION__);
      return;
    }
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 177 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                   ((void *)0)
   
# 178 "/doner/binutils/binutils-515f23e/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
s_ifb (int test_blank)
{
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 214 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                   ((void *)0)
   
# 215 "/doner/binutils/binutils-515f23e/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
{
  char *stop = 
# 266 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
              ((void *)0)
# 266 "/doner/binutils/binutils-515f23e/gas/cond.c"
                  ;
  char stopc = 0;
  char *s1, *s2;
  int len1, len2;
  ...
  if (*input_line_pointer != ',')
    as_bad (gettext ("bad format for ifc or ifnc"));
  else
    ++input_line_pointer;
 ...
 if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 295 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                   ((void *)0)
   
# 296 "/doner/binutils/binutils-515f23e/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
{
  if (current_cframe == 
# 308 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                       ((void *)0)
# 308 "/doner/binutils/binutils-515f23e/gas/cond.c"
                           )
    {
      as_bad (gettext ("\".elseif\" without matching \".if\""));
    }
  else if (current_cframe->else_seen)
    {
      as_bad (gettext ("\".elseif\" after \".else\""));
      as_bad_where (current_cframe->else_file_line.file,
      current_cframe->else_file_line.line,
      gettext ("here is the previous \".else\""));
      as_bad_where (current_cframe->if_file_line.file,
      current_cframe->if_file_line.line,
      gettext ("here is the previous \".if\""));
    }
  else
    {
  ...
  if (current_cframe == 
# 331 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                       ((void *)0) 
# 331 "/doner/binutils/binutils-515f23e/gas/cond.c"
                            || current_cframe->ignoring)
    {
      while (! is_end_of_line[(unsigned char) *input_line_pointer])
 ++input_line_pointer;
      ...
      if (current_cframe == 
# 336 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                           ((void *)0)
# 336 "/doner/binutils/binutils-515f23e/gas/cond.c"
                               )
 return;
    }
  else
    {
      ...
      expr (0, &operand, expr_evaluate);
      if (operand.X_op != O_constant)
 as_bad (gettext ("non-constant expression in \".elseif\" statement"));
 ...
 case O_gt: t = operand.X_add_number > 0; break;
 default:
   as_abort ("/doner/binutils/binutils-515f23e/gas/cond.c", 360, __PRETTY_FUNCTION__);
   return;
 }
  ...
  if (((listing & 32) != 0)
      && (current_cframe->previous_cframe == 
# 368 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                            ((void *)0)
   
# 369 "/doner/binutils/binutils-515f23e/gas/cond.c"
...
void
s_endif (int arg __attribute__ ((__unused__)))
{
  struct conditional_frame *hold;

  if (current_cframe == 
# 385 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                       ((void *)0)
# 385 "/doner/binutils/binutils-515f23e/gas/cond.c"
                           )
    {
      as_bad (gettext ("\".endif\" without \".if\""));
    }
  else
    {
      if (((listing & 32) != 0)
   && current_cframe->ignoring
   && (current_cframe->previous_cframe == 
# 393 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                         ((void *)0)
       
# 394 "/doner/binutils/binutils-515f23e/gas/cond.c"
      || ! current_cframe->previous_cframe->ignoring))
 listing_list (1);

      hold = current_cframe;
      current_cframe = current_cframe->previous_cframe;
      __extension__ ({ struct obstack *__o = (&cond_obstack); void *__obj = (void *) (hold); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
    }
...
void
s_else (int arg __attribute__ ((__unused__)))
{
  if (current_cframe == 
# 414 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                       ((void *)0)
# 414 "/doner/binutils/binutils-515f23e/gas/cond.c"
                           )
    {
      as_bad (gettext ("\".else\" without matching \".if\""));
    }
  else if (current_cframe->else_seen)
    {
      as_bad (gettext ("duplicate \".else\""));
      as_bad_where (current_cframe->else_file_line.file,
      current_cframe->else_file_line.line,
      gettext ("here is the previous \".else\""));
      as_bad_where (current_cframe->if_file_line.file,
 ...
 current_cframe->dead_tree | !current_cframe->ignoring;
      ...
      if (((listing & 32) != 0)
   && (current_cframe->previous_cframe == 
# 437 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                         ((void *)0)
       
# 438 "/doner/binutils/binutils-515f23e/gas/cond.c"
      || ! current_cframe->previous_cframe->ignoring))
 {
   if (! current_cframe->ignoring)
     listing_list (1);
...
s_ifeqs (int arg)
{
  ...
  if (*input_line_pointer != ',')
    {
      as_bad (gettext (".ifeqs syntax error"));
      ignore_rest_of_line ();
      return;
    }
  ...
  if (((listing & 32) != 0)
      && cframe.ignoring
      && (cframe.previous_cframe == 
# 490 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                   ((void *)0)
   
# 491 "/doner/binutils/binutils-515f23e/gas/cond.c"
  || ! cframe.previous_cframe->ignoring))
    listing_list (2);
...
ignore_input (void)
{
 ...
 --s;
    ...
    {
      if (s[-1] != '.')
 return (current_cframe != 
# 512 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                          ((void *)0)
# 512 "/doner/binutils/binutils-515f23e/gas/cond.c"
                              ) && (current_cframe->ignoring);
    }
 ...
 return 0;
  ...
  return (current_cframe != 
# 534 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                           ((void *)0)
# 534 "/doner/binutils/binutils-515f23e/gas/cond.c"
                               ) && (current_cframe->ignoring);
}
...
initialize_cframe (struct conditional_frame *cframe)
{
  ...
  cframe->dead_tree = current_cframe != 
# 544 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                                       ((void *)0) 
# 544 "/doner/binutils/binutils-515f23e/gas/cond.c"
                                            && current_cframe->ignoring;
...
{
  if (current_cframe != 
# 556 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                       ((void *)0) 
# 556 "/doner/binutils/binutils-515f23e/gas/cond.c"
                            && current_cframe->macro_nest >= nest)
    {
      if (nest >= 0)
 as_bad (gettext ("end of macro inside conditional"));
      else
 as_bad (gettext ("end of file inside conditional"));

      as_bad_where (current_cframe->if_file_line.file,
      current_cframe->if_file_line.line,
      gettext ("here is the start of the unterminated conditional"));
      if (current_cframe->else_seen)
 as_bad_where (current_cframe->else_file_line.file,
        current_cframe->else_file_line.line,
        gettext ("here is the \"else\" of the unterminated conditional"));
...
{
  while (current_cframe != 
# 581 "/doner/binutils/binutils-515f23e/gas/cond.c" 3 4
                          ((void *)0) 
# 581 "/doner/binutils/binutils-515f23e/gas/cond.c"
                               && current_cframe->macro_nest >= nest)
    {
      struct conditional_frame *hold;
