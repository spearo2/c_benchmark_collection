# 1 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
# 21 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 2
# 62 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
static char *buffer_start;
static char *partial_where;
static size_t partial_size;




static char save_source[(1)];
...
int macro_nest;
# 99 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
...
static 
# 108 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
      _Bool 
# 108 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
           is_linefile;
...
# 121 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
 _Bool 
# 121 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                     is_linefile;
  size_t sb_index;
  sb from_sb;
  enum expansion from_sb_expansion;
...
input_scrub_reinit (void)
{
  ...
  logical_input_file = 
# 145 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                      ((void *)0)
# 145 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                          ;
  sb_index = -1;

  buffer_length = input_file_buffer_size () * 2;
  buffer_start = ((char *) xmalloc (sizeof (char) * ((1) + (1) + 1 + buffer_length)));
  memcpy (buffer_start, ("\n"), (int) (1));
}
...
input_scrub_push (char *saved_position)
{
  ...
  saved = ((struct input_save *) xmalloc (sizeof (struct input_save)));
...
{
  ((void) ((strlen (("\n")) == (1)) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/input-scrub.c", 217, __PRETTY_FUNCTION__), 0)));
  ((void) ((strlen (("\0")) == (1) || (("\0")[0] == '\0' && (1) == 1)) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/input-scrub.c", 218, __PRETTY_FUNCTION__), 0)))
                                                 ;

  physical_input_file = 
# 221 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                       ((void *)0)
# 221 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                           ;
  next_saved_file = 
# 222 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                   ((void *)0)
# 222 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                       ;
  macro_nest = 0;
  input_scrub_reinit ();
  do_scrub_begin (0);
...
input_scrub_new_file (const char *filename)
{
  ...
  physical_input_file = filename[0] ? filename : gettext ("{standard input}");
...
input_scrub_include_sb (sb *from, char *position, enum expansion expansion)
{
  ...
  if (macro_nest > max_macro_nest)
    as_fatal (gettext ("macros nested too deeply"));
  ++macro_nest;
# 284 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
  next_saved_file = input_scrub_push (position);
...
input_scrub_next_buffer (char **bufp)
{
      ...
      if (sb_index >= from_sb.len)
 {
   ...
   --macro_nest;
   partial_where = 
# 339 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                  ((void *)0)
# 339 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                      ;
   partial_size = 0;
   if (next_saved_file != 
# 341 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                         ((void *)0)
# 341 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                             )
  ...
  if (partial_size)
    {
      memmove (buffer_start + (1), partial_where, partial_size);
      memcpy (buffer_start + (1), save_source, (1));
    }

  while (1)
    {
      char *p;
      char *start = buffer_start + (1) + partial_size;
...
# 392 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
          1 
# 392 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                      );
      ...
      memcpy (save_source, partial_where, (int) (1));
      memcpy (partial_where, ("\0"), (int) (1));
      return partial_where;

    read_more:

      partial_size = limit - (buffer_start + (1));
      if (buffer_length - input_file_buffer_size () < partial_size)
 {


   buffer_length *= 2;
   buffer_start = ((char *) xrealloc ((void *) (buffer_start), sizeof (char) * ((buffer_length + (1) + (1) + 1))))
  ...
  { if (listing) listing_newline (
# 418 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
 ((void *)0)
# 418 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
 ); };


  partial_where = 
# 421 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                 ((void *)0)
# 421 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                     ;
  if (next_saved_file)
    *bufp = input_scrub_pop (next_saved_file);
...
# 434 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                ((void *)0)
# 434 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                    );
}
...
# 454 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
void
new_logical_line_flags (const char *fname,
   int line_number,
   int flags)
{
  switch (flags)
    ...
    case 1:
      if (line_number != -1)
 as_abort ("/doner/binutils/binutils-515f23e/gas/input-scrub.c", 465, __PRETTY_FUNCTION__);
      break;
    case 1 << 1:
    case 1 << 2:
      ...
      break;
    case 1 << 3:
      if (line_number < 0 || fname != 
# 472 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                     ((void *)0)
# 472 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                         )
 as_abort ("/doner/binutils/binutils-515f23e/gas/input-scrub.c", 473, __PRETTY_FUNCTION__);
      if (next_saved_file == 
# 474 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                            ((void *)0)
# 474 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                )
 ...
 fname = next_saved_file->physical_input_file;
      break;
    default:
      as_abort ("/doner/binutils/binutils-515f23e/gas/input-scrub.c", 482, __PRETTY_FUNCTION__);
    }
  ...
  if (line_number >= 0)
  ...
  else if (line_number == -1 && fname && !*fname && (flags & (1 << 2)))
    {
      ...
      fname = 
# 493 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
             ((void *)0)
# 493 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                 ;
    }

  if (fname
      && (logical_input_file == 
# 497 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                               ((void *)0)
   
# 498 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
  ...
  do
    {
      if (expansion != expanding_macro)
                ;
      else if (saved->logical_input_file != 
# 522 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                           ((void *)0)
        
# 523 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
       && saved->logical_input_line != -1u)
 as_info_where (saved->logical_input_file, saved->logical_input_line,
         indent, gettext ("macro invoked from here"));
      else
 as_info_where (saved->physical_input_file, saved->physical_input_line,
  ...
  while ((saved = saved->next_saved_file) != 
# 533 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                            ((void *)0)
# 533 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                                );
}
...
# 541 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                            ((void *)0)
# 541 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                )
    {
      if (linep != 
# 543 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                  ((void *)0)
# 543 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                      )
 *linep = physical_input_line;
  ...
  if (linep != 
# 548 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
              ((void *)0)
# 548 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                  )
    *linep = 0;
  return 
# 550 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
        ((void *)0)
# 550 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
            ;
}
...
# 570 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                        ((void *)0)
     
# 571 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
    && (linep == 
# 571 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                 ((void *)0) 
# 571 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                      || saved->logical_input_line != -1u))
     {
       if (linep != 
# 573 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                   ((void *)0)
# 573 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                       )
  *linep = saved->logical_input_line;
       file = saved->logical_input_file;
     }
   else if (saved->physical_input_file != 
# 577 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                         ((void *)0)
# 577 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                             )
     {
       if (linep != 
# 579 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                   ((void *)0)
# 579 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                       )
  *linep = saved->physical_input_line;
   ...
   expansion = saved->from_sb_expansion;
      ...
      while ((saved = saved->next_saved_file) != 
# 586 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                                                ((void *)0)
# 586 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                                                    );
    }
...
{
  if (logical_input_file != 
# 597 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                           ((void *)0)
      
# 598 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
     && (linep == 
# 598 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                  ((void *)0) 
# 598 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                       || logical_input_line != -1u))
    {
      if (linep != 
# 600 "/doner/binutils/binutils-515f23e/gas/input-scrub.c" 3 4
                  ((void *)0)
# 600 "/doner/binutils/binutils-515f23e/gas/input-scrub.c"
                      )
