# 1 "/doner/binutils/binutils-515f23e/gas/sframe-opt.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/sframe-opt.c"
# 21 "/doner/binutils/binutils-515f23e/gas/sframe-opt.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/sframe-opt.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/sframe-opt.c" 2
...
sframe_estimate_size_before_relax (fragS *frag)
{
  ...
  ((void) (((exp->X_op == O_modulus) || (exp->X_op == O_absent)) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/sframe-opt.c", 43, __PRETTY_FUNCTION__), 0)));
  ...
  if (exp->X_op == O_modulus)
  ...
  else
    {
      ...
      if (width < (offsetT) (1ULL << ((0 + 1) * 8)))
 ret = 1;
      else if (width < (offsetT) (1ULL << ((1 * 2) * 8)))
 ret = 2;
      else
 ret = 4;
    }
...
sframe_convert_frag (fragS *frag)
{
  ...
  exp = symbol_get_value_expression (frag->fr_symbol);
  ((void) (((exp->X_op == O_modulus) || (exp->X_op == O_absent)) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/sframe-opt.c", 111, __PRETTY_FUNCTION__), 0)));
  ...
  if (exp->X_op == O_modulus)
    {
      ...
      fde_type = (((rest_of_data) >> 4) & 0x1);
      pauth_key = (((rest_of_data) >> 5) & 0x1);
      ((void) ((fde_type == 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/sframe-opt.c", 121, __PRETTY_FUNCTION__), 0)));


      fsizeS = exp->X_op_symbol;
      fsize = resolve_symbol_value (fsizeS);
      if (fsize < (offsetT) (1ULL << ((0 + 1) * 8)))
 fre_type = 0;
      else if (fsize < (offsetT) (1ULL << ((1 * 2) * 8)))
 fre_type = 1;
      else
 fre_type = 2;


      value = (((0 & 0x1) << 5) | (((fde_type) & 0x1) << 4) | ((fre_type) & 0xf));
      value = ((((pauth_key) & 0x1) << 5) | ((value) & 0xdf));
 ...
 {
 case 1:
   ((void) ((fsize < (offsetT) (1ULL << ((0 + 1) * 8))) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/sframe-opt.c", 153, __PRETTY_FUNCTION__), 0)));
   frag->fr_literal[frag->fr_fix] = diff;
   break;
 case 2:
   ((void) ((fsize < (offsetT) (1ULL << ((1 * 2) * 8))) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/sframe-opt.c", 157, __PRETTY_FUNCTION__), 0)));
 ...
 case 4:
   ...
   break;
 default:
   as_abort ("/doner/binutils/binutils-515f23e/gas/sframe-opt.c", 164, __PRETTY_FUNCTION__);
 }
    }
