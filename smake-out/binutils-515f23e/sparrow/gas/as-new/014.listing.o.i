# 1 "/doner/binutils/binutils-515f23e/gas/listing.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/listing.c"
# 90 "/doner/binutils/binutils-515f23e/gas/listing.c"
...
# 91 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
...
# 92 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
...
# 93 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
# 1 "/doner/binutils/binutils-515f23e/gas/input-file.h" 1
# 58 "/doner/binutils/binutils-515f23e/gas/input-file.h"
...
# 94 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
...
# 95 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
# 1 "../bfd/bfdver.h" 1
# 96 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
...
# 97 "/doner/binutils/binutils-515f23e/gas/listing.c" 2
# 122 "/doner/binutils/binutils-515f23e/gas/listing.c"
...
int listing_lhs_width = ((4) > 4 ? 1 : 4 / (4));
int listing_lhs_width_second = ((4) > 4 ? 1 : 4 / (4));
int listing_lhs_cont_lines = 4;
int listing_rhs_width = 100;
...
# 218 "/doner/binutils/binutils-515f23e/gas/listing.c"
...
{
  if (listing_tail != (list_info_type *) 
# 235 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                        ((void *)0)
# 235 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                            )
    {
      char *n = concat (name, message, (char *) 
# 237 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                               ((void *)0)
# 237 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                   );
      struct list_message *lm = ((struct list_message *) xmalloc (sizeof (struct list_message)));
      lm->message = n;
      lm->next = 
# 240 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                ((void *)0)
# 240 "/doner/binutils/binutils-515f23e/gas/listing.c"
                    ;
...
{
  listing_message (gettext ("Warning: "), message);
}

void
listing_error (const char *message)
{
  listing_message (gettext ("Error: "), message);
}
...
file_info (const char *file_name)
{
  ...
  while (p != (file_info_type *) 
# 268 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                ((void *)0)
# 268 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                    )
    {
...
# 300 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                ((void *)0)
# 300 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                    ;
  list_info_type *new_i = 
# 301 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                         ((void *)0)
# 301 "/doner/binutils/binutils-515f23e/gas/listing.c"
                             ;
  ...
  if ((listing & 16) != 0
      && listing_tail != 
# 315 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                        ((void *)0)
      
# 316 "/doner/binutils/binutils-515f23e/gas/listing.c"
     && ! listing_tail->debugging)
    {
      const char *segname;

      segname = bfd_section_name (now_seg);
 ...
 listing_tail->debugging = 1;
  ...
  if (ps == 
# 334 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
           ((void *)0)
# 334 "/doner/binutils/binutils-515f23e/gas/listing.c"
               )
    {
      if (line == last_line
...
# 353 "/doner/binutils/binutils-515f23e/gas/listing.c"
      if (strcmp (file, gettext ("{standard input}")) == 0
   && input_line_pointer != 
# 354 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                           ((void *)0)
# 354 "/doner/binutils/binutils-515f23e/gas/listing.c"
                               )
 {
   char *copy, *src, *dest;
   int len;
  ...
  seen_quote = !seen_quote;
   ...
   copy = ((char *) xmalloc (sizeof (char) * (len)));
 ...
 new_i->line_contents = 
# 395 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                       ((void *)0)
# 395 "/doner/binutils/binutils-515f23e/gas/listing.c"
                           ;
    }
  else
    {
  ...
  new_i->next = (list_info_type *) 
# 418 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                  ((void *)0)
# 418 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                      ;
  new_i->messages = 
# 419 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                   ((void *)0)
# 419 "/doner/binutils/binutils-515f23e/gas/listing.c"
                       ;
  new_i->last_message = 
# 420 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                       ((void *)0)
# 420 "/doner/binutils/binutils-515f23e/gas/listing.c"
                           ;
  new_i->edict = EDICT_NONE;
  new_i->hll_file = (file_info_type *) 
# 422 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                      ((void *)0)
# 422 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                          ;
  new_i->hll_line = 0;
  new_i->debugging = 0;
...
listing_prev_line (void)
{
  ...
  if (head == (list_info_type *) 
# 455 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                ((void *)0)
      
# 456 "/doner/binutils/binutils-515f23e/gas/listing.c"
     || head == listing_tail)
    return;
  ...
  for (f = frchain_now->frch_root; f != (fragS *) 
# 464 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                                 ((void *)0)
# 464 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                     ; f = f->fr_next)
...
buffer_line (file_info_type *file, char *line, unsigned int size)
{
      ...
      if (last_open_file)
 {
   ...
   fclose (last_open_file);
      ...
      if (last_open_file == 
# 500 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                           ((void *)0)
# 500 "/doner/binutils/binutils-515f23e/gas/listing.c"
                               )
 {
   file->at_end = 1;
   return "";
      ...
      if (file->pos)
 fseek (last_open_file, file->pos, 
# 508 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                  0
# 508 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                          );
    }
  ...
  while (c != 
# 513 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
             (-1) 
# 513 "/doner/binutils/binutils-515f23e/gas/listing.c"
                 && c != '\n' && c != '\r')
    {
      if (++count < size)
 *p++ = c;
 ...
 ungetc (next, last_open_file);
  ...
  if (c == 
# 531 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
          (-1)
# 531 "/doner/binutils/binutils-515f23e/gas/listing.c"
             )
    {
      file->at_end = 1;
      if (count + 3 < size)
...
# 563 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
 _Bool 
# 563 "/doner/binutils/binutils-515f23e/gas/listing.c"
      found = 
# 563 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
              0
# 563 "/doner/binutils/binutils-515f23e/gas/listing.c"
  ...
  if (file == 
# 566 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
             ((void *)0) 
# 566 "/doner/binutils/binutils-515f23e/gas/listing.c"
                  || buffer == 
# 566 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                               ((void *)0) 
# 566 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                    || size <= 1 || file->linenum <= linenum)
    return;


  if (last_open_file_info == 
# 570 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                            ((void *)0) 
# 570 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                 || file != last_open_file_info)
    {
      if (last_open_file)
 {
   last_open_file_info->pos = ftell (last_open_file);
   fclose (last_open_file);
      ...
      last_open_file = fopen (file->filename, "r");
      if (last_open_file == 
# 582 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                           ((void *)0)
# 582 "/doner/binutils/binutils-515f23e/gas/listing.c"
                               )
 {
   file->at_end = 1;
   return;
      ...
      if (file->pos)
 fseek (last_open_file, file->pos, 
# 590 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                  0
# 590 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                          );
    }
  ...
  while (pos2 > 0 && ! found)
    {
      ...
      fseek (last_open_file, pos2, 
# 615 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                  0
# 615 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                          );


      if (fread (buffer, 1, size, last_open_file) != size)
 {
   as_warn (gettext ("unable to rebuffer file: %s\n"), file->filename);
   return;
 }
      ...
      for (ptr = buffer + size; ptr >= buffer; -- ptr)
 {
       ...
       if (current_line == linenum)
  {
    ...
    found = 
# 633 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
           1
# 633 "/doner/binutils/binutils-515f23e/gas/listing.c"
               ;
   ...
   ++ pos2;
    ...
    fseek (last_open_file, pos2, 
# 653 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                0
# 653 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                        );
    break;
  }
     }
  ...
  while (c != 
# 663 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
             (-1) 
# 663 "/doner/binutils/binutils-515f23e/gas/listing.c"
                 && c != '\n' && c != '\r')
    {
      if (count < size)
 *p++ = c;
  ...
  *p++ = 0;
  ...
  fseek (last_open_file, pos, 
# 687 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                             0
# 687 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                     );
}
...
# 748 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
 __builtin_va_start(
# 748 "/doner/binutils/binutils-515f23e/gas/listing.c"
 args
# 748 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
 ,
# 748 "/doner/binutils/binutils-515f23e/gas/listing.c"
...
# 754 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
 __builtin_va_end(
# 754 "/doner/binutils/binutils-515f23e/gas/listing.c"
 args
# 754 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
 )
# 754 "/doner/binutils/binutils-515f23e/gas/listing.c"
...
calc_hex (list_info_type *list)
{
  ...
  while (frag_ptr != (fragS *) 
# 777 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                              ((void *)0) 
# 777 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                   && frag_ptr->line == first)
    {

      octet_in_frag = 0;
      while (octet_in_frag < frag_ptr->fr_fix
      && data_buffer_size < (((4 * 2) + 1) * listing_lhs_width + ((((4 * 2) + 1) * listing_lhs_width_second) * listing_lhs_cont_lines) + 20) - 3)
 {
   if (address == ~(unsigned int) 0)
     address = frag_ptr->fr_address / (1<<0);
      ...
      const char *string, unsigned int address)
{
  ...
  listing_page (list);
  nchars = (4 * 2 + 1) * listing_lhs_width;
 ...
 fprintf (list_file, " ");
      ...
      emit_line (
# 848 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                ((void *)0)
# 848 "/doner/binutils/binutils-515f23e/gas/listing.c"
                    , "\t%s\n", string ? string : "");
      return;
    }
      ...
      if (octet_in_word == 4)
 {
  ...
  && src[cur];
       lines++)
    {
      nchars = ((4 * 2) + 1) * listing_lhs_width_second - 1;
      idx = 0;
...
list_symbol_table (void)
{
  ...
  eject = 1;
  listing_page (
# 926 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
               ((void *)0)
# 926 "/doner/binutils/binutils-515f23e/gas/listing.c"
                   );

  for (ptr = symbol_rootP; ptr != (symbolS *) 
# 928 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                             ((void *)0)
# 928 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                 ; ptr = symbol_next (ptr))
    {
      if (( (S_GET_SEGMENT (ptr)) != (&_bfd_std_section[2]) && (S_GET_SEGMENT (ptr)) != (&_bfd_std_section[1]) && (S_GET_SEGMENT (ptr)) != reg_section && (S_GET_SEGMENT (ptr)) != expr_section)
   || S_GET_SEGMENT (ptr) == (&_bfd_std_section[2]))
 {
       ...
       if (symbol_get_frag (ptr) && symbol_get_frag (ptr)->line)
  {
    fprintf (list_file, "%20s:%-5d  %s:%s %s\n",
      ...
      bfd_section_name (S_GET_SEGMENT (ptr)),
      buf, S_GET_NAME (ptr));
  }
       else
  {
    fprintf (list_file, "%33s:%s %s\n",
      ...
      buf, S_GET_NAME (ptr));
       ...
       on_page++;
       listing_page (
# 966 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                    ((void *)0)
# 966 "/doner/binutils/binutils-515f23e/gas/listing.c"
                        );
     }
 }
  ...
  emit_line (
# 976 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
            ((void *)0)
# 976 "/doner/binutils/binutils-515f23e/gas/listing.c"
                , "\n");

  got_some = 0;

  for (ptr = symbol_rootP; ptr != (symbolS *) 
# 980 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                             ((void *)0)
# 980 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                 ; ptr = symbol_next (ptr))
    {
      if (S_GET_NAME (ptr) && strlen (S_GET_NAME (ptr)) != 0)
 {
   if (S_GET_SEGMENT (ptr) == (&_bfd_std_section[1]))
     {
       if (!got_some)
  {
    got_some = 1;
    ...
    emit_line (
# 990 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
              ((void *)0)
# 990 "/doner/binutils/binutils-515f23e/gas/listing.c"
                  , "UNDEFINED SYMBOLS\n");
  }

       emit_line (
# 993 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                 ((void *)0)
# 993 "/doner/binutils/binutils-515f23e/gas/listing.c"
                     , "%s\n", S_GET_NAME (ptr));
     }
 }
    }
  ...
  if (!got_some)
    emit_line (
# 999 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
              ((void *)0)
# 999 "/doner/binutils/binutils-515f23e/gas/listing.c"
       ...
       unsigned int width)
{
  ...
  static cached_line cached_lines[3];
  static int next_free_line = 0;
  cached_line * cache = 
# 1017 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                       ((void *)0)
# 1017 "/doner/binutils/binutils-515f23e/gas/listing.c"
                           ;

  if (current_file->linenum > list->hll_line
      && list->hll_line > 0)
    {
# 1038 "/doner/binutils/binutils-515f23e/gas/listing.c"
      int i;
...
debugging_pseudo (list_info_type *list, const char *line)
{
  ...
  while ((_sch_istable[(*line) & 0xff] & (unsigned short)(_sch_isspace)))
    line++;
  ...
  if (*line != '.')
   ...
   && *line == '\0'
   && list->next != 
# 1134 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                   ((void *)0)
   
# 1135 "/doner/binutils/binutils-515f23e/gas/listing.c"
  && list->next->debugging)
 {
   in_debug = 1;
   return 1;
...
static void
listing_listing (char *name __attribute__ ((__unused__)))
{
  list_info_type *list = head;
  file_info_type *current_hll_file = (file_info_type *) 
# 1179 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                                       ((void *)0)
# 1179 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                           ;
  char *buffer;
  const char *p;
  int show_listing = 1;
  ...
  buffer = ((char *) xmalloc (sizeof (char) * (listing_rhs_width)));
  data_buffer = ((char *) xmalloc (sizeof (char) * ((((4 * 2) + 1) * listing_lhs_width + ((((4 * 2) + 1) * listing_lhs_width_second) * listing_lhs_cont_lines) + 20))));
  eject = 1;
  list = head->next;
 ...
 case EDICT_SBTTL:
   ...
   break;
 default:
   as_abort ("/doner/binutils/binutils-515f23e/gas/listing.c", 1222, __PRETTY_FUNCTION__);
 }
      ...
      if (show_listing > 0)
 {
   ...
   if (current_hll_file && list->hll_line && (listing & 8))
  ...
  print_lines (list, list->line, list->line_contents,
       ...
       list->line_contents = 
# 1278 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                            ((void *)0)
# 1278 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                ;
     }
 ...
 --show_listing;
  ...
  free (data_buffer);
  data_buffer = 
# 1293 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
               ((void *)0)
# 1293 "/doner/binutils/binutils-515f23e/gas/listing.c"
                   ;
}
...
# 1301 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                          ((void *)0)
# 1301 "/doner/binutils/binutils-515f23e/gas/listing.c"
                              );
  struct tm * timestamp;
  char stampstr[30];
  ...
  strftime (stampstr, 30, "%Y-%m-%dT%H:%M:%S.000%z", timestamp);
  fprintf (list_file, gettext ("\n time stamp    \t: %s\n\n"), stampstr);
}
...
print_single_option (char * opt, int *pos)
{
  int opt_len = strlen (opt);
   ...
   if ((*pos + opt_len) < paper_width)
     {
        fprintf (list_file, gettext ("%s "), opt);
        *pos = *pos + opt_len;
     }
   else
     {
...
{
  const char *field_name = gettext ("\n options passed\t: ");
  int pos = strlen (field_name);
  char **p;

  fputs (field_name, list_file);
  for (p = &argv[1]; *p != 
# 1338 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                          ((void *)0)
# 1338 "/doner/binutils/binutils-515f23e/gas/listing.c"
                              ; p++)
    if (**p == '-')
      {
        ...
        if (strcmp (*p, "-o") == 0)
          {
            if (p[1] != 
# 1344 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                       ((void *)0)
# 1344 "/doner/binutils/binutils-515f23e/gas/listing.c"
                           )
              p++;
            continue;
          }
...
# 1364 "/doner/binutils/binutils-515f23e/gas/listing.c"
static void
listing_general_info (char ** argv)
{
  ...
  eject = 1;
  listing_page (
# 1369 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
               ((void *)0)
# 1369 "/doner/binutils/binutils-515f23e/gas/listing.c"
                   );

  fprintf (list_file,
           gettext (" GNU assembler version %s (%s)\n\t using BFD version %s."),
           "2.41.50", "x86_64-pc-linux-gnu", "(GNU Binutils) " "2.41.50.20230725");
  print_options (argv);
  fprintf (list_file, gettext ("\n input file    \t: %s"), fn);
  fprintf (list_file, gettext ("\n output file   \t: %s"), out_file_name);
  fprintf (list_file, gettext ("\n target        \t: %s"), "x86_64-pc-linux-gnu");
  print_timestamp ();
}
...
listing_print (char *name, char **argv)
{
  ...
  if (name == 
# 1389 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
             ((void *)0)
# 1389 "/doner/binutils/binutils-515f23e/gas/listing.c"
                 )
    {
      list_file = 
# 1391 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                 stdout
# 1391 "/doner/binutils/binutils-515f23e/gas/listing.c"
                       ;
      using_stdout = 1;
    }
  else
    {
      ...
      if (list_file != 
# 1397 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                      ((void *)0)
# 1397 "/doner/binutils/binutils-515f23e/gas/listing.c"
                          )
 using_stdout = 0;
      else
 {
   as_warn (gettext ("can't open %s: %s"), name, xstrerror (
# 1401 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                                    (*__errno_location ())
# 1401 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                         ));
   list_file = 
# 1402 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
              stdout
# 1402 "/doner/binutils/binutils-515f23e/gas/listing.c"
                    ;
   using_stdout = 1;
 }
    }
  ...
  if (! using_stdout)
    {
      if (fclose (list_file) == 
# 1421 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                               (-1)
# 1421 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                  )
 as_warn (gettext ("can't close %s: %s"), name, xstrerror (
# 1422 "/doner/binutils/binutils-515f23e/gas/listing.c" 3 4
                                                   (*__errno_location ())
# 1422 "/doner/binutils/binutils-515f23e/gas/listing.c"
                                                        ));
    }
...
void
listing_eject (int ignore __attribute__ ((__unused__)))
{
  if (listing)
...
listing_list (int on)
{
 ...
 case 2:
   ...
   break;
 default:
   as_abort ("/doner/binutils/binutils-515f23e/gas/listing.c", 1471, __PRETTY_FUNCTION__);
 }
    }
}
...
listing_psize (int width_only)
{
 ...
 {
   paper_height = 0;
   as_warn (gettext ("strange paper height, set to no form"));
 }
 ...
 if (new_width > 7)
   ...
   as_bad (gettext ("new paper width is too small"));
      }
    else if (exp.X_op != O_absent)
      as_bad (gettext ("bad or irreducible expression for paper width"));
    else
      as_bad (gettext ("missing expression for paper width"));
  }
...
void
listing_nopage (int ignore __attribute__ ((__unused__)))
{
  paper_height = 0;
}
...
listing_title (int depth)
{
 ...
 {
   as_bad (gettext ("new line in title"));
   demand_empty_rest_of_line ();
   return;
 }
      else
