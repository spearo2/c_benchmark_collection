# 1 "/doner/binutils/binutils-515f23e/gas/sb.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/sb.c"
# 24 "/doner/binutils/binutils-515f23e/gas/sb.c"
...
# 25 "/doner/binutils/binutils-515f23e/gas/sb.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/sb.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 28 "/doner/binutils/binutils-515f23e/gas/sb.c" 2
# 53 "/doner/binutils/binutils-515f23e/gas/sb.c"
...
{
  ptr->ptr = ((char *) xmalloc (sizeof (char) * (size + 1)));
  ptr->max = size;
  ptr->len = 0;
}
...
sb_new (sb *ptr)
{
  sb_build (ptr, (64 - (2 * sizeof (size_t)) - 1));
}
  ...
  if (want > ptr->max)
    {
      ...
      want += (2 * sizeof (size_t)) + 1;
      if ((ssize_t) want < 0)
 as_fatal ("string buffer overflow");

      max = (size_t) 1 << (8 * sizeof (want)
      ...
      ptr->max = max;
      ptr->ptr = ((char *) xrealloc ((void *) (ptr->ptr), sizeof (char) * (max + 1)));
    }
}
