# 1 "/doner/binutils/binutils-515f23e/gas/frags.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/frags.c"
# 21 "/doner/binutils/binutils-515f23e/gas/frags.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/frags.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/frags.c" 2
...
frag_alloc_check (const struct obstack *ob)
{
  if (ob->chunk_size == 0)
    {
      as_bad (gettext ("attempt to allocate data in absolute section"));
      subseg_set (text_section, 0);
    }

  if (mri_common_symbol != 
# 64 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                          ((void *)0)
# 64 "/doner/binutils/binutils-515f23e/gas/frags.c"
                              )
    {
      as_bad (gettext ("attempt to allocate data in common section"));
      mri_common_symbol = 
# 67 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                         ((void *)0)
# 67 "/doner/binutils/binutils-515f23e/gas/frags.c"
                             ;
    }
}
...
{
  if (__extension__ ({ struct obstack const *__o1 = (&frchain_now->frch_obstack); (size_t) (__o1->chunk_limit - __o1->next_free); }) < nchars)
    {
      size_t oldc;
      size_t newc;
      ...
      if (nchars < 0x10000)
        ...
        newc = nchars + 0x10000;
      newc += ((char *) zero_address_frag.fr_literal - (char *) &zero_address_frag);
 ...
 as_fatal (ngettext ("can't extend frag %lu char",
    ...
    (unsigned long) nchars);
      ...
      if (newc > oldc)
 ((&frchain_now->frch_obstack)->chunk_size) = newc;

      while (__extension__ ({ struct obstack const *__o1 = (&frchain_now->frch_obstack); (size_t) (__o1->chunk_limit - __o1->next_free); }) < nchars)
        {
...
# 157 "/doner/binutils/binutils-515f23e/gas/frags.c"
void
                                       ...
                                       )
{
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 165, __PRETTY_FUNCTION__), 0)));


  frag_now->fr_fix = frag_now_fix_octets ();
  ((void) ((frag_now->fr_fix >= old_frags_var_max_size || now_seg == (&_bfd_std_section[2])) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 169, __PRETTY_FUNCTION__), 0)))
                                      ;
  frag_now->fr_fix -= old_frags_var_max_size;

  ((void) ((frag_now->fr_type != 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 173, __PRETTY_FUNCTION__), 0)));



  __extension__ ({ struct obstack *__o1 = (&frchain_now->frch_obstack); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = (sizeof (ptrdiff_t) < sizeof (void *) ? ((__o1->object_base) + (((__o1->next_free) - (__o1->object_base) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))) : (char *) (((ptrdiff_t) (__o1->next_free) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; });
  frchP = frchain_now;
  ((void) ((frchP) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 179, __PRETTY_FUNCTION__), 0)));
  former_last_fragP = frchP->frch_last;
  ((void) ((former_last_fragP != 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 181, __PRETTY_FUNCTION__), 0)));
  ((void) ((former_last_fragP == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 182, __PRETTY_FUNCTION__), 0)));
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/frags.c", 201, __PRETTY_FUNCTION__), 0)));

  frag_now->fr_next = 
# 203 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                     ((void *)0)
# 203 "/doner/binutils/binutils-515f23e/gas/frags.c"
                         ;
}
...
frag_more (size_t nchars)
{
  ...
  frag_grow (nchars);
  retval = ((void *) (&frchain_now->frch_obstack)->next_free);
  ((void) ((&frchain_now->frch_obstack)->next_free += (nchars)));
  return retval;
}
               ...
               char *opcode)
{
  ...
  do { (frag_now)->tc_frag_data.u.padding_fragP = 
# 244 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
 ((void *)0)
# 244 "/doner/binutils/binutils-515f23e/gas/frags.c"
 ; (frag_now)->tc_frag_data.padding_address = 0; (frag_now)->tc_frag_data.isa = cpu_arch_isa; (frag_now)->tc_frag_data.isa_flags = cpu_arch_isa_flags; (frag_now)->tc_frag_data.tune = cpu_arch_tune; (frag_now)->tc_frag_data.max_bytes = (max_chars); (frag_now)->tc_frag_data.length = 0; (frag_now)->tc_frag_data.last_length = 0; (frag_now)->tc_frag_data.max_prefix_length = 0; (frag_now)->tc_frag_data.prefix_length = 0; (frag_now)->tc_frag_data.default_prefix = 0; (frag_now)->tc_frag_data.cmp_size = 0; (frag_now)->tc_frag_data.classified = 0; (frag_now)->tc_frag_data.branch_type = 0; (frag_now)->tc_frag_data.mf_type = 0; } while (0);

  frag_now->fr_file = as_where (&frag_now->fr_line);

  frag_new (max_chars);
}
# 258 "/doner/binutils/binutils-515f23e/gas/frags.c"
char *
   ...
   char *opcode)
{
  ...
  frag_grow (max_chars);
  retval = ((void *) (&frchain_now->frch_obstack)->next_free);
  ((void) ((&frchain_now->frch_obstack)->next_free += (max_chars)));
...
frag_room (void)
{
  return __extension__ ({ struct obstack const *__o1 = (&frchain_now->frch_obstack); (size_t) (__o1->chunk_limit - __o1->next_free); });
}
# 314 "/doner/binutils/binutils-515f23e/gas/frags.c"
void
...
# 344 "/doner/binutils/binutils-515f23e/gas/frags.c"
void
...
# 375 "/doner/binutils/binutils-515f23e/gas/frags.c"
void
frag_align_code (int alignment, int max)
{
  char *p;

  p = frag_var (rs_align_code, (alignment ? ((size_t) 1 << alignment) - 1 : (size_t) 1), 1,
...
frag_now_fix_octets (void)
{
  ...
  return ((char *) ((void *) (&frchain_now->frch_obstack)->next_free)
   - frag_now->fr_literal);
}
...
frag_now_fix (void)
{
  ...
  if (now_seg->flags & (1 ? 0x40000000 : 0))
    return frag_now_fix_octets ();
  else
    return frag_now_fix_octets () / (1<<0);
}
...
{
  frag_alloc_check (&frchain_now->frch_obstack);
  if (__extension__ ({ struct obstack const *__o1 = (&frchain_now->frch_obstack); (size_t) (__o1->chunk_limit - __o1->next_free); }) <= 1)
    {
      frag_wane (frag_now);
      frag_new (0);
    }
  __extension__ ({ struct obstack *__o = (&frchain_now->frch_obstack); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < 1) _obstack_newchunk (__o, 1); ((void) (*((__o)->next_free)++ = (datum))); });
}
...
# 423 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
_Bool

# 424 "/doner/binutils/binutils-515f23e/gas/frags.c"
  ...
  if (frag1 == frag2)
    {
      *offset = off;
      return 
# 435 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
            1
# 435 "/doner/binutils/binutils-515f23e/gas/frags.c"
                ;
    }
  ...
  while (frag->fr_type == rs_fill)
    {
      ...
      frag = frag->fr_next;
      if (frag == 
# 444 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                 ((void *)0)
# 444 "/doner/binutils/binutils-515f23e/gas/frags.c"
                     )
 break;
      if (frag == frag2)
 {
   *offset = off;
   return 
# 449 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
         1
# 449 "/doner/binutils/binutils-515f23e/gas/frags.c"
             ;
 }
    }
  ...
  while (frag->fr_type == rs_fill)
    {
      ...
      frag = frag->fr_next;
      if (frag == 
# 460 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                 ((void *)0)
# 460 "/doner/binutils/binutils-515f23e/gas/frags.c"
                     )
 break;
      if (frag == frag1)
 {
   *offset = off;
   return 
# 465 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
         1
# 465 "/doner/binutils/binutils-515f23e/gas/frags.c"
             ;
 }
    }

  return 
# 469 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
        0
# 469 "/doner/binutils/binutils-515f23e/gas/frags.c"
             ;
}
...
# 477 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
_Bool

# 478 "/doner/binutils/binutils-515f23e/gas/frags.c"
  ...
  if (frag1 == frag2)
    {
      *offset = off;
      return 
# 490 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
            1
# 490 "/doner/binutils/binutils-515f23e/gas/frags.c"
                ;
    }
 ...
 off += frag->fr_fix + frag->fr_offset * frag->fr_var;
      frag = frag->fr_next;
      if (frag == 
# 502 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                 ((void *)0)
# 502 "/doner/binutils/binutils-515f23e/gas/frags.c"
                     )
 break;
      if (frag == frag2)
 {
   *offset = off;
   return 
# 507 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
         1
# 507 "/doner/binutils/binutils-515f23e/gas/frags.c"
             ;
 }
    }

  return 
# 511 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
        0
# 511 "/doner/binutils/binutils-515f23e/gas/frags.c"
             ;
}
# 529 "/doner/binutils/binutils-515f23e/gas/frags.c"

# 529 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
_Bool

# 530 "/doner/binutils/binutils-515f23e/gas/frags.c"
   ...
   valueT off1, const fragS *frag1, offsetT *offset)
{
  ...
  if (frag2 == frag1 || off1 > frag1->fr_fix)
    return 
# 535 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
          0
# 535 "/doner/binutils/binutils-515f23e/gas/frags.c"
               ;
# 546 "/doner/binutils/binutils-515f23e/gas/frags.c"
      ...
      if (frag == frag2)
 {
   if (delta == 0)
     return 
# 555 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
           0
# 555 "/doner/binutils/binutils-515f23e/gas/frags.c"
                ;
   break;
 }
      ...
      if (frag == 
# 561 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
                 ((void *)0)
# 561 "/doner/binutils/binutils-515f23e/gas/frags.c"
                     )
 return 
# 562 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
       0
# 562 "/doner/binutils/binutils-515f23e/gas/frags.c"
            ;
    }

  *offset = (off2 - off1 - delta) * (1<<0);
  return 
# 566 "/doner/binutils/binutils-515f23e/gas/frags.c" 3 4
        1
# 566 "/doner/binutils/binutils-515f23e/gas/frags.c"
            ;
}
