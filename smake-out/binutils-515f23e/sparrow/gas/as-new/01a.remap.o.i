# 1 "/doner/binutils/binutils-515f23e/gas/remap.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/remap.c"
# 21 "/doner/binutils/binutils-515f23e/gas/remap.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/remap.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/remap.c" 2
...
add_debug_prefix_map (const char *arg)
{
  ...
  if (!p)
    {
      as_fatal (gettext ("invalid argument '%s' to -fdebug-prefix-map"), arg);
      return;
    }
  map = ((debug_prefix_map *) xmalloc (sizeof (debug_prefix_map)));
  o = xstrdup (arg);
  map->old_prefix = o;
  map->old_len = p - arg;
  o[map->old_len] = 0;
...
remap_debug_filename (const char *filename)
{
 ...
 return concat (map->new_prefix, name, 
# 81 "/doner/binutils/binutils-515f23e/gas/remap.c" 3 4
                                      ((void *)0)
# 81 "/doner/binutils/binutils-515f23e/gas/remap.c"
                                          );
      }
