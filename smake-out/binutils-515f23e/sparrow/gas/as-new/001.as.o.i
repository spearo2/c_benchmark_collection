# 1 "/doner/binutils/binutils-515f23e/gas/as.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/as.c"
# 38 "/doner/binutils/binutils-515f23e/gas/as.c"
...
extern const struct format_ops aout_format_ops;
 ...
 const struct format_ops *this_format;
...
# 39 "/doner/binutils/binutils-515f23e/gas/as.c" 2
...
# 40 "/doner/binutils/binutils-515f23e/gas/as.c" 2
...
# 41 "/doner/binutils/binutils-515f23e/gas/as.c" 2
...
# 42 "/doner/binutils/binutils-515f23e/gas/as.c" 2
...
# 43 "/doner/binutils/binutils-515f23e/gas/as.c" 2
# 1 "/doner/binutils/binutils-515f23e/gas/dwarf2dbg.h" 1
# 44 "/doner/binutils/binutils-515f23e/gas/as.c" 2
...
# 45 "/doner/binutils/binutils-515f23e/gas/as.c" 2
...
# 46 "/doner/binutils/binutils-515f23e/gas/as.c" 2
# 1 "../bfd/bfdver.h" 1
# 47 "/doner/binutils/binutils-515f23e/gas/as.c" 2
# 62 "/doner/binutils/binutils-515f23e/gas/as.c"
struct defsym_list
{
...
# 80 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                                                 ((void *)0)
# 80 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                                                         ;
...
int flag_use_elf_stt_common = 0;

# 112 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
_Bool 
# 112 "/doner/binutils/binutils-515f23e/gas/as.c"
    flag_generate_build_notes = 0;
...
# 122 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                               ((void *)0)
# 122 "/doner/binutils/binutils-515f23e/gas/as.c"
                                   ;

static struct defsym_list *defsyms;

static long start_time;
# 213 "/doner/binutils/binutils-515f23e/gas/as.c"
void
print_version_id (void)
{
  ...
  fprintf (
# 222 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
          stderr
# 222 "/doner/binutils/binutils-515f23e/gas/as.c"
                , gettext ("GNU assembler version %s (%s) using BFD version %s\n"),
    "2.41.50", "x86_64-pc-linux-gnu", "(GNU Binutils) " "2.41.50.20230725");
}
...
{
  fprintf (stream, gettext ("Usage: %s [option...] [asmfile...]\n"), myname);

  fprintf (stream, gettext ("Options:\n  -a[sub-option...]	  turn on listings\n                      	  Sub-options [default hls]:\n                      	  c      omit false conditionals\n                      	  d      omit debugging directives\n                      	  g      include general info\n                      	  h      include high-level source\n                      	  l      include assembly\n                      	  m      include macro expansions\n                      	  n      omit forms processing\n                      	  s      include symbols\n                      	  =FILE  list to FILE (must be last sub-option)\n")
# 252 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                                          );

  fprintf (stream, gettext ("  --alternate             initially turn on alternate macro syntax\n")
                                                                      );
  fprintf (stream, gettext ("  --compress-debug-sections[={none|zlib|zlib-gnu|zlib-gabi|zstd}]\n                          compress DWARF debug sections\n")

                                                           ),
  fprintf (stream, gettext ("		            Default: %s\n")
                             ,
    bfd_get_compression_algorithm_name
             (COMPRESS_DEBUG_GABI_ZLIB));

  fprintf (stream, gettext ("  --nocompress-debug-sections\n                          don't compress DWARF debug sections\n")

                                                                 );
  fprintf (stream, gettext ("  -D                      produce assembler debugging messages\n")
                                                                  );
  fprintf (stream, gettext ("  --dump-config           display how the assembler is configured and then exit\n")
                                                                                   );
  fprintf (stream, gettext ("  --debug-prefix-map OLD=NEW\n                          map OLD to NEW in debug information\n")

                                                                 );
  fprintf (stream, gettext ("  --defsym SYM=VAL        define symbol SYM to given value\n")
                                                              );
# 295 "/doner/binutils/binutils-515f23e/gas/as.c"
  fprintf (stream, gettext ("  --execstack             require executable stack for this object\n")
                                                                      );
  fprintf (stream, gettext ("  --noexecstack           don't require executable stack for this object\n")
                                                                            );
  fprintf (stream, gettext ("  --size-check=[error|warning]\n			  ELF .size directive check (default --size-check=error)\n")

                                                               );
  fprintf (stream, gettext ("  --elf-stt-common=[no|yes] ")
                              );
  if (0)
    fprintf (stream, gettext ("(default: yes)\n"));
  else
    fprintf (stream, gettext ("(default: no)\n"));
  fprintf (stream, gettext ("                          generate ELF common symbols with STT_COMMON type\n")
                                                                              );
  fprintf (stream, gettext ("  --sectname-subst        enable section name substitution sequences\n")
                                                                        );

  fprintf (stream, gettext ("  --generate-missing-build-notes=[no|yes] ")
                                            );
  ...
  fprintf (stream, gettext ("                          generate GNU Build notes if none are present in the input\n")
                                                                                       );
  fprintf (stream, gettext ("  --gsframe               generate SFrame stack trace information\n")
                                                                     );


  fprintf (stream, gettext ("  -f                      skip whitespace and comment preprocessing\n")
                                                                       );
  fprintf (stream, gettext ("  -g --gen-debug          generate debugging information\n")
                                                            );
  fprintf (stream, gettext ("  --gstabs                generate STABS debugging information\n")
                                                                  );
  fprintf (stream, gettext ("  --gstabs+               generate STABS debug info with GNU extensions\n")
                                                                           );
  fprintf (stream, gettext ("  --gdwarf-<N>            generate DWARF<N> debugging information. 2 <= <N> <= 5\n")
                                                                                    );
  fprintf (stream, gettext ("  --gdwarf-cie-version=<N> generate version 1, 3 or 4 DWARF CIEs\n")
                                                                    );
  fprintf (stream, gettext ("  --gdwarf-sections       generate per-function section names for DWARF line information\n")
                                                                                            );




  fprintf (stream, gettext ("  --hash-size=<N>         ignored\n")
                                     );
  fprintf (stream, gettext ("  --help                  show all assembler options\n")
                                                        );
  fprintf (stream, gettext ("  --target-help           show target specific options\n")
                                                          );
  fprintf (stream, gettext ("  -I DIR                  add DIR to search list for .include directives\n")
                                                                            );
  fprintf (stream, gettext ("  -J                      don't warn about signed overflow\n")
                                                              );
  fprintf (stream, gettext ("  -K                      warn when differences altered for long displacements\n")
                                                                                  );
  fprintf (stream, gettext ("  -L,--keep-locals        keep local symbols (e.g. starting with `L')\n")
                                                                         );
  fprintf (stream, gettext ("  -M,--mri                assemble in MRI compatibility mode\n")
                                                                );
  fprintf (stream, gettext ("  --MD FILE               write dependency information in FILE (default none)\n")
                                                                                 );
  fprintf (stream, gettext ("  --multibyte-handling=<method>\n                          what to do with multibyte characters encountered in the input\n")

                                                                                           );
  fprintf (stream, gettext ("  -nocpp                  ignored\n")
                                     );
  fprintf (stream, gettext ("  -no-pad-sections        do not pad the end of sections to alignment boundaries\n")
                                                                                    );
  fprintf (stream, gettext ("  -o OBJFILE              name the object-file output OBJFILE (default a.out)\n")
                                                                                 );
  fprintf (stream, gettext ("  -R                      fold data section into text section\n")
                                                                 );
  fprintf (stream, gettext ("  --reduce-memory-overheads ignored\n")
                                       );
  fprintf (stream, gettext ("  --statistics            print various measured statistics from execution\n")
                                                                              );
  fprintf (stream, gettext ("  --strip-local-absolute  strip local absolute symbols\n")
                                                          );
  fprintf (stream, gettext ("  --traditional-format    Use same format as native assembler when possible\n")
                                                                               );
  fprintf (stream, gettext ("  --version               print assembler version number and exit\n")
                                                                     );
  fprintf (stream, gettext ("  -W  --no-warn           suppress warnings\n")
                                               );
  fprintf (stream, gettext ("  --warn                  don't suppress warnings\n")
                                                     );
  fprintf (stream, gettext ("  --fatal-warnings        treat warnings as errors\n")
                                                      );
  ...
  fprintf (stream, gettext ("  -w                      ignored\n")
                                     );
  fprintf (stream, gettext ("  -X                      ignored\n")
                                     );
  fprintf (stream, gettext ("  -Z                      generate object file even after errors\n")
                                                                    );
  fprintf (stream, gettext ("  --listing-lhs-width     set the width in words of the output data column of\n                          the listing\n")

                                         );
  fprintf (stream, gettext ("  --listing-lhs-width2    set the width in words of the continuation lines\n                          of the output data column; ignored if smaller than\n                          the width of the first line\n")


                                                         );
  fprintf (stream, gettext ("  --listing-rhs-width     set the max width in characters of the lines from\n                          the source file\n")

                                             );
  fprintf (stream, gettext ("  --listing-cont-lines    set the maximum number of continuation lines used\n                          for the output data column of the listing\n")
...
# 420 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                    stdout
# 420 "/doner/binutils/binutils-515f23e/gas/as.c"
                                          )
    fprintf (stream, gettext ("Report bugs to %s\n"), "<https://sourceware.org/bugzilla/>");
}
# 433 "/doner/binutils/binutils-515f23e/gas/as.c"
static void
parse_args (int * pargc, char *** pargv)
{
  ...
  static const struct option std_longopts[] =
  {
    ...
    {"alternate", 0, 
# 524 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 524 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_ALTERNATE}
    ...
    ,{"a", 2, 
# 529 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 529 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , 'a'}

    ,{"al", 2, 
# 531 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 531 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_AL}
    ,{"compress-debug-sections", 2, 
# 532 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                                   ((void *)0)
# 532 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                       , OPTION_COMPRESS_DEBUG}
    ,{"nocompress-debug-sections", 0, 
# 533 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                               ((void *)0)
# 533 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                   , OPTION_NOCOMPRESS_DEBUG}
    ,{"debug-prefix-map", 1, 
# 534 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                            ((void *)0)
# 534 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                , OPTION_DEBUG_PREFIX_MAP}
    ,{"defsym", 1, 
# 535 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                  ((void *)0)
# 535 "/doner/binutils/binutils-515f23e/gas/as.c"
                                      , OPTION_DEFSYM}
    ,{"dump-config", 0, 
# 536 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                 ((void *)0)
# 536 "/doner/binutils/binutils-515f23e/gas/as.c"
                                     , OPTION_DUMPCONFIG}
    ,{"emulation", 1, 
# 537 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                     ((void *)0)
# 537 "/doner/binutils/binutils-515f23e/gas/as.c"
                                         , OPTION_EMULATION}

    ,{"execstack", 0, 
# 539 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                               ((void *)0)
# 539 "/doner/binutils/binutils-515f23e/gas/as.c"
                                   , OPTION_EXECSTACK}
    ,{"noexecstack", 0, 
# 540 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                 ((void *)0)
# 540 "/doner/binutils/binutils-515f23e/gas/as.c"
                                     , OPTION_NOEXECSTACK}
    ,{"size-check", 1, 
# 541 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                      ((void *)0)
# 541 "/doner/binutils/binutils-515f23e/gas/as.c"
                                          , OPTION_SIZE_CHECK}
    ,{"elf-stt-common", 1, 
# 542 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                          ((void *)0)
# 542 "/doner/binutils/binutils-515f23e/gas/as.c"
                                              , OPTION_ELF_STT_COMMON}
    ,{"sectname-subst", 0, 
# 543 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                    ((void *)0)
# 543 "/doner/binutils/binutils-515f23e/gas/as.c"
                                        , OPTION_SECTNAME_SUBST}
    ,{"generate-missing-build-notes", 1, 
# 544 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                                        ((void *)0)
# 544 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                            , OPTION_ELF_BUILD_NOTES}
    ,{"gsframe", 0, 
# 545 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 545 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , OPTION_SFRAME}

    ,{"fatal-warnings", 0, 
# 547 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                    ((void *)0)
# 547 "/doner/binutils/binutils-515f23e/gas/as.c"
                                        , OPTION_WARN_FATAL}
    ,{"gdwarf-2", 0, 
# 548 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 548 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_GDWARF_2}
    ,{"gdwarf-3", 0, 
# 549 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 549 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_GDWARF_3}
    ,{"gdwarf-4", 0, 
# 550 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 550 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_GDWARF_4}
    ,{"gdwarf-5", 0, 
# 551 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 551 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_GDWARF_5}


    ,{"gdwarf2", 0, 
# 554 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 554 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , OPTION_GDWARF_2}
    ,{"gdwarf-sections", 0, 
# 555 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                     ((void *)0)
# 555 "/doner/binutils/binutils-515f23e/gas/as.c"
                                         , OPTION_GDWARF_SECTIONS}
    ,{"gdwarf-cie-version", 1, 
# 556 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                              ((void *)0)
# 556 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                  , OPTION_GDWARF_CIE_VERSION}



    ,{"gen-debug", 0, 
# 560 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                               ((void *)0)
# 560 "/doner/binutils/binutils-515f23e/gas/as.c"
                                   , 'g'}
    ,{"gstabs", 0, 
# 561 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                            ((void *)0)
# 561 "/doner/binutils/binutils-515f23e/gas/as.c"
                                , OPTION_GSTABS}
    ,{"gstabs+", 0, 
# 562 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 562 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , OPTION_GSTABS_PLUS}
    ,{"hash-size", 1, 
# 563 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                     ((void *)0)
# 563 "/doner/binutils/binutils-515f23e/gas/as.c"
                                         , OPTION_HASH_TABLE_SIZE}
    ,{"help", 0, 
# 564 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                          ((void *)0)
# 564 "/doner/binutils/binutils-515f23e/gas/as.c"
                              , OPTION_HELP}
# 577 "/doner/binutils/binutils-515f23e/gas/as.c"
    ,{"keep-locals", 0, 
# 577 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                 ((void *)0)
# 577 "/doner/binutils/binutils-515f23e/gas/as.c"
                                     , 'L'}
    ,{"keep-locals", 0, 
# 578 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                 ((void *)0)
# 578 "/doner/binutils/binutils-515f23e/gas/as.c"
                                     , 'L'}
    ,{"listing-lhs-width", 1, 
# 579 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                             ((void *)0)
# 579 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                 , OPTION_LISTING_LHS_WIDTH}
    ,{"listing-lhs-width2", 1, 
# 580 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                              ((void *)0)
# 580 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                  , OPTION_LISTING_LHS_WIDTH2}
    ,{"listing-rhs-width", 1, 
# 581 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                             ((void *)0)
# 581 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                 , OPTION_LISTING_RHS_WIDTH}
    ,{"listing-cont-lines", 1, 
# 582 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                              ((void *)0)
# 582 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                  , OPTION_LISTING_CONT_LINES}
    ,{"MD", 1, 
# 583 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                              ((void *)0)
# 583 "/doner/binutils/binutils-515f23e/gas/as.c"
                                  , OPTION_DEPFILE}
    ,{"mri", 0, 
# 584 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                         ((void *)0)
# 584 "/doner/binutils/binutils-515f23e/gas/as.c"
                             , 'M'}
    ,{"nocpp", 0, 
# 585 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                           ((void *)0)
# 585 "/doner/binutils/binutils-515f23e/gas/as.c"
                               , OPTION_NOCPP}
    ,{"no-pad-sections", 0, 
# 586 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                     ((void *)0)
# 586 "/doner/binutils/binutils-515f23e/gas/as.c"
                                         , OPTION_NO_PAD_SECTIONS}
    ,{"no-warn", 0, 
# 587 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 587 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , 'W'}
    ,{"reduce-memory-overheads", 0, 
# 588 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                             ((void *)0)
# 588 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                 , OPTION_REDUCE_MEMORY_OVERHEADS}
    ,{"statistics", 0, 
# 589 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                ((void *)0)
# 589 "/doner/binutils/binutils-515f23e/gas/as.c"
                                    , OPTION_STATISTICS}
    ,{"strip-local-absolute", 0, 
# 590 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                          ((void *)0)
# 590 "/doner/binutils/binutils-515f23e/gas/as.c"
                                              , OPTION_STRIP_LOCAL_ABSOLUTE}
    ,{"version", 0, 
# 591 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 591 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , OPTION_VERSION}
    ,{"verbose", 0, 
# 592 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                             ((void *)0)
# 592 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 , OPTION_VERBOSE}
    ,{"target-help", 0, 
# 593 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                 ((void *)0)
# 593 "/doner/binutils/binutils-515f23e/gas/as.c"
                                     , OPTION_TARGET_HELP}
    ,{"traditional-format", 0, 
# 594 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                        ((void *)0)
# 594 "/doner/binutils/binutils-515f23e/gas/as.c"
                                            , OPTION_TRADITIONAL_FORMAT}
    ,{"warn", 0, 
# 595 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                          ((void *)0)
# 595 "/doner/binutils/binutils-515f23e/gas/as.c"
                              , OPTION_WARN}
    ,{"multibyte-handling", 1, 
# 596 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                              ((void *)0)
# 596 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                  , OPTION_MULTIBYTE_HANDLING}
  };
  ...
  shortopts = concat (std_shortopts, md_shortopts, (char *) 
# 602 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                                           ((void *)0)
# 602 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                               );
  ...
  new_argc = 1;
  new_argv[new_argc] = 
# 618 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                      ((void *)0)
# 618 "/doner/binutils/binutils-515f23e/gas/as.c"
                          ;
 ...
 default:
   ...
   if (optc == 'v')
     {
# 651 "/doner/binutils/binutils-515f23e/gas/as.c"
       case 'v':
  ...
  verbose = 1;
     ...
     as_bad (gettext ("unrecognized option -%c%s"), optc, optarg ? optarg : "");


 case '?':
   exit (
# 663 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
        1
# 663 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );
 ...
 case 1:
   ...
   new_argv[new_argc] = 
# 669 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                       ((void *)0)
# 669 "/doner/binutils/binutils-515f23e/gas/as.c"
                           ;
   break;

 case OPTION_TARGET_HELP:
   md_show_usage (
# 673 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                 stdout
# 673 "/doner/binutils/binutils-515f23e/gas/as.c"
                       );
   exit (
# 674 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
        0
# 674 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );

 case OPTION_HELP:
   show_usage (
# 677 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
              stdout
# 677 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );
   exit (
# 678 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
        0
# 678 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );
 ...
 case OPTION_MULTIBYTE_HANDLING:
   if (strcmp (optarg, "allow") == 0)
     ...
     as_fatal (gettext ("unexpected argument to --multibyte-input-option: '%s'"), optarg);
   break;

 case OPTION_VERSION:

   printf (gettext ("GNU assembler %s\n"), "(GNU Binutils) " "2.41.50.20230725");
   printf (gettext ("Copyright (C) 2023 Free Software Foundation, Inc.\n"));
   ...
   printf (gettext ("This assembler was configured for a target of `%s'.\n"),
    "x86_64-pc-linux-gnu");

   exit (
# 728 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
        0
# 728 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );
 ...
 case OPTION_EMULATION:
   ...
   as_fatal (gettext ("emulations not handled in this configuration"));

   break;

 case OPTION_DUMPCONFIG:
   fprintf (
# 740 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
           stderr
# 740 "/doner/binutils/binutils-515f23e/gas/as.c"
                 , gettext ("alias = %s\n"), "x86_64-pc-linux-gnu");
   fprintf (
# 741 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
           stderr
# 741 "/doner/binutils/binutils-515f23e/gas/as.c"
                 , gettext ("canonical = %s\n"), "x86_64-pc-linux-gnu");
   fprintf (
# 742 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
           stderr
# 742 "/doner/binutils/binutils-515f23e/gas/as.c"
                 , gettext ("cpu-type = %s\n"), "x86_64");
   ...
   fprintf (
# 747 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
           stderr
# 747 "/doner/binutils/binutils-515f23e/gas/as.c"
                 , gettext ("bfd-target = %s\n"), i386_target_format ());

   exit (
# 749 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
        0
# 749 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );
 ...
 case OPTION_COMPRESS_DEBUG:
   if (optarg)
    ...
    as_fatal (gettext ("--compress-debug-sections=zstd: gas is not " "built with zstd support")
                                    );

       if (flag_compress_debug == COMPRESS_UNKNOWN)
  as_fatal (gettext ("Invalid --compress-debug-sections option: `%s'"),
     optarg);
 ...
 case OPTION_DEFSYM:
   {
     ...
     for (s = optarg; *s != '\0' && *s != '='; s++)
       ;
     if (*s == '\0')
       as_fatal (gettext ("bad defsym; format is --defsym name=value"));
     *s++ = '\0';
     i = bfd_scan_vma (s, (const char **) 
# 792 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                         ((void *)0)
# 792 "/doner/binutils/binutils-515f23e/gas/as.c"
                                             , 0);
     n = ((struct defsym_list *) xmalloc (sizeof (struct defsym_list)));
     n->next = defsyms;
     n->name = optarg;
     n->value = i;
     defsyms = n;
   ...
   break;
# 823 "/doner/binutils/binutils-515f23e/gas/as.c"
 case OPTION_DEPFILE:
 ...
 case 'g':
   ...
   if (startswith (old_argv[optind - 1], "-gdwarf"))
     as_fatal (gettext ("unknown DWARF option %s\n"), old_argv[optind - 1]);
   else if (old_argv[optind - 1][1] == 'g' && optarg != 
# 840 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                                       ((void *)0)
# 840 "/doner/binutils/binutils-515f23e/gas/as.c"
                                                           )
     as_fatal (gettext ("unknown option `%s'"), old_argv[optind - 1]);
 ...
 case OPTION_GDWARF_SECTIONS:
   flag_dwarf_sections = 
# 882 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                        1
# 882 "/doner/binutils/binutils-515f23e/gas/as.c"
                            ;
   break;
   ...
   if (flag_dwarf_cie_version < 1
            ...
            as_fatal (gettext ("Invalid --gdwarf-cie-version `%s'"), optarg);
 ...
 case OPTION_SIZE_CHECK:
   if (strcasecmp (optarg, "error") == 0)
     flag_allow_nonconst_size = 
# 987 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                               0
# 987 "/doner/binutils/binutils-515f23e/gas/as.c"
                                    ;
   else if (strcasecmp (optarg, "warning") == 0)
     flag_allow_nonconst_size = 
# 989 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                               1
# 989 "/doner/binutils/binutils-515f23e/gas/as.c"
                                   ;
   else
     as_fatal (gettext ("Invalid --size-check= option: `%s'"), optarg);
   break;
 ...
 case OPTION_ELF_STT_COMMON:
   if (strcasecmp (optarg, "no") == 0)
     ...
     as_fatal (gettext ("Invalid --elf-stt-common= option: `%s'"),
        optarg);
   break;
 ...
 case OPTION_ELF_BUILD_NOTES:
   if (strcasecmp (optarg, "no") == 0)
     flag_generate_build_notes = 
# 1010 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                0
# 1010 "/doner/binutils/binutils-515f23e/gas/as.c"
                                     ;
   else if (strcasecmp (optarg, "yes") == 0)
     flag_generate_build_notes = 
# 1012 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                                1
# 1012 "/doner/binutils/binutils-515f23e/gas/as.c"
                                    ;
   else
     as_fatal (gettext ("Invalid --generate-missing-build-notes option: `%s'"),
        optarg);
   break;
       ...
       while (*optarg)
  {
    switch (*optarg)
      ...
      case '=':
        ...
        break;
      default:
        as_fatal (gettext ("invalid listing option `%c'"), *optarg);
        break;
      }
    optarg++;
  }
...
dump_statistics (void)
{
  ...
  fprintf (
# 1152 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
          stderr
# 1152 "/doner/binutils/binutils-515f23e/gas/as.c"
                , gettext ("%s: total time in assembly: %ld.%06ld\n"),
    myname, run_time / 1000000, run_time % 1000000);

  subsegs_print_statistics (
# 1155 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                           stderr
# 1155 "/doner/binutils/binutils-515f23e/gas/as.c"
                                 );
  write_print_statistics (
# 1156 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                         stderr
# 1156 "/doner/binutils/binutils-515f23e/gas/as.c"
                               );
  symbol_print_statistics (
# 1157 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                          stderr
# 1157 "/doner/binutils/binutils-515f23e/gas/as.c"
                                );
  read_print_statistics (
# 1158 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                        stderr
# 1158 "/doner/binutils/binutils-515f23e/gas/as.c"
                              );


  i386_print_statistics (
# 1161 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                      stderr
# 1161 "/doner/binutils/binutils-515f23e/gas/as.c"
                            );
...
# 1178 "/doner/binutils/binutils-515f23e/gas/as.c"
static void
perform_an_assembly_pass (int argc, char ** argv)
{
  ...
  bfd_set_section_flags (text_section,
    applicable & (0x1 | 0x2 | 0x4
           | 0x10 | 0x8));
  bfd_set_section_flags (data_section,
    applicable & (0x1 | 0x2 | 0x4
           | 0x20));
  bfd_set_section_flags (bss_section, applicable & 0x1);
  ((segment_info_type *) bfd_section_userdata (bss_section))->bss = 1;
...
{
  _obstack_free (&notes, 
# 1247 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                        ((void *)0)
# 1247 "/doner/binutils/binutils-515f23e/gas/as.c"
                            );
}
...
gas_early_init (int *argcp, char ***argvp)
{
  ...
  setlocale (
# 1259 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
            5
# 1259 "/doner/binutils/binutils-515f23e/gas/as.c"
                       , "");

  setlocale (
# 1261 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
            0
# 1261 "/doner/binutils/binutils-515f23e/gas/as.c"
                    , "");
  bindtextdomain ("gas", "/usr/local/share/locale");
  textdomain ("gas");
  ...
  if (bfd_init () != (sizeof (struct bfd_section)))
    as_fatal (gettext ("libbfd ABI mismatch"));
  ...
  init_include_dir ();
# 1296 "/doner/binutils/binutils-515f23e/gas/as.c"
}
...
gas_init (void)
{
  ...
  local_symbol_make (".gasversion.", (&_bfd_std_section[2]),
       &predefined_address_frag, 241500000 / 10000UL);
  ...
  ((void) ((stdoutput != 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/as.c", 1324, __PRETTY_FUNCTION__), 0)));
  ...
  while (defsyms != 
# 1342 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                   ((void *)0)
# 1342 "/doner/binutils/binutils-515f23e/gas/as.c"
                       )
    {
      symbolS *sym;
      struct defsym_list *next;

      sym = symbol_new (defsyms->name, (&_bfd_std_section[2]),
...
main (int argc, char ** argv)
{
      ...
      for (i = 1; i < argc; ++i)
 {
   ...
   if (stat (argv[i], &sib) == 0
       ...
       && 
# 1400 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
         ((((
# 1400 "/doner/binutils/binutils-515f23e/gas/as.c"
         sib.st_mode
# 1400 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
         )) & 0170000) == (0100000))
# 1400 "/doner/binutils/binutils-515f23e/gas/as.c"
                              )
     {
       ...
       out_file_name = 
# 1405 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
                      ((void *)0)
# 1405 "/doner/binutils/binutils-515f23e/gas/as.c"
                          ;
       as_fatal (gettext ("The input '%s' and output '%s' files are the same"),
 ...
 {
   if (n_errs == 0)
     as_bad (gettext ("%s, treating warnings as errors"), warn_msg);
   n_errs += n_warns;
 }
      ...
      else if (flag_always_generate_output)
 {
   ...
   keep_it = 1;
   fprintf (
# 1476 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
           stderr
# 1476 "/doner/binutils/binutils-515f23e/gas/as.c"
                 , gettext ("%s, %s, generating bad object file\n"),
     err_msg, warn_msg);
 }
    }

  fflush (
# 1481 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
         stderr
# 1481 "/doner/binutils/binutils-515f23e/gas/as.c"
               );
  ...
  if (had_errors () != 0)
    xexit (
# 1492 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
          1
# 1492 "/doner/binutils/binutils-515f23e/gas/as.c"
                      );
  ...
  xexit (
# 1497 "/doner/binutils/binutils-515f23e/gas/as.c" 3 4
        0
# 1497 "/doner/binutils/binutils-515f23e/gas/as.c"
                    );
}
