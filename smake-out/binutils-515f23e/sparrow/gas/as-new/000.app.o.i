# 1 "/doner/binutils/binutils-515f23e/gas/app.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/app.c"
# 27 "/doner/binutils/binutils-515f23e/gas/app.c"
...
# 28 "/doner/binutils/binutils-515f23e/gas/app.c" 2
# 59 "/doner/binutils/binutils-515f23e/gas/app.c"
static char last_char;

static char lex[256];
static const char symbol_chars[] =
"$._ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
# 96 "/doner/binutils/binutils-515f23e/gas/app.c"
...
void
do_scrub_begin (int m68k_mri __attribute__ ((__unused__)))
{
  const char *p;
  int c;
  ...
  for (p = i386_comment_chars; *p; p++)
    lex[(unsigned char) *p] = 4;

  for (p = line_comment_chars; *p; p++)
    lex[(unsigned char) *p] = 5;




  for (p = line_separator_chars; *p; p++)
    lex[(unsigned char) *p] = 3;
# 177 "/doner/binutils/binutils-515f23e/gas/app.c"
  if (lex['/'] == 0)
    lex['/'] = 6;
# 210 "/doner/binutils/binutils-515f23e/gas/app.c"
}
...
app_push (void)
{
  ...
  saved = ((struct app_save *) xmalloc (sizeof (struct app_save)));
  saved->state = state;
  ...
  if (saved_input == 
# 260 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                    ((void *)0)
# 260 "/doner/binutils/binutils-515f23e/gas/app.c"
                        )
    saved->saved_input = 
# 261 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                        ((void *)0)
# 261 "/doner/binutils/binutils-515f23e/gas/app.c"
                            ;
  else
    {
      saved->saved_input = ((char *) xmalloc (sizeof (char) * (saved_input_len)));
  ...
  state = 0;
  saved_input = 
# 281 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
               ((void *)0)
# 281 "/doner/binutils/binutils-515f23e/gas/app.c"
                   ;
  add_newlines = 0;
...
app_pop (char *arg)
{
  ...
  if (saved->saved_input == 
# 298 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                           ((void *)0)
# 298 "/doner/binutils/binutils-515f23e/gas/app.c"
                               )
    saved_input = 
# 299 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                 ((void *)0)
# 299 "/doner/binutils/binutils-515f23e/gas/app.c"
                     ;
  else
    {
      ((void) ((saved->saved_input_len <= sizeof (input_buffer)) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/app.c", 302, __PRETTY_FUNCTION__), 0)));
...
# 351 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
_Bool

# 352 "/doner/binutils/binutils-515f23e/gas/app.c"
scan_for_multibyte_characters (const unsigned char * start,
          const unsigned char * end,
          
# 354 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
         _Bool 
# 354 "/doner/binutils/binutils-515f23e/gas/app.c"
                                warn)
{
  if (end <= start)
    return 
# 357 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          0
# 357 "/doner/binutils/binutils-515f23e/gas/app.c"
               ;

  if (warn && multibyte_warn_count > 10)
    return 
# 360 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          0
# 360 "/doner/binutils/binutils-515f23e/gas/app.c"
               ;

  
# 362 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
 _Bool 
# 362 "/doner/binutils/binutils-515f23e/gas/app.c"
      found = 
# 362 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
              0
# 362 "/doner/binutils/binutils-515f23e/gas/app.c"
 ...
 continue;
      ...
      if (!warn)
 return 
# 372 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       1
# 372 "/doner/binutils/binutils-515f23e/gas/app.c"
           ;

      found = 
# 374 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
             1
# 374 "/doner/binutils/binutils-515f23e/gas/app.c"
                 ;
      ...
      if (filename == 
# 380 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                     ((void *)0)
# 380 "/doner/binutils/binutils-515f23e/gas/app.c"
                         )
 as_warn (gettext ("multibyte character (%#x) encountered in input"), c);
      else if (lineno == 0)
 as_warn (gettext ("multibyte character (%#x) encountered in %s"), c, filename);
      else
 as_warn (gettext ("multibyte character (%#x) encountered in %s at or near line %u"), c, filename, lineno);

      if (++ multibyte_warn_count == 10)
 {
   as_warn (gettext ("further multibyte character warnings suppressed"));
   break;
 }
    }
...
# 408 "/doner/binutils/binutils-515f23e/gas/app.c"
size_t
...
# 503 "/doner/binutils/binutils-515f23e/gas/app.c"
  if (saved_input != 
# 503 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                    ((void *)0)
# 503 "/doner/binutils/binutils-515f23e/gas/app.c"
                        )
    {
...
# 519 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          1 
# 519 "/doner/binutils/binutils-515f23e/gas/app.c"
                                        );
    }
   ...
   for (;;)
     {
       do
  {
    ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 544 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        ((void *)0)
# 544 "/doner/binutils/binutils-515f23e/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 544 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        (-1) 
# 544 "/doner/binutils/binutils-515f23e/gas/app.c"
        : * (unsigned char *) (from++))));
    ...
    if (ch == 
# 546 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
             (-1)
# 546 "/doner/binutils/binutils-515f23e/gas/app.c"
                )
      {
        as_warn (gettext ("end of file in comment"));
        goto fromeof;
      }
    ...
    if (ch == '\n')
      do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
       ...
       while ((ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 557 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                   ((void *)0)
# 557 "/doner/binutils/binutils-515f23e/gas/app.c"
                   , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 557 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                   (-1) 
# 557 "/doner/binutils/binutils-515f23e/gas/app.c"
  ...
  ;
       ...
       if (ch == 
# 560 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                (-1)
# 560 "/doner/binutils/binutils-515f23e/gas/app.c"
                   )
  {
    as_warn (gettext ("end of file in comment"));
    goto fromeof;
 ...
 case 4:
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 577 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       ((void *)0)
# 577 "/doner/binutils/binutils-515f23e/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 577 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       (-1) 
# 577 "/doner/binutils/binutils-515f23e/gas/app.c"
       : * (unsigned char *) (from++))));
   if (ch == 
# 578 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1)
# 578 "/doner/binutils/binutils-515f23e/gas/app.c"
               )
     goto fromeof;
   else if (ch >= '0' && ch <= '9')
     do { *to++ = (ch); if (to >= toend) goto tofull; } while (0);
     ...
     {
       while (ch != 
# 584 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                   (-1) 
# 584 "/doner/binutils/binutils-515f23e/gas/app.c"
                       && (lex[ch] == 2))
  ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 585 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
      ((void *)0)
# 585 "/doner/binutils/binutils-515f23e/gas/app.c"
      , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 585 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
      (-1) 
# 585 "/doner/binutils/binutils-515f23e/gas/app.c"
  ...
  {
    while (ch != 
# 595 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                (-1) 
# 595 "/doner/binutils/binutils-515f23e/gas/app.c"
                    && ch != '\n')
      ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 596 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          ((void *)0)
# 596 "/doner/binutils/binutils-515f23e/gas/app.c"
          , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 596 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          (-1) 
# 596 "/doner/binutils/binutils-515f23e/gas/app.c"
 ...
 case 5:
  ...
  if (to >= toend)
   ...
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 633 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       ((void *)0)
# 633 "/doner/binutils/binutils-515f23e/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 633 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       (-1) 
# 633 "/doner/binutils/binutils-515f23e/gas/app.c"
       : * (unsigned char *) (from++))));
   if (ch == 
# 634 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1)
# 634 "/doner/binutils/binutils-515f23e/gas/app.c"
               )
     {
       ...
       as_warn (gettext ("end of file in string; '%c' inserted"), quotechar);
       state = old_state;
 ...
 case 6:
   state = 5;
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 673 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       ((void *)0)
# 673 "/doner/binutils/binutils-515f23e/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 673 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       (-1) 
# 673 "/doner/binutils/binutils-515f23e/gas/app.c"
   ...
   switch (ch)
     ...
     case 
# 684 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
         (-1)
# 684 "/doner/binutils/binutils-515f23e/gas/app.c"
            :
       as_warn (gettext ("end of file in string; '%c' inserted"), quotechar);
       do { *to++ = (quotechar); if (to >= toend) goto tofull; } while (0);
       continue;
   ...
   do { *to++ = (ch); if (to >= toend) goto tofull; } while (0);
   continue;
# 769 "/doner/binutils/binutils-515f23e/gas/app.c"
 }
      ...
      ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 774 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          ((void *)0)
# 774 "/doner/binutils/binutils-515f23e/gas/app.c"
          , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 774 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          (-1) 
# 774 "/doner/binutils/binutils-515f23e/gas/app.c"
          : * (unsigned char *) (from++))));
# 799 "/doner/binutils/binutils-515f23e/gas/app.c"
    recycle:
# 883 "/doner/binutils/binutils-515f23e/gas/app.c"
      if (ch == 
# 883 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
               (-1)
# 883 "/doner/binutils/binutils-515f23e/gas/app.c"
                  )
 {
   if (state != 0)
     {
       as_warn (gettext ("end of file not at end of a line; newline inserted"));
       state = 0;
       do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
     }
   goto fromeof;
 ...
 case 2:
   do
     {
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 899 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           ((void *)0)
# 899 "/doner/binutils/binutils-515f23e/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 899 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           (-1) 
# 899 "/doner/binutils/binutils-515f23e/gas/app.c"
   ...
   while (ch != 
# 901 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
               (-1) 
# 901 "/doner/binutils/binutils-515f23e/gas/app.c"
                   && (lex[ch] == 2));
   if (ch == 
# 902 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1)
# 902 "/doner/binutils/binutils-515f23e/gas/app.c"
               )
     goto fromeof;
...
# 932 "/doner/binutils/binutils-515f23e/gas/app.c"
   if ((lex[ch] == 4)
       || (lex[ch] == 3)
       || (lex[ch] == 14))
     {
       ...
       else
  {
    ...
    state = 3;
       ...
       break;
     default:
       { as_fatal (gettext ("Case value %ld unexpected at line %d of file \"%s\"\n"), (long) state, 1019, "/doner/binutils/binutils-515f23e/gas/app.c"); };
     }
   break;

 case 6:
   ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1024 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        ((void *)0)
# 1024 "/doner/binutils/binutils-515f23e/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1024 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        (-1) 
# 1024 "/doner/binutils/binutils-515f23e/gas/app.c"
       ...
       for (;;)
  {
    do
      {
        ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1031 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
             ((void *)0)
# 1031 "/doner/binutils/binutils-515f23e/gas/app.c"
             , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1031 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
             (-1) 
# 1031 "/doner/binutils/binutils-515f23e/gas/app.c"
             : * (unsigned char *) (from++))));
        if (ch2 != 
# 1032 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                  (-1) 
# 1032 "/doner/binutils/binutils-515f23e/gas/app.c"
                      && (lex[ch2] == 10))
   add_newlines++;
      }
    while (ch2 != 
# 1035 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                 (-1) 
# 1035 "/doner/binutils/binutils-515f23e/gas/app.c"
                     && ch2 != '*');

    while (ch2 == '*')
      ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1038 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           ((void *)0)
# 1038 "/doner/binutils/binutils-515f23e/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1038 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           (-1) 
# 1038 "/doner/binutils/binutils-515f23e/gas/app.c"
    ...
    if (ch2 == 
# 1040 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
              (-1) 
# 1040 "/doner/binutils/binutils-515f23e/gas/app.c"
                  || ch2 == '/')
      break;
    ...
    (*--from = (ch2));
       ...
       if (ch2 == 
# 1048 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                 (-1)
# 1048 "/doner/binutils/binutils-515f23e/gas/app.c"
                    )
  as_warn (gettext ("end of file in multiline comment"));

       ch = ' ';
       goto recycle;
     }
# 1069 "/doner/binutils/binutils-515f23e/gas/app.c"
   else
     {
       if (ch2 != 
# 1071 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                 (-1)
# 1071 "/doner/binutils/binutils-515f23e/gas/app.c"
                    )
  (*--from = (ch2));
       if (state == 9 || state == 10)
  state = 3;
   ...
   if (state == 10)
     {
       ...
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1090 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           ((void *)0)
# 1090 "/doner/binutils/binutils-515f23e/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1090 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           (-1) 
# 1090 "/doner/binutils/binutils-515f23e/gas/app.c"
 ...
 case 11:
# 1112 "/doner/binutils/binutils-515f23e/gas/app.c"
   if (state == 10)
     {
   ...
   ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1120 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       ((void *)0)
# 1120 "/doner/binutils/binutils-515f23e/gas/app.c"
       , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1120 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
       (-1) 
# 1120 "/doner/binutils/binutils-515f23e/gas/app.c"
       : * (unsigned char *) (from++))));
   if (ch == 
# 1121 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1)
# 1121 "/doner/binutils/binutils-515f23e/gas/app.c"
               )
     {
       as_warn (gettext ("end of file after a one-character quote; \\0 inserted"));
       ch = 0;
     }
   if (ch == '\\')
     {
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1128 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           ((void *)0)
# 1128 "/doner/binutils/binutils-515f23e/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1128 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           (-1) 
# 1128 "/doner/binutils/binutils-515f23e/gas/app.c"
           : * (unsigned char *) (from++))));
       if (ch == 
# 1129 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                (-1)
# 1129 "/doner/binutils/binutils-515f23e/gas/app.c"
                   )
  {
    as_warn (gettext ("end of file in escape character"));
    ch = '\\';
  }
       else
  ch = process_escape (ch);
   ...
   if ((ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1140 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            ((void *)0)
# 1140 "/doner/binutils/binutils-515f23e/gas/app.c"
            , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1140 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1) 
# 1140 "/doner/binutils/binutils-515f23e/gas/app.c"
            : * (unsigned char *) (from++))))) != '\'')
     {
       ...
       if (ch != 
# 1145 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                (-1)
# 1145 "/doner/binutils/binutils-515f23e/gas/app.c"
                   )
  (*--from = (ch));
 ...
 case 14:
   ...
   do { *to++ = (ch); if (to >= toend) goto tofull; } while (0);
   break;
# 1232 "/doner/binutils/binutils-515f23e/gas/app.c"
 case 5:
   ...
   if (ch == '/')
     {
       ch2 = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1239 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            ((void *)0)
# 1239 "/doner/binutils/binutils-515f23e/gas/app.c"
            , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1239 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1) 
# 1239 "/doner/binutils/binutils-515f23e/gas/app.c"
...
# 1246 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                      (-1)
# 1246 "/doner/binutils/binutils-515f23e/gas/app.c"
                         )
  {
    (*--from = (ch2));
  }
  ...
  {
    ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1260 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        ((void *)0)
# 1260 "/doner/binutils/binutils-515f23e/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1260 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        (-1) 
# 1260 "/doner/binutils/binutils-515f23e/gas/app.c"
       ...
       while (ch != 
# 1262 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                   (-1) 
# 1262 "/doner/binutils/binutils-515f23e/gas/app.c"
                       && (lex[ch] == 2));

       if (ch == 
# 1264 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                (-1)
# 1264 "/doner/binutils/binutils-515f23e/gas/app.c"
                   )
  {
    as_warn (gettext ("end of file in comment; newline inserted"));
    do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
    break;
  }
       ...
       if (ch < '0' || ch > '9' || state != 0 || startch != '#')
  {
    ...
    while (ch != 
# 1274 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                (-1) 
# 1274 "/doner/binutils/binutils-515f23e/gas/app.c"
                    && !(lex[ch] == 10))
      ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1275 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          ((void *)0)
# 1275 "/doner/binutils/binutils-515f23e/gas/app.c"
          , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1275 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
          (-1) 
# 1275 "/doner/binutils/binutils-515f23e/gas/app.c"
          : * (unsigned char *) (from++))));
    if (ch == 
# 1276 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
             (-1)
# 1276 "/doner/binutils/binutils-515f23e/gas/app.c"
                )
      {
        as_warn (gettext ("end of file in comment; newline inserted"));
        do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
...
# 1319 "/doner/binutils/binutils-515f23e/gas/app.c"
   if (strchr (i386_comment_chars, ch) == 
# 1319 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                                       ((void *)0)
       
# 1320 "/doner/binutils/binutils-515f23e/gas/app.c"
      && (! 0
    || (ch != '!' && ch != '*')))
     goto de_fault;
   if (0
 ...
 case 4:
# 1342 "/doner/binutils/binutils-515f23e/gas/app.c"
   ...
   do
     {
       ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1352 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           ((void *)0)
# 1352 "/doner/binutils/binutils-515f23e/gas/app.c"
           , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1352 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
           (-1) 
# 1352 "/doner/binutils/binutils-515f23e/gas/app.c"
   ...
   while (ch != 
# 1354 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
               (-1) 
# 1354 "/doner/binutils/binutils-515f23e/gas/app.c"
                   && !(lex[ch] == 10));
   if (ch == 
# 1355 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
            (-1)
# 1355 "/doner/binutils/binutils-515f23e/gas/app.c"
               )
     as_warn (gettext ("end of file in comment; newline inserted"));
   state = 0;
   do { *to++ = ('\n'); if (to >= toend) goto tofull; } while (0);
   break;
# 1381 "/doner/binutils/binutils-515f23e/gas/app.c"
 case 1:
   if (state == 10)
     {
...
# 1418 "/doner/binutils/binutils-515f23e/gas/app.c"
   if (state == 3)
     state = 9;
   ...
   if (to + 1 < toend
       && mri_state == 
# 1424 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                      ((void *)0)



       
# 1428 "/doner/binutils/binutils-515f23e/gas/app.c"
      )
     {
       char *s;
       ptrdiff_t len;
       ...
       if (len > 0)
  {
    ...
    if (to >= toend)
      goto tofull;
    ch = (from < fromend ? * (unsigned char *) (from++) : (saved_input = 
# 1462 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        ((void *)0)
# 1462 "/doner/binutils/binutils-515f23e/gas/app.c"
        , fromlen = (*get) (input_buffer, sizeof input_buffer), from = input_buffer, fromend = from + fromlen, (fromlen == 0 ? 
# 1462 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
        (-1) 
# 1462 "/doner/binutils/binutils-515f23e/gas/app.c"
 ...
 de_fault:
  ...
  state = 3;
   ...
   else if (state == 10)
     {
       if (ch == '\\')
  {
# 1499 "/doner/binutils/binutils-515f23e/gas/app.c"
    if (to + 1 >= toend)
      {
 ...
 tofull:
  ...
  if (fromend > from)
    ...
    saved_input = 
# 1534 "/doner/binutils/binutils-515f23e/gas/app.c" 3 4
                 ((void *)0)
# 1534 "/doner/binutils/binutils-515f23e/gas/app.c"
                     ;
