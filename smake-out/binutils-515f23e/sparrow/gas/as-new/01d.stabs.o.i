# 1 "/doner/binutils/binutils-515f23e/gas/stabs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/stabs.c"
# 21 "/doner/binutils/binutils-515f23e/gas/stabs.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/stabs.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/stabs.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/stabs.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gas/stabs.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/stabs.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gas/stabs.c" 2
...
# 53 "/doner/binutils/binutils-515f23e/gas/stabs.c"
...
static 
# 68 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
      _Bool 
# 68 "/doner/binutils/binutils-515f23e/gas/stabs.c"
           void_emitted_p;


static int endfunc_label_count;
# 97 "/doner/binutils/binutils-515f23e/gas/stabs.c"
unsigned int
get_stab_string_offset (const char *string, const char *stabstr_secname,
   
# 99 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
  _Bool 
# 99 "/doner/binutils/binutils-515f23e/gas/stabs.c"
       free_stabstr_secname)
{
  unsigned int length;
  unsigned int retval;
  segT save_seg;
  ...
  if (! 1)
    as_abort ("/doner/binutils/binutils-515f23e/gas/stabs.c", 109, __PRETTY_FUNCTION__);
  ...
  retval = ((segment_info_type *) bfd_section_userdata (seg))->stabu.stab_string_size;
  if (retval <= 0)
    {

      p = frag_more (1);
      *p = 0;
      retval = ((segment_info_type *) bfd_section_userdata (seg))->stabu.stab_string_size = 1;
      bfd_set_section_flags (seg, 0x8 | 0x2000);
    }
  ...
  if (length > 0)
    {
      ...
      ((segment_info_type *) bfd_section_userdata (seg))->stabu.stab_string_size += length + 1;
    }
  else
    retval = 0;
...
# 192 "/doner/binutils/binutils-515f23e/gas/stabs.c"
static void
  ...
  const char *stab_secname_obstack_end)
{
  ...
  int other;
  int desc;
# 213 "/doner/binutils/binutils-515f23e/gas/stabs.c"
  if (what != 's')
    {
      string = "";
  ...
  else
    {
      ...
      if (string == 
# 223 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                   ((void *)0)
# 223 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                       )
 {
   as_warn (gettext (".stab%c: missing string"), what);
   ignore_rest_of_line ();
   return;
 }
      ...
      saved_string_obstack_end = ((void *) (&notes)->next_free);
      ((*input_line_pointer == ' ') ? ++input_line_pointer : 0);
      if (*input_line_pointer == ',')
 input_line_pointer++;
      else
 {
   as_warn (gettext (".stab%c: missing comma"), what);
   ignore_rest_of_line ();
   return;
 }
    }
  ...
  if ((desc > 0xffff) || (desc < -0x8000))
    ...
    as_warn (gettext (".stab%c: description field '%x' too big, try a different debug format"),
      what, desc);
...
# 302 "/doner/binutils/binutils-515f23e/gas/stabs.c"
  if (listing)
    {
      switch (type)
 {
      ...
      else
 {
   ...
   cached_sec = seg;
      ...
      if (! ((segment_info_type *) bfd_section_userdata (seg))->hadone)
 {
   ...
   ((segment_info_type *) bfd_section_userdata (seg))->hadone = 1;
 }

      stroff = get_stab_string_offset (string, stabstr_secname,
           stab_secname_obstack_end != 
# 361 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                                      ((void *)0)
# 361 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                          );


      if (saved_string_obstack_end != 
# 364 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                                     ((void *)0)
   
# 365 "/doner/binutils/binutils-515f23e/gas/stabs.c"
  && saved_string_obstack_end == ((void *) (&notes)->next_free))
 __extension__ ({ struct obstack *__o = (&notes); void *__obj = (void *) (string); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });


      if (seg->name != stab_secname
   && stab_secname_obstack_end != 
# 370 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                                 ((void *)0)
   
# 371 "/doner/binutils/binutils-515f23e/gas/stabs.c"
  && stab_secname_obstack_end == ((void *) (&notes)->next_free))
 __extension__ ({ struct obstack *__o = (&notes); void *__obj = (void *) (stab_secname); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });



      p = frag_more (8);
      number_to_chars_littleendian (p, (valueT) stroff, 4);
      number_to_chars_littleendian (p + 4, (valueT) type, 1);
      number_to_chars_littleendian (p + 5, (valueT) other, 1);
      number_to_chars_littleendian (p + 6, (valueT) desc, 2);
      ...
      else
 {
   ...
   emit_expr (&exp, 4);
    ...
    {
      if (stab_secname_obstack_end != 
# 411 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                                     ((void *)0)
# 411 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                         )
 {
   free ((char *) stabstr_secname);
   if (stab_secname_obstack_end == ((void *) (&notes)->next_free))
     __extension__ ({ struct obstack *__o = (&notes); void *__obj = (void *) (stab_secname); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
 }



      as_abort ("/doner/binutils/binutils-515f23e/gas/stabs.c", 420, __PRETTY_FUNCTION__);
...
s_stab (int what)
{
  s_stab_generic (what, ".stab", ".stabstr", 
# 432 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                                                                    ((void *)0)
# 432 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                                                        );
}
...
s_xstab (int what)
{
  ...
  if (*input_line_pointer == ',')
    ...
    {
      as_bad (gettext ("comma missing in .xstabs"));
      ignore_rest_of_line ();
      return;
    }
  ...
  stabstr_secname = concat (stab_secname, "str", (char *) 
# 457 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                                                         ((void *)0)
# 457 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                                             );
  s_stab_generic (what, stab_secname, stabstr_secname,
    stab_secname_obstack_end);
}
# 502 "/doner/binutils/binutils-515f23e/gas/stabs.c"
void
  ...
  if (use_gnu_debug_info_extensions)
    {
      ...
      dir2 = concat (dir, "/", 
# 515 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                              ((void *)0)
# 515 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                  );
...
generate_asm_file (int type, const char *file)
{
  ...
  if (last_asm_file != 
# 535 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                      ((void *)0)
      
# 536 "/doner/binutils/binutils-515f23e/gas/stabs.c"
  ...
  sprintf (sym, "%sF%d", "L0\001", file_label_count);
  ++file_label_count;




  bufp = buf = ((char *) xmalloc (sizeof (char) * (2 * strlen (file) + strlen (sym) + 12)));
  ...
  while (tmp < file_endp)
    {
      ...
      size_t len = bslash != 
# 556 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                            ((void *)0) 
# 556 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                 ? bslash - tmp + 1 : file_endp - tmp;
      ...
      if (bslash != 
# 566 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                   ((void *)0)
# 566 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                       )
 *bufp++ = '\\';
    }
...
stabs_generate_asm_lineno (void)
{
  ...
  if (prev_line_file != 
# 603 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                       ((void *)0)
      
# 604 "/doner/binutils/binutils-515f23e/gas/stabs.c"
 ...
 return;
  ...
  sprintf (sym, "%sL%d", "L0\001", line_label_count);
  ++line_label_count;

  if (current_function_label)
    {
      buf = ((char *) xmalloc (sizeof (char) * (100 + strlen (current_function_label))));
      sprintf (buf, "%d,0,%d,%s-%s\n", N_SLINE, lineno,
        sym, current_function_label);
    }
  else
    {
      buf = ((char *) xmalloc (sizeof (char) * (100)));
      sprintf (buf, "%d,0,%d,%s\n", N_SLINE, lineno, sym);
    }
  ...
  if (! void_emitted_p)
    {
      ...
      restore_ilp ();
      void_emitted_p = 
# 664 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                      1
# 664 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                          ;
    }
...
# 670 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                              (*__errno_location ())
# 670 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                   ));
...
void
stabs_generate_asm_endfunc (const char *funcname __attribute__ ((__unused__)),
       const char *startlabname)
{
  char *buf;
  char sym[30];

  sprintf (sym, "%sendfunc%d", "L0\001", endfunc_label_count);
  ++endfunc_label_count;
  colon (sym);

  if (asprintf (&buf, "\"\",%d,0,0,%s-%s", N_FUN, sym, startlabname) == -1)
    as_fatal ("%s", xstrerror (
# 695 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                              (*__errno_location ())
# 695 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                                   ));
...
# 703 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                          ((void *)0)
# 703 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                              ;
}
...
{
  current_function_label = 
# 709 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                          ((void *)0)
# 709 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                              ;
  cached_sec = 
# 710 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
              ((void *)0)
# 710 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                  ;
  last_asm_file = 
# 711 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                 ((void *)0)
# 711 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                     ;
  file_label_count = 0;
  line_label_count = 0;
  prev_lineno = -1u;
  prev_line_file = 
# 715 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                  ((void *)0)
# 715 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                      ;
  void_emitted_p = 
# 716 "/doner/binutils/binutils-515f23e/gas/stabs.c" 3 4
                  0
# 716 "/doner/binutils/binutils-515f23e/gas/stabs.c"
                       ;
