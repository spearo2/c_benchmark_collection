# 1 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
# 21 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/atof-generic.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/atof-generic.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 24 "/doner/binutils/binutils-515f23e/gas/atof-generic.c" 2
# 68 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
...
# 92 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
  char *p;
  char c;
  int seen_significant_digit;


  ((void) ((string_of_decimal_marks[0] == '.' && string_of_decimal_marks[1] == 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/atof-generic.c", 97, __PRETTY_FUNCTION__), 0)))
                                      ;
      ...
      if (!strncasecmp ("nan", first_digit + 1, 3))
 {
   address_of_generic_floating_point_number->sign =
     digits_sign_char == '+' ? _sch_toupper[(first_digit[0]) & 0xff]
        : _sch_tolower[(first_digit[0]) & 0xff];
...
# 207 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
  seen_significant_digit = 0;
 ...
 first_digit++;
      ...
      for (p++; (c = *p) && (_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isdigit)); p++)
 {
   if (c == '0')
     {
       if (number_of_digits_before_decimal == 0
...
# 275 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
  if (0)
    {
      while (c == '_')
 c = *++p;
      ...
      for (; (c); c = *++p)
 {
   if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isdigit)))
     {
       if (decimal_exponent > 0x7fffffffffffffffL / 10
    || (decimal_exponent == 0x7fffffffffffffffL / 10
        && c > '0' + (char) (0x7fffffffffffffffL - 0x7fffffffffffffffL / 10 * 10)))
  return_value = (2);
...
# 345 "/doner/binutils/binutils-515f23e/gas/atof-generic.c" 3 4
                                            ((void *)0)
# 345 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
                                                ;
      LITTLENUM_TYPE *power_binary_low = 
# 346 "/doner/binutils/binutils-515f23e/gas/atof-generic.c" 3 4
                                        ((void *)0)
# 346 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
                                            ;
 ...
 = (more_than_enough_bits_for_digits
    / (16))
 + 2;
# 400 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
...
# 419 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
      for (p = first_digit, count = number_of_digits_to_use; count; p++, --count)
 {
       ...
       if (carry != 0)
  {
    ...
    as_fatal (gettext ("failed sanity check"));
  }
     }
   else
     {
...
# 489 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
      digits_flonum.sign = '+';
...
# 545 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
 {
       ...
       if (decimal_exponent & 1)
  {
    if (place_number > place_number_limit)
      ...
      {
# 591 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
...
# 622 "/doner/binutils/binutils-515f23e/gas/atof-generic.c"
