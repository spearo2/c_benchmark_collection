# 1 "/doner/binutils/binutils-515f23e/gas/expr.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/expr.c"
# 28 "/doner/binutils/binutils-515f23e/gas/expr.c"
...
# 29 "/doner/binutils/binutils-515f23e/gas/expr.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gas/expr.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 32 "/doner/binutils/binutils-515f23e/gas/expr.c" 2




_Bool 
# 36 "/doner/binutils/binutils-515f23e/gas/expr.c"
    literal_prefix_dollar_hex = 
# 36 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                0
# 36 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                     ;
...
expr_symbol_where (symbolS *sym, const char **pfile, unsigned int *pline)
{
  ...
  for (l = expr_symbol_lines; l != 
# 114 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                  ((void *)0)
# 114 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                      ; l = l->next)
    {
      if (l->sym == sym)
 {
...
static symbolS *
symbol_lookup_or_make (const char *name, 
# 133 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                        _Bool 
# 133 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                             start)
{
  char *buf = concat (start ? ".startof." : ".sizeof.", name, 
# 135 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                                             ((void *)0)
# 135 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                                                 );
  symbolS *symbolP;
  unsigned int i;
  ...
  if (i >= nr_seen[start])
    {
      ...
      seen[start] = ((symbolS * *) xrealloc ((void *) (seen[start]), sizeof (symbolS *) * (nr)));
      nr_seen[start] = nr;
...
# 185 "/doner/binutils/binutils-515f23e/gas/expr.c"
symbolS *
...
expr_build_dot (void)
{
  ...
  current_location (&e);
  return symbol_clone_if_forward_ref (make_expr_symbol (&e), 0);
}
# 216 "/doner/binutils/binutils-515f23e/gas/expr.c"
LITTLENUM_TYPE generic_bignum[(20) + 6];

FLONUM_TYPE generic_floating_point_number = {
  &generic_bignum[6],
  &generic_bignum[(20) + 6 - 1],
  0,
  0,
  0
};
  ...
  if (error_code)
    {
      if (error_code == (2))
 {
   as_bad (gettext ("bad floating-point constant: exponent overflow"));
 }
      else
 {
   as_bad (gettext ("bad floating-point constant: unknown error code=%d"),
    error_code);
 }
    }
...
{
  return ((((uint32_t) generic_bignum[1] & (0xFFFF))
    << (16))
   | ((uint32_t) generic_bignum[0] & (0xFFFF)));
}

uint64_t
generic_bignum_to_int64 (void)
{
  return ((((((((uint64_t) generic_bignum[3] & (0xFFFF))
        << (16))
       | ((uint64_t) generic_bignum[2] & (0xFFFF)))
      << (16))
     | ((uint64_t) generic_bignum[1] & (0xFFFF)))
    << (16))
   | ((uint64_t) generic_bignum[0] & (0xFFFF)));
}
...
integer_constant (int radix, expressionS *expressionP)
{
  char *start;
  char *suffix = 
# 278 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                ((void *)0)
# 278 "/doner/binutils/binutils-515f23e/gas/expr.c"
                    ;
  char c;
  valueT number;
  short int digit;
  ...
  int small;
# 313 "/doner/binutils/binutils-515f23e/gas/expr.c"
  ...
  if ((0 || 0) && radix == 0)
    {
      ...
      for (suffix = input_line_pointer; (_sch_istable[(*suffix) & 0xff] & (unsigned short)(_sch_isalnum)); suffix++)
 {
      ...
      if (suffix == input_line_pointer)
 {
   radix = 10;
   suffix = 
# 335 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
           ((void *)0)
# 335 "/doner/binutils/binutils-515f23e/gas/expr.c"
               ;
 }
      else
 {
   ...
   if ((0 && 1 ? *suffix : c) == 'B')
   ...
   else
     {
       radix = 10;
       suffix = 
# 360 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
               ((void *)0)
# 360 "/doner/binutils/binutils-515f23e/gas/expr.c"
                   ;
     }
 }
    }
  ...
  switch (radix)
    ...
    case 2:
      maxdig = 2;
      too_many_digits = 64 + 1;
      break;
    case 8:
      maxdig = radix = 8;
      too_many_digits = (64 + 2) / 3 + 1;
      break;
    case 16:
      maxdig = radix = 16;
      too_many_digits = (64 + 3) / 4 + 1;
      break;
    case 10:
      maxdig = radix = 10;
      too_many_digits = (64 + 11) / 4;
    }

  start = input_line_pointer;
  c = *input_line_pointer++;
  for (number = 0;
       (digit = ((unsigned int) _hex_value[(unsigned char) (c)])) < maxdig;
       c = *input_line_pointer++)
    {
  ...
  if (radix == 16 && c == '_')
    {
      ...
      ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 405, __PRETTY_FUNCTION__), 0)));
      ...
      for (c = '_'; c == '_'; num_little_digits += 2)
 {
   ...
   if (ndigit > 8)
     as_bad (gettext ("a bignum with underscores may not have more than 8 hex digits in any word"));



   ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 427, __PRETTY_FUNCTION__), 0)));
   for (i = ((num_little_digits + 1) < ((20) - 1) ? (num_little_digits + 1) : ((20) - 1));
        i >= 2;
        i--)
   ...
   generic_bignum[1] = number >> 16;
      ...
      if (num_little_digits > (20) - 1)
 num_little_digits = (20) - 1;

      ((void) ((num_little_digits >= 4) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 443, __PRETTY_FUNCTION__), 0)));

      if (num_little_digits != 8)
 as_bad (gettext ("a bignum with underscores must have exactly 4 words"));
      ...
      else
 {
   ...
   number = num_little_digits;
  ...
  else if (!small)
    {
      ...
      input_line_pointer = start;
      c = *input_line_pointer++;
      for (; (carry = ((unsigned int) _hex_value[(unsigned char) (c)])) < maxdig; c = *input_line_pointer++)
 {
       ...
       if (leader < generic_bignum + (20) - 1)
  {
    ...
    *++leader = carry;
      ...
      ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 511, __PRETTY_FUNCTION__), 0)));
      ...
      else
 {
  ...
  if ((0 || 0)
      && suffix != 
# 534 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                  ((void *)0)
      
# 535 "/doner/binutils/binutils-515f23e/gas/expr.c"
      ...
      if (1 && c == 'b')
 {
   ...
   if ((symbolP != 
# 570 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                  ((void *)0)
# 570 "/doner/binutils/binutils-515f23e/gas/expr.c"
   ...
   else
     {
       ...
       as_bad (gettext ("backward ref to unknown label \"%d:\""),
        (int) number);
       expressionP->X_op = O_constant;
     }
   ...
   if (dollar_label_defined (number))
     {
       ...
       symbolP = symbol_find (name);
       ((void) ((symbolP != 
# 614 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
      ((void *)0)
# 614 "/doner/binutils/binutils-515f23e/gas/expr.c"
      ) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 614, __PRETTY_FUNCTION__), 0)));
     }
   else
     {
...
mri_char_constant (expressionS *expressionP)
{
 ...
 break;
  ...
  if (i < 0)
    {
      as_bad (gettext ("character constant too large"));
      i = 0;
    }
 ...
 generic_bignum[j] = generic_bignum[i + j];
  ...
  ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 708, __PRETTY_FUNCTION__), 0)));
  if (i > 2)
    {
      expressionP->X_op = O_big;
  ...
  else
    {
      expressionP->X_op = O_constant;
      if (i < 2)
 expressionP->X_add_number = generic_bignum[0] & (0xFFFF);
      else
 expressionP->X_add_number =
   (((generic_bignum[1] & (0xFFFF))
     << (16))
    | (generic_bignum[0] & (0xFFFF)));
    }
...
# 760 "/doner/binutils/binutils-515f23e/gas/expr.c"
static segT
operand (expressionS *expressionP, enum expr_mode mode)
{
      ...
      if (0 || 0)
 {
   ...
   for (s = input_line_pointer; (((unsigned int) _hex_value[(unsigned char) (*s)]) != 99); s++)
     ;
   ...
   if (c && strchr (FLT_CHARS, c))
     {
       input_line_pointer++;
       floating_constant (expressionP);
       expressionP->X_add_number = - _sch_tolower[(c) & 0xff];
     }
   else
     {
 ...
 case 'f':
   if (1)
    ...
    && strchr (FLT_CHARS, 'f') != 
# 913 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                 ((void *)0)
# 913 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                     )
  {
 ...
 {
   if (* input_line_pointer)
     as_bad (gettext ("found '%c', expected: '%c'"),
      * input_line_pointer, c == '(' ? ')' : ']');
   else
     as_bad (gettext ("missing '%c'"), c == '(' ? ')' : ']');
 }
      else
 input_line_pointer++;
      ...
      return segment;
# 1007 "/doner/binutils/binutils-515f23e/gas/expr.c"
    case '\'':
      if (! 0)
 {
   ...
   break;
      ...
      break;
# 1029 "/doner/binutils/binutils-515f23e/gas/expr.c"
    case '~':

      if (( lex_type[(unsigned char) (c)] & (2) ))
 goto isname;
      op = O_bit_not;
      goto unary;
 ...
 if (i386_record_operator (op, 
# 1049 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
    ((void *)0)
# 1049 "/doner/binutils/binutils-515f23e/gas/expr.c"
    , expressionP))
 {
 ...
 if (expressionP->X_op == O_constant)
  ...
  if (expressionP->X_add_number < (20))
    {
      expressionP->X_add_number = (20);
  ...
  expressionP->X_add_number = 0;
     ...
     else if (!0 && expressionP->X_op == O_register)
       {
  ...
  expressionP->X_op = O_add;
   ...
   as_warn (gettext ("Unary operator %c ignored because bad operand follows"),
     c);
      }
      break;
      ...
      else
 {
   goto isname;
      ...
      break;
# 1193 "/doner/binutils/binutils-515f23e/gas/expr.c"
    case '.':
      if (!( lex_type[(unsigned char) (*input_line_pointer)] & (1) ))
 {
   current_location (expressionP);
   break;
 }
      else if ((strncasecmp (input_line_pointer, "startof.", 8) == 0
  && ! ( lex_type[(unsigned char) (input_line_pointer[8])] & (1) ))
        || (strncasecmp (input_line_pointer, "sizeof.", 7) == 0
     && ! ( lex_type[(unsigned char) (input_line_pointer[7])] & (1) )))
 {
   int start;
   ...
   if (*input_line_pointer != '(')
     as_bad (gettext ("syntax error in .startof. or .sizeof."));
   else
     {
       ++input_line_pointer;
       ((*input_line_pointer == ' ') ? ++input_line_pointer : 0);
      ...
      else
 {
   goto isname;
    ...
    eol:
      ...
      input_line_pointer--;
      break;
# 1287 "/doner/binutils/binutils-515f23e/gas/expr.c"
    default:

    de_fault:

      if (( lex_type[(unsigned char) (c)] & (2) ) || c == '"')
 {
 ...
 isname:
  ...
  goto unary;
       case O_illegal:
  as_bad (gettext ("invalid use of operator \"%s\""), name);
  break;
       default:
  break;
       }
...
# 1328 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                            ((void *)0)
# 1328 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                ;
  expressionP->X_add_number = 0;
  expressionP->X_op = op;
  break;
   ...
   if (i386_parse_name (name, expressionP, &c))
     {
       restore_line_pointer (c);
       break;
     }
      ...
      else
 {
  ...
  while (*input_line_pointer == ' ') ++input_line_pointer;
  ((void) ((*input_line_pointer != ' ') ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1398, __PRETTY_FUNCTION__), 0)));
 ...
 = symbol_clone_if_forward_ref (expressionP->X_add_symbol, 0);
      expressionP->X_op_symbol
 = symbol_clone_if_forward_ref (expressionP->X_op_symbol, 0);
    }
...
# 1432 "/doner/binutils/binutils-515f23e/gas/expr.c"
static void
clean_up_expression (expressionS *expressionP)
{
  switch (expressionP->X_op)
    ...
    case O_register:
      expressionP->X_add_symbol = 
# 1444 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                 ((void *)0)
# 1444 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                     ;
    ...
    case O_bit_not:
      expressionP->X_op_symbol = 
# 1449 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                ((void *)0)
# 1449 "/doner/binutils/binutils-515f23e/gas/expr.c"
                                    ;
      break;
    default:
      break;
...
# 1484 "/doner/binutils/binutils-515f23e/gas/expr.c"
static const operatorT op_encoding[256] = {
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,

  O_illegal, O_bit_or_not, O_illegal, O_illegal, O_illegal, O_modulus, O_bit_and, O_illegal,
  O_illegal, O_illegal, O_multiply, O_add, O_illegal, O_subtract, O_illegal, O_divide,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_lt, O_illegal, O_gt, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal,



  O_illegal,

  O_illegal, O_illegal, O_bit_exclusive_or, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal, O_illegal,
  O_illegal, O_illegal, O_illegal, O_illegal, O_bit_inclusive_or, O_illegal, O_illegal, O_illegal,
...
# 1528 "/doner/binutils/binutils-515f23e/gas/expr.c"
...
# 1571 "/doner/binutils/binutils-515f23e/gas/expr.c"
void
expr_set_precedence (void)
{
  if (0)
    {
      op_rank[O_multiply] = 6;
      op_rank[O_divide] = 6;
      op_rank[O_modulus] = 6;
    }
  else
...
{
  ((void) ((op >= O_md1 && op < (sizeof (op_rank) / sizeof ((op_rank)[0]))) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1591, __PRETTY_FUNCTION__), 0)));
  op_rank[op] = rank;
}
...
expr_begin (void)
{
...

  {
    expressionS e;
    e.X_op = O_max;
    ((void) ((e.X_op == O_max) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1606, __PRETTY_FUNCTION__), 0)));
  }

  memset (seen, 0, sizeof seen);
  memset (nr_seen, 0, sizeof nr_seen);
  expr_symbol_lines = 
# 1611 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                     ((void *)0)
# 1611 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
}
...
operatorf (int *num_chars)
{
      ...
      if (ret == O_illegal)
 {
   ...
   ret = i386_operator (
# 1674 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                     ((void *)0)
# 1674 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         , 2, 
# 1674 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                              ((void *)0)
# 1674 "/doner/binutils/binutils-515f23e/gas/expr.c"
      ...
      enum expr_mode mode )
{
  ...
  ((void) ((rankarg >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1811, __PRETTY_FUNCTION__), 0)));
  ...
  ((void) ((*input_line_pointer != ' ') ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1823, __PRETTY_FUNCTION__), 0)));
...
# 1829 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
     _Bool 
# 1829 "/doner/binutils/binutils-515f23e/gas/expr.c"
          is_unsigned;
      offsetT frag_off;
 ...
 {
   as_warn (gettext ("missing operand; zero assumed"));
   right.X_op = O_constant;
   right.X_add_number = 0;
   right.X_add_symbol = 
# 1841 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                       ((void *)0)
# 1841 "/doner/binutils/binutils-515f23e/gas/expr.c"
                           ;
   right.X_op_symbol = 
# 1842 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                      ((void *)0)
# 1842 "/doner/binutils/binutils-515f23e/gas/expr.c"
                          ;
 }

      ((void) ((*input_line_pointer != ' ') ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1845, __PRETTY_FUNCTION__), 0)));
      ...
      if (op_left == O_index)
 {
   if (*input_line_pointer != ']')
   ...
   else
     {
      ...
      ((void) ((op_right == O_illegal || op_left == O_index || op_rank[(int) op_right] <= op_rank[(int) op_left]) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1860, __PRETTY_FUNCTION__), 0)))
                                                          ;
      ((void) (((int) op_left >= (int) O_multiply) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1862, __PRETTY_FUNCTION__), 0)));



      ((void) (((int) op_left < (int) O_max) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 1866, __PRETTY_FUNCTION__), 0)));
      ...
      if (resultP->X_op == O_big)
 {
   if (resultP->X_add_number > 0)
     as_warn (gettext ("left operand is a bignum; integer 0 assumed"));
   else
     as_warn (gettext ("left operand is a float; integer 0 assumed"));
   resultP->X_op = O_constant;
   resultP->X_add_number = 0;
   resultP->X_add_symbol = 
# 1882 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                          ((void *)0)
# 1882 "/doner/binutils/binutils-515f23e/gas/expr.c"
                              ;
   resultP->X_op_symbol = 
# 1883 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                         ((void *)0)
# 1883 "/doner/binutils/binutils-515f23e/gas/expr.c"
                             ;
 }
      if (right.X_op == O_big)
 {
   if (right.X_add_number > 0)
     as_warn (gettext ("right operand is a bignum; integer 0 assumed"));
   else
     as_warn (gettext ("right operand is a float; integer 0 assumed"));
   right.X_op = O_constant;
   right.X_add_number = 0;
   right.X_add_symbol = 
# 1893 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                       ((void *)0)
# 1893 "/doner/binutils/binutils-515f23e/gas/expr.c"
                           ;
   right.X_op_symbol = 
# 1894 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                      ((void *)0)
# 1894 "/doner/binutils/binutils-515f23e/gas/expr.c"
                          ;
 }
      ...
      if (mode == expr_defer
   && ((resultP->X_add_symbol != 
# 1900 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                ((void *)0)
        
# 1901 "/doner/binutils/binutils-515f23e/gas/expr.c"
       && S_IS_FORWARD_REF (resultP->X_add_symbol))
       || (right.X_add_symbol != 
# 1902 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                                ((void *)0)
    
# 1903 "/doner/binutils/binutils-515f23e/gas/expr.c"
   && S_IS_FORWARD_REF (right.X_add_symbol))))
 goto general;



      if (i386_record_operator (op_left, resultP, &right))
 {
   ...
   && (0 || resultP->X_op != O_register))
 {
   ...
   add_to_result (resultP, right.X_add_number, right.X_extrabit);
        ...
        && ((( (rightseg) != (&_bfd_std_section[2]) && (rightseg) != (&_bfd_std_section[1]) && (rightseg) != reg_section && (rightseg) != expr_section)
           ...
           &frag_off))
 {
   ...
   subtract_from_result (resultP, frag_off / (1<<0), 0);
   add_to_result (resultP, symval_diff, symval_diff < 0);
   resultP->X_op = O_constant;
   resultP->X_add_symbol = 0;
   is_unsigned = 
# 1944 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                0
# 1944 "/doner/binutils/binutils-515f23e/gas/expr.c"
                     ;
 }
        ...
        && (0 || resultP->X_op != O_register))
 {
   ...
   subtract_from_result (resultP, right.X_add_number, right.X_extrabit);
   is_unsigned = 
# 1951 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                0
# 1951 "/doner/binutils/binutils-515f23e/gas/expr.c"
                     ;
 }
      else if (op_left == O_add && resultP->X_op == O_constant
        && (0 || right.X_op != O_register))
 {
      ...
      else if (resultP->X_op == O_constant && right.X_op == O_constant)
 {
   ...
   if (v == 0 && (op_left == O_divide || op_left == O_modulus))
     {
       as_warn (gettext ("division by zero"));
       v = 1;
     }
   switch (op_left)
     {
     ...
     case O_left_shift:
     case O_right_shift:
# 1993 "/doner/binutils/binutils-515f23e/gas/expr.c"
       if ((valueT) v >= sizeof (valueT) * 8)
  {
    as_warn_value_out_of_range (gettext ("shift count"), v, 0,
           sizeof (valueT) * 8 - 1,
           
# 1997 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
          ((void *)0)
# 1997 "/doner/binutils/binutils-515f23e/gas/expr.c"
              , 0);
    resultP->X_add_number = 0;
  }
  ...
  resultP->X_add_number
    = (valueT) resultP->X_add_number >> (valueT) v;
     ...
     case O_subtract:
       ...
       is_unsigned = 
# 2017 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2017 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_eq:
       resultP->X_add_number =
  resultP->X_add_number == v ? ~ (offsetT) 0 : 0;
       is_unsigned = 
# 2022 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2022 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_ne:
       resultP->X_add_number =
  resultP->X_add_number != v ? ~ (offsetT) 0 : 0;
       is_unsigned = 
# 2027 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2027 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_lt:
       resultP->X_add_number =
  resultP->X_add_number < v ? ~ (offsetT) 0 : 0;
       is_unsigned = 
# 2032 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2032 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_le:
       resultP->X_add_number =
  resultP->X_add_number <= v ? ~ (offsetT) 0 : 0;
       is_unsigned = 
# 2037 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2037 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_ge:
       resultP->X_add_number =
  resultP->X_add_number >= v ? ~ (offsetT) 0 : 0;
       is_unsigned = 
# 2042 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2042 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_gt:
       resultP->X_add_number =
  resultP->X_add_number > v ? ~ (offsetT) 0 : 0;
       is_unsigned = 
# 2047 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    0
# 2047 "/doner/binutils/binutils-515f23e/gas/expr.c"
                         ;
       break;
     case O_logical_and:
       resultP->X_add_number = resultP->X_add_number && v;
       is_unsigned = 
# 2051 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    1
# 2051 "/doner/binutils/binutils-515f23e/gas/expr.c"
                        ;
       break;
     case O_logical_or:
       resultP->X_add_number = resultP->X_add_number || v;
       is_unsigned = 
# 2055 "/doner/binutils/binutils-515f23e/gas/expr.c" 3 4
                    1
# 2055 "/doner/binutils/binutils-515f23e/gas/expr.c"
                        ;
       break;
     }
 }
   ...
   if (op_left == O_add)
   ...
   else if (op_left == O_subtract)
     {
       subtract_from_result (resultP, right.X_add_number,
        right.X_extrabit);
       if (retval == rightseg
    && ( (retval) != (&_bfd_std_section[2]) && (retval) != (&_bfd_std_section[1]) && (retval) != reg_section && (retval) != expr_section)
    && !S_FORCE_RELOC (resultP->X_add_symbol, 0)
    && !S_FORCE_RELOC (right.X_add_symbol, 0))
  {
    retval = (&_bfd_std_section[2]);
    rightseg = (&_bfd_std_section[2]);
  }
     }
 }
      else
      ...
      if (retval != rightseg)
 {
   if (retval == (&_bfd_std_section[1]))
     ;
   else if (rightseg == (&_bfd_std_section[1]))
     retval = rightseg;
     ...
     retval = rightseg;
   else if (rightseg == (&_bfd_std_section[2]))
     ;
   else if (retval == (&_bfd_std_section[2]))
     retval = rightseg;
     ...
     as_bad (gettext ("operation combines symbols in different segments"));
 }
  ...
  return resultP->X_op == O_constant ? (&_bfd_std_section[2]) : retval;
}
...
# 2256 "/doner/binutils/binutils-515f23e/gas/expr.c"
      frag_off = 0;
      if (!(seg_left == (&_bfd_std_section[2])
  ...
  || op == O_lt || op == O_le || op == O_ge || op == O_gt)
     ...
     || (op == O_gt
        ...
        && (seg_left != (&_bfd_std_section[1]) || add_symbol == op_symbol)))
 {
   if ((seg_left == (&_bfd_std_section[2]) && left == 0)
       || (seg_right == (&_bfd_std_section[2]) && right == 0))
     {
       if (op == O_bit_exclusive_or || op == O_bit_inclusive_or)
  {
    if (!(seg_right == (&_bfd_std_section[2]) && right == 0))
      {
        seg_left = seg_right;
        left = right;
        add_symbol = op_symbol;
       ...
       else if (op == O_left_shift || op == O_right_shift)
  {
    if (!(seg_left == (&_bfd_std_section[2]) && left == 0))
     ...
     && seg_left == (&_bfd_std_section[2]) && left == 1)
     {
       seg_left = seg_right;
       left = right;
       add_symbol = op_symbol;
     ...
     && seg_right == (&_bfd_std_section[2]) && right == 1)
     {
       op = O_symbol;
       break;
     }
 ...
 default: as_abort ("/doner/binutils/binutils-515f23e/gas/expr.c", 2386, __PRETTY_FUNCTION__);
 }
...
# 2456 "/doner/binutils/binutils-515f23e/gas/expr.c"
char
get_symbol_name (char ** ilp_return)
{
  ...
  * ilp_return = input_line_pointer;
  ...
  if (( lex_type[(unsigned char) (c = *input_line_pointer++)] & (2) )
      ...
      for (;;)
 {
   ...
   if (c == 0)
     {
       as_warn (gettext ("missing closing '\"'"));
       break;
     }
  ...
  break;
       ...
       default:
  if (c != 0)
    as_warn (gettext ("'\\%c' in quoted symbol name; " "behavior may change in the future")
                                            ,
      *input_line_pointer);
  break;
       }
