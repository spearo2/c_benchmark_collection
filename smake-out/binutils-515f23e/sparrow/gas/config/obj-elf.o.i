# 1 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
# 22 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
# 1 "./as.h" 1
# 37 "./as.h"
# 1 "./config.h" 1
# 38 "./as.h" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 2
# 1 "./subsegs.h" 1
# 40 "./subsegs.h"
...
# 25 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 2
# 52 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
...
R_X86_64_max };
# 53 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 2
# 67 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
...
static const pseudo_typeS elf_pseudo_table[] =
{
  ...
  {"internal", obj_elf_visibility, 1},
  {"hidden", obj_elf_visibility, 2},
  {"protected", obj_elf_visibility, 3},
  ...
  {
# 139 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
  ((void *)0)
# 139 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
      , 
# 139 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
        ((void *)0)
# 139 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
...
{
# 185 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
  {
# 185 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
  ((void *)0)
# 185 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
      , 
# 185 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
...
# 190 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 2
...
{
  return (((elf_symbol_type *) (&(symbol_get_bfdsym (sym))->the_bfd))->internal_elf_sym.st_size);
}

static void
elf_s_set_size (symbolS *sym, bfd_vma sz)
{
  (((elf_symbol_type *) (&(symbol_get_bfdsym (sym))->the_bfd))->internal_elf_sym.st_size = (sz));
}

static bfd_vma
elf_s_get_align (symbolS *sym)
{
  return (((elf_symbol_type *) (&(symbol_get_bfdsym (sym))->the_bfd))->internal_elf_sym.st_value);
}
...
{
  return ((elf_symbol_type *) (&(symbol_get_bfdsym (sym))->the_bfd))->internal_elf_sym.st_other;
}

static void
elf_s_set_other (symbolS *sym, int other)
{
  (((elf_symbol_type *) (&(symbol_get_bfdsym (sym))->the_bfd))->internal_elf_sym.st_other = (other));
}
...
{
  asymbol *bsym;
  symbolS *sym = symbol_new (s, (&_bfd_std_section[2]), &zero_address_frag, 0);
  size_t name_length = strlen (s);

  if (name_length > strlen (S_GET_NAME (sym)))
    {
      __extension__ ({ struct obstack *__o = (&notes); size_t __len = (name_length + 1); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); memcpy (__o->next_free, s, __len); __o->next_free += __len; (void) 0; });
      S_SET_NAME (sym, (const char *) __extension__ ({ struct obstack *__o1 = (&notes); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = (sizeof (ptrdiff_t) < sizeof (void *) ? ((__o1->object_base) + (((__o1->next_free) - (__o1->object_base) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))) : (char *) (((ptrdiff_t) (__o1->next_free) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }));
    }
  else
    strcpy ((char *) S_GET_NAME (sym), s);

  symbol_get_bfdsym (sym)->flags |= (1 << 14);

  if (symbol_rootP != sym
      && ((bsym = symbol_get_bfdsym (symbol_rootP)) == 
# 261 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                                      ((void *)0)
   
# 262 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
  || (bsym->flags & (1 << 14)) == 0))
    {
      symbol_remove (sym, &symbol_rootP, &symbol_lastP);
      symbol_insert (sym, symbol_rootP, &symbol_rootP, &symbol_lastP);
    }
# 275 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
}
...
symbolS *
elf_common_parse (int ignore __attribute__ ((__unused__)), symbolS *symbolP, addressT size)
{
  addressT align = 0;
  ...
  if (*input_line_pointer++ == '"')
    break;
       ...
       *input_line_pointer = '\0';
       as_bad (gettext ("bad .common segment %s"), p);
       *input_line_pointer = c;
       ignore_rest_of_line ();
       return 
# 320 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             ((void *)0)
# 320 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                 ;
     }
      ...
      else
 {
   ...
   if (align == (addressT) -1)
     return 
# 330 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
           ((void *)0)
# 330 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
               ;
 }
    }
  ...
  if (is_local)
  ...
  else
    {
      ...
      (((elf_symbol_type *) (&(symbol_get_bfdsym (symbolP))->the_bfd))->internal_elf_sym.st_value = (align));
      S_SET_EXTERNAL (symbolP);
      S_SET_SEGMENT (symbolP, elf_com_section_ptr);
    }

  symbol_get_bfdsym (symbolP)->flags |= (1 << 16);
...
static void
obj_elf_tls_common (int ignore __attribute__ ((__unused__)))
{
  symbolS *symbolP = s_comm_internal (0, elf_common_parse);

  if (symbolP)
    symbol_get_bfdsym (symbolP)->flags |= (1 << 18);
}

static void
obj_elf_lcomm (int ignore __attribute__ ((__unused__)))
{
...
get_sym_from_input_line_and_check (void)
{
  ...
  *input_line_pointer = c;
  ...
  if (name == input_line_pointer)
    as_bad (gettext ("Missing symbol name in directive"));
  return sym;
}

static void
obj_elf_local (int ignore __attribute__ ((__unused__)))
{
  int c;
  symbolS *symbolP;
...
static void
obj_elf_weak (int ignore __attribute__ ((__unused__)))
{
  int c;
  symbolS *symbolP;
  ...
  do
    {
      ...
      elfsym = ((((bfdsym)->flags & (1 << 21)) == 0 && (bfdsym)->the_bfd != 
# 457 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
              ((void *)0) 
# 457 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
              && (bfdsym)->the_bfd->xvec->flavour == bfd_target_elf_flavour && (bfdsym)->the_bfd->tdata.elf_obj_data != 0) ? (elf_symbol_type *) (bfdsym) : 0);

      ((void) ((elfsym) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/config/obj-elf.c", 459, __PRETTY_FUNCTION__), 0)));
...
static 
# 497 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
      _Bool

# 498 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
get_section_by_match (bfd *abfd __attribute__ ((__unused__)), asection *sec, void *inf)
{
  ...
  unsigned int sh_info = ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_hdr.sh_info;
  bfd_vma sh_flags = (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_hdr.sh_flags
        & (1 << 21));

  return (sh_info == match->sh_info
   && sh_flags == match->sh_flags
   && ((bfd_section_flags (sec) & 0x100000)
        == (match->flags & 0x100000))
   && sec->section_id == match->section_id
   && (group_name == gname
       || (group_name != 
# 515 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                        ((void *)0)
    
# 516 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
   && gname != 
# 516 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
               ((void *)0)
    
# 517 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
   && strcmp (group_name, gname) == 0))
   && (linked_to_symbol_name == match->linked_to_symbol_name
       || (linked_to_symbol_name != 
# 519 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                   ((void *)0)
    
# 520 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
   && match->linked_to_symbol_name != 
# 520 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                      ((void *)0)
    
# 521 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
   && strcmp (linked_to_symbol_name,
        match->linked_to_symbol_name) == 0)));
}
# 543 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
void
   ...
   int push)
{
  ...
  if (match_p == 
# 558 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                ((void *)0)
# 558 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                    )
    {
  ...
  bed = ((const struct elf_backend_data *) ((stdoutput)->xvec)->backend_data);
  ssect = (*bed->get_sec_type_attr) (stdoutput, sec);

  if (ssect != 
# 596 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
              ((void *)0)
# 596 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                  )
    {
      
# 598 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
     _Bool 
# 598 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
          override = 
# 598 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                     0
# 598 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
 ...
 {
   if (old_sec == 
# 604 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                 ((void *)0)
# 617 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
       
# 617 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
      && (bed->s->arch_size != 64
    || !(ssect->attr & 0x10000000))
    ...
    && type < 0x70000000)
  as_warn (gettext ("setting incorrect section type for %s"),
    name);
     }
   else
     {
       as_warn (gettext ("ignoring incorrect section type for %s"),
         name);
       type = ssect->type;
     }
 }
      ...
      if (old_sec == 
# 639 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                    ((void *)0) 
# 639 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                         && ((attr & ~((1 << 7)
     | 0x0FF00000
     | 0xF0000000))
         & ~ssect->attr) != 0)
 {
   ...
   if (((stdoutput) -> tdata.elf_obj_data)->has_gnu_osabi)
     generic_attr &= ~(1 << 21);
   ...
   else if (generic_attr == (1 << 1)
     && (strcmp (name, ".interp") == 0
         || strcmp (name, ".strtab") == 0
         || strcmp (name, ".symtab") == 0))
     override = 
# 671 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
               1
# 671 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                   ;

   else if (generic_attr == (1 << 2)
     && strcmp (name, ".note.GNU-stack") == 0)
     override = 
# 675 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
               1
# 675 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                   ;
# 689 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
   else
     {
       if (match_p->group_name == 
# 691 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                 ((void *)0)
# 691 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                     )
  as_warn (gettext ("setting incorrect section attributes for %s"),
    name);
       override = 
# 694 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                 1
# 694 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                     ;
     }
 }

      if (!override && old_sec == 
# 698 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                 ((void *)0)
# 698 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                     )
 attr |= ssect->attr;
    }
  ...
  flags = (0x4
    | ((attr & (1 << 0)) ? 0 : 0x8)
    | ((attr & (1 << 1)) ? 0x1 : 0)
    | (((attr & (1 << 1)) && type != 8) ? 0x2 : 0)
    | ((attr & (1 << 2)) ? 0x10 : 0)
    | ((attr & (1 << 4)) ? 0x800000 : 0)
    | ((attr & (1 << 5)) ? 0x1000000 : 0)
    | ((attr & 0x80000000) ? 0x8000: 0)
    | ((attr & (1 << 10)) ? 0x400 : 0));
  ...
  if ((flags & 0x1) == 0 && name [0] == '.')
    {
      if ( startswith (name, ".debug")
   || startswith (name, ".zdebug")
   || startswith (name, ".gnu.debuglto_.debug_")
   || startswith (name, ".gnu.linkonce.wi.")
   || startswith (name, ".gnu.build.attributes")
   || startswith (name, ".note.gnu"))
 flags |= 0x40000000;
    }

  if (old_sec == 
# 735 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                ((void *)0)
# 735 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                    )
    {
      symbolS *secsym;
 ...
 type = bfd_elf_get_default_section_type (flags);
      (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_hdr.sh_type) = type;
      (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_hdr.sh_flags) = attr;
      ((struct bfd_elf_section_data*)(sec)->used_by_bfd)->this_hdr.sh_info = match_p->sh_info;


      if (type == 8)
 ((segment_info_type *) bfd_section_userdata (sec))->bss = 1;
 ...
 = match_p->linked_to_symbol_name;
      ...
      if (flags & 0x800000)
 sec->entsize = entsize;
      (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->group.name) = match_p->group_name;


      secsym = symbol_find (name);
      if (secsym != 
# 764 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                   ((void *)0)
# 764 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                       )
 {
 ...
 symbol_table_insert (section_symbol (sec));
    ...
    {
      if (type != 0
   && (unsigned) type != (((struct bfd_elf_section_data*)(old_sec)->used_by_bfd)->this_hdr.sh_type))
 {
   if (ssect != 
# 781 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
               ((void *)0)
# 781 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                   )




     as_warn (gettext ("ignoring changed section type for %s"), name);
   else

     as_bad (gettext ("changed section type for %s"), name);
 }
      ...
      if (attr != 0)
 {
   ...
   if (((old_sec->flags ^ flags)
        & (0x1 | 0x2 | 0x8 | 0x10
    | 0x8000 | 0x10000 | 0x800000 | 0x1000000
    | 0x20000 | 0x0
    | 0x400)))
     {
       if (ssect != 
# 803 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                   ((void *)0)
# 803 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                       )
  as_warn (gettext ("ignoring changed section attributes for %s"), name);
       else
  as_bad (gettext ("changed section attributes for %s"), name);
     }
   else
   ...
   if ((flags & 0x800000) && old_sec->entsize != (unsigned) entsize)
     as_bad (gettext ("changed section entity size for %s"), name);
 }
    }
...
# 825 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
         _Bool 
# 825 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
              *is_clone, bfd_vma *gnu_attr)
{
  bfd_vma attr = 0;
  *is_clone = 
# 828 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             0
# 828 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                  ;
 ...
 case '?':
   *is_clone = 
# 879 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
              1
# 879 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                  ;
   break;
 default:
   {
     const char *bad_msg = gettext ("unrecognized .section attribute:" " want a,e,o,w,x,M,S,G,T or number")
                                            ;

     bfd_vma md_attr = x86_64_section_letter (*str, &bad_msg);
       ...
       if ((_sch_istable[(*str) & 0xff] & (unsigned short)(_sch_isdigit)))
  {
    ...
    bed = (struct elf_backend_data *)
      ((const struct elf_backend_data *) ((stdoutput)->xvec)->backend_data);
    ...
    if (bed->elf_osabi == 0
        ...
        || bed->elf_osabi == 9)
      {
# 917 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
        *gnu_attr |= (numeric_flags & 0x0FF00000);
      }
...
# 938 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                            _Bool 
# 938 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                                 warn)
{
  ...
  {
    int md_type = i386_elf_section_type (str, len);
    if (md_type >= 0)
      return md_type;
  }
 ...
 as_warn (gettext ("extraneous characters at end of numeric section type"));

      return type;
    }

  if (warn)
    as_warn (gettext ("unrecognized section type"));
  return 0;
}
# 1013 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
const char *
  ...
  if (*input_line_pointer == '"')
    {
      ...
      if (name == 
# 1024 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                 ((void *)0)
# 1024 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                     )
 {
   ignore_rest_of_line ();
   return 
# 1027 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
         ((void *)0)
# 1027 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
             ;
 }
    }
  else
 ...
 {
   as_bad (gettext ("missing name"));
   ignore_rest_of_line ();
   return 
# 1040 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
         ((void *)0)
# 1040 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
             ;
 }

      __extension__ ({ struct obstack *__o = (&notes); size_t __len = (end - input_line_pointer); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len + 1) _obstack_newchunk (__o, __len + 1); memcpy (__o->next_free, input_line_pointer, __len); __o->next_free += __len; *(__o->next_free)++ = 0; (void) 0; });
      name = ((void *) (&notes)->object_base);
   ...
   if (subst && subst[1] == 'S')
     {
       ...
       if (slen > 2)
  {
    __extension__ ({ struct obstack *__o = (&notes); size_t __len = (slen - 2); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); });
    name = ((void *) (&notes)->object_base);
  }
...
static void
obj_elf_attach_to_group (int dummy __attribute__ ((__unused__)))
{
  const char * gname = obj_elf_section_name ();

  if (gname == 
# 1083 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
              ((void *)0)
# 1083 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                  )
    {
      as_warn (gettext ("group name not parseable"));
      return;
    }

  if ((((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->group.name))
    {
      as_warn (gettext ("section %s already has a group (%s)"),
        bfd_section_name (now_seg), (((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->group.name));
      return;
    }

  (((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->group.name) = gname;
  (((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->this_hdr.sh_flags) |= (1 << 9);
}
...
obj_elf_section (int push)
{
  ...
  if (name == 
# 1134 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             ((void *)0)
# 1134 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                 )
    return;
  ...
  symbolS * sym;
  if ((sym = symbol_find (name)) != 
# 1140 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                   ((void *)0)
      
# 1141 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
     && ! symbol_section_p (sym)
      && S_IS_DEFINED (sym)
      && ! S_IS_VOLATILE (sym)
      && ! S_CAN_BE_REDEFINED (sym))
    {
      as_bad (gettext ("section name '%s' already defined as another symbol"), name);
      ignore_rest_of_line ();
      return;
    }
  type = 0;
  ...
  if (*input_line_pointer == ',')
    {
      ...
      if (push && (_sch_istable[(*input_line_pointer) & 0xff] & (unsigned short)(_sch_isdigit)))
 {
...
# 1180 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
  _Bool 
# 1180 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
       is_clone;

   beg = demand_copy_C_string (&dummy);
   if (beg == 
# 1183 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             ((void *)0)
# 1183 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                 )
     {
       ignore_rest_of_line ();
       return;
       ...
       if (c == '"')
  {
    beg = demand_copy_C_string (&dummy);
    if (beg == 
# 1203 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
              ((void *)0)
# 1203 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                  )
      {
        ignore_rest_of_line ();
        return;
...
# 1208 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                                   1
# 1208 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                                       );
  }
       else if (c == '@' || c == '%')
  {
...
# 1222 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
        1
# 1222 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
            );
      }
  }
       else
  input_line_pointer = save;
   ...
   ((*input_line_pointer == ' ') ? ++input_line_pointer : 0);
   if ((attr & (1 << 4)) != 0 && *input_line_pointer == ',')
     {
       ++input_line_pointer;
       ((*input_line_pointer == ' ') ? ++input_line_pointer : 0);
       ...
       if (entsize < 0)
  {
    as_warn (gettext ("invalid merge entity size"));
    attr &= ~(1 << 4);
    entsize = 0;
  }
     }
     ...
     {
       as_warn (gettext ("entity size for SHF_MERGE not specified"));
       attr &= ~(1 << 4);
     }

   if ((attr & (1 << 7)) != 0 && *input_line_pointer == ',')
     {
       ++input_line_pointer;
       ((*input_line_pointer == ' ') ? ++input_line_pointer : 0);
       ...
       else
  {
   ...
   if ((attr & (1 << 9)) != 0 && is_clone)
     {
       as_warn (gettext ("? section flag ignored with G present"));
       is_clone = 
# 1274 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                 0
# 1274 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                      ;
     }

   if ((attr & (1 << 9)) != 0 && *input_line_pointer == ',')
     {
       ++input_line_pointer;
       match.group_name = obj_elf_section_name ();
       if (match.group_name == 
# 1281 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                              ((void *)0)
# 1281 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                  )
  attr &= ~(1 << 9);
  ...
  linkonce = 1;
     ...
     {
       as_warn (gettext ("group name for SHF_GROUP not specified"));
       attr &= ~(1 << 9);
     }

   if (is_clone)
     {
       const char *now_group = (((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->group.name);
       if (now_group != 
# 1305 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                       ((void *)0)
# 1305 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                           )
  {
    match.group_name = now_group;
    linkonce = (now_seg->flags & 0x20000) != 0;
  }
     }

   if ((gnu_attr & 0x01000000) != 0 && *input_line_pointer == ',')
     {
       char *save = input_line_pointer;
       ++input_line_pointer;
       ((*input_line_pointer == ' ') ? ++input_line_pointer : 0);
       if ((_sch_istable[(* input_line_pointer) & 0xff] & (unsigned short)(_sch_isdigit)))
  {
    ...
    if (match.sh_info == (unsigned int) -1)
      {
        as_warn (gettext ("unsupported mbind section info: %s"), t);
        match.sh_info = 0;
      }
  }
       else
...
# 1352 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
    _Bool 
# 1352 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
         overflow;
     char *t = input_line_pointer;
     if (sizeof (bfd_vma) <= sizeof (unsigned long))
       {
         
# 1356 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
        (*__errno_location ()) 
# 1356 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
              = 0;
         id = strtoul (input_line_pointer,
         &input_line_pointer, 0);
         overflow = (id == (unsigned long) -1
       && 
# 1360 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
         (*__errno_location ()) 
# 1360 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
               == 
# 1360 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                  34
# 1360 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
...
# 1372 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                             ((void *)0)
# 1372 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                                 )
    {
      saved_char = *linefeed;
      *linefeed = '\0';
    }
         as_bad (gettext ("unsupported section id: %s"), t);
         if (saved_char)
    *linefeed = saved_char;
       }
     else
...
# 1420 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
    }

 done:
  demand_empty_rest_of_line ();

  if ((gnu_attr & (0x01000000 | (1 << 21))) != 0)
    {
      const struct elf_backend_data *bed;
      
# 1428 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
     _Bool 
# 1428 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
          mbind_p = (gnu_attr & 0x01000000) != 0;

      if (mbind_p && (attr & (1 << 1)) == 0)
 as_bad (gettext ("SHF_ALLOC isn't set for GNU_MBIND section: %s"), name);
   ...
   && bed->elf_osabi != 9
   && bed->elf_osabi != 0)
 as_bad (gettext ("%s section is supported only by GNU and FreeBSD targets"),
  mbind_p ? "GNU_MBIND" : "GNU_RETAIN");
      else
 {
   if (mbind_p)
     ((stdoutput) -> tdata.elf_obj_data)->has_gnu_osabi |= elf_gnu_osabi_mbind;
   if ((gnu_attr & (1 << 21)) != 0)
     ((stdoutput) -> tdata.elf_obj_data)->has_gnu_osabi |= elf_gnu_osabi_retain;
  ...
  if (linked_to_section_index != -1UL)
    {
      (((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->this_hdr.sh_flags) |= (1 << 7);
      ((struct bfd_elf_section_data*)(now_seg)->used_by_bfd)->this_hdr.sh_link = linked_to_section_index;
...
void
obj_elf_bss (int i __attribute__ ((__unused__)))
{
  int temp;
...
static void
obj_elf_subsection (int ignore __attribute__ ((__unused__)))
{
  int temp;
...
void
obj_elf_previous (int ignore __attribute__ ((__unused__)))
{
  segT new_section;
  int new_subsection;
  ...
  if (previous_section == 0)
    {
      as_warn (gettext (".previous without corresponding .section; ignored"));
      return;
    }
...
static void
obj_elf_popsection (int xxx __attribute__ ((__unused__)))
{
  struct section_stack *top = section_stack;

  if (top == 
# 1603 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
            ((void *)0)
# 1603 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                )
    {
      as_warn (gettext (".popsection without corresponding .pushsection; ignored"));
      return;
    }
...
static void
obj_elf_line (int ignore __attribute__ ((__unused__)))
{


  new_logical_line (
# 1629 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                   ((void *)0)
# 1629 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
         ...
         struct elf_obj_sy *sy_obj)
{
  ...
  if (0 && *p == '\0')
    {
      as_bad (gettext ("missing version name in `%s' for symbol `%s'"),
       version_name, sym_name);
      return 
# 1651 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
            ((void *)0)
# 1651 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                ;
    }
      ...
      if (sy_obj->rename)
 {
   if (strcmp (versioned_name->name, version_name) == 0)
     ...
     {
       as_bad (gettext ("only one version name with `@@@' is allowed " "for symbol `%s'")
                     , sym_name);
       return 
# 1670 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             ((void *)0)
# 1670 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                 ;
     }
 }
      sy_obj->rename = 
# 1673 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                      1
# 1673 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                          ;
      break;
    default:
      as_bad (gettext ("invalid version name '%s' for symbol `%s'"),
       version_name, sym_name);
      return 
# 1678 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
            ((void *)0)
# 1678 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                ;
    }

  for (;
       versioned_name != 
# 1682 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                        ((void *)0)
# 1682 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                            ;
...
static void
obj_elf_symver (int ignore __attribute__ ((__unused__)))
{
  char *name;
  const char *sym_name;
  char c;
  ...
  if (*input_line_pointer != ',')
    {
      as_bad (gettext ("expected comma after name in .symver"));
      ignore_rest_of_line ();
      return;
    }
  ...
  if (S_IS_COMMON (sym))
    {
      as_bad (gettext ("`%s' can't be versioned to common symbol '%s'"),
       name, sym_name);
      ignore_rest_of_line ();
      return;
    }
  ...
  p = strchr (name, '@');
  if (p == 
# 1742 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
          ((void *)0)
# 1742 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
              )
    {
      as_bad (gettext ("missing version name in `%s' for symbol `%s'"),
       name, sym_name);
  ...
  if (obj_elf_find_and_add_versioned_name (name, sym_name,
        p, sy_obj) == 
# 1752 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                     ((void *)0)
# 1752 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                         )
    {
      sy_obj->bad_version = 
# 1754 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                           1
# 1754 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                               ;
      ignore_rest_of_line ();
      return;
    }
...
obj_elf_get_vtable_inherit (void)
{
  ...
  if (csym == 
# 1810 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             ((void *)0) 
# 1810 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
...
# 1810 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
    ...
    {
      as_bad (gettext ("expected `%s' to have already been set for .vtable_inherit"),
       cname);
      bad = 1;
    }
  ...
  *input_line_pointer = c;
  ...
  if (*input_line_pointer != ',')
    {
      as_bad (gettext ("expected comma after name in .vtable_inherit"));
      ignore_rest_of_line ();
      return 
# 1824 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
            ((void *)0)
# 1824 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                ;
    }
  ...
  if (input_line_pointer[0] == '0'
   ...
   || (_sch_istable[(input_line_pointer[1]) & 0xff] & (unsigned short)(_sch_isspace))))
    {
      psym = section_symbol ((&_bfd_std_section[2]));
      ++input_line_pointer;
    }
  else
    {
  ...
  if (bad)
    return 
# 1850 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
          ((void *)0)
# 1850 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
              ;

  ((void) ((symbol_get_value_expression (csym)->X_op == O_constant) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/config/obj-elf.c", 1852, __PRETTY_FUNCTION__), 0)));
...
void
obj_elf_vtable_inherit (int ignore __attribute__ ((__unused__)))
{
...
obj_elf_get_vtable_entry (void)
{
  ...
  if (*input_line_pointer != ',')
    {
      as_bad (gettext ("expected comma after name in .vtable_entry"));
      ignore_rest_of_line ();
      return 
# 1885 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
            ((void *)0)
# 1885 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                ;
    }
...
void
obj_elf_vtable_entry (int ignore __attribute__ ((__unused__)))
{
...
record_attribute (int vendor, unsigned int tag)
{
 ...
 return;
  ...
  rai = ((struct recorded_attribute_info *) xmalloc (sizeof (struct recorded_attribute_info)));
...
# 1965 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
_Bool

# 1966 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
obj_elf_seen_attribute (int vendor, unsigned int tag)
{
  ...
  return 
# 1977 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
        0
# 1977 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
             ;
}
...
obj_elf_vendor_attribute (int vendor)
{
  ...
  unsigned int i = 0;
  char *s = 
# 1990 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
           ((void *)0)
# 1990 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
               ;
 ...
 goto bad;
  ...
  else
    {
      ...
      for (; (_sch_istable[(*input_line_pointer) & 0xff] & (unsigned short)(_sch_isalnum)) || *input_line_pointer == '_';
    ++input_line_pointer)
 i++;
      if (i == 0)
 goto bad;
      ...
      if (tag == -1)
 {
   as_bad (gettext ("Attribute name not recognised: %s"), name);
   ignore_rest_of_line ();
   free (name);
   return 0;
 }
  ...
  if (skip_past_char (&input_line_pointer, ',') == -1)
    goto bad;
  if (type & 1)
    {
      expr (0, & exp, expr_normal);
      if (exp.X_op != O_constant)
 {
   as_bad (gettext ("expected numeric constant"));
   ignore_rest_of_line ();
   return 0;
 }
      i = exp.X_add_number;
  ...
  if ((type & 3) == 3
      && skip_past_char (&input_line_pointer, ',') == -1)
    {
      as_bad (gettext ("expected comma"));
      ignore_rest_of_line ();
      return 0;
    }
  if (type & 2)
 ...
 goto bad_string;
  ...
  switch (type & 3)
    ...
    case 1:
      ...
      break;
    default:
      as_abort ("/doner/binutils/binutils-515f23e/gas/config/obj-elf.c", 2075, __PRETTY_FUNCTION__);
    }

  demand_empty_rest_of_line ();
  return tag;
 bad_string:
  as_bad (gettext ("bad string constant"));
  ignore_rest_of_line ();
  return 0;
 bad:
  as_bad (gettext ("expected <tag> , <value>"));
  ignore_rest_of_line ();
  return 0;
}
...
static void
obj_elf_gnu_attribute (int ignored __attribute__ ((__unused__)))
{
  obj_elf_vendor_attribute (1);
}
...
elf_obj_symbol_new_hook (symbolS *symbolP)
{
  ...
  sy_obj->size = 
# 2113 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                ((void *)0)
# 2113 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                    ;
  sy_obj->versioned_name = 
# 2114 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                          ((void *)0)
# 2114 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                              ;
...
void
elf_obj_symbol_clone_hook (symbolS *newsym, symbolS *orgsym __attribute__ ((__unused__)))
{
...
elf_copy_symbol_attributes (symbolS *dest, symbolS *src)
{
  ...
  if (!destelf->size && (((elf_symbol_type *) (&(symbol_get_bfdsym (dest))->the_bfd))->internal_elf_sym.st_size) == 0)
    {
      if (srcelf->size)
 {
   ...
   *destelf->size = *srcelf->size;
      ...
      (((elf_symbol_type *) (&(symbol_get_bfdsym (dest))->the_bfd))->internal_elf_sym.st_size = ((((elf_symbol_type *) (&(symbol_get_bfdsym (src))->the_bfd))->internal_elf_sym.st_size)));
    }

  (((elf_symbol_type *) (&(symbol_get_bfdsym (dest))->the_bfd))->internal_elf_sym.st_other = (((((elf_s_get_other (dest))) & 0x3) | ((elf_s_get_other (src)) & ~((-1) & 0x3)))))
                                                         ;
}

void
obj_elf_version (int ignore __attribute__ ((__unused__)))
{
  char *name;
  unsigned int c;
  char *p;
  ...
  asection *note_secp = 
# 2170 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                       ((void *)0)
# 2170 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                           ;
 ...
 ;
      ...
      *input_line_pointer = c;
      ...
      bfd_set_section_flags (note_secp, 0x100 | 0x8);
      ...
      number_to_chars_littleendian (p, i_note.namesz, sizeof (e_note.namesz));
      p = frag_more (sizeof (e_note.descsz));
      number_to_chars_littleendian (p, i_note.descsz, sizeof (e_note.descsz));
      p = frag_more (sizeof (e_note.type));
      number_to_chars_littleendian (p, i_note.type, sizeof (e_note.type));
      p = frag_more (len);
      memcpy (p, name, len);
    ...
    as_bad (gettext ("expected quoted string"));

  demand_empty_rest_of_line ();
}

static void
obj_elf_size (int ignore __attribute__ ((__unused__)))
{
  char *name;
  ...
  *p = c;
  ...
  if (*input_line_pointer != ',')
    {
      *p = 0;
      as_bad (gettext ("expected comma after name `%s' in .size directive"), name);
      *p = c;
      ignore_rest_of_line ();
      return;
    }
  ...
  if (exp.X_op == O_absent)
    {
      as_bad (gettext ("missing expression in .size directive"));
      exp.X_op = O_constant;
      exp.X_add_number = 0;
    }
  *p = 0;
  ...
  *p = c;
  if (exp.X_op == O_constant)
    {
      (((elf_symbol_type *) (&(symbol_get_bfdsym (sym))->the_bfd))->internal_elf_sym.st_size = (exp.X_add_number));
      free (symbol_get_obj (sym)->size);
      symbol_get_obj (sym)->size = 
# 2254 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                  ((void *)0)
# 2254 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                      ;
    }
  else
    {
      symbol_get_obj (sym)->size = ((expressionS *) xmalloc (sizeof (expressionS)));
      *symbol_get_obj (sym)->size = exp;
    }
  demand_empty_rest_of_line ();
}
# 2282 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
static char *
...
static void
obj_elf_type (int ignore __attribute__ ((__unused__)))
{
  char c;
  int type;
      ...
      if (! S_IS_COMMON (sym))
 {
   ...
   && bed->elf_osabi != 3
   && bed->elf_osabi != 9)
 as_bad (gettext ("symbol type \"%s\" is supported only by GNU " "and FreeBSD targets")
                          , type_name);

      else if (bed->target_id == MIPS_ELF_DATA)
 as_bad (gettext ("symbol type \"%s\" is not supported by " "MIPS targets")
                                   , type_name);
      ((stdoutput) -> tdata.elf_obj_data)->has_gnu_osabi |= elf_gnu_osabi_ifunc;
      type = (1 << 3) | (1 << 22);
    }
  else if (strcmp (type_name, "gnu_unique_object") == 0)
    {
      ...
      if (bed->elf_osabi != 0
   && bed->elf_osabi != 3)
 as_bad (gettext ("symbol type \"%s\" is supported only by GNU targets"),
  type_name);
      ((stdoutput) -> tdata.elf_obj_data)->has_gnu_osabi |= elf_gnu_osabi_unique;
      type = (1 << 16) | (1 << 23);
    }
    ...
    as_bad (gettext ("unrecognized symbol type \"%s\""), type_name);
      ...
      if (type != (1 << 16))
 {
   ...
   if (S_IS_COMMON (sym))
     {
       as_bad (gettext ("cannot change type of common symbol '%s'"),
        S_GET_NAME (sym));
       mask = type = 0;
     }
 }
      ...
      if (type)
 {
   ...
   if (new != (elfsym->symbol.flags | type))
     as_warn (gettext ("symbol '%s' already has its type set"), S_GET_NAME (sym));
...
static void
obj_elf_ident (int ignore __attribute__ ((__unused__)))
{
  ...
  if (!comment_section)
    {
      ...
      bfd_set_section_flags (comment_section, (0x8 | 0x100
            | 0x800000 | 0x1000000));
...
obj_elf_init_stab_section (segT seg)
{
  ...
  memset (p, 0, 12);
  file = remap_debug_filename (as_where (
# 2503 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                        ((void *)0)
# 2503 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                            ));
  stabstr_name = concat (bfd_section_name (seg), "str", (char *) 
# 2504 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                                            ((void *)0)
# 2504 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                                                );
  stroff = get_stab_string_offset (file, stabstr_name, 
# 2505 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                                      1
# 2505 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                                          );
  ((void) ((stroff == 1 || (stroff == 0 && file[0] == '\0')) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/config/obj-elf.c", 2506, __PRETTY_FUNCTION__), 0)));
  number_to_chars_littleendian (p, stroff, 4);
  ((segment_info_type *) bfd_section_userdata (seg))->stabu.p = p;
  free (file);
}
...
static void
adjust_stab_sections (bfd *abfd, asection *sec, void *xxx __attribute__ ((__unused__)))
{
  char *name;
  asection *strsec;
  char *p;
  ...
  name = concat (sec->name, "str", 
# 2529 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                  ((void *)0)
# 2529 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                      );
  ...
  p = ((segment_info_type *) bfd_section_userdata (sec))->stabu.p;
  ((void) ((p != 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/config/obj-elf.c", 2538, __PRETTY_FUNCTION__), 0)));

  ((*((abfd)->xvec->bfd_h_putx16)) (nsyms, p + 6));
  ((*((abfd)->xvec->bfd_h_putx32)) (strsz, p + 8));
  free (name);
}
# 2586 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
void
elf_frob_symbol (symbolS *symp, int *puntp)
{
  ...
  size = sy_obj->size;
  if (size != 
# 2601 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
             ((void *)0)
# 2601 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                 )
    {
      if (resolve_expression (size)
   && size->X_op == O_constant)
 (((elf_symbol_type *) (&(symbol_get_bfdsym (symp))->the_bfd))->internal_elf_sym.st_size = (size->X_add_number));
      else
 {
   if (!flag_allow_nonconst_size)
     as_bad (gettext (".size expression for %s " "does not evaluate to a constant")
                                          , S_GET_NAME (symp));
   else
     as_warn (gettext (".size expression for %s " "does not evaluate to a constant")
                                           , S_GET_NAME (symp));
 }
      free (sy_obj->size);
      sy_obj->size = 
# 2616 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                    ((void *)0)
# 2616 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                        ;
    }
 ...
 *puntp = 
# 2629 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
         1
# 2629 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
             ;
      ...
      else if (S_IS_COMMON (symp))
 {
   ...
   *puntp = 
# 2638 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
           1
# 2638 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
               ;
 }
      else
 {
   asymbol *bfdsym;
   elf_symbol_type *elfsym;
# 2656 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
   for (; versioned_name != 
# 2656 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                           ((void *)0)
# 2656 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                               ;
        versioned_name = versioned_name->next)
     {
      ...
      (S_GET_VALUE (symp)
       ...
       (((elf_symbol_type *) (&(symbol_get_bfdsym (symp2))->the_bfd))->internal_elf_sym.st_other = ((elf_s_get_other (symp))));
  ...
  S_SET_EXTERNAL (symp2);
   ...
   switch (sy_obj->visibility)
     ...
     case visibility_hidden:
       ...
       elfsym = ((((bfdsym)->flags & (1 << 21)) == 0 && (bfdsym)->the_bfd != 
# 2690 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
               ((void *)0) 
# 2690 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
               && (bfdsym)->the_bfd->xvec->flavour == bfd_target_elf_flavour && (bfdsym)->the_bfd->tdata.elf_obj_data != 0) ? (elf_symbol_type *) (bfdsym) : 0);
       elfsym->internal_elf_sym.st_other &= ~3;
       elfsym->internal_elf_sym.st_other |= 2;
       break;
...
# 2700 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                       ((void *)0)
# 2700 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                           )
      as_bad (gettext ("symbol '%s' with multiple versions cannot be used in relocation"),
       S_GET_NAME (symp));
  ...
  if (S_IS_WEAK (symp))
    {
      if (S_IS_COMMON (symp))
 as_bad (gettext ("symbol `%s' can not be both weak and common"),
  S_GET_NAME (symp));
    }
}
      ...
      asection *sec, void *inf)
{
 ...
 as_bad (gettext ("undefined linked-to symbol `%s' on section `%s'"),
  sec->map_head.linked_to_symbol_name,
  bfd_section_name (sec));
      else
 (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->linked_to) = S_GET_SEGMENT (linked_to_sym);
    }

  if (group_name == 
# 2774 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                   ((void *)0)
# 2774 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                       )
    return;
  ...
  if (elem_idx != 
# 2780 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                 ((void *)0)
# 2780 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                     )
    {
      (((struct bfd_elf_section_data*)(sec)->used_by_bfd)->next_in_group) = list->head[*elem_idx];
  ...
  if ((i & 127) == 0)
    {
      ...
      list->head = ((asection * *) xrealloc ((void *) (list->head), sizeof (asection *) * (newsize)));
    }
  list->head[i] = sec;
  list->num_group += 1;
...
elf_adjust_symtab (void)
{
  ...
  groups.num_group = 0;
  groups.head = 
# 2820 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
               ((void *)0)
# 2820 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                   ;
  groups.indexes = htab_create_alloc (16, hash_string_tuple, eq_string_tuple,
          free_section_idx, notes_calloc, 
# 2822 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                         ((void *)0)
# 2822 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                             );
 ...
 for (i = 0; i < groups.num_group; i++)
    {
      const char *group_name = (((struct bfd_elf_section_data*)(groups.head[i])->used_by_bfd)->group.name);
      const char *sec_name;
      asection *s;
      flagword flags;
      struct symbol *sy;

      flags = 0x8 | 0x100 | 0x4000 | 0x2000000;
      for (s = groups.head[i]; s != 
# 2839 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                   ((void *)0)
# 2839 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                       ; s = (((struct bfd_elf_section_data*)(s)->used_by_bfd)->next_in_group))
 if ((s->flags ^ flags) & 0x20000)
   {
     flags |= 0x20000 | 0x0;
     if (s != groups.head[i])
       {
  as_warn (gettext ("assuming all members of group `%s' are COMDAT"),
    group_name);
  break;
       }
   }
      ...
      if (s == 
# 2853 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
              ((void *)0)
   
# 2854 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
  || !bfd_set_section_flags (s, flags)
   || !bfd_set_section_alignment (s, 2))
 {
   as_fatal (gettext ("can't create group: %s"),
      bfd_errmsg (bfd_get_error ()));
 }
      (((struct bfd_elf_section_data*)(s)->used_by_bfd)->this_hdr.sh_type) = 17;


      (((struct bfd_elf_section_data*)(s)->used_by_bfd)->next_in_group) = groups.head[i];
      (((struct bfd_elf_section_data*)(groups.head[i])->used_by_bfd)->sec_group) = s;
      ...
      if (!sy || !symbol_on_chain (sy, symbol_rootP, symbol_lastP))
 {
   ...
   symbol_table_insert (sy);
      ...
      (((struct bfd_elf_section_data*)(s)->used_by_bfd)->group.id) = symbol_get_bfdsym (sy);
...
# 2892 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                                                         ((void *)0)
# 2892 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                                                             );
...
elf_frob_file_before_adjust (void)
{
      ...
      for (symp = symbol_rootP; symp; symp = symbol_next (symp))
 {
       ...
       if (!is_defined)
  {
    ...
    if (!sy_obj->rename && p[1] == '@')
      {
        as_bad (gettext ("invalid attempt to declare external " "version name as default in symbol `%s'")
                                             ,
    ...
    if (sy_obj->versioned_name->next)
      {
        as_bad (gettext ("multiple versions [`%s'|`%s'] for " "symbol `%s'")
                  ,
         sy_obj->versioned_name->name,
    ...
    sy_obj->rename = 
# 2952 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                    1
# 2952 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                        ;
  }
     }
  ...
  for (i = 0; i < groups.num_group; i++)
    {
      ...
      size = 4;
      for (s = head; s != 
# 2985 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                         ((void *)0)
# 2985 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                             ; s = (((struct bfd_elf_section_data*)(s)->used_by_bfd)->next_in_group))
 size += (s->flags & 0x4) != 0 ? 8 : 4;

      group = (((struct bfd_elf_section_data*)(head)->used_by_bfd)->sec_group);
      subseg_set (group, 0);
...
# 3065 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
}
...
static void
elf_process_stab (segT sec __attribute__ ((__unused__)),
    int what __attribute__ ((__unused__)),
    const char *string __attribute__ ((__unused__)),
    int type __attribute__ ((__unused__)),
    int other __attribute__ ((__unused__)),
    int desc __attribute__ ((__unused__)))
{
...
elf_begin (void)
{
  ...
  s = bfd_get_section_by_name (stdoutput, ".text");
  symbol_table_insert (section_symbol (s));
  s = bfd_get_section_by_name (stdoutput, ".data");
  symbol_table_insert (section_symbol (s));
  s = bfd_get_section_by_name (stdoutput, ".bss");
  symbol_table_insert (section_symbol (s));
  elf_com_section_ptr = (&_bfd_std_section[0]);
  previous_section = 
# 3124 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                    ((void *)0)
# 3124 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                        ;
  previous_subsection = 0;
  comment_section = 
# 3126 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c" 3 4
                   ((void *)0)
# 3126 "/doner/binutils/binutils-515f23e/gas/config/obj-elf.c"
                       ;
