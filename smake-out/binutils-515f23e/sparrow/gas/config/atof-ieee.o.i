# 1 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
# 21 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
# 1 "./as.h" 1
# 37 "./as.h"
# 1 "./config.h" 1
# 38 "./as.h" 2
...
# 22 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 2



# 25 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
extern FLONUM_TYPE generic_floating_point_number;
# 50 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
  ...
  if (number_of_bits >= bits_left_in_littlenum)
    {
      ...
      if (--littlenums_left)
 {
   bits_left_in_littlenum = (16) - number_of_bits;
   --littlenum_pointer;
   return_value |=
...
unget_bits (int num)
{
  ...
  else if (bits_left_in_littlenum + num > (16))
    {
      bits_left_in_littlenum =
 num - ((16) - bits_left_in_littlenum);
      ++littlenum_pointer;
      ++littlenums_left;
    }
  else
...
{
  as_bad (gettext ("cannot create floating-point number"));
...
# 168 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
char *
    ...
    FLONUM_TYPE * generic_float_info)
{
  ...
  static LITTLENUM_TYPE bits[5 + 5 + 2];
  char *return_value;
  ...
  return_value = str;
  generic_floating_point_number.low = bits + 5;
  generic_floating_point_number.high = 
# 191 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
                                      ((void *)0)
# 191 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
                                          ;
  generic_floating_point_number.leader = 
# 192 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
                                        ((void *)0)
# 192 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
                                            ;
  ...
  memset (bits, '\0', sizeof (LITTLENUM_TYPE) * 5);

  generic_floating_point_number.high
    = generic_floating_point_number.low + precision - 1 + 2;
  ...
  if (atof_generic (&return_value, ".", EXP_CHARS,
      &generic_floating_point_number))
    {
      ...
      return 
# 208 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
            ((void *)0)
# 208 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
                ;
    }
...
# 232 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
char *
atof_ieee (char *str,
    int what_kind,
    LITTLENUM_TYPE *words)
{
  ...
  switch (what_kind)
    ...
    default:
      make_invalid_floating_point_number (words);
      return (
# 286 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
             ((void *)0)
# 286 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
                 );
    }

  return atof_ieee_detail (str, precision, exponent_bits, words, 
# 289 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
                                                                ((void *)0)
# 289 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
                                                                    );
}
...
gen_to_words (LITTLENUM_TYPE *words, int precision, long exponent_bits)
{
 ...
 words[0] = 0x8000;
  ...
  switch (generic_floating_point_number.sign)
    ...
    case 'S': case 's':
      if (0)
 as_warn (gettext ("NaNs are not supported by this target"));

      if (precision == 1)
 {
   if (_sch_toupper[(generic_floating_point_number.sign) & 0xff] != 'S')
     words[0] = 0x7fff;
   else
 ...
 {
   words[0] = _sch_toupper[(generic_floating_point_number.sign) & 0xff] == 'S'
              ? 0x7fbf : 0x7fff;
   words[1] = 0xffff;
 }
      else if (precision == 5)
 {
# 364 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
   words[0] = 0x7fff;
   words[1] = _sch_toupper[(generic_floating_point_number.sign) & 0xff] == 'S'
       ? 0xbfff : 0xffff;
   words[2] = 0xffff;
   words[3] = 0xffff;
   words[4] = 0xffff;
      ...
      else
 {
   ...
   words[3] = 0xffff;
      ...
      if ((_sch_istable[(generic_floating_point_number.sign) & 0xff] & (unsigned short)(_sch_islower)))
 words[0] |= 0x8000;
    ...
    case 'N':
      if (0)
 as_warn (gettext ("Infinities are not supported by this target"));
 ...
 {
# 415 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
   words[0] = 0x7fff;
   words[1] = 0x8000;
   words[2] = 0;
   words[3] = 0;
...
# 447 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
  bits_left_in_littlenum = (16);
  ...
  if (exponent_4 <= 0)
    {
      ...
      num_bits = -exponent_4;
      prec_bits =
 (16) * precision - (exponent_bits + 1 + num_bits);

      if (precision == 5 && exponent_bits == 15)
 {
   ...
   num_bits += 1;
      ...
      if (num_bits >= (16) - exponent_bits)
 {

   num_bits -= ((16) - 1) - exponent_bits;
   *lp++ = word1;
 ...
 *lp++ = next_bits ((16));
      ...
      if (next_bits (1))
 {
       ...
       else
  {
    ...
    *lp++ = word1;
    ...
    {
      word1 |= (exponent_4 << (((16) - 1) - exponent_bits))
 | next_bits (((16) - 1) - exponent_bits);
    }
  ...
  *lp++ = word1;
  ...
  if (exponent_bits == 15 && precision == 5)
    {
  ...
  if (next_bits (1))
    {
      unsigned long carry;
# 666 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
      ...
      if (precision == 5 && exponent_bits == 15)
 {
   ...
   if (lp == words)
     {
# 688 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
       lp[1] |= 1 << ((16) - 1);
     }
 }
      if ((word1 ^ *words) & (1 << ((16) - 1)))
 {
...
# 743 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
const char *
ieee_md_atof (int type,
       char *litP,
       int *sizeP,
       
# 747 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
      _Bool 
# 747 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
           big_wordian)
{
  ...
  if (strchr (FLT_CHARS, type) != 
# 754 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
                                 ((void *)0)
# 754 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
                                     )
    {
      switch (type)
 {
...
# 817 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
  else if (type == 'f')
    prec = 2;
  else if (type == 'd')
    prec = 4;
  ...
  if (prec == 0)
    {
      *sizeP = 0;
      return gettext ("Unrecognized or unsupported floating point constant");
    }

  ((void) ((prec <= 6) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c", 828, __PRETTY_FUNCTION__), 0)));
 ...
 {
   number_to_chars_littleendian (litP, (valueT) (* wordP ++), sizeof (LITTLENUM_TYPE));
      ...
      for (wordP = words + prec; prec --;)
 {
  ...
  return 
# 856 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c" 3 4
        ((void *)0)
# 856 "/doner/binutils/binutils-515f23e/gas/config/atof-ieee.c"
            ;
}
