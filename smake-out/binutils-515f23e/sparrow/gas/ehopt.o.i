# 1 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
# 22 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
...
# 23 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 2
# 91 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
struct cie_info
{
...
get_cie_info (struct cie_info *info)
{
  ...
  f = ((segment_info_type *) bfd_section_userdata (now_seg))->frchainP->frch_root;
  fix = ((segment_info_type *) bfd_section_userdata (now_seg))->frchainP->fix_root;





  if (startswith (bfd_section_name (now_seg), ".debug_frame"))
    CIE_id = (char)0xff;
  else
    CIE_id = 0;
  ...
  offset = 4;
  while (f != 
# 125 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
             ((void *)0) 
# 125 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                  && offset >= f->fr_fix)
    {
      offset -= f->fr_fix;
      f = f->fr_next;
  ...
  if (f == 
# 130 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
          ((void *)0)
      
# 131 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
     || f->fr_fix - offset < 4
  ...
  offset += 4;
  while (f != 
# 141 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
             ((void *)0) 
# 141 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                  && offset >= f->fr_fix)
    {
      offset -= f->fr_fix;
      f = f->fr_next;
  ...
  if (f == 
# 146 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
          ((void *)0)
      
# 147 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
     || f->fr_fix - offset < 1
  ...
  while (1)
    {
      while (f != 
# 157 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
                 ((void *)0) 
# 157 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                      && offset >= f->fr_fix)
 {
   offset -= f->fr_fix;
   f = f->fr_next;
      ...
      if (f == 
# 162 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
              ((void *)0)
# 162 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                  )
 return 0;
 ...
 break;
  ...
  ++offset;
  while (f != 
# 178 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
             ((void *)0) 
# 178 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                  && offset >= f->fr_fix)
    {
      offset -= f->fr_fix;
      f = f->fr_next;
  ...
  if (f == 
# 183 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
          ((void *)0)
# 183 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
              )
    return 0;
  ...
  if (augmentation[0] == '\0')
  ...
  else if (strcmp (augmentation, "eh") == 0)
    {
      ...
      while (fix != 
# 195 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
                   ((void *)0)
      
# 196 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
     && (fix->fx_frag != f || fix->fx_where != offset))
 fix = fix->fx_next;
      if (fix == 
# 198 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
                ((void *)0)
# 198 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                    )
 offset += 4;
      else
 offset += fix->fx_size;
      while (f != 
# 202 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
                 ((void *)0) 
# 202 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                      && offset >= f->fr_fix)
 {
   offset -= f->fr_fix;
   f = f->fr_next;
      ...
      if (f == 
# 207 "/doner/binutils/binutils-515f23e/gas/ehopt.c" 3 4
              ((void *)0)
# 207 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
                  )
 return 0;
    }
...
# 273 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
int
check_eh_frame (expressionS *exp, unsigned int *pnbytes)
{
  ...
  if (startswith (bfd_section_name (now_seg), ".eh_frame")
      && bfd_section_name (now_seg)[9] != '_')
    d = &frame.eh_data;
  else if (startswith (bfd_section_name (now_seg), ".debug_frame"))
    d = &frame.debug_data;
  else
    return 0;
  ...
  switch (d->state)
    ...
    case state_idle:
      if (*pnbytes == 4)
 {
# 318 "/doner/binutils/binutils-515f23e/gas/ehopt.c"
        ...
        && d->cie_info.code_alignment > 1)
 {
   if (symbol_symbolS (exp->X_add_symbol)
       ...
       && S_GET_SEGMENT (exp->X_op_symbol) == (&_bfd_std_section[2])
       && ((exp->X_op == O_divide
...
eh_frame_estimate_size_before_relax (fragS *frag)
{
  ...
  ((void) ((ca > 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 485, __PRETTY_FUNCTION__), 0)));
  diff /= ca;
  if (diff == 0)
    ret = -1;
  else if (diff < 0x40)
...
eh_frame_convert_frag (fragS *frag)
{
  ...
  ((void) ((ca > 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 536, __PRETTY_FUNCTION__), 0)));
  diff /= ca;
  switch (frag->fr_subtype & 7)
    {
    case 0:
      ((void) ((diff < 0x40) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 541, __PRETTY_FUNCTION__), 0)));
      loc4_frag->fr_literal[loc4_fix] = DW_CFA_advance_loc | diff;
      break;

    case 1:
      ((void) ((diff < 0x100) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 546, __PRETTY_FUNCTION__), 0)));
      loc4_frag->fr_literal[loc4_fix] = DW_CFA_advance_loc1;
      frag->fr_literal[frag->fr_fix] = diff;
      break;

    case 2:
      ((void) ((diff < 0x10000) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 552, __PRETTY_FUNCTION__), 0)));
      loc4_frag->fr_literal[loc4_fix] = DW_CFA_advance_loc2;
      number_to_chars_littleendian (frag->fr_literal + frag->fr_fix, diff, 2);
      break;

    case 4:
      number_to_chars_littleendian (frag->fr_literal + frag->fr_fix, diff, 4);
      break;

    case 7:
      ((void) ((diff == 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 562, __PRETTY_FUNCTION__), 0)));
      frag->fr_fix -= 8;
      break;

    default:
      as_abort ("/doner/binutils/binutils-515f23e/gas/ehopt.c", 567, __PRETTY_FUNCTION__);
    }
