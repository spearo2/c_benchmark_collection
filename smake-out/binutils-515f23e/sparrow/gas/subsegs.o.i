# 1 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
# 23 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
...
# 24 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 2
...
subsegs_begin (void)
{
  _obstack_begin ((&frchains), (chunksize), 0, (xmalloc), (free));

  ((&frchains)->alignment_mask) = __alignof__ (frchainS) - 1;


  frchain_now = 
# 43 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
               ((void *)0)
# 43 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                   ;
  frag_now = &dummy_frag;
}
...
subsegs_end (struct obstack **obs)
{
  for (; *obs; obs++)
    _obstack_free (*obs, 
# 51 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                        ((void *)0)
# 51 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                            );
  _obstack_free (&frchains, 
# 52 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                           ((void *)0)
# 52 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                               );
  bfd_set_section_userdata ((&_bfd_std_section[2]), 
# 53 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                                                ((void *)0)
# 53 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                                                    );
  bfd_set_section_userdata ((&_bfd_std_section[1]), 
# 54 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                                                ((void *)0)
# 54 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                                                    );
}
...
subseg_change (segT seg, int subseg)
{
  ...
  if (!((segment_info_type *) bfd_section_userdata (seg)))
    alloc_seginfo (seg);
}
...
subseg_set_rest (segT seg, subsegT subseg)
{
  ...
  mri_common_symbol = 
# 95 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                     ((void *)0)
# 95 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                         ;

  if (frag_now && frchain_now)
    frchain_now->frch_frag_now = frag_now;

  ((void) ((frchain_now == 0 || frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/subsegs.c", 100, __PRETTY_FUNCTION__), 0)))
                                         ;

  subseg_change (seg, (int) subseg);

  seginfo = ((segment_info_type *) bfd_section_userdata (seg));


  if (bfd_keep_unused_section_symbols (stdoutput))
    seg->symbol->flags |= (1 << 24);



  for (frcP = *(lastPP = &seginfo->frchainP);
       frcP != 
# 114 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
              ((void *)0)
# 114 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                  ;
  ...
  if (frcP == 
# 119 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
             ((void *)0) 
# 119 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                  || frcP->frch_subseg != subseg)
    {


      newP = (frchainS *) __extension__ ({ struct obstack *__h = (&frchains); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof (frchainS))); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = (sizeof (ptrdiff_t) < sizeof (void *) ? ((__o1->object_base) + (((__o1->next_free) - (__o1->object_base) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))) : (char *) (((ptrdiff_t) (__o1->next_free) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); });
      newP->frch_subseg = subseg;
      newP->fix_root = 
# 125 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                      ((void *)0)
# 125 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                          ;
      newP->fix_tail = 
# 126 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                      ((void *)0)
# 126 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                          ;
      _obstack_begin ((&newP->frch_obstack), (chunksize), 0, (xmalloc), (free));

      ((&newP->frch_obstack)->alignment_mask) = __alignof__ (fragS) - 1;

      newP->frch_frag_now = frag_alloc (&newP->frch_obstack);
      newP->frch_frag_now->fr_type = rs_fill;
      newP->frch_cfi_data = 
# 133 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                           ((void *)0)
# 133 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                               ;
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/subsegs.c", 145, __PRETTY_FUNCTION__), 0)));
}
# 163 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
segT
subseg_get (const char *segname, int force_new)
{
  ...
  if (!((segment_info_type *) bfd_section_userdata (secptr)))
    {
...
subseg_set (segT secptr, subsegT subseg)
{
  if (! (secptr == now_seg && subseg == now_subseg))
    subseg_set_rest (secptr, subseg);
  mri_common_symbol = 
# 215 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                     ((void *)0)
# 215 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                         ;
}
...
section_symbol (segT sec)
{
  ...
  if (seginfo == 0)
    as_abort ("/doner/binutils/binutils-515f23e/gas/subsegs.c", 229, __PRETTY_FUNCTION__);
  if (seginfo->sym)
    return seginfo->sym;
  ...
  if (! 1 || symbol_table_frozen)
  ...
  else
    {
      ...
      if (s == 
# 248 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
              ((void *)0)
   
# 249 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
  || ((seg = S_GET_SEGMENT (s)) != sec
       && seg != (&_bfd_std_section[1])))
 s = symbol_new (sec->symbol->name, sec, &zero_address_frag, 0);
      else if (seg == (&_bfd_std_section[1]))
 {
   S_SET_SEGMENT (s, sec);
...
{
  return (bfd_section_flags (sec) & 0x10) != 0;
}
...
int
seg_not_empty_p (segT sec __attribute__ ((__unused__)))
{
  segment_info_type *seginfo = ((segment_info_type *) bfd_section_userdata (sec));
  frchainS *chain;
  fragS *frag;
 ...
 if (frag->fr_fix)
   return 1;
      if (((void *) (&chain->frch_obstack)->next_free)
...
subsegs_print_statistics (FILE *file)
{
  ...
  if (stdoutput == 
# 314 "/doner/binutils/binutils-515f23e/gas/subsegs.c" 3 4
                  ((void *)0)
# 314 "/doner/binutils/binutils-515f23e/gas/subsegs.c"
                      )
    return;
  ...
  for (s = stdoutput->sections; s; s = s->next)
    {
      ...
      if (bfd_section_name (s)[0] == '*')
 continue;

      seginfo = ((segment_info_type *) bfd_section_userdata (s));
      if (!seginfo)
 continue;
