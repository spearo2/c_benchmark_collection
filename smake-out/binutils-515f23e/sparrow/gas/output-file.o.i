# 1 "/doner/binutils/binutils-515f23e/gas/output-file.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/output-file.c"
# 21 "/doner/binutils/binutils-515f23e/gas/output-file.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/output-file.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/output-file.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/output-file.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gas/output-file.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/output-file.c" 2
...
{
  if (name[0] == '-' && name[1] == '\0')
    as_fatal (gettext ("can't open a bfd on stdout %s"), name);

  else if (!(stdoutput = bfd_openw (name, i386_target_format ())))
    {
      bfd_error_type err = bfd_get_error ();

      if (err == bfd_error_invalid_target)
 as_fatal (gettext ("selected target format '%s' unknown"), i386_target_format ());
      else
 as_fatal (gettext ("can't create %s: %s"), name, bfd_errmsg (err));
    }

  bfd_set_format (stdoutput, bfd_object);
  ((*((stdoutput)->xvec->_bfd_set_arch_mach)) (stdoutput, (i386_arch ()), (i386_mach ())));
  if (flag_traditional_format)
    stdoutput->flags |= 0x400;
}

static void
stash_frchain_obs (asection *sec)
{
  segment_info_type *info = ((segment_info_type *) bfd_section_userdata (sec));
  if (info)
    {
      struct frchain *frchp;
      for (frchp = info->frchainP; frchp; frchp = frchp->frch_next)
 __extension__ ({ struct obstack *__o = (&notes); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < sizeof (void *)) _obstack_newchunk (__o, sizeof (void *)); __extension__ ({ struct obstack *__o1 = (__o); void *__p1 = __o1->next_free; *(const void **) __p1 = (&frchp->frch_obstack); __o1->next_free += sizeof (const void *); (void) 0; }); });
      info->frchainP = 
# 64 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
                      ((void *)0)
# 64 "/doner/binutils/binutils-515f23e/gas/output-file.c"
                          ;
    }
}
...
# 71 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
 _Bool 
# 71 "/doner/binutils/binutils-515f23e/gas/output-file.c"
      res;
  bfd *obfd = stdoutput;
  struct obstack **obs;
  asection *sec;
  ...
  if (obfd == 
# 77 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
             ((void *)0)
# 77 "/doner/binutils/binutils-515f23e/gas/output-file.c"
                 )
    return;
  ...
  stdoutput = 
# 82 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
             ((void *)0)
# 82 "/doner/binutils/binutils-515f23e/gas/output-file.c"
                 ;
  ...
  stash_frchain_obs ((&_bfd_std_section[2]));
  stash_frchain_obs ((&_bfd_std_section[1]));
  __extension__ ({ struct obstack *__o = (&notes); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < sizeof (void *)) _obstack_newchunk (__o, sizeof (void *)); __extension__ ({ struct obstack *__o1 = (__o); void *__p1 = __o1->next_free; *(const void **) __p1 = (
# 94 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
 ((void *)0)
# 94 "/doner/binutils/binutils-515f23e/gas/output-file.c"
 ); __o1->next_free += sizeof (const void *); (void) 0; }); });
  obs = __extension__ ({ struct obstack *__o1 = (&notes); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = (sizeof (ptrdiff_t) < sizeof (void *) ? ((__o1->object_base) + (((__o1->next_free) - (__o1->object_base) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))) : (char *) (((ptrdiff_t) (__o1->next_free) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; });
  ...
  if (!flag_always_generate_output && had_errors ())
    ...
    res = bfd_close (obfd);
  now_seg = 
# 102 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
           ((void *)0)
# 102 "/doner/binutils/binutils-515f23e/gas/output-file.c"
               ;
  now_subseg = 0;

  filename = out_file_name;
  out_file_name = 
# 106 "/doner/binutils/binutils-515f23e/gas/output-file.c" 3 4
                 ((void *)0)
# 106 "/doner/binutils/binutils-515f23e/gas/output-file.c"
                     ;
  if (!keep_it && filename)
