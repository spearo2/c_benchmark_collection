# 1 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
# 21 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
...
# 22 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 2
...
# 24 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 2
# 71 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
static inline void
out_one (int byte)
{
...
static 
# 110 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
      _Bool

# 111 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
get_dw_fde_pauth_b_key_p (const struct fde_entry *dw_fde __attribute__ ((__unused__)))
{



  return 
# 116 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
        0
# 116 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
             ;
        ...
        unsigned int cfa_base_reg)
{
  ...
  fre->merge_candidate = 
# 139 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                        0
# 139 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                             ;
}
      ...
      offsetT cfa_offset)
{
  ...
  fre->merge_candidate = 
# 147 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                        0
# 147 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                             ;
}
# 160 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
static void
sframe_fre_set_bp_track (struct sframe_row_entry *fre, offsetT bp_offset)
{
  ...
  fre->merge_candidate = 
# 165 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                        0
# 165 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                             ;
}
# 179 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
static unsigned int
get_offset_size_in_bytes (offsetT value)
{
  unsigned int size = 0;

  if (value <= 0x7f && value >= (offsetT) -0x7f)
    size = 1;
  else if (value <= 0x7fff && value >= (offsetT) -0x7fff)
    size = 2;
  else if (value <= 0x7fffffff && value >= (offsetT) -0x7fffffff)
    size = 4;
  else if ((sizeof (offsetT) > 4) && (value <= (offsetT) 0x7fffffffffffffff
          && value >= (offsetT) -0x7fffffffffffffff))
    size = 8;

  return size;
}
# 205 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
...
static const
struct sframe_fre_offset_func_map
fre_offset_func_map[3 +1] =
{
  { 0, out_one },
  { 1, out_two },
  { 2, out_four },
  { -1, 
# 246 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
       ((void *)0) 
# 246 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
            }
};
...
sframe_v1_set_fre_info (unsigned int base_reg, unsigned int num_offsets,
   unsigned int offset_size, 
# 257 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                            _Bool 
# 257 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                 mangled_ra_p)
{
  unsigned char fre_info;
  fre_info = (((0 & 0x1) << 7) | (((offset_size) & 0x3) << 5) | (((num_offsets) & 0xf) << 1) | ((base_reg) & 0x1));
  fre_info = ((((mangled_ra_p) & 0x1) << 7) | ((fre_info) & 0x7f));
  return fre_info;
}
    ...
    unsigned int pauth_key)
{
  ...
  func_info = (((0 & 0x1) << 5) | (((fde_type) & 0x1) << 4) | ((fre_type) & 0xf));
  func_info = ((((pauth_key) & 0x1) << 5) | ((func_info) & 0xdf));
  return func_info;
}
...
static void
sframe_set_version (uint32_t sframe_version __attribute__ ((__unused__)))
{
  sframe_ver_ops.format_version = 2;
...
sframe_set_fre_info (unsigned int base_reg, unsigned int num_offsets,
       unsigned int offset_size, 
# 295 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                                _Bool 
# 295 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                     mangled_ra_p)
{
...
get_fre_base_reg_id (struct sframe_row_entry *sframe_fre)
{
  ...
  unsigned fre_base_reg = 1;

  if (cfi_insn_cfa_base_reg == x86_sframe_cfa_fp_reg)
    fre_base_reg = 0;


  ((void) ((fre_base_reg == 1 || fre_base_reg == 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 332, __PRETTY_FUNCTION__), 0)))
                                             ;
...
sframe_get_fre_offset_size (struct sframe_row_entry *sframe_fre)
{
  ...
  ((void) ((max_offset_size) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 385, __PRETTY_FUNCTION__), 0)));
  ...
  switch (max_offset_size)
    ...
    default:
      ...
      as_fatal (gettext ("SFrame unsupported offset value\n"));
      break;
    }

  return fre_offset_size;
}
# 423 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
static void
...
# 466 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
static void
...
# 524 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
  ...
  ((void) ((idx < 3) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 532, __PRETTY_FUNCTION__), 0)));


  fre_offset_func_map[idx].out_func (sframe_fre->cfa_offset);
  fre_write_offsets++;
# 545 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
  if (sframe_fre->bp_loc == 1)
    {
  ...
  ((void) ((fre_write_offsets == fre_num_offsets) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 553, __PRETTY_FUNCTION__), 0)));
}
   ...
   struct sframe_func_entry *sframe_fde)
{
  ...
  exp.X_op = O_subtract;
  exp.X_add_symbol = dw_fde_start_addrS;
  ...
  pauth_key = (get_dw_fde_pauth_b_key_p (sframe_fde->dw_fde)
        ? 1 : 0);
  func_info = sframe_set_func_info (0,
        2,
        pauth_key);
...
output_sframe_internal (void)
{
  ...
  int fixed_bp_offset = 0;
  int fixed_ra_offset = 0;
  unsigned int addr_size;
  ...
  symbolS **fre_symbols = ((symbolS * *) xmalloc (sizeof (symbolS *) * (num_fres)));
  ...
  abi_arch = x86_sframe_get_abi_arch ();

  ((void) ((abi_arch) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 658, __PRETTY_FUNCTION__), 0)));
  out_one (abi_arch);
  ...
  if (!x86_sframe_ra_tracking_p ())
    fixed_ra_offset = x86_sframe_cfa_ra_offset ();
    ...
    sframe_fre = sframe_fre->next)
 {
  ...
  ((void) ((i == num_fres) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 739, __PRETTY_FUNCTION__), 0)));

  free (fre_symbols);
  fre_symbols = 
# 742 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
               ((void *)0)
# 742 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                   ;
}
...
{
  struct sframe_func_entry *sframe_fde = ((struct sframe_func_entry *) xcalloc (1, sizeof (struct sframe_func_entry)));
  return sframe_fde;
}
...
{
  free ((void*) (sframe_fde));
  sframe_fde = 
# 805 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
              ((void *)0)
# 805 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                  ;
}
...
{
  struct sframe_xlate_ctx* xlate_ctx = ((struct sframe_xlate_ctx *) xcalloc (1, sizeof (struct sframe_xlate_ctx)));
  return xlate_ctx;
}
...
{
  xlate_ctx->dw_fde = 
# 824 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                     ((void *)0)
# 824 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                         ;
  xlate_ctx->first_fre = 
# 825 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                        ((void *)0)
# 825 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                            ;
  xlate_ctx->last_fre = 
# 826 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                       ((void *)0)
# 826 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                           ;
  xlate_ctx->cur_fre = 
# 827 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                      ((void *)0)
# 827 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                          ;
  xlate_ctx->remember_fre = 
# 828 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                           ((void *)0)
# 828 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                               ;
...
{
  struct sframe_row_entry *fre = ((struct sframe_row_entry *) xcalloc (1, sizeof (struct sframe_row_entry)));


  fre->cfa_base_reg = -1;
  fre->merge_candidate = 
# 871 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                        1
# 871 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                            ;


  fre->mangled_ra_p = 
# 874 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                     0
# 874 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                          ;
...
{
  ((void) ((xlate_ctx && fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 886, __PRETTY_FUNCTION__), 0)));
...
# 909 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
static void
sframe_row_entry_initialize (struct sframe_row_entry *cur_fre,
        struct sframe_row_entry *prev_fre)
{
  ((void) ((prev_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 913, __PRETTY_FUNCTION__), 0)));
        ...
        struct cfi_insn_data *cfi_insn)
{
      ...
      else
 {
   ...
   ((void) ((last_fre->merge_candidate == 
# 956 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
  0
# 956 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
  ) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 956, __PRETTY_FUNCTION__), 0)));
 }
    }
  else
    {
  ...
  ((void) ((cur_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 965, __PRETTY_FUNCTION__), 0)));
...
# 992 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                            0
# 992 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                 ;
      ...
      struct cfi_insn_data *cfi_insn)
{
  ...
  struct sframe_row_entry *cur_fre = xlate_ctx->cur_fre;
  ((void) ((cur_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1007, __PRETTY_FUNCTION__), 0)));


  sframe_fre_set_cfa_base_reg (cur_fre, cfi_insn->u.ri.reg);
  sframe_fre_set_cfa_offset (cur_fre, last_fre->cfa_offset);
  cur_fre->merge_candidate = 
# 1012 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                            0
# 1012 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                 ;
    ...
    struct cfi_insn_data *cfi_insn)
{
  ...
  ((void) ((cur_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1029, __PRETTY_FUNCTION__), 0)));



  if ((cur_fre->cfa_base_reg == x86_sframe_cfa_fp_reg)
      || (cur_fre->cfa_base_reg == x86_sframe_cfa_sp_reg))
    {
      sframe_fre_set_cfa_offset (cur_fre, cfi_insn->u.i);
      cur_fre->merge_candidate = 
# 1037 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                                0
# 1037 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                     ;
    }
  else
   ...
   struct cfi_insn_data *cfi_insn)
{
  ...
  ((void) ((cur_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1057, __PRETTY_FUNCTION__), 0)));


  if (cfi_insn->u.r == x86_sframe_cfa_fp_reg)
    {
      ((void) ((!cur_fre->base_reg) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1062, __PRETTY_FUNCTION__), 0)));
      sframe_fre_set_bp_track (cur_fre, cfi_insn->u.ri.offset);
      cur_fre->merge_candidate = 
# 1064 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                                0
# 1064 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                     ;
    }
# 1076 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
  return SFRAME_XLATE_OK;
}
...
static int
sframe_xlate_do_val_offset (struct sframe_xlate_ctx *xlate_ctx __attribute__ ((__unused__)),
       struct cfi_insn_data *cfi_insn)
{
...
sframe_xlate_do_restore_state (struct sframe_xlate_ctx *xlate_ctx)
{
  ...
  ((void) ((xlate_ctx->remember_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1134, __PRETTY_FUNCTION__), 0)));
  ((void) ((cur_fre && cur_fre->merge_candidate) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1135, __PRETTY_FUNCTION__), 0)));
  ...
  cur_fre->merge_candidate = 
# 1141 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                            0
# 1141 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                 ;
  return SFRAME_XLATE_OK;
}
    ...
    struct cfi_insn_data *cfi_insn)
{
  ...
  ((void) ((cie_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1160, __PRETTY_FUNCTION__), 0)));


  if (cfi_insn->u.r == x86_sframe_cfa_fp_reg)
    {
      ((void) ((cur_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1165, __PRETTY_FUNCTION__), 0)));
      cur_fre->bp_loc = cie_fre->bp_loc;
      cur_fre->bp_offset = cie_fre->bp_offset;
      cur_fre->merge_candidate = 
# 1168 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                                0
# 1168 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                     ;
    }
# 1180 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
  return SFRAME_XLATE_OK;
}
...
sframe_xlate_do_gnu_window_save (struct sframe_xlate_ctx *xlate_ctx,
     struct cfi_insn_data *cfi_insn __attribute__ ((__unused__)))
{
  struct sframe_row_entry *cur_fre = xlate_ctx->cur_fre;

  ((void) ((cur_fre) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1192, __PRETTY_FUNCTION__), 0)));

  cur_fre->mangled_ra_p = !cur_fre->mangled_ra_p;
  cur_fre->merge_candidate = 
# 1195 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                            0
# 1195 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                 ;
      ...
      struct cfi_insn_data *cfi_insn)
{
  ...
  ((void) ((cfi_insn) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/gen-sframe.c", 1213, __PRETTY_FUNCTION__), 0)));
  ...
  switch (op)
    ...
    default:
      {
# 1264 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
        ...
        const struct fde_entry *dw_fde)
{
  ...
  if (xlate_ctx->dw_fde->return_column != x86_dwarf2_return_column)
    return SFRAME_XLATE_ERR_NOTREPRESENTED;
  ...
  if (xlate_ctx->cur_fre)
    {
      ...
      xlate_ctx->cur_fre = 
# 1305 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                          ((void *)0)
# 1305 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                              ;
    }
...
{
  struct fde_entry *dw_fde = 
# 1326 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                            ((void *)0)
# 1326 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                ;
  struct sframe_func_entry *sframe_fde = 
# 1327 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c" 3 4
                                        ((void *)0)
# 1327 "/doner/binutils/binutils-515f23e/gas/gen-sframe.c"
                                            ;
