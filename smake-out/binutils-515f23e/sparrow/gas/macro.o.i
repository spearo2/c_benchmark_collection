# 1 "/doner/binutils/binutils-515f23e/gas/macro.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/macro.c"
# 24 "/doner/binutils/binutils-515f23e/gas/macro.c"
...
# 25 "/doner/binutils/binutils-515f23e/gas/macro.c" 2
...
# 26 "/doner/binutils/binutils-515f23e/gas/macro.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/gas/macro.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gas/macro.c" 2
# 47 "/doner/binutils/binutils-515f23e/gas/macro.c"
htab_t macro_hash;
...
macro_init (void)
{
  macro_hash = htab_create_alloc (16, hash_string_tuple, eq_string_tuple,
      macro_del_f, notes_calloc, 
# 76 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                ((void *)0)
# 76 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                    );
  macro_defined = 0;
}
...
# 93 "/doner/binutils/binutils-515f23e/gas/macro.c"
int
   ...
   size_t (*get_line) (sb *))
{
  ...
  if (to_len == 4 && strcasecmp (to, "ENDR") == 0)
    {
      from = 
# 104 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
            ((void *)0)
# 104 "/doner/binutils/binutils-515f23e/gas/macro.c"
                ;
      from_len = 0;
    }
  else
...
# 132 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
     _Bool 
# 132 "/doner/binutils/binutils-515f23e/gas/macro.c"
          had_colon = 
# 132 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                      0
# 132 "/doner/binutils/binutils-515f23e/gas/macro.c"
      ...
      if (! 0)
 {
   ...
   while (i < ptr->len && ((ptr->ptr[i]) == ' ' || (ptr->ptr[i]) == '\t'))
     i++;
 }
      ...
      for (;;)
 {
   ...
   if (i >= ptr->len || ! ( lex_type[(unsigned char) (ptr->ptr[i])] & (2) ))
     break;
   i++;
   while (i < ptr->len && ( lex_type[(unsigned char) (ptr->ptr[i])] & (1) ))
     i++;
   if (i < ptr->len && ( lex_type[(unsigned char) (ptr->ptr[i])] & (4) ))
     i++;
  ...
  break;
   ...
   line_start = i;
   had_colon = 
# 173 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              1
# 173 "/doner/binutils/binutils-515f23e/gas/macro.c"
                  ;
 }
      ...
      || flag_mri))
 {
   ...
   if (from == 
# 187 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              ((void *)0)
# 187 "/doner/binutils/binutils-515f23e/gas/macro.c"
                  )
     {
  ...
  from_len = 0;
   ...
   if ((from != 
# 204 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
               ((void *)0)
        
# 205 "/doner/binutils/binutils-515f23e/gas/macro.c"
       ? (len >= from_len
    && strncasecmp (ptr->ptr + i, from, from_len) == 0)
        : from_len > 0)
       && (len == from_len
    || ! (( lex_type[(unsigned char) (ptr->ptr[i + from_len])] & (1) )
   || ( lex_type[(unsigned char) (ptr->ptr[i + from_len])] & (4) ))))
     depth++;
   if (len >= to_len
       && strncasecmp (ptr->ptr + i, to, to_len) == 0
       && (len == to_len
    || ! (( lex_type[(unsigned char) (ptr->ptr[i + to_len])] & (1) )
   || ( lex_type[(unsigned char) (ptr->ptr[i + to_len])] & (4) ))))
     {
       depth--;
       if (depth == 0)
  {
   ...
   if (from != 
# 230 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              ((void *)0) 
# 230 "/doner/binutils/binutils-515f23e/gas/macro.c"
                   && strcasecmp (from, "MACRO") == 0
...
{
  if (idx < in->len
      && ( lex_type[(unsigned char) (in->ptr[idx])] & (2) ))
    {
      sb_add_char (name, in->ptr[idx++]);
      while (idx < in->len
      && ( lex_type[(unsigned char) (in->ptr[idx])] & (1) ))
 {
   sb_add_char (name, in->ptr[idx++]);
 }
      if (idx < in->len
      && ( lex_type[(unsigned char) (in->ptr[idx])] & (4) ))
 {
   sb_add_char (name, in->ptr[idx++]);
 }
    }
...
# 367 "/doner/binutils/binutils-515f23e/gas/macro.c"
static size_t
get_any_string (size_t idx, sb *in, sb *out)
{
  ...
  if (idx < in->len)
    {
      if (in->len > idx + 2 && in->ptr[idx + 1] == '\'' && ((in->ptr[idx]) == 'b' || (in->ptr[idx]) == 'B' || (in->ptr[idx]) == 'q' || (in->ptr[idx]) == 'Q' || (in->ptr[idx]) == 'h' || (in->ptr[idx]) == 'H' || (in->ptr[idx]) == 'd' || (in->ptr[idx]) == 'D'))
 {
   while (idx < in->len && !((in->ptr[idx]) == ' ' || (in->ptr[idx]) == '\t' || (in->ptr[idx]) == ',' || (in->ptr[idx]) == '"' || (in->ptr[idx]) == ';' || (in->ptr[idx]) == ')' || (in->ptr[idx]) == '(' || ((flag_macro_alternate || flag_mri) && ((in->ptr[idx]) == '<' || (in->ptr[idx]) == '>'))))
      ...
      else if (in->ptr[idx] == '%' && flag_macro_alternate)
 {
   ...
   expr (0, &ex, expr_evaluate);
   idx = input_line_pointer - in->ptr;
   restore_ilp ();

   if (ex.X_op != O_constant)
     as_bad (gettext ("%% operator needs absolute expression"));

   sprintf (buf, "%" 
# 396 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                    "l" "d"
# 396 "/doner/binutils/binutils-515f23e/gas/macro.c"
                          , (int64_t) ex.X_add_number);
...
# 403 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                0 
# 403 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                               && in->ptr[idx] != '<')
     {
 ...
 {
   char *br_buf = ((char *) xmalloc (sizeof (char) * (1)));
   char *in_br = br_buf;
  ...
  case '[':
    if (in_br > br_buf)
      ...
      {
        br_buf = ((char *) xmalloc (sizeof (char) * (strlen (in_br) + 2)));
...
new_formal (void)
{
  ...
  formal->next = 
# 489 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                ((void *)0)
# 489 "/doner/binutils/binutils-515f23e/gas/macro.c"
                    ;
...
do_formals (macro_entry *macro, size_t idx, sb *in)
{
      ...
      if (formal->name.len == 0)
 {
   ...
   && idx < in->len
   && in->ptr[idx] == ':'
   && (! ( lex_type[(unsigned char) (':')] & (2) )
       || idx + 1 >= in->len
       || ! ( lex_type[(unsigned char) (in->ptr[idx + 1])] & (1) )))
 {
   ...
   if (qual.len == 0)
     ...
     macro->line,
     gettext ("Missing parameter qualifier for `%s' in macro `%s'"),
     name,
     macro->name);
     ...
     as_bad_where (macro->file,
     macro->line,
     gettext ("`%s' is not a valid parameter qualifier for `%s' in macro `%s'"),
     qual.ptr,
     name,
     macro->name);
   sb_kill (&qual);
   ...
   if (formal->type == FORMAL_REQUIRED)
     {
       ...
       macro->line,
       gettext ("Pointless default value for required parameter `%s' in macro `%s'"),
       name,
       macro->name);
     }
 }
      ...
      if (str_hash_insert (macro->formal_hash, name, formal, 0) != 
# 580 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                                                  ((void *)0)
# 580 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                                                      )
 {
   as_bad_where (macro->file, macro->line,
   gettext ("A parameter named `%s' " "already exists for macro `%s'")
                                     ,
   name, macro->name);
 }
  ...
  if (flag_mri)
    {
      ...
      if (
# 610 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
         0
# 610 "/doner/binutils/binutils-515f23e/gas/macro.c"
                       )
 name = "$NARG";
      else
 name = "NARG";
      ...
      if (str_hash_insert (macro->formal_hash, name, formal, 0) != 
# 618 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                                                  ((void *)0)
# 618 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                                                      )
 {
   as_bad_where (macro->file, macro->line,
   gettext ("Reserved word `%s' used as parameter in macro `%s'"),
   name, macro->name);
 }
...
define_macro (sb *in, sb *label, size_t (*get_line) (sb *))
{
  ...
  size_t idx;
  const char *error = 
# 661 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                     ((void *)0)
# 661 "/doner/binutils/binutils-515f23e/gas/macro.c"
                         ;
  ...
  if (! buffer_and_nest ("MACRO", "ENDM", &macro->sub, get_line))
    error = gettext ("unexpected end of file in macro `%s' definition");
  if (label != 
# 675 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              ((void *)0) 
# 675 "/doner/binutils/binutils-515f23e/gas/macro.c"
                   && label->len != 0)
    {
      ...
      if (idx < in->len && in->ptr[idx] == '(')
 {
   ...
   if (idx < in->len && in->ptr[idx] == ')')
     ...
     error = gettext ("missing `)' after formals in macro definition `%s'");
 }
      else
 {
   ...
   idx = do_formals (macro, idx, in);
  ...
  else
    {
      ...
      macro->name = sb_terminate (&name);
      if (name.len == 0)
 error = gettext ("Missing macro name");
 ...
 idx = cidx;
  ...
  if (!error && idx < in->len)
    error = gettext ("Bad parameter list for macro `%s'");


  for (idx = 0; idx < name.len; idx++)
    name.ptr[idx] = _sch_tolower[(name.ptr[idx]) & 0xff];
  if (!error)
    {
      if (str_hash_insert (macro_hash, macro->name, macro, 0) != 
# 717 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                                                ((void *)0)
# 717 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                                                    )
 error = gettext ("Macro `%s' was already defined");
    }
  ...
  if (!error)
  ...
  else
    {
      ...
      free_macro (macro);
      macro = 
# 727 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
             ((void *)0)
# 727 "/doner/binutils/binutils-515f23e/gas/macro.c"
                 ;
    }
...
get_apost_token (size_t idx, sb *in, sb *name, int kind)
{
  ...
  if (idx < in->len
      && in->ptr[idx] == kind
      && (! flag_mri || 
# 741 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                       0
# 741 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                     )
      && (! 
# 742 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
           0 
# 742 "/doner/binutils/binutils-515f23e/gas/macro.c"
                          || kind == '@'))
    idx++;
  return idx;
}
     ...
     int kind, sb *out, int copyifnotthere)
{
  ...
  if (
# 759 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
     0
      
# 760 "/doner/binutils/binutils-515f23e/gas/macro.c"
     && kind == '@'
      && (src == start || in->ptr[src - 1] != '@'))
    ptr = 
# 762 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
         ((void *)0)
# 762 "/doner/binutils/binutils-515f23e/gas/macro.c"
             ;
  else
     ...
     struct htab *formal_hash, const macro_entry *macro)
{
  ...
  formal_entry *loclist = 
# 805 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                         ((void *)0)
# 805 "/doner/binutils/binutils-515f23e/gas/macro.c"
                             ;
  const char *err = 
# 806 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                   ((void *)0)
# 806 "/doner/binutils/binutils-515f23e/gas/macro.c"
                       ;
      ...
      else if (in->ptr[src] == '\\')
 {
  ...
  as_bad_where (macro->file, macro->line + macro_line, gettext ("missing `)'"));
     }
   ...
   else if (flag_mri && src < in->len && (_sch_istable[(in->ptr[src]) & 0xff] & (unsigned short)(_sch_isalnum)))
     {
       int ind;
       formal_entry *f;

       if ((_sch_istable[(in->ptr[src]) & 0xff] & (unsigned short)(_sch_isdigit)))
  ind = in->ptr[src] - '0';
       else if ((_sch_istable[(in->ptr[src]) & 0xff] & (unsigned short)(_sch_isupper)))
  ind = in->ptr[src] - 'A' + 10;
       else
  ind = in->ptr[src] - 'a' + 10;
       ++src;
       for (f = formals; f != 
# 876 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                             ((void *)0)
# 876 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                 ; f = f->next)
  {
    if (f->index == ind - 1)
      {
   ...
   sb_add_sb (out, &f->def);
   ...
   else
     {
       ...
       src = sub_actual (src, in, &t, formal_hash, '\'', out, 0);
        ...
        && ( lex_type[(unsigned char) (in->ptr[src])] & (2) )
        && (! inquote
     || ! 
# 897 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
         0
     
# 898 "/doner/binutils/binutils-515f23e/gas/macro.c"
    || (src > 0 && in->ptr[src - 1] == '@')))
 {
   if (! macro
       || src + 5 >= in->len
       || strncasecmp (in->ptr + src, "LOCAL", 5) != 0
       || ! ((in->ptr[src + 5]) == ' ' || (in->ptr[src + 5]) == '\t')
    ...
    (
# 909 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
    0 
# 909 "/doner/binutils/binutils-515f23e/gas/macro.c"
                   && inquote) ? '@' : '\'',
    out, 1);
     }
   else
       ...
       while (in->ptr[src] != '\n')
  {
    ...
    if (str_hash_insert (formal_hash, name, f, 0) != 
# 922 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                                    ((void *)0)
# 922 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                                        )
      {
        as_bad_where (macro->file, macro->line + macro_line,
        gettext ("`%s' was already used as parameter " "(or another local) name")
                                    , name);
        del_formal (f);
      }
    else
      {
        ...
        sprintf (buf, 1 ? ".LL%04x" : "LL%04x", ++loccnt);
...
# 952 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                     0
# 952 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                                   )
 {
   ++src;
   if (src < in->len
        ...
        && in->ptr[src + 1] == '=')
 {
   ...
   ptr = str_hash_find (formal_hash, sb_terminate (&t));
   if (ptr == 
# 972 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
             ((void *)0)
# 972 "/doner/binutils/binutils-515f23e/gas/macro.c"
                 )
     {
# 982 "/doner/binutils/binutils-515f23e/gas/macro.c"
       sb_add_char (out, '=');
       sb_add_char (out, '=');
       sb_add_sb (out, &t);
     }
      ...
      else
 {
  ...
  while (loclist != 
# 1008 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                   ((void *)0)
# 1008 "/doner/binutils/binutils-515f23e/gas/macro.c"
                       )
    {
      formal_entry *f;
      const char *name;
...
macro_expand (size_t idx, sb *in, macro_entry *m, sb *out)
{
  ...
  int narg = 0;
  const char *err = 
# 1036 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                   ((void *)0)
# 1036 "/doner/binutils/binutils-515f23e/gas/macro.c"
                       ;
  ...
  f = m->formals;
  while (f != 
# 1044 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
             ((void *)0) 
# 1044 "/doner/binutils/binutils-515f23e/gas/macro.c"
                  && f->index < 0)
    f = f->next;
  ...
  while (idx < in->len)
    {
      ...
      scan = idx;
      while (scan < in->len
      && !((in->ptr[scan]) == ' ' || (in->ptr[scan]) == '\t' || (in->ptr[scan]) == ',' || (in->ptr[scan]) == '"' || (in->ptr[scan]) == ';' || (in->ptr[scan]) == ')' || (in->ptr[scan]) == '(' || ((flag_macro_alternate || flag_mri) && ((in->ptr[scan]) == '<' || (in->ptr[scan]) == '>')))
      ...
      if (scan < in->len && !flag_macro_alternate && in->ptr[scan] == '=')
 {
   ...
   if (idx >= in->len || in->ptr[idx] != '=')
     {
       err = gettext ("confusion in formal parameters");
       break;
     }
   ...
   if (!ptr)
     {
       as_bad (gettext ("Parameter named `%s' does not exist for macro `%s'"),
        t.ptr,
        m->name);
       sb_reset (&t);
   ...
   else
     {
       ...
       if (ptr->actual.len)
  {
    as_warn (gettext ("Value for parameter `%s' of macro `%s' was already specified"),
      ptr->name.ptr,
      m->name);
    sb_reset (&ptr->actual);
  }
      ...
      else
 {
   if (is_keyword)
     {
       err = gettext ("can't mix positional and keyword arguments");
       break;
     }
   ...
   if (!f)
     {
       ...
       if (!flag_mri)
  {
    err = gettext ("too many positional arguments");
    break;
  }
       ...
       c = -1;
       for (pf = &m->formals; *pf != 
# 1148 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                                    ((void *)0)
# 1148 "/doner/binutils/binutils-515f23e/gas/macro.c"
                                        ; pf = &(*pf)->next)
  if ((*pf)->index >= c)
    c = (*pf)->index + 1;
       if (c == -1)
  c = 0;
   ...
   while (f != 
# 1170 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              ((void *)0) 
# 1170 "/doner/binutils/binutils-515f23e/gas/macro.c"
                   && f->index < 0);
 }
      ...
      for (ptr = m->formals; ptr; ptr = ptr->next)
 {
   if (ptr->type == FORMAL_REQUIRED && ptr->actual.len == 0)
     as_bad (gettext ("Missing value for required parameter `%s' of macro `%s'"),
      ptr->name.ptr,
      m->name);
 }
...
# 1197 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
         0 
# 1197 "/doner/binutils/binutils-515f23e/gas/macro.c"
                        ? "$NARG" : "NARG");
   if (ptr)
     {
       char buffer[20];
  ...
  if (flag_mri)
    {
      ...
      pf = &m->formals;
      while (*pf != 
# 1215 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                   ((void *)0)
# 1215 "/doner/binutils/binutils-515f23e/gas/macro.c"
                       )
 {
   if ((*pf)->name.len != 0)
     pf = &(*pf)->next;
      ...
      const char **error, macro_entry **info)
{
  ...
  if (! ( lex_type[(unsigned char) (*line)] & (2) )
      && (! flag_mri || *line != '.'))
    return 0;

  s = line + 1;
  while (( lex_type[(unsigned char) (*s)] & (1) ))
    ++s;
  if (( lex_type[(unsigned char) (*s)] & (4) ))
    ++s;

  copy = xmemdup0 (line, s - line);
  for (cls = copy; *cls != '\0'; cls ++)
    *cls = _sch_tolower[(*cls) & 0xff];

  macro = str_hash_find (macro_hash, copy);
  free (copy);

  if (macro == 
# 1264 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              ((void *)0)
# 1264 "/doner/binutils/binutils-515f23e/gas/macro.c"
                  )
    return 0;
...
delete_macro (const char *name)
{
  ...
  len = strlen (name);
  copy = ((char *) xmalloc (sizeof (char) * (len + 1)));
  for (i = 0; i < len; ++i)
    copy[i] = _sch_tolower[(name[i]) & 0xff];
  copy[i] = '\0';

  macro = str_hash_find (macro_hash, copy);
  if (macro != 
# 1300 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              ((void *)0)
# 1300 "/doner/binutils/binutils-515f23e/gas/macro.c"
                  )
    str_hash_delete (macro_hash, copy);
  else
    as_warn (gettext ("Attempt to purge non-existing macro `%s'"), copy);
  free (copy);
}
...
expand_irp (int irpc, size_t idx, sb *in, sb *out, size_t (*get_line) (sb *))
{
  ...
  struct htab *h;
  const char *err = 
# 1317 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                   ((void *)0)
# 1317 "/doner/binutils/binutils-515f23e/gas/macro.c"
                       ;
  ...
  sb_new (&sub);
  if (! buffer_and_nest (
# 1322 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                        ((void *)0)
# 1322 "/doner/binutils/binutils-515f23e/gas/macro.c"
                            , "ENDR", &sub, get_line))
    {
      err = gettext ("unexpected end of file in irp or irpc");
      goto out2;
    }
  ...
  if (f.name.len == 0)
    {
      err = gettext ("missing model parameter");
      goto out1;
    }
  ...
  f.index = 1;
  f.next = 
# 1344 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
          ((void *)0)
# 1344 "/doner/binutils/binutils-515f23e/gas/macro.c"
              ;
...
# 1357 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
     _Bool 
# 1357 "/doner/binutils/binutils-515f23e/gas/macro.c"
          in_quotes = 
# 1357 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
                      0
# 1357 "/doner/binutils/binutils-515f23e/gas/macro.c"
 ...
 {
   in_quotes = 
# 1361 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
              1
# 1361 "/doner/binutils/binutils-515f23e/gas/macro.c"
                  ;
   ++idx;
 }
      ...
      while (idx < in->len)
 {
       ...
       if (in->ptr[idx] == '"')
  {
   ...
   err = macro_expand_body (&sub, out, &f, h, 0);
   if (err != 
# 1391 "/doner/binutils/binutils-515f23e/gas/macro.c" 3 4
             ((void *)0)
# 1391 "/doner/binutils/binutils-515f23e/gas/macro.c"
                 )
     break;
   if (!irpc)
     idx = sb_skip_comma (idx, in);
