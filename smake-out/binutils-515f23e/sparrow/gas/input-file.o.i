# 1 "/doner/binutils/binutils-515f23e/gas/input-file.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gas/input-file.c"
# 26 "/doner/binutils/binutils-515f23e/gas/input-file.c"
...
# 27 "/doner/binutils/binutils-515f23e/gas/input-file.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gas/input-file.c" 2
...
# 29 "/doner/binutils/binutils-515f23e/gas/input-file.c" 2




# 32 "/doner/binutils/binutils-515f23e/gas/input-file.c"
int preprocess = 0;
# 44 "/doner/binutils/binutils-515f23e/gas/input-file.c"
static FILE *f_in;
...
input_file_push (void)
{
  ...
  saved = ((struct saved_file *) xmalloc (sizeof (struct saved_file)));
   ...
   int pre)
{
  ...
  ((void) ((filename != 0) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/input-file.c", 125, __PRETTY_FUNCTION__), 0)));
  if (filename[0])
    {
  ...
  else
    {
      ...
      f_in = 
# 134 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
            stdin
# 134 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                 ;

      file_name = gettext ("{standard input}");
    }

  if (f_in == 
# 139 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
             ((void *)0)
# 139 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                 )
    {
      as_bad (gettext ("can't open %s for reading: %s"),
       file_name, xstrerror (
# 142 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
                            (*__errno_location ())
# 142 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                                 ));
      return;
    }
  ...
  if (ferror (f_in))
    {
      as_bad (gettext ("can't read from %s: %s"),
       file_name, xstrerror (
# 151 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
                            (*__errno_location ())
# 151 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                                 ));

      fclose (f_in);
      f_in = 
# 154 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
            ((void *)0)
# 154 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                ;
      return;
    }
  ...
  if (feof (f_in))
    {
      fclose (f_in);
      f_in = 
# 162 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
            ((void *)0)
# 162 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                ;
      return;
    }
  ((void) ((c != 
# 165 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
 (-1)
# 165 "/doner/binutils/binutils-515f23e/gas/input-file.c"
 ) ? 0 : (as_abort ("/doner/binutils/binutils-515f23e/gas/input-file.c", 165, __PRETTY_FUNCTION__), 0)));
      ...
      if (c == 'N')
 {
   ...
   if (p && startswith (p, "O_APP") && (_sch_istable[(p[5]) & 0xff] & (unsigned short)(_sch_isspace)))
     preprocess = 0;
   if (!p || !strchr (p, '\n'))
     ungetc ('#', f_in);
   else
 ...
 {
   char *p = fgets (buf, sizeof (buf), f_in);
   if (p && startswith (p, "PP") && (_sch_istable[(p[2]) & 0xff] & (unsigned short)(_sch_isspace)))
     preprocess = 1;
   if (!p || !strchr (p, '\n'))
     ungetc ('#', f_in);
   else
...
input_file_close (void)
{
  ...
  if (f_in != 
# 206 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
             ((void *)0)
# 206 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                 )
    fclose (f_in);
...
input_file_get (char *buf, size_t buflen)
{
  ...
  if (ferror (f_in))
    as_bad (gettext ("can't read from %s: %s"), file_name, xstrerror (
# 224 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
                                                              (*__errno_location ())
# 224 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                                                                   ));
  return size;
}
...
input_file_give_next_buffer (char *where )
{
  ...
  if (preprocess)
    size = do_scrub_chars (input_file_get, where, (32 * 1024));
  else
    size = input_file_get (where, (32 * 1024));
  ...
  if (size)
    ...
    {
      if (fclose (f_in))
 as_warn (gettext ("can't close %s: %s"), file_name, xstrerror (
# 252 "/doner/binutils/binutils-515f23e/gas/input-file.c" 3 4
                                                        (*__errno_location ())
# 252 "/doner/binutils/binutils-515f23e/gas/input-file.c"
                                                             ));
