# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
# 28 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
# 1 "../config.h" 1
# 29 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 30 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 31 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 32 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 33 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 34 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2

# 1 "./../common/gp-defs.h" 1
# 36 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 37 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
# 1 "./../common/gp-experiment.h" 1
# 31 "./../common/gp-experiment.h"
# 1 "./../src/Emsgnum.h" 1
# 32 "./../common/gp-experiment.h" 2
# 38 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 39 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_util.h" 1
# 26 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_util.h"
...
# 27 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_util.h" 2
...
# 40 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/hwprofile.h" 1
# 26 "/doner/binutils/binutils-515f23e/gprofng/libcollector/hwprofile.h"
...
# 41 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 42 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 2
...
# 66 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                                                ((void *)0)
# 66 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                                                    ;
static int prof_mode = 0;
static CollectorModule prof_hndl = ((CollectorModule)-1);
static unsigned prof_key = ((unsigned)-1);
...
# 98 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
...
# 104 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                                                   ((void *) 0)
# 104 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                                                               , "__collector_register_module");
  __collector_dlsym_guard = 0;
  if (reg_module == 
# 106 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                   ((void *)0)
# 106 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                       )
    {
      ;
      return;
  ...
  if (prof_hndl == ((CollectorModule)-1) && collector_interface != 
# 112 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                                                                 ((void *)0)
# 112 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                                                                     )
    {
      ;
...
# 131 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                            ((void *)0)
# 131 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                                )
    {
      ;
      return 9;
 ...
 params++;
      if (*params == 0)
 params = 
# 147 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
         ((void *)0)
# 147 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
             ;
      else
 params++;
    }
  if (params == 
# 151 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
               ((void *)0)
# 151 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                   )
    return 9;
  ;
  int prof_interval = __collector_util_funcs.strtol(params, 
# 154 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                                                ((void *)0)
# 154 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                                                    , 0);
  prof_key = collector_interface->createKey (sizeof ( int), 
# 155 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                                                           ((void *)0)
# 155 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                                                               , 
# 155 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                                                                 ((void *)0)
# 155 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
  ...
  if ((prof_interval_actual >= (prof_interval + prof_interval / 10)) ||
    ...
    collector_interface->writeLog ("<event kind=\"%s\" id=\"%d\">%d -> %d</event>\n", "cwarn", 202, prof_interval, prof_interval_actual);
  else if (prof_interval_actual != prof_interval)
    collector_interface->writeLog ("<event kind=\"%s\" id=\"%d\">%d -> %d</event>\n", "comment", 202, prof_interval, prof_interval_actual);
  prof_interval = prof_interval_actual;
  collector_interface->writeLog ("<profile name=\"%s\" ptimer=\"%d\" numstates=\"%d\">\n",
     "profile", prof_interval, 1);
  collector_interface->writeLog ("  <profdata fname=\"%s\"/>\n",
     module_interface.description);


  ClockPacket *cp = 
# 184 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                   ((void *)0)
# 184 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                       ;
  collector_interface->writeLog ("  <profpckt kind=\"%d\" uname=\"" "Clock profiling data" "\">\n", OPROF_PCKT);
  ...
  collector_interface->writeLog ("    <field name=\"MSTATE\" uname=\"" "Thread state" "\" offset=\"%d\" type=\"%s\"/>\n",
     &cp->mstate, sizeof (cp->mstate) == 4 ? "INT32" : "INT64");
  collector_interface->writeLog ("    <field name=\"NTICK\" uname=\"" "Duration" "\" offset=\"%d\" type=\"%s\"/>\n",
...
__collector_ext_profile_handler (siginfo_t *info, ucontext_t *context)
{
  ...
  if (!prof_mode)
    return;
  if (( !prof_mode || ((guard) = collector_interface->getKey( prof_key )) == 
# 257 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
     ((void *)0) 
# 257 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
     || (*(guard) != 0) ))
    {
  ...
  ucontext_t uctxmem;
  if (context == 
# 266 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
                ((void *)0)
# 266 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
                    )
    {

      ;
      context = &uctxmem;
      __collector_util_funcs.getcontext (context);
      (context)->uc_mcontext.gregs[
# 272 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
     REG_RIP
# 272 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
     ] = (intptr_t)(&__collector_lost_profile_context); (context)->uc_mcontext.gregs[
# 272 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
     REG_RSP
# 272 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
     ] = 0; (context)->uc_mcontext.gregs[
# 272 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c" 3 4
     REG_RBP
# 272 "/doner/binutils/binutils-515f23e/gprofng/libcollector/profile.c"
     ] = 0;;
  ...
  ClockPacket pckt;
  __collector_util_funcs.memset(&pckt, 0, sizeof ( pckt));
  pckt.comm.tsize = sizeof ( pckt);
  pckt.comm.type = OPROF_PCKT;
  ...
  pckt.frinfo = collector_interface->getFrameInfo (((CollectorModule)-1), pckt.tstamp, 1, context);
  pckt.mstate = 10;
  pckt.nticks = 1;
