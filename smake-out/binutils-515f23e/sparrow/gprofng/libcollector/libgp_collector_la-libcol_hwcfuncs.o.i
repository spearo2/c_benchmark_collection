# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_hwcfuncs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_hwcfuncs.c"
# 21 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_hwcfuncs.c"
# 1 "../config.h" 1
# 22 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_hwcfuncs.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/gprofng/libcollector/collector.h" 2
...
# 23 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_hwcfuncs.c" 2


# 1 "./../common/hwcfuncs.c" 1
# 22 "./../common/hwcfuncs.c"
# 1 "./../common/hwcdrv.h" 1
# 26 "./../common/hwcdrv.h"
...
extern void __collector_hwcfuncs_int_logerr(const char *format,...);
# 150 "./../common/hwcfuncs.h"
  ...
  extern void
  __collector_hwcfuncs_parse_ctr (const char *counter_def, int *pplus, char **pnameOnly,
...
# 170 "./../common/hwcfuncs.h"
  ...
  void * __collector_hwcfuncs_parse_attrs (const char *countername,
...
# 210 "./../common/hwcfuncs.h"
  extern int __collector_hwcfuncs_bind_hwcentry (const Hwcentry *entries[],
         unsigned numctrs);
# 221 "./../common/hwcfuncs.h"
  extern int __collector_hwcfuncs_assign_regnos (Hwcentry *entries[], unsigned numctrs);
# 234 "./../common/hwcfuncs.h"
  extern int __collector_regno_is_valid (const Hwcentry *pctr, regno_t regno);
  ...
  extern char *__collector_hwcfuncs_errmsg_get (char * buf, size_t bufsize,
        int enable_capture);
# 27 "./../common/hwcdrv.h" 2
# 41 "./../common/hwcdrv.h"
# 1 "./libcol_util.h" 1
# 42 "./../common/hwcdrv.h" 2
# 116 "./../common/hwcdrv.h"
  typedef struct
  {
    int (*__collector_hwcdrv_init)(hwcfuncs_abort_fn_t abort_ftn, int * tsd_sz);
# 127 "./../common/hwcdrv.h"
    void (*__collector_hwcdrv_get_info)(int *cpuver, const char **cciname, uint_t *npics,
       const char **docref, uint64_t *support);
# 139 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_enable_mt)(hwcfuncs_tsd_get_fn_t tsd_ftn);
# 151 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_get_descriptions)(hwcf_hwc_cb_t *hwc_find_action,
       hwcf_attr_cb_t *attr_find_action);
# 161 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_assign_regnos)(Hwcentry* entries[], unsigned numctrs);
# 171 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_create_counters)(unsigned hwcdef_cnt, Hwcentry *hwcdef);
# 181 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_start)(void);
    ...
    int (*__collector_hwcdrv_overflow)(siginfo_t *si, hwc_event_t *sample,
      hwc_event_t *lost_samples);
# 200 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_read_events)(hwc_event_t *overflow_data,
         hwc_event_samples_t *sampled_data);
# 211 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_sighlr_restart)(const hwc_event_t* startVals);
# 221 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_lwp_suspend)(void);
    ...
    int (*__collector_hwcdrv_lwp_resume)(void);
    ...
    int (*__collector_hwcdrv_free_counters)(void);
# 244 "./../common/hwcdrv.h"
    int (*__collector_hwcdrv_lwp_init)(void);
# 253 "./../common/hwcdrv.h"
    void (*__collector_hwcdrv_lwp_fini)(void);
  ...
  extern int __collector_hwcfuncs_bind_descriptor (const char *defstring);
  extern Hwcentry **__collector_hwcfuncs_get_ctrs (unsigned *defcnt);
  extern hwcdrv_api_t *__collector_hwcdrv_drivers[];
  ...
  extern int __collector_hwcdrv_assign_all_regnos (Hwcentry* entries[], unsigned numctrs);


  extern int __collector_hwcdrv_lookup_cpuver (const char * cpcN_cciname);


  extern void __collector_hwcfuncs_int_capture_errmsg (const char *fn, int subcode,
...
# 23 "./../common/hwcfuncs.c" 2
# 33 "./../common/hwcfuncs.c"
...
static Hwcentry hwcdef[20];
static Hwcentry *hwctable[20];
...
static int
__collector_hwcdrv_init (hwcfuncs_abort_fn_t abort_ftn, int* tsd_sz)
{
  return -1;
}

static void
__collector_hwcdrv_get_info (
   int * cpuver, const char ** cciname,
   uint_t * npics, const char ** docref, uint64_t* support) { }

static int
__collector_hwcdrv_enable_mt (hwcfuncs_tsd_get_fn_t tsd_ftn)
{
  return -1;
}

static int
__collector_hwcdrv_get_descriptions (hwcf_hwc_cb_t *hwc_find_action,
    hwcf_attr_cb_t *attr_find_action)
{
  return 0;
}
...
static int
__collector_hwcdrv_assign_regnos (Hwcentry *entries[], unsigned numctrs)
{
  return -1;
}

static int
__collector_hwcdrv_create_counters (unsigned hwcdef_cnt, Hwcentry *hwcdef)
{
  return -1;
}

static int
__collector_hwcdrv_read_events (hwc_event_t *events, hwc_event_samples_t*samples)
{
  return -1;
}

static int
__collector_hwcdrv_start (void)
{
  return -1;
}

static int
__collector_hwcdrv_overflow (siginfo_t *si, hwc_event_t *s, hwc_event_t *t)
{
  return 0;
}

static int
__collector_hwcdrv_sighlr_restart (const hwc_event_t *sample)
{
  return -1;
}

static int
__collector_hwcdrv_lwp_suspend (void)
{
  return -1;
}

static int
__collector_hwcdrv_lwp_resume (void)
{
  return -1;
}

static int
__collector_hwcdrv_free_counters (void)
{
  return 0;
}

static int
__collector_hwcdrv_lwp_init (void)
{
  return 0;
}

static void
__collector_hwcdrv_lwp_fini (void) { }

static hwcdrv_api_t __collector_hwcdrv_default = {
  __collector_hwcdrv_init,
  __collector_hwcdrv_get_info,
  __collector_hwcdrv_enable_mt,
  __collector_hwcdrv_get_descriptions,
  __collector_hwcdrv_assign_regnos,
  __collector_hwcdrv_create_counters,
  __collector_hwcdrv_start,
  __collector_hwcdrv_overflow,
  __collector_hwcdrv_read_events,
  __collector_hwcdrv_sighlr_restart,
  __collector_hwcdrv_lwp_suspend,
  __collector_hwcdrv_lwp_resume,
  __collector_hwcdrv_free_counters,
  __collector_hwcdrv_lwp_init,
  __collector_hwcdrv_lwp_fini,
  -1
};

static hwcdrv_api_t *__collector_hwcdrv_driver = &__collector_hwcdrv_default;
...
# 180 "./../common/hwcfuncs.c"
 char *
__collector_hwcfuncs_errmsg_get (char *buf, size_t bufsize, int enable)
{
 ...
 {
   __collector_util_funcs.strncpy (buf, hwcfuncs_errmsg_buf, bufsize);
   buf[bufsize - 1] = 0;
 }
      else
 *buf = 0;
 ...
 void
__collector_hwcfuncs_int_capture_errmsg (const char *fn, int subcode,
        const char *fmt, va_list ap)
{
  if (hwcfuncs_errmsg_enabled &&
      !hwcfuncs_errmsg_valid)
    {
      __collector_util_funcs.vsnprintf (hwcfuncs_errmsg_buf, sizeof (hwcfuncs_errmsg_buf), fmt, ap);
 ...
 void
__collector_hwcfuncs_int_logerr (const char *format, ...)
{
  va_list va;
  
# 225 "./../common/hwcfuncs.c" 3 4
 __builtin_va_start(
# 225 "./../common/hwcfuncs.c"
 va
# 225 "./../common/hwcfuncs.c" 3 4
 ,
# 225 "./../common/hwcfuncs.c"
...
# 225 "./../common/hwcfuncs.c"
                      ;
  __collector_hwcfuncs_int_capture_errmsg ("logerr", 0, format, va);
  
# 227 "./../common/hwcfuncs.c" 3 4
 __builtin_va_end(
# 227 "./../common/hwcfuncs.c"
 va
# 227 "./../common/hwcfuncs.c" 3 4
 )
# 227 "./../common/hwcfuncs.c"
...
process_data_descriptor (const char *defstring)
{
  ...
  int err = 0;
  char *ds = 
# 256 "./../common/hwcfuncs.c" 3 4
            ((void *)0)
# 256 "./../common/hwcfuncs.c"
                ;
  char *dsp = 
# 257 "./../common/hwcfuncs.c" 3 4
             ((void *)0)
# 257 "./../common/hwcfuncs.c"
                 ;
  unsigned idx;

  clear_hwcdefs ();
  if (!defstring || !__collector_util_funcs.strlen (defstring))
    {
      err = (-5);
      goto ext_hw_install_end;
    }
  ds = __collector_strdup (defstring);
  if (!ds)
    {
      err = (-4);
      goto ext_hw_install_end;
  ...
  for (idx = 0; idx < 20 && *dsp; idx++)
    {
      char *name = 
# 276 "./../common/hwcfuncs.c" 3 4
                  ((void *)0)
# 276 "./../common/hwcfuncs.c"
                      ;
      char *int_name = 
# 277 "./../common/hwcfuncs.c" 3 4
                      ((void *)0)
# 277 "./../common/hwcfuncs.c"
                          ;
      regno_t reg = ((regno_t)-1);
      ...
      name = dsp;
      dsp = __collector_util_funcs.strchr (dsp, ':');
      if (dsp == 
# 287 "./../common/hwcfuncs.c" 3 4
                ((void *)0)
# 287 "./../common/hwcfuncs.c"
                    )
 {
   err = (-5);
   goto ext_hw_install_end;
      ...
      *dsp++ = (char) 0;
      ...
      dsp = __collector_util_funcs.strchr (dsp, ':');
      if (dsp == 
# 297 "./../common/hwcfuncs.c" 3 4
                ((void *)0)
# 297 "./../common/hwcfuncs.c"
                    )
 {
   err = (-5);
   goto ext_hw_install_end;
      ...
      *dsp++ = (char) 0;
      ...
      reg = (int) __collector_util_funcs.strtol (dsp, &dsp, 0);
      if (*dsp++ != ':')
 {
   err = (-5);
   goto ext_hw_install_end;
 ...
 hwcdef[idx].reg_num = reg;
      ...
      interval = (int) __collector_util_funcs.strtol (dsp, &dsp, 0);
      if (*dsp++ != ':')
 {
   err = (-5);
   goto ext_hw_install_end;
      ...
      if (*dsp == 'm')
 {
   long long tmp_ll = 0;
   dsp++;
   tmp_ll = __collector_util_funcs.strtoll (dsp, &dsp, 0);
   if (*dsp++ != ':')
     {
       err = (-5);
       goto ext_hw_install_end;
 ...
 hwcdef[idx].min_time = 0;
      ...
      sort_order = (int) __collector_util_funcs.strtoul (dsp, &dsp, 0);
      if (*dsp++ != ':')
 {
   err = (-5);
   goto ext_hw_install_end;
      ...
      timecvt = (int) __collector_util_funcs.strtol (dsp, &dsp, 0);
      if (*dsp++ != ':')
 {
   err = (-5);
   goto ext_hw_install_end;
      ...
      memop = (ABST_type) __collector_util_funcs.strtol (dsp, &dsp, 0);
      if (*dsp != 0 && *dsp++ != ',')
 {
   err = (-5);
   goto ext_hw_install_end;
      ...
      if (*name)
 hwcdef[idx].name = __collector_strdup (name);
      else
 hwcdef[idx].name = __collector_strdup (int_name);
      if (*int_name)
 hwcdef[idx].int_name = __collector_strdup (int_name);
      else
 hwcdef[idx].int_name = __collector_strdup (name);
      ctrdefprint (1, "hwcfuncs: process_data_descriptor", &hwcdef[idx]);
    }
  ...
  if (dsp && *dsp)
    {
                 ...
                 ;
      __collector_hwcfuncs_int_logerr ("Data descriptor syntax error near `%s'\n", dsp);
    }
  else
    __collector_hwcfuncs_int_logerr ("Data descriptor syntax error\n");
  ;
  return err;
}
...
process_hwcentrylist (const Hwcentry* entries[], unsigned numctrs)
{
  ...
  if (numctrs > cpcN_npics)
    {
      __collector_hwcfuncs_int_logerr ("More than %d counters were specified\n", cpcN_npics);
      return (-5);
    }
  for (unsigned idx = 0; idx < numctrs; idx++)
    {
      ...
      *phwcdef = *entries[idx];
      if (phwcdef->name)
 phwcdef->name = __collector_strdup (phwcdef->name);
      else
 phwcdef->name = "NULL";
      if (phwcdef->int_name)
 phwcdef->int_name = __collector_strdup (phwcdef->int_name);
      else
 phwcdef->int_name = "NULL";
      if (phwcdef->val < 0)
 {
   __collector_hwcfuncs_int_logerr ("Negative interval specified for HW counter `%s'\n",
    phwcdef->name);
   err = (-5);
   break;
 }
      ctrdefprint (1, "hwcfuncs: process_hwcentrylist", phwcdef);
    }
  if (!err)
    hwcdef_cnt = numctrs;
  return err;
 ...
 void *
__collector_hwcfuncs_parse_attrs (const char *countername, hwcfuncs_attr_t attrs[],
        unsigned max_attrs, uint_t *pnum_attrs, char**errstring)
{
  char *head = 
# 464 "./../common/hwcfuncs.c" 3 4
              ((void *)0)
# 464 "./../common/hwcfuncs.c"
                  ;
  char *tail = 
# 465 "./../common/hwcfuncs.c" 3 4
              ((void *)0)
# 465 "./../common/hwcfuncs.c"
                  ;
  uint_t nattrs = 0;
  char *counter_copy;
  int success = 0;
  char errbuf[512];
  errbuf[0] = 0;
  counter_copy = __collector_strdup (countername);


  tail = __collector_util_funcs.strchr (counter_copy, '~');
  if (tail)
    *tail = 0;


  {
    char *tmp = __collector_util_funcs.strchr (counter_copy, '/');
    if (tmp)
      *tmp = 0;
    tmp = __collector_util_funcs.strchr (counter_copy, ',');
    if (tmp)
      *tmp = 0;
  }
      ...
      if (nattrs >= max_attrs)
 {
   __collector_util_funcs.snprintf (errbuf, sizeof (errbuf),
      "Too many attributes defined in `%s'",
      countername);
   goto mycpc2_parse_attrs_end;
 }

      head = tail + 1;
      tail = __collector_util_funcs.strchr (head, '=');
      if (!tail)
 {
   __collector_util_funcs.snprintf (errbuf, sizeof (errbuf),
      "Missing value for attribute `%s' in `%s'",
      head, countername);
   goto mycpc2_parse_attrs_end;
 }
      *tail = 0;
      ...
      if (tail)
 *tail = 0;
      attrs[nattrs].ca_val = __collector_util_funcs.strtoull (head, &pch, 0);
      if (pch == head)
 {
   __collector_util_funcs.snprintf (errbuf, sizeof (errbuf),
      "Illegal value for attribute `%s' in `%s'",
  ...
  if (success)
    {
      if (errstring)
 *errstring = 
# 538 "./../common/hwcfuncs.c" 3 4
             ((void *)0)
# 538 "./../common/hwcfuncs.c"
                 ;
    }
  else
    {
      if (errstring)
 *errstring = __collector_strdup (errbuf);
      ;
      counter_copy = 
# 545 "./../common/hwcfuncs.c" 3 4
                    ((void *)0)
# 545 "./../common/hwcfuncs.c"
                        ;
    }
  return counter_copy;
}
      ...
      char **pattrs, char **pregstr, regno_t *pregno)
{
  ...
  int plus;
  regno_t regno;
  nameptr = copy = __collector_strdup (counter_def);
  ...
  if (pregstr)
    *pregstr = 
# 577 "./../common/hwcfuncs.c" 3 4
              ((void *)0)
# 577 "./../common/hwcfuncs.c"
                  ;
  slash = __collector_util_funcs.strchr (nameptr, '/');
  if (slash != 
# 579 "./../common/hwcfuncs.c" 3 4
              ((void *)0)
# 579 "./../common/hwcfuncs.c"
                  )
    {

      if (pregstr)
 *pregstr = __collector_strdup (slash);
      char *endchar = 
# 584 "./../common/hwcfuncs.c" 3 4
                     ((void *)0)
# 584 "./../common/hwcfuncs.c"
                         ;
      regno = (regno_t) __collector_util_funcs.strtol (slash + 1, &endchar, 0);
      if (*endchar != 0)
 regno = -2;
      if (*(slash + 1) == '-')
 regno = -2;
  ...
  if (pattrs)
    *pattrs = 
# 598 "./../common/hwcfuncs.c" 3 4
             ((void *)0)
# 598 "./../common/hwcfuncs.c"
                 ;
  attr_delim = __collector_util_funcs.strchr (nameptr, '~');
  if (attr_delim != 
# 600 "./../common/hwcfuncs.c" 3 4
                   ((void *)0)
# 600 "./../common/hwcfuncs.c"
                       )
    {
      if (pattrs)
 *pattrs = __collector_strdup (attr_delim);

      *attr_delim++ = 0;
    }
  if (pnameOnly)
    *pnameOnly = __collector_strdup (nameptr);
  ;
}


 int
__collector_hwcfuncs_bind_descriptor (const char *defstring)
{
  ...
  err = __collector_hwcdrv_driver->__collector_hwcdrv_create_counters (hwcdef_cnt, hwcdef);
  return err;
}


 int
__collector_hwcfuncs_bind_hwcentry (const Hwcentry* entries[], unsigned numctrs)
{
  int err = -1;
 ...
 Hwcentry **
__collector_hwcfuncs_get_ctrs (unsigned *defcnt)
{
  if (defcnt)
    *defcnt = hwcdef_cnt;
  return hwctable;
 ...
 int
__collector_regno_is_valid (const Hwcentry * pctr, regno_t regno)
{
  regno_t *reg_list = pctr->reg_list;
  if ((!(reg_list) || (reg_list)[0] == ((regno_t)-1)))
    return 0;
  if (regno == ((regno_t)-1))
    return 1;
 ...
 int
__collector_hwcfuncs_assign_regnos (Hwcentry* entries[],
   unsigned numctrs)
{
  if (numctrs > cpcN_npics)
    {
  ...
  return __collector_hwcdrv_driver->__collector_hwcdrv_assign_regnos (entries, numctrs);
}
...
__collector_get_hwcdrv ()
{
  if (hwcdrv_driver_inited)
    return __collector_hwcdrv_driver;
  hwcdrv_driver_inited = 1;
  cpcN_npics = 0;
  for (int i = 0; i < 20; i++)
    hwctable[i] = &hwcdef[i];
  __collector_hwcdrv_driver = &hwcdrv_pcl_api;
  __collector_hwcdrv_driver->hwcdrv_init_status = __collector_hwcdrv_driver->__collector_hwcdrv_init (
# 696 "./../common/hwcfuncs.c" 3 4
                                                                 ((void *)0)
# 696 "./../common/hwcfuncs.c"
                                                                     , 
# 696 "./../common/hwcfuncs.c" 3 4
                                                                       ((void *)0)
# 696 "./../common/hwcfuncs.c"
                                                                           );
  if (__collector_hwcdrv_driver->hwcdrv_init_status == 0)
    {
      __collector_hwcdrv_driver->__collector_hwcdrv_get_info (
# 699 "./../common/hwcfuncs.c" 3 4
                                     ((void *)0)
# 699 "./../common/hwcfuncs.c"
                                         , 
# 699 "./../common/hwcfuncs.c" 3 4
                                           ((void *)0)
# 699 "./../common/hwcfuncs.c"
...
# 699 "./../common/hwcfuncs.c"
  ...
  __collector_hwcdrv_driver = &__collector_hwcdrv_default;
  return __collector_hwcdrv_driver;
}
# 26 "/doner/binutils/binutils-515f23e/gprofng/libcollector/libcol_hwcfuncs.c" 2
