# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
# 21 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
# 1 "../config.h" 1
# 22 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 2
...
# 23 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 2
...
# 25 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 2
...
# 27 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 2
...
# 28 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 2
# 39 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
static pthread_key_t tsd_pkeys[64];
static size_t tsd_sizes[64];
...
__collector_tsd_create_key (size_t sz, void (*init)(void*), void (*fini)(void*))
{
  ...
  if (init || fini || (tsd_nkeys >= 64))
    return ((unsigned)-1);
# 96 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
...
{
  if (key_index == ((unsigned)-1))
    return 
# 107 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 3 4
          ((void *)0)
# 107 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
              ;
  if (key_index < 0 || key_index >= tsd_nkeys)
    return 
# 109 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 3 4
          ((void *)0)
# 109 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
              ;
  pthread_key_t key = tsd_pkeys[key_index];
  size_t sz = tsd_sizes[key_index];
# 120 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
  size_t header = 8;
  void *value = pthread_getspecific (key);


  if (value == 
# 124 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 3 4
              ((void *)0)
# 124 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
                  )
    {

      value = __collector_allocCSize (__collector_heap, sz + header, 0);
      if (value == 
# 128 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 3 4
                  ((void *)0)
# 128 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
                      )
 {

   return 
# 131 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 3 4
         ((void *)0)
# 131 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
             ;
 }

      *((size_t *) value) = sz + header;
      __collector_util_funcs.memset(((char *) value) + header, 0, sz);


      if (pthread_setspecific (key, value))
 return 
# 139 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c" 3 4
       ((void *)0)
# 139 "/doner/binutils/binutils-515f23e/gprofng/libcollector/tsd.c"
           ;
    }
