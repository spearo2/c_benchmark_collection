# 1 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
# 1 "/doner/jasper/jasper-2b2efba/src/appl//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
# 72 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
...
# 73 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 2
...
# 74 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 2
...
# 75 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/float.h" 1 3 4
# 76 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 2
...
# 77 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 2
...
# 79 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 2
...
int main(int argc, char **argv)
{
 ...
 while ((id = jas_getopt(argc, argv, opts)) >= 0) {
  ...
  case OPT_VERSION:
   printf("%s\n", "1.900.24");
   exit(
# 230 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
       0
# 230 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                   );
   break;
  case OPT_MAXMEM:
 ...
 if (!(origstream = jas_stream_fopen(origpath, "rb"))) {
  fprintf(
# 266 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         stderr
# 266 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
               , "cannot open %s\n", origpath);
  return 
# 267 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        1
# 267 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                    ;
 }
 ...
 if (!(reconstream = jas_stream_fopen(reconpath, "rb"))) {
  fprintf(
# 272 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         stderr
# 272 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
               , "cannot open %s\n", reconpath);
  return 
# 273 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        1
# 273 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                    ;
 }
 ...
 if (!(origimage = jas_image_decode(origstream, -1, 0))) {
  fprintf(
# 278 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         stderr
# 278 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
               , "cannot load original image\n");
  return 
# 279 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        1
# 279 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                    ;
 }
 ...
 if (!(reconimage = jas_image_decode(reconstream, -1, 0))) {
  fprintf(
# 284 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         stderr
# 284 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
               , "cannot load reconstructed image\n");
  return 
# 285 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        1
# 285 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                    ;
 }
 ...
 if (((reconimage)->numcmpts_) != numcomps) {
  fprintf(
# 297 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         stderr
# 297 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
               , "number of components differ (%d != %d)\n",
    numcomps, ((reconimage)->numcmpts_));
  return 
# 299 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        1
# 299 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                    ;
 }
 ...
 for (compno = 0; compno < numcomps; ++compno) {
  ...
  if (((reconimage)->cmpts_[compno]->width_) != width ||
   ...
   fprintf(
# 311 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 311 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                , "image dimensions differ\n");
   return 
# 312 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         1
# 312 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                     ;
  }
  if (((reconimage)->cmpts_[compno]->prec_) != depth) {
   fprintf(
# 315 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 315 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                , "precisions differ\n");
   return 
# 316 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         1
# 316 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                     ;
  }

  if (!(origdata = jas_matrix_create(height, width))) {
   fprintf(
# 320 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 320 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                , "internal error\n");
   return 
# 321 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         1
# 321 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                     ;
  }
  if (!(recondata = jas_matrix_create(height, width))) {
   fprintf(
# 324 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 324 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                , "internal error\n");
   return 
# 325 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         1
# 325 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                     ;
  }
  if (jas_image_readcmpt(origimage, compno, 0, 0, width, height,
    origdata)) {
   fprintf(
# 329 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 329 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                , "cannot read component data\n");
   return 
# 330 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         1
# 330 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                     ;
  }
  if (jas_image_readcmpt(reconimage, compno, 0, 0, width, height,
    recondata)) {
   fprintf(
# 334 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 334 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                , "cannot read component data\n");
   return 
# 335 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         1
# 335 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                     ;
  }
  ...
  if (diffpath) {
   if (!(diffstream = jas_stream_fopen(diffpath, "rwb"))) {
    fprintf(
# 340 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
           stderr
# 340 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                 , "cannot open diff stream\n");
    return 
# 341 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          1
# 341 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                      ;
   }
   if (!(diffimage = makediffimage(origdata, recondata))) {
    fprintf(
# 344 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
           stderr
# 344 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                 , "cannot make diff image\n");
    return 
# 345 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          1
# 345 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                      ;
   }
   fmtid = jas_image_strtofmt("pnm");
   if (jas_image_encode(diffimage, diffstream, fmtid, 0)) {
    fprintf(
# 349 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
           stderr
# 349 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                 , "cannot save\n");
    return 
# 350 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          1
# 350 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                      ;
   }
 ...
 return 
# 396 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
       0
# 396 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                   ;
}
...
# 489 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
                                                (__builtin_inff ())
# 489 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                                                        ;
}
...
jas_image_t *makediffimage(jas_matrix_t *origdata, jas_matrix_t *recondata)
{
 ...
 for (i = 0; i < 3; ++i) {
  ...
  compparms[i].prec = 8;
  compparms[i].sgnd = 
# 521 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
                     0
# 521 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                          ;
 }
 if (!(diffimage = jas_image_create(3, compparms, (((4) << 8) | (1))))) {
  fprintf(
# 524 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
         stderr
# 524 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
               , "cannot create image\n");
  goto error;
 }
 ...
 for (i = 0; i < 3; ++i) {
  if (!(diffdata[i] = jas_matrix_create(height, width))) {
   fprintf(
# 530 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 530 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
 ...
 for (i = 0; i < 3; ++i) {
  if (jas_image_writecmpt(diffimage, i, 0, 0, width, height, diffdata[i])) {
   fprintf(
# 557 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
          stderr
# 557 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
...
{
 fprintf(
# 577 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        stderr
# 577 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
              , "Image Comparison Utility (Version %s).\n",
   "1.900.24");
 fprintf(
# 579 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        stderr
# 579 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
              ,
...
void usage()
{
 cmdinfo();
 fprintf(
# 588 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        stderr
# 588 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
              , "usage:\n");
 fprintf(
# 589 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        stderr
# 589 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
              ,"%s ", cmdname);
 fprintf(
# 590 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        stderr
# 590 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
              ,
   "-f reference_image_file -F other_image_file [-m metric]\n"
   );
 fprintf(
# 593 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
        stderr
# 593 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
              ,
 ...
 exit(
# 602 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c" 3 4
     1
# 602 "/doner/jasper/jasper-2b2efba/src/appl/imgcmp.c"
                 );
}
