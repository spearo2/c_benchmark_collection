# 1 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
...
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
# 72 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
...
# 73 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
...
# 74 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
...
# 75 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/float.h" 1 3 4
# 76 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
...
# 77 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
...
# 78 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
...
# 80 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 2
...
int main(int argc, char **argv)
{
 ...
 while ((id = jas_getopt(argc, argv, opts)) >= 0) {
  ...
  case OPT_VERSION:
   printf("%s\n", "1.900.24");
   exit(
# 160 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
       0
# 160 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                   );
   break;
  case OPT_DEBUG:
 ...
 if (infile) {
  ...
  if (!(instream = jas_stream_fopen(infile, "rb"))) {
   fprintf(
# 187 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
          stderr
# 187 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                , "cannot open input image file %s\n", infile);
   exit(
# 188 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
       1
# 188 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                   );
  }
 } else {
  ...
  if (!(instream = jas_stream_fdopen(0, "rb"))) {
   fprintf(
# 193 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
          stderr
# 193 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                , "cannot open standard input\n");
   exit(
# 194 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
       1
# 194 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                   );
  }
 }
 ...
 if ((fmtid = jas_image_getfmt(instream)) < 0) {
  fprintf(
# 199 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
         stderr
# 199 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
 ...
 if (!(image = jas_image_decode(instream, fmtid, 0))) {
  ...
  fprintf(
# 205 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
         stderr
# 205 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
               , "cannot load image\n");
  return 
# 206 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
        1
# 206 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                    ;
 }
 ...
 if (!(numcmpts = ((image)->numcmpts_))) {
  fprintf(
# 213 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
         stderr
# 213 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
 ...
 return 
# 232 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
       0
# 232 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                   ;
}
...
{
 fprintf(
# 241 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
        stderr
# 241 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
              , "Image Information Utility (Version %s).\n",
   "1.900.24");
 fprintf(
# 243 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
        stderr
# 243 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
              ,
...
static void usage()
{
 cmdinfo();
 fprintf(
# 252 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
        stderr
# 252 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
              , "usage:\n");
 fprintf(
# 253 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
        stderr
# 253 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
              ,"%s ", cmdname);
 fprintf(
# 254 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
        stderr
# 254 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
              , "[-f image_file]\n");
 exit(
# 255 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c" 3 4
     1
# 255 "/doner/jasper/jasper-2b2efba/src/appl/imginfo.c"
                 );
}
