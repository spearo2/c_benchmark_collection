# 1 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
# 27 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
...
# 30 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
...
# 31 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
...
# 32 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
...
# 35 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
...
# 39 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
# 57 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 58 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2
...
{
 fprintf(
# 104 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
        stderr
# 104 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 127 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
                                    ((void *)0)
# 127 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                                        , 0);
   break;
  case 'm':
   maxitems = strtoul(optarg, 
# 130 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
                             ((void *)0)
# 130 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                                 , 0);
   break;
  default:
   usage();
 ...
 for (; optind < argc; optind++) {
  fd = open(argv[optind], 
# 139 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
                         00
# 139 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                                 |0, 0);
  if (fd < 0) {
   perror(argv[0]);
   return (-1);
...
ReadDirectory(int fd, unsigned int ix, uint64 off)
{
 ...
 uint32 direntrysize;
 void* dirmem = 
# 268 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
               ((void *)0)
# 268 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                   ;
 uint64 nextdiroff;
 uint32 n;
 uint8* dp;
...
# 278 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
                          0
# 278 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                                  ) != (off_t)off) {
 ...
 if (dirmem == 
# 307 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
              ((void *)0)
# 307 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                  ) {
 ...
 for (dp = (uint8*)dirmem, n = dircount; n > 0; n--) {
  ...
  if (swabflag)
   TIFFSwabShort(&type);
  PrintTag(
# 366 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
          stdout
# 366 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                , tag);
  putchar(' ');
  PrintType(
# 368 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
           stdout
# 368 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                 , type);
  putchar(' ');
  if (!bigtiff)
  {
  ...
  if (!bigtiff)
  {
   if (datasize>4)
   {
    ...
    datafits = 0;
    datamem = 
# 406 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
             ((void *)0)
# 406 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                 ;
  ...
  else
  {
   if (datasize>8)
   {
    datafits = 0;
    datamem = 
# 419 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
             ((void *)0)
# 419 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                 ;
  ...
  if (!datafits)
  {
   ...
   if (datamem) {
    ...
    "Seek error accessing tag %u value", tag);
     _TIFFfree(datamem);
     datamem = 
# 453 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
              ((void *)0)
# 453 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                  ;
    }
    ...
    "Read error accessing tag %u value", tag);
     _TIFFfree(datamem);
     datamem = 
# 460 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
              ((void *)0)
# 460 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                  ;
    }
   } else
  ...
  if (datamem)
  {
   ...
   PrintData(
# 498 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
            stdout
# 498 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 657 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 2


# 658 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
static void
PrintASCII(FILE* fd, uint32 cc, const unsigned char* cp)
{
 for (; cc > 0; cc--, cp++) {
  ...
  if (
# 664 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 664 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
     *cp
# 664 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
...
# 833 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
__builtin_va_start(
# 833 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
ap
# 833 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
,
# 833 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 833 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                 ;
 vError(
# 834 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
       stderr
# 834 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
             , fmt, ap);
 
# 835 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
__builtin_va_end(
# 835 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
ap
# 835 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
)
# 835 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 842 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
__builtin_va_start(
# 842 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
ap
# 842 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
,
# 842 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
...
# 842 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
                 ;
 vError(
# 843 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
       stderr
# 843 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
             , fmt, ap);
 
# 844 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
__builtin_va_end(
# 844 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
ap
# 844 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c" 3 4
)
# 844 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffdump.c"
