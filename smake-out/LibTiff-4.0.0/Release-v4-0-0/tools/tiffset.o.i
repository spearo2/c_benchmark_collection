# 1 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
# 33 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
...
# 34 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 2
...
# 35 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 2
...
# 36 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 2
...
# 38 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 2
...
# 39 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 2
...
# 47 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
((void *)0)

# 48 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
};
...
usage(void)
{
 ...
 for (i = 0; usageMsg[i]; i++)
  fprintf(
# 55 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
         stderr
# 55 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
               , "%s\n", usageMsg[i]);
 exit(-1);
}
...
GetField(TIFF *tiff, const char *tagname)
{
    ...
    if (!fip) {
        fprintf( 
# 70 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                stderr
# 70 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                      , "Field name \"%s\" is not recognised.\n", tagname );
        return (TIFFField *)
# 71 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                           ((void *)0)
# 71 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                               ;
    }
...
main(int argc, char* argv[])
{
    ...
    if (tiff == 
# 87 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
               ((void *)0)
# 87 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                   )
        return 2;
 ...
 if (strcmp(argv[arg_index],"-d") == 0 && arg_index < argc-2) {
     ...
     if( TIFFSetDirectory(tiff, atoi(argv[arg_index]) ) != 1 )
            {
               fprintf( 
# 95 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                       stderr
# 95 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
 ...
 if (strcmp(argv[arg_index],"-sd") == 0 && arg_index < argc-2) {
     ...
     if( TIFFSetSubDirectory(tiff, atoi(argv[arg_index]) ) != 1 )
            {
               fprintf( 
# 104 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                       stderr
# 104 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
        ...
        if (strcmp(argv[arg_index],"-s") == 0 && arg_index < argc-3) {
            ...
            if (fip->field_type == TIFF_ASCII) {
                if (TIFFSetField(tiff, fip->field_tag, argv[arg_index]) != 1)
                    fprintf( 
# 123 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                            stderr
# 123 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                                  , "Failed to set %s=%s\n",
         ...
         || fip->field_writecount == -1) {
                ...
                if (argc - arg_index < wc) {
                    fprintf( 
# 136 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                            stderr
# 136 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                                  ,
    ...
    default:
                        ...
                        if (!array) {
                                fprintf(
# 184 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                                       stderr
# 184 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                                             , "No space for %s tag\n",
                                        tagname);
                                return 4;
                        }
     ...
     ret = TIFFSetField(tiff, fip->field_tag,
      ((uint16 *)array)[0], ((uint16 *)array)[1]);
                ...
                if (ret != 1)
                    fprintf(
# 280 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                           stderr
# 280 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                                 , "Failed to set %s\n", fip->field_name);
                arg_index += wc;
            }
            ...
            if (fip->field_type != TIFF_ASCII) {
                fprintf( 
# 296 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                        stderr
# 296 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                              ,
            ...
            if(fp == 
# 304 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                    ((void *)0)
# 304 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
                        ) {
            ...
            if(TIFFSetField( tiff, fip->field_tag, text ) != 1) {
                fprintf(
# 316 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                       stderr
# 316 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
            ...
            fprintf(
# 323 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c" 3 4
                   stderr
# 323 "/doner/libtiff/libtiff-Release-v4-0-0/tools/tiffset.c"
