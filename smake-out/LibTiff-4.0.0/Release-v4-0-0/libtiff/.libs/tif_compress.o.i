# 1 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
# 32 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
...
# 33 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 2
...
# 184 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
                                  ((void *)0)
# 184 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
                                      ;
...
TIFFRegisterCODEC(uint16 scheme, const char* name, TIFFInitMethod init)
{
 ...
 if (cd != 
# 207 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
          ((void *)0)
# 207 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
              ) {
  ...
  return 
# 219 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
        ((void *)0)
# 219 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
            ;
 }
 return (cd->info);
}
...
# 252 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
TIFFCodec*
TIFFGetConfiguredCODECs()
{
 ...
 const TIFFCodec* c;
 TIFFCodec* codecs = 
# 258 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
                    ((void *)0)
# 258 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
                        ;
 ...
 for (cd = registeredCODECS; cd; cd = cd->next) {
  ...
  if (!new_codecs) {
   _TIFFfree (codecs);
   return 
# 266 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
         ((void *)0)
# 266 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
             ;
  }
  codecs = new_codecs;
 ...
 for (c = _TIFFBuiltinCODECS; c->name; c++) {
  if (TIFFIsCODECConfigured(c->scheme)) {
   ...
   if (!new_codecs) {
    _TIFFfree (codecs);
    return 
# 278 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
          ((void *)0)
# 278 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
              ;
   }
   codecs = new_codecs;
 ...
 if (!new_codecs) {
  _TIFFfree (codecs);
  return 
# 289 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c" 3 4
        ((void *)0)
# 289 "/doner/libtiff/libtiff-Release-v4-0-0/libtiff/tif_compress.c"
            ;
 }
 codecs = new_codecs;
