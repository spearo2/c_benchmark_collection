# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c" 2
...
void jpc_rct(jas_matrix_t *c0, jas_matrix_t *c1, jas_matrix_t *c2)
{
 ...
 ((void) sizeof ((((c1)->numrows_) == numrows && ((c1)->numcols_) == numcols && ((c2)->numrows_) == numrows && ((c2)->numcols_) == numcols) ? 1 : 0), __extension__ ({ if (((c1)->numrows_) == numrows && ((c1)->numcols_) == numcols && ((c2)->numrows_) == numrows && ((c2)->numcols_) == numcols) ; else __assert_fail ("jas_matrix_numrows(c1) == numrows && jas_matrix_numcols(c1) == numcols && jas_matrix_numrows(c2) == numrows && jas_matrix_numcols(c2) == numcols", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c", 102, __extension__ __PRETTY_FUNCTION__); }));
...
void jpc_irct(jas_matrix_t *c0, jas_matrix_t *c1, jas_matrix_t *c2)
{
 ...
 ((void) sizeof ((((c1)->numrows_) == numrows && ((c1)->numcols_) == numcols && ((c2)->numrows_) == numrows && ((c2)->numcols_) == numcols) ? 1 : 0), __extension__ ({ if (((c1)->numrows_) == numrows && ((c1)->numcols_) == numcols && ((c2)->numrows_) == numrows && ((c2)->numcols_) == numcols) ; else __assert_fail ("jas_matrix_numrows(c1) == numrows && jas_matrix_numcols(c1) == numcols && jas_matrix_numrows(c2) == numrows && jas_matrix_numcols(c2) == numcols", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c", 146, __extension__ __PRETTY_FUNCTION__); }));
...
void jpc_ict(jas_matrix_t *c0, jas_matrix_t *c1, jas_matrix_t *c2)
{
 ...
 numrows = ((c0)->numrows_);
 ((void) sizeof ((((c1)->numrows_) == numrows && ((c2)->numrows_) == numrows) ? 1 : 0), __extension__ ({ if (((c1)->numrows_) == numrows && ((c2)->numrows_) == numrows) ; else __assert_fail ("jas_matrix_numrows(c1) == numrows && jas_matrix_numrows(c2) == numrows", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c", 190, __extension__ __PRETTY_FUNCTION__); }));
 numcols = ((c0)->numcols_);
 ((void) sizeof ((((c1)->numcols_) == numcols && ((c2)->numcols_) == numcols) ? 1 : 0), __extension__ ({ if (((c1)->numcols_) == numcols && ((c2)->numcols_) == numcols) ; else __assert_fail ("jas_matrix_numcols(c1) == numcols && jas_matrix_numcols(c2) == numcols", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c", 192, __extension__ __PRETTY_FUNCTION__); }));
 for (i = 0; i < numrows; ++i) {
  c0p = (&(c0)->rows_[i][0]);
  c1p = (&(c1)->rows_[i][0]);
  c2p = (&(c2)->rows_[i][0]);
...
void jpc_iict(jas_matrix_t *c0, jas_matrix_t *c1, jas_matrix_t *c2)
{
 ...
 numrows = ((c0)->numrows_);
 ((void) sizeof ((((c1)->numrows_) == numrows && ((c2)->numrows_) == numrows) ? 1 : 0), __extension__ ({ if (((c1)->numrows_) == numrows && ((c2)->numrows_) == numrows) ; else __assert_fail ("jas_matrix_numrows(c1) == numrows && jas_matrix_numrows(c2) == numrows", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c", 231, __extension__ __PRETTY_FUNCTION__); }));
 numcols = ((c0)->numcols_);
 ((void) sizeof ((((c1)->numcols_) == numcols && ((c2)->numcols_) == numcols) ? 1 : 0), __extension__ ({ if (((c1)->numcols_) == numcols && ((c2)->numcols_) == numcols) ; else __assert_fail ("jas_matrix_numcols(c1) == numcols && jas_matrix_numcols(c2) == numcols", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mct.c", 233, __extension__ __PRETTY_FUNCTION__); }));
 for (i = 0; i < numrows; ++i) {
  c0p = (&(c0)->rows_[i][0]);
  c1p = (&(c1)->rows_[i][0]);
  c2p = (&(c2)->rows_[i][0]);
