# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h" 1
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h"
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h" 2
...
# 148 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h"
...
# 180 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h"
void jpc_mqdec_dump(jpc_mqdec_t *dec, FILE *out);
# 267 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h"
...
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.h" 1
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.h"
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h" 1
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h"
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tsfb.h" 1
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tsfb.h"
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tsfb.h" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h" 2


# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.h" 1
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.h"
typedef struct {
...
# 86 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h" 2
...
# 487 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_dec.h"
typedef struct {
...
void jpc_seglist_insert(jpc_dec_seglist_t *list, jpc_dec_seg_t *ins,
  jpc_dec_seg_t *node);
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.h" 2
...
int JPC_ISTERMINATED(int passno, int firstpassno, int numpasses, int termall,
  int lazy);
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.h" 2
...
# 86 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c" 2
...
# 144 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
int jpc_dec_decodecblks(jpc_dec_t *dec, jpc_dec_tile_t *tile)
{
  ...
  jpc_dec_cblk_t *cblk, int dopartial, int maxlyrs)
{
 ...
 if (!cblk->flags) {
  ...
  if (!(cblk->flags = jas_matrix_create(((cblk->data)->numrows_) +
    2, ((cblk->data)->numcols_) + 2))) {
   return -1;
  }
 }
 ...
 while (seg && (seg != cblk->curseg || dopartial) && (maxlyrs < 0 ||
   seg->lyrno < maxlyrs)) {
  ((void) sizeof ((seg->numpasses >= seg->maxpasses || dopartial) ? 1 : 0), __extension__ ({ if (seg->numpasses >= seg->maxpasses || dopartial) ; else __assert_fail ("seg->numpasses >= seg->maxpasses || dopartial", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 217, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof ((seg->stream) ? 1 : 0), __extension__ ({ if (seg->stream) ; else __assert_fail ("seg->stream", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 218, __extension__ __PRETTY_FUNCTION__); }));
  jas_stream_rewind(seg->stream);
  jas_stream_setrwcount(seg->stream, 0);
  if (seg->type == 1) {
   if (!cblk->mqdec) {
    if (!(cblk->mqdec = jpc_mqdec_create((((((0 + 1) + 9) + 3) + 5) + 1), 0))) {
     return -1;
    }
    jpc_mqdec_setctxs(cblk->mqdec, (((((0 + 1) + 9) + 3) + 5) + 1), jpc_mqctxs);
   }
   jpc_mqdec_setinput(cblk->mqdec, seg->stream);
   jpc_mqdec_init(cblk->mqdec);
  } else {
   ((void) sizeof ((seg->type == 2) ? 1 : 0), __extension__ ({ if (seg->type == 2) ; else __assert_fail ("seg->type == JPC_SEG_RAW", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 231, __extension__ __PRETTY_FUNCTION__); }));
   if (!cblk->nulldec) {
    if (!(cblk->nulldec = jpc_bitstream_sopen(seg->stream, "r"))) {
     ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 234, __extension__ __PRETTY_FUNCTION__); }));
    }
   }
  }
...
if (bpno < 0) {
 goto premature_exit;
   ...
   ((void) sizeof ((bpno >= 0 && bpno < 31) ? 1 : 0), __extension__ ({ if (bpno >= 0 && bpno < 31) ; else __assert_fail ("bpno >= 0 && bpno < 31", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 261, __extension__ __PRETTY_FUNCTION__); }));
   switch (passtype) {
   case 0:
    ret = (seg->type == 1) ? dec_sigpass(dec,
      cblk->mqdec, bpno, band->orient,
      (tile->cp->ccps[compno].cblkctx & 0x08) != 0,
   ...
   case 1:
    ...
    break;
   case 2:
    ((void) sizeof ((seg->type == 1) ? 1 : 0), __extension__ ({ if (seg->type == 1) ; else __assert_fail ("seg->type == JPC_SEG_MQ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 282, __extension__ __PRETTY_FUNCTION__); }));
    ret = dec_clnpass(dec, cblk->mqdec, bpno,
      band->orient, (tile->cp->ccps[compno].cblkctx &
      0x08) != 0, (tile->cp->ccps[compno].cblkctx &
      0x20) != 0, cblk->flags,
      cblk->data);
    break;
   default:
   ...
   if (tile->cp->ccps[compno].cblkctx & 0x02) {
    jpc_mqdec_setctxs(cblk->mqdec, (((((0 + 1) + 9) + 3) + 5) + 1), jpc_mqctxs);
   }
  ...
  if (seg->type == 1) {
   ...
   ((void) sizeof ((seg->type == 2) ? 1 : 0), __extension__ ({ if (seg->type == 2) ; else __assert_fail ("seg->type == JPC_SEG_RAW", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 308, __extension__ __PRETTY_FUNCTION__); }));
   if (tile->cp->ccps[compno].cblkctx & 0x10) {
    fillmask = 0x7f;
    filldata = 0x2a;
   } else {
    fillmask = 0;
 ...
 ((void) sizeof ((dopartial ? (!cblk->curseg) : 1) ? 1 : 0), __extension__ ({ if (dopartial ? (!cblk->curseg) : 1) ; else __assert_fail ("dopartial ? (!cblk->curseg) : 1", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 332, __extension__ __PRETTY_FUNCTION__); }));

premature_exit:
 return 0;
}
# 362 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
  ...
  int vcausalflag, jas_matrix_t *flags, jas_matrix_t *data)
{
 ...
 for (i = height; i > 0; i -= 4, fstripestart += fstripestep,
  ...
  for (j = width; j > 0; --j, ++fvscanstart, ++dvscanstart) {
   ...
   { int f; int v; f = *(fp); if ((f & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008)) && !(f & (0x1000 | 0x4000))) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_zcctxnolut[(((orient)) << 8) | ((f) & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008))])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); if (v) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_scctxnolut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); v ^= (jpc_spblut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4]); { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((vcausalflag))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; *(dp) = (v) ? (-(oneplushalf)) : (oneplushalf); } *(fp) |= 0x4000; } };
...
# 468 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
  ...
  jas_matrix_t *flags, jas_matrix_t *data)
{
 ...
 for (i = height; i > 0; i -= 4, fstripestart += fstripestep,
  ...
  for (j = width; j > 0; --j, ++fvscanstart, ++dvscanstart) {
   ...
   { jpc_fix_t f = *(fp); jpc_fix_t v; if ((f & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008)) && !(f & (0x1000 | 0x4000))) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 519, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } if (v) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 519, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((vcausalflag))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; *(dp) = v ? (-oneplushalf) : (oneplushalf); } *(fp) |= 0x4000; } };
   ...
   { jpc_fix_t f = *(fp); jpc_fix_t v; if ((f & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008)) && !(f & (0x1000 | 0x4000))) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 528, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } if (v) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 528, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((0))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; *(dp) = v ? (-oneplushalf) : (oneplushalf); } *(fp) |= 0x4000; } };
   ...
   { jpc_fix_t f = *(fp); jpc_fix_t v; if ((f & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008)) && !(f & (0x1000 | 0x4000))) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 537, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } if (v) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 537, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((0))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; *(dp) = v ? (-oneplushalf) : (oneplushalf); } *(fp) |= 0x4000; } };
   ...
   { jpc_fix_t f = *(fp); jpc_fix_t v; if ((f & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008)) && !(f & (0x1000 | 0x4000))) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 546, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } if (v) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 546, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((0))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; *(dp) = v ? (-oneplushalf) : (oneplushalf); } *(fp) |= 0x4000; } };
...
# 570 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
  ...
  int vcausalflag, jas_matrix_t *flags, jas_matrix_t *data)
{
 ...
 for (i = height; i > 0; i -= 4, fstripestart += fstripestep,
  ...
  for (j = width; j > 0; --j, ++fvscanstart, ++dvscanstart) {
   ...
   { int v; int t; if (((*(fp)) & (0x1000 | 0x4000)) == 0x1000) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_magctxnolut[((*(fp)) & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008)) | ((((*(fp)) & 0x2000) != 0) << 11)])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); t = (v ? (poshalf) : (neghalf)); *(dp) += (*(dp) < 0) ? (-t) : t; *(fp) |= 0x2000; } };
...
# 668 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
  ...
  jas_matrix_t *flags, jas_matrix_t *data)
{
 ...
 for (i = height; i > 0; i -= 4, fstripestart += fstripestep,
  ...
  for (j = width; j > 0; --j, ++fvscanstart, ++dvscanstart) {
   ...
   { jpc_fix_t v; jpc_fix_t t; if (((*(fp)) & (0x1000 | 0x4000)) == 0x1000) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 720, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } t = (v ? poshalf : neghalf); *(dp) += (*(dp) < 0) ? (-t) : t; *(fp) |= 0x2000; } };
   ...
   { jpc_fix_t v; jpc_fix_t t; if (((*(fp)) & (0x1000 | 0x4000)) == 0x1000) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 728, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } t = (v ? poshalf : neghalf); *(dp) += (*(dp) < 0) ? (-t) : t; *(fp) |= 0x2000; } };
   if (--k <= 0) {
    continue;
   }
   fp += frowstep;
   ...
   { jpc_fix_t v; jpc_fix_t t; if (((*(fp)) & (0x1000 | 0x4000)) == 0x1000) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 736, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } t = (v ? poshalf : neghalf); *(dp) += (*(dp) < 0) ? (-t) : t; *(fp) |= 0x2000; } };
   if (--k <= 0) {
    continue;
   }
   fp += frowstep;
   ...
   { jpc_fix_t v; jpc_fix_t t; if (((*(fp)) & (0x1000 | 0x4000)) == 0x1000) { ((v) = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c", 744, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))); if (v < 0) { return -1; } t = (v ? poshalf : neghalf); *(dp) += (*(dp) < 0) ? (-t) : t; *(fp) |= 0x2000; } };
  }
 }
 return 0;
}
# 776 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1dec.c"
  ...
  int vcausalflag, int segsymflag, jas_matrix_t *flags, jas_matrix_t *data)
{
 ...
 for (i = 0; i < height; i += 4, fstripestart += fstripestep,
  ...
  fvscanstart = fstripestart;
  dvscanstart = dstripestart;
  vscanlen = (((4) < (height - i)) ? (4) : (height - i));
  for (j = width; j > 0; --j, ++fvscanstart, ++dvscanstart) {
   fp = fvscanstart;
   if (vscanlen >= 4 && (!((*fp) & (0x1000 | 0x4000 |
    ...
    ((v) = ((((mqdec)->areg -= (*(mqdec)->curctx)->qeval), (mqdec)->creg >> 16 >= (*(mqdec)->curctx)->qeval) ? ((((mqdec)->creg -= (*(mqdec)->curctx)->qeval << 16), (mqdec)->areg & 0x8000) ? (*(mqdec)->curctx)->mps : jpc_mqdec_mpsexchrenormd(mqdec)) : jpc_mqdec_lpsexchrenormd(mqdec)));
    if (!v) {
     continue;
    }
    ((mqdec)->curctx = &(mqdec)->ctxs[((((0 + 1) + 9) + 3) + 5)]);;
    ((v) = ((((mqdec)->areg -= (*(mqdec)->curctx)->qeval), (mqdec)->creg >> 16 >= (*(mqdec)->curctx)->qeval) ? ((((mqdec)->creg -= (*(mqdec)->curctx)->qeval << 16), (mqdec)->areg & 0x8000) ? (*(mqdec)->curctx)->mps : jpc_mqdec_mpsexchrenormd(mqdec)) : jpc_mqdec_lpsexchrenormd(mqdec)));
    runlen = v;
    ((v) = ((((mqdec)->areg -= (*(mqdec)->curctx)->qeval), (mqdec)->creg >> 16 >= (*(mqdec)->curctx)->qeval) ? ((((mqdec)->creg -= (*(mqdec)->curctx)->qeval << 16), (mqdec)->areg & 0x8000) ? (*(mqdec)->curctx)->mps : jpc_mqdec_mpsexchrenormd(mqdec)) : jpc_mqdec_lpsexchrenormd(mqdec)));
    runlen = (runlen << 1) | v;
   ...
   { int v; clnpass_full0: if (!((f) & (0x1000 | 0x4000))) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_zcctxnolut[(((orient)) << 8) | (((f)) & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008))])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); if (v) { clnpass_partial0: ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_scctxnolut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); v ^= (jpc_spblut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4]); *(dp) = (v) ? (-(oneplushalf)) : (oneplushalf); { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((vcausalflag))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; } } *(fp) &= ~0x4000; };
   ...
   f = *fp;
   { int v; ; if (!((f) & (0x1000 | 0x4000))) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_zcctxnolut[(((orient)) << 8) | (((f)) & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008))])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); if (v) { clnpass_partial1: ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_scctxnolut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); v ^= (jpc_spblut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4]); *(dp) = (v) ? (-(oneplushalf)) : (oneplushalf); { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((0))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; } } *(fp) &= ~0x4000; };
   ...
   f = *fp;
   { int v; ; if (!((f) & (0x1000 | 0x4000))) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_zcctxnolut[(((orient)) << 8) | (((f)) & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008))])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); if (v) { clnpass_partial2: ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_scctxnolut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); v ^= (jpc_spblut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4]); *(dp) = (v) ? (-(oneplushalf)) : (oneplushalf); { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((0))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; } } *(fp) &= ~0x4000; };
   ...
   f = *fp;
   { int v; ; if (!((f) & (0x1000 | 0x4000))) { ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_zcctxnolut[(((orient)) << 8) | (((f)) & (0x0010 | 0x0001 | 0x0020 | 0x0002 | 0x0040 | 0x0004 | 0x0080 | 0x0008))])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); if (v) { clnpass_partial3: ((mqdec)->curctx = &(mqdec)->ctxs[(jpc_scctxnolut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4])]);; ((v) = (((((mqdec))->areg -= (*((mqdec))->curctx)->qeval), ((mqdec))->creg >> 16 >= (*((mqdec))->curctx)->qeval) ? (((((mqdec))->creg -= (*((mqdec))->curctx)->qeval << 16), ((mqdec))->areg & 0x8000) ? (*((mqdec))->curctx)->mps : jpc_mqdec_mpsexchrenormd((mqdec))) : jpc_mqdec_lpsexchrenormd((mqdec)))); v ^= (jpc_spblut[((f) & ((0x0010 | 0x0020 | 0x0040 | 0x0080) | (0x0100 | 0x0200 | 0x0400 | 0x0800))) >> 4]); *(dp) = (v) ? (-(oneplushalf)) : (oneplushalf); { register jpc_fix_t *np = ((fp)) - ((frowstep)); register jpc_fix_t *sp = ((fp)) + ((frowstep)); if (((0))) { sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } else { np[-1] |= 0x0002; np[1] |= 0x0004; sp[-1] |= 0x0001; sp[1] |= 0x0008; if (v) { *np |= 0x0040 | 0x0400; *sp |= 0x0010 | 0x0100; ((fp))[-1] |= 0x0020 | 0x0200; ((fp))[1] |= 0x0080 | 0x0800; } else { *np |= 0x0040; *sp |= 0x0010; ((fp))[-1] |= 0x0020; ((fp))[1] |= 0x0080; } } }; *(fp) |= 0x1000; } } *(fp) &= ~0x4000; };
