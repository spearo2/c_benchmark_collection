# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c"
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_image.h" 1
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_image.h"
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_image.h" 2
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2


# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.h" 1
# 121 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.h"
typedef struct {
 uint_fast32_t magic;
} jp2_jp_t;
# 132 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.h"
typedef struct {
...
# 171 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.h"
typedef struct {
 uint_fast8_t method;
 uint_fast8_t pri;
 uint_fast8_t approx;
...
# 208 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.h"
typedef struct {
...
# 301 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.h"
jp2_cdefchan_t *jp2_cdef_lookup(jp2_cdef_t *cdef, int channo);
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.h" 1
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.h"
typedef struct {
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c" 2
...
jas_image_t *jp2_decode(jas_stream_t *in, const char *optstr)
{
 ...
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jp2_decode(%p, \"%s\")\n", in, optstr)) : 0);
 ...
 if (box->type != 0x6a502020) {
  jas_eprintf("error: expecting signature box\n");
  goto error;
 }
 if (box->data.jp.magic != 0x0d0a870a) {
 ...
 if (dec->ihdr->data.ihdr.numcmpts != ((unsigned int) (((dec->image)->numcmpts_)))) {
 ...
 samedtype = 1;
 dtype = (((((dec->image)->cmpts_[0]->sgnd_) & 1) << 7) | (((dec->image)->cmpts_[0]->prec_) & 0x7f));
 for (i = 1; i < ((unsigned int) (((dec->image)->numcmpts_))); ++i) {
  if ((((((dec->image)->cmpts_[i]->sgnd_) & 1) << 7) | (((dec->image)->cmpts_[i]->prec_) & 0x7f)) != dtype) {
   samedtype = 0;
   break;
  }
 }
 ...
 if ((samedtype && dec->ihdr->data.ihdr.bpc != (((((dtype) >> 7) & 1) << 7) | (((dtype) & 0x7f) - 1))) ||
   (!samedtype && dec->ihdr->data.ihdr.bpc != 255)) {
  jas_eprintf("warning: component data type mismatch\n");
 }


 if (dec->ihdr->data.ihdr.comptype != 7) {
 ...
 if (dec->bpcc) {
  ...
  if (dec->bpcc->data.bpcc.numcmpts != ((unsigned int) (((dec->image)->numcmpts_)))) {
  ...
  if (!samedtype) {
   for (i = 0; i < ((unsigned int) (((dec->image)->numcmpts_)));
     ++i) {
    if ((((((dec->image)->cmpts_[i]->sgnd_) & 1) << 7) | (((dec->image)->cmpts_[i]->prec_) & 0x7f)) !=
      ((((dec->bpcc->data.bpcc.bpcs[i] >> 7) & 1) << 7) | (((dec->bpcc->data.bpcc.bpcs[i] & 0x7f) + 1) & 0x7f))) {
     jas_eprintf("warning: component data type mismatch\n");
    }
   }
  } else {
 ...
 case 2:
  ...
  ((dec->image)->clrspc_ = (fromiccpcs(icchdr.colorspc)));
  dec->image->cmprof_ = jas_cmprof_createfromiccprof(iccprof);
  ((void) sizeof ((dec->image->cmprof_) ? 1 : 0), __extension__ ({ if (dec->image->cmprof_) ; else __assert_fail ("dec->image->cmprof_", "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c", 308, __extension__ __PRETTY_FUNCTION__); }));
 ...
 dec->numchans = dec->cmap ? dec->cmap->data.cmap.numchans :
   ((unsigned int) (((dec->image)->numcmpts_)));


 if (dec->cmap) {
  for (i = 0; i < dec->numchans; ++i) {

   if (dec->cmap->data.cmap.ents[i].cmptno >= ((unsigned int) (((dec->image)->numcmpts_)))) {
  ...
  for (channo = 0; channo < cmapd->numchans; ++channo) {
   ...
   if (cmapent->map == 0) {
    ...
    jas_image_depalettize(dec->image, cmapent->cmptno,
      ...
      ((((pclrd->bpc[cmapent->pcol] >> 7) & 1) << 7) | (((pclrd->bpc[cmapent->pcol] & 0x7f) + 1) & 0x7f)), newcmptno);
    dec->chantocmptlut[channo] = newcmptno;
    jas_free(lutents);
# 391 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c"
   }
  }
 }
 ...
 for (i = 0; i < ((unsigned int) (((dec->image)->numcmpts_))); ++i) {
  ((dec->image)->cmpts_[(i)]->type_ = (0x10000));
 }
 ...
 if (dec->cdef) {
  for (i = 0; i < dec->numchans; ++i) {
   ...
   ((dec->image)->cmpts_[(dec->chantocmptlut[dec->cdef->data.cdef.ents[i].channo])]->type_ = (jp2_getct(((dec->image)->clrspc_), dec->cdef->data.cdef.ents[i].type, dec->cdef->data.cdef.ents[i].assoc)));
  ...
  for (i = 0; i < dec->numchans; ++i) {
   ((dec->image)->cmpts_[(dec->chantocmptlut[i])]->type_ = (jp2_getct(((dec->image)->clrspc_), 0, i + 1)));

  }
 }


 for (i = ((dec->image)->numcmpts_); i > 0; --i) {
  if (((dec->image)->cmpts_[(i - 1)]->type_) == 0x10000) {
...
int jp2_validate(jas_stream_t *in)
{
 ...
 ((void) sizeof ((16 >= ((((12 + 16) < (16)) ? (12 + 16) : (16)))) ? 1 : 0), __extension__ ({ if (16 >= ((((12 + 16) < (16)) ? (12 + 16) : (16)))) ; else __assert_fail ("JAS_STREAM_MAXPUTBACK >= JP2_VALIDATELEN", "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_dec.c", 466, __extension__ __PRETTY_FUNCTION__); }));



 if ((n = jas_stream_read(in, buf, ((((12 + 16) < (16)) ? (12 + 16) : (16))))) < 0) {
  return -1;
 }
