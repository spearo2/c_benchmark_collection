# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.h" 1
# 65 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.h"
typedef struct {
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c" 2
...
int bmp_encode(jas_image_t *image, jas_stream_t *out, const char *optstr)
{
 ...
 for (cmptno = 0; cmptno < enc->numcmpts; ++cmptno) {
  if (((image)->cmpts_[enc->cmpts[cmptno]]->width_) != width ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->height_) != height ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->prec_) != depth ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->sgnd_) != 0 ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->tlx_) != 0 ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->tly_) != 0) {
 ...
 hdr.magic = 0x4d42;
 hdr.siz = 14 + 40 + 0 + datalen;
 hdr.off = 14 + 40 + ((info)->numcolors * 4);
...
static int bmp_puthdr(jas_stream_t *out, bmp_hdr_t *hdr)
{
 ((void) sizeof ((hdr->magic == 0x4d42) ? 1 : 0), __extension__ ({ if (hdr->magic == 0x4d42) ; else __assert_fail ("hdr->magic == BMP_MAGIC", "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c", 238, __extension__ __PRETTY_FUNCTION__); }));
...
static int bmp_putinfo(jas_stream_t *out, bmp_info_t *info)
{
 ...
 {
  if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(i)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (i))))) : (-1)) == (-1) ||
    ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(i)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (i))))) : (-1)) == (-1) ||
    ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(i)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (i))))) : (-1)) == (-1) ||
  ...
  int *cmpts)
{
 ...
 if (((info)->numcolors > 0) && numcmpts == 3) {
 ...
 for (i = info->height - 1; i >= 0; --i) {
  ...
  for (j = 0; j < info->width; ++j) {
   if (numcmpts == 3) {
    red = ((((bufs[0])->numrows_ == 1) ? ((bufs[0])->rows_[0][j]) : ((bufs[0])->rows_[j][0])));
    grn = ((((bufs[1])->numrows_ == 1) ? ((bufs[1])->rows_[0][j]) : ((bufs[1])->rows_[j][0])));
    blu = ((((bufs[2])->numrows_ == 1) ? ((bufs[2])->rows_[0][j]) : ((bufs[2])->rows_[j][0])));
    if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(blu)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (blu))))) : (-1)) == (-1) ||
      ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(grn)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (grn))))) : (-1)) == (-1) ||
      ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(red)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (red))))) : (-1)) == (-1)) {
     ret = -1;
     goto bmp_putdata_done;
    }
   } else if (numcmpts == 1) {
    v = ((((bufs[cmpts[0]])->numrows_ == 1) ? ((bufs[cmpts[0]])->rows_[0][j]) : ((bufs[cmpts[0]])->rows_[j][0])));
    if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(v)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (v))))) : (-1)) == (-1)) {
     ret = -1;
     goto bmp_putdata_done;
    }
   } else {
  ...
  for (j = numpad; j > 0; --j) {
   if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(0)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (0))))) : (-1)) == (-1)) {
    ret = -1;
    goto bmp_putdata_done;
   }
  }
...
static int bmp_putint16(jas_stream_t *in, int_fast16_t val)
{
 if (((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, (-1)) : (((in)->bufmode_ |= 0x0020, --(in)->cnt_ < 0) ? jas_stream_flushbuf((in), (unsigned char)(val & 0xff)) : (++(in)->rwcnt_, (int)(*(in)->ptr_++ = (val & 0xff))))) : (-1)) == (-1) || ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, (-1)) : (((in)->bufmode_ |= 0x0020, --(in)->cnt_ < 0) ? jas_stream_flushbuf((in), (unsigned char)((val >> 8) & 0xff)) : (++(in)->rwcnt_, (int)(*(in)->ptr_++ = ((val >> 8) & 0xff))))) : (-1)) == (-1)) {
...
static int bmp_putint32(jas_stream_t *out, int_fast32_t val)
{
 ...
 ((void) sizeof ((val >= 0) ? 1 : 0), __extension__ ({ if (val >= 0) ; else __assert_fail ("val >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/bmp/bmp_enc.c", 389, __extension__ __PRETTY_FUNCTION__); }));
 v = val;
 for (n = 4;;) {
  if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(v & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (v & 0xff))))) : (-1)) == (-1)) {
   return -1;
  }
  if (--n <= 0) {
   break;
