# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
# 86 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c" 2
...
jas_seq_t *jpc_seq_upsample(jas_seq_t *x, int m)
{
 ...
 if (!(z = (jas_seq2d_create(((x)->xstart_) * m, 0, (((x)->xend_) - 1) * m + 1, 1))))
  return 0;
 for (i = ((z)->xstart_); i < ((z)->xend_); i++) {
  *(&(z)->rows_[0][(i) - (z)->xstart_]) = (!(((i) < 0) ? (((-i) % (m)) ? ((m) - ((-(i)) % (m))) : (0)) : ((i) % (m)))) ? ((x)->rows_[0][(i / m) - (x)->xstart_]) :
    ((jpc_fix_t) ((0) << (13)));
 }
...
jpc_fix_t jpc_seq_norm(jas_seq_t *x)
{
 ...
 return ((jpc_fix_t) (((sqrt((((double) (s)) / (((jpc_fix_t) (1)) << (13))))) * ((double) (((jpc_fix_t) (1)) << (13))))));
}
...
jas_seq_t *jpc_seq_conv(jas_seq_t *x, jas_seq_t *y)
{
 ...
 z = (jas_seq2d_create(((x)->xstart_) + ((y)->xstart_), 0, ((x)->xend_) + ((y)->xend_) - 1, 1));

 ((void) sizeof ((z) ? 1 : 0), __extension__ ({ if (z) ; else __assert_fail ("z", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_util.c", 178, __extension__ __PRETTY_FUNCTION__); }));
 for (i = ((z)->xstart_); i < ((z)->xend_); i++) {
  s = ((jpc_fix_t) ((0) << (13)));
