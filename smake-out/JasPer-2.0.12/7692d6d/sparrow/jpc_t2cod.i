# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c" 2
# 70 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c"
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h" 2
...
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c" 2
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c" 2
...
static int jpc_pi_nextrlcp(register jpc_pi_t *pi)
{
 ...
 pchg = pi->pchg;
 if (!pi->prgvolfirst) {
  ((void) sizeof ((pi->prcno < pi->pirlvl->numprcs) ? 1 : 0), __extension__ ({ if (pi->prcno < pi->pirlvl->numprcs) ; else __assert_fail ("pi->prcno < pi->pirlvl->numprcs", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c", 188, __extension__ __PRETTY_FUNCTION__); }));
  prclyrno = &pi->pirlvl->prclyrnos[pi->prcno];
  goto skip;
 } else {
  pi->prgvolfirst = 0;
  ...
  for (compno = 0, picomp = pi->picomps; compno < pi->numcomps;
   ...
   for (rlvlno = 0, pirlvl = picomp->pirlvls; rlvlno <
    ...
    if (pirlvl->prcwidthexpn + picomp->numrlvls >
      (8 * sizeof(uint_fast32_t)) - 2 ||
      pirlvl->prcheightexpn + picomp->numrlvls >
      (8 * sizeof(uint_fast32_t)) - 2) {
     return -1;
    }
    xstep = picomp->hsamp * (((uint_fast32_t) (1)) <<
      (pirlvl->prcwidthexpn + picomp->numrlvls - rlvlno - 1));
    ystep = picomp->vsamp * (((uint_fast32_t) (1)) <<
  ...
  for (pi->y = pi->ystart; pi->y < pi->yend; pi->y +=
   ...
   for (pi->x = pi->xstart; pi->x < pi->xend; pi->x +=
    ...
    for (pi->compno = pchg->compnostart,
     ...
     if (((pi->x == pi->xstart &&
       ((trx0 << r) % (((uint_fast32_t) (1)) << rpx)))
       || !(pi->x % (((uint_fast32_t) (1)) << rpx))) &&
       ((pi->y == pi->ystart &&
       ((try0 << r) % (((uint_fast32_t) (1)) << rpy)))
       || !(pi->y % (((uint_fast32_t) (1)) << rpy)))) {
      ...
      ((void) sizeof ((pi->prcno < pi->pirlvl->numprcs) ? 1 : 0), __extension__ ({ if (pi->prcno < pi->pirlvl->numprcs) ; else __assert_fail ("pi->prcno < pi->pirlvl->numprcs", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c", 305, __extension__ __PRETTY_FUNCTION__); }));
    ...
    for (pi->rlvlno = pchg->rlvlnostart,
     ...
     if (((pi->x == pi->xstart &&
      ...
      prcvind = (((((pi->y) + (pi->picomp->vsamp << r) - 1) / (pi->picomp->vsamp << r))) >> (pi->pirlvl->prcheightexpn)) -
        ...
        ((try0) >> (pi->pirlvl->prcheightexpn));
      pi->prcno = prcvind * pi->pirlvl->numhprcs + prchind;
      ((void) sizeof ((pi->prcno < pi->pirlvl->numprcs) ? 1 : 0), __extension__ ({ if (pi->prcno < pi->pirlvl->numprcs) ; else __assert_fail ("pi->prcno < pi->pirlvl->numprcs", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c", 405, __extension__ __PRETTY_FUNCTION__); }));
      for (pi->lyrno = 0; pi->lyrno < pi->numlyrs &&
        pi->lyrno < ((int) (pchg->lyrnoend));
        ++pi->lyrno) {
       prclyrno = &pi->pirlvl->prclyrnos[pi->prcno];
       if (pi->lyrno >= *prclyrno) {
        ++(*prclyrno);
...
static int jpc_pi_nextcprl(register jpc_pi_t *pi)
{
 ...
 for (pi->compno = pchg->compnostart, pi->picomp = &pi->picomps[pi->compno];
   pi->compno < ((int) (pchg->compnoend)) && pi->compno < pi->numcomps;
   ++pi->compno, ++pi->picomp) {
  ...
  pi->xstep = pi->picomp->hsamp * (((uint_fast32_t) (1)) <<
    (pirlvl->prcwidthexpn + pi->picomp->numrlvls - 1));
  pi->ystep = pi->picomp->vsamp * (((uint_fast32_t) (1)) <<
    (pirlvl->prcheightexpn + pi->picomp->numrlvls - 1));
  for (rlvlno = 1, pirlvl = &pi->picomp->pirlvls[1];
    rlvlno < pi->picomp->numrlvls; ++rlvlno, ++pirlvl) {
   pi->xstep = (((pi->xstep) < (pi->picomp->hsamp * (((uint_fast32_t) (1)) << (pirlvl->prcwidthexpn + pi->picomp->numrlvls - rlvlno - 1)))) ? (pi->xstep) : (pi->picomp->hsamp * (((uint_fast32_t) (1)) << (pirlvl->prcwidthexpn + pi->picomp->numrlvls - rlvlno - 1))));


   pi->ystep = (((pi->ystep) < (pi->picomp->vsamp * (((uint_fast32_t) (1)) << (pirlvl->prcheightexpn + pi->picomp->numrlvls - rlvlno - 1)))) ? (pi->ystep) : (pi->picomp->vsamp * (((uint_fast32_t) (1)) << (pirlvl->prcheightexpn + pi->picomp->numrlvls - rlvlno - 1))));
    ...
    for (pi->rlvlno = pchg->rlvlnostart,
     ...
     if (((pi->x == pi->xstart &&
      ...
      prcvind = (((((pi->y) + (pi->picomp->vsamp << r) - 1) / (pi->picomp->vsamp << r))) >> (pi->pirlvl->prcheightexpn)) -
        ...
        ((try0) >> (pi->pirlvl->prcheightexpn));
      pi->prcno = prcvind * pi->pirlvl->numhprcs + prchind;
      ((void) sizeof ((pi->prcno < pi->pirlvl->numprcs) ? 1 : 0), __extension__ ({ if (pi->prcno < pi->pirlvl->numprcs) ; else __assert_fail ("pi->prcno < pi->pirlvl->numprcs", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c", 499, __extension__ __PRETTY_FUNCTION__); }));
      for (pi->lyrno = 0; pi->lyrno < pi->numlyrs &&
        pi->lyrno < ((int) (pchg->lyrnoend));
        ++pi->lyrno) {
       prclyrno = &pi->pirlvl->prclyrnos[pi->prcno];
...
jpc_pchg_t *jpc_pchglist_remove(jpc_pchglist_t *pchglist, int pchgno)
{
 int i;
 jpc_pchg_t *pchg;
 ((void) sizeof ((pchgno < pchglist->numpchgs) ? 1 : 0), __extension__ ({ if (pchgno < pchglist->numpchgs) ; else __assert_fail ("pchgno < pchglist->numpchgs", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2cod.c", 617, __extension__ __PRETTY_FUNCTION__); }));
