# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
# 66 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c"
...
# 67 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 68 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
# 69 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_tvp.h" 1
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_tvp.h"
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_tvp.h" 2
...
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_jpeglib.h" 1
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_jpeglib.h"
...
extern boolean jpeg_read_icc_profile(j_decompress_ptr cinfo,
                                      JOCTET **icc_data_ptr,
                                      unsigned int *icc_data_len);
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_jpeglib.h" 2
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_cod.h" 1
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c" 2
...
# 148 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c"
static const char jas_libjpeg_turbo_version[] = "2.0.3";
...
jas_image_t *jpg_decode(jas_stream_t *in, const char *optstr)
{
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpg_decode(%p, \"%s\")\n", in, optstr)) : 0);
 ...
 if (opts.print_version) {
  printf("%d %s\n", 80, jas_libjpeg_turbo_version);
  goto error;
 }

 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("JPEG library version: %d\n", 80)) : 0);
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("JPEG Turbo library version: %s\n", jas_libjpeg_turbo_version)) : 0);
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_std_error(%p)\n", &jerr)) : 0);
 cinfo.err = jpeg_std_error(&jerr);
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_create_decompress(%p)\n", &cinfo)) : 0);
 jpeg_CreateDecompress((&cinfo), 80, (size_t)sizeof(struct jpeg_decompress_struct));


 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_stdio_src(%p, %p)\n", &cinfo, input_file)) : 0);
 jpeg_stdio_src(&cinfo, input_file);


 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_read_header(%p, TRUE)\n", &cinfo)) : 0);
 ret = jpeg_read_header(&cinfo, 1);
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_read_header return value %d\n", ret)) : 0);
 if (ret != 1) {
  jas_eprintf("jpeg_read_header did not return JPEG_HEADER_OK\n");
 }
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ( "header: image_width %d; image_height %d; num_components %d\n", cinfo.image_width, cinfo.image_height, cinfo.num_components)) : 0);
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_start_decompress(%p)\n", &cinfo)) : 0);
 ret = jpeg_start_decompress(&cinfo);
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_start_decompress return value %d\n", ret)) : 0);
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ( "header: output_width %d; output_height %d; output_components %d\n", cinfo.output_width, cinfo.output_height, cinfo.output_components)) : 0);
 ...
 while (cinfo.output_scanline < cinfo.output_height) {
  ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jpeg_read_scanlines(%p, %p, %lu)\n", &cinfo, dest_mgr->buffer, ((unsigned long) (dest_mgr->buffer_height)))) : 0);

  num_scanlines = jpeg_read_scanlines(&cinfo, dest_mgr->buffer,
    dest_mgr->buffer_height);
  ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jpeg_read_scanlines return value %lu\n", ((unsigned long) (num_scanlines)))) : 0);
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_finish_decompress(%p)\n", &cinfo)) : 0);
 jpeg_finish_decompress(&cinfo);


 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpeg_destroy_decompress(%p)\n", &cinfo)) : 0);
 jpeg_destroy_decompress(&cinfo);

 jas_matrix_destroy(dest_mgr->data);

 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("fclose(%p)\n", input_file)) : 0);
 fclose(input_file);
 input_file = 0;
...
static jas_image_t *jpg_mkimage(j_decompress_ptr cinfo)
{
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpg_mkimage(%p)\n", cinfo)) : 0);
 ...
 for (cmptno = 0; cmptno < numcmpts; ++cmptno) {
  if (cinfo->image_width > (9223372036854775807L) ||
    cinfo->image_height > (9223372036854775807L)) {
   goto error;
  }
  cmptparm.tlx = 0;
  cmptparm.tly = 0;
...
static int jpg_copystreamtofile(FILE *out, jas_stream_t *in)
{
 ...
 while ((c = ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, (-1)) : ((--(in)->cnt_ < 0) ? jas_stream_fillbuf(in, 1) : (++(in)->rwcnt_, (int)(*(in)->ptr_++)))) : (-1))) != (-1)) {
  if (fputc(c, out) == (-1)) {
   return -1;
  }
 }
 if ((((in)->flags_ & 0x0002) != 0)) {
  return -1;
 }
 return 0;
}
...
static void jpg_start_output(j_decompress_ptr cinfo, jpg_dest_t *dinfo)
{
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpg_start_output(%p, %p)\n", cinfo, dinfo)) : 0);
  ...
  JDIMENSION rows_supplied)
{
 ...
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jpg_put_pixel_rows(%p, %p)\n", cinfo, dinfo)) : 0);

 if (dinfo->error) {
  return;
 }

 ((void) sizeof ((cinfo->output_components == ((dinfo->image)->numcmpts_)) ? 1 : 0), __extension__ ({ if (cinfo->output_components == ((dinfo->image)->numcmpts_)) ; else __assert_fail ("cinfo->output_components == jas_image_numcmpts(dinfo->image)", "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_dec.c", 463, __extension__ __PRETTY_FUNCTION__); }));

 for (cmptno = 0; cmptno < cinfo->output_components; ++cmptno) {
  width = ((dinfo->image)->cmpts_[cmptno]->width_);
  bufptr = (dinfo->buffer[0]) + cmptno;
  for (x = 0; x < width; ++x) {
   ((dinfo->data)->rows_[0][x] = (((int)(*bufptr))));
   bufptr += cinfo->output_components;
  }
  ((jas_getdbglevel() >= (100)) ? (jas_eprintf ( "jas_image_writecmpt called for component %d row %lu\n", cmptno, ((unsigned long) (dinfo->row)))) : 0);
...
static void jpg_finish_output(j_decompress_ptr cinfo, jpg_dest_t *dinfo)
{
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("jpg_finish_output(%p, %p)\n", cinfo, dinfo)) : 0);
