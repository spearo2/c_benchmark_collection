# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c" 2
# 93 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_tvp.c"
jas_tvparser_t *jas_tvparser_create(const char *s)
{
 jas_tvparser_t *tvp;
...
int jas_tvparser_next(jas_tvparser_t *tvp)
{
 ...
 p = tvp->pos;
 while (*p != '\0' && ((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISspace)) {
  ++p;
 }
 ...
 if (!(((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISalpha) || (*p) == '_' || ((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISdigit))) {
  return -1;
 }
 ...
 while (*p != '\0' && (((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISalpha) || (*p) == '_' || ((*__ctype_b_loc ())[(int) ((*p))] & (unsigned short int) _ISdigit))) {
  ++p;
 }
