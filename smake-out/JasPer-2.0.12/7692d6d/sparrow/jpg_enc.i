# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
# 66 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 67 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 68 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 70 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_cod.h" 1
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.h" 1
# 65 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.h"
typedef struct {
 int numcmpts;
 int cmpts[4];
} jpg_enc_t;
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c" 2
...
static JDIMENSION jpg_get_pixel_rows(j_compress_ptr cinfo, struct jpg_src_s *sinfo)
{
 ...
 width = ((sinfo->image)->brx_ - (sinfo->image)->tlx_);
...
int jpg_encode(jas_image_t *image, jas_stream_t *out, const char *optstr)
{
 ...
 for (cmptno = 0; cmptno < enc->numcmpts; ++cmptno) {
  if (((image)->cmpts_[enc->cmpts[cmptno]]->width_) != width ||
    ...
    ((image)->cmpts_[enc->cmpts[cmptno]]->hstep_) != 1 ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->vstep_) != 1 ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->prec_) != 8 ||
 ...
 ((void) sizeof ((src_mgr->data) ? 1 : 0), __extension__ ({ if (src_mgr->data) ; else __assert_fail ("src_mgr->data", "/doner/jasper/jasper-7692d6d/src/libjasper/jpg/jpg_enc.c", 300, __extension__ __PRETTY_FUNCTION__); }));
 src_mgr->buffer = (*cinfo.mem->alloc_sarray)((j_common_ptr) &cinfo,
   1, (JDIMENSION) width * cinfo.input_components,
   (JDIMENSION) 1);
 ...
 if (encopts.qual >= 0) {
  jpeg_set_quality(&cinfo, encopts.qual, 1);
 }
