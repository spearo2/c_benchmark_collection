# 1 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 77 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
...
extern int timespec_get (struct timespec *__ts, int __base)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 78 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/appl/../libjasper/include/jasper/jas_fix.h"
...
# 83 "/doner/jasper/jasper-7692d6d/src/appl/../libjasper/include/jasper/jas_fix.h" 2
...
# 70 "/doner/jasper/jasper-7692d6d/src/appl/../libjasper/include/jasper/jas_tmr.h"
...
# 81 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c" 2
# 95 "/doner/jasper/jasper-7692d6d/src/appl/jasper.c"
typedef struct {
...
int main(int argc, char **argv)
{
 ...
 if (cmdopts->srgb) {
  ...
  if (!(outprof = jas_cmprof_createfromclrspc((((4) << 8) | (1))))) {
   jas_eprintf("cannot create sRGB profile\n");
   exit(1);
  }
  if (!(newimage = jas_image_chclrspc(image, outprof, 0))) {
...
cmdopts_t *cmdopts_parse(int argc, char **argv)
{
 ...
 static jas_opt_t cmdoptions[] = {
  ...
  {CMDOPT_INFILE, "input", 0x01},
  {CMDOPT_INFILE, "f", 0x01},
  {CMDOPT_INFMT, "input-format", 0x01},
  {CMDOPT_INFMT, "t", 0x01},
  {CMDOPT_INOPT, "input-option", 0x01},
  {CMDOPT_INOPT, "o", 0x01},
  {CMDOPT_OUTFILE, "output", 0x01},
  {CMDOPT_OUTFILE, "F", 0x01},
  {CMDOPT_OUTFMT, "output-format", 0x01},
  {CMDOPT_OUTFMT, "T", 0x01},
  {CMDOPT_OUTOPT, "output-option", 0x01},
  {CMDOPT_OUTOPT, "O", 0x01},
  {CMDOPT_VERSION, "version", 0},
  {CMDOPT_DEBUG, "debug-level", 0x01},
  {CMDOPT_CMPTNO, "cmptno", 0x01},
 ...
 while ((c = jas_getopt(argc, argv, cmdoptions)) != (-1)) {
  switch (c) {
  case CMDOPT_HELP:
   cmdusage();
   break;
  ...
  case CMDOPT_INFMT:
   ...
   break;
  case CMDOPT_INOPT:
   addopt(cmdopts->inoptsbuf, 4096, jas_optarg);
  ...
  case CMDOPT_OUTFMT:
   ...
   break;
  case CMDOPT_OUTOPT:
   addopt(cmdopts->outoptsbuf, 4096, jas_optarg);
