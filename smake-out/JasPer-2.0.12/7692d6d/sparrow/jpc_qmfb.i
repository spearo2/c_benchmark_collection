# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_fix.h" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_fix.h" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
...
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.h" 1
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.h"
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.h" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.h" 2
...
# 87 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
...
# 88 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
...
# 89 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c" 2
...
void jpc_ft_fwdlift_row(jpc_fix_t *a, int numcols, int parity)
{
 ...
 if (numcols > 1) {
  ...
  while (n-- > 0) {
   ...
   hptr[0] -= jas_fast32_asr(lptr[0] + lptr[1], 1);
   ++hptr;
   ++lptr;
  }
  if (parity == (numcols & 1)) {
  ...
  if (!parity) {
   ...
   lptr[0] += jas_fast32_asr(hptr[0] + 1, 1);
   ++lptr;
  }
  n = llen - (!parity) - (parity != (numcols & 1));
  while (n-- > 0) {

   lptr[0] += jas_fast32_asr(hptr[0] + hptr[1] + 2, 2);
   ++lptr;
   ++hptr;
  }
  if (parity != (numcols & 1)) {
  ...
  if (parity) {
   ...
   lptr[0] = jas_fast32_asl(lptr[0], 1);
  }
...
void jpc_ft_fwdlift_col(jpc_fix_t *a, int numrows, int stride, int parity)
{
 ...
 if (numrows > 1) {
  ...
  while (n-- > 0) {
   ...
   hptr[0] -= jas_fast32_asr(lptr[0] + lptr[stride], 1);
   hptr += stride;
   lptr += stride;
  }
  if (parity == (numrows & 1)) {
  ...
  while (n-- > 0) {
   ...
   lptr[0] += jas_fast32_asr(hptr[0] + hptr[stride] + 2, 2);
   lptr += stride;
   hptr += stride;
  }
  if (parity != (numrows & 1)) {
 ...
 if (numrows > 1) {
  ...
  while (n-- > 0) {
   ...
   for (i = 0; i < 16; ++i) {
    ...
    hptr2[0] -= jas_fast32_asr(lptr2[0] + lptr2[stride], 1);
    ++lptr2;
    ++hptr2;
   }
   hptr += stride;
  ...
  if (!parity) {
   ...
   for (i = 0; i < 16; ++i) {
    ...
    lptr2[0] += jas_fast32_asr(hptr2[0] + 1, 1);
    ++lptr2;
    ++hptr2;
   }
   lptr += stride;
  ...
  while (n-- > 0) {
   ...
   for (i = 0; i < 16; ++i) {
    ...
    lptr2[0] += jas_fast32_asr(hptr2[0] + hptr2[stride] + 2, 2);
    ++lptr2;
    ++hptr2;
   }
   lptr += stride;
  ...
  if (parity) {
   ...
   for (i = 0; i < 16; ++i) {
    ...
    lptr2[0] = jas_fast32_asl(lptr2[0], 1);
    ++lptr2;
   }
  }
...
void jpc_ft_invlift_row(jpc_fix_t *a, int numcols, int parity)
{
 ...
 if (numcols > 1) {
  ...
  if (parity) {
   ...
   lptr[0] = jas_fast32_asr(lptr[0], 1);
  }
 ...
 if (numrows > 1) {
  ...
  if (parity) {
   ...
   for (i = 0; i < 16; ++i) {
    ...
    lptr2[0] = jas_fast32_asr(lptr2[0], 1);
    ++lptr2;
   }
  }
...
# 1629 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
void jpc_ns_fwdlift_row(jpc_fix_t *a, int numcols, int parity)
{
 ...
 if (numcols > 1) {
  ...
  hptr = &a[llen];
  if (parity) {
   ((hptr[0]) = ((hptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (-1.586134342059924)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (lptr[0]))) >> (13))))));

   ++hptr;
  }
  n = numcols - llen - parity - (parity == (numcols & 1));
  while (n-- > 0) {
   ((hptr[0]) = ((hptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((-1.586134342059924)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((lptr[0]) + (lptr[1]))))) >> (13))))));
  ...
  hptr = &a[llen];
  if (!parity) {
   ((lptr[0]) = ((lptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (-0.052980118572961)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (hptr[0]))) >> (13))))));

   ++lptr;
  }
  n = llen - (!parity) - (parity != (numcols & 1));
  while (n-- > 0) {
   ((lptr[0]) = ((lptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((-0.052980118572961)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((hptr[0]) + (hptr[1]))))) >> (13))))));
  ...
  hptr = &a[llen];
  if (parity) {
   ((hptr[0]) = ((hptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (0.882911075530934)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (lptr[0]))) >> (13))))));

   ++hptr;
  }
  n = numcols - llen - parity - (parity == (numcols & 1));
  while (n-- > 0) {
   ((hptr[0]) = ((hptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((0.882911075530934)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((lptr[0]) + (lptr[1]))))) >> (13))))));
  ...
  hptr = &a[llen];
  if (!parity) {
   ((lptr[0]) = ((lptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (0.443506852043971)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (hptr[0]))) >> (13))))));

   ++lptr;
  }
  n = llen - (!parity) - (parity != (numcols & 1));
  while (n-- > 0) {
   ((lptr[0]) = ((lptr[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((0.443506852043971)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((hptr[0]) + (hptr[1]))))) >> (13))))));
  ...
  n = llen;
  while (n-- > 0) {
   lptr[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (lptr[0])) * ((jpc_fix_big_t) (((jpc_fix_t) ((((1.0 / 1.23017410558578)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
   ++lptr;
  }
  hptr = &a[llen];
  n = numcols - llen;
  while (n-- > 0) {
   hptr[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (hptr[0])) * ((jpc_fix_big_t) (((jpc_fix_t) ((((1.0 / 1.62578613134411)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
   ++hptr;
  }


 } else {
# 1747 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
  ...
  int parity)
{
 ...
 if (numrows > 1) {
  ...
  if (parity) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((hptr2[0]) = ((hptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (-1.586134342059924)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (lptr2[0]))) >> (13))))));
  ...
  while (n-- > 0) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((hptr2[0]) = ((hptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((-1.586134342059924)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((lptr2[0]) + (lptr2[stride]))))) >> (13))))));
  ...
  if (!parity) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((lptr2[0]) = ((lptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (-0.052980118572961)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (hptr2[0]))) >> (13))))));
  ...
  while (n-- > 0) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((lptr2[0]) = ((lptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((-0.052980118572961)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((hptr2[0]) + (hptr2[stride]))))) >> (13))))));
  ...
  if (parity) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((hptr2[0]) = ((hptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (0.882911075530934)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (lptr2[0]))) >> (13))))));
  ...
  while (n-- > 0) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((hptr2[0]) = ((hptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) ((((0.882911075530934)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (((lptr2[0]) + (lptr2[stride]))))) >> (13))))));
  ...
  if (!parity) {
   ...
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    ((lptr2[0]) = ((lptr2[0]) + (((jpc_fix_t) ((((jpc_fix_big_t) (((jpc_fix_t) (((2.0 * (0.443506852043971)) * ((double) (((jpc_fix_t) (1)) << (13)))))))) * ((jpc_fix_big_t) (hptr2[0]))) >> (13))))));
  ...
  while (n-- > 0) {
   lptr2 = lptr;
   for (i = 0; i < 16; ++i) {
    lptr2[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (lptr2[0])) * ((jpc_fix_big_t) (((jpc_fix_t) ((((1.0 / 1.23017410558578)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
    ++lptr2;
   }
   lptr += stride;
  }
  ...
  while (n-- > 0) {
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    hptr2[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (hptr2[0])) * ((jpc_fix_big_t) (((jpc_fix_t) ((((1.0 / 1.62578613134411)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
    ++hptr2;
   }
   hptr += stride;
  }
...
# 1956 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
...
# 2165 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
...
# 2343 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
...
void jpc_ns_invlift_row(jpc_fix_t *a, int numcols, int parity)
{
 ...
 if (numcols > 1) {
  ...
  n = llen;
  while (n-- > 0) {
   lptr[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (lptr[0])) * ((jpc_fix_big_t) (((jpc_fix_t) (((1.0 / (1.0 / 1.23017410558578)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
   ++lptr;
  }
  hptr = &a[llen];
  n = numcols - llen;
  while (n-- > 0) {
   hptr[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (hptr[0])) * ((jpc_fix_big_t) (((jpc_fix_t) (((1.0 / (1.0 / 1.62578613134411)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
   ++hptr;
  }
...
# 2465 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
  ...
  int parity)
{
 ...
 if (numrows > 1) {
  ...
  while (n-- > 0) {
   lptr2 = lptr;
   for (i = 0; i < 16; ++i) {
    lptr2[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (lptr2[0])) * ((jpc_fix_big_t) (((jpc_fix_t) (((1.0 / (1.0 / 1.23017410558578)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
    ++lptr2;
   }
   lptr += stride;
  }
  ...
  while (n-- > 0) {
   hptr2 = hptr;
   for (i = 0; i < 16; ++i) {
    hptr2[0] = ((jpc_fix_t) ((((jpc_fix_big_t) (hptr2[0])) * ((jpc_fix_big_t) (((jpc_fix_t) (((1.0 / (1.0 / 1.62578613134411)) * ((double) (((jpc_fix_t) (1)) << (13))))))))) >> (13)));
    ++hptr2;
   }
   hptr += stride;
  }
...
# 2674 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
...
# 2883 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
...
# 3061 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_qmfb.c"
 }
