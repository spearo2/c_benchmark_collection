# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
# 66 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 67 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
# 69 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
# 70 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.h" 1
# 65 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.h"
typedef struct {
 int cmpt;
} pgx_enc_t;
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_enc.c" 2
...
static int pgx_putword(jas_stream_t *out, _Bool bigendian, int prec,
  uint_fast32_t val);
static uint_fast32_t pgx_inttoword(int_fast32_t val, int prec, _Bool sgnd);
  ...
  uint_fast32_t val)
{
 ...
 for (i = 0; i < wordsize; ++i) {
  ...
  if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((val >> (8 * j)) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((val >> (8 * j)) & 0xff))))) : (-1)) == (-1)) {
   return -1;
  }
 }
 return 0;
...
static uint_fast32_t pgx_inttoword(jas_seqent_t v, int prec, _Bool sgnd)
{
 uint_fast32_t ret;
