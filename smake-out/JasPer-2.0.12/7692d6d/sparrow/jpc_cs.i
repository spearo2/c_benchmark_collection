# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_malloc.h" 1
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_malloc.h"
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_malloc.h" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_malloc.h" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c" 2
...
void jpc_ms_dump(jpc_ms_t *ms, FILE *out)
{
 jpc_mstabent_t *mstabent;
 mstabent = jpc_mstab_lookup(ms->id);
 fprintf(out, "type = 0x%04""l" "x"" (%s);", ms->id, mstabent->name);
 if ((!((ms->id) == 0xff4f || (ms->id) == 0xff93 || (ms->id) == 0xffd9 || (ms->id) == 0xff92 || ((ms->id) >= 0xff30 && (ms->id) <= 0xff3f)))) {
  fprintf(out, " len = %""l" "u"";", ms->len + 2);
  if (ms->ops->dumpparms) {
...
static int jpc_sot_dumpparms(jpc_ms_t *ms, FILE *out)
{
 jpc_sot_t *sot = &ms->parms.sot;
 fprintf(out,
   "tileno = %""l" "u""; len = %""l" "u""; partno = %d; numparts = %d\n",
...
static int jpc_siz_putparms(jpc_ms_t *ms, jpc_cstate_t *cstate, jas_stream_t *out)
{
 ...
 ((void) sizeof ((siz->width && siz->height && siz->tilewidth && siz->tileheight && siz->numcomps) ? 1 : 0), __extension__ ({ if (siz->width && siz->height && siz->tilewidth && siz->tileheight && siz->numcomps) ; else __assert_fail ("siz->width && siz->height && siz->tilewidth && siz->tileheight && siz->numcomps", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 580, __extension__ __PRETTY_FUNCTION__); }));
...
static int jpc_siz_dumpparms(jpc_ms_t *ms, FILE *out)
{
 jpc_siz_t *siz = &ms->parms.siz;
 unsigned int i;
 fprintf(out, "caps = 0x%02""l" "x"";\n", siz->caps);
 fprintf(out, "width = %""l" "u""; height = %""l" "u""; xoff = %""l" "u""; yoff = %" "l" "u" ";\n",
   siz->width, siz->height, siz->xoff, siz->yoff);
 fprintf(out, "tilewidth = %""l" "u""; tileheight = %""l" "u""; "
   "tilexoff = %""l" "u""; tileyoff = %" "l" "u" ";\n",
   siz->tilewidth, siz->tileheight, siz->tilexoff, siz->tileyoff);
 fprintf(out, "numcomps = %""l" "u"";\n", siz->numcomps);
 for (i = 0; i < siz->numcomps; ++i) {
...
{
 jpc_cod_t *cod = &ms->parms.cod;
 ((void) sizeof ((cod->numlyrs > 0 && cod->compparms.numdlvls <= 32) ? 1 : 0), __extension__ ({ if (cod->numlyrs > 0 && cod->compparms.numdlvls <= 32) ; else __assert_fail ("cod->numlyrs > 0 && cod->compparms.numdlvls <= 32", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 662, __extension__ __PRETTY_FUNCTION__); }));
 ((void) sizeof ((cod->compparms.numdlvls == cod->compparms.numrlvls - 1) ? 1 : 0), __extension__ ({ if (cod->compparms.numdlvls == cod->compparms.numrlvls - 1) ; else __assert_fail ("cod->compparms.numdlvls == cod->compparms.numrlvls - 1", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 663, __extension__ __PRETTY_FUNCTION__); }));
...
{
 jpc_coc_t *coc = &ms->parms.coc;
 ((void) sizeof ((coc->compparms.numdlvls <= 32) ? 1 : 0), __extension__ ({ if (coc->compparms.numdlvls <= 32) ; else __assert_fail ("coc->compparms.numdlvls <= 32", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 739, __extension__ __PRETTY_FUNCTION__); }));
 if (cstate->numcomps <= 256) {
...
{
 jpc_coc_t *coc = &ms->parms.coc;
 fprintf(out, "compno = %""l" "u""; csty = 0x%02x; numdlvls = %d;\n",
...
{
 int i;
 ((void) sizeof ((compparms->numdlvls <= 32) ? 1 : 0), __extension__ ({ if (compparms->numdlvls <= 32) ; else __assert_fail ("compparms->numdlvls <= 32", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 830, __extension__ __PRETTY_FUNCTION__); }));
...
{
 jpc_rgn_t *rgn = &ms->parms.rgn;
 fprintf(out, "compno = %""l" "u""; roisty = %d; roishift = %d\n",
...
static int jpc_qcc_dumpparms(jpc_ms_t *ms, FILE *out)
{
 jpc_qcc_t *qcc = &ms->parms.qcc;
 int i;
 fprintf(out, "compno = %""l" "u""; qntsty = %d; numguard = %d; "
 ...
 if (compparms->numstepsizes > 0) {
  ...
  for (i = 0; i < compparms->numstepsizes; ++i) {
   if (compparms->qntsty == 0) {
    ...
    compparms->stepsizes[i] = (((void) sizeof ((!((tmp >> 3) & (~0x1f))) ? 1 : 0), __extension__ ({ if (!((tmp >> 3) & (~0x1f))) ; else __assert_fail ("!((tmp >> 3) & (~0x1f))", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 1069, __extension__ __PRETTY_FUNCTION__); })), (((tmp >> 3) & 0x1f) << 11));
   } else {
  ...
  jas_stream_t *out)
{
 ...
 for (i = 0; i < compparms->numstepsizes; ++i) {
  if (compparms->qntsty == 0) {
   if (jpc_putuint8(out, ((compparms->stepsizes[i]) >> 11) << 3)) {
...
static int jpc_crg_dumpparms(jpc_ms_t *ms, FILE *out)
{
 ...
 for (compno = 0, comp = crg->comps; compno < crg->numcomps; ++compno,
   ++comp) {
  fprintf(out, "hoff[%d] = %""l" "u""; voff[%d] = %""l" "u""\n",
...
static int jpc_com_dumpparms(jpc_ms_t *ms, FILE *out)
{
 ...
 unsigned int i;
 int printable;
 fprintf(out, "regid = %""l" "u"";\n", com->regid);
 printable = 1;
 for (i = 0; i < com->len; ++i) {
  if (!((*__ctype_b_loc ())[(int) ((com->data[i]))] & (unsigned short int) _ISprint)) {
   printable = 0;
   break;
  }
 }
...
int jpc_putuint8(jas_stream_t *out, uint_fast8_t val)
{
 if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(val & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (val & 0xff))))) : (-1)) == (-1)) {
  return -1;
 }
 return 0;
}
...
int jpc_putuint16(jas_stream_t *out, uint_fast16_t val)
{
 if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((val >> 8) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((val >> 8) & 0xff))))) : (-1)) == (-1) ||
   ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(val & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (val & 0xff))))) : (-1)) == (-1)) {
  return -1;
 }
 return 0;
}
...
int jpc_putuint32(jas_stream_t *out, uint_fast32_t val)
{
 if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((val >> 24) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((val >> 24) & 0xff))))) : (-1)) == (-1) ||
   ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((val >> 16) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((val >> 16) & 0xff))))) : (-1)) == (-1) ||
   ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((val >> 8) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((val >> 8) & 0xff))))) : (-1)) == (-1) ||
   ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(val & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (val & 0xff))))) : (-1)) == (-1)) {
  return -1;
 }
 return 0;
...
static jpc_mstabent_t *jpc_mstab_lookup(int id)
{
 ...
 ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 1693, __extension__ __PRETTY_FUNCTION__); }));
 return 0;
}
...
int jpc_validate(jas_stream_t *in)
{
 ...
 ((void) sizeof ((16 >= 2) ? 1 : 0), __extension__ ({ if (16 >= 2) ; else __assert_fail ("JAS_STREAM_MAXPUTBACK >= 2", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_cs.c", 1703, __extension__ __PRETTY_FUNCTION__); }));

 if ((n = jas_stream_read(in, (char *) buf, 2)) < 0) {
  return -1;
 }
 for (i = n - 1; i >= 0; --i) {
  if (jas_stream_ungetc(in, buf[i]) == (-1)) {
   return -1;
  }
 }
 if (n < 2) {
