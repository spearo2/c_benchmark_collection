# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h" 1
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h"
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.h" 2
...
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c" 2
# 101 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c"
...
jpc_mqdec_t *jpc_mqdec_create(int maxctxs, jas_stream_t *in)
{
 ...
 ((void) sizeof ((maxctxs > 0) ? 1 : 0), __extension__ ({ if (maxctxs > 0) ; else __assert_fail ("maxctxs > 0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_mqdec.c", 113, __extension__ __PRETTY_FUNCTION__); }));
...
void jpc_mqdec_init(jpc_mqdec_t *mqdec)
{
 ...
 if ((c = ((!((mqdec->in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((mqdec->in)->rwlimit_ >= 0 && (mqdec->in)->rwcnt_ >= (mqdec->in)->rwlimit_) ? (mqdec->in->flags_ |= 0x0004, (-1)) : ((--(mqdec->in)->cnt_ < 0) ? jas_stream_fillbuf(mqdec->in, 1) : (++(mqdec->in)->rwcnt_, (int)(*(mqdec->in)->ptr_++)))) : (-1))) == (-1)) {
...
int jpc_mqdec_mpsexchrenormd(register jpc_mqdec_t *mqdec)
{
 ...
 { do { if (!(mqdec->ctreg)) { { int c; unsigned char prevbuf; if (!(mqdec->eof)) { if ((c = ((!((mqdec->in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((mqdec->in)->rwlimit_ >= 0 && (mqdec->in)->rwcnt_ >= (mqdec->in)->rwlimit_) ? (mqdec->in->flags_ |= 0x0004, (-1)) : ((--(mqdec->in)->cnt_ < 0) ? jas_stream_fillbuf(mqdec->in, 1) : (++(mqdec->in)->rwcnt_, (int)(*(mqdec->in)->ptr_++)))) : (-1))) == (-1)) { (mqdec->eof) = 1; c = 0xff; } prevbuf = (mqdec->inbuffer); (mqdec->inbuffer) = c; if (prevbuf == 0xff) { if (c > 0x8f) { (mqdec->creg) += 0xff00; (mqdec->ctreg) = 8; } else { (mqdec->creg) += c << 9; (mqdec->ctreg) = 7; } } else { (mqdec->creg) += c << 8; (mqdec->ctreg) = 8; } } else { (mqdec->creg) += 0xff00; (mqdec->ctreg) = 8; } }; } (mqdec->areg) <<= 1; (mqdec->creg) <<= 1; --(mqdec->ctreg); } while (!((mqdec->areg) & 0x8000)); };
...
void jpc_mqdec_dump(jpc_mqdec_t *mqdec, FILE *out)
{
 ...
 fprintf(out, "CTX = %" "l" "d" ", ", mqdec->curctx - mqdec->ctxs);
 fprintf(out, "IND %" "l" "d" ", MPS %d, QEVAL %""l" "x""\n", *mqdec->curctx -
