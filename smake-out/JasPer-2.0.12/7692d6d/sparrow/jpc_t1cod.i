# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c"
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.h" 1
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.h"
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.h" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
void jpc_seglist_insert(jpc_dec_seglist_t *list, jpc_dec_seg_t *ins,
  jpc_dec_seg_t *node);
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
int JPC_ISTERMINATED(int passno, int firstpassno, int numpasses, int termall,
  int lazy);
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c" 2
...
int JPC_PASSTYPE(int passno)
{
 ...
 default:
  passtype = -1;
  ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 130, __extension__ __PRETTY_FUNCTION__); }));
  break;
 }
 return passtype;
}
...
int JPC_NOMINALGAIN(int qmfbid, int numlvls, int lvlno, int orient)
{
 ...
 ((void) sizeof ((qmfbid == 0x01) ? 1 : 0), __extension__ ({ if (qmfbid == 0x01) ; else __assert_fail ("qmfbid == JPC_COX_RFT", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 144, __extension__ __PRETTY_FUNCTION__); }));
 if (lvlno == 0) {
  ((void) sizeof ((orient == 0) ? 1 : 0), __extension__ ({ if (orient == 0) ; else __assert_fail ("orient == JPC_TSFB_LL", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 146, __extension__ __PRETTY_FUNCTION__); }));
  return 0;
 } else {
  switch (orient) {
  case 1:
...
int JPC_SEGPASSCNT(int passno, int firstpassno, int numpasses, int bypass, int termall)
{
 ...
 if (termall) {
  ...
  if (passno < firstpassno + 10) {
   ...
   default:
    ret = -1;
    ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 206, __extension__ __PRETTY_FUNCTION__); }));
    break;
   }
  }
 } else {
...
{
 jpc_fix_t y;
 ((void) sizeof ((!(x & (~((1 << (bitpos + 1)) - 1)))) ? 1 : 0), __extension__ ({ if (!(x & (~((1 << (bitpos + 1)) - 1)))) ; else __assert_fail ("!(x & (~JAS_ONES(bitpos + 1)))", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 290, __extension__ __PRETTY_FUNCTION__); }));
...
int jpc_getzcctxno(int f, int orient)
{
 ...
 ((void) sizeof ((n < 9) ? 1 : 0), __extension__ ({ if (n < 9) ; else __assert_fail ("n < JPC_NUMZCCTXS", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 374, __extension__ __PRETTY_FUNCTION__); }));
 return (0 + 1) + n;
}
...
int jpc_getscctxno(int f)
{
 ...
 hc = (((((f & (0x0020 | 0x0200)) == 0x0020) + ((f & (0x0080 | 0x0800)) == 0x0080)) < (1)) ? (((f & (0x0020 | 0x0200)) == 0x0020) + ((f & (0x0080 | 0x0800)) == 0x0080)) : (1)) - (((((f & (0x0020 | 0x0200)) == (0x0020 | 0x0200)) +
        ((f & (0x0080 | 0x0800)) == (0x0080 | 0x0800))) < (1)) ? (((f & (0x0020 | 0x0200)) == (0x0020 | 0x0200)) + ((f & (0x0080 | 0x0800)) == (0x0080 | 0x0800))) : (1));

 vc = (((((f & (0x0010 | 0x0100)) == 0x0010) + ((f & (0x0040 | 0x0400)) == 0x0040)) < (1)) ? (((f & (0x0010 | 0x0100)) == 0x0010) + ((f & (0x0040 | 0x0400)) == 0x0040)) : (1)) - (((((f & (0x0010 | 0x0100)) == (0x0010 | 0x0100)) +
        ((f & (0x0040 | 0x0400)) == (0x0040 | 0x0400))) < (1)) ? (((f & (0x0010 | 0x0100)) == (0x0010 | 0x0100)) + ((f & (0x0040 | 0x0400)) == (0x0040 | 0x0400))) : (1));

 ((void) sizeof ((hc >= -1 && hc <= 1 && vc >= -1 && vc <= 1) ? 1 : 0), __extension__ ({ if (hc >= -1 && hc <= 1 && vc >= -1 && vc <= 1) ; else __assert_fail ("hc >= -1 && hc <= 1 && vc >= -1 && vc <= 1", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 411, __extension__ __PRETTY_FUNCTION__); }));
 if (hc < 0) {
  hc = -hc;
  vc = -vc;
 }
 ...
 ((void) sizeof ((n < 5) ? 1 : 0), __extension__ ({ if (n < 5) ; else __assert_fail ("n < JPC_NUMSCCTXS", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 433, __extension__ __PRETTY_FUNCTION__); }));
 return (((0 + 1) + 9) + 3) + n;
}
...
int jpc_getmagctxno(int f)
{
 ...
 ((void) sizeof ((n < 3) ? 1 : 0), __extension__ ({ if (n < 3) ; else __assert_fail ("n < JPC_NUMMAGCTXS", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t1cod.c", 447, __extension__ __PRETTY_FUNCTION__); }));
 return ((0 + 1) + 9) + n;
}
