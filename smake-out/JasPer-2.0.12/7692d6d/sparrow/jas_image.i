# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
# 1 "/usr/lib/llvm-13/lib/clang/13.0.1/include/stdbool.h" 1 3
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h" 1
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h"
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h" 2
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 85 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 86 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 87 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
...
# 88 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c" 2
# 99 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
...
static jas_image_cmpt_t *jas_image_cmpt_create(int_fast32_t tlx,
  ...
  int_fast32_t width, int_fast32_t height, uint_fast16_t depth, _Bool sgnd,
  uint_fast32_t inmem);
...
static uint_fast32_t inttobits(jas_seqent_t v, int prec, _Bool sgnd);
static jas_seqent_t bitstoint(uint_fast32_t v, int prec, _Bool sgnd);
...
# 178 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
...
# 349 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
 cmpt = 0;
 ...
 if (size > 0) {
  if (size - 1 > 9223372036854775807L) {
   goto error;
  }
  if (jas_stream_seek(cmpt->stream_, size - 1, 0) < 0 ||
    ((!((cmpt->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((cmpt->stream_)->rwlimit_ >= 0 && (cmpt->stream_)->rwcnt_ >= (cmpt->stream_)->rwlimit_) ? (cmpt->stream_->flags_ |= 0x0004, (-1)) : (((cmpt->stream_)->bufmode_ |= 0x0020, --(cmpt->stream_)->cnt_ < 0) ? jas_stream_flushbuf((cmpt->stream_), (unsigned char)(0)) : (++(cmpt->stream_)->rwcnt_, (int)(*(cmpt->stream_)->ptr_++ = (0))))) : (-1)) == (-1) ||
  ...
  jas_matrix_t *data)
{
 ...
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jas_image_readcmpt(%p, %d, %ld, %ld, %ld, %ld, %p)\n", image, cmptno, ((long) (x)), ((long) (y)), ((long) (width)), ((long) (height)), data)) : 0);
 ...
 for (i = 0; i < height; ++i, dr += drs) {
  ...
  for (j = width; j > 0; --j, ++d) {
   ...
   for (k = cmpt->cps_; k > 0; --k) {
    if ((c = ((!((cmpt->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((cmpt->stream_)->rwlimit_ >= 0 && (cmpt->stream_)->rwcnt_ >= (cmpt->stream_)->rwlimit_) ? (cmpt->stream_->flags_ |= 0x0004, (-1)) : ((--(cmpt->stream_)->cnt_ < 0) ? jas_stream_fillbuf(cmpt->stream_, 1) : (++(cmpt->stream_)->rwcnt_, (int)(*(cmpt->stream_)->ptr_++)))) : (-1))) == (-1)) {
     return -1;
    }
    v = (v << 8) | (c & 0xff);
   }
  ...
  jas_matrix_t *data)
{
 ...
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jas_image_writecmpt(%p, %d, %ld, %ld, %ld, %ld, %p)\n", image, cmptno, ((long) (x)), ((long) (y)), ((long) (width)), ((long) (height)), data)) : 0);
 ...
 for (i = 0; i < height; ++i, dr += drs) {
  ...
  for (j = width; j > 0; --j, ++d) {
   ...
   for (k = cmpt->cps_; k > 0; --k) {
    ...
    if (((!((cmpt->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((cmpt->stream_)->rwlimit_ >= 0 && (cmpt->stream_)->rwcnt_ >= (cmpt->stream_)->rwlimit_) ? (cmpt->stream_->flags_ |= 0x0004, (-1)) : (((cmpt->stream_)->bufmode_ |= 0x0020, --(cmpt->stream_)->cnt_ < 0) ? jas_stream_flushbuf((cmpt->stream_), (unsigned char)((unsigned char) c)) : (++(cmpt->stream_)->rwcnt_, (int)(*(cmpt->stream_)->ptr_++ = ((unsigned char) c))))) : (-1)) == (-1)) {
...
{
 jas_image_fmtinfo_t *fmtinfo;
 ((void) sizeof ((id >= 0 && name && ext && ops) ? 1 : 0), __extension__ ({ if (id >= 0 && name && ext && ops) ; else __assert_fail ("id >= 0 && name && ext && ops", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 632, __extension__ __PRETTY_FUNCTION__); }));
  ...
  jas_image_cmptparm_t *cmptparm)
{
 ...
 ((void) sizeof ((cmptno >= 0 && cmptno <= image->numcmpts_) ? 1 : 0), __extension__ ({ if (cmptno >= 0 && cmptno <= image->numcmpts_) ; else __assert_fail ("cmptno >= 0 && cmptno <= image->numcmpts_", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 777, __extension__ __PRETTY_FUNCTION__); }));
...
void jas_image_dump(jas_image_t *image, FILE *out)
{
 ...
 for (cmptno = 0; cmptno < image->numcmpts_; ++cmptno) {
  cmpt = image->cmpts_[cmptno];
  fprintf(out, "prec=%d, sgnd=%d, cmpttype=%""l" "i""\n", cmpt->prec_,
...
# 1082 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
int jas_image_readcmpt2(jas_image_t *image, int cmptno, jas_image_coord_t x,
  jas_image_coord_t y, jas_image_coord_t width, jas_image_coord_t height,
  long *buf)
{
  ...
  jas_image_coord_t vs, int sgnd, int prec)
{
 ...
 ((void) sizeof ((cmptno >= 0 && cmptno < image->numcmpts_) ? 1 : 0), __extension__ ({ if (cmptno >= 0 && cmptno < image->numcmpts_) ; else __assert_fail ("cmptno >= 0 && cmptno < image->numcmpts_", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1183, __extension__ __PRETTY_FUNCTION__); }));
 oldcmpt = image->cmpts_[cmptno];
 ((void) sizeof ((oldcmpt->tlx_ == 0 && oldcmpt->tly_ == 0) ? 1 : 0), __extension__ ({ if (oldcmpt->tlx_ == 0 && oldcmpt->tly_ == 0) ; else __assert_fail ("oldcmpt->tlx_ == 0 && oldcmpt->tly_ == 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1185, __extension__ __PRETTY_FUNCTION__); }));
...
cmptbry = oldcmpt->tly_ + (oldcmpt->height_ - 1) * oldcmpt->vstep_;
 ...
 for (i = 0; i < height; ++i) {
  ...
  for (j = 0; j < width; ++j) {
   ...
   ((void) sizeof ((oldx >= 0 && oldx < oldcmpt->width_ && oldy >= 0 && oldy < oldcmpt->height_) ? 1 : 0), __extension__ ({ if (oldx >= 0 && oldx < oldcmpt->width_ && oldy >= 0 && oldy < oldcmpt->height_) ; else __assert_fail ("oldx >= 0 && oldx < oldcmpt->width_ && oldy >= 0 && oldy < oldcmpt->height_", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1233, __extension__ __PRETTY_FUNCTION__); }));

   if (jas_stream_seek(oldcmpt->stream_, oldcmpt->cps_ *
     (oldy * oldcmpt->width_ + oldx), 0) < 0)
    goto error;
...
{
 long result;
 ((void) sizeof ((prec >= 2) ? 1 : 0), __extension__ ({ if (prec >= 2) ; else __assert_fail ("prec >= 2", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1319, __extension__ __PRETTY_FUNCTION__); }));
...
static inline unsigned long encode_twos_comp(long n, int prec)
{
 ...
 ((void) sizeof ((prec >= 2) ? 1 : 0), __extension__ ({ if (prec >= 2) ; else __assert_fail ("prec >= 2", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1329, __extension__ __PRETTY_FUNCTION__); }));
 jas_eprintf("warning: support for signed data is untested\n");
...
static int getint(jas_stream_t *in, int sgnd, int prec, long *val)
{
 ...
 int n;
 int c;
 ((void) sizeof (((!sgnd && prec >= 1) || (sgnd && prec >= 2)) ? 1 : 0), __extension__ ({ if ((!sgnd && prec >= 1) || (sgnd && prec >= 2)) ; else __assert_fail ("(!sgnd && prec >= 1) || (sgnd && prec >= 2)", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1347, __extension__ __PRETTY_FUNCTION__); }));
 n = (prec + 7) / 8;
 v = 0;
 while (--n >= 0) {
...
static int putint(jas_stream_t *out, int sgnd, int prec, long val)
{
 ...
 _Bool s;
 unsigned long tmp;
 ((void) sizeof (((!sgnd && prec >= 1) || (sgnd && prec >= 2)) ? 1 : 0), __extension__ ({ if ((!sgnd && prec >= 1) || (sgnd && prec >= 2)) ; else __assert_fail ("(!sgnd && prec >= 1) || (sgnd && prec >= 2)", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1370, __extension__ __PRETTY_FUNCTION__); }));
 if (sgnd) {
  val = encode_twos_comp(val, prec);
 }
 ((void) sizeof ((val >= 0) ? 1 : 0), __extension__ ({ if (val >= 0) ; else __assert_fail ("val >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1374, __extension__ __PRETTY_FUNCTION__); }));
 val &= (1 << prec) - 1;
 n = (prec + 7) / 8;
 while (--n >= 0) {
  c = (val >> (n * 8)) & 0xff;
  if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(c)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (c))))) : (-1)) != c)
   return -1;
 }
 return 0;
}
...
static long downtomult(long x, long y)
{
 ((void) sizeof ((x >= 0) ? 1 : 0), __extension__ ({ if (x >= 0) ; else __assert_fail ("x >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1402, __extension__ __PRETTY_FUNCTION__); }));
 return (x / y) * y;
}

static long uptomult(long x, long y)
{
 ((void) sizeof ((x >= 0) ? 1 : 0), __extension__ ({ if (x >= 0) ; else __assert_fail ("x >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1408, __extension__ __PRETTY_FUNCTION__); }));
 return ((x + y - 1) / y) * y;
}
...
# 1522 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c"
 if (!(tmpprof = jas_cmprof_copy(outprof)))
  goto error;
 ((void) sizeof ((!((outimage)->cmprof_)) ? 1 : 0), __extension__ ({ if (!((outimage)->cmprof_)) ; else __assert_fail ("!jas_image_cmprof(outimage)", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1524, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (i = 0; i < numinclrchans; ++i) {
  ...
  ((void) sizeof ((j >= 0) ? 1 : 0), __extension__ ({ if (j >= 0) ; else __assert_fail ("j >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1541, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (i = 0; i < numoutclrchans; ++i) {
  ...
  ((void) sizeof ((j >= 0) ? 1 : 0), __extension__ ({ if (j >= 0) ; else __assert_fail ("j >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_image.c", 1559, __extension__ __PRETTY_FUNCTION__); }));
