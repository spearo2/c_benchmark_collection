# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h" 1
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_math.h"
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c" 2
...
int jpc_bitstream_getbit_func(jpc_bitstream_t *bitstream)
{
 ...
 ret = (((void) sizeof (((bitstream)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((bitstream)->openmode_ & 0x01) ; else __assert_fail ("(bitstream)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 174, __extension__ __PRETTY_FUNCTION__); })), (--(bitstream)->cnt_ >= 0) ? ((int)(((bitstream)->buf_ >> (bitstream)->cnt_) & 1)) : jpc_bitstream_fillbuf(bitstream));
...
int jpc_bitstream_putbit_func(jpc_bitstream_t *bitstream, int b)
{
 ...
 ret = (((void) sizeof (((bitstream)->openmode_ & 0x02) ? 1 : 0), __extension__ ({ if ((bitstream)->openmode_ & 0x02) ; else __assert_fail ("(bitstream)->openmode_ & JPC_BITSTREAM_WRITE", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 184, __extension__ __PRETTY_FUNCTION__); })), (--(bitstream)->cnt_ < 0) ? ((bitstream)->buf_ = ((bitstream)->buf_ << 8) & 0xffff, (bitstream)->cnt_ = ((bitstream)->buf_ == 0xff00) ? 6 : 7, (bitstream)->buf_ |= ((b) & 1) << (bitstream)->cnt_, (((!(((bitstream)->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? ((((bitstream)->stream_)->rwlimit_ >= 0 && ((bitstream)->stream_)->rwcnt_ >= ((bitstream)->stream_)->rwlimit_) ? ((bitstream)->stream_->flags_ |= 0x0004, (-1)) : ((((bitstream)->stream_)->bufmode_ |= 0x0020, --((bitstream)->stream_)->cnt_ < 0) ? jas_stream_flushbuf(((bitstream)->stream_), (unsigned char)((bitstream)->buf_ >> 8)) : (++((bitstream)->stream_)->rwcnt_, (int)(*((bitstream)->stream_)->ptr_++ = ((bitstream)->buf_ >> 8))))) : (-1)) == (-1)) ? ((-1)) : ((b) & 1)) : ((bitstream)->buf_ |= ((b) & 1) << (bitstream)->cnt_, (b) & 1));
...
long jpc_bitstream_getbits(jpc_bitstream_t *bitstream, int n)
{
 ...
 v = 0;
 while (--n >= 0) {
  if ((u = (((void) sizeof (((bitstream)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((bitstream)->openmode_ & 0x01) ; else __assert_fail ("(bitstream)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 205, __extension__ __PRETTY_FUNCTION__); })), (--(bitstream)->cnt_ >= 0) ? ((int)(((bitstream)->buf_ >> (bitstream)->cnt_) & 1)) : jpc_bitstream_fillbuf(bitstream))) < 0) {
   return -1;
  }
  v = (v << 1) | u;
 }
...
int jpc_bitstream_putbits(jpc_bitstream_t *bitstream, int n, long v)
{
 ...
 ((void) sizeof ((!(v & (~((1 << (n)) - 1)))) ? 1 : 0), __extension__ ({ if (!(v & (~((1 << (n)) - 1)))) ; else __assert_fail ("!(v & (~JAS_ONES(n)))", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 225, __extension__ __PRETTY_FUNCTION__); }));


 m = n - 1;
 while (--n >= 0) {
  if ((((void) sizeof (((bitstream)->openmode_ & 0x02) ? 1 : 0), __extension__ ({ if ((bitstream)->openmode_ & 0x02) ; else __assert_fail ("(bitstream)->openmode_ & JPC_BITSTREAM_WRITE", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 230, __extension__ __PRETTY_FUNCTION__); })), (--(bitstream)->cnt_ < 0) ? ((bitstream)->buf_ = ((bitstream)->buf_ << 8) & 0xffff, (bitstream)->cnt_ = ((bitstream)->buf_ == 0xff00) ? 6 : 7, (bitstream)->buf_ |= (((v >> m) & 1) & 1) << (bitstream)->cnt_, (((!(((bitstream)->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? ((((bitstream)->stream_)->rwlimit_ >= 0 && ((bitstream)->stream_)->rwcnt_ >= ((bitstream)->stream_)->rwlimit_) ? ((bitstream)->stream_->flags_ |= 0x0004, (-1)) : ((((bitstream)->stream_)->bufmode_ |= 0x0020, --((bitstream)->stream_)->cnt_ < 0) ? jas_stream_flushbuf(((bitstream)->stream_), (unsigned char)((bitstream)->buf_ >> 8)) : (++((bitstream)->stream_)->rwcnt_, (int)(*((bitstream)->stream_)->ptr_++ = ((bitstream)->buf_ >> 8))))) : (-1)) == (-1)) ? ((-1)) : (((v >> m) & 1) & 1)) : ((bitstream)->buf_ |= (((v >> m) & 1) & 1) << (bitstream)->cnt_, ((v >> m) & 1) & 1)) == (-1)) {
   return (-1);
  }
  v <<= 1;
 }
...
int jpc_bitstream_fillbuf(jpc_bitstream_t *bitstream)
{
 ...
 ((void) sizeof ((bitstream->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if (bitstream->openmode_ & 0x01) ; else __assert_fail ("bitstream->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 247, __extension__ __PRETTY_FUNCTION__); }));
 ((void) sizeof ((bitstream->cnt_ <= 0) ? 1 : 0), __extension__ ({ if (bitstream->cnt_ <= 0) ; else __assert_fail ("bitstream->cnt_ <= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 248, __extension__ __PRETTY_FUNCTION__); }));
 ...
 if ((c = ((!(((bitstream)->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? ((((bitstream)->stream_)->rwlimit_ >= 0 && ((bitstream)->stream_)->rwcnt_ >= ((bitstream)->stream_)->rwlimit_) ? ((bitstream)->stream_->flags_ |= 0x0004, (-1)) : ((--((bitstream)->stream_)->cnt_ < 0) ? jas_stream_fillbuf((bitstream)->stream_, 1) : (++((bitstream)->stream_)->rwcnt_, (int)(*((bitstream)->stream_)->ptr_++)))) : (-1))) == (-1)) {
...
# 278 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c"
int jpc_bitstream_needalign(jpc_bitstream_t *bitstream)
{
 if (bitstream->openmode_ & 0x01) {
  ...
  ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 300, __extension__ __PRETTY_FUNCTION__); }));
  return -1;
 }
 return 0;
}
...
# 324 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c"
  return 0;
 } else {
...
int jpc_bitstream_outalign(jpc_bitstream_t *bitstream, int filldata)
{
 ...
 ((void) sizeof ((bitstream->openmode_ & 0x02) ? 1 : 0), __extension__ ({ if (bitstream->openmode_ & 0x02) ; else __assert_fail ("bitstream->openmode_ & JPC_BITSTREAM_WRITE", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 401, __extension__ __PRETTY_FUNCTION__); }));





 ((void) sizeof ((!(filldata & (~0x3f))) ? 1 : 0), __extension__ ({ if (!(filldata & (~0x3f))) ; else __assert_fail ("!(filldata & (~0x3f))", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 407, __extension__ __PRETTY_FUNCTION__); }));
 ...
 if (bitstream->cnt_ < 8) {
  ((void) sizeof ((bitstream->cnt_ >= 0 && bitstream->cnt_ < 8) ? 1 : 0), __extension__ ({ if (bitstream->cnt_ >= 0 && bitstream->cnt_ < 8) ; else __assert_fail ("bitstream->cnt_ >= 0 && bitstream->cnt_ < 8", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 433, __extension__ __PRETTY_FUNCTION__); }));
  ((void) sizeof (((bitstream->buf_ & 0xff) != 0xff) ? 1 : 0), __extension__ ({ if ((bitstream->buf_ & 0xff) != 0xff) ; else __assert_fail ("(bitstream->buf_ & 0xff) != 0xff", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.c", 434, __extension__ __PRETTY_FUNCTION__); }));


  if (((!((bitstream->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((bitstream->stream_)->rwlimit_ >= 0 && (bitstream->stream_)->rwcnt_ >= (bitstream->stream_)->rwlimit_) ? (bitstream->stream_->flags_ |= 0x0004, (-1)) : (((bitstream->stream_)->bufmode_ |= 0x0020, --(bitstream->stream_)->cnt_ < 0) ? jas_stream_flushbuf((bitstream->stream_), (unsigned char)(bitstream->buf_ & 0xff)) : (++(bitstream->stream_)->rwcnt_, (int)(*(bitstream->stream_)->ptr_++ = (bitstream->buf_ & 0xff))))) : (-1)) == (-1)) {
   return -1;
  }
  bitstream->cnt_ = 8;
  bitstream->buf_ = (bitstream->buf_ << 8) & 0xffff;
