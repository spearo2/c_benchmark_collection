# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
# 66 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 67 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
# 68 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
# 70 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_cod.h" 1
# 90 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_cod.h"
typedef struct {
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c" 2
...
static int_fast32_t pgx_getword(jas_stream_t *in, _Bool bigendian, int prec);
static int pgx_getsgnd(jas_stream_t *in, _Bool *sgnd);
static int pgx_getbyteorder(jas_stream_t *in, _Bool *bigendian);
static int pgx_getc(jas_stream_t *in);
static int pgx_getuint32(jas_stream_t *in, uint_fast32_t *val);
static jas_seqent_t pgx_wordtoint(uint_fast32_t word, int prec, _Bool sgnd);
...
int pgx_validate(jas_stream_t *in)
{
 ...
 ((void) sizeof ((16 >= 2) ? 1 : 0), __extension__ ({ if (16 >= 2) ; else __assert_fail ("JAS_STREAM_MAXPUTBACK >= PGX_MAGICLEN", "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c", 232, __extension__ __PRETTY_FUNCTION__); }));
...
static int pgx_gethdr(jas_stream_t *in, pgx_hdr_t *hdr)
{
 ...
 if ((c = pgx_getc(in)) == (-1) || !((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISspace)) {
  goto error;
 }
...
static int pgx_getbyteorder(jas_stream_t *in, _Bool *bigendian)
{
 ...
 while ((c = pgx_getc(in)) != (-1) && !((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISspace)) {
  ;
 }
 if (c == (-1)) {
  goto error;
...
# 465 "/doner/jasper/jasper-7692d6d/src/libjasper/pgx/pgx_dec.c"
 if (c == '+' || c == '-') {
  *sgnd = (c == '-');
  while ((c = pgx_getc(in)) != (-1) && !((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _ISspace)) {
   ;
...
static jas_seqent_t pgx_wordtoint(uint_fast32_t v, int prec, _Bool sgnd)
{
 jas_seqent_t ret;
 v &= (1 << prec) - 1;
