# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.h"
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_bs.h" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c" 2
...
jpc_tagtree_t *jpc_tagtree_create(int numleafsh, int numleafsv)
{
 ...
 ((void) sizeof ((numleafsh > 0 && numleafsv > 0) ? 1 : 0), __extension__ ({ if (numleafsh > 0 && numleafsv > 0) ; else __assert_fail ("numleafsh > 0 && numleafsv > 0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 109, __extension__ __PRETTY_FUNCTION__); }));
...
void jpc_tagtree_copy(jpc_tagtree_t *dsttree, jpc_tagtree_t *srctree)
{
 ...
 ((void) sizeof ((srctree->numleafsh_ == dsttree->numleafsh_ && srctree->numleafsv_ == dsttree->numleafsv_) ? 1 : 0), __extension__ ({ if (srctree->numleafsh_ == dsttree->numleafsh_ && srctree->numleafsv_ == dsttree->numleafsv_) ; else __assert_fail ("srctree->numleafsh_ == dsttree->numleafsh_ && srctree->numleafsv_ == dsttree->numleafsv_", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 207, __extension__ __PRETTY_FUNCTION__); }));
  ...
  int value)
{
 ...
 ((void) sizeof ((value >= 0) ? 1 : 0), __extension__ ({ if (value >= 0) ; else __assert_fail ("value >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 250, __extension__ __PRETTY_FUNCTION__); }));
  ...
  int threshold, jpc_bitstream_t *out)
{
 ...
 ((void) sizeof ((leaf) ? 1 : 0), __extension__ ({ if (leaf) ; else __assert_fail ("leaf", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 279, __extension__ __PRETTY_FUNCTION__); }));
 ((void) sizeof ((threshold >= 0) ? 1 : 0), __extension__ ({ if (threshold >= 0) ; else __assert_fail ("threshold >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 280, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (;;) {
  ...
  while (low < threshold) {
   if (low >= node->value_) {
    if (!node->known_) {
     if ((((void) sizeof (((out)->openmode_ & 0x02) ? 1 : 0), __extension__ ({ if ((out)->openmode_ & 0x02) ; else __assert_fail ("(out)->openmode_ & JPC_BITSTREAM_WRITE", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 303, __extension__ __PRETTY_FUNCTION__); })), (--(out)->cnt_ < 0) ? ((out)->buf_ = ((out)->buf_ << 8) & 0xffff, (out)->cnt_ = ((out)->buf_ == 0xff00) ? 6 : 7, (out)->buf_ |= ((1) & 1) << (out)->cnt_, (((!(((out)->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? ((((out)->stream_)->rwlimit_ >= 0 && ((out)->stream_)->rwcnt_ >= ((out)->stream_)->rwlimit_) ? ((out)->stream_->flags_ |= 0x0004, (-1)) : ((((out)->stream_)->bufmode_ |= 0x0020, --((out)->stream_)->cnt_ < 0) ? jas_stream_flushbuf(((out)->stream_), (unsigned char)((out)->buf_ >> 8)) : (++((out)->stream_)->rwcnt_, (int)(*((out)->stream_)->ptr_++ = ((out)->buf_ >> 8))))) : (-1)) == (-1)) ? ((-1)) : ((1) & 1)) : ((out)->buf_ |= ((1) & 1) << (out)->cnt_, (1) & 1)) == (-1)) {
      return -1;
     }
     node->known_ = 1;
    }
   ...
   if ((((void) sizeof (((out)->openmode_ & 0x02) ? 1 : 0), __extension__ ({ if ((out)->openmode_ & 0x02) ; else __assert_fail ("(out)->openmode_ & JPC_BITSTREAM_WRITE", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 310, __extension__ __PRETTY_FUNCTION__); })), (--(out)->cnt_ < 0) ? ((out)->buf_ = ((out)->buf_ << 8) & 0xffff, (out)->cnt_ = ((out)->buf_ == 0xff00) ? 6 : 7, (out)->buf_ |= ((0) & 1) << (out)->cnt_, (((!(((out)->stream_)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? ((((out)->stream_)->rwlimit_ >= 0 && ((out)->stream_)->rwcnt_ >= ((out)->stream_)->rwlimit_) ? ((out)->stream_->flags_ |= 0x0004, (-1)) : ((((out)->stream_)->bufmode_ |= 0x0020, --((out)->stream_)->cnt_ < 0) ? jas_stream_flushbuf(((out)->stream_), (unsigned char)((out)->buf_ >> 8)) : (++((out)->stream_)->rwcnt_, (int)(*((out)->stream_)->ptr_++ = ((out)->buf_ >> 8))))) : (-1)) == (-1)) ? ((-1)) : ((0) & 1)) : ((out)->buf_ |= ((0) & 1) << (out)->cnt_, (0) & 1)) == (-1)) {
    return -1;
   }
   ++low;
  }
  ...
  int threshold, jpc_bitstream_t *in)
{
 ...
 ((void) sizeof ((threshold >= 0) ? 1 : 0), __extension__ ({ if (threshold >= 0) ; else __assert_fail ("threshold >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 340, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (;;) {
  ...
  while (low < threshold && low < node->value_) {
   if ((ret = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_tagtree.c", 358, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))) < 0) {
    return -1;
   }
   if (ret) {
    node->value_ = low;
