# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
# 84 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_cod.h" 1
# 117 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_cod.h"
typedef struct {
...
# 86 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.h" 1
# 65 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.h"
typedef struct {
 int numcmpts;
 int cmpts[4];
} pnm_enc_t;
# 87 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c" 2
...
int pnm_encode(jas_image_t *image, jas_stream_t *out, const char *optstr)
{
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("pnm_encode(%p, %p, \"%s\")\n", image, out, optstr ? optstr : "")) : 0);
...
# 190 "/doner/jasper/jasper-7692d6d/src/libjasper/pnm/pnm_enc.c"
 for (cmptno = 0; cmptno < enc->numcmpts; ++cmptno) {
  if (((image)->cmpts_[enc->cmpts[cmptno]]->width_) != width ||
    ...
    ((image)->cmpts_[enc->cmpts[cmptno]]->prec_) != prec ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->sgnd_) != sgnd ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->hstep_) != ((image)->cmpts_[0]->hstep_) ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->vstep_) != ((image)->cmpts_[0]->vstep_) ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->tlx_) != ((image)->cmpts_[0]->tlx_) ||
    ((image)->cmpts_[enc->cmpts[cmptno]]->tly_) != ((image)->cmpts_[0]->tly_)) {
 ...
 if (enc->numcmpts == 1) {
  hdr.magic = encopts.bin ? 0x5035 : 0x5032;
 } else if (enc->numcmpts == 3) {
  hdr.magic = encopts.bin ? 0x5036 : 0x5033;
 } else {
  return -1;
 }
 hdr.width = width;
...
static int pnm_putsint(jas_stream_t *out, int wordsize, int_fast32_t *val)
{
 ...
 tmpval = (*val < 0) ?
   ((~(((uint_fast32_t) (-(*val))) + 1)) & (((wordsize) < 32) ? ((1UL << (wordsize)) - 1) : 0xffffffffUL)) :
   ((uint_fast32_t) ((*val)));
...
static int pnm_putuint(jas_stream_t *out, int wordsize, uint_fast32_t *val)
{
 ...
 n = (wordsize + 7) / 8;
 tmpval = (*val);
 tmpval &= (((8 * n) < 32) ? ((1UL << (8 * n)) - 1) : 0xffffffffUL);
 tmpval = tmpval << (8 * (4 - n));
 while (--n >= 0) {
  c = (tmpval >> 24) & 0xff;
...
static int pnm_putuint16(jas_stream_t *out, uint_fast16_t val)
{
 if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((unsigned char)(val >> 8))) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((unsigned char)(val >> 8)))))) : (-1)) == (-1) ||
   ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((unsigned char)(val & 0xff))) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((unsigned char)(val & 0xff)))))) : (-1)) == (-1)) {
  return -1;
 }
 return 0;
}
