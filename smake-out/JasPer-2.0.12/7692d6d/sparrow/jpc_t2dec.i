# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c"
...
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 86 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
void jpc_seglist_insert(jpc_dec_seglist_t *list, jpc_dec_seg_t *ins,
  jpc_dec_seg_t *node);
# 87 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 90 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
int JPC_ISTERMINATED(int passno, int firstpassno, int numpasses, int termall,
  int lazy);
# 91 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
# 92 "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c" 2
...
static int jpc_getcommacode(jpc_bitstream_t *in)
{
 ...
 n = 0;
 for (;;) {
  if ((v = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 114, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))) < 0) {
   return -1;
  }
  if (((in)->flags_ & 0x02)) {
   return -1;
...
static int jpc_getnumnewpasses(jpc_bitstream_t *in)
{
 ...
 if ((n = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 133, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))) > 0) {
  if ((n = (((void) sizeof (((in)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((in)->openmode_ & 0x01) ; else __assert_fail ("(in)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 134, __extension__ __PRETTY_FUNCTION__); })), (--(in)->cnt_ >= 0) ? ((int)(((in)->buf_ >> (in)->cnt_) & 1)) : jpc_bitstream_fillbuf(in))) > 0) {
  ...
  int prcno, int lyrno)
{
 ...
 if (cp->csty & 0x02) {
  if (jpc_dec_lookahead(in) == 0xff91) {
...
hdroffstart = (((const jas_stream_t *)(pkthdrstream))->rwcnt_);

 if (!(inb = jpc_bitstream_sopen(pkthdrstream, "r"))) {
  return -1;
 }

 if ((present = (((void) sizeof (((inb)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((inb)->openmode_ & 0x01) ; else __assert_fail ("(inb)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 227, __extension__ __PRETTY_FUNCTION__); })), (--(inb)->cnt_ >= 0) ? ((int)(((inb)->buf_ >> (inb)->cnt_) & 1)) : jpc_bitstream_fillbuf(inb))) < 0) {
  return 1;
 }
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("\n", present)) : 0);
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("present=%d ", present)) : 0);
  ...
  for (bandno = 0, band = rlvl->bands; bandno < rlvl->numbands;
   ...
   for (cblkno = 0, cblk = prc->cblks; cblkno < prc->numcblks;
    ...
    if (!cblk->numpasses) {
     ...
     if ((included = (((void) sizeof (((inb)->openmode_ & 0x01) ? 1 : 0), __extension__ ({ if ((inb)->openmode_ & 0x01) ; else __assert_fail ("(inb)->openmode_ & JPC_BITSTREAM_READ", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 258, __extension__ __PRETTY_FUNCTION__); })), (--(inb)->cnt_ >= 0) ? ((int)(((inb)->buf_ >> (inb)->cnt_) & 1)) : jpc_bitstream_fillbuf(inb))) < 0) {
      return -1;
     }
    }
    ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("\n")) : 0);
    ...
    if (numnewpasses > 0) {
     ...
     cblk->numlenbits += m;
     ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("increment=%d ", m)) : 0);
     while (numnewpasses > 0) {
      passno = cblk->firstpassno + cblk->numpasses + mycounter;

      maxpasses = JPC_SEGPASSCNT(passno, cblk->firstpassno, 10000, (ccp->cblkctx & 0x01) != 0, (ccp->cblkctx & 0x04) != 0);
      if (!discard && !seg) {
       ...
       seg->passno = passno;
       seg->type = JPC_SEGTYPE(seg->passno, cblk->firstpassno, (ccp->cblkctx & 0x01) != 0);
       seg->maxpasses = maxpasses;
      }
      n = (((numnewpasses) < (maxpasses)) ? (numnewpasses) : (maxpasses));
      mycounter += n;
      numnewpasses -= n;
      if ((len = jpc_bitstream_getbits(inb, cblk->numlenbits + jpc_floorlog2(n))) < 0) {
       return -1;
      }
      ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("len=%d ", len)) : 0);
      if (!discard) {
       seg->lyrno = lyrno;
       seg->numpasses += n;
       seg->cnt = len;
 ...
 hdroffend = (((const jas_stream_t *)(pkthdrstream))->rwcnt_);
 ...
 if (cp->csty & 0x04) {
  if (jpc_dec_lookahead(pkthdrstream) == 0xff92) {
 ...
 if (!discard) {
  ...
  if (jas_stream_gobble(in, bodylen) != ((int) (bodylen))) {
   return -1;
  }
 }
 return 0;
...
int jpc_dec_decodepkts(jpc_dec_t *dec, jas_stream_t *pkthdrstream, jas_stream_t *in)
{
 ...
 pi = tile->pi;
 for (;;) {
  if (!tile->pkthdrstream || (((tile->pkthdrstream)->cnt_ <= 0) ? jas_stream_fillbuf(tile->pkthdrstream, 0) : ((int)(*(tile->pkthdrstream)->ptr_))) == (-1)) {
  ...
  if (jas_getdbglevel() >= 1) {
   jas_eprintf("packet offset=%08ld prg=%d cmptno=%02d "
     ...
     (((const jas_stream_t *)(in))->rwcnt_), (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 451, __extension__ __PRETTY_FUNCTION__); })), (pi)->pchg->prgord), (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 451, __extension__ __PRETTY_FUNCTION__); })), (pi)->compno),
     (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 452, __extension__ __PRETTY_FUNCTION__); })), (pi)->rlvlno), (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 452, __extension__ __PRETTY_FUNCTION__); })), (pi)->prcno), (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 452, __extension__ __PRETTY_FUNCTION__); })), (pi)->lyrno));
  }
  if (jpc_dec_decodepkt(dec, pkthdrstream, in, (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 454, __extension__ __PRETTY_FUNCTION__); })), (pi)->compno),
    (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 455, __extension__ __PRETTY_FUNCTION__); })), (pi)->rlvlno), (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 455, __extension__ __PRETTY_FUNCTION__); })), (pi)->prcno), (((void) sizeof ((pi->valid) ? 1 : 0), __extension__ ({ if (pi->valid) ; else __assert_fail ("pi->valid", "/doner/jasper/jasper-7692d6d/src/libjasper/jpc/jpc_t2dec.c", 455, __extension__ __PRETTY_FUNCTION__); })), (pi)->lyrno))) {
   return -1;
  }
  ++dec->numpkts;
 }
...
long jpc_dec_lookahead(jas_stream_t *in)
{
 ...
 if (jas_stream_ungetc(in, x & 0xff) == (-1) ||
   jas_stream_ungetc(in, x >> 8) == (-1)) {
  return -1;
 }
 if (x >= 0xff80 && x <= 0xffff) {
  return x;
 }
 return 0;
}
