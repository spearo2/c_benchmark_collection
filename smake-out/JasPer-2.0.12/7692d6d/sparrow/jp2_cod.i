# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
# 81 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c" 2
...
jp2_box_t *jp2_box_get(jas_stream_t *in)
{
 ...
 if (box->len == 1) {
  ...
  box->len = extlen;
  box->datalen = extlen - ((1) ? 16 : 8);
 } else {
  box->datalen = box->len - ((0) ? 16 : 8);
 }
...
void jp2_box_dump(jp2_box_t *box, FILE *out)
{
 jp2_boxinfo_t *boxinfo;
 boxinfo = jp2_boxinfolookup(box->type);
 ((void) sizeof ((boxinfo) ? 1 : 0), __extension__ ({ if (boxinfo) ; else __assert_fail ("boxinfo", "/doner/jasper/jasper-7692d6d/src/libjasper/jp2/jp2_cod.c", 331, __extension__ __PRETTY_FUNCTION__); }));

 fprintf(out, "JP2 box: ");
 fprintf(out, "type=%c%s%c (0x%08""l" "x""); length=%""l" "u""\n", '"',
...
int jp2_box_put(jp2_box_t *box, jas_stream_t *out)
{
 ...
 if (dataflag) {
  ...
  box->len = jas_stream_tell(tmpstream) + ((0) ? 16 : 8);
  jas_stream_rewind(tmpstream);
 }
 ...
 if (dataflag) {
  if (jas_stream_copy(out, tmpstream, box->len - ((0) ? 16 : 8))) {
   goto error;
  }
  jas_stream_close(tmpstream);
 }
