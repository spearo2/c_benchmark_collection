# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
...
# 80 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
...
# 82 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.h" 1
# 65 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.h"
typedef struct {
 int numcmpts;
 int cmpts[4];
} ras_enc_t;
# 83 "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c" 2
...
int ras_encode(jas_image_t *image, jas_stream_t *out, const char *optstr)
{
 ...
 ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("ras_encode(%p, %p, \"%s\"\n", image, out, optstr ? optstr : "")) : 0);
 ...
 hdr.magic = 0x59a66a95;
 hdr.width = width;
 hdr.height = height;
 hdr.depth = (enc->numcmpts == 3) ? 24 : depth;

 rowsize = ((((&hdr)->width * (&hdr)->depth + 15) / 16) * 2);
...
static int ras_putdatastd(jas_stream_t *out, ras_hdr_t *hdr, jas_image_t *image, int numcmpts, int *cmpts)
{
 ...
 ((void) sizeof ((numcmpts <= 3) ? 1 : 0), __extension__ ({ if (numcmpts <= 3) ; else __assert_fail ("numcmpts <= 3", "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c", 233, __extension__ __PRETTY_FUNCTION__); }));
 ...
 for (i = 0; i < numcmpts; ++i) {
  if (!(data[i] = jas_matrix_create(((image)->bry_ - (image)->tly_),
 ...
 for (y = 0; y < hdr->height; y++) {
  for (i = 0; i < numcmpts; ++i) {
   if (jas_image_readcmpt(image, cmpts[i], 0, y,
     ((image)->brx_ - (image)->tlx_), 1, data[i])) {
    goto error;
   }
  }
  z = 0;
  ...
  for (x = 0; x < hdr->width; x++) {
   ...
   if (((hdr)->depth == 24 || (hdr)->depth == 32)) {
    v = ((((((data[0])->numrows_ == 1) ? ((data[0])->rows_[0][x]) : ((data[0])->rows_[x][0])))) & 0xff) |
      (((((((data[1])->numrows_ == 1) ? ((data[1])->rows_[0][x]) : ((data[1])->rows_[x][0])))) & 0xff) << 8) |
      (((((((data[2])->numrows_ == 1) ? ((data[2])->rows_[0][x]) : ((data[2])->rows_[x][0])))) & 0xff) << 16);
   } else {
    v = ((((data[0])->numrows_ == 1) ? ((data[0])->rows_[0][x]) : ((data[0])->rows_[x][0])));
   }
   z |= v & (((hdr->depth) == 32) ? 0xffffffffUL : ((1UL << (hdr->depth)) - 1));
   nz += hdr->depth;
   while (nz >= 8) {
    c = (z >> (nz - 8)) & 0xff;
    ...
    nz -= 8;
    z &= (((nz) == 32) ? 0xffffffffUL : ((1UL << (nz)) - 1));
   }
  }
  if (nz > 0) {
   c = (z >> (8 - nz)) & (((nz) == 32) ? 0xffffffffUL : ((1UL << (nz)) - 1));
   if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(c)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (c))))) : (-1)) == (-1)) {
    goto error;
   }
  }
...
static int ras_puthdr(jas_stream_t *out, ras_hdr_t *hdr)
{
 if (ras_putint(out, 0x59a66a95) || ras_putint(out, hdr->width) ||
...
static int ras_putint(jas_stream_t *out, int_fast32_t val)
{
 ...
 ((void) sizeof ((val >= 0) ? 1 : 0), __extension__ ({ if (val >= 0) ; else __assert_fail ("val >= 0", "/doner/jasper/jasper-7692d6d/src/libjasper/ras/ras_enc.c", 327, __extension__ __PRETTY_FUNCTION__); }));
 x = val;
 for (i = 0; i < 4; i++) {
  c = (x >> (8 * (3 - i))) & 0xff;
  if (((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(c)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (c))))) : (-1)) == (-1)) {
