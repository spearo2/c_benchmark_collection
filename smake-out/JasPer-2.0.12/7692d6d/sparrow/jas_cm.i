# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
# 68 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c"
...
# 69 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 70 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 68 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_icc.h"
...
# 69 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_icc.h" 2
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_init.h" 1
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/include/jasper/jas_init.h"
              int jas_init(void);

              void jas_cleanup(void);
# 75 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 77 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 78 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 79 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c" 2
...
# 132 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c"
...
static jas_cmprof_t *jas_cmprof_createsycc()
{
 ...
 if (!(prof = jas_cmprof_createfromclrspc((((4) << 8) | (1)))))
  goto error;
 prof->clrspc = (((5) << 8) | (1));
 ((void) sizeof ((prof->numchans == 3 && prof->numrefchans == 3) ? 1 : 0), __extension__ ({ if (prof->numchans == 3 && prof->numrefchans == 3) ; else __assert_fail ("prof->numchans == 3 && prof->numrefchans == 3", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 188, __extension__ __PRETTY_FUNCTION__); }));
 ((void) sizeof ((prof->refclrspc == (((1) << 8) | (1))) ? 1 : 0), __extension__ ({ if (prof->refclrspc == (((1) << 8) | (1))) ; else __assert_fail ("prof->refclrspc == JAS_CLRSPC_CIEXYZ", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 189, __extension__ __PRETTY_FUNCTION__); }));
...
# 296 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c"
 return prof;
  ...
  jas_cmprof_t *prfprof, int op, int intent, int optimize)
{
 ...
 case 1:
  ...
  break;
 case 2:
  ((void) sizeof ((prfprof) ? 1 : 0), __extension__ ({ if (prfprof) ; else __assert_fail ("prfprof", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 416, __extension__ __PRETTY_FUNCTION__); }));
  inpxformseq = (((inprof)->pxformseqs[(intent)]) ? ((inprof)->pxformseqs[(intent)]) : ((inprof)->pxformseqs[(0)]));
...
int jas_cmxform_apply(jas_cmxform_t *xform, jas_cmpixmap_t *in, jas_cmpixmap_t *out)
{
 ...
 ((void) sizeof ((bufmax > 0) ? 1 : 0), __extension__ ({ if (bufmax > 0) ; else __assert_fail ("bufmax > 0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 524, __extension__ __PRETTY_FUNCTION__); }));
...
static int jas_cmpxformseq_delete(jas_cmpxformseq_t *pxformseq, int i)
{
 ((void) sizeof ((i >= 0 && i < pxformseq->numpxforms) ? 1 : 0), __extension__ ({ if (i >= 0 && i < pxformseq->numpxforms) ; else __assert_fail ("i >= 0 && i < pxformseq->numpxforms", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 638, __extension__ __PRETTY_FUNCTION__); }));
  ...
  int i, jas_cmpxform_t *pxform)
{
 ...
 ((void) sizeof ((i >= 0 && i <= pxformseq->numpxforms) ? 1 : 0), __extension__ ({ if (i >= 0 && i <= pxformseq->numpxforms) ; else __assert_fail ("i >= 0 && i <= pxformseq->numpxforms", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 665, __extension__ __PRETTY_FUNCTION__); }));
 if (pxformseq->numpxforms >= pxformseq->maxpxforms) {
  if (jas_cmpxformseq_resize(pxformseq, pxformseq->numpxforms +
    16))
   goto error;
 }
 ((void) sizeof ((pxformseq->numpxforms < pxformseq->maxpxforms) ? 1 : 0), __extension__ ({ if (pxformseq->numpxforms < pxformseq->maxpxforms) ; else __assert_fail ("pxformseq->numpxforms < pxformseq->maxpxforms", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 671, __extension__ __PRETTY_FUNCTION__); }));
...
{
 jas_cmpxform_t **p;
 ((void) sizeof ((n >= pxformseq->numpxforms) ? 1 : 0), __extension__ ({ if (n >= pxformseq->numpxforms) ; else __assert_fail ("n >= pxformseq->numpxforms", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 713, __extension__ __PRETTY_FUNCTION__); }));
...
((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 853, __extension__ __PRETTY_FUNCTION__); }));
   while (--cnt >= 0) {
    a0 = *src++;
    src++;
    src++;
  ...
  jas_cmshapmatlut_t *lut, int n)
{
 ...
 jas_cmreal_t sx;
 jas_cmreal_t sy;
 ((void) sizeof ((n >= 2) ? 1 : 0), __extension__ ({ if (n >= 2) ; else __assert_fail ("n >= 2", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 951, __extension__ __PRETTY_FUNCTION__); }));
 if (invlut->data) {
 ...
 for (i = 1; i < lut->size; ++i) {
  if (lut->data[i - 1] > lut->data[i]) {
   ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c", 959, __extension__ __PRETTY_FUNCTION__); }));
   return -1;
  }
 }
...
static int jas_cmshapmat_invmat(jas_cmreal_t out[3][4], jas_cmreal_t in[3][4])
{
 ...
 out[1][3] = -in[1][3];
 out[2][3] = -in[2][3];
# 1043 "/doner/jasper/jasper-7692d6d/src/libjasper/base/jas_cm.c"
 return 0;
}
