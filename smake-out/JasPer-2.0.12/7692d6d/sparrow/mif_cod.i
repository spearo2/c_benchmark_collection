# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
# 66 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 67 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
# 69 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
# 70 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
# 71 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
# 72 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
# 73 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
# 74 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2

# 1 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.h" 1
# 87 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.h"
typedef struct {
...
# 76 "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c" 2
...
int mif_validate(jas_stream_t *in)
{
 ...
 ((void) sizeof ((16 >= 4) ? 1 : 0), __extension__ ({ if (16 >= 4) ; else __assert_fail ("JAS_STREAM_MAXPUTBACK >= MIF_MAGICLEN", "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c", 378, __extension__ __PRETTY_FUNCTION__); }));
...
static int mif_hdr_growcmpts(mif_hdr_t *hdr, int maxcmpts)
{
 int cmptno;
 mif_cmpt_t **newcmpts;
 ((void) sizeof ((maxcmpts >= hdr->numcmpts) ? 1 : 0), __extension__ ({ if (maxcmpts >= hdr->numcmpts) ; else __assert_fail ("maxcmpts >= hdr->numcmpts", "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c", 449, __extension__ __PRETTY_FUNCTION__); }));
...
static int mif_hdr_put(mif_hdr_t *hdr, jas_stream_t *out)
{
 ...
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((0x4d49460a >> 24) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((0x4d49460a >> 24) & 0xff))))) : (-1));
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((0x4d49460a >> 16) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((0x4d49460a >> 16) & 0xff))))) : (-1));
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((0x4d49460a >> 8) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((0x4d49460a >> 8) & 0xff))))) : (-1));
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, (-1)) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(0x4d49460a & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (0x4d49460a & 0xff))))) : (-1));
...
static int mif_hdr_addcmpt(mif_hdr_t *hdr, int cmptno, mif_cmpt_t *cmpt)
{
 ((void) sizeof ((cmptno >= hdr->numcmpts) ? 1 : 0), __extension__ ({ if (cmptno >= hdr->numcmpts) ; else __assert_fail ("cmptno >= hdr->numcmpts", "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c", 668, __extension__ __PRETTY_FUNCTION__); }));
...
static char *mif_getline(jas_stream_t *stream, char *buf, int bufsize)
{
 int c;
 char *bufptr;
 ((void) sizeof ((bufsize > 0) ? 1 : 0), __extension__ ({ if (bufsize > 0) ; else __assert_fail ("bufsize > 0", "/doner/jasper/jasper-7692d6d/src/libjasper/mif/mif_cod.c", 709, __extension__ __PRETTY_FUNCTION__); }));

 bufptr = buf;
 while (bufsize > 1) {
  if ((c = mif_getc(stream)) == (-1)) {
   break;
  }
  *bufptr++ = c;
  --bufsize;
...
static int mif_getc(jas_stream_t *in)
{
 ...
 do {
  switch (c = ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, (-1)) : ((--(in)->cnt_ < 0) ? jas_stream_fillbuf(in, 1) : (++(in)->rwcnt_, (int)(*(in)->ptr_++)))) : (-1))) {
  case (-1):
   done = 1;
   break;
  case '#':
  ...
  case '\\':
   if ((((in)->cnt_ <= 0) ? jas_stream_fillbuf(in, 0) : ((int)(*(in)->ptr_))) == '\n') {
    ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, (-1)) : ((--(in)->cnt_ < 0) ? jas_stream_fillbuf(in, 1) : (++(in)->rwcnt_, (int)(*(in)->ptr_++)))) : (-1));
   }
   break;
  default:
   done = 1;
