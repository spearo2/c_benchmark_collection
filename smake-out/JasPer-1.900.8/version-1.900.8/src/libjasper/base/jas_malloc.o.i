# 1 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c"
# 74 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c"
...
# 75 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 76 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 77 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdbool.h" 1 3 4
# 78 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 79 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 82 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 84 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 85 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
...
# 86 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c" 2
# 101 "/doner/jasper/jasper-version-1.900.8/src/libjasper/base/jas_malloc.c"
void *jas_malloc(size_t size)
{
 void *result;
 ((jas_getdbglevel() >= (101)) ? (jas_eprintf ("jas_malloc called with %zu\n", size)) : 0);
 result = malloc(size);
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jas_malloc(%zu) -> %p\n", size, result)) : 0);
 return result;
}
...
{
 void *result;
 ((jas_getdbglevel() >= (101)) ? (jas_eprintf ("jas_realloc called with %x,%zu\n", ptr, size)) : 0);
 result = realloc(ptr, size);
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jas_realloc(%p, %zu) -> %p\n", ptr, size, result)) : 0);
 return result;
}

void jas_free(void *ptr)
{
 ((jas_getdbglevel() >= (100)) ? (jas_eprintf ("jas_free(%p)\n", ptr)) : 0);
 free(ptr);
}
