# 1 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
# 33 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
...
# 34 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 2
...
# 35 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 2
...
# 36 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 2
...
# 38 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 2
...
# 47 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
((void *)0)

# 48 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
};
...
usage(void)
{
 ...
 for (i = 0; usageMsg[i]; i++)
  fprintf(
# 55 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
         stderr
# 55 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
               , "%s\n", usageMsg[i]);
 exit(-1);
}
...
GetField(TIFF *tiff, const char *tagname)
{
    ...
    if (!fip) {
        fprintf( 
# 70 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                stderr
# 70 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                      , "Field name \"%s\" is not recognised.\n", tagname );
        return (TIFFField *)
# 71 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                           ((void *)0)
# 71 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                               ;
    }
...
main(int argc, char* argv[])
{
    ...
    if (tiff == 
# 87 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
               ((void *)0)
# 87 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                   )
        return 2;
 ...
 if (strcmp(argv[arg_index],"-d") == 0 && arg_index < argc-2) {
     ...
     if( TIFFSetDirectory(tiff, atoi(argv[arg_index]) ) != 1 )
            {
               fprintf( 
# 95 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                       stderr
# 95 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
 ...
 if (strcmp(argv[arg_index],"-sd") == 0 && arg_index < argc-2) {
     ...
     if( TIFFSetSubDirectory(tiff, atoi(argv[arg_index]) ) != 1 )
            {
               fprintf( 
# 104 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                       stderr
# 104 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
    ...
    if (strcmp(argv[arg_index],"-u") == 0 && arg_index < argc-2) {
            ...
            {
                    fprintf(
# 121 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                           stderr
# 121 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                                 , "Failed to unset %s\n", TIFFFieldName(fip));
            }
            arg_index++;
            ...
            if (TIFFFieldDataType(fip) == TIFF_ASCII) {
                if (TIFFSetField(tiff, TIFFFieldTag(fip), argv[arg_index]) != 1)
                    fprintf( 
# 138 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                            stderr
# 138 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                                  , "Failed to set %s=%s\n",
         ...
         || TIFFFieldWriteCount(fip) == -1) {
                ...
                if (argc - arg_index < wc) {
                    fprintf( 
# 151 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                            stderr
# 151 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                                  ,
    ...
    default:
                        ...
                        if (!array) {
                                fprintf(
# 199 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                                       stderr
# 199 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                                             , "No space for %s tag\n",
                                        tagname);
                                return 4;
                        }
     ...
     ret = TIFFSetField(tiff, TIFFFieldTag(fip),
      ((uint16 *)array)[0], ((uint16 *)array)[1]);
                ...
                if (ret != 1)
                    fprintf(
# 295 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                           stderr
# 295 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                                 , "Failed to set %s\n", TIFFFieldName(fip));
                arg_index += wc;
            }
            ...
            if (TIFFFieldDataType(fip) != TIFF_ASCII) {
                fprintf( 
# 311 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                        stderr
# 311 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                              ,
            ...
            if(fp == 
# 319 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                    ((void *)0)
# 319 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
                        ) {
            ...
            if(TIFFSetField( tiff, TIFFFieldTag(fip), text ) != 1) {
                fprintf(
# 331 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                       stderr
# 331 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
            ...
            fprintf(
# 338 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c" 3 4
                   stderr
# 338 "/doner/libtiff/libtiff-f3069a5/tools/tiffset.c"
