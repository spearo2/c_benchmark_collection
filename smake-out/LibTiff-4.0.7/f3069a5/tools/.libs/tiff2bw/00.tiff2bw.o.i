# 1 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
# 27 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
# 30 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
# 31 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
# 32 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
# 33 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
# 36 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
# 43 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 2
...
main(int argc, char* argv[])
{
 ...
 if (in == 
# 160 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
          ((void *)0)
# 160 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
              )
  return (-1);
 photometric = 0;
 ...
 if (photometric != 2 && photometric != 3 ) {
  fprintf(
# 165 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
         stderr
# 165 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
               ,
 ...
 if (samplesperpixel != 1 && samplesperpixel != 3) {
  fprintf(
# 172 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
         stderr
# 172 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
 ...
 if( photometric == 2 && samplesperpixel != 3) {
  fprintf(
# 177 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
         stderr
# 177 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
 ...
 if (bitspersample != 8) {
  fprintf(
# 183 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
         stderr
# 183 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
               ,
 ...
 if (out == 
# 192 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
           ((void *)0)
# 192 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
               )
  return (-1);
...
processCompressOptions(char* opt)
{
 if ((strcmp((opt),("none")) == 0))
  ...
  char* cp = strchr(opt, ':');
                ...
                {
                    if (
# 293 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
                       ((*__ctype_b_loc ())[(int) ((
# 293 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
                       (int)cp[1]
# 293 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
...
# 326 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
static void
...
# 455 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
((void *)0)

# 456 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
};
...
{
 char buf[
# 461 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
         8192
# 461 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
               ];
 int i;

 setbuf(
# 464 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
       stderr
# 464 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
             , buf);
        fprintf(
# 465 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
               stderr
# 465 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 466 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
                        ((void *)0)
# 466 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
                            ; i++)
  fprintf(
# 467 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c" 3 4
         stderr
# 467 "/doner/libtiff/libtiff-f3069a5/tools/tiff2bw.c"
               , "%s\n", stuff[i]);
 exit(-1);
}
