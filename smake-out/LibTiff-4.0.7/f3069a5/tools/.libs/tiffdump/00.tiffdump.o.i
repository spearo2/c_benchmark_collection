# 1 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
# 27 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
...
# 30 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
...
# 31 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
...
# 32 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
...
# 35 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
...
# 38 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
# 59 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
# 1 "../libtiff/tiffio.h" 1
# 60 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2
...
{
 fprintf(
# 109 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
        stderr
# 109 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
...
# 132 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
                                    ((void *)0)
# 132 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                                        , 0);
   break;
  case 'm':
   maxitems = strtoul(optarg, 
# 135 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
                             ((void *)0)
# 135 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                                 , 0);
   break;
  default:
   usage();
 ...
 for (; optind < argc; optind++) {
  fd = open(argv[optind], 
# 144 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
                         00
# 144 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                                 |0, 0);
  if (fd < 0) {
   perror(argv[0]);
   return (-1);
...
# 171 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
                         ((void *)0)
# 171 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                             ;
...
ReadDirectory(int fd, unsigned int ix, uint64 off)
{
 ...
 uint32 direntrysize;
 void* dirmem = 
# 305 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
               ((void *)0)
# 305 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                   ;
 uint64 nextdiroff = 0;
 uint32 n;
 uint8* dp;
...
# 312 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
    0
# 312 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
    ) != (off_t)off) {
 ...
 if (dirmem == 
# 340 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
              ((void *)0)
# 340 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                  ) {
 ...
 for (dp = (uint8*)dirmem, n = dircount; n > 0; n--) {
  ...
  if (swabflag)
   TIFFSwabShort(&type);
  PrintTag(
# 401 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
          stdout
# 401 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                , tag);
  putchar(' ');
  PrintType(
# 403 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
           stdout
# 403 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                 , type);
  putchar(' ');
  if (!bigtiff)
  {
  ...
  if (!bigtiff)
  {
   if (datasizeoverflow || datasize>4)
   {
    ...
    datafits = 0;
    datamem = 
# 442 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
             ((void *)0)
# 442 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                 ;
  ...
  else
  {
   if (datasizeoverflow || datasize>8)
   {
    datafits = 0;
    datamem = 
# 455 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
             ((void *)0)
# 455 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                 ;
  ...
  if (!datafits)
  {
   ...
   if (datamem) {
    ...
    "Seek error accessing tag %u value", tag);
     _TIFFfree(datamem);
     datamem = 
# 484 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
              ((void *)0)
# 484 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                  ;
    }
    ...
    "Read error accessing tag %u value", tag);
     _TIFFfree(datamem);
     datamem = 
# 491 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
              ((void *)0)
# 491 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                  ;
    }
   } else
  ...
  if (datamem)
  {
   ...
   PrintData(
# 529 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
            stdout
# 529 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
   ...
   if (!datafits)
                                {
                                        _TIFFfree(datamem);
                                        datamem = 
# 535 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
                                                 ((void *)0)
# 535 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                                                     ;
                                }
  }
  printf(">\n");
...
# 691 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 2


# 692 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
static void
PrintASCII(FILE* fd, uint32 cc, const unsigned char* cp)
{
 for (; cc > 0; cc--, cp++) {
  ...
  if (
# 698 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 698 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
     *cp
# 698 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
...
# 867 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
__builtin_va_start(
# 867 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
ap
# 867 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
,
# 867 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
...
# 867 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                 ;
 vError(
# 868 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
       stderr
# 868 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
             , fmt, ap);
 
# 869 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
__builtin_va_end(
# 869 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
ap
# 869 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
)
# 869 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
...
# 876 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
__builtin_va_start(
# 876 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
ap
# 876 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
,
# 876 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
...
# 876 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
                 ;
 vError(
# 877 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
       stderr
# 877 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
             , fmt, ap);
 
# 878 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
__builtin_va_end(
# 878 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
ap
# 878 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c" 3 4
)
# 878 "/doner/libtiff/libtiff-f3069a5/tools/tiffdump.c"
