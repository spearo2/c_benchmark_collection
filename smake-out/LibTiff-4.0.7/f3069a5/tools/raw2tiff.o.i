# 1 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
# 30 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
# 1 "../libtiff/tif_config.h" 1
# 31 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 33 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 34 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 35 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 36 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 38 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 39 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 42 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
...
# 46 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
# 60 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
...
# 61 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
# 1 "../libtiff/tiffio.h" 1
# 62 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 2
# 71 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
typedef enum {
 PIXEL,
 BAND
} InterleavingType;
...
main(int argc, char* argv[])
{
 ...
 int fd;
 char *outfilename = 
# 103 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                    ((void *)0)
# 103 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                        ;
 TIFF *out;
 ...
 int c;
 unsigned char *buf = 
# 108 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                     ((void *)0)
# 108 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                         , *buf1 = 
# 108 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                                   ((void *)0)
# 108 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
 ...
 while ((c = getopt(argc, argv, "c:r:H:w:l:b:d:LMp:si:o:h")) != -1) {
  ...
  usage();
        ...
        fd = open(argv[optind], 
# 206 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                               00
# 206 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                                       |0, 0);
 if (fd < 0) {
  fprintf(
# 208 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 208 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
 ...
 if (outfilename == 
# 216 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                   ((void *)0)
# 216 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                       )
  outfilename = argv[optind+1];
 out = TIFFOpen(outfilename, "w");
 if (out == 
# 219 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
           ((void *)0)
# 219 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
               ) {
  fprintf(
# 220 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 220 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
 ...
 lseek(fd,hdr_size,
# 287 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
0
# 287 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
);
...
# 292 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
       0
# 292 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
       )

                                                    == (off_t)-1) {
                                        fprintf(
# 295 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                                               stderr
# 295 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                                                     ,
    ...
    if (read(fd, buf, linebytes) < 0) {
     fprintf(
# 302 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
            stderr
# 302 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                  ,
  ...
  default:
   if (read(fd, buf1, bufsize) < 0) {
    fprintf(
# 318 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
           stderr
# 318 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                 ,
     "%s: %s: scanline %lu: Read error.\n",
     argv[0], argv[optind],
     (unsigned long) row);
  ...
  if (TIFFWriteScanline(out, buf1, row, 0) < 0) {
   fprintf(
# 330 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
          stderr
# 330 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
   ...
   int swab, uint32 *width, uint32 *length)
{
 ...
 if (fstat(fd,&filestat) == -1) {
                fprintf(
# 379 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                       stderr
# 379 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
 ...
 if (filestat.st_size < hdr_size) {
  fprintf(
# 384 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 384 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
 ...
 if (*width != 0 && *length == 0) {
  fprintf(
# 391 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 391 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
               , "Image height is not specified.\n");

  *length = imagesize / *width;

  fprintf(
# 395 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 395 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
  ...
  fprintf(
# 400 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 400 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
               , "Image width is not specified.\n");

  *width = imagesize / *length;

  fprintf(
# 404 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 404 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
  ...
  return 1;
                ...
                unsigned int fail = 0;
  fprintf(
# 410 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 410 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
...
# 421 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                                           0
# 421 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                                           )
                                                            == (off_t)-1) {
                                                fprintf(
# 423 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                                                       stderr
# 423 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                                                             , "seek error.\n");
                                                fail=1;
                                                break;
                                        }
                                        if (read(fd, buf1, scanlinesize) !=
                                            (long) scanlinesize) {
                                                fprintf(
# 429 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                                                       stderr
# 429 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                                                             , "read error.\n");
                                                fail=1;
                                                break;
                                        }
                                        if (read(fd, buf2, scanlinesize) !=
                                            (long) scanlinesize) {
                                                fprintf(
# 435 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                                                       stderr
# 435 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                                                             , "read error.\n");
                                                fail=1;
                                                break;
                                        }
  ...
  fprintf(
# 460 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 460 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
               ,
  ...
  if (filestat.st_size<(off_t)(hdr_size+(*width)*(*length)*nbands*depth)) {
   fprintf(
# 467 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
          stderr
# 467 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
...
processCompressOptions(char* opt)
{
 if (strcmp(opt, "none") == 0)
  ...
  char* cp = strchr(opt, ':');
                ...
                {
                    if (
# 580 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                       ((*__ctype_b_loc ())[(int) ((
# 580 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                       (int)cp[1]
# 580 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
...
# 661 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
((void *)0)

# 662 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
};
...
{
 char buf[
# 667 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         8192
# 667 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
               ];
 int i;

 setbuf(
# 670 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
       stderr
# 670 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
             , buf);
        fprintf(
# 671 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
               stderr
# 671 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 672 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
                        ((void *)0)
# 672 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
                            ; i++)
  fprintf(
# 673 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c" 3 4
         stderr
# 673 "/doner/libtiff/libtiff-f3069a5/tools/raw2tiff.c"
               , "%s\n", stuff[i]);
 exit(-1);
}
