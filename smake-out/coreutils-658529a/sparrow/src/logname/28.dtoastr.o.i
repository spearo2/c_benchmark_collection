# 1 "/home/yuntong/vulnfix/data/coreutils/coreutils-658529a/lib/dtoastr.c"
...
# 109 "/home/yuntong/vulnfix/data/coreutils/coreutils-658529a/lib/ftoastr.c"
  ...
  *p = '\0';
  ...
  for (prec = abs_x < ((double)2.22507385850720138309023271733240406e-308L) ? 1 : 15; ; prec++)
    {
      int n = snprintf (buf, bufsize, format, width, prec, x);
      if (n < 0
          || (((((53) * 1) * 146 + 484) / 485) + 1) <= prec
          || (n < bufsize && strtod (buf, 
...
# 2 "/home/yuntong/vulnfix/data/coreutils/coreutils-658529a/lib/dtoastr.c" 2
