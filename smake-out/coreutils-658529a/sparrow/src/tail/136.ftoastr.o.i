# 1 "/home/yuntong/vulnfix/data/coreutils/coreutils-658529a/lib/ftoastr.c"
...
# 109 "/home/yuntong/vulnfix/data/coreutils/coreutils-658529a/lib/ftoastr.c"
  ...
  *p = '\0';
  ...
  for (prec = abs_x < 1.17549435082228750796873653722224568e-38F ? 1 : 6; ; prec++)
    {
      int n = snprintf (buf, bufsize, format, width, prec, x);
      if (n < 0
          || (((((24) * 1) * 146 + 484) / 485) + 1) <= prec
          || (n < bufsize && strtof (buf, 
