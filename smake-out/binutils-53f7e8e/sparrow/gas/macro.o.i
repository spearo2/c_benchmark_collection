# 1 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
# 24 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
...
# 25 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 2
# 47 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
...
# 110 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
int
   ...
   size_t (*get_line) (sb *))
{
  ...
  if (to_len == 4 && strcasecmp (to, "ENDR") == 0)
    {
      from = 
# 122 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
            ((void *)0)
# 122 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                ;
      from_len = 0;
    }
  else
      ...
      || macro_mri))
 {
   if (! 0 && ptr->ptr[i] == '.')
     i++;
   if (from == 
# 186 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
              ((void *)0)
      
# 187 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
     ...
     from_len = 0;
   if ((from != 
# 194 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
               ((void *)0)
        
# 195 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
...
# 224 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
...
# 362 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
static size_t
get_any_string (size_t idx, sb *in, sb *out)
{
 ...
 {
   while (!((in->ptr[idx]) == ' ' || (in->ptr[idx]) == '\t' || (in->ptr[idx]) == ',' || (in->ptr[idx]) == '"' || (in->ptr[idx]) == ';' || (in->ptr[idx]) == ')' || (in->ptr[idx]) == '(' || ((macro_alternate || macro_mri) && ((in->ptr[idx]) == '<' || (in->ptr[idx]) == '>'))))
      ...
      else if (in->ptr[idx] == '%' && macro_alternate)
 {
   ...
   idx = (*macro_expr) (gettext ("% operator needs absolute expression"),
          idx + 1,
          in,
          &val);
   sprintf (buf, "%" "l" "d", val);
...
new_formal (void)
{
  ...
  formal->next = 
# 479 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                ((void *)0)
# 479 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                    ;
       ...
       const char **namep)
{
  ...
  sb name;
  const char *error = 
# 656 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                     ((void *)0)
# 656 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                         ;
  ...
  if (label != 
# 671 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
              ((void *)0) 
# 671 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                   && label->len != 0)
    {
 ...
 idx = cidx;
  ...
  if (namep != 
# 716 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
              ((void *)0)
# 716 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                  )
    *namep = macro->name;
     ...
     int kind, sb *out, int copyifnotthere)
{
  ...
  if (macro_strip_at
    ...
    ptr = 
# 756 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
         ((void *)0)
# 756 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
             ;
  else
...
# 799 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                         ((void *)0)
# 799 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                             ;
  const char *err = 
# 800 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                   ((void *)0)
# 800 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                       ;
      ...
      else if (in->ptr[src] == '\\')
 {
  ...
  as_bad_where (macro->file, macro->line + macro_line, gettext ("missing `)'"));
   ...
   else if (macro_mri && src < in->len && (_sch_istable[(in->ptr[src]) & 0xff] & (unsigned short)(_sch_isalnum)))
     {
       int ind;
       formal_entry *f;
  ...
  ind = in->ptr[src] - 'a' + 10;
       ++src;
       for (f = formals; f != 
# 870 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                             ((void *)0)
# 870 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                                 ; f = f->next)
  {
    if (f->index == ind - 1)
      {
    ...
    if (! hash_find (formal_hash, name))
      {
        ...
        if (err != 
# 929 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                  ((void *)0)
# 929 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                      )
   break;
      }
    else
        ...
        && in->ptr[src + 1] == '=')
 {
   ...
   ptr = (formal_entry *) hash_find (formal_hash, sb_terminate (&t));
   if (ptr == 
# 971 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
             ((void *)0)
# 971 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                 )
     {
# 981 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
       sb_add_char (out, '=');
       sb_add_char (out, '=');
       sb_add_sb (out, &t);
     }
      ...
      else
 {
  ...
  while (loclist != 
# 1007 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                   ((void *)0)
# 1007 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                       )
    {
      formal_entry *f;
      const char *name;
      ...
      hash_delete (formal_hash, name, f == 
# 1014 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                                          ((void *)0)
# 1014 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                                              );
      del_formal (loclist);
      loclist = f;
    }
...
macro_expand (size_t idx, sb *in, macro_entry *m, sb *out)
{
  ...
  int narg = 0;
  const char *err = 
# 1033 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                   ((void *)0)
# 1033 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                       ;
  ...
  f = m->formals;
  while (f != 
# 1041 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
             ((void *)0) 
# 1041 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                  && f->index < 0)
    f = f->next;
  ...
  while (idx < in->len)
    {
      ...
      scan = idx;
      while (scan < in->len
      && !((in->ptr[scan]) == ' ' || (in->ptr[scan]) == '\t' || (in->ptr[scan]) == ',' || (in->ptr[scan]) == '"' || (in->ptr[scan]) == ';' || (in->ptr[scan]) == ')' || (in->ptr[scan]) == '(' || ((macro_alternate || macro_mri) && ((in->ptr[scan]) == '<' || (in->ptr[scan]) == '>')))
      ...
      else
 {
       ...
       if (!macro_mri)
  {
    ...
    break;
       ...
       c = -1;
       for (pf = &m->formals; *pf != 
# 1145 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                                    ((void *)0)
# 1145 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                                        ; pf = &(*pf)->next)
  if ((*pf)->index >= c)
    c = (*pf)->index + 1;
       if (c == -1)
  c = 0;
   ...
   while (f != 
# 1167 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
              ((void *)0) 
# 1167 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                   && f->index < 0);
 }
  ...
  if (macro_mri)
    {
      ...
      pf = &m->formals;
      while (*pf != 
# 1211 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                   ((void *)0)
# 1211 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                       )
 {
   if ((*pf)->name.len != 0)
     pf = &(*pf)->next;
      ...
      const char **error, macro_entry **info)
{
  ...
  if (macro == 
# 1260 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
              ((void *)0)
# 1260 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                  )
    return 0;
...
delete_macro (const char *name)
{
  ...
  if ((macro = (macro_entry *) hash_find (macro_hash, copy)) != 
# 1298 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                                                               ((void *)0)
# 1298 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                                                                   )
    {
      hash_jam (macro_hash, copy, 
# 1300 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                                 ((void *)0)
# 1300 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                                     );
      free_macro (macro);
    }
  else
...
expand_irp (int irpc, size_t idx, sb *in, sb *out, size_t (*get_line) (sb *))
{
  ...
  sb_new (&sub);
  if (! buffer_and_nest (
# 1323 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
                        ((void *)0)
# 1323 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                            , "ENDR", &sub, get_line))
    return gettext ("unexpected end of file in irp or irpc");
  ...
  if (f.name.len == 0)
    return gettext ("missing model parameter");

  h = hash_new ();
  err = hash_jam (h, sb_terminate (&f.name), &f);
  if (err != 
# 1336 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
            ((void *)0)
# 1336 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                )
    return err;

  f.index = 1;
  f.next = 
# 1340 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
          ((void *)0)
# 1340 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
              ;
      ...
      while (idx < in->len)
 {
       ...
       if (in->ptr[idx] == '"')
  {
   ...
   err = macro_expand_body (&sub, out, &f, h, 0);
   if (err != 
# 1387 "/doner/binutils/binutils-53f7e8e/gas/macro.c" 3 4
             ((void *)0)
# 1387 "/doner/binutils/binutils-53f7e8e/gas/macro.c"
                 )
     break;
   if (!irpc)
     idx = sb_skip_comma (idx, in);
