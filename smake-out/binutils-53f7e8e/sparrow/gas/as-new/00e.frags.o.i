# 1 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
# 21 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
...
# 22 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 2
...
# 23 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 2
...
# 64 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 3 4
                          ((void *)0)
# 64 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
                              )
    {
      as_bad (gettext ("attempt to allocate data in common section"));
      mri_common_symbol = 
# 67 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 3 4
                         ((void *)0)
# 67 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
                             ;
    }
}
  ...
  if (__extension__ ({ struct obstack const *__o1 = (&frchain_now->frch_obstack); (size_t) (__o1->chunk_limit - __o1->next_free); }) < nchars)
    {
      ...
      if (newc < nchars)
        as_fatal (gettext ("can't extend frag %lu chars"), (unsigned long) nchars);
...
# 154 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
void
                                       ...
                                       )
{
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/frags.c", 162, __PRETTY_FUNCTION__), 0)));


  frag_now->fr_fix = frag_now_fix_octets () - old_frags_var_max_size;

  ((void) ((frag_now->fr_type != 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/frags.c", 167, __PRETTY_FUNCTION__), 0)));



  __extension__ ({ struct obstack *__o1 = (&frchain_now->frch_obstack); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; });
  frchP = frchain_now;
  ((void) ((frchP) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/frags.c", 173, __PRETTY_FUNCTION__), 0)));
  former_last_fragP = frchP->frch_last;
  ((void) ((former_last_fragP != 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/frags.c", 175, __PRETTY_FUNCTION__), 0)));
  ((void) ((former_last_fragP == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/frags.c", 176, __PRETTY_FUNCTION__), 0)));
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/frags.c", 195, __PRETTY_FUNCTION__), 0)));

  frag_now->fr_next = 
# 197 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 3 4
                     ((void *)0)
# 197 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
                         ;
}
               ...
               char *opcode)
{
  ...
  do { (frag_now)->tc_frag_data.isa = cpu_arch_isa; (frag_now)->tc_frag_data.isa_flags = cpu_arch_isa_flags; (frag_now)->tc_frag_data.tune = cpu_arch_tune; } while (0);

  frag_now->fr_file = as_where (&frag_now->fr_line);

  frag_new (max_chars);
}
# 252 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
char *
...
# 308 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
void
...
# 338 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
void
...
# 369 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
void
frag_align_code (int alignment, int max)
{
  char *p;

  p = frag_var (rs_align_code, 31, 1,
  ...
  while (frag->fr_type == rs_fill)
    {
      ...
      frag = frag->fr_next;
      if (frag == 
# 433 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 3 4
                 ((void *)0)
# 433 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
                     )
 break;
      if (frag == frag2)
 {
  ...
  while (frag->fr_type == rs_fill)
    {
      ...
      frag = frag->fr_next;
      if (frag == 
# 449 "/doner/binutils/binutils-53f7e8e/gas/frags.c" 3 4
                 ((void *)0)
# 449 "/doner/binutils/binutils-53f7e8e/gas/frags.c"
                     )
 break;
      if (frag == frag1)
 {
