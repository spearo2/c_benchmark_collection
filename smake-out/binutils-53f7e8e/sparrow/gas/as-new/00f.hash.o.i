# 1 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
# 30 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
...
# 31 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 2
...
# 67 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
};
...
{
  __extension__ ({ struct obstack *__o = (&table->memory); void *__obj = (void *) (0); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
  free (table);
}
# 133 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
      ...
      struct hash_entry ***plist, unsigned long *phash)
{
  ...
  if (phash != 
# 159 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
              ((void *)0)
# 159 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                  )
    *phash = hash;
  ...
  if (plist != 
# 165 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
              ((void *)0)
# 165 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                  )
    *plist = list;

  prev = 
# 168 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
        ((void *)0)
# 168 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
            ;
  for (p = *list; p != 
# 169 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                      ((void *)0)
# 169 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                          ; p = p->next)
    {
      ...
      if (p->hash == hash)
 {
   ...
   if (strncmp (p->string, key, len) == 0 && p->string[len] == '\0')
     {
       if (prev != 
# 183 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                  ((void *)0)
# 183 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                      )
  {
    prev->next = p->next;
    p->next = *list;
  ...
  return 
# 197 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
        ((void *)0)
# 197 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
            ;
}
...
hash_insert (struct hash_control *table, const char *key, void *val)
{
  ...
  if (p != 
# 213 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 213 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              )
    return "exists";
  ...
  p = (struct hash_entry *) __extension__ ({ struct obstack *__h = (&table->memory); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof (*p))); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); });
  p->string = key;
  p->hash = hash;
  p->data = val;
  ...
  *list = p;
  ...
  return 
# 228 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
        ((void *)0)
# 228 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
            ;
}
...
hash_jam (struct hash_control *table, const char *key, void *val)
{
  ...
  p = hash_lookup (table, key, strlen (key), &list, &hash);
  if (p != 
# 243 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 243 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              )
    {
  ...
  return 
# 266 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
        ((void *)0)
# 266 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
            ;
}
...
hash_replace (struct hash_control *table, const char *key, void *value)
{
  ...
  p = hash_lookup (table, key, strlen (key), 
# 279 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                            ((void *)0)
# 279 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                                                , 
# 279 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                                  ((void *)0)
# 279 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
  ...
  if (p == 
# 280 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 280 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              )
    return 
# 281 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 281 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              ;
...
hash_find (struct hash_control *table, const char *key)
{
  ...
  p = hash_lookup (table, key, strlen (key), 
# 302 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                            ((void *)0)
# 302 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                                                , 
# 302 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                                  ((void *)0)
# 302 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
  ...
  if (p == 
# 303 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 303 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              )
    return 
# 304 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 304 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              ;
...
hash_find_n (struct hash_control *table, const char *key, size_t len)
{
  ...
  p = hash_lookup (table, key, len, 
# 317 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                   ((void *)0)
# 317 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                                       , 
# 317 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                         ((void *)0)
# 317 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
  ...
  if (p == 
# 318 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 318 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              )
    return 
# 319 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 319 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              ;
...
hash_delete (struct hash_control *table, const char *key, int freeme)
{
  ...
  p = hash_lookup (table, key, strlen (key), &list, 
# 333 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                                   ((void *)0)
# 333 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                                                       );
  if (p == 
# 334 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 334 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              )
    return 
# 335 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
          ((void *)0)
# 335 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
              ;

  if (p != *list)
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/hash.c", 338, __PRETTY_FUNCTION__);
  ...
  *list = p->next;
  ...
  if (freeme)
    __extension__ ({ struct obstack *__o = (&table->memory); void *__obj = (void *) (p); if (__obj > (void *) __o->chunk && __obj < (void *) __o->chunk_limit) __o->next_free = __o->object_base = (char *) __obj; else _obstack_free (__o, __obj); });
  ...
  for (i = 0; i < table->size; ++i)
    {
      ...
      for (p = table->table[i]; p != 
# 365 "/doner/binutils/binutils-53f7e8e/gas/hash.c" 3 4
                                    ((void *)0)
# 365 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
                                        ; p = p->next)
 (*pfn) (p->string, p->data);
    }
}
...
void
hash_print_statistics (FILE *f __attribute__ ((__unused__)),
         const char *name __attribute__ ((__unused__)),
         struct hash_control *table __attribute__ ((__unused__)))
{
# 409 "/doner/binutils/binutils-53f7e8e/gas/hash.c"
}
