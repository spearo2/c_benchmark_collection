# 1 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
# 31 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
...
# 32 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 36 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2
# 45 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
# 1 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.h" 1
# 46 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2
...
# 47 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2
# 105 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
...
# 106 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2
...
# 108 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 2
# 165 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
struct line_entry {
...
{
  struct line_seg *s = ((segment_info_type *) ((void) stdoutput, (seg)->userdata))->dwarf2_line_seg;
  struct line_subseg **pss, *lss;

  if (s == 
# 251 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
          ((void *)0)
# 251 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
              )
    {
      if (!create_p)
 return 
# 254 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
       ((void *)0)
# 254 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
           ;

      s = ((struct line_seg *) xmalloc (sizeof (struct line_seg)));
      s->next = 
# 257 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
               ((void *)0)
# 257 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                   ;
      s->seg = seg;
      s->head = 
# 259 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
               ((void *)0)
# 259 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                   ;
      *last_seg_ptr = s;
      last_seg_ptr = &s->next;
      ((segment_info_type *) ((void) stdoutput, (seg)->userdata))->dwarf2_line_seg = s;
    }
  ((void) ((seg == s->seg) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 264, __PRETTY_FUNCTION__), 0)));

  for (pss = &s->head; (lss = *pss) != 
# 266 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                                      ((void *)0) 
# 266 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                                           ; pss = &lss->next)
    {
 ...
 break;
  ...
  lss->subseg = subseg;
  lss->head = 
# 277 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
             ((void *)0)
# 277 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                 ;
  lss->ptail = &lss->head;
...
dwarf2_gen_line_info_1 (symbolS *label, struct dwarf2_line_info *loc)
{
  ...
  e->next = 
# 295 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
           ((void *)0)
# 295 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
               ;
  e->label = label;
  e->loc = *loc;

  lss = get_line_subseg (now_seg, now_subseg, 1);
  *lss->ptail = e;
  lss->ptail = &e->next;
}
...
dwarf2_move_insn (int delta)
{
  ...
  lss = get_line_subseg (now_seg, now_subseg, 0);
  if (!lss)
    return;
...
dwarf2_emit_label (symbolS *label)
{
  ...
  if (S_GET_SEGMENT (label) != now_seg)
    return;
  if (!(((void) stdoutput, (now_seg)->flags) & 0x010))
    return;
...
get_filenum (const char *filename, unsigned int num)
{
 ...
 return last_used;
   ...
   && filename_ncmp (filename, dirs[files[last_used].dir],
       last_used_dir_len) == 0
   && (((filename [last_used_dir_len]) == '/') || (((filename [last_used_dir_len]) == '\\') && (0)))
  ...
  if (i >= files_allocated)
    {
      ...
      files = ((struct file_entry *) xrealloc ((void *) (files), sizeof (struct file_entry) * (files_allocated)));
  ...
  if (*input_line_pointer == '"')
    {
      s_app_file (0);
      return 
# 576 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
            ((void *)0)
# 576 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                ;
    }
  ...
  if (filename == 
# 581 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                 ((void *)0)
# 581 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                     )
    return 
# 582 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
          ((void *)0)
# 582 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
              ;
  ...
  if (num < 1)
    {
      ...
      return 
# 588 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
            ((void *)0)
# 588 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                ;
    }
  ...
  if (num < (int) files_in_use && files[num].filename != 0)
    {
      as_bad (gettext ("file number %ld already allocated"), (long) num);
      return 
# 598 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
            ((void *)0)
# 598 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                ;
    }
...
{
  return ((segment_info_type *) ((void) stdoutput, (seg)->userdata))->frchainP->frch_root;
}

static struct frag *
last_frag_for_seg (segT seg)
{
  frchainS *f = ((segment_info_type *) ((void) stdoutput, (seg)->userdata))->frchainP;

  while (f->frch_next != 
# 767 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                        ((void *)0)
# 767 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                            )
    f = f->frch_next;
...
get_frag_fix (fragS *frag, segT seg)
{
  ...
  for (fr = ((segment_info_type *) ((void) stdoutput, (seg)->userdata))->frchainP; fr; fr = fr->frch_next)
    if (fr->frch_last == frag)
      return (char *) ((void *) (&fr->frch_obstack)->next_free) - frag->fr_literal;

  as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 847, __PRETTY_FUNCTION__);
}
...
scale_addr_delta (addressT *addr_delta)
{
  ...
  if (1 > 1)
    {
      if (*addr_delta % 1 != 0 && !printed_this)
        {
...
# 891 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
static int
size_inc_line_addr (int line_delta, addressT addr_delta)
{
 ...
 return len + 1;
      ...
      opcode = tmp + (addr_delta - (((255) - 13)/14)) * 14;
      if (opcode <= 255)
 return len + 2;
    }
...
emit_inc_line_addr (int line_delta, addressT addr_delta, char *p, int len)
{
  ...
  ((void) (((offsetT) addr_delta >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 959, __PRETTY_FUNCTION__), 0)));
 ...
 *p++ = DW_LNS_const_add_pc;
  ...
  *p++ = DW_LNS_advance_pc;
  ...
  ((void) ((p == end) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1040, __PRETTY_FUNCTION__), 0)));
}
...
# 1059 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
static int
     ...
     char *p, int len)
{
  ...
  ((void) (((offsetT) addr_delta >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1098, __PRETTY_FUNCTION__), 0)));


  ((void) ((len == size_fixed_inc_line_addr (line_delta, addr_delta)) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1101, __PRETTY_FUNCTION__), 0)));
  ...
  if (addr_delta > 50000)
    {
      ...
      ((void) ((pexp->X_op == O_subtract) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1122, __PRETTY_FUNCTION__), 0)));
  ...
  ((void) ((p == end) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1150, __PRETTY_FUNCTION__), 0)));
}
...
# 1176 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                                         ((void *)0)
# 1176 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                                             );
}
...
dwarf2dbg_convert_frag (fragS *frag)
{
  ...
  if (linkrelax)
    {
# 1234 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
  ...
  ((void) ((frag->fr_var >= (int) frag->fr_subtype) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1246, __PRETTY_FUNCTION__), 0)));
...
process_entries (segT seg, struct line_entry *e)
{
  ...
  fragS *last_frag = 
# 1273 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                    ((void *)0)
# 1273 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                        , *frag;
  addressT last_frag_ofs = 0, frag_ofs;
  symbolS *last_lab = 
# 1275 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                     ((void *)0)
# 1275 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                         , *lab;
  struct line_entry *next;
  ...
  if (flag_dwarf_sections)
    {
      char * name;
      const char * sec_name;
# 1295 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
      sec_name = ((void) stdoutput, (seg)->name);
      if (strcmp (sec_name, ".text") != 0)
 {
   name = concat (".debug_line", sec_name, (char *) 
# 1298 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                                                   ((void *)0)
# 1298 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                                                       );
   subseg_set (subseg_get (name, 0), 0);
 }
      else



 subseg_set (subseg_get (".debug_line", 0), 0);
    }
 ...
 out_opcode (DW_LNS_set_epilogue_begin);
      ...
      if (last_frag == 
# 1365 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                      ((void *)0)
# 1365 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                          )
 {
   out_set_addr (lab);
  ...
  for (i = 1; i < files_in_use; ++i)
    {
      ...
      if (files[i].filename == 
# 1423 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                              ((void *)0)
# 1423 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                                  )
 {
...
out_debug_line (segT line_seg)
{
  ...
  for (s = all_segs; s; s = s->next)
    if (( (s->seg) != (&_bfd_std_section[2]) && (s->seg) != (&_bfd_std_section[1]) && (s->seg) != reg_section && (s->seg) != expr_section))
      process_entries (s->seg, s->head->head);
    else
      as_warn ("dwarf line number information for %s ignored",
        ((void) stdoutput, (s->seg)->name));
  ...
  if (flag_dwarf_sections)
    ...
    subseg_set (subseg_get (".debug_line_end", 0), 0);
    ...
    segT line_seg __attribute__ ((__unused__)))
{
  ...
  if (all_segs->next == 
# 1713 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                       ((void *)0)
# 1713 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                           )
    {
...
out_debug_info (segT info_seg, segT abbrev_seg, segT line_seg, segT ranges_seg)
{
  ...
  if (all_segs->next == 
# 1774 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                       ((void *)0)
# 1774 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                           )
    {
      ...
      else
 {
   ...
   exp.X_op_symbol = all_segs->text_start;
  ...
  else
    {
      ...
      generic_dwarf2_emit_offset (section_symbol (ranges_seg), sizeof_offset);
    }
  ...
  if (files_in_use == 0)
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1806, __PRETTY_FUNCTION__);
  if (files[1].dir)
    {
  ...
  sprintf (producer, "GNU AS %s", "2.28.51");
...
# 1860 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
void
dwarf2_finish (void)
{
  segT line_seg;
...
# 1870 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                                   ((void *)0) 
# 1870 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                                        || !seg_not_empty_p (info_seg);

  line_seg = bfd_get_section_by_name (stdoutput, ".debug_line");
  empty_debug_line = line_seg == 
# 1873 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                                ((void *)0) 
# 1873 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
  ...
  bfd_set_section_flags (stdoutput, line_seg, 0x008 | 0x2000);
  ...
  for (s = all_segs; s; s = s->next)
    {
      ...
      while ((lss = lss->next) != 
# 1900 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                                 ((void *)0)
# 1900 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                                     )
 {
   *ptail = lss->head;
   ptail = lss->ptail;
  ...
  if (emit_other_sections)
    {
      ...
      ((void) ((all_segs) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c", 1918, __PRETTY_FUNCTION__), 0)));
      ...
      if (all_segs->next == 
# 1933 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
                           ((void *)0)
# 1933 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                               )
 ranges_seg = 
# 1934 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c" 3 4
             ((void *)0)
# 1934 "/doner/binutils/binutils-53f7e8e/gas/dwarf2dbg.c"
                 ;
      else
 {
