# 1 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
# 22 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 2
# 307 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
         ...
         unsigned int size)
{
  ...
  if (table->memory == 
# 386 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                      ((void *)0)
# 386 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                          )
    {
      bfd_set_error (bfd_error_no_memory);
      return 0;
...
# 392 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
     __builtin_offsetof (
# 392 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
...
# 392 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
  ...
  if (table->table == 
# 393 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                     ((void *)0)
# 393 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                         )
    {
...
bfd_hash_table_free (struct bfd_hash_table *table)
{
  ...
  table->memory = 
# 427 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                 ((void *)0)
# 427 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                     ;
}
...
bfd_hash_hash (const char *string, unsigned int *lenp)
{
  ...
  hash ^= hash >> 2;
  if (lenp != 
# 449 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
             ((void *)0)
# 449 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                 )
    *lenp = len;
  return hash;
}
   ...
   bfd_boolean copy)
{
  ...
  for (hashp = table->table[_index];
       hashp != 
# 470 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
               ((void *)0)
# 470 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                   ;
       hashp = hashp->next)
    {
      if (hashp->hash == hash
 ...
 return hashp;
  ...
  if (! create)
    return 
# 479 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
          ((void *)0)
# 479 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
              ;
...
# 485 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                           __builtin_offsetof (
# 485 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                           struct objalloc_align
# 485 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                           , 
# 485 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
...
# 485 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
      ...
      if (!new_string)
 {
   bfd_set_error (bfd_error_no_memory);
   return 
# 490 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
         ((void *)0)
# 490 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
             ;
 }
   ...
   unsigned long hash)
{
  ...
  hashp = (*table->newfunc) (
# 509 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                            ((void *)0)
# 509 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                                , table, string);
  if (hashp == 
# 510 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
              ((void *)0)
# 510 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                  )
    return 
# 511 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
          ((void *)0)
# 511 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
              ;
  hashp->string = string;
  hashp->hash = hash;
  _index = hash % table->size;
      ...
      if (newsize == 0 || alloc / sizeof (struct bfd_hash_entry *) != newsize)
 {
   ...
   return hashp;
    ...
    __extension__ ({ struct objalloc *__o = ((struct objalloc *) table->memory); unsigned long __len = (alloc); if (__len == 0) __len = 1; __len = (__len + 
# 535 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
   __builtin_offsetof (
# 535 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
   struct objalloc_align
# 535 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
   , 
# 535 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
...
# 535 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
   - 1); (__len != 0 && __len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); }));
      if (newtable == 
# 536 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                     ((void *)0)
# 536 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                         )
 {
   table->frozen = 1;
   return hashp;
...
# 575 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                                           ((void *)0)
# 575 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                                               ; pph = &(*pph)->next)
    if (*pph == ent)
      break;
  if (*pph == 
# 578 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
             ((void *)0)
# 578 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                 )
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/hash.c", 579, __PRETTY_FUNCTION__);

  *pph = ent->next;
  ent->string = string;
  ent->hash = bfd_hash_hash (string, 
# 583 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                                    ((void *)0)
# 583 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                                        );
  _index = ent->hash % table->size;
    ...
    struct bfd_hash_entry *nw)
{
  ...
  for (pph = &table->table[_index];
       (*pph) != 
# 601 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                ((void *)0)
# 601 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                    ;
       pph = &(*pph)->next)
    {
      if (*pph == old)
 {
  ...
  _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/hash.c", 611, __PRETTY_FUNCTION__);
}
...
# 622 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
       __builtin_offsetof (
# 622 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
       struct objalloc_align
# 622 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
       , 
# 622 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
...
# 622 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
       - 1); (__len != 0 && __len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); });
  if (ret == 
# 623 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
            ((void *)0) 
# 623 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                 && size != 0)
    bfd_set_error (bfd_error_no_memory);
  return ret;
}
...
{
  if (entry == 
# 635 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
              ((void *)0)
# 635 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                  )
...
# 655 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                                    ((void *)0)
# 655 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                                        ; p = p->next)
 if (! (*func) (p, info))
   goto out;
    }
...
# 696 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
       ...
       const char *string)
{
  ...
  if (ret == 
# 732 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
            ((void *)0)
# 732 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                )
    ret = (struct strtab_hash_entry *) bfd_hash_allocate (table,
                                                          sizeof (* ret));
  if (ret == 
# 735 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
            ((void *)0)
# 735 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                )
    return 
# 736 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
          ((void *)0)
# 736 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
              ;
  ...
  if (ret)
    {
      ...
      ret->next = 
# 746 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                 ((void *)0)
# 746 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                     ;
    }

  return (struct bfd_hash_entry *) ret;
}
# 760 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
struct bfd_strtab_hash *
_bfd_stringtab_init (void)
{
  ...
  if (table == 
# 767 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
              ((void *)0)
# 767 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                  )
    return 
# 768 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
          ((void *)0)
# 768 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
              ;
  ...
  if (!bfd_hash_table_init (&table->table, strtab_hash_newfunc,
       sizeof (struct strtab_hash_entry)))
    {
      free (table);
      return 
# 774 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
            ((void *)0)
# 774 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                ;
    }

  table->size = 0;
  table->first = 
# 778 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                ((void *)0)
# 778 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                    ;
  table->last = 
# 779 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
               ((void *)0)
# 779 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                   ;
  table->xcoff = 0;
...
_bfd_xcoff_stringtab_init (void)
{
  ...
  if (ret != 
# 795 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
            ((void *)0)
# 795 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                )
    ret->xcoff = 1;
  return ret;
}
  ...
  if (hash)
    {
      ...
      if (entry == 
# 825 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                  ((void *)0)
# 825 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                      )
 return (bfd_size_type) -1;
  ...
  else
    {
      entry = (struct strtab_hash_entry *) bfd_hash_allocate (&tab->table,
                                                              sizeof (* entry));
      if (entry == 
# 832 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                  ((void *)0)
# 832 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                      )
 return (bfd_size_type) -1;
      if (! copy)
      ...
      else
 {
   ...
   if (n == 
# 842 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
           ((void *)0)
# 842 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
               )
     return (bfd_size_type) -1;
          memcpy (n, str, len);
   entry->root.string = n;
      ...
      entry->next = 
# 848 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                   ((void *)0)
# 848 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                       ;
    }
      ...
      if (tab->xcoff)
 {
   ...
   tab->size += 2;
      ...
      if (tab->first == 
# 860 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                       ((void *)0)
# 860 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                           )
 tab->first = entry;
      else
 tab->last->next = entry;
...
# 889 "/doner/binutils/binutils-53f7e8e/bfd/hash.c" 3 4
                                   ((void *)0)
# 889 "/doner/binutils/binutils-53f7e8e/bfd/hash.c"
                                       ; entry = entry->next)
    {
      const char *str;
      size_t len;
