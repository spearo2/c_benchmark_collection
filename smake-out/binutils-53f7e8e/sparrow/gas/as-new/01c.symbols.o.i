# 1 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
# 23 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
...
# 24 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/subsegs.h" 1
# 42 "/doner/binutils/binutils-53f7e8e/gas/subsegs.h"
...
# 27 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/struc-symbol.h" 1
# 24 "/doner/binutils/binutils-53f7e8e/gas/struc-symbol.h"
struct symbol_flags
{
...
# 107 "/doner/binutils/binutils-53f7e8e/gas/struc-symbol.h"
};
# 120 "/doner/binutils/binutils-53f7e8e/gas/struc-symbol.h"
struct local_symbol
{
...
# 28 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 2
...
symbolS abs_symbol;
symbolS dot_symbol;
# 62 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
...
# 85 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
symbolS *
symbol_new (const char *name, segT segment, valueT valu, fragS *frag)
{
...

  {
    ...
    if (symbol_table_frozen)
      as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 94, __PRETTY_FUNCTION__);
  }
        ...
        fragS *frag )
{
  ...
  if (symbolP->bsym == 
# 146 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                      ((void *)0)
# 146 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                          )
...
# 190 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
struct local_symbol *
local_symbol_make (const char *name, segT section, valueT val, fragS *frag)
{
  ...
  ret = (struct local_symbol *) __extension__ ({ struct obstack *__h = (&notes); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof *ret)); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); });
...
local_symbol_convert (struct local_symbol *locsym)
{
  ...
  ((void) ((locsym->lsy_flags.sy_local_symbol) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 221, __PRETTY_FUNCTION__), 0)));
  if (((locsym)->lsy_section == reg_section))
    return ((locsym)->u.lsy_sym);
  ...
  if (((locsym)->lsy_flags.sy_resolved))
  ...
  ((locsym)->lsy_section = reg_section);
  ((locsym)->u.lsy_sym = (ret));

  hash_jam (local_hash, locsym->lsy_name, 
# 245 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                                         ((void *)0)
# 245 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                             );
                                                     ...
                                                     )
{
  ...
  if (0
    ...
    dollar_label_clear ();
# 322 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
  if ((symbolP = symbol_find (sym_name)) != 0)
    {
      ...
      if ((symbolP->sy_flags.sy_local_symbol ? ((((struct local_symbol *) symbolP)->lsy_section == reg_section) ? (symbolP = (((struct local_symbol *) symbolP)->u.lsy_sym), 0) : 1) : 0))
 {
   struct local_symbol *locsym = (struct local_symbol *) symbolP;

   if (locsym->lsy_section != (&_bfd_std_section[1])
       && (((locsym)->u.lsy_frag) != frag_now
        ...
        || S_IS_VOLATILE (symbolP))
 {
   ...
   if (S_GET_VALUE (symbolP) == 0)
     ...
     {
# 378 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
...
# 420 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
    as_bad (gettext ("symbol `%s' is already defined as \"%s\"/%s%ld"),
       sym_name,
       ((void) stdoutput, (S_GET_SEGMENT (symbolP))->name),
       od_buf,
...
# 456 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                          ((void *)0)
# 456 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                              )
    {
...
symbol_table_insert (symbolS *symbolP)
{
  ...
  ((void) ((symbolP) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 487, __PRETTY_FUNCTION__), 0)));
  ((void) ((S_GET_NAME (symbolP)) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 488, __PRETTY_FUNCTION__), 0)));
  ...
  if ((symbolP->sy_flags.sy_local_symbol ? ((((struct local_symbol *) symbolP)->lsy_section == reg_section) ? (symbolP = (((struct local_symbol *) symbolP)->u.lsy_sym), 0) : 1) : 0))
    {
      error_string = hash_jam (local_hash, S_GET_NAME (symbolP),
          (void *) symbolP);
      if (error_string != 
# 494 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                         ((void *)0)
# 494 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                             )
 as_fatal (gettext ("inserting \"%s\" into symbol table failed: %s"),
...
symbol_find_or_make (const char *name)
{
  ...
  if (symbolP == 
# 517 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                ((void *)0)
# 517 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                    )
    {
      if (! flag_keep_locals && ((*((stdoutput)->xvec->_bfd_is_local_label_name)) (stdoutput, name)))
 {
   ...
   if (symbolP != 
# 522 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                 ((void *)0)
# 522 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                     )
     return symbolP;
...
symbol_make (const char *name)
{
  ...
  if (!symbolP)
    symbolP = symbol_new (name, (&_bfd_std_section[1]), (valueT) 0, &zero_address_frag);
...
symbol_clone (symbolS *orgsymP, int replace)
{
  ...
  ((void) ((orgsymP != &dot_symbol) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 560, __PRETTY_FUNCTION__), 0)));





  if ((orgsymP->sy_flags.sy_local_symbol ? ((((struct local_symbol *) orgsymP)->lsy_section == reg_section) ? (orgsymP = (((struct local_symbol *) orgsymP)->u.lsy_sym), 0) : 1) : 0))
    orgsymP = local_symbol_convert ((struct local_symbol *) orgsymP);
  bsymorg = orgsymP->bsym;

  newsymP = (symbolS *) __extension__ ({ struct obstack *__h = (&notes); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((sizeof (*newsymP))); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); });
  *newsymP = *orgsymP;
  bsymnew = ((*((((bsymorg)->the_bfd))->xvec->_bfd_make_empty_symbol)) (((bsymorg)->the_bfd)));
  if (bsymnew == 
# 573 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                ((void *)0)
# 573 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                    )
    as_fatal ("bfd_make_empty_symbol: %s", bfd_errmsg (bfd_get_error ()));
  ...
  ((*((((bsymnew)->the_bfd))->xvec->_bfd_copy_private_symbol_data)) (((bsymorg)->the_bfd), bsymorg, ((bsymnew)->the_bfd), bsymnew))
                                       ;
# 590 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
  if (replace)
    {
      ...
      else if (orgsymP->sy_previous)
 {
   ...
   orgsymP->sy_previous = 
# 597 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                         ((void *)0)
# 597 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                             ;
 }
...
{
  if (symbolP && !(symbolP->sy_flags.sy_local_symbol ? ((((struct local_symbol *) symbolP)->lsy_section == reg_section) ? (symbolP = (((struct local_symbol *) symbolP)->u.lsy_sym), 0) : 1) : 0))
    {
...
{
  return symbol_new ("L0\001", seg, ofs, frag);
}
...
symbol_find_exact_noref (const char *name, int noref)
{
  ...
  if (locsym != 
# 721 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
               ((void *)0)
# 721 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                   )
...
symbol_find_noref (const char *name, int noref)
{
  symbolS * result;
  char * copy = 
# 747 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
               ((void *)0)
# 747 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                   ;
# 756 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
  if (! symbols_case_sensitive)
    {
      const char *orig;
      char *copy2 = 
# 759 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                   ((void *)0)
# 759 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                       ;
      unsigned char c;

      orig = name;
      if (copy != 
# 763 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                 ((void *)0)
# 763 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                     )
 copy2 = copy;
 ...
 *copy++ = _sch_toupper[(c) & 0xff];
      *copy = '\0';
      ...
      if (copy2 != 
# 771 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                  ((void *)0)
# 771 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                      )
 free (copy2);
      copy = (char *) name;
    }
  ...
  if (copy != 
# 777 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
             ((void *)0)
# 777 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                 )
    free (copy);
  return result;
}
# 790 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
void
symbol_append (symbolS *addme, symbolS *target,
        symbolS **rootPP, symbolS **lastPP)
{
  if ((addme->sy_flags.sy_local_symbol ? ((((struct local_symbol *) addme)->lsy_section == reg_section) ? (addme = (((struct local_symbol *) addme)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 795, __PRETTY_FUNCTION__);
  if (target != 
# 796 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
               ((void *)0) 
# 796 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                    && (target->sy_flags.sy_local_symbol ? ((((struct local_symbol *) target)->lsy_section == reg_section) ? (target = (((struct local_symbol *) target)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 797, __PRETTY_FUNCTION__);

  if (target == 
# 799 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
               ((void *)0)
# 799 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                   )
    {
      ((void) ((*rootPP == 
# 801 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
     ((void *)0)
# 801 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
     ) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 801, __PRETTY_FUNCTION__), 0)));
      ((void) ((*lastPP == 
# 802 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
     ((void *)0)
# 802 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
     ) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 802, __PRETTY_FUNCTION__), 0)));
      addme->sy_next = 
# 803 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                      ((void *)0)
# 803 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                          ;
      addme->sy_previous = 
# 804 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                          ((void *)0)
# 804 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                              ;
      *rootPP = addme;
      *lastPP = addme;
      return;
  ...
  if (target->sy_next != 
# 810 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                        ((void *)0)
# 810 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                            )
    {
    ...
    {
      ((void) ((*lastPP == target) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 816, __PRETTY_FUNCTION__), 0)));
      *lastPP = addme;
    }
...
{
  if ((symbolP->sy_flags.sy_local_symbol ? ((((struct local_symbol *) symbolP)->lsy_section == reg_section) ? (symbolP = (((struct local_symbol *) symbolP)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 833, __PRETTY_FUNCTION__);
  symbolP->sy_next = 
# 834 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                    ((void *)0)
# 834 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                        ;
  symbolP->sy_previous = 
# 835 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                        ((void *)0)
# 835 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                            ;
}
...
{
  if ((symbolP->sy_flags.sy_local_symbol ? ((((struct local_symbol *) symbolP)->lsy_section == reg_section) ? (symbolP = (((struct local_symbol *) symbolP)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 844, __PRETTY_FUNCTION__);
  ...
  if (symbolP->sy_next != 
# 856 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                         ((void *)0)
# 856 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                             )
    {
...
# 861 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                             ((void *)0)
# 861 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                 )
    {
...
{
  if ((addme->sy_flags.sy_local_symbol ? ((((struct local_symbol *) addme)->lsy_section == reg_section) ? (addme = (((struct local_symbol *) addme)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 876, __PRETTY_FUNCTION__);
  if ((target->sy_flags.sy_local_symbol ? ((((struct local_symbol *) target)->lsy_section == reg_section) ? (target = (((struct local_symbol *) target)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 878, __PRETTY_FUNCTION__);

  if (target->sy_previous != 
# 880 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                            ((void *)0)
# 880 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                )
    {
    ...
    {
      ((void) ((*rootPP == target) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 886, __PRETTY_FUNCTION__), 0)));
      *rootPP = addme;
    }
...
verify_symbol_chain (symbolS *rootP, symbolS *lastP)
{
  ...
  if (symbolP == 
# 902 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                ((void *)0)
# 902 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                    )
    return;

  for (; symbol_next (symbolP) != 
# 905 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                                 ((void *)0)
# 905 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                     ; symbolP = symbol_next (symbolP))
    {
      ((void) ((symbolP->bsym != 
# 907 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
     ((void *)0)
# 907 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
     ) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 907, __PRETTY_FUNCTION__), 0)));
      ((void) ((symbolP->sy_flags.sy_local_symbol == 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 908, __PRETTY_FUNCTION__), 0)));
      ((void) ((symbolP->sy_next->sy_previous == symbolP) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 909, __PRETTY_FUNCTION__), 0)));
    }

  ((void) ((lastP == symbolP) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 912, __PRETTY_FUNCTION__), 0)));
}
# 978 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
static void
report_op_error (symbolS *symp, symbolS *left, operatorT op, symbolS *right)
{
  ...
  switch (op)
    {
    default:
      as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 990, __PRETTY_FUNCTION__);
      return;
...
resolve_symbol_value (symbolS *symp)
{
  ...
  if ((symp->sy_flags.sy_local_symbol ? ((((struct local_symbol *) symp)->lsy_section == reg_section) ? (symp = (((struct local_symbol *) symp)->u.lsy_sym), 0) : 1) : 0))
    {
 ...
 return final_val;
      ...
      final_val += ((locsym)->u.lsy_frag)->fr_address / (1<<0);

      if (finalize_syms)
 {
   locsym->lsy_value = final_val;
   ((locsym)->lsy_flags.sy_resolved = 1);
 }
...
# 1137 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
  else
    {
 ...
 case O_constant:
   final_val += symp->sy_frag->fr_address / (1<<0);
 ...
 case O_symbol_rva:
   ...
   if (finalize_syms)
     symp->sy_value.X_op_symbol = 
# 1178 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                                 ((void *)0)
# 1178 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                     ;

 do_symbol:
   if (S_IS_WEAKREFR (symp))
     {
       ((void) ((final_val == 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1183, __PRETTY_FUNCTION__), 0)));
       if (S_IS_WEAKREFR (add_symbol))
  {
    ((void) ((add_symbol->sy_value.X_op == O_symbol && add_symbol->sy_value.X_add_number == 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1186, __PRETTY_FUNCTION__), 0)))
                                               ;
    add_symbol = add_symbol->sy_value.X_add_symbol;
    ((void) ((! S_IS_WEAKREFR (add_symbol)) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1189, __PRETTY_FUNCTION__), 0)));
   ...
   if (finalize_syms && final_val == 0)
     {
       if ((add_symbol->sy_flags.sy_local_symbol ? ((((struct local_symbol *) add_symbol)->lsy_section == reg_section) ? (add_symbol = (((struct local_symbol *) add_symbol)->u.lsy_sym), 0) : 1) : 0))
...
# 1283 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                           ((void *)0)
# 1283 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                               , op, add_symbol);
 ...
 case O_logical_or:
  ...
  left = ~left;
     ...
     default:
       as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1441, __PRETTY_FUNCTION__);
     }
...
static void
resolve_local_symbol (const char *key __attribute__ ((__unused__)), void *value)
{
  if (value != 
# 1503 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
              ((void *)0)
# 1503 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                  )
...
# 1587 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
...
dollar_label_defined (long label)
{
  ...
  ((void) (((dollar_labels != 
# 1598 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
 ((void *)0)
# 1598 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
 ) || (dollar_label_count == 0)) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1598, __PRETTY_FUNCTION__), 0)));
...
dollar_label_instance (long label)
{
  ...
  ((void) (((dollar_labels != 
# 1613 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
 ((void *)0)
# 1613 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
 ) || (dollar_label_count == 0)) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1613, __PRETTY_FUNCTION__), 0)));
...
define_dollar_label (long label)
{
 ...
 return;
  ...
  if (dollar_labels == 
# 1647 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                      ((void *)0)
# 1647 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                          )
    {
      dollar_labels = ((long *) xmalloc (sizeof (long) * (10)));
      dollar_label_instances = ((long *) xmalloc (sizeof (long) * (10)));
    ...
    {
      dollar_label_max += 10;
      dollar_labels = ((long *) xrealloc ((void *) (dollar_labels), sizeof (long) * (dollar_label_max)));
      dollar_label_instances = ((long *) xrealloc ((void *) (dollar_label_instances), sizeof (long) * (dollar_label_max)))
                        ;
...
# 1682 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
char *
dollar_label_name (long n,
     int augend )
{
  long i;
  ...
  ((void) ((n >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1693, __PRETTY_FUNCTION__), 0)));
  ((void) ((augend == 0 || augend == 1) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1694, __PRETTY_FUNCTION__), 0)));
  p = symbol_name_build;
...
# 1746 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
static long fb_low_counter[(10)];
...
fb_label_instance_inc (long label)
{
  ...
  if (fb_labels != 
# 1774 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                  ((void *)0)
# 1774 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                      )
    {
      for (i = fb_labels + (10);
    i < fb_labels + fb_label_count; ++i)
 {
  ...
  if (fb_labels == 
# 1789 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                  ((void *)0)
# 1789 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                      )
    {
      fb_labels = ((long *) xmalloc (sizeof (long) * (((10) + 6))));
      fb_label_instances = ((long *) xmalloc (sizeof (long) * (((10) + 6))));
      fb_label_max = ((10) + 6);
      fb_label_count = (10);
    ...
    {
      fb_label_max += ((10) + 6);
      fb_labels = ((long *) xrealloc ((void *) (fb_labels), sizeof (long) * (fb_label_max)));
      fb_label_instances = ((long *) xrealloc ((void *) (fb_label_instances), sizeof (long) * (fb_label_max)));
    }
...
fb_label_instance (long label)
{
  ...
  if (fb_labels != 
# 1819 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                  ((void *)0)
# 1819 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                      )
    {
      for (i = fb_labels + (10);
    i < fb_labels + fb_label_count; ++i)
...
# 1847 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
char *
        ...
        long augend )
{
  ...
  ((void) ((n >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1858, __PRETTY_FUNCTION__), 0)));



  ((void) (((unsigned long) augend <= 1) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 1862, __PRETTY_FUNCTION__), 0)));
...
decode_local_label_name (char *s)
{
  ...
  symbol_decode = (char *) __extension__ ({ struct obstack *__h = (&notes); __extension__ ({ struct obstack *__o = (__h); size_t __len = ((strlen (message_format) + 30)); if (__extension__ ({ struct obstack const *__o1 = (__o); (size_t) (__o1->chunk_limit - __o1->next_free); }) < __len) _obstack_newchunk (__o, __len); ((void) ((__o)->next_free += (__len))); }); __extension__ ({ struct obstack *__o1 = (__h); void *__value = (void *) __o1->object_base; if (__o1->next_free == __value) __o1->maybe_empty_object = 1; __o1->next_free = ((sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (((__o1->next_free) - (sizeof (ptrdiff_t) < sizeof (void *) ? (__o1->object_base) : (char *) 0) + (__o1->alignment_mask)) & ~(__o1->alignment_mask))); if ((size_t) (__o1->next_free - (char *) __o1->chunk) > (size_t) (__o1->chunk_limit - (char *) __o1->chunk)) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; __value; }); });
...
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
...
{
  if ((dest->sy_flags.sy_local_symbol ? ((((struct local_symbol *) dest)->lsy_section == reg_section) ? (dest = (((struct local_symbol *) dest)->u.lsy_sym), 0) : 1) : 0))
    dest = local_symbol_convert ((struct local_symbol *) dest);
  if ((src->sy_flags.sy_local_symbol ? ((((struct local_symbol *) src)->lsy_section == reg_section) ? (src = (((struct local_symbol *) src)->u.lsy_sym), 0) : 1) : 0))
...
S_IS_EXTERNAL (symbolS *s)
{
  ...
  if ((flags & (1 << 0)) && (flags & (1 << 1)))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 2032, __PRETTY_FUNCTION__);
...
S_IS_COMMON (symbolS *s)
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    return 0;
  return (((s->bsym->section)->flags & 0x1000) != 0);
}
...
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    return ((struct local_symbol *) s)->lsy_section != (&_bfd_std_section[1]);
  return s->bsym->section != (&_bfd_std_section[1]);
}
# 2091 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
int
S_FORCE_RELOC (symbolS *s, int strict)
{
  ...
  return ((strict
    && ((s->bsym->flags & (1 << 7)) != 0
     ...
     && (s->bsym->flags & (1 << 1)) != 0)))
   || (s->bsym->flags & (1 << 22)) != 0
   || s->bsym->section == (&_bfd_std_section[1])
   || (((s->bsym->section)->flags & 0x1000) != 0));
}
...
S_IS_LOCAL (symbolS *s)
{
  ...
  if ((flags & (1 << 0)) && (flags & (1 << 1)))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 2129, __PRETTY_FUNCTION__);

  if (((s->bsym)->section) == reg_section)
    return 1;
  ...
  if (flag_strip_local_absolute
      ...
      && (flags & ((1 << 1) | (1 << 14))) == 0
      && ((s->bsym)->section) == (&_bfd_std_section[2]))
    return 1;

  name = S_GET_NAME (s);
  return (name != 
# 2142 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                 ((void *)0)
   
# 2143 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
  && ! S_IS_DEBUG (s)
   && (strchr (name, '\001')
       || strchr (name, '\002')
       || 0
...
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    return ((((struct local_symbol *) s)->u.lsy_frag)
...
S_SET_SEGMENT (symbolS *s, segT seg)
{
 ...
 as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 2223, __PRETTY_FUNCTION__);
    }
  else
    s->bsym->section = seg;
}
  ...
  if (s->bsym->flags & (1 << 8))
    {
      ...
      as_warn (gettext ("section symbols are already global"));
      return;
    }
...
S_SET_THREAD_LOCAL (symbolS *s)
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    s = local_symbol_convert ((struct local_symbol *) s);
  if ((((s->bsym->section)->flags & 0x1000) != 0)
      && (s->bsym->flags & (1 << 18)) != 0)
    return;
  s->bsym->flags |= (1 << 18);
  if ((s->bsym->flags & (1 << 3)) != 0)
    as_bad (gettext ("Accessing function `%s' as thread-local object"),
     S_GET_NAME (s));
  else if (! ((s->bsym->section) == (&_bfd_std_section[1]))
...
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 2403, __PRETTY_FUNCTION__);
...
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/symbols.c", 2413, __PRETTY_FUNCTION__);
  return s->sy_next;
}
...
symbol_same_p (symbolS *s1, symbolS *s2)
{
  if (s1->sy_flags.sy_local_symbol
      && (((struct local_symbol *) s1)->lsy_section == reg_section))
    s1 = (((struct local_symbol *) s1)->u.lsy_sym);
  if (s2->sy_flags.sy_local_symbol
      && (((struct local_symbol *) s2)->lsy_section == reg_section))
    s2 = (((struct local_symbol *) s2)->u.lsy_sym);
  return s1 == s2;
}
...
symbol_set_frag (symbolS *s, fragS *f)
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    {
      (((struct local_symbol *) s)->u.lsy_frag = (f));
      return;
    }
  s->sy_frag = f;
  S_CLEAR_WEAKREFR (s);
...
symbol_mark_resolved (symbolS *s)
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    {
      (((struct local_symbol *) s)->lsy_flags.sy_resolved = 1);
      return;
    }
...
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    return (((struct local_symbol *) s)->lsy_flags.sy_resolved);
...
int
symbol_section_p (symbolS *s __attribute__ ((__unused__)))
{
  if ((s->sy_flags.sy_local_symbol ? ((((struct local_symbol *) s)->lsy_section == reg_section) ? (s = (((struct local_symbol *) s)->u.lsy_sym), 0) : 1) : 0))
    return 0;
...
symbol_equated_reloc_p (symbolS *s)
{
  ...
  return (s->sy_value.X_op == O_symbol
   ...
   && ((s->sy_flags.sy_resolved && s->sy_value.X_op_symbol != 
# 2677 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                                                             ((void *)0)
# 2677 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                                                 )
       || ! S_IS_DEFINED (s)
       || S_IS_COMMON (s)));
}
...
# 2780 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
void
symbol_begin (void)
{
  symbol_lastP = 
# 2783 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                ((void *)0)
# 2783 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                    ;
  symbol_rootP = 
# 2784 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                ((void *)0)
# 2784 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                    ;
  sy_hash = hash_new ();
  local_hash = hash_new ();
...
dot_symbol_init (void)
{
  ...
  if (dot_symbol.bsym == 
# 2803 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                        ((void *)0)
# 2803 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                            )
    as_fatal ("bfd_make_empty_symbol: %s", bfd_errmsg (bfd_get_error ()));
...
print_symbol_value_1 (FILE *file, symbolS *sym)
{
  ...
  if (!name || !name[0])
    name = "(unnamed)";
  fprintf (file, "sym ");
  fprintf (file, "%016" "l" "x", (bfd_vma) ((bfd_hostptr_t) sym));
  fprintf (file, " %s", name);

  if ((sym->sy_flags.sy_local_symbol ? ((((struct local_symbol *) sym)->lsy_section == reg_section) ? (sym = (((struct local_symbol *) sym)->u.lsy_sym), 0) : 1) : 0))
    {
      struct local_symbol *locsym = (struct local_symbol *) sym;

      if (((locsym)->u.lsy_frag) != & zero_address_frag
   && ((locsym)->u.lsy_frag) != 
# 2831 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                                       ((void *)0)
# 2831 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                                           )
 {
   fprintf (file, " frag ");
   fprintf (file, "%016" "l" "x", (bfd_vma) ((bfd_hostptr_t) ((locsym)->u.lsy_frag)));
        }
      if (((locsym)->lsy_flags.sy_resolved))
 ...
 {
   fprintf (file, " frag ");
   fprintf (file, "%016" "l" "x", (bfd_vma) ((bfd_hostptr_t) sym->sy_frag));
 }
 ...
 fprintf (file, " defined");
  ...
  fprintf (file, " %s", ((void) stdoutput, (S_GET_SEGMENT (sym))->name));
...
# 2901 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
                       stderr
# 2901 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                             , sym);
  fprintf (
# 2902 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
          stderr
# 2902 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                , "\n");
}
...
{
  fprintf (file, "expr ");
  fprintf (file, "%016" "l" "x", (bfd_vma) ((bfd_hostptr_t) exp));
  fprintf (file, " ");
  switch (exp->X_op)
    {
    case O_illegal:
 ...
 fprintf (file, "\n%*s%lx", indent_level * 4, "",
  ...
  fflush (
# 3028 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
         stdout
# 3028 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
               );
}
...
{
  print_expr_1 (
# 3034 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
               stderr
# 3034 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                     , exp);
  fprintf (
# 3035 "/doner/binutils/binutils-53f7e8e/gas/symbols.c" 3 4
          stderr
# 3035 "/doner/binutils/binutils-53f7e8e/gas/symbols.c"
                , "\n");
}
