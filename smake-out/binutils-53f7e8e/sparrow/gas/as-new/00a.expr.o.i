# 1 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
# 28 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
# 29 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 33 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 2
...
# 38 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
make_expr_symbol (expressionS *expressionP)
{
 ...
 as_bad (gettext ("floating point number invalid"));
  ...
  n = ((struct expr_symbol_line *) xmalloc (sizeof (struct expr_symbol_line)));
  n->sym = symbolP;
...
# 127 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                                  ((void *)0)
# 127 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                                      ; l = l->next)
    {
      if (l->sym == sym)
 {
...
# 152 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
symbolS *
...
# 183 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
{
  valueT number =
    ((((((((valueT) generic_bignum[3] & (0xFFFF))
   << (16))
  | ((valueT) generic_bignum[2] & (0xFFFF)))
 << (16))
       | ((valueT) generic_bignum[1] & (0xFFFF)))
      << (16))
     | ((valueT) generic_bignum[0] & (0xFFFF)));
  return number;
}
...
integer_constant (int radix, expressionS *expressionP)
{
  char *start;
  char *suffix = 
# 251 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                ((void *)0)
# 251 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                    ;
  char c;
  valueT number;
  short int digit;
  ...
  int small;
# 286 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
      ...
      if (suffix == input_line_pointer)
 {
   radix = 10;
   suffix = 
# 308 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
           ((void *)0)
# 308 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
               ;
 }
      else
 {
   ...
   if ((0 && 1 ? *suffix : c) == 'B')
   ...
   else
     {
       radix = 10;
       suffix = 
# 333 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
               ((void *)0)
# 333 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                   ;
     }
 }
    }
  ...
  if (radix == 16 && c == '_')
    {
      ...
      ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 378, __PRETTY_FUNCTION__), 0)));
      ...
      for (c = '_'; c == '_'; num_little_digits += 2)
 {
   ...
   ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 400, __PRETTY_FUNCTION__), 0)));
 ...
 num_little_digits = (20) - 1;
      ...
      ((void) ((num_little_digits >= 4) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 416, __PRETTY_FUNCTION__), 0)));
      ...
      for (; (carry = ((unsigned int) _hex_value[(unsigned char) (c)])) < maxdig; c = *input_line_pointer++)
 {
       ...
       if (leader < generic_bignum + (20) - 1)
  {
    ...
    *++leader = carry;
      ...
      ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 484, __PRETTY_FUNCTION__), 0)));
      ...
      else
 {
  ...
  if ((0 || 0)
      && suffix != 
# 507 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                  ((void *)0)
      
# 508 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
      ...
      if (1 && c == 'b')
 {
   ...
   if ((symbolP != 
# 543 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                  ((void *)0)
# 543 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                      ) && (S_IS_DEFINED (symbolP)))
     {


       ((void) ((( (S_GET_SEGMENT (symbolP)) != (&_bfd_std_section[2]) && (S_GET_SEGMENT (symbolP)) != (&_bfd_std_section[1]) && (S_GET_SEGMENT (symbolP)) != reg_section && (S_GET_SEGMENT (symbolP)) != expr_section)) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 547, __PRETTY_FUNCTION__), 0)));
      ...
      else if (1 && c == 'f')
 {
   ...
   ((void) ((S_GET_SEGMENT (symbolP) == (&_bfd_std_section[1]) || S_GET_SEGMENT (symbolP) == text_section || S_GET_SEGMENT (symbolP) == data_section) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 579, __PRETTY_FUNCTION__), 0)));
   ...
   if (dollar_label_defined ((long) number))
     {
       ...
       symbolP = symbol_find (name);
       ((void) ((symbolP != 
# 596 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
      ((void *)0)
# 596 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
      ) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 596, __PRETTY_FUNCTION__), 0)));
     }
   else
     {
...
mri_char_constant (expressionS *expressionP)
{
 ...
 generic_bignum[j] = generic_bignum[i + j];
  ...
  ((void) (((16) == 16) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 690, __PRETTY_FUNCTION__), 0)));
  if (i > 2)
    {
      expressionP->X_op = O_big;
...
# 738 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
static segT
operand (expressionS *expressionP, enum expr_mode mode)
{
  ...
  switch (c)
   ...
   expressionP);
      break;
# 796 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
    case '0':
 ...
 case 'f':
   if (1)
    ...
    && strchr (FLT_CHARS, 'f') != 
# 899 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                                 ((void *)0)
# 899 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                                     )
  {
 ...
 input_line_pointer++;
      ...
      return segment;
# 993 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
    case '\'':
      if (! 0)
 {
   ...
   break;
      ...
      break;
# 1015 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
    case '~':
  ...
  expressionP->X_add_number = 0;
   ...
   as_warn (gettext ("Unary operator %c ignored because bad operand follows"),
     c);
      ...
      break;
# 1140 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
    case '.':
     ...
     && ! ( lex_type[(unsigned char) (input_line_pointer[7])] & (1) )))
 {
   ...
   if (*input_line_pointer != '(')
   ...
   else
     {
       ...
       (char *) 
# 1168 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
               ((void *)0)
# 1168 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                   );
      ...
      else
 {
   goto isname;
    ...
    eol:
      ...
      input_line_pointer--;
      break;
# 1229 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
    default:
 ...
 isname:
   ...
   {
     operatorT op = i386_operator (name, 1, &c);
...
# 1271 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                            ((void *)0)
# 1271 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                                ;
  expressionP->X_add_number = 0;
  expressionP->X_op = op;
  break;
...
# 1325 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
   symbolP = symbol_find_or_make (name);
      ...
      else
 {
  ...
  ((void) ((*input_line_pointer != ' ') ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1375, __PRETTY_FUNCTION__), 0)));
...
# 1409 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
static void
clean_up_expression (expressionS *expressionP)
{
  switch (expressionP->X_op)
    ...
    case O_register:
      expressionP->X_add_symbol = 
# 1421 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                                 ((void *)0)
# 1421 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                                     ;
    ...
    case O_bit_not:
      expressionP->X_op_symbol = 
# 1426 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                                ((void *)0)
# 1426 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                                    ;
      break;
    default:
      break;
...
# 1461 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
# 1505 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
# 1547 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
void
...
{
  ((void) ((op >= O_md1 && op < (sizeof (op_rank) / sizeof ((op_rank)[0]))) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1567, __PRETTY_FUNCTION__), 0)));
  op_rank[op] = rank;
}
...
expr_begin (void)
{
...

  {
    expressionS e;
    e.X_op = O_max;
    ((void) ((e.X_op == O_max) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1582, __PRETTY_FUNCTION__), 0)));
  }
}
...
operatorf (int *num_chars)
{
      ...
      if (ret == O_illegal)
 {
   ...
   ret = i386_operator (
# 1639 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                     ((void *)0)
# 1639 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                         , 2, 
# 1639 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                              ((void *)0)
# 1639 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
      ...
      enum expr_mode mode )
{
  ...
  ((void) ((rankarg >= 0) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1776, __PRETTY_FUNCTION__), 0)));
  ...
  ((void) ((*input_line_pointer != ' ') ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1788, __PRETTY_FUNCTION__), 0)));
      ...
      if (right.X_op == O_absent)
 {
   ...
   right.X_add_symbol = 
# 1805 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                       ((void *)0)
# 1805 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                           ;
   right.X_op_symbol = 
# 1806 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                      ((void *)0)
# 1806 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                          ;
 }

      ((void) ((*input_line_pointer != ' ') ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1809, __PRETTY_FUNCTION__), 0)));
      ...
      if (op_left == O_index)
 {
   if (*input_line_pointer != ']')
   ...
   else
     {
      ...
      ((void) ((op_right == O_illegal || op_left == O_index || op_rank[(int) op_right] <= op_rank[(int) op_left]) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1824, __PRETTY_FUNCTION__), 0)))
                                                          ;
      ((void) (((int) op_left >= (int) O_multiply) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1826, __PRETTY_FUNCTION__), 0)));



      ((void) (((int) op_left < (int) O_max) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 1830, __PRETTY_FUNCTION__), 0)));
...
# 1846 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                          ((void *)0)
# 1846 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                              ;
   resultP->X_op_symbol = 
# 1847 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                         ((void *)0)
# 1847 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                             ;
 }
      if (right.X_op == O_big)
 {
   ...
   right.X_add_number = 0;
   right.X_add_symbol = 
# 1857 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                       ((void *)0)
# 1857 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                           ;
   right.X_op_symbol = 
# 1858 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
                      ((void *)0)
# 1858 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
                          ;
 }
# 1873 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
...
# 1933 "/doner/binutils/binutils-53f7e8e/gas/expr.c" 3 4
      ((void *)0)
# 1933 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
          , 0);
...
# 2187 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
      frag_off = 0;
      if (!(seg_left == (&_bfd_std_section[2])
 ...
 default: as_abort ("/doner/binutils/binutils-53f7e8e/gas/expr.c", 2304, __PRETTY_FUNCTION__);
 }
...
# 2344 "/doner/binutils/binutils-53f7e8e/gas/expr.c"
char
get_symbol_name (char ** ilp_return)
{
  ...
  * ilp_return = input_line_pointer;
  ...
  if (( lex_type[(unsigned char) (c = *input_line_pointer++)] & (2) ) || c == '\001')
    {
