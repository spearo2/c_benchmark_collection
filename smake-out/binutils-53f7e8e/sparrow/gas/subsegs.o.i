# 1 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
# 23 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
...
# 24 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 2
...
subsegs_begin (void)
{
  ...
  frchain_now = 
# 43 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
               ((void *)0)
# 43 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                   ;
  frag_now = &dummy_frag;
}
# 57 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
void
subseg_change (segT seg, int subseg)
{
  segment_info_type *seginfo = ((segment_info_type *) ((void) stdoutput, (seg)->userdata));
  now_seg = seg;
  now_subseg = subseg;

  if (! seginfo)
    {
      seginfo = ((segment_info_type *) xcalloc (1, sizeof (segment_info_type)));
...
subseg_set_rest (segT seg, subsegT subseg)
{
  ...
  mri_common_symbol = 
# 80 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
                     ((void *)0)
# 80 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                         ;

  if (frag_now && frchain_now)
    frchain_now->frch_frag_now = frag_now;

  ((void) ((frchain_now == 0 || frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/subsegs.c", 85, __PRETTY_FUNCTION__), 0)))
                                         ;

  subseg_change (seg, (int) subseg);

  seginfo = ((segment_info_type *) ((void) stdoutput, (seg)->userdata));



  for (frcP = *(lastPP = &seginfo->frchainP);
       frcP != 
# 95 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
              ((void *)0)
# 95 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                  ;
  ...
  if (frcP == 
# 100 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
             ((void *)0) 
# 100 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                  || frcP->frch_subseg != subseg)
    {
      ...
      newP->fix_root = 
# 106 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
                      ((void *)0)
# 106 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                          ;
      newP->fix_tail = 
# 107 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
                      ((void *)0)
# 107 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                          ;
      ...
      newP->frch_cfi_data = 
# 114 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
                           ((void *)0)
# 114 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                               ;
  ...
  ((void) ((frchain_now->frch_last == frag_now) ? 0 : (as_abort ("/doner/binutils/binutils-53f7e8e/gas/subsegs.c", 126, __PRETTY_FUNCTION__), 0)));
}
# 144 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
segT
subseg_get (const char *segname, int force_new)
{
  ...
  seginfo = ((segment_info_type *) ((void) stdoutput, (secptr)->userdata));
  if (! seginfo)
    {
...
subseg_set (segT secptr, subsegT subseg)
{
  if (! (secptr == now_seg && subseg == now_subseg))
    subseg_set_rest (secptr, subseg);
  mri_common_symbol = 
# 202 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
                     ((void *)0)
# 202 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                         ;
}
...
section_symbol (segT sec)
{
  ...
  if (seginfo == 0)
    as_abort ("/doner/binutils/binutils-53f7e8e/gas/subsegs.c", 216, __PRETTY_FUNCTION__);
  if (seginfo->sym)
    return seginfo->sym;
  ...
  if (! 1 || symbol_table_frozen)
  ...
  else
    {
      ...
      if (s == 
# 235 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
              ((void *)0)
   
# 236 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
...
{
  return (((void) stdoutput, (sec)->flags) & 0x010) != 0;
}
...
subsegs_print_statistics (FILE *file)
{
  ...
  if (stdoutput == 
# 301 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c" 3 4
                  ((void *)0)
# 301 "/doner/binutils/binutils-53f7e8e/gas/subsegs.c"
                      )
    return;
  ...
  for (s = stdoutput->sections; s; s = s->next)
    {
      ...
      if (((void) stdoutput, (s)->name)[0] == '*')
 continue;

      seginfo = ((segment_info_type *) ((void) stdoutput, (s)->userdata));
      if (!seginfo)
 continue;
