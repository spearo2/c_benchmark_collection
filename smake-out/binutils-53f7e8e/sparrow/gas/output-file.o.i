# 1 "/doner/binutils/binutils-53f7e8e/gas/output-file.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gas/output-file.c"
# 21 "/doner/binutils/binutils-53f7e8e/gas/output-file.c"
...
# 22 "/doner/binutils/binutils-53f7e8e/gas/output-file.c" 2
...
# 23 "/doner/binutils/binutils-53f7e8e/gas/output-file.c" 2
...
output_file_close (const char *filename)
{
  ...
  if (stdoutput == 
# 57 "/doner/binutils/binutils-53f7e8e/gas/output-file.c" 3 4
                  ((void *)0)
# 57 "/doner/binutils/binutils-53f7e8e/gas/output-file.c"
                      )
    return;
  ...
  stdoutput = 
# 68 "/doner/binutils/binutils-53f7e8e/gas/output-file.c" 3 4
             ((void *)0)
# 68 "/doner/binutils/binutils-53f7e8e/gas/output-file.c"
                 ;

  if (! res)
    as_fatal (gettext ("can't close %s: %s"), filename,
