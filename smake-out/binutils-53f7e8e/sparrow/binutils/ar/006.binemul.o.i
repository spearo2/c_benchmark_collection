# 1 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c"
# 22 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c"
# 1 "/doner/binutils/binutils-53f7e8e/binutils/binemul.h" 1
# 25 "/doner/binutils/binutils-53f7e8e/binutils/binemul.h"
...
# 26 "/doner/binutils/binutils-53f7e8e/binutils/binemul.h" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 27 "/doner/binutils/binutils-53f7e8e/binutils/binemul.h" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/binutils/binemul.h" 2
...
# 23 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c" 2
  ...
  bfd_boolean verbose, bfd_boolean flatten)
{
  if (bin_vanilla_emulation.ar_append)
    return bin_vanilla_emulation.ar_append (after_bfd, file_name, target,
       verbose, flatten);
...
# 70 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c" 3 4
                                                       ((void *)0)
# 70 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c"
                                                           );
           elt;
           elt = bfd_openr_next_archived_file (new_bfd, elt))
        {
          if (do_ar_emul_append (after_bfd, elt, verbose, 1, check))
            {
              added = 1;
   ...
   bfd_boolean flatten)
{
  ...
  do { if ((new_bfd) == 
# 103 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c" 3 4
 ((void *)0)
# 103 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c"
   ...
   bfd_boolean verbose)
{
  if (bin_vanilla_emulation.ar_replace)
    return bin_vanilla_emulation.ar_replace (after_bfd, file_name,
        target, verbose);
    ...
    const char *target, bfd_boolean verbose)
{
  ...
  new_bfd = bfd_openr (file_name, target);
  do { if ((new_bfd) == 
# 125 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c" 3 4
 ((void *)0)
# 125 "/doner/binutils/binutils-53f7e8e/binutils/binemul.c"
 ) bfd_fatal (file_name); } while (0);
