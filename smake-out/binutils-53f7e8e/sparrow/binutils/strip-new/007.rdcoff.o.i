# 1 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
# 24 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
...
# 25 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
# 1 "../bfd/bfd.h" 1
# 43 "../bfd/bfd.h"
...
# 26 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
...
# 35 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 2
# 48 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
struct coff_symbols
{
...
coff_get_slot (struct coff_types *types, long indx)
{
  ...
  while (indx >= (16))
    {
      if (*pps == 
# 120 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                 ((void *)0)
# 120 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                     )
 {
  ...
  if (*pps == 
# 129 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
             ((void *)0)
# 129 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                 )
    {
      *pps = (struct coff_slots *) xmalloc (sizeof **pps);
      memset (*pps, 0, sizeof **pps);
...
# 164 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                                                                 ((void *)0)
# 164 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                                                                     ,
        0);
 }
      else if ((((unsigned long) (ntype) & (((abfd)->tdata.coff_obj_data)->local_n_tmask)) == ((unsigned long) (3) << (((abfd)->tdata.coff_obj_data)->local_n_btshft))))
 {
   ...
   if (pauxent == 
# 171 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                 ((void *)0)
# 171 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                     )
     n = 0;
   else
     {
...
# 197 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
            ((void *)0)
# 197 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                , dhandle),
     0, n - 1, 0);
 }
      else
 {
   ...
   return ((debug_type) 
# 203 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
         ((void *)0)
# 203 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
         );
 }
  ...
  if (pauxent != 
# 209 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                ((void *)0) 
# 209 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                     && pauxent->x_sym.x_tagndx.l > 0)
    {
      debug_type *slot;
      ...
      if (*slot != ((debug_type) 
# 216 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                  ((void *)0)
# 216 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                  ))
 return *slot;
      else
 return debug_make_indirect_type (dhandle, slot, (const char *) 
# 219 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                                                               ((void *)0)
# 219 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                                                                   );
    }
  ...
  if (! useaux)
    pauxent = 
# 229 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
             ((void *)0)
# 229 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                 ;
        ...
        union internal_auxent *pauxent, void *dhandle)
{
  ...
  if (ntype >= 0
      && ntype <= (16)
      && types->basic[ntype] != ((debug_type) 
# 249 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                               ((void *)0)
# 249 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                               ))
    return types->basic[ntype];

  set_basic = 1;
  name = 
# 253 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
        ((void *)0)
# 253 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
            ;
  ...
  switch (ntype)
    ...
    case 8:
      if (pauxent == 
# 324 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                    ((void *)0)
# 324 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                        )
 ret = debug_make_struct_type (dhandle, 1, 0,
          (debug_field *) 
# 326 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                         ((void *)0)
# 326 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                             );
      else
 ret = parse_coff_struct_type (abfd, symbols, types, ntype, pauxent,
    ...
    case 9:
      if (pauxent == 
# 338 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                    ((void *)0)
# 338 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                        )
 ret = debug_make_struct_type (dhandle, 0, 0, (debug_field *) 
# 339 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                                                                 ((void *)0)
# 339 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                                                                     );
      else
 ret = parse_coff_struct_type (abfd, symbols, types, ntype, pauxent,
          dhandle);
    ...
    case 10:
      if (pauxent == 
# 351 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                    ((void *)0)
# 351 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                        )
 ret = debug_make_enum_type (dhandle, (const char **) 
# 352 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                                                     ((void *)0)
# 352 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                                                         ,
        (bfd_signed_vma *) 
# 353 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                          ((void *)0)
# 353 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                              );
      else
 ret = parse_coff_enum_type (abfd, symbols, types, pauxent, dhandle);
  ...
  if (name != 
# 364 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
             ((void *)0)
# 364 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                 )
   ...
   union internal_auxent *pauxent, void *dhandle)
{
      ...
      if (! bfd_coff_get_syment (abfd, sym, &syment))
 {
   ...
   return ((debug_type) 
# 412 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
         ((void *)0)
# 412 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
         );
 }
 ...
 psubaux = 
# 421 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
          ((void *)0)
# 421 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
              ;
      else
 {
   if (! bfd_coff_get_auxent (abfd, sym, 0, &auxent))
    ...
    bfd_errmsg (bfd_get_error ()));
       return ((debug_type) 
# 428 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
             ((void *)0)
# 428 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
             );
     }
   psubaux = &auxent;
 }
      ...
      if (! done)
 {
   ...
   if (f == ((debug_field) 
# 460 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
           ((void *)0)
# 460 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
           ))
     return ((debug_type) 
# 461 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
           ((void *)0)
# 461 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
           );
...
# 475 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                 ((void *)0)
# 475 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                 );
        ...
        union internal_auxent *pauxent, void *dhandle)
{
      ...
      if (! bfd_coff_get_syment (abfd, sym, &syment))
 {
   non_fatal (gettext ("bfd_coff_get_syment failed: %s"),
       bfd_errmsg (bfd_get_error ()));
   return ((debug_type) 
# 517 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
         ((void *)0)
# 517 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
         );
 }
 ...
 case 102:
  ...
  names[count] = 
# 546 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                ((void *)0)
# 546 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                    ;
     ...
     debug_type type, bfd_boolean within_function)
{
 ...
 return 0;
    ...
    case 13:
      ...
      if (type == ((debug_type) 
# 611 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                 ((void *)0)
# 611 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                 ))
 return 0;
      break;
 ...
 if (type == ((debug_type) 
# 622 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
            ((void *)0)
# 622 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
            ))
   return 0;
...
parse_coff (bfd *abfd, asymbol **syms, long symcount, void *dhandle)
{
  ...
  types.slots = 
# 678 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
               ((void *)0)
# 678 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                   ;
  for (i = 0; i <= (16); i++)
    types.basic[i] = ((debug_type) 
# 680 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                    ((void *)0)
# 680 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                    );

  next_c_file = -1;
  fnname = 
# 683 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
          ((void *)0)
# 683 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
              ;
  fnclass = 0;
  fntype = 0;
  fnend = 0;
  linenos = 
# 687 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
           ((void *)0)
# 687 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
               ;
  within_function = 0;
      ...
      if (! bfd_coff_get_syment (abfd, sym, &syment))
 {
   ...
   return 0;
      ...
      if (syment.n_numaux == 0)
 paux = 
# 718 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
       ((void *)0)
# 718 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
           ;
      else
 {
   if (! bfd_coff_get_auxent (abfd, sym, 0, &auxent))
 ...
 case 2:
  ...
  fnend = 0;
   ...
   if (type == ((debug_type) 
# 778 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
              ((void *)0)
# 778 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
              ))
     return 0;
 ...
 case 101:
   if (strcmp (name, ".bf") == 0)
     {
       if (fnname == 
# 788 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                    ((void *)0)
# 788 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                        )
  {
    ...
    return 0;
       ...
       if (type == ((debug_type) 
# 797 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                  ((void *)0)
# 797 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                  ))
  return 0;
  ...
  return 0;
       ...
       if (linenos != 
# 805 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                     ((void *)0)
# 805 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                         )
  {
    int base;
    bfd_vma addr;
   ...
   return 0;
       ...
       fnname = 
# 829 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
               ((void *)0)
# 829 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                   ;
       linenos = 
# 830 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
                ((void *)0)
# 830 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
                    ;
       fnclass = 0;
       fntype = 0;
 ...
 default:
   type = parse_coff_type (abfd, &symbols, &types, this_coff_symno,
      syment.n_type, paux, 1, dhandle);
   if (type == ((debug_type) 
# 870 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c" 3 4
              ((void *)0)
# 870 "/doner/binutils/binutils-53f7e8e/binutils/rdcoff.c"
              ))
     return 0;
   if (! parse_coff_symbol (abfd, &types, sym, this_coff_symno, &syment,
       dhandle, type, within_function))
