# 1 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
# 21 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
...
# 22 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 2
# 1 "./../zlib/zlib.h" 1
# 34 "./../zlib/zlib.h"
# 1 "./../zlib/zconf.h" 1
# 247 "./../zlib/zconf.h"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 23 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 2




# 29 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
static bfd_boolean
       ...
       bfd_size_type uncompressed_size)
{
  z_stream strm;
  int rc;
# 45 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
  memset (& strm, 0, sizeof strm);
  strm.avail_in = compressed_size;
  strm.next_in = (Bytef*) compressed_buffer;
  strm.avail_out = uncompressed_size;

  do { if (!(0 == 0)) bfd_assert("/doner/binutils/binutils-53f7e8e/bfd/compress.c",50); } while (0);
  rc = inflateInit_((&strm), "1.2.10", (int)sizeof(z_stream));
...
# 75 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
...
# 87 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                                                          ((void *)0)
# 87 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                                                              );
 ...
 _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/compress.c", 102, __PRETTY_FUNCTION__);
      ...
      else
 {
  ...
  if (buffer == 
# 139 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
               ((void *)0)
# 139 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                   )
    return 0;
...
# 222 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
bfd_boolean
bfd_get_full_section_contents (bfd *abfd, sec_ptr sec, bfd_byte **ptr)
{
  ...
  if (sz == 0)
    {
      *ptr = 
# 239 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
            ((void *)0)
# 239 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                ;
      return 1;
    }
  ...
  switch (sec->compress_status)
    ...
    case 0:
      if (p == 
# 246 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
              ((void *)0)
# 246 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                  )
 {
   p = (bfd_byte *) bfd_malloc (sz);
   if (p == 
# 249 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
           ((void *)0)
# 249 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
               )
     {
...
# 273 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                              ((void *)0)
# 273 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                                  )
 return 0;
 ...
 goto fail_compressed;
      ...
      if (p == 
# 292 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
              ((void *)0)
# 292 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                  )
 p = (bfd_byte *) bfd_malloc (sz);
      if (p == 
# 294 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
              ((void *)0)
# 294 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                  )
 goto fail_compressed;
 ...
 fail_compressed:
   ...
   return 0;
    ...
    case 1:
      if (sec->contents == 
# 318 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                          ((void *)0)
# 318 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                              )
 return 0;
      if (p == 
# 320 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
              ((void *)0)
# 320 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
                  )
 {
   p = (bfd_byte *) bfd_malloc (sz);
   if (p == 
# 323 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
           ((void *)0)
# 323 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
               )
     return 0;
   *ptr = p;
 }
 ...
 memcpy (p, sec->contents, sz);
    ...
    default:
      _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/compress.c", 333, __PRETTY_FUNCTION__);
    }
}
# 350 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
void
...
# 377 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
bfd_boolean
           ...
           bfd_size_type *uncompressed_size_p)
{
  ...
  if (compression_header_size > 24)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/compress.c", 390, __PRETTY_FUNCTION__);
...
# 447 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
bfd_boolean
...
# 476 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
bfd_boolean
bfd_init_section_decompress_status (bfd *abfd, sec_ptr sec)
{
  ...
  compression_header_size = bfd_get_compression_header_size (abfd, sec);
  if (compression_header_size > 24)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/compress.c", 486, __PRETTY_FUNCTION__);
  header_size = compression_header_size ? compression_header_size : 12;


  if (sec->rawsize != 0
      || sec->contents != 
# 491 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                         ((void *)0)
      
# 492 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
     || sec->compress_status != 0
...
# 540 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
bfd_boolean
bfd_init_section_compress_status (bfd *abfd, sec_ptr sec)
{
  ...
  if (abfd->direction != read_direction
      ...
      || sec->rawsize != 0
      || sec->contents != 
# 551 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                         ((void *)0)
      
# 552 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
     || sec->compress_status != 0)
    {
      bfd_set_error (bfd_error_invalid_operation);
      return 0;
...
# 591 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
bfd_boolean
bfd_compress_section (bfd *abfd, sec_ptr sec, bfd_byte *uncompressed_buffer)
{
  ...
  if (abfd->direction != write_direction
      || uncompressed_size == 0
      || uncompressed_buffer == 
# 599 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                               ((void *)0)
      
# 600 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
     || sec->contents != 
# 600 "/doner/binutils/binutils-53f7e8e/bfd/compress.c" 3 4
                         ((void *)0)
      
# 601 "/doner/binutils/binutils-53f7e8e/bfd/compress.c"
