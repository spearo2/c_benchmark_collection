# 1 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
# 69 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
...
# 70 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 2
...
# 71 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 72 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 2
...
# 73 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 2
...
# 203 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
static void
tekhex_init (void)
{
  unsigned int i;
...
# 238 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
  ...
  if (!d && create)
    {
      ...
      if (!d)
 return 
# 331 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
       ((void *)0)
# 331 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
           ;
...
first_phase (bfd *abfd, int type, char *src, char * src_end)
{
 ...
 return 0;
      ...
      if (section == 
# 388 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                    ((void *)0)
# 388 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                        )
 {
   ...
   if (section == 
# 396 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                 ((void *)0)
# 396 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                     )
     return 0;
 }
      alt_section = 
# 399 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                   ((void *)0)
# 399 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                       ;
  ...
  if (stype == '2' || stype == '6')
  ...
  else if (stype == '3' || stype == '7')
    {
      if ((section->flags & 0x020) == 0)
        ...
        {
   if (alt_section == 
# 461 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 461 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         )
     alt_section
       = bfd_get_next_section_by_name (
# 463 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                                      ((void *)0)
# 463 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                                          , section);
   if (alt_section == 
# 464 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 464 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         )
     alt_section = bfd_make_section_anyway_with_flags
       (abfd, section->name,
        (section->flags & ~0x020) | 0x010);
   if (alt_section == 
# 468 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 468 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         )
     return 0;
   new_symbol->symbol.section = alt_section;
  ...
  else if (stype == '4' || stype == '8')
    {
      if ((section->flags & 0x010) == 0)
        ...
        {
   if (alt_section == 
# 479 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 479 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         )
     alt_section
       = bfd_get_next_section_by_name (
# 481 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                                      ((void *)0)
# 481 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                                          , section);
   if (alt_section == 
# 482 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 482 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         )
     alt_section = bfd_make_section_anyway_with_flags
       (abfd, section->name,
        (section->flags & ~0x010) | 0x020);
   if (alt_section == 
# 486 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 486 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         )
     return 0;
   new_symbol->symbol.section = alt_section;
        }
...
# 515 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                                   0
# 515 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                                           ) != 0)
    return 0;
  while (! is_eof)
    {
...
tekhex_mkobject (bfd *abfd)
{
  ...
  tdata->type = 1;
  tdata->head = 
# 590 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                ((void *)0)
# 590 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                    ;
  tdata->symbols = 
# 591 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                  ((void *)0)
# 591 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                      ;
  tdata->data = 
# 592 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
               ((void *)0)
# 592 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                   ;
  return 1;
}
...
tekhex_object_p (bfd *abfd)
{
  ...
  if (bfd_seek (abfd, (file_ptr) 0, 
# 606 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                                   0
# 606 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                                           ) != 0
      || bfd_bread (b, (bfd_size_type) 4, abfd) != 4)
    return 
# 608 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
          ((void *)0)
# 608 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
              ;
  ...
  if (b[0] != '%' || !(((unsigned int) _hex_value[(unsigned char) (b[1])]) != 99) || !(((unsigned int) _hex_value[(unsigned char) (b[2])]) != 99) || !(((unsigned int) _hex_value[(unsigned char) (b[3])]) != 99))
    return 
# 611 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
          ((void *)0)
# 611 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
              ;
  ...
  if (!pass_over (abfd, first_phase))
    return 
# 616 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
          ((void *)0)
# 616 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
              ;
...
# 632 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                         ((void *)0)
# 632 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                             ;

  do { if (!(offset == 0)) bfd_assert("/doner/binutils/binutils-53f7e8e/bfd/tekhex.c",634); } while (0);
...
out (bfd *abfd, int type, char *start, char *end)
{
  ...
  if (bfd_bwrite (front, (bfd_size_type) 6, abfd) != 6)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/tekhex.c", 788, __PRETTY_FUNCTION__);
  end[0] = '\n';
  wrlen = end - start + 1;
  if (bfd_bwrite (start, wrlen, abfd) != wrlen)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/tekhex.c", 792, __PRETTY_FUNCTION__);
}
...
tekhex_write_object_contents (bfd *abfd)
{
  ...
  for (d = abfd->tdata.tekhex_data->data;
       d != 
# 807 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
           ((void *)0)
# 807 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
               ;
       d = d->next)
    {
      int low;
...
# 832 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                               ((void *)0)
# 832 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                                   ; s = s->next)
    {
      char *dst = buffer;
      ...
      for (p = abfd->outsymbols; *p; p++)
 {
  ...
  if (bfd_bwrite ("%0781010\n", (bfd_size_type) 9, abfd) != 9)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/tekhex.c", 897, __PRETTY_FUNCTION__);
  return 1;
}
...
tekhex_make_empty_symbol (bfd *abfd)
{
  ...
  if (!new_symbol)
    return 
# 916 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
          ((void *)0)
# 916 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
              ;
  new_symbol->symbol.the_bfd = abfd;
  new_symbol->prev = 
# 918 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
                     ((void *)0)
# 918 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
                         ;
...
# 989 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
...
# 1040 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
 ((void *)0)
# 1040 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
     ,

  
# 1042 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c" 3 4
 ((void *)0)

# 1043 "/doner/binutils/binutils-53f7e8e/bfd/tekhex.c"
};
