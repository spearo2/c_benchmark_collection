# 1 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
# 22 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 2
# 46 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
bfd_boolean
...
bfd_nullvoidptr (bfd *ignore __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 
# 69 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
        ((void *)0)
# 69 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
            ;
}
...
{
  *relptr = 
# 118 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
           ((void *)0)
# 118 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
               ;
  return 0;
}
...
_bfd_nocore_core_file_failing_command (bfd *ignore_abfd __attribute__ ((__unused__)))
{
  bfd_set_error (bfd_error_invalid_operation);
  return 
# 138 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
        ((void *)0)
# 138 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
            ;
}
...
bfd_malloc (bfd_size_type size)
{
  ...
  if (size != sz
      ...
      || ((signed long) sz) < 0)
    {
      ...
      return 
# 181 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0)
# 181 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                ;
    }

  ptr = malloc (sz);
  if (ptr == 
# 185 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0) 
# 185 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                 && sz != 0)
    bfd_set_error (bfd_error_no_memory);
...
bfd_malloc2 (bfd_size_type nmemb, bfd_size_type size)
{
  if ((nmemb | size) >= (((bfd_size_type) 1) << (8 * sizeof (bfd_size_type) / 2))
      ...
      && nmemb > ~(bfd_size_type) 0 / size)
    {
      bfd_set_error (bfd_error_no_memory);
      return 
# 201 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0)
# 201 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                ;
    }
...
bfd_realloc (void *ptr, bfd_size_type size)
{
  ...
  if (ptr == 
# 215 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0)
# 215 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                )
  ...
  if (size != sz
      ...
      || ((signed long) sz) < 0)
    {
      bfd_set_error (bfd_error_no_memory);
      return 
# 223 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0)
# 223 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                ;
    }
  ...
  if (ret == 
# 228 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0) 
# 228 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                 && sz != 0)
    bfd_set_error (bfd_error_no_memory);
...
bfd_realloc2 (void *ptr, bfd_size_type nmemb, bfd_size_type size)
{
  if ((nmemb | size) >= (((bfd_size_type) 1) << (8 * sizeof (bfd_size_type) / 2))
      ...
      && nmemb > ~(bfd_size_type) 0 / size)
    {
      bfd_set_error (bfd_error_no_memory);
      return 
# 244 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0)
# 244 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                ;
    }
...
bfd_realloc_or_free (void *ptr, bfd_size_type size)
{
  ...
  if (ret == 
# 258 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0) 
# 258 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                 && ptr != 
# 258 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
                           ((void *)0)
# 258 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
...
bfd_zmalloc (bfd_size_type size)
{
  ...
  if (ptr != 
# 271 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0) 
# 271 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                 && size > 0)
...
bfd_zmalloc2 (bfd_size_type nmemb, bfd_size_type size)
{
  ...
  if (ptr != 
# 285 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
            ((void *)0)
# 285 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                )
    {
...
# 309 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
bfd_boolean
...
# 485 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
bfd_vma
...
bfd_put_bits (bfd_uint64_t data, void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/libbfd.c", 738, __PRETTY_FUNCTION__);
...
bfd_get_bits (const void *p, int bits, bfd_boolean big_p)
{
  ...
  if (bits % 8 != 0)
    _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/libbfd.c", 759, __PRETTY_FUNCTION__);
...
# 812 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
                                                0
# 812 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                                                        ) != 0
...
{
# 867 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
  _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/libbfd.c", 867, __PRETTY_FUNCTION__);
       ...
       bfd_size_type count)
{
  ...
  if (bfd_seek (abfd, section->filepos + offset, 
# 885 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
                                                0
# 885 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                                                        ) != 0
...
# 904 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
unsigned int
bfd_log2 (bfd_vma x)
{
   ...
   const char *func)
{
  ...
  if (~(size_t) func & ~mask)
    {
      fflush (
# 940 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
             stdout
# 940 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                   );
 ...
 fprintf (
# 945 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
         stderr
# 945 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
               , dgettext ("bfd", "Deprecated %s called at %s line %d in %s\n"),
   what, file, line, func);
      else
 fprintf (
# 948 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
         stderr
# 948 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
               , dgettext ("bfd", "Deprecated %s called\n"), what);
      fflush (
# 949 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
             stderr
# 949 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                   );
      mask |= ~(size_t) func;
    }
}
    ...
    const bfd_byte * const end)
{
 ...
 break;
  ...
  if (length_return != 
# 1012 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c" 3 4
                      ((void *)0)
# 1012 "/doner/binutils/binutils-53f7e8e/bfd/libbfd.c"
                          )
