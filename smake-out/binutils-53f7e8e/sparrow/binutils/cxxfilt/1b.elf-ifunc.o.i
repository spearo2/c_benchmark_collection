# 1 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
# 21 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
...
# 22 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
# 23 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 25 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 2
...
_bfd_elf_create_ifunc_sections (bfd *abfd, struct bfd_link_info *info)
{
  ...
  if (htab->irelifunc != 
# 41 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                        ((void *)0) 
# 41 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                             || htab->iplt != 
# 41 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                                              ((void *)0)
# 41 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
  ...
  if ((((info)->type == type_dll) || ((info)->type == type_pie)))
    {
      ...
      s = bfd_make_section_with_flags (abfd, rel_sec,
           flags | 0x008);
      if (s == 
# 64 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 65 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
 ...
 return 0;
  ...
  else
    {
      ...
      if (s == 
# 75 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 76 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
 ...
 return 0;
     ...
     ? ".rela.iplt" : ".rel.iplt"),
           flags | 0x008);
      if (s == 
# 84 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 85 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
  || ! bfd_set_section_alignment (abfd, s,
       bed->s->log_file_align))
 return 0;
      htab->irelplt = s;
 ...
 s = bfd_make_section_with_flags (abfd, ".igot", flags);
      if (s == 
# 96 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
              ((void *)0)
   
# 97 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
  || !bfd_set_section_alignment (abfd, s,
      bed->s->log_file_align))
 return 0;
      htab->igotplt = s;
  ...
  if (need_dynreloc && h->ref_regular)
    {
      bfd_boolean keep = 0;
      for (p = *head; p != 
# 160 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                          ((void *)0)
# 160 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                              ; p = p->next)
 if (p->count)
   {
     h->non_got_ref = 1;
  ...
  if (h->plt.refcount <= 0 && h->got.refcount <= 0)
    {
      ...
      *head = 
# 183 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
             ((void *)0)
# 183 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                 ;
      return 1;
    }
  ...
  if (!h->ref_regular)
    {
      if (h->plt.refcount > 0
   || h->got.refcount > 0)
 _bfd_abort ("/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c", 193, __PRETTY_FUNCTION__);
      h->got = htab->init_got_offset;
      h->plt = htab->init_plt_offset;
      *head = 
# 196 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
             ((void *)0)
# 196 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                 ;
      return 1;
    }
...
keep:
  ...
  if (htab->splt != 
# 209 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                   ((void *)0)
# 209 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                       )
    {
      plt = htab->splt;
      gotplt = htab->sgotplt;
 ...
 plt->size += plt_header_size;
  ...
  if (!need_dynreloc || !h->non_got_ref)
    *head = 
# 252 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
           ((void *)0)
# 252 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
               ;
  ...
  p = *head;
  if (p != 
# 258 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
          ((void *)0)
# 258 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
              )
    {
   ...
   if (!readonly_dynrelocs_against_ifunc)
     {
       ...
       if (s != 
# 266 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
               ((void *)0) 
# 266 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                    && (s->flags & 0x008) != 0)
  readonly_dynrelocs_against_ifunc = 1;
   ...
   p = p->next;
      ...
      while (p != 
# 272 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                 ((void *)0)
# 272 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                     );
...
# 280 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                            ((void *)0)
# 280 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                                )
...
# 307 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
  if (use_plt
      && (h->got.refcount <= 0
   ...
   || ((info)->type == type_pie)
   || htab->sgot == 
# 315 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                   ((void *)0)
# 315 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                       ))
    {
   ...
   if (need_dynreloc)
     {
       ...
       if (htab->splt != 
# 345 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                        ((void *)0)
# 345 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                            )
   ...
   bfd_vma *(*get_plt_sym_val) (bfd *, asymbol **, asection *, asection *))
{
  ...
  *ret = 
# 382 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
        ((void *)0)
# 382 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
            ;

  if (plt == 
# 384 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
            ((void *)0)
# 384 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                )
    return 0;
  ...
  if (relplt_name == 
# 394 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                    ((void *)0)
# 394 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                        )
    relplt_name = bed->rela_plts_and_copies_p ? ".rela.plt" : ".rel.plt";
  relplt = bfd_get_section_by_name (abfd, relplt_name);
  if (relplt == 
# 397 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
               ((void *)0)
# 397 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                   )
    return 0;
      ...
      if (p->addend != 0)
 {
  ...
  if (plt_sym_val == 
# 426 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                    ((void *)0)
# 426 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                        )
    return -1;

  s = *ret = (asymbol *) bfd_malloc (size);
  if (s == 
# 430 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
          ((void *)0)
# 430 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
              )
    {
      free (plt_sym_val);
      return -1;
 ...
 s->flags |= (1 << 1);
      ...
      s->name = names;
      s->udata.p = 
# 457 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c" 3 4
                  ((void *)0)
# 457 "/doner/binutils/binutils-53f7e8e/bfd/elf-ifunc.c"
                      ;
