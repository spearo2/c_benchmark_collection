# 1 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
# 122 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
...
# 123 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 2
...
# 124 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 2
...
bfd_boolean _bfd_generic_verify_endian_match
   (bfd *ibfd, struct bfd_link_info *info);
# 125 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 2
...
# 126 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 2
...
# 127 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 2
# 142 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
...
ihex_mkobject (bfd *abfd)
{
  ...
  if (tdata == 
# 180 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
              ((void *)0)
# 180 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                  )
    return 0;

  abfd->tdata.ihex_data = tdata;
  tdata->head = 
# 184 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
               ((void *)0)
# 184 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                   ;
  tdata->tail = 
# 185 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
               ((void *)0)
# 185 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                   ;
  return 1;
}
 ...
 *errorptr = 1;
      return 
# 201 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            (-1)
# 201 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
               ;
    }
...
{
  if (c == 
# 212 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
          (-1)
# 212 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
             )
    {
      if (! error)
...
ihex_scan (bfd *abfd)
{
  ...
  bfd_boolean error;
  bfd_byte *buf = 
# 247 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                 ((void *)0)
# 247 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                     ;
  size_t bufsize;
  int c;

  if (bfd_seek (abfd, (file_ptr) 0, 
# 251 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                   0
# 251 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                           ) != 0)
    goto error_return;
  ...
  extbase = 0;
  sec = 
# 258 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
       ((void *)0)
# 258 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
           ;
  lineno = 1;
  error = 0;
  bufsize = 0;
...
# 263 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                              (-1)
# 263 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                                 )
    {
      if (c == '\r')
 continue;
   ...
   if (chars >= bufsize)
     {
       ...
       if (buf == 
# 313 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                 ((void *)0)
# 313 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                     )
  goto error_return;
       bufsize = chars;
     }
  ...
  (dgettext ("bfd", "%B:%u: bad checksum in Intel Hex file (expected %u, found %u)"),
   ...
   switch (type)
     ...
     case 0:
       ...
       if (sec != 
# 349 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                 ((void *)0)
    
# 350 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
       ...
       else if (len > 0)
  {
    ...
    if (secname == 
# 366 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                  ((void *)0)
# 366 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                      )
      goto error_return;
    ...
    if (sec == 
# 371 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
              ((void *)0)
# 371 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                  )
      goto error_return;
  ...
  abfd->start_address = addr;
       if (buf != 
# 384 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                 ((void *)0)
# 384 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                     )
  free (buf);
       return 1;
       ...
       if (len != 2)
  {
    ...
    goto error_return;
       ...
       sec = 
# 402 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 402 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
       ...
       if (len != 4)
  {
    ...
    goto error_return;
       ...
       sec = 
# 420 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 420 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
       ...
       if (len != 2)
  {
    ...
    goto error_return;
       ...
       sec = 
# 438 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 438 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
  ...
  abfd->start_address = ((((((((unsigned int) _hex_value[(unsigned char) ((buf)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf) + 2)[1])])))) << 16) + (((((((unsigned int) _hex_value[(unsigned char) ((buf + 4)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 4)[1])]))) << 8) + (((((unsigned int) _hex_value[(unsigned char) (((buf + 4) + 2)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) (((buf + 4) + 2)[1])]))));
       ...
       sec = 
# 459 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 459 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
  ...
  if (buf != 
# 477 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 477 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                )
    free (buf);
 ...
 error_return:
  if (buf != 
# 483 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 483 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                )
    free (buf);
  return 0;
}
...
ihex_object_p (bfd *abfd)
{
  ...
  if (bfd_seek (abfd, (file_ptr) 0, 
# 500 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                   0
# 500 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                           ) != 0)
    return 
# 501 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
          ((void *)0)
# 501 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
              ;
 ...
 bfd_set_error (bfd_error_wrong_format);
      return 
# 506 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 506 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
    }
  ...
  if (b[0] != ':')
    {
      bfd_set_error (bfd_error_wrong_format);
      return 
# 512 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 512 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
    }
      ...
      if (! ((((unsigned int) _hex_value[(unsigned char) (b[i])]) != 99)))
 {
   bfd_set_error (bfd_error_wrong_format);
   return 
# 520 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
         ((void *)0)
# 520 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
             ;
 }
    }
  ...
  if (type > 5)
    {
      bfd_set_error (bfd_error_wrong_format);
      return 
# 528 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 528 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
    }
...
# 535 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                                             ((void *)0)
# 535 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                                                 )
 bfd_release (abfd, abfd->tdata.any);
      abfd->tdata.any = tdata_save;
      return 
# 538 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 538 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                ;
    }
...
ihex_read_section (bfd *abfd, asection *section, bfd_byte *contents)
{
  ...
  bfd_byte *p;
  bfd_byte *buf = 
# 551 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                 ((void *)0)
# 551 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                     ;
  size_t bufsize;
  bfd_boolean error;

  if (bfd_seek (abfd, section->filepos, 
# 555 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                       0
# 555 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                               ) != 0)
    goto error_return;
  ...
  error = 0;
  while ((c = ihex_get_byte (abfd, &error)) != 
# 561 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                              (-1)
# 561 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                                 )
    {
      unsigned char hdr[8];
      unsigned int len;
 ...
 continue;
      ...
      do { if (!(c == ':')) bfd_assert("/doner/binutils/binutils-53f7e8e/bfd/ihex.c",573); } while (0);
      ...
      if (len * 2 > bufsize)
 {
   ...
   if (buf == 
# 593 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
             ((void *)0)
# 593 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                 )
     goto error_return;
   bufsize = len * 2;
 }
 ...
 *p++ = (((((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[0])])) << 4) + (((unsigned int) _hex_value[(unsigned char) ((buf + 2 * i)[1])])));
      if ((bfd_size_type) (p - contents) >= section->size)
 {
   ...
   if (buf != 
# 606 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
             ((void *)0)
# 606 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                 )
     free (buf);
   return 1;
 }
 ...
 (dgettext ("bfd", "%B: bad section length in ihex_read_section"), abfd);
  ...
  if (buf != 
# 624 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 624 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                )
    free (buf);
 ...
 error_return:
  if (buf != 
# 630 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
            ((void *)0)
# 630 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                )
    free (buf);
  return 0;
}
...
# 644 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                             ((void *)0)
# 644 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                 )
    {
      section->used_by_bfd = bfd_alloc (abfd, section->size);
      if (section->used_by_bfd == 
# 647 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                 ((void *)0)
# 647 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                     )
 return 0;
      ...
      bfd_size_type count)
{
  ...
  if (n == 
# 679 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
          ((void *)0)
# 679 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
              )
    return 0;

  data = (bfd_byte *) bfd_alloc (abfd, count);
  if (data == 
# 683 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
             ((void *)0)
# 683 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                 )
    return 0;
  ...
  if (tdata->tail != 
# 694 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                    ((void *)0)
      
# 695 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
     && n->where >= tdata->tail->where)
    {
      tdata->tail->next = n;
      n->next = 
# 698 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
               ((void *)0)
# 698 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                   ;
      tdata->tail = n;
    }
  else
    {
      ...
      for (pp = &tdata->head;
    *pp != 
# 706 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
          ((void *)0) 
# 706 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
               && (*pp)->where < n->where;
    pp = &(*pp)->next)
 ;
      n->next = *pp;
      *pp = n;
      if (n->next == 
# 711 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                    ((void *)0)
# 711 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                        )
 tdata->tail = n;
    }
...
# 773 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                            ((void *)0)
# 773 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                                ; l = l->next)
    {
      bfd_vma where;
      bfd_byte *p;
      ...
      while (count > 0)
 {
       ...
       if (where <= 0xfffff)
  {
    ...
    do { if (!(extbase == 0)) bfd_assert("/doner/binutils/binutils-53f7e8e/bfd/ihex.c",800); } while (0);
...
# 887 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
                                         ((void *)0)
# 887 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
                                             ))
    return 0;
...
# 958 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
...
# 1006 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
 ((void *)0)
# 1006 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
     ,

  
# 1008 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c" 3 4
 ((void *)0)

# 1009 "/doner/binutils/binutils-53f7e8e/bfd/ihex.c"
};
