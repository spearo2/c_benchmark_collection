# 1 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
# 16 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
# 1 "/doner/binutils/binutils-53f7e8e/libiberty/./config.h" 1
# 17 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 20 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 22 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 37 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 40 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
...
# 43 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 2
# 67 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
char *
getpwd (void)
{
  static char *pwd;
  ...
  if (!p && !(
# 77 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 3 4
             (*__errno_location ()) 
# 77 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
                   = failure_errno))
    {
      if (! ((p = getenv ("PWD")) != 0
      && *p == '/'
 ...
 for (s = (
# 87 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 3 4
         4096 
# 87 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
         + 1); !getcwd (p = ((char *) xmalloc (sizeof (char) * (s))), s); s *= 2)
   {
     int e = 
# 89 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 3 4
            (*__errno_location ())
# 89 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
                 ;
     free (p);

     if (e != 
# 92 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 3 4
             34
# 92 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
                   )

       {
  
# 95 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c" 3 4
 (*__errno_location ()) 
# 95 "/doner/binutils/binutils-53f7e8e/libiberty/./getpwd.c"
       = failure_errno = e;
  p = 0;
  break;
       }
