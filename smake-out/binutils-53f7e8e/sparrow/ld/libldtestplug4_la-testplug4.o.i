# 1 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
# 22 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 2
...
static bfd_boolean register_claimfile_hook = 1;
static bfd_boolean register_allsymbolsread_hook = 0;
static bfd_boolean register_cleanup_hook = 0;
static bfd_boolean dumpresolutions = 0;
static bfd_boolean allsymbolsread_silent = 0;


static claim_file_t *claimfiles_list = 
# 131 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
                                      ((void *)0)
# 131 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                                          ;
...
# 137 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
                                     ((void *)0)
# 137 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                                         ;


static add_file_t *addfiles_list = 
# 140 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
                                  ((void *)0)
# 140 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                                      ;
...
record_add_file (const char *file, addfile_enum_t type)
{
  ...
  if (!newfile)
    return LDPS_ERR;
  newfile->next = 
# 175 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
                 ((void *)0)
# 175 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                     ;
  newfile->name = file;
  newfile->type = type;
...
parse_symdefstr (const char *str, struct ld_plugin_symbol *sym)
{
 ...
 return LDPS_ERR;
    ...
    sym->version = 
# 242 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
                  ((void *)0)
# 242 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                      ;
  if (colon5 && colon5[1])
    {
  ...
  if (!strncmp ("fatal", opt, 5))
    {
      ...
      fflush (
# 330 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
             ((void *)0)
# 330 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                 );
    }
  else if (!strncmp ("error", opt, 5))
    {
      ...
      fflush (
# 335 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
             ((void *)0)
# 335 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                 );
    }
  else if (!strncmp ("warning", opt, 7))
    {
      ...
      fflush (
# 340 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
             ((void *)0)
# 340 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                 );
    }
    ...
    return set_register_hook (opt + 8, 1);
  else if (!strncmp ("noregister", opt, 10))
    return set_register_hook (opt + 10, 0);
...
onload (struct ld_plugin_tv *tv)
{
      ...
      if (!tv_register_claim_file)
 {
   ...
   fflush (
# 459 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
          ((void *)0)
# 459 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_all_symbols_read)
 {
   ...
   fflush (
# 469 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
          ((void *)0)
# 469 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_cleanup)
 {
   ...
   fflush (
# 479 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
          ((void *)0)
# 479 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
              );
   return LDPS_ERR;
 }
...
# 581 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
                                                               ((void *)0)
# 581 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
                                                                   ;
 ...
 return rv;
  ...
  fflush (
# 663 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
         ((void *)0)
# 663 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
             );
...
oncleanup (void)
{
  ...
  fflush (
# 672 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c" 3 4
         ((void *)0)
# 672 "/doner/binutils/binutils-53f7e8e/ld/testplug4.c"
             );
  return cleanup_ret;
}
