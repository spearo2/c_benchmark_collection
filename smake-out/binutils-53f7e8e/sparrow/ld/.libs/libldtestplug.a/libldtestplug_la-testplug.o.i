# 1 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
# 21 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
...
# 22 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 2


# 29 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
...
static bfd_boolean register_claimfile_hook = 0;
...
# 130 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                                      ((void *)0)
# 130 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                                          ;
...
# 136 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                                     ((void *)0)
# 136 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                                         ;


static add_file_t *addfiles_list = 
# 139 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                                  ((void *)0)
# 139 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                                      ;
...
record_read_length (const char *length)
{
  ...
  tmp = length;
  while (*tmp != '\0' && 
# 175 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                        ((*__ctype_b_loc ())[(int) ((
# 175 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                        *tmp
# 175 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
...
# 175 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
  ...
  if (*tmp != '\0' || *length == '\0')
    {
      fprintf (
# 179 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
              stderr
# 179 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
...
record_add_file (const char *file, addfile_enum_t type)
{
  ...
  if (!newfile)
    return LDPS_ERR;
  newfile->next = 
# 196 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                 ((void *)0)
# 196 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                     ;
  newfile->name = file;
  newfile->type = type;
...
parse_symdefstr (const char *str, struct ld_plugin_symbol *sym)
{
 ...
 return LDPS_ERR;
    ...
    sym->version = 
# 263 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                  ((void *)0)
# 263 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                      ;
  if (colon5 && colon5[1])
    {
...
onload (struct ld_plugin_tv *tv)
{
  ...
  fflush (
# 510 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
         ((void *)0)
# 510 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
             );
      ...
      if (!tv_register_claim_file)
 {
   ...
   fflush (
# 524 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
          ((void *)0)
# 524 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_all_symbols_read)
 {
   ...
   fflush (
# 534 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
          ((void *)0)
# 534 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
              );
   return LDPS_ERR;
 }
      ...
      if (!tv_register_cleanup)
 {
   ...
   fflush (
# 544 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
          ((void *)0)
# 544 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
              );
   return LDPS_ERR;
 }
  ...
  fflush (
# 549 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
         ((void *)0)
# 549 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
             );
  return onload_ret;
}
  ...
  if (bytes_to_read_before_claim > 0)
    {
      ...
      if (buffer == 
# 564 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                   ((void *)0)
# 564 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                       )
        return LDPS_ERR;
 ...
 break;
  ...
  fflush (
# 584 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
         ((void *)0)
# 584 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
             );
...
# 620 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
                                                               ((void *)0)
# 620 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
                                                                   ;
 ...
 return rv;
  ...
  fflush (
# 657 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
         ((void *)0)
# 657 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
             );
...
oncleanup (void)
{
  ...
  fflush (
# 666 "/doner/binutils/binutils-53f7e8e/ld/testplug.c" 3 4
         ((void *)0)
# 666 "/doner/binutils/binutils-53f7e8e/ld/testplug.c"
             );
  return cleanup_ret;
}
