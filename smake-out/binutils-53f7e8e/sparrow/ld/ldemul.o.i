# 1 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
# 21 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
...
# 22 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 23 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 24 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/ldemul-list.h" 1
...
# 34 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 2
...
ldemul_place_orphan (asection *s, const char *name, int constraint)
{
  ...
  return 
# 125 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 3 4
        ((void *)0)
# 125 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
            ;
}
...
# 188 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 3 4
                              ((void *)0)
# 188 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
                                  )
    return from_outside;
  return ld_emulation->target_name;
}
# 204 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
void
after_parse_default (void)
{
  if (entry_symbol.name != 
# 207 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 3 4
                          ((void *)0)
      
# 208 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
     && ((((&link_info)->type == type_pde) || ((&link_info)->type == type_pie)) || entry_from_cmdline))
    {
      bfd_boolean is_vma = 0;
...
{
  info_msg (gettext ("%S SYSLIB ignored\n"), 
# 263 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 3 4
                                     ((void *)0)
# 263 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
                                         );
}
...
{
  info_msg (gettext ("%S HLL ignored\n"), 
# 269 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 3 4
                                  ((void *)0)
# 269 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
                                      );
}

ld_emulation_xfer_type *ld_emulations[] = { &ld_elf_x86_64_emulation, &ld_elf32_x86_64_emulation, &ld_elf_i386_emulation, &ld_elf_iamcu_emulation, &ld_i386linux_emulation, &ld_elf_l1om_emulation, &ld_elf_k1om_emulation, 0 };
...
# 291 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c" 3 4
                         stderr
# 291 "/doner/binutils/binutils-53f7e8e/ld/ldemul.c"
                               );
  einfo ("%F\n");
}
