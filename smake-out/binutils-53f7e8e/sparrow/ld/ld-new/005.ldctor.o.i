# 1 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
# 22 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 24 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
# 1 "./ldgram.h" 1
# 50 "./ldgram.h"
  enum yytokentype
  {
...
int yyparse (void);
# 32 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
extern void ldctor_build_sets
  (void);
# 34 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 2
...
# 54 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
void
        ...
        bfd_vma value)
{
  ...
  for (p = sets; p != 
# 65 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                     ((void *)0)
# 65 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                         ; p = p->next)
    if (p->h == h)
      break;

  if (p == 
# 69 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
          ((void *)0)
# 69 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
              )
    {
      ...
      p->count = 0;
      p->elements = 
# 77 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                   ((void *)0)
# 77 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                       ;
    }
  else
    {
      if (p->reloc != reloc)
 {
   einfo (gettext ("%P%X: Different relocs used in set %s\n"),
   h->root.string);
   return;
 }
# 95 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
      if (p->elements != 
# 95 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                        ((void *)0)
   
# 96 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
  && section->owner != 
# 96 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                       ((void *)0)
   
# 97 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
  && p->elements->section->owner != 
# 97 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                                    ((void *)0)
   
# 98 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
  && strcmp (((section->owner)->xvec->name),
       ((p->elements->section->owner)->xvec->name)) != 0)
 {
   einfo (gettext ("%P%X: Different object file formats composing set %s\n"),
   h->root.string);
   return;
 }
    }
  ...
  e->next = 
# 108 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
           ((void *)0)
# 108 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
               ;
  e->name = name;
  e->section = section;
  e->value = value;
...
# 113 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                                  ((void *)0)
# 113 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                                      ; epp = &(*epp)->next)
    ;
  *epp = e;
...
ctor_cmp (const void *p1, const void *p2)
{
  ...
  n1 = (*pe1)->name;
  if (n1 == 
# 164 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
           ((void *)0)
# 164 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
               )
    n1 = "";
  n2 = (*pe2)->name;
  if (n2 == 
# 167 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
           ((void *)0)
# 167 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
               )
    n2 = "";
...
ldctor_build_sets (void)
{
  ...
  if (constructors_sorted)
    {
      for (p = sets; p != 
# 213 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                         ((void *)0)
# 213 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                             ; p = p->next)
 {
   int c, i;
   struct set_element *e;
   ...
   if (p->elements == 
# 219 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                     ((void *)0)
# 219 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                         )
     continue;

   c = 0;
   for (e = p->elements; e != 
# 223 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                             ((void *)0)
# 223 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                                 ; e = e->next)
     ++c;
   ...
   i = 0;
   for (e = p->elements; e != 
# 229 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                             ((void *)0)
# 229 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                                 ; e = e->next)
     {
       array[i] = e;
       ++i;
   ...
   array[i]->next = 
# 241 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                   ((void *)0)
# 241 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                       ;
  ...
  header_printed = 0;
  for (p = sets; p != 
# 251 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                     ((void *)0)
# 251 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                         ; p = p->next)
    {
      struct set_element *e;
      reloc_howto_type *howto;
 ...
 continue;
# 274 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
      howto = bfd_reloc_type_lookup (link_info.output_bfd, p->reloc);
      if (howto == 
# 275 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                  ((void *)0)
# 275 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                      )
 {
   if (((&link_info)->type == type_relocatable))
     {
       einfo (gettext ("%P%X: %s does not support reloc %s for set %s\n"),
...
# 288 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                                     ((void *)0)
# 288 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                                         )
     howto = bfd_reloc_type_lookup (p->elements->section->owner,
        p->reloc);
   if (howto == 
# 291 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
               ((void *)0)
# 291 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                   )
     {

       if (p->elements->section->owner == 
# 294 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                                         ((void *)0)
# 294 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                                             )
  einfo (gettext ("%P%X: Special section %s does not support reloc %s for set %s\n"),
         ((void) link_info.output_bfd, (p->elements->section)->name),
         bfd_get_reloc_code_name (p->reloc),
         p->h->root.string);
       else
  einfo (gettext ("%P%X: %s does not support reloc %s for set %s\n"),
         ((p->elements->section->owner)->xvec->name),
         bfd_get_reloc_code_name (p->reloc),
         p->h->root.string);
       continue;
     }
      ...
      switch (reloc_size)
 {
 case 1: size = 286; break;
 case 2: size = 285; break;
 case 4: size = 284; break;
 case 8:
   ...
   break;
 default:
   einfo (gettext ("%P%X: Unsupported size %d for set %s\n"),
   ...
   break;
      ...
      for (e = p->elements; e != 
# 336 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                                ((void *)0)
# 336 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                                    ; e = e->next)
 {
   if (config.map_file != 
# 338 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                         ((void *)0)
# 338 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                             )
     {
       int len;
       ...
       while (len < 20)
  {
    ...
    ++len;
       ...
       if (e->name != 
# 362 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c" 3 4
                     ((void *)0)
# 362 "/doner/binutils/binutils-53f7e8e/ld/ldctor.c"
                         )
  minfo ("%T\n", e->name);
       else
  minfo ("%G\n", e->section->owner, e->section, e->value);
   ...
   if (!((e->section) == (&_bfd_std_section[2])))
