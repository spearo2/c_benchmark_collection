# 1 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
# 26 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
...
# 27 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
# 1 "../bfd/bfd.h" 1
# 42 "../bfd/bfd.h"
...
# 28 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/ld/mri.h" 1
# 24 "/doner/binutils/binutils-53f7e8e/ld/mri.h"
...
# 33 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
# 1 "./ldgram.h" 1
# 50 "./ldgram.h"
  enum yytokentype
  {
...
int yyparse (void);
# 34 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
...
# 35 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 2
   ...
   etree_type *subalign)
{
  ...
  (*ptr)->vma = vma;
  (*ptr)->next = 
# 89 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                ((void *)0)
# 89 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                    ;
  (*ptr)->ok_to_load = 0;
  (*ptr)->alias = zalias;
  (*ptr)->align = align;
...
mri_draw_tree (void)
{
  ...
  if (address != 
# 129 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                ((void *)0)
# 129 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                    )
    {
      ...
      if (order == 
# 134 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                  ((void *)0)
# 134 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                      )
 order = address;

      for (alist = address;
    alist != 
# 138 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
            ((void *)0)
# 138 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                ;
    alist = alist->next)
 {
   int done = 0;
...
# 143 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                            ((void *)0)
# 143 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                                ; olist = olist->next)
     {
  ...
  if (only_load != 
# 162 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                  ((void *)0)
# 162 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                      )
    {
      ...
      if (order == 
# 167 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                  ((void *)0)
# 167 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                      )
 order = only_load;
 ...
 ptr->ok_to_load = 1;
  ...
  if (order != 
# 186 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
              ((void *)0)
# 186 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                  )
    {
      ...
      while (p)
 {
   ...
   lang_enter_output_section_statement (p->name, base,
            ...
            align, subalign, 
# 212 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                            ((void *)0)
# 212 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                , 0, 0);
   base = 0;
   tmp = (struct wildcard_list *) xmalloc (sizeof *tmp);
   tmp->next = 
# 215 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
              ((void *)0)
# 215 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                  ;
   tmp->spec.name = p->name;
   tmp->spec.exclude_name_list = 
# 217 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                ((void *)0)
# 217 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                    ;
   tmp->spec.sorted = none;
   tmp->spec.section_flag_list = 
# 219 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                ((void *)0)
# 219 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                    ;
   lang_add_wild (
# 220 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                 ((void *)0)
# 220 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                     , tmp, 0);
  ...
  tmp = (struct wildcard_list *) xmalloc (sizeof *tmp);
  tmp->next = 
# 227 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
             ((void *)0)
# 227 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                 ;
  tmp->spec.name = aptr->name;
  tmp->spec.exclude_name_list = 
# 229 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                               ((void *)0)
# 229 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                   ;
  tmp->spec.sorted = none;
  tmp->spec.section_flag_list = 
# 231 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                               ((void *)0)
# 231 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                   ;
  lang_add_wild (
# 232 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                ((void *)0)
# 232 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                    , tmp, 0);
       }

   lang_leave_output_section_statement (0, "*default*", 
# 235 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                                       ((void *)0)
# 235 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                                           , 
# 235 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                                             ((void *)0)
# 235 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
...
# 248 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                                          ((void *)0)
# 248 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                                              );
}
  ...
  if (!is)
    {
      ...
      if (is == 
# 269 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
               ((void *)0)
# 269 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                   )
 ld_abort ("/doner/binutils/binutils-53f7e8e/ld/mri.c", 270, __PRETTY_FUNCTION__);
    }
...
# 286 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                   ((void *)0)
# 286 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                       , 
# 286 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                         ((void *)0)
# 286 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
...
# 289 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                   ((void *)0)
# 289 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                       , 
# 289 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                         ((void *)0)
# 289 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
...
# 292 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                        ((void *)0)
# 292 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
                                            , 
# 292 "/doner/binutils/binutils-53f7e8e/ld/mri.c" 3 4
                                              ((void *)0)
# 292 "/doner/binutils/binutils-53f7e8e/ld/mri.c"
    ...
    einfo (gettext ("%P%F: unknown format type %s\n"), name);
}

void
mri_public (const char *name, etree_type *exp)
{
  lang_add_assignment (exp_assign (name, exp, 0));
}
