# 1 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
# 29 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 33 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
# 35 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
# 36 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
# 37 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 2
...
DFN_Stack *dfn_stack = 
# 53 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 3 4
                      ((void *)0)
# 53 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
                          ;
int dfn_maxdepth = 0;
int dfn_depth = 0;
int dfn_counter = 0;
...
# 89 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
static void
find_cycle (Sym *child)
{
      ...
      if (child->cg.cyc.head != child && child->cg.cyc.head == head)
 {
  ...
  if (cycle_top <= 0)
    {
      fprintf (
# 111 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 3 4
              stderr
# 111 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
      ...
      for (cycle_index = cycle_top + 1; cycle_index <= dfn_depth; ++cycle_index)
 {
       ...
       for (tail = child; tail->cg.cyc.next; tail = tail->cg.cyc.next)
  {
    ...
    if (debug_level & ((1<<1))) {printf ("[find_cycle] and its tail "); print_name (tail->cg.cyc.next); printf (" onto "); print_name (head); printf ("\n");}
     ...
     {
       fprintf (
# 200 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c" 3 4
               stderr
# 200 "/doner/binutils/binutils-53f7e8e/gprof/cg_dfn.c"
