# 1 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
# 22 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 26 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
GMON_Record_Tag;
# 30 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/utils.h" 1
# 23 "/doner/binutils/binutils-53f7e8e/gprof/utils.h"
extern int print_name_only (Sym * self);
extern void print_name (Sym * self);
# 33 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 2
...
# 39 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
...
# 89 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
static void
         ...
         int first)
{
  ...
  if (gmon_io_read_vma (ifp, &record->lowpc)
    ...
    {
      fprintf (
# 106 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
              stderr
# 106 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                    , gettext ("%s: %s: unexpected end of file\n"),
        whoami, filename);
 ...
 {
   fprintf (
# 133 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
           stderr
# 133 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                 ,
     gettext ("%s: dimension unit changed between histogram records\n" "%s: from '%s'\n" "%s: to '%s'\n")
 ...
 {
   fprintf (
# 143 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
           stderr
# 143 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                 ,
     gettext ("%s: dimension abbreviation changed between histogram records\n" "%s: from '%c'\n" "%s: to '%c'\n")
 ...
 {
   fprintf (
# 157 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
           stderr
# 157 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                 ,
     gettext ("%s: different scales in histogram records"),
     whoami);
   done (1);
 }
    }
...
hist_read_rec (FILE * ifp, const char *filename)
{
 ...
 {
   fprintf (
# 194 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
           stderr
# 194 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                 ,
     gettext ("%s: overlapping histogram records\n"),
     whoami);
   done (1);
 }
 ...
 {
   fprintf (
# 228 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
           stderr
# 228 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                 ,
    gettext ("%s: %s: unexpected EOF after reading %u of %u samples\n"),
...
# 291 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
static void
...
# 360 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
static void
...
print_header (int prefix)
{
  ...
  sprintf (unit, gettext ("%c%c/call"), prefix, hist_dimension_abbrev);
      ...
      if (total_time > 0.0)
 {
  ...
  if (total_time <= 0.0)
    {
      printf (gettext (" no time accumulated\n\n"));
  ...
  printf ("%5.5s %10.10s %8.8s %8.8s %8.8s %8.8s  %-8.8s\n",
   "%  ", gettext ("cumulative"), gettext ("self  "), "", gettext ("self  "), gettext ("total "),
   "");
  printf ("%5.5s %9.9s  %8.8s %8.8s %8.8s %8.8s  %-8.8s\n",
   gettext ("time"), hist_dimension, hist_dimension, gettext ("calls"), unit, unit,
   gettext ("name"));
}
...
hist_print (void)
{
      ...
      if (print_descriptions)
 {
   printf (gettext ("\n\n\nflat profile:\n"));
   flat_blurb (
# 585 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
              stdout
# 585 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                    );
 }
    }
  else
    {
      printf (gettext ("Flat profile:\n"));
    }
 ...
 print_line (time_sorted_syms[sym_index], SItab[log_scale].scale);
  ...
  if (print_descriptions && !bsd_style_output)
    flat_blurb (
# 666 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
               stdout
# 666 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                     );
}
...
# 688 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
void
hist_clip_symbol_address (bfd_vma *p_lowpc, bfd_vma *p_highpc)
{
      ...
      if (common_low < common_high)
 {
   if (found)
     {
       fprintf (
# 710 "/doner/binutils/binutils-53f7e8e/gprof/hist.c" 3 4
               stderr
# 710 "/doner/binutils/binutils-53f7e8e/gprof/hist.c"
                     ,
         gettext ("%s: found a symbol that covers " "several histogram records")
                                ,
    whoami);
       done (1);
     }
