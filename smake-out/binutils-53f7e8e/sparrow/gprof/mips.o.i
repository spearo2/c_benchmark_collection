# 1 "/doner/binutils/binutils-53f7e8e/gprof/mips.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/mips.c"
# 29 "/doner/binutils/binutils-53f7e8e/gprof/mips.c"
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 32 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
# 35 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
# 36 "/doner/binutils/binutils-53f7e8e/gprof/mips.c" 2
...
mips_find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
      ...
      if ((op & 0xfc000000) == 0x0c000000)
 {
   ...
   if (debug_level & ((1<<8))) {printf (gettext ("[find_call] 0x%lx: jal"), (unsigned long) pc);}
                                                                 ;
      ...
      else if ((op & 0xfc00f83f) == 0x0000f809)
 {
   ...
   if (debug_level & ((1<<8))) {printf (gettext ("[find_call] 0x%lx: jalr\n"), (unsigned long) pc);}
                                                                    ;
