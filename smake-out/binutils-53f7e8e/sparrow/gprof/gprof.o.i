# 1 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
# 30 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
# 1 "../bfd/bfdver.h" 1
# 33 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 35 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 36 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 37 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 38 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 39 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.h" 1
# 25 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.h"
...
# 40 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 41 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
# 44 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.h" 1
# 25 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.h"
typedef enum
  {
...
# 45 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
cplus_demangle_print_callback (int options,
                               const struct demangle_component *tree,
                               demangle_callbackref callback, void *opaque);
# 46 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
extern int _getopt_internal (int argc, char *const *argv,
        const char *shortopts,
               const struct option *longopts, int *longind,
        int long_only);
# 47 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 2
...
int output_style = 0;
int output_width = 80;
bfd_boolean bsd_style_output = 0;
bfd_boolean demangle = 1;
bfd_boolean ignore_direct_calls = 0;
bfd_boolean ignore_static_funcs = 0;
bfd_boolean ignore_zeros = 1;
bfd_boolean line_granularity = 0;
bfd_boolean print_descriptions = 1;
bfd_boolean print_path = 0;
bfd_boolean ignore_non_functions = 0;
bfd_boolean inline_file_names = 0;
File_Format file_format = FF_AUTO;

bfd_boolean first_output = 1;
...
# 99 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
...
{
  fprintf (stream, gettext ("Usage: %s [-[abcDhilLsTvwxyz]] [-[ACeEfFJnNOpPqSQZ][name]] [-I dirs]\n	[-d[num]] [-k from/to] [-m min-count] [-t table-length]\n	[--[no-]annotated-source[=name]] [--[no-]exec-counts[=name]]\n	[--[no-]flat-profile[=name]] [--[no-]graph[=name]]\n	[--[no-]time=name] [--all-lines] [--brief] [--debug[=level]]\n	[--function-ordering] [--file-ordering] [--inline-file-names]\n	[--directory-path=dirs] [--display-unused-functions]\n	[--file-format=name] [--file-info] [--help] [--line] [--min-count=n]\n	[--no-static] [--print-path] [--separate-files]\n	[--static-call-graph] [--sum] [--table-length=len] [--traditional]\n	[--version] [--width=n] [--ignore-non-functions]\n	[--demangle[=STYLE]] [--no-demangle] [--external-symbol-table=name] [@FILE]\n	[image-file] [profile-file...]\n")
# 175 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                                   ,
    whoami);
...
# 197 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
 ...
 "aA::bBcC::d::De:E:f:F:hiI:J::k:lLm:n:N:O:p::P::q::Q::rR:sS:t:Tvw:xyzZ::",
       long_options, 0))
  != 
# 209 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
    (-1)
# 209 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
       )
    {
      switch (ch)
 {
 case 'a':
   ignore_static_funcs = 1;
   break;
 case 'A':
   if (optarg)
     {
 ...
 case 'h':
   usage (
# 279 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
         stdout
# 279 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
               , 0);
 case 'i':
   output_style |= (1<<5);
   user_specified |= (1<<5);
...
# 309 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
                                                            ((void *)0)
# 309 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                                                                , 10);
   break;
 case 'n':
   sym_id_add (optarg, INCL_TIME);
 ...
 case 'O':
   switch (optarg[0])
     ...
     default:
       fprintf (
# 336 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
               stderr
# 336 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                     , gettext ("%s: unknown file format %s\n"),
         optarg, whoami);
       done (1);
     }
   break;
 ...
 case 'v':
   ...
   printf (gettext ("GNU gprof %s\n"), "(GNU Binutils) " "2.28.51.20170210");
   printf (gettext ("Based on BSD gprof, copyright 1983 Regents of the University of California.\n"));
   printf (gettext ("This program is free software.  This program has absolutely no warranty.\n")
                                                                            );
   done (0);
 case 'w':
   ...
   break;
 case 'x':
   bb_annotate_all_lines = 1;
   break;
 case 'y':
   create_annotation_files = 1;
   break;
 case 'z':
   ignore_zeros = 0;
   break;
 ...
 case (150):
   demangle = 1;
   if (optarg != 
# 459 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
                ((void *)0)
# 459 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                    )
     {
  ...
  {
    fprintf (
# 466 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
            stderr
# 466 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                  ,
      gettext ("%s: unknown demangling style `%s'\n"),
      whoami, optarg);
    xexit (1);
  }
 ...
 default:
   usage (
# 482 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
         stderr
# 482 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
               , 1);
 }
    }
  ...
  if ((user_specified & (1<<6))
    ...
    {
      fprintf (
# 490 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
              stderr
# 490 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                    ,gettext ("%s: Only one of --function-ordering and --file-ordering may be specified.\n")
                                                                             ,
        whoami);
      done (1);
    }
  ...
  if (file_format == FF_PROF)
    {
      fprintf (
# 541 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
              stderr
# 541 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                    ,
        gettext ("%s: sorry, file format `prof' is not yet supported\n"),
        whoami);
      done (1);
    }
  else
 ...
 output_style = (1<<3);
  ...
  if ((output_style & (1<<0))
    ...
    {
      fprintf (
# 596 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
              stderr
# 596 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                    , gettext ("%s: gmon.out file is missing histogram\n"), whoami);
      done (1);
    }
  ...
  if ((output_style & (1<<1)) && !(gmon_input & (1 << 1)))
    {
      fprintf (
# 602 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c" 3 4
              stderr
# 602 "/doner/binutils/binutils-53f7e8e/gprof/gprof.c"
                    ,
        gettext ("%s: gmon.out file is missing call-graph data\n"), whoami);
      done (1);
    }
