# 1 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
# 22 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 27 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 2
...
# 85 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c" 3 4
                                    ((void *)0)

# 86 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
};
...
# 117 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
static void
  ...
  if (pattern->name)
    {
      ...
      if (*sym_name && ((core_bfd)->xvec->symbol_leading_char) == *sym_name)
 sym_name++;
...
# 275 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
void
sym_id_parse (void)
{
  Sym *sym, *left, *right;
      ...
      for (id = id_list; id; id = id->next)
 {
   if (match (&id->left.sym, sym))
     extend_match (&id->left, sym, &syms[id->which_table], 0);

   if (id->has_right && match (&id->right.sym, sym))
     extend_match (&id->right, sym, &right_ids, 0);
 }
    }
 ...
 {
   if (match (&id->left.sym, sym))
     extend_match (&id->left, sym, &syms[id->which_table], 1);

   if (id->has_right && match (&id->right.sym, sym))
     extend_match (&id->right, sym, &right_ids, 1);
 }
    }
...
# 350 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
                                 ;
...
# 374 "/doner/binutils/binutils-53f7e8e/gprof/sym_ids.c"
bfd_boolean
