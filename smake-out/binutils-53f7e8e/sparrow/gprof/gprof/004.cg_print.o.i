# 1 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
# 22 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 24 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 26 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 27 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 28 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 29 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 32 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 2
...
print_header (void)
{
 ...
 printf (gettext ("\t\t     Call graph (explanation follows)\n\n"));
      else
 printf (gettext ("\t\t\tCall graph\n\n"));
    }
  ...
  if (print_time > 0.0)
    printf (gettext (" for %.2f%% of %.2f seconds\n\n"),
     100.0 / print_time, print_time / hz);
  else
    {
      printf (gettext (" no time propagated\n\n"));
  ...
  if (bsd_style_output)
    {
      printf ("%6.6s %5.5s %7.7s %11.11s %7.7s/%-7.7s     %-8.8s\n",
       "", "", "", "", gettext ("called"), gettext ("total"), gettext ("parents"));
      printf ("%-6.6s %5.5s %7.7s %11.11s %7.7s+%-7.7s %-8.8s\t%5.5s\n",
       gettext ("index"),

       gettext ("%time"),
       gettext ("self"), gettext ("descendants"), gettext ("called"), gettext ("self"),
       gettext ("name"), gettext ("index"));
      printf ("%6.6s %5.5s %7.7s %11.11s %7.7s/%-7.7s     %-8.8s\n",
       "", "", "", "", gettext ("called"), gettext ("total"), gettext ("children"));
      printf ("\n");
    }
  else
    {
      printf (gettext ("index %% time    self  children    called     name\n"));
    }
}
...
{
  char buf[
# 118 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
          8192
# 118 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
                ];
  ...
  printf (gettext (" <cycle %d as a whole> [%d]\n"), cyc->cg.cyc.num, cyc->cg.index);
}
...
# 173 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
                             ((void *)0)
# 173 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
                                 ; doing = todo)
    {
...
# 224 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
static int
...
# 247 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
     ;
...
print_parents (Sym *child)
{
  ...
  if (!child->cg.parents)
    {
      printf (bsd_style_output
       ? gettext ("%6.6s %5.5s %7.7s %11.11s %7.7s %7.7s     <spontaneous>\n")
       : gettext ("%6.6s %5.5s %7.7s %7.7s %7.7s %7.7s     <spontaneous>\n"),
       "", "", "", "", "", "");
      return;
    }
...
{
  char buf[
# 472 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
          8192
# 472 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
                ];
...
cg_print (Sym ** timesortsym)
{
  ...
  if (print_descriptions && bsd_style_output)
    bsd_callg_blurb (
# 509 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
                    stdout
# 509 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
                          );
 ...
 printf ("\n");
  ...
  if (print_descriptions && !bsd_style_output)
    fsf_callg_blurb (
# 549 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
                    stdout
# 549 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
                          );
}
...
cg_print_index (void)
{
 ...
 continue;
  ...
  printf ("\f\n");
  printf (gettext ("Index by function name\n\n"));
  sym_index = (todo + 2) / 3;
      ...
      for (j = i; j < todo; j += sym_index)
 {
  ...
  {
    printf ("%6.6s ", buf);
    sprintf (buf, gettext ("<cycle %d>"), sym->cg.cyc.num);
    printf ("%-19.19s", buf);
  }
       else
  {
...
# 776 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
void
  ...
  for (sym_index = 0; sym_index < used / 80; sym_index++)
    {
      ...
      if (sym->nuses == 5)
 break;
# 884 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
      arc = sym->cg.children;
...
# 986 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
static void
      ...
      unsigned long *unplaced_arc_count)
{
 ...
 continue;
      ...
      if (sym->next == 
# 1183 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
                      ((void *)0)
   
# 1184 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
  && sym->prev == 
# 1184 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
                  ((void *)0)
# 1184 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
                      )
 continue;
...
cg_print_file_ordering (void)
{
 ...
 printf ("%s\n", symtab.base[sym_index].name);
  ...
  last = 
# 1264 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c" 3 4
        ((void *)0)
# 1264 "/doner/binutils/binutils-53f7e8e/gprof/cg_print.c"
            ;
