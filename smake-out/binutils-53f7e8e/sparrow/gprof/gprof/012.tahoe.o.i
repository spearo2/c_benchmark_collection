# 1 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c"
# 29 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c"
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 32 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
...
# 35 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
...
# 36 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 2
# 47 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c"
...
tahoe_offset (unsigned char *modep)
{
  ...
  switch (mode)
    ...
    default:
      fprintf (
# 208 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c" 3 4
              stderr
# 208 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c"
  ...
  for (pc = p_lowpc; pc < p_highpc; pc += length)
    {
     ...
     + pc - core_text_sect->vma);
      if ((*instructp & 0xff) == 0xfe)
 {




   if (debug_level & ((1<<8))) {printf ("[findcall]\t0x%lx:callf", (unsigned long) pc);}
                          ;
   ...
   if (debug_level & ((1<<8))) {printf ("\tfirst operand is %s", tahoe_operandname (firstmode)); printf ("\tsecond operand is %s\n", tahoe_operandname (mode));;}
   ...
   switch (mode)
     ...
     case wordreldef:
     case longreldef:
# 286 "/doner/binutils/binutils-53f7e8e/gprof/tahoe.c"
