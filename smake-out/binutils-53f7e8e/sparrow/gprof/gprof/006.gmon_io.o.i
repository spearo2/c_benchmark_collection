# 1 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
# 22 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
...
# 23 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "./../include/binary-io.h" 1
# 24 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
# 25 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 26 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
# 27 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/cg_arcs.h" 1
# 30 "/doner/binutils/binutils-53f7e8e/gprof/cg_arcs.h"
typedef struct arc
  {
    Sym *parent;
    Sym *child;
...
# 28 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/basic_blocks.h" 1
# 25 "/doner/binutils/binutils-53f7e8e/gprof/basic_blocks.h"
extern bfd_boolean bb_annotate_all_lines;
...
# 29 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/call_graph.h" 1
# 25 "/doner/binutils/binutils-53f7e8e/gprof/call_graph.h"
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.h" 1
# 29 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.h"
...
# 32 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/gmon_out.h" 1
# 32 "/doner/binutils/binutils-53f7e8e/gprof/gmon_out.h"
struct gmon_hdr
  {
    char cookie[4];
    char version[4];
...
GMON_Record_Tag;
# 33 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/gmon.h" 1
# 125 "/doner/binutils/binutils-53f7e8e/gprof/gmon.h"
struct tostruct
  {
    char *selfpc;
    int count;
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/hertz.h" 1
# 30 "/doner/binutils/binutils-53f7e8e/gprof/hertz.h"
extern int hertz (void);
# 35 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
# 36 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
# 37 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 2
...
static int gmon_io_read_64 (FILE *, unsigned long *);
static int gmon_io_write_64 (FILE *, unsigned long);
...
gmon_get_ptr_size (void)
{
  ...
  switch (size)
    ...
    default:
      fprintf (
# 83 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
              stderr
# 83 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                    , gettext ("%s: address size has unexpected value of %u\n"),
        whoami, size);
      done (1);
    }
}
...
static int
gmon_io_read_64 (FILE *ifp, unsigned long *valp)
{
  char buf[8];
...
static int
gmon_io_write_64 (FILE *ofp, unsigned long val)
{
  char buf[8];
...
gmon_io_write_vma (FILE *ofp, bfd_vma val)
{
 ...
 return 1;
    ...
    case ptr_64bit:
      if (gmon_io_write_64 (ofp, (unsigned long) val))
 return 1;
      break;
...
gmon_io_write_8 (FILE *ofp, unsigned int val)
{
  ...
  ((void) (*((unsigned char *) (buf)) = (val) & 0xff));
...
gmon_write_raw_arc (FILE *ofp, bfd_vma fpc, bfd_vma spc, unsigned long cnt)
{
 ...
 return 1;
    ...
    case ptr_64bit:
      if (gmon_io_write_64 (ofp, (unsigned long) cnt))
 return 1;
      break;
...
gmon_out_read (const char *filename)
{
  ...
  if (strcmp (filename, "-") == 0)
    {
      ifp = 
# 302 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
           stdin
# 302 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                ;
      ;
    }
  else
      ...
      if (!ifp)
 {
  ...
  if (fread (&ghdr, sizeof (struct gmon_hdr), 1, ifp) != 1)
    {
      fprintf (
# 318 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
              stderr
# 318 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                    , gettext ("%s: file too short to be a gmon file\n"),
        filename);
      done (1);
    }
 ...
 {
   fprintf (
# 328 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
           stderr
# 328 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                 , gettext ("%s: file `%s' has bad magic cookie\n"),
     whoami, filename);
   done (1);
 }
 ...
 {
   fprintf (
# 338 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
           stderr
# 338 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                 ,
     gettext ("%s: file `%s' has unsupported version %d\n"),
      ...
      while (fread (&tag, sizeof (tag), 1, ifp) == 1)
 {
   switch (tag)
     ...
     default:
       fprintf (
# 368 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
               stderr
# 368 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                     ,
         gettext ("%s: %s: found bad tag %d (file corrupted?)\n"),
         whoami, filename, tag);
       done (1);
     }
 }
 ...
 unsigned int ncnt;
      ...
      if (fseek (ifp, 0, 
# 401 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
                        0
# 401 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                                ) < 0)
 {
   perror (filename);
   done (1);
 ...
 bad_gmon_file:
          fprintf (
# 414 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
                  stderr
# 414 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                        , gettext ("%s: file too short to be a gmon file\n"),
     filename);
   done (1);
 }
      ...
      if (version == 0x00051879)
 {
   ...
   if (!histograms)
     ...
     {
       fprintf (
# 435 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
               stderr
# 435 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                     ,
         gettext ("%s: profiling rate incompatible with first gmon file\n"),
         filename);
       done (1);
     }
      ...
      else
 {
   ...
   if (file_format == FF_BSD44)
     {
       fprintf (
# 457 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
               stderr
# 457 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                     , gettext ("%s: file `%s' has bad magic cookie\n"),
         whoami, filename);
       done (1);
     }
...
# 475 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
                                  0
# 475 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                                          ) < 0)
 {
   perror (filename);
   done (1);
 ...
 {
   fprintf (
# 487 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
           stderr
# 487 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                 , gettext ("%s: incompatible with first gmon file\n"),
     filename);
   done (1);
 }
 ...
 {
   fprintf (
# 516 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
           stderr
# 516 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                 ,
     gettext ("%s: file '%s' does not appear to be in gmon.out format\n"),
     whoami, filename);
   done (1);
 }
      ...
      for (i = 0; i < hist_num_bins; ++i)
 {
   if (fread (raw_bin_count, sizeof (raw_bin_count), 1, ifp) != 1)
     {
       fprintf (
# 529 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
               stderr
# 529 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                     ,
         gettext ("%s: unexpected EOF after reading %d/%d bins\n"),
   ...
   if (hz == 0)
     {
       hz = 1;
       fprintf (
# 562 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
               stderr
# 562 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                     , gettext ("time is in ticks, not seconds\n"));
     }
 }
    }
  else
    {
      fprintf (
# 568 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
              stderr
# 568 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                    , gettext ("%s: don't know how to deal with file format %d\n"),
        whoami, file_format);
      done (1);
    }

  if (ifp != 
# 573 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
            stdin
# 573 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                 )
    fclose (ifp);

  if (output_style & (1<<5))
    {
      printf (gettext ("File `%s' (version %d) contains:\n"),
       filename, gmon_file_version);
      printf (nhist == 1 ?
       gettext ("\t%d histogram record\n") :
       gettext ("\t%d histogram records\n"), nhist);
      printf (narcs == 1 ?
       gettext ("\t%d call-graph record\n") :
       gettext ("\t%d call-graph records\n"), narcs);
      printf (nbbs == 1 ?
       gettext ("\t%d basic-block count record\n") :
       gettext ("\t%d basic-block count records\n"), nbbs);
      first_output = 0;
    }
}
...
gmon_out_write (const char *filename)
{
      ...
      for (sym = symtab.base; sym < symtab.limit; ++sym)
 {
          ...
          arc->child->addr, arc->count))
  {
    ...
    {
      fprintf (
# 748 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c" 3 4
              stderr
# 748 "/doner/binutils/binutils-53f7e8e/gprof/gmon_io.c"
                    , gettext ("%s: don't know how to deal with file format %d\n"),
        whoami, file_format);
      done (1);
    }
