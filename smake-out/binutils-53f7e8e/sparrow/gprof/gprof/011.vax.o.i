# 1 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
...
# 1 "<command-line>" 2
# 1 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
# 29 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
...
# 30 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
...
# 31 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
...
extern FILE *annotate_source
  (Source_File *sf, unsigned int max_width,
    ...
    void * arg);
# 32 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
...
# 33 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
...
# 34 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
...
# 35 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
...
# 36 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 2
# 47 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
enum opermodes
  {
...
# 71 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
...
vax_offset (unsigned char *modep)
{
  ...
  switch (mode)
    ...
    default:
      fprintf (
# 219 "/doner/binutils/binutils-53f7e8e/gprof/vax.c" 3 4
              stderr
# 219 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
                    , "[reladdr] not relative address\n");
      return 0;
    case byterel:
      return 1 + (((*(const unsigned char *) (modep) & 0xff) ^ 0x80) - 0x80);
    case wordrel:
...
vax_find_call (Sym *parent, bfd_vma p_lowpc, bfd_vma p_highpc)
{
      ...
      if ((*instructp & 0xff) == 0xfb)
 {
   ...
   switch (mode)
     ...
     case wordreldef:
     case longreldef:
# 297 "/doner/binutils/binutils-53f7e8e/gprof/vax.c"
