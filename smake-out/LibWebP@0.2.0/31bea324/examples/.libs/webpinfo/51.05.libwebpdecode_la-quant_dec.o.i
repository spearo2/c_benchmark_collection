# 1 "/doner/libwebp/libwebp-31bea324/src/dec/quant_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dec/quant_dec.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dec/quant_dec.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dec/quant_dec.c" 2
...
void VP8ParseQuant(VP8Decoder* const dec) {
  ...
  const int dqy1_dc = VP8GetValue(br, 1) ?
       VP8GetSignedValue(br, 4) : 0;
  const int dqy2_dc = VP8GetValue(br, 1) ?
       VP8GetSignedValue(br, 4) : 0;
  const int dqy2_ac = VP8GetValue(br, 1) ?
       VP8GetSignedValue(br, 4) : 0;
  const int dquv_dc = VP8GetValue(br, 1) ?
       VP8GetSignedValue(br, 4) : 0;
  const int dquv_ac = VP8GetValue(br, 1) ?
       VP8GetSignedValue(br, 4) : 0;
