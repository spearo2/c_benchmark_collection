# 1 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 2
# 171 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
static int CheckSizeArgumentsOverflow(uint64_t nmemb, size_t size) {
  const uint64_t total_size = nmemb * size;
  if (nmemb == 0) return 1;
  if ((uint64_t)size > (1ULL << 34) / nmemb) return 0;
  if (!CheckSizeOverflow(total_size)) return 0;
# 191 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
  return 1;
}
...
void* WebPSafeMalloc(uint64_t nmemb, size_t size) {
  void* ptr;
  do {} while (0);
  if (!CheckSizeArgumentsOverflow(nmemb, size)) return 
# 197 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
                                                      ((void *)0)
# 197 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                                          ;
  
# 198 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 198 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                         ;
...
void* WebPSafeCalloc(uint64_t nmemb, size_t size) {
  ...
  do {} while (0);
  if (!CheckSizeArgumentsOverflow(nmemb, size)) return 
# 207 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
                                                      ((void *)0)
# 207 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                                          ;
  
# 208 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 208 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                         ;
...
void WebPSafeFree(void* const ptr) {
  if (ptr != 
# 215 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
            ((void *)0)
# 215 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                ) {
    do {} while (0);
    do {} while (0);
  }
...
# 236 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 236 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                   ;
  
# 237 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 237 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                                             ;
  while (height-- > 0) {
...
# 246 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 246 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                   ;
  
# 247 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 247 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                                               ;
  
# 248 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c" 3 4
 ((void) (0))
# 248 "/doner/libwebp/libwebp-31bea324/src/utils/utils.c"
                                       ;
