# 1 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
# 15 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
# 16 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 2
# 1 "../../src/mux/muxi.h" 1
# 17 "../../src/mux/muxi.h"
# 1 "/usr/include/assert.h" 1 3 4
# 18 "../../src/mux/muxi.h" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 2



const ChunkInfo kChunks[] = {
  { (('V') | ('P') << 8 | ('8') << 16 | (uint32_t)('X') << 24), WEBP_CHUNK_VP8X, 10 },
  { (('I') | ('C') << 8 | ('C') << 16 | (uint32_t)('P') << 24), WEBP_CHUNK_ICCP, ((uint32_t)(-1)) },
  { (('A') | ('N') << 8 | ('I') << 16 | (uint32_t)('M') << 24), WEBP_CHUNK_ANIM, 6 },
  { (('A') | ('N') << 8 | ('M') << 16 | (uint32_t)('F') << 24), WEBP_CHUNK_ANMF, 16 },
  { (('A') | ('L') << 8 | ('P') << 16 | (uint32_t)('H') << 24), WEBP_CHUNK_ALPHA, ((uint32_t)(-1)) },
  { (('V') | ('P') << 8 | ('8') << 16 | (uint32_t)(' ') << 24), WEBP_CHUNK_IMAGE, ((uint32_t)(-1)) },
  { (('V') | ('P') << 8 | ('8') << 16 | (uint32_t)('L') << 24), WEBP_CHUNK_IMAGE, ((uint32_t)(-1)) },
  { (('E') | ('X') << 8 | ('I') << 16 | (uint32_t)('F') << 24), WEBP_CHUNK_EXIF, ((uint32_t)(-1)) },
  { (('X') | ('M') << 8 | ('P') << 16 | (uint32_t)(' ') << 24), WEBP_CHUNK_XMP, ((uint32_t)(-1)) },
  { 0x00000000u, WEBP_CHUNK_UNKNOWN, ((uint32_t)(-1)) },

  { 0x00000000u, WEBP_CHUNK_NIL, ((uint32_t)(-1)) }
};
...
# 46 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 46 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
              ;
...
WebPChunk* ChunkRelease(WebPChunk* const chunk) {
  WebPChunk* next;
  if (chunk == 
# 53 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
              ((void *)0)
# 53 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                  ) return 
# 53 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                           ((void *)0)
# 53 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
CHUNK_INDEX ChunkGetIndexFromTag(uint32_t tag) {
  int i;
  for (i = 0; kChunks[i].tag != 0x00000000u; ++i) {
...
uint32_t ChunkGetTagFromFourCC(const char fourcc[4]) {
  return ((fourcc[0]) | (fourcc[1]) << 8 | (fourcc[2]) << 16 | (uint32_t)(fourcc[3]) << 24);
}
...
static WebPChunk* ChunkSearchNextInList(WebPChunk* chunk, uint32_t tag) {
  while (chunk != 
# 95 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                 ((void *)0) 
# 95 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      && chunk->tag_ != tag) {
    chunk = chunk->next_;
  }
  return chunk;
...
WebPChunk* ChunkSearchList(WebPChunk* first, uint32_t nth, uint32_t tag) {
  ...
  if (first == 
# 104 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
              ((void *)0)
# 104 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                  ) return 
# 104 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                           ((void *)0)
# 104 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
  ...
  while (--iter != 0) {
    ...
    if (next_chunk == 
# 108 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 108 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) break;
    first = next_chunk;
  }
  return ((nth > 0) && (iter > 0)) ? 
# 111 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                                    ((void *)0) 
# 111 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                                         : first;
}
...
WebPMuxError ChunkAssignData(WebPChunk* chunk, const WebPData* const data,
  ...
  if (data != 
# 126 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
             ((void *)0)
# 126 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                 ) {
    if (copy_data) {
...
# 142 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 142 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                           ;
  if (*chunk_list != 
# 143 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                    ((void *)0)
# 143 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                        ) {
  ...
  if (new_chunk == 
# 148 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                  ((void *)0)
# 148 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      ) return WEBP_MUX_MEMORY_ERROR;
  *new_chunk = *chunk;
  chunk->owner_ = 0;
  new_chunk->next_ = 
# 151 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                    ((void *)0)
# 151 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                        ;
...
# 159 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 159 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                                                  ;

  if (**chunk_list == 
# 161 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 161 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) {
    err = ChunkSetHead(chunk, *chunk_list);
  } else {
    WebPChunk* last_chunk = **chunk_list;
    while (last_chunk->next_ != 
# 165 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                               ((void *)0)
# 165 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
void ChunkListDelete(WebPChunk** const chunk_list) {
  while (*chunk_list != 
# 182 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                       ((void *)0)
# 182 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                           ) {
...
# 192 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 192 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
              ;
  
# 193 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 193 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                               ;
  PutLE32(dst + 0, chunk->tag_);
  PutLE32(dst + 4, (uint32_t)chunk_size);
  
# 196 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 196 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                                           ;
  memcpy(dst + 8, chunk->data_.bytes, chunk_size);
  if (chunk_size & 1)
    dst[8 + chunk_size] = 0;
...
uint8_t* ChunkListEmit(const WebPChunk* chunk_list, uint8_t* dst) {
  while (chunk_list != 
# 204 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                      ((void *)0)
# 204 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                          ) {
...
size_t ChunkListDiskSize(const WebPChunk* chunk_list) {
  size_t size = 0;
  while (chunk_list != 
# 213 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                      ((void *)0)
# 213 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                          ) {
...
# 224 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 224 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
            ;
...
WebPMuxImage* MuxImageRelease(WebPMuxImage* const wpi) {
  WebPMuxImage* next;
  if (wpi == 
# 230 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
            ((void *)0)
# 230 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                ) return 
# 230 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                         ((void *)0)
# 230 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
# 249 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 249 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                    ;
  switch (id) {
    ...
    default: return 
# 254 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                   ((void *)0)
# 254 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                       ;
  }
}
...
int MuxImageCount(const WebPMuxImage* wpi_list, WebPChunkId id) {
  ...
  for (current = wpi_list; current != 
# 261 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                                     ((void *)0)
# 261 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
    ...
    if (id == WEBP_CHUNK_NIL) {
      ...
      if (wpi_chunk != 
# 266 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                      ((void *)0)
# 266 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                          ) {
...
# 281 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 281 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                 ;
  *location = wpi_list;
  ...
  while (*wpi_list != 
# 289 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 289 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) {
...
WebPMuxError MuxImagePush(const WebPMuxImage* wpi, WebPMuxImage** wpi_list) {
  ...
  while (*wpi_list != 
# 305 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 305 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) {
    WebPMuxImage* const cur_wpi = *wpi_list;
    if (cur_wpi->next_ == 
# 307 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                         ((void *)0)
# 307 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                             ) break;
    wpi_list = &cur_wpi->next_;
  }
  ...
  if (new_wpi == 
# 312 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                ((void *)0)
# 312 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                    ) return WEBP_MUX_MEMORY_ERROR;
  *new_wpi = *wpi;
  new_wpi->next_ = 
# 314 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                  ((void *)0)
# 314 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      ;

  if (*wpi_list != 
# 316 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                  ((void *)0)
# 316 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      ) {
...
# 335 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 335 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                 ;
...
# 348 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 348 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                 ;
  
# 349 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 349 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
            ;
...
size_t MuxImageDiskSize(const WebPMuxImage* const wpi) {
  size_t size = 0;
  if (wpi->header_ != 
# 364 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 364 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) size += ChunkDiskSize(wpi->header_);
  if (wpi->alpha_ != 
# 365 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                    ((void *)0)
# 365 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                        ) size += ChunkDiskSize(wpi->alpha_);
  if (wpi->img_ != 
# 366 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                  ((void *)0)
# 366 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      ) size += ChunkDiskSize(wpi->img_);
  if (wpi->unknown_ != 
# 367 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                      ((void *)0)
# 367 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
static uint8_t* ChunkEmitSpecial(const WebPChunk* const header,
  ...
  const size_t offset_to_next = total_size - 8;
  
# 376 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 376 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                                              ;
  PutLE32(dst + 0, header->tag_);
  PutLE32(dst + 4, (uint32_t)offset_to_next);
  
# 379 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 379 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                                             ;
  memcpy(dst + 8, header->data_.bytes, header_size);
  if (header_size & 1) {
    dst[8 + header_size] = 0;
  }
...
# 392 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 392 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
            ;
  if (wpi->header_ != 
# 393 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 393 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) {
    dst = ChunkEmitSpecial(wpi->header_, MuxImageDiskSize(wpi), dst);
  }
  if (wpi->alpha_ != 
# 396 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                    ((void *)0)
# 396 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                        ) dst = ChunkEmit(wpi->alpha_, dst);
  if (wpi->img_ != 
# 397 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                  ((void *)0)
# 397 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      ) dst = ChunkEmit(wpi->img_, dst);
  if (wpi->unknown_ != 
# 398 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                      ((void *)0)
# 398 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
...
int MuxHasAlpha(const WebPMuxImage* images) {
  while (images != 
# 406 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                  ((void *)0)
# 406 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                      ) {
...
uint8_t* MuxEmitRiffHeader(uint8_t* const data, size_t size) {
  PutLE32(data + 0, (('R') | ('I') << 8 | ('F') << 16 | (uint32_t)('F') << 24));
  PutLE32(data + 4, (uint32_t)size - 8);
  
# 416 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 416 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                               ;
  PutLE32(data + 4 + 4, (('W') | ('E') << 8 | ('B') << 16 | (uint32_t)('P') << 24));
  return data + 12;
}

WebPChunk** MuxGetChunkListFromId(const WebPMux* mux, WebPChunkId id) {
  
# 422 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
 ((void) (0))
# 422 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                    ;
  switch (id) {
...
static WebPMuxError ValidateChunk(const WebPMux* const mux, CHUNK_INDEX idx,
  ...
  if (feature != ((WebPFeatureFlags)0) && IsNotCompatible(vp8x_flags & feature, *num)) {
...
WebPMuxError MuxValidate(const WebPMux* const mux) {
  ...
  if (mux == 
# 470 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
            ((void *)0)
# 470 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                ) return WEBP_MUX_INVALID_ARGUMENT;


  if (mux->images_ == 
# 473 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                     ((void *)0)
# 473 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                         ) return WEBP_MUX_INVALID_ARGUMENT;
  ...
  err = ValidateChunk(mux, IDX_ANIM, ((WebPFeatureFlags)0), flags, 1, &num_anim);
  if (err != WEBP_MUX_OK) return err;
  err = ValidateChunk(mux, IDX_ANMF, ((WebPFeatureFlags)0), flags, -1, &num_frames);
  if (err != WEBP_MUX_OK) return err;

  {
    ...
    if (!has_animation) {
      ...
      if (images == 
# 508 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                   ((void *)0) 
# 508 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
                        || images->next_ != 
# 508 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c" 3 4
                                            ((void *)0)
# 508 "/doner/libwebp/libwebp-31bea324/src/mux/muxinternal.c"
  ...
  err = ValidateChunk(mux, IDX_VP8X, ((WebPFeatureFlags)0), flags, 1, &num_vp8x);
  if (err != WEBP_MUX_OK) return err;
  err = ValidateChunk(mux, IDX_VP8, ((WebPFeatureFlags)0), flags, -1, &num_images);
  if (err != WEBP_MUX_OK) return err;
