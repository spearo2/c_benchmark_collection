# 1 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
# 19 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
...
# 20 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 2
...
# 24 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 2
# 33 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
...
void VP8TBufferInit(VP8TBuffer* const b, int page_size) {
  b->tokens_ = 
# 46 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
              ((void *)0)
# 46 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                  ;
  b->pages_ = 
# 47 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
             ((void *)0)
# 47 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                 ;
  b->last_page_ = &b->pages_;
  b->left_ = 0;
  b->page_size_ = (page_size < 8192) ? 8192 : page_size;
  b->error_ = 0;
}

void VP8TBufferClear(VP8TBuffer* const b) {
  if (b != 
# 55 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
          ((void *)0)
# 55 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
              ) {
    VP8Tokens* p = b->pages_;
    while (p != 
# 57 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
               ((void *)0)
# 57 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                   ) {
...
static int TBufferNewPage(VP8TBuffer* const b) {
  VP8Tokens* page = 
# 67 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
                   ((void *)0)
# 67 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                       ;
  if (!b->error_) {
  ...
  if (page == 
# 72 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
             ((void *)0)
# 72 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                 ) {
    b->error_ = 1;
    return 0;
  }
  page->next_ = 
# 76 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
               ((void *)0)
# 76 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                   ;

  *b->last_page_ = page;
  b->last_page_ = &page->next_;
  b->left_ = b->page_size_;
  b->tokens_ = (token_t*)((const token_t*)&(page)[1]);
  return 1;
}
...
static inline uint32_t AddToken(VP8TBuffer* const b, uint32_t bit,
                                     uint32_t proba_idx,
                                     proba_t* const stats) {
  
# 93 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
 ((void) (0))
# 93 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                                    ;
  
# 94 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
 ((void) (0))
# 94 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                 ;
...
static inline void AddConstantToken(VP8TBuffer* const b,
                                         uint32_t bit, uint32_t proba) {
  
# 105 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
 ((void) (0))
# 105 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                    ;
  
# 106 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
 ((void) (0))
# 106 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                 ;
  if (b->left_ > 0 || TBufferNewPage(b)) {
    const int slot = --b->left_;
    b->tokens_[slot] = (bit << 15) | (1u << 14) | proba;
  }
}
...
int VP8RecordCoeffTokens(int ctx, const struct VP8Residual* const res,
  ...
  int n = res->first;
  uint32_t base_id = (NUM_PROBAS * ((ctx) + NUM_CTX * ((n) + NUM_BANDS * (coeff_type))));
  ...
  while (n < 16) {
    ...
    if (!AddToken(tokens, v != 0, base_id + 1, s + 1)) {
      base_id = (NUM_PROBAS * ((0) + NUM_CTX * ((VP8EncBands[n]) + NUM_BANDS * (coeff_type))));
      s = res->stats[VP8EncBands[n]][0];
      continue;
    }
    if (!AddToken(tokens, v > 1, base_id + 2, s + 2)) {
      base_id = (NUM_PROBAS * ((1) + NUM_CTX * ((VP8EncBands[n]) + NUM_BANDS * (coeff_type))));
      ...
      base_id = (NUM_PROBAS * ((2) + NUM_CTX * ((VP8EncBands[n]) + NUM_BANDS * (coeff_type))));
...
# 203 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
 ((void) (0))
# 203 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                   ;
  while (p != 
# 204 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
             ((void *)0)
# 204 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                 ) {
    const VP8Tokens* const next = p->next_;
    const int N = (next == 
# 206 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
                          ((void *)0)
# 206 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                              ) ? b->left_ : 0;
    int n = b->page_size_;
    const token_t* const tokens = ((const token_t*)&(p)[1]);
    while (n-- > N) {
  ...
  if (final_pass) b->pages_ = 
# 221 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
                             ((void *)0)
# 221 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                                 ;
  return 1;
}
...
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
 ((void) (0))
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                   ;
  while (p != 
# 230 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
             ((void *)0)
# 230 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                 ) {
    const VP8Tokens* const next = p->next_;
    const int N = (next == 
# 232 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c" 3 4
                          ((void *)0)
# 232 "/doner/libwebp/libwebp-31bea324/src/enc/token_enc.c"
                              ) ? b->left_ : 0;
    int n = b->page_size_;
    const token_t* const tokens = ((const token_t*)&(p)[1]);
    while (n-- > N) {
