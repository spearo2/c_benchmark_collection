# 1 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2

# 1 "../../src/utils/filters_utils.h" 1
# 25 "../../src/utils/filters_utils.h"
WEBP_FILTER_TYPE WebPEstimateBestFilter(const uint8_t* data,
                                        int width, int height, int stride);
# 21 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
# 1 "../../src/utils/quant_levels_utils.h" 1
# 29 "../../src/utils/quant_levels_utils.h"
int QuantizeLevels(uint8_t* const data, int width, int height, int num_levels,
                   uint64_t* const sse);
# 22 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
...
# 24 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
# 48 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
...
int VP8LColorSpaceTransform(int width, int height, int bits, int quality,
                            ...
                            const WebPPicture* const pic, int percent_range,
                            int* const percent);
# 49 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 2
...
# 84 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 84 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                       ;
...
# 120 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                         ((void *)0)
# 120 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                             ;
  size_t output_size = 0;
  VP8LBitWriter tmp_bw;

  
# 124 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 124 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                        ;
  
# 125 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 125 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                 ;
  
# 126 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 126 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                       ;
  
# 127 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 127 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                             ;
  
# 128 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 128 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                           ;

  filter_func = WebPFilters[filter];
  if (filter_func != 
# 131 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                    ((void *)0)
# 131 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                        ) {
  ...
  if (!VP8BitWriterInit(&result->bw, 1 + output_size)) ok = 0;
  ok = ok && VP8BitWriterAppend(&result->bw, &header, 1);
...
static int ApplyFiltersAndEncode(const uint8_t* alpha, int width, int height,
  ...
  if (try_map != (1 << WEBP_FILTER_NONE)) {
    uint8_t* filtered_alpha = (uint8_t*)WebPSafeMalloc(1ULL, data_size);
    if (filtered_alpha == 
# 255 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                         ((void *)0)
# 255 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                             ) return 0;
    ...
    ok = EncodeAlphaInternal(alpha, width, height, method, WEBP_FILTER_NONE,
                             reduce_levels, effort_level, 
# 274 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                                                         ((void *)0)
# 274 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                             , &best);
  }
  if (ok) {

    if (stats != 
# 278 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                ((void *)0)
# 278 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                    ) {
...
static int EncodeAlpha(VP8Encoder* const enc,
  ...
  uint8_t* quant_alpha = 
# 307 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                        ((void *)0)
# 307 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                            ;
  const size_t data_size = width * height;
  uint64_t sse = 0;
  int ok = 1;
...
# 314 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 314 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                        ;
  
# 315 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 315 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                     ;
  
# 316 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 316 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                              ;
  
# 317 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 317 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                ;
  
# 318 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 318 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                               ;
  
# 319 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
 ((void) (0))
# 319 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                                                 ;
  ...
  if (quant_alpha == 
# 335 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                    ((void *)0)
# 335 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                        ) {
  ...
  if (ok) {
    ...
    if (pic->stats != 
# 360 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                     ((void *)0)
# 360 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                         ) {
...
static int CompressAlphaJob(void* arg1, void* unused) {
  ...
  uint8_t* alpha_data = 
# 377 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                       ((void *)0)
# 377 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                           ;
  size_t alpha_size = 0;
...
void VP8EncInitAlpha(VP8Encoder* const enc) {
  ...
  enc->alpha_data_ = 
# 401 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                    ((void *)0)
# 401 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                        ;
  ...
  if (enc->thread_level_ > 0) {
    ...
    worker->data1 = enc;
    worker->data2 = 
# 407 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                   ((void *)0)
# 407 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                       ;
...
# 423 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                                  ((void *)0)
# 423 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                                      );
    }
  }
  return 1;
...
int VP8EncDeleteAlpha(VP8Encoder* const enc) {
  ...
  enc->alpha_data_ = 
# 449 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c" 3 4
                    ((void *)0)
# 449 "/doner/libwebp/libwebp-31bea324/src/enc/alpha_enc.c"
                        ;
  enc->alpha_data_size_ = 0;
  enc->has_alpha_ = 0;
  return ok;
