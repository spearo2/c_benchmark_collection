# 1 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 2
...
static int EmitFancyRGB(const VP8Io* const io, WebPDecParams* const p) {
  ...
  if (y == 0) {
    ...
    upsample(cur_y, 
# 74 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                   ((void *)0)
# 74 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
...
# 74 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
  ...
  if (io->crop_top + y_end < io->crop_bottom) {
    ...
    if (!(y_end & 1)) {
      upsample(cur_y, 
# 106 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                     ((void *)0)
# 106 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                         , cur_u, cur_v, cur_u, cur_v,
               dst + buf->stride, 
# 107 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                                 ((void *)0)
# 107 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                     , mb_w);
    }
  }
...
# 134 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
 ((void) (0))
# 134 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                       ;
  if (alpha != 
# 135 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
              ((void *)0)
# 135 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                  ) {
    for (j = 0; j < mb_h; ++j) {
...
# 141 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                      ((void *)0)
# 141 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                          ) {
...
static int EmitAlphaRGB(const VP8Io* const io, WebPDecParams* const p,
  ...
  const uint8_t* alpha = io->a;
  if (alpha != 
# 177 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
              ((void *)0)
# 177 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                  ) {
    const int mb_w = io->mb_w;
...
# 190 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 190 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                             ;
...
static int EmitAlphaRGBA4444(const VP8Io* const io, WebPDecParams* const p,
  ...
  const uint8_t* alpha = io->a;
  if (alpha != 
# 203 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
              ((void *)0)
# 203 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                  ) {
    const int mb_w = io->mb_w;
    const WEBP_CSP_MODE colorspace = p->output->colorspace;
    const WebPRGBABuffer* const buf = &p->output->u.RGBA;
...
# 228 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 228 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                             ;
...
static int EmitRescaledYUV(const VP8Io* const io, WebPDecParams* const p) {
  ...
  int num_lines_out = 0;
  if (WebPIsAlphaMode(p->output->colorspace) && io->a != 
# 257 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                                                        ((void *)0)
# 257 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                            ) {
...
static int EmitRescaledAlphaYUV(const VP8Io* const io, WebPDecParams* const p,
  ...
  if (io->a != 
# 275 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
              ((void *)0)
# 275 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                  ) {
    uint8_t* const dst_y = buf->y + (size_t)p->last_y * buf->y_stride;
    const int num_lines_out = Rescale(io->a, io->width, io->mb_h, p->scaler_a);
    
# 278 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 278 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                  ;
    if (num_lines_out > 0) {
...
# 283 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                      ((void *)0)
# 283 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                          ) {

    
# 285 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 285 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                                  ;
...
static int InitYUVRescaler(const VP8Io* const io, WebPDecParams* const p) {
  ...
  rescaler_size = num_rescalers * sizeof(*p->scaler_y) + 31;
  ...
  if (p->memory == 
# 321 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                  ((void *)0)
# 321 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                      ) {
    return 0;
  }
  work = (rescaler_t*)p->memory;

  scalers = (WebPRescaler*)(((uintptr_t)((const uint8_t*)work + total_size - rescaler_size) + 31) & ~(uintptr_t)31)
                                                        ;
  p->scaler_y = &scalers[0];
  p->scaler_u = &scalers[1];
  p->scaler_v = &scalers[2];
  p->scaler_a = has_alpha ? &scalers[3] : 
# 331 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                                         ((void *)0)
# 331 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                             ;
...
# 371 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 371 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                    ;
    
# 372 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 372 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                       ;
...
# 402 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
     ((void) (0))
# 402 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                     ;
      uv_j += u_lines_in;
    }
...
# 424 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 424 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                    ;
...
# 455 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
   ((void) (0))
# 455 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                                    ;
    WebPRescalerExportRow(p->scaler_a);
    for (i = 0; i < width; ++i) {
...
static int EmitRescaledAlphaRGB(const VP8Io* const io, WebPDecParams* const p,
                                int expected_num_out_lines) {
  if (io->a != 
# 474 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
              ((void *)0)
# 474 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                  ) {
...
static int InitRGBRescaler(const VP8Io* const io, WebPDecParams* const p) {
  ...
  p->memory = WebPSafeMalloc(1ULL, (size_t)total_size);
  if (p->memory == 
# 513 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                  ((void *)0)
# 513 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                      ) {
    return 0;
  }
  work = (rescaler_t*)p->memory;
  ...
  p->scaler_v = &scalers[2];
  p->scaler_a = has_alpha ? &scalers[3] : 
# 524 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                                         ((void *)0)
# 524 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                                             ;
...
static int CustomSetup(VP8Io* io) {
  ...
  p->memory = 
# 569 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
             ((void *)0)
# 569 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                 ;
  p->emit = 
# 570 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
           ((void *)0)
# 570 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
               ;
  p->emit_alpha = 
# 571 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                 ((void *)0)
# 571 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                     ;
  p->emit_alpha_row = 
# 572 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                     ((void *)0)
# 572 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                         ;
  ...
  if (io->use_scaling) {
    ...
    if (is_rgb) {
      ...
      if (io->fancy_upsampling) {
        ...
        if (p->memory == 
# 596 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                        ((void *)0)
# 596 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                            ) {
          return 0;
        }
...
# 631 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
 ((void) (0))
# 631 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                        ;
  ...
  if (p->emit_alpha != 
# 637 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
                      ((void *)0)
# 637 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                          ) {
...
static void CustomTeardown(const VP8Io* io) {
  ...
  p->memory = 
# 649 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c" 3 4
             ((void *)0)
# 649 "/doner/libwebp/libwebp-31bea324/src/dec/io_dec.c"
                 ;
}
