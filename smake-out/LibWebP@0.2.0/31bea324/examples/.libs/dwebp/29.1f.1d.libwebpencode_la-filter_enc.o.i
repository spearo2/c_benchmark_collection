# 1 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c" 2
# 24 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
static const uint8_t kLevelsFromDelta[8][64] = {
...
int VP8FilterStrengthFromDelta(int sharpness, int delta) {
  const int pos = (delta < 64) ? delta : 64 - 1;
  
# 61 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c" 3 4
 ((void) (0))
# 61 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
                                         ;
...
static void DoFilter(const VP8EncIterator* const it, int level) {
  ...
  uint8_t* const y_dst = it->yuv_out2_ + (0);
  uint8_t* const u_dst = it->yuv_out2_ + (16);
  uint8_t* const v_dst = it->yuv_out2_ + (16 + 8);


  memcpy(y_dst, it->yuv_out_, (32 * 16) * sizeof(uint8_t));
...
static double GetMBSSIM(const uint8_t* yuv1, const uint8_t* yuv2) {
  ...
  for (y = 3; y < 16 - 3; y++) {
    for (x = 3; x < 16 - 3; x++) {
      sum += VP8SSIMGetClipped(yuv1 + (0), 32, yuv2 + (0), 32,
                               x, y, 16, 16);
    }
  }
  for (x = 1; x < 7; x++) {
    for (y = 1; y < 7; y++) {
      sum += VP8SSIMGetClipped(yuv1 + (16), 32, yuv2 + (16), 32,
                               x, y, 8, 8);
      sum += VP8SSIMGetClipped(yuv1 + (16 + 8), 32, yuv2 + (16 + 8), 32,
                               x, y, 8, 8);
    }
  }
  return sum;
...
void VP8InitFilter(VP8EncIterator* const it) {
  ...
  if (it->lf_stats_ != 
# 142 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c" 3 4
                      ((void *)0)
# 142 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
                          ) {
    int s, i;
...
void VP8StoreFilterStats(VP8EncIterator* const it) {
  ...
  if (it->lf_stats_ == 
# 168 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c" 3 4
                      ((void *)0)
# 168 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
                          ) return;
...
void VP8AdjustFilterStrength(VP8EncIterator* const it) {
  ...
  if (it->lf_stats_ != 
# 197 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c" 3 4
                      ((void *)0)
# 197 "/doner/libwebp/libwebp-31bea324/src/enc/filter_enc.c"
                          ) {
    int s;
    for (s = 0; s < NUM_MB_SEGMENTS; s++) {
      int i, best_level = 0;
