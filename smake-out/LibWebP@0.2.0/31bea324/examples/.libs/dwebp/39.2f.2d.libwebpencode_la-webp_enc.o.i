# 1 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 2
...
int VP8LColorSpaceTransform(int width, int height, int bits, int quality,
                            ...
                            const WebPPicture* const pic, int percent_range,
                            int* const percent);
# 22 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 2
# 32 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
...
# 95 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
...
# 144 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
static VP8Encoder* InitVP8Encoder(const WebPConfig* const config,
  ...
  const size_t nz_size = (mb_w + 1) * sizeof(*enc->nz_) + 31;
  const size_t info_size = mb_w * mb_h * sizeof(*enc->mb_info_);
  const size_t samples_size =
      2 * top_stride * sizeof(*enc->y_top_)
      + 31;
  const size_t lf_stats_size =
      config->autofilter ? sizeof(*enc->lf_stats_) + 31 : 0;
  const size_t top_derr_size =
      (config->quality <= 98 || config->pass > 1) ?
  ...
  const uint64_t size = (uint64_t)sizeof(*enc)
                      ...
                      + nz_size
                      + lf_stats_size;
# 201 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
  mem = (uint8_t*)WebPSafeMalloc(size, sizeof(*mem));
  if (mem == 
# 202 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
            ((void *)0)
# 202 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                ) {
    WebPEncodingSetError(picture, VP8_ENC_ERROR_OUT_OF_MEMORY);
    return 
# 204 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
          ((void *)0)
# 204 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
              ;
  }
  enc = (VP8Encoder*)mem;
  mem = (uint8_t*)(((uintptr_t)(mem + sizeof(*enc)) + 31) & ~(uintptr_t)31);
  ...
  mem += preds_size;
  enc->nz_ = 1 + (uint32_t*)(((uintptr_t)(mem) + 31) & ~(uintptr_t)31);
  mem += nz_size;
  enc->lf_stats_ = lf_stats_size ? (LFStats*)(((uintptr_t)(mem) + 31) & ~(uintptr_t)31) : 
# 219 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                                                              ((void *)0)
# 219 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                                                                  ;
  mem += lf_stats_size;
  ...
  mem += 2 * top_stride;
  enc->top_derr_ = top_derr_size ? (DError*)mem : 
# 227 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                                                 ((void *)0)
# 227 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                                                     ;
  mem += top_derr_size;
  
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
 ((void) (0))
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                                    ;
...
static int DeleteVP8Encoder(VP8Encoder* enc) {
  int ok = 1;
  if (enc != 
# 256 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
            ((void *)0)
# 256 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                ) {
...
static void StoreStats(VP8Encoder* const enc) {
  ...
  if (stats != 
# 286 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
              ((void *)0)
# 286 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                  ) {
    int i, s;
...
# 308 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
 ((void) (0))
# 308 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                                        ;
  
# 309 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
 ((void) (0))
# 309 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                                 ;
...
int WebPReportProgress(const WebPPicture* const pic,
                       int percent, int* const percent_store) {
  if (percent_store != 
# 319 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                      ((void *)0) 
# 319 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
...
int WebPEncode(const WebPConfig* config, WebPPicture* pic) {
  int ok = 0;
  if (pic == 
# 332 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
            ((void *)0)
# 332 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                ) return 0;

  pic->error_code = VP8_ENC_OK;
  if (config == 
# 335 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
               ((void *)0)
# 335 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                   ) {
  ...
  if (pic->stats != 
# 346 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                   ((void *)0)
# 346 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                       ) memset(pic->stats, 0, sizeof(*pic->stats));

  if (!config->lossless) {
    VP8Encoder* enc = 
# 349 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                     ((void *)0)
# 349 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                         ;

    if (pic->use_argb || pic->y == 
# 351 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                                  ((void *)0) 
# 351 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                                       || pic->u == 
# 351 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                                                    ((void *)0) 
# 351 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
...
# 351 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
    ...
    if (enc == 
# 377 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
              ((void *)0)
# 377 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
                  ) return 0;
    ...
    if (pic->argb == 
# 398 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c" 3 4
                    ((void *)0) 
# 398 "/doner/libwebp/libwebp-31bea324/src/enc/webp_enc.c"
