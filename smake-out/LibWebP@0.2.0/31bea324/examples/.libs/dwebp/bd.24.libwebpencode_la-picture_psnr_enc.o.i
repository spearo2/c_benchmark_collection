# 1 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 2


typedef double (*AccumulateFunc)(const uint8_t* src, int src_stride,
                                 const uint8_t* ref, int ref_stride,
                                 int w, int h);
# 37 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
...
static double AccumulateSSIM(const uint8_t* src, int src_stride,
                             const uint8_t* ref, int ref_stride,
                             int w, int h) {
  const int w0 = (w < 3) ? w : 3;
  const int w1 = w - 3 - 1;
  const int h0 = (h < 3) ? h : 3;
  const int h1 = h - 3 - 1;
  int x, y;
  double sum = 0.;
  for (y = 0; y < h0; ++y) {
  ...
  for (; y < h1; ++y) {
    ...
    for (; x < w1; ++x) {
      const int off1 = x - 3 + (y - 3) * src_stride;
      const int off2 = x - 3 + (y - 3) * ref_stride;
...
int WebPPlaneDistortion(const uint8_t* src, size_t src_stride,
  ...
  uint8_t* allocated = 
# 136 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
                      ((void *)0)
# 136 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
                          ;
  const AccumulateFunc metric = (type == 0) ? AccumulateSSE :
                                (type == 1) ? AccumulateSSIM :
                                              AccumulateLSIM;
  if (src == 
# 140 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
            ((void *)0) 
# 140 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
                 || ref == 
# 140 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
                           ((void *)0) 
# 140 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
      ...
      result == 
# 142 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
               ((void *)0) 
# 142 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
                    || distortion == 
# 142 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
                                     ((void *)0)
# 142 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
  ...
  if (x_step != 1) {
    ...
    if (allocated == 
# 153 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
                    ((void *)0)
# 153 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
                        ) return 0;
    tmp1 = allocated;
...
int WebPPictureDistortion(const WebPPicture* src, const WebPPicture* ref,
  ...
  if (src == 
# 185 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
            ((void *)0) 
# 185 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
                 || ref == 
# 185 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
                           ((void *)0) 
# 185 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
      ...
      results == 
# 187 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c" 3 4
                ((void *)0)
# 187 "/doner/libwebp/libwebp-31bea324/src/enc/picture_psnr_enc.c"
                    ) {
    return 0;
  }
