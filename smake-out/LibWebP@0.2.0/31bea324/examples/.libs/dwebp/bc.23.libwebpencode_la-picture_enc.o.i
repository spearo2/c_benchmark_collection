# 1 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 2
...
int WebPPictureInitInternal(WebPPicture* picture, int version) {
  if ((((version) >> 8) != ((0x020f) >> 8))) {
    return 0;
  }
  if (picture != 
# 38 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                ((void *)0)
# 38 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                    ) {
...
int WebPValidatePicture(const WebPPicture* const picture) {
  if (picture == 
# 49 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                ((void *)0)
# 49 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                    ) return 0;
  if (picture->width <= 0 || picture->height <= 0) {
    return WebPEncodingSetError(picture, VP8_ENC_ERROR_BAD_DIMENSION);
  }
  if (picture->width <= 0 || picture->width / 4 > 0x7fffffff / 4 ||
      picture->height <= 0 || picture->height / 4 > 0x7fffffff / 4) {
    return WebPEncodingSetError(picture, VP8_ENC_ERROR_BAD_DIMENSION);
  }
...
# 65 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                         ((void *)0)
# 65 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                             ;
  picture->argb = 
# 66 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                 ((void *)0)
# 66 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                     ;
...
static void WebPPictureResetBufferYUVA(WebPPicture* const picture) {
  picture->memory_ = 
# 71 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                    ((void *)0)
# 71 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                        ;
  picture->y = picture->u = picture->v = picture->a = 
# 72 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                                                     ((void *)0)
# 72 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                                                         ;
...
int WebPPictureAllocARGB(WebPPicture* const picture) {
  ...
  memory = WebPSafeMalloc(argb_size + 31, sizeof(*picture->argb));
  if (memory == 
# 95 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
               ((void *)0)
# 95 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                   ) {
    return WebPEncodingSetError(picture, VP8_ENC_ERROR_OUT_OF_MEMORY);
  }
  picture->memory_argb_ = memory;
  picture->argb = (uint32_t*)(((uintptr_t)(memory) + 31) & ~(uintptr_t)31);
...
int WebPPictureAllocYUVA(WebPPicture* const picture) {
  ...
  if (mem == 
# 137 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
            ((void *)0)
# 137 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                ) {
    return WebPEncodingSetError(picture, VP8_ENC_ERROR_OUT_OF_MEMORY);
  }
...
int WebPPictureAlloc(WebPPicture* picture) {
  if (picture != 
# 165 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                ((void *)0)
# 165 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                    ) {
...
void WebPPictureFree(WebPPicture* picture) {
  if (picture != 
# 178 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                ((void *)0)
# 178 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                    ) {
    WebPSafeFree(picture->memory_);
    WebPSafeFree(picture->memory_argb_);
...
void WebPMemoryWriterInit(WebPMemoryWriter* writer) {
  writer->mem = 
# 189 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
               ((void *)0)
# 189 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                   ;
  writer->size = 0;
  writer->max_size = 0;
}
...
int WebPMemoryWrite(const uint8_t* data, size_t data_size,
  ...
  uint64_t next_size;
  if (w == 
# 198 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
          ((void *)0)
# 198 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
              ) {
    return 1;
  }
  ...
  if (next_size > w->max_size) {
    ...
    if (new_mem == 
# 208 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                  ((void *)0)
# 208 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                      ) {
      return 0;
    }
    if (w->size > 0) {
...
void WebPMemoryWriterClear(WebPMemoryWriter* writer) {
  if (writer != 
# 227 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
               ((void *)0)
# 227 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                   ) {
    WebPSafeFree(writer->mem);
    writer->mem = 
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
                 ((void *)0)
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                     ;
    writer->size = 0;
    writer->max_size = 0;
  }
...
static size_t Encode(const uint8_t* rgba, int width, int height, int stride,
  ...
  if (output == 
# 248 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
               ((void *)0)
# 248 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                   ) return 0;
  ...
  if (!ok) {
    ...
    *output = 
# 267 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c" 3 4
             ((void *)0)
# 267 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
                 ;
    return 0;
  }
  *output = wrt.mem;
...
# 295 "/doner/libwebp/libwebp-31bea324/src/enc/picture_enc.c"
