# 1 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 2
# 34 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
...
# 132 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
 ((void) (0))
# 132 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                    ;
...
static void SetSegmentProbas(VP8Encoder* const enc) {
  ...
  if (enc->pic_->stats != 
# 207 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                         ((void *)0)
# 207 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                             ) {
...
# 472 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
...
static void StoreSSE(const VP8EncIterator* const it) {
  ...
  enc->sse_[1] += VP8SSE8x8(in + (16), out + (16));
  enc->sse_[2] += VP8SSE8x8(in + (16 + 8), out + (16 + 8));
...
static void StoreSideInfo(const VP8EncIterator* const it) {
  ...
  if (pic->stats != 
# 496 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                   ((void *)0)
# 496 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                       ) {
    StoreSSE(it);
  ...
  if (pic->extra_info != 
# 503 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                        ((void *)0)
# 503 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                            ) {
...
static void ResetSideInfo(const VP8EncIterator* const it) {
  ...
  WebPPicture* const pic = enc->pic_;
  if (pic->stats != 
# 529 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                   ((void *)0)
# 529 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                       ) {
    memset(enc->block_count_, 0, sizeof(enc->block_count_));
  }
  ResetSSE(enc);
}
# 554 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
...
# 587 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                          ((void *)0)
# 587 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                              );
  ...
  if (s->do_size_search) {
    ...
    size = ((size + size_p0 + 1024) >> 11) + (12 + 8 + 10);
    s->value = (double)size;
  } else {
...
static int StatLoop(VP8Encoder* const enc) {
  ...
  while (num_pass_left-- > 0) {
    const int is_last_pass = (fabs(stats.dq) <= 0.4) ||
                             (num_pass_left == 0) ||
    ...
    if (enc->max_i4_header_bits_ > 0 && size_p0 > (((1 << 19) - 2048ULL) << 11)) {
      ++num_pass_left;
...
static int PostLoopFinalize(VP8EncIterator* const it, int ok) {
  ...
  if (ok) {
    ...
    if (enc->pic_->stats != 
# 709 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                           ((void *)0)
# 709 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                               ) {
      int i, s;
      for (i = 0; i <= 2; ++i) {
...
int VP8EncLoop(VP8Encoder* const enc) {
  ...
  do {
    ...
    VP8IteratorImport(&it, 
# 753 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                          ((void *)0)
# 753 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                              );
...
# 783 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
int VP8EncTokenLoop(VP8Encoder* const enc) {
...
# 802 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
 ((void) (0))
# 802 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                             ;
  
# 803 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
 ((void) (0))
# 803 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                         ;
  
# 804 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
 ((void) (0))
# 804 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                                    ;
  
# 805 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
 ((void) (0))
# 805 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                               ;
  
# 806 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
 ((void) (0))
# 806 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                          ;
  ...
  while (ok && num_pass_left-- > 0) {
    ...
    do {
      VP8ModeScore info;
      VP8IteratorImport(&it, 
# 827 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c" 3 4
                            ((void *)0)
# 827 "/doner/libwebp/libwebp-31bea324/src/enc/frame_enc.c"
                                );
      if (--cnt < 0) {
