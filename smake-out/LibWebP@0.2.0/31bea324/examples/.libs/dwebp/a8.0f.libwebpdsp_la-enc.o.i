# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 2
...
static inline int clip_max(int v, int max) {
  return (v > max) ? max : v;
}
...
# 112 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
...
# 231 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
static inline void Fill(uint8_t* dst, int value, int size) {
  int j;
  for (j = 0; j < size; ++j) {
    memset(dst + j * 32, value, size);
  }
}

static inline void VerticalPred(uint8_t* dst,
                                     const uint8_t* top, int size) {
  int j;
  if (top != 
# 241 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
            ((void *)0)
# 241 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                ) {
    for (j = 0; j < size; ++j) memcpy(dst + j * 32, top, size);
  } else {
    Fill(dst, 127, size);
  }
}

static inline void HorizontalPred(uint8_t* dst,
                                       const uint8_t* left, int size) {
  if (left != 
# 250 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
             ((void *)0)
# 250 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                 ) {
    int j;
    for (j = 0; j < size; ++j) {
...
static inline void TrueMotion(uint8_t* dst, const uint8_t* left,
  ...
  int y;
  if (left != 
# 263 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
             ((void *)0)
# 263 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                 ) {
    if (top != 
# 264 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
              ((void *)0)
# 264 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                  ) {
    ...
    if (top != 
# 282 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
              ((void *)0)
# 282 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                  ) {
...
static inline void DCMode(uint8_t* dst, const uint8_t* left,
  ...
  int j;
  if (top != 
# 295 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
            ((void *)0)
# 295 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                ) {
    for (j = 0; j < size; ++j) DC += top[j];
    if (left != 
# 297 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
               ((void *)0)
# 297 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                   ) {
...
# 303 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
                    ((void *)0)
# 303 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                        ) {
    for (j = 0; j < size; ++j) DC += left[j];
    DC += DC;
    DC = (DC + round) >> shift;
...
static void IntraChromaPreds_C(uint8_t* dst, const uint8_t* left,
  ...
  DCMode((2 * 16 * 32) + dst, left, top, 8, 8, 4);
  VerticalPred((2 * 16 * 32 + 8 * 32) + dst, top, 8);
  HorizontalPred(((2 * 16 * 32 + 8 * 32) + 1 * 16) + dst, left, 8);
  TrueMotion(((2 * 16 * 32) + 1 * 16) + dst, left, top, 8);

  dst += 8;
  if (top != 
# 325 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
            ((void *)0)
# 325 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                ) top += 8;
  if (left != 
# 326 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
             ((void *)0)
# 326 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                 ) left += 16;
  DCMode((2 * 16 * 32) + dst, left, top, 8, 8, 4);
  VerticalPred((2 * 16 * 32 + 8 * 32) + dst, top, 8);
  HorizontalPred(((2 * 16 * 32 + 8 * 32) + 1 * 16) + dst, left, 8);
...
static void Intra16Preds_C(uint8_t* dst,
  ...
  DCMode((0 * 16 * 32) + dst, left, top, 16, 16, 5);
  VerticalPred((1 * 16 * 32) + dst, top, 16);
  HorizontalPred(((1 * 16 * 32) + 16) + dst, left, 16);
  TrueMotion(((0 * 16 * 32) + 16) + dst, left, top, 16);
}
# 351 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
...
static void HE4(uint8_t* dst, const uint8_t* top) {
  ...
  const int K = top[-4];
  const int L = top[-5];
  WebPUint32ToMem(dst + 0 * 32, 0x01010101U * ((uint8_t)(((X) + 2 * (I) + (J) + 2) >> 2)));
  WebPUint32ToMem(dst + 1 * 32, 0x01010101U * ((uint8_t)(((I) + 2 * (J) + (K) + 2) >> 2)));
  WebPUint32ToMem(dst + 2 * 32, 0x01010101U * ((uint8_t)(((J) + 2 * (K) + (L) + 2) >> 2)));
  WebPUint32ToMem(dst + 3 * 32, 0x01010101U * ((uint8_t)(((K) + 2 * (L) + (L) + 2) >> 2)));
}
...
static void RD4(uint8_t* dst, const uint8_t* top) {
  ...
  dst[(0) + (2) * 32] = dst[(1) + (3) * 32] = ((uint8_t)(((I) + 2 * (J) + (K) + 2) >> 2));
  dst[(0) + (1) * 32] = dst[(1) + (2) * 32] = dst[(2) + (3) * 32] = ((uint8_t)(((X) + 2 * (I) + (J) + 2) >> 2));
  dst[(0) + (0) * 32] = dst[(1) + (1) * 32] = dst[(2) + (2) * 32] = dst[(3) + (3) * 32] = ((uint8_t)(((A) + 2 * (X) + (I) + 2) >> 2));
  dst[(1) + (0) * 32] = dst[(2) + (1) * 32] = dst[(3) + (2) * 32] = ((uint8_t)(((B) + 2 * (A) + (X) + 2) >> 2));
  dst[(2) + (0) * 32] = dst[(3) + (1) * 32] = ((uint8_t)(((C) + 2 * (B) + (A) + 2) >> 2));
...
static void Intra4Preds_C(uint8_t* dst, const uint8_t* top) {
  DC4((3 * 16 * 32 + 0) + dst, top);
  TM4(((3 * 16 * 32 + 0) + 4) + dst, top);
  VE4(((3 * 16 * 32 + 0) + 8) + dst, top);
  HE4(((3 * 16 * 32 + 0) + 12) + dst, top);
  RD4(((3 * 16 * 32 + 0) + 16) + dst, top);
  VR4(((3 * 16 * 32 + 0) + 20) + dst, top);
  LD4(((3 * 16 * 32 + 0) + 24) + dst, top);
  VL4(((3 * 16 * 32 + 0) + 28) + dst, top);
  HD4((3 * 16 * 32 + 4 * 32) + dst, top);
  HU4(((3 * 16 * 32 + 4 * 32) + 4) + dst, top);
}
...
static inline int GetSSE(const uint8_t* a, const uint8_t* b,
                              int w, int h) {
  int count = 0;
  int y, x;
  for (y = 0; y < h; ++y) {
...
# 590 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
...
static inline void Copy(const uint8_t* src, uint8_t* dst, int w, int h) {
  int y;
  for (y = 0; y < h; ++y) {
    memcpy(dst, src, w);
    src += 32;
...
static void VP8EncDspInit_body(void); void VP8EncDspInit(void) { do { static volatile VP8CPUInfo VP8EncDspInit_body_last_cpuinfo_used = (VP8CPUInfo)&VP8EncDspInit_body_last_cpuinfo_used; static pthread_mutex_t VP8EncDspInit_body_lock = 
# 743 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
{ { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 743 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
; if (pthread_mutex_lock(&VP8EncDspInit_body_lock)) break; if (VP8EncDspInit_body_last_cpuinfo_used != VP8GetCPUInfo) VP8EncDspInit_body(); VP8EncDspInit_body_last_cpuinfo_used = VP8GetCPUInfo; (void)pthread_mutex_unlock(&VP8EncDspInit_body_lock); } while (0); } static void VP8EncDspInit_body(void) {
  VP8DspInit();
  InitTables();
  ...
  if (VP8GetCPUInfo != 
# 776 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
                      ((void *)0)
# 776 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                          ) {
...
# 802 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
  }
# 811 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
  
# 811 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 811 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                              ;
  
# 812 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 812 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                              ;
  
# 813 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 813 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                 ;
  
# 814 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 814 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                             ;
  
# 815 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 815 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                               ;
  
# 816 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 816 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                    ;
  
# 817 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 817 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                            ;
  
# 818 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 818 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                           ;
  
# 819 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 819 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                          ;
  
# 820 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 820 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                          ;
  
# 821 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 821 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                    ;
  
# 822 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 822 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                      ;
  
# 823 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 823 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                               ;
  
# 824 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 824 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                ;
  
# 825 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 825 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                 ;
  
# 826 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 826 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                  ;
  
# 827 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 827 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                            ;
  
# 828 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 828 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                                       ;
  
# 829 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 829 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                           ;
  
# 830 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c" 3 4
 ((void) (0))
# 830 "/doner/libwebp/libwebp-31bea324/src/dsp/enc.c"
                            ;
}
