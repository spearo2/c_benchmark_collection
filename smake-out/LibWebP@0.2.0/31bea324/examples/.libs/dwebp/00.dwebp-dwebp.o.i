# 1 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
# 14 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2


# 1 "../src/webp/config.h" 1
# 21 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
...
# 24 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
# 1 "/doner/libwebp/libwebp-31bea324/examples/../imageio/image_enc.h" 1
# 20 "/doner/libwebp/libwebp-31bea324/examples/../imageio/image_enc.h"
# 1 "../src/webp/config.h" 1
# 21 "/doner/libwebp/libwebp-31bea324/examples/../imageio/image_enc.h" 2
...
extern __attribute__ ((visibility ("default"))) VP8StatusCode WebPDecode(const uint8_t* data, size_t data_size,
                                     WebPDecoderConfig* config);
# 25 "/doner/libwebp/libwebp-31bea324/examples/../imageio/image_enc.h" 2
...
int WebPWrite16bAsPGM(FILE* fout, const struct WebPDecBuffer* const buffer);
# 25 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
# 1 "/doner/libwebp/libwebp-31bea324/examples/../imageio/webpdec.h" 1
# 21 "/doner/libwebp/libwebp-31bea324/examples/../imageio/webpdec.h"
struct Metadata;
struct WebPPicture;
...
# 26 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
...
# 27 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
# 1 "/doner/libwebp/libwebp-31bea324/examples/./unicode.h" 1
# 28 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 2
...
static int SaveOutput(const WebPDecBuffer* const buffer,
  ...
  const int use_stdout = (out_file != 
# 46 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                                     ((void *)0)
# 46 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                         ) && !strcmp(out_file, "-");
  int ok = 1;
  ...
  if (ok) {
    if (!quiet) {
      if (use_stdout) {
        fprintf(
# 58 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
               stderr
# 58 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                     , "Saved to stdout\n");
      } else {
        fprintf(
# 60 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
       stderr
# 60 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
       , "Saved file %s\n", (const char*)out_file);
      }
    }
    if (verbose) {
      ...
      fprintf(
# 65 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
             stderr
# 65 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                   , "Time to write output: %.3fs\n", write_time);
    }
  } else {
    if (use_stdout) {
      fprintf(
# 69 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
             stderr
# 69 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                   , "Error writing to stdout !!\n");
    } else {
      fprintf(
# 71 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
     stderr
# 71 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
...
# 119 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                            ((void *)0)
# 119 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                ;
  ...
  if (format >= RGB && format <= rgbA_4444) {
    ...
    if (external_buffer == 
# 137 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                          ((void *)0)
# 137 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                              ) return 
# 137 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                                       ((void *)0)
# 137 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
...
# 148 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
   ((void) (0))
# 148 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                          ;
    external_buffer = (uint8_t*)WebPMalloc(total_size);
    if (external_buffer == 
# 150 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                          ((void *)0)
# 150 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                              ) return 
# 150 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                                       ((void *)0)
# 150 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
    ...
    if (has_alpha) {
      ...
      output_buffer->u.YUVA.a = 
# 162 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                               ((void *)0)
# 162 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                   ;
...
# 174 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
   ((void) (0))
# 174 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                              ;
  }
...
int main(int argc, const char* argv[]) {
  int ok = 0;
  const char* in_file = 
# 182 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                       ((void *)0)
# 182 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                           ;
  const char* out_file = 
# 183 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                        ((void *)0)
# 183 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                            ;
  ...
  uint8_t* external_buffer = 
# 189 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                            ((void *)0)
# 189 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                ;
  int use_external_memory = 0;
  const uint8_t* data = 
# 191 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                       ((void *)0)
# 191 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                           ;
  ...
  if (!WebPInitDecoderConfig(&config)) {
    fprintf(
# 199 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
           stderr
# 199 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
  ...
  for (c = 1; c < argc; ++c) {
    ...
    if (!strcmp(argv[c], "-h") || !strcmp(argv[c], "-help")) {
      ...
      if (!strcmp(fmt, "RGB")) format = RGB;
        ...
        fprintf(
# 251 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
               stderr
# 251 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                     , "Can't parse pixel_format %s\n", fmt);
        parse_error = 1;
      }
      ...
      if (parse_error) {
        fprintf(
# 258 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
               stderr
# 258 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                     , "Can't parse 'external_memory' value %s\n", argv[c]);
      }
      ...
      VP8GetCPUInfo = 
# 286 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                     ((void *)0)
# 286 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                         ;
      ...
      fprintf(
# 294 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
             stderr
# 294 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                   , "Unknown option '%s'\n", argv[c]);
      Help();
      do { ; return (-1); } while (0);
    } else {
  ...
  if (in_file == 
# 307 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                ((void *)0)
# 307 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                    ) {
    fprintf(
# 308 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
           stderr
# 308 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                 , "missing input file!!\n");
    Help();
    do { ; return (-1); } while (0);
  }
...

  {
    ...
    if (use_external_memory > 0 && format >= RGB) {
      external_buffer = AllocateExternalBuffer(&config, format,
                                               use_external_memory);
      if (external_buffer == 
# 369 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                            ((void *)0)
# 369 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                                ) goto Exit;
    }

    {
      ...
      if (verbose) {
        ...
        fprintf(
# 383 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
               stderr
# 383 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                     , "Time to decode picture: %.3fs\n", decode_time);
      }
    }
  ...
  if (out_file != 
# 394 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
                 ((void *)0)
# 394 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                     ) {
    if (!quiet) {
      fprintf(
# 396 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
     stderr
# 396 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
     , "Decoded %s.", (const char*)in_file);
      fprintf(
# 397 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
             stderr
# 397 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                   , " Dimensions: %d x %d %s. Format: %s. Now saving...\n",
    ...
    if (!quiet) {
      fprintf(
# 405 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
     stderr
# 405 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
     , "File %s can be decoded ", (const char*)in_file);
      fprintf(
# 406 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
             stderr
# 406 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                   , "(dimensions: %d x %d %s. Format: %s).\n",
              output_buffer->width, output_buffer->height,
              bitstream->has_alpha ? " (with alpha)" : "",
              kFormatType[bitstream->format]);
      fprintf(
# 410 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c" 3 4
             stderr
# 410 "/doner/libwebp/libwebp-31bea324/examples/dwebp.c"
                   , "Nothing written; "
