# 1 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
# 12 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
# 1 "/doner/libwebp/libwebp-31bea324/imageio/./jpegdec.h" 1
# 15 "/doner/libwebp/libwebp-31bea324/imageio/./jpegdec.h"
...
# 16 "/doner/libwebp/libwebp-31bea324/imageio/./jpegdec.h" 2
...
# 13 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2


# 1 "../src/webp/config.h" 1
# 16 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
extern boolean jpeg_read_icc_profile(j_decompress_ptr cinfo,
                                      JOCTET **icc_data_ptr,
                                      unsigned int *icc_data_len);
# 22 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 24 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 25 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 26 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 28 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 29 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
...
# 30 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 2
# 41 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
typedef struct {
  const uint8_t* data;
  size_t data_length;
  int seq;
...
static void SaveMetadataMarkers(j_decompress_ptr dinfo) {
  ...
  jpeg_save_markers(dinfo, (
# 49 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                          0xE0 
# 49 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                          + 1), max_marker_length);
  jpeg_save_markers(dinfo, (
# 50 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                          0xE0 
# 50 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                          + 2), max_marker_length);
}
...
static int StoreICCP(j_decompress_ptr dinfo, MetadataPayload* const iccp) {
  ...
  static const size_t kICCPSignatureLength = 12;
  static const size_t kICCPSkipLength = 14;
  ...
  for (marker = dinfo->marker_list; marker != 
# 75 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                                             ((void *)0)
# 75 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                                 ; marker = marker->next) {
    if (marker->marker == (
# 76 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                         0xE0 
# 76 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                         + 2) &&
      ...
      if (segment_size == 0 || count == 0 || seq == 0) {
        fprintf(
# 86 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
               stderr
# 86 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
      ...
      if (expected_count == 0) {
        ...
        fprintf(
# 95 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
               stderr
# 95 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                     , "[ICCP] Inconsistent segment count (%d / %d)!\n",
                expected_count, count);
        return 0;
      }
      ...
      if (segment->data_length != 0) {
        fprintf(
# 102 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
               stderr
# 102 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                     , "[ICCP] Duplicate segment number (%d)!\n" , seq);
        return 0;
      }
  ...
  if (seq_max != actual_count) {
    fprintf(
# 117 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
           stderr
# 117 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                 , "[ICCP] Discontinuous segments, expected: %d actual: %d!\n",
            actual_count, seq_max);
    return 0;
  }
  if (expected_count != actual_count) {
    fprintf(
# 122 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
           stderr
# 122 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                 , "[ICCP] Segment count: %d does not match expected: %d!\n",
  ...
  if (iccp->bytes == 
# 133 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                    ((void *)0)
# 133 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                        ) return 0;
...
static int ExtractMetadataFromJPEG(j_decompress_ptr dinfo,
  ...
  static const struct {
    ...
    { (
# 159 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
     0xE0 
# 159 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
     + 1), "Exif\0", 6, 
# 159 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                                                    __builtin_offsetof (
# 159 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
...
# 159 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
    ...
    { (
# 162 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
     0xE0 
# 162 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
     + 1), "http://ns.adobe.com/xap/1.0/", 29, 
# 162 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                                                    __builtin_offsetof (
# 162 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                                    Metadata
...
# 162 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
    ...
    { 0, 
# 163 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
        ((void *)0)
# 163 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
            , 0, 0 },
  };
  jpeg_saved_marker_ptr marker;
  ...
  for (marker = dinfo->marker_list; marker != 
# 169 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                                             ((void *)0)
# 169 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                                 ; marker = marker->next) {
    int i;
    for (i = 0; kJPEGMetadataMap[i].marker != 0; ++i) {
      if (marker->marker == kJPEGMetadataMap[i].marker &&
        ...
        if (payload->bytes == 
# 180 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                             ((void *)0)
# 180 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                 ) {
          ...
          fprintf(
# 187 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                 stderr
# 187 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                       , "Ignoring additional '%s' marker\n",
...
static void my_error_exit(j_common_ptr dinfo) {
  ...
  fprintf(
# 209 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
         stderr
# 209 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
               , "libjpeg error: ");
...
# 228 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
 ((
# 228 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
 cinfo
# 228 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
 )->err->msg_code = (
# 228 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
...
# 228 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                               ;
  return 
# 229 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
        0
# 229 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
             ;
}
...
static void ContextSetup(volatile struct jpeg_decompress_struct* const cinfo,
  ...
  ctx->pub.next_input_byte = 
# 255 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                            ((void *)0)
# 255 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                ;
}
...
int ReadJPEG(const uint8_t* const data, size_t data_size,
  ...
  uint8_t* volatile rgb = 
# 266 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                         ((void *)0)
# 266 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                             ;
  JSAMPROW buffer[1];
  JPEGReadContext ctx;

  if (data == 
# 270 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
             ((void *)0) 
# 270 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                  || data_size == 0 || pic == 
# 270 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                                              ((void *)0)
# 270 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
  ...
  memset((j_decompress_ptr)&dinfo, 0, sizeof(dinfo));
  dinfo.err = jpeg_std_error(&jerr.pub);
  jerr.pub.error_exit = my_error_exit;

  if (
# 281 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
     _setjmp (
# 281 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
     jerr.setjmp_buffer
# 281 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
     )
# 281 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
...
# 288 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
 jpeg_CreateDecompress((
# 288 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
...
# 288 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
  ...
  if (metadata != 
# 290 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                 ((void *)0)
# 290 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                     ) SaveMetadataMarkers((j_decompress_ptr)&dinfo);
  jpeg_read_header((j_decompress_ptr)&dinfo, 
# 291 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                                            1
# 291 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                                );

  dinfo.out_color_space = JCS_RGB;
  dinfo.do_fancy_upsampling = 
# 294 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                             1
# 294 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                                 ;
  ...
  if (rgb == 
# 312 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
            ((void *)0)
# 312 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                ) {
    goto Error;
  }
  ...
  if (metadata != 
# 324 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
                 ((void *)0)
# 324 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                     ) {
    ok = ExtractMetadataFromJPEG((j_decompress_ptr)&dinfo, metadata);
    if (!ok) {
      fprintf(
# 327 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c" 3 4
             stderr
# 327 "/doner/libwebp/libwebp-31bea324/imageio/jpegdec.c"
                   , "Error extracting JPEG metadata!\n");
      goto Error;
    }
  }
