# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
# 12 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 13 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c" 2
...
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c" 2
...
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c" 3 4
   ((void) (0))
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
                 ;
    cost += VP8LevelCost(t, v);
    if (n < 15) {
...
# 361 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c" 3 4
 ((void) (0))
# 361 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
                                          ;
  for (n = 15; n >= 0; --n) {
    if (coeffs[n]) {
      res->last = n;
...
static void VP8EncDspCostInit_body(void); void VP8EncDspCostInit(void) { do { static volatile VP8CPUInfo VP8EncDspCostInit_body_last_cpuinfo_used = (VP8CPUInfo)&VP8EncDspCostInit_body_last_cpuinfo_used; static pthread_mutex_t VP8EncDspCostInit_body_lock = 
# 383 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c" 3 4
{ { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 383 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
; if (pthread_mutex_lock(&VP8EncDspCostInit_body_lock)) break; if (VP8EncDspCostInit_body_last_cpuinfo_used != VP8GetCPUInfo) VP8EncDspCostInit_body(); VP8EncDspCostInit_body_last_cpuinfo_used = VP8GetCPUInfo; (void)pthread_mutex_unlock(&VP8EncDspCostInit_body_lock); } while (0); } static void VP8EncDspCostInit_body(void) {
  VP8GetResidualCost = GetResidualCost_C;
  VP8SetResidualCoeffs = SetResidualCoeffs_C;


  if (VP8GetCPUInfo != 
# 388 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c" 3 4
                      ((void *)0)
# 388 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
                          ) {
# 400 "/doner/libwebp/libwebp-31bea324/src/dsp/cost.c"
