# 1 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
# 1 "/doner/libwebp/libwebp-31bea324/sharpyuv//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
# 14 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
# 1 "../sharpyuv/sharpyuv_cpu.h" 1
# 20 "../sharpyuv/sharpyuv_cpu.h"
# 1 "../src/dsp/cpu.h" 1
# 17 "../src/dsp/cpu.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 18 "../src/dsp/cpu.h" 2
...
# 21 "../sharpyuv/sharpyuv_cpu.h" 2
# 24 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
# 1 "../sharpyuv/sharpyuv_dsp.h" 1
# 18 "../sharpyuv/sharpyuv_dsp.h"
...
# 25 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
# 1 "../sharpyuv/sharpyuv_gamma.h" 1
# 24 "../sharpyuv/sharpyuv_gamma.h"
...
uint16_t SharpYuvLinearToGamma(uint32_t value, int bit_depth,
                               SharpYuvTransferFunctionType transfer_type);
# 26 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 2
...
static const int kYuvHalf = 1 << (16 - 1);
...
static inline void UpdateW(const fixed_y_t* src, fixed_y_t* dst, int w,
                                int rgb_bit_depth,
                                SharpYuvTransferFunctionType transfer_type) {
  const int bit_depth = rgb_bit_depth + GetPrecisionShift(rgb_bit_depth);
  int i;
...
# 132 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
 ((void) (0))
# 132 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
              ;
  for (i = 0; i < w; ++i) {
...
static inline fixed_y_t Filter2(int A, int B, int W0, int bit_depth) {
...
static inline int Shift(int v, int shift) {
...
static inline int RGBToYUVComponent(int r, int g, int b,
                                         const int coeffs[4], int sfix) {
  const int srounder = 1 << (16 + sfix - 1);
...
static void* SafeMalloc(uint64_t nmemb, size_t size) {
  ...
  if (total_size != (size_t)total_size) return 
# 291 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                                              ((void *)0)
# 291 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                                                  ;
...
static int DoSharpArgbToYuv(const uint8_t* r_ptr, const uint8_t* g_ptr,
  ...
  fixed_y_t* const tmp_buffer = ((fixed_y_t*)SafeMalloc((w * 3) * (2), sizeof(fixed_y_t)));
  fixed_y_t* const best_y_base = ((fixed_y_t*)SafeMalloc((w) * (h), sizeof(fixed_y_t)));
  fixed_y_t* const target_y_base = ((fixed_y_t*)SafeMalloc((w) * (h), sizeof(fixed_y_t)));
  fixed_y_t* const best_rgb_y = ((fixed_y_t*)SafeMalloc((w) * (2), sizeof(fixed_y_t)));
  fixed_t* const best_uv_base = ((fixed_t*)SafeMalloc((uv_w * 3) * (uv_h), sizeof(fixed_t)));
  fixed_t* const target_uv_base = ((fixed_t*)SafeMalloc((uv_w * 3) * (uv_h), sizeof(fixed_t)));
  fixed_t* const best_rgb_uv = ((fixed_t*)SafeMalloc((uv_w * 3) * (1), sizeof(fixed_t)));
...
# 328 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
 ((void) (0))
# 328 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
              ;
  
# 329 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
 ((void) (0))
# 329 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
              ;

  if (best_y_base == 
# 331 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                    ((void *)0) 
# 331 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                         || best_uv_base == 
# 331 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                                            ((void *)0) 
# 331 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                                                 ||
      target_y_base == 
# 332 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                      ((void *)0) 
# 332 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                           || target_uv_base == 
# 332 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                                                ((void *)0) 
# 332 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                                                     ||
      best_rgb_y == 
# 333 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                   ((void *)0) 
# 333 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                        || best_rgb_uv == 
# 333 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                                          ((void *)0) 
# 333 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                                               ||
      tmp_buffer == 
# 334 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                   ((void *)0)
# 334 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                       ) {
    ok = 0;
    goto End;
  }
...
# 451 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
extern VP8CPUInfo SharpYuvGetCPUInfo;
extern __attribute__((visibility("default"))) void SharpYuvInit(VP8CPUInfo cpu_info_func);
void SharpYuvInit(VP8CPUInfo cpu_info_func) {
  static volatile VP8CPUInfo sharpyuv_last_cpuinfo_used =
      (VP8CPUInfo)&sharpyuv_last_cpuinfo_used;
  static pthread_mutex_t sharpyuv_lock = 
# 456 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
 { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 456 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
 ; if (pthread_mutex_lock(&sharpyuv_lock)) return;
  ...
  if (sharpyuv_last_cpuinfo_used == SharpYuvGetCPUInfo) {
    do { (void)pthread_mutex_unlock(&sharpyuv_lock); return; } while (0);
  }
...
int SharpYuvOptionsInitInternal(const SharpYuvConversionMatrix* yuv_matrix,
  ...
  if (options == 
# 490 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                ((void *)0) 
# 490 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                     || yuv_matrix == 
# 490 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                                      ((void *)0) 
# 490 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
...
int SharpYuvConvertWithOptions(const void* r_ptr, const void* g_ptr,
  ...
  if (width < 1 || height < 1 || width == 0x7fffffff || height == 0x7fffffff ||
      r_ptr == 
# 516 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
              ((void *)0) 
# 516 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                   || g_ptr == 
# 516 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                               ((void *)0) 
# 516 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
...
# 516 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                                                                      ||
      u_ptr == 
# 517 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
              ((void *)0) 
# 517 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
                   || v_ptr == 
# 517 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c" 3 4
                               ((void *)0)
# 517 "/doner/libwebp/libwebp-31bea324/sharpyuv/sharpyuv.c"
