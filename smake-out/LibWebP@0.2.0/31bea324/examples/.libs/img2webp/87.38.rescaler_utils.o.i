# 1 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 19 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 2
...
int WebPRescalerInit(WebPRescaler* const rescaler,
  ...
  if (!rescaler->x_expand) {
    rescaler->fx_scale = ((uint32_t)(((uint64_t)(1) << 32) / (rescaler->x_sub)));
  }
  ...
  if (!rescaler->y_expand) {
    ...
    const uint64_t num = (uint64_t)dst_height * (1ull << 32);
    ...
    rescaler->fy_scale = ((uint32_t)(((uint64_t)(1) << 32) / (rescaler->y_sub)));
  } else {
    rescaler->fy_scale = ((uint32_t)(((uint64_t)(1) << 32) / (rescaler->x_add)));
...
# 88 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 3 4
 ((void) (0))
# 88 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c"
                             ;
  
# 89 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c" 3 4
 ((void) (0))
# 89 "/doner/libwebp/libwebp-31bea324/src/utils/rescaler_utils.c"
                              ;
  {
    int width = *scaled_width;
    int height = *scaled_height;
    const int max_size = 0x7fffffff / 2;
