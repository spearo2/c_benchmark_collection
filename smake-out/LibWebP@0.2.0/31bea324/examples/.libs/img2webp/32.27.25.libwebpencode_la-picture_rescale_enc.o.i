# 1 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 17 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 2
...
# 32 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
 ((void) (0))
# 32 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                                   ;
  *dst = *src;
...
int WebPPictureCopy(const WebPPicture* src, WebPPicture* dst) {
  if (src == 
# 62 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
            ((void *)0) 
# 62 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                 || dst == 
# 62 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                           ((void *)0)
# 62 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
  ...
  if (!src->use_argb) {
    ...
    WebPCopyPlane(src->u, src->uv_stride, dst->u, dst->uv_stride,
                  (((dst->width) + 1) >> 1), (((dst->height) + 1) >> 1));
    WebPCopyPlane(src->v, src->uv_stride, dst->v, dst->uv_stride,
                  (((dst->width) + 1) >> 1), (((dst->height) + 1) >> 1));
    if (dst->a != 
# 75 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                 ((void *)0)
# 75 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                     ) {
...
int WebPPictureIsView(const WebPPicture* picture) {
  if (picture == 
# 89 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                ((void *)0)
# 89 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                    ) return 0;
  if (picture->use_argb) {
    return (picture->memory_argb_ == 
# 91 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                                    ((void *)0)
# 91 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                                        );
  }
  return (picture->memory_ == 
# 93 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                             ((void *)0)
# 93 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                                 );
}
...
int WebPPictureView(const WebPPicture* src,
                    ...
                    WebPPicture* dst) {
  if (src == 
# 99 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
            ((void *)0) 
# 99 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                 || dst == 
# 99 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                           ((void *)0)
# 99 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
  ...
  if (!src->use_argb) {
    ...
    if (src->a != 
# 115 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                 ((void *)0)
# 115 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                     ) {
...
int WebPPictureCrop(WebPPicture* pic,
  ...
  if (pic == 
# 134 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
            ((void *)0)
# 134 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                ) return 0;
  ...
  if (!pic->use_argb) {
    ...
    if (tmp.a != 
# 154 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                ((void *)0)
# 154 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                    ) {
...
# 195 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
 ((void) (0))
# 195 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                          ;
...
static void AlphaMultiplyY(WebPPicture* const pic, int inverse) {
  if (pic->a != 
# 201 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
               ((void *)0)
# 201 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                   ) {
...
int WebPPictureRescale(WebPPicture* picture, int width, int height) {
  ...
  if (picture == 
# 212 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                ((void *)0)
# 212 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                    ) return 0;
  ...
  if (!picture->use_argb) {
    ...
    if (work == 
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
               ((void *)0)
# 229 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                   ) {
      WebPPictureFree(&tmp);
    ...
    if (picture->a != 
# 234 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
                     ((void *)0)
# 234 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                         ) {
    ...
    if (!RescalePlane(picture->y, prev_width, prev_height, picture->y_stride,
        ...
        !RescalePlane(picture->u, (((prev_width) + 1) >> 1), (((prev_height) + 1) >> 1),
                      picture->uv_stride, tmp.u, (((width) + 1) >> 1), (((height) + 1) >> 1),
                      tmp.uv_stride, work, 1) ||
        !RescalePlane(picture->v, (((prev_width) + 1) >> 1), (((prev_height) + 1) >> 1),
    ...
    if (work == 
# 258 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c" 3 4
               ((void *)0)
# 258 "/doner/libwebp/libwebp-31bea324/src/enc/picture_rescale_enc.c"
                   ) {
      WebPPictureFree(&tmp);
      return WebPEncodingSetError(picture, VP8_ENC_ERROR_OUT_OF_MEMORY);
    }
