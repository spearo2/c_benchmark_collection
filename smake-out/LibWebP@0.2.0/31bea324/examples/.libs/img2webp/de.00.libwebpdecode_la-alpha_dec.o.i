# 1 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 2


# 1 "../../src/utils/quant_levels_dec_utils.h" 1
# 28 "../../src/utils/quant_levels_dec_utils.h"
int WebPDequantizeLevels(uint8_t* const data, int width, int height, int stride,
                         int strength);
# 20 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 2
...
static void ALPHDelete(ALPHDecoder* const dec) {
  if (dec != 
# 34 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
            ((void *)0)
# 34 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                ) {
    VP8LDelete(dec->vp8l_dec_);
    dec->vp8l_dec_ = 
# 36 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                    ((void *)0)
# 36 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                        ;
    WebPSafeFree(dec);
  }
}
# 48 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
static int ALPHInit(ALPHDecoder* const dec, const uint8_t* data,
                    size_t data_size, const VP8Io* const src_io,
                    uint8_t* output) {
  int ok = 0;
  const uint8_t* const alpha_data = data + 1;
  const size_t alpha_data_size = data_size - 1;
  int rsrv;
  VP8Io* const io = &dec->io_;

  
# 57 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
 ((void) (0))
# 57 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                                         ;
...
# 63 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
 ((void) (0))
# 63 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                            ;
  ...
  VP8InitIo(io);
  WebPInitCustomIo(
# 83 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                  ((void *)0)
# 83 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                      , io);
  io->opaque = dec;
...
# 99 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
   ((void) (0))
# 99 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                                     ;
...
static int ALPHDecode(VP8Decoder* const dec, int row, int num_rows) {
  ...
  if (alph_dec->method_ == 0) {
    ...
    const uint8_t* deltas = dec->alpha_data_ + 1 + row * width;
    uint8_t* dst = dec->alpha_plane_ + row * width;
    
# 119 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
   ((void) (0))
# 119 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                                             ;
    
# 120 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
   ((void) (0))
# 120 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                                   ;
...
# 129 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
   ((void) (0))
# 129 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                      ;
...
# 145 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
 ((void) (0))
# 145 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                      ;
  dec->alpha_plane_mem_ =
      (uint8_t*)WebPSafeMalloc(alpha_size, sizeof(*dec->alpha_plane_));
  if (dec->alpha_plane_mem_ == 
# 148 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                              ((void *)0)
# 148 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                  ) {
    return 0;
  }
  dec->alpha_plane_ = dec->alpha_plane_mem_;
  dec->alpha_prev_line_ = 
# 152 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                         ((void *)0)
# 152 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                             ;
  return 1;
}
...
# 157 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
 ((void) (0))
# 157 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                    ;
  WebPSafeFree(dec->alpha_plane_mem_);
  dec->alpha_plane_mem_ = 
# 159 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                         ((void *)0)
# 159 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                             ;
  dec->alpha_plane_ = 
# 160 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                     ((void *)0)
# 160 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                         ;
  ALPHDelete(dec->alph_dec_);
  dec->alph_dec_ = 
# 162 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                  ((void *)0)
# 162 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                      ;
}
...
# 174 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
 ((void) (0))
# 174 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                  ;

  if (row < 0 || num_rows <= 0 || row + num_rows > height) {
    return 
# 177 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
          ((void *)0)
# 177 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
              ;
  }

  if (!dec->is_alpha_decoded_) {
    if (dec->alph_dec_ == 
# 181 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                         ((void *)0)
# 181 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                             ) {
      dec->alph_dec_ = ALPHNew();
      if (dec->alph_dec_ == 
# 183 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                           ((void *)0)
# 183 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                               ) return 
# 183 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                                        ((void *)0)
# 183 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
...
# 197 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
   ((void) (0))
# 197 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                 ;
    
# 198 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
   ((void) (0))
# 198 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                                   ;
    ...
    if (dec->is_alpha_decoded_) {
      ALPHDelete(dec->alph_dec_);
      dec->alph_dec_ = 
# 203 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
                      ((void *)0)
# 203 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
                          ;
 ...
 Error:
  ...
  return 
# 222 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c" 3 4
        ((void *)0)
# 222 "/doner/libwebp/libwebp-31bea324/src/dec/alpha_dec.c"
            ;
}
