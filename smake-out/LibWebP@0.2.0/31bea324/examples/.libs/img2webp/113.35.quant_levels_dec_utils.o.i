# 1 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c"
# 17 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c"
# 1 "../../src/utils/quant_levels_dec_utils.h" 1
# 17 "../../src/utils/quant_levels_dec_utils.h"
...
# 18 "../../src/utils/quant_levels_dec_utils.h" 2
# 28 "../../src/utils/quant_levels_dec_utils.h"
int WebPDequantizeLevels(uint8_t* const data, int width, int height, int stride,
                         int strength);
# 18 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c" 2
# 45 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c"
typedef struct {
  int width_, height_;
  int stride_;
  int row_;
...
static inline uint8_t clip_8b(int v) {
  return (!(v & (int)(~0U << (8 + 0)))) ? (uint8_t)(v >> 0) : (v < 0) ? 0u : 255u;
}
...
static void ApplyFilter(SmoothParams* const p) {
  ...
  for (x = 0; x < w; ++x) {
    ...
    if (v < p->max_ && v > p->min_) {
      const int c = (v << 0) + correction[average[x] - (v << 2)];
...
static void InitCorrectionLUT(int16_t* const lut, int min_dist) {
  ...
  const int threshold1 = min_dist << 2;
  const int threshold2 = (3 * threshold1) >> 2;
  const int max_threshold = threshold2 << 0;
  const int delta = threshold1 - threshold2;
  int i;
  for (i = 1; i <= ((1 << (8 + 2)) - 1); ++i) {
    int c = (i <= threshold2) ? (i << 0)
...
static int InitParams(uint8_t* const data, int width, int height, int stride,
  ...
  const size_t size_lut = (1 + 2 * ((1 << (8 + 2)) - 1)) * sizeof(*p->correction_);
  const size_t total_size = size_scratch_m + size_m + size_lut;
  uint8_t* mem = (uint8_t*)WebPSafeMalloc(1U, total_size);

  if (mem == 
# 226 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c" 3 4
            ((void *)0)
# 226 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c"
                ) return 0;
  p->mem_ = (void*)mem;
  ...
  p->correction_ = ((int16_t*)mem) + ((1 << (8 + 2)) - 1);
...
int WebPDequantizeLevels(uint8_t* const data, int width, int height, int stride,
  ...
  if (data == 
# 267 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c" 3 4
             ((void *)0) 
# 267 "/doner/libwebp/libwebp-31bea324/src/utils/quant_levels_dec_utils.c"
