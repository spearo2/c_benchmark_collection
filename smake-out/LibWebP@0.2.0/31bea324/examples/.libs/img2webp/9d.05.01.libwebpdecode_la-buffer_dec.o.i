# 1 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 2
...
static VP8StatusCode CheckDecBuffer(const WebPDecBuffer* const buffer) {
  ...
  if (!IsValidColorspace(mode)) {
    ...
    const uint64_t y_size = ((uint64_t)(y_stride) * ((height) - 1) + (width));
    const uint64_t u_size = ((uint64_t)(u_stride) * ((uv_height) - 1) + (uv_width));
    const uint64_t v_size = ((uint64_t)(v_stride) * ((uv_height) - 1) + (uv_width));
    const uint64_t a_size = ((uint64_t)(a_stride) * ((height) - 1) + (width));
    ...
    ok &= (buf->y != 
# 66 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                    ((void *)0)
# 66 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                        );
    ok &= (buf->u != 
# 67 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                    ((void *)0)
# 67 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                        );
    ok &= (buf->v != 
# 68 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                    ((void *)0)
# 68 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                        );
    if (mode == MODE_YUVA) {
      ok &= (a_stride >= width);
      ok &= (a_size <= buf->a_size);
      ok &= (buf->a != 
# 72 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                      ((void *)0)
# 72 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                          );
    }
  } else {
    ...
    const uint64_t size =
        ((uint64_t)(stride) * ((height) - 1) + (width * kModeBpp[mode]));
    ok &= (size <= buf->size);
    ok &= (stride >= width * kModeBpp[mode]);
    ok &= (buf->rgba != 
# 81 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                       ((void *)0)
# 81 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                           );
  }
...
static VP8StatusCode AllocateBuffer(WebPDecBuffer* const buffer) {
  ...
  if (buffer->is_external_memory <= 0 && buffer->private_memory == 
# 96 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                                                                  ((void *)0)
# 96 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                                                                      ) {
    uint8_t* output;
    ...
    if (output == 
# 121 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                 ((void *)0)
# 121 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                     ) {
...
VP8StatusCode WebPFlipBuffer(WebPDecBuffer* const buffer) {
  if (buffer == 
# 153 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
               ((void *)0)
# 153 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                   ) {
    return VP8_STATUS_INVALID_PARAM;
  }
  if (WebPIsRGBMode(buffer->colorspace)) {
    ...
    if (buf->a != 
# 169 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                 ((void *)0)
# 169 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                     ) {
...
VP8StatusCode WebPAllocateDecBuffer(int width, int height,
  ...
  if (buffer == 
# 181 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
               ((void *)0) 
# 181 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                    || width <= 0 || height <= 0) {
    return VP8_STATUS_INVALID_PARAM;
  }
  if (options != 
# 184 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                ((void *)0)
# 184 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                    ) {
  ...
  if (options != 
# 220 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                ((void *)0) 
# 220 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                     && options->flip) {
...
int WebPInitDecBufferInternal(WebPDecBuffer* buffer, int version) {
  ...
  if (buffer == 
# 233 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
               ((void *)0)
# 233 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                   ) return 0;
...
void WebPFreeDecBuffer(WebPDecBuffer* buffer) {
  if (buffer != 
# 239 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
               ((void *)0)
# 239 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                   ) {
    if (buffer->is_external_memory <= 0) {
      WebPSafeFree(buffer->private_memory);
    }
    buffer->private_memory = 
# 243 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                            ((void *)0)
# 243 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                                ;
  }
}
...
void WebPCopyDecBuffer(const WebPDecBuffer* const src,
                       WebPDecBuffer* const dst) {
  if (src != 
# 249 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
            ((void *)0) 
# 249 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                 && dst != 
# 249 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                           ((void *)0)
# 249 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
...
# 251 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                              ((void *)0)
# 251 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                                  ) {
      dst->is_external_memory = 1;
      dst->private_memory = 
# 253 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                           ((void *)0)
# 253 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                               ;
    }
  }
}
...
void WebPGrabDecBuffer(WebPDecBuffer* const src, WebPDecBuffer* const dst) {
  if (src != 
# 260 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
            ((void *)0) 
# 260 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                 && dst != 
# 260 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                           ((void *)0)
# 260 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
    ...
    *dst = *src;
    if (src->private_memory != 
# 262 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                              ((void *)0)
# 262 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                                  ) {
      src->is_external_memory = 1;
      src->private_memory = 
# 264 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                           ((void *)0)
# 264 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                               ;
    }
  }
}
...
# 271 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
 ((void) (0))
# 271 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                                           ;
  
# 272 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
 ((void) (0))
# 272 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                                                   ;
...
# 304 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
 ((void) (0))
# 304 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                       ;
  return (output->is_external_memory >= 2) &&
         WebPIsPremultipliedMode(output->colorspace) &&
         (features != 
# 307 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c" 3 4
                     ((void *)0) 
# 307 "/doner/libwebp/libwebp-31bea324/src/dec/buffer_dec.c"
                          && features->has_alpha);
}
