# 1 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
# 13 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
# 1 "../src/webp/config.h" 1
# 14 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2


# 1 "/doner/libwebp/libwebp-31bea324/imageio/./webpdec.h" 1
# 15 "/doner/libwebp/libwebp-31bea324/imageio/./webpdec.h"
...
extern __attribute__ ((visibility ("default"))) VP8StatusCode WebPDecode(const uint8_t* data, size_t data_size,
                                     WebPDecoderConfig* config);
# 16 "/doner/libwebp/libwebp-31bea324/imageio/./webpdec.h" 2
...
VP8StatusCode DecodeWebPIncremental(
    ...
    WebPDecoderConfig* const config);
# 59 "/doner/libwebp/libwebp-31bea324/imageio/./webpdec.h"
int ReadWebP(const uint8_t* const data, size_t data_size,
             struct WebPPicture* const pic,
             int keep_alpha, struct Metadata* const metadata);
# 17 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 19 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
...
# 24 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
...
# 25 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
# 1 "/doner/libwebp/libwebp-31bea324/imageio/../examples/unicode.h" 1
# 26 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
# 1 "/doner/libwebp/libwebp-31bea324/imageio/./imageio_util.h" 1
# 17 "/doner/libwebp/libwebp-31bea324/imageio/./imageio_util.h"
# 1 "../src/webp/types.h" 1
...
# 27 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
...
# 28 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 2
...
static void PrintAnimationWarning(const WebPDecoderConfig* const config) {
  if (config->input.has_animation) {
    fprintf(
# 39 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
           stderr
# 39 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                 ,
...
void PrintWebPError(const char* const in_file, int status) {
  fprintf(
# 47 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
 stderr
# 47 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
 , "Decoding of %s failed.\n", (const char*)in_file);
  fprintf(
# 48 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
         stderr
# 48 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
               , "Status: %d", status);
  if (status >= VP8_STATUS_OK && status <= VP8_STATUS_NOT_ENOUGH_DATA) {
    fprintf(
# 50 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
           stderr
# 50 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                 , "(%s)", kStatusMessages[status]);
  }
  fprintf(
# 52 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
         stderr
# 52 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
               , "\n");
}
...
int LoadWebP(const char* const in_file,
  ...
  if (bitstream == 
# 62 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
                  ((void *)0)
# 62 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                      ) {
  ...
  if (status != VP8_STATUS_OK) {
    WebPFree((void*)*data);
    *data = 
# 69 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
           ((void *)0)
# 69 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
               ;
    *data_size = 0;
...
VP8StatusCode DecodeWebP(const uint8_t* const data, size_t data_size,
                         WebPDecoderConfig* const config) {
  if (config == 
# 81 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
               ((void *)0)
# 81 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
...
VP8StatusCode DecodeWebPIncremental(
  ...
  if (config == 
# 90 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
               ((void *)0)
# 90 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                   ) return VP8_STATUS_INVALID_PARAM;
...

  {
    ...
    if (idec == 
# 97 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
               ((void *)0)
# 97 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                   ) {
      fprintf(
# 98 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
             stderr
# 98 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                   , "Failed during WebPIDecode().\n");
...
static int ExtractMetadata(const uint8_t* const data, size_t data_size,
  ...
  if (demux == 
# 118 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
              ((void *)0)
# 118 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                  ) return 0;
  
# 119 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
 ((void) (0))
# 119 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                         ;
...
int ReadWebP(const uint8_t* const data, size_t data_size,
  ...
  if (data == 
# 153 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
             ((void *)0) 
# 153 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                  || data_size == 0 || pic == 
# 153 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
                                              ((void *)0)
# 153 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
  ...
  if (!WebPInitDecoderConfig(&config)) {
    fprintf(
# 156 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
           stderr
# 156 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
  ...
  do {
    ...
    if (pic->use_argb) {
      ...
      output_buffer->u.YUVA.a = has_alpha ? pic->a : 
# 202 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
                                                    ((void *)0)
# 202 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                                                        ;
  ...
  if (ok && metadata != 
# 234 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c" 3 4
                       ((void *)0)
# 234 "/doner/libwebp/libwebp-31bea324/imageio/webpdec.c"
                           ) {
