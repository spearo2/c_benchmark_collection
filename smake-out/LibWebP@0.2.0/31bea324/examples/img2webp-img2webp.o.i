# 1 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
# 18 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
...
# 19 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2


# 1 "../src/webp/config.h" 1
# 24 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 27 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
WebPImageReader WebPGuessImageReader(const uint8_t* const data,
                                     size_t data_size);
# 28 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 29 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 30 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
# 1 "/doner/libwebp/libwebp-31bea324/examples/./unicode.h" 1
# 31 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 32 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
# 33 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
# 1 "../src/webp/mux.h" 1
# 18 "../src/webp/mux.h"
# 1 "../src/webp/./mux_types.h" 1
# 19 "../src/webp/mux.h" 2
...
# 34 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 2
...
static int ReadImage(const char filename[], WebPPicture* const pic) {
  const uint8_t* data = 
# 81 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                       ((void *)0)
# 81 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                           ;
  size_t data_size = 0;
  ...
  ok = reader(data, data_size, pic, 1, 
# 93 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                                      ((void *)0)
# 93 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                                          );
  WebPFree((void*)data);
  return ok;
}
...
static int SetLoopCount(int loop_count, WebPData* const webp_data) {
  ...
  if (mux == 
# 104 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
            ((void *)0)
# 104 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                ) return 0;
 ...
 End:
  ...
  if (!ok) {
    fprintf(
# 126 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
           stderr
# 126 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                 , "Error during loop-count setting\n");
  }
  return ok;
}
...
int main(int argc, const char* argv[]) {
  const char* output = 
# 134 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                      ((void *)0)
# 134 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                          ;
  WebPAnimEncoder* enc = 
# 135 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                        ((void *)0)
# 135 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                            ;
  int verbose = 0;
  int pic_num = 0;
  int duration = 100;
  ...
  if (!WebPAnimEncoderOptionsInit(&anim_config) ||
      ...
      !WebPPictureInit(&pic)) {
    fprintf(
# 163 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
           stderr
# 163 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
  ...
  for (c = 0; ok && c < argc; ++c) {
    if (argv[c][0] == '-') {
      ...
      if (!strcmp(argv[c], "-o") && c + 1 < argc) {
        argv[c] = 
# 173 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 ((void *)0)
# 173 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     ;
        output = (const char*)(argv)[++c];
      } else if (!strcmp(argv[c], "-kmin") && c + 1 < argc) {
        argv[c] = 
# 176 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 ((void *)0)
# 176 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     ;
        anim_config.kmin = ExUtilGetInt(argv[++c], 0, &parse_error);
      } else if (!strcmp(argv[c], "-kmax") && c + 1 < argc) {
        argv[c] = 
# 179 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 ((void *)0)
# 179 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     ;
        anim_config.kmax = ExUtilGetInt(argv[++c], 0, &parse_error);
      } else if (!strcmp(argv[c], "-loop") && c + 1 < argc) {
        argv[c] = 
# 182 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 ((void *)0)
# 182 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     ;
        loop_count = ExUtilGetInt(argv[++c], 0, &parse_error);
        if (loop_count < 0) {
          fprintf(
# 185 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 stderr
# 185 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                       , "Invalid non-positive loop-count (%d)\n", loop_count);
          parse_error = 1;
        }
        ...
        argv[c] = 
# 194 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 ((void *)0)
# 194 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     ;
      ...
      if (!ok) goto End;
      argv[c] = 
# 219 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
               ((void *)0)
# 219 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                   ;
    } else {
      have_input |= 1;
    }
  ...
  if (!have_input) {
    fprintf(
# 225 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
           stderr
# 225 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                 , "No input file(s) for generating animation!\n");
    goto End;
  }
  ...
  for (c = 0; ok && c < argc; ++c) {
    if (argv[c] == 
# 233 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                  ((void *)0)
# 233 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                      ) continue;
    if (argv[c][0] == '-') {
      int parse_error = 0;
      if (!strcmp(argv[c], "-lossy")) {
        ...
        if (duration <= 0) {
          fprintf(
# 247 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 stderr
# 247 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                       , "Invalid negative duration (%d)\n", duration);
          parse_error = 1;
        }
      } else {
        parse_error = 1;
        fprintf(
# 252 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
               stderr
# 252 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     , "Unknown option [%s]\n", argv[c]);
      }
      ok = !parse_error;
      if (!ok) goto End;
    ...
    if (ok) {
      ...
      if (!ok) {
        fprintf(
# 262 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
               stderr
# 262 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
    ...
    pic.use_argb = 1;
    ok = ReadImage((const char*)(argv)[c], &pic);
    if (!ok) goto End;

    if (enc == 
# 272 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
              ((void *)0)
# 272 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                  ) {
      width = pic.width;
      height = pic.height;
      enc = WebPAnimEncoderNew(width, height, &anim_config);
      ok = (enc != 
# 276 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                  ((void *)0)
# 276 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                      );
      if (!ok) {
        fprintf(
# 278 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
               stderr
# 278 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     , "Could not create WebPAnimEncoder object.\n");
      }
    }
    ...
    if (ok) {
      ...
      if (!ok) {
        fprintf(
# 285 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
               stderr
# 285 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
    ...
    if (ok) {
      ...
      if (!ok) {
        fprintf(
# 294 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
               stderr
# 294 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     , "Error while adding frame #%d\n", pic_num);
      }
    }
    WebPPictureFree(&pic);
    if (!ok) goto End;
    ...
    if (verbose) {
      fprintf(
# 301 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
     stderr
# 301 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
     , "Added frame #%3d at time %4d (file: %s)\n", pic_num, timestamp_ms, (argv)[c])
                                                                 ;
    }
  ...
  ok = ok && WebPAnimEncoderAdd(enc, 
# 309 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                                    ((void *)0)
# 309 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                                        , timestamp_ms, 
# 309 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                                                        ((void *)0)
# 309 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
  ...
  if (!ok) {
    fprintf(
# 312 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
           stderr
# 312 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                 , "Error during final animation assembly.\n");
  }
 ...
 End:
  ...
  if (ok) {
    if (output != 
# 324 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
                 ((void *)0)
# 324 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                     ) {
      ok = ImgIoUtilWriteFile(output, webp_data.bytes, webp_data.size);
      if (ok) fprintf(
# 326 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
             stderr
# 326 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
             , "output file: %s     ", (const char*)output);
    } else {
      fprintf(
# 328 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
             stderr
# 328 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
  ...
  if (ok) {
    fprintf(
# 333 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c" 3 4
           stderr
# 333 "/doner/libwebp/libwebp-31bea324/examples/img2webp.c"
                 , "[%d frames, %u bytes].\n",
            pic_num, (unsigned int)webp_data.size);
  }
  WebPDataClear(&webp_data);
  ExUtilDeleteCommandLineArguments(&cmd_args);
  do { ; return (ok ? 0 : 1); } while (0);
}
