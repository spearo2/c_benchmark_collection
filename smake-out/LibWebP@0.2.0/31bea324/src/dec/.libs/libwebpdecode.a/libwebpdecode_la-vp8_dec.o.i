# 1 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 2
...
# 35 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
                                         ((void *)0)
# 35 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                                             ;
...
int VP8InitIoInternal(VP8Io* const io, int version) {
  ...
  if (io != 
# 51 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
           ((void *)0)
# 51 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
               ) {
...
VP8Decoder* VP8New(void) {
  ...
  if (dec != 
# 59 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
            ((void *)0)
# 59 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                ) {
    SetOk(dec);
...
const char* VP8StatusMessage(VP8Decoder* const dec) {
  if (dec == 
# 75 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
            ((void *)0)
# 75 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                ) return "no object";
...
void VP8Delete(VP8Decoder* const dec) {
  if (dec != 
# 81 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
            ((void *)0)
# 81 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                ) {
    VP8Clear(dec);
    WebPSafeFree(dec);
  }
...
int VP8GetInfo(const uint8_t* data, size_t data_size, size_t chunk_size,
               int* const width, int* const height) {
  if (data == 
# 107 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
             ((void *)0) 
# 107 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                  || data_size < 10) {
    return 0;
  }
...
# 151 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
 ((void) (0))
# 151 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                    ;
  hdr->use_segment_ = 0;
  hdr->update_map_ = 0;
...
# 162 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
 ((void) (0))
# 162 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                   ;
  
# 163 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
 ((void) (0))
# 163 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                    ;
  hdr->use_segment_ = VP8GetValue(br, 1);
  if (hdr->use_segment_) {
    hdr->update_map_ = VP8GetValue(br, 1);
    if (VP8GetValue(br, 1)) {
      int s;
      hdr->absolute_delta_ = VP8GetValue(br, 1);
      for (s = 0; s < NUM_MB_SEGMENTS; ++s) {
        hdr->quantizer_[s] = VP8GetValue(br, 1) ?
            VP8GetSignedValue(br, 7) : 0;
      }
      for (s = 0; s < NUM_MB_SEGMENTS; ++s) {
        hdr->filter_strength_[s] = VP8GetValue(br, 1) ?
            VP8GetSignedValue(br, 6) : 0;
      }
    }
    if (hdr->update_map_) {
      int s;
      for (s = 0; s < MB_FEATURE_TREE_PROBS; ++s) {
        proba->segments_[s] = VP8GetValue(br, 1) ?
            VP8GetValue(br, 8) : 255u;
      }
    }
  } else {
    hdr->update_map_ = 0;
...
# 201 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
...
static int ParseFilterHeader(VP8BitReader* br, VP8Decoder* const dec) {
  ...
  hdr->simple_ = VP8GetValue(br, 1);
  hdr->level_ = VP8GetValue(br, 6);
  hdr->sharpness_ = VP8GetValue(br, 3);
  hdr->use_lf_delta_ = VP8GetValue(br, 1);
...
int VP8GetHeaders(VP8Decoder* const dec, VP8Io* const io) {
  ...
  if (dec == 
# 267 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
            ((void *)0)
# 267 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                ) {
    return 0;
  }
  SetOk(dec);
  if (io == 
# 271 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
           ((void *)0)
# 271 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
               ) {
  ...
  if (frm_hdr->key_frame_) {
    pic_hdr->colorspace_ = VP8GetValue(br, 1);
    pic_hdr->clamp_type_ = VP8GetValue(br, 1);
  }
...
static void InitGetCoeffs_body(void); void InitGetCoeffs(void) { do { static volatile VP8CPUInfo InitGetCoeffs_body_last_cpuinfo_used = (VP8CPUInfo)&InitGetCoeffs_body_last_cpuinfo_used; static pthread_mutex_t InitGetCoeffs_body_lock = 
# 499 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
{ { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 499 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
; if (pthread_mutex_lock(&InitGetCoeffs_body_lock)) break; if (InitGetCoeffs_body_last_cpuinfo_used != VP8GetCPUInfo) InitGetCoeffs_body(); InitGetCoeffs_body_last_cpuinfo_used = VP8GetCPUInfo; (void)pthread_mutex_unlock(&InitGetCoeffs_body_lock); } while (0); } static void InitGetCoeffs_body(void) {
  if (VP8GetCPUInfo != 
# 500 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
                      ((void *)0) 
# 500 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                           && VP8GetCPUInfo(kSlowSSSE3)) {
...
static inline uint32_t NzCodeBits(uint32_t nz_coeffs, int nz, int dc_nz) {
  nz_coeffs <<= 2;
...
int VP8Decode(VP8Decoder* const dec, VP8Io* const io) {
  int ok = 0;
  if (dec == 
# 674 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
            ((void *)0)
# 674 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                ) {
    return 0;
  }
  if (io == 
# 677 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
           ((void *)0)
# 677 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
               ) {
    return VP8SetError(dec, VP8_STATUS_INVALID_PARAM,
...
# 687 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
 ((void) (0))
# 687 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                    ;
...
void VP8Clear(VP8Decoder* const dec) {
  if (dec == 
# 712 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
            ((void *)0)
# 712 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                ) {
    return;
  }
  ...
  dec->mem_ = 
# 718 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c" 3 4
             ((void *)0)
# 718 "/doner/libwebp/libwebp-31bea324/src/dec/vp8_dec.c"
                 ;
  dec->mem_size_ = 0;
