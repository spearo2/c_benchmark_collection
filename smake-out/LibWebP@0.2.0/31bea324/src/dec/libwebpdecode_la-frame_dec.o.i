# 1 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 2
...
# 201 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
...
# 214 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 214 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                   ;
...
# 256 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 256 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                     ;
...
# 323 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
static const uint8_t kQuantToDitherAmp[12] = {
...
# 330 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 330 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                    ;
  if (options != 
# 331 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                ((void *)0)
# 331 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                    ) {
    const int d = options->dithering_strength;
    const int max_amp = (1 << 8) - 1;
...
# 373 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 373 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                     ;
  for (mb_x = dec->tl_mb_x_; mb_x < dec->br_mb_x_; ++mb_x) {
    const VP8ThreadContext* const ctx = &dec->thread_ctx_;
...
# 402 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
static int FinishRow(void* arg1, void* arg2) {
  ...
  if (io->put != 
# 432 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                ((void *)0)
# 432 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                    ) {
    int y_start = ((mb_y) * 16);
    int y_end = ((mb_y + 1) * 16);
    if (!is_first_row) {
    ...
    io->a = 
# 453 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
           ((void *)0)
# 453 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
               ;
    if (dec->alpha_data_ != 
# 454 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                           ((void *)0) 
# 454 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                && y_start < y_end) {
      io->a = VP8DecompressAlphaRows(dec, io, y_start, y_end - y_start);
      if (io->a == 
# 456 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                  ((void *)0)
# 456 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                      ) {
...
# 464 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
     ((void) (0))
# 464 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                           ;
      io->y += dec->cache_y_stride_ * delta_y;
      io->u += dec->cache_uv_stride_ * (delta_y >> 1);
      io->v += dec->cache_uv_stride_ * (delta_y >> 1);
      if (io->a != 
# 468 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                  ((void *)0)
# 468 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                      ) {
    ...
    if (y_start < y_end) {
      ...
      io->v += io->crop_left >> 1;
      if (io->a != 
# 476 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                  ((void *)0)
# 476 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                      ) {
        io->a += io->crop_left;
      }
...
# 517 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
   ((void) (0))
# 517 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                ;
    if (ok) {
      ctx->io_ = *io;
...
VP8StatusCode VP8EnterCritical(VP8Decoder* const dec, VP8Io* const io) {
  ...
  if (io->setup != 
# 552 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                  ((void *)0) 
# 552 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                       && !io->setup(io)) {
...
# 571 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
  {
...
int VP8ExitCritical(VP8Decoder* const dec, VP8Io* const io) {
  ...
  if (io->teardown != 
# 607 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                     ((void *)0)
# 607 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                         ) {
    io->teardown(io);
  }
  return ok;
}
# 641 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
...
int VP8GetThreadMethod(const WebPDecoderOptions* const options,
                       ...
                       int width, int height) {
  if (options == 
# 663 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                ((void *)0) 
# 663 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
...
# 669 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 669 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                                 ;
...
# 700 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                                                  ((void *)0)
# 700 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                                      ) ?
  ...
  if (needed > dec->mem_size_) {
    ...
    if (dec->mem_ == 
# 713 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                    ((void *)0)
# 713 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                        ) {
      return VP8SetError(dec, VP8_STATUS_OUT_OF_MEMORY,
...
# 731 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                                               ((void *)0)
# 731 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                                   ;
  mem += f_info_size;
  ...
  mem = (uint8_t*)(((uintptr_t)(mem) + 31) & ~(uintptr_t)31);
  
# 743 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 743 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                         ;
  dec->yuv_b_ = mem;
  mem += yuv_size;
  ...
  dec->alpha_plane_ = alpha_size ? mem : 
# 770 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
                                        ((void *)0)
# 770 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                            ;
  mem += alpha_size;
  
# 772 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
 ((void) (0))
# 772 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
                                                    ;
...
static void InitIo(VP8Decoder* const dec, VP8Io* io) {
  ...
  io->a = 
# 792 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c" 3 4
         ((void *)0)
# 792 "/doner/libwebp/libwebp-31bea324/src/dec/frame_dec.c"
             ;
}
