# 1 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
# 1 "../../src/utils/palette.h" 1
# 17 "../../src/utils/palette.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 17 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2
...
# 24 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 2
...
# 32 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
 ((void) (0))
# 32 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
               ;
  return (a < b) ? -1 : 1;
}

static inline uint32_t PaletteComponentDistance(uint32_t v) {
...
static inline uint32_t PaletteColorDistance(uint32_t col1, uint32_t col2) {
...
static inline void SwapColor(uint32_t* const col1, uint32_t* const col2) {
...
# 76 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
 ((void) (0))
# 76 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
          ;
  return 0;
}
...
# 105 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
 ((void) (0))
# 105 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                    ;
  
# 106 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
 ((void) (0))
# 106 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                      ;
  ...
  if (palette != 
# 137 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
                ((void *)0)
# 137 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                    ) {
    num_colors = 0;
    for (i = 0; i < (256 * 4); ++i) {
      if (in_use[i]) {
...
# 161 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
...
# 240 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
 ((void) (0))
# 240 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                   ;
}
...
static int CoOccurrenceBuild(const WebPPicture* const pic,
  ...
  uint32_t idx_map[256] = {0};
  uint32_t palette_sorted[256];
  lines = (uint32_t*)WebPSafeMalloc(2 * pic->width, sizeof(*lines));
  if (lines == 
# 255 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
              ((void *)0)
# 255 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                  ) {
    return 0;
  }
  line_top = &lines[0];
...
int PaletteSortModifiedZeng(const WebPPicture* const pic,
  ...
  if (cooccurrence == 
# 310 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
                     ((void *)0)
# 310 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                         ) {
    return 0;
  }
...
# 369 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c" 3 4
 ((void) (0))
# 369 "/doner/libwebp/libwebp-31bea324/src/utils/palette.c"
                                         ;
  WebPSafeFree(cooccurrence);
