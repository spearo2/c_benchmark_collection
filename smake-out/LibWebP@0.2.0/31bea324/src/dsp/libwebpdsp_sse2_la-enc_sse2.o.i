# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 2


# 1 "/usr/include/assert.h" 1 3 4
# 18 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 2
...
static void ITransform_One_SSE2(const uint8_t* ref, const int16_t* in,
                                uint8_t* dst) {
# 47 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...

  {
    ...
    const __m128i tmp23 = _mm_shuffle_epi32(tmp32, 
# 87 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                  (((
# 87 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                                  1
# 87 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                  ) << 6) | ((
# 87 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 87 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...

  {
    ...
    const __m128i tmp32 = _mm_sub_epi16(comb_ab, comb_dc);
    const __m128i tmp23 = _mm_shuffle_epi32(tmp32, 
# 128 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                  (((
# 128 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                                  1
# 128 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                  ) << 6) | ((
# 128 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 128 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...

  {
    ...
    const __m128i ref0 = _mm_cvtsi32_si128(WebPMemToInt32(&ref[0 * 32]));
    const __m128i ref1 = _mm_cvtsi32_si128(WebPMemToInt32(&ref[1 * 32]));
    const __m128i ref2 = _mm_cvtsi32_si128(WebPMemToInt32(&ref[2 * 32]));
    const __m128i ref3 = _mm_cvtsi32_si128(WebPMemToInt32(&ref[3 * 32]));
    ...
    WebPInt32ToMem(&dst[0 * 32], buf[0]);
    WebPInt32ToMem(&dst[1 * 32], buf[1]);
    WebPInt32ToMem(&dst[2 * 32], buf[2]);
    WebPInt32ToMem(&dst[3 * 32], buf[3]);
  }
}
...
static void ITransform_Two_SSE2(const uint8_t* ref, const int16_t* in,
                                uint8_t* dst) {
# 198 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...

  {
    ...
    ref0 = _mm_loadl_epi64((const __m128i*)&ref[0 * 32]);
    ref1 = _mm_loadl_epi64((const __m128i*)&ref[1 * 32]);
    ref2 = _mm_loadl_epi64((const __m128i*)&ref[2 * 32]);
    ref3 = _mm_loadl_epi64((const __m128i*)&ref[3 * 32]);
    ...
    _mm_storel_epi64((__m128i*)&dst[0 * 32], ref0);
    _mm_storel_epi64((__m128i*)&dst[1 * 32], ref1);
    _mm_storel_epi64((__m128i*)&dst[2 * 32], ref2);
    _mm_storel_epi64((__m128i*)&dst[3 * 32], ref3);
  }
}
...
static void FTransformPass1_SSE2(const __m128i* const in01,
  ...
  const __m128i shuf01_p = _mm_shufflehi_epi16(*in01, 
# 344 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                     (((
# 344 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                                     2
# 344 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                     ) << 6) | ((
# 344 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 344 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
  ...
  const __m128i shuf23_p = _mm_shufflehi_epi16(*in23, 
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                     (((
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                                     2
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                                     ) << 6) | ((
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 345 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
  ...
  *out32 = _mm_shuffle_epi32(v23, 
# 371 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                 (((
# 371 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                 1
# 371 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                 ) << 6) | ((
# 371 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
static void FTransform_SSE2(const uint8_t* src, const uint8_t* ref,
  ...
  const __m128i src0 = _mm_loadl_epi64((const __m128i*)&src[0 * 32]);
  const __m128i src1 = _mm_loadl_epi64((const __m128i*)&src[1 * 32]);
  const __m128i src2 = _mm_loadl_epi64((const __m128i*)&src[2 * 32]);
  const __m128i src3 = _mm_loadl_epi64((const __m128i*)&src[3 * 32]);
  ...
  const __m128i ref0 = _mm_loadl_epi64((const __m128i*)&ref[0 * 32]);
  const __m128i ref1 = _mm_loadl_epi64((const __m128i*)&ref[1 * 32]);
  const __m128i ref2 = _mm_loadl_epi64((const __m128i*)&ref[2 * 32]);
  const __m128i ref3 = _mm_loadl_epi64((const __m128i*)&ref[3 * 32]);
...
static inline void Put8x8uv_SSE2(uint8_t v, uint8_t* dst) {
  int j;
  const __m128i values = _mm_set1_epi8((char)v);
  for (j = 0; j < 8; ++j) {
    _mm_storel_epi64((__m128i*)(dst + j * 32), values);
  }
}

static inline void Put16_SSE2(uint8_t v, uint8_t* dst) {
  int j;
  const __m128i values = _mm_set1_epi8((char)v);
  for (j = 0; j < 16; ++j) {
    _mm_store_si128((__m128i*)(dst + j * 32), values);
  }
}

static inline void Fill_SSE2(uint8_t* dst, int value, int size) {
  if (size == 4) {
    int j;
    for (j = 0; j < 4; ++j) {
      memset(dst + j * 32, value, 4);
    }
  } else if (size == 8) {
...
static inline void VE8uv_SSE2(uint8_t* dst, const uint8_t* top) {
  int j;
  const __m128i top_values = _mm_loadl_epi64((const __m128i*)top);
  for (j = 0; j < 8; ++j) {
    _mm_storel_epi64((__m128i*)(dst + j * 32), top_values);
  }
}

static inline void VE16_SSE2(uint8_t* dst, const uint8_t* top) {
  const __m128i top_values = _mm_load_si128((const __m128i*)top);
  int j;
  for (j = 0; j < 16; ++j) {
    _mm_store_si128((__m128i*)(dst + j * 32), top_values);
  }
}

static inline void VerticalPred_SSE2(uint8_t* dst,
                                          const uint8_t* top, int size) {
  if (top != 
# 661 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
            ((void *)0)
# 661 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                ) {
    if (size == 8) {
      VE8uv_SSE2(dst, top);
    } else {
...
static inline void HE8uv_SSE2(uint8_t* dst, const uint8_t* left) {
  int j;
  for (j = 0; j < 8; ++j) {
...
static inline void HE16_SSE2(uint8_t* dst, const uint8_t* left) {
  int j;
  for (j = 0; j < 16; ++j) {
    const __m128i values = _mm_set1_epi8((char)left[j]);
...
static inline void HorizontalPred_SSE2(uint8_t* dst,
                                            const uint8_t* left, int size) {
  if (left != 
# 692 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
             ((void *)0)
# 692 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                 ) {
    if (size == 8) {
      HE8uv_SSE2(dst, left);
    } else {
...
static inline void TM_SSE2(uint8_t* dst, const uint8_t* left,
                                const uint8_t* top, int size) {
  const __m128i zero = _mm_setzero_si128();
  int y;
  if (size == 8) {
...
static inline void TrueMotion_SSE2(uint8_t* dst, const uint8_t* left,
                                        const uint8_t* top, int size) {
  if (left != 
# 733 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
             ((void *)0)
# 733 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                 ) {
    if (top != 
# 734 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
              ((void *)0)
# 734 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                  ) {
    ...
    if (top != 
# 744 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
              ((void *)0)
# 744 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                  ) {
...
static inline void DC8uv_SSE2(uint8_t* dst, const uint8_t* left,
                                   const uint8_t* top) {
  const __m128i top_values = _mm_loadl_epi64((const __m128i*)top);
...
static inline void DC8uvNoLeft_SSE2(uint8_t* dst, const uint8_t* top) {
  const __m128i zero = _mm_setzero_si128();
  const __m128i top_values = _mm_loadl_epi64((const __m128i*)top);
...
static inline void DC8uvNoTop_SSE2(uint8_t* dst, const uint8_t* left) {

  DC8uvNoLeft_SSE2(dst, left);
}

static inline void DC8uvNoTopLeft_SSE2(uint8_t* dst) {
  Put8x8uv_SSE2(0x80, dst);
}

static inline void DC8uvMode_SSE2(uint8_t* dst, const uint8_t* left,
                                       const uint8_t* top) {
  if (top != 
# 780 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
            ((void *)0)
# 780 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                ) {
    if (left != 
# 781 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
               ((void *)0)
# 781 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                   ) {
...
# 786 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                    ((void *)0)
# 786 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                        ) {
...
static inline void DC16_SSE2(uint8_t* dst, const uint8_t* left,
                                  const uint8_t* top) {
...
static inline void DC16NoLeft_SSE2(uint8_t* dst, const uint8_t* top) {
  const __m128i top_row = _mm_load_si128((const __m128i*)top);
  const int DC = VP8HorizontalAdd8b(&top_row) + 8;
  Put16_SSE2(DC >> 4, dst);
}

static inline void DC16NoTop_SSE2(uint8_t* dst, const uint8_t* left) {

  DC16NoLeft_SSE2(dst, left);
}

static inline void DC16NoTopLeft_SSE2(uint8_t* dst) {
  Put16_SSE2(0x80, dst);
}

static inline void DC16Mode_SSE2(uint8_t* dst, const uint8_t* left,
                                      const uint8_t* top) {
  if (top != 
# 819 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
            ((void *)0)
# 819 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                ) {
    if (left != 
# 820 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
               ((void *)0)
# 820 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                   ) {
...
# 825 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                    ((void *)0)
# 825 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                        ) {
...
# 847 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
static inline void VE4_SSE2(uint8_t* dst,
                                 const uint8_t* top) {
  ...
  int i;
  for (i = 0; i < 4; ++i) {
    WebPInt32ToMem(dst + i * 32, vals);
  }
}

static inline void HE4_SSE2(uint8_t* dst,
                                 const uint8_t* top) {
  const int X = top[-1];
  const int I = top[-2];
  const int J = top[-3];
  const int K = top[-4];
  const int L = top[-5];
  WebPUint32ToMem(dst + 0 * 32, 0x01010101U * (((X) + 2 * (I) + (J) + 2) >> 2));
  WebPUint32ToMem(dst + 1 * 32, 0x01010101U * (((I) + 2 * (J) + (K) + 2) >> 2));
  WebPUint32ToMem(dst + 2 * 32, 0x01010101U * (((J) + 2 * (K) + (L) + 2) >> 2));
  WebPUint32ToMem(dst + 3 * 32, 0x01010101U * (((K) + 2 * (L) + (L) + 2) >> 2));
}

static inline void DC4_SSE2(uint8_t* dst, const uint8_t* top) {
  uint32_t dc = 4;
  int i;
...
static inline void LD4_SSE2(uint8_t* dst,
                                 const uint8_t* top) {
  const __m128i one = _mm_set1_epi8(1);
  ...
  WebPInt32ToMem(dst + 0 * 32, _mm_cvtsi128_si32( abcdefg ));
  WebPInt32ToMem(dst + 1 * 32, _mm_cvtsi128_si32(_mm_srli_si128(abcdefg, 1)));
  WebPInt32ToMem(dst + 2 * 32, _mm_cvtsi128_si32(_mm_srli_si128(abcdefg, 2)));
  WebPInt32ToMem(dst + 3 * 32, _mm_cvtsi128_si32(_mm_srli_si128(abcdefg, 3)));
}

static inline void VR4_SSE2(uint8_t* dst,
                                 const uint8_t* top) {
  const __m128i one = _mm_set1_epi8(1);
  const int I = top[-2];
  const int J = top[-3];
  ...
  WebPInt32ToMem(dst + 0 * 32, _mm_cvtsi128_si32( abcd ));
  WebPInt32ToMem(dst + 1 * 32, _mm_cvtsi128_si32( efgh ));
  WebPInt32ToMem(dst + 2 * 32, _mm_cvtsi128_si32(_mm_slli_si128(abcd, 1)));
  WebPInt32ToMem(dst + 3 * 32, _mm_cvtsi128_si32(_mm_slli_si128(efgh, 1)));
...
static inline void VL4_SSE2(uint8_t* dst,
                                 const uint8_t* top) {
  const __m128i one = _mm_set1_epi8(1);
  const __m128i ABCDEFGH = _mm_loadl_epi64((const __m128i*)top);
  ...
  WebPInt32ToMem(dst + 0 * 32, _mm_cvtsi128_si32( avg1 ));
  WebPInt32ToMem(dst + 1 * 32, _mm_cvtsi128_si32( avg4 ));
  WebPInt32ToMem(dst + 2 * 32, _mm_cvtsi128_si32(_mm_srli_si128(avg1, 1)));
  WebPInt32ToMem(dst + 3 * 32, _mm_cvtsi128_si32(_mm_srli_si128(avg4, 1)));


  dst[(3) + (2) * 32] = (extra_out >> 0) & 0xff;
  dst[(3) + (3) * 32] = (extra_out >> 8) & 0xff;
}

static inline void RD4_SSE2(uint8_t* dst,
                                 const uint8_t* top) {
  const __m128i one = _mm_set1_epi8(1);
  ...
  WebPInt32ToMem(dst + 3 * 32, _mm_cvtsi128_si32( abcdefg ));
  WebPInt32ToMem(dst + 2 * 32, _mm_cvtsi128_si32(_mm_srli_si128(abcdefg, 1)));
  WebPInt32ToMem(dst + 1 * 32, _mm_cvtsi128_si32(_mm_srli_si128(abcdefg, 2)));
  WebPInt32ToMem(dst + 0 * 32, _mm_cvtsi128_si32(_mm_srli_si128(abcdefg, 3)));
}

static inline void HU4_SSE2(uint8_t* dst, const uint8_t* top) {
  const int I = top[-2];
  const int J = top[-3];
  const int K = top[-4];
  const int L = top[-5];
...
static inline void HD4_SSE2(uint8_t* dst, const uint8_t* top) {
  const int X = top[-1];
  const int I = top[-2];
  const int J = top[-3];
  const int K = top[-4];
...
static inline void TM4_SSE2(uint8_t* dst, const uint8_t* top) {
  const __m128i zero = _mm_setzero_si128();
...
# 1031 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
static void Intra4Preds_SSE2(uint8_t* dst, const uint8_t* top) {
  DC4_SSE2((3 * 16 * 32 + 0) + dst, top);
  TM4_SSE2(((3 * 16 * 32 + 0) + 4) + dst, top);
  VE4_SSE2(((3 * 16 * 32 + 0) + 8) + dst, top);
  HE4_SSE2(((3 * 16 * 32 + 0) + 12) + dst, top);
  RD4_SSE2(((3 * 16 * 32 + 0) + 16) + dst, top);
  VR4_SSE2(((3 * 16 * 32 + 0) + 20) + dst, top);
  LD4_SSE2(((3 * 16 * 32 + 0) + 24) + dst, top);
  VL4_SSE2(((3 * 16 * 32 + 0) + 28) + dst, top);
  HD4_SSE2((3 * 16 * 32 + 4 * 32) + dst, top);
  HU4_SSE2(((3 * 16 * 32 + 4 * 32) + 4) + dst, top);
}
...
static void IntraChromaPreds_SSE2(uint8_t* dst, const uint8_t* left,
  ...
  DC8uvMode_SSE2((2 * 16 * 32) + dst, left, top);
  VerticalPred_SSE2((2 * 16 * 32 + 8 * 32) + dst, top, 8);
  HorizontalPred_SSE2(((2 * 16 * 32 + 8 * 32) + 1 * 16) + dst, left, 8);
  TrueMotion_SSE2(((2 * 16 * 32) + 1 * 16) + dst, left, top, 8);

  dst += 8;
  if (top != 
# 1056 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
            ((void *)0)
# 1056 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                ) top += 8;
  if (left != 
# 1057 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
             ((void *)0)
# 1057 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                 ) left += 16;
  DC8uvMode_SSE2((2 * 16 * 32) + dst, left, top);
  VerticalPred_SSE2((2 * 16 * 32 + 8 * 32) + dst, top, 8);
  HorizontalPred_SSE2(((2 * 16 * 32 + 8 * 32) + 1 * 16) + dst, left, 8);
...
static void Intra16Preds_SSE2(uint8_t* dst,
  ...
  DC16Mode_SSE2((0 * 16 * 32) + dst, left, top);
  VerticalPred_SSE2((1 * 16 * 32) + dst, top, 16);
  HorizontalPred_SSE2(((1 * 16 * 32) + 16) + dst, left, 16);
  TrueMotion_SSE2(((0 * 16 * 32) + 16) + dst, left, top, 16);
}




static inline void SubtractAndAccumulate_SSE2(const __m128i a,
                                                   const __m128i b,
                                                   __m128i* const sum) {
...
static inline int SSE_16xN_SSE2(const uint8_t* a, const uint8_t* b,
                                     int num_pairs) {
...
static int SSE8x8_SSE2(const uint8_t* a, const uint8_t* b) {
  ...
  int32_t tmp[4];
  while (num_pairs-- > 0) {
    const __m128i a0 = _mm_unpacklo_epi8(_mm_loadl_epi64((const __m128i*)(&a[32 * 0])), zero);
    const __m128i a1 = _mm_unpacklo_epi8(_mm_loadl_epi64((const __m128i*)(&a[32 * 1])), zero);
    const __m128i b0 = _mm_unpacklo_epi8(_mm_loadl_epi64((const __m128i*)(&b[32 * 0])), zero);
    const __m128i b1 = _mm_unpacklo_epi8(_mm_loadl_epi64((const __m128i*)(&b[32 * 1])), zero);
...
static int SSE4x4_SSE2(const uint8_t* a, const uint8_t* b) {
  ...
  const __m128i a0 = _mm_loadl_epi64((const __m128i*)&a[32 * 0]);
  const __m128i a1 = _mm_loadl_epi64((const __m128i*)&a[32 * 1]);
  const __m128i a2 = _mm_loadl_epi64((const __m128i*)&a[32 * 2]);
  const __m128i a3 = _mm_loadl_epi64((const __m128i*)&a[32 * 3]);
  const __m128i b0 = _mm_loadl_epi64((const __m128i*)&b[32 * 0]);
  const __m128i b1 = _mm_loadl_epi64((const __m128i*)&b[32 * 1]);
  const __m128i b2 = _mm_loadl_epi64((const __m128i*)&b[32 * 2]);
  const __m128i b3 = _mm_loadl_epi64((const __m128i*)&b[32 * 3]);
...
static void Mean16x4_SSE2(const uint8_t* ref, uint32_t dc[4]) {
  ...
  const __m128i a0 = _mm_loadu_si128((const __m128i*)&ref[32 * 0]);
  const __m128i a1 = _mm_loadu_si128((const __m128i*)&ref[32 * 1]);
  const __m128i a2 = _mm_loadu_si128((const __m128i*)&ref[32 * 2]);
  const __m128i a3 = _mm_loadu_si128((const __m128i*)&ref[32 * 3]);
...
# 1230 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
static int TTransform_SSE2(const uint8_t* inA, const uint8_t* inB,
  ...
  {
    const __m128i inA_0 = _mm_loadl_epi64((const __m128i*)&inA[32 * 0]);
    const __m128i inA_1 = _mm_loadl_epi64((const __m128i*)&inA[32 * 1]);
    const __m128i inA_2 = _mm_loadl_epi64((const __m128i*)&inA[32 * 2]);
    const __m128i inA_3 = _mm_loadl_epi64((const __m128i*)&inA[32 * 3]);
    const __m128i inB_0 = _mm_loadl_epi64((const __m128i*)&inB[32 * 0]);
    const __m128i inB_1 = _mm_loadl_epi64((const __m128i*)&inB[32 * 1]);
    const __m128i inB_2 = _mm_loadl_epi64((const __m128i*)&inB[32 * 2]);
...
static inline int DoQuantizeBlock_SSE2(int16_t in[16], int16_t out[16],
  ...
  if (sharpen != 
# 1381 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                ((void *)0)
# 1381 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                    ) {
  ...
  {
    __m128i outZ0, outZ8;
    outZ0 = _mm_shufflehi_epi16(out0, 
# 1444 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      (((
# 1444 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                      2
# 1444 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 1444 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 1444 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
    ...
    outZ0 = _mm_shuffle_epi32 (outZ0, 
# 1445 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      (((
# 1445 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                      3
# 1445 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 1445 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 1445 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
    ...
    outZ0 = _mm_shufflehi_epi16(outZ0, 
# 1446 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      (((
# 1446 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                      3
# 1446 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 1446 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 1446 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
    ...
    outZ8 = _mm_shufflelo_epi16(out8, 
# 1447 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      (((
# 1447 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                      3
# 1447 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 1447 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 1447 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
    ...
    outZ8 = _mm_shuffle_epi32 (outZ8, 
# 1448 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      (((
# 1448 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                      3
# 1448 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 1448 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
# 1448 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
    ...
    outZ8 = _mm_shufflelo_epi16(outZ8, 
# 1449 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      (((
# 1449 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                      1
# 1449 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ) << 6) | ((
# 1449 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
...
static int QuantizeBlockWHT_SSE2(int16_t in[16], int16_t out[16],
                                 const VP8Matrix* const mtx) {
  return DoQuantizeBlock_SSE2(in, out, 
# 1472 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c" 3 4
                                      ((void *)0)
# 1472 "/doner/libwebp/libwebp-31bea324/src/dsp/enc_sse2.c"
                                          , mtx);
}
