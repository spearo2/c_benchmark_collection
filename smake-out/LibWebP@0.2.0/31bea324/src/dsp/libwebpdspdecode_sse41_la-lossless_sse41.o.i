# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c"
# 12 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 13 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c" 2



# 1 "../../src/dsp/common_sse41.h" 1
# 22 "../../src/dsp/common_sse41.h"
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c" 2
...
static void TransformColorInverse_SSE41(const VP8LMultipliers* const m,
  ...
  const __m128i mults_rb =
      _mm_set1_epi32((int)((uint32_t)(((int16_t)(m->green_to_red_ << 8)) >> 5) << 16 |
                           ((((int16_t)(m->green_to_blue_ << 8)) >> 5) & 0xffff)));
  const __m128i mults_b2 = _mm_set1_epi32((((int16_t)(m->red_to_blue_ << 8)) >> 5));
...
# 80 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse41.c"
static void ConvertBGRAToRGB_SSE41(const uint32_t* src, int num_pixels,
  ...
  do { while (num_pixels >= 16) { const __m128i in0 = _mm_loadu_si128(in + 0); const __m128i in1 = _mm_loadu_si128(in + 1); const __m128i in2 = _mm_loadu_si128(in + 2); const __m128i in3 = _mm_loadu_si128(in + 3); const __m128i a0 = _mm_shuffle_epi8(in0, perm0); const __m128i a1 = _mm_shuffle_epi8(in1, perm1); const __m128i a2 = _mm_shuffle_epi8(in2, perm2); const __m128i a3 = _mm_shuffle_epi8(in3, perm3); const __m128i b0 = _mm_blend_epi16(a0, a1, 0xc0); const __m128i b1 = _mm_blend_epi16(a1, a2, 0xf0); const __m128i b2 = _mm_blend_epi16(a2, a3, 0xfc); _mm_storeu_si128(out + 0, b0); _mm_storeu_si128(out + 1, b1); _mm_storeu_si128(out + 2, b2); in += 4; out += 3; num_pixels -= 16; } } while (0);
