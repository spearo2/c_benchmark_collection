# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 16 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 2
# 32 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"

# 32 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
static inline void PredictLine_C(const uint8_t* src, const uint8_t* pred,
...
static inline void DoHorizontalFilter_C(const uint8_t* in,
...
# 52 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 52 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
 ; 
# 52 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 52 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
...
# 89 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 89 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
 ; 
# 89 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 89 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
...
# 134 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 134 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
 ; 
# 134 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 134 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
...
static void HorizontalUnfilter_C(const uint8_t* prev, const uint8_t* in,
                                 uint8_t* out, int width) {
  uint8_t pred = (prev == 
# 200 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
                         ((void *)0)
# 200 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                             ) ? 0 : prev[0];
  int i;
  for (i = 0; i < width; ++i) {
...
static void VerticalUnfilter_C(const uint8_t* prev, const uint8_t* in,
                               uint8_t* out, int width) {
  if (prev == 
# 211 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
             ((void *)0)
# 211 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                 ) {
    HorizontalUnfilter_C(
# 212 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
                        ((void *)0)
# 212 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                            , in, out, width);
  } else {
    int i;
...
static void GradientUnfilter_C(const uint8_t* prev, const uint8_t* in,
                               uint8_t* out, int width) {
  if (prev == 
# 222 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
             ((void *)0)
# 222 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                 ) {
    HorizontalUnfilter_C(
# 223 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
                        ((void *)0)
# 223 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                            , in, out, width);
  } else {
...
static void VP8FiltersInit_body(void); void VP8FiltersInit(void) { do { static volatile VP8CPUInfo VP8FiltersInit_body_last_cpuinfo_used = (VP8CPUInfo)&VP8FiltersInit_body_last_cpuinfo_used; static pthread_mutex_t VP8FiltersInit_body_lock = 
# 248 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
{ { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 248 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
; if (pthread_mutex_lock(&VP8FiltersInit_body_lock)) break; if (VP8FiltersInit_body_last_cpuinfo_used != VP8GetCPUInfo) VP8FiltersInit_body(); VP8FiltersInit_body_last_cpuinfo_used = VP8GetCPUInfo; (void)pthread_mutex_unlock(&VP8FiltersInit_body_lock); } while (0); } static void VP8FiltersInit_body(void) {
  ...
  WebPFilters[WEBP_FILTER_NONE] = 
# 256 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
                                 ((void *)0)
# 256 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                     ;
  ...
  if (VP8GetCPUInfo != 
# 263 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
                      ((void *)0)
# 263 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                          ) {

    if (VP8GetCPUInfo(kSSE2)) {
      VP8FiltersInitSSE2();
    }
# 279 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
  }
# 288 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
  
# 288 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 288 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                ;
  
# 289 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 289 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                      ;
  
# 290 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 290 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                    ;
  
# 291 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 291 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                    ;
  
# 292 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 292 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                    ;
  
# 293 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 293 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                  ;
  
# 294 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c" 3 4
 ((void) (0))
# 294 "/doner/libwebp/libwebp-31bea324/src/dsp/filters.c"
                                                  ;
}
