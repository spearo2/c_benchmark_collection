# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 2




# 21 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
static int DispatchAlpha_SSE2(const uint8_t* __restrict__ alpha,
                              int alpha_stride, int width, int height,
                              uint8_t* __restrict__ dst, int dst_stride) {
...
static void DispatchAlphaToGreen_SSE2(const uint8_t* __restrict__ alpha,
                                      int alpha_stride, int width, int height,
                                      uint32_t* __restrict__ dst,
                                      int dst_stride) {
  int i, j;
...
static int ExtractAlpha_SSE2(const uint8_t* __restrict__ argb, int argb_stride,
...
static void ExtractGreen_SSE2(const uint32_t* __restrict__ argb,
                              uint8_t* __restrict__ alpha, int size) {
  int i;
...
# 218 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
  ...
  while (h-- > 0) {
    ...
    if (!alpha_first) {
      for (i = 0; i + kSpan <= w; i += kSpan) {
        do { const __m128i argb0 = _mm_loadu_si128((const __m128i*)&(rgbx[i])); const __m128i argb1_lo = _mm_unpacklo_epi8(argb0, zero); const __m128i argb1_hi = _mm_unpackhi_epi8(argb0, zero); const __m128i alpha0_lo = _mm_or_si128(argb1_lo, kMask); const __m128i alpha0_hi = _mm_or_si128(argb1_hi, kMask); const __m128i alpha1_lo = _mm_shufflelo_epi16(alpha0_lo, 
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       (((
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       2
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       ) << 6) | ((
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
...
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       ); const __m128i alpha1_hi = _mm_shufflelo_epi16(alpha0_hi, 
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       (((
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       2
...
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       ); const __m128i alpha2_lo = _mm_shufflehi_epi16(alpha1_lo, 
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       (((
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       2
...
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       ); const __m128i alpha2_hi = _mm_shufflehi_epi16(alpha1_hi, 
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       (((
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       2
...
# 229 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       ); const __m128i A0_lo = _mm_mullo_epi16(alpha2_lo, argb1_lo); const __m128i A0_hi = _mm_mullo_epi16(alpha2_hi, argb1_hi); const __m128i A1_lo = _mm_mulhi_epu16(A0_lo, kMult); const __m128i A1_hi = _mm_mulhi_epu16(A0_hi, kMult); const __m128i A2_lo = _mm_srli_epi16(A1_lo, 7); const __m128i A2_hi = _mm_srli_epi16(A1_hi, 7); const __m128i A3 = _mm_packus_epi16(A2_lo, A2_hi); _mm_storeu_si128((__m128i*)&(rgbx[i]), A3); } while (0);
      }
    } else {
      for (i = 0; i + kSpan <= w; i += kSpan) {
        do { const __m128i argb0 = _mm_loadu_si128((const __m128i*)&(rgbx[i])); const __m128i argb1_lo = _mm_unpacklo_epi8(argb0, zero); const __m128i argb1_hi = _mm_unpackhi_epi8(argb0, zero); const __m128i alpha0_lo = _mm_or_si128(argb1_lo, kMask); const __m128i alpha0_hi = _mm_or_si128(argb1_hi, kMask); const __m128i alpha1_lo = _mm_shufflelo_epi16(alpha0_lo, 
# 233 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       (((
# 233 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
       0
# 233 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
       ) << 6) | ((
# 233 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
...
static void MultARGBRow_SSE2(uint32_t* const ptr, int width, int inverse) {
  ...
  if (!inverse) {
    ...
    for (x = 0; x + kSpan <= width; x += kSpan) {
      ...
      const __m128i A3 = _mm_shufflelo_epi16(A2, 
# 347 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
                                                (((
# 347 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
                                                2
# 347 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
                                                ) << 6) | ((
# 347 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
...
# 347 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
      ...
      const __m128i A4 = _mm_shufflehi_epi16(A3, 
# 348 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
                                                (((
# 348 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
                                                2
# 348 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c" 3 4
                                                ) << 6) | ((
# 348 "/doner/libwebp/libwebp-31bea324/src/dsp/alpha_processing_sse2.c"
...
static void MultRow_SSE2(uint8_t* __restrict__ const ptr,
                         const uint8_t* __restrict__ const alpha,
                         int width, int inverse) {
  int x = 0;
  if (!inverse) {
