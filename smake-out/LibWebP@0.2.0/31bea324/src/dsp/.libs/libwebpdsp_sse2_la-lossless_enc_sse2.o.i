# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 2


# 1 "/usr/include/assert.h" 1 3 4
# 18 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 2
...
# 35 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            (((
# 35 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                                            2
# 35 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            ) << 6) | ((
# 35 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 36 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            (((
# 36 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                                            2
# 36 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            ) << 6) | ((
# 36 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
static void TransformColor_SSE2(const VP8LMultipliers* const m,
  ...
  const __m128i mults_rb = _mm_set1_epi32((int)(((uint32_t)((((int16_t)((uint16_t)(m->green_to_red_) << 8)) >> 5)) << 16) | (((((int16_t)((uint16_t)(m->green_to_blue_) << 8)) >> 5)) & 0xffff)))
                                                               ;
  const __m128i mults_b2 = _mm_set1_epi32((int)(((uint32_t)((((int16_t)((uint16_t)(m->red_to_blue_) << 8)) >> 5)) << 16) | ((0) & 0xffff)));
  ...
  for (i = 0; i + 4 <= num_pixels; i += 4) {
    ...
    const __m128i B = _mm_shufflelo_epi16(A, 
# 63 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            (((
# 63 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                                            2
# 63 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            ) << 6) | ((
# 63 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 63 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
    ...
    const __m128i C = _mm_shufflehi_epi16(B, 
# 64 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            (((
# 64 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                                            2
# 64 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                            ) << 6) | ((
# 64 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
static void CollectColorBlueTransforms_SSE2(const uint32_t* argb, int stride,
                                            ...
                                            int green_to_blue, int red_to_blue,
                                            int histo[]) {
  const __m128i mults_r = _mm_set1_epi32((int)(((uint32_t)((((int16_t)((uint16_t)(red_to_blue) << 8)) >> 5)) << 16) | ((0) & 0xffff)));
  const __m128i mults_g = _mm_set1_epi32((int)(((uint32_t)(0) << 16) | (((((int16_t)((uint16_t)(green_to_blue) << 8)) >> 5)) & 0xffff)));
  ...
  for (y = 0; y < tile_height; ++y) {
    ...
    int i, x;
    for (x = 0; x + 8 <= tile_width; x += 8) {
      uint16_t values[8];
      const __m128i in0 = _mm_loadu_si128((__m128i*)&src[x + 0]);
      const __m128i in1 = _mm_loadu_si128((__m128i*)&src[x + 8 / 2]);
      ...
      for (i = 0; i < 8; ++i) ++histo[values[i]];
    }
  }
  {
    const int left_over = tile_width & (8 - 1);
    if (left_over > 0) {
...
static void CollectColorRedTransforms_SSE2(const uint32_t* argb, int stride,
                                           int tile_width, int tile_height,
                                           int green_to_red, int histo[]) {
  const __m128i mults_g = _mm_set1_epi32((int)(((uint32_t)(0) << 16) | (((((int16_t)((uint16_t)(green_to_red) << 8)) >> 5)) & 0xffff)));
  const __m128i mask_g = _mm_set1_epi32(0x00ff00);
...
# 176 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 240 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 287 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 341 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
 ((void) (0))
# 341 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                   ;
  
# 342 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
 ((void) (0))
# 342 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                   ;
  switch (xbits) {
    case 0: {
...
# 396 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
     ((void) (0))
# 396 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                       ;
...
static void PredictorSub0_SSE2(const uint32_t* in, const uint32_t* upper,
  ...
  if (i != num_pixels) {
    VP8LPredictorsSub_C[0](in + i, 
# 437 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
                                  ((void *)0)
# 437 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
                                      , num_pixels - i, out + i);
  }
  (void)upper;
}
# 459 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
static void PredictorSub1_SSE2(const uint32_t* const in, const uint32_t* const upper, int num_pixels, uint32_t* const out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i pred = _mm_loadu_si128((const __m128i*)&(in[i - 1])); const __m128i res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(1)](in + i, (((upper) == 
# 459 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0)
# 459 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
) ? 
# 459 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0) 
# 459 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
: ((upper) + (i))), num_pixels - i, out + i); } }
static void PredictorSub2_SSE2(const uint32_t* const in, const uint32_t* const upper, int num_pixels, uint32_t* const out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i pred = _mm_loadu_si128((const __m128i*)&(upper[i])); const __m128i res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(2)](in + i, (((upper) == 
# 460 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0)
# 460 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
) ? 
# 460 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0) 
# 460 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
: ((upper) + (i))), num_pixels - i, out + i); } }
static void PredictorSub3_SSE2(const uint32_t* const in, const uint32_t* const upper, int num_pixels, uint32_t* const out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i pred = _mm_loadu_si128((const __m128i*)&(upper[i + 1])); const __m128i res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(3)](in + i, (((upper) == 
# 461 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0)
# 461 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
) ? 
# 461 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0) 
# 461 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
: ((upper) + (i))), num_pixels - i, out + i); } }
static void PredictorSub4_SSE2(const uint32_t* const in, const uint32_t* const upper, int num_pixels, uint32_t* const out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i pred = _mm_loadu_si128((const __m128i*)&(upper[i - 1])); const __m128i res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(4)](in + i, (((upper) == 
# 462 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0)
# 462 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
) ? 
# 462 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c" 3 4
((void *)0) 
# 462 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
...
# 503 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_enc_sse2.c"
static void PredictorSub6_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i tA = _mm_loadu_si128((const __m128i*)&(in[i - 1])); const __m128i tB = _mm_loadu_si128((const __m128i*)&(upper[i - 1])); const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); __m128i pred, res; Average2_m128i(&tA, &tB, &pred); res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(6)](in + i, upper + i, num_pixels - i, out + i); } }
static void PredictorSub7_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i tA = _mm_loadu_si128((const __m128i*)&(in[i - 1])); const __m128i tB = _mm_loadu_si128((const __m128i*)&(upper[i])); const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); __m128i pred, res; Average2_m128i(&tA, &tB, &pred); res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(7)](in + i, upper + i, num_pixels - i, out + i); } }
static void PredictorSub8_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i tA = _mm_loadu_si128((const __m128i*)&(upper[i - 1])); const __m128i tB = _mm_loadu_si128((const __m128i*)&(upper[i])); const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); __m128i pred, res; Average2_m128i(&tA, &tB, &pred); res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(8)](in + i, upper + i, num_pixels - i, out + i); } }
static void PredictorSub9_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i tA = _mm_loadu_si128((const __m128i*)&(upper[i])); const __m128i tB = _mm_loadu_si128((const __m128i*)&(upper[i + 1])); const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); __m128i pred, res; Average2_m128i(&tA, &tB, &pred); res = _mm_sub_epi8(src, pred); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsSub_C[(9)](in + i, upper + i, num_pixels - i, out + i); } }
