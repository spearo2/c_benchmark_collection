# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 2



# 1 "../../src/dsp/common_sse2.h" 1
# 23 "../../src/dsp/common_sse2.h"
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 2





static inline uint32_t ClampedAddSubtractFull_SSE2(uint32_t c0,
                                                        uint32_t c1,
                                                        uint32_t c2) {
  const __m128i zero = _mm_setzero_si128();
...
static inline uint32_t ClampedAddSubtractHalf_SSE2(uint32_t c0,
                                                        uint32_t c1,
                                                        uint32_t c2) {
  const __m128i zero = _mm_setzero_si128();
  const __m128i C0 = _mm_unpacklo_epi8(_mm_cvtsi32_si128((int)c0), zero);
...
static inline uint32_t Select_SSE2(uint32_t a, uint32_t b, uint32_t c) {
  int pa_minus_pb;
  const __m128i zero = _mm_setzero_si128();
...
static inline void Average2_m128i(const __m128i* const a0,
...
static inline void Average2_uint32_SSE2(const uint32_t a0,
                                             const uint32_t a1,
                                             __m128i* const avg) {
...
static inline __m128i Average2_uint32_16_SSE2(uint32_t a0, uint32_t a1) {
  const __m128i zero = _mm_setzero_si128();
...
static inline uint32_t Average2_SSE2(uint32_t a0, uint32_t a1) {
  __m128i output;
  Average2_uint32_SSE2(a0, a1, &output);
  return (uint32_t)_mm_cvtsi128_si32(output);
}

static inline uint32_t Average3_SSE2(uint32_t a0, uint32_t a1,
                                          uint32_t a2) {
  const __m128i zero = _mm_setzero_si128();
...
static inline uint32_t Average4_SSE2(uint32_t a0, uint32_t a1,
...
static void PredictorAdd0_SSE2(const uint32_t* in, const uint32_t* upper,
  ...
  int i;
  const __m128i black = _mm_set1_epi32((int)0xff000000);
  ...
  if (i != num_pixels) {
    VP8LPredictorsAdd_C[0](in + i, 
# 198 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                  ((void *)0)
# 198 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                      , num_pixels - i, out + i);
  }
  (void)upper;
}
...
# 247 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
static void PredictorAdd2_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i other = _mm_loadu_si128((const __m128i*)&(upper[i])); const __m128i res = _mm_add_epi8(src, other); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsAdd_C[(2)](in + i, upper + i, num_pixels - i, out + i); } }

static void PredictorAdd3_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i other = _mm_loadu_si128((const __m128i*)&(upper[i + 1])); const __m128i res = _mm_add_epi8(src, other); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsAdd_C[(3)](in + i, upper + i, num_pixels - i, out + i); } }

static void PredictorAdd4_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); const __m128i other = _mm_loadu_si128((const __m128i*)&(upper[i - 1])); const __m128i res = _mm_add_epi8(src, other); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsAdd_C[(4)](in + i, upper + i, num_pixels - i, out + i); } }




static void PredictorAdd5_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int x; 
# 256 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
((void) (0))
# 256 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
; for (x = 0; x < num_pixels; ++x) { const uint32_t pred = (Predictor5_SSE2)(&out[x - 1], upper + x); out[x] = VP8LAddPixels(in[x], pred); } }
static void PredictorAdd6_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int x; 
# 257 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
((void) (0))
# 257 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
; for (x = 0; x < num_pixels; ++x) { const uint32_t pred = (Predictor6_SSE2)(&out[x - 1], upper + x); out[x] = VP8LAddPixels(in[x], pred); } }
static void PredictorAdd7_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int x; 
# 258 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
((void) (0))
# 258 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
; for (x = 0; x < num_pixels; ++x) { const uint32_t pred = (Predictor7_SSE2)(&out[x - 1], upper + x); out[x] = VP8LAddPixels(in[x], pred); } }
# 278 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
static void PredictorAdd8_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i Tother = _mm_loadu_si128((const __m128i*)&(upper[i - 1])); const __m128i T = _mm_loadu_si128((const __m128i*)&upper[i]); const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); __m128i avg, res; Average2_m128i(&T, &Tother, &avg); res = _mm_add_epi8(avg, src); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsAdd_C[(8)](in + i, upper + i, num_pixels - i, out + i); } }

static void PredictorAdd9_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int i; for (i = 0; i + 4 <= num_pixels; i += 4) { const __m128i Tother = _mm_loadu_si128((const __m128i*)&(upper[i + 1])); const __m128i T = _mm_loadu_si128((const __m128i*)&upper[i]); const __m128i src = _mm_loadu_si128((const __m128i*)&in[i]); __m128i avg, res; Average2_m128i(&T, &Tother, &avg); res = _mm_add_epi8(avg, src); _mm_storeu_si128((__m128i*)&out[i], res); } if (i != num_pixels) { VP8LPredictorsAdd_C[(9)](in + i, upper + i, num_pixels - i, out + i); } }
# 299 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
static void PredictorAdd10_SSE2(const uint32_t* in, const uint32_t* upper,
  ...
  for (i = 0; i + 4 <= num_pixels; i += 4) {
    ...
    do { __m128i avgLTL, avg; Average2_m128i(&L, &TL, &avgLTL); Average2_m128i(&avgTTR, &avgLTL, &avg); L = _mm_add_epi8(avg, src); out[i + (0)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
    do { avgTTR = _mm_srli_si128(avgTTR, 4); TL = _mm_srli_si128(TL, 4); src = _mm_srli_si128(src, 4); } while (0);
    do { __m128i avgLTL, avg; Average2_m128i(&L, &TL, &avgLTL); Average2_m128i(&avgTTR, &avgLTL, &avg); L = _mm_add_epi8(avg, src); out[i + (1)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
    do { avgTTR = _mm_srli_si128(avgTTR, 4); TL = _mm_srli_si128(TL, 4); src = _mm_srli_si128(src, 4); } while (0);
    do { __m128i avgLTL, avg; Average2_m128i(&L, &TL, &avgLTL); Average2_m128i(&avgTTR, &avgLTL, &avg); L = _mm_add_epi8(avg, src); out[i + (2)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
    do { avgTTR = _mm_srli_si128(avgTTR, 4); TL = _mm_srli_si128(TL, 4); src = _mm_srli_si128(src, 4); } while (0);
    do { __m128i avgLTL, avg; Average2_m128i(&L, &TL, &avgLTL); Average2_m128i(&avgTTR, &avgLTL, &avg); L = _mm_add_epi8(avg, src); out[i + (3)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
  }
  if (i != num_pixels) {
    VP8LPredictorsAdd_C[10](in + i, upper + i, num_pixels - i, out + i);
  }
}
# 346 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
static void PredictorAdd11_SSE2(const uint32_t* in, const uint32_t* upper,
  ...
  for (i = 0; i + 4 <= num_pixels; i += 4) {
    ...
    do { const __m128i L_lo = _mm_unpacklo_epi32(L, T); const __m128i TL_lo = _mm_unpacklo_epi32(TL, T); const __m128i pb = _mm_sad_epu8(L_lo, TL_lo); const __m128i mask = _mm_cmpgt_epi32(pb, pa); const __m128i A = _mm_and_si128(mask, L); const __m128i B = _mm_andnot_si128(mask, T); const __m128i pred = _mm_or_si128(A, B); L = _mm_add_epi8(src, pred); out[i + (0)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
    do { T = _mm_srli_si128(T, 4); TL = _mm_srli_si128(TL, 4); src = _mm_srli_si128(src, 4); pa = _mm_srli_si128(pa, 4); } while (0);
    do { const __m128i L_lo = _mm_unpacklo_epi32(L, T); const __m128i TL_lo = _mm_unpacklo_epi32(TL, T); const __m128i pb = _mm_sad_epu8(L_lo, TL_lo); const __m128i mask = _mm_cmpgt_epi32(pb, pa); const __m128i A = _mm_and_si128(mask, L); const __m128i B = _mm_andnot_si128(mask, T); const __m128i pred = _mm_or_si128(A, B); L = _mm_add_epi8(src, pred); out[i + (1)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
    do { T = _mm_srli_si128(T, 4); TL = _mm_srli_si128(TL, 4); src = _mm_srli_si128(src, 4); pa = _mm_srli_si128(pa, 4); } while (0);
    do { const __m128i L_lo = _mm_unpacklo_epi32(L, T); const __m128i TL_lo = _mm_unpacklo_epi32(TL, T); const __m128i pb = _mm_sad_epu8(L_lo, TL_lo); const __m128i mask = _mm_cmpgt_epi32(pb, pa); const __m128i A = _mm_and_si128(mask, L); const __m128i B = _mm_andnot_si128(mask, T); const __m128i pred = _mm_or_si128(A, B); L = _mm_add_epi8(src, pred); out[i + (2)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
    do { T = _mm_srli_si128(T, 4); TL = _mm_srli_si128(TL, 4); src = _mm_srli_si128(src, 4); pa = _mm_srli_si128(pa, 4); } while (0);
    do { const __m128i L_lo = _mm_unpacklo_epi32(L, T); const __m128i TL_lo = _mm_unpacklo_epi32(TL, T); const __m128i pb = _mm_sad_epu8(L_lo, TL_lo); const __m128i mask = _mm_cmpgt_epi32(pb, pa); const __m128i A = _mm_and_si128(mask, L); const __m128i B = _mm_andnot_si128(mask, T); const __m128i pred = _mm_or_si128(A, B); L = _mm_add_epi8(src, pred); out[i + (3)] = (uint32_t)_mm_cvtsi128_si32(L); } while (0);
  }
  if (i != num_pixels) {
    VP8LPredictorsAdd_C[11](in + i, upper + i, num_pixels - i, out + i);
  }
}
# 397 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
static void PredictorAdd12_SSE2(const uint32_t* in, const uint32_t* upper,
  ...
  for (i = 0; i + 4 <= num_pixels; i += 4) {
    ...
    do { const __m128i all = _mm_add_epi16(L, (diff_lo)); const __m128i alls = _mm_packus_epi16(all, all); const __m128i res = _mm_add_epi8(src, alls); out[i + (0)] = (uint32_t)_mm_cvtsi128_si32(res); L = _mm_unpacklo_epi8(res, zero); } while (0);
    do { if ((0) == 0) (diff_lo) = _mm_srli_si128((diff_lo), 8); src = _mm_srli_si128(src, 4); } while (0);
    do { const __m128i all = _mm_add_epi16(L, (diff_lo)); const __m128i alls = _mm_packus_epi16(all, all); const __m128i res = _mm_add_epi8(src, alls); out[i + (1)] = (uint32_t)_mm_cvtsi128_si32(res); L = _mm_unpacklo_epi8(res, zero); } while (0);
    do { if ((1) == 0) (diff_lo) = _mm_srli_si128((diff_lo), 8); src = _mm_srli_si128(src, 4); } while (0);
    do { const __m128i all = _mm_add_epi16(L, (diff_hi)); const __m128i alls = _mm_packus_epi16(all, all); const __m128i res = _mm_add_epi8(src, alls); out[i + (2)] = (uint32_t)_mm_cvtsi128_si32(res); L = _mm_unpacklo_epi8(res, zero); } while (0);
    do { if ((0) == 0) (diff_hi) = _mm_srli_si128((diff_hi), 8); src = _mm_srli_si128(src, 4); } while (0);
    do { const __m128i all = _mm_add_epi16(L, (diff_hi)); const __m128i alls = _mm_packus_epi16(all, all); const __m128i res = _mm_add_epi8(src, alls); out[i + (3)] = (uint32_t)_mm_cvtsi128_si32(res); L = _mm_unpacklo_epi8(res, zero); } while (0);
  }
  if (i != num_pixels) {
...
static void PredictorAdd13_SSE2(const uint32_t* in, const uint32_t* upper, int num_pixels, uint32_t* out) { int x; 
# 431 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
((void) (0))
# 431 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
; for (x = 0; x < num_pixels; ++x) { const uint32_t pred = (Predictor13_SSE2)(&out[x - 1], upper + x); out[x] = VP8LAddPixels(in[x], pred); } }
...
static void AddGreenToBlueAndRed_SSE2(const uint32_t* const src, int num_pixels,
  ...
  for (i = 0; i + 4 <= num_pixels; i += 4) {
    ...
    const __m128i B = _mm_shufflelo_epi16(A, 
# 442 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            (((
# 442 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                            2
# 442 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            ) << 6) | ((
# 442 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
# 442 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
    ...
    const __m128i C = _mm_shufflehi_epi16(B, 
# 443 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            (((
# 443 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                            2
# 443 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            ) << 6) | ((
# 443 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
static void TransformColorInverse_SSE2(const VP8LMultipliers* const m,
  ...
  const __m128i mults_rb = _mm_set1_epi32((int)(((uint32_t)((((int16_t)(m->green_to_red_ << 8)) >> 5)) << 16) | (((((int16_t)(m->green_to_blue_ << 8)) >> 5)) & 0xffff)));
  const __m128i mults_b2 = _mm_set1_epi32((int)(((uint32_t)((((int16_t)(m->red_to_blue_ << 8)) >> 5)) << 16) | ((0) & 0xffff)));
  ...
  for (i = 0; i + 4 <= num_pixels; i += 4) {
    ...
    const __m128i B = _mm_shufflelo_epi16(A, 
# 472 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            (((
# 472 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                            2
# 472 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            ) << 6) | ((
# 472 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
# 472 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
    ...
    const __m128i C = _mm_shufflehi_epi16(B, 
# 473 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            (((
# 473 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                            2
# 473 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                            ) << 6) | ((
# 473 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
static void ConvertBGRAToRGBA_SSE2(const uint32_t* src,
  ...
  while (num_pixels >= 8) {
    ...
    const __m128i D1 = _mm_shufflelo_epi16(B1, 
# 541 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              (((
# 541 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                              2
# 541 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              ) << 6) | ((
# 541 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
# 541 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
    ...
    const __m128i D2 = _mm_shufflelo_epi16(B2, 
# 542 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              (((
# 542 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                              2
# 542 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              ) << 6) | ((
# 542 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
# 542 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
    ...
    const __m128i E1 = _mm_shufflehi_epi16(D1, 
# 543 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              (((
# 543 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                              2
# 543 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              ) << 6) | ((
# 543 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
...
# 543 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
    ...
    const __m128i E2 = _mm_shufflehi_epi16(D2, 
# 544 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              (((
# 544 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
                                              2
# 544 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c" 3 4
                                              ) << 6) | ((
# 544 "/doner/libwebp/libwebp-31bea324/src/dsp/lossless_sse2.c"
