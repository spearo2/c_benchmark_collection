# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 2



# 1 "/usr/include/assert.h" 1 3 4
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 2
# 35 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
...
# 39 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 39 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                    ;
...
# 57 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 57 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                    ;
  for (i = 0; i < max_pos; i += 32) {
    const __m128i A0 = _mm_loadu_si128((const __m128i*)(src + i + 0 ));
...
static inline void DoHorizontalFilter_SSE2(const uint8_t* in,
...
# 81 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 81 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
 ; 
# 81 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 81 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
...
static inline void DoVerticalFilter_SSE2(const uint8_t* in,
...
# 114 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 114 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
 ; 
# 114 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 114 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
...
static inline int GradientPredictor_SSE2(uint8_t a, uint8_t b, uint8_t c) {
  const int g = a + b - c;
...
static inline void DoGradientFilter_SSE2(const uint8_t* in,
                                              int width, int height, int stride,
                                              int row, int num_rows,
                                              uint8_t* out) {
  const size_t start_offset = row * stride;
...
# 177 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 177 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
 ; 
# 177 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
 ((void) (0))
# 177 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
...
static void HorizontalUnfilter_SSE2(const uint8_t* prev, const uint8_t* in,
  ...
  int i;
  __m128i last;
  out[0] = (uint8_t)(in[0] + (prev == 
# 227 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
                                     ((void *)0) 
# 227 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                                          ? 0 : prev[0]));
  if (width <= 1) return;
...
static void VerticalUnfilter_SSE2(const uint8_t* prev, const uint8_t* in,
                                  uint8_t* out, int width) {
  if (prev == 
# 247 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
             ((void *)0)
# 247 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                 ) {
    HorizontalUnfilter_SSE2(
# 248 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
                           ((void *)0)
# 248 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                               , in, out, width);
  } else {
    int i;
    const int max_pos = width & ~31;
    
# 252 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
   ((void) (0))
# 252 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                     ;
    for (i = 0; i < max_pos; i += 32) {
...
static void GradientUnfilter_SSE2(const uint8_t* prev, const uint8_t* in,
                                  uint8_t* out, int width) {
  if (prev == 
# 308 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
             ((void *)0)
# 308 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                 ) {
    HorizontalUnfilter_SSE2(
# 309 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c" 3 4
                           ((void *)0)
# 309 "/doner/libwebp/libwebp-31bea324/src/dsp/filters_sse2.c"
                               , in, out, width);
  } else {
