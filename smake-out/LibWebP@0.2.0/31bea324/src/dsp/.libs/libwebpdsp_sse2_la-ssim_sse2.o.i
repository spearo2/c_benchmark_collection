# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c" 2



# 1 "/usr/include/assert.h" 1 3 4
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c" 2
...
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c" 2




static inline void SubtractAndSquare_SSE2(const __m128i a, const __m128i b,
                                               __m128i* const sum) {
...
# 125 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c"
...
# 132 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c" 3 4
 ((void) (0))
# 132 "/doner/libwebp/libwebp-31bea324/src/dsp/ssim_sse2.c"
                                     ;
  do { const __m128i Wy = _mm_set1_epi16((1)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
  do { const __m128i Wy = _mm_set1_epi16((2)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
  do { const __m128i Wy = _mm_set1_epi16((3)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
  do { const __m128i Wy = _mm_set1_epi16((4)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
  do { const __m128i Wy = _mm_set1_epi16((3)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
  do { const __m128i Wy = _mm_set1_epi16((2)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
  do { const __m128i Wy = _mm_set1_epi16((1)); const __m128i W = _mm_mullo_epi16(Wx, Wy); const __m128i a0 = _mm_loadl_epi64((const __m128i*)src1); const __m128i b0 = _mm_loadl_epi64((const __m128i*)src2); const __m128i a1 = _mm_unpacklo_epi8(a0, zero); const __m128i b1 = _mm_unpacklo_epi8(b0, zero); const __m128i wa1 = _mm_mullo_epi16(a1, W); const __m128i wb1 = _mm_mullo_epi16(b1, W); xm = _mm_add_epi16(xm, wa1); ym = _mm_add_epi16(ym, wb1); xxm = _mm_add_epi32(xxm, _mm_madd_epi16(a1, wa1)); xym = _mm_add_epi32(xym, _mm_madd_epi16(a1, wb1)); yym = _mm_add_epi32(yym, _mm_madd_epi16(b1, wb1)); src1 += stride1; src2 += stride2; } while (0);
