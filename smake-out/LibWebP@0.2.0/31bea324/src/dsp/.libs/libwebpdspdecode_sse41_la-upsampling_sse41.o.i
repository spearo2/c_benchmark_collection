# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 2



# 1 "/usr/include/assert.h" 1 3 4
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 2
...
#pragma GCC pop_options
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 2
# 1 "../../src/dsp/yuv.h" 1
# 39 "../../src/dsp/yuv.h"
...
# 22 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 2
# 93 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
...
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
static void UpsampleRgbLinePair_SSE41(const uint8_t* top_y, const uint8_t* bottom_y, const uint8_t* top_u, const uint8_t* top_v, const uint8_t* cur_u, const uint8_t* cur_v, uint8_t* top_dst, uint8_t* bottom_dst, int len) { int uv_pos, pos; uint8_t uv_buf[14 * 32 + 15] = { 0 }; uint8_t* const r_u = (uint8_t*)((uintptr_t)(uv_buf + 15) & ~15); uint8_t* const r_v = r_u + 32; 
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void) (0))
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
...
((void) (0))
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
; { uint8_t r1[17], r2[17]; memcpy(r1, (top_u + uv_pos), (left_over)); memcpy(r2, (cur_u + uv_pos), (left_over)); memset(r1 + (left_over), r1[(left_over) - 1], 17 - (left_over)); memset(r2 + (left_over), r2[(left_over) - 1], 17 - (left_over)); Upsample32Pixels_SSE41(r1, r2, r_u); }; { uint8_t r1[17], r2[17]; memcpy(r1, (top_v + uv_pos), (left_over)); memcpy(r2, (cur_v + uv_pos), (left_over)); memset(r1 + (left_over), r1[(left_over) - 1], 17 - (left_over)); memset(r2 + (left_over), r2[(left_over) - 1], 17 - (left_over)); Upsample32Pixels_SSE41(r1, r2, r_v); }; memcpy(tmp_top, top_y + pos, len - pos); if (bottom_y != 
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) memcpy(tmp_bottom, bottom_y + pos, len - pos); do { VP8YuvToRgb32_SSE41((tmp_top) + (0), r_u, r_v, (tmp_top_dst) + (0) * (3)); if ((tmp_bottom) != 
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) { VP8YuvToRgb32_SSE41((tmp_bottom) + (0), r_u + 64, r_v + 64, (tmp_bottom_dst) + (0) * (3)); } } while (0); memcpy(top_dst + pos * (3), tmp_top_dst, (len - pos) * (3)); if (bottom_y != 
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 170 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) { memcpy(bottom_dst + pos * (3), tmp_bottom_dst, (len - pos) * (3)); } } }
static void UpsampleBgrLinePair_SSE41(const uint8_t* top_y, const uint8_t* bottom_y, const uint8_t* top_u, const uint8_t* top_v, const uint8_t* cur_u, const uint8_t* cur_v, uint8_t* top_dst, uint8_t* bottom_dst, int len) { int uv_pos, pos; uint8_t uv_buf[14 * 32 + 15] = { 0 }; uint8_t* const r_u = (uint8_t*)((uintptr_t)(uv_buf + 15) & ~15); uint8_t* const r_v = r_u + 32; 
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void) (0))
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
...
((void *)0)
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) { const int u0_b = (cur_u[0] + u_diag) >> 1; const int v0_b = (cur_v[0] + v_diag) >> 1; VP8YuvToBgr(bottom_y[0], u0_b, v0_b, bottom_dst); } } for (pos = 1, uv_pos = 0; pos + 32 + 1 <= len; pos += 32, uv_pos += 16) { { const __m128i one = _mm_set1_epi8(1); const __m128i a = _mm_loadu_si128((const __m128i*)&(top_u + uv_pos)[0]); const __m128i b = _mm_loadu_si128((const __m128i*)&(top_u + uv_pos)[1]); const __m128i c = _mm_loadu_si128((const __m128i*)&(cur_u + uv_pos)[0]); const __m128i d = _mm_loadu_si128((const __m128i*)&(cur_u + uv_pos)[1]); const __m128i s = _mm_avg_epu8(a, d); const __m128i t = _mm_avg_epu8(b, c); const __m128i st = _mm_xor_si128(s, t); const __m128i ad = _mm_xor_si128(a, d); const __m128i bc = _mm_xor_si128(b, c); const __m128i t1 = _mm_or_si128(ad, bc); const __m128i t2 = _mm_or_si128(t1, st); const __m128i t3 = _mm_and_si128(t2, one); const __m128i t4 = _mm_avg_epu8(s, t); const __m128i k = _mm_sub_epi8(t4, t3); __m128i diag1, diag2; do { const __m128i tmp0 = _mm_avg_epu8(k, (t)); const __m128i tmp1 = _mm_and_si128((bc), st); const __m128i tmp2 = _mm_xor_si128(k, (t)); const __m128i tmp3 = _mm_or_si128(tmp1, tmp2); const __m128i tmp4 = _mm_and_si128(tmp3, one); (diag1) = _mm_sub_epi8(tmp0, tmp4); } while (0); do { const __m128i tmp0 = _mm_avg_epu8(k, (s)); const __m128i tmp1 = _mm_and_si128((ad), st); const __m128i tmp2 = _mm_xor_si128(k, (s)); const __m128i tmp3 = _mm_or_si128(tmp1, tmp2); const __m128i tmp4 = _mm_and_si128(tmp3, one); (diag2) = _mm_sub_epi8(tmp0, tmp4); } while (0); do { const __m128i t_a = _mm_avg_epu8(a, diag1); const __m128i t_b = _mm_avg_epu8(b, diag2); const __m128i t_1 = _mm_unpacklo_epi8(t_a, t_b); const __m128i t_2 = _mm_unpackhi_epi8(t_a, t_b); _mm_store_si128(((__m128i*)((r_u) + 0)) + 0, t_1); _mm_store_si128(((__m128i*)((r_u) + 0)) + 1, t_2); } while (0); do { const __m128i t_a = _mm_avg_epu8(c, diag2); const __m128i t_b = _mm_avg_epu8(d, diag1); const __m128i t_1 = _mm_unpacklo_epi8(t_a, t_b); const __m128i t_2 = _mm_unpackhi_epi8(t_a, t_b); _mm_store_si128(((__m128i*)((r_u) + 2 * 32)) + 0, t_1); _mm_store_si128(((__m128i*)((r_u) + 2 * 32)) + 1, t_2); } while (0); }; { const __m128i one = _mm_set1_epi8(1); const __m128i a = _mm_loadu_si128((const __m128i*)&(top_v + uv_pos)[0]); const __m128i b = _mm_loadu_si128((const __m128i*)&(top_v + uv_pos)[1]); const __m128i c = _mm_loadu_si128((const __m128i*)&(cur_v + uv_pos)[0]); const __m128i d = _mm_loadu_si128((const __m128i*)&(cur_v + uv_pos)[1]); const __m128i s = _mm_avg_epu8(a, d); const __m128i t = _mm_avg_epu8(b, c); const __m128i st = _mm_xor_si128(s, t); const __m128i ad = _mm_xor_si128(a, d); const __m128i bc = _mm_xor_si128(b, c); const __m128i t1 = _mm_or_si128(ad, bc); const __m128i t2 = _mm_or_si128(t1, st); const __m128i t3 = _mm_and_si128(t2, one); const __m128i t4 = _mm_avg_epu8(s, t); const __m128i k = _mm_sub_epi8(t4, t3); __m128i diag1, diag2; do { const __m128i tmp0 = _mm_avg_epu8(k, (t)); const __m128i tmp1 = _mm_and_si128((bc), st); const __m128i tmp2 = _mm_xor_si128(k, (t)); const __m128i tmp3 = _mm_or_si128(tmp1, tmp2); const __m128i tmp4 = _mm_and_si128(tmp3, one); (diag1) = _mm_sub_epi8(tmp0, tmp4); } while (0); do { const __m128i tmp0 = _mm_avg_epu8(k, (s)); const __m128i tmp1 = _mm_and_si128((ad), st); const __m128i tmp2 = _mm_xor_si128(k, (s)); const __m128i tmp3 = _mm_or_si128(tmp1, tmp2); const __m128i tmp4 = _mm_and_si128(tmp3, one); (diag2) = _mm_sub_epi8(tmp0, tmp4); } while (0); do { const __m128i t_a = _mm_avg_epu8(a, diag1); const __m128i t_b = _mm_avg_epu8(b, diag2); const __m128i t_1 = _mm_unpacklo_epi8(t_a, t_b); const __m128i t_2 = _mm_unpackhi_epi8(t_a, t_b); _mm_store_si128(((__m128i*)((r_v) + 0)) + 0, t_1); _mm_store_si128(((__m128i*)((r_v) + 0)) + 1, t_2); } while (0); do { const __m128i t_a = _mm_avg_epu8(c, diag2); const __m128i t_b = _mm_avg_epu8(d, diag1); const __m128i t_1 = _mm_unpacklo_epi8(t_a, t_b); const __m128i t_2 = _mm_unpackhi_epi8(t_a, t_b); _mm_store_si128(((__m128i*)((r_v) + 2 * 32)) + 0, t_1); _mm_store_si128(((__m128i*)((r_v) + 2 * 32)) + 1, t_2); } while (0); }; do { VP8YuvToBgr32_SSE41((top_y) + (pos), r_u, r_v, (top_dst) + (pos) * (3)); if ((bottom_y) != 
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) { VP8YuvToBgr32_SSE41((bottom_y) + (pos), r_u + 64, r_v + 64, (bottom_dst) + (pos) * (3)); } } while (0); } if (len > 1) { const int left_over = ((len + 1) >> 1) - (pos >> 1); uint8_t* const tmp_top_dst = r_u + 4 * 32; uint8_t* const tmp_bottom_dst = tmp_top_dst + 4 * 32; uint8_t* const tmp_top = tmp_bottom_dst + 4 * 32; uint8_t* const tmp_bottom = (bottom_y == 
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) ? 
...
((void *)0)
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) memcpy(tmp_bottom, bottom_y + pos, len - pos); do { VP8YuvToBgr32_SSE41((tmp_top) + (0), r_u, r_v, (tmp_top_dst) + (0) * (3)); if ((tmp_bottom) != 
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) { VP8YuvToBgr32_SSE41((tmp_bottom) + (0), r_u + 64, r_v + 64, (tmp_bottom_dst) + (0) * (3)); } } while (0); memcpy(top_dst + pos * (3), tmp_top_dst, (len - pos) * (3)); if (bottom_y != 
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c" 3 4
((void *)0)
# 171 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
) { memcpy(bottom_dst + pos * (3), tmp_bottom_dst, (len - pos) * (3)); } } }
# 186 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
extern WebPUpsampleLinePairFunc WebPUpsamplers[ ];
...
# 220 "/doner/libwebp/libwebp-31bea324/src/dsp/upsampling_sse41.c"
extern void WebPYuv444ToRgb_C(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len); static void Yuv444ToRgb_SSE41(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len) { int i; const int max_len = len & ~31; for (i = 0; i < max_len; i += 32) { VP8YuvToRgb32_SSE41(y + i, u + i, v + i, dst + i * (3)); } if (i < len) { WebPYuv444ToRgb_C(y + i, u + i, v + i, dst + i * (3), len - i); } };
extern void WebPYuv444ToBgr_C(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len); static void Yuv444ToBgr_SSE41(const uint8_t* y, const uint8_t* u, const uint8_t* v, uint8_t* dst, int len) { int i; const int max_len = len & ~31; for (i = 0; i < max_len; i += 32) { VP8YuvToBgr32_SSE41(y + i, u + i, v + i, dst + i * (3)); } if (i < len) { WebPYuv444ToBgr_C(y + i, u + i, v + i, dst + i * (3), len - i); } };
