# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
# 14 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
# 1 "../../src/dsp/yuv.h" 1
# 38 "../../src/dsp/yuv.h"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c" 2
...
#pragma GCC pop_options
# 20 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c" 2

# 1 "../../src/dsp/common_sse41.h" 1
# 38 "../../src/dsp/common_sse41.h"

# 38 "../../src/dsp/common_sse41.h"
static inline void VP8PlanarTo24b_SSE41(
...

  {
    ...
    R0 = _mm_shuffle_epi8(*in0, shuff0); R1 = _mm_shuffle_epi8(*in0, shuff1); R2 = _mm_shuffle_epi8(*in0, shuff2); R3 = _mm_shuffle_epi8(*in1, shuff0); R4 = _mm_shuffle_epi8(*in1, shuff1); R5 = _mm_shuffle_epi8(*in1, shuff2);
  }
...

  {
    ...
    G0 = _mm_shuffle_epi8(*in2, shuff0); G1 = _mm_shuffle_epi8(*in2, shuff1); G2 = _mm_shuffle_epi8(*in2, shuff2); G3 = _mm_shuffle_epi8(*in3, shuff0); G4 = _mm_shuffle_epi8(*in3, shuff1); G5 = _mm_shuffle_epi8(*in3, shuff2);
  }
...

  {
    ...
    B0 = _mm_shuffle_epi8(*in4, shuff0); B1 = _mm_shuffle_epi8(*in4, shuff1); B2 = _mm_shuffle_epi8(*in4, shuff2); B3 = _mm_shuffle_epi8(*in5, shuff0); B4 = _mm_shuffle_epi8(*in5, shuff1); B5 = _mm_shuffle_epi8(*in5, shuff2);
  }
...
static inline void VP8L32bToPlanar_SSE41(__m128i* const in0,
                                              __m128i* const in1,
                                              __m128i* const in2,
                                              __m128i* const in3) {
...
# 22 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c" 2
...
# 23 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c" 2
# 31 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
...
static inline __m128i Load_HI_16_SSE41(const uint8_t* src) {
  const __m128i zero = _mm_setzero_si128();
  return _mm_unpacklo_epi8(zero, _mm_loadl_epi64((const __m128i*)src));
}


static inline __m128i Load_UV_HI_8_SSE41(const uint8_t* src) {
  const __m128i zero = _mm_setzero_si128();
...
static inline void PlanarTo24b_SSE41(
    __m128i* const in0, __m128i* const in1, __m128i* const in2,
    __m128i* const in3, __m128i* const in4, __m128i* const in5,
    uint8_t* const rgb) {
# 125 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
...
extern void WebPInitSamplersSSE41(void);
 ...
 void WebPInitSamplersSSE41(void) {
  WebPSamplers[MODE_RGB] = YuvToRgbRow_SSE41;
  WebPSamplers[MODE_BGR] = YuvToBgrRow_SSE41;
}
# 292 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
static inline void RGB24PackedToPlanar_SSE41(
...

  {
    ...
    do { const __m128i tmp0 = _mm_shuffle_epi8(A0, shuff0); const __m128i tmp1 = _mm_shuffle_epi8(A1, shuff1); const __m128i tmp2 = _mm_shuffle_epi8(A2, shuff2); const __m128i tmp3 = _mm_shuffle_epi8(A3, shuff0); const __m128i tmp4 = _mm_shuffle_epi8(A4, shuff1); const __m128i tmp5 = _mm_shuffle_epi8(A5, shuff2); const __m128i tmp6 = _mm_or_si128(tmp0, tmp1); const __m128i tmp7 = _mm_or_si128(tmp3, tmp4); out[0 + 0] = _mm_or_si128(tmp6, tmp2); out[0 + 1] = _mm_or_si128(tmp7, tmp5); } while (0);
  }

  {
    ...
    do { const __m128i tmp0 = _mm_shuffle_epi8(A0, shuff0); const __m128i tmp1 = _mm_shuffle_epi8(A1, shuff1); const __m128i tmp2 = _mm_shuffle_epi8(A2, shuff2); const __m128i tmp3 = _mm_shuffle_epi8(A3, shuff0); const __m128i tmp4 = _mm_shuffle_epi8(A4, shuff1); const __m128i tmp5 = _mm_shuffle_epi8(A5, shuff2); const __m128i tmp6 = _mm_or_si128(tmp0, tmp1); const __m128i tmp7 = _mm_or_si128(tmp3, tmp4); out[2 + 0] = _mm_or_si128(tmp6, tmp2); out[2 + 1] = _mm_or_si128(tmp7, tmp5); } while (0);
  }

  {
    ...
    do { const __m128i tmp0 = _mm_shuffle_epi8(A0, shuff0); const __m128i tmp1 = _mm_shuffle_epi8(A1, shuff1); const __m128i tmp2 = _mm_shuffle_epi8(A2, shuff2); const __m128i tmp3 = _mm_shuffle_epi8(A3, shuff0); const __m128i tmp4 = _mm_shuffle_epi8(A4, shuff1); const __m128i tmp5 = _mm_shuffle_epi8(A5, shuff2); const __m128i tmp6 = _mm_or_si128(tmp0, tmp1); const __m128i tmp7 = _mm_or_si128(tmp3, tmp4); out[4 + 0] = _mm_or_si128(tmp6, tmp2); out[4 + 1] = _mm_or_si128(tmp7, tmp5); } while (0);
  }
}
...
static inline void RGB32PackedToPlanar_SSE41(
...
# 371 "/doner/libwebp/libwebp-31bea324/src/dsp/yuv_sse41.c"
static inline void ConvertRGBToY_SSE41(const __m128i* const R,
                                            const __m128i* const G,
                                            const __m128i* const B,
                                            __m128i* const Y) {
  const __m128i kRG_y = _mm_set_epi16((33059 - 16384), (16839), (33059 - 16384), (16839), (33059 - 16384), (16839), (33059 - 16384), (16839));
  const __m128i kGB_y = _mm_set_epi16((6420), (16384), (6420), (16384), (6420), (16384), (6420), (16384));
  ...
  do { const __m128i V0_lo = _mm_madd_epi16(RG_lo, kRG_y); const __m128i V0_hi = _mm_madd_epi16(RG_hi, kRG_y); const __m128i V1_lo = _mm_madd_epi16(GB_lo, kGB_y); const __m128i V1_hi = _mm_madd_epi16(GB_hi, kGB_y); const __m128i V2_lo = _mm_add_epi32(V0_lo, V1_lo); const __m128i V2_hi = _mm_add_epi32(V0_hi, V1_hi); const __m128i V3_lo = _mm_add_epi32(V2_lo, kHALF_Y); const __m128i V3_hi = _mm_add_epi32(V2_hi, kHALF_Y); const __m128i V5_lo = _mm_srai_epi32(V3_lo, YUV_FIX); const __m128i V5_hi = _mm_srai_epi32(V3_hi, YUV_FIX); (*Y) = _mm_packs_epi32(V5_lo, V5_hi); } while (0);
}

static inline void ConvertRGBToUV_SSE41(const __m128i* const R,
                                             const __m128i* const G,
                                             const __m128i* const B,
                                             __m128i* const U,
                                             __m128i* const V) {
  const __m128i kRG_u = _mm_set_epi16((-19081), (-9719), (-19081), (-9719), (-19081), (-9719), (-19081), (-9719));
  const __m128i kGB_u = _mm_set_epi16((28800), (0), (28800), (0), (28800), (0), (28800), (0));
  const __m128i kRG_v = _mm_set_epi16((0), (28800), (0), (28800), (0), (28800), (0), (28800));
  const __m128i kGB_v = _mm_set_epi16((-4684), (-24116), (-4684), (-24116), (-4684), (-24116), (-4684), (-24116));
  ...
  const __m128i GB_lo = _mm_unpacklo_epi16(*G, *B);
  const __m128i GB_hi = _mm_unpackhi_epi16(*G, *B);
  do { const __m128i V0_lo = _mm_madd_epi16(RG_lo, kRG_u); const __m128i V0_hi = _mm_madd_epi16(RG_hi, kRG_u); const __m128i V1_lo = _mm_madd_epi16(GB_lo, kGB_u); const __m128i V1_hi = _mm_madd_epi16(GB_hi, kGB_u); const __m128i V2_lo = _mm_add_epi32(V0_lo, V1_lo); const __m128i V2_hi = _mm_add_epi32(V0_hi, V1_hi); const __m128i V3_lo = _mm_add_epi32(V2_lo, kHALF_UV); const __m128i V3_hi = _mm_add_epi32(V2_hi, kHALF_UV); const __m128i V5_lo = _mm_srai_epi32(V3_lo, YUV_FIX + 2); const __m128i V5_hi = _mm_srai_epi32(V3_hi, YUV_FIX + 2); (*U) = _mm_packs_epi32(V5_lo, V5_hi); } while (0)
                                      ;
  do { const __m128i V0_lo = _mm_madd_epi16(RG_lo, kRG_v); const __m128i V0_hi = _mm_madd_epi16(RG_hi, kRG_v); const __m128i V1_lo = _mm_madd_epi16(GB_lo, kGB_v); const __m128i V1_hi = _mm_madd_epi16(GB_hi, kGB_v); const __m128i V2_lo = _mm_add_epi32(V0_lo, V1_lo); const __m128i V2_hi = _mm_add_epi32(V0_hi, V1_hi); const __m128i V3_lo = _mm_add_epi32(V2_lo, kHALF_UV); const __m128i V3_hi = _mm_add_epi32(V2_hi, kHALF_UV); const __m128i V5_lo = _mm_srai_epi32(V3_lo, YUV_FIX + 2); const __m128i V5_hi = _mm_srai_epi32(V3_hi, YUV_FIX + 2); (*V) = _mm_packs_epi32(V5_lo, V5_hi); } while (0)
                                      ;
}
...
static void ConvertARGBToUV_SSE41(const uint32_t* argb,
  ...
  for (i = 0; i < max_width; i += 32, u += 16, v += 16) {
    ...
    if (!do_store) {
      const __m128i prev_u = _mm_loadu_si128((const __m128i*)(u));
      const __m128i prev_v = _mm_loadu_si128((const __m128i*)(v));
      U0 = _mm_avg_epu8(U0, prev_u);
      V0 = _mm_avg_epu8(V0, prev_v);
    }
    _mm_storeu_si128((__m128i*)(u), (U0));
...
static inline void RGBA32PackedToPlanar_16b_SSE41(
    const uint16_t* const rgbx,
    __m128i* const r, __m128i* const g, __m128i* const b) {
  const __m128i in0 = _mm_loadu_si128((const __m128i*)(rgbx + 0));
  const __m128i in1 = _mm_loadu_si128((const __m128i*)(rgbx + 8));
  const __m128i in2 = _mm_loadu_si128((const __m128i*)(rgbx + 16));
  const __m128i in3 = _mm_loadu_si128((const __m128i*)(rgbx + 24));
...
static void ConvertRGBA32ToUV_SSE41(const uint16_t* rgb,
  ...
  while (rgb < last_rgb) {
    ...
    _mm_storeu_si128((__m128i*)(u), (_mm_packus_epi16(U0, U1)));
    _mm_storeu_si128((__m128i*)(v), (_mm_packus_epi16(V0, V1)));
    u += 16;
    v += 16;
    rgb += 2 * 32;
  }
