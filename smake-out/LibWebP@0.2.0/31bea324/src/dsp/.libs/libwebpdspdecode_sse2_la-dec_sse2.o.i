# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
# 15 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
# 1 "../../src/dsp/dsp.h" 1
# 18 "../../src/dsp/dsp.h"
...
# 16 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c" 2
# 25 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
...
# 26 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c" 2
...
# 27 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c" 2
...
# 28 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c" 2
...
# 29 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c" 2




static void Transform_SSE2(const int16_t* in, uint8_t* dst, int do_two) {
# 50 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
...

  {
    ...
    if (do_two) {
      ...
      dst0 = _mm_cvtsi32_si128(WebPMemToInt32(dst + 0 * 32));
      dst1 = _mm_cvtsi32_si128(WebPMemToInt32(dst + 1 * 32));
      dst2 = _mm_cvtsi32_si128(WebPMemToInt32(dst + 2 * 32));
      dst3 = _mm_cvtsi32_si128(WebPMemToInt32(dst + 3 * 32));
    }
    ...
    if (do_two) {
      ...
      WebPInt32ToMem(dst + 0 * 32, _mm_cvtsi128_si32(dst0));
      WebPInt32ToMem(dst + 1 * 32, _mm_cvtsi128_si32(dst1));
      WebPInt32ToMem(dst + 2 * 32, _mm_cvtsi128_si32(dst2));
      WebPInt32ToMem(dst + 3 * 32, _mm_cvtsi128_si32(dst3));
    }
  }
}
# 253 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
static inline void SignedShift8b_SSE2(__m128i* const x) {
  const __m128i zero = _mm_setzero_si128();
...
# 273 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
static inline void GetNotHEV_SSE2(const __m128i* const p1,
                                       const __m128i* const p0,
                                       const __m128i* const q0,
                                       const __m128i* const q1,
                                       int hev_thresh, __m128i* const not_hev) {
  const __m128i zero = _mm_setzero_si128();
  const __m128i t_1 = _mm_or_si128( _mm_subs_epu8((*p0), (*p1)), _mm_subs_epu8((*p1), (*p0)));
  const __m128i t_2 = _mm_or_si128( _mm_subs_epu8((*q0), (*q1)), _mm_subs_epu8((*q1), (*q0)));
...
static inline void GetBaseDelta_SSE2(const __m128i* const p1,
                                          const __m128i* const p0,
                                          const __m128i* const q0,
                                          const __m128i* const q1,
                                          __m128i* const delta) {
...
static inline void DoSimpleFilter_SSE2(__m128i* const p0,
                                            __m128i* const q0,
...
static inline void Update2Pixels_SSE2(__m128i* const pi, __m128i* const qi,
  ...
  *qi = _mm_subs_epi8(*qi, delta);
  { (*pi) = _mm_xor_si128(*pi, sign_bit); (*qi) = _mm_xor_si128(*qi, sign_bit); };
}


static inline void NeedsFilter_SSE2(const __m128i* const p1,
                                         const __m128i* const p0,
                                         const __m128i* const q0,
                                         const __m128i* const q1,
                                         int thresh, __m128i* const mask) {
  const __m128i m_thresh = _mm_set1_epi8((char)thresh);
  const __m128i t1 = _mm_or_si128( _mm_subs_epu8((*q1), (*p1)), _mm_subs_epu8((*p1), (*q1)));
  const __m128i kFE = _mm_set1_epi8((char)0xFE);
  const __m128i t2 = _mm_and_si128(t1, kFE);
  const __m128i t3 = _mm_srli_epi16(t2, 1);

  const __m128i t4 = _mm_or_si128( _mm_subs_epu8((*q0), (*p0)), _mm_subs_epu8((*p0), (*q0)));
...
static inline void DoFilter2_SSE2(__m128i* const p1, __m128i* const p0,
...
static inline void DoFilter4_SSE2(__m128i* const p1, __m128i* const p0,
                                       __m128i* const q0, __m128i* const q1,
  ...
  *p1 = _mm_adds_epi8(*p1, t3);
  { (*p1) = _mm_xor_si128(*p1, sign_bit); (*q1) = _mm_xor_si128(*q1, sign_bit); };
}


static inline void DoFilter6_SSE2(__m128i* const p2, __m128i* const p1,
...
static inline void Load8x4_SSE2(const uint8_t* const b, int stride,
...
static inline void Load16x4_SSE2(const uint8_t* const r0,
                                      const uint8_t* const r8,
                                      int stride,
                                      __m128i* const p1, __m128i* const p0,
                                      __m128i* const q0, __m128i* const q1) {
# 522 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
...
static inline void Store4x4_SSE2(__m128i* const x,
...
static inline void Store16x4_SSE2(const __m128i* const p1,
                                       const __m128i* const p0,
                                       const __m128i* const q0,
                                       const __m128i* const q1,
...
# 674 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
static inline void ComplexMask_SSE2(const __m128i* const p1,
                                         const __m128i* const p0,
                                         const __m128i* const q0,
                                         const __m128i* const q1,
...
static void VFilter16_SSE2(uint8_t* p, int stride,
  ...
  do { (mask) = _mm_or_si128( _mm_subs_epu8((p0), (p1)), _mm_subs_epu8((p1), (p0))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p2), (t1)), _mm_subs_epu8((t1), (p2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p1), (p2)), _mm_subs_epu8((p2), (p1)))); } while (0);
  ...
  do { (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q0), (q1)), _mm_subs_epu8((q1), (q0)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q2), (t1)), _mm_subs_epu8((t1), (q2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q1), (q2)), _mm_subs_epu8((q2), (q1)))); } while (0);
...
static void HFilter16_SSE2(uint8_t* p, int stride,
  ...
  do { (mask) = _mm_or_si128( _mm_subs_epu8((p0), (p1)), _mm_subs_epu8((p1), (p0))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p2), (p3)), _mm_subs_epu8((p3), (p2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p1), (p2)), _mm_subs_epu8((p2), (p1)))); } while (0);

  Load16x4_SSE2(p, p + 8 * stride, stride, &q0, &q1, &q2, &q3);
  do { (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q0), (q1)), _mm_subs_epu8((q1), (q0)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q2), (q3)), _mm_subs_epu8((q3), (q2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q1), (q2)), _mm_subs_epu8((q2), (q1)))); } while (0);
...
static void VFilter16i_SSE2(uint8_t* p, int stride,
  ...
  { (p3) = _mm_loadu_si128((__m128i*)&(p)[0 * (stride)]); (p2) = _mm_loadu_si128((__m128i*)&(p)[1 * (stride)]); (p1) = _mm_loadu_si128((__m128i*)&(p)[2 * (stride)]); (p0) = _mm_loadu_si128((__m128i*)&(p)[3 * (stride)]); };
  ...
  for (k = 3; k > 0; --k) {
    ...
    do { (mask) = _mm_or_si128( _mm_subs_epu8((p0), (p1)), _mm_subs_epu8((p1), (p0))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p2), (p3)), _mm_subs_epu8((p3), (p2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p1), (p2)), _mm_subs_epu8((p2), (p1)))); } while (0);
    { (p3) = _mm_loadu_si128((__m128i*)&(p)[0 * (stride)]); (p2) = _mm_loadu_si128((__m128i*)&(p)[1 * (stride)]); (tmp1) = _mm_loadu_si128((__m128i*)&(p)[2 * (stride)]); (tmp2) = _mm_loadu_si128((__m128i*)&(p)[3 * (stride)]); };
    do { (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((tmp2), (tmp1)), _mm_subs_epu8((tmp1), (tmp2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p2), (p3)), _mm_subs_epu8((p3), (p2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((tmp1), (p2)), _mm_subs_epu8((p2), (tmp1)))); } while (0);
...
static void VFilter8_SSE2(uint8_t* u, uint8_t* v, int stride,
  ...
  { do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u - 4 * stride)[(0 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v - 4 * stride)[(0 * (stride))]); (t1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u - 4 * stride)[(1 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v - 4 * stride)[(1 * (stride))]); (p2) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u - 4 * stride)[(2 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v - 4 * stride)[(2 * (stride))]); (p1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u - 4 * stride)[(3 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v - 4 * stride)[(3 * (stride))]); (p0) = _mm_unpacklo_epi64(U, V); } while (0); };
  do { (mask) = _mm_or_si128( _mm_subs_epu8((p0), (p1)), _mm_subs_epu8((p1), (p0))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p2), (t1)), _mm_subs_epu8((t1), (p2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p1), (p2)), _mm_subs_epu8((p2), (p1)))); } while (0);


  { do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(0 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(0 * (stride))]); (q0) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(1 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(1 * (stride))]); (q1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(2 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(2 * (stride))]); (q2) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(3 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(3 * (stride))]); (t1) = _mm_unpacklo_epi64(U, V); } while (0); };
  do { (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q0), (q1)), _mm_subs_epu8((q1), (q0)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q2), (t1)), _mm_subs_epu8((t1), (q2)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q1), (q2)), _mm_subs_epu8((q2), (q1)))); } while (0);
...
static void VFilter8i_SSE2(uint8_t* u, uint8_t* v, int stride,
  ...
  { do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(0 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(0 * (stride))]); (t2) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(1 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(1 * (stride))]); (t1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(2 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(2 * (stride))]); (p1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(3 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(3 * (stride))]); (p0) = _mm_unpacklo_epi64(U, V); } while (0); };
  do { (mask) = _mm_or_si128( _mm_subs_epu8((p0), (p1)), _mm_subs_epu8((p1), (p0))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((t1), (t2)), _mm_subs_epu8((t2), (t1)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((p1), (t1)), _mm_subs_epu8((t1), (p1)))); } while (0);

  u += 4 * stride;
  v += 4 * stride;


  { do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(0 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(0 * (stride))]); (q0) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(1 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(1 * (stride))]); (q1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(2 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(2 * (stride))]); (t1) = _mm_unpacklo_epi64(U, V); } while (0); do { const __m128i U = _mm_loadl_epi64((__m128i*)&(u)[(3 * (stride))]); const __m128i V = _mm_loadl_epi64((__m128i*)&(v)[(3 * (stride))]); (t2) = _mm_unpacklo_epi64(U, V); } while (0); };
  do { (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q0), (q1)), _mm_subs_epu8((q1), (q0)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((t1), (t2)), _mm_subs_epu8((t2), (t1)))); (mask) = _mm_max_epu8(mask, _mm_or_si128( _mm_subs_epu8((q1), (t1)), _mm_subs_epu8((t1), (q1)))); } while (0);
...
# 902 "/doner/libwebp/libwebp-31bea324/src/dsp/dec_sse2.c"
static void VE4_SSE2(uint8_t* dst) {
  const __m128i one = _mm_set1_epi8(1);
  const __m128i ABCDEFGH = _mm_loadl_epi64((__m128i*)(dst - 32 - 1));
...
static void LD4_SSE2(uint8_t* dst) {
  const __m128i one = _mm_set1_epi8(1);
  const __m128i ABCDEFGH = _mm_loadl_epi64((__m128i*)(dst - 32));
  const __m128i BCDEFGH0 = _mm_srli_si128(ABCDEFGH, 1);
  const __m128i CDEFGH00 = _mm_srli_si128(ABCDEFGH, 2);
  const __m128i CDEFGHH0 = _mm_insert_epi16(CDEFGH00, dst[-32 + 7], 3);
...
static void VR4_SSE2(uint8_t* dst) {
  ...
  const __m128i XABCD = _mm_loadl_epi64((__m128i*)(dst - 32 - 1));
...
static void RD4_SSE2(uint8_t* dst) {
  ...
  const uint32_t I = dst[-1 + 0 * 32];
  const uint32_t J = dst[-1 + 1 * 32];
  const uint32_t K = dst[-1 + 2 * 32];
  const uint32_t L = dst[-1 + 3 * 32];
...
static inline void TrueMotion_SSE2(uint8_t* dst, int size) {
...
static void VE16_SSE2(uint8_t* dst) {
  const __m128i top = _mm_loadu_si128((const __m128i*)(dst - 32));
  int j;
  for (j = 0; j < 16; ++j) {
    _mm_storeu_si128((__m128i*)(dst + j * 32), top);
  }
}
...
static inline void Put16_SSE2(uint8_t v, uint8_t* dst) {
  ...
  for (j = 0; j < 16; ++j) {
    _mm_storeu_si128((__m128i*)(dst + j * 32), values);
  }
}
...
static void VE8uv_SSE2(uint8_t* dst) {
  int j;
  const __m128i top = _mm_loadl_epi64((const __m128i*)(dst - 32));
  for (j = 0; j < 8; ++j) {
    _mm_storel_epi64((__m128i*)(dst + j * 32), top);
  }
}
