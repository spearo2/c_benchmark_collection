# 1 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
# 12 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
# 1 "/doner/libwebp/libwebp-31bea324/imageio/./pnmdec.h" 1
# 15 "/doner/libwebp/libwebp-31bea324/imageio/./pnmdec.h"
...
# 16 "/doner/libwebp/libwebp-31bea324/imageio/./pnmdec.h" 2
...
# 13 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2

# 1 "/usr/include/assert.h" 1 3 4
# 15 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
# 16 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
# 17 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
# 18 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
# 19 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
# 21 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
# 22 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 2
...
static size_t ReadLine(const uint8_t* const data, size_t off, size_t data_size,
                       char out[1024 + 1], size_t* const out_size) {
  size_t i = 0;
  *out_size = 0;
 redo:
  for (i = 0; i < 1024 && off < data_size; ++i) {
    out[i] = data[off++];
    if (out[i] == '\n') break;
  }
  if (off < data_size) {
...
static size_t FlagError(const char flag[]) {
  fprintf(
# 72 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
         stderr
# 72 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
               , "PAM header error: flags '%s' already seen.\n", flag);
  return 0;
}
...
# 82 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
 ((void) (0))
# 82 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                     ;
  while (1) {
    ...
    if (sscanf(out, "WIDTH %d", &tmp) == 1) {
      ...
      const size_t kLen = strlen(kEllipsis) + 1;
      int i;
      if (out_size > 20) snprintf(out + 20 - kLen, kLen, kEllipsis);
      for (i = 0; i < (int)strlen(out); ++i) {

        if (!
# 123 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 123 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
            (int)out[i]
# 123 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
...
# 123 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
      ...
      fprintf(
# 125 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
             stderr
# 125 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                   , "PAM header error: unrecognized entry [%s]\n", out);
      return 0;
    }
  }
  if (!(info->seen_flags & ALL_NEEDED_FLAGS)) {
    fprintf(
# 130 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
           stderr
# 130 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 , "PAM header error: missing tags%s%s%s%s\n",
  ...
  if (expected_depth != -1 && info->depth != expected_depth) {
    fprintf(
# 138 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
           stderr
# 138 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 , "PAM header error: expected DEPTH %d but got DEPTH %d\n",
...
static size_t ReadHeader(PNMInfo* const info) {
  ...
  size_t out_size;
  if (info == 
# 149 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
             ((void *)0)
# 149 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 ) return 0;
  if (info->data == 
# 150 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
                   ((void *)0) 
# 150 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                        || info->data_size < kMinPNMHeaderSize) return 0;
...
int ReadPNM(const uint8_t* const data, size_t data_size,
  ...
  uint8_t* rgb = 
# 191 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
                ((void *)0)
# 191 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                    , *tmp_rgb;
  size_t offset;
  PNMInfo info;
  ...
  if (offset == 0) {
    fprintf(
# 199 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
           stderr
# 199 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 , "Error parsing PNM header.\n");
    goto End;
  }

  if (info.type < 5 || info.type > 7) {
    fprintf(
# 204 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
           stderr
# 204 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 , "Unsupported P%d PNM format.\n", info.type);
    goto End;
  }


  if (pic == 
# 209 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
            ((void *)0)
# 209 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                ) goto End;
  if (info.width > 16383 || info.height > 16383) {
    fprintf(
# 211 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
           stderr
# 211 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 , "Invalid %dx%d dimension for PNM\n",
  ...
  if (data_size < offset + pixel_bytes) {
    fprintf(
# 218 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
           stderr
# 218 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                 , "Truncated PNM file (P%d).\n", info.type);
    goto End;
  }
  ...
  if (rgb == 
# 231 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
            ((void *)0)
# 231 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                ) goto End;
...
# 239 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
   ((void) (0))
# 239 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                              ;
...
# 245 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c" 3 4
       ((void) (0))
# 245 "/doner/libwebp/libwebp-31bea324/imageio/pnmdec.c"
                                             ;
