# 1 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c"
# 16 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c"
...
# 17 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c" 2
...
# 19 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c" 2
...
void float_values (WavpackStream *wps, int32_t *values, int32_t num_values)
{
    ...
    if (!((&wps->wvxbits)->ptr != 
# 26 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c" 3 4
        ((void *)0)
# 26 "/doner/wavpack/wavpack-5.1.0/src/unpack_floats.c"
        )) {
    ...
    while (num_values--) {
        ...
        if (*values == 0) {
            if (wps->float_flags & 8) {
                if (( (((&wps->wvxbits)->bc) ? ((&wps->wvxbits)->bc--, (&wps->wvxbits)->sr & 1) : (((++((&wps->wvxbits)->ptr) != (&wps->wvxbits)->end) ? (void) 0 : (&wps->wvxbits)->wrap (&wps->wvxbits)), (&wps->wvxbits)->bc = sizeof (*((&wps->wvxbits)->ptr)) * 8 - 1, ((&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr)) & 1) ) ? ((&wps->wvxbits)->sr >>= 1, 1) : ((&wps->wvxbits)->sr >>= 1, 0) )) {
                    do { while ((23) > (&wps->wvxbits)->bc) { if (++((&wps->wvxbits)->ptr) == (&wps->wvxbits)->end) (&wps->wvxbits)->wrap (&wps->wvxbits); (&wps->wvxbits)->sr |= (int32_t)*((&wps->wvxbits)->ptr) << (&wps->wvxbits)->bc; (&wps->wvxbits)->bc += sizeof (*((&wps->wvxbits)->ptr)) * 8; } *(&temp) = (&wps->wvxbits)->sr; if ((&wps->wvxbits)->bc > 32) { (&wps->wvxbits)->bc -= (23); (&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr) >> (sizeof (*((&wps->wvxbits)->ptr)) * 8 - (&wps->wvxbits)->bc); } else { (&wps->wvxbits)->bc -= (23); (&wps->wvxbits)->sr >>= (23); } } while (0);
                    (outval) ^= (((outval) ^ (temp)) & 0x7fffff);

                    if (exp >= 25) {
                        do { while ((8) > (&wps->wvxbits)->bc) { if (++((&wps->wvxbits)->ptr) == (&wps->wvxbits)->end) (&wps->wvxbits)->wrap (&wps->wvxbits); (&wps->wvxbits)->sr |= (int32_t)*((&wps->wvxbits)->ptr) << (&wps->wvxbits)->bc; (&wps->wvxbits)->bc += sizeof (*((&wps->wvxbits)->ptr)) * 8; } *(&temp) = (&wps->wvxbits)->sr; if ((&wps->wvxbits)->bc > 32) { (&wps->wvxbits)->bc -= (8); (&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr) >> (sizeof (*((&wps->wvxbits)->ptr)) * 8 - (&wps->wvxbits)->bc); } else { (&wps->wvxbits)->bc -= (8); (&wps->wvxbits)->sr >>= (8); } } while (0);
                        (outval) ^= (((outval) ^ ((temp) << 23)) & 0x7f800000);
                    }

                    (outval) ^= (((outval) ^ ((( (((&wps->wvxbits)->bc) ? ((&wps->wvxbits)->bc--, (&wps->wvxbits)->sr & 1) : (((++((&wps->wvxbits)->ptr) != (&wps->wvxbits)->end) ? (void) 0 : (&wps->wvxbits)->wrap (&wps->wvxbits)), (&wps->wvxbits)->bc = sizeof (*((&wps->wvxbits)->ptr)) * 8 - 1, ((&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr)) & 1) ) ? ((&wps->wvxbits)->sr >>= 1, 1) : ((&wps->wvxbits)->sr >>= 1, 0) )) << 31)) & 0x80000000);
                }
                else if (wps->float_flags & 0x10)
                    (outval) ^= (((outval) ^ ((( (((&wps->wvxbits)->bc) ? ((&wps->wvxbits)->bc--, (&wps->wvxbits)->sr & 1) : (((++((&wps->wvxbits)->ptr) != (&wps->wvxbits)->end) ? (void) 0 : (&wps->wvxbits)->wrap (&wps->wvxbits)), (&wps->wvxbits)->bc = sizeof (*((&wps->wvxbits)->ptr)) * 8 - 1, ((&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr)) & 1) ) ? ((&wps->wvxbits)->sr >>= 1, 1) : ((&wps->wvxbits)->sr >>= 1, 0) )) << 31)) & 0x80000000);
            }
        }
        else {
            *values <<= wps->float_shift;
            ...
            if (*values == 0x1000000) {
                ...
                (outval) ^= (((outval) ^ ((255) << 23)) & 0x7f800000);
            }
            else {
                if (exp)
                ...
                if (shift_count) {
                    if ((wps->float_flags & 1) ||
                        ((wps->float_flags & 2) && ( (((&wps->wvxbits)->bc) ? ((&wps->wvxbits)->bc--, (&wps->wvxbits)->sr & 1) : (((++((&wps->wvxbits)->ptr) != (&wps->wvxbits)->end) ? (void) 0 : (&wps->wvxbits)->wrap (&wps->wvxbits)), (&wps->wvxbits)->bc = sizeof (*((&wps->wvxbits)->ptr)) * 8 - 1, ((&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr)) & 1) ) ? ((&wps->wvxbits)->sr >>= 1, 1) : ((&wps->wvxbits)->sr >>= 1, 0) )))
                            *values |= ((1 << shift_count) - 1);
                    else if (wps->float_flags & 4) {
                        do { while ((shift_count) > (&wps->wvxbits)->bc) { if (++((&wps->wvxbits)->ptr) == (&wps->wvxbits)->end) (&wps->wvxbits)->wrap (&wps->wvxbits); (&wps->wvxbits)->sr |= (int32_t)*((&wps->wvxbits)->ptr) << (&wps->wvxbits)->bc; (&wps->wvxbits)->bc += sizeof (*((&wps->wvxbits)->ptr)) * 8; } *(&temp) = (&wps->wvxbits)->sr; if ((&wps->wvxbits)->bc > 32) { (&wps->wvxbits)->bc -= (shift_count); (&wps->wvxbits)->sr = *((&wps->wvxbits)->ptr) >> (sizeof (*((&wps->wvxbits)->ptr)) * 8 - (&wps->wvxbits)->bc); } else { (&wps->wvxbits)->bc -= (shift_count); (&wps->wvxbits)->sr >>= (shift_count); } } while (0);
                        *values |= temp & ((1 << shift_count) - 1);
                    }
                }

                (outval) ^= (((outval) ^ (*values)) & 0x7fffff);
                (outval) ^= (((outval) ^ ((exp) << 23)) & 0x7f800000);
            }
        }

        crc = crc * 27 + ((outval) & 0x7fffff) * 9 + (((outval) >> 23) & 0xff) * 3 + (((outval) >> 31) & 0x1);
        * (f32 *) values++ = outval;
    }
        ...
        if (*values) {
            *values <<= wps->float_shift;
            ...
            if (*values >= 0x1000000) {
                ...
                if (shift_count && (wps->float_flags & 1))
                    *values |= ((1 << shift_count) - 1);
            }
