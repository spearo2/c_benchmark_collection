# 1 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
# 16 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
...
# 17 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 2
...
# 18 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 2
...
# 20 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 2
# 28 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
int load_tag (WavpackContext *wpc)
{
    ...
    while (1) {
        ...
        if (m_tag->tag_begins_file)
            ...
            wpc->reader->set_pos_rel (wpc->wv_in, -(int32_t)(sizeof (APE_Tag_Hdr) + sizeof (ID3_Tag)), 
# 48 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 3 4
                                                                                                      2
# 48 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
                                                                                                              );
        else
            wpc->reader->set_pos_rel (wpc->wv_in, -(int32_t)sizeof (APE_Tag_Hdr), 
# 50 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 3 4
                                                                                 2
# 50 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
                                                                                         );
        ...
        if (wpc->reader->read_bytes (wpc->wv_in, &m_tag->ape_tag_hdr, sizeof (APE_Tag_Hdr)) == sizeof (APE_Tag_Hdr) &&
            !strncmp (m_tag->ape_tag_hdr.ID, "APETAGEX", 8)) {
                ...
                if (m_tag->ape_tag_hdr.version == 2000 && m_tag->ape_tag_hdr.item_count &&
                    ...
                    m_tag->ape_tag_hdr.length <= (1024 * 1024 * 16) &&
                    (m_tag->ape_tag_data = malloc (m_tag->ape_tag_hdr.length)) != 
# 62 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 3 4
                                                                                 ((void *)0)
# 62 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
                                                                                     ) {
                        ...
                        if (!(m_tag->ape_tag_hdr.flags & 0x20000000)) {
                            ...
                            wpc->reader->set_pos_rel (wpc->wv_in, m_tag->tag_file_pos, 
# 84 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 3 4
                                                                                      2
# 84 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
                                                                                              );
                        ...
                        if (wpc->reader->read_bytes (wpc->wv_in, m_tag->ape_tag_data,
                            ...
                            memset (&m_tag->id3_tag, 0, sizeof (m_tag->id3_tag));;
                            return 1;
                        }
                }
        }
        ...
        if (m_tag->id3_tag.tag_id [0] == 'T') {
            memset (&m_tag->ape_tag_hdr, 0, sizeof (m_tag->ape_tag_hdr));;
            return 1;
        }
...
# 140 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
        m_tag->tag_file_pos = -(int32_t)sizeof (ID3_Tag);
        wpc->reader->set_pos_rel (wpc->wv_in, m_tag->tag_file_pos, 
# 141 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 3 4
                                                                  2
# 141 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
                                                                          );

        if (wpc->reader->read_bytes (wpc->wv_in, &m_tag->id3_tag, sizeof (ID3_Tag)) != sizeof (ID3_Tag) ||
            strncmp (m_tag->id3_tag.tag_id, "TAG", 3)) {
                m_tag->tag_begins_file = 1;
                memset (&m_tag->id3_tag, 0, sizeof (m_tag->id3_tag));;
            }
    }
}
...
void free_tag (M_Tag *m_tag)
{
    if (m_tag->ape_tag_data) {
        free (m_tag->ape_tag_data);
        m_tag->ape_tag_data = 
# 177 "/doner/wavpack/wavpack-5.1.0/src/tags.c" 3 4
                             ((void *)0)
# 177 "/doner/wavpack/wavpack-5.1.0/src/tags.c"
                                 ;
    }
}
