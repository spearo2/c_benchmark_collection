# 1 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
# 15 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
...
# 16 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c" 2
...
# 17 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c" 2
...
# 19 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c" 2
...
int WavpackGetNumTagItems (WavpackContext *wpc)
{
    ...
    while (WavpackGetTagItemIndexed (wpc, i, 
# 44 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c" 3 4
                                            ((void *)0)
# 44 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
                                                , 0))
        ++i;
...
int WavpackGetNumBinaryTagItems (WavpackContext *wpc)
{
    ...
    while (WavpackGetBinaryTagItemIndexed (wpc, i, 
# 57 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c" 3 4
                                                  ((void *)0)
# 57 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
                                                      , 0))
        ++i;

    return i;
}
# 76 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
int WavpackGetTagItem (WavpackContext *wpc, const char *item, char *value, int size)
{
    ...
    if (m_tag->ape_tag_hdr.ID [0] == 'A')
        return get_ape_tag_item (m_tag, item, value, size, 0x0);
    else if (m_tag->id3_tag.tag_id [0] == 'T')
        return get_id3_tag_item (m_tag, item, value, size);
    else
        return 0;
}
# 99 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
int WavpackGetBinaryTagItem (WavpackContext *wpc, const char *item, char *value, int size)
{
    M_Tag *m_tag = &wpc->m_tag;
    ...
    if (m_tag->ape_tag_hdr.ID [0] == 'A')
        return get_ape_tag_item (m_tag, item, value, size, 0x1);
    else
        return 0;
}
# 125 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
int WavpackGetTagItemIndexed (WavpackContext *wpc, int index, char *item, int size)
{
    M_Tag *m_tag = &wpc->m_tag;
    ...
    if (m_tag->ape_tag_hdr.ID [0] == 'A')
        return get_ape_tag_item_indexed (m_tag, index, item, size, 0x0);
    else if (m_tag->id3_tag.tag_id [0] == 'T')
...
int WavpackGetBinaryTagItemIndexed (WavpackContext *wpc, int index, char *item, int size)
{
    ...
    if (m_tag->ape_tag_hdr.ID [0] == 'A')
        return get_ape_tag_item_indexed (m_tag, index, item, size, 0x1);
    else
        return 0;
}
# 164 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
int WavpackAppendTagItem (WavpackContext *wpc, const char *item, const char *value, int vsize)
{
    while (WavpackDeleteTagItem (wpc, item));
    return append_ape_tag_item (wpc, item, value, vsize, 0x0);
}

int WavpackAppendBinaryTagItem (WavpackContext *wpc, const char *item, const char *value, int vsize)
{
    while (WavpackDeleteTagItem (wpc, item));
    return append_ape_tag_item (wpc, item, value, vsize, 0x1);
}
...
static int get_ape_tag_item (M_Tag *m_tag, const char *item, char *value, int size, int type)
{
    ...
    for (i = 0; i < m_tag->ape_tag_hdr.item_count && q - p > 8; ++i) {
        ...
        if (isize && vsize && !strcasecmp (item, (char *) p) && ((flags & 6) >> 1) == type) {
...
static int append_ape_tag_item (WavpackContext *wpc, const char *item, const char *value, int vsize, int type)
{
    ...
    if (m_tag->ape_tag_hdr.ID [0] == 'A') {
        ...
        if (m_tag->ape_tag_hdr.length + new_item_len > (1024 * 1024 * 16)) {
...
static int write_tag_blockout (WavpackContext *wpc)
{
    ...
    if (m_tag->ape_tag_hdr.ID [0] == 'A' && m_tag->ape_tag_hdr.item_count) {
        ...
        if (m_tag->ape_tag_hdr.flags & 0x80000000) {
            ...
            WavpackNativeToLittleEndian (&m_tag->ape_tag_hdr, "8LLLL");
            result = wpc->blockout (wpc->wv_out, &m_tag->ape_tag_hdr, sizeof (m_tag->ape_tag_hdr));
            WavpackLittleEndianToNative (&m_tag->ape_tag_hdr, "8LLLL");
        }
...
static int write_tag_reader (WavpackContext *wpc)
{
    ...
    if (tag_size && (m_tag->ape_tag_hdr.flags & 0x80000000))
        tag_size += sizeof (m_tag->ape_tag_hdr);

    result = !wpc->reader->set_pos_rel (wpc->wv_in, m_tag->tag_file_pos, 
# 522 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c" 3 4
                                                                        2
# 522 "/doner/wavpack/wavpack-5.1.0/src/tag_utils.c"
                                                                                );
