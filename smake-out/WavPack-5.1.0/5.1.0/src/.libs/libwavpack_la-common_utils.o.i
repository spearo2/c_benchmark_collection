# 1 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
# 19 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
...
# 20 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 2
...
# 21 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 2
...
# 22 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 2
...
# 24 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 2
...
# 55 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
int WavpackGetMode (WavpackContext *wpc)
{
    int mode = 0;

    if (wpc) {
        if (wpc->config.flags & 8)
            mode |= 0x4;
        else if (!(wpc->config.flags & 0x1000000))
            mode |= 0x2;
        ...
        if (wpc->config.flags & 0x200)
            mode |= 0x40;

        if (wpc->config.flags & 0x2000000)
            mode |= (0x80 | (wpc->config.xmode << 12));

        if (wpc->config.flags & 0x40000)
            mode |= 0x200;

        if (wpc->config.flags & 0x8000000)
            mode |= 0x800;

        if ((wpc->config.flags & 8) && (wpc->config.flags & 0x20000) &&
...
# 132 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
int WavpackGetQualifyMode (WavpackContext *wpc)
{
...
{
    if (wpc && wpc->stream3)
        return WavpackGetAverageBitrate (wpc, 1);
...
# 303 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
...
# 324 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
...
WavpackContext *WavpackCloseFile (WavpackContext *wpc)
{
    ...
    return 
# 390 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
          ((void *)0)
# 390 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
              ;
}
...
unsigned char *WavpackGetWrapperData (WavpackContext *wpc)
{
    return wpc ? wpc->wrapper_data : 
# 405 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                    ((void *)0)
# 405 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                        ;
}
...
void WavpackFreeWrapper (WavpackContext *wpc)
{
    if (wpc && wpc->wrapper_data) {
        ...
        wpc->wrapper_data = 
# 412 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                           ((void *)0)
# 412 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                               ;
        wpc->wrapper_bytes = 0;
    }
}
...
# 469 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
int WavpackGetBitsPerSample (WavpackContext *wpc)
{
...
void free_streams (WavpackContext *wpc)
{
    ...
    while (si--) {
        if (wpc->streams [si]->blockbuff) {
            ...
            wpc->streams [si]->blockbuff = 
# 509 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                          ((void *)0)
# 509 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                              ;
        }

        if (wpc->streams [si]->block2buff) {
            free (wpc->streams [si]->block2buff);
            wpc->streams [si]->block2buff = 
# 514 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                           ((void *)0)
# 514 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                               ;
        }

        if (wpc->streams [si]->sample_buffer) {
            free (wpc->streams [si]->sample_buffer);
            wpc->streams [si]->sample_buffer = 
# 519 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                              ((void *)0)
# 519 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                                  ;
        }

        if (wpc->streams [si]->dc.shaping_data) {
            free (wpc->streams [si]->dc.shaping_data);
            wpc->streams [si]->dc.shaping_data = 
# 524 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                                ((void *)0)
# 524 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                                    ;
        }
        ...
        if (wpc->streams [si]->dsd.probabilities) {
            ...
            wpc->streams [si]->dsd.probabilities = 
# 530 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                                  ((void *)0)
# 530 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                                      ;
        }

        if (wpc->streams [si]->dsd.summed_probabilities) {
            free (wpc->streams [si]->dsd.summed_probabilities);
            wpc->streams [si]->dsd.summed_probabilities = 
# 535 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                                         ((void *)0)
# 535 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                                             ;
        }
        ...
        if (wpc->streams [si]->dsd.value_lookup) {
            ...
            wpc->streams [si]->dsd.value_lookup = 
# 546 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                                 ((void *)0)
# 546 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                                     ;
        }

        if (wpc->streams [si]->dsd.ptable) {
            free (wpc->streams [si]->dsd.ptable);
            wpc->streams [si]->dsd.ptable = 
# 551 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                                           ((void *)0)
# 551 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                               ;
        }
        ...
        if (si) {
            ...
            free (wpc->streams [si]);
            wpc->streams [si] = 
# 558 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                               ((void *)0)
# 558 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                                   ;
        }
    }
...
void WavpackFloatNormalize (int32_t *values, int32_t num_values, int delta_exp)
{
    ...
    while (num_values--) {
        if ((exp = (((*fvalues) >> 23) & 0xff)) == 0 || exp + delta_exp <= 0)
            *fvalues = 0;
        else if (exp == 255 || (exp += delta_exp) >= 255) {
            (*fvalues) ^= (((*fvalues) ^ ((255) << 23)) & 0x7f800000);
            (*fvalues) ^= (((*fvalues) ^ (0)) & 0x7fffff);
        }
        else
            (*fvalues) ^= (((*fvalues) ^ ((exp) << 23)) & 0x7f800000);
...
void WavpackLittleEndianToNative (void *data, char *format)
{
    ...
    while (*format) {
        switch (*format) {
            ...
            default:
                if (
# 614 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 614 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                   *format
# 614 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
...
void WavpackNativeToLittleEndian (void *data, char *format)
{
    ...
    while (*format) {
        switch (*format) {
            ...
            default:
                if (
# 658 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 658 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                   *format
# 658 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ))] & (unsigned short int) _ISdigit)
# 658 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
...
void WavpackBigEndianToNative (void *data, char *format)
{
    ...
    while (*format) {
        switch (*format) {
            ...
            default:
                if (
# 695 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 695 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                   *format
# 695 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ))] & (unsigned short int) _ISdigit)
# 695 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
...
void WavpackNativeToBigEndian (void *data, char *format)
{
    ...
    while (*format) {
        switch (*format) {
            ...
            default:
                if (
# 739 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 739 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
                   *format
# 739 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c" 3 4
                   ))] & (unsigned short int) _ISdigit)
# 739 "/doner/wavpack/wavpack-5.1.0/src/common_utils.c"
