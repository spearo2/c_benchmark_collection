# 1 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
# 36 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
...
# 37 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 2
...
# 38 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 2
...
# 40 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 2
...
# 42 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 2
...
# 43 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 2
...
# 46 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 2
# 65 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
...
static int set_pos_abs (void *id, int64_t pos)
{
    ...
    return fseeko (id, pos, 
# 84 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                          0
# 84 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                                  );
...
# 126 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
static int64_t get_length (void *id)
{
    FILE *file = id;
    struct stat statbuf;

    if (!file || fstat (fileno (file), &statbuf) || !
# 131 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                                                    ((((
# 131 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                                                    statbuf.st_mode
# 131 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                                                    )) & 0170000) == (0100000))
# 131 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
...
static int can_seek (void *id)
{
    ...
    return file && !fstat (fileno (file), &statbuf) && 
# 144 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                                                      ((((
# 144 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                                                      statbuf.st_mode
# 144 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                                                      )) & 0170000) == (0100000))
# 144 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
...
# 164 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
static int truncate_here (void *id)
{
    FILE *file = id;
    off_t curr_pos = ftello (file);
...
# 190 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
...
# 225 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
WavpackContext *WavpackOpenFileInput (const char *infilename, char *error, int flags, int norm_offset)
{
    char *file_mode = (flags & 0x40) ? "r+b" : "rb";
    ...
    if (*infilename == '-') {
        wv_id = 
# 237 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
               stdin
# 237 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                    ;
    ...
    else if ((wv_id = fopen_func (infilename, file_mode)) == 
# 245 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                                                            ((void *)0)
# 245 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                                                                ) {
        if (error) strcpy (error, (flags & 0x40) ? "can't open file for editing" : "can't open file");
        return 
# 247 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
              ((void *)0)
# 247 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                  ;
    }

    if (wv_id != 
# 250 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                stdin 
# 250 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                      && (flags & 0x1)) {
        ...
        wvc_id = 
# 259 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c" 3 4
                ((void *)0)
# 259 "/doner/wavpack/wavpack-5.1.0/src/open_filename.c"
                    ;
