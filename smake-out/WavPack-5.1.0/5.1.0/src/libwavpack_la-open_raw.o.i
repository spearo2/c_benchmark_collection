# 1 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
# 17 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
...
# 18 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 2
...
# 19 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 2
...
# 21 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 2
...
static WavpackStreamReader64 raw_reader = {
    ...
    raw_push_back_byte, raw_get_length, raw_can_seek, 
# 121 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 3 4
                                                     ((void *)0)
# 121 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
                                                         , raw_close_stream
};
# 133 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
...
# 138 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 3 4
                               ((void *)0)
# 138 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
                                   , *raw_wvc = 
# 138 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 3 4
                                                ((void *)0)
# 138 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
    ...
    if (strncmp (main_data, "wvpk", 4)) {
        ...
        while (main_bytes >= 12) {
            ...
            if (block_size > main_bytes) {
                ...
                return 
# 201 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 3 4
                      ((void *)0)
# 201 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
                          ;
            }
            ...
            do { int64_t tmp = (block_samples); if (tmp < 0) (*wphdr).total_samples = (uint32_t) -1; else { tmp += (tmp / (int64_t) 0xffffffff); (*wphdr).total_samples = (uint32_t) tmp; (*wphdr).total_samples_u8 = (unsigned char) (tmp >> 32); } } while (0);
            ...
            if (corr_data && corr_bytes >= 4) {
                ...
                if (block_size > corr_bytes) {
                    ...
                    raw_close_stream (raw_wvc);
                    return 
# 248 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 3 4
                          ((void *)0)
# 248 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
                              ;
                }
        ...
        if (main_bytes || (corr_data && corr_bytes)) {
            ...
            raw_close_stream (raw_wvc);
            return 
# 278 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c" 3 4
                  ((void *)0)
# 278 "/doner/wavpack/wavpack-5.1.0/src/open_raw.c"
                      ;
        }
    }
    else {
    ...
    return WavpackOpenFileInputEx64 (&raw_reader, raw_wv, raw_wvc, error, flags | 0x20 | 0x800, norm_offset);
}
