# 1 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
# 21 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
# 22 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
...
# 23 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
...
# 26 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
...
# 29 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
...
# 30 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
...
# 32 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
...
# 33 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2
# 82 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
# 83 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2



# 85 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
int copy_timestamp(const char *src_filename, const char *dst_filename)
{
    ...
    times[0].tv_sec = fileinfo.
# 96 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                               st_atim.tv_sec
# 96 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                                       ;
    times[0].tv_usec = 0;

    times[1].tv_sec = fileinfo.
# 99 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                               st_mtim.tv_sec
# 99 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                                       ;
    times[1].tv_usec = 0;
...
# 140 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
char *filespec_ext (char *filespec)
{
    ...
    while (--cp >= filespec) {
        ...
        if (*cp == '/')
            return 
# 147 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                  ((void *)0)
# 147 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                      ;
        ...
        if (*cp == '.') {
            if (strlen (cp+1) && strlen (cp+1) <= 4)
                ...
                return 
# 153 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                      ((void *)0)
# 153 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                          ;
        }
    }

    return 
# 157 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
          ((void *)0)
# 157 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
              ;
}
# 173 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
char *filespec_path (char *filespec)
{
    ...
    if (cp == filespec || filespec_wild (filespec))
        return 
# 180 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
              ((void *)0)
# 180 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                  ;
    ...
    if (glob (filespec, 
# 188 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                       (1 << 1)
# 188 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                                |
# 188 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                                 (1 << 2)
# 188 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
# 188 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
        ...
        globs.gl_pathc > 0)
    {
        ...
        if (stat(globs.gl_pathv[0], &fstats) == 0 && (fstats.st_mode & 
# 192 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                                                                      0040000
# 192 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                                                                             )) {
                filespec[0] = '\0';
    ...
    return 
# 201 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
          ((void *)0)
# 201 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
              ;
}
# 250 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
char *filespec_wild (char *filespec)
{
    return strpbrk (filespec, "*?");
}
# 280 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
char *filespec_name (char *filespec)
{
    ...
    if (strlen (cp + 1))
        ...
        return 
# 291 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
              ((void *)0)
# 291 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                  ;
}
# 302 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
char yna (void)
{
    ...
    while (1) {
        ...
        key = fgetc(
# 315 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                   stdin
# 315 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                        );

        if (key == 3) {
            fprintf (
# 318 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                    stderr
# 318 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                          , "^C\n");
            exit (1);
        }
        else if (key == 
# 321 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                       (-1)
# 321 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                          ) {
            fprintf (
# 322 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                    stderr
# 322 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                          , "\r\n");
            exit (1);
        }
        else if (key == '\r' || key == '\n') {
            if (choice) {
                fprintf (
# 327 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                        stderr
# 327 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                              , "\r\n");
                fflush (
# 328 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                       stderr
# 328 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                             );
                break;
            }
            else {
                fprintf (
# 332 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                        stderr
# 332 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                              , "%c", 7);
                fflush (
# 333 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                       stderr
# 333 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                             );
            }
        }
        else if (key == 'Y' || key == 'y') {
            ...
            fprintf (
# 358 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                    stderr
# 358 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                          , "%c", 7);
            fflush (
# 359 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                   stderr
# 359 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                         );
        }
    }
...
# 375 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
extern int debug_logging_mode;
# 475 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
void error_line (char *error, ...)
{
    char error_msg [512];
    va_list argptr;
...
# 481 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
   __builtin_va_start(
# 481 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
   argptr
# 481 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
   ,
# 481 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
# 483 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
   __builtin_va_end(
# 483 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
   argptr
# 483 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
   )
# 483 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                  ;
    fputs (error_msg, 
# 484 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                     stderr
# 484 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                           );
    finish_line ();
}
# 568 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
void finish_line (void)
{
    fprintf (
# 570 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
            stderr
# 570 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                  , "                                \n");
    fflush (
# 571 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
           stderr
# 571 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                 );
}
...
# 579 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 2


# 580 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
void setup_break (void)
{
    ...
    break_flag = 0;
    sigIntHandler.
# 592 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                 __sigaction_handler.sa_handler 
# 592 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                            = int_handler;
    sigemptyset (&sigIntHandler.sa_mask);
    sigIntHandler.sa_flags = 0;
    sigaction (
# 595 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
              2
# 595 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                    , &sigIntHandler, 
# 595 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                                      ((void *)0)
# 595 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
# 690 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
int64_t DoGetFileSize (FILE *hFile)
{
    struct stat statbuf;

    if (!hFile || fstat (fileno (hFile), &statbuf) || !
# 694 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                                                      ((((
# 694 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                                                      statbuf.st_mode
# 694 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                                                      )) & 0170000) == (0100000))
# 694 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
...
int DoSetFilePositionAbsolute (FILE *hFile, int64_t pos)
{
    return fseek (hFile, pos, 
# 707 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
                             0
# 707 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                                     );
}
...
# 763 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
void DoSetConsoleTitle (char *text)
{
    fprintf (
# 765 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
            stderr
# 765 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                  , "\033]0;%s\007", text);
    fflush (
# 766 "/doner/wavpack/wavpack-5.1.0/cli/utils.c" 3 4
           stderr
# 766 "/doner/wavpack/wavpack-5.1.0/cli/utils.c"
                 );
}
