# 1 "/doner/wavpack/wavpack-5.1.0/cli/riff.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/riff.c"
# 14 "/doner/wavpack/wavpack-5.1.0/cli/riff.c"
...
# 15 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 16 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 17 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 18 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 19 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 20 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 22 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 23 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
# 24 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 2
...
int ParseRiffHeaderConfig (FILE *infile, char *infilename, char *fourcc, WavpackContext *wpc, WavpackConfig *config)
{
    ...
    if (!is_rf64 && infilesize >= 4294967296LL && !(config->qmode & 0x800)) {
    ...
    while (1) {
        ...
        if (!strncmp (chunk_header.ckID, "ds64", 4)) {
            ...
            else if (WaveHeader.ChannelMask && (config->channel_mask || (config->qmode & 0x400))) {
            ...
            if (infilesize && !(config->qmode & 0x800) && infilesize - data_chunk_size > 16777216) {
                error_line ("this .WAV file has over 16 MB of extra RIFF data, probably is corrupt!");
                return 1;
            }

            if (config->qmode & 0x800) {
...
# 308 "/doner/wavpack/wavpack-5.1.0/cli/riff.c" 3 4
                                                               ((void *)0)
# 308 "/doner/wavpack/wavpack-5.1.0/cli/riff.c"
                                                                   )) {
...
int WriteRiffHeader (FILE *outfile, WavpackContext *wpc, int64_t total_samples, int qmode)
{
    ...
    if (do_rf64) {
        ...
        WavpackNativeToLittleEndian (&ds64hdr, "4L");
