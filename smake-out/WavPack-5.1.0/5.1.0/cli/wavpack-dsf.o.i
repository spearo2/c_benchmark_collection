# 1 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c"
# 13 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c"
...
# 14 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 15 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 16 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 17 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 18 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 19 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 21 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 22 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
...
# 23 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 2
# 32 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c"
...
int ParseDsfHeaderConfig (FILE *infile, char *infilename, char *fourcc, WavpackContext *wpc, WavpackConfig *config)
{
    ...
    if (infilesize && !(config->qmode & 0x800) &&
    ...
    if (format_chunk.ckSize != sizeof (DSFFormatChunk) || format_chunk.formatVersion != 1 ||
        ...
        format_chunk.chanType < 1 || format_chunk.chanType > (sizeof (channel_masks) / sizeof (channel_masks [0]))) {
            error_line ("%s is not a valid .DSF file!", infilename);
            return 1;
    }
    ...
    if (format_chunk.bitsPerSample == 1)
        config->qmode |= 0x10 | 0x40;
    else
        config->qmode |= 0x20 | 0x40;

    if (!WavpackSetConfiguration64 (wpc, config, (total_samples + 7) / 8, 
# 180 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c" 3 4
                                                                         ((void *)0)
# 180 "/doner/wavpack/wavpack-5.1.0/cli/dsf.c"
                                                                             )) {
...
int WriteDsfHeader (FILE *outfile, WavpackContext *wpc, int64_t total_samples, int qmode)
{
    ...
    for (i = 0; i < (sizeof (channel_masks) / sizeof (channel_masks [0])); ++i)
    ...
    total_blocks = (total_samples + 4096 - 1) / 4096;
    data_size = total_blocks * 4096 * num_channels;
    ...
    format_chunk.bitsPerSample = (qmode & 0x10) ? 1 : 8;
    format_chunk.sampleCount = total_samples * 8;
    format_chunk.blockSize = 4096;
