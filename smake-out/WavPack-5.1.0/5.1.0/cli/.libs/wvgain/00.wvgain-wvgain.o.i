# 1 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
# 29 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
...
# 30 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 31 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 32 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 34 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 35 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 40 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 45 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 46 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 47 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 48 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 49 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 51 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
...
# 52 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 2
# 62 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
...
static uint32_t track_histogram [12000], album_histogram [12000];
...
# 133 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
...

{
    ...
    int error_count = 0;
    char **matches = 
# 140 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                    ((void *)0)
# 140 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                        ;
    int result = 0;
# 157 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
...
# 175 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
    while (--argc) {
            ...
            while (*++*argv)
                switch (**argv) {
                    ...
                    case 'D': case 'd':
                        display_mode = 1;
                        break;
# 210 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                    case 'N': case 'n':
                        new_mode = 1;
                        break;
    ...
    if (strcmp (WavpackGetLibraryVersionString (), "5.1.0")) {
        fprintf (
# 260 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                stderr
# 260 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                      , version_warning, WavpackGetLibraryVersionString (), "5.1.0");
        fflush (
# 261 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
               stderr
# 261 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                     );
    }
    else if (!quiet_mode && !error_count) {
        fprintf (
# 264 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                stderr
# 264 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                      , sign_on, "Linux", WavpackGetLibraryVersionString ());
        fflush (
# 265 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
               stderr
# 265 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                     );
    }
    ...
    for (file_index = 0; file_index < num_files; ++file_index) {
        ...
        if (*infilename == '@') {
            ...
            char *listbuff = 
# 288 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                            ((void *)0)
# 288 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                , *cp;
            ...
            if (list == 
# 297 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                       ((void *)0)
# 297 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                           ) {
            ...
            while ((c = *cp++)) {
                ...
                if (c) {
                    char *fname = malloc (
# 326 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                                         4096
# 326 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                                 );
                    int ci = 0;
                    ...
                    do
                        fname [ci++] = c;
                    while ((c = *cp++) != '\n' && c != '\r' && c && ci < 
# 331 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                                                                        4096
# 331 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                                                                );
...
# 388 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
    }
    ...
    if (num_files) {
        ...
        for (file_index = 0; !clean_mode && !show_mode && file_index < num_files; ++file_index) {
            ...
            if (num_files > 1 && !quiet_mode) {
                fprintf (
# 409 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                        stderr
# 409 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                              , "\n%s:\n", matches [file_index]);
                fflush (
# 410 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                       stderr
# 410 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                             );
            }
            ...
            if (new_mode) {
                ...
                wpc = WavpackOpenFileInput (matches [file_index], error, 0x2 | 0x200, 0);

                if (wpc) {
                    int alreadyHasTag = WavpackGetTagItem (wpc, album_mode ? "replaygain_album_gain" : "replaygain_track_gain", 
# 422 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                                                                                                                               ((void *)0)
# 422 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                                                                                                                   , 0);
        ...
        if (result != 2)
            for (file_index = 0; (clean_mode || album_mode || show_mode) && !display_mode && file_index < num_files; ++file_index) {
                ...
                if (num_files > 1 && !quiet_mode) {
                    fprintf (
# 498 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                            stderr
# 498 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                  , "\n%s:\n", matches [file_index]);
                    fflush (
# 499 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                           stderr
# 499 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                 );
                }

                if (show_mode)
                    result = show_file_info (matches [file_index], 
# 503 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                                                                  stdout
# 503 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                                                        );
                else
        ...
        if (num_files > 1) {
            if (error_count) {
                fprintf (
# 519 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                        stderr
# 519 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                              , "\n **** warning: errors occurred in %d of %d files! ****\n", error_count, num_files);
                fflush (
# 520 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                       stderr
# 520 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                             );
            }
            else if (!quiet_mode) {
                fprintf (
# 523 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                        stderr
# 523 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                              , "\n **** %d files successfully processed ****\n", num_files);
                fflush (
# 524 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                       stderr
# 524 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                             );
            }
        }
...
# 578 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
...
static int analyze_file (char *infilename, uint32_t *histogram, float *peak)
{
    int result = 0, open_flags = 0, num_channels, wvc_mode;
    uint32_t sample_rate, window_samples;
    int64_t total_unpacked_samples = 0;
    void *decimation_context = 
# 589 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                              ((void *)0)
# 589 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                  ;
    double progress = -1.0;
    int32_t *temp_buffer;
    WavpackContext *wpc;
    ...
    memset (histogram, 0, sizeof (*histogram) * 12000);
    *peak = 0.0;
    ...
    if (!quiet_mode) {
        fprintf (
# 625 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                stderr
# 625 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                      , "analyzing %s%s,", *infilename == '-' ? "stdin" :
            ((strlen (infilename) > 30) ? filespec_name (infilename) : infilename), wvc_mode ? " (+.wvc)" : "");
        fflush (
# 627 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
               stderr
# 627 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                     );
    }
    ...
    while (result == 0) {
        ...
        if (check_break ()) {
            ...
            fprintf (
# 712 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                    stderr
# 712 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                          , "\n");

            fflush (
# 714 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                   stderr
# 714 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                         );
            result = 2;
            break;
        }
        ...
        if (WavpackGetProgress (wpc) != -1.0 &&
            progress != floor (WavpackGetProgress (wpc) * 100.0 + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 728 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                            stderr
# 728 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                  , "%s%3d%% done...",
                        nobs ? " " : "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 730 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
                           stderr
# 730 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
                                 );
                }
        }
    }
...
static int update_file (char *infilename, float track_gain, float track_peak, float album_gain, float album_peak)
{
    ...
    wpc = WavpackOpenFileInput (infilename, error, 0x40 | 0x200, 0);
    ...
    if (clean_mode) {
        ...
        if ((WavpackGetMode (wpc) & (0x10 | 0x100)) == 0x10) {
...
static int show_file_info (char *infilename, FILE *dst)
{
    ...
    wpc = WavpackOpenFileInput (infilename, error, 0x2 | 0x200, 0);
...
{
    uint32_t rate;
    double BYule[10 +1],AYule[10 +1],BButter[2 +1],AButter[2 +1];
};
...
typedef struct chan_state {
    int delay [((int)(sizeof (filter) / sizeof (filter [0])))], index, num_channels, ratio;
} ChanState;
...
static int decimation_run (void *context, int32_t *samples, int num_samples)
{
    ...
    while (num_samples) {
        ...
        if (sp->index == ((int)(sizeof (filter) / sizeof (filter [0])))) {
            ...
            for (i = 0; i < ((int)(sizeof (filter) / sizeof (filter [0]))); ++i)
                sum += (int64_t) filter [i] * sp->delay [i];

            *out_samples++ = (int32_t)(sum >> 24);
            memmove (sp->delay, sp->delay + ratio, sizeof (sp->delay [0]) * (((int)(sizeof (filter) / sizeof (filter [0]))) - ratio));
...
static void *decimation_destroy (void *context)
{
    ...
    return 
# 1388 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c" 3 4
          ((void *)0)
# 1388 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
              ;
}
# 1466 "/doner/wavpack/wavpack-5.1.0/cli/wvgain.c"
