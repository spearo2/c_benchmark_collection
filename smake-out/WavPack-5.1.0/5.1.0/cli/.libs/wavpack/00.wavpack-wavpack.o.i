# 1 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
# 24 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
...
# 25 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 26 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 27 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 28 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 31 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 32 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 33 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 34 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 35 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 36 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2

# 1 "../include/wavpack.h" 1
...
# 319 "../include/wavpack.h"
int WavpackGetMode (WavpackContext *wpc);
# 336 "../include/wavpack.h"
...
# 38 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/utils.h" 1
# 39 "/doner/wavpack/wavpack-5.1.0/cli/utils.h"
...
# 39 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 40 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 43 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 44 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
...
# 45 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 2
# 66 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
...
static struct {
    ...
    { 0, "RIFF", "wav", ParseRiffHeaderConfig, 2 },
    { 0, "RF64", "wav", ParseRiffHeaderConfig, 2 },
    { 1, "riff", "w64", ParseWave64HeaderConfig, 8 },
    { 2, "caff", "caf", ParseCaffHeaderConfig, 1 },
    { 3, "FRM8", "dff", ParseDsdiffHeaderConfig, 2 },
    { 4, "DSD ", "dsf", ParseDsfHeaderConfig, 1 }
};
...
# 300 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
...

{
    ...
    char *outfilename = 
# 307 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       ((void *)0)
# 307 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                           , *out2filename = 
# 307 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                             ((void *)0)
# 307 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                 ;
    char **matches = 
# 308 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    ((void *)0)
# 308 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                        ;
    WavpackConfig config;
    int result, i;
# 328 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
    ...
    while (--argc)
        if (**++argv == '-' && (*argv)[1] == '-' && (*argv)[2]) {
            ...
            if (!strcmp (long_option, "help")) {
                printf ("%s", help);
                return 0;
            }
            else if (!strcmp (long_option, "version")) {
                printf ("wavpack %s\n", "5.1.0");
            ...
            else if (!strcmp (long_option, "optimize-mono"))
                error_line ("warning: --optimize-mono deprecated, now enabled by default");
            else if (!strcmp (long_option, "dns")) {
                error_line ("warning: --dns deprecated, use --use-dns");
                ++error_count;
            }
            else if (!strcmp (long_option, "use-dns"))
                config.flags |= 0x20000;
            else if (!strcmp (long_option, "cross-decorr"))
                config.flags |= 0x20;
            else if (!strcmp (long_option, "merge-blocks"))
                config.flags |= 0x10000000;
            else if (!strcmp (long_option, "pair-unassigned-chans"))
                config.flags |= 0x20000000;
            else if (!strcmp (long_option, "import-id3"))
                import_id3 = 1;
            else if (!strcmp (long_option, "no-utf8-convert"))
                no_utf8_convert = 1;
            else if (!strcmp (long_option, "allow-huge-tags"))
                allow_huge_tags = 1;
            else if (!strcmp (long_option, "write-binary-tag"))
                tag_next_arg = 2;
            else if (!strncmp (long_option, "raw-pcm-skip", 12)) {
            ...
            else if (!strncmp (long_option, "raw-pcm", 7)) {
                int params [] = { 44100, 16, 2 };
                int pi, fp = 0, be = 0, us = 0, s = 0;

                for (pi = 0; *long_param && pi < 3; ++pi) {
                    if (
# 409 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       ((*__ctype_b_loc ())[(int) ((
# 409 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                       *long_param
# 409 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
...
# 409 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                ...
                if (*long_param && pi == 3) {
                    if (!strcasecmp (long_param, "be")) {
                        long_param += 2;
                        be = 1;
                    }
                    else if (!strcasecmp (long_param, "le"))
                        long_param += 2;
                }
            ...
            else if (!strncmp (long_option, "blocksize", 9)) {
                config.block_samples = strtol (long_param, 
# 479 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                          ((void *)0)
# 479 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                              , 10);
            ...
            else if (!strncmp (long_option, "channel-order", 13)) {
                ...
                for (chan = 0; chan < sizeof (channel_order); ++chan) {
                    ...
                    for (ci = 0; 
# 505 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                ((*__ctype_b_loc ())[(int) ((
# 505 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                *long_param
# 505 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
...
# 505 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                    ...
                    for (si = 0; si < (sizeof (speakers) / sizeof (speakers [0])); ++si)
                        if (!strcasecmp (name, speakers [si])) {
                            if (mask & (1L << si))
                                channel_error = 1;
                    ...
                    if (channel_error || si == (sizeof (speakers) / sizeof (speakers [0]))) {
            ...
            else if (!strncmp (long_option, "pre-quantize-round", 18)) {
                quantize_round = quantize_bits = strtol(long_param, 
# 551 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                   ((void *)0)
# 551 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                       , 10);
            ...
            else if (!strncmp (long_option, "pre-quantize", 12)) {
                quantize_bits = strtol(long_param, 
# 559 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                  ((void *)0)
# 559 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                      , 10);
                ...
                switch (**argv) {
                    ...
                    case 'C': case 'c':
                        if (config.flags & 0x80000)
                            config.flags |= 0x100000;
                        else
                            config.flags |= 0x80000;
                    ...
                    case 'A': case 'a':
                        config.qmode |= 0x100;
                        break;
# 640 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                    case 'O': case 'o':
                        output_spec = 1;
                        break;
                    ...
                    case 'J': case 'j':
                        switch (strtol (++*argv, argv, 10)) {
                            ...
                            case 0:
                                config.flags |= 0x10000;
                                config.flags &= ~0x10;
                                break;

                            case 1:
                                config.flags |= (0x10000 | 0x10);
                                break;
            ...
            if (!strcasecmp (*argv, "encoder")) {
                char *tag_arg = malloc (80);
                sprintf (tag_arg, "%s=WavPack %s", *argv, "5.1.0");
                *argv = tag_arg;
            }
            else if (!strcasecmp (*argv, "settings")) {
            ...
            if (cp && cp > *argv) {
                ...
                tag_items [i].ext = 
# 770 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                   ((void *)0)
# 770 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                       ;
            }
            else {
...
# 804 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
        else if (output_spec) {
            outfilename = malloc (strlen (*argv) + 
# 805 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                  4096
# 805 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                          );
            ...
            if (*(matches [num_files]) != '-' && *(matches [num_files]) != '@' &&
                !filespec_ext (matches [num_files]))
                    strcat (matches [num_files], (config.qmode & 0x1000) ? ".raw" : ".wav");
    ...
    if (!(~config.flags & (0x800 | 0x200))) {
        error_line ("high and fast modes are mutually exclusive!");
        ++error_count;
    }

    if ((config.qmode & 0x800) && outfilename && *outfilename == '-') {
    ...
    if (strcmp (WavpackGetLibraryVersionString (), "5.1.0")) {
        fprintf (
# 884 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                stderr
# 884 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                      , version_warning, WavpackGetLibraryVersionString (), "5.1.0");
        fflush (
# 885 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               stderr
# 885 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     );
    }
    else if (!quiet_mode && !error_count) {
        fprintf (
# 888 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                stderr
# 888 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                      , sign_on, "Linux", WavpackGetLibraryVersionString ());
        fflush (
# 889 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               stderr
# 889 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     );
    }
    ...
    for (i = 0; i < num_tag_items; ++i) {
        ...
        if (*tag_items [i].value == '@') {
            char *fn = tag_items [i].value + 1, *new_value = 
# 901 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                            ((void *)0)
# 901 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                ;
            ...
            if (!file && num_files && filespec_name (matches [0]) && *matches [0] != '-') {
                char *temp = malloc (strlen (matches [0]) + 
# 908 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                           4096
# 908 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                   );
            ...
            if (!file && outfilename && filespec_name (outfilename) && *outfilename != '-') {
                char *temp = malloc (strlen (outfilename) + 
# 917 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                           4096
# 917 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                   );
                ...
                if (tag_items [i].vsize < 1048576 * (allow_huge_tags ? 16 : 1)) {
                    ...
                    if (!DoReadFile (file, new_value, tag_items [i].vsize, &bcount) ||
                        bcount != tag_items [i].vsize) {
                            free (new_value);
                            new_value = 
# 940 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                       ((void *)0)
# 940 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                           ;
                        }
                }
    ...
    if (error_count) {
        fprintf (
# 1006 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                stderr
# 1006 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                      , "\ntype 'wavpack' for short help or 'wavpack --help' for full help\n");
        fflush (
# 1007 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               stderr
# 1007 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     );
        return 1;
    }
    ...
    for (file_index = 0; file_index < num_files; ++file_index) {
        ...
        if (*infilename == '@') {
            ...
            char *listbuff = 
# 1026 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            ((void *)0)
# 1026 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                , *cp;
            ...
            if (list == 
# 1035 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       ((void *)0)
# 1035 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                           ) {
            ...
            while ((c = *cp++)) {
                ...
                if (c) {
                    char *fname = malloc (
# 1064 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                         4096
# 1064 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                 );
                    int ci = 0;
                    ...
                    do
                        fname [ci++] = c;
                    while ((c = *cp++) != '\n' && c != '\r' && c && ci < 
# 1069 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                        4096
# 1069 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                );
...
# 1126 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
    }
    ...
    if (outfilename && outfilename [0] == '@') {
        char listbuff [
# 1134 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                      4096 
# 1134 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                               * 2], *lp = listbuff;
        FILE *list = fopen (outfilename+1, "rb");
        int c;

        if (list == 
# 1138 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   ((void *)0)
# 1138 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                       ) {
        ...
        if (c) {
            ...
            do
                outfilename [ci++] = c;
            while ((c = *lp++) != '\n' && c != '\r' && c && ci < 
# 1158 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                4096
# 1158 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                        );
    ...
    if (out2filename && (num_files > 1 || !(config.flags & 0x80000))) {
    ...
    if (num_files) {
        ...
        if (outfilename && *outfilename != '-') {
            outpath = (filespec_path (outfilename) != 
# 1200 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                     ((void *)0)
# 1200 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                         );
        ...
        for (file_index = 0; file_index < num_files; ++file_index) {
            ...
            if (config.flags & 0x80000) {
                if (!out2filename) {
                    ...
                    char *temp = malloc (strlen (outfilename) + 
# 1246 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                               4096
# 1246 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                       );
                ...
                out2filename = 
# 1260 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                              ((void *)0)
# 1260 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                  ;

            if (num_files > 1 && !quiet_mode) {
                fprintf (
# 1263 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                        stderr
# 1263 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                              , "\n%s:\n", matches [file_index]);
                fflush (
# 1264 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       stderr
# 1264 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                             );
            }

            if (filespec_ext (matches [file_index]) && !strcasecmp (filespec_ext (matches [file_index]), ".wv"))
            ...
            if (outpath)
                *filespec_name (outfilename) = '\0';
                ...
                free (outfilename);
                outfilename = 
# 1284 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                             ((void *)0)
# 1284 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                 ;
            }
            ...
            if (out2filename) {
                free (out2filename);
                out2filename = 
# 1289 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                              ((void *)0)
# 1289 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                  ;
            }
        ...
        if (num_files > 1) {
            if (error_count) {
                fprintf (
# 1297 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                        stderr
# 1297 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                              , "\n **** warning: errors occurred in %d of %d files! ****\n", error_count, num_files);
                fflush (
# 1298 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       stderr
# 1298 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                             );
            }
            else if (!quiet_mode) {
                fprintf (
# 1301 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                        stderr
# 1301 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                              , "\n **** %d files successfully processed ****\n", num_files);
                fflush (
# 1302 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       stderr
# 1302 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                             );
            }
        }
...
# 1367 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
typedef struct {
...
static int write_block (void *id, void *data, int32_t length)
{
    ...
    if (wid && wid->file && data && length) {
        if (!DoWriteFile (wid->file, data, length, &bcount) || bcount != length) {
            ...
            wid->file = 
# 1385 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       ((void *)0)
# 1385 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                           ;
            wid->error = 1;
            return 0;
        }
...
# 1455 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
static FILE *wild_fopen (char *filename, const char *mode)
{
    char *matchname = 
# 1457 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                     ((void *)0)
# 1457 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         ;
    struct stat statbuf;
    FILE *res = 
# 1459 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               ((void *)0)
# 1459 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                   ;
    glob_t globbuf;
    int i;

    glob (filename, 0, 
# 1463 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                      ((void *)0)
# 1463 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , &globbuf);

    for (i = 0; i < globbuf.gl_pathc; ++i) {
        if (stat (globbuf.gl_pathv [i], &statbuf) == -1 || 
# 1466 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                          ((((
# 1466 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                          statbuf.st_mode
# 1466 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                          )) & 0170000) == (0040000))
# 1466 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
        ...
        if (matchname) {
            free (matchname);
            matchname = 
# 1471 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       ((void *)0)
# 1471 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                           ;
            break;
        }
        else {
...
# 1498 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
...
# 1502 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            ((void *)0)
# 1502 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                , *out2filename_temp = 
# 1502 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                       ((void *)0)
# 1502 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                           , dummy;
    int use_tempfiles = (out2filename != 
# 1503 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                        ((void *)0)
# 1503 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                            ), chunk_alignment = 1;
    int imported_tag_items = 0;
    uint32_t bcount;
    WavpackConfig loc_config = *config;
    unsigned char *new_channel_order = 
# 1507 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                      ((void *)0)
# 1507 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                          ;
    ...
    wpc = WavpackOpenFileOutput (write_block, &wv_file, out2filename ? &wvc_file : 
# 1524 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                  ((void *)0)
# 1524 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                      );
    ...
    if (*infilename == '-') {
        infile = 
# 1529 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                stdin
# 1529 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     ;
...
# 1537 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                   ((void *)0)
# 1537 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                       ) {
    ...
    if (loc_config.qmode & 0x1000) {
        ...
        if (infilesize) {
            ...
            loc_config.qmode |= 0x800;
            total_samples = -1;
        }

        if (!loc_config.channel_mask && !(loc_config.qmode & 0x400)) {
...
# 1584 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                        ((void *)0)
# 1584 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                            )) {
    ...
    if (*outfilename != '-' && (wv_file.file = fopen (outfilename, "rb")) != 
# 1597 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                            ((void *)0)
# 1597 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                ) {
        ...
        if (res == 1) {
            ...
            if (!overwrite_all) {
                fprintf (
# 1606 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                        stderr
# 1606 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                              , "overwrite %s (yes/no/all)? ", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));
                fflush (
# 1607 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                       stderr
# 1607 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                             );
    ...
    if (out2filename && !overwrite_all && (wvc_file.file = fopen (out2filename, "rb")) != 
# 1625 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                         ((void *)0)
# 1625 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                             ) {
        ...
        if (res == 1) {
            fprintf (
# 1631 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 1631 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "overwrite %s (yes/no/all)? ", ((strlen (out2filename) > 30) ? filespec_name (out2filename) : out2filename));
            fflush (
# 1632 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   stderr
# 1632 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         );
    ...
    if (*outfilename == '-') {
        wv_file.file = 
# 1720 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                      stdout
# 1720 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                            ;
    ...
    else if ((wv_file.file = fopen (use_tempfiles ? outfilename_temp : outfilename, "w+b")) == 
# 1728 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                              ((void *)0)
# 1728 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                  ) {
    ...
    if (!quiet_mode) {
        if (*outfilename == '-')
            fprintf (
# 1737 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 1737 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "packing %s to stdout,", *infilename == '-' ? "stdin" : ((strlen (infilename) > 30) ? filespec_name (infilename) : infilename));
        else if (out2filename)
            fprintf (
# 1739 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 1739 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "creating %s (+%s),", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename), filespec_ext (out2filename));
        else
            fprintf (
# 1741 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 1741 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "creating %s,", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));

        fflush (
# 1743 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               stderr
# 1743 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     );
    }
    ...
    if (loc_config.qmode & 0x1000)
        if (loc_config.qmode & (0x10 | 0x20))
            WavpackSetFileInformation (wpc, "dff", 3);
    ...
    if (!(loc_config.qmode & 0x1000)) {
        ...
        if (i == (sizeof (file_formats) / sizeof (file_formats [0]))) {
    ...
    else if (raw_pcm_skip_bytes_begin) {
    ...
    if (loc_config.qmode & 0x8) {
        int layout = WavpackGetChannelLayout (wpc, 
# 1821 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                  ((void *)0)
# 1821 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                      ), i;
    ...
    if (num_channels_order || (loc_config.qmode & 0x400)) {
        int i, j;

        if (loc_config.num_channels < num_channels_order ||
            (loc_config.num_channels > num_channels_order && !(loc_config.qmode & 0x400))) {
    ...
    if (out2filename) {
        if ((wvc_file.file = fopen (use_tempfiles ? out2filename_temp : out2filename, "w+b")) == 
# 1874 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                                ((void *)0)
# 1874 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                    ) {
    ...
    if (loc_config.qmode & (0x10 | 0x20))
        result = pack_dsd_audio (wpc, infile, loc_config.qmode, new_channel_order, ((loc_config.flags & 0x8000000) || verify_mode) ? md5_digest : 
# 1887 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                                                                                           ((void *)0)
# 1887 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                                                                               );
    else
        result = pack_audio (wpc, infile, loc_config.qmode, new_channel_order, ((loc_config.flags & 0x8000000) || verify_mode) ? md5_digest : 
# 1889 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                                                                                       ((void *)0)
# 1889 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                                                                           );
    ...
    if (result == 0 && (loc_config.flags & 0x8000000))
    ...
    if (result == 0 && !(loc_config.qmode & (0x800 | 0x1000))) {
        ...
        if (wrapper_size && !(loc_config.qmode & 0x200) && !WavpackAddWrapper (wpc, buffer, wrapper_size)) {
            error_line ("%s", WavpackGetErrorMessage (wpc));
            result = 2;
        }
        ...
        if (result == 0 && import_id3 && wrapper_size > 10 && !strncmp ((char *) buffer, "ID3", 3)) {
            ...
            id3_res = ImportID3v2 (
# 1948 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                  ((void *)0)
# 1948 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                      , buffer, wrapper_size, error, &bytes_used);
            ...
            if (!allow_huge_tags && bytes_used > 1048576) {
                ...
                if (id3_res > 0)
                    id3_res = ImportID3v2 (wpc, buffer, wrapper_size, error, 
# 1960 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                            ((void *)0)
# 1960 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                );
    ...
    if (result == 0 && !WavpackFlushSamples (wpc)) {
        error_line ("%s", WavpackGetErrorMessage (wpc));
        result = 2;
    }
    ...
    if (result == 0 && (num_tag_items || imported_tag_items)) {
        int i, res = 1;
    ...
    if (result == 0 && WavpackGetNumSamples64 (wpc) != WavpackGetSampleIndex64 (wpc)) {
        if (loc_config.qmode & 0x800) {
    ...
    if (result == 0 && verify_mode)
        result = verify_audio (use_tempfiles ? outfilename_temp : outfilename, !WavpackLossyBlocks (wpc) ? md5_digest : 
# 2087 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                                                       ((void *)0)
# 2087 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                                           );
    ...
    if (use_tempfiles) {
# 2115 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
        ...
        if (out2filename) {
# 2131 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
...
# 2169 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
    gettimeofday(&time2,&timez);
    dtime = time2.tv_sec + time2.tv_usec / 1000000.0;
    dtime -= time1.tv_sec + time1.tv_usec / 1000000.0;


    if ((loc_config.flags & 0x800000) && WavpackGetEncodedNoise (wpc, 
# 2174 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                              ((void *)0)
# 2174 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                  ) > 0.0) {
    ...
    if (!quiet_mode) {
        ...
        if (outfilename && *outfilename != '-') {
            file = ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename);
            fext = wvc_file.bytes_written ? " (+.wvc)" : "";
            oper = verify_mode ? "created (and verified)" : "created";
        }
        else {
            file = (*infilename == '-') ? "stdin" : ((strlen (infilename) > 30) ? filespec_name (infilename) : infilename);
            fext = "";
            oper = "packed";
        }
        ...
        if (WavpackLossyBlocks (wpc)) {
            ...
            if (WavpackGetAverageBitrate (wpc, 1) != 0.0)
                sprintf (cratio, ", %d kbps", (int) (WavpackGetAverageBitrate (wpc, 1) / 1000.0));
        }
        else {
            cmode = "lossless";
...
static int pack_audio (WavpackContext *wpc, FILE *infile, int qmode, unsigned char *new_order, unsigned char *md5_digest_source)
{
    int64_t samples_remaining, input_samples = 65536;
    double progress = -1.0;
    ...
    while (1) {
        ...
        if ((qmode & 0x800) || samples_remaining > input_samples)
        ...
        if (check_break ()) {
            ...
            fprintf (
# 2365 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 2365 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "\n");

            fflush (
# 2367 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   stderr
# 2367 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         );
            free (sample_buffer);
            free (input_buffer);
            return 1;
        ...
        if (WavpackGetProgress (wpc) != -1.0 &&
            progress != floor (WavpackGetProgress (wpc) * encode_time_percent + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 2381 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            stderr
# 2381 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                  , "%s%3d%% done...",
                        nobs ? " " : "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 2383 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                           stderr
# 2383 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                 );
                }
        }
    }
...
static int pack_dsd_audio (WavpackContext *wpc, FILE *infile, int qmode, unsigned char *new_order, unsigned char *md5_digest_source)
{
    ...
    input_buffer = malloc (4096 * num_channels);
    sample_buffer = malloc (4096 * sizeof (int32_t) * num_channels);
    samples_remaining = WavpackGetNumSamples64 (wpc);
    ...
    while (samples_remaining) {
        ...
        if ((qmode & 0x40) || samples_remaining > 4096)
            bytes_to_read = 4096 * num_channels;
        else
        ...
        if (qmode & 0x40) {
            ...
            else if (samples_remaining < 4096)
        ...
        if (sample_count) {
            if (qmode & 0x40) {
                ...
                for (sindex = 0; sindex < 4096; ++sindex) {
                    unsigned char *srcp = input_buffer + sindex;
                    int cc;

                    for (cc = num_channels; cc--; srcp += 4096)
                        if (sindex < sample_count)
                            *sptr++ = (qmode & 0x10) ? bit_reverse_table [*srcp] : *srcp;
                        else if (*srcp)
                            non_null++;
                }
        ...
        if (check_break ()) {
            ...
            fprintf (
# 2523 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 2523 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "\n");

            fflush (
# 2525 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   stderr
# 2525 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         );
            free (sample_buffer);
            free (input_buffer);
            return 1;
        ...
        if (WavpackGetProgress (wpc) != -1.0 &&
            progress != floor (WavpackGetProgress (wpc) * encode_time_percent + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 2539 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            stderr
# 2539 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                  , "%s%3d%% done...",
                        nobs ? " " : "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 2541 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                           stderr
# 2541 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                 );
                }
        }
    }
...
# 2567 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
static int repack_file (char *infilename, char *outfilename, char *out2filename, const WavpackConfig *config)
{
    int output_lossless = !(config->flags & 8) || (config->flags & 0x80000);
    int flags = 0x1 | 0x2 | 0x100 | 0x400, imported_tag_items = 0;
    char *outfilename_temp = 
# 2571 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            ((void *)0)
# 2571 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                , *out2filename_temp = 
# 2571 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                       ((void *)0)
# 2571 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                           ;
    int use_tempfiles = (out2filename != 
# 2572 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                        ((void *)0)
# 2572 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                            ), input_mode;
    ...
    if (!(loc_config.qmode & 0x200) || import_id3)
        flags |= 0x4;
    ...
    if (!(input_mode & 0x2) && output_lossless) {
    ...
    memset (&wv_file, 0, sizeof (wv_file));;
    memset (&wvc_file, 0, sizeof (wvc_file));;
    outfile = WavpackOpenFileOutput (write_block, &wv_file, out2filename ? &wvc_file : 
# 2626 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                      ((void *)0)
# 2626 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                          );



    if (*outfilename != '-' && (wv_file.file = fopen (outfilename, "rb")) != 
# 2630 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                            ((void *)0)
# 2630 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                ) {
        DoCloseHandle (wv_file.file);
        use_tempfiles = 1;
        ...
        if (!overwrite_all) {
            if (output_lossless)
                fprintf (
# 2636 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                        stderr
# 2636 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                              , "overwrite %s (yes/no/all)? ", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));
            else
                fprintf (
# 2638 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                        stderr
# 2638 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                              , "overwrite %s with lossy transcode (yes/no/all)? ", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));

            fflush (
# 2640 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   stderr
# 2640 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         );
    ...
    if (out2filename && !overwrite_all && (wvc_file.file = fopen (out2filename, "rb")) != 
# 2657 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                         ((void *)0)
# 2657 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                             ) {
        DoCloseHandle (wvc_file.file);
        fprintf (
# 2659 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                stderr
# 2659 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                      , "overwrite %s (yes/no/all)? ", ((strlen (out2filename) > 30) ? filespec_name (out2filename) : out2filename));
        fflush (
# 2660 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               stderr
# 2660 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     );
    ...
    if (*outfilename == '-') {
        wv_file.file = 
# 2739 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                      stdout
# 2739 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                            ;
...
# 2747 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                              ((void *)0)
# 2747 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                  ) {
        error_line ("can't create file %s!", use_tempfiles ? outfilename_temp : outfilename);
        WavpackCloseFile (infile);
        WavpackCloseFile (outfile);
    ...
    if (!quiet_mode) {
        if (*outfilename == '-')
            fprintf (
# 2756 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 2756 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "packing %s to stdout,", *infilename == '-' ? "stdin" : ((strlen (infilename) > 30) ? filespec_name (infilename) : infilename));
        else if (out2filename)
            fprintf (
# 2758 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 2758 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "creating %s (+%s),", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename), filespec_ext (out2filename));
        else
            fprintf (
# 2760 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 2760 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "creating %s,", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));

        fflush (
# 2762 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
               stderr
# 2762 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                     );
    }
    ...
    if (WavpackGetWrapperBytes (infile)) {
        if (!(loc_config.qmode & 0x200) && !WavpackAddWrapper (outfile, WavpackGetWrapperData (infile), WavpackGetWrapperBytes (infile))) {
    ...
    if (loc_config.qmode & 0x8) {
        uint32_t layout = WavpackGetChannelLayout (infile, 
# 2809 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                          ((void *)0)
# 2809 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                              );
        ...
        WavpackSetChannelLayout (outfile, WavpackGetChannelLayout (infile, 
# 2818 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                          ((void *)0)
# 2818 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                              ), 
# 2818 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                 ((void *)0)
# 2818 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
    ...
    if (out2filename) {
        if ((wvc_file.file = fopen (use_tempfiles ? out2filename_temp : out2filename, "w+b")) == 
# 2823 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                                ((void *)0)
# 2823 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                    ) {
            error_line ("can't create correction file!");
            WavpackCloseFile (infile);
            DoCloseHandle (wv_file.file);
    ...
    if (result == 0) {
        ...
        if ((input_mode & 0x2) && !quantize_bits) {
    ...
    if (result == 0) {
        ...
        else if (loc_config.flags & 0x8000000) {
    ...
    if (result == 0 && WavpackGetWrapperBytes (infile)) {
        unsigned char *buffer = WavpackGetWrapperData (infile);
        int wrapper_size = WavpackGetWrapperBytes (infile);



        if (!(loc_config.qmode & 0x200) && !WavpackAddWrapper (outfile, buffer, wrapper_size)) {
            error_line ("%s", WavpackGetErrorMessage (outfile));
            result = 1;
        }
        ...
        if (result == 0 && import_id3 && wrapper_size > 10 && !strncmp ((char *) buffer, "ID3", 3)) {
            ...
            id3_res = ImportID3v2 (
# 2898 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                  ((void *)0)
# 2898 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                      , buffer, wrapper_size, error, &bytes_used);
            ...
            if (!allow_huge_tags && bytes_used > 1048576) {
                ...
                if (id3_res > 0)
                    id3_res = ImportID3v2 (outfile, buffer, wrapper_size, error, 
# 2910 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                ((void *)0)
# 2910 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                    );
    ...
    if (result == 0 && !WavpackFlushSamples (outfile)) {
        error_line ("%s", WavpackGetErrorMessage (outfile));
        result = 2;
    }
    ...
    if (result == 0 && ((input_mode & 0x10) || num_tag_items || imported_tag_items)) {
        ...
        for (i = 0; i < num_items && res; ++i) {
            item_len = WavpackGetTagItemIndexed (infile, i, 
# 2942 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                           ((void *)0)
# 2942 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                               , 0);
            ...
            if (!strcasecmp (item, "encoder")) {
                value = malloc (80);
                sprintf (value, "WavPack %s", "5.1.0");
                value_len = (int) strlen (value);
            }
            else if (!strcasecmp (item, "settings")) {
                value = malloc (256);
                make_settings_string (value, &loc_config);
                value_len = (int) strlen (value);
            }
            else {
                value_len = WavpackGetTagItem (infile, item, 
# 2960 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                            ((void *)0)
# 2960 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                , 0);
        ...
        for (i = 0; i < num_binary_items && res; ++i) {
            item_len = WavpackGetBinaryTagItemIndexed (infile, i, 
# 2971 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                 ((void *)0)
# 2971 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                     , 0);
            item = malloc (item_len + 1);
            WavpackGetBinaryTagItemIndexed (infile, i, item, item_len + 1);
            value_len = WavpackGetBinaryTagItem (infile, item, 
# 2974 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                              ((void *)0)
# 2974 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                  , 0);
    ...
    if (result == 0 && verify_mode)
        result = verify_audio (use_tempfiles ? outfilename_temp : outfilename, !WavpackLossyBlocks (outfile) ? md5_verify : 
# 3021 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                                                           ((void *)0)
# 3021 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                                                               );
    ...
    if (result == 0 && delete_source) {
        ...
        if (input_mode & 0x1) {
            char in2filename [
# 3055 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                             4096
# 3055 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                     ];

            strcpy (in2filename, infilename);
            strcat (in2filename, "c");

            if (!out2filename || strcasecmp (in2filename, out2filename)) {
    ...
    if (use_tempfiles) {
# 3084 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
        if (rename (outfilename_temp, outfilename)) {
            error_line ("can not rename temp file %s to %s!", outfilename_temp, outfilename);
            result = 1;
        }
        ...
        if (out2filename) {
# 3100 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
            if (rename (out2filename_temp, out2filename)) {
                error_line ("can not rename temp file %s to %s!", out2filename_temp, out2filename);
                result = 1;
            }
...
# 3123 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
    gettimeofday(&time2,&timez);
    dtime = time2.tv_sec + time2.tv_usec / 1000000.0;
    dtime -= time1.tv_sec + time1.tv_usec / 1000000.0;


    if ((loc_config.flags & 0x800000) && WavpackGetEncodedNoise (outfile, 
# 3128 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                                                  ((void *)0)
# 3128 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                                                      ) > 0.0) {
    ...
    if (!quiet_mode) {
        ...
        if (WavpackLossyBlocks (outfile)) {
            ...
            if (WavpackGetAverageBitrate (outfile, 1) != 0.0)
                sprintf (cratio, ", %d kbps", (int) (WavpackGetAverageBitrate (outfile, 1) / 1000.0));
        }
        else {
            cmode = "lossless";
...
# 3198 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
static int repack_audio (WavpackContext *outfile, WavpackContext *infile, unsigned char *md5_digest_source)
{
    ...
    unsigned char *new_channel_order = 
# 3202 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                      ((void *)0)
# 3202 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                          ;
    uint32_t input_samples = 65536;
    ...
    if (md5_digest_source) {
        ...
        if (qmode & 0x8) {
            int layout = WavpackGetChannelLayout (infile, 
# 3224 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                         ((void *)0)
# 3224 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                             ), i;
    ...
    if (quantize_bits && quantize_bits < bps*8) {
        ...
        if (0x8 == (WavpackGetMode(infile) & 0x8)) {
    ...
    while (1) {
        ...
        if (quantize_bit_mask) {
            ...
            if (0 == (WavpackGetMode(infile) & 0x8)) {
                if (quantize_round) {
                    int32_t offset = (quantize_bit_mask >> 1) ^ quantize_bit_mask;
                    int shift = 32 - bps * 8;
            ...
            if (qmode & (0x10 | 0x20)) {
                ...
                if (qmode & 0x40) {
                    ...
                    while (cc--) {
                        ...
                        for (si = 0; si < 4096; si++, sptr += num_channels)
                            if (si < sample_count)
                                *dptr++ = (qmode & 0x10) ? bit_reverse_table [*sptr & 0xff] : *sptr;
                            else
                                *dptr++ = 0;
        ...
        if (check_break ()) {
            ...
            fprintf (
# 3325 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 3325 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "\n");

            fflush (
# 3327 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   stderr
# 3327 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         );
            free (sample_buffer);
            return 1;
        }
        ...
        if (WavpackGetProgress (outfile) != -1.0 &&
            progress != floor (WavpackGetProgress (outfile) * encode_time_percent + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 3340 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            stderr
# 3340 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                  , "%s%3d%% done...",
                        nobs ? " " : "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 3342 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                           stderr
# 3342 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                 );
                }
        }
    }
...
# 3424 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
static int verify_audio (char *infilename, unsigned char *md5_digest_source)
{
    int num_channels, bps, qmode, result = 0;
    unsigned char *new_channel_order = 
# 3427 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                      ((void *)0)
# 3427 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                          ;
    ...
    wpc = WavpackOpenFileInput (infilename, error, 0x1 | 0x100 | 0x400, 0);
    ...
    temp_buffer = malloc (4096 * num_channels * 4);

    if (qmode & 0x8) {
        int layout = WavpackGetChannelLayout (wpc, 
# 3458 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                                                  ((void *)0)
# 3458 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                                      ), i;
    ...
    while (result == 0) {
        ...
        if (samples_unpacked) {
            if (md5_digest_source) {
                ...
                if (qmode & (0x10 | 0x20)) {
                    unsigned char *dsd_buffer = malloc (4096 * num_channels);
        ...
        if (check_break ()) {
            ...
            fprintf (
# 3526 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                    stderr
# 3526 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                          , "\n");

            fflush (
# 3528 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                   stderr
# 3528 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                         );
            result = 1;
            break;
        }
        ...
        if (WavpackGetProgress (wpc) != -1.0 &&
            progress != floor (WavpackGetProgress (wpc) * (100.0 - encode_time_percent) + encode_time_percent + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 3540 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                            stderr
# 3540 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                  , "%s%3d%% done...",
                        "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 3542 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                           stderr
# 3542 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                 );
                }
        }
    }
...
static void make_settings_string (char *settings, WavpackConfig *config)
{
    ...
    if (config->flags & 0x200)
        strcat (settings, "f");
    else if (config->flags & 0x1000)
        strcat (settings, "hh");
    else if (config->flags & 0x800)
        strcat (settings, "h");

    if (config->flags & 8) {
        sprintf (settings + strlen (settings), "b%g", config->bitrate);

        if (config->flags & 0x100000)
            strcat (settings, "cc");
        else if (config->flags & 0x80000)
            strcat (settings, "c");
    }
    ...
    if (config->flags & 0x10000) {
        if (config->flags & 0x10)
            strcat (settings, "j1");
        else
            strcat (settings, "j0");
    }

    if (config->flags & 0x8000)
...
# 4118 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
static void TextToUTF8 (void *string, int len)
{
...
# 4139 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
                           0
# 4139 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                                   , "");
    ...
    setlocale (
# 4161 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c" 3 4
              0
# 4161 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
                      , old_locale);
...
# 4181 "/doner/wavpack/wavpack-5.1.0/cli/wavpack.c"
static void display_progress (double file_progress)
{
    char title [40];
