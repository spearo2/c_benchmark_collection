# 1 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
# 24 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
...
# 25 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 26 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 27 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 28 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 31 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 32 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 33 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 34 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 35 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 36 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 38 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 39 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 40 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 43 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 44 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
...
# 45 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 2
# 65 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
...
# 181 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
...

{
    ...
    char **matches = 
# 190 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                    ((void *)0)
# 190 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                        ;
    int result, i;
# 209 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
    ...
    while (--argc)
        if (**++argv == '-' && (*argv)[1] == '-' && (*argv)[2]) {
            ...
            else if (!strcmp (long_option, "clean"))
                clean_tags = 1;
            else if (!strcmp (long_option, "clear"))
                clean_tags = 1;
            else if (!strcmp (long_option, "list"))
                list_tags = 1;
            ...
            if (cp && cp > *argv) {
                ...
                tag_items [i].ext = 
# 349 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                   ((void *)0)
# 349 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                       ;
            }
            else {
    ...
    if (strcmp (WavpackGetLibraryVersionString (), "5.1.0")) {
        fprintf (
# 410 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                stderr
# 410 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                      , version_warning, WavpackGetLibraryVersionString (), "5.1.0");
        fflush (
# 411 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
               stderr
# 411 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                     );
    }
    else if (!quiet_mode && !error_count) {
        fprintf (
# 414 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                stderr
# 414 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                      , sign_on, "Linux", WavpackGetLibraryVersionString ());
        fflush (
# 415 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
               stderr
# 415 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                     );
    }
...
# 429 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                            ((void *)0)
# 429 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                ;
...
# 436 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                           4096
# 436 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                   );
                ...
                if (tag_items [i].vsize < 1048576 * (allow_huge_tags ? 16 : 1)) {
                    ...
                    if (!DoReadFile (file, new_value, tag_items [i].vsize, &bcount) ||
                        bcount != tag_items [i].vsize) {
                            free (new_value);
                            new_value = 
# 459 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                       ((void *)0)
# 459 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                           ;
                        }
                }
    ...
    for (file_index = 0; file_index < num_files; ++file_index) {
        ...
        if (*infilename == '@') {
            ...
            char *listbuff = 
# 542 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                            ((void *)0)
# 542 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                , *cp;
            ...
            if (list == 
# 551 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                       ((void *)0)
# 551 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                           ) {
            ...
            while ((c = *cp++)) {
                ...
                if (c) {
                    char *fname = malloc (
# 580 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                         4096
# 580 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                 );
                    int ci = 0;
                    ...
                    do
                        fname [ci++] = c;
                    while ((c = *cp++) != '\n' && c != '\r' && c && ci < 
# 585 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                        4096
# 585 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                                );
...
# 642 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
    }
    ...
    if (num_files) {
        ...
        for (file_index = 0; file_index < num_files; ++file_index) {
            ...
            if (num_files > 1 && !quiet_mode) {
                fprintf (
# 655 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                        stderr
# 655 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                              , "\n%s:\n", matches [file_index]);
                fflush (
# 656 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                       stderr
# 656 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                             );
            }
        ...
        if (num_files > 1) {
            if (error_count) {
                fprintf (
# 674 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                        stderr
# 674 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                              , "\n **** warning: errors occurred in %d of %d files! ****\n", error_count, num_files);
                fflush (
# 675 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                       stderr
# 675 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                             );
            }
            else if (!quiet_mode) {
                fprintf (
# 678 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                        stderr
# 678 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                              , "\n **** %d files successfully processed ****\n", num_files);
                fflush (
# 679 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                       stderr
# 679 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                             );
            }
        }
...
# 735 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
...
static int process_file (char *infilename)
{
    int open_flags = 0x2 | 0x100, write_tag = 0, huge_tag = 0;
    WavpackContext *wpc;
    char error [80];
    ...
    if (num_tag_items || import_id3) {
        ...
        if (!clean_tags && (WavpackGetMode (wpc) & (0x10 | 0x100)) == 0x10) {
        ...
        if (import_id3) {
            ...
            if (WavpackGetWrapperBytes (wpc) > 10) {
                ...
                int res = ImportID3v2 (
# 826 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                      ((void *)0)
# 826 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                          , WavpackGetWrapperData (wpc), WavpackGetWrapperBytes (wpc), error, 
# 826 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                                                              ((void *)0)
# 826 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                                                                  );
                ...
                if (res > 0)
                    res = ImportID3v2 (wpc, WavpackGetWrapperData (wpc), WavpackGetWrapperBytes (wpc), error, 
# 829 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                                                             ((void *)0)
# 829 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                                                                 );
...
# 892 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                            stdout
# 892 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                  , 
# 892 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                    ((void *)0)
# 892 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
    ...
    if (list_tags)
        list_tags_to_file (wpc, infilename, 
# 908 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                           stdout
# 908 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                 );
...
# 935 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                        ((void *)0)
# 935 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                            , tag_filename)) {
...
# 995 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                           ((void *)0)
# 995 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                               ) {
                DoCloseHandle (outfile);
                fprintf (
# 997 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                        stderr
# 997 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                              , "overwrite %s (yes/no/all)? ", ((strlen (full_filename) > 30) ? filespec_name (full_filename) : full_filename));
                fflush (
# 998 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                       stderr
# 998 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                             );
...
# 1014 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                             ((void *)0)
# 1014 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                 ) {
...
# 1019 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                         ((void *)0)
# 1019 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                             );
...
static void clear_tag_items (WavpackContext *wpc)
{
    if ((WavpackGetMode (wpc) & 0x10) && (WavpackGetMode (wpc) & 0x100)) {
        int item_len;
        char *item;

        while (WavpackGetNumTagItems (wpc)) {
            item_len = WavpackGetTagItemIndexed (wpc, 0, 
# 1046 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                        ((void *)0)
# 1046 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                            , 0);
        ...
        while (WavpackGetNumBinaryTagItems (wpc)) {
            item_len = WavpackGetBinaryTagItemIndexed (wpc, 0, 
# 1054 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                              ((void *)0)
# 1054 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                  , 0);
            item = malloc (item_len + 1);
...
# 1082 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                        ((void *)0)
# 1082 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                            , 0);
            item = malloc (item_len + 1);
            WavpackGetTagItemIndexed (wpc, i, item, item_len + 1);
            value_len = WavpackGetTagItem (wpc, item, 
# 1085 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                     ((void *)0)
# 1085 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                         , 0);
...
# 1114 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                              ((void *)0)
# 1114 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                  , 0);
            item = malloc (item_len + 1);
            WavpackGetBinaryTagItemIndexed (wpc, i, item, item_len + 1);
            value_len = dump_tag_item_to_file (wpc, item, 
# 1117 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                         ((void *)0)
# 1117 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                             , fname);
            fprintf (dst, "%s:%s", item, strlen (item) < strlen (spaces) ? spaces + strlen (item) : " ");
...
# 1155 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
            free (item);
        }
    }
}
# 1170 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
static int dump_tag_item_to_file (WavpackContext *wpc, const char *tag_item, FILE *dst, char *fname)
{
    if (WavpackGetMode (wpc) & 0x10) {
        if (WavpackGetTagItem (wpc, tag_item, 
# 1173 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                             ((void *)0)
# 1173 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                 , 0)) {
            int value_len = WavpackGetTagItem (wpc, tag_item, 
# 1174 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                             ((void *)0)
# 1174 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                 , 0);
            char *value;
...
# 1197 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                        ((void *)0)
# 1197 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                            , 0)) {
            int value_len = WavpackGetBinaryTagItem (wpc, tag_item, 
# 1198 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                                   ((void *)0)
# 1198 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                       , 0), res = 0, i;
            uint32_t bcount = 0;
            char *value;
...
# 1254 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
static int calculate_tag_size (WavpackContext *wpc)
{
    int mode = WavpackGetMode (wpc);

    if ((mode & 0x10) && (mode & 0x100)) {
        int num_binary_items = WavpackGetNumBinaryTagItems (wpc);
        int num_items = WavpackGetNumTagItems (wpc), i;
        ...
        for (i = 0; i < num_items; ++i) {
            item_len = WavpackGetTagItemIndexed (wpc, i, 
# 1269 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                        ((void *)0)
# 1269 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                            , 0);
            item = malloc (item_len + 1);
            WavpackGetTagItemIndexed (wpc, i, item, item_len + 1);
            value_len = WavpackGetTagItem (wpc, item, 
# 1272 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                     ((void *)0)
# 1272 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                         , 0);
        ...
        for (i = 0; i < num_binary_items; ++i) {
            item_len = WavpackGetBinaryTagItemIndexed (wpc, i, 
# 1278 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                              ((void *)0)
# 1278 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                                  , 0);
            item = malloc (item_len + 1);
            WavpackGetBinaryTagItemIndexed (wpc, i, item, item_len + 1);
            value_len = WavpackGetBinaryTagItem (wpc, item, 
# 1281 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                           ((void *)0)
# 1281 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                               , 0);
            ape_tag_size += 8 + item_len + 1 + value_len;
            free (item);
        }
...
# 1368 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
...
# 1378 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                           0
# 1378 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                   , "");
    ...
    setlocale (
# 1388 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
              0
# 1388 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                      , old_locale);
...
# 1513 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
static void TextToUTF8 (void *string, int len)
{
    char *temp = malloc (len);
    char *outp = temp;
    ...
    memset(temp, 0, len);
    old_locale = setlocale (
# 1534 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                           0
# 1534 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                   , "");
    ...
    setlocale (
# 1556 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
              0
# 1556 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                      , old_locale);
...
# 1624 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
static FILE *wild_fopen (char *filename, const char *mode)
{
    char *matchname = 
# 1626 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                     ((void *)0)
# 1626 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                         ;
    struct stat statbuf;
    FILE *res = 
# 1628 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
               ((void *)0)
# 1628 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                   ;
    glob_t globbuf;
    int i;

    glob (filename, 0, 
# 1632 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                      ((void *)0)
# 1632 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                          , &globbuf);

    for (i = 0; i < globbuf.gl_pathc; ++i) {
        if (stat (globbuf.gl_pathv [i], &statbuf) == -1 || 
# 1635 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                          ((((
# 1635 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                                                          statbuf.st_mode
# 1635 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                                                          )) & 0170000) == (0040000))
# 1635 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
        ...
        if (matchname) {
            free (matchname);
            matchname = 
# 1640 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c" 3 4
                       ((void *)0)
# 1640 "/doner/wavpack/wavpack-5.1.0/cli/wvtag.c"
                           ;
            break;
        }
        else {
