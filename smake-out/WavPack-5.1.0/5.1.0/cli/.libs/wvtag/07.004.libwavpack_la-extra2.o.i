# 1 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
# 14 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
...
# 15 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 2
...
# 16 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 2
...
# 17 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 2
...
# 18 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 2
...
# 20 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 2
# 53 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
...
typedef struct {
    int32_t *sampleptrs [16 +2];
    struct decorr_pass dps [16];
...
static void decorr_stereo_pass (int32_t *in_samples, int32_t *out_samples, int32_t num_samples, struct decorr_pass *dpp, int dir)
{
    ...
    if (num_samples > 16 && 1) {
        int32_t pre_samples = (dpp->term < 0 || dpp->term > 8) ? 2 : dpp->term;
    ...
    switch (dpp->term) {
        ...
        case 2:
            while (num_samples--) {
                ...
                out_samples [0] = tmp = (dpp->samples_A [1] = in_samples [0]) - (sam != (int16_t) sam ? (((((sam & 0xffff) * dpp->weight_A) >> 9) + (((sam & ~0xffff) >> 9) * dpp->weight_A) + 1) >> 1) : ((dpp->weight_A * sam + 512) >> 10));
                ...
                out_samples [1] = tmp = (dpp->samples_B [1] = in_samples [1]) - (sam != (int16_t) sam ? (((((sam & 0xffff) * dpp->weight_B) >> 9) + (((sam & ~0xffff) >> 9) * dpp->weight_B) + 1) >> 1) : ((dpp->weight_B * sam + 512) >> 10));
        ...
        case 17:
            while (num_samples--) {
                ...
                out_samples [0] = tmp = (dpp->samples_A [0] = in_samples [0]) - (sam != (int16_t) sam ? (((((sam & 0xffff) * dpp->weight_A) >> 9) + (((sam & ~0xffff) >> 9) * dpp->weight_A) + 1) >> 1) : ((dpp->weight_A * sam + 512) >> 10));
                if (sam && tmp) { int32_t s = (int32_t) (sam ^ tmp) >> 31; dpp->weight_A = (dpp->delta ^ s) + (dpp->weight_A - s); };
                dpp->sum_A += dpp->weight_A;

                sam = 2 * dpp->samples_B [0] - dpp->samples_B [1];
                dpp->samples_B [1] = dpp->samples_B [0];
                out_samples [1] = tmp = (dpp->samples_B [0] = in_samples [1]) - (sam != (int16_t) sam ? (((((sam & 0xffff) * dpp->weight_B) >> 9) + (((sam & ~0xffff) >> 9) * dpp->weight_B) + 1) >> 1) : ((dpp->weight_B * sam + 512) >> 10));
                if (sam && tmp) { int32_t s = (int32_t) (sam ^ tmp) >> 31; dpp->weight_B = (dpp->delta ^ s) + (dpp->weight_B - s); };
                dpp->sum_B += dpp->weight_B;
        ...
        default: {
            ...
            while (num_samples--) {
                ...
                sam = dpp->samples_A [m];
                out_samples [0] = tmp = (dpp->samples_A [k] = in_samples [0]) - (sam != (int16_t) sam ? (((((sam & 0xffff) * dpp->weight_A) >> 9) + (((sam & ~0xffff) >> 9) * dpp->weight_A) + 1) >> 1) : ((dpp->weight_A * sam + 512) >> 10));
                if (sam && tmp) { int32_t s = (int32_t) (sam ^ tmp) >> 31; dpp->weight_A = (dpp->delta ^ s) + (dpp->weight_A - s); };
                dpp->sum_A += dpp->weight_A;

                sam = dpp->samples_B [m];
                out_samples [1] = tmp = (dpp->samples_B [k] = in_samples [1]) - (sam != (int16_t) sam ? (((((sam & 0xffff) * dpp->weight_B) >> 9) + (((sam & ~0xffff) >> 9) * dpp->weight_B) + 1) >> 1) : ((dpp->weight_B * sam + 512) >> 10));
                if (sam && tmp) { int32_t s = (int32_t) (sam ^ tmp) >> 31; dpp->weight_B = (dpp->delta ^ s) + (dpp->weight_B - s); };
                dpp->sum_B += dpp->weight_B;
        ...
        case -1:
            while (num_samples--) {
                ...
                out_samples [0] = tmp = (sam_B = in_samples [0]) - (sam_A != (int16_t) sam_A ? (((((sam_A & 0xffff) * dpp->weight_A) >> 9) + (((sam_A & ~0xffff) >> 9) * dpp->weight_A) + 1) >> 1) : ((dpp->weight_A * sam_A + 512) >> 10));
                if (sam_A && tmp) { const int32_t s = (sam_A ^ tmp) >> 31; if ((dpp->weight_A = (dpp->weight_A ^ s) + (dpp->delta - s)) > 1024) dpp->weight_A = 1024; dpp->weight_A = (dpp->weight_A ^ s) - s; };
                dpp->sum_A += dpp->weight_A;

                out_samples [1] = tmp = (dpp->samples_A [0] = in_samples [1]) - (sam_B != (int16_t) sam_B ? (((((sam_B & 0xffff) * dpp->weight_B) >> 9) + (((sam_B & ~0xffff) >> 9) * dpp->weight_B) + 1) >> 1) : ((dpp->weight_B * sam_B + 512) >> 10));
                if (sam_B && tmp) { const int32_t s = (sam_B ^ tmp) >> 31; if ((dpp->weight_B = (dpp->weight_B ^ s) + (dpp->delta - s)) > 1024) dpp->weight_B = 1024; dpp->weight_B = (dpp->weight_B ^ s) - s; };
                dpp->sum_B += dpp->weight_B;
        ...
        case -2:
            while (num_samples--) {
                ...
                out_samples [1] = tmp = (sam_A = in_samples [1]) - (sam_B != (int16_t) sam_B ? (((((sam_B & 0xffff) * dpp->weight_B) >> 9) + (((sam_B & ~0xffff) >> 9) * dpp->weight_B) + 1) >> 1) : ((dpp->weight_B * sam_B + 512) >> 10));
                if (sam_B && tmp) { const int32_t s = (sam_B ^ tmp) >> 31; if ((dpp->weight_B = (dpp->weight_B ^ s) + (dpp->delta - s)) > 1024) dpp->weight_B = 1024; dpp->weight_B = (dpp->weight_B ^ s) - s; };
                dpp->sum_B += dpp->weight_B;

                out_samples [0] = tmp = (dpp->samples_B [0] = in_samples [0]) - (sam_A != (int16_t) sam_A ? (((((sam_A & 0xffff) * dpp->weight_A) >> 9) + (((sam_A & ~0xffff) >> 9) * dpp->weight_A) + 1) >> 1) : ((dpp->weight_A * sam_A + 512) >> 10));
                if (sam_A && tmp) { const int32_t s = (sam_A ^ tmp) >> 31; if ((dpp->weight_A = (dpp->weight_A ^ s) + (dpp->delta - s)) > 1024) dpp->weight_A = 1024; dpp->weight_A = (dpp->weight_A ^ s) - s; };
                dpp->sum_A += dpp->weight_A;
        ...
        case -3:
            while (num_samples--) {
                ...
                out_samples [1] = tmp -= (sam_B != (int16_t) sam_B ? (((((sam_B & 0xffff) * dpp->weight_B) >> 9) + (((sam_B & ~0xffff) >> 9) * dpp->weight_B) + 1) >> 1) : ((dpp->weight_B * sam_B + 512) >> 10));
                if (sam_B && tmp) { const int32_t s = (sam_B ^ tmp) >> 31; if ((dpp->weight_B = (dpp->weight_B ^ s) + (dpp->delta - s)) > 1024) dpp->weight_B = 1024; dpp->weight_B = (dpp->weight_B ^ s) - s; };
                dpp->sum_B += dpp->weight_B;

                dpp->samples_B [0] = tmp = in_samples [0];
                out_samples [0] = tmp -= (sam_A != (int16_t) sam_A ? (((((sam_A & 0xffff) * dpp->weight_A) >> 9) + (((sam_A & ~0xffff) >> 9) * dpp->weight_A) + 1) >> 1) : ((dpp->weight_A * sam_A + 512) >> 10));
                if (sam_A && tmp) { const int32_t s = (sam_A ^ tmp) >> 31; if ((dpp->weight_A = (dpp->weight_A ^ s) + (dpp->delta - s)) > 1024) dpp->weight_A = 1024; dpp->weight_A = (dpp->weight_A ^ s) - s; };
                dpp->sum_A += dpp->weight_A;
    ...
    if (cont_samples) {
        if (dir < 0)
            pack_decorr_stereo_pass_cont_rev_x64 (dpp, in_samples, out_samples, cont_samples);
        else
            pack_decorr_stereo_pass_cont_x64 (dpp, in_samples, out_samples, cont_samples);
    }
...
static void decorr_stereo_buffer (WavpackExtraInfo *info, int32_t *samples, int32_t *outsamples, int32_t num_samples, int tindex)
{
    ...
    if (tindex == 0)
        ...
        memset (&dp.samples_B, 0, sizeof (dp.samples_B));;
    }
...
static void recurse_stereo (WavpackContext *wpc, WavpackExtraInfo *info, int depth, int delta, uint32_t input_bits)
{
    ...
    int term, branches = ((wpc->config.extra_flags & 0x1c0) >> 6) - depth;
    ...
    memset (&term_bits, 0, sizeof (term_bits));;
    ...
    for (term = -3; term <= 18; ++term) {
        ...
        if (term == -1 || term == -2)
            if (!(wps->wphdr.flags & 0x20))
                continue;

        if ((wpc->config.flags & 0x200) && (term > 4 && term < 17))
            continue;
        ...
        bits = log2buffer_x64 (outsamples, wps->wphdr.block_samples * 2, info->log_limit);
...
static void delta_stereo (WavpackContext *wpc, WavpackExtraInfo *info)
{
    ...
    for (d = delta - 1; d >= 0; --d) {
        ...
        bits = log2buffer_x64 (info->sampleptrs [i], wps->wphdr.block_samples * 2, info->log_limit);
...
static void analyze_stereo (WavpackContext *wpc, int32_t *samples, int do_samples)
{
    ...
    info.log_limit = (((wps->wphdr.flags & (0x1fL << 18)) >> 18) + 4) * 256;

    if (info.log_limit > 6912)
        info.log_limit = 6912;




    if (wpc->config.flags & (0x800 | 0x1000))
    ...
    info.best_bits = log2buffer_x64 (info.sampleptrs [info.nterms], wps->wphdr.block_samples * 2, 0) * 1;
    info.best_bits += log2overhead (info.dps [0].term, i);
    memcpy (info.sampleptrs [info.nterms + 1], info.sampleptrs [i], wps->wphdr.block_samples * 8);

    if (wpc->config.extra_flags & 0x1c0)
        recurse_stereo (wpc, &info, 0, (int) floor (wps->delta_decay + 0.5),
            log2buffer_x64 (info.sampleptrs [0], wps->wphdr.block_samples * 2, 0));

    if (wpc->config.extra_flags & 32)
        sort_stereo (wpc, &info);

    if (wpc->config.extra_flags & 8) {
        delta_stereo (wpc, &info);

        if ((wpc->config.extra_flags & 16) && wps->decorr_passes [0].term)
            wps->delta_decay = (float)((wps->delta_decay * 2.0 + wps->decorr_passes [0].delta) / 3.0);
        else
            wps->delta_decay = 2.0;
    }

    if (wpc->config.extra_flags & 32768)
        sort_stereo (wpc, &info);
...
{
    int shaping_weight, new = wps->wphdr.flags & 0x20000000;
    ...
    if (wps->wphdr.flags & 0x40) {
        while (cnt--) {
            ...
            temp = -(error [0] != (int16_t) error [0] ? (((((error [0] & 0xffff) * shaping_weight) >> 9) + (((error [0] & ~0xffff) >> 9) * shaping_weight) + 1) >> 1) : ((shaping_weight * error [0] + 512) >> 10));
            ...
            temp = -(error [1] != (int16_t) error [1] ? (((((error [1] & 0xffff) * shaping_weight) >> 9) + (((error [1] & ~0xffff) >> 9) * shaping_weight) + 1) >> 1) : ((shaping_weight * error [1] + 512) >> 10));
...
void execute_stereo (WavpackContext *wpc, int32_t *samples, int no_history, int do_samples)
{
    int32_t *temp_buffer [2], *best_buffer, *noisy_buffer = 
# 704 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 3 4
                                                           ((void *)0)
# 704 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
                                                               , *js_buffer = 
# 704 "/doner/wavpack/wavpack-5.1.0/src/extra2.c" 3 4
                                                                              ((void *)0)
# 704 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
                                                                                  ;
    struct decorr_pass temp_decorr_pass, save_decorr_passes [16];
    WavpackStream *wps = wpc->streams [wpc->current_stream];
    ...
    log_limit = (((wps->wphdr.flags & (0x1fL << 18)) >> 18) + 4) * 256;
    ...
    memset (&save_decorr_passes, 0, sizeof (save_decorr_passes));;
    temp_buffer [0] = malloc (buf_size);
    temp_buffer [1] = malloc (buf_size);
    best_buffer = malloc (buf_size);

    if (wps->num_passes > 1 && (wps->wphdr.flags & 8)) {
        memset (&temp_decorr_pass, 0, sizeof (temp_decorr_pass));;
    ...
    for (pi = 0; pi < wps->num_passes;) {
        ...
        while (1) {
            ...
            for (j = 0; j < nterms; ++j) {
                ...
                if (temp_decorr_pass.term < 0 && !(wps->wphdr.flags & 0x20))
                ...
                if (j) {
                    memset (&temp_decorr_pass.samples_A, 0, sizeof (temp_decorr_pass.samples_A));;
                    memset (&temp_decorr_pass.samples_B, 0, sizeof (temp_decorr_pass.samples_B));;
                }
                else
                    reverse_decorr (&temp_decorr_pass);
            ...
            size = log2buffer_x64 (temp_buffer [j&1], num_samples * 2, log_limit);
        ...
        if (size < best_size) {
            ...
            memcpy (wps->decorr_passes, save_decorr_passes, sizeof (struct decorr_pass) * 16);
    ...
    free (temp_buffer [0]);
    free (best_buffer);
# 928 "/doner/wavpack/wavpack-5.1.0/src/extra2.c"
}
