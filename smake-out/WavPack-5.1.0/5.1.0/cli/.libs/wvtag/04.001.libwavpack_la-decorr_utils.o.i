# 1 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c"
# 18 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c"
...
# 19 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c" 2
...
# 20 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c" 2
...
# 22 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c" 2
# 32 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c"
int read_decorr_terms (WavpackStream *wps, WavpackMetadata *wpmd)
{
    ...
    for (dpp = wps->decorr_passes + termcnt - 1; termcnt--; dpp--) {
        ...
        if (!dpp->term || dpp->term < -3 || (dpp->term > 8 && dpp->term < 17) || dpp->term > 18 ||
            ((wps->wphdr.flags & (4 | 0x40000000)) && dpp->term < 0))
                return 0;
    }
...
# 94 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c"
int read_decorr_samples (WavpackStream *wps, WavpackMetadata *wpmd)
{
    unsigned char *byteptr = wpmd->data;
    ...
    if (wps->wphdr.version == 0x402 && (wps->wphdr.flags & 8)) {
        if (byteptr + (wps->wphdr.flags & (4 | 0x40000000) ? 2 : 4) > endptr)
            return 0;
    ...
    while (dpp-- > wps->decorr_passes && byteptr < endptr)
        if (dpp->term > 8) {
            if (byteptr + (wps->wphdr.flags & (4 | 0x40000000) ? 4 : 8) > endptr)
                return 0;
...
# 171 "/doner/wavpack/wavpack-5.1.0/src/decorr_utils.c"
int read_shaping_info (WavpackStream *wps, WavpackMetadata *wpmd)
{
    if (wpmd->byte_length == 2) {
    ...
    else if (wpmd->byte_length >= (wps->wphdr.flags & (4 | 0x40000000) ? 4 : 8)) {
        unsigned char *byteptr = wpmd->data;
        ...
        if (wpmd->byte_length == (wps->wphdr.flags & (4 | 0x40000000) ? 6 : 12)) {
