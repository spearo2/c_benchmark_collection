# 1 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c"
# 19 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c"
...
# 20 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c" 2
...
# 21 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c" 2
...
# 23 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c" 2
...
void update_error_limit (WavpackStream *wps)
{
    ...
    if (wps->wphdr.flags & (4 | 0x40000000)) {
        if (wps->wphdr.flags & 0x200) {
            int slow_log_0 = (wps->w.c [0].slow_level + ((1 << (8 - 1)))) >> 8;
        ...
        if (wps->wphdr.flags & 0x200) {
            int slow_log_0 = (wps->w.c [0].slow_level + ((1 << (8 - 1)))) >> 8;
            int slow_log_1 = (wps->w.c [1].slow_level + ((1 << (8 - 1)))) >> 8;
...
# 264 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c"
int wp_log2 (uint32_t avalue)
{
    int dbits;
...
# 328 "/doner/wavpack/wavpack-5.1.0/src/entropy_utils.c"
int wp_log2s (int32_t value)
{
