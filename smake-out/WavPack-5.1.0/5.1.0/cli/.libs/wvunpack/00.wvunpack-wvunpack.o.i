# 1 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
# 24 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 25 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 26 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 27 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 28 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 30 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 31 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 36 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 41 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 42 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 43 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 44 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 45 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 46 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 48 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 49 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
...
# 50 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 2
# 63 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 79 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 213 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...

{
    ...
    char outpath, **matches = 
# 220 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                             ((void *)0)
# 220 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                 , *outfilename = 
# 220 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                  ((void *)0)
# 220 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                      ;
    int result;
# 237 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 255 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    while (--argc) {
        if (**++argv == '-' && (*argv)[1] == '-' && (*argv)[2]) {
            ...
            else if (!strcmp (long_option, "caf-be")) {
                decode_format = 2;
                caf_be = format_specified = 1;
            }
            else if (!strcmp (long_option, "caf-le")) {
                decode_format = 2;
                format_specified = 1;
            }
            ...
            while (*++*argv)
                switch (**argv) {
                    ...
                    case 'D': case 'd':
                        delete_source = 1;
                        break;
# 361 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                    case 'O': case 'o':
                        output_spec = 1;
                        break;
...
# 487 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
            else if (output_spec) {
                outfilename = malloc (strlen (*argv) + 
# 488 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                      4096
# 488 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                              );
    ...
    if (strcmp (WavpackGetLibraryVersionString (), "5.1.0")) {
        fprintf (
# 551 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                stderr
# 551 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                      , version_warning, WavpackGetLibraryVersionString (), "5.1.0");
        fflush (
# 552 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
               stderr
# 552 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                     );
    }
    else if (!quiet_mode && !error_count) {
        fprintf (
# 555 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                stderr
# 555 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                      , sign_on, "Linux", WavpackGetLibraryVersionString ());
        fflush (
# 556 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
               stderr
# 556 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                     );
    }
    ...
    for (file_index = 0; file_index < num_files; ++file_index) {
        ...
        if (*infilename == '@') {
            ...
            char *listbuff = 
# 579 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                            ((void *)0)
# 579 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                , *cp;
            ...
            if (list == 
# 588 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       ((void *)0)
# 588 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                           ) {
            ...
            while ((c = *cp++)) {
                ...
                if (c) {
                    char *fname = malloc (
# 617 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                         4096
# 617 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                 );
                    int ci = 0;
                    ...
                    do
                        fname [ci++] = c;
                    while ((c = *cp++) != '\n' && c != '\r' && c && ci < 
# 622 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                        4096
# 622 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                                );
...
# 679 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    }
    ...
    if (outfilename && outfilename [0] == '@') {
        char listbuff [
# 687 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                      4096 
# 687 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                               * 2], *lp = listbuff;
        FILE *list = fopen (outfilename+1, "rb");
        int c;

        if (list == 
# 691 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                   ((void *)0)
# 691 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                       ) {
        ...
        if (c) {
            ...
            do
                outfilename [ci++] = c;
            while ((c = *lp++) != '\n' && c != '\r' && c && ci < 
# 711 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                4096
# 711 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                        );
...
# 729 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                     ((void *)0)
# 729 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                         );
        ...
        for (file_index = 0; file_index < num_files; ++file_index) {
            ...
            if (num_files > 1 && !quiet_mode) {
                fprintf (
# 765 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                        stderr
# 765 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                              , "\n%s:\n", matches [file_index]);
                fflush (
# 766 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       stderr
# 766 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                             );
            }

            result = unpack_file (matches [file_index], verify_only ? 
# 769 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                     ((void *)0) 
# 769 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                          : outfilename, add_extension);
            ...
            if (outpath)
                *filespec_name (outfilename) = '\0';
                ...
                free (outfilename);
                outfilename = 
# 783 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                             ((void *)0)
# 783 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                 ;
            }
        ...
        if (num_files > 1) {
            if (error_count) {
                fprintf (
# 791 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                        stderr
# 791 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                              , "\n **** warning: errors occurred in %d of %d files! ****\n", error_count, num_files);
                fflush (
# 792 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       stderr
# 792 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                             );
            }
            else if (!quiet_mode) {
                fprintf (
# 795 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                        stderr
# 795 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                              , "\n **** %d files successfully processed ****\n", num_files);
                fflush (
# 796 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       stderr
# 796 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                             );
            }
        }
...
# 863 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
static void parse_sample_time_index (struct sample_time_index *dst, char *src)
{
    int colons = 0;
    double temp;
...
# 883 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                               ((*__ctype_b_loc ())[(int) ((
# 883 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                               *src
# 883 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
...
# 905 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
static FILE *open_output_file (char *filename, char **tempfilename)
{
    ...
    *tempfilename = 
# 910 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                   ((void *)0)
# 910 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                       ;
    ...
    if (*filename == '-') {
        ...
        return 
# 919 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
              stdout
# 919 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                    ;
    }
    ...
    if (testfile) {
        ...
        if (res == 1) {
            ...
            if (!overwrite_all) {
                fprintf (
# 933 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                        stderr
# 933 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                              , "overwrite %s (yes/no/all)? ", ((strlen (filename) > 30) ? filespec_name (filename) : filename));
                fflush (
# 934 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       stderr
# 934 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                             );
                ...
                switch (yna ()) {
                    case 'n':
                        return 
# 941 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                              ((void *)0)
# 941 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                  ;
    ...
    if (retval == 
# 984 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                 ((void *)0)
# 984 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                     )
        error_line ("can't create file %s!", *tempfilename ? *tempfilename : filename);

    return retval;
}
# 998 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
static int unpack_file (char *infilename, char *outfilename, int add_extension)
{
    ...
    int result = 0, md5_diff = 0, created_riff_header = 0;
...
# 1014 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                            ((void *)0)
# 1014 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                ;
    char *extension = 
# 1015 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                     ((void *)0)
# 1015 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                         ;
    WavpackContext *wpc;
    uint32_t bcount;
    char error [80];
...
# 1035 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    ...
    if (format_specified && decode_format != 3 && decode_format != 4)
        open_flags |= 0x200 | 0x400;
    else
        open_flags |= 0x100 | 0x400;
    ...
    wvc_mode = WavpackGetMode (wpc) & 0x1;
    num_channels = WavpackGetNumChannels (wpc);
    input_qmode = WavpackGetQualifyMode (wpc);
    input_format = WavpackGetFileFormat (wpc);
# 1081 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    if (raw_decode) {
        output_qmode = (input_qmode & (0x10 | 0x20)) ? 0x20 : 0;
    }
    else if (format_specified) {
        switch (decode_format) {
            case 2:
                output_qmode = 0x2 | (caf_be ? 0x1 : 0) | (input_qmode & 0x8);
    ...
    else if (input_format < (sizeof (file_formats) / sizeof (file_formats [0]))) {
        output_format = input_format;
        output_qmode = input_qmode;
    }
    else if (!WavpackGetWrapperBytes (wpc) ||
        skip.value_is_valid || until.value_is_valid) {
    ...
    if (file_info)
        dump_file_info (wpc, infilename, 
# 1200 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                        stdout
# 1200 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                              , file_info - 1);
    else if (summary)
        dump_summary (wpc, infilename, 
# 1202 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                      stdout
# 1202 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                            );
    else if (tag_extract_stdout) {
        if (!dump_tag_item_to_file (wpc, tag_extract_stdout, 
# 1204 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                            stdout
# 1204 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                  , 
# 1204 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                    ((void *)0)
# 1204 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    ...
    if (outfilename) {
        ...
        if ((outfile = open_output_file (outfilename, &outfilename_temp)) == 
# 1230 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                            ((void *)0)
# 1230 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                                ) {
            WavpackCloseFile (wpc);
            return 1;
        }
            ...
            if (!quiet_mode) {
                fprintf (
# 1236 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                        stderr
# 1236 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                              , "unpacking %s%s to stdout,", *infilename == '-' ?
                    "stdin" : ((strlen (infilename) > 30) ? filespec_name (infilename) : infilename), wvc_mode ? " (+.wvc)" : "");
                fflush (
# 1238 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       stderr
# 1238 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                             );
            }
        }
        else if (!quiet_mode) {
            fprintf (
# 1242 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                    stderr
# 1242 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                          , "restoring %s,", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));
            fflush (
# 1243 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                   stderr
# 1243 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                         );
        }
    }
    else {
        outfile = 
# 1247 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                 ((void *)0)
# 1247 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                     ;

        if (!quiet_mode) {
            fprintf (
# 1250 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                    stderr
# 1250 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                          , "verifying %s%s,", *infilename == '-' ? "stdin" :
                ((strlen (infilename) > 30) ? filespec_name (infilename) : infilename), wvc_mode ? " (+.wvc)" : "");
            fflush (
# 1252 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                   stderr
# 1252 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                         );
        }
    }
    ...
    if (output_qmode & (0x10 | 0x20))
        result = unpack_dsd_audio (wpc, outfile, output_qmode, calc_md5 ? md5_unpacked : 
# 1292 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                                        ((void *)0)
# 1292 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                                            , &total_unpacked_samples);
    else
        result = unpack_audio (wpc, outfile, output_qmode, calc_md5 ? md5_unpacked : 
# 1294 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                                    ((void *)0)
# 1294 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                                        , &total_unpacked_samples);



    if (result == 0 && outfile && !raw_decode && file_formats [output_format].chunk_alignment != 1) {
    ...
    if (outfile && result == 0 && !created_riff_header && WavpackGetWrapperBytes (wpc)) {
    ...
    if (result == 0 && outfile && created_riff_header &&
    ...
    if (outfile) {
        ...
        if (*outfilename != '-') {
            ...
            if (!DoCloseHandle (outfile)) {
                error_line ("can't close file %s!", ((strlen (outfilename) > 30) ? filespec_name (outfilename) : outfilename));
                result = 1;
            }
...
# 1407 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    if (result == 0 && outfilename && outfilename_temp && rename (outfilename_temp, outfilename)) {
    ...
    if (result == 0 && copy_time && outfilename &&
    ...
    if (result == 0 && md5_diff && (WavpackGetMode (wpc) & 0x2) && !until_samples_total && input_qmode == output_qmode) {
        error_line ("MD5 signatures should match, but do not!");
        result = 1;
    }
# 1452 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    ...
    if (result == 0 && delete_source) {
        ...
        if (wvc_mode) {
            char in2filename [
# 1497 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                             4096
# 1497 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                     ];
...
# 1516 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                  ((void *)0)
# 1516 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                      , *output_pointer = 
# 1516 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                          ((void *)0)
# 1516 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 1516 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
    ...
    int bytes_per_sample = bps * num_channels, result = 0;
...
# 1544 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                  ((void *)0)
# 1544 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                      ), i;
    ...
    temp_buffer = malloc (4096L * num_channels * sizeof (temp_buffer [0]));
    ...
    while (result == 0) {
        ...
        if (output_buffer) {
            ...
            if (samples_to_unpack > 4096L)
                samples_to_unpack = 4096L;
        }
        else
            samples_to_unpack = 4096L;
        ...
        if (check_break ()) {
            ...
            fprintf (
# 1608 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                    stderr
# 1608 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                          , "\n");

            fflush (
# 1610 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                   stderr
# 1610 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                         );
            DoTruncateFile (outfile);
            result = 1;
            break;
        ...
        if (WavpackGetProgress (wpc) != -1.0 &&
            progress != floor (WavpackGetProgress (wpc) * 100.0 + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 1625 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                            stderr
# 1625 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                  , "%s%3d%% done...",
                        nobs ? " " : "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 1627 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                           stderr
# 1627 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                 );
                }
        }
    }
...
{
    unsigned char *output_buffer = 
# 1670 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                  ((void *)0)
# 1670 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                      , *new_channel_order = 
# 1670 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                             ((void *)0)
# 1670 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                 ;
    int num_channels = WavpackGetNumChannels (wpc), result = 0;
    int64_t until_samples_total = *sample_count, total_unpacked_samples = 0;
    uint32_t output_buffer_size = 0, bcount;
    double progress = -1.0;
    int32_t *temp_buffer;
    ...
    output_buffer_size = 4096 * num_channels;
    ...
    if (qmode & 0x8) {
        int layout = WavpackGetChannelLayout (wpc, 
# 1691 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                  ((void *)0)
# 1691 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                      ), i;
    ...
    temp_buffer = malloc (4096 * num_channels * sizeof (temp_buffer [0]));

    while (result == 0) {
        uint32_t samples_to_unpack = 4096, samples_unpacked;
        ...
        if (check_break ()) {
            ...
            fprintf (
# 1763 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                    stderr
# 1763 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                          , "\n");

            fflush (
# 1765 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                   stderr
# 1765 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                         );
            DoTruncateFile (outfile);
            result = 1;
            break;
        ...
        if (WavpackGetProgress (wpc) != -1.0 &&
            progress != floor (WavpackGetProgress (wpc) * 100.0 + 0.5)) {
                ...
                if (!quiet_mode) {
                    fprintf (
# 1780 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                            stderr
# 1780 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                  , "%s%3d%% done...",
                        nobs ? " " : "\b\b\b\b\b\b\b\b\b\b\b\b", (int) progress);
                    fflush (
# 1782 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                           stderr
# 1782 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                 );
                }
        }
    }
...
static int do_tag_extractions (WavpackContext *wpc, char *outfilename)
{
    ...
    for (i = 0; result == 0 && i < num_tag_extractions; ++i) {
        ...
        if (dump_tag_item_to_file (wpc, extraction_spec, 
# 1823 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                        ((void *)0)
# 1823 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                            , tag_filename)) {
            ...
            if (!overwrite_all && (outfile = fopen (full_filename, "r")) != 
# 1883 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                           ((void *)0)
# 1883 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                               ) {
                DoCloseHandle (outfile);
                fprintf (
# 1885 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                        stderr
# 1885 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                              , "overwrite %s (yes/no/all)? ", ((strlen (full_filename) > 30) ? filespec_name (full_filename) : full_filename));
                fflush (
# 1886 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                       stderr
# 1886 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                             );
            ...
            if (*full_filename) {
                if ((outfile = fopen (full_filename, "w")) == 
# 1905 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                             ((void *)0)
# 1905 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                 ) {
                    error_line ("can't create file %s!", ((strlen (full_filename) > 30) ? filespec_name (full_filename) : full_filename));
                    result = 1;
                }
                else {
                    dump_tag_item_to_file (wpc, extraction_spec, outfile, 
# 1910 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                         ((void *)0)
# 1910 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                             );

                    if (!DoCloseHandle (outfile)) {
                        error_line ("can't close file %s!", ((strlen (full_filename) > 30) ? filespec_name (full_filename) : full_filename));
                        result = 1;
                    }
                    else if (!quiet_mode)
                        error_line ("extracted tag \"%s\" to file %s", extraction_spec, ((strlen (full_filename) > 30) ? filespec_name (full_filename) : full_filename));
                }
            }
...
static void dump_summary (WavpackContext *wpc, char *name, FILE *dst)
{
    ...
    if (WavpackGetMode (wpc) & 0x4)
        strcat (modes, "hybrid ");

    strcat (modes, (WavpackGetMode (wpc) & 0x2) ? "lossless" : "lossy");

    if (WavpackGetMode (wpc) & 0x40)
        strcat (modes, ", fast");
    else if (WavpackGetMode (wpc) & 0x400)
        strcat (modes, ", very high");
    else if (WavpackGetMode (wpc) & 0x20)
        strcat (modes, ", high");

    if (WavpackGetMode (wpc) & 0x80) {
        strcat (modes, ", extra");

        if (WavpackGetMode (wpc) & 0x7000) {
            char xmode[3] = "-0";

            xmode [1] = ((WavpackGetMode (wpc) & 0x7000) >> 12) + '0';
            strcat (modes, xmode);
        }
    }

    if (WavpackGetMode (wpc) & 0x200)
        strcat (modes, ", sfx");

    if (WavpackGetMode (wpc) & 0x8000)
        strcat (modes, ", dns");
    ...
    if (WavpackGetRatio (wpc) != 0.0) {
        ...
        fprintf (dst, "ave bitrate:       %d kbps\n", (int) ((WavpackGetAverageBitrate (wpc, 1) + 500.0) / 1000.0));

        if (WavpackGetMode (wpc) & 0x1)
            fprintf (dst, "ave lossy bitrate: %d kbps\n", (int) ((WavpackGetAverageBitrate (wpc, 0) + 500.0) / 1000.0));
    }
    ...
    if (summary > 1) {
        ...
        if (WavpackGetFileFormat (wpc) < (sizeof (file_formats) / sizeof (file_formats [0])))
    ...
    if (WavpackGetMode (wpc) & 0x10) {
        int ape_tag = WavpackGetMode (wpc) & 0x100;
        ...
        for (i = 0; i < num_items; ++i) {
            ...
            item_len = WavpackGetTagItemIndexed (wpc, i, 
# 2335 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                        ((void *)0)
# 2335 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                            , 0);
            item = malloc (item_len + 1);
            WavpackGetTagItemIndexed (wpc, i, item, item_len + 1);
            value_len = WavpackGetTagItem (wpc, item, 
# 2338 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                     ((void *)0)
# 2338 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                         , 0);
        ...
        for (i = 0; i < num_binary_items; ++i) {
            ...
            item_len = WavpackGetBinaryTagItemIndexed (wpc, i, 
# 2367 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                              ((void *)0)
# 2367 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                  , 0);
            item = malloc (item_len + 1);
            WavpackGetBinaryTagItemIndexed (wpc, i, item, item_len + 1);
            value_len = dump_tag_item_to_file (wpc, item, 
# 2370 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                         ((void *)0)
# 2370 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                             , fname);
            fprintf (dst, "%s:%s", item, strlen (item) < strlen (spaces) ? spaces + strlen (item) : " ");
...
# 2408 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
            free (item);
        }
    }
}
# 2431 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
static void dump_file_item (WavpackContext *wpc, char *str, int item_id)
{
    ...
    switch (item_id) {
        ...
        case 2:
            sprintf (str + strlen (str), "%d", (WavpackGetQualifyMode (wpc) & (0x10 | 0x20)) ? 1 : WavpackGetBitsPerSample (wpc));
            break;

        case 3:
            sprintf (str + strlen (str), "%s", (WavpackGetMode (wpc) & 0x8) ? "float" : "int");
            break;
        ...
        case 6:
            if (WavpackGetNumSamples64 (wpc) != -1)
                sprintf (str + strlen (str), "%lld",
                    (long long int) WavpackGetNumSamples64 (wpc) * (WavpackGetQualifyMode (wpc) & (0x10 | 0x20) ? 8 : 1));
...
# 2529 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
static int dump_tag_item_to_file (WavpackContext *wpc, const char *tag_item, FILE *dst, char *fname)
{
    if (WavpackGetMode (wpc) & 0x10) {
        if (WavpackGetTagItem (wpc, tag_item, 
# 2532 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                             ((void *)0)
# 2532 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                 , 0)) {
            int value_len = WavpackGetTagItem (wpc, tag_item, 
# 2533 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                             ((void *)0)
# 2533 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                 , 0);
            char *value;
        ...
        else if (WavpackGetBinaryTagItem (wpc, tag_item, 
# 2556 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                        ((void *)0)
# 2556 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                            , 0)) {
            int value_len = WavpackGetBinaryTagItem (wpc, tag_item, 
# 2557 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                                                                   ((void *)0)
# 2557 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                                                       , 0), res = 0, i;
            uint32_t bcount = 0;
            char *value;
...
# 2772 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
static void UTF8ToAnsi (char *string, int len)
{
    int max_chars = (int) strlen (string);
# 2791 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
...
# 2801 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
                           0
# 2801 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                                   , "");
    ...
    setlocale (
# 2811 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c" 3 4
              0
# 2811 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
                      , old_locale);
...
# 2830 "/doner/wavpack/wavpack-5.1.0/cli/wvunpack.c"
