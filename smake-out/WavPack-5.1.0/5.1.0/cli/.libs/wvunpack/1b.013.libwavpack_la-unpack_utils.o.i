# 1 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
# 16 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
...
# 17 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c" 2
...
# 18 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c" 2
...
# 20 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c" 2
# 37 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
uint32_t WavpackUnpackSamples (WavpackContext *wpc, int32_t *buffer, uint32_t samples)
{
    WavpackStream *wps = wpc->streams ? wpc->streams [wpc->current_stream = 0] : 
# 39 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c" 3 4
                                                                                ((void *)0)
# 39 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
                                                                                    ;
    int num_channels = wpc->config.num_channels, file_done = 0;
    ...
    while (samples) {
        ...
        if (!wps->wphdr.block_samples || !(wps->wphdr.flags & 0x800) ||
            wps->sample_index >= ( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) ) + wps->wphdr.block_samples) {

                int64_t nexthdrpos;

                if (wpc->wrapper_bytes >= 16777216)
                    break;
                ...
                if (!WavpackVerifySingleBlock (wps->blockbuff, !(wpc->open_flags & 0x800))) {
                ...
                if (wpc->open_flags & 0x20)
                    do { int64_t tmp = (wps->sample_index = 0); (wps->wphdr).block_index = (uint32_t) tmp; (wps->wphdr).block_index_u8 = (unsigned char) (tmp >> 32); } while (0);
                else
                    do { int64_t tmp = (( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) ) - wpc->initial_index); (wps->wphdr).block_index = (uint32_t) tmp; (wps->wphdr).block_index_u8 = (unsigned char) (tmp >> 32); } while (0);
                ...
                if (wps->wphdr.block_samples && wps->sample_index != ( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) ))
                    wpc->crc_errors++;
        ...
        if (wps->sample_index < ( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) )) {
            int32_t zvalue = (wps->wphdr.flags & 0x80000000) ? 0x55 : 0;

            samples_to_unpack = (uint32_t) (( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) ) - wps->sample_index);
        ...
        samples_to_unpack = (uint32_t) (( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) ) + wps->wphdr.block_samples - wps->sample_index);
        ...
        if (!wpc->reduced_channels && !(wps->wphdr.flags & 0x1000)) {
  ...
  break;
   ...
   break;
          ...
          break;
                ...
                if ((wps->wphdr.flags & 0x1000) || wpc->current_stream == wpc->max_streams - 1 || offset == num_channels)
                    break;
                else
                    wpc->current_stream++;
            }
        ...
        else if (!(wps->wphdr.flags & 4) && (num_channels == 1 || wpc->reduced_channels == 1)) {
            memset (bptr, 0, samples_to_unpack * sizeof (*bptr));
            wps->sample_index += samples_to_unpack;
            wpc->crc_errors++;
        }

        else if (wps->wphdr.flags & 0x80000000)
        ...
        if (wps->sample_index == ( (int64_t) (wps->wphdr).block_index + ((int64_t) (wps->wphdr).block_index_u8 << 32) ) + wps->wphdr.block_samples) {
            if (check_crc_error (wpc)) {
                int32_t *zptr = bptr, zvalue = (wps->wphdr.flags & 0x80000000) ? 0x55 : 0;
                ...
                if (wps->blockbuff && wpc->reader->can_seek (wpc->wv_in)) {
                    ...
                    wpc->reader->set_pos_rel (wpc->wv_in, (rseek > 16384) ? -16384 : -rseek, 
# 389 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c" 3 4
                                                                                            1
# 389 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
                                                                                                    );
                }

                if (wpc->wvc_flag && wps->block2buff && wpc->reader->can_seek (wpc->wvc_in)) {
                    int32_t rseek = ((WavpackHeader *) wps->block2buff)->ckSize / 3;
                    wpc->reader->set_pos_rel (wpc->wvc_in, (rseek > 16384) ? -16384 : -rseek, 
# 394 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c" 3 4
                                                                                             1
# 394 "/doner/wavpack/wavpack-5.1.0/src/unpack_utils.c"
                                                                                                     );
                }
