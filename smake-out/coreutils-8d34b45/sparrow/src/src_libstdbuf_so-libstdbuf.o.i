# 1 "/home/8d34b45/src/libstdbuf.c"
# 1 "/home/8d34b45//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/8d34b45/src/libstdbuf.c"
# 19 "/home/8d34b45/src/libstdbuf.c"
# 1 "./lib/config.h" 1
# 20 "/home/8d34b45/src/libstdbuf.c" 2
# 1 "./lib/stdio.h" 1
# 20 "./lib/stdio.h"
...
extern int _gl_cxxalias_dummy;
# 21 "/home/8d34b45/src/libstdbuf.c" 2
...
# 22 "/home/8d34b45/src/libstdbuf.c" 2
# 64 "/home/8d34b45/src/libstdbuf.c"
static const char *
fileno_to_name (const int fd)
{
  const char *ret = 
# 67 "/home/8d34b45/src/libstdbuf.c" 3 4
                   ((void *)0)
# 67 "/home/8d34b45/src/libstdbuf.c"
                       ;
...
{
  char *buf = 
# 91 "/home/8d34b45/src/libstdbuf.c" 3 4
             ((void *)0)
# 91 "/home/8d34b45/src/libstdbuf.c"
                 ;
  int setvbuf_mode;
  size_t size = 0;
  ...
  if (*mode == '0')
    setvbuf_mode = 
# 96 "/home/8d34b45/src/libstdbuf.c" 3 4
                  2
# 96 "/home/8d34b45/src/libstdbuf.c"
                        ;
  else if (*mode == 'L')
    setvbuf_mode = 
# 98 "/home/8d34b45/src/libstdbuf.c" 3 4
                  1
# 98 "/home/8d34b45/src/libstdbuf.c"
                        ;
  else
    {
      setvbuf_mode = 
# 101 "/home/8d34b45/src/libstdbuf.c" 3 4
                    0
# 101 "/home/8d34b45/src/libstdbuf.c"
                          ;
      _Static_assert (
# 102 "/home/8d34b45/src/libstdbuf.c" 3 4
     (18446744073709551615UL) 
# 102 "/home/8d34b45/src/libstdbuf.c"
     <= 
# 102 "/home/8d34b45/src/libstdbuf.c" 3 4
     (0x7fffffffffffffffL * 2UL + 1UL)
# 102 "/home/8d34b45/src/libstdbuf.c"
     , "verify (" "SIZE_MAX <= ULONG_MAX" ")");
      size = strtoul (mode, 
# 103 "/home/8d34b45/src/libstdbuf.c" 3 4
                           ((void *)0)
# 103 "/home/8d34b45/src/libstdbuf.c"
                               , 10);
      if (size > 0)
        {
          if (!(buf = malloc (size)))
            {
              ...
              fprintf (
# 111 "/home/8d34b45/src/libstdbuf.c" 3 4
                      stderr
# 111 "/home/8d34b45/src/libstdbuf.c"
                            ,
                       gettext ("failed to allocate a %" 
# 112 "/home/8d34b45/src/libstdbuf.c" 3 4
                      "l" "u" 
# 112 "/home/8d34b45/src/libstdbuf.c"
                      " byte stdio buffer\n")
                                                , (uintmax_t) size);
              return;
            }
        ...
        {
          fprintf (
# 119 "/home/8d34b45/src/libstdbuf.c" 3 4
                  stderr
# 119 "/home/8d34b45/src/libstdbuf.c"
  ...
  if (setvbuf (stream, buf, setvbuf_mode, size) != 0)
    {
      fprintf (
# 127 "/home/8d34b45/src/libstdbuf.c" 3 4
              stderr
# 127 "/home/8d34b45/src/libstdbuf.c"
...
stdbuf (void)
{
  ...
  if (e_mode)
    apply_mode (
# 141 "/home/8d34b45/src/libstdbuf.c" 3 4
               stderr
# 141 "/home/8d34b45/src/libstdbuf.c"
                     , e_mode);
  if (i_mode)
    apply_mode (
# 143 "/home/8d34b45/src/libstdbuf.c" 3 4
               stdin
# 143 "/home/8d34b45/src/libstdbuf.c"
                    , i_mode);
  if (o_mode)
    apply_mode (
# 145 "/home/8d34b45/src/libstdbuf.c" 3 4
               stdout
# 145 "/home/8d34b45/src/libstdbuf.c"
                     , o_mode);
}
