...
# 32 "<command-line>" 2
# 1 "/home/8d34b45/lib/posixtm.c"
# 21 "/home/8d34b45/lib/posixtm.c"
# 1 "./lib/config.h" 1
# 22 "/home/8d34b45/lib/posixtm.c" 2

# 1 "/home/8d34b45/lib/posixtm.h" 1
# 24 "/home/8d34b45/lib/posixtm.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdbool.h" 1 3 4
# 25 "/home/8d34b45/lib/posixtm.h" 2
# 1 "./lib/time.h" 1
# 20 "./lib/time.h"
...
extern int _gl_cxxalias_dummy;
# 26 "/home/8d34b45/lib/posixtm.h" 2
# 34 "/home/8d34b45/lib/posixtm.h"
_Bool 
# 34 "/home/8d34b45/lib/posixtm.h"
    posixtime (time_t *p, const char *s, unsigned int syntax_bits);
# 24 "/home/8d34b45/lib/posixtm.c" 2
...
extern int _gl_cxxalias_dummy;
# 26 "/home/8d34b45/lib/posixtm.c" 2
# 1 "./lib/stdlib.h" 1
# 20 "./lib/stdlib.h"
...
extern int _gl_cxxalias_dummy;
# 27 "/home/8d34b45/lib/posixtm.c" 2
# 1 "./lib/sys/types.h" 1
# 20 "./lib/sys/types.h"
       
# 21 "./lib/sys/types.h" 3
# 28 "/home/8d34b45/lib/posixtm.c" 2
# 1 "./lib/string.h" 1
# 20 "./lib/string.h"
...
extern int _gl_cxxalias_dummy;
# 29 "/home/8d34b45/lib/posixtm.c" 2
...
# 32 "/home/8d34b45/lib/posixtm.c" 2
# 60 "/home/8d34b45/lib/posixtm.c"

# 60 "/home/8d34b45/lib/posixtm.c"
static 
# 60 "/home/8d34b45/lib/posixtm.c" 3 4
      _Bool

# 61 "/home/8d34b45/lib/posixtm.c"
      ...
      if (digit_pair[0] <= 68)
        {
          if (syntax_bits & 16)
            return 
# 73 "/home/8d34b45/lib/posixtm.c" 3 4
                  0
# 73 "/home/8d34b45/lib/posixtm.c"
                       ;
          tm->tm_year += 100;
        }
      break;
    ...
    case 2:
      if (! (syntax_bits & 4))
        return 
# 80 "/home/8d34b45/lib/posixtm.c" 3 4
              0
# 80 "/home/8d34b45/lib/posixtm.c"
                   ;
    ...
    case 0:
      {
        ...
        if (! tmp)
          return 
# 93 "/home/8d34b45/lib/posixtm.c" 3 4
                0
# 93 "/home/8d34b45/lib/posixtm.c"
                     ;
  ...
  return 
# 102 "/home/8d34b45/lib/posixtm.c" 3 4
        1
# 102 "/home/8d34b45/lib/posixtm.c"
            ;
}

static 
# 105 "/home/8d34b45/lib/posixtm.c" 3 4
      _Bool

# 106 "/home/8d34b45/lib/posixtm.c"
posix_time_parse (struct tm *tm, const char *s, unsigned int syntax_bits)
{
  const char *dot = 
# 108 "/home/8d34b45/lib/posixtm.c" 3 4
                   ((void *)0)
# 108 "/home/8d34b45/lib/posixtm.c"
                       ;
  int pair[6];
  int *p;
  size_t i;
      ...
      if (dot)
        {
          ...
          if (s_len - len != 3)
            return 
# 123 "/home/8d34b45/lib/posixtm.c" 3 4
                  0
# 123 "/home/8d34b45/lib/posixtm.c"
                       ;
        }
    }
  ...
  if (! (8 <= len && len <= 12 && len % 2 == 0))
    return 
# 128 "/home/8d34b45/lib/posixtm.c" 3 4
          0
# 128 "/home/8d34b45/lib/posixtm.c"
               ;

  for (i = 0; i < len; i++)
    if (!((unsigned int) (s[i]) - '0' <= 9))
      return 
# 132 "/home/8d34b45/lib/posixtm.c" 3 4
            0
# 132 "/home/8d34b45/lib/posixtm.c"
                 ;
  ...
  if (syntax_bits & 1)
    {
      if (! year (tm, p, len - 4, syntax_bits))
        return 
# 142 "/home/8d34b45/lib/posixtm.c" 3 4
              0
# 142 "/home/8d34b45/lib/posixtm.c"
                   ;
      p += len - 4;
      len = 4;
    }
  ...
  if (syntax_bits & 2)
    {
      if (! year (tm, p, len, syntax_bits))
        return 
# 158 "/home/8d34b45/lib/posixtm.c" 3 4
              0
# 158 "/home/8d34b45/lib/posixtm.c"
                   ;
    }
  ...
  if (!dot)
    ...
    return 
# 167 "/home/8d34b45/lib/posixtm.c" 3 4
          0
# 167 "/home/8d34b45/lib/posixtm.c"
               ;

  return 
# 169 "/home/8d34b45/lib/posixtm.c" 3 4
        1
# 169 "/home/8d34b45/lib/posixtm.c"
            ;
}
...
# 174 "/home/8d34b45/lib/posixtm.c" 3 4
_Bool

# 175 "/home/8d34b45/lib/posixtm.c"
posixtime (time_t *p, const char *s, unsigned int syntax_bits)
{
  struct tm tm0;
  struct tm tm1;
  ...
  if (! posix_time_parse (&tm0, s, syntax_bits))
    return 
# 183 "/home/8d34b45/lib/posixtm.c" 3 4
          0
# 183 "/home/8d34b45/lib/posixtm.c"
               ;

  tm1 = tm0;
  tm1.tm_isdst = -1;
  t = 
# 187 "/home/8d34b45/lib/posixtm.c" 3
     rpl_mktime 
# 187 "/home/8d34b45/lib/posixtm.c"
            (&tm1);
  ...
  if (t != (time_t) -1)
  ...
  else
    {
      ...
      if (! tm)
        return 
# 197 "/home/8d34b45/lib/posixtm.c" 3 4
              0
# 197 "/home/8d34b45/lib/posixtm.c"
                   ;
    }
  ...
  if ((tm0.tm_year ^ tm->tm_year)
      ...
      | (tm0.tm_sec ^ tm->tm_sec))
    {
      ...
      if (tm0.tm_sec != 60)
        return 
# 213 "/home/8d34b45/lib/posixtm.c" 3 4
              0
# 213 "/home/8d34b45/lib/posixtm.c"
                   ;

      {
        ...
        if (!posixtime (&dummy, buf, syntax_bits))
          return 
# 222 "/home/8d34b45/lib/posixtm.c" 3 4
                0
# 222 "/home/8d34b45/lib/posixtm.c"
                     ;
      }
    }
  ...
  *p = t;
  return 
# 227 "/home/8d34b45/lib/posixtm.c" 3 4
        1
# 227 "/home/8d34b45/lib/posixtm.c"
            ;
}
