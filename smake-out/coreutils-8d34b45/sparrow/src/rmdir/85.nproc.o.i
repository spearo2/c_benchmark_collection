...
# 32 "<command-line>" 2
# 1 "/home/8d34b45/lib/nproc.c"
# 20 "/home/8d34b45/lib/nproc.c"
# 1 "./lib/config.h" 1
# 21 "/home/8d34b45/lib/nproc.c" 2
# 1 "/home/8d34b45/lib/nproc.h" 1
# 32 "/home/8d34b45/lib/nproc.h"
enum nproc_query
{
  NPROC_ALL,
  NPROC_CURRENT,
...
# 21 "./lib/sys/types.h" 3
# 36 "/home/8d34b45/lib/nproc.c" 2
# 46 "/home/8d34b45/lib/nproc.c"
...
# 59 "/home/8d34b45/lib/nproc.c" 2

# 1 "/home/8d34b45/lib/minmax.h" 1
# 61 "/home/8d34b45/lib/nproc.c" 2
    ...
    if (sched_getaffinity (0, sizeof (set), &set) == 0)
      {
        ...
        count = 
# 137 "/home/8d34b45/lib/nproc.c" 3 4
               __sched_cpucount (sizeof (cpu_set_t), 
# 137 "/home/8d34b45/lib/nproc.c"
               &set
# 137 "/home/8d34b45/lib/nproc.c" 3 4
               )
# 137 "/home/8d34b45/lib/nproc.c"
                               ;
# 146 "/home/8d34b45/lib/nproc.c"
        if (count > 0)
          return count;
      }
  }
# 199 "/home/8d34b45/lib/nproc.c"
  return 0;
}
...
# 235 "/home/8d34b45/lib/nproc.c" 3 4
                                  _SC_NPROCESSORS_ONLN
# 235 "/home/8d34b45/lib/nproc.c"
                                                      );
        if (nprocs > 0)
          return nprocs;
      }
  ...
  else
    {

      {
        ...
        long int nprocs = sysconf (
# 246 "/home/8d34b45/lib/nproc.c" 3 4
                                  _SC_NPROCESSORS_CONF
# 246 "/home/8d34b45/lib/nproc.c"
                                                      );
...
parse_omp_threads (char const* threads)
{
  ...
  if (threads == 
# 340 "/home/8d34b45/lib/nproc.c" 3 4
                ((void *)0)
# 340 "/home/8d34b45/lib/nproc.c"
                    )
    return ret;
  ...
  if (c_isdigit (*threads))
    {
      char *endptr = 
# 351 "/home/8d34b45/lib/nproc.c" 3 4
                    ((void *)0)
# 351 "/home/8d34b45/lib/nproc.c"
                        ;
      unsigned long int value = strtoul (threads, &endptr, 10);

      if (endptr != 
# 354 "/home/8d34b45/lib/nproc.c" 3 4
                   ((void *)0)
# 354 "/home/8d34b45/lib/nproc.c"
                       )
        {
...
# 373 "/home/8d34b45/lib/nproc.c" 3 4
                                   (0x7fffffffffffffffL * 2UL + 1UL)
# 373 "/home/8d34b45/lib/nproc.c"
                                            ;
  ...
  if (query == NPROC_CURRENT_OVERRIDABLE)
    {
      ...
      if (! omp_env_limit)
        omp_env_limit = 
# 383 "/home/8d34b45/lib/nproc.c" 3 4
                       (0x7fffffffffffffffL * 2UL + 1UL)
# 383 "/home/8d34b45/lib/nproc.c"
                                ;

      if (omp_env_threads)
        return 
# 386 "/home/8d34b45/lib/nproc.c" 3 4
              (((
# 386 "/home/8d34b45/lib/nproc.c"
              omp_env_threads
# 386 "/home/8d34b45/lib/nproc.c" 3 4
              )<(
# 386 "/home/8d34b45/lib/nproc.c"
...
# 386 "/home/8d34b45/lib/nproc.c"
...

  {
    ...
    return 
# 393 "/home/8d34b45/lib/nproc.c" 3 4
          (((
# 393 "/home/8d34b45/lib/nproc.c"
          nprocs
# 393 "/home/8d34b45/lib/nproc.c" 3 4
          )<(
# 393 "/home/8d34b45/lib/nproc.c"
