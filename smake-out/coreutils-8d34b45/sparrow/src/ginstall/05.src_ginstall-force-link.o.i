# 1 "/home/8d34b45/src/force-link.c"
# 1 "/home/8d34b45//"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "<command-line>" 2
# 1 "/home/8d34b45/src/force-link.c"
# 26 "/home/8d34b45/src/force-link.c"
# 1 "./lib/config.h" 1
# 27 "/home/8d34b45/src/force-link.c" 2
...
# 28 "/home/8d34b45/src/force-link.c" 2
...
# 30 "/home/8d34b45/src/force-link.c" 2
...
extern int try_tempname_len (char *tmpl, int suffixlen, void *args,
                             int (*tryfunc) (char *, void *),
                             size_t x_suffix_len);
# 32 "/home/8d34b45/src/force-link.c" 2
...
force_linkat (int srcdir, char const *srcname,
              int dstdir, char const *dstname, int flags, 
# 94 "/home/8d34b45/src/force-link.c" 3 4
                                                         _Bool 
# 94 "/home/8d34b45/src/force-link.c"
                                                              force)
{
  int r = linkat (srcdir, srcname, dstdir, dstname, flags);
  if (!force || r == 0 || 
# 97 "/home/8d34b45/src/force-link.c" 3 4
                         (*__errno_location ()) 
# 97 "/home/8d34b45/src/force-link.c"
                               != 
# 97 "/home/8d34b45/src/force-link.c" 3 4
                                  17
# 97 "/home/8d34b45/src/force-link.c"
  ...
  if (try_tempname_len (dsttmp, 0, &arg, try_link, x_suffix_len) != 0)
    err = 
# 108 "/home/8d34b45/src/force-link.c" 3 4
         (*__errno_location ())
# 108 "/home/8d34b45/src/force-link.c"
              ;
  else
    {
      err = renameat (dstdir, dsttmp, dstdir, dstname) == 0 ? 0 : 
# 111 "/home/8d34b45/src/force-link.c" 3 4
                                                                 (*__errno_location ())
# 111 "/home/8d34b45/src/force-link.c"
                                                                      ;
...
# 122 "/home/8d34b45/src/force-link.c" 3 4
 (*__errno_location ()) 
# 122 "/home/8d34b45/src/force-link.c"
       = err;
  return -1;
}
...
# 149 "/home/8d34b45/src/force-link.c" 3 4
                _Bool 
# 149 "/home/8d34b45/src/force-link.c"
                     force)
{
  int r = symlinkat (srcname, dstdir, dstname);
  if (!force || r == 0 || 
# 152 "/home/8d34b45/src/force-link.c" 3 4
                         (*__errno_location ()) 
# 152 "/home/8d34b45/src/force-link.c"
                               != 
# 152 "/home/8d34b45/src/force-link.c" 3 4
                                  17
# 152 "/home/8d34b45/src/force-link.c"
  ...
  if (try_tempname_len (dsttmp, 0, &arg, try_symlink, x_suffix_len) != 0)
    err = 
# 163 "/home/8d34b45/src/force-link.c" 3 4
         (*__errno_location ())
# 163 "/home/8d34b45/src/force-link.c"
              ;
  else if (renameat (dstdir, dsttmp, dstdir, dstname) != 0)
    {
      err = 
# 166 "/home/8d34b45/src/force-link.c" 3 4
           (*__errno_location ())
# 166 "/home/8d34b45/src/force-link.c"
                ;
      unlinkat (dstdir, dsttmp, 0);
    }
  else
...
# 180 "/home/8d34b45/src/force-link.c" 3 4
 (*__errno_location ()) 
# 180 "/home/8d34b45/src/force-link.c"
       = err;
  return -1;
}
