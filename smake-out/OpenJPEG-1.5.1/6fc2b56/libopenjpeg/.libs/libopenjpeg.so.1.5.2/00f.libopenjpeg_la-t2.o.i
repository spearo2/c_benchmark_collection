# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
# 32 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
...
# 33 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 2
...
# 60 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
...
# 79 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
static int t2_decode_packet(opj_t2_t* t2, unsigned char *src, int len, opj_tcd_tile_t *tile,
              opj_tcp_t *tcp, opj_pi_iterator_t *pi, opj_packet_info_t *pack_info);
# 90 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
static void t2_putcommacode(opj_bio_t *bio, int n) {
 while (--n >= 0) {
  bio_write(bio, 1, 1);
 }
...
static int t2_encode_packet(opj_tcd_tile_t * tile, opj_tcp_t * tcp, opj_pi_iterator_t *pi, unsigned char *dest, int length, opj_codestream_info_t *cstr_info, int tileno) {
 ...
 opj_bio_t *bio = 
# 144 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
                 ((void *)0)
# 144 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                     ;
...
static opj_bool t2_init_seg(opj_tcd_cblk_dec_t* cblk, int index, int cblksty, int first) {
 opj_tcd_seg_t* seg;
    ...
    if (segs == 
# 304 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
               ((void *)0)
# 304 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                   )
    {
        return 0;
    }
 ...
 seg = &cblk->segs[index];
 seg->data = 
# 311 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
            ((void *)0)
# 311 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                ;
 seg->dataindex = 0;
 seg->numpasses = 0;
 seg->len = 0;
...
static int t2_decode_packet(opj_t2_t* t2, unsigned char *src, int len, opj_tcd_tile_t *tile,
 ...
 unsigned char *hd = 
# 345 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
                    ((void *)0)
# 345 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                        ;
 int present;

 opj_bio_t *bio = 
# 348 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
                 ((void *)0)
# 348 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                     ;
...
# 385 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
 bio = bio_create();
 ...
 for (bandno = 0; bandno < res->numbands; bandno++) {
  ...
  for (cblkno = 0; cblkno < prc->cw * prc->ch; cblkno++) {
   opj_tcd_cblk_dec_t* cblk = &prc->cblks.dec[cblkno];
   opj_tcd_seg_t *seg = 
# 556 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
                       ((void *)0)
# 556 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                           ;
...
# 596 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
...
# 624 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
                        ((void *)0)
# 624 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                            ;
 int poc;
  ...
  while (pi_next(&pi[pino])) {
   if ((cp->layer==0) || (cp->layer>=((pi[pino].layno)+1))) {
    ...
    if (cstr_info)
     ...
     pack_info = 
# 737 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
                ((void *)0)
# 737 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                    ;
...
opj_t2_t* t2_create(opj_common_ptr cinfo, opj_image_t *image, opj_cp_t *cp) {
 ...
 if(!t2) return 
# 805 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c" 3 4
               ((void *)0)
# 805 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/t2.c"
                   ;
 t2->cinfo = cinfo;
 t2->image = image;
 t2->cp = cp;
