# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
...
# 1 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
# 27 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
...
# 28 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c" 2
...
opj_image_t* opj_image_create(int numcmpts, opj_image_cmptparm_t *cmptparms, OPJ_COLOR_SPACE clrspc) {
 int compno;
 opj_image_t *image = 
# 36 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c" 3 4
                     ((void *)0)
# 36 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
                         ;
 ...
 if(image) {
  ...
  if(!image->comps) {
   fprintf(
# 45 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c" 3 4
          stderr
# 45 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
                ,"Unable to allocate memory for image.\n");
   opj_image_destroy(image);
   return 
# 47 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c" 3 4
         ((void *)0)
# 47 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
             ;
  }
  ...
  for(compno = 0; compno < numcmpts; compno++) {
   ...
   if(!comp->data) {
    fprintf(
# 63 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c" 3 4
           stderr
# 63 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
                 ,"Unable to allocate memory for image.\n");
    opj_image_destroy(image);
    return 
# 65 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c" 3 4
          ((void *)0)
# 65 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/image.c"
              ;
   }
  }
 }
