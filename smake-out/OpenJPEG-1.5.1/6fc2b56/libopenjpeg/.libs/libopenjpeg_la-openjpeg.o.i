# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
...
# 1 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
# 31 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
# 1 "../opj_config.h" 1
# 32 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 2
...
# 33 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 2
# 61 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
const char* opj_version(void) {
    return "1.5.2";
}
...
opj_dinfo_t* opj_create_decompress(OPJ_CODEC_FORMAT format) {
 ...
 if(!dinfo) return 
# 67 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
                  ((void *)0)
# 67 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
                      ;
 ...
 switch(format) {
  ...
  case CODEC_JPT:
   ...
   if(!dinfo->j2k_handle) {
    free(dinfo);
    return 
# 76 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
          ((void *)0)
# 76 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
              ;
   }
   break;
  case CODEC_JP2:
   ...
   if(!dinfo->jp2_handle) {
    free(dinfo);
    return 
# 84 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
          ((void *)0)
# 84 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
              ;
   }
   break;
  case CODEC_UNKNOWN:
  default:
   free(dinfo);
   return 
# 90 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
         ((void *)0)
# 90 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
             ;
 }
...
# 157 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
                                        ((void *)0)
# 157 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
                                            );
}
...
opj_image_t* opj_decode_with_info(opj_dinfo_t *dinfo, opj_cio_t *cio, opj_codestream_info_t *cstr_info) {
 ...
 return 
# 174 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
       ((void *)0)
# 174 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
           ;
}
...
opj_cinfo_t* opj_create_compress(OPJ_CODEC_FORMAT format) {
 ...
 if(!cinfo) return 
# 179 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
                  ((void *)0)
# 179 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
                      ;
 ...
 switch(format) {
  case CODEC_J2K:
   ...
   if(!cinfo->j2k_handle) {
    free(cinfo);
    return 
# 187 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
          ((void *)0)
# 187 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
              ;
   }
   break;
  case CODEC_JP2:
   ...
   if(!cinfo->jp2_handle) {
    free(cinfo);
    return 
# 195 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
          ((void *)0)
# 195 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
              ;
   }
   break;
  case CODEC_JPT:
  ...
  default:
   free(cinfo);
   return 
# 202 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
         ((void *)0)
# 202 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
             ;
 }
...
# 285 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
 }
}
...
opj_bool opj_encode(opj_cinfo_t *cinfo, opj_cio_t *cio, opj_image_t *image, char *index) {
 if (index != 
# 306 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
             ((void *)0)
# 306 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
                 )
...
# 310 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c" 3 4
                                               ((void *)0)
# 310 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/openjpeg.c"
                                                   );
}
