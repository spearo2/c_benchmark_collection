# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
...
# 1 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
# 32 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
...
# 33 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 2
...
opj_tgt_tree_t *tgt_create(int numleafsh, int numleafsv) {
 ...
 int nplv[32];
 opj_tgt_node_t *node = 
# 43 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
                       ((void *)0)
# 43 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
                           ;
 opj_tgt_node_t *parentnode = 
# 44 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
                             ((void *)0)
# 44 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
                                 ;
 opj_tgt_node_t *parentnode0 = 
# 45 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
                              ((void *)0)
# 45 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
                                  ;
 opj_tgt_tree_t *tree = 
# 46 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
                       ((void *)0)
# 46 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
                           ;
 int i, j, k;
 int numlvls;
 int n;
 ...
 if(!tree) return 
# 52 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
                 ((void *)0)
# 52 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
                     ;
 ...
 if (tree->numnodes == 0) {
  free(tree);
  return 
# 71 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
        ((void *)0)
# 71 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
            ;
 }
 ...
 if(!tree->nodes) {
  free(tree);
  return 
# 77 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
        ((void *)0)
# 77 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
            ;
 }
...
void tgt_reset(opj_tgt_tree_t *tree) {
 ...
 if (
# 119 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c" 3 4
    ((void *)0) 
# 119 "/doner/openjpeg/openjpeg-6fc2b56/libopenjpeg/tgt.c"
         == tree)
  return;
