# 1 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
# 30 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
...
# 31 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 32 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 33 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 34 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 35 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 36 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 38 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 39 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
# 1 "../src/ming.h" 1
# 56 "../src/ming.h"
...
# 40 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 41 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
...
# 45 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 2
# 60 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
...
# 98 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
                     4096
# 98 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                             ];
 ...
 if ( dopreprocess )
 {
  ...
  fflush(
# 113 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
        stdout
# 113 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
              );
  if ( ! makeswf_preprocess(filename, ppfile) )
  {
   return 
# 116 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
         ((void *)0)
# 116 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
             ;
  }
 ...
 {
  return 
# 124 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
        ((void *)0)
# 124 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
            ;
 }
 ...
 if (SWFAction_compile(ac, swfversion, &length) || lastcompilefailed)
 {
  ...
  return 
# 136 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
        ((void *)0)
# 136 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
            ;
 }
 else
 {
...
printCompileMessage(SWFMsgFunc func)
{
   ...
   fprintf(
# 158 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
          stderr
# 158 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                , "  %s\n", strtok(lastcompilemessage, "\n"));
   while ( (ptr1=strtok(
# 159 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
                        ((void *)0)
# 159 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                            , "\n")) )
   {
      fprintf(
# 161 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
             stderr
# 161 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                   , "  %s\n", ptr1);
   }
   func("\n");
}
...
# 178 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
__builtin_va_start(
# 178 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
ap
# 178 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
,
# 178 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
...
# 178 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
 ...
 {
  fprintf(
# 188 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
         stderr
# 188 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
               , "vasnprintf allocated 0 bytes\n");
  
# 189 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
 __builtin_va_end(
# 189 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
 ap
# 189 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
 )
# 189 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
...
# 192 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
__builtin_va_end(
# 192 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
ap
# 192 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
)
# 192 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
...
makeswf_readfile (const char *file)
{
   ...
   if ( ! fd )
   {
      perror(file);
      return 
# 215 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
            ((void *)0)
# 215 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                ;
   }
   fstat(fileno(fd), &buf);
   size = buf.st_size;
   ...
   if ( ! ret )
   {
      perror("readfile");
      return 
# 223 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
            ((void *)0)
# 223 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                ;
   }
   if(fread(ret, 1, size, fd) != size)
   {
 fprintf(
# 227 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
        stderr
# 227 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
              , "makeswf_readfile: failed\n");
 fclose(fd);
 free(ret);
 return 
# 230 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
       ((void *)0)
# 230 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
           ;
   }
   ret[size] = '\0';
   fclose(fd);
...
makeswf_preprocess (const char *file, const char *out)
{
 ...
 if ( -1 == stat(file, &statbuf) )
 {
  perror(file);
  exit(
# 248 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
      1
# 248 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                  );
 }
 ...
 {
  exit(
# 258 "/doner/libming/libming-19e7127/util/makeswf_utils.c" 3 4
      1
# 258 "/doner/libming/libming-19e7127/util/makeswf_utils.c"
                  );
 }
