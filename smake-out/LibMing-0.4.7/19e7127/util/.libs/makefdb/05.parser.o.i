# 1 "/doner/libming/libming-19e7127/util/parser.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-19e7127/util/parser.c"
# 21 "/doner/libming/libming-19e7127/util/parser.c"
...
# 22 "/doner/libming/libming-19e7127/util/parser.c" 2
...
# 23 "/doner/libming/libming-19e7127/util/parser.c" 2
...
# 24 "/doner/libming/libming-19e7127/util/parser.c" 2
...
# 25 "/doner/libming/libming-19e7127/util/parser.c" 2
# 1 "../src/abctypes.h" 1
# 23 "../src/abctypes.h"
typedef enum {
 __add = 0xa0,
...
# 26 "/doner/libming/libming-19e7127/util/parser.c" 2
...
# 27 "/doner/libming/libming-19e7127/util/parser.c" 2
...
# 28 "/doner/libming/libming-19e7127/util/parser.c" 2
...
# 29 "/doner/libming/libming-19e7127/util/parser.c" 2
...
void dumpBuffer(unsigned char *buf, int length);
# 30 "/doner/libming/libming-19e7127/util/parser.c" 2
# 1 "../src/blocks/error.h" 1
# 31 "/doner/libming/libming-19e7127/util/parser.c" 2
...
void silentSkipBytes(FILE *f, int length);
# 54 "/doner/libming/libming-19e7127/util/parser.c"
void
...
parseSWF_FOCALGRADIENT (FILE * f, struct SWF_FOCALGRADIENT *gradient, int level)
{
  ...
  if(gradient->NumGradients > 15) {
   fprintf(
# 425 "/doner/libming/libming-19e7127/util/parser.c" 3 4
          stderr
# 425 "/doner/libming/libming-19e7127/util/parser.c"
...
parseSWF_GRADIENT (FILE * f, struct SWF_GRADIENT *gradient, int level)
{
  ...
  if((gradient->NumGradients > 8 && level < 4) || (gradient->NumGradients > 15 && level == 4)) {
   fprintf(
# 443 "/doner/libming/libming-19e7127/util/parser.c" 3 4
          stderr
# 443 "/doner/libming/libming-19e7127/util/parser.c"
...
# 655 "/doner/libming/libming-19e7127/util/parser.c" 3 4
                           ((void *)0)
# 655 "/doner/libming/libming-19e7127/util/parser.c"
                               ;
  ...
  else
  {
    ...
    linestyle->LineStyles2 = 
# 663 "/doner/libming/libming-19e7127/util/parser.c" 3 4
                            ((void *)0)
# 663 "/doner/libming/libming-19e7127/util/parser.c"
                                ;
  }
...
parseSWF_MORPHGRADIENT (FILE * f, struct SWF_MORPHGRADIENT *gradient)
{
  ...
  if( gradient->NumGradients > 8 ) {
   fprintf(
# 757 "/doner/libming/libming-19e7127/util/parser.c" 3 4
          stderr
# 757 "/doner/libming/libming-19e7127/util/parser.c"
...
# 876 "/doner/libming/libming-19e7127/util/parser.c"
int
parseSWF_ACTIONRECORD(FILE * f, int *thisactionp, SWF_ACTION *actions)
{
 ...
 case SWFACTION_LOGICALNOT:
  ...
  fprintf(
# 992 "/doner/libming/libming-19e7127/util/parser.c" 3 4
         stderr
# 992 "/doner/libming/libming-19e7127/util/parser.c"
               ,"NOT param: %d\n", act->Boolean );
  break;
  }
...
parseSWF_DEFINESPRITE (FILE * f, int length)
{
  ...
  parserrec->tagTypes = 
# 2204 "/doner/libming/libming-19e7127/util/parser.c" 3 4
                       ((void *)0)
# 2204 "/doner/libming/libming-19e7127/util/parser.c"
                           ;
  parserrec->Tags = 
# 2205 "/doner/libming/libming-19e7127/util/parser.c" 3 4
                   ((void *)0)
# 2205 "/doner/libming/libming-19e7127/util/parser.c"
                       ;
  while( fileOffset < start+length ) {
   ...
   if( ftell(f) != nextFrame ) {
     ...
     fseek(f,blockstart,
# 2232 "/doner/libming/libming-19e7127/util/parser.c" 3 4
                       0
# 2232 "/doner/libming/libming-19e7127/util/parser.c"
                               );
...
parseSWF_PROTECT (FILE * f, int length)
{
  ...
  if( length != 0 ) {
   ...
   parserrec->Password = 
# 2670 "/doner/libming/libming-19e7127/util/parser.c" 3 4
                        ((void *)0)
# 2670 "/doner/libming/libming-19e7127/util/parser.c"
                            ;
  }
