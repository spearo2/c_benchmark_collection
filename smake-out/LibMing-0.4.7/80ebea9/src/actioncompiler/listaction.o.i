# 1 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
...
# 2 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 2
...
# 3 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 4 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 2
...
# 5 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 2
...
# 6 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 2
# 1 "../../src/libming.h" 1
# 33 "../../src/libming.h"
...
# 76 "../../src/libming.h" 2
# 7 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 2





# 11 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
int gIndent;
...
# 22 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
 __builtin_va_start(
# 22 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
 ap
# 22 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
 ,
# 22 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
...
# 24 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
 __builtin_va_end(
# 24 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
 ap
# 24 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
 )
# 24 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
...
int readUInt8(Buffer f)
{
  ...
  {
    return 
# 35 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
          (-1)
# 35 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
             ;
  }
...
int readUInt16(Buffer f)
{
  ...
  {
    return 
# 54 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
          (-1)
# 54 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
             ;
  }
...
unsigned long readUInt32(Buffer f)
{
  ...
  {
    return 
# 68 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
          (-1)
# 68 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
             ;
  }
...
char *readString(Buffer f)
{
  ...
  while(tmp_char != 
# 99 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
                   (-1) 
# 99 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
                       && tmp_char != '\0')
  {
    if(len==buflen)
    {
...
void dumpBytes(Buffer f, int length)
{
  ...
  break;
    ...
    if(j==length)
    {
      for(k=i+1; k<16; ++k)
 {fputs("   ",
# 140 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
stdout
# 140 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
);};
    ...
    {fputs("   ",
# 145 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
   stdout
# 145 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
   );};
...
int printActionRecord(Buffer f)
{
 ...
 switch(flags & 0x03)
 {
    ...
    case SWFACTION_GOTOFRAME2:
      {fputs("Goto Expression",
# 396 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
     stdout
# 396 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
     );};
      if(readUInt8(f) == 1)
 printf(" and Play\n");
      else
 printf(" and Stop\n");
    ...
    case SWFACTION_CONSTANTPOOL:
    {
      ...
      {fputs("declare dictionary:",
# 498 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
     stdout
# 498 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
     );};
 ...
 printf(" %s%c", dictionary[i]=readString(f), (i<n-1)?',':'\n');
    ...
    case SWFACTION_DEFINEFUNCTION:
    {
      ...
      {fputs("function ",
# 520 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
     stdout
# 520 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
     );};
      {fputs(name,
# 521 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
     stdout
# 521 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
     );};
      putchar('(');
 ...
 char *name;
   ...
   if(Catch)
      { {fputs("catch (",
# 577 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
       stdout
# 577 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
       );}; {fputs(name,
# 577 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c" 3 4
                         stdout
# 577 "/doner/libming/libming-80ebea9/src/actioncompiler/listaction.c"
