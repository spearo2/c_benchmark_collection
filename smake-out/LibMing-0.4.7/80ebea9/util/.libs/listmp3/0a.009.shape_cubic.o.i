# 1 "/doner/libming/libming-80ebea9/src/shape_cubic.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/src/shape_cubic.c"
# 21 "/doner/libming/libming-80ebea9/src/shape_cubic.c"
...
# 22 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
...
# 23 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
...
# 26 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
...
# 27 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
# 1 "/doner/libming/libming-80ebea9/src/shape_util.h" 1
# 28 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
...
# 29 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
# 1 "/doner/libming/libming-80ebea9/src/blocks/shape.h" 1
# 33 "/doner/libming/libming-80ebea9/src/blocks/shape.h"
...
SWFShape_setLineStyle_internal(SWFShape shape, unsigned short width,
                      byte r, byte g, byte b, byte a);
# 30 "/doner/libming/libming-80ebea9/src/shape_cubic.c" 2
...
{
 if ( !(t>0.0 && t<1.0) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "t>0.0 && t<1.0", "/doner/libming/libming-80ebea9/src/shape_cubic.c",74); } while(0);;
...
{
 if ( !(t>0.0 && t<1.0) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "t>0.0 && t<1.0", "/doner/libming/libming-80ebea9/src/shape_cubic.c",97); } while(0);;
       ...
       int cx, int cy, int dx, int dy)
{
 ...
 if ( t1 > 0.0 && t1 < 1.0 )
 {
  ...
  nCurves += SWFShape_approxCubic(shape, &New);
# 263 "/doner/libming/libming-80ebea9/src/shape_cubic.c"
 ...
 if ( t2 > 0.0 && t2 < 1.0 )
 {
  ...
  nCurves += SWFShape_approxCubic(shape, &New);
# 280 "/doner/libming/libming-80ebea9/src/shape_cubic.c"
