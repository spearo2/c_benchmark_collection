# 1 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/util/outputtxt.c"
# 21 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
# 22 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
...
# 23 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
...
# 24 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
# 1 "/doner/libming/libming-80ebea9/util/read.h" 1
...
void dumpBuffer(unsigned char *buf, int length);
# 25 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
# 1 "/doner/libming/libming-80ebea9/util/decompile.h" 1
# 31 "/doner/libming/libming-80ebea9/util/decompile.h"
struct _stack;
...
# 26 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
# 1 "/doner/libming/libming-80ebea9/util/swfoutput.h" 1
# 25 "/doner/libming/libming-80ebea9/util/swfoutput.h"
...
# 1 "/doner/libming/libming-80ebea9/util/outputdecl.h" 1
# 22 "/doner/libming/libming-80ebea9/util/outputdecl.h"
...
# 32 "/doner/libming/libming-80ebea9/util/swfoutput.h" 2
# 27 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
# 1 "../src/abctypes.h" 1
# 23 "../src/abctypes.h"
typedef enum {
 __add = 0xa0,
...
# 28 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 31 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2
...
# 32 "/doner/libming/libming-80ebea9/util/outputtxt.c" 2


# 33 "/doner/libming/libming-80ebea9/util/outputtxt.c"
extern const char *blockName (SWFBlocktype header);

extern int verbose;

extern struct Movie m;
# 46 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
# 143 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
__builtin_va_start(
# 143 "/doner/libming/libming-80ebea9/util/outputtxt.c"
ap
# 143 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
,
# 143 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
# 226 "/doner/libming/libming-80ebea9/util/outputtxt.c"
void
...
{
# 305 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
{
# 351 "/doner/libming/libming-80ebea9/util/outputtxt.c"
  ++INDENT;
...
# 576 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
                                    ((void *)0)
# 576 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                                        )
      outputSWF_LINESTYLE (&(linestylearray->LineStyles[i]),"",0);
    else if(linestylearray->LineStyles2 != 
# 578 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
                                          ((void *)0)
# 578 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                                              )
...
outputSWF_MORPHLINESTYLES (SWF_MORPHLINESTYLES * linestylearray)
{
  ...
  {
    if(linestylearray->LineStyles != 
# 636 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
                                    ((void *)0)
# 636 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                                        )
      outputSWF_MORPHLINESTYLE (&(linestylearray->LineStyles[i]),"");
    else if(linestylearray->LineStyles2 != 
# 638 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
                                          ((void *)0)
# 638 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                                              )
...
{
  struct SWF_DEFINEBITS *sblock = (struct SWF_DEFINEBITS *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
}
...
{
  struct SWF_DEFINEBITSJPEG2 *sblock = (struct SWF_DEFINEBITSJPEG2 *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
}
...
{
  struct SWF_DEFINEBITSJPEG3 *sblock = (struct SWF_DEFINEBITSJPEG3 *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
...
{
  int i;
  struct SWF_DEFINEBUTTON2 *sblock = (struct SWF_DEFINEBUTTON2 *)pblock;;
# 998 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
{
  struct SWF_DEFINEBUTTONCXFORM *sblock = (struct SWF_DEFINEBUTTONCXFORM *)pblock;;
  _iprintf(" ButtonId %d\n", sblock->ButtonId);
...
{
  struct SWF_DEFINEBUTTONSOUND *sblock = (struct SWF_DEFINEBUTTONSOUND *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
...
{
  struct SWF_DEFINEEDITTEXT *sblock = (struct SWF_DEFINEEDITTEXT *)pblock;;
...
{
  int i;
  struct SWF_DEFINEFONT *sblock = (struct SWF_DEFINEFONT *)pblock;;
  _iprintf (" FontID: %d\n", sblock->FontID);
...
{
  int i;
  struct SWF_DEFINEFONT2 *sblock = (struct SWF_DEFINEFONT2 *)pblock;;
...
{
  int i;
  struct SWF_DEFINEFONT3 *sblock = (struct SWF_DEFINEFONT3 *)pblock;;
...
{
  int i;
  struct SWF_DEFINEFONTINFO *sblock = (struct SWF_DEFINEFONTINFO *)pblock;;
  _iprintf("FontID: %d\n", sblock->FontID);
  _iprintf("FontNameLen %d\n", sblock->FontNameLen);
  _iprintf("FontName %s\n", sblock->FontName);
  _iprintf("FontFlagsSmallText %d\n", sblock->FontFlagsSmallText);
...
{
  int i;
  struct SWF_DEFINEFONTINFO2 *sblock = (struct SWF_DEFINEFONTINFO2 *)pblock;;
  _iprintf("FontID: %d\n", sblock->FontID);
  _iprintf("FontNameLen %d\n", sblock->FontNameLen);
  _iprintf("FontName %s\n", sblock->FontName);
  _iprintf("FontFlagsSmallText %d\n", sblock->FontFlagsSmallText);
...
{
  struct SWF_CSMTEXTSETTINGS *sblock = (struct SWF_CSMTEXTSETTINGS *)pblock;;
  _iprintf("TextID: %d\n", sblock->TextID);
...
{
  int i;
  struct SWF_DEFINEFONTALIGNZONES *sblock = (struct SWF_DEFINEFONTALIGNZONES *)pblock;;
...
{
  struct SWF_DEFINEFONTNAME *sblock = (struct SWF_DEFINEFONTNAME *)pblock;;
  _iprintf(" FontId: %d\n", sblock->FontId);
  _iprintf(" FontName: %s\n", sblock->FontName);
...
{
  struct SWF_DEFINELOSSLESS *sblock = (struct SWF_DEFINELOSSLESS *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
...
{
  struct SWF_DEFINELOSSLESS2 *sblock = (struct SWF_DEFINELOSSLESS2 *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
  _iprintf(" Bitmap format %d\n", sblock->BitmapFormat);
  _iprintf(" Bitmap width %d x height %d\n", sblock->BitmapWidth, sblock->BitmapHeight);
  if(sblock->BitmapFormat == 3)
...
{
  struct SWF_DEFINEMORPHSHAPE *sblock = (struct SWF_DEFINEMORPHSHAPE *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
...
{
  struct SWF_DEFINEMORPHSHAPE2 *sblock = (struct SWF_DEFINEMORPHSHAPE2 *)pblock;;
  _iprintf(" CharacterID: %d\n", sblock->CharacterID);
  outputSWF_RECT(&(sblock->StartBounds));
  outputSWF_RECT(&(sblock->EndBounds));
...
{
  struct SWF_DEFINESHAPE *sblock = (struct SWF_DEFINESHAPE *)pblock;;
...
{
  struct SWF_DEFINESHAPE2 *sblock = (struct SWF_DEFINESHAPE2 *)pblock;;
...
{
  struct SWF_DEFINESHAPE3 *sblock = (struct SWF_DEFINESHAPE3 *)pblock;;
...
{
  struct SWF_DEFINESHAPE4 *sblock = (struct SWF_DEFINESHAPE4 *)pblock;;
...
{
 struct SWF_DEFINESOUND *sblock = (struct SWF_DEFINESOUND *)pblock;;
 _iprintf(" CharacterID: %d\n", sblock->SoundId);
...
{
  int i;
  struct SWF_DEFINESPRITE *sblock = (struct SWF_DEFINESPRITE *)pblock;;
...
# 1540 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
                                                        ((void *)0)
# 1540 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                                                            );
  }
  --INDENT;
...
{
  int i;
  struct SWF_DEFINETEXT *sblock = (struct SWF_DEFINETEXT *)pblock;;
...
{
  int i;
  struct SWF_DEFINETEXT2 *sblock = (struct SWF_DEFINETEXT2 *)pblock;;
...
{
  struct SWF_DEFINEVIDEOSTREAM *sblock = (struct SWF_DEFINEVIDEOSTREAM *)pblock;;
  _iprintf("  CharacterID: %d\n", sblock->CharacterID);
...
outputSWF_DOACTION (SWF_Parserstruct * pblock)
{
 ...
 struct SWF_DOACTION *sblock = (struct SWF_DOACTION *)pblock;;
...
{
  struct SWF_ENABLEDEBUGGER *sblock = (struct SWF_ENABLEDEBUGGER *)pblock;;
  _iprintf(" Password: %s\n", sblock->Password);
}
...
{
  struct SWF_ENABLEDEBUGGER2 *sblock = (struct SWF_ENABLEDEBUGGER2 *)pblock;;
  _iprintf(" Password: %s\n", sblock->Password);
}
...
{
  int i;
  struct SWF_EXPORTASSETS *sblock = (struct SWF_EXPORTASSETS *)pblock;;
...
{
  struct SWF_FRAMELABEL *sblock = (struct SWF_FRAMELABEL *)pblock;;
...
{
  int i;
  struct SWF_IMPORTASSETS *sblock = (struct SWF_IMPORTASSETS *)pblock;;
...
{
  int i;
  struct SWF_IMPORTASSETS2 *sblock = (struct SWF_IMPORTASSETS2 *)pblock;;
...
{
  struct SWF_NAMECHARACTER *sblock = (struct SWF_NAMECHARACTER *)pblock;;
  _iprintf("  Id: %d\n", sblock->Id);
  _iprintf("  Name: %s\n", sblock->Name);
}
...
{
  struct SWF_PLACEOBJECT2 *sblock = (struct SWF_PLACEOBJECT2 *)pblock;;
# 1795 "/doner/libming/libming-80ebea9/util/outputtxt.c"
...
{
  struct SWF_PLACEOBJECT3 *sblock = (struct SWF_PLACEOBJECT3 *)pblock;;
# 1848 "/doner/libming/libming-80ebea9/util/outputtxt.c"
  if( sblock->PlaceFlagHasClipActions )
 outputSWF_CLIPACTIONS (&(sblock->ClipActions));
...
{
  struct SWF_PROTECT *sblock = (struct SWF_PROTECT *)pblock;;
...
{
  struct SWF_REMOVEOBJECT *sblock = (struct SWF_REMOVEOBJECT *)pblock;;
...
{
  struct SWF_REMOVEOBJECT2 *sblock = (struct SWF_REMOVEOBJECT2 *)pblock;;
  _iprintf(" Depth: %d\n", sblock->Depth);
...
{
  struct SWF_SERIALNUMBER *sblock = (struct SWF_SERIALNUMBER *)pblock;;
...
{
  struct SWF_SETBACKGROUNDCOLOR *sblock = (struct SWF_SETBACKGROUNDCOLOR *)pblock;;
...
{
  struct SWF_SOUNDSTREAMBLOCK *sblock = (struct SWF_SOUNDSTREAMBLOCK *)pblock;;
...
outputSWF_SOUNDSTREAMHEAD (SWF_Parserstruct * pblock)
{
  ...
  struct SWF_SOUNDSTREAMHEAD *sblock = (struct SWF_SOUNDSTREAMHEAD *)pblock;;
...
{
  char *tmp;
  struct SWF_SOUNDSTREAMHEAD2 *sblock = (struct SWF_SOUNDSTREAMHEAD2 *)pblock;;
  switch(sblock->PlaybackSoundRate)
  {
    case 0: tmp = "5.5 kHz"; break;
    case 1: tmp = "11 kHz"; break;
...
{
  struct SWF_STARTSOUND *sblock = (struct SWF_STARTSOUND *)pblock;;
  _iprintf(" SoundId %d\n", sblock->SoundId);
...
{
  struct SWF_STARTSOUND2 *sblock = (struct SWF_STARTSOUND2 *)pblock;;
...
outputSWF_INITACTION (SWF_Parserstruct * pblock)
{
 ...
 struct SWF_INITACTION *sblock = (struct SWF_INITACTION *)pblock;;
...
{
  struct SWF_VIDEOFRAME *sblock = (struct SWF_VIDEOFRAME *)pblock;;
  _iprintf("  StreamID %i\n", sblock->StreamID);
  _iprintf("  FrameNum %i\n", sblock->FrameNum);
}
...
{
  struct SWF_REFLEX *sblock = (struct SWF_REFLEX *)pblock;;
...
{
  struct SWF_FILEATTRIBUTES *sblock = (struct SWF_FILEATTRIBUTES *)pblock;;
...
{
  struct SWF_METADATA *sblock = (struct SWF_METADATA *)pblock;;
...
{
  struct SWF_SCRIPTLIMITS *sblock = (struct SWF_SCRIPTLIMITS *)pblock;;
...
{
  struct SWF_DEFINESCALINGGRID *sblock = (struct SWF_DEFINESCALINGGRID *)pblock;;
  _iprintf(" CharacterId %d\n", sblock->CharacterId);
...
{
  struct SWF_SETTABINDEX *sblock = (struct SWF_SETTABINDEX *)pblock;;
  _iprintf(" Depth: %d\n", sblock->Depth);
  _iprintf(" TabIndex: %d\n", sblock->TabIndex);
}
...
{
  struct SWF_DOABC *sblock = (struct SWF_DOABC *)pblock;;
...
{
  int count, i;
  struct SWF_SYMBOLCLASS *sblock = (struct SWF_SYMBOLCLASS *)pblock;;
...
{
  int i;
  struct SWF_DEFINESCENEANDFRAMEDATA *sblock = (struct SWF_DEFINESCENEANDFRAMEDATA *)pblock;;
...
{
  int i;
  struct SWF_DEBUGID *sblock = (struct SWF_DEBUGID *)pblock;;
  _iprintf(" UUID: ");
...
{
  struct SWF_UNKNOWNBLOCK *sblock = (struct SWF_UNKNOWNBLOCK *)pblock;;
  if(sblock->Data == 
# 2868 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
                    ((void *)0)
# 2868 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                        )
 return;
...
outputBlock (int type, SWF_Parserstruct * blockp, FILE* stream)
{
  ...
  if(blockp == 
# 2907 "/doner/libming/libming-80ebea9/util/outputtxt.c" 3 4
              ((void *)0)
# 2907 "/doner/libming/libming-80ebea9/util/outputtxt.c"
                  )
 return;
      ...
      if (outputs[i].type == type)
 {
  ...
  do { if(_SWF_error) _SWF_error(("printing type:  %d (%s) is not implemented"), type, blockName(type)); } while(0);
  return;
}
