# 1 "/doner/libming/libming-80ebea9/util/read.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/util/read.c"
# 23 "/doner/libming/libming-80ebea9/util/read.c"
...
# 24 "/doner/libming/libming-80ebea9/util/read.c" 2
...
# 25 "/doner/libming/libming-80ebea9/util/read.c" 2
...
# 26 "/doner/libming/libming-80ebea9/util/read.c" 2
...
# 27 "/doner/libming/libming-80ebea9/util/read.c" 2
...
# 72 "/doner/libming/libming-80ebea9/util/parser.h" 2
...
# 29 "/doner/libming/libming-80ebea9/util/read.c" 2
...
int readBits(FILE *f, int number)
{
  ...
  if(number > bufbits)
  {
    ...
    while(number>8)
    {
      tmp_char = fgetc(f);
      if (tmp_char == 
# 63 "/doner/libming/libming-80ebea9/util/read.c" 3 4
                     (-1)
# 63 "/doner/libming/libming-80ebea9/util/read.c"
                        )
      {

        fprintf(
# 66 "/doner/libming/libming-80ebea9/util/read.c" 3 4
               stderr
# 66 "/doner/libming/libming-80ebea9/util/read.c"
                     , "truncated file\n");
        exit(-1);
      }
    ...
    tmp_char = fgetc(f);
    if (tmp_char == 
# 78 "/doner/libming/libming-80ebea9/util/read.c" 3 4
                   (-1)
# 78 "/doner/libming/libming-80ebea9/util/read.c"
                      )
    {

      fprintf(
# 81 "/doner/libming/libming-80ebea9/util/read.c" 3 4
             stderr
# 81 "/doner/libming/libming-80ebea9/util/read.c"
                   , "truncated file\n");
      exit(-1);
    }
...
int readUInt8(FILE *f)
{
  ...
  if (tmp_char == 
# 131 "/doner/libming/libming-80ebea9/util/read.c" 3 4
                 (-1)
# 131 "/doner/libming/libming-80ebea9/util/read.c"
                    )
  {

    fprintf(
# 134 "/doner/libming/libming-80ebea9/util/read.c" 3 4
           stderr
# 134 "/doner/libming/libming-80ebea9/util/read.c"
                 , "truncated file\n");
    exit(-1);
  }
...
# 196 "/doner/libming/libming-80ebea9/util/read.c"
  return data.d;
}
...
void _dumpBytes(FILE *f, int length, int restore)
{
 ...
 putchar('.');
  ...
  if(restore) {
 fseek(f,offset, 
# 435 "/doner/libming/libming-80ebea9/util/read.c" 3 4
                0
# 435 "/doner/libming/libming-80ebea9/util/read.c"
                        );
   fileOffset = offset;
  }
}
