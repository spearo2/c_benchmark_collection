# 1 "/doner/libming/libming-80ebea9/util/listfdb.c"
...
# 2 "/doner/libming/libming-80ebea9/util/listfdb.c" 2
...
# 3 "/doner/libming/libming-80ebea9/util/listfdb.c" 2
...
# 5 "/doner/libming/libming-80ebea9/util/listfdb.c" 2
...
# 6 "/doner/libming/libming-80ebea9/util/listfdb.c" 2
...
int readBits(FILE *f, int number)
{
  ...
  if(number > bufbits)
  {
    ...
    while(number>8)
    {
      ...
      {
        fprintf(
# 76 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
               stderr
# 76 "/doner/libming/libming-80ebea9/util/listfdb.c"
                     , "truncated file\n");
        exit(-1);
      }
    ...
    {
      fprintf(
# 88 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
             stderr
# 88 "/doner/libming/libming-80ebea9/util/listfdb.c"
                   , "truncated file\n");
      exit(-1);
    }
...
int readUInt8(FILE *f)
{
  ...
  if (tmp_char == 
# 125 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
                 (-1)
# 125 "/doner/libming/libming-80ebea9/util/listfdb.c"
                    )
  {

    fprintf(
# 128 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
           stderr
# 128 "/doner/libming/libming-80ebea9/util/listfdb.c"
                 , "truncated file\n");
    exit(-1);
  }
...
void dumpBytes(FILE *f, int length)
{
  ...
  break;
    ...
    if(j==length)
    {
      for(k=i+1; k<16; ++k)
 {fputs("   ",
# 215 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
stdout
# 215 "/doner/libming/libming-80ebea9/util/listfdb.c"
);};
    ...
    {fputs("   ",
# 222 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
   stdout
# 222 "/doner/libming/libming-80ebea9/util/listfdb.c"
   );};
...
int printShapeRec(FILE *f, int *lineBits, int *fillBits, int shapeType)
{
  ...
  if(type==0)
  {
    ...
    {
      {fputs(indent(),
# 305 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
     stdout
# 305 "/doner/libming/libming-80ebea9/util/listfdb.c"
     );fputs("EndShape",
# 305 "/doner/libming/libming-80ebea9/util/listfdb.c" 3 4
     stdout
# 305 "/doner/libming/libming-80ebea9/util/listfdb.c"
...
# 369 "/doner/libming/libming-80ebea9/util/listfdb.c"
void printDefineFont2(FILE *f)
{
  ...
  if(flags & (1<<7))
  {
    ...
    {
      code1 = (flags & (1<<2)) ? readUInt16(f) : readUInt8(f);
      code2 = (flags & (1<<2)) ? readUInt16(f) : readUInt8(f);
...
int main(int argc, char *argv[])
{
  ...
  if(!(f = fopen(argv[1],"rb")))
    {puts("Sorry, can't seem to read that file.\n"); exit(1);};

  if(!(readUInt8(f)=='f' && readUInt8(f)=='d' && readUInt8(f)=='b'))
    {puts("Doesn't look like an fdb file to me..\n"); exit(1);};
