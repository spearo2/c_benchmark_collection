# 1 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
# 22 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
...
# 23 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 24 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2

# 1 "/doner/libming/libming-80ebea9/src/blocks/outputblock.h" 1
# 32 "/doner/libming/libming-80ebea9/src/blocks/outputblock.h"
# 1 "../../src/ming.h" 1
# 56 "../../src/ming.h"
...
# 33 "/doner/libming/libming-80ebea9/src/blocks/outputblock.h" 2
...
# 26 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 27 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 28 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 29 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 30 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 31 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
# 33 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 2
...
soundDataSize(SWFSound sound)
{
 ...
 else if ((sound->flags&0xf0) == (1<<4))
 {
  ...
  if ( !((sound->flags & 0x02) == (1<<1)) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "(sound->flags & 0x02) == (1<<1)", "/doner/libming/libming-80ebea9/src/blocks/sound.c",72); } while(0);;
...
# 102 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 3 4
                                  0
# 102 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
                                          );
  return samples;
 }
 else
...
# 177 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
void
...
# 217 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
SWFSound
...
newSWFSound_fromInput(SWFInput input, byte flags)
{
 ...
 if((sound->flags&0xf0) == (2<<4))
 {
  if(getMP3Flags(input, &sound->flags) < 0)
  {
   free(sound);
   return 
# 258 "/doner/libming/libming-80ebea9/src/blocks/sound.c" 3 4
         ((void *)0)
# 258 "/doner/libming/libming-80ebea9/src/blocks/sound.c"
             ;
  }
 }
 sound->soundStream = 0;
