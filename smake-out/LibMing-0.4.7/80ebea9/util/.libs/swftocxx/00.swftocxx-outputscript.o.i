# 1 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/util/outputscript.c"
# 21 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 22 "/doner/libming/libming-80ebea9/util/outputscript.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 40 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 3 4
typedef __builtin_va_list __gnuc_va_list;
# 99 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 23 "/doner/libming/libming-80ebea9/util/outputscript.c" 2
...
# 24 "/doner/libming/libming-80ebea9/util/outputscript.c" 2
...
# 26 "/doner/libming/libming-80ebea9/util/outputscript.c" 2
# 1 "/doner/libming/libming-80ebea9/util/decompile.h" 1
# 28 "/doner/libming/libming-80ebea9/util/decompile.h"
...
# 29 "/doner/libming/libming-80ebea9/util/decompile.h" 2
...
# 27 "/doner/libming/libming-80ebea9/util/outputscript.c" 2
...
# 28 "/doner/libming/libming-80ebea9/util/outputscript.c" 2
...
# 29 "/doner/libming/libming-80ebea9/util/outputscript.c" 2

extern char *swftargetfile;
# 115 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 249 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
__builtin_va_start(
# 249 "/doner/libming/libming-80ebea9/util/outputscript.c"
ap
# 249 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
,
# 249 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
for(i=0;i<nparam;i++) {
 fmt = 
# 252 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
      __builtin_va_arg(
# 252 "/doner/libming/libming-80ebea9/util/outputscript.c"
      ap
# 252 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
      ,
# 252 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 252 "/doner/libming/libming-80ebea9/util/outputscript.c"
                       ;
 p = 
# 253 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
    __builtin_va_arg(
# 253 "/doner/libming/libming-80ebea9/util/outputscript.c"
    ap
# 253 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
    ,
# 253 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 259 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
__builtin_va_end(
# 259 "/doner/libming/libming-80ebea9/util/outputscript.c"
ap
# 259 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
)
# 259 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
outputSWF_MATRIX (SWF_MATRIX * matrix, char *fname)
{
 ...
 angle = 90;
    ...
    {
      angle = atan (c / a) * 180 / 
# 330 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                  3.14159265358979323846
# 330 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                      ;
...
# 451 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                                                              ((void *)0)
# 451 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                                                  , "Action"),
...
# 479 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                            ((void *)0)
# 479 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                ;
...
# 601 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                    ((void *)0)
# 601 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                        )
      outputSWF_LINESTYLE (&(linestylearray->LineStyles[i]), parentname, i);
    else if(linestylearray->LineStyles2 != 
# 603 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                          ((void *)0)
# 603 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                              )
...
# 657 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                                                               ((void *)0)
# 657 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                                                   );
      }
...
# 875 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                                                              ((void *)0)
# 875 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                                                  , "Action"),
...
# 974 "/doner/libming/libming-80ebea9/util/outputscript.c"
  if (sblock->AutoSize)
    {
      if (notFirst)
 printf (" | ");
  ...
  if (sblock->HasFont)
    {
      ...
      while (fi)
      {
       ...
       if (fi->fontcodeID==sblock->FontID)
       {
        ...
        {
# 1035 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
static void saveFontInfo(int id,int numglyph,int *codetable,UI16 *ct16)
{
  ...
  {
   if (
# 1125 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
      ((void *)0) 
# 1125 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 1151 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                                                  ((void *)0)
# 1151 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                                      );
  }
  else
  {
...
# 1171 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                                ((void *)0)
# 1171 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                    ,sblock->CodeTable);
  }
  else
  {
...
# 1187 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                            ((void *)0)
# 1187 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                ,sblock->CodeTable);
}
...
outputSWF_DEFINEFONTINFO2(SWF_Parserstruct * pblock)
{
  ...
  printf ("%s(\"%s.fdb\" );\n", newobj (fname, "Font"), sblock->FontName);
  saveFontInfo(sblock->FontID,sblock->nGlyph,
# 1198 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                            ((void *)0)
# 1198 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                ,sblock->CodeTable);
}
...
# 1335 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                                                     ((void *)0)
# 1335 "/doner/libming/libming-80ebea9/util/outputscript.c"
                                                         );
  }
  spritenum = 0;
...
outputSWF_DOACTION (SWF_Parserstruct * pblock)
{
  ...
  printf ("%s(%s(\"%s\") );\n", methodcall (spritenum?spritename:"m", "add"),
   newobj (
# 1492 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
          ((void *)0)
# 1492 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
outputSWF_PROTECT (SWF_Parserstruct * pblock)
{
  ...
  if( sblock->Password == 
# 1683 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                         ((void *)0) 
# 1683 "/doner/libming/libming-80ebea9/util/outputscript.c"
                              ) {
   printf ("%s();\n",
...
outputSWF_INITACTION (SWF_Parserstruct * pblock)
{
  ...
  printf ("%s(%s(",
          methodcall (spritenum?spritename:"m", "add"),
          newobj (
# 1793 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                 ((void *)0)
# 1793 "/doner/libming/libming-80ebea9/util/outputscript.c"
                     , "InitAction"));
  ...
  printf ("%s(\"%s\")));\n",
          newobj (
# 1798 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                 ((void *)0)
# 1798 "/doner/libming/libming-80ebea9/util/outputscript.c"
                     , "Action"),
...
# 1942 "/doner/libming/libming-80ebea9/util/outputscript.c"
...
# 1960 "/doner/libming/libming-80ebea9/util/outputscript.c"
  if( npending )
...
{
 if( swftargetfile == 
# 1980 "/doner/libming/libming-80ebea9/util/outputscript.c" 3 4
                     ((void *)0) 
# 1980 "/doner/libming/libming-80ebea9/util/outputscript.c"
                          ) {
# 1990 "/doner/libming/libming-80ebea9/util/outputscript.c"
 if( m->version > 5 ) {
