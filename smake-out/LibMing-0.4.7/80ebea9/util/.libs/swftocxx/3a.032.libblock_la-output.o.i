# 1 "/doner/libming/libming-80ebea9/src/blocks/output.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/src/blocks/output.c"
# 23 "/doner/libming/libming-80ebea9/src/blocks/output.c"
...
# 24 "/doner/libming/libming-80ebea9/src/blocks/output.c" 2
...
# 25 "/doner/libming/libming-80ebea9/src/blocks/output.c" 2
...
# 26 "/doner/libming/libming-80ebea9/src/blocks/output.c" 2


# 1 "/doner/libming/libming-80ebea9/src/blocks/output.h" 1
# 32 "/doner/libming/libming-80ebea9/src/blocks/output.h"
# 1 "../../src/ming.h" 1
# 56 "../../src/ming.h"
...
# 33 "/doner/libming/libming-80ebea9/src/blocks/output.h" 2
...
# 29 "/doner/libming/libming-80ebea9/src/blocks/output.c" 2
...
# 30 "/doner/libming/libming-80ebea9/src/blocks/output.c" 2
...
# 76 "../../src/libming.h" 2
# 32 "/doner/libming/libming-80ebea9/src/blocks/output.c" 2


# 33 "/doner/libming/libming-80ebea9/src/blocks/output.c"
struct SWFOutput_s
{
 SWFOutput next;
...
newSWFOutput()
{
 ...
 if (
# 51 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
    ((void *)0) 
# 51 "/doner/libming/libming-80ebea9/src/blocks/output.c"
         == out)
  return 
# 52 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
        ((void *)0)
# 52 "/doner/libming/libming-80ebea9/src/blocks/output.c"
            ;

 out->next = 
# 54 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
            ((void *)0)
# 54 "/doner/libming/libming-80ebea9/src/blocks/output.c"
                ;
 out->buffer = (byte*) malloc(1024);


 if (
# 58 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
    ((void *)0) 
# 58 "/doner/libming/libming-80ebea9/src/blocks/output.c"
         == out->buffer)
 {
  free(out);
  return 
# 61 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
        ((void *)0)
# 61 "/doner/libming/libming-80ebea9/src/blocks/output.c"
            ;
 }
...
newSizedSWFOutput(int size)
{
 ...
 if (
# 82 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
    ((void *)0) 
# 82 "/doner/libming/libming-80ebea9/src/blocks/output.c"
         == out)
  return 
# 83 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
        ((void *)0)
# 83 "/doner/libming/libming-80ebea9/src/blocks/output.c"
            ;

 out->next = 
# 85 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
            ((void *)0)
# 85 "/doner/libming/libming-80ebea9/src/blocks/output.c"
                ;
 out->buffer = (byte*) malloc(size+1);


 if (
# 89 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
    ((void *)0) 
# 89 "/doner/libming/libming-80ebea9/src/blocks/output.c"
         == out->buffer)
 {
  free(out);
  return 
# 92 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
        ((void *)0)
# 92 "/doner/libming/libming-80ebea9/src/blocks/output.c"
            ;
 }
...
SWFOutput_writeToMethod(SWFOutput out, SWFByteOutputMethod method, void *data)
{
 ...
 while ( o != 
# 113 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
             ((void *)0) 
# 113 "/doner/libming/libming-80ebea9/src/blocks/output.c"
                  )
 {
  buffer = o->buffer;
  l = o->pos - buffer;
...
destroySWFOutput(SWFOutput out)
{
 ...
 while(o != 
# 131 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
           ((void *)0)
# 131 "/doner/libming/libming-80ebea9/src/blocks/output.c"
               )
 {
  next = o->next;
  free(o->buffer);
...
SWFOutput_getLength(SWFOutput out)
{
 ...
 while ( out!=
# 163 "/doner/libming/libming-80ebea9/src/blocks/output.c" 3 4
             ((void *)0) 
# 163 "/doner/libming/libming-80ebea9/src/blocks/output.c"
                  )
 {
...
{ if ( !(size < out->buffersize) ) do { if(_SWF_error) _SWF_error(("failed assertion '%s' in %s:%i\n"), "size < out->buffersize", "/doner/libming/libming-80ebea9/src/blocks/output.c",294); } while(0);;
...
SWFOutput_writeDouble(SWFOutput out, double d)
{
 ...
 SWFOutput_writeUInt8(out, p[2]);
 SWFOutput_writeUInt8(out, p[3]);
# 472 "/doner/libming/libming-80ebea9/src/blocks/output.c"
}
# 492 "/doner/libming/libming-80ebea9/src/blocks/output.c"
void
