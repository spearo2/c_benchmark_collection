# 1 "/doner/libming/libming-80ebea9/util/parser.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libming/libming-80ebea9/util/parser.c"
# 21 "/doner/libming/libming-80ebea9/util/parser.c"
...
# 22 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 23 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 24 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 25 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 26 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 27 "/doner/libming/libming-80ebea9/util/parser.c" 2
# 1 "../src/abctypes.h" 1
# 23 "../src/abctypes.h"
typedef enum {
 __add = 0xa0,
...
# 28 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 29 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 30 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
# 31 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
void dumpBuffer(unsigned char *buf, int length);
# 32 "/doner/libming/libming-80ebea9/util/parser.c" 2
# 1 "../src/blocks/error.h" 1
# 33 "/doner/libming/libming-80ebea9/util/parser.c" 2
...
void silentSkipBytes(FILE *f, int length);
# 56 "/doner/libming/libming-80ebea9/util/parser.c"
void
...
parseSWF_TEXTRECORD (FILE * f, struct SWF_TEXTRECORD *brec, int glyphbits, int advancebits, int level)
{
  ...
  if (glyph_count == 
# 311 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                    (-1)
# 311 "/doner/libming/libming-80ebea9/util/parser.c"
                       ) {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
    return 0;
  } else {
...
parseSWF_FOCALGRADIENT (FILE * f, struct SWF_FOCALGRADIENT *gradient, int level)
{
  ...
  if(gradient->NumGradients > 15) {
   fprintf(
# 441 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
          stderr
# 441 "/doner/libming/libming-80ebea9/util/parser.c"
                , "%d gradients in SWF_FOCALGRADIENT, expected a max of 15\n", gradient->NumGradients );
...
parseSWF_GRADIENT (FILE * f, struct SWF_GRADIENT *gradient, int level)
{
  ...
  if((gradient->NumGradients > 8 && level < 4) || (gradient->NumGradients > 15 && level == 4)) {
   fprintf(
# 459 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
          stderr
# 459 "/doner/libming/libming-80ebea9/util/parser.c"
                , "%d gradients in SWF_GRADiENT, expected a max of %d\n", gradient->NumGradients, level<4 ? 8 : 15 );
...
parseSWF_LINESTYLEARRAY (FILE * f, SWF_LINESTYLEARRAY * linestyle, int level)
{
  ...
  if (count == 
# 667 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
              (-1)
# 667 "/doner/libming/libming-80ebea9/util/parser.c"
                 )
  {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
  }
...
# 676 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                           ((void *)0)
# 676 "/doner/libming/libming-80ebea9/util/parser.c"
                               ;
  ...
  else
  {
    ...
    linestyle->LineStyles2 = 
# 684 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                            ((void *)0)
# 684 "/doner/libming/libming-80ebea9/util/parser.c"
                                ;
  }
                          ...
                          int version)
{
  ...
  if (count == 
# 745 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
              (-1)
# 745 "/doner/libming/libming-80ebea9/util/parser.c"
                 )
  {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
  }
...
parseSWF_MORPHGRADIENT (FILE * f, struct SWF_MORPHGRADIENT *gradient)
{
  ...
  if( gradient->NumGradients > 8 ) {
   fprintf(
# 782 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
          stderr
# 782 "/doner/libming/libming-80ebea9/util/parser.c"
                , "%d gradients in SWF_MORPHGRADiENT, expected a max of 8", gradient->NumGradients);
...
# 901 "/doner/libming/libming-80ebea9/util/parser.c"
int
parseSWF_ACTIONRECORD(FILE * f, int *thisactionp, SWF_ACTION *actions)
{
 ...
 case SWFACTION_LOGICALNOT:
  ...
  fprintf(
# 1017 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
         stderr
# 1017 "/doner/libming/libming-80ebea9/util/parser.c"
               ,"NOT param: %d\n", act->Boolean );
  break;
  }
 ...
 case SWFACTION_CONSTANTPOOL:
  ...
  count = readUInt16(f);
  if (count == 
# 1118 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
              (-1)
# 1118 "/doner/libming/libming-80ebea9/util/parser.c"
                 )
                {
                  do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
                }
 ...
 case SWFACTION_DEFINEFUNCTION:
  ...
  act->FunctionName = readString(f);
                ...
                if (num_params == 
# 1136 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                                 (-1)
# 1136 "/doner/libming/libming-80ebea9/util/parser.c"
                                    ) {
                  do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
                }
 ...
 case SWFACTION_DEFINEFUNCTION2:
  ...
  num_params = readUInt16(f);
  if (num_params == 
# 1194 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                   (-1)
# 1194 "/doner/libming/libming-80ebea9/util/parser.c"
                      ) {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
  }
  act->NumParams = num_params;
...
parseSWF_GRADIENTFILTER(FILE *f, SWF_GRADIENTFILTER *filter)
{
 ...
 num_colors = readUInt8(f);
        if (num_colors == 
# 1346 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                         (-1)
# 1346 "/doner/libming/libming-80ebea9/util/parser.c"
                            ) {
          do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
        }
...
parseSWF_CONVOLUTIONFILTER(FILE *f, SWF_CONVOLUTIONFILTER *filter)
{
 ...
 y = readUInt8(f);
        if (x == 
# 1379 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                (-1) 
# 1379 "/doner/libming/libming-80ebea9/util/parser.c"
                    || y == 
# 1379 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                            (-1)
# 1379 "/doner/libming/libming-80ebea9/util/parser.c"
...
parseSWF_FILTERLIST(FILE *f, SWF_FILTERLIST *list)
{
 ...
 number_of_filters = readUInt8(f);
        if (number_of_filters == 
# 1448 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                                (-1)
# 1448 "/doner/libming/libming-80ebea9/util/parser.c"
                                   ) {
...
parseSWF_DEFINEFONT (FILE * f, int length)
{
  ...
  if (firstOffset == 
# 1707 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                    (-1)
# 1707 "/doner/libming/libming-80ebea9/util/parser.c"
                       ) {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
  }
  ...
  parserrec->OffsetTable = (UI16 *)malloc(
# 1714 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                                         (((
# 1714 "/doner/libming/libming-80ebea9/util/parser.c"
                                         1
# 1714 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                                         )>(
# 1714 "/doner/libming/libming-80ebea9/util/parser.c"
...
parseSWF_DEFINEFONT2 (FILE * f, int length)
{
  ...
  if (num_glyphs == 
# 1752 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                   (-1)
# 1752 "/doner/libming/libming-80ebea9/util/parser.c"
                      ) {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
  }
      ...
      for (i = 0; i < parserrec->NumGlyphs; i++)
 {
  ...
  if( parserrec->FontFlagsHasLayout ) {
   ...
   kerning_count = readUInt16(f);
          if (kerning_count == 
# 1844 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                              (-1)
# 1844 "/doner/libming/libming-80ebea9/util/parser.c"
                                 ) {
            do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
          }
...
parseSWF_DEFINEFONT3 (FILE * f, int length)
{
  ...
  num_glyphs = readUInt16 (f);
  if (num_glyphs == 
# 1888 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                   (-1)
# 1888 "/doner/libming/libming-80ebea9/util/parser.c"
                      ) {
    do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
  }
  parserrec->NumGlyphs = num_glyphs;
      ...
      for (i = 0; i < parserrec->NumGlyphs; i++)
 {
  ...
  if( parserrec->FontFlagsHasLayout ) {
   ...
   kerning_count = readUInt16(f);
          if (kerning_count == 
# 1980 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                              (-1)
# 1980 "/doner/libming/libming-80ebea9/util/parser.c"
                                 ) {
            do { if(_SWF_error) _SWF_error(("unexpected end of file")); } while(0);
          }
   parserrec->KerningCount = kerning_count;
...
parseSWF_DEFINEFONTINFO (FILE * f, int length)
{
  ...
  if (parserrec->nGlyph < 0 || parserrec->nGlyph > (0x7fffffff / sizeof(UI16))) {
...
parseSWF_ZONERECORD(FILE *f, struct SWF_ZONERECORD *table)
{
  ...
  if (num_zone_data == 
# 2094 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                      (-1)
# 2094 "/doner/libming/libming-80ebea9/util/parser.c"
                         ) {
...
parseSWF_DEFINESPRITE (FILE * f, int length)
{
  ...
  parserrec->tagTypes = 
# 2291 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                       ((void *)0)
# 2291 "/doner/libming/libming-80ebea9/util/parser.c"
                           ;
  parserrec->Tags = 
# 2292 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                   ((void *)0)
# 2292 "/doner/libming/libming-80ebea9/util/parser.c"
                       ;
  while( fileOffset < start+length ) {
   ...
   if( ftell(f) != nextFrame ) {
     ...
     fseek(f,blockstart,
# 2319 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                       0
# 2319 "/doner/libming/libming-80ebea9/util/parser.c"
                               );
...
parseSWF_PROTECT (FILE * f, int length)
{
  ...
  if( length != 0 ) {
   ...
   parserrec->Password = 
# 2757 "/doner/libming/libming-80ebea9/util/parser.c" 3 4
                        ((void *)0)
# 2757 "/doner/libming/libming-80ebea9/util/parser.c"
                            ;
  }
...
void parseABC_CONSTANT_POOL(struct ABC_CONSTANT_POOL *cpool, FILE *f)
{
  ...
  if (cpool->IntCount > 0x7fffffff / sizeof(S32))
  ...
  if (cpool->UIntCount > 0x7fffffff / sizeof(U32))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->DoubleCount > 0x7fffffff / sizeof(DOUBLE))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->StringCount > 0x7fffffff / sizeof(struct ABC_STRING_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->NamespaceCount > 0x7fffffff / sizeof(struct ABC_NS_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->NamespaceSetCount > 0x7fffffff / sizeof(struct ABC_NS_SET_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
  ...
  if (cpool->MultinameCount > 0x7fffffff / sizeof(struct ABC_MULTINAME_INFO))
    do { if(_SWF_error) _SWF_error(("value is too big")); } while(0);
...
void parseABC_OPTION_INFO(struct ABC_OPTION_INFO *oinfo, FILE *f)
{
  ...
  if (oinfo->OptionCount > 0x7fffffff / sizeof(struct ABC_OPTION_INFO))
...
void parseABC_METHOD_INFO(struct ABC_METHOD_INFO *method, FILE *f)
{
  ...
  if (method->ParamCount > 0x7fffffff / sizeof(U30))
...
void parseABC_METADATA_INFO(struct ABC_METADATA_INFO *meta, FILE *f)
{
  ...
  if (meta->ItemCount > 0x7fffffff / sizeof(struct ABC_ITEM_INFO))
...
void parseABC_TRAITS_INFO(struct ABC_TRAITS_INFO *trait, FILE *f)
{
  ...
  if(trait->Attr & 0x04)
  {
    ...
    if (trait->MetadataCount > 0x7fffffff / sizeof(U30)) {
...
void parseABC_CLASS_INFO(struct ABC_CLASS_INFO *cinfo, FILE *f)
{
  ...
  if (cinfo->TraitCount > 0x7fffffff / sizeof(struct ABC_TRAITS_INFO))
...
void parseABC_SCRIPT_INFO(struct ABC_SCRIPT_INFO *sinfo, FILE *f)
{
  ...
  if (sinfo->TraitCount > 0x7fffffff / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_INSTANCE_INFO(struct ABC_INSTANCE_INFO *inst, FILE *f)
{
  ...
  if (inst->InterfaceCount > 0x7fffffff / sizeof(U30))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (inst->TraitCount > 0x7fffffff / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_METHOD_BODY_INFO(struct ABC_METHOD_BODY_INFO *minfo, FILE *f)
{
  ...
  if (minfo->ExceptionCount > 0x7fffffff / sizeof(struct ABC_EXCEPTION_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (minfo->TraitCount > 0x7fffffff / sizeof(struct ABC_TRAITS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
void parseABC_FILE(struct ABC_FILE *abcFile, FILE *f)
{
  ...
  if (abcFile->MethodCount > 0x7fffffff / sizeof(struct ABC_METHOD_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->MetadataCount > 0x7fffffff / sizeof(struct ABC_METADATA_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->ClassCount > 0x7fffffff / sizeof(struct ABC_INSTANCE_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  size = abcFile->ClassCount * sizeof(struct ABC_INSTANCE_INFO);
  abcFile->Instances = malloc(size);
  if (abcFile->ClassCount > 0x7fffffff / sizeof(struct ABC_CLASS_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->ScriptCount > 0x7fffffff / sizeof(struct ABC_SCRIPT_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (abcFile->MethodBodyCount > 0x7fffffff / sizeof(struct ABC_METHOD_BODY_INFO))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
parseSWF_SYMBOLCLASS (FILE *f, int length)
{
  ...
  if (parserrec->SymbolCount > 0x7fffffff / sizeof(struct SWF_SYMBOLCLASS))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
...
parseSWF_DEFINESCENEANDFRAMEDATA(FILE *f, int length)
{
  ...
  if (parserrec->SceneCount > 0x7fffffff / sizeof(struct SCENE_DATA))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
  ...
  if (parserrec->FrameLabelCount > 0x7fffffff / sizeof(struct FRAME_DATA))
    do { if(_SWF_error) _SWF_error(("%s: value is too big, "), __FUNCTION__); } while(0);
