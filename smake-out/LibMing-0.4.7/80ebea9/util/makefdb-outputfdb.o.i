# 1 "/doner/libming/libming-80ebea9/util/outputfdb.c"
...
# 2 "/doner/libming/libming-80ebea9/util/outputfdb.c" 2
...
# 3 "/doner/libming/libming-80ebea9/util/outputfdb.c" 2
...
# 4 "/doner/libming/libming-80ebea9/util/outputfdb.c" 2
...
# 5 "/doner/libming/libming-80ebea9/util/outputfdb.c" 2
...
outputBlock (int type, SWF_Parserstruct * blockp, FILE* f)
{
 ...
 sprintf(name, "font%i.fdb", blockp->block.SWF_DEFINEFONT2.FontID);
   ...
   out=fopen(name,"wb");
 if ( out == 
# 40 "/doner/libming/libming-80ebea9/util/outputfdb.c" 3 4
            ((void *)0) 
# 40 "/doner/libming/libming-80ebea9/util/outputfdb.c"
                 )
 {
  perror("Failed");
  return;
 ...
 fseek(f, offset + skipBytes, 
# 55 "/doner/libming/libming-80ebea9/util/outputfdb.c" 3 4
                             0
# 55 "/doner/libming/libming-80ebea9/util/outputfdb.c"
                                     );
 length -= 2;

 printf("Writing font '%s' to file '%s' (%i bytes)... ",
  blockp->block.SWF_DEFINEFONT2.FontName, name, length+4);
 fflush(
# 60 "/doner/libming/libming-80ebea9/util/outputfdb.c" 3 4
       stdout
# 60 "/doner/libming/libming-80ebea9/util/outputfdb.c"
             );
 ...
 {
  fclose(out);
  do { if(_SWF_error) _SWF_error(("memory allocation error")); } while(0);
  return;
 }
