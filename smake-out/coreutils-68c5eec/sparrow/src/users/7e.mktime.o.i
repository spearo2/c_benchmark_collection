...
# 32 "<command-line>" 2
# 1 "/home/68c5eec/lib/mktime.c"
# 27 "/home/68c5eec/lib/mktime.c"
# 1 "./lib/config.h" 1
# 28 "/home/68c5eec/lib/mktime.c" 2
# 37 "/home/68c5eec/lib/mktime.c"
# 1 "./lib/time.h" 1
# 20 "./lib/time.h"
...
extern int _gl_cxxalias_dummy;
# 38 "/home/68c5eec/lib/mktime.c" 2
...
# 28 "./lib/limits.h" 2 3
# 40 "/home/68c5eec/lib/mktime.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdbool.h" 1 3 4
# 41 "/home/68c5eec/lib/mktime.c" 2
...
# 43 "/home/68c5eec/lib/mktime.c" 2
# 68 "/home/68c5eec/lib/mktime.c"
typedef long int long_int;



_Static_assert (0x7fffffff <= ((long_int) (! (! ((long_int) 0 < (long_int) -1)) ? (long_int) -1 : ((((long_int) 1 << ((sizeof (long_int) * 8) - 2)) - 1) * 2 + 1))) / 3 / 366 / 24 / 60 / 60, "verify (" "INT_MAX <= TYPE_MAXIMUM (long_int) / 3 / 366 / 24 / 60 / 60" ")");
# 84 "/home/68c5eec/lib/mktime.c"
static long_int
...
static long_int const mktime_min
  = (((! ((time_t) 0 < (time_t) -1)) && ((time_t) ~ ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << ((sizeof (time_t) * 8) - 2)) - 1) * 2 + 1)))) < ((long_int) ~ ((long_int) (! (! ((long_int) 0 < (long_int) -1)) ? (long_int) -1 : ((((long_int) 1 << ((sizeof (long_int) * 8) - 2)) - 1) * 2 + 1)))))
...
static 
# 109 "/home/68c5eec/lib/mktime.c" 3 4
      _Bool

# 110 "/home/68c5eec/lib/mktime.c"
...
# 143 "/home/68c5eec/lib/mktime.c"
# 1 "/home/68c5eec/lib/mktime-internal.h" 1
# 19 "/home/68c5eec/lib/mktime-internal.h"
# 1 "./lib/time.h" 1
# 20 "./lib/time.h"
       
# 21 "./lib/time.h" 3
# 20 "/home/68c5eec/lib/mktime-internal.h" 2
# 30 "/home/68c5eec/lib/mktime-internal.h"
...
time_t mktime_internal (struct tm *,
                        ...
                        mktime_offset_t *);
# 144 "/home/68c5eec/lib/mktime.c" 2




static 
# 148 "/home/68c5eec/lib/mktime.c" 3 4
      _Bool

# 149 "/home/68c5eec/lib/mktime.c"
isdst_differ (int a, int b)
{
  return (!a != !b) && (0 <= a) && (0 <= b);
}
# 163 "/home/68c5eec/lib/mktime.c"
static long_int
  ...
  if (tp)
    {
      ...
      if (! __builtin_add_overflow (t, d, &result))
 return result;
    }
  ...
  if (!r && *t)
    {
      ...
      while (
# 264 "/home/68c5eec/lib/mktime.c" 3 4
            1
# 264 "/home/68c5eec/lib/mktime.c"
                )
 {
     ...
     mktime_offset_t *offset)
{
 ...
 sec = 59;
  ...
  __builtin_sub_overflow (0, *offset, &negative_offset_guess);
  t0 = ydhms_diff (year, yday, hour, min, sec,
     1970 - 1900, 0, 0, 0, negative_offset_guess);
...
# 402 "/home/68c5eec/lib/mktime.c"
 ...
 offset_found:
  ...
  __builtin_sub_overflow (t, t0, &dt);
  __builtin_sub_overflow (dt, negative_offset_guess, offset);
...
# 466 "/home/68c5eec/lib/mktime.c" 3
rpl_mktime 
# 466 "/home/68c5eec/lib/mktime.c"
      (struct tm *tp)
{
