# 1 "/home/68c5eec/lib/localcharset.c"
# 1 "/home/68c5eec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/68c5eec/lib/localcharset.c"
# 20 "/home/68c5eec/lib/localcharset.c"
# 1 "./lib/config.h" 1
# 21 "/home/68c5eec/lib/localcharset.c" 2


# 1 "/home/68c5eec/lib/localcharset.h" 1
# 32 "/home/68c5eec/lib/localcharset.h"
extern const char * locale_charset (void);
# 24 "/home/68c5eec/lib/localcharset.c" 2
...
extern int _gl_cxxalias_dummy;
# 26 "/home/68c5eec/lib/localcharset.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stddef.h" 1 3 4
...
# 27 "/home/68c5eec/lib/localcharset.c" 2
# 1 "./lib/stdio.h" 1
# 20 "./lib/stdio.h"
...
extern int _gl_cxxalias_dummy;
# 28 "/home/68c5eec/lib/localcharset.c" 2
# 1 "./lib/string.h" 1
# 20 "./lib/string.h"
...
extern int _gl_cxxalias_dummy;
# 29 "/home/68c5eec/lib/localcharset.c" 2
# 1 "./lib/stdlib.h" 1
# 20 "./lib/stdlib.h"
...
extern int _gl_cxxalias_dummy;
# 30 "/home/68c5eec/lib/localcharset.c" 2
# 48 "/home/68c5eec/lib/localcharset.c"
# 1 "./lib/unistd.h" 1
# 21 "./lib/unistd.h"
...
# 49 "/home/68c5eec/lib/localcharset.c" 2
...
extern int _gl_cxxalias_dummy;
# 51 "/home/68c5eec/lib/localcharset.c" 2
# 82 "/home/68c5eec/lib/localcharset.c"
# 1 "/home/68c5eec/lib/configmake.h" 1
# 83 "/home/68c5eec/lib/localcharset.c" 2
# 120 "/home/68c5eec/lib/localcharset.c"
...
get_charset_aliases (void)
{
  ...
  cp = charset_aliases;
  if (cp == 
# 129 "/home/68c5eec/lib/localcharset.c" 3 4
           ((void *)0)
# 129 "/home/68c5eec/lib/localcharset.c"
               )
    {
      ...
      if (dir == 
# 139 "/home/68c5eec/lib/localcharset.c" 3 4
                ((void *)0) 
# 139 "/home/68c5eec/lib/localcharset.c"
                     || dir[0] == '\0')
        dir = ("/usr/local/lib");
...

      {
        ...
        if (file_name != 
# 148 "/home/68c5eec/lib/localcharset.c" 3 4
                        ((void *)0)
# 148 "/home/68c5eec/lib/localcharset.c"
                            )
          {
      ...
      if (file_name == 
# 157 "/home/68c5eec/lib/localcharset.c" 3 4
                      ((void *)0)
# 157 "/home/68c5eec/lib/localcharset.c"
                          )
        ...
        {
          int fd;
# 171 "/home/68c5eec/lib/localcharset.c"
          fd = open (file_name,
                     
# 172 "/home/68c5eec/lib/localcharset.c" 3 4
                    00 
# 172 "/home/68c5eec/lib/localcharset.c"
                             | (1 ? 
# 172 "/home/68c5eec/lib/localcharset.c" 3 4
                                                          0400000 
# 172 "/home/68c5eec/lib/localcharset.c"
          ...
          if (fd < 0)
          ...
          else
            {
              ...
              fp = fdopen (fd, "r");
              if (fp == 
# 181 "/home/68c5eec/lib/localcharset.c" 3 4
                       ((void *)0)
# 181 "/home/68c5eec/lib/localcharset.c"
                           )
                {
              ...
              else
                {
                  ...
                  char *res_ptr = 
# 190 "/home/68c5eec/lib/localcharset.c" 3 4
                                 ((void *)0)
# 190 "/home/68c5eec/lib/localcharset.c"
                                     ;
                  size_t res_size = 0;
                  ...
                  for (;;)
                    {
                      ...
                      c = getc_unlocked (fp);
                      if (c == 
# 202 "/home/68c5eec/lib/localcharset.c" 3 4
                              (-1)
# 202 "/home/68c5eec/lib/localcharset.c"
                                 )
                        break;
                      if (c == '\n' || c == ' ' || c == '\t')
                        continue;
                      if (c == '#')
                        {
                          ...
                          do
                            c = getc_unlocked (fp);
                          while (!(c == 
# 211 "/home/68c5eec/lib/localcharset.c" 3 4
                                       (-1) 
# 211 "/home/68c5eec/lib/localcharset.c"
                                           || c == '\n'));
                          if (c == 
# 212 "/home/68c5eec/lib/localcharset.c" 3 4
                                  (-1)
# 212 "/home/68c5eec/lib/localcharset.c"
                                     )
                            break;
                          continue;
                        }
                      ...
                      if (res_ptr == 
# 232 "/home/68c5eec/lib/localcharset.c" 3 4
                                    ((void *)0)
# 232 "/home/68c5eec/lib/localcharset.c"
                                        )
                        {
...
# 242 "/home/68c5eec/lib/localcharset.c" 3
                 rpl_fclose 
# 242 "/home/68c5eec/lib/localcharset.c"
                        (fp);
                  if (res_size == 0)
                    cp = "";
                  else
...
# 377 "/home/68c5eec/lib/localcharset.c"
      charset_aliases = cp;
    }

  return cp;
}
# 392 "/home/68c5eec/lib/localcharset.c"
const char *
locale_charset (void)
{
  const char *codeset;
  ...
  codeset = nl_langinfo (
# 403 "/home/68c5eec/lib/localcharset.c" 3 4
                        CODESET
# 403 "/home/68c5eec/lib/localcharset.c"
                               );
# 584 "/home/68c5eec/lib/localcharset.c"
  if (codeset == 
# 584 "/home/68c5eec/lib/localcharset.c" 3 4
                ((void *)0)
# 584 "/home/68c5eec/lib/localcharset.c"
                    )
  ...
  if (codeset[0] == '\0')
    codeset = "ASCII";
# 612 "/home/68c5eec/lib/localcharset.c"
  return codeset;
}
