# 1 "/home/68c5eec/src/libstdbuf.c"
# 1 "/home/68c5eec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/68c5eec/src/libstdbuf.c"
# 19 "/home/68c5eec/src/libstdbuf.c"
# 1 "./lib/config.h" 1
# 20 "/home/68c5eec/src/libstdbuf.c" 2
# 1 "./lib/stdio.h" 1
# 20 "./lib/stdio.h"
...
extern int _gl_cxxalias_dummy;
# 21 "/home/68c5eec/src/libstdbuf.c" 2
...
# 22 "/home/68c5eec/src/libstdbuf.c" 2
# 59 "/home/68c5eec/src/libstdbuf.c"
static const char *
fileno_to_name (const int fd)
{
  const char *ret = 
# 62 "/home/68c5eec/src/libstdbuf.c" 3 4
                   ((void *)0)
# 62 "/home/68c5eec/src/libstdbuf.c"
                       ;
...
{
  char *buf = 
# 86 "/home/68c5eec/src/libstdbuf.c" 3 4
             ((void *)0)
# 86 "/home/68c5eec/src/libstdbuf.c"
                 ;
  int setvbuf_mode;
  size_t size = 0;
  ...
  if (*mode == '0')
    setvbuf_mode = 
# 91 "/home/68c5eec/src/libstdbuf.c" 3 4
                  2
# 91 "/home/68c5eec/src/libstdbuf.c"
                        ;
  else if (*mode == 'L')
    setvbuf_mode = 
# 93 "/home/68c5eec/src/libstdbuf.c" 3 4
                  1
# 93 "/home/68c5eec/src/libstdbuf.c"
                        ;
  else
    {
      setvbuf_mode = 
# 96 "/home/68c5eec/src/libstdbuf.c" 3 4
                    0
# 96 "/home/68c5eec/src/libstdbuf.c"
                          ;
      _Static_assert (
# 97 "/home/68c5eec/src/libstdbuf.c" 3 4
     (18446744073709551615UL) 
# 97 "/home/68c5eec/src/libstdbuf.c"
     <= 
# 97 "/home/68c5eec/src/libstdbuf.c" 3 4
     (0x7fffffffffffffffL * 2UL + 1UL)
# 97 "/home/68c5eec/src/libstdbuf.c"
     , "verify (" "SIZE_MAX <= ULONG_MAX" ")");
      size = strtoul (mode, 
# 98 "/home/68c5eec/src/libstdbuf.c" 3 4
                           ((void *)0)
# 98 "/home/68c5eec/src/libstdbuf.c"
                               , 10);
      if (size > 0)
        {
          if (!(buf = malloc (size)))
            {
              ...
              fprintf (
# 106 "/home/68c5eec/src/libstdbuf.c" 3 4
                      stderr
# 106 "/home/68c5eec/src/libstdbuf.c"
                            ,
                       gettext ("failed to allocate a %" 
# 107 "/home/68c5eec/src/libstdbuf.c" 3 4
                      "l" "u" 
# 107 "/home/68c5eec/src/libstdbuf.c"
                      " byte stdio buffer\n")
                                                , (uintmax_t) size);
              return;
            }
        ...
        {
          fprintf (
# 114 "/home/68c5eec/src/libstdbuf.c" 3 4
                  stderr
# 114 "/home/68c5eec/src/libstdbuf.c"
  ...
  if (setvbuf (stream, buf, setvbuf_mode, size) != 0)
    {
      fprintf (
# 122 "/home/68c5eec/src/libstdbuf.c" 3 4
              stderr
# 122 "/home/68c5eec/src/libstdbuf.c"
...
stdbuf (void)
{
  ...
  if (e_mode)
    apply_mode (
# 136 "/home/68c5eec/src/libstdbuf.c" 3 4
               stderr
# 136 "/home/68c5eec/src/libstdbuf.c"
                     , e_mode);
  if (i_mode)
    apply_mode (
# 138 "/home/68c5eec/src/libstdbuf.c" 3 4
               stdin
# 138 "/home/68c5eec/src/libstdbuf.c"
                    , i_mode);
  if (o_mode)
    apply_mode (
# 140 "/home/68c5eec/src/libstdbuf.c" 3 4
               stdout
# 140 "/home/68c5eec/src/libstdbuf.c"
                     , o_mode);
}
