# 1 "/home/68c5eec/lib/pipe-safer.c"
# 1 "/home/68c5eec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/68c5eec/lib/pipe-safer.c"
# 19 "/home/68c5eec/lib/pipe-safer.c"
# 1 "./lib/config.h" 1
# 20 "/home/68c5eec/lib/pipe-safer.c" 2
...
# 22 "/home/68c5eec/lib/pipe-safer.c" 2
...
# 24 "/home/68c5eec/lib/pipe-safer.c" 2
...
# 25 "/home/68c5eec/lib/pipe-safer.c" 2
...
# 30 "/home/68c5eec/lib/pipe-safer.c"
int
pipe_safer (int fd[2])
{
      ...
      for (i = 0; i < 2; i++)
        {
          ...
          if (fd[i] < 0)
            {
              int e = 
# 42 "/home/68c5eec/lib/pipe-safer.c" 3 4
                     (*__errno_location ())
# 42 "/home/68c5eec/lib/pipe-safer.c"
                          ;
              close (fd[1 - i]);
              
# 44 "/home/68c5eec/lib/pipe-safer.c" 3 4
             (*__errno_location ()) 
# 44 "/home/68c5eec/lib/pipe-safer.c"
                   = e;
              return -1;
            }
        }
