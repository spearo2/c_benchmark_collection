# 1 "/home/68c5eec/lib/filevercmp.c"
# 1 "/home/68c5eec//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 32 "<command-line>" 2
# 1 "/home/68c5eec/lib/filevercmp.c"
# 19 "/home/68c5eec/lib/filevercmp.c"
# 1 "./lib/config.h" 1
# 20 "/home/68c5eec/lib/filevercmp.c" 2
# 1 "/home/68c5eec/lib/filevercmp.h" 1
# 40 "/home/68c5eec/lib/filevercmp.h"
int filevercmp (const char *s1, const char *s2) __attribute__ ((__pure__));
# 21 "/home/68c5eec/lib/filevercmp.c" 2
...
# 29 "./lib/sys/types.h" 2 3
# 23 "/home/68c5eec/lib/filevercmp.c" 2
# 1 "./lib/stdlib.h" 1
# 20 "./lib/stdlib.h"
...
extern int _gl_cxxalias_dummy;
# 24 "/home/68c5eec/lib/filevercmp.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdbool.h" 1 3 4
# 25 "/home/68c5eec/lib/filevercmp.c" 2
# 1 "./lib/string.h" 1
# 20 "./lib/string.h"
...
extern int _gl_cxxalias_dummy;
# 26 "/home/68c5eec/lib/filevercmp.c" 2
# 1 "./lib/c-ctype.h" 1
# 31 "./lib/c-ctype.h"
...
# 27 "/home/68c5eec/lib/filevercmp.c" 2
# 1 "./lib/limits.h" 1
# 22 "./lib/limits.h"
...
# 28 "./lib/limits.h" 2 3
# 28 "/home/68c5eec/lib/filevercmp.c" 2
...
{
  const char *match = 
# 36 "/home/68c5eec/lib/filevercmp.c" 3 4
                     ((void *)0)
# 36 "/home/68c5eec/lib/filevercmp.c"
                         ;
  
# 37 "/home/68c5eec/lib/filevercmp.c" 3 4
 _Bool 
# 37 "/home/68c5eec/lib/filevercmp.c"
      read_alpha = 
# 37 "/home/68c5eec/lib/filevercmp.c" 3 4
                   0
# 37 "/home/68c5eec/lib/filevercmp.c"
  ...
  while (**str)
    {
      if (read_alpha)
        {
          read_alpha = 
# 42 "/home/68c5eec/lib/filevercmp.c" 3 4
                      0
# 42 "/home/68c5eec/lib/filevercmp.c"
                           ;
          if (!c_isalpha (**str) && '~' != **str)
            match = 
# 44 "/home/68c5eec/lib/filevercmp.c" 3 4
                   ((void *)0)
# 44 "/home/68c5eec/lib/filevercmp.c"
                       ;
        }
      else if ('.' == **str)
        {
          read_alpha = 
# 48 "/home/68c5eec/lib/filevercmp.c" 3 4
                      1
# 48 "/home/68c5eec/lib/filevercmp.c"
                          ;
          if (!match)
            match = *str;
        }
        ...
        match = 
# 53 "/home/68c5eec/lib/filevercmp.c" 3 4
               ((void *)0)
# 53 "/home/68c5eec/lib/filevercmp.c"
                   ;
      (*str)++;
    }
  return match;
...
order (unsigned char c)
{
  if (c_isdigit (c))
    ...
    return (int) c + 
# 70 "/home/68c5eec/lib/filevercmp.c" 3 4
                    (0x7f * 2 + 1) 
# 70 "/home/68c5eec/lib/filevercmp.c"
                              + 1;
}
# 83 "/home/68c5eec/lib/filevercmp.c"
static int 
# 83 "/home/68c5eec/lib/filevercmp.c" 3
          __attribute__ ((__pure__))

# 84 "/home/68c5eec/lib/filevercmp.c"
