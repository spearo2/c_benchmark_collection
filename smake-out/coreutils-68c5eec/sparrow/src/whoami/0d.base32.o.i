...
# 32 "<command-line>" 2
# 1 "/home/68c5eec/lib/base32.c"
# 40 "/home/68c5eec/lib/base32.c"
# 1 "./lib/config.h" 1
# 41 "/home/68c5eec/lib/base32.c" 2


# 1 "/home/68c5eec/lib/base32.h" 1
# 22 "/home/68c5eec/lib/base32.h"
...
# 23 "/home/68c5eec/lib/base32.h" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/7/include/stdbool.h" 1 3 4
# 26 "/home/68c5eec/lib/base32.h" 2
...
extern 
# 37 "/home/68c5eec/lib/base32.h" 3 4
      _Bool 
# 37 "/home/68c5eec/lib/base32.h"
...
extern int _gl_cxxalias_dummy;
# 47 "/home/68c5eec/lib/base32.c" 2
...
# 28 "./lib/limits.h" 2 3
# 50 "/home/68c5eec/lib/base32.c" 2
...
extern int _gl_cxxalias_dummy;
# 52 "/home/68c5eec/lib/base32.c" 2



# 54 "/home/68c5eec/lib/base32.c"
...
base32_encode_alloc (const char *in, size_t inlen, char **out)
{
  ...
  if (inlen > outlen)
    {
      *out = 
# 152 "/home/68c5eec/lib/base32.c" 3 4
            ((void *)0)
# 152 "/home/68c5eec/lib/base32.c"
                ;
      return 0;
    }
...
# 285 "/home/68c5eec/lib/base32.c"

# 285 "/home/68c5eec/lib/base32.c" 3 4
_Bool

# 286 "/home/68c5eec/lib/base32.c"
isbase32 (char ch)
{
  return 
# 288 "/home/68c5eec/lib/base32.c" 3 4
        1 
# 288 "/home/68c5eec/lib/base32.c"
                                       && 0 <= b32[to_uchar (ch)];
}
...
# 316 "/home/68c5eec/lib/base32.c" 3 4
                                                     ((void *)0)
# 316 "/home/68c5eec/lib/base32.c"
                                                         )
        {
...
# 359 "/home/68c5eec/lib/base32.c"
static 
# 359 "/home/68c5eec/lib/base32.c" 3 4
      _Bool

# 360 "/home/68c5eec/lib/base32.c"
          ...
          char *__restrict *outp, size_t *outleft)
{
  ...
  if (inlen < 8)
    return 
# 365 "/home/68c5eec/lib/base32.c" 3 4
          0
# 365 "/home/68c5eec/lib/base32.c"
               ;

  if (!isbase32 (in[0]) || !isbase32 (in[1]) )
    return 
# 368 "/home/68c5eec/lib/base32.c" 3 4
          0
# 368 "/home/68c5eec/lib/base32.c"
               ;
  ...
  if (in[2] == '=')
    {
      if (in[3] != '=' || in[4] != '=' || in[5] != '='
          || in[6] != '=' || in[7] != '=')
        do { *outp = out; return 
# 381 "/home/68c5eec/lib/base32.c" 3 4
       0
# 381 "/home/68c5eec/lib/base32.c"
       ; } while (
# 381 "/home/68c5eec/lib/base32.c" 3 4
       0
# 381 "/home/68c5eec/lib/base32.c"
  ...
  else
    {
      if (!isbase32 (in[2]) || !isbase32 (in[3]))
        do { *outp = out; return 
# 386 "/home/68c5eec/lib/base32.c" 3 4
       0
# 386 "/home/68c5eec/lib/base32.c"
       ; } while (
# 386 "/home/68c5eec/lib/base32.c" 3 4
       0
# 386 "/home/68c5eec/lib/base32.c"
      ...
      if (in[4] == '=')
        {
          if (in[5] != '=' || in[6] != '=' || in[7] != '=')
            do { *outp = out; return 
# 399 "/home/68c5eec/lib/base32.c" 3 4
           0
# 399 "/home/68c5eec/lib/base32.c"
           ; } while (
# 399 "/home/68c5eec/lib/base32.c" 3 4
           0
# 399 "/home/68c5eec/lib/base32.c"
      ...
      else
        {
          if (!isbase32 (in[4]))
            do { *outp = out; return 
# 404 "/home/68c5eec/lib/base32.c" 3 4
           0
# 404 "/home/68c5eec/lib/base32.c"
           ; } while (
# 404 "/home/68c5eec/lib/base32.c" 3 4
           0
# 404 "/home/68c5eec/lib/base32.c"
          ...
          if (in[5] == '=')
            {
              if (in[6] != '=' || in[7] != '=')
                do { *outp = out; return 
# 416 "/home/68c5eec/lib/base32.c" 3 4
               0
# 416 "/home/68c5eec/lib/base32.c"
               ; } while (
# 416 "/home/68c5eec/lib/base32.c" 3 4
               0
# 416 "/home/68c5eec/lib/base32.c"
          ...
          else
            {
              if (!isbase32 (in[5]) || !isbase32 (in[6]))
                do { *outp = out; return 
# 421 "/home/68c5eec/lib/base32.c" 3 4
               0
# 421 "/home/68c5eec/lib/base32.c"
               ; } while (
# 421 "/home/68c5eec/lib/base32.c" 3 4
               0
# 421 "/home/68c5eec/lib/base32.c"
              ...
              if (in[7] != '=')
                {
                  if (!isbase32 (in[7]))
                    do { *outp = out; return 
# 434 "/home/68c5eec/lib/base32.c" 3 4
                   0
# 434 "/home/68c5eec/lib/base32.c"
                   ; } while (
# 434 "/home/68c5eec/lib/base32.c" 3 4
                   0
# 434 "/home/68c5eec/lib/base32.c"
  ...
  *outp = out;
  return 
# 448 "/home/68c5eec/lib/base32.c" 3 4
        1
# 448 "/home/68c5eec/lib/base32.c"
            ;
}
# 469 "/home/68c5eec/lib/base32.c"

# 469 "/home/68c5eec/lib/base32.c" 3 4
_Bool

# 470 "/home/68c5eec/lib/base32.c"
base32_decode_ctx (struct base32_decode_context *ctx,
                   const char *__restrict in, size_t inlen,
                   char *__restrict out, size_t *outlen)
{
...
# 475 "/home/68c5eec/lib/base32.c" 3 4
 _Bool 
# 475 "/home/68c5eec/lib/base32.c"
      ignore_newlines = ctx != 
# 475 "/home/68c5eec/lib/base32.c" 3 4
                               ((void *)0)
# 475 "/home/68c5eec/lib/base32.c"
...
# 476 "/home/68c5eec/lib/base32.c" 3 4
 _Bool 
# 476 "/home/68c5eec/lib/base32.c"
      flush_ctx = 
# 476 "/home/68c5eec/lib/base32.c" 3 4
                  0
# 476 "/home/68c5eec/lib/base32.c"
  ...
  while (
# 486 "/home/68c5eec/lib/base32.c" 3 4
        1
# 486 "/home/68c5eec/lib/base32.c"
            )
    {
      ...
      if (ctx_i == 0 && !flush_ctx)
        {
          while (
# 491 "/home/68c5eec/lib/base32.c" 3 4
                1
# 491 "/home/68c5eec/lib/base32.c"
                    )
            {
...
# 560 "/home/68c5eec/lib/base32.c"

# 560 "/home/68c5eec/lib/base32.c" 3 4
_Bool

# 561 "/home/68c5eec/lib/base32.c"
base32_decode_alloc_ctx (struct base32_decode_context *ctx,
                         ...
                         size_t *outlen)
{
  ...
  *out = malloc (needlen);
  if (!*out)
    return 
# 574 "/home/68c5eec/lib/base32.c" 3 4
          1
# 574 "/home/68c5eec/lib/base32.c"
              ;
  ...
  if (!base32_decode_ctx (ctx, in, inlen, *out, &needlen))
    {
      free (*out);
      *out = 
# 579 "/home/68c5eec/lib/base32.c" 3 4
            ((void *)0)
# 579 "/home/68c5eec/lib/base32.c"
                ;
      return 
# 580 "/home/68c5eec/lib/base32.c" 3 4
            0
# 580 "/home/68c5eec/lib/base32.c"
                 ;
    }
  ...
  return 
# 586 "/home/68c5eec/lib/base32.c" 3 4
        1
# 586 "/home/68c5eec/lib/base32.c"
            ;
}
