# 1 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
# 27 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
...
# 30 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
...
# 31 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
...
# 32 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
...
# 33 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
...
# 36 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
...
# 43 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 2
# 54 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
typedef enum {
    EXP50,
    EXP60,
    EXP70,
...
main(int argc, char* argv[])
{
 ...
 switch (c) {
 case 'w': tnw = strtoul(optarg, 
# 88 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
                                ((void *)0)
# 88 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                                    , 0); break;
 case 'h': tnh = strtoul(optarg, 
# 89 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
                                ((void *)0)
# 89 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                                    , 0); break;
 case 'c': contrast = (strcmp(optarg,"exp50") == 0) ? EXP50 :
       (strcmp(optarg,"exp60") == 0) ? EXP60 :
       (strcmp(optarg,"exp70") == 0) ? EXP70 :
       (strcmp(optarg,"exp80") == 0) ? EXP80 :
       (strcmp(optarg,"exp90") == 0) ? EXP90 :
       (strcmp(optarg,"exp") == 0) ? EXP :
       (strcmp(optarg,"linear") == 0)? LINEAR :
           EXP;
   break;
 default: usage();
 }
 ...
 usage();
    ...
    if (out == 
# 106 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
              ((void *)0)
# 106 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                  )
 return 2;
    in = TIFFOpen(argv[optind], "r");
    if( in == 
# 109 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
             ((void *)0) 
# 109 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                  )
        return 2;
    ...
    if (in != 
# 119 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
             ((void *)0)
# 119 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                 ) {
 initScale();
 do {
...
# 145 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
static void
...
expFill(float pct[], uint32 p, uint32 n)
{
    ...
    uint32 c = (p * n) / 100;
    for (i = 1; i < c; i++)
 pct[i] = (float) (1-exp(i/((double)(n-1)))/ 
# 426 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
                                            2.7182818284590452354
# 426 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                                               );
    for (; i < n; i++)
 pct[i] = 0.;
}
...
setImage1(const uint8* br, uint32 rw, uint32 rh)
{
 ...
 uint32 nrows = 1;
 fprintf(
# 566 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
        stderr
# 566 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
              , "bpr=%d, sy=%d, bpr*sy=%d\n", bpr, sy, bpr*sy);
 rows[0] = br + bpr*sy;
 err += step;
 while (err >= limit) {
...
generateThumbnail(TIFF* in, TIFF* out)
{
 ...
 return 0;
    ...
    fprintf(
# 614 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
           stderr
# 614 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
...
# 668 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
((void *)0)

# 669 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
};
...
{
 char buf[
# 674 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
         8192
# 674 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
               ];
 int i;

 setbuf(
# 677 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
       stderr
# 677 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
             , buf);
        fprintf(
# 678 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
               stderr
# 678 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 679 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
                        ((void *)0)
# 679 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
                            ; i++)
  fprintf(
# 680 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c" 3 4
         stderr
# 680 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/thumbnail.c"
               , "%s\n", stuff[i]);
 exit(-1);
}
