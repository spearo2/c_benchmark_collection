# 1 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
# 27 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
# 30 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
# 31 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
# 32 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
# 35 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
# 42 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
# 43 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 2
...
fsdither(TIFF* in, TIFF* out)
{
 ...
 if (! (inputline && thisline && nextline && outline)) {
     fprintf(
# 82 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
            stderr
# 82 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
                  , "Out of memory.\n");
     goto skip_on_error;
 }
...
main(int argc, char* argv[])
{
 ...
 if (in == 
# 249 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
          ((void *)0)
# 249 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
              )
  return (-1);
 TIFFGetField(in, 277, &samplesperpixel);
 if (samplesperpixel != 1) {
  fprintf(
# 253 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
         stderr
# 253 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
               , "%s: Not a b&w image.\n", argv[0]);
  return (-1);
 }
 ...
 if (bitspersample != 8) {
  fprintf(
# 258 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
         stderr
# 258 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
               ,
 ...
 if (out == 
# 263 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
           ((void *)0)
# 263 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
               )
  return (-1);
...
# 324 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
((void *)0)

# 325 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
};
...
{
 char buf[
# 330 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
         8192
# 330 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
               ];
 int i;

 setbuf(
# 333 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
       stderr
# 333 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
             , buf);
        fprintf(
# 334 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
               stderr
# 334 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 335 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
                        ((void *)0)
# 335 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
                            ; i++)
  fprintf(
# 336 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c" 3 4
         stderr
# 336 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiffdither.c"
               , "%s\n", stuff[i]);
 exit(-1);
}
