# 1 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
# 27 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
...
# 30 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
...
# 31 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
...
# 32 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
...
# 35 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
...
# 42 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
# 1 "../libtiff/tiffio.h" 1
# 43 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 2
# 53 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
...
main(int argc, char* argv[])
{
 ...
 if (out == 
# 119 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
           ((void *)0)
# 119 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
               )
  return (-2);
 ...
 for (; optind < argc-1; optind++) {
  ...
  if (in != 
# 124 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
           ((void *)0)
# 124 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
               ) {
   do {
    if (!tiffcvt(in, out) ||
...
# 210 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
...
# 306 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
...
# 354 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
static int
...
# 403 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
    if (no_alpha)
    {
...
# 520 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
   ((void *)0)

# 521 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
};
...
{
 char buf[
# 526 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
         8192
# 526 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
               ];
 int i;

 setbuf(
# 529 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
       stderr
# 529 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
             , buf);
        fprintf(
# 530 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
               stderr
# 530 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 531 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
                        ((void *)0)
# 531 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
                            ; i++)
  fprintf(
# 532 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c" 3 4
         stderr
# 532 "/doner/libtiff/libtiff-Release-v4-0-6/source/tools/tiff2rgba.c"
               , "%s\n", stuff[i]);
 exit(code);
}
