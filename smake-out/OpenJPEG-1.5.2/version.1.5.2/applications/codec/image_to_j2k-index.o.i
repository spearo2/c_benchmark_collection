# 1 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
...
# 1 "<command-line>" 2
# 1 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
# 29 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
...
# 30 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 2
...
# 31 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 2
...
# 32 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 2
...
# 33 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 2
...
# 34 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 2
# 43 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
int write_index_file(opj_codestream_info_t *cstr_info, char *index) {
 int tileno, compno, layno, resno, precno, pack_nb, x, y;
 FILE *stream = 
# 45 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 3 4
               ((void *)0)
# 45 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
                   ;
 ...
 if (!stream) {
  fprintf(
# 62 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 3 4
         stderr
# 62 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
               , "failed to open index file [%s] for writing\n", index);
  return 1;
 }
 ...
 for (resno = cstr_info->numdecompos[0]; resno >= 0; resno--) {
  fprintf(stream, "[%d,%d] ",
   (1 << cstr_info->tile[0].pdx[resno]), (1 << cstr_info->tile[0].pdx[resno]));
 }
 ...
 fprintf(
# 388 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c" 3 4
        stderr
# 388 "/doner/openjpeg/openjpeg-version.1.5.2/applications/codec/index.c"
              ,"Generated index file %s\n", index);
