# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
# 34 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
# 1 "../src/config.h" 1
# 35 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 37 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 40 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 41 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 43 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 45 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 2
...
# 59 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                               ((void *)0)
# 59 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
                                   , 
# 59 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                                     ((void *)0) 
# 59 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
 ...
 { if (argv [k][0] != '-')
  { if (filenames [0] == 
# 78 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                        ((void *)0)
# 78 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
                            )
    filenames [0] = argv [k] ;
   else if (filenames [1] == 
# 80 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                            ((void *)0)
# 80 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
                                )
    filenames [1] = argv [k] ;
   else
...
# 97 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
  if (strcmp (argv [k], "--bext-description") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.description = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-originator") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.originator = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-orig-ref") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.originator_reference = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-umid") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.umid = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-orig-date") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.origination_date = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-orig-time") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.origination_time = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-coding-hist") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.coding_history = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--bext-time-ref") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.time_ref = argv [k] ; continue ; } ; ;
# 114 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
  if (strcmp (argv [k], "--str-comment") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.comment = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--str-title") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.title = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--str-copyright") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.copyright = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--str-artist") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.artist = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--str-date") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.date = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--str-album") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.album = argv [k] ; continue ; } ; ;
  if (strcmp (argv [k], "--str-license") == 0) { k ++ ; if (k == argc) missing_param (argv [k - 1]) ; info.license = argv [k] ; continue ; } ; ;
 ...
 if (filenames [0] == 
# 158 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                     ((void *)0)
# 158 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
                         )
 ...
 if (filenames [1] != 
# 163 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                     ((void *)0) 
# 163 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
                          && strcmp (filenames [0], filenames [1]) == 0)
 { printf ("Error : Input and output files are the same.\n\n") ;
  exit (1) ;
  } ;

 if (info.coding_history != 
# 168 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                           ((void *)0) 
# 168 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
                                && filenames [1] == 
# 168 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c" 3 4
                                                    ((void *)0)
# 168 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
...
# 281 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-set.c"
 return ;
}
