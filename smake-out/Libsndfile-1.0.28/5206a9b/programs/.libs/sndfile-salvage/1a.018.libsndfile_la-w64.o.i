# 1 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 2
# 87 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
static unsigned char riff_MARKER16 [16] = { ('r'), ('i'), ('f'), ('f'), (0x2E), (0x91), (0xCF), (0x11), (0xA5), (0xD6), (0x28), (0xDB), (0x04), (0xC1), (0x00), (0x00) }
                                                        ;


static unsigned char wave_MARKER16 [16] = { ('w'), ('a'), ('v'), ('e'), (0xF3), (0xAC), (0xD3), (0x11), (0x8C), (0xD1), (0x00), (0xC0), (0x4F), (0x8E), (0xDB), (0x8A) }
                                                        ;

static unsigned char fmt_MARKER16 [16] = { ('f'), ('m'), ('t'), (' '), (0xF3), (0xAC), (0xD3), (0x11), (0x8C), (0xD1), (0x00), (0xC0), (0x4F), (0x8E), (0xDB), (0x8A) }
                                                        ;

static unsigned char fact_MARKER16 [16] = { ('f'), ('a'), ('c'), ('t'), (0xF3), (0xAC), (0xD3), (0x11), (0x8C), (0xD1), (0x00), (0xC0), (0x4F), (0x8E), (0xDB), (0x8A) }
                                                        ;

static unsigned char data_MARKER16 [16] = { ('d'), ('a'), ('t'), ('a'), (0xF3), (0xAC), (0xD3), (0x11), (0x8C), (0xD1), (0x00), (0xC0), (0x4F), (0x8E), (0xDB), (0x8A) }
                                                        ;
...
# 128 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 3 4
                                                      ((void *)0)
# 128 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
                                                          )
 ...
 { if (psf->is_pipe)
  ...
  { blockalign = wavlike_srate2blocksize (psf->sf.samplerate * psf->sf.channels) ;
   ...
   psf->filelength = 0x7FFFFFFFFFFFFFFFLL - 10000 ;
...
# 231 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 3 4
                                     ((void *)0)
# 231 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
                                         )
  return SFE_INTERNAL ;
 ...
 while (! done)
 {
  ...
  if (bytesread == 0)
   break ;
  switch (marker)
  { case ( ('r') ^ (('i') << 1) ^ (('f') << 2) ^ (('f') << 3) ^ ((0x2E) << 4) ^ ((0x91) << 5) ^ ((0xCF) << 6) ^ ((0x11) << 7) ^ ((0xA5) << 8) ^ ((0xD6) << 9) ^ ((0x28) << 10) ^ ((0xDB) << 11) ^ ((0x04) << 12) ^ ((0xC1) << 13) ^ ((0x00) << 14) ^ ((0x00) << 15) ) :
     if (parsestage)
     ...
   case ( (0x6C) ^ ((0x69) << 1) ^ ((0x73) << 2) ^ ((0x74) << 3) ^ ((0x2F) << 4) ^ ((0x91) << 5) ^ ((0xCF) << 6) ^ ((0x11) << 7) ^ ((0xA5) << 8) ^ ((0xD6) << 9) ^ ((0x28) << 10) ^ ((0xDB) << 11) ^ ((0x04) << 12) ^ ((0xC1) << 13) ^ ((0x00) << 14) ^ ((0x00) << 15) ) :
     psf_log_printf (psf, "list : %D\n", chunk_size) ;
     chunk_size -= 24 ;
     break ;

   case ( (0x6A) ^ ((0x75) << 1) ^ ((0x6E) << 2) ^ ((0x6b) << 3) ^ ((0xF3) << 4) ^ ((0xAC) << 5) ^ ((0xD3) << 6) ^ ((0x11) << 7) ^ ((0x8C) << 8) ^ ((0xD1) << 9) ^ ((0x00) << 10) ^ ((0xC0) << 11) ^ ((0x4f) << 12) ^ ((0x8E) << 13) ^ ((0xDB) << 14) ^ ((0x8A) << 15) ) :
     psf_log_printf (psf, "junk : %D\n", chunk_size) ;
     chunk_size -= 24 ;
     break ;

   case ( (0x62) ^ ((0x65) << 1) ^ ((0x78) << 2) ^ ((0x74) << 3) ^ ((0xf3) << 4) ^ ((0xac) << 5) ^ ((0xd3) << 6) ^ ((0xaa) << 7) ^ ((0xd1) << 8) ^ ((0x8c) << 9) ^ ((0x00) << 10) ^ ((0xC0) << 11) ^ ((0x4F) << 12) ^ ((0x8E) << 13) ^ ((0xDB) << 14) ^ ((0x8A) << 15) ) :
     psf_log_printf (psf, "bext : %D\n", chunk_size) ;
     chunk_size -= 24 ;
     break ;

   case ( (0x56) ^ ((0x62) << 1) ^ ((0xf7) << 2) ^ ((0xab) << 3) ^ ((0x2d) << 4) ^ ((0x39) << 5) ^ ((0xd2) << 6) ^ ((0x11) << 7) ^ ((0x86) << 8) ^ ((0xc7) << 9) ^ ((0x00) << 10) ^ ((0xc0) << 11) ^ ((0x4f) << 12) ^ ((0x8e) << 13) ^ ((0xdb) << 14) ^ ((0x8a) << 15) ) :
     psf_log_printf (psf, "marker : %D\n", chunk_size) ;
     chunk_size -= 24 ;
     break ;

   case ( (0xBC) ^ ((0x94) << 1) ^ ((0x5F) << 2) ^ ((0x92) << 3) ^ ((0x5A) << 4) ^ ((0x52) << 5) ^ ((0xD2) << 6) ^ ((0x11) << 7) ^ ((0x86) << 8) ^ ((0xDC) << 9) ^ ((0x00) << 10) ^ ((0xC0) << 11) ^ ((0x4F) << 12) ^ ((0x8E) << 13) ^ ((0xDB) << 14) ^ ((0x8A) << 15) ) :
  ...
  if (psf_ftell (psf) >= (psf->filelength - (2 * ((int) sizeof (dword)))))
   break ;
...
# 392 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 3 4
                                  0
# 392 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
                                          ) ;
...
{ sf_count_t fmt_size, current ;
 ...
 psf->header.indx = 0 ;
 psf_fseek (psf, 0, 
# 465 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 3 4
                   0
# 465 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
                           ) ;
 ...
 { case SF_FORMAT_PCM_U8 :
  ...
  case SF_FORMAT_GSM610 :
     { int bytespersec ;
      ...
      bytespersec = (psf->sf.samplerate * 65) / 320 ;
...
# 632 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c" 3 4
                          0
# 632 "/doner/libsndfile/libsndfile-5206a9b/src/w64.c"
                                  ) ;
