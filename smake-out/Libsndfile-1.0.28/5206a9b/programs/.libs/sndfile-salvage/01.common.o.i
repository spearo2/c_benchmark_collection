# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
# 34 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
...
# 35 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 37 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 41 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 43 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 2
...
# 65 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                                           ((void *)0)
# 65 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                                               , SF_FALSE) ;
...
{ SF_BROADCAST_INFO_2K binfo ;
 ...
 if (info->description != 
# 143 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
((void *)0)
# 143 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
 ...
 if (info->originator != 
# 144 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
((void *)0)
# 144 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
...
# 145 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
((void *)0)
# 145 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
...
# 146 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
((void *)0)
# 146 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
...
# 147 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
((void *)0)
# 147 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
 ...
 if (info->umid != 
# 148 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
((void *)0)
# 148 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
 ...
 if (info->time_ref != 
# 151 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                      ((void *)0)
# 151 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                          )
...
# 159 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                            ((void *)0)
# 159 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                                )
 { if (info->coding_hist_append)
  { int slen = strlen (binfo.coding_history) ;

   while (slen > 1 && 
# 163 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                     ((*__ctype_b_loc ())[(int) ((
# 163 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
...
{
 if (info->title != 
# 188 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                   ((void *)0)
# 188 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                       )
  sf_set_string (outfile, SF_STR_TITLE, info->title) ;

 if (info->copyright != 
# 191 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                       ((void *)0)
# 191 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                           )
  sf_set_string (outfile, SF_STR_COPYRIGHT, info->copyright) ;

 if (info->artist != 
# 194 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                    ((void *)0)
# 194 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                        )
  sf_set_string (outfile, SF_STR_ARTIST, info->artist) ;

 if (info->comment != 
# 197 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                     ((void *)0)
# 197 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                         )
  sf_set_string (outfile, SF_STR_COMMENT, info->comment) ;

 if (info->date != 
# 200 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                  ((void *)0)
# 200 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                      )
  sf_set_string (outfile, SF_STR_DATE, info->date) ;

 if (info->album != 
# 203 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                   ((void *)0)
# 203 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                       )
  sf_set_string (outfile, SF_STR_ALBUM, info->album) ;

 if (info->license != 
# 206 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                     ((void *)0)
# 206 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                         )
...
{ SNDFILE *infile = 
# 215 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                   ((void *)0)
# 215 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                       , *outfile = 
# 215 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                                    ((void *)0) 
# 215 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
 ...
 if (filenames [1] == 
# 223 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                     ((void *)0)
# 223 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                         )
 ...
 if (infile == 
# 233 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
              ((void *)0)
# 233 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                  )
 ...
 if (outfile == 
# 239 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
               ((void *)0)
# 239 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                   )
...
cleanup_exit :
 ...
 if (outfile != 
# 264 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
               ((void *)0) 
# 264 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                    && outfile != infile)
  sf_close (outfile) ;

 if (infile != 
# 267 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
              ((void *)0)
# 267 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                  )
  sf_close (infile) ;
...
{ char buffer [16], *cptr ;
 ...
 if ((cptr = strrchr (str, '.')) == 
# 330 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                                   ((void *)0)
# 330 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                                       )
  return 0 ;
 ...
 for (k = 0 ; buffer [k] ; k++)
  buffer [k] = 
# 337 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
              (__extension__ ({ int __res; if (sizeof (
# 337 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
              (buffer [k])
# 337 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
...
{ SF_FORMAT_INFO info ;
 ...
 { info.format = format_map [k].format ;
  sf_command (
# 363 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
             ((void *)0)
# 363 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                 , SFC_GET_FORMAT_INFO, &info, sizeof (info)) ;
  printf ("        %-10s : %s\n", format_map [k].ext, info.name == 
# 364 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c" 3 4
                                                                  ((void *)0) 
# 364 "/doner/libsndfile/libsndfile-5206a9b/programs/common.c"
                                                                       ? "????" : info.name) ;
  } ;
