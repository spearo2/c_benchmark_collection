# 1 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 32 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 34 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 37 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 2
# 70 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
...
static int rf64_command (SF_PRIVATE *psf, int command, void * UNUSED_data __attribute__ ((unused)), int datasize) ;
...
# 91 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                                      ((void *)0)
# 91 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                                          )
...
# 186 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                     ((void *)0)
# 186 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
 ...
 if (marker != ((uint32_t) (('R') | (('F') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24))) || marks [1] != ((uint32_t) (('W') | (('A') << 8) | (('V') << 16) | (((uint32_t) ('E')) << 24))))
  return SFE_RF64_NOT_RF64 ;

 if (marks [0] == ((uint32_t) ((0xff) | ((0xff) << 8) | ((0xff) << 16) | (((uint32_t) (0xff)) << 24))))
  psf_log_printf (psf, "%M\n  %M\n", ((uint32_t) (('R') | (('F') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24))), ((uint32_t) (('W') | (('A') << 8) | (('V') << 16) | (((uint32_t) ('E')) << 24)))) ;
 else
 ...
 while ((! (done)))
 {
  ...
  switch (marker)
  { case ((uint32_t) (('d') | (('s') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24))) :
    ...
    { unsigned int table_len, bytesread ;
     ...
     { unsigned int next ;
      ...
      if (next == ((uint32_t) (('f') | (('m') << 8) | (('t') << 16) | (((uint32_t) (' ')) << 24))))
...
# 335 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                     1
# 335 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                             ) ;
   ...
   default :
     ...
     if (
# 349 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 349 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
        (marker >> 24) & 0xFF
# 349 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
...
# 350 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
     && 
# 350 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 350 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
        (marker >> 8) & 0xFF
# 350 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
...
# 350 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
  ...
  if (marker != ((uint32_t) (('d') | (('a') << 8) | (('t') << 16) | (((uint32_t) ('a')) << 24))) && chunk_size >= psf->filelength)
  { psf_log_printf (psf, "*** Chunk size %u > file length %D. Exiting parser.\n", chunk_size, psf->filelength) ;
   break ;
   } ;

  if (psf_ftell (psf) >= psf->filelength - ((int) sizeof (marker)))
...
# 391 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                 0
# 391 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                         ) ;
 ...
 psf_fseek (psf, psf->dataoffset, 
# 404 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                 0
# 404 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                         ) ;
...
{ WAVLIKE_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 522 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                     ((void *)0)
# 522 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
...
{ sf_count_t current, pad_size ;
 ...
 if ((wpriv = psf->container_data) == 
# 636 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                     ((void *)0)
# 636 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
 ...
 psf->header.indx = 0 ;
 psf_fseek (psf, 0, 
# 658 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                   0
# 658 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                           ) ;

 if (wpriv->rf64_downgrade && psf->filelength < ((sf_count_t) 0xffffffff))
 { psf_binheader_writef (psf, "etm8m", ((uint32_t) (('R') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24))), (psf->filelength < 8) ? 8 : psf->filelength - 8, ((uint32_t) (('W') | (('A') << 8) | (('V') << 16) | (((uint32_t) ('E')) << 24)))) ;
  psf_binheader_writef (psf, "m4884", ((uint32_t) (('J') | (('U') << 8) | (('N') << 16) | (((uint32_t) ('K')) << 24))), 20, 0, 0, 0, 0) ;
  add_fact_chunk = 1 ;
  }
 else
 { psf_binheader_writef (psf, "em4m", ((uint32_t) (('R') | (('F') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24))), 0xffffffff, ((uint32_t) (('W') | (('A') << 8) | (('V') << 16) | (((uint32_t) ('E')) << 24)))) ;

  psf_binheader_writef (psf, "m48884", ((uint32_t) (('d') | (('s') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24))), 28, psf->filelength - 8, psf->datalength, psf->sf.frames, 0) ;
  } ;


 psf_binheader_writef (psf, "m", ((uint32_t) (('f') | (('m') << 8) | (('t') << 16) | (((uint32_t) (' ')) << 24)))) ;
...
# 693 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                          ((void *)0)
# 693 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                              )
  wavlike_write_bext_chunk (psf) ;

 if (psf->cart_16k != 
# 696 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                     ((void *)0)
# 696 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                         )
 ...
 if (psf->peak_info != 
# 703 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                      ((void *)0) 
# 703 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
...
# 738 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
 pad_size = psf->dataoffset - 16 - psf->header.indx ;
 if (pad_size >= 0)
  psf_binheader_writef (psf, "m4z", ((uint32_t) (('P') | (('A') << 8) | (('D') << 16) | (((uint32_t) (' ')) << 24))), pad_size, make_size_t (pad_size)) ;

 if (wpriv->rf64_downgrade && (psf->filelength < ((sf_count_t) 0xffffffff)))
  psf_binheader_writef (psf, "tm8", ((uint32_t) (('d') | (('a') << 8) | (('t') << 16) | (((uint32_t) ('a')) << 24))), psf->datalength) ;
 else
  psf_binheader_writef (psf, "m4", ((uint32_t) (('d') | (('a') << 8) | (('t') << 16) | (((uint32_t) ('a')) << 24))), 0xffffffff) ;
 ...
 if ((! (has_data)))
  psf_fseek (psf, psf->dataoffset, 
# 759 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                  0
# 759 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 761 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                          0
# 761 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                  ) ;
...
# 779 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                               0
# 779 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                       ) ;
 else
  psf->dataend = psf_fseek (psf, 0, 
# 781 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                   2
# 781 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                           ) ;
...
static int
rf64_command (SF_PRIVATE *psf, int command, void * UNUSED_data __attribute__ ((unused)), int datasize)
{ WAVLIKE_PRIVATE *wpriv ;

 if ((wpriv = psf->container_data) == 
# 811 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                     ((void *)0)
# 811 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                         )
  return SFE_INTERNAL ;
...
{ int indx ;
 ...
 if (chunk_info->data == 
# 875 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                        ((void *)0)
# 875 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                            )
...
# 882 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                                                   0
# 882 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                                                           ) ;
 ...
 psf_fseek (psf, pos, 
# 884 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c" 3 4
                     0
# 884 "/doner/libsndfile/libsndfile-5206a9b/src/rf64.c"
                             ) ;
