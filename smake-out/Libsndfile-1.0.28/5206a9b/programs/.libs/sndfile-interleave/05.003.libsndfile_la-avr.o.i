# 1 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 2
# 42 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c"
typedef struct
{ int marker ;
 char name [8] ;
 short mono ;
...
{ AVR_HEADER hdr ;
 ...
 if (hdr.marker != (((uint32_t) (('2') | (('B') << 8) | (('I') << 16) | (((uint32_t) ('T')) << 24)))))
  return 666 ;
 ...
 if (psf->fileoffset > 0)
  psf->filelength = 128 + psf->datalength ;
...
{ sf_count_t current ;
 ...
 if (psf->is_pipe == SF_FALSE)
  psf_fseek (psf, 0, 
# 212 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 3 4
                    0
# 212 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c"
                            ) ;

 psf_binheader_writef (psf, "Emz22", (((uint32_t) (('2') | (('B') << 8) | (('I') << 16) | (((uint32_t) ('T')) << 24)))), make_size_t (8),
...
# 233 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c" 3 4
                          0
# 233 "/doner/libsndfile/libsndfile-5206a9b/src/avr.c"
                                  ) ;
