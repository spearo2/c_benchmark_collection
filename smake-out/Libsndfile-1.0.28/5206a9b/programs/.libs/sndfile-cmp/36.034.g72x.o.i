# 1 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
...
# 34 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 2
...
# 35 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 2
...
# 58 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
static
...
# 95 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
...
# 113 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
void private_init_state (G72x_STATE *state_ptr)
{
 int cnta ;
...
# 137 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
                                    ((void *)0)
# 137 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
                                        )
  return 
# 138 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
        ((void *)0) 
# 138 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
             ;

 private_init_state (pstate) ;

 pstate->encoder = 
# 142 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
                  ((void *)0) 
# 142 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
                       ;
 ...
 { case G723_16_BITS_PER_SAMPLE :
  ...
  default :
    free (pstate) ;
    return 
# 183 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
          ((void *)0) 
# 183 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
               ;
  } ;
...
{ G72x_STATE *pstate ;
 ...
 if ((pstate = g72x_state_new ()) == 
# 192 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
                                    ((void *)0)
# 192 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
                                        )
  return 
# 193 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
        ((void *)0) 
# 193 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
             ;

 private_init_state (pstate) ;
 pstate->decoder = 
# 196 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
                  ((void *)0) 
# 196 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
                       ;
 ...
 { case G723_16_BITS_PER_SAMPLE :
  ...
  default :
    free (pstate) ;
    return 
# 237 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c" 3 4
          ((void *)0) 
# 237 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
               ;
  } ;
...
# 327 "/doner/libsndfile/libsndfile-5206a9b/src/G72x/g72x.c"
int quantize (
 int d,
 int y,
 short *table,
