# 1 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
...
# 8 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c" 2
...
# 9 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c" 2
...
# 11 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c" 2
...
# 54 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -32), 10) ; temp1 = GSM_SUB (temp1, 0 * 2) ; temp1 = GSM_MULT_R (13107, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -32), 10) ; temp1 = GSM_SUB (temp1, 0 * 2) ; temp1 = GSM_MULT_R (13107, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -16), 10) ; temp1 = GSM_SUB (temp1, 2048 * 2) ; temp1 = GSM_MULT_R (13107, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -16), 10) ; temp1 = GSM_SUB (temp1, -2560 * 2) ; temp1 = GSM_MULT_R (13107, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;

 temp1 = arith_shift_left (GSM_ADD (*LARc++, -8), 10) ; temp1 = GSM_SUB (temp1, 94 * 2) ; temp1 = GSM_MULT_R (19223, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -8), 10) ; temp1 = GSM_SUB (temp1, -1792 * 2) ; temp1 = GSM_MULT_R (17476, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -4), 10) ; temp1 = GSM_SUB (temp1, -341 * 2) ; temp1 = GSM_MULT_R (31454, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;
 temp1 = arith_shift_left (GSM_ADD (*LARc++, -4), 10) ; temp1 = GSM_SUB (temp1, -1144 * 2) ; temp1 = GSM_MULT_R (29708, temp1) ; *LARpp++ = GSM_ADD (temp1, temp1) ; ;




}
# 85 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
...

{
 ...
 for (i = 1 ; i <= 8 ; i++, LARp++)
 {
# 155 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
  if (*LARp < 0)
...
# 188 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
{
...
)
{
 ...
 int16_t LARp [8] ;
# 352 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
 Decoding_of_the_coded_Log_Area_Ratios (LARc, LARpp_j) ;

 Coefficients_0_12 (LARpp_j_1, LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_analysis_filtering : Short_term_analysis_filtering)) (S, LARp, 13, s) ;

 Coefficients_13_26 (LARpp_j_1, LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_analysis_filtering : Short_term_analysis_filtering)) (S, LARp, 14, s + 13) ;

 Coefficients_27_39 (LARpp_j_1, LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_analysis_filtering : Short_term_analysis_filtering)) (S, LARp, 13, s + 27) ;

 Coefficients_40_159 (LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_analysis_filtering : Short_term_analysis_filtering)) (S, LARp, 120, s + 40) ;
}
...
)
{
 ...
 int16_t LARp [8] ;
# 395 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/short_term.c"
 Decoding_of_the_coded_Log_Area_Ratios (LARcr, LARpp_j) ;

 Coefficients_0_12 (LARpp_j_1, LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_synthesis_filtering : Short_term_synthesis_filtering)) (S, LARp, 13, wt, s) ;

 Coefficients_13_26 (LARpp_j_1, LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_synthesis_filtering : Short_term_synthesis_filtering)) (S, LARp, 14, wt + 13, s + 13) ;

 Coefficients_27_39 (LARpp_j_1, LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_synthesis_filtering : Short_term_synthesis_filtering)) (S, LARp, 13, wt + 27, s + 27) ;

 Coefficients_40_159 (LARpp_j, LARp) ;
 LARp_to_rp (LARp) ;
 (* (S->fast ? Fast_Short_term_synthesis_filtering : Short_term_synthesis_filtering)) (S, LARp, 120, wt + 40, s + 40) ;
}
