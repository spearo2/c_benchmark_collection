# 1 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/sfendian.h" 2
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 2
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 111 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 3 4
                             0
# 111 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
                                     ) != offset)
  ...
  while (templen > 0)
  { if (templen > ((int) sizeof (pdata->buffer)) / ((int) sizeof (short)))
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 158 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 3 4
                             0
# 158 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
                                     ) != offset)
  { psf->error = SFE_INTERLEAVE_SEEK ;
   return 0 ;
   } ;
  ...
  while (templen > 0)
  { if (templen > ((int) sizeof (pdata->buffer)) / ((int) sizeof (int)))
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 207 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 3 4
                             0
# 207 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
                                     ) != offset)
  { psf->error = SFE_INTERLEAVE_SEEK ;
  ...
  while (templen > 0)
  { if (templen > ((int) sizeof (pdata->buffer)) / ((int) sizeof (float)))
...
{ INTERLEAVE_DATA *pdata ;
 ...
 { outptr = ptr + chan ;
  ...
  if (psf_fseek (psf, offset, 
# 256 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c" 3 4
                             0
# 256 "/doner/libsndfile/libsndfile-5206a9b/src/interleave.c"
                                     ) != offset)
  { psf->error = SFE_INTERLEAVE_SEEK ;
   return 0 ;
   } ;
  ...
  while (templen > 0)
  { if (templen > ((int) sizeof (pdata->buffer)) / ((int) sizeof (double)))
...
static sf_count_t
interleave_seek (SF_PRIVATE * UNUSED_psf __attribute__ ((unused)), int UNUSED_mode __attribute__ ((unused)), sf_count_t samples_from_start)
{
