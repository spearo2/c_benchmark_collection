# 1 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/common.h" 1
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/common.h"
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/common.h" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 2
# 59 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
typedef struct
{ int read_short_dither_bits, read_int_dither_bits ;
 ...
 double buffer [(8192) / sizeof (double)] ;
} DITHER_DATA ;
...
{ DITHER_DATA *pdither ;
 ...
 { if (pdither == 
# 94 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                 ((void *)0)
# 94 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                     )
   return 0 ;
 ...
 { if (pdither == 
# 110 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                 ((void *)0)
# 110 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                     )
   return 0 ;
 ...
 { if (pdither == 
# 126 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                 ((void *)0)
# 126 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                     )
   pdither = psf->dither = calloc (1, sizeof (DITHER_DATA)) ;
  if (pdither == 
# 128 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                ((void *)0)
# 128 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                    )
 ...
 { if (pdither == 
# 153 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                 ((void *)0)
# 153 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                     )
   pdither = psf->dither = calloc (1, sizeof (DITHER_DATA)) ;
  if (pdither == 
# 155 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                ((void *)0)
# 155 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                    )
   return SFE_MALLOC_FAILED ;
...
static sf_count_t
dither_read_short (SF_PRIVATE * UNUSED_psf __attribute__ ((unused)), short * UNUSED_ptr __attribute__ ((unused)), sf_count_t len)
{
 return len ;
}

static sf_count_t
dither_read_int (SF_PRIVATE * UNUSED_psf __attribute__ ((unused)), int * UNUSED_ptr __attribute__ ((unused)), sf_count_t len)
{
 return len ;
}
...
{ DITHER_DATA *pdither ;
 ...
 if ((pdither = psf->dither) == 
# 221 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                               ((void *)0)
# 221 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                                   )
 { psf->error = 666 ;
  return 0 ;
  } ;
...
{ DITHER_DATA *pdither ;
 ...
 if ((pdither = psf->dither) == 
# 261 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                               ((void *)0)
# 261 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                                   )
 { psf->error = 666 ;
  return 0 ;
  } ;
...
{ DITHER_DATA *pdither ;
 ...
 if ((pdither = psf->dither) == 
# 307 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                               ((void *)0)
# 307 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                                   )
 { psf->error = 666 ;
  return 0 ;
  } ;
...
{ DITHER_DATA *pdither ;
 ...
 if ((pdither = psf->dither) == 
# 352 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c" 3 4
                               ((void *)0)
# 352 "/doner/libsndfile/libsndfile-5206a9b/src/dither.c"
                                   )
 { psf->error = 666 ;
  return 0 ;
  } ;
