# 1 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
...
# 21 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 32 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
...
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 2
# 79 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
enum
{ HAVE_RIFF = 0x01,
 HAVE_WAVE = 0x02,
 HAVE_fmt = 0x04,
...
# 139 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
...
{ WAVLIKE_PRIVATE * wpriv ;
 ...
 if ((wpriv = calloc (1, sizeof (WAVLIKE_PRIVATE))) == 
# 163 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                                      ((void *)0)
# 163 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                                          )
...
# 216 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                                                 ((void *)0)
# 216 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                                                     )
    return SFE_MALLOC_FAILED ;
...
# 294 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                     ((void *)0)
# 294 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                         )
  return SFE_INTERNAL ;
...
# 420 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                     1
# 420 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                             ) ;
   ...
   case (((uint32_t) (('c') | (('u') << 8) | (('e') << 16) | (((uint32_t) (' ')) << 24)))) :
     ...
     { uint32_t thisread, bytesread, cue_count, position, offset ;
      ...
      if ((psf->cues = psf_cues_alloc (cue_count)) == 
# 477 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                                     ((void *)0)
# 477 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                                         )
       return SFE_MALLOC_FAILED ;
...
# 639 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                 0
# 639 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                         ) ;
 ...
 psf_fseek (psf, psf->dataoffset, 
# 652 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                 0
# 652 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                         ) ;
...
{ WAVLIKE_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 884 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                     ((void *)0)
# 884 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { case SF_FORMAT_PCM_U8 :
  ...
  case SF_FORMAT_ALAW :
   ...
   break ;
# 993 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
  default : return SFE_UNIMPLEMENTED ;
  } ;
...
{ sf_count_t current ;
 ...
 psf->header.indx = 0 ;
 psf_fseek (psf, 0, 
# 1026 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                   0
# 1026 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                           ) ;
# 1036 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
 ...
 if (psf->peak_info != 
# 1064 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                      ((void *)0) 
# 1064 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                           && psf->peak_info->peak_loc == SF_PEAK_START)
  wavlike_write_peak_chunk (psf) ;

 if (psf->broadcast_16k != 
# 1067 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                          ((void *)0)
# 1067 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                              )
  wavlike_write_bext_chunk (psf) ;

 if (psf->cart_16k != 
# 1070 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                     ((void *)0)
# 1070 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                         )
  wavlike_write_cart_chunk (psf) ;

 if (psf->cues != 
# 1073 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                 ((void *)0)
# 1073 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                     )
 { uint32_t k ;

  psf_binheader_writef (psf, "em44", (((uint32_t) (('c') | (('u') << 8) | (('e') << 16) | (((uint32_t) (' ')) << 24)))), 4 + psf->cues->cue_count * 6 * 4, psf->cues->cue_count) ;
 ...
 if (psf->instrument != 
# 1084 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                       ((void *)0)
# 1084 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                           )
 { int tmp ;
 ...
 if (psf->header.indx + 16 < psf->dataoffset)
 {
  ...
  psf_binheader_writef (psf, "m4z", ((uint32_t) (('P') | (('A') << 8) | (('D') << 16) | (((uint32_t) (' ')) << 24))), k, k) ;
  } ;
 ...
 if (! has_data)
  psf_fseek (psf, psf->dataoffset, 
# 1132 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                  0
# 1132 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 1134 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                          0
# 1134 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                  ) ;
...
# 1153 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                               0
# 1153 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                       ) ;
 else
  psf->dataend = psf_fseek (psf, 0, 
# 1155 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                   2
# 1155 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                           ) ;
 ...
 if (psf->peak_info != 
# 1161 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                      ((void *)0) 
# 1161 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
...
{ WAVLIKE_PRIVATE *wpriv ;
 ...
 if ((wpriv = psf->container_data) == 
# 1204 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                     ((void *)0)
# 1204 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                         )
  return SFE_INTERNAL ;
...
# 1282 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                                   ((void *)0)
# 1282 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                                       )
  return SFE_MALLOC_FAILED ;
...
# 1401 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
static int
...
# 1432 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                                            ((void *)0)
# 1432 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                                                )
  return SFE_MALLOC_FAILED ;
...
{ int indx ;
 ...
 if (chunk_info->data == 
# 1478 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                        ((void *)0)
# 1478 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                            )
...
# 1485 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                                                   0
# 1485 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                                                           ) ;
 ...
 psf_fseek (psf, pos, 
# 1487 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c" 3 4
                     0
# 1487 "/doner/libsndfile/libsndfile-5206a9b/src/wav.c"
                             ) ;
