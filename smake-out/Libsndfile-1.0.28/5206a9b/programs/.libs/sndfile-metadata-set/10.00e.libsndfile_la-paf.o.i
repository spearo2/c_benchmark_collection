# 1 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 2
# 52 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
typedef struct
{ int version ;
 int endianness ;
 int samplerate ;
...
{ int subformat, error, endian ;
 ...
 { if ((((psf->sf.format) & SF_FORMAT_TYPEMASK)) != SF_FORMAT_PAF)
  ...
  if (endian == SF_ENDIAN_LITTLE || (1 && (endian == SF_ENDIAN_CPU)))
...
{ PAF_FMT paf_fmt ;
 ...
 if (marker == (((uint32_t) ((' ') | (('p') << 8) | (('a') << 16) | (((uint32_t) ('f')) << 24)))))
 ...
 else if (marker == (((uint32_t) (('f') | (('a') << 8) | (('p') << 16) | (((uint32_t) (' ')) << 24)))))
 { psf_binheader_readf (psf, "e444444", &(paf_fmt.version), &(paf_fmt.endianness),
   &(paf_fmt.samplerate), &(paf_fmt.format), &(paf_fmt.channels), &(paf_fmt.source)) ;
  }
 else
 ...
 if (paf_fmt.channels < 1 || paf_fmt.channels > 1024)
 ...
 { case PAF_PCM_S8 :
  ...
  case PAF_PCM_24 :
     ...
     psf->blockwidth = 0 ;
     psf->sf.frames = 10 * psf->datalength /
           (32 * psf->sf.channels) ;
     break ;
...
static int
paf_write_header (SF_PRIVATE *psf, int UNUSED_calc_length __attribute__ ((unused)))
{ int paf_format ;


 if (psf_ftell (psf) >= 2048)
  return 0 ;
 ...
 {
  psf_binheader_writef (psf, "Em444", (((uint32_t) ((' ') | (('p') << 8) | (('a') << 16) | (((uint32_t) ('f')) << 24)))), 0, 0, psf->sf.samplerate) ;

  psf_binheader_writef (psf, "E444", paf_format, psf->sf.channels, 0) ;
  }
 else if (psf->endian == SF_ENDIAN_LITTLE)
 {
  psf_binheader_writef (psf, "em444", (((uint32_t) (('f') | (('a') << 8) | (('p') << 16) | (((uint32_t) (' ')) << 24)))), 0, 1, psf->sf.samplerate) ;
...
# 339 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 psf->sf.frames = 10 * ppaf24->max_blocks ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 416 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 416 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
...
# 434 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                                                                   0
# 434 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                                                                           ) ;
  ...
  case SFM_WRITE :
    ...
    psf_fseek (psf, psf->dataoffset + newblock * ppaf24->blocksize, 
# 449 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                                                                   0
# 449 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                                                                           ) ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 467 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 467 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
...
{ int k, channel ;
 ...
 if (ppaf24->read_block * 10 > ppaf24->sample_count)
 { memset (ppaf24->samples, 0, 10 * ppaf24->channels) ;
  return 1 ;
  } ;
 ...
 if ((0 && psf->endian == SF_ENDIAN_LITTLE) || (1 && psf->endian == SF_ENDIAN_BIG))
...
{ int count, total = 0 ;
 ...
 { if (ppaf24->read_block * 10 >= ppaf24->sample_count)
  ...
  count = (10 - ppaf24->read_count) * ppaf24->channels ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 545 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 545 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 567 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 567 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 585 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 585 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 613 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 613 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ int k, nextsample, channel ;
 ...
 if (ppaf24->sample_count < ppaf24->write_block * 10 + ppaf24->write_count)
  ppaf24->sample_count = ppaf24->write_block * 10 + ppaf24->write_count ;
...
{ int count, total = 0 ;
 ...
 while (total < len)
 { count = (10 - ppaf24->write_count) * ppaf24->channels ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 714 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 714 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ PAF24_PRIVATE *ppaf24 ;
 ...
 if (psf->codec_data == 
# 739 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 739 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 766 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 766 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 797 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c" 3 4
                       ((void *)0)
# 797 "/doner/libsndfile/libsndfile-5206a9b/src/paf.c"
                           )
  return 0 ;
 ppaf24 = (PAF24_PRIVATE*) psf->codec_data ;
