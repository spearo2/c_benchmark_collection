# 1 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 32 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 34 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 35 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 2
# 46 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
...
{ int error ;
 ...
 { if (psf->is_pipe)
  ...
  if (psf->endian == 0 || psf->endian == SF_ENDIAN_CPU)
   psf->endian = (0) ? SF_ENDIAN_BIG : SF_ENDIAN_LITTLE ;
...
# 174 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                                                         ((void *)0)
# 174 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                                                             )
  sscanf (cptr, "channel_count -i %d", &(psf->sf.channels)) ;

 if ((cptr = strstr (psf_header, "sample_rate -i ")) != 
# 177 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                                                       ((void *)0)
# 177 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                                                           )
  sscanf (cptr, "sample_rate -i %d", &(psf->sf.samplerate)) ;

 if ((cptr = strstr (psf_header, "sample_count -i ")) != 
# 180 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                                                        ((void *)0)
# 180 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                                                            )
...
# 185 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                                                          ((void *)0)
# 185 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                                                              )
...
# 230 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                                 0
# 230 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                                         ) ;
 ...
 { case SF_FORMAT_ULAW :
  ...
  case SF_FORMAT_PCM_U8 :
   ...
   psf->sf.format = SF_FORMAT_NIST | ((psf->sf.format) & SF_FORMAT_SUBMASK) ;
   break ;
...
{ const char *end_str ;
 ...
 psf_fseek (psf, 0, 
# 317 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                   0
# 317 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                           ) ;
 ...
 psf_binheader_writef (psf, "z", (size_t) (1024 - psf->header.indx)) ;
...
# 368 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c" 3 4
                          0
# 368 "/doner/libsndfile/libsndfile-5206a9b/src/nist.c"
                                  ) ;
