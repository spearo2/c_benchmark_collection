# 1 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c"
# 32 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c"
...
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 35 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 37 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 40 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 41 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
# 42 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/ima_oki_adpcm.h" 1
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/ima_oki_adpcm.h"
typedef struct
{
...
# 43 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 2
...
{ IMA_OKI_ADPCM *pvox = 
# 72 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 3 4
                       ((void *)0) 
# 72 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c"
                            ;
 ...
 if ((pvox = malloc (sizeof (IMA_OKI_ADPCM))) == 
# 80 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 3 4
                                                ((void *)0)
# 80 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c"
                                                    )
 ...
 if (psf_fseek (psf, 0 , 
# 113 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c" 3 4
                        0
# 113 "/doner/libsndfile/libsndfile-5206a9b/src/vox_adpcm.c"
                                ) == -1)
  return SFE_BAD_SEEK ;
...
{ int indx = 0, k ;
 ...
 while (indx < len)
 { pvox->code_count = (len - indx > (256 *2)) ? 256 : (len - indx + 1) / 2 ;
...
{ int indx = 0, k ;
 ...
 while (indx < len)
 { pvox->pcm_count = (len - indx > (256 *2)) ? (256 *2) : len - indx ;
