# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c"
# 34 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c"
# 1 "../src/config.h" 1
# 35 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 37 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 40 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 41 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 43 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
# 45 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 2
...
{ SNDFILE *file ;
 ...
 const char *progname ;
 const char * filename = 
# 57 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 3 4
                        ((void *)0) 
# 57 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c"
                             ;
 int start ;
...
# 81 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c" 3 4
                                                      ((void *)0)
# 81 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c"
                                                          )
...
{ const char * str ;
 int k, do_all = 0 ;
# 147 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-metadata-get.c"
 if (argc == 0)
 { do_all = 1 ;
  argc = 1 ;
  } ;
 ...
 { if (do_all || strcmp (argv [k], "--all") == 0)
  ...
  if (do_all || strcmp (argv [k], "--bext-description") == 0) { printf ("%-20s : %.*s\n", "Description", (int) sizeof (binfo->description), binfo->description) ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--bext-originator") == 0) { printf ("%-20s : %.*s\n", "Originator", (int) sizeof (binfo->originator), binfo->originator) ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--bext-orig-ref") == 0) { printf ("%-20s : %.*s\n", "Origination ref", (int) sizeof (binfo->originator_reference), binfo->originator_reference) ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--bext-umid") == 0) { printf ("%-20s : %.*s\n", "UMID", (int) sizeof (binfo->umid), binfo->umid) ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--bext-orig-date") == 0) { printf ("%-20s : %.*s\n", "Origination date", (int) sizeof (binfo->origination_date), binfo->origination_date) ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--bext-orig-time") == 0) { printf ("%-20s : %.*s\n", "Origination time", (int) sizeof (binfo->origination_time), binfo->origination_time) ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--bext-coding-hist") == 0) { printf ("%-20s : %.*s\n", "Coding history", (int) sizeof (binfo->coding_history), binfo->coding_history) ; if (! do_all) continue ; } ; ;

  if (do_all || strcmp (argv [k], "--str-title") == 0) { str = sf_get_string (file, SF_STR_TITLE) ; printf ("%-20s : %s\n", "Name", str ? str : "") ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--str-copyright") == 0) { str = sf_get_string (file, SF_STR_COPYRIGHT) ; printf ("%-20s : %s\n", "Copyright", str ? str : "") ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--str-artist") == 0) { str = sf_get_string (file, SF_STR_ARTIST) ; printf ("%-20s : %s\n", "Artist", str ? str : "") ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--str-comment") == 0) { str = sf_get_string (file, SF_STR_COMMENT) ; printf ("%-20s : %s\n", "Comment", str ? str : "") ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--str-date") == 0) { str = sf_get_string (file, SF_STR_DATE) ; printf ("%-20s : %s\n", "Create date", str ? str : "") ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--str-album") == 0) { str = sf_get_string (file, SF_STR_ALBUM) ; printf ("%-20s : %s\n", "Album", str ? str : "") ; if (! do_all) continue ; } ; ;
  if (do_all || strcmp (argv [k], "--str-license") == 0) { str = sf_get_string (file, SF_STR_LICENSE) ; printf ("%-20s : %s\n", "License", str ? str : "") ; if (! do_all) continue ; } ; ;
