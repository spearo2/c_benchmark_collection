# 1 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
...
# 21 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2

# 1 "/doner/libsndfile/libsndfile-5206a9b/src/sndfile.h" 1
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/sndfile.h"
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.h" 1
# 72 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.h"
enum
{
...
# 329 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.h"
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 2
# 40 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
...
# 87 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
...
# 129 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                     ((void *)0)
# 129 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { case WAVE_FORMAT_PCM :
  case WAVE_FORMAT_IEEE_FLOAT :
    ...
    psf->bytewidth = (((wav_fmt->min.bitwidth) + 7) / 8) ;
    break ;
  ...
  case WAVE_FORMAT_MS_ADPCM :
    ...
    if (wav_fmt->msadpcm.numcoeffs > ((int) (sizeof (wav_fmt->msadpcm.coeffs) / sizeof ((wav_fmt->msadpcm.coeffs) [0]))))
    { psf_log_printf (psf, "  No. of Coeffs : %d (should be <= %d)\n", wav_fmt->msadpcm.numcoeffs, ((int) (sizeof (wav_fmt->msadpcm.coeffs) / sizeof ((wav_fmt->msadpcm.coeffs) [0])))) ;
     wav_fmt->msadpcm.numcoeffs = ((int) (sizeof (wav_fmt->msadpcm.coeffs) / sizeof ((wav_fmt->msadpcm.coeffs) [0]))) ;
     }
    else
...
# 332 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                                                                         ((void *)0)
# 332 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                                                                             )
     ...
     for (bit = k = 0 ; bit < ((int) (sizeof (channel_mask_bits) / sizeof ((channel_mask_bits) [0]))) && k < psf->sf.channels ; bit++)
     {
    ...
    psf_log_printf (psf, "\n") ;
    psf->bytewidth = (((wav_fmt->ext.bitwidth) + 7) / 8) ;
...
{ int chan, mask = 0, bit = -1, last_bit = -1 ;
 ...
 if (chan_map == 
# 465 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                ((void *)0)
# 465 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                    )
  return 0 ;
 ...
 { int k ;
  ...
  for (k = bit + 1 ; k < ((int) (sizeof (channel_mask_bits) / sizeof ((channel_mask_bits) [0]))) ; k++)
...
{ unsigned char buffer [4096] ;
 ...
 psf_fseek (psf, 3 * 4 * 50, 
# 506 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                            0
# 506 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                    ) ;
...
# 515 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                 0
# 515 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                         ) ;
...
{ { WAVE_FORMAT_PCM, "WAVE_FORMAT_PCM" },
 { WAVE_FORMAT_MS_ADPCM, "WAVE_FORMAT_MS_ADPCM" },
 { WAVE_FORMAT_IEEE_FLOAT, "WAVE_FORMAT_IEEE_FLOAT" },
 { WAVE_FORMAT_VSELP, "WAVE_FORMAT_VSELP" },
 { WAVE_FORMAT_IBM_CVSD, "WAVE_FORMAT_IBM_CVSD" },
 { WAVE_FORMAT_ALAW, "WAVE_FORMAT_ALAW" },
 { WAVE_FORMAT_MULAW, "WAVE_FORMAT_MULAW" },
 { WAVE_FORMAT_OKI_ADPCM, "WAVE_FORMAT_OKI_ADPCM" },
 { WAVE_FORMAT_IMA_ADPCM, "WAVE_FORMAT_IMA_ADPCM" },
 { WAVE_FORMAT_MEDIASPACE_ADPCM, "WAVE_FORMAT_MEDIASPACE_ADPCM" },
 { WAVE_FORMAT_SIERRA_ADPCM, "WAVE_FORMAT_SIERRA_ADPCM" },
 { WAVE_FORMAT_G723_ADPCM, "WAVE_FORMAT_G723_ADPCM" },
 { WAVE_FORMAT_DIGISTD, "WAVE_FORMAT_DIGISTD" },
 { WAVE_FORMAT_DIGIFIX, "WAVE_FORMAT_DIGIFIX" },
 { WAVE_FORMAT_DIALOGIC_OKI_ADPCM, "WAVE_FORMAT_DIALOGIC_OKI_ADPCM" },
 { WAVE_FORMAT_MEDIAVISION_ADPCM, "WAVE_FORMAT_MEDIAVISION_ADPCM" },
 { WAVE_FORMAT_CU_CODEC, "WAVE_FORMAT_CU_CODEC" },
 { WAVE_FORMAT_YAMAHA_ADPCM, "WAVE_FORMAT_YAMAHA_ADPCM" },
 { WAVE_FORMAT_SONARC, "WAVE_FORMAT_SONARC" },
 { WAVE_FORMAT_DSPGROUP_TRUESPEECH, "WAVE_FORMAT_DSPGROUP_TRUESPEECH" },
 { WAVE_FORMAT_ECHOSC1, "WAVE_FORMAT_ECHOSC1" },
 { WAVE_FORMAT_AUDIOFILE_AF36, "WAVE_FORMAT_AUDIOFILE_AF36" },
 { WAVE_FORMAT_APTX, "WAVE_FORMAT_APTX" },
 { WAVE_FORMAT_AUDIOFILE_AF10, "WAVE_FORMAT_AUDIOFILE_AF10" },
 { WAVE_FORMAT_PROSODY_1612, "WAVE_FORMAT_PROSODY_1612" },
 { WAVE_FORMAT_LRC, "WAVE_FORMAT_LRC" },
 { WAVE_FORMAT_DOLBY_AC2, "WAVE_FORMAT_DOLBY_AC2" },
 { WAVE_FORMAT_GSM610, "WAVE_FORMAT_GSM610" },
 { WAVE_FORMAT_MSNAUDIO, "WAVE_FORMAT_MSNAUDIO" },
 { WAVE_FORMAT_ANTEX_ADPCME, "WAVE_FORMAT_ANTEX_ADPCME" },
 { WAVE_FORMAT_CONTROL_RES_VQLPC, "WAVE_FORMAT_CONTROL_RES_VQLPC" },
 { WAVE_FORMAT_DIGIREAL, "WAVE_FORMAT_DIGIREAL" },
 { WAVE_FORMAT_DIGIADPCM, "WAVE_FORMAT_DIGIADPCM" },
 { WAVE_FORMAT_CONTROL_RES_CR10, "WAVE_FORMAT_CONTROL_RES_CR10" },
 { WAVE_FORMAT_NMS_VBXADPCM, "WAVE_FORMAT_NMS_VBXADPCM" },
 { WAVE_FORMAT_ROLAND_RDAC, "WAVE_FORMAT_ROLAND_RDAC" },
 ...
 { WAVE_FORMAT_DSAT, "WAVE_FORMAT_DSAT" },
 ...
 { WAVE_FORMAT_VOXARE_TQ60, "WAVE_FORMAT_VOXARE_TQ60" },
 { WAVE_FORMAT_MSRT24, "WAVE_FORMAT_MSRT24" },
 { WAVE_FORMAT_G729A, "WAVE_FORMAT_G729A" },
 { WAVE_FORMAT_MVI_MV12, "WAVE_FORMAT_MVI_MV12" },
 ...
 { IBM_FORMAT_MULAW, "IBM_FORMAT_MULAW" },
 { IBM_FORMAT_ALAW, "IBM_FORMAT_ALAW" },
 { IBM_FORMAT_ADPCM, "IBM_FORMAT_ADPCM" },
 ...
 { WAVE_FORMAT_BZV_DIGITAL, "WAVE_FORMAT_BZV_DIGITAL" },
 ...
 { WAVE_FORMAT_SOUNDSPACE_MUSICOMPRESS, "WAVE_FORMAT_SOUNDSPACE_MUSICOMPRESS" },
 { WAVE_FORMAT_DVM, "WAVE_FORMAT_DVM" },
 { WAVE_FORMAT_INTERWAV_VSC112, "WAVE_FORMAT_INTERWAV_VSC112" },
 { WAVE_FORMAT_IPP_ITU_G_723_1, "WAVE_FORMAT_IPP_ITU_G_723_1" },
...
# 728 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                                     ((void *)0)
# 728 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                                         )
...
# 762 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                          ((void *)0)
# 762 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                              )
  return -1 ;
...
# 814 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                           ((void *)0)
# 814 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                               )
 { psf->error = SFE_MALLOC_FAILED ;
  return psf->error ;
  } ;
...
{ SF_CART_INFO_16K *c ;
 ...
 if (psf->cart_16k == 
# 857 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                     ((void *)0)
# 857 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                         )
  return -1 ;
...
# 901 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                 1
# 901 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                         ) ;
...
# 952 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                                                              1
# 952 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                                                                      )) ;
     return 0 ;
...
# 1149 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                                              ((void *)0)
# 1149 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                                                  )
  return SFE_MALLOC_FAILED ;
...
# 1171 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                                     "l" "d" 
# 1171 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                                            "   %g\n",
...
{ int k ;
 ...
 if (psf->peak_info == 
# 1184 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                      ((void *)0)
# 1184 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                          )
  return ;
...
# 1188 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c" 3 4
                                          ((void *)0)
# 1188 "/doner/libsndfile/libsndfile-5206a9b/src/wavlike.c"
                                              )) ;
