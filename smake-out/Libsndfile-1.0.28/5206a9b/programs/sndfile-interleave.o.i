# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
# 33 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
...
# 34 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 2
...
# 35 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 2
# 1 "../src/sndfile.h" 1
# 33 "../src/sndfile.h"
...
# 37 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 2
...
{ STATE state ;
 ...
 for (k = 1 ; k < argc - 2 ; k++)
 {
  if ((state.infile [k - 1] = sf_open (argv [k], SFM_READ, &sfinfo)) == 
# 95 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 3 4
                                                                       ((void *)0)
# 95 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
                                                                           )
  { printf ("\nError : Not able to open input file '%s'\n%s\n", argv [k], sf_strerror (
# 96 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 3 4
                                                                                      ((void *)0)
# 96 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
                                                                                          )) ;
   exit (1) ;
   } ;
 ...
 if ((state.outfile = sf_open (argv [argc - 1], SFM_WRITE, &sfinfo)) == 
# 122 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 3 4
                                                                       ((void *)0)
# 122 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
                                                                           )
 { printf ("Not able to open output file '%s'\n%s\n", argv [argc - 1], sf_strerror (
# 123 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 3 4
                                                                                   ((void *)0)
# 123 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
                                                                                       )) ;
  exit (1) ;
  } ;
 ...
 for (k = 0 ; k < 16 ; k++)
  if (state.infile [k] != 
# 133 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c" 3 4
                         ((void *)0)
# 133 "/doner/libsndfile/libsndfile-5206a9b/programs/sndfile-interleave.c"
                             )
...
{ int max_read_len, read_len ;
 ...
 { max_read_len = 0 ;
  ...
  { read_len = sf_read_int (state->infile [ch], state->din.i, 4096) ;
   if (read_len < 4096)
    memset (state->din.i + read_len, 0, sizeof (state->din.i [0]) * (4096 - read_len)) ;
...
{ int max_read_len, read_len ;
 ...
 { max_read_len = 0 ;
  ...
  for (ch = 0 ; ch < state->channels ; ch ++)
  { read_len = sf_read_double (state->infile [ch], state->din.d, 4096) ;
   if (read_len < 4096)
    memset (state->din.d + read_len, 0, sizeof (state->din.d [0]) * (4096 - read_len)) ;
