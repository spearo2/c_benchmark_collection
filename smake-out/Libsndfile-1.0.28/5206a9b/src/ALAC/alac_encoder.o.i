# 1 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
...
# 32 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 34 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 40 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 41 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 42 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
# 44 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2

# 1 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/EndianPortable.h" 1
# 46 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 2
...
const uint32_t kALACEncoderMagic = ((uint32_t) (('d') | (('p') << 8) | (('g') << 16) | (((uint32_t) ('e')) << 24))) ;
...
# 101 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
...
# 221 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
static int32_t
EncodeStereo (ALAC_ENCODER *p, struct BitBuffer * bitstream, const int32_t * inputBuffer, uint32_t stride, uint32_t channelIndex, uint32_t numSamples)
{
 ...
 if (! ((p->mBitDepth == 16) || (p->mBitDepth == 20) || (p->mBitDepth == 24) || (p->mBitDepth == 32))) { return kALAC_ParamError ; } ;
 ...
 for (mixRes = 0 ; mixRes <= maxRes ; mixRes++)
 {
  ...
  pc_block (p->mMixBufferU, p->mPredictorU, numSamples / dilate, coefsU [numU - 1], numU, chanBits, 9) ;
  pc_block (p->mMixBufferV, p->mPredictorV, numSamples / dilate, coefsV [numV - 1], numV, chanBits, 9) ;


  set_ag_params (&agParams, 10, (pbFactor * 40) / 4, 14, numSamples / dilate, numSamples / dilate, 255) ;
 ...
 for (uint32_t numUV = kMinUV ; numUV <= kMaxUV ; numUV += 4)
 {
  ...
  {
   pc_block (p->mMixBufferU, p->mPredictorU, numSamples / dilate, coefsU [numUV-1], numUV, chanBits, 9) ;
   pc_block (p->mMixBufferV, p->mPredictorV, numSamples / dilate, coefsV [numUV-1], numUV, chanBits, 9) ;
  }
 ...
 escapeBits = (numSamples * p->mBitDepth * 2) + ((partialFrame == true) ? 32 : 0) + (2 * 8) ;
 ...
 if (doEscape == false)
 {
  ...
  BitBufferWrite (bitstream, (mode << 4) | 9, 8) ;
  ...
  if (mode == 0)
  {
   pc_block (p->mMixBufferU, p->mPredictorU, numSamples, coefsU [numU - 1], numU, chanBits, 9) ;
  }
  else
  {
   pc_block (p->mMixBufferU, p->mPredictorV, numSamples, coefsU [numU - 1], numU, chanBits, 9) ;
   pc_block (p->mPredictorV, p->mPredictorU, numSamples, 
# 451 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 3 4
                                                        ((void *)0)
# 451 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
                                                            , 31, chanBits, 0) ;
  }

  set_ag_params (&agParams, 10, (pbFactor * 40) / 4, 14, numSamples, numSamples, 255) ;
  ...
  if (mode == 0)
  {
   pc_block (p->mMixBufferV, p->mPredictorV, numSamples, coefsV [numV - 1], numV, chanBits, 9) ;
  }
  else
  {
   pc_block (p->mMixBufferV, p->mPredictorU, numSamples, coefsV [numV - 1], numV, chanBits, 9) ;
   pc_block (p->mPredictorU, p->mPredictorV, numSamples, 
# 466 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c" 3 4
                                                        ((void *)0)
# 466 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
                                                            , 31, chanBits, 0) ;
  }
...
EncodeMono (ALAC_ENCODER *p, struct BitBuffer * bitstream, const int32_t * inputBuffer, uint32_t stride, uint32_t channelIndex, uint32_t numSamples)
{
 ...
 escapeBits = (numSamples * p->mBitDepth) + ((partialFrame == true) ? 32 : 0) + (2 * 8) ;
 ...
 if (doEscape == false)
 {
  ...
  numU = bestU ;
  BitBufferWrite (bitstream, (0 << 4) | 9, 8) ;
  BitBufferWrite (bitstream, (pbFactor << 5) | numU, 8) ;
  for (indx = 0 ; indx < numU ; indx++)
   BitBufferWrite (bitstream, coefsU [numU-1][indx], 16) ;
...
# 960 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
int32_t
...
# 1078 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
 ...
 *ioNumBytes = outputSize ;
 ...
 p->mMaxFrameBytes = ((p->mMaxFrameBytes) > (outputSize) ? (p->mMaxFrameBytes) : (outputSize)) ;
...
# 1109 "/doner/libsndfile/libsndfile-5206a9b/src/ALAC/alac_encoder.c"
void
GetConfig (ALAC_ENCODER *p, ALACSpecificConfig * config)
{
 config->frameLength = ENDSWAP_32 (p->mFrameSize) ;
 ...
 config->maxRun = ENDSWAP_16 ((uint16_t) 255) ;
 config->maxFrameBytes = ENDSWAP_32 (p->mMaxFrameBytes) ;
 config->avgBitRate = ENDSWAP_32 (p->mAvgBitRate) ;
 config->sampleRate = ENDSWAP_32 (p->mOutputSampleRate) ;
}
...
alac_get_magic_cookie_size (uint32_t inNumChannels)
{
 if (inNumChannels > 2)
 {
  return sizeof (ALACSpecificConfig) + 12 + sizeof (ALACAudioChannelLayout) ;
 }
 else
 {
...
alac_get_magic_cookie (ALAC_ENCODER *p, void * outCookie, uint32_t * ioSize)
{
 ...
 uint8_t theChannelAtom [12] = { 0, 0, 0, 0, 'c', 'h', 'a', 'n', 0, 0, 0, 0 } ;
 ...
 {
  theChannelLayout.mChannelLayoutTag = ENDSWAP_32 (ALACChannelLayoutTags [theConfig.numChannels - 1]) ;
  theCookieSize += (sizeof (ALACAudioChannelLayout) + 12) ;
 }
 if (*ioSize >= theCookieSize)
 {
  memcpy (theCookiePointer, &theConfig, sizeof (ALACSpecificConfig)) ;
  theChannelAtom [3] = (sizeof (ALACAudioChannelLayout) + 12) ;
  if (theConfig.numChannels > 2)
  {
   theCookiePointer += sizeof (ALACSpecificConfig) ;
   memcpy (theCookiePointer, theChannelAtom, 12) ;
   theCookiePointer += 12 ;
...
alac_encoder_init (ALAC_ENCODER *p, uint32_t samplerate, uint32_t channels, uint32_t format_flags, uint32_t frameSize)
{
 ...
 p->mFrameSize = (frameSize > 0 && frameSize <= 4096) ? frameSize : 4096 ;
 ...
 for (int32_t channel = 0 ; channel < (int32_t) p->mNumChannels ; channel++)
 {
  ...
  {
   init_coefs (p->mCoefsU [channel][search], 9, kALACMaxCoefs) ;
   init_coefs (p->mCoefsV [channel][search], 9, kALACMaxCoefs) ;
  }
 }
