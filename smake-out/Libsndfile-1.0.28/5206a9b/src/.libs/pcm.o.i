# 1 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/pcm.c" 2
...
{ BUF_UNION ubuf ;
 ...
 bufferlen = sizeof (ubuf.ucbuf) / 3 ;

 while (len > 0)
 { if (len < bufferlen)
   bufferlen = (int) len ;
  readcount = psf_fread (ubuf.ucbuf, 3, bufferlen, psf) ;
...
{ BUF_UNION ubuf ;
 ...
 { if (len < bufferlen)
  ...
  writecount = psf_fwrite (ubuf.ucbuf, 3, bufferlen, psf) ;
  total += writecount ;
  if (writecount < bufferlen)
   break ;
  len -= writecount ;
