# 1 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/gsm.h" 1
# 16 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/gsm.h"
typedef struct gsm_state * gsm ;
typedef short gsm_signal ;
typedef unsigned char gsm_byte ;
typedef gsm_byte gsm_frame [33] ;
# 34 "/doner/libsndfile/libsndfile-5206a9b/src/GSM610/gsm.h"
gsm gsm_create (void) ;
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 2
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data != 
# 82 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 82 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
 ...
 if ((pgsm610 = calloc (1, sizeof (GSM610_PRIVATE))) == 
# 92 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                                                       ((void *)0)
# 92 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                                                           )
...
# 105 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                                           ((void *)0)
# 105 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                                               )
  return SFE_MALLOC_FAILED ;
 ...
 { if (psf->datalength % pgsm610->blocksize == 0)
  ...
  else if (psf->datalength % pgsm610->blocksize == 1 && pgsm610->blocksize == 33)
  {
...
# 155 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                                  0
# 155 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                                          ) ;
...
{ int k ;
 ...
 if ((k = psf_fread (pgsm610->block, 1, 65, psf)) != 65)
 ...
 if (gsm_decode (pgsm610->gsm_data, pgsm610->block + (65 + 1) / 2, pgsm610->samples + 320 / 2) < 0)
...
{ int k ;
 ...
 if ((k = psf_fread (pgsm610->block, 1, 33, psf)) != 33)
  psf_log_printf (psf, "*** Warning : short read (%d != %d).\n", k, 33) ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 271 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 271 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 298 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 298 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 325 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 325 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 356 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 356 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
static sf_count_t
gsm610_seek (SF_PRIVATE *psf, int UNUSED_mode __attribute__ ((unused)), sf_count_t offset)
{ GSM610_PRIVATE *pgsm610 ;
 int newblock, newsample ;

 if (psf->codec_data == 
# 379 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 379 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
 ...
 { int true_flag = 1 ;
  ...
  psf_fseek (psf, psf->dataoffset, 
# 391 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                                  0
# 391 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                                          ) ;
  pgsm610->blockcount = 0 ;
...
# 414 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                                                                          0
# 414 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                                                                                  ) ;
...
{ int k ;
 ...
 if ((k = psf_fwrite (pgsm610->block, 1, 33, psf)) != 33)
...
{ int k ;
 ...
 gsm_encode (pgsm610->gsm_data, pgsm610->samples, pgsm610->block) ;
 gsm_encode (pgsm610->gsm_data, pgsm610->samples+320 / 2, pgsm610->block+65 / 2) ;


 if ((k = psf_fwrite (pgsm610->block, 1, 65, psf)) != 65)
  psf_log_printf (psf, "*** Warning : short write (%d != %d).\n", k, 65) ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 501 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 501 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 528 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 528 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 555 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 555 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 584 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 584 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
 pgsm610 = (GSM610_PRIVATE*) psf->codec_data ;
...
{ GSM610_PRIVATE *pgsm610 ;
 ...
 if (psf->codec_data == 
# 608 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c" 3 4
                       ((void *)0)
# 608 "/doner/libsndfile/libsndfile-5206a9b/src/gsm610.c"
                           )
  return 0 ;
