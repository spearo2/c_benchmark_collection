# 1 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
...
# 21 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
...
# 32 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/chanmap.h" 1
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/chanmap.h"
typedef struct
{
...
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 2
# 116 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
enum
{ HAVE_FORM = 0x01,
 HAVE_AIFF = 0x02,
 HAVE_AIFC = 0x04,
...
{ COMM_CHUNK comm_fmt ;
 ...
 if ((psf->container_data = calloc (1, sizeof (AIFF_PRIVATE))) == 
# 243 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                                 ((void *)0)
# 243 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                                     )
...
# 254 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                  0
# 254 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                          ) ;
  } ;
...
# 265 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                                 ((void *)0)
# 265 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                                     )
    return SFE_MALLOC_FAILED ;
...
{ SSND_CHUNK ssnd_fmt ;
 ...
 if (psf->filelength > 0xffffffffL)
  psf_log_printf (psf, "Warning : filelength > 0xffffffff. This is bad!!!!\n") ;

 if ((paiff = psf->container_data) == 
# 409 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                     ((void *)0)
# 409 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { unsigned marker ;
  ...
  switch (marker)
  { case (((uint32_t) (('F') | (('O') << 8) | (('R') << 16) | (((uint32_t) ('M')) << 24)))) :
     if (found_chunk)
     ...
     switch (marker)
     { case (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) :
      case (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))) :
       found_chunk |= (marker == (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24))))) ? (HAVE_AIFC | HAVE_AIFF) : HAVE_AIFF ;
       break ;
      default :
       break ;
      } ;
     ...
     else if (FORMsize != psf->filelength - 2 * ((int) sizeof (chunk_size)))
   ...
   case (((uint32_t) (('C') | (('O') << 8) | (('M') << 16) | (((uint32_t) ('M')) << 24)))) :
   ...
   case (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))) :
     ...
     if ((psf->peak_info = peak_info_calloc (psf->sf.channels)) == 
# 501 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                                  ((void *)0)
# 501 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                                      )
      return SFE_MALLOC_FAILED ;
     ...
     { float value ;
      ...
      snprintf (cptr, sizeof (ubuf.scbuf), "    %2d   %-12" 
# 524 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                           "l" "d" 
# 524 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                                  "   %g\n",
   ...
   case (((uint32_t) (('S') | (('S') << 8) | (('N') << 16) | (((uint32_t) ('D')) << 24)))) :
     ...
     psf_fseek (psf, psf->dataoffset + psf->datalength, 
# 575 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                       0
# 575 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                               ) ;
     break ;

   case (((uint32_t) (('(') | (('c') << 8) | ((')') << 16) | (((uint32_t) (' ')) << 24)))) :
     if (chunk_size == 0)
      break ;
     if (chunk_size >= ((int) sizeof (ubuf.scbuf)))
   ...
   case (((uint32_t) (('A') | (('U') << 8) | (('T') << 16) | (((uint32_t) ('H')) << 24)))) :
     if (chunk_size == 0)
      break ;
     if (chunk_size >= ((int) sizeof (ubuf.scbuf)) - 1)
     { psf_log_printf (psf, " %M : %d (too big)\n", marker, chunk_size) ;
      return SFE_INTERNAL ;
      } ;
   ...
   case (((uint32_t) (('C') | (('O') << 8) | (('M') << 16) | (((uint32_t) ('T')) << 24)))) :
    { uint16_t count, id, len ;
     ...
     { bytes -= psf_binheader_readf (psf, "E422", &timestamp, &id, &len) ;
      ...
      if (len + 1 > ((int) sizeof (ubuf.scbuf)))
   ...
   case (((uint32_t) (('A') | (('P') << 8) | (('P') << 16) | (((uint32_t) ('L')) << 24)))) :
   ...
   case (((uint32_t) (('N') | (('A') << 8) | (('M') << 16) | (((uint32_t) ('E')) << 24)))) :
     if (chunk_size == 0)
      break ;
     if (chunk_size >= ((int) sizeof (ubuf.scbuf)) - 2)
     { psf_log_printf (psf, " %M : %d (too big)\n", marker, chunk_size) ;
      return SFE_INTERNAL ;
      } ;
   ...
   case (((uint32_t) (('A') | (('N') << 8) | (('N') << 16) | (((uint32_t) ('O')) << 24)))) :
     if (chunk_size == 0)
      break ;
     if (chunk_size >= ((int) sizeof (ubuf.scbuf)) - 2)
     { psf_log_printf (psf, " %M : %d (too big)\n", marker, chunk_size) ;
   ...
   case (((uint32_t) (('I') | (('N') << 8) | (('S') << 16) | (((uint32_t) ('T')) << 24)))) :
     if (chunk_size != 20)
     { psf_log_printf (psf, " %M : %d (should be %d)\n", marker, chunk_size, 20) ;
      psf_binheader_readf (psf, "j", chunk_size) ;
      break ;
      } ;
     psf_log_printf (psf, " %M : %d\n", marker, chunk_size) ;
     { uint8_t bytes [6] ;
      ...
      if (psf->instrument == 
# 718 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                            ((void *)0) 
# 718 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
...
# 718 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
   ...
   case (((uint32_t) (('b') | (('a') << 8) | (('s') << 16) | (((uint32_t) ('c')) << 24)))) :
   ...
   case (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))) :
     psf_log_printf (psf, " %M : %d\n", marker, chunk_size) ;
     { uint16_t mark_id, n = 0 ;
      ...
      if (paiff->markstr != 
# 789 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                           ((void *)0)
# 789 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                               )
      ...
      if (paiff->markstr == 
# 794 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                           ((void *)0)
# 794 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                               )
       return SFE_MALLOC_FAILED ;
      ...
      if ((psf->cues = psf_cues_alloc (mark_count)) == 
# 803 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                      ((void *)0)
# 803 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                          )
       return SFE_MALLOC_FAILED ;
      ...
      { uint32_t pstr_len ;
       ...
       psf->cues->cue_points [n].fcc_chunk = ((uint32_t) (('d') | (('a') << 8) | (('t') << 16) | (((uint32_t) ('a')) << 24))) ;
   ...
   case (((uint32_t) (('F') | (('V') << 8) | (('E') << 16) | (((uint32_t) ('R')) << 24)))) :
     found_chunk |= HAVE_FVER ;


   case (((uint32_t) (('S') | (('F') << 8) | (('X') << 16) | (((uint32_t) ('!')) << 24)))) :
     psf_log_printf (psf, " %M : %d\n", marker, chunk_size) ;
     psf_binheader_readf (psf, "j", chunk_size) ;
     break ;

   case (((uint32_t) (('N') | (('O') << 8) | (('N') << 16) | (((uint32_t) ('E')) << 24)))) :
   ...
   case (((uint32_t) (('C') | (('H') << 8) | (('A') << 16) | (((uint32_t) ('N')) << 24)))) :
     if (chunk_size < 12)
  ...
  if (psf_ftell (psf) >= psf->filelength - (2 * ((int) sizeof (int32_t))))
   break ;
  } ;
 ...
 { int ji, str_index ;
  ...
  { uint32_t j ;
   ...
   } else
   {
    free (psf->cues) ;
    psf->cues = 
# 946 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
               ((void *)0) 
# 946 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                    ;
    }
  } ;
...
{ AIFF_PRIVATE *paiff = psf->container_data ;
 ...
 if (paiff != 
# 975 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
             ((void *)0) 
# 975 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                  && paiff->markstr != 
# 975 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                       ((void *)0)
# 975 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
 ...
 { free (paiff->markstr) ;
  paiff->markstr = 
# 977 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                  ((void *)0) 
# 977 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                       ;
  } ;
...
{ BUF_UNION ubuf ;
 ...
 if (comm_fmt->size == 18)
  comm_fmt->encoding = (((uint32_t) (('N') | (('O') << 8) | (('N') << 16) | (((uint32_t) ('E')) << 24)))) ;
 else if (comm_fmt->size == 22)
  psf_binheader_readf (psf, "Em", &(comm_fmt->encoding)) ;
 else if (comm_fmt->size >= 24)
 { uint8_t encoding_len ;
  unsigned read_len ;

  psf_binheader_readf (psf, "Em1", &(comm_fmt->encoding), &encoding_len) ;

  comm_fmt->size = ({ typeof (sizeof (ubuf.scbuf)) sf_min_x2 = (sizeof (ubuf.scbuf)) ; typeof (make_size_t (comm_fmt->size)) sf_min_y2 = (make_size_t (comm_fmt->size)) ; (void) (&sf_min_x2 == &sf_min_y2) ; sf_min_x2 < sf_min_y2 ? sf_min_x2 : sf_min_y2 ; }) ;
  memset (ubuf.scbuf, 0, comm_fmt->size) ;
  read_len = comm_fmt->size - 24 + 1 ;
 ...
 if (comm_fmt->numChannels < 1 || comm_fmt->numChannels >= 1024)
 { psf_log_printf (psf, "  Channels    : %d (should be >= 1 and < %d)\n", comm_fmt->numChannels, 1024) ;
 ...
 if ((comm_fmt->encoding == (((uint32_t) (('f') | (('l') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24)))) || comm_fmt->encoding == (((uint32_t) (('F') | (('L') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24))))) && comm_fmt->sampleSize != 32)
 { psf_log_printf (psf, "  Sample Size : %d (should be 32)\n", comm_fmt->sampleSize) ;
  comm_fmt->sampleSize = 32 ;
  }
 else if ((comm_fmt->encoding == (((uint32_t) (('f') | (('l') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24)))) || comm_fmt->encoding == (((uint32_t) (('F') | (('L') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24))))) && comm_fmt->sampleSize != 64)
 ...
 psf->bytewidth = (((comm_fmt->sampleSize) + 7) / 8) ;
 ...
 { case (((uint32_t) (('N') | (('O') << 8) | (('N') << 16) | (((uint32_t) ('E')) << 24)))) :
  ...
  case (((uint32_t) (('t') | (('w') << 8) | (('o') << 16) | (((uint32_t) ('s')) << 24)))) :
  case (((uint32_t) (('i') | (('n') << 8) | (('2') << 16) | (((uint32_t) ('4')) << 24)))) :
  case (((uint32_t) (('i') | (('n') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24)))) :
    psf->sf.format = (SF_ENDIAN_BIG | SF_FORMAT_AIFF | subformat) ;
    break ;

  case (((uint32_t) (('s') | (('o') << 8) | (('w') << 16) | (((uint32_t) ('t')) << 24)))) :
  case (((uint32_t) (('4') | (('2') << 8) | (('n') << 16) | (((uint32_t) ('1')) << 24)))) :
  case (((uint32_t) (('2') | (('3') << 8) | (('n') << 16) | (((uint32_t) ('i')) << 24)))) :
    psf->endian = SF_ENDIAN_LITTLE ;
    psf->sf.format = (SF_ENDIAN_LITTLE | SF_FORMAT_AIFF | subformat) ;
    break ;

  case (((uint32_t) (('f') | (('l') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24)))) :
  case (((uint32_t) (('F') | (('L') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24)))) :
    psf->sf.format = (SF_FORMAT_AIFF | SF_FORMAT_FLOAT) ;
    break ;

  case (((uint32_t) (('u') | (('l') << 8) | (('a') << 16) | (((uint32_t) ('w')) << 24)))) :
  case (((uint32_t) (('U') | (('L') << 8) | (('A') << 16) | (((uint32_t) ('W')) << 24)))) :
    psf->sf.format = (SF_FORMAT_AIFF | SF_FORMAT_ULAW) ;
    break ;

  case (((uint32_t) (('a') | (('l') << 8) | (('a') << 16) | (((uint32_t) ('w')) << 24)))) :
  case (((uint32_t) (('A') | (('L') << 8) | (('A') << 16) | (((uint32_t) ('W')) << 24)))) :
    psf->sf.format = (SF_FORMAT_AIFF | SF_FORMAT_ALAW) ;
    break ;

  case (((uint32_t) (('f') | (('l') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24)))) :
  case (((uint32_t) (('F') | (('L') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24)))) :
    psf->sf.format = (SF_FORMAT_AIFF | SF_FORMAT_DOUBLE) ;
    break ;

  case (((uint32_t) (('r') | (('a') << 8) | (('w') << 16) | (((uint32_t) (' ')) << 24)))) :
    psf->sf.format = (SF_FORMAT_AIFF | SF_FORMAT_PCM_U8) ;
    break ;

  case (((uint32_t) (('D') | (('W') << 8) | (('V') << 16) | (((uint32_t) ('W')) << 24)))) :
  ...
  case (((uint32_t) (('G') | (('S') << 8) | (('M') << 16) | (((uint32_t) (' ')) << 24)))) :
    psf->sf.format = SF_FORMAT_AIFF ;
    psf->sf.format = (SF_FORMAT_AIFF | SF_FORMAT_GSM610) ;
    break ;


  case (((uint32_t) (('i') | (('m') << 8) | (('a') << 16) | (((uint32_t) ('4')) << 24)))) :
    psf->endian = SF_ENDIAN_BIG ;
...
aiff_rewrite_header (SF_PRIVATE *psf)
{
 ...
 psf_fseek (psf, 0, 
# 1160 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                   0
# 1160 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                           ) ;
 ...
 psf_binheader_writef (psf, "Etm8", (((uint32_t) (('F') | (('O') << 8) | (('R') << 16) | (((uint32_t) ('M')) << 24)))), psf->filelength - 8) ;


 if ((k = psf_find_read_chunk_m32 (&psf->rchunks, (((uint32_t) (('C') | (('O') << 8) | (('M') << 16) | (((uint32_t) ('M')) << 24)))))) >= 0)
 { psf->header.indx = psf->rchunks.chunks [k].offset - 8 ;
  comm_frames = psf->sf.frames ;
  comm_size = psf->rchunks.chunks [k].len ;
  psf_binheader_writef (psf, "Em42t4", (((uint32_t) (('C') | (('O') << 8) | (('M') << 16) | (((uint32_t) ('M')) << 24)))), comm_size, psf->sf.channels, comm_frames) ;
  } ;


 if ((k = psf_find_read_chunk_m32 (&psf->rchunks, (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))))) >= 0)
 { psf->header.indx = psf->rchunks.chunks [k].offset - 8 ;
  psf_binheader_writef (psf, "Em4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "E44", 1, time (
# 1180 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                            ((void *)0)
# 1180 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                )) ;
 ...
 if ((k = psf_find_read_chunk_m32 (&psf->rchunks, (((uint32_t) (('S') | (('S') << 8) | (('N') << 16) | (((uint32_t) ('D')) << 24)))))) >= 0)
 { psf->header.indx = psf->rchunks.chunks [k].offset - 8 ;
  psf_binheader_writef (psf, "Etm8", (((uint32_t) (('S') | (('S') << 8) | (('N') << 16) | (((uint32_t) ('D')) << 24)))), psf->datalength + 8) ;
  } ;


 psf_fseek (psf, 0, 
# 1193 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                   0
# 1193 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                           ) ;
...
{ sf_count_t current ;
 ...
 if ((paiff = psf->container_data) == 
# 1223 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                     ((void *)0)
# 1223 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                         )
  return SFE_INTERNAL ;
 ...
 { aiff_rewrite_header (psf) ;
  if (current > 0)
   psf_fseek (psf, current, 
# 1245 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                           0
# 1245 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                   ) ;
  return 0 ;
  } ;

 endian = ((psf->sf.format) & SF_FORMAT_ENDMASK) ;
 if (1 && endian == SF_ENDIAN_CPU)
 ...
 switch (((psf->sf.format) & SF_FORMAT_SUBMASK) | endian)
 { case SF_FORMAT_PCM_S8 | SF_ENDIAN_BIG :
   psf->endian = SF_ENDIAN_BIG ;
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
   comm_size = 24 ;
   comm_encoding = (((uint32_t) (('t') | (('w') << 8) | (('o') << 16) | (((uint32_t) ('s')) << 24)))) ;
   break ;
  ...
  case SF_FORMAT_PCM_S8 | SF_ENDIAN_LITTLE :
   ...
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
   comm_size = 24 ;
   comm_encoding = (((uint32_t) (('s') | (('o') << 8) | (('w') << 16) | (((uint32_t) ('t')) << 24)))) ;
   break ;
  ...
  case SF_FORMAT_PCM_24 | SF_ENDIAN_BIG :
   ...
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
   comm_size = 24 ;
   comm_encoding = (((uint32_t) (('i') | (('n') << 8) | (('2') << 16) | (((uint32_t) ('4')) << 24)))) ;
   break ;
  ...
  case SF_FORMAT_PCM_24 | SF_ENDIAN_LITTLE :
   ...
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
   comm_size = 24 ;
   comm_encoding = (((uint32_t) (('4') | (('2') << 8) | (('n') << 16) | (((uint32_t) ('1')) << 24)))) ;
   break ;
  ...
  case SF_FORMAT_PCM_32 | SF_ENDIAN_BIG :
   ...
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
   comm_size = 24 ;
   comm_encoding = (((uint32_t) (('i') | (('n') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24)))) ;
   break ;
  ...
  case SF_FORMAT_PCM_32 | SF_ENDIAN_LITTLE :
   ...
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
   comm_size = 24 ;
   comm_encoding = (((uint32_t) (('2') | (('3') << 8) | (('n') << 16) | (((uint32_t) ('i')) << 24)))) ;
   break ;
  ...
  case SF_FORMAT_PCM_32 :
   psf->endian = SF_ENDIAN_BIG ;
   comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('F')) << 24)))) ;
   comm_size = 18 ;
   comm_encoding = 0 ;
   break ;
  ...
  case SF_FORMAT_FLOAT :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('F') | (('L') << 8) | (('3') << 16) | (((uint32_t) ('2')) << 24)))) ;
    break ;
  ...
  case SF_FORMAT_DOUBLE :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('F') | (('L') << 8) | (('6') << 16) | (((uint32_t) ('4')) << 24)))) ;
    break ;
  ...
  case SF_FORMAT_ULAW :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('u') | (('l') << 8) | (('a') << 16) | (((uint32_t) ('w')) << 24)))) ;
    break ;
  ...
  case SF_FORMAT_ALAW :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('a') | (('l') << 8) | (('a') << 16) | (((uint32_t) ('w')) << 24)))) ;
    break ;
  ...
  case SF_FORMAT_PCM_U8 :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('r') | (('a') << 8) | (('w') << 16) | (((uint32_t) (' ')) << 24)))) ;
    break ;
  ...
  case SF_FORMAT_DWVW_12 :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('D') | (('W') << 8) | (('V') << 16) | (((uint32_t) ('W')) << 24)))) ;
  ...
  case SF_FORMAT_GSM610 :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('G') | (('S') << 8) | (('M') << 16) | (((uint32_t) (' ')) << 24)))) ;
  ...
  case SF_FORMAT_IMA_ADPCM :
    ...
    comm_type = (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))) ;
    comm_size = 24 ;
    comm_encoding = (((uint32_t) (('i') | (('m') << 8) | (('a') << 16) | (((uint32_t) ('4')) << 24)))) ;


    bit_width = 16 ;
    comm_frames = psf->sf.frames / 64 ;
    break ;
 ...
 psf->header.indx = 0 ;
 psf_fseek (psf, 0, 
# 1416 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                   0
# 1416 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                           ) ;

 psf_binheader_writef (psf, "Etm8", (((uint32_t) (('F') | (('O') << 8) | (('R') << 16) | (((uint32_t) ('M')) << 24)))), psf->filelength - 8) ;


 if (comm_type == (((uint32_t) (('A') | (('I') << 8) | (('F') << 16) | (((uint32_t) ('C')) << 24)))))

  psf_binheader_writef (psf, "Emm44", comm_type, (((uint32_t) (('F') | (('V') << 8) | (('E') << 16) | (((uint32_t) ('R')) << 24)))), 4, 0xA2805140) ;
 else
 ...
 psf_binheader_writef (psf, "Em42t42", (((uint32_t) (('C') | (('O') << 8) | (('M') << 16) | (((uint32_t) ('M')) << 24)))), comm_size, psf->sf.channels, comm_frames, bit_width) ;
 ...
 if (psf->channel_map && paiff->chanmap_tag)
  psf_binheader_writef (psf, "Em4444", (((uint32_t) (('C') | (('H') << 8) | (('A') << 16) | (((uint32_t) ('N')) << 24)))), 12, paiff->chanmap_tag, 0, 0) ;


 if (psf->instrument != 
# 1443 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                       ((void *)0) 
# 1443 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                            && psf->cues != 
# 1443 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                            ((void *)0)
# 1443 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                )
 {
  ...
  if (psf->instrument->loops [0].mode != SF_LOOP_NONE && psf->instrument->loops [1].mode != SF_LOOP_NONE)
  {
   psf_binheader_writef (psf, "Em42 241b 241b 241b 241b",
     (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))), 2 + 2 * (2 + 4 + 1 + 19) + 2 * (2 + 4 + 1 + 17) + psf->cues->cue_count * (2 + 4) + totalStringLength, 4 + psf->cues->cue_count,
  ...
  else if (psf->instrument->loops [0].mode != SF_LOOP_NONE && psf->instrument->loops [1].mode == SF_LOOP_NONE)
  {
   psf_binheader_writef (psf, "Em42241b241b",
     (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))), 2 + (2 + 4 + 1 + 19) + (2 + 4 + 1 + 17) + psf->cues->cue_count * (2 + 4) + totalStringLength, 2 + psf->cues->cue_count,
     1, psf->instrument->loops [0].start, 18, "sustain loop start", make_size_t (19),
     2, psf->instrument->loops [0].end, 16, "sustain loop end", make_size_t (17)) ;
  ...
  psf_binheader_writef (psf, "Em4111111", (((uint32_t) (('I') | (('N') << 8) | (('S') << 16) | (((uint32_t) ('T')) << 24)))), 20, psf->instrument->basenote, psf->instrument->detune,
 ...
 else if (psf->instrument != 
# 1523 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                            ((void *)0) 
# 1523 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                 && psf->cues == 
# 1523 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                 ((void *)0)
# 1523 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                     )
 {
  ...
  {
   psf_binheader_writef (psf, "Em42 241b 241b 241b 241b",
     (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))), 2 + 2 * (2 + 4 + 1 + 19) + 2 * (2 + 4 + 1 + 17), 4,
     1, psf->instrument->loops [0].start, 18, "sustain loop start", make_size_t (19),
     2, psf->instrument->loops [0].end, 16, "sustain loop end", make_size_t (17),
     3, psf->instrument->loops [1].start, 18, "release loop start", make_size_t (19),
     4, psf->instrument->loops [1].end, 16, "release loop end", make_size_t (17)) ;
  ...
  {
   psf_binheader_writef (psf, "Em42241b241b",
     (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))), 2 + (2 + 4 + 1 + 19) + (2 + 4 + 1 + 17), 2,
     1, psf->instrument->loops [0].start, 18, "sustain loop start", make_size_t (19),
     2, psf->instrument->loops [0].end, 16, "sustain loop end", make_size_t (17)) ;
...
# 1580 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                            ((void *)0) 
# 1580 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                 && psf->cues != 
# 1580 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                 ((void *)0)
# 1580 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                     )
 {
  ...
  psf_binheader_writef (psf, "Em42",
   (((uint32_t) (('M') | (('A') << 8) | (('R') << 16) | (((uint32_t) ('K')) << 24)))), 2 + psf->cues->cue_count * (2 + 4) + totalStringLength, psf->cues->cue_count) ;
 ...
 if (psf->peak_info != 
# 1601 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                      ((void *)0) 
# 1601 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                           && psf->peak_info->peak_loc == SF_PEAK_START)
 { psf_binheader_writef (psf, "Em4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "E44", 1, time (
# 1603 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                            ((void *)0)
# 1603 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                )) ;
  for (k = 0 ; k < psf->sf.channels ; k++)
 ...
 psf_binheader_writef (psf, "Etm844", (((uint32_t) (('S') | (('S') << 8) | (('N') << 16) | (((uint32_t) ('D')) << 24)))), psf->datalength + 8, 0, 0) ;
 ...
 if (! has_data)
  psf_fseek (psf, psf->dataoffset, 
# 1628 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                  0
# 1628 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                          ) ;
 else if (current > 0)
  psf_fseek (psf, current, 
# 1630 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                          0
# 1630 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                  ) ;
...
{ int k ;
 ...
 psf->dataend = psf_fseek (psf, 0, 
# 1643 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                  2
# 1643 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                          ) ;
 ...
 if (psf->peak_info != 
# 1651 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                      ((void *)0) 
# 1651 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                           && psf->peak_info->peak_loc == SF_PEAK_END)
 { psf_binheader_writef (psf, "Em4", (((uint32_t) (('P') | (('E') << 8) | (('A') << 16) | (((uint32_t) ('K')) << 24)))), (2 * sizeof (int) + psf->sf.channels * (sizeof (float) + sizeof (int)))) ;
  psf_binheader_writef (psf, "E44", 1, time (
# 1653 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                            ((void *)0)
# 1653 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                )) ;
  for (k = 0 ; k < psf->sf.channels ; k++)
   psf_binheader_writef (psf, "Eft8", (float) psf->peak_info->peaks [k].value, psf->peak_info->peaks [k].position) ;
  } ;
...
{ int k, slen ;
 ...
 { if (psf->strings.data [k].type == 0)
  ...
  { case SF_STR_SOFTWARE :
    ...
    psf_binheader_writef (psf, "Em4mb", (((uint32_t) (('A') | (('P') << 8) | (('P') << 16) | (((uint32_t) ('L')) << 24)))), slen + 4, (((uint32_t) (('m') | (('3') << 8) | (('g') << 16) | (((uint32_t) ('a')) << 24)))), psf->strings.storage + psf->strings.data [k].offset, make_size_t (slen + (slen & 1))) ;
    break ;

   case SF_STR_TITLE :
    psf_binheader_writef (psf, "EmS", (((uint32_t) (('N') | (('A') << 8) | (('M') << 16) | (((uint32_t) ('E')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_COPYRIGHT :
    psf_binheader_writef (psf, "EmS", (((uint32_t) (('(') | (('c') << 8) | ((')') << 16) | (((uint32_t) (' ')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_ARTIST :
    psf_binheader_writef (psf, "EmS", (((uint32_t) (('A') | (('U') << 8) | (('T') << 16) | (((uint32_t) ('H')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;

   case SF_STR_COMMENT :
    psf_binheader_writef (psf, "EmS", (((uint32_t) (('A') | (('N') << 8) | (('N') << 16) | (((uint32_t) ('O')) << 24)))), psf->strings.storage + psf->strings.data [k].offset) ;
    break ;
...
static int
aiff_command (SF_PRIVATE * psf, int command, void * UNUSED_data __attribute__ ((unused)), int UNUSED_datasize __attribute__ ((unused)))
{ AIFF_PRIVATE *paiff ;

 if ((paiff = psf->container_data) == 
# 1716 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                     ((void *)0)
# 1716 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                         )
  return SFE_INTERNAL ;
...
# 1762 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
static int
...
{ const char * type_str ;
 ...
 if ((psf->loop_info = calloc (1, sizeof (SF_LOOP_INFO))) == 
# 1869 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                            ((void *)0)
# 1869 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                                )
  return SFE_MALLOC_FAILED ;
...
{ const AIFF_CAF_CHANNEL_MAP * map_info ;
 ...
 if ((map_info = aiff_caf_of_channel_layout_tag (layout_tag)) == 
# 1897 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                                ((void *)0)
# 1897 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                                    )
  return 0 ;
 ...
 if (map_info->channel_map != 
# 1907 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                             ((void *)0)
# 1907 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                 )
 { size_t chanmap_size = psf->sf.channels * sizeof (psf->channel_map [0]) ;

  free (psf->channel_map) ;

  if ((psf->channel_map = malloc (chanmap_size)) == 
# 1912 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                   ((void *)0)
# 1912 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                       )
   return SFE_MALLOC_FAILED ;
...
{ sf_count_t pos ;
 ...
 if (chunk_info->data == 
# 1954 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                        ((void *)0)
# 1954 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                            )
 ...
 pos = psf_ftell (psf) ;
 psf_fseek (psf, psf->rchunks.chunks [indx].offset, 
# 1961 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                                                   0
# 1961 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                                                           ) ;
 psf_fread (chunk_info->data, ({ typeof (chunk_info->datalen) sf_min_x2 = (chunk_info->datalen) ; typeof (psf->rchunks.chunks [indx].len) sf_min_y2 = (psf->rchunks.chunks [indx].len) ; (void) (&sf_min_x2 == &sf_min_y2) ; sf_min_x2 < sf_min_y2 ? sf_min_x2 : sf_min_y2 ; }), 1, psf) ;
 psf_fseek (psf, pos, 
# 1963 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c" 3 4
                     0
# 1963 "/doner/libsndfile/libsndfile-5206a9b/src/aiff.c"
                             ) ;
