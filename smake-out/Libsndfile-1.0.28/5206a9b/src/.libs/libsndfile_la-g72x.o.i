# 1 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 2
...
{ G72x_PRIVATE *pg72x ;
 ...
 if (psf->codec_data != 
# 75 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 75 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
 ...
 if ((pg72x = calloc (1, sizeof (G72x_PRIVATE))) == 
# 85 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                                                   ((void *)0)
# 85 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                                                       )
 ...
 { pg72x->private = g72x_reader_init (codec, &(pg72x->blocksize), &(pg72x->samplesperblock)) ;
  if (pg72x->private == 
# 125 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 125 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
   return SFE_MALLOC_FAILED ;
 ...
 { pg72x->private = g72x_writer_init (codec, &(pg72x->blocksize), &(pg72x->samplesperblock)) ;
  if (pg72x->private == 
# 150 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 150 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
   return SFE_MALLOC_FAILED ;
...
{ int k ;
 ...
 { memset (pg72x->samples, 0, (3 * 5 * 8) * sizeof (short)) ;
  return 1 ;
  } ;
...
{ G72x_PRIVATE *pg72x ;
 ...
 if (psf->codec_data == 
# 233 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 233 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 260 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 260 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;

 sptr = ubuf.sbuf ;
 bufferlen = (8192) / sizeof (short) ;
 while (len > 0)
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 291 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 291 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 323 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 323 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;
...
static sf_count_t
g72x_seek (SF_PRIVATE *psf, int UNUSED_mode __attribute__ ((unused)), sf_count_t UNUSED_offset __attribute__ ((unused)))
{
 ...
 return 0 ;
# 421 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
}
...
{ G72x_PRIVATE *pg72x ;
 ...
 if (psf->codec_data == 
# 475 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 475 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 501 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 501 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 530 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 530 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 562 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c" 3 4
                       ((void *)0)
# 562 "/doner/libsndfile/libsndfile-5206a9b/src/g72x.c"
                           )
  return 0 ;
 pg72x = (G72x_PRIVATE*) psf->codec_data ;
...
{ G72x_PRIVATE *pg72x ;
 ...
 if (psf->file.mode == SFM_WRITE)
 {
  ...
  if (pg72x->sample_curr && pg72x->sample_curr < (3 * 5 * 8))
   psf_g72x_encode_block (psf, pg72x) ;
