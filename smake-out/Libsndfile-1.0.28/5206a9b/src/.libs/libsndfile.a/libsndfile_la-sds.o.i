# 1 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 26 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 2
# 47 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
...
{ SDS_PRIVATE *psds ;
 ...
 { if (sds_write_header (psf, SF_FALSE))
  ...
  psf_fseek (psf, 0x15, 
# 130 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                  0
# 130 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                          ) ;
  } ;
...
sds_close (SF_PRIVATE *psf)
{
 ...
 { SDS_PRIVATE *psds ;
  ...
  if ((psds = (SDS_PRIVATE *) psf->codec_data) == 
# 154 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                                 ((void *)0)
# 154 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                                     )
...
{ unsigned char channel, bitwidth, loop_type, byte ;
 ...
 sample_no = (((sample_no) & 0x7F) | (((sample_no) & 0x7F00) >> 1) | (((sample_no) & 0x7F0000) >> 2)) ;
 ...
 samp_period = (((samp_period) & 0x7F) | (((samp_period) & 0x7F00) >> 1) | (((samp_period) & 0x7F0000) >> 2)) ;
 ...
 data_length = (((data_length) & 0x7F) | (((data_length) & 0x7F00) >> 1) | (((data_length) & 0x7F0000) >> 2)) ;

 psf->sf.frames = psds->frames = data_length ;

 sustain_loop_start = (((sustain_loop_start) & 0x7F) | (((sustain_loop_start) & 0x7F00) >> 1) | (((sustain_loop_start) & 0x7F0000) >> 2)) ;
 sustain_loop_end = (((sustain_loop_end) & 0x7F) | (((sustain_loop_end) & 0x7F00) >> 1) | (((sustain_loop_end) & 0x7F0000) >> 2)) ;
 ...
 for (blockcount = 0 ; bytesread < psf->filelength ; blockcount++)
 {
  ...
  psf_fseek (psf, 127 - 2, 
# 289 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                     1
# 289 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                             ) ;
  bytesread += 127 - 2 ;
  } ;
 ...
 psf_fseek (psf, 0x15, 
# 331 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                 0
# 331 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                         ) ;
...
{ SDS_PRIVATE *psds ;
 ...
 if ((psds = (SDS_PRIVATE *) psf->codec_data) == 
# 343 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                                ((void *)0)
# 343 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                                    )
 { psf_log_printf (psf, "*** Bad psf->codec_data ptr.\n") ;
  return SFE_INTERNAL ;
  } ;
 ...
 { int current_count = psds->write_count ;
  ...
  psf_fseek (psf, -1 * 127, 
# 362 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                      1
# 362 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                              ) ;
 ...
 if (psf->is_pipe == SF_FALSE)
  psf_fseek (psf, 0, 
# 373 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                    0
# 373 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                            ) ;
 ...
 samp_period = (((1000000000 / psf->sf.samplerate) & 0x7F) | (((1000000000 / psf->sf.samplerate) << 1) & 0x7F00) | (((1000000000 / psf->sf.samplerate) << 2) & 0x7F0000)) ;

 psf_binheader_writef (psf, "e213", 0, psds->bitwidth, samp_period) ;

 data_length = (((psds->total_written) & 0x7F) | (((psds->total_written) << 1) & 0x7F00) | (((psds->total_written) << 2) & 0x7F0000)) ;
 sustain_loop_start = (((0) & 0x7F) | (((0) << 1) & 0x7F00) | (((0) << 2) & 0x7F0000)) ;
 sustain_loop_end = (((0) & 0x7F) | (((0) << 1) & 0x7F00) | (((0) << 2) & 0x7F0000)) ;
 ...
 psf->datalength = psds->write_block * 127 ;

 if (current > 0)
  psf_fseek (psf, current, 
# 411 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                          0
# 411 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                  ) ;
...
{ unsigned char *ucptr, checksum ;
 ...
 if ((k = psf_fread (psds->read_data, 1, 127, psf)) != 127)
 ...
 if (checksum != psds->read_data [127 - 2])
 { psf_log_printf (psf, "Block %d : checksum is %02X should be %02X\n", psds->read_data [4], checksum, psds->read_data [127 - 2]) ;
  } ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 561 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 561 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
...
{ SDS_PRIVATE *psds ;
 ...
 if (psf->codec_data == 
# 584 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 584 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 602 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 602 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 634 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 634 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ SDS_PRIVATE *psds ;
 ...
 if ((psds = psf->codec_data) == 
# 690 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                ((void *)0)
# 690 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                    )
 ...
 { case SFM_READ :
   ...
   file_offset = psf->dataoffset + newblock * 127 ;

   if (psf_fseek (psf, file_offset, 
# 720 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                   0
# 720 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                           ) != file_offset)
  ...
  case SFM_WRITE :
   ...
   if (psf_fseek (psf, file_offset, 
# 738 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                                   0
# 738 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                                           ) != file_offset)
   { psf->error = SFE_SEEK_FAILED ;
    return ((sf_count_t) -1) ;
    } ;
...
{ unsigned char *ucptr, checksum ;
 ...
 psds->write_data [2] = 0 ;
 psds->write_data [3] = 2 ;
 psds->write_data [4] = psds->write_block & 0x7F ;
 ...
 psds->write_data [127 - 2] = checksum ;
 psds->write_data [127 - 1] = 0xF7 ;

 if ((k = psf_fwrite (psds->write_data, 1, 127, psf)) != 127)
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 903 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 903 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
...
{ SDS_PRIVATE *psds ;
 ...
 if (psf->codec_data == 
# 927 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 927 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
 psds->total_written += len ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 946 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 946 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
 psds->total_written += len ;
...
{ BUF_UNION ubuf ;
 ...
 if (psf->codec_data == 
# 979 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c" 3 4
                       ((void *)0)
# 979 "/doner/libsndfile/libsndfile-5206a9b/src/sds.c"
                           )
  return 0 ;
 psds = (SDS_PRIVATE*) psf->codec_data ;
 psds->total_written += len ;
