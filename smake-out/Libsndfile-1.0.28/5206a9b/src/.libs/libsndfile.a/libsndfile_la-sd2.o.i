# 1 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
# 30 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
...
# 31 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 33 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 34 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 35 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 36 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 38 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 39 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
...
# 40 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 2
# 53 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
enum
{ RSRC_STR = 111,
 RSRC_BIN
} ;
...
{ int subformat, error = 0, valid ;
 ...
 { psf->rsrc.mode = psf->file.mode ;
  ...
  psf->write_header = 
# 141 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 3 4
                     ((void *)0) 
# 141 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
                          ;
  } ;
...
# 161 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 3 4
                                 0
# 161 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
                                         ) ;
...
static int
sd2_write_rsrc_fork (SF_PRIVATE *psf, int UNUSED_calc_length __attribute__ ((unused)))
{ SD2_RSRC rsrc ;
 STR_RSRC str_rsrc [] =
 ...
 for (k = 0 ; k < ((int) (sizeof (str_rsrc) / sizeof ((str_rsrc) [0]))) ; k++)
 ...
 psf_binheader_writef (psf, "Eo2mm", make_size_t (0x50), 0, ((uint32_t) (('S') | (('d') << 8) | (('2') << 16) | (((uint32_t) ('f')) << 24))), ((uint32_t) (('l') | (('s') << 8) | (('f') << 16) | (((uint32_t) ('1')) << 24)))) ;
 ...
 rsrc.str_count = 3 ;
 psf_binheader_writef (psf, "Eom22", make_size_t (rsrc.type_offset), ((uint32_t) (('S') | (('T') << 8) | (('R') << 16) | (((uint32_t) (' ')) << 24))), rsrc.str_count - 1, 0x12) ;


 psf_binheader_writef (psf, "Em22", ((uint32_t) (('s') | (('d') << 8) | (('M') << 16) | (((uint32_t) ('L')) << 24))), 0, 0x36) ;
...
{ SD2_RSRC rsrc ;
 ...
 { if (rsrc.type_offset + k * 8 > rsrc.rsrc_len)
  ...
  if (marker == ((uint32_t) (('S') | (('T') << 8) | (('R') << 16) | (((uint32_t) (' ')) << 24))))
  { rsrc.str_index = k ;
...
{ char name [32], value [32] ;
 ...
 { int slen ;
  ...
  read_rsrc_str (rsrc, str_offset + 1, name, ({ typeof (((int) sizeof (name))) sf_min_x2 = (((int) sizeof (name))) ; typeof (slen + 1) sf_min_y2 = (slen + 1) ; (void) (&sf_min_x2 == &sf_min_y2) ; sf_min_x2 < sf_min_y2 ? sf_min_x2 : sf_min_y2 ; })) ;
  str_offset += slen + 1 ;
  ...
  read_rsrc_str (rsrc, data_offset + 5, value, ({ typeof (((int) sizeof (value))) sf_min_x2 = (((int) sizeof (value))) ; typeof (slen + 1) sf_min_y2 = (slen + 1) ; (void) (&sf_min_x2 == &sf_min_y2) ; sf_min_x2 < sf_min_y2 ? sf_min_x2 : sf_min_y2 ; })) ;

  psf_log_printf (psf, "  0x%04x     %4d     %4d     %3d    '%s'\n", data_offset, rsrc_id, data_len, slen, value) ;

  if (rsrc_id == 1000 && rsrc->sample_size == 0)
   rsrc->sample_size = strtol (value, 
# 546 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 3 4
                                     ((void *)0)
# 546 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
                                         , 10) ;
  else if (rsrc_id == 1001 && rsrc->sample_rate == 0)
   rsrc->sample_rate = strtol (value, 
# 548 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 3 4
                                     ((void *)0)
# 548 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
                                         , 10) ;
  else if (rsrc_id == 1002 && rsrc->channels == 0)
   rsrc->channels = strtol (value, 
# 550 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c" 3 4
                                  ((void *)0)
# 550 "/doner/libsndfile/libsndfile-5206a9b/src/sd2.c"
                                      , 10) ;
  } ;
