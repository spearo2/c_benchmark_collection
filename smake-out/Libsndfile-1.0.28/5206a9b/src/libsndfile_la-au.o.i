# 1 "/doner/libsndfile/libsndfile-5206a9b/src/au.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/au.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/au.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 2
# 43 "/doner/libsndfile/libsndfile-5206a9b/src/au.c"
enum
...
{ sf_count_t current ;
 ...
 if (psf->is_pipe == SF_FALSE)
  psf_fseek (psf, 0, 
# 229 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 3 4
                    0
# 229 "/doner/libsndfile/libsndfile-5206a9b/src/au.c"
                            ) ;
 ...
 { psf_binheader_writef (psf, "Em4", (((uint32_t) (('.') | (('s') << 8) | (('n') << 16) | (((uint32_t) ('d')) << 24)))), 24) ;
  psf_binheader_writef (psf, "E4444", datalength, encoding, psf->sf.samplerate, psf->sf.channels) ;
  }
 else if (psf->endian == SF_ENDIAN_LITTLE)
 { psf_binheader_writef (psf, "em4", (((uint32_t) (('d') | (('n') << 8) | (('s') << 16) | (((uint32_t) ('.')) << 24)))), 24) ;
  psf_binheader_writef (psf, "e4444", datalength, encoding, psf->sf.samplerate, psf->sf.channels) ;
  }
 else
  return (psf->error = SFE_BAD_OPEN_FORMAT) ;
...
# 261 "/doner/libsndfile/libsndfile-5206a9b/src/au.c" 3 4
                          0
# 261 "/doner/libsndfile/libsndfile-5206a9b/src/au.c"
                                  ) ;
...
{ AU_FMT au_fmt ;
 ...
 else if (au_fmt.channels > 1024)
 { psf_log_printf (psf, "  Channels    : %d  **** should be <= %d\n", au_fmt.channels, 1024) ;
