# 1 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
# 19 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
...
# 20 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 22 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 23 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 24 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 25 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 27 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 28 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
# 29 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 2
...
{ int error ;
 ...
 if (psf->codec_data != 
# 111 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 3 4
                       ((void *)0)
# 111 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
                           )
...
# 734 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 3 4
                                   0
# 734 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
                                           ) ;
  pima->blockcount = 0 ;
  pima->decode_block (psf, pima) ;
  pima->samplecount = 0 ;
...
# 751 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 3 4
                                                                    0
# 751 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
                                                                            ) ;
...
{ IMA_ADPCM_PRIVATE *pima ;
 ...
 if (offset == 0)
 { psf_fseek (psf, psf->dataoffset, 
# 780 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 3 4
                                   0
# 780 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
                                           ) ;
  pima->blockcount = 0 ;
  pima->decode_block (psf, pima) ;
  pima->samplecount = 0 ;
 ...
 if (mode == SFM_READ)
 { psf_fseek (psf, psf->dataoffset + newblock * pima->blocksize, 
# 796 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 3 4
                                                                0
# 796 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
                                                                        ) ;
...
{ IMA_ADPCM_PRIVATE *pima ;
 ...
 if ((pima = calloc (1, pimasize)) == 
# 827 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c" 3 4
                                     ((void *)0)
# 827 "/doner/libsndfile/libsndfile-5206a9b/src/ima_adpcm.c"
                                         )
  return SFE_MALLOC_FAILED ;
