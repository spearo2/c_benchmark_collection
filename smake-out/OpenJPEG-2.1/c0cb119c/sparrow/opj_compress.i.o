# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
# 42 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
...
# 43 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 44 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 45 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 46 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
# 1 "/usr/include/assert.h" 1 3 4
# 47 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 48 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 53 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 62 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 63 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 64 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 67 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 68 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/common/opj_getopt.h" 1
...
# 69 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
extern opj_image_t* pngtoimage(const char *filename,
                               opj_cparameters_t *parameters);
# 70 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.h" 1
# 47 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.h"
int write_index_file(opj_codestream_info_t *cstr_info, char *index);
# 71 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2

# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/common/format_defs.h" 1
# 73 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/common/opj_string.h" 1
# 35 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/common/opj_string.h"
...
# 36 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/common/opj_string.h" 2
...
# 74 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c" 2
...
# 407 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
    fprintf(stdout, "\n");
# 450 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
}
...
static int get_file_format(char *filename)
{
    ...
    static const int format[] = {
        11, 10, 10, 10, 10, 10, 12, 14, 14, 15, 15, 18, 16, 17, 0, 1, 0, 0
    };
                                 ...
                                 unsigned int* pTarget_bitdepth)
{
    ...
    opj_option_t long_option[] = {
        ...
        {"threads", 1, ((void*)0), 'B'},
        {"TLM", 0, ((void*)0), 'D'},
        {"TargetBitDepth", 1, ((void*)0), 'X'},
        {"GuardBits", 1, ((void*)0), 'G'}
    };
    ...
    do {
        ...
        break;
# 1733 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
        case 'J': {
...
{
# 1900 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
    struct rusage t;
...
int main(int argc, char **argv)
{
    ...
    *indexfilename = 0;
    ...
    if (img_fol.set_imgdir == 1) {
        ...
        if (dirptr) {
            dirptr->filename_buf = (char*)calloc(num_images, 4096 * sizeof(
                    char));
            ...
            for (i = 0; i < num_images; i++) {
                dirptr->filename[i] = dirptr->filename_buf + (size_t)i * 4096;
            }
        }
    ...
    for (imageno = 0; imageno < num_images; imageno++) {
        ...
        case 16:
            ...
            break;
# 2112 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/opj_compress.c"
        }
        ...
        if ((((parameters.rsiz) >= 0x0400)&&((parameters.rsiz) <= ((0x0900) | (0x009b)))) && framerate > 0) {
            const int mainlevel = ((parameters.rsiz) & 0xf);
        ...
        {
            const char* options[4] = { ((void*)0), ((void*)0), ((void*)0), ((void*)0) };
            int iOpt = 0;
            char szGuardBits[32];
            if (PLT) {
        ...
        l_stream = opj_stream_create_default_file_stream(parameters.outfile, 0);
        if (! l_stream) {
            ret = 1;
            goto fin;
        }
