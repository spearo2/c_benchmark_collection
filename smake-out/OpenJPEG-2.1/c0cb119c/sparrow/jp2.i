# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c" 2
# 40 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
# 41 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c" 2
# 64 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_ihdr(opj_jp2_t *jp2,
                                  OPJ_BYTE *p_image_header_data,
                                  OPJ_UINT32 p_image_header_size,
                                  opj_event_mgr_t * p_manager);
# 77 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BYTE * opj_jp2_write_ihdr(opj_jp2_t *jp2,
                                     OPJ_UINT32 * p_nb_bytes_written);
# 88 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BYTE * opj_jp2_write_bpcc(opj_jp2_t *jp2,
                                     OPJ_UINT32 * p_nb_bytes_written);
# 101 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
static void opj_jp2_apply_cdef(opj_image_t *image, opj_jp2_color_t *color,
                               opj_event_mgr_t *);
# 122 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BYTE * opj_jp2_write_cdef(opj_jp2_t *jp2,
                                     OPJ_UINT32 * p_nb_bytes_written);
# 133 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BYTE * opj_jp2_write_colr(opj_jp2_t *jp2,
                                     OPJ_UINT32 * p_nb_bytes_written);
# 145 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_write_ftyp(opj_jp2_t *jp2,
                                   opj_stream_private_t *cio,
                                   opj_event_mgr_t * p_manager);
# 159 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
static OPJ_BOOL opj_jp2_skip_jp2c(opj_jp2_t *jp2,
                                  opj_stream_private_t *stream,
                                  opj_event_mgr_t * p_manager);
# 178 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_jp2h(opj_jp2_t *jp2,
                                  OPJ_BYTE *p_header_data,
                                  OPJ_UINT32 p_header_size,
                                  opj_event_mgr_t * p_manager);
# 192 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_write_jp2h(opj_jp2_t *jp2,
                                   opj_stream_private_t *stream,
                                   opj_event_mgr_t * p_manager);
# 205 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_write_jp2c(opj_jp2_t *jp2,
                                   opj_stream_private_t *cio,
                                   opj_event_mgr_t * p_manager);
# 251 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_jp(opj_jp2_t *jp2,
                                OPJ_BYTE * p_header_data,
                                OPJ_UINT32 p_header_size,
                                opj_event_mgr_t * p_manager);
# 265 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_write_jp(opj_jp2_t *jp2,
                                 opj_stream_private_t *cio,
                                 opj_event_mgr_t * p_manager);
# 276 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_apply_pclr(opj_image_t *image,
                                   opj_jp2_color_t *color,
                                   opj_event_mgr_t * p_manager);

static void opj_jp2_free_pclr(opj_jp2_color_t *color);
# 292 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_pclr(opj_jp2_t *jp2,
                                  OPJ_BYTE * p_pclr_header_data,
                                  OPJ_UINT32 p_pclr_header_size,
                                  opj_event_mgr_t * p_manager);
# 308 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_cmap(opj_jp2_t * jp2,
                                  OPJ_BYTE * p_cmap_header_data,
                                  OPJ_UINT32 p_cmap_header_size,
                                  opj_event_mgr_t * p_manager);
# 323 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_colr(opj_jp2_t *jp2,
                                  OPJ_BYTE * p_colr_header_data,
                                  OPJ_UINT32 p_colr_header_size,
                                  opj_event_mgr_t * p_manager);
# 336 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
static OPJ_BOOL opj_jp2_setup_end_header_reading(opj_jp2_t *jp2,
        opj_event_mgr_t * p_manager);
# 355 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_header_procedure(opj_jp2_t *jp2,
        opj_stream_private_t *stream,
        opj_event_mgr_t * p_manager);
# 369 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_exec(opj_jp2_t * jp2,
                             opj_procedure_list_t * p_procedure_list,
                             opj_stream_private_t *stream,
                             opj_event_mgr_t * p_manager);
# 384 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
static OPJ_BOOL opj_jp2_default_validation(opj_jp2_t * jp2,
        opj_stream_private_t *cio,
        opj_event_mgr_t * p_manager);
# 413 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static const opj_jp2_header_handler_t * opj_jp2_img_find_handler(
    OPJ_UINT32 p_id);
# 423 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
# 452 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
...
# 561 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_ihdr(opj_jp2_t *jp2,
                                  OPJ_BYTE *p_image_header_data,
                                  OPJ_UINT32 p_image_header_size,
                                  opj_event_mgr_t * p_manager)
        ...
        opj_event_mgr_t * p_manager)
{
    ...
    ((void) (0));
    ((void) (0));
# 2159 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
    if (! opj_procedure_list_add_procedure(jp2->m_procedure_list,
                                           (opj_procedure)opj_jp2_write_jp2c, p_manager)) {
        return 0;
    }
# 2176 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
    return 1;
}
...
# 2417 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_exec(opj_jp2_t * jp2,
                             opj_procedure_list_t * p_procedure_list,
                             opj_stream_private_t *stream,
                             opj_event_mgr_t * p_manager
...
# 2503 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static const opj_jp2_header_handler_t * opj_jp2_img_find_handler(
    OPJ_UINT32 p_id)
{
...
# 2527 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_jp(opj_jp2_t *jp2,
                                OPJ_BYTE * p_header_data,
                                OPJ_UINT32 p_header_size,
                                opj_event_mgr_t * p_manager
...
# 2576 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_ftyp(opj_jp2_t *jp2,
                                  OPJ_BYTE * p_header_data,
                                  OPJ_UINT32 p_header_size,
                                  opj_event_mgr_t * p_manager
...
# 2681 "/doner/openjpeg/openjpeg-c0cb119c/src/lib/openjp2/jp2.c"
static OPJ_BOOL opj_jp2_read_jp2h(opj_jp2_t *jp2,
                                  OPJ_BYTE *p_header_data,
                                  OPJ_UINT32 p_header_size,
                                  opj_event_mgr_t * p_manager
