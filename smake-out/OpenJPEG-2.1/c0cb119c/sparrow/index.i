# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
# 34 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c"
...
# 35 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
...
# 36 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 37 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
...
# 38 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
...
# 39 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
...
# 40 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c" 2
# 49 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c"
int write_index_file(opj_codestream_info_t *cstr_info, char *index)
{
...
# 65 "/doner/openjpeg/openjpeg-c0cb119c/src/bin/jp2/index.c"
    if (!cstr_info) {
        return 1;
    }
    ...
    for (tileno = 0; tileno < cstr_info->tw * cstr_info->th; tileno++) {
                ...
                for (resno = 0; resno < max_numdecompos + 1; resno++) {
                    for (compno = 0; compno < cstr_info->numcomps; compno++) {
                        ...
                        for (precno = 0; precno < prec_max; precno++) {
                            ...
                            fprintf(stream, "%4d %6d %7d %5d %6d  %6d    %6" "l" "d" "     %6" "l" "d" " %7"
                                    "l" "d",
                                    pack_nb, tileno, layno, resno, compno, precno, start_pos, end_ph_pos, end_pos);
                            if (disto_on) {
        ...
        else if (cstr_info->prog == OPJ_RLCP) {
            fprintf(stream,
                ...
                for (layno = 0; layno < cstr_info->numlayers; layno++) {
                    for (compno = 0; compno < cstr_info->numcomps; compno++) {
                        ...
                        for (precno = 0; precno < prec_max; precno++) {
                            ...
                            end_pos = cstr_info->tile[tileno].packet[pack_nb].end_pos;
                            disto = cstr_info->tile[tileno].packet[pack_nb].disto;
                            fprintf(stream, "%4d %6d %5d %7d %6d %6d %9" "l" "d" "   %9" "l" "d" " %7" "l" "d",
                                    pack_nb, tileno, resno, layno, compno, precno, start_pos, end_ph_pos, end_pos);
                            if (disto_on) {
                                fprintf(stream, " %8e", disto);
                            }
        ...
        else if (cstr_info->prog == OPJ_RPCL) {
                                ...
                                for (x = x0; x < x1; x++) {
                                    if (precno_x * pcx == x) {
                                        for (layno = 0; layno < cstr_info->numlayers; layno++) {
                                            ...
                                            end_pos = cstr_info->tile[tileno].packet[pack_nb].end_pos;
                                            disto = cstr_info->tile[tileno].packet[pack_nb].disto;
                                            fprintf(stream, "%4d %6d %5d %6d %6d %7d %9" "l" "d" "   %9" "l" "d" " %7" "l" "d",
                                                    pack_nb, tileno, resno, precno, compno, layno, start_pos, end_ph_pos, end_pos);
                                            if (disto_on) {
                                                fprintf(stream, " %8e", disto);
                                            }
        ...
        else if (cstr_info->prog == OPJ_PCRL) {
                                ...
                                for (x = x0; x < x1; x++) {
                                    if (precno_x * pcx == x) {
                                        for (layno = 0; layno < cstr_info->numlayers; layno++) {
                                            ...
                                            end_pos = cstr_info->tile[tileno].packet[pack_nb].end_pos;
                                            disto = cstr_info->tile[tileno].packet[pack_nb].disto;
                                            fprintf(stream, "%4d %6d %6d %6d %5d %7d %9" "l" "d" "   %9" "l" "d" " %7" "l" "d",
                                                    pack_nb, tileno, precno, compno, resno, layno, start_pos, end_ph_pos, end_pos);
                                            if (disto_on) {
                                                fprintf(stream, " %8e", disto);
                                            }
