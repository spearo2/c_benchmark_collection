# 1 "/doner/libtiff/libtiff-991404c/libtiff/tif_tile.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-991404c/libtiff/tif_tile.c"
# 32 "/doner/libtiff/libtiff-991404c/libtiff/tif_tile.c"
...
# 33 "/doner/libtiff/libtiff-991404c/libtiff/tif_tile.c" 2
...
TIFFNumberOfTiles(TIFF* tif)
{
 ...
 ntiles = (dx == 0 || dy == 0 || dz == 0) ? 0 :
     multiply(tif, multiply(tif, ((((uint32)(td->td_imagewidth))+(((uint32)(dx))-1))/((uint32)(dx))),
       ((((uint32)(td->td_imagelength))+(((uint32)(dy))-1))/((uint32)(dy))),
       "TIFFNumberOfTiles"),
       ((((uint32)(td->td_imagedepth))+(((uint32)(dz))-1))/((uint32)(dz))), "TIFFNumberOfTiles");
 if (td->td_planarconfig == 2)
...
TIFFTileRowSize(TIFF* tif)
{
 ...
 if (td->td_planarconfig == 1)
  rowsize = multiply(tif, rowsize, td->td_samplesperpixel,
       "TIFFTileRowSize");
 return ((tsize_t) (((rowsize)&0x07)?((uint32)(rowsize)>>3)+1:(uint32)(rowsize)>>3));
}
...
TIFFVTileSize(TIFF* tif, uint32 nrows)
{
 ...
 if (td->td_planarconfig == 1 &&
     td->td_photometric == 6 &&
     !(((tif)->tif_flags & 0x4000) != 0)) {
# 204 "/doner/libtiff/libtiff-991404c/libtiff/tif_tile.c"
  tsize_t w =
      (((((uint32)(td->td_tilewidth))+(((uint32)(td->td_ycbcrsubsampling[0]))-1))/((uint32)(td->td_ycbcrsubsampling[0])))*(td->td_ycbcrsubsampling[0]));
  tsize_t rowsize =
      (((multiply(tif, w, td->td_bitspersample, "TIFFVTileSize"))&0x07)?((uint32)(multiply(tif, w, td->td_bitspersample, "TIFFVTileSize"))>>3)+1:(uint32)(multiply(tif, w, td->td_bitspersample, "TIFFVTileSize"))>>3)
                        ;
  ...
  nrows = (((((uint32)(nrows))+(((uint32)(td->td_ycbcrsubsampling[1]))-1))/((uint32)(td->td_ycbcrsubsampling[1])))*(td->td_ycbcrsubsampling[1]));
...
_TIFFDefaultTileSize(TIFF* tif, uint32* tw, uint32* th)
{
 ...
 if (*tw & 0xf)
  *tw = (((((uint32)(*tw))+(((uint32)(16))-1))/((uint32)(16)))*(16));
 if (*th & 0xf)
  *th = (((((uint32)(*th))+(((uint32)(16))-1))/((uint32)(16)))*(16));
}
