# 1 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
# 26 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
# 1 "../libtiff/tif_config.h" 1
# 27 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
# 29 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
# 30 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
# 31 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
# 32 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
# 33 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
# 36 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
extern void TIFFYCbCrtoRGB(TIFFYCbCrToRGB *, uint32, int32, int32,
      uint32 *, uint32 *, uint32 *);
# 43 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 2
...
int row;
int maxline = 512;
# 63 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
static void
...
# 105 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
 l = 0;
 while (runlength > 6) {
...
# 182 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
((void *)0)
    
# 183 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
   };
    int i;
    for (i = 0; fontPrologue[i] != 
# 185 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
                                  ((void *)0)
# 185 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                                      ; i++)
 fprintf(fd, "%s\n", fontPrologue[i]);
}
...
printTIF(TIFF* tif, uint16 pageNumber)
{
 ...
 (int)(pageWidth * points), (int)(pageHeight * points));
    ...
    printf("%%%%BeginProlog\n");
    emitFont(
# 237 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
            stdout
# 237 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                  );
...
# 257 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
                                              ((void *)0)
# 257 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                                                  , (tsize_t) -1);
    printf("p\n");
...
fax2ps(TIFF* tif, uint16 npages, uint16* pages, char* filename)
{
 ...
 if (!TIFFGetField(tif, 297, &pn, &ptotal))
     fprintf(
# 287 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
            stderr
# 287 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
 ...
 for (i = 0; i < npages; i++) {
  ...
  fprintf(
# 293 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
         stderr
# 293 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
               , "%s: No page number %d\n", filename, pages[i]);
 }
    } else {
 uint16 pageNumber = 0;
...
main(int argc, char** argv)
{
    ...
    extern char* optarg;
    uint16 *pages = 
# 320 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
                   ((void *)0)
# 320 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                       , npages = 0, pageNumber;
    int c, dowarnings = 0;
    TIFF* tif;
 ...
 do {
  ...
  fprintf(
# 369 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
         stderr
# 369 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
 ...
 fd = tmpfile();
 if (fd == 
# 378 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
          ((void *)0)
# 378 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
              ) {
     fprintf(
# 379 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
            stderr
# 379 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                  , "Could not create temporary file, exiting.\n");
     fclose(fd);
     exit(-2);
 }
 while ((n = read(fileno(
# 383 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
                        stdin
# 383 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                             ), buf, sizeof (buf))) > 0)
 ...
 if (tif) {
     ...
     fprintf(
# 390 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
            stderr
# 390 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
...
# 411 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
((void *)0)

# 412 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
};
...
{
 char buf[
# 417 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
         8192
# 417 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
               ];
 int i;

 setbuf(
# 420 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
       stderr
# 420 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
             , buf);
        fprintf(
# 421 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
               stderr
# 421 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                     , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 422 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
                        ((void *)0)
# 422 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
                            ; i++)
  fprintf(
# 423 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c" 3 4
         stderr
# 423 "/doner/libtiff/libtiff-991404c/tools/fax2ps.c"
               , "%s\n", stuff[i]);
 exit(code);
}
