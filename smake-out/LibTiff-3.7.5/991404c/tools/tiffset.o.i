# 1 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
# 41 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
...
# 42 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 2
...
# 43 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 2
...
# 44 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 2
...
extern void TIFFYCbCrtoRGB(TIFFYCbCrToRGB *, uint32, int32, int32,
      uint32 *, uint32 *, uint32 *);
# 46 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 2
...
# 52 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
((void *)0)

# 53 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
};
...
usage(void)
{
 ...
 for (i = 0; usageMsg[i]; i++)
  fprintf(
# 60 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
         stderr
# 60 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
               , "%s\n", usageMsg[i]);
 exit(-1);
}
...
GetField(TIFF *tiff, const char *tagname)
{
    ...
    if (!fip) {
        fprintf( 
# 75 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                stderr
# 75 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                      , "Field name %s not recognised.\n", tagname );
        return (TIFFFieldInfo *)
# 76 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                               ((void *)0)
# 76 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                                   ;
    }
...
main(int argc, char* argv[])
{
    ...
    if (tiff == 
# 92 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
               ((void *)0)
# 92 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                   )
        return 2;
        ...
        if (strcmp(argv[arg_index],"-s") == 0 && arg_index < argc-3) {
            ...
            if (fip->field_type == TIFF_ASCII) {
                if (TIFFSetField(tiff, fip->field_tag, argv[arg_index]) != 1)
                    fprintf( 
# 110 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                            stderr
# 110 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                                  , "Failed to set %s=%s\n",
                ...
                if (argc - arg_index < wc) {
                    fprintf( 
# 122 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                            stderr
# 122 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                                  ,
    ...
    default:
                        ...
                        if (!array) {
                                fprintf(
# 170 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                                       stderr
# 170 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                                             , "No space for %s tag\n",
                                        tagname);
                                return 4;
                        }
                ...
                if (ret != 1)
                    fprintf(
# 255 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                           stderr
# 255 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                                 , "Failed to set %s\n", fip->field_name);
                arg_index += wc;
            }
            ...
            if (fip->field_type != TIFF_ASCII) {
                fprintf( 
# 271 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                        stderr
# 271 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                              ,
            ...
            if(fp == 
# 279 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                    ((void *)0)
# 279 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
                        ) {
            ...
            if(TIFFSetField( tiff, fip->field_tag, text ) != 1) {
                fprintf(
# 291 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                       stderr
# 291 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
            ...
            fprintf(
# 298 "/doner/libtiff/libtiff-991404c/tools/tiffset.c" 3 4
                   stderr
# 298 "/doner/libtiff/libtiff-991404c/tools/tiffset.c"
