# 1 "/doner/libtiff/libtiff-991404c/libtiff/tif_thunder.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-991404c/libtiff/tif_thunder.c"
# 27 "/doner/libtiff/libtiff-991404c/libtiff/tif_thunder.c"
...
# 28 "/doner/libtiff/libtiff-991404c/libtiff/tif_thunder.c" 2
# 55 "/doner/libtiff/libtiff-991404c/libtiff/tif_thunder.c"
static const int twobitdeltas[4] = { 0, 1, 0, -1 };
static const int threebitdeltas[8] = { 0, 1, 2, 3, 0, -3, -2, -1 };
# 66 "/doner/libtiff/libtiff-991404c/libtiff/tif_thunder.c"
static int
ThunderDecode(TIFF* tif, tidata_t op, tsize_t maxpixels)
{
 ...
 while (cc > 0 && npixels < maxpixels) {
  ...
  case 0x40:
   if ((delta = ((n >> 4) & 3)) != 2)
    { lastpixel = (lastpixel + twobitdeltas[delta]) & 0xf; if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (tidataval_t) (lastpixel << 4); };
   if ((delta = ((n >> 2) & 3)) != 2)
    { lastpixel = (lastpixel + twobitdeltas[delta]) & 0xf; if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (tidataval_t) (lastpixel << 4); };
   if ((delta = (n & 3)) != 2)
    { lastpixel = (lastpixel + twobitdeltas[delta]) & 0xf; if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (tidataval_t) (lastpixel << 4); };
  ...
  case 0x80:
   if ((delta = ((n >> 3) & 7)) != 4)
    { lastpixel = (lastpixel + threebitdeltas[delta]) & 0xf; if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (tidataval_t) (lastpixel << 4); };
   if ((delta = (n & 7)) != 4)
    { lastpixel = (lastpixel + threebitdeltas[delta]) & 0xf; if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (tidataval_t) (lastpixel << 4); };
   break;
  case 0xc0:
   { lastpixel = (n) & 0xf; if (npixels++ & 1) *op++ |= lastpixel; else op[0] = (tidataval_t) (lastpixel << 4); };
   break;
  }
 }
