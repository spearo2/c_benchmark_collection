# 1 "/doner/libtiff/libtiff-991404c/libtiff/tif_strip.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-991404c/libtiff/tif_strip.c"
# 32 "/doner/libtiff/libtiff-991404c/libtiff/tif_strip.c"
...
# 33 "/doner/libtiff/libtiff-991404c/libtiff/tif_strip.c" 2
...
# 124 "/doner/libtiff/libtiff-991404c/libtiff/tif_strip.c"
  ...
  w = (((((uint32)(td->td_imagewidth))+(((uint32)(ycbcrsubsampling[0]))-1))/((uint32)(ycbcrsubsampling[0])))*(ycbcrsubsampling[0]));
  scanline = (((multiply(tif, w, td->td_bitspersample, "TIFFVStripSize"))&0x07)?((uint32)(multiply(tif, w, td->td_bitspersample, "TIFFVStripSize"))>>3)+1:(uint32)(multiply(tif, w, td->td_bitspersample, "TIFFVStripSize"))>>3)
                         ;
  nrows = (((((uint32)(nrows))+(((uint32)(ycbcrsubsampling[1]))-1))/((uint32)(ycbcrsubsampling[1])))*(ycbcrsubsampling[1]));
...
# 180 "/doner/libtiff/libtiff-991404c/libtiff/tif_strip.c"
tsize_t
...
TIFFScanlineSize(TIFF* tif)
{
 ...
 if (td->td_planarconfig == 1)
  scanline = multiply (tif, scanline, td->td_samplesperpixel,
         "TIFFScanlineSize");
 return ((tsize_t) (((scanline)&0x07)?((uint32)(scanline)>>3)+1:(uint32)(scanline)>>3));
}
...
TIFFRasterScanlineSize(TIFF* tif)
{
 ...
 if (td->td_planarconfig == 1) {
  ...
  return ((tsize_t) multiply (tif, (((scanline)&0x07)?((uint32)(scanline)>>3)+1:(uint32)(scanline)>>3),
