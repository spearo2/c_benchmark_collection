# 1 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
# 27 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
...
# 30 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
...
# 31 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
...
# 32 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
...
# 35 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
...
# 42 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
# 1 "../libtiff/tiffio.h" 1
# 43 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 2
# 57 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
...
main(int argc, char* argv[])
{
 ...
 if (out == 
# 124 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
           ((void *)0)
# 124 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
               )
  return (-2);
 setupLumaTables();
 for (; optind < argc-1; optind++) {
  ...
  if (in != 
# 129 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
           ((void *)0)
# 129 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
               ) {
   do {
    if (!tiffcvt(in, out) ||
...
# 220 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
static void
...
# 373 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
   ((void *)0)

# 374 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
};
...
{
 char buf[
# 379 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
         8192
# 379 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
               ];
 int i;

 setbuf(
# 382 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
       stderr
# 382 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
             , buf);

 fprintf(
# 384 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
        stderr
# 384 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
              , "%s\n\n", TIFFGetVersion());
 for (i = 0; stuff[i] != 
# 385 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
                        ((void *)0)
# 385 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
                            ; i++)
  fprintf(
# 386 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c" 3 4
         stderr
# 386 "/doner/libtiff/libtiff-d651abc/libtiff/tools/rgb2ycbcr.c"
               , "%s\n", stuff[i]);
 exit(code);
}
