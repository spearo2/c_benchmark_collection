# 1 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
# 28 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
# 1 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h" 1
# 42 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h"
# 1 "./config.h" 1
# 43 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h" 2
# 51 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h"
...
# 52 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h" 2
# 65 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h"
# 1 "./libarchive/archive.h" 1
# 41 "./libarchive/archive.h"
...
# 45 "./libarchive/archive.h" 2
# 56 "./libarchive/archive.h"
...
# 57 "./libarchive/archive.h" 2
# 69 "./libarchive/archive.h"
...
# 70 "./libarchive/archive.h" 2




# 73 "./libarchive/archive.h"
typedef int64_t la_int64_t;
# 95 "./libarchive/archive.h"
typedef ssize_t la_ssize_t;
# 153 "./libarchive/archive.h"
...
typedef const char *archive_passphrase_callback(struct archive *,
       void *_client_data);
# 378 "./libarchive/archive.h"
 struct archive *archive_read_new(void);
# 389 "./libarchive/archive.h"
...
# 66 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h" 2
# 1 "./libarchive/archive_entry.h" 1
...
# 43 "./libarchive/archive_entry.h" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
# 44 "./libarchive/archive_entry.h" 2
# 127 "./libarchive/archive_entry.h"

# 127 "./libarchive/archive_entry.h"
struct archive;
struct archive_entry;
# 168 "./libarchive/archive_entry.h"
 struct archive_entry *archive_entry_clear(struct archive_entry *);

 struct archive_entry *archive_entry_clone(struct archive_entry *);
 void archive_entry_free(struct archive_entry *);
 struct archive_entry *archive_entry_new(void);
# 181 "./libarchive/archive_entry.h"
 struct archive_entry *archive_entry_new2(struct archive *);
# 202 "./libarchive/archive_entry.h"
...
# 267 "./libarchive/archive_entry.h"
...
# 348 "./libarchive/archive_entry.h"
 const struct stat *archive_entry_stat(struct archive_entry *);
 void archive_entry_copy_stat(struct archive_entry *, const struct stat *);
# 358 "./libarchive/archive_entry.h"
...
# 470 "./libarchive/archive_entry.h"
 ...
 int archive_entry_acl_next_w(struct archive_entry *, int ,
     int * , int * , int * ,
     int * , const wchar_t ** );
# 506 "./libarchive/archive_entry.h"
...
struct archive_acl;
 ...
 int archive_entry_sparse_next(struct archive_entry *,
     la_int64_t * , la_int64_t * );
# 584 "./libarchive/archive_entry.h"
struct archive_entry_linkresolver;
# 626 "./libarchive/archive_entry.h"
...
# 67 "/doner/libarchive/libarchive-3.2.0/cpio/cpio_platform.h" 2
# 29 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
struct _undefined_hack;
# 42 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
...
# 43 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 55 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 58 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 61 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stdarg.h" 1 3 4
# 64 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 71 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
...
# 74 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
# 82 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
# 1 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.h" 1
# 42 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.h"
...
# 83 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
# 1 "./libarchive_fe/err.h" 1
# 43 "./libarchive_fe/err.h"
void lafe_warnc(int code, const char *fmt, ...) __attribute__((__format__(__printf__, 2, 3)));
void lafe_errc(int eval, int code, const char *fmt, ...) __attribute__((__noreturn__))
    __attribute__((__format__(__printf__, 3, 4)));

const char * lafe_getprogname(void);
void lafe_setprogname(const char *name, const char *defaultname);
# 84 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
# 1 "./libarchive_fe/line_reader.h" 1
# 29 "./libarchive_fe/line_reader.h"
...
# 85 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
# 1 "./libarchive_fe/passphrase.h" 1
# 29 "./libarchive_fe/passphrase.h"
char *lafe_readpassphrase(const char *prompt, char *buf, size_t bufsiz);
# 86 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 2
# 94 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
struct name_cache {
 int probes;
 int hits;
 size_t size;
...
main(int argc, char *argv[])
{
...

 {
  ...
  sa.sa_flags = 0;
  sa.
# 150 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
    __sigaction_handler.sa_handler 
# 150 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               = 
# 150 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                 ((__sighandler_t) 1)
# 150 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                        ;
  sigaction(
# 151 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
           13
# 151 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  , &sa, 
# 151 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                         ((void *)0)
# 151 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
 ...
 if (setlocale(
# 159 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              6
# 159 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                    , "") == 
# 159 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                             ((void *)0)
# 159 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
 ...
 cpio->verbose = 0;
 cpio->compress = '\0';
 cpio->extract_flags = (0x0400);
 cpio->extract_flags |= (0x0800);
 cpio->extract_flags |= (0x0100);
 cpio->extract_flags |= (0x0200);
 cpio->extract_flags |= (0x10000);
 cpio->extract_flags |= (0x0002);
 cpio->extract_flags |= (0x0040);
 cpio->extract_flags |= (0x0020);

 if (geteuid() == 0)
  cpio->extract_flags |= (0x0001);

 cpio->bytes_per_block = 512;
 cpio->filename = 
# 183 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                 ((void *)0)
# 183 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                     ;

 cpio->matching = archive_match_new();
 if (cpio->matching == 
# 186 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                      ((void *)0)
# 186 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                          )
 ...
 while ((opt = cpio_getopt(cpio)) != -1) {
  ...
  case 'R':
   ...
   if (uid != -1) {
    ...
    cpio->uname_override = 
# 318 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                          ((void *)0)
# 318 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                              ;
   }
   if (gid != -1) {
    cpio->gid_override = gid;
    cpio->gname_override = 
# 322 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                          ((void *)0)
# 322 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                              ;
   }
   break;
  case 'r':
  ...
  case OPTION_VERSION:
   version();
   break;
# 355 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
  case 'y':
   cpio->compress = opt;
   break;
  case 'Z':
 ...
 if (cpio->format != 
# 382 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                    ((void *)0) 
# 382 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                         && cpio->mode != 'o')
 ...
 case 'o':
  ...
  if (cpio->format == 
# 396 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                     ((void *)0)
# 396 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                         )
   cpio->format = "odc";
 ...
 case 'i':
  while (*cpio->argv != 
# 402 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                       ((void *)0)
# 402 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                           ) {
 ...
 case 'p':
  if (*cpio->argv == 
# 416 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                    ((void *)0) 
# 416 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                         || **cpio->argv == '\0')
   lafe_errc(1, 0,
...
usage(void)
{
 ...
 fprintf(
# 441 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        stderr
# 441 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              , "Brief Usage:\n");
 fprintf(
# 442 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        stderr
# 442 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              , "  List:    %s -it < archive\n", p);
 fprintf(
# 443 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        stderr
# 443 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              , "  Extract: %s -i < archive\n", p);
 fprintf(
# 444 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        stderr
# 444 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              , "  Create:  %s -o < filenames > archive\n", p);
 fprintf(
# 445 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        stderr
# 445 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              , "  Help:    %s --help\n", p);
 exit(1);
}
...
# 471 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
static void
long_help(void)
{
 const char *prog;
 ...
 fflush(
# 479 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
       stderr
# 479 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             );
 ...
 for (p = long_help_msg; *p != '\0'; p++) {
  if (*p == '%') {
   if (p[1] == 'p') {
    fputs(prog, 
# 487 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
               stdout
# 487 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                     );
    p++;
   } else
    putchar('%');
...
{
 fprintf(
# 500 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        stdout
# 500 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              ,"bsdcpio %s -- %s\n",
     "3.2.0",
...
mode_out(struct cpio *cpio)
{
 ...
 if (cpio->archive_read_disk == 
# 518 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                               ((void *)0)
# 518 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                   )
 ...
 if (cpio->archive == 
# 527 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                     ((void *)0)
# 527 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                         )
  lafe_errc(1, 0, "Failed to allocate archive object");
 ...
 if (cpio->passphrase != 
# 583 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                        ((void *)0)
# 583 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                            )
 ...
 while ((p = lafe_line_reader_next(lr)) != 
# 599 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                                          ((void *)0)
# 599 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                              )
 ...
 entry = 
# 607 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        ((void *)0)
# 607 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
            ;
 archive_entry_linkify(cpio->linkresolver, &entry, &spare);
 while (entry != 
# 609 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                ((void *)0)
# 609 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                    ) {
  entry_to_archive(cpio, entry);
  archive_entry_free(entry);
  entry = 
# 612 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 612 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             ;
  archive_entry_linkify(cpio->linkresolver, &entry, &spare);
 }
 ...
 if (cpio->dot)
  fprintf(
# 618 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 618 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , "\n");
 if (r != 0)
  lafe_errc(1, 0, "%s", archive_error_string(cpio->archive));
 ...
 if (!cpio->quiet) {
  int64_t blocks =
   ...
   / 512;
  fprintf(
# 626 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 626 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
...
file_to_archive(struct cpio *cpio, const char *srcpath)
{
 ...
 if (entry == 
# 693 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             ((void *)0)
# 693 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                 )
  lafe_errc(1, 0, "Couldn't allocate entry");
 archive_entry_copy_sourcepath(entry, srcpath);
 r = archive_read_disk_entry_from_file(cpio->archive_read_disk,
     entry, -1, 
# 697 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
               ((void *)0)
# 697 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                   );
 if (r < (-25))
  lafe_errc(1, 0, "%s",
 ...
 if (cpio->destdir) {
  ...
  if (len >= cpio->pass_destpath_alloc) {
   ...
   if (cpio->pass_destpath == 
# 734 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                             ((void *)0)
# 734 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                 )
    lafe_errc(1, 
# 735 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                12
# 735 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                      ,
 ...
 if (destpath == 
# 744 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                ((void *)0)
# 744 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                    )
  return (0);
 ...
 spare = 
# 751 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        ((void *)0)
# 751 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
            ;
 if (cpio->linkresolver != 
# 752 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                          ((void *)0)
     
# 753 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
    && archive_entry_filetype(entry) != ((mode_t)0040000)) {
  archive_entry_linkify(cpio->linkresolver, &entry, &spare);
 }

 if (entry != 
# 757 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             ((void *)0)
# 757 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                 ) {
  r = entry_to_archive(cpio, entry);
  archive_entry_free(entry);
  if (spare != 
# 760 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              ((void *)0)
# 760 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  ) {
   if (r == 0)
...
entry_to_archive(struct cpio *cpio, struct archive_entry *entry)
{
 ...
 if (cpio->verbose)
  fprintf(
# 780 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 780 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               ,"%s", destpath);
 if (cpio->dot)
  fprintf(
# 782 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 782 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , ".");
# 793 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
 if (cpio->option_link
     && archive_entry_filetype(entry) == ((mode_t)0100000))
 {
  ...
  if (t == 
# 799 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
          ((void *)0)
# 799 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              )
   lafe_errc(1, 
# 800 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
               12
# 800 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                     , "Can't create link");
  ...
  if (r != 0 && archive_errno(cpio->archive) == 
# 815 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                                                        18
# 815 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                                             ) {
 ...
 if (archive_entry_filetype(entry) == ((mode_t)0100000)) {
  if (archive_entry_size(entry) > 0) {
   fd = open(srcpath, 
# 830 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                     00 
# 830 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                              | 0);
   if (fd < 0) {
    lafe_warnc(
# 832 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              (*__errno_location ())
# 832 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                   ,
 ...
 if (r >= (-20) && archive_entry_size(entry) > 0 && fd >= 0) {
...
cleanup:
 if (cpio->verbose)
  fprintf(
# 875 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 875 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               ,"\n");
 if (fd >= 0)
  close(fd);
 return (0);
...
{
# 900 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
 ...
 if (fd >= 0) {
  ...
  fd = -1;
        ...
        if (lutimes(name, times) != 0)
                ...
                lafe_warnc(
# 931 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                          (*__errno_location ())
# 931 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
...
mode_in(struct cpio *cpio)
{
 ...
 if (ext == 
# 947 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
           ((void *)0)
# 947 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               )
 ...
 a = archive_read_new();
 if (a == 
# 953 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 953 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             )
  lafe_errc(1, 0, "Couldn't allocate archive object");
 archive_read_support_filter_all(a);
 archive_read_support_format_all(a);
 if (cpio->passphrase != 
# 957 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                        ((void *)0)
# 957 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                            )
 ...
 for (;;) {
  ...
  if (destpath == 
# 984 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                 ((void *)0)
# 984 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                     )
   continue;
  if (cpio->verbose)
   fprintf(
# 987 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
          stderr
# 987 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                , "%s\n", destpath);
  if (cpio->dot)
   fprintf(
# 989 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
          stderr
# 989 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                , ".");
  if (cpio->uid_override >= 0)
   archive_entry_set_uid(entry, cpio->uid_override);
  if (cpio->gid_override >= 0)
  ...
  if (r != 0) {
   fprintf(
# 996 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
          stderr
# 996 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                , "%s: %s\n",
 ...
 if (cpio->dot)
  fprintf(
# 1008 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 1008 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , "\n");
 if (r != 0)
  lafe_errc(1, 0, "%s", archive_error_string(a));
 ...
 if (!cpio->quiet) {
  int64_t blocks = (archive_filter_bytes(a, 0) + 511)
         / 512;
  fprintf(
# 1017 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 1017 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , "%lu %s\n", (unsigned long)blocks,
      blocks == 1 ? "block" : "blocks");
 }
 archive_read_free(a);
...
mode_list(struct cpio *cpio)
{
 ...
 a = archive_read_new();
 if (a == 
# 1063 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1063 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             )
  lafe_errc(1, 0, "Couldn't allocate archive object");
 archive_read_support_filter_all(a);
 archive_read_support_format_all(a);
 if (cpio->passphrase != 
# 1067 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                        ((void *)0)
# 1067 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                            )
  r = archive_read_add_passphrase(a, cpio->passphrase);
 else
  r = archive_read_set_passphrase_callback(a, cpio,
 ...
 for (;;) {
  ...
  if (cpio->verbose)
   ...
   fprintf(
# 1092 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
          stdout
# 1092 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                , "%s\n", archive_entry_pathname(entry));
 }
 r = archive_read_close(a);
 if (r != 0)
 ...
 if (!cpio->quiet) {
  int64_t blocks = (archive_filter_bytes(a, 0) + 511)
         / 512;
  fprintf(
# 1100 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 1100 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , "%lu %s\n", (unsigned long)blocks,
      blocks == 1 ? "block" : "blocks");
 }
 archive_read_free(a);
...
# 1115 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
static void
list_item_verbose(struct cpio *cpio, struct archive_entry *entry)
{
 ...
 FILE *out = 
# 1122 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              stdout
# 1122 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                    ;
 const char *fmt;
 time_t mtime;
 static time_t now;
 ...
 if (cpio->option_numeric_uid_gid) {
  ...
  if (uname == 
# 1139 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              ((void *)0)
# 1139 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  )
   uname = lookup_uname(cpio, (uid_t)archive_entry_uid(entry));

  gname = archive_entry_gname(entry);
  if (gname == 
# 1143 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              ((void *)0)
# 1143 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  )
   gname = lookup_gname(cpio, (uid_t)archive_entry_gid(entry));
 }


 if (archive_entry_filetype(entry) == ((mode_t)0020000)
...
# 1167 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
...
mode_pass(struct cpio *cpio, const char *destdir)
{
 ...
 if (cpio->archive == 
# 1203 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                     ((void *)0)
# 1203 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                         )
  lafe_errc(1, 0, "Failed to allocate archive object");
 ...
 cpio->archive_read_disk = archive_read_disk_new();
 if (cpio->archive_read_disk == 
# 1212 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                               ((void *)0)
# 1212 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                   )
  lafe_errc(1, 0, "Failed to allocate archive object");
 if (cpio->option_follow_links)
  archive_read_disk_set_symlink_logical(cpio->archive_read_disk);
 ...
 lr = lafe_line_reader("-", cpio->option_null);
 while ((p = lafe_line_reader_next(lr)) != 
# 1221 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                                          ((void *)0)
# 1221 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                              )
  file_to_archive(cpio, p);
 lafe_line_reader_free(lr);
 ...
 if (cpio->dot)
  fprintf(
# 1228 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 1228 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , "\n");
 if (r != 0)
  lafe_errc(1, 0, "%s", archive_error_string(cpio->archive));
 ...
 if (!cpio->quiet) {
  int64_t blocks =
   ...
   / 512;
  fprintf(
# 1236 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         stderr
# 1236 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
               , "%lu %s\n", (unsigned long)blocks,
      blocks == 1 ? "block" : "blocks");
 }
...
# 1250 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
static const char *
cpio_rename(const char *name)
{
 ...
 FILE *t;
 char *p, *ret;
# 1270 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
 t = fopen("/dev/tty", "r+");
 if (t == 
# 1271 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1271 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             )
  return (name);
 ...
 fclose(t);
 if (p == 
# 1279 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1279 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             )

  return (
# 1281 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1281 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             );
 ...
 if (*p == '\n' || *p == '\0')
  ...
  return (
# 1287 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1287 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             );
 if (*p == '.' && p[1] == '\n')
...
free_cache(struct name_cache *cache)
{
 ...
 if (cache != 
# 1305 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             ((void *)0)
# 1305 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                 ) {
    ...
    int (*lookup_fn)(struct cpio *, const char **, id_t), id_t id)
{
 ...
 if (*name_cache_variable == 
# 1325 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                            ((void *)0)
# 1325 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                ) {
  *name_cache_variable = malloc(sizeof(struct name_cache));
  if (*name_cache_variable == 
# 1327 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                             ((void *)0)
# 1327 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                 )
   lafe_errc(1, 
# 1328 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
               12
# 1328 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                     , "No more memory");
 ...
 slot = id % cache->size;
 if (cache->cache[slot].name != 
# 1337 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                               ((void *)0)
# 1337 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                   ) {
  ...
  cache->cache[slot].name = 
# 1343 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                           ((void *)0)
# 1343 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                               ;
 }

 if (lookup_fn(cpio, &name, id) == 0) {
  if (name == 
# 1347 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             ((void *)0) 
# 1347 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  || name[0] == '\0') {
  ...
  if (cache->cache[slot].name != 
# 1353 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                                ((void *)0)
# 1353 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                                    ) {
 ...
 return (
# 1363 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
        ((void *)0)
# 1363 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
            );
}
...
# 1380 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
(*__errno_location ()) 
# 1380 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
      = 0;
 pwent = getpwuid((uid_t)id);
 if (pwent == 
# 1382 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             ((void *)0)
# 1382 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                 ) {
  *name = 
# 1383 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1383 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             ;
  if (
# 1384 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
     (*__errno_location ()) 
# 1384 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
           != 0 && 
# 1384 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                   (*__errno_location ()) 
# 1384 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
...
# 1384 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
   ...
   lafe_warnc(
# 1385 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             (*__errno_location ())
# 1385 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  , "getpwuid(%s) failed",
       cpio_i64toa((int64_t)id));
  return (
# 1387 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         (*__errno_location ())
# 1387 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              );
 }
...
# 1408 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
(*__errno_location ()) 
# 1408 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
      = 0;
 grent = getgrgid((gid_t)id);
 if (grent == 
# 1410 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             ((void *)0)
# 1410 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                 ) {
  *name = 
# 1411 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         ((void *)0)
# 1411 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
             ;
  if (
# 1412 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
     (*__errno_location ()) 
# 1412 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
           != 0)
   lafe_warnc(
# 1413 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
             (*__errno_location ())
# 1413 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  , "getgrgid(%s) failed",
       cpio_i64toa((int64_t)id));
  return (
# 1415 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
         (*__errno_location ())
# 1415 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
              );
 }
...
passphrase_callback(struct archive *a, void *_client_data)
{
 ...
 if (cpio->ppbuff == 
# 1454 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                    ((void *)0)
# 1454 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                        ) {
  cpio->ppbuff = malloc(1024);
  if (cpio->ppbuff == 
# 1456 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
                     ((void *)0)
# 1456 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                         )
   lafe_errc(1, 
# 1457 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
               (*__errno_location ())
# 1457 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                    , "Out of memory");
 }
...
{
 if (ppbuff != 
# 1466 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c" 3 4
              ((void *)0)
# 1466 "/doner/libarchive/libarchive-3.2.0/cpio/cpio.c"
                  ) {
