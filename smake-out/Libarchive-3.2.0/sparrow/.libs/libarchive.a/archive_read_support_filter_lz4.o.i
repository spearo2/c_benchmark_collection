# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 48 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 51 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 2
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
...
archive_read_support_filter_lz4(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xdeb0c5U)), (1U), ("archive_read_support_filter_lz4")); if (magic_test == (-30)) return (-30); } while (0)
                                                          ;

 if (__archive_read_get_bidder(a, &reader) != 0)
  return ((-30));

 reader->data = 
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 3 4
               ((void *)0)
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
                   ;
 reader->name = "lz4";
 reader->bid = lz4_reader_bid;
 reader->init = lz4_reader_init;
 reader->options = 
# 126 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 3 4
                  ((void *)0)
# 126 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
                      ;
...
# 150 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
static int
    ...
    struct archive_read_filter *filter)
{
 ...
 if (buffer == 
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c" 3 4
              ((void *)0)
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
                  )
  return (0);


 bits_checked = 0;
 if ((number = archive_le32dec(buffer)) == 0x184d2204) {
  ...
  if (BD & ~0x70)
   return (0);
  bits_checked += 8;
 } else if (number == 0x184c2102) {
  bits_checked += 32;
 }

 return (bits_checked);
}
# 204 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lz4.c"
static int
