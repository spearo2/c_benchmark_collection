# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 2

# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_private.h" 1
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_private.h"
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_private.h" 2
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 2
...
archive_write_set_passphrase(struct archive *_a, const char *p)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_passphrase")); if (magic_test == (-30)) return (-30); } while (0)
                                 ;

 if (p == 
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
         ((void *)0) 
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
              || p[0] == '\0') {
 ...
 if (a->passphrase == 
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
                     ((void *)0)
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
                         ) {
  archive_set_error(&a->archive, 
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
                                12
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
                                      ,
    ...
    archive_passphrase_callback *cb)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_passphrase_callback")); if (magic_test == (-30)) return (-30); } while (0)
                                          ;
...
__archive_write_get_passphrase(struct archive_write *a)
{
 ...
 if (a->passphrase != 
# 77 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
                     ((void *)0)
# 77 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
                         )
  return (a->passphrase);

 if (a->passphrase_callback != 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
                              ((void *)0)
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
                                  ) {
  const char *p;
  p = a->passphrase_callback(&a->archive,
      a->passphrase_client_data);
  if (p != 
# 84 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
          ((void *)0)
# 84 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
              ) {
   a->passphrase = strdup(p);
   if (a->passphrase == 
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
                       ((void *)0)
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
                           ) {
    archive_set_error(&a->archive, 
# 87 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
                                  12
# 87 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
                                        ,
        "Can't allocate data for passphrase");
    return (
# 89 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
           ((void *)0)
# 89 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
               );
   }
   return (a->passphrase);
  }
 ...
 return (
# 94 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c" 3 4
        ((void *)0)
# 94 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_passphrase.c"
            );
}
