# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h" 2
# 59 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h"
...
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h" 2




# 63 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h"
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 2
...
archive_entry_strmode(struct archive_entry *entry)
{
 ...
 case ((mode_t)0100000): bp[0] = '-'; break;
 case ((mode_t)0060000): bp[0] = 'b'; break;
 case ((mode_t)0020000): bp[0] = 'c'; break;
 case ((mode_t)0040000): bp[0] = 'd'; break;
 case ((mode_t)0120000): bp[0] = 'l'; break;
 case ((mode_t)0140000): bp[0] = 's'; break;
 case ((mode_t)0010000): bp[0] = 'p'; break;
 default:
  if (archive_entry_hardlink(entry) != 
# 61 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 3 4
                                      ((void *)0)
# 61 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
                                          ) {
   bp[0] = 'h';
   break;
  }
 ...
 if (mode & 
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 3 4
           04000
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
                  ) {
  if (mode & 0100) bp[3] = 's';
  else bp[3] = 'S';
 }
 if (mode & 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 3 4
           02000
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
                  ) {
  if (mode & 0010) bp[6] = 's';
  else bp[6] = 'S';
 }
 if (mode & 
# 79 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c" 3 4
           01000
# 79 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_strmode.c"
                  ) {
  if (mode & 0001) bp[9] = 't';
  else bp[9] = 'T';
 }
 if (archive_entry_acl_count(entry, 256))
  bp[10] = '+';
