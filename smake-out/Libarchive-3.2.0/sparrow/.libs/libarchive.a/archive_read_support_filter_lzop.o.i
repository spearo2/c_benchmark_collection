# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2


# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
# 53 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 54 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 57 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 62 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 63 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
...
# 64 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 2
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
...
archive_read_support_filter_lzop(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xdeb0c5U)), (1U), ("archive_read_support_filter_lzop")); if (magic_test == (-30)) return (-30); } while (0)
                                                           ;
 ...
 reader->data = 
# 116 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 3 4
               ((void *)0)
# 116 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
                   ;
 reader->bid = lzop_bidder_bid;
 reader->init = lzop_bidder_init;
 reader->options = 
# 119 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 3 4
                  ((void *)0)
# 119 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
                      ;
 reader->free = 
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 3 4
               ((void *)0)
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
                   ;
    ...
    struct archive_read_filter *filter)
{
 ...
 p = __archive_read_filter_ahead(filter, 9, &avail);
 if (p == 
# 145 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c" 3 4
         ((void *)0) 
# 145 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_lzop.c"
              || avail == 0)
  return (0);

 if (memcmp(p, "\x89\x4c\x5a\x4f\x00\x0d\x0a\x1a\x0a", 9))
  return (0);
