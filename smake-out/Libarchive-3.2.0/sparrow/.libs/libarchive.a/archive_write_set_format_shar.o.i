# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2

# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 2
...
archive_write_set_format_shar(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_shar")); if (magic_test == (-30)) return (-30); } while (0)
                                                        ;


 if (a->format_free != 
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                      ((void *)0)
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                          )
  (a->format_free)(a);

 shar = (struct shar *)malloc(sizeof(*shar));
 if (shar == 
# 117 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
            ((void *)0)
# 117 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                ) {
  archive_set_error(&a->archive, 
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                12
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                      , "Can't allocate shar data");
  return ((-30));
 }
 memset(shar, 0, sizeof(*shar));
 do { (&shar->work)->s = 
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
((void *)0)
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
; (&shar->work)->length = 0; (&shar->work)->buffer_length = 0; } while(0);
 do { (&shar->quoted_name)->s = 
# 123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
((void *)0)
# 123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
; (&shar->quoted_name)->length = 0; (&shar->quoted_name)->buffer_length = 0; } while(0);
 a->format_data = shar;
 a->format_name = "shar";
 ...
 a->archive.archive_format = (0x20000 | 1);
...
archive_write_set_format_shar_dump(struct archive *_a)
{
 ...
 a->archive.archive_format = (0x20000 | 2);
...
# 197 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                      ((void *)0) 
# 197 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                           &&
      archive_entry_symlink(entry) == 
# 198 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                     ((void *)0)
# 198 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                         ) {
 ...
 if (archive_entry_filetype(entry) != ((mode_t)0040000)) {
  ...
  if (pp != 
# 216 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
           ((void *)0)
# 216 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
               ) {
   *pp = '\0';
   ...
   if (strcmp(p, ".") == 0) {
    ...
    free(p);
   } else if (shar->last_dir == 
# 223 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                               ((void *)0)
# 223 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                   ) {
 ...
 shar->has_data = 0;
 if ((linkname = archive_entry_hardlink(entry)) != 
# 250 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                                  ((void *)0)
# 250 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                                      ) {
  archive_strcat(&shar->work, "ln -f ");
  shar_quote(&shar->work, linkname, 1);
  archive_string_sprintf(&shar->work, " %s\n",
      shar->quoted_name.s);
 } else if ((linkname = archive_entry_symlink(entry)) != 
# 255 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                                        ((void *)0)
# 255 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                                            ) {
  ...
  case ((mode_t)0040000):
   ...
   if (shar->last_dir != 
# 293 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                        ((void *)0)
# 293 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                            )
    free(shar->last_dir);
   ...
   if (pp != 
# 299 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
            ((void *)0) 
# 299 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                 && pp[1] == '\0')
    *pp = '\0';
...
archive_write_shar_data_sed(struct archive_write *a, const void *buff, size_t n)
{
 ...
 src = (const char *)buff;
# 353 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
 if (archive_string_ensure(&shar->work, ensured + 3) == 
# 353 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                                       ((void *)0)
# 353 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                                           ) {
  archive_set_error(&a->archive, 
# 354 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                12
# 354 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                      , "Out of memory");
  return ((-30));
 }
...
uuencode_group(const char _in[3], char out[4])
{
 ...
 out[0] = (((0x3f & (t >> 18))!=0) ? ((0x3f & (t >> 18)) & 077) + ' ': '`');
 out[1] = (((0x3f & (t >> 12))!=0) ? ((0x3f & (t >> 12)) & 077) + ' ': '`');
 out[2] = (((0x3f & (t >> 6))!=0) ? ((0x3f & (t >> 6)) & 077) + ' ': '`');
 out[3] = (((0x3f & t)!=0) ? ((0x3f & t) & 077) + ' ': '`');
}
...
_uuencode_line(struct archive_write *a, struct shar *shar, const char *inbuf, size_t len)
{
 ...
 if (archive_string_ensure(&shar->work, alloc_len) == 
# 420 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                                     ((void *)0)
# 420 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                                         ) {
  archive_set_error(&a->archive, 
# 421 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                12
# 421 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                      , "Out of memory");
  return ((-30));
 }
...
# 461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
static ssize_t
    ...
    size_t length)
{
 ...
 if (shar->outpos != 0) {
  ...
  do { int r = _uuencode_line(a, shar, shar->outbuff, 45); if (r != 0) return ((-30)); } while (0);
  src += n;
  n = length - n;
 } else {
  n = length;
 ...
 while (n >= 45) {
  do { int r = _uuencode_line(a, shar, src, 45); if (r != 0) return ((-30)); } while (0);
  src += 45;
  n -= 45;
...
archive_write_shar_finish_entry(struct archive_write *a)
{
 ...
 shar = (struct shar *)a->format_data;
 if (shar->entry == 
# 519 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                   ((void *)0)
# 519 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                       )
  return (0);
 ...
 if (shar->dump) {
  ...
  if (shar->has_data) {
   if (shar->outpos > 0)
    do { int r = _uuencode_line(a, shar, shar->outbuff, shar->outpos); if (r != 0) return ((-30)); } while (0)
                     ;
   archive_strcat(&shar->work, "`\nend\n");
  ...
  if (u != 
# 543 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
          ((void *)0) 
# 543 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
               || g != 
# 543 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                       ((void *)0)
# 543 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
   ...
   if (u != 
# 545 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
           ((void *)0)
# 545 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
               )
    shar_quote(&shar->work, u, 1);
   if (g != 
# 547 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
           ((void *)0)
# 547 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
               ) {
    archive_strcat(&shar->work, ":");
  ...
  if ((p = archive_entry_fflags_text(shar->entry)) != 
# 557 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                                                     ((void *)0)
# 557 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                                                         ) {
 ...
 archive_entry_free(shar->entry);
 shar->entry = 
# 576 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
              ((void *)0)
# 576 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                  ;
...
archive_write_shar_free(struct archive_write *a)
{
 ...
 shar = (struct shar *)a->format_data;
 if (shar == 
# 633 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
            ((void *)0)
# 633 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                )
  return (0);
 ...
 free(shar);
 a->format_data = 
# 641 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c" 3 4
                 ((void *)0)
# 641 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_shar.c"
                     ;
 return (0);
}
