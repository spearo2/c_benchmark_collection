# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
...
# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2

# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
int _archive_entry_copy_uname_l(struct archive_entry *,
    const char *, size_t, struct archive_string_conv *);
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 2
...
# 106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
int
archive_write_set_format_cpio_newc(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_cpio_newc")); if (magic_test == (-30)) return (-30); } while (0)
                                                             ;


 if (a->format_free != 
# 116 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                      ((void *)0)
# 116 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                          )
  (a->format_free)(a);

 cpio = (struct cpio *)malloc(sizeof(*cpio));
 if (cpio == 
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
            ((void *)0)
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                ) {
  archive_set_error(&a->archive, 
# 121 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                12
# 121 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
    ...
    const char *val)
{
 ...
 if (strcmp(key, "hdrcharset") == 0) {
  if (val == 
# 146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
            ((void *)0) 
# 146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                 || val[0] == 0)
   ...
   cpio->opt_sconv = archive_string_conversion_to_charset(
       &a->archive, val, 0);
   if (cpio->opt_sconv != 
# 153 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                         ((void *)0)
# 153 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                             )
    ret = 0;
   else
    ret = (-30);
...
get_sconv(struct archive_write *a)
{
 ...
 if (sconv == 
# 175 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
             ((void *)0)
# 175 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                 ) {
...
archive_write_newc_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 if (_archive_entry_pathname_l(entry, &path, &len, get_sconv(a)) != 0
     && 
# 199 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
       (*__errno_location ()) 
# 199 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
             == 
# 199 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                12
# 199 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
  ...
  archive_set_error(&a->archive, 
# 200 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                12
# 200 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                      ,
      "Can't allocate memory for Pathname");
  return ((-30));
 }
 if (len == 0 || path == 
# 204 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                        ((void *)0) 
# 204 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                             || path[0] == '\0') {
...
# 209 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                     ((void *)0)
     
# 210 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
...
write_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 ret_final = 0;
 sconv = get_sconv(a);
# 248 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
 entry_main = 
# 248 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
             ((void *)0)
# 248 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                 ;


 ret = _archive_entry_pathname_l(entry, &path, &len, sconv);
 if (ret != 0) {
  if (
# 253 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
     (*__errno_location ()) 
# 253 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
           == 
# 253 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
              12
# 253 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
   ...
   archive_set_error(&a->archive, 
# 254 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                 12
# 254 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                       ,
       "Can't allocate memory for Pathname");
   ret_final = (-30);
  ...
  archive_set_error(&a->archive, 
# 259 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                84
# 259 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                                         ,
 ...
 memset(h, 0, 110);
 format_hex(0x070701, h + 0, 6);
 format_hex(archive_entry_devmajor(entry), h + 62,
     8);
 format_hex(archive_entry_devminor(entry), h + 70,
     8);

 ino = archive_entry_ino64(entry);
 if (ino > 0xffffffff) {
  archive_set_error(&a->archive, 
# 276 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                34
# 276 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                      ,
 ...
 format_hex(ino & 0xffffffff, h + 6, 8);
 format_hex(archive_entry_mode(entry), h + 14, 8);
 format_hex(archive_entry_uid(entry), h + 22, 8);
 format_hex(archive_entry_gid(entry), h + 30, 8);
 format_hex(archive_entry_nlink(entry), h + 38, 8);
 if (archive_entry_filetype(entry) == ((mode_t)0060000)
     || archive_entry_filetype(entry) == ((mode_t)0020000)) {
     format_hex(archive_entry_rdevmajor(entry), h + 78, 8);
     format_hex(archive_entry_rdevminor(entry), h + 86, 8);
 } else {
     format_hex(0, h + 78, 8);
     format_hex(0, h + 86, 8);
 }
 format_hex(archive_entry_mtime(entry), h + 46, 8);
 format_hex(pathlength, h + 94, 8);
 format_hex(0, h + 102, 8);
 ...
 ret = _archive_entry_symlink_l(entry, &p, &len, sconv);
 if (ret != 0) {
  if (
# 306 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
     (*__errno_location ()) 
# 306 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
           == 
# 306 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
              12
# 306 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
   ...
   archive_set_error(&a->archive, 
# 307 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                 12
# 307 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                       ,
  ...
  archive_set_error(&a->archive, 
# 312 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                84
# 312 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                                         ,
 ...
 if (len > 0 && p != 
# 318 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                    ((void *)0) 
# 318 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                          && *p != '\0')
  ret = format_hex(strlen(p), h + 54,
      8);
 else
 ...
 if (ret) {
  archive_set_error(&a->archive, 
# 325 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                                34
# 325 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                                      ,
 ...
 ret = __archive_write_output(a, h, 110);
 if (ret != 0) {
  ret_final = (-30);
  goto exit_write_header;
 }
 ...
 cpio->padding = (int)(3 & (1 + ~(cpio->entry_bytes_remaining)));


 if (p != 
# 356 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
         ((void *)0) 
# 356 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
               && *p != '\0') {
...
archive_write_newc_free(struct archive_write *a)
{
 ...
 free(cpio);
 a->format_data = 
# 446 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c" 3 4
                 ((void *)0)
# 446 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio_newc.c"
                     ;
 return (0);
}
