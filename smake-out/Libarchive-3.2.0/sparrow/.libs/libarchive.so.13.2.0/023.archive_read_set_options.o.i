# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
...
# 30 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 2
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 2
    ...
    const char *v)
{
 return _archive_set_option(a, m, o, v,
     (0xdeb0c5U), "archive_read_set_format_option",
...
{
 return _archive_set_option(a, m, o, v,
     (0xdeb0c5U), "archive_read_set_filter_option",
...
{
 return _archive_set_option(a, m, o, v,
     (0xdeb0c5U), "archive_read_set_option",
     archive_set_option);
}
...
archive_read_set_options(struct archive *a, const char *options)
{
 return _archive_set_options(a, options,
     (0xdeb0c5U), "archive_read_set_options",
     archive_set_option);
}
    ...
    const char *v)
{
 ...
 size_t i;
 int r, rv = (-20), matched_modules = 0;

 for (i = 0; i < sizeof(a->formats)/sizeof(a->formats[0]); i++) {
  struct archive_format_descriptor *format = &a->formats[i];

  if (format->options == 
# 85 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
                        ((void *)0) 
# 85 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
                             || format->name == 
# 85 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
                                                ((void *)0)
# 85 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
   ...
   continue;
  if (m != 
# 88 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
          ((void *)0)
# 88 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
              ) {
  ...
  a->format = 
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
             ((void *)0)
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
                 ;
 ...
 if (m != 
# 106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
         ((void *)0) 
# 106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
              && matched_modules == 0)
  return (-20) - 1;
 return (rv);
}
    ...
    const char *v)
{
 ...
 for (filter = a->filter; filter != 
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
                                   ((void *)0)
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
                                       ; filter = filter->upstream) {
  bidder = filter->bidder;
  if (bidder == 
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
               ((void *)0)
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
                   )
   continue;
  if (bidder->options == 
# 124 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
                        ((void *)0)
# 124 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
                            )

   continue;
  if (m != 
# 127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
          ((void *)0)
# 127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
              ) {
 ...
 if (m != 
# 143 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c" 3 4
         ((void *)0) 
# 143 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_options.c"
              && matched_modules == 0)
  return (-20) - 1;
 return (rv);
}
