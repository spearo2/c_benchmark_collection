# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 2

# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h" 1
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h"
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry.h" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/stddef.h" 1 3 4
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 2
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 2
...
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                             ((void *)0)
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                                 ) {
 ...
 entry->sparse_tail = 
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                     ((void *)0)
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                         ;
}
 ...
 int64_t offset, int64_t length)
{
 ...
 if (offset < 0 || length < 0)
  ...
  return;
 if (offset > 
# 61 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
             (9223372036854775807L) 
# 61 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                       - length ||
     offset + length > archive_entry_size(entry))

  return;
 if ((sp = entry->sparse_tail) != 
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                                 ((void *)0)
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                                     ) {
 ...
 if ((sp = (struct ae_sparse *)malloc(sizeof(*sp))) == 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                                                      ((void *)0)
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                                                          )
 ...
 sp->length = length;
 sp->next = 
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
           ((void *)0)
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
               ;

 if (entry->sparse_head == 
# 88 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                          ((void *)0)
# 88 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                              )
  entry->sparse_head = entry->sparse_tail = sp;
 else {

  if (entry->sparse_tail != 
# 92 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                           ((void *)0)
# 92 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                               )
...
archive_entry_sparse_count(struct archive_entry *entry)
{
 ...
 for (sp = entry->sparse_head; sp != 
# 108 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c" 3 4
                                    ((void *)0)
# 108 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_entry_sparse.c"
                                        ; sp = sp->next)
  count++;
