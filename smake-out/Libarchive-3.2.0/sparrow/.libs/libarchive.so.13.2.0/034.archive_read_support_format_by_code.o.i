# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c"
...
# 30 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c" 2
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_by_code.c" 2

int
archive_read_support_format_by_code(struct archive *a, int format_code)
{
 do { int magic_test = __archive_check_magic((a), ((0xdeb0c5U)), (1U), ("archive_read_support_format_by_code")); if (magic_test == (-30)) return (-30); } while (0)
                                                              ;

 switch (format_code & 0xff0000) {
 case 0xE0000:
