# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 2
...
# 30 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 2
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 2
...
archive_write_set_format_raw(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_raw")); if (magic_test == (-30)) return (-30); } while (0)
                                                       ;


 if (a->format_free != 
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                      ((void *)0)
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                          )
  (a->format_free)(a);

 raw = (struct raw *)calloc(1, sizeof(*raw));
 if (raw == 
# 62 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
           ((void *)0)
# 62 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
               ) {
  archive_set_error(&a->archive, 
# 63 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                                12
# 63 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
 ...
 a->format_options = 
# 70 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                    ((void *)0)
# 70 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                        ;
 a->format_write_header = archive_write_raw_header;
 a->format_write_data = archive_write_raw_data;
 a->format_finish_entry = 
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                         ((void *)0)
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                             ;

 a->format_close = 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                  ((void *)0)
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                      ;
...
archive_write_raw_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 if (archive_entry_filetype(entry) != ((mode_t)0100000)) {
  archive_set_error(&a->archive, 
# 88 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                                34
# 88 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                                      ,
 ...
 if (raw->entries_written > 0) {
  archive_set_error(&a->archive, 
# 95 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                                34
# 95 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                                      ,
...
archive_write_raw_free(struct archive_write *a)
{
 ...
 free(raw);
 a->format_data = 
# 123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c" 3 4
                 ((void *)0)
# 123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_raw.c"
                     ;
 return (0);
}
