# 1 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
# 30 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
# 1 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h" 1
# 42 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h"
# 1 "./config.h" 1
# 43 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h" 2
...
# 48 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h" 2
# 61 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h"
...
# 62 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h" 2
...
# 63 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat_platform.h" 2
# 31 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 2


# 1 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.h" 1
# 31 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.h"
# 1 "./config.h" 1
# 32 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.h" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.h"
struct bsdcat {
...
# 44 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 2




static const char *short_options = "h";
# 60 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
static const struct bsdcat_option {
 ...
 { 
# 67 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
  ((void *)0)
# 67 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
      , 0, 0 }
};
# 112 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
int
bsdcat_getopt(struct bsdcat *bsdcat)
{
 ...
 const struct bsdcat_option *popt, *match = 
# 118 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                                           ((void *)0)
# 118 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                                               , *match2 = 
# 118 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                                                           ((void *)0)
# 118 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
 ...
 bsdcat->argument = 
# 124 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                   ((void *)0)
# 124 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                       ;
 ...
 if (bsdcat->getopt_state == state_start) {
  ...
  --bsdcat->argc;
  if (*bsdcat->argv == 
# 131 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                      ((void *)0)
# 131 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                          )
   return (-1);
 ...
 if (bsdcat->getopt_state == state_next_word) {
  ...
  if (bsdcat->argv[0] == 
# 142 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                        ((void *)0)
# 142 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                            )
   return (-1);
 ...
 if (bsdcat->getopt_state == state_short) {
  ...
  if (p == 
# 181 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
          ((void *)0)
# 181 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
              )
   return ('?');
  if (p[1] == ':')
   required = 1;
  ...
  if (required) {
   ...
   if (bsdcat->getopt_word[0] == '\0') {
    ...
    bsdcat->getopt_word = *bsdcat->argv;
    if (bsdcat->getopt_word == 
# 192 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                              ((void *)0)
# 192 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                                  ) {
     lafe_warnc(0,
 ...
 if (bsdcat->getopt_state == state_long) {
  ...
  if (p != 
# 218 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
          ((void *)0)
# 218 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
              ) {
...
# 226 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                                         ((void *)0)
# 226 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                                             ; popt++) {
   ...
   if (strncmp(bsdcat->getopt_word, popt->name, optlength) == 0) {
    ...
    if (strlen(popt->name) == optlength) {
     match2 = 
# 236 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
             ((void *)0)
# 236 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                 ;
     break;
    }
   }
  ...
  if (match == 
# 243 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
              ((void *)0)
# 243 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                  ) {
   lafe_warnc(0,
  ...
  if (match2 != 
# 249 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
               ((void *)0)
# 249 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                   ) {
   lafe_warnc(0,
  ...
  if (match->required) {
   ...
   if (bsdcat->argument == 
# 259 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                          ((void *)0)
# 259 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                              ) {
    bsdcat->argument = *bsdcat->argv;
    if (bsdcat->argument == 
# 261 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                           ((void *)0)
# 261 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                               ) {
     lafe_warnc(0,
   ...
   if (bsdcat->argument != 
# 272 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c" 3 4
                          ((void *)0)
# 272 "/doner/libarchive/libarchive-3.2.0/cat/cmdline.c"
                              ) {
    lafe_warnc(0,
