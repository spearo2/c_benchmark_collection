# 1 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
# 26 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 2
...
# 32 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 2
...
bsdcat_read_to_stdout(char* filename)
{
 ...
 if (archive_read_open_filename(a, filename, (20*512))
     != 0)
  bsdcat_print_error();
  ...
  ;
 else if (archive_read_data_into_fd(a, 1) != 0)
  bsdcat_print_error();
 if (archive_read_free(a) != 0)
  bsdcat_print_error();
}
...
main(int argc, char **argv)
{
 ...
 while ((c = bsdcat_getopt(bsdcat)) != -1) {
  ...
  case 'h':
   usage(
# 124 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 3 4
        stdout
# 124 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
              , 0);
   break;
  case OPTION_VERSION:
   version();
  ...
  default:
   usage(
# 130 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 3 4
        stderr
# 130 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
              , 1);
  }
 }
 ...
 bsdcat_next();
 if (*bsdcat->argv == 
# 135 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 3 4
                     ((void *)0)
# 135 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
                         ) {
  bsdcat_current_path = "<stdin>";
  bsdcat_read_to_stdout(
# 137 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c" 3 4
                       ((void *)0)
# 137 "/doner/libarchive/libarchive-3.2.0/cat/bsdcat.c"
                           );
 } else
  while (*bsdcat->argv) {
