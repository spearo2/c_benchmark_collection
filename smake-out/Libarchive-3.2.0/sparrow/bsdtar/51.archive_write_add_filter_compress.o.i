# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
# 59 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
...
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2


# 61 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
...
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2
...
# 68 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2
...
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2
...
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2
...
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2
...
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 2
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
struct private_data {
...
archive_write_add_filter_compress(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_compress")); if (magic_test == (-30)) return (-30); } while (0)
                                                            ;
...
archive_compressor_compress_open(struct archive_write_filter *f)
{
 ...
 if (state == 
# 161 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 3 4
             ((void *)0)
# 161 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
                 ) {
  archive_set_error(f->archive, 
# 162 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 3 4
                               12
# 162 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
                                     ,
 ...
 if (state->compressed == 
# 179 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 3 4
                         ((void *)0)
# 179 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
                             ) {
  archive_set_error(f->archive, 
# 180 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c" 3 4
                               12
# 180 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
                                     ,
 ...
 state->checkpoint = 10000;
 state->code_len = 9;
 state->cur_maxcode = ((1 << (state->code_len)) - 1);
 state->first_free = 257;
...
# 228 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_compress.c"
    ...
    const void *buff, size_t length)
{
 ...
 nomatch:
  ...
  state->checkpoint = state->in_count + 10000;
