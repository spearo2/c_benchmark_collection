# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 2
...
archive_read_set_format(struct archive *_a, int code)
{
  ...
  if ((r1 = archive_read_support_format_by_code(_a, code)) < (0))
    return r1;
...
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 3 4
                                    22
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c"
                                                            ,
  ...
  {
    archive_set_error(&a->archive, 
# 99 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c" 3 4
                                  22
# 99 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_set_format.c"
                                                          ,
