# 1 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
# 26 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
# 39 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
# 40 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2


# 1 "/usr/include/paths.h" 1 3 4
# 52 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
...
# 59 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
...
# 62 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
# 70 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
void list_item_verbose(struct bsdtar *, FILE *,
      struct archive_entry *);
# 71 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
...
# 72 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 2
# 97 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
# 121 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
...
# 155 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                                       ((void *)0)
# 155 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                                           ;
 compress_program = 
# 156 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                   ((void *)0)
# 156 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                       ;
...

 {
  struct sigaction sa;
  sa.
# 161 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
    __sigaction_handler.sa_handler 
# 161 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
               = siginfo_handler;
  ...
  if (sigaction(
# 170 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
               10
# 170 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                      , &sa, 
# 170 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                             ((void *)0)
# 170 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
   ...
   lafe_errc(1, 
# 171 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
               (*__errno_location ())
# 171 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                    , "sigaction(SIGUSR1) failed");



  sa.
# 175 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
    __sigaction_handler.sa_handler 
# 175 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
               = 
# 175 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                 ((__sighandler_t) 1)
# 175 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                        ;
  sigaction(
# 176 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
           13
# 176 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                  , &sa, 
# 176 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                         ((void *)0)
# 176 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
 ...
 if (setlocale(
# 185 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
              6
# 185 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                    , "") == 
# 185 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                             ((void *)0)
# 185 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
 ...
 if (bsdtar->filename == 
# 198 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                        ((void *)0)
# 198 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                            )
  bsdtar->filename = "/dev/st0";


 bsdtar->bytes_per_block = (20*512);

 bsdtar->bytes_in_last_block = -1;


 bsdtar->extract_flags = (0x0004);


 bsdtar->extract_flags |= ((0x0100) | (0x0200));
 ...
 if (bsdtar->user_uid == 0) {
  ...
  bsdtar->extract_flags |= (0x0001);

  bsdtar->extract_flags |= (0x0002);
  bsdtar->extract_flags |= (0x0020);
  bsdtar->extract_flags |= (0x0080);
  bsdtar->extract_flags |= (0x0040);
  bsdtar->extract_flags |= (0x2000);
 }
 ...
 if (bsdtar->matching == 
# 237 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                        ((void *)0)
# 237 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                            )
  lafe_errc(1, 
# 238 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
              (*__errno_location ())
# 238 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                   , "Out of memory");
 bsdtar->cset = cset_new();
 if (bsdtar->cset == 
# 240 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                    ((void *)0)
# 240 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                        )
  lafe_errc(1, 
# 241 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
              (*__errno_location ())
# 241 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                   , "Out of memory");
 ...
 while ((opt = bsdtar_getopt(bsdtar)) != -1) {
  ...
  case OPTION_IGNORE_ZEROS:
   ...
   break;
  case 'I':
# 360 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
  ...
  case 'J':
   ...
   break;
  case 'k':
   bsdtar->extract_flags |= (0x0008);
   break;
  case OPTION_KEEP_NEWER_FILES:
   bsdtar->extract_flags |= (0x0800);
   break;
  case 'L':
   bsdtar->symlink_mode = 'L';
   break;
  ...
  case OPTION_NO_SAME_PERMISSIONS:
   ...
   bsdtar->extract_flags &= ~(0x2000);
   break;
  case OPTION_NO_XATTR:
   bsdtar->extract_flags &= ~(0x0080);
   bsdtar->readdisk_flags |= (0x0010);
   break;
  case OPTION_NULL:
   bsdtar->option_null++;
   break;
  ...
  case OPTION_OPTIONS:
   ...
   break;
# 549 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
  case 'P':
   bsdtar->extract_flags &= ~((0x0100) | (0x0200));
...
# 588 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
  (*__errno_location ()) 
# 588 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
        = 0;
   bsdtar->strip_components = strtol(bsdtar->argument,
       
# 590 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
      ((void *)0)
# 590 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
          , 0);
   if (
# 591 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
      (*__errno_location ())
# 591 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
           )
    lafe_errc(1, 0,
  ...
  case OPTION_VERSION:
   version();
   break;
# 645 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
  case 'w':
 ...
 if (bsdtar->readdisk_flags & (0x0008))
  only_mode(bsdtar, "--one-file-system", "cru");
 if (bsdtar->option_fast_read)
  only_mode(bsdtar, "--fast-read", "xt");
 if (bsdtar->extract_flags & (0x8000))
  only_mode(bsdtar, "--hfsCompression", "x");
 if (bsdtar->extract_flags & (0x4000))
  only_mode(bsdtar, "--nopreserveHFSCompression", "x");
 if (bsdtar->readdisk_flags & (0x0002))
  only_mode(bsdtar, "--nodump", "cru");
 if (bsdtar->readdisk_flags & (0x0010))
 ...
 if (compress_program != 
# 756 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                        ((void *)0)
# 756 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                            ) {
...
# 783 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                                     ((void *)0)
# 783 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                                         )
 ...
 if (strcmp(bsdtar->filename, "-") == 0)
  bsdtar->filename = 
# 793 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                    ((void *)0)
# 793 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                        ;
...
{
 if (strchr(valid_modes, bsdtar->mode) == 
# 841 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
                                         ((void *)0)
# 841 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                                             )
  lafe_errc(1, 0,
...
usage(void)
{
 ...
 fprintf(
# 855 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
        stderr
# 855 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
              , "Usage:\n");
 fprintf(
# 856 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
        stderr
# 856 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
              , "  List:    %s -tf <archive-filename>\n", p);
 fprintf(
# 857 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
        stderr
# 857 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
              , "  Extract: %s -xf <archive-filename>\n", p);
 fprintf(
# 858 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
        stderr
# 858 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
              , "  Create:  %s -cf <archive-filename> [filenames...]\n", p);
 fprintf(
# 859 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
        stderr
# 859 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
              , "  Help:    %s --help\n", p);
 exit(1);
}
...
# 907 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
static void
long_help(void)
{
 const char *prog;
 ...
 fflush(
# 915 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
       stderr
# 915 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
             );
 ...
 for (p = long_help_msg; *p != '\0'; p++) {
  if (*p == '%') {
   if (p[1] == 'p') {
    fputs(prog, 
# 923 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c" 3 4
               stdout
# 923 "/doner/libarchive/libarchive-3.2.0/tar/bsdtar.c"
                     );
    p++;
   } else
    putchar('%');
