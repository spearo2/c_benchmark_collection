# 1 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
# 26 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
...
# 34 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/limits.h" 1 3 4
# 57 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 60 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 67 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 70 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
# 78 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
...
void list_item_verbose(struct bsdtar *, FILE *,
      struct archive_entry *);
# 79 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 80 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 2
...
# 94 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                          ((void *)0)
# 94 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                              );
...
tar_mode_x(struct bsdtar *bsdtar)
{
 ...
 if (writer == 
# 106 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
              ((void *)0)
# 106 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                  )
  lafe_errc(1, 
# 107 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
              12
# 107 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
...
progress_func(void *cookie)
{
 ...
 if (bsdtar->verbose)
  fprintf(
# 134 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
         stderr
# 134 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
               , "\n");
 if (a != 
# 135 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
         ((void *)0)
# 135 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
             ) {
  ...
  fprintf(
# 142 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
         stderr
# 142 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
               ,
      "In: %s bytes, compression %d%%;",
      tar_i64toa(comp), compression);
  fprintf(
# 145 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
         stderr
# 145 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
               , "  Out: %d files, %s bytes\n",
      archive_file_count(a), tar_i64toa(uncomp));
 }
 if (entry != 
# 148 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
             ((void *)0)
# 148 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                 ) {
  safe_fprintf(
# 149 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
              stderr
# 149 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                    , "Current: %s",
      archive_entry_pathname(entry));
  fprintf(
# 151 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
         stderr
# 151 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
               , " (%s bytes)\n",
...
# 177 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                               ((void *)0)
# 177 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                                   )
 ...
 if (reader_options != 
# 190 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                      ((void *)0)
# 190 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                          ) {
  char *p;

  p = (char *)malloc(sizeof("__ignore_wrong_module_name__,")
      + strlen(reader_options) + 1);
  if (p == 
# 195 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
          ((void *)0)
# 195 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
              )
   lafe_errc(1, 
# 196 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
               (*__errno_location ())
# 196 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                    , "Out of memory");
 ...
 if (0 != archive_read_set_options(a, bsdtar->option_options))
  lafe_errc(1, 0, "%s", archive_error_string(a));
 if (bsdtar->option_ignore_zeros)
  if (archive_read_set_options(a,
      "read_concatenated_archives") != 0)
   lafe_errc(1, 0, "%s", archive_error_string(a));
 if (bsdtar->passphrase != 
# 216 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                          ((void *)0)
# 216 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                              )
 ...
 if (mode == 'x' && bsdtar->option_chroot) {
  ...
  if (chroot(".") != 0)
   lafe_errc(1, 
# 241 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
               (*__errno_location ())
# 241 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                    , "Can't chroot to \".\"");
 ...
 for (;;) {
  ...
  if (p == 
# 277 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
          ((void *)0) 
# 277 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
               || p[0] == '\0') {
...
# 285 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                                 ((void *)0)
# 285 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                                     );
  }
  if (bsdtar->gid >= 0) {
   archive_entry_set_gid(entry, bsdtar->gid);
   archive_entry_set_gname(entry, 
# 289 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                                 ((void *)0)
# 289 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                                     );
  }
  if (bsdtar->uname)
...
# 305 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
  ...
  if (mode == 't') {
   ...
   out = bsdtar->option_stdout ? 
# 311 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                                stderr 
# 311 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                                       : 
# 311 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                                         stdout
# 311 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
   ...
   if (bsdtar->verbose > 1) {
    ...
    safe_fprintf(
# 355 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                stderr
# 355 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                      , "x ");
    list_item_verbose(bsdtar, 
# 356 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                             stderr
# 356 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                                   , entry);
    fflush(
# 357 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
          stderr
# 357 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                );
   } else if (bsdtar->verbose > 0) {


    safe_fprintf(
# 361 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                stderr
# 361 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                      , "x %s",
        archive_entry_pathname(entry));
    fflush(
# 363 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
          stderr
# 363 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                );
   }
   ...
   if (r != 0) {
    if (!bsdtar->verbose)
     safe_fprintf(
# 374 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                 stderr
# 374 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                       , "%s",
         archive_entry_pathname(entry));
    safe_fprintf(
# 376 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                stderr
# 376 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                      , ": %s",
        archive_error_string(a));
    if (!bsdtar->verbose)
     fprintf(
# 379 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
            stderr
# 379 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                  , "\n");
    bsdtar->return_value = 1;
   }
   if (bsdtar->verbose)
    fprintf(
# 383 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
           stderr
# 383 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                 , "\n");
   if (r == (-30))
    break;
  }
 ...
 if (bsdtar->verbose > 2)
  fprintf(
# 397 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
         stdout
# 397 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
...
unmatched_inclusions_warn(struct archive *matching, const char *msg)
{
 ...
 if (matching == 
# 410 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
                ((void *)0)
# 410 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                    )
  return (0);
 ...
 if (r == (-30))
  lafe_errc(1, 
# 417 "/doner/libarchive/libarchive-3.2.0/tar/read.c" 3 4
              (*__errno_location ())
# 417 "/doner/libarchive/libarchive-3.2.0/tar/read.c"
                   , "Out of memory");
