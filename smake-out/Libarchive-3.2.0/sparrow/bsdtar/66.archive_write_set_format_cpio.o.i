# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2

# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
int _archive_entry_copy_uname_l(struct archive_entry *,
    const char *, size_t, struct archive_string_conv *);
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 2
...
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
int
archive_write_set_format_cpio(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_cpio")); if (magic_test == (-30)) return (-30); } while (0)
                                                        ;


 if (a->format_free != 
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                      ((void *)0)
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                          )
  (a->format_free)(a);

 cpio = (struct cpio *)calloc(1, sizeof(*cpio));
 if (cpio == 
# 114 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
            ((void *)0)
# 114 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                ) {
  archive_set_error(&a->archive, 
# 115 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                12
# 115 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
    ...
    const char *val)
{
 ...
 if (strcmp(key, "hdrcharset") == 0) {
  if (val == 
# 139 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
            ((void *)0) 
# 139 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                 || val[0] == 0)
   ...
   cpio->opt_sconv = archive_string_conversion_to_charset(
       &a->archive, val, 0);
   if (cpio->opt_sconv != 
# 146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                         ((void *)0)
# 146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                             )
    ret = 0;
   else
    ret = (-30);
...
# 174 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
static int
synthesize_ino_value(struct cpio *cpio, struct archive_entry *entry)
{
 ...
 if (cpio->ino_list_size <= cpio->ino_list_next) {
  ...
  if (newlist == 
# 211 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                ((void *)0)
# 211 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                    )
   return (-1);
...
get_sconv(struct archive_write *a)
{
 ...
 if (sconv == 
# 234 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
             ((void *)0)
# 234 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                 ) {
...
archive_write_cpio_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 if (_archive_entry_pathname_l(entry, &path, &len, get_sconv(a)) != 0
     && 
# 258 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
       (*__errno_location ()) 
# 258 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
             == 
# 258 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                12
# 258 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
  ...
  archive_set_error(&a->archive, 
# 259 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                12
# 259 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                      ,
      "Can't allocate memory for Pathname");
  return ((-30));
 }
 if (len == 0 || path == 
# 263 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                        ((void *)0) 
# 263 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                             || path[0] == '\0') {
...
write_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 ret_final = 0;
 sconv = get_sconv(a);
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
 entry_main = 
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
             ((void *)0)
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                 ;
 ...
 if (ret != 0) {
  if (
# 310 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
     (*__errno_location ()) 
# 310 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
           == 
# 310 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
              12
# 310 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
   ...
   archive_set_error(&a->archive, 
# 311 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                 12
# 311 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                       ,
       "Can't allocate memory for Pathname");
   ret_final = (-30);
  ...
  archive_set_error(&a->archive, 
# 316 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                84
# 316 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                                         ,
 ...
 memset(h, 0, sizeof(h));
 format_octal(070707, h + 0, 6);
 format_octal(archive_entry_dev(entry), h + 6, 6);

 ino = synthesize_ino_value(cpio, entry);
 if (ino < 0) {
  archive_set_error(&a->archive, 
# 331 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                12
# 331 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                      ,
  ...
  archive_set_error(&a->archive, 
# 336 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                34
# 336 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                      ,
      "Too many files for this cpio format");
  ret_final = (-30);
  goto exit_write_header;
 }
 format_octal(ino & 0777777, h + 12, 6);


 format_octal(archive_entry_mode(entry), h + 18, 6);
 format_octal(archive_entry_uid(entry), h + 24, 6);
 format_octal(archive_entry_gid(entry), h + 30, 6);
 format_octal(archive_entry_nlink(entry), h + 36, 6);
 if (archive_entry_filetype(entry) == ((mode_t)0060000)
     || archive_entry_filetype(entry) == ((mode_t)0020000))
     format_octal(archive_entry_dev(entry), h + 42, 6);
 else
     format_octal(0, h + 42, 6);
 format_octal(archive_entry_mtime(entry), h + 48, 11);
 format_octal(pathlength, h + 59, 6);
 ...
 if (ret != 0) {
  if (
# 363 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
     (*__errno_location ()) 
# 363 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
           == 
# 363 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
              12
# 363 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
   ...
   archive_set_error(&a->archive, 
# 364 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                 12
# 364 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                       ,
  ...
  archive_set_error(&a->archive, 
# 369 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                84
# 369 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                                         ,
 ...
 if (len > 0 && p != 
# 375 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                    ((void *)0) 
# 375 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                          && *p != '\0')
  ret = format_octal(strlen(p), h + 65,
      11);
 else
 ...
 if (ret) {
  archive_set_error(&a->archive, 
# 382 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                                34
# 382 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                      ,
 ...
 if (p != 
# 403 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
         ((void *)0) 
# 403 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
               && *p != '\0') {
...
archive_write_cpio_close(struct archive_write *a)
{
 ...
 trailer = archive_entry_new2(
# 470 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                             ((void *)0)
# 470 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                                 );
...
archive_write_cpio_free(struct archive_write *a)
{
 ...
 free(cpio);
 a->format_data = 
# 488 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c" 3 4
                 ((void *)0)
# 488 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_cpio.c"
                     ;
 return (0);
}
