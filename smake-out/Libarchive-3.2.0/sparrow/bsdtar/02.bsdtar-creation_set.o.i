# 1 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
# 26 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 2
...
void list_item_verbose(struct bsdtar *, FILE *,
      struct archive_entry *);
# 37 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 2
...
get_suffix_code(const struct suffix_code_t *tbl, const char *suffix)
{
 ...
 if (suffix == 
# 58 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
              ((void *)0)
# 58 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                  )
  return (
# 59 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
         ((void *)0)
# 59 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
             );
 for (i = 0; tbl[i].suffix != 
# 60 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
                             ((void *)0)
# 60 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                                 ; i++) {
  if (strcmp(tbl[i].suffix, suffix) == 0)
   return (tbl[i].form);
 }
 return (
# 64 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
        ((void *)0)
# 64 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
            );
}
...
get_filter_code(const char *suffix)
{
 ...
 static const struct suffix_code_t filters[] = {
  ...
  { ".xz", "xz" },
  { 
# 83 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
   ((void *)0)
# 83 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
       , 
# 83 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
          ((void *)0) 
# 83 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
...
get_format_code(const char *suffix)
{
 ...
 static const struct suffix_code_t formats[] = {
  ...
  { ".zip", "zip" },
  { 
# 104 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
   ((void *)0)
# 104 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
       , 
# 104 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
          ((void *)0) 
# 104 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
...
decompose_alias(const char *suffix)
{
 static const struct suffix_code_t alias[] = {
  ...
  { ".tZ", ".tar.Z" },
  { 
# 124 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
   ((void *)0)
# 124 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
       , 
# 124 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
          ((void *)0) 
# 124 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
...
_cset_add_filter(struct creation_set *cset, int program, const char *filter)
{
 ...
 if (new_ptr == 
# 138 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
               ((void *)0)
# 138 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                   )
  lafe_errc(1, 0, "No memory");
 new_filter = strdup(filter);
 if (new_filter == 
# 141 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
                  ((void *)0)
# 141 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                      )
  lafe_errc(1, 0, "No memory");
...
cset_set_format(struct creation_set *cset, const char *format)
{
 ...
 f = strdup(format);
 if (f == 
# 204 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
         ((void *)0)
# 204 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
             )
  lafe_errc(1, 0, "No memory");
...
cset_auto_compress(struct creation_set *cset, const char *filename)
{
 ...
 if (name == 
# 255 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
            ((void *)0)
# 255 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                )
  lafe_errc(1, 0, "No memory");
 ...
 cset->filters = 
# 260 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
                ((void *)0)
# 260 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                    ;
 cset->filter_count = 0;
 ...
 for (;;) {
  ...
  p = strrchr(name, '.');
  if (p == 
# 266 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
          ((void *)0)
# 266 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
              )
   break;
  ...
  if (code != 
# 271 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
             ((void *)0)
# 271 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                 ) {
  ...
  if (code != 
# 278 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
             ((void *)0)
# 278 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                 ) {
  ...
  if (code == 
# 284 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
             ((void *)0)
# 284 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                 )
   break;
  ...
  *p = '\0';
  ...
  if (name == 
# 289 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
             ((void *)0)
# 289 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
                 )
   lafe_errc(1, 0, "No memory");
  strcat(name, code);
 }
 ...
 if (cset->filters) {
  ...
  if (v == 
# 302 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c" 3 4
          ((void *)0)
# 302 "/doner/libarchive/libarchive-3.2.0/tar/creation_set.c"
              )
   lafe_errc(1, 0, "No memory");
