# 1 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
# 26 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
...
void list_item_verbose(struct bsdtar *, FILE *,
      struct archive_entry *);
# 31 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2
...
# 33 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 2
...
init_substitution(struct bsdtar *bsdtar)
{
 ...
 if (subst == 
# 64 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
             ((void *)0)
# 64 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                 )
  lafe_errc(1, 
# 65 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
              (*__errno_location ())
# 65 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   , "Out of memory");
 subst->first_rule = subst->last_rule = 
# 66 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                                       ((void *)0)
# 66 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                                           ;
}
...
add_substitution(struct bsdtar *bsdtar, const char *rule_text)
{
 ...
 if ((subst = bsdtar->substitution) == 
# 78 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                                      ((void *)0)
# 78 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                                          ) {
 ...
 if (rule == 
# 84 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
            ((void *)0)
# 84 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                )
  lafe_errc(1, 
# 85 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
              (*__errno_location ())
# 85 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   , "Out of memory");
 rule->next = 
# 86 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
             ((void *)0)
# 86 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                 ;

 if (subst->last_rule == 
# 88 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                        ((void *)0)
# 88 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                            )
 ...
 if (end_pattern == 
# 97 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                   ((void *)0)
# 97 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                       )
  lafe_errc(1, 0, "Invalid replacement string");

 pattern = malloc(end_pattern - rule_text);
 if (pattern == 
# 101 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
               ((void *)0)
# 101 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   )
  lafe_errc(1, 
# 102 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
              (*__errno_location ())
# 102 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   , "Out of memory");
 ...
 if (end_pattern == 
# 115 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                   ((void *)0)
# 115 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                       )
  lafe_errc(1, 0, "Invalid replacement string");

 rule->result = malloc(end_pattern - start_subst + 1);
 if (rule->result == 
# 119 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                    ((void *)0)
# 119 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                        )
  lafe_errc(1, 
# 120 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
              (*__errno_location ())
# 120 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   , "Out of memory");
...
realloc_strncat(char **str, const char *append, size_t len)
{
 ...
 if (*str == 
# 171 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
            ((void *)0)
# 171 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                )
  old_len = 0;
 else
  old_len = strlen(*str);
 ...
 if (new_str == 
# 177 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
               ((void *)0)
# 177 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   )
  lafe_errc(1, 
# 178 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
              (*__errno_location ())
# 178 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   , "Out of memory");
 if (*str != 
# 179 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
            ((void *)0)
# 179 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                )
...
realloc_strcat(char **str, const char *append)
{
 ...
 if (*str == 
# 193 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
            ((void *)0)
# 193 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                )
  old_len = 0;
 else
  old_len = strlen(*str);
 ...
 if (new_str == 
# 199 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
               ((void *)0)
# 199 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   )
  lafe_errc(1, 
# 200 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
              (*__errno_location ())
# 200 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   , "Out of memory");
 if (*str != 
# 201 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
            ((void *)0)
# 201 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                )
  memcpy(new_str, *str, old_len);
 ...
 *result = 
# 219 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
          ((void *)0)
# 219 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
              ;

 if ((subst = bsdtar->substitution) == 
# 221 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                                      ((void *)0)
# 221 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                                          )
  return 0;
 ...
 for (rule = subst->first_rule; rule != 
# 227 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                                       ((void *)0)
# 227 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                                           ; rule = rule->next) {
  if (symlink_target) {
   if (!rule->symlink)
    continue;
   ...
   for (i = 0, j = 0; rule->result[i] != '\0'; ++i) {
    ...
    case '9':
     ...
     if ((size_t)(c - '0') > (size_t)(rule->re.re_nsub)) {
      free(*result);
      *result = 
# 279 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
               ((void *)0)
# 279 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                   ;
      return -1;
     }
 ...
 if (print_match)
  fprintf(
# 305 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
         stderr
# 305 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
               , "%s >> %s\n", path, *result);
...
cleanup_substitution(struct bsdtar *bsdtar)
{
 ...
 if ((subst = bsdtar->substitution) == 
# 316 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                                      ((void *)0)
# 316 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                                          )
  return;

 while ((rule = subst->first_rule) != 
# 319 "/doner/libarchive/libarchive-3.2.0/tar/subst.c" 3 4
                                     ((void *)0)
# 319 "/doner/libarchive/libarchive-3.2.0/tar/subst.c"
                                         ) {
