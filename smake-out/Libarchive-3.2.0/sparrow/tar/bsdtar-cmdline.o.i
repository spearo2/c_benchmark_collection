# 1 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
# 30 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 2

# 31 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
...
# 35 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 2
...
void list_item_verbose(struct bsdtar *, FILE *,
      struct archive_entry *);
# 44 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 2
...
# 61 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
static const struct bsdtar_option {
 ...
 { "xz", 0, 'J' },
 { 
# 154 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
  ((void *)0)
# 154 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
      , 0, 0 }
};
# 199 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
int
bsdtar_getopt(struct bsdtar *bsdtar)
{
 ...
 const struct bsdtar_option *popt, *match = 
# 205 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                                           ((void *)0)
# 205 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                                               , *match2 = 
# 205 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                                                           ((void *)0)
# 205 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
 ...
 bsdtar->argument = 
# 211 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                   ((void *)0)
# 211 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                       ;
 ...
 if (bsdtar->getopt_state == state_start) {
  ...
  --bsdtar->argc;
  if (*bsdtar->argv == 
# 218 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                      ((void *)0)
# 218 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                          )
   return (-1);
 ...
 if (bsdtar->getopt_state == state_old_tar) {
  ...
  if (opt == '\0') {
   ...
   if (p == 
# 242 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
           ((void *)0)
# 242 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
               )
    return ('?');
   if (p[1] == ':') {
    bsdtar->argument = *bsdtar->argv;
    if (bsdtar->argument == 
# 246 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                           ((void *)0)
# 246 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                               ) {
     lafe_warnc(0,
 ...
 if (bsdtar->getopt_state == state_next_word) {
  ...
  if (bsdtar->argv[0] == 
# 263 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                        ((void *)0)
# 263 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                            )
   return (-1);
 ...
 if (bsdtar->getopt_state == state_short) {
  ...
  p = strchr(short_options, opt);
  if (p == 
# 302 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
          ((void *)0)
# 302 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
              )
   return ('?');
  if (p[1] == ':')
   required = 1;
  ...
  if (required) {
   ...
   if (bsdtar->getopt_word[0] == '\0') {
    ...
    bsdtar->getopt_word = *bsdtar->argv;
    if (bsdtar->getopt_word == 
# 313 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                              ((void *)0)
# 313 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                                  ) {
     lafe_warnc(0,
         "Option -%c requires an argument",
         opt);
 ...
 if (bsdtar->getopt_state == state_long) {
  ...
  if (p != 
# 339 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
          ((void *)0)
# 339 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
              ) {
  ...
  for (popt = tar_longopts; popt->name != 
# 347 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                                         ((void *)0)
# 347 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                                             ; popt++) {
   ...
   if (strncmp(bsdtar->getopt_word, popt->name, optlength) == 0) {
    ...
    if (strlen(popt->name) == optlength) {
     match2 = 
# 357 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
             ((void *)0)
# 357 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                 ;
     break;
    }
   }
  ...
  if (match == 
# 364 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
              ((void *)0)
# 364 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                  ) {
   lafe_warnc(0,
  ...
  if (match2 != 
# 370 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
               ((void *)0)
# 370 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                   ) {
   lafe_warnc(0,
  ...
  if (match->required) {
   ...
   if (bsdtar->argument == 
# 380 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                          ((void *)0)
# 380 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                              ) {
    bsdtar->argument = *bsdtar->argv;
    if (bsdtar->argument == 
# 382 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                           ((void *)0)
# 382 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                               ) {
     lafe_warnc(0,
   ...
   if (bsdtar->argument != 
# 393 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c" 3 4
                          ((void *)0)
# 393 "/doner/libarchive/libarchive-3.2.0/tar/cmdline.c"
                              ) {
    lafe_warnc(0,
