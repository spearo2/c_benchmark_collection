# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
...
# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2

# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
int _archive_entry_copy_uname_l(struct archive_entry *,
    const char *, size_t, struct archive_string_conv *);
# 48 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
# 51 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 2
...
archive_write_set_format_warc(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_warc")); if (magic_test == (-30)) return (-30); } while (0)
                                                        ;


 if (a->format_free != 
# 127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                      ((void *)0)
# 127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                          ) {
  (a->format_free)(a);
 }
 ...
 w = malloc(sizeof(*w));
 if (w == 
# 132 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
         ((void *)0)
# 132 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
             ) {
  archive_set_error(&a->archive, 
# 133 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                                12
# 133 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                                      ,
 ...
 w->now = time(
# 140 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
              ((void *)0)
# 140 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                  );
...
_warc_options(struct archive_write *a, const char *key, const char *val)
{
 ...
 if (strcmp(key, "omit-warcinfo") == 0) {
  if (val == 
# 167 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
            ((void *)0) 
# 167 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                 || strcmp(val, "true") == 0) {
...
# 192 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
         ((void *)0)
# 192 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
             ,
          
# 193 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
         ((void *)0)
# 193 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
             ,
          0,
          0,
  ...
  do { (&hdr)->s = 
# 202 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
 ((void *)0)
# 202 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
 ; (&hdr)->length = 0; (&hdr)->buffer_length = 0; } while(0);
  r = _popul_ehdr(&hdr, 512, wi);
  if (r >= 0) {
   ...
   __archive_write_output(a, hdr.s, ((&hdr)->length));
  }
...
# 220 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                                     ((void *)0)
# 220 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                                         ) {
  archive_set_error(&a->archive, 
# 221 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                                22
# 221 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                                      ,
      "Invalid filename");
  return ((-20));
 }
 ...
 w->populz = 0U;
 if (w->typ == ((mode_t)0100000)) {
  warc_essential_hdr_t rh = {
   WT_RSRC,
          
# 231 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
         ((void *)0)
# 231 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
             ,
          
# 232 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
         ((void *)0)
# 232 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
             ,
          0,
          0,
          
# 235 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
         ((void *)0)
# 235 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
             ,
          0,
  };
  ssize_t r;
  ...
  do { (&hdr)->s = 
# 244 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
 ((void *)0)
# 244 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
 ; (&hdr)->length = 0; (&hdr)->buffer_length = 0; } while(0);
  r = _popul_ehdr(&hdr, 512, rh);
  if (r < 0) {

   archive_set_error(
    &a->archive,
    
# 250 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
   84
# 250 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                            ,
    "cannot archive file");
   return ((-20));
  }
...
# 264 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
 84
# 264 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                          ,
...
_warc_free(struct archive_write *a)
{
 ...
 free(w);
 a->format_data = 
# 322 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                 ((void *)0)
# 322 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                     ;
 return (0);
}
...
xstrftime(struct archive_string *as, const char *fmt, time_t t)
{
 ...
 if ((rt = gmtime_r(&t, &timeHere)) == 
# 340 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                                      ((void *)0)
# 340 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                                          )
  return;
...
# 358 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
 ((void *)0)
# 358 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
     , "warcinfo", "metadata", "resource", 
# 358 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                                           ((void *)0)
 
# 359 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
};
 char std_uuid[48U];
 ...
 (((tgt))->length=0, archive_strncat(((tgt)), ((_ver)), (((_ver) == 
# 367 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
((void *)0) 
# 367 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
? 0 : strlen(_ver)))));

 archive_string_sprintf(tgt, "WARC-Type: %s\r\n", _typ[hdr.type]);

 if (hdr.tgturi != 
# 371 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                  ((void *)0)
# 371 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                      ) {
  ...
  if (chk != 
# 378 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
            ((void *)0) 
# 378 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                 && chk[1U] == '/' && chk[2U] == '/') {
 ...
 if (hdr.recid == 
# 396 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                 ((void *)0)
# 396 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                     ) {
 ...
 if (hdr.cnttyp != 
# 421 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c" 3 4
                  ((void *)0)
# 421 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_warc.c"
                      ) {
 ...
 return (((tgt)->length) >= tsz)? -1: (ssize_t)((tgt)->length);
}
