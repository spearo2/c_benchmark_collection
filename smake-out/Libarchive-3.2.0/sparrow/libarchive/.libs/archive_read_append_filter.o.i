# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 2
...
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                    22
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                                            ,
    ...
    default:
      archive_set_error(&a->archive, 
# 101 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                    22
# 101 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                                            ,
  ...
  if (code != 0)
  {
    ...
    {
      archive_set_error(&a->archive, 
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                    22
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                                            ,
    ...
    if (filter == 
# 125 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                 ((void *)0)
# 125 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                     )
    {
      archive_set_error(&a->archive, 
# 127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                    12
# 127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                          , "Out of memory");
      return ((-30));
    }
...
{
  return (archive_read_append_filter_program_signature(_a, cmd, 
# 149 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                                               ((void *)0)
# 149 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                                                   , 0));
}
  ...
  const char *cmd, const void *signature, size_t signature_len)
{
  ...
  {
    archive_set_error(&a->archive, 
# 176 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                  22
# 176 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                                          ,
  ...
  filter
      = (struct archive_read_filter *)calloc(1, sizeof(*filter));
  if (filter == 
# 183 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
               ((void *)0)
# 183 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                   )
  {
    archive_set_error(&a->archive, 
# 185 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c" 3 4
                                  12
# 185 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_append_filter.c"
                                        , "Out of memory");
    return ((-30));
  }
  filter->bidder = bidder;
