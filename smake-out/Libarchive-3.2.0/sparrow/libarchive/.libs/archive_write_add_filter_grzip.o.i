# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 2
...
archive_write_add_filter_grzip(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_grzip")); if (magic_test == (-30)) return (-30); } while (0)
                                                         ;

 data = calloc(1, sizeof(*data));
 if (data == 
# 62 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 3 4
            ((void *)0)
# 62 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
                ) {
  archive_set_error(_a, 
# 63 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 3 4
                       12
# 63 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
                             , "Can't allocate memory");
  return ((-30));
 }
 data->pdata = __archive_write_program_allocate("grzip");
 if (data->pdata == 
# 67 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 3 4
                   ((void *)0)
# 67 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
                       ) {
  free(data);
  archive_set_error(_a, 
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c" 3 4
                       12
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_grzip.c"
                             , "Can't allocate memory");
  return ((-30));
 }
