# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
struct _undefined_hack;
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 54 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 56 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 59 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 61 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
# 62 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 2
...
archive_write_new(void)
{
 ...
 if (a == 
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
         ((void *)0)
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
             )
  return (
# 114 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
         ((void *)0)
# 114 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
             );
 memset(a, 0, sizeof(*a));
 a->archive.magic = (0xb0c5c0deU);
 a->archive.state = 1U;
 ...
 if (nulls == 
# 130 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
             ((void *)0)
# 130 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                 ) {
  free(a);
  return (
# 132 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
         ((void *)0)
# 132 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
             );
 }
...
archive_write_set_bytes_per_block(struct archive *_a, int bytes_per_block)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (1U), ("archive_write_set_bytes_per_block")); if (magic_test == (-30)) return (-30); } while (0)
                                                            ;
...
{
 struct archive_write *a = (struct archive_write *)_a;
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), ((0xFFFFU & ~0x8000U)), ("archive_write_get_bytes_per_block")); if (magic_test == (-30)) return (-30); } while (0)
                                                            ;
...
{
 struct archive_write *a = (struct archive_write *)_a;
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), ((0xFFFFU & ~0x8000U)), ("archive_write_set_bytes_in_last_block")); if (magic_test == (-30)) return (-30); } while (0)
                                                                ;
...
{
 struct archive_write *a = (struct archive_write *)_a;
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), ((0xFFFFU & ~0x8000U)), ("archive_write_get_bytes_in_last_block")); if (magic_test == (-30)) return (-30); } while (0)
                                                                ;
...
{
 struct archive_write *a = (struct archive_write *)_a;
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), ((0xFFFFU & ~0x8000U)), ("archive_write_set_skip_file")); if (magic_test == (-30)) return (-30); } while (0)
                                                      ;
 a->skip_file_set = 1;
 a->skip_file_dev = d;
 a->skip_file_ino = i;
...
__archive_write_allocate_filter(struct archive *_a)
{
 ...
 f->archive = _a;
 if (a->filter_first == 
# 217 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                       ((void *)0)
# 217 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                           )
  a->filter_first = f;
 else
    ...
    const void *buff, size_t length)
{
 ...
 if (length == 0)
  return(0);
 if (f->write == 
# 235 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                ((void *)0)
# 235 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                    )
...
{
 if (f->open == 
# 250 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
               ((void *)0)
# 250 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                   )
  return (0);
 return (f->open)(f);
}
...
{
 if (f->close != 
# 261 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                ((void *)0)
# 261 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                    )
  return (f->close)(f);
 if (f->next_filter != 
# 263 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                      ((void *)0)
# 263 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                          )
...
archive_write_client_open(struct archive_write_filter *f)
{
 ...
 if (state == 
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
             ((void *)0) 
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                  || buffer == 
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                               ((void *)0)
# 305 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
...
# 308 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                               12
# 308 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                                     ,
 ...
 if (a->client_opener == 
# 319 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                        ((void *)0)
# 319 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                            )
  return (0);
...
archive_write_client_close(struct archive_write_filter *f)
{
 ...
 f->close = 
# 445 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
           ((void *)0)
# 445 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
               ;
 a->client_data = 
# 446 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                 ((void *)0)
# 446 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                     ;

 if (a->passphrase != 
# 448 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                     ((void *)0)
# 448 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                         ) {
  memset(a->passphrase, 0, strlen(a->passphrase));
  free(a->passphrase);
  a->passphrase = 
# 451 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                 ((void *)0)
# 451 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                     ;
 }
 return (ret);
}
    ...
    archive_close_callback *closer)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (1U), ("archive_write_open")); if (magic_test == (-30)) return (-30); } while (0)
                                             ;
...
_archive_write_close(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), ((0xFFFFU & ~0x8000U) | 0x8000U), ("archive_write_close")); if (magic_test == (-30)) return (-30); } while (0)

                           ;
 if (a->archive.state == 1U
...
# 514 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                                 ((void *)0)
# 514 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                                     )
 ...
 if (a->format_close != 
# 519 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                       ((void *)0)
# 519 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                           ) {
  r1 = (a->format_close)(a);
  if (r1 < r)
   r = r1;
...
# 554 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                          ((void *)0)
# 554 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                              ) {
  struct archive_write_filter *next
      = a->filter_first->next_filter;
  if (a->filter_first->free != 
# 557 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                              ((void *)0)
# 557 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                                  ) {
 ...
 a->filter_last = 
# 565 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                 ((void *)0)
# 565 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                     ;
}
# 575 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
static int
_archive_write_free(struct archive *_a)
{
 ...
 if (_a == 
# 581 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
          ((void *)0)
# 581 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
              )
  return (0);

 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), ((0xFFFFU & ~0x8000U) | 0x8000U), ("archive_write_free")); if (magic_test == (-30)) return (-30); } while (0)
                                                                   ;
 if (a->archive.state != 0x8000U)
 ...
 if (a->format_free != 
# 590 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                      ((void *)0)
# 590 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                          ) {
  r1 = (a->format_free)(a);
  if (r1 < r)
   r = r1;
 ...
 if (a->passphrase != 
# 601 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                     ((void *)0)
# 601 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                         ) {
...
_archive_write_header(struct archive *_a, struct archive_entry *entry)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (4U | 2U), ("archive_write_header")); if (magic_test == (-30)) return (-30); } while (0)
                                                                       ;
 archive_clear_error(&a->archive);

 if (a->format_write_header == 
# 625 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                              ((void *)0)
# 625 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                                  ) {
...
_archive_write_finish_entry(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (2U | 4U), ("archive_write_finish_entry")); if (magic_test == (-30)) return (-30); } while (0)

                                  ;
 if (a->archive.state & 4U
     && a->format_finish_entry != 
# 677 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                                 ((void *)0)
# 677 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                                     )
...
{
 struct archive_write *a = (struct archive_write *)_a;
 const size_t max_write = 0x7fffffff;

 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (4U), ("archive_write_data")); if (magic_test == (-30)) return (-30); } while (0)
                                              ;
...
filter_lookup(struct archive *_a, int n)
{
 ...
 if (n < 0)
  return 
# 709 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
        ((void *)0)
# 709 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
            ;
 while (n > 0 && f != 
# 710 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                     ((void *)0)
# 710 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                         ) {
  f = f->next_filter;
  --n;
 }
...
_archive_filter_code(struct archive *_a, int n)
{
 ...
 return f == 
# 721 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
            ((void *)0) 
# 721 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                 ? -1 : f->code;
}
...
_archive_filter_name(struct archive *_a, int n)
{
 struct archive_write_filter *f = filter_lookup(_a, n);
 return f != 
# 728 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
            ((void *)0) 
# 728 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                 ? f->name : 
# 728 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
                             ((void *)0)
# 728 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
...
_archive_filter_bytes(struct archive *_a, int n)
{
 struct archive_write_filter *f = filter_lookup(_a, n);
 return f == 
# 735 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c" 3 4
            ((void *)0) 
# 735 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write.c"
                 ? -1 : f->bytes_written;
}
