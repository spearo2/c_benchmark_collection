# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 2
...
# 108 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
int
__archive_cmdline_parse(struct archive_cmdline *data, const char *cmd)
{
 ...
 do { (&as)->s = 
# 116 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
((void *)0)
# 116 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
; (&as)->length = 0; (&as)->buffer_length = 0; } while(0);
 ...
 p = strrchr(as.s, '/');
 if (p == 
# 132 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
         ((void *)0)
# 132 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
             )
  p = as.s;
 else
  p++;
...
cmdline_set_path(struct archive_cmdline *data, const char *path)
{
 ...
 if (newptr == 
# 171 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
              ((void *)0)
# 171 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                  )
  return ((-30));
 data->path = newptr;
...
cmdline_add_arg(struct archive_cmdline *data, const char *arg)
{
 ...
 if (data->path == 
# 186 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
                  ((void *)0)
# 186 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                      )
  return ((-25));

 newargv = realloc(data->argv, (data->argc + 2) * sizeof(char *));
 if (newargv == 
# 190 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
               ((void *)0)
# 190 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                   )
  return ((-30));
 data->argv = newargv;
 data->argv[data->argc] = strdup(arg);
 if (data->argv[data->argc] == 
# 194 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
                              ((void *)0)
# 194 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                                  )
  return ((-30));

 data->argv[++data->argc] = 
# 197 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
                           ((void *)0)
# 197 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                               ;
 return (0);
}
...
__archive_cmdline_free(struct archive_cmdline *data)
{
 ...
 if (data) {
  free(data->path);
  if (data->argv != 
# 217 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
                   ((void *)0)
# 217 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                       ) {
   int i;
   for (i = 0; data->argv[i] != 
# 219 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c" 3 4
                               ((void *)0)
# 219 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cmdline.c"
                                   ; i++)
    free(data->argv[i]);
   free(data->argv);
  }
