# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 2
...
archive_read_open_fd(struct archive *a, int fd, size_t block_size)
{
 ...
 if (fstat(fd, &st) != 0) {
  archive_set_error(a, 
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                      (*__errno_location ())
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                           , "Can't stat fd %d", fd);
  return ((-30));
 }
 ...
 b = malloc(block_size);
 if (mine == 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
            ((void *)0) 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                 || b == 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                         ((void *)0)
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
  ...
  archive_set_error(a, 
# 81 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                      12
# 81 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                            , "No memory");
  free(mine);
  free(b);
  return ((-30));
 ...
 if (
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
    ((((
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
    st.st_mode
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
    )) & 0170000) == (0100000))
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
 ...
 *buff = mine->buffer;
 for (;;) {
  ...
  if (bytes_read < 0) {
   if (
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
      (*__errno_location ()) 
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
            == 
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
               4
# 122 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
    ...
    continue;
   archive_set_error(a, 
# 124 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                       (*__errno_location ())
# 124 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                            , "Error reading fd %d",
       mine->fd);
  }
  return (bytes_read);
...
# 155 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                                      1
# 155 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                                              )) >= 0) &&
     ((new_offset = lseek(mine->fd, skip, 
# 156 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                                         1
# 156 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                                                 )) >= 0))
 ...
 if (
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
    (*__errno_location ()) 
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
          == 
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
             29
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
 ...
 archive_set_error(a, 
# 171 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                     (*__errno_location ())
# 171 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                          , "Error seeking");
 return (-1);
}
...
file_seek(struct archive *a, void *client_data, int64_t request, int whence)
{
 ...
 if (
# 190 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
    (*__errno_location ()) 
# 190 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
          == 
# 190 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
             29
# 190 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
  ...
  archive_set_error(a, 
# 191 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                      (*__errno_location ())
# 191 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                           ,
  ...
  archive_set_error(a, 
# 196 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c" 3 4
                      (*__errno_location ())
# 196 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_fd.c"
                           ,
