# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
...
# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2

# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 2
...
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
...
archive_write_set_format_ar_bsd(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_ar_bsd")); if (magic_test == (-30)) return (-30); } while (0)
                                                          ;
...
archive_write_set_format_ar_svr4(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_ar_svr4")); if (magic_test == (-30)) return (-30); } while (0)
                                                           ;
 r = archive_write_set_format_ar(a);
 if (r == 0) {
...
archive_write_set_format_ar(struct archive_write *a)
{
 ...
 if (a->format_free != 
# 126 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                      ((void *)0)
# 126 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                          )
  (a->format_free)(a);

 ar = (struct ar_w *)malloc(sizeof(*ar));
 if (ar == 
# 130 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
          ((void *)0)
# 130 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
              ) {
  archive_set_error(&a->archive, 
# 131 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                12
# 131 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
...
archive_write_ar_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 ar->is_strtab = 0;
 filename = 
# 160 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
           ((void *)0)
# 160 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
               ;
 ...
 if (pathname == 
# 168 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                ((void *)0) 
# 168 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                     || *pathname == '\0') {
  archive_set_error(&a->archive, 
# 169 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                22
# 169 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
      "Invalid filename");
  return ((-20));
 }
 ...
 if ((filename = ar_basename(pathname)) == 
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                          ((void *)0)
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                              ) {

  archive_set_error(&a->archive, 
# 216 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                22
# 216 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
      "Invalid filename");
  return ((-20));
 }
 ...
 if (a->archive.archive_format == (0x70000 | 1)) {
  ...
  if (strlen(filename) <= 15) {
   ...
   if (ar->has_strtab <= 0) {
    archive_set_error(&a->archive, 
# 240 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                  22
# 240 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                        ,
   ...
   if (se == 
# 246 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
            ((void *)0)
# 246 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                ) {
    archive_set_error(&a->archive, 
# 247 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                  12
# 247 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                        ,
   ...
   if (ss == 
# 258 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
            ((void *)0)
# 258 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                ) {
    archive_set_error(&a->archive, 
# 259 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                  22
# 259 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                        ,
   ...
   if (format_decimal(ss - ar->strtab,
       ...
       16 - 1)) {
    archive_set_error(&a->archive, 
# 273 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                  34
# 273 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                        ,
...
# 288 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
  if (strlen(filename) <= 16 && strchr(filename, ' ') == 
# 288 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                                        ((void *)0)
# 288 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                                            ) {
   strncpy(&buff[0], filename, strlen(filename));
   buff[0 + strlen(filename)] = ' ';
  }
  else {
   strncpy(buff + 0, "#1/", 3);
   if (format_decimal(strlen(filename),
       ...
       16 - 3)) {
    archive_set_error(&a->archive, 
# 297 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                  34
# 297 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                        ,
        "File name too long");
    return ((-20));
   }
...
stat:
 if (format_decimal(archive_entry_mtime(entry), buff + 16, 12)) {
  archive_set_error(&a->archive, 
# 308 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                34
# 308 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
      "File modification time too large");
  return ((-20));
 }
 if (format_decimal(archive_entry_uid(entry), buff + 28, 6)) {
  archive_set_error(&a->archive, 
# 313 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                34
# 313 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
      "Numeric user ID too large");
  return ((-20));
 }
 if (format_decimal(archive_entry_gid(entry), buff + 34, 6)) {
  archive_set_error(&a->archive, 
# 318 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                34
# 318 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
      "Numeric group ID too large");
  return ((-20));
 }
 if (format_octal(archive_entry_mode(entry), buff + 40, 8)) {
  archive_set_error(&a->archive, 
# 323 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                34
# 323 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
 ...
 if (filename != 
# 331 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                ((void *)0) 
# 331 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                     && archive_entry_filetype(entry) != ((mode_t)0100000)) {
  archive_set_error(&a->archive, 
# 332 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                22
# 332 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
...
size:
 if (format_decimal(size, buff + 48, 10)) {
  archive_set_error(&a->archive, 
# 339 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                34
# 339 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                      ,
...
archive_write_ar_data(struct archive_write *a, const void *buff, size_t s)
{
 ...
 if (ar->is_strtab > 0) {
  if (ar->has_strtab > 0) {
   archive_set_error(&a->archive, 
# 373 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                 22
# 373 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                       ,
  ...
  if (ar->strtab == 
# 379 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                   ((void *)0)
# 379 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                       ) {
   archive_set_error(&a->archive, 
# 380 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                                 12
# 380 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                                       ,
...
archive_write_ar_free(struct archive_write *a)
{
 ...
 if (ar == 
# 403 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
          ((void *)0)
# 403 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
              )
  return (0);
 ...
 if (ar->has_strtab > 0) {
  free(ar->strtab);
  ar->strtab = 
# 408 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
              ((void *)0)
# 408 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                  ;
 }

 free(ar);
 a->format_data = 
# 412 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
                 ((void *)0)
# 412 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
                     ;
 return (0);
}
...
ar_basename(const char *path)
{
 ...
 if (*endp == '/')
  return (
# 556 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c" 3 4
         ((void *)0)
# 556 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_ar.c"
             );
