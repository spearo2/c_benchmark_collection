# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2


# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 48 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 2
...
# 101 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
struct private_data {
...
common_setup(struct archive_write_filter *f)
{
 ...
 if (data == 
# 149 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
            ((void *)0)
# 149 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                ) {
  archive_set_error(&a->archive, 
# 150 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                                12
# 150 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                      , "Out of memory");
  return ((-30));
 }
 f->data = data;
 data->compression_level = 
# 154 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                          6U
# 154 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                             ;
 data->threads = 1;
...
archive_write_add_filter_xz(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_xz")); if (magic_test == (-30)) return (-30); } while (0)
                                                      ;
...
archive_write_add_filter_lzma(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_lzma")); if (magic_test == (-30)) return (-30); } while (0)
                                                        ;
 f = __archive_write_allocate_filter(_a);
 r = common_setup(f);
 if (r == 0) {
...
archive_write_add_filter_lzip(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_lzip")); if (magic_test == (-30)) return (-30); } while (0)
                                                        ;
 f = __archive_write_allocate_filter(_a);
 r = common_setup(f);
 if (r == 0) {
...
archive_compressor_xz_init_stream(struct archive_write_filter *f,
    struct private_data *data)
{
 static const lzma_stream lzma_stream_init_data = 
# 224 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                                                 { ((void *)0), 0, 0, ((void *)0), 0, 0, ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0, 0, 0, 0, LZMA_RESERVED_ENUM, LZMA_RESERVED_ENUM }
# 224 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                                                 ;
 int ret;
 ...
 if (f->code == 6) {
# 245 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
...
# 290 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                               12
# 290 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                     ,
...
archive_compressor_xz_open(struct archive_write_filter *f)
{
 ...
 if (data->compressed == 
# 316 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                        ((void *)0)
# 316 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                            ) {
  size_t bs = 65536, bpb;
  if (f->archive->magic == (0xb0c5c0deU)) {
  ...
  if (data->compressed == 
# 330 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                         ((void *)0)
# 330 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                             ) {
   archive_set_error(f->archive, 
# 331 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                                12
# 331 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                      ,
 ...
 if (f->code == 9) {
  ...
  data->lzma_opt.preset_dict = 
# 345 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                              ((void *)0)
# 345 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                  ;
  data->lzma_opt.preset_dict_size = 0;
  data->lzma_opt.lc = 
# 347 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                     3
# 347 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                    ;
  data->lzma_opt.lp = 
# 348 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                     0
# 348 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                    ;
  data->lzma_opt.pb = 
# 349 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                     2
# 349 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                    ;
  data->lzma_opt.mode =
...
# 355 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                           0x4000000000000001UL
# 355 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                            ;
  data->lzmafilters[0].options = &data->lzma_opt;
  data->lzmafilters[1].id = 
# 357 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                           (18446744073709551615UL)
# 357 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                           ;
 } else {
  ...
  data->lzmafilters[0].id = 
# 363 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                           0x21UL
# 363 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                            ;
  data->lzmafilters[0].options = &data->lzma_opt;
  data->lzmafilters[1].id = 
# 365 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                           (18446744073709551615UL)
# 365 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                           ;
 }
    ...
    const char *key, const char *value)
{
 ...
 if (strcmp(key, "compression-level") == 0) {
  if (value == 
# 385 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
              ((void *)0) 
# 385 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                   || !(value[0] >= '0' && value[0] <= '9') ||
      value[1] != '\0')
   return ((-20));
  ...
  if (value == 
# 393 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
              ((void *)0)
# 393 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                  )
   return ((-20));
  data->threads = (int)strtoul(value, 
# 395 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                                     ((void *)0)
# 395 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                         , 10);
  if (data->threads == 0 && 
# 396 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                           (*__errno_location ()) 
# 396 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                 != 0) {
   data->threads = 1;
   return ((-20));
  }
    ...
    const void *buff, size_t length)
{
 ...
 if ((ret = drive_compressor(f, data, 0)) != 0)
  return (ret);
...
archive_compressor_xz_free(struct archive_write_filter *f)
{
 ...
 free(data);
 f->data = 
# 476 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
          ((void *)0)
# 476 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
              ;
 return (0);
}
# 487 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
static int
    ...
    struct private_data *data, int finishing)
{
 ...
 for (;;) {
  ...
  case LZMA_MEMLIMIT_ERROR:
   archive_set_error(f->archive, 
# 529 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c" 3 4
                                12
# 529 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_xz.c"
                                      ,
