# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
int _archive_entry_copy_uname_l(struct archive_entry *,
    const char *, size_t, struct archive_string_conv *);
# 48 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_private.h" 1
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_private.h" 1
# 51 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 2
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
struct _7z_digests {
...
struct _7zip {
 ...
 int lzstream_valid;
# 278 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 z_stream stream;
 int stream_valid;
...
archive_read_support_format_7zip(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xdeb0c5U)), (1U), ("archive_read_support_format_7zip")); if (magic_test == (-30)) return (-30); } while (0)
                                                           ;

 zip = calloc(1, sizeof(*zip));
 if (zip == 
# 413 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
           ((void *)0)
# 413 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
               ) {
  archive_set_error(&a->archive, 
# 414 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                12
# 414 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      ,
...
# 430 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
    ((void *)0)
# 430 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
        ,
     archive_read_format_7zip_read_header,
     archive_read_format_7zip_read_data,
     archive_read_format_7zip_read_data_skip,
     
# 434 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
    ((void *)0)
# 434 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
        ,
...
archive_read_format_7zip_bid(struct archive_read *a, int best_bid)
{
 ...
 if ((p = __archive_read_ahead(a, 6, 
# 475 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                    ((void *)0)
# 475 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        )) == 
# 475 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                              ((void *)0)
# 475 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 ...
 if (memcmp(p, "7z\xBC\xAF\x27\x1C", 6) == 0)
  return (48);
# 491 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 if ((p[0] == 'M' && p[1] == 'Z') || memcmp(p, "\x7F\x45LF", 4) == 0) {
  ...
  while (offset + window <= (0x60000)) {
   ...
   if (buff == 
# 498 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
              ((void *)0)
# 498 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                  ) {
...
skip_sfx(struct archive_read *a, ssize_t bytes_avail)
{
 ...
 else if (__archive_read_seek(a, 0x27000, 
# 559 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                              0
# 559 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                      ) < 0)
  return ((-30));

 offset = 0;
 window = 1;
 while (offset + window <= 0x60000 - 0x27000) {
  h = __archive_read_ahead(a, window, &bytes);
  if (h == 
# 566 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          ((void *)0)
# 566 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              ) {
...
fatal:
 archive_set_error(&a->archive, 
# 604 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                               84
# 604 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                        ,
 ...
 struct archive_entry *entry)
{
 ...
 uint64_t fidx = 0;
# 626 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 if (zip->has_encrypted_entries == -1) {
  zip->has_encrypted_entries = 0;
 }

 a->archive.archive_format = 0xE0000;
 if (a->archive.archive_format_name == 
# 631 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                      ((void *)0)
# 631 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                          )
  a->archive.archive_format_name = "7-Zip";

 if (zip->entries == 
# 634 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    ((void *)0)
# 634 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                        ) {
 ...
 if (zip->entries_remaining <= 0 || zip_entry == 
# 649 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                ((void *)0)
# 649 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                    )
  return 1;
 ...
 zip->entry_offset = 0;
 zip->end_of_entry = 0;
 zip->entry_crc32 = crc32(0, 
# 655 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                            ((void *)0)
# 655 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                , 0);


 if (zip->sconv == 
# 658 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                  ((void *)0)
# 658 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                      ) {
  zip->sconv = archive_string_conversion_from_charset(
      &a->archive, "UTF-16LE", 1);
  if (zip->sconv == 
# 661 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                   ((void *)0)
# 661 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                       )
   return ((-30));
 }
 ...
 if (_archive_entry_copy_pathname_l(entry,
     (const char *)zip_entry->utf16name,
     zip_entry->name_len, zip->sconv) != 0) {
  if (
# 694 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
     (*__errno_location ()) 
# 694 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
           == 
# 694 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
              12
# 694 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
   ...
   archive_set_error(&a->archive, 
# 695 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 12
# 695 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       ,
...
# 700 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
     84
# 700 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                              ,
 ...
 if ((zip_entry->mode & ((mode_t)0170000)) == ((mode_t)0120000)) {
  unsigned char *symname = 
# 732 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                          ((void *)0)
# 732 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                              ;
  size_t symsize = 0;
  ...
  while (zip->entry_bytes_remaining > 0) {
   ...
   if (mem == 
# 752 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
             ((void *)0)
# 752 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                 ) {
    free(symname);
    archive_set_error(&a->archive, 
# 754 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  12
# 754 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        ,
  ...
  if (symsize == 0) {
   ...
   zip_entry->mode &= ~((mode_t)0170000);
   zip_entry->mode |= ((mode_t)0100000);
   archive_entry_set_mode(entry, zip_entry->mode);
  } else {
   symname[symsize] = '\0';
 ...
 *size = 0;
 *buff = 
# 803 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
        ((void *)0)
# 803 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
            ;
...
# 817 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
     84
# 817 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                              ,
...
archive_read_format_7zip_cleanup(struct archive_read *a)
{
 ...
 free(zip);
 (a->format->data) = 
# 897 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    ((void *)0)
# 897 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                        ;
 return (0);
}
...
set_error(struct archive_read *a, int ret)
{
 ...
 case LZMA_MEM_ERROR:
  archive_set_error(&a->archive, 
# 927 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                12
# 927 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      ,
      "Lzma library error: Cannot allocate memory");
  break;
 case LZMA_MEMLIMIT_ERROR:
  archive_set_error(&a->archive, 
# 931 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                12
# 931 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      ,
...
ppmd_read(void *p)
{
 ...
 if (zip->ppstream.avail_in == 0) {
  archive_set_error(&a->archive, 
# 998 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                84
# 998 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                         ,
    ...
    const struct _7z_coder *coder1, const struct _7z_coder *coder2)
{
 ...
 case 0x030401:
  if (coder2 != 
# 1025 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
               ((void *)0)
# 1025 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                   ) {
   if (coder2->codec != 0x03030103 &&
       coder2->codec != 0x0303011B) {
    archive_set_error(&a->archive,
        (-1),
 ...
 case 0x030101: case 0x21:
# 1057 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 {
  lzma_options_delta delta_opt;
  lzma_filter filters[
# 1059 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                     4
# 1059 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     ];
...
# 1088 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  if (coder2 != 
# 1088 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
               ((void *)0)
# 1088 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                   ) {
   zip->codec2 = coder2->codec;
   ...
   filters[fi].options = 
# 1091 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                        ((void *)0)
# 1091 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                            ;
   switch (zip->codec2) {
   case 0x03030103:
    if (zip->codec == 0x21) {
     filters[fi].id = 
# 1095 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                     0x04UL
# 1095 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    ;
     fi++;
    } else
   ...
   case 0x03:
    filters[fi].id = 
# 1106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    0x03UL
# 1106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     ;
   ...
   case 0x03030205:
    filters[fi].id = 
# 1115 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    0x05UL
# 1115 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       ;
    fi++;
    break;
   case 0x03030401:
    filters[fi].id = 
# 1119 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    0x06UL
# 1119 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    ;
    fi++;
    break;
   case 0x03030501:
    filters[fi].id = 
# 1123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    0x07UL
# 1123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                   ;
    fi++;
    break;
   case 0x03030701:
    filters[fi].id = 
# 1127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    0x08UL
# 1127 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        ;
    fi++;
    break;
   case 0x03030805:
    filters[fi].id = 
# 1131 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    0x09UL
# 1131 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     ;
    fi++;
    break;
   default:
  ...
  if (zip->codec == 0x21)
   filters[fi].id = 
# 1143 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                   0x21UL
# 1143 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    ;
  else
   filters[fi].id = 
# 1145 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                   0x4000000000000001UL
# 1145 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    ;
  filters[fi].options = 
# 1146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                       ((void *)0)
# 1146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                           ;



  r = lzma_properties_decode(&filters[fi], 
# 1150 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                          ((void *)0)
# 1150 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                              ,
  ...
  filters[fi].id = 
# 1158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                  (18446744073709551615UL)
# 1158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                  ;
  filters[fi].options = 
# 1159 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                       ((void *)0)
# 1159 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                           ;
 ...
 case 0x040202:
# 1215 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  archive_set_error(&a->archive, (-1),
 ...
 case 0x040108:
  ...
  if (zip->stream_valid)
   ...
   r = 
# 1224 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      inflateInit2_((
# 1224 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
      &(zip->stream)
# 1224 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      ), (
# 1224 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
...
# 1225 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                            ;
  if (r != 
# 1226 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          0
# 1226 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              ) {
   archive_set_error(&a->archive, (-1),
 ...
 case 0x030401:
 {
  ...
  if (order < 2 || order > 64 ||
      msize < (1 << 11) || msize > (0xFFFFFFFF - 12 * 3)) {
   archive_set_error(&a->archive, (-1),
       "Malformed PPMd parameter");
   return ((-25));
  }
  ...
  if (r == 0) {
   archive_set_error(&a->archive, 
# 1268 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 12
# 1268 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       ,
    ...
    void *buff, size_t *outbytes, const void *b, size_t *used)
{
 ...
 if (zip->codec != 0x21 && zip->codec2 == 0x03030103) {
  int i;
 ...
 case 0x030101: case 0x21:
  ...
  break;
# 1464 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 case 0x040108:
  ...
  switch (r) {
  case 
# 1471 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      1
# 1471 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                  :
   ret = 1;
   break;
  case 
# 1474 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      0
# 1474 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
          :
   break;
  default:
   archive_set_error(&a->archive, (-1),
...
# 1534 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
       84
# 1534 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                ,
...
free_decompression(struct archive_read *a, struct _7zip *zip)
{
 ...
 if (zip->lzstream_valid)
  lzma_end(&(zip->lzstream));
# 1634 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 if (zip->stream_valid) {
  if (inflateEnd(&(zip->stream)) != 
# 1635 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                   0
# 1635 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       ) {
   archive_set_error(&a->archive,
       (-1),
...
parse_7zip_uint64(struct archive_read *a, uint64_t *val)
{
 ...
 if ((p = header_bytes(a, 1)) == 
# 1659 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 1659 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 avail = *p;
 mask = 0x80;
 *val = 0;
 for (i = 0; i < 8; i++) {
  if (avail & mask) {
   if ((p = header_bytes(a, 1)) == 
# 1666 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  ((void *)0)
# 1666 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      )
    return (-1);
   *val |= ((uint64_t)*p) << (8 * i);
   mask >>= 1;
...
read_Bools(struct archive_read *a, unsigned char *data, size_t num)
{
 ...
 for (i = 0; i < num; i++) {
  if (mask == 0) {
   if ((p = header_bytes(a, 1)) == 
# 1686 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  ((void *)0)
# 1686 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      )
    return (-1);
   avail = *p;
   mask = 0x80;
...
read_Digests(struct archive_read *a, struct _7z_digests *d, size_t num)
{
 ...
 if (d->defineds == 
# 1715 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                   ((void *)0)
# 1715 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                       )
  return (-1);
 ...
 if ((p = header_bytes(a, 1)) == 
# 1720 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 1720 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 if (*p == 0) {
 ...
 if (d->digests == 
# 1730 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                  ((void *)0)
# 1730 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                      )
  return (-1);
 for (i = 0; i < num; i++) {
  if (d->defineds[i]) {
   if ((p = header_bytes(a, 4)) == 
# 1734 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  ((void *)0)
# 1734 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      )
    return (-1);
...
read_PackInfo(struct archive_read *a, struct _7z_pack_info *pi)
{
 ...
 if (pi->numPackStreams == 0)
  return (-1);
 if (100000000ull < pi->numPackStreams)
  return (-1);
 ...
 if ((p = header_bytes(a, 1)) == 
# 1778 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 1778 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 if (*p == 0x00)
 ...
 if (pi->sizes == 
# 1787 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                 ((void *)0) 
# 1787 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                      || pi->positions == 
# 1787 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                          ((void *)0)
# 1787 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 ...
 if ((p = header_bytes(a, 1)) == 
# 1798 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 1798 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 if (*p == 0x00) {
  ...
  if (pi->digest.defineds == 
# 1806 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                            ((void *)0) 
# 1806 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                 || pi->digest.digests == 
# 1806 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                          ((void *)0)
# 1806 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
 ...
 if ((p = header_bytes(a, 1)) == 
# 1820 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 1820 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 if (*p != 0x00)
  return (-1);
...
read_Folder(struct archive_read *a, struct _7z_folder *f)
{
 ...
 if (f->coders == 
# 1864 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                 ((void *)0)
# 1864 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                     )
  return (-1);
 for (i = 0; i< f->numCoders; i++) {
  size_t codec_size;
  ...
  if ((p = header_bytes(a, 1)) == 
# 1870 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 1870 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
# 1880 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  codec_size = *p & 0xf;
  simple = (*p & 0x10)?0:1;
  attr = *p & 0x20;
  if (*p & 0x80)
  ...
  if ((p = header_bytes(a, codec_size)) == 
# 1889 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                          ((void *)0)
# 1889 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                              )
   return (-1);
  ...
  if (simple) {
   ...
   if (parse_7zip_uint64(
    ...
    return (-1);
   if (100000000ull < f->coders[i].numInStreams)
    return (-1);
   if (parse_7zip_uint64(
       a, &(f->coders[i].numOutStreams)) < 0)
    return (-1);
   if (100000000ull < f->coders[i].numOutStreams)
    return (-1);
  }
  ...
  if (attr) {
   if (parse_7zip_uint64(
    ...
    return (-1);
   if ((p = header_bytes(
       a, (size_t)f->coders[i].propertiesSize)) == 
# 1915 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                  ((void *)0)
# 1915 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                      )
    return (-1);
   f->coders[i].properties =
       malloc((size_t)f->coders[i].propertiesSize);
   if (f->coders[i].properties == 
# 1919 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 1919 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
    return (-1);
 ...
 if (f->numBindPairs > 0) {
  ...
  if (f->bindPairs == 
# 1939 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                     ((void *)0)
# 1939 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                         )
   return (-1);
 } else
  f->bindPairs = 
# 1942 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                ((void *)0)
# 1942 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                    ;
 for (i = 0; i < f->numBindPairs; i++) {
  if (parse_7zip_uint64(a, &(f->bindPairs[i].inIndex)) < 0)
   return (-1);
  if (100000000ull < f->bindPairs[i].inIndex)
   return (-1);
  if (parse_7zip_uint64(a, &(f->bindPairs[i].outIndex)) < 0)
   return (-1);
  if (100000000ull < f->bindPairs[i].outIndex)
   return (-1);
 }
 ...
 if (f->packedStreams == 
# 1957 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                        ((void *)0)
# 1957 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                            )
  return (-1);
 if (f->numPackedStreams == 1) {
  ...
  for (i = 0; i < f->numPackedStreams; i++) {
   if (parse_7zip_uint64(a, &(f->packedStreams[i])) < 0)
    return (-1);
   if (100000000ull < f->packedStreams[i])
    return (-1);
  }
 }
...
read_CodersInfo(struct archive_read *a, struct _7z_coders_info *ci)
{
 ...
 if ((p = header_bytes(a, 1)) == 
# 2008 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2008 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 if (*p != 0x0B)
  goto failed;
 ...
 if ((p = header_bytes(a, 1)) == 
# 2024 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2024 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 switch (*p) {
 case 0:
  ...
  if (ci->folders == 
# 2030 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    ((void *)0)
# 2030 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                        )
   return (-1);
  for (i = 0; i < ci->numFolders; i++) {
 ...
 case 1:
  if (parse_7zip_uint64(a, &(ci->dataStreamIndex)) < 0)
   return (-1);
  if (100000000ull < ci->dataStreamIndex)
   return (-1);
  if (ci->numFolders > 0) {
   archive_set_error(&a->archive, -1,
 ...
 if ((p = header_bytes(a, 1)) == 
# 2054 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2054 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 if (*p != 0x0C)
  goto failed;
 ...
 for (i = 0; i < ci->numFolders; i++) {
  ...
  if (folder->unPackSize == 
# 2065 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                           ((void *)0)
# 2065 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               )
   goto failed;
 ...
 if ((p = header_bytes(a, 1)) == 
# 2076 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2076 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 if (*p == 0x00)
  return (0);
 ...
 if ((p = header_bytes(a, 1)) == 
# 2092 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2092 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 if (*p != 0x00)
  goto failed;
    ...
    struct _7z_folder *f, size_t numFolders)
{
 ...
 if ((p = header_bytes(a, 1)) == 
# 2145 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2145 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 type = *p;
 ...
 if (type == 0x0D) {
  ...
  for (i = 0; i < numFolders; i++) {
   if (parse_7zip_uint64(a, &(f[i].numUnpackStreams)) < 0)
    return (-1);
   if (100000000ull < f[i].numUnpackStreams)
    return (-1);
   unpack_streams += (size_t)f[i].numUnpackStreams;
  }
  if ((p = header_bytes(a, 1)) == 
# 2158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
  type = *p;
 } else
 ...
 if (unpack_streams) {
  ...
  ss->digests = calloc(unpack_streams,
      sizeof(*ss->digests));
  if (ss->unpackSizes == 
# 2172 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                        ((void *)0) 
# 2172 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                             || ss->digestsDefined == 
# 2172 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                      ((void *)0) 
# 2172 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                           ||
      ss->digests == 
# 2173 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    ((void *)0)
# 2173 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                        )
   return (-1);
 }
 ...
 if (type == 0x09) {
  if ((p = header_bytes(a, 1)) == 
# 2197 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2197 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
  type = *p;
 }
 ...
 if (type == 0x0A) {
  ...
  free_Digest(&tmpDigests);
  if ((p = header_bytes(a, 1)) == 
# 2241 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2241 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
  type = *p;
 }
...
read_StreamsInfo(struct archive_read *a, struct _7z_stream_info *si)
{
 ...
 if ((p = header_bytes(a, 1)) == 
# 2271 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2271 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 if (*p == 0x06) {
  uint64_t packPos;
  ...
  if (si->pi.positions == 
# 2279 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                         ((void *)0) 
# 2279 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                              || si->pi.sizes == 
# 2279 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                 ((void *)0)
# 2279 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  ...
  if ((p = header_bytes(a, 1)) == 
# 2291 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2291 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
 }
 if (*p == 0x07) {
  ...
  if ((p = header_bytes(a, 1)) == 
# 2312 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2312 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
 }
 ...
 if (*p == 0x08) {
  if (read_SubStreamsInfo(a, &(si->ss),
   ...
   return (-1);
  if ((p = header_bytes(a, 1)) == 
# 2320 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2320 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
 }
    ...
    int check_header_id)
{
 ...
 if (check_header_id) {
  ...
  if ((p = header_bytes(a, 1)) == 
# 2358 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2358 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
  if (*p != 0x01)
   return (-1);
 ...
 if ((p = header_bytes(a, 1)) == 
# 2367 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2367 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  return (-1);
 if (*p == 0x02) {
  for (;;) {
   uint64_t size;
   if ((p = header_bytes(a, 1)) == 
# 2372 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  ((void *)0)
# 2372 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      )
    return (-1);
   if (*p == 0)
    break;
  ...
  if ((p = header_bytes(a, 1)) == 
# 2379 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2379 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
 }
 ...
 if (*p == 0x04) {
  if (read_StreamsInfo(a, &(zip->si)) < 0)
   return (-1);
  if ((p = header_bytes(a, 1)) == 
# 2389 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2389 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
 }
 if (*p == 0x00)
 ...
 if (parse_7zip_uint64(a, &(zip->numFiles)) < 0)
  return (-1);
 if (100000000ull < zip->numFiles)
  return (-1);

 zip->entries = calloc((size_t)zip->numFiles, sizeof(*zip->entries));
 if (zip->entries == 
# 2407 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                    ((void *)0)
# 2407 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                        )
  return (-1);
 entries = zip->entries;
 ...
 for (;;) {
  ...
  if ((p = header_bytes(a, 1)) == 
# 2417 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2417 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   return (-1);
  type = *p;
  if (type == 0x00)
...
# 2433 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                             ((void *)0)
# 2433 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                 )
    return (-1);
   if (read_Bools(
  ...
  case 0x0F:
   if (empty_streams <= 0) {
    ...
    if (header_bytes(a, ll) == 
# 2447 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                              ((void *)0)
# 2447 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                  )
     return (-1);
    break;
   }
   ...
   if (h->emptyFileBools == 
# 2453 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                           ((void *)0)
# 2453 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               )
    return (-1);
  ...
  case 0x10:
   if (empty_streams <= 0) {
    ...
    if (header_bytes(a, ll) == 
# 2461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                              ((void *)0)
# 2461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                  )
     return (-1);
    break;
   }
   h->antiBools = calloc(empty_streams,
       sizeof(*h->antiBools));
   if (h->antiBools == 
# 2467 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                      ((void *)0)
# 2467 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                          )
    return (-1);
  ...
  case 0x11:
  {
   ...
   if ((p = header_bytes(a, 1)) == 
# 2484 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  ((void *)0)
# 2484 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      )
    return (-1);
   ll--;
   ...
   if (zip->entry_names == 
# 2492 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                          ((void *)0)
# 2492 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                              )
    return (-1);
   np = zip->entry_names;
   nb = ll;
   ...
   while (nb) {
    ...
    if (nb > (64 * 1024))
     ...
     b = nb;
    if ((p = header_bytes(a, b)) == 
# 2508 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                   ((void *)0)
# 2508 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       )
     return (-1);
    memcpy(np, p, b);
    np += b;
  ...
  case 0x15:
  {
   ...
   if ((p = header_bytes(a, 2)) == 
# 2540 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  ((void *)0)
# 2540 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      )
    return (-1);
   allAreDefined = *p;
   h->attrBools = calloc((size_t)zip->numFiles,
       sizeof(*h->attrBools));
   if (h->attrBools == 
# 2545 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                      ((void *)0)
# 2545 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                          )
    return (-1);
   if (allAreDefined)
   ...
   for (i = 0; i < zip->numFiles; i++) {
    if (h->attrBools[i]) {
     if ((p = header_bytes(a, 4)) == 
# 2556 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                    ((void *)0)
# 2556 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        )
      return (-1);
  ...
  default:
   if (header_bytes(a, ll) == 
# 2567 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                             ((void *)0)
# 2567 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                 )
    return (-1);
   break;
  }
 ...
 for (i = 0; i < zip->numFiles; i++) {
  if (h->emptyStreamBools == 
# 2580 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                            ((void *)0) 
# 2580 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                 || h->emptyStreamBools[i] == 0)
   entries[i].flg |= (1<<4);

  entries[i].mode = entries[i].attr >> 16;
  if (entries[i].flg & (1<<4)) {
   if ((size_t)sindex >= si->ss.unpack_streams)
    return (-1);
   if (entries[i].mode == 0)
    entries[i].mode = ((mode_t)0100000) | 0666;
   ...
   int dir;
   if (h->emptyFileBools == 
# 2595 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                           ((void *)0)
# 2595 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               )
    dir = 1;
   else {
   ...
   if (entries[i].mode == 0) {
    if (dir)
     entries[i].mode = ((mode_t)0040000) | 0777;
    else
     entries[i].mode = ((mode_t)0100000) | 0666;
   } else if (dir &&
       (entries[i].mode & ((mode_t)0170000)) != ((mode_t)0040000)) {
    entries[i].mode &= ~((mode_t)0170000);
    entries[i].mode |= ((mode_t)0040000);
   }
   if ((entries[i].mode & ((mode_t)0170000)) == ((mode_t)0040000) &&
  ...
  if ((entries[i].flg & (1<<4)) == 0 && indexInFolder == 0) {
...
read_Times(struct archive_read *a, struct _7z_header_info *h, int type)
{
 ...
 if (timeBools == 
# 2685 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                 ((void *)0)
# 2685 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                     )
  return (-1);


 if ((p = header_bytes(a, 1)) == 
# 2689 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2689 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 allAreDefined = *p;
 if (allAreDefined)
 ...
 if ((p = header_bytes(a, 1)) == 
# 2700 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2700 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
  goto failed;
 if (*p) {
  if (parse_7zip_uint64(a, &(h->dataIndex)) < 0)
   goto failed;
  if (100000000ull < h->dataIndex)
   goto failed;
 }
 ...
 for (i = 0; i < zip->numFiles; i++) {
  if (!timeBools[i])
   continue;
  if ((p = header_bytes(a, 8)) == 
# 2712 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 2712 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     )
   goto failed;
  switch (type) {
  case 0x12:
...
# 2748 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
(*__errno_location ()) 
# 2748 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
      = 0;
 if (read_StreamsInfo(a, si) < 0) {
  if (
# 2750 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
     (*__errno_location ()) 
# 2750 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
           == 
# 2750 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
              12
# 2750 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
...
header_bytes(struct archive_read *a, size_t rbytes)
{
 ...
 if (zip->header_bytes_remaining < rbytes)
  return (
# 2781 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
         ((void *)0)
# 2781 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
             );
 if (zip->pack_stream_bytes_unconsumed)
  read_consume(a);

 if (zip->header_is_encoded == 0) {
  p = __archive_read_ahead(a, rbytes, 
# 2786 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                     ((void *)0)
# 2786 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                         );
  if (p == 
# 2787 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          ((void *)0)
# 2787 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              )
   return (
# 2788 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          ((void *)0)
# 2788 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              );
  ...
  if (bytes <= 0)
   return (
# 2797 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          ((void *)0)
# 2797 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              );
    ...
    struct _7z_header_info *header)
{
 ...
 if ((p = __archive_read_ahead(a, 32, &bytes_avail)) == 
# 2818 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                       ((void *)0)
# 2818 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                           )
  return ((-30));
 ...
 if ((p[0] == 'M' && p[1] == 'Z') || memcmp(p, "\x7F\x45LF", 4) == 0) {
  ...
  if (r < (-20))
   return (r);
  if ((p = __archive_read_ahead(a, 32, &bytes_avail)) == 
# 2826 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                        ((void *)0)
# 2826 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                            )
   return ((-30));
 }
 zip->seek_base += 32;
 ...
 if (next_header_offset != 0) {
  if (bytes_avail >= (ssize_t)next_header_offset)
   __archive_read_consume(a, next_header_offset);
      ...
      next_header_offset + zip->seek_base, 
# 2860 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                          0
# 2860 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                  ) < 0)
   return ((-30));
 }
 ...
 if ((p = header_bytes(a, 1)) == 
# 2872 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 2872 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    ) {
  archive_set_error(&a->archive,
      
# 2874 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
     84
# 2874 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                              ,
      "Truncated 7-Zip file body");
  return ((-30));
 }
...
# 2919 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
 (*__errno_location ()) 
# 2919 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
       = 0;
  r = read_Header(a, header, zip->header_is_encoded);
  if (r < 0) {
   if (
# 2922 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      (*__errno_location ()) 
# 2922 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
            == 
# 2922 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
               12
# 2922 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  ...
  if ((p = header_bytes(a, 1)) == 
# 2934 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0) 
# 2934 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                      ||*p != 0x00) {
   archive_set_error(&a->archive, -1,
       "Malformed 7-Zip archive");
   return ((-30));
    ...
    size_t minimum)
{
 ...
 if (zip->codec == 0 && zip->codec2 == (unsigned long)-1) {
# 2980 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  *buff = __archive_read_ahead(a, 1, &bytes_avail);
  if (bytes_avail <= 0) {
   archive_set_error(&a->archive,
       
# 2983 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      84
# 2983 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               ,
 ...
 } else if (zip->uncompressed_buffer_pointer == 
# 2995 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                               ((void *)0)
# 2995 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                   ) {

  archive_set_error(&(a->archive),
      (-1), "Damaged 7-Zip archive");
  return ((-30));
 } else {
...
extract_pack_stream(struct archive_read *a, size_t minimum)
{
 ...
 if (zip->codec == 0 && zip->codec2 == (unsigned long)-1) {
  if (minimum == 0)
   minimum = 1;
  if (__archive_read_ahead(a, minimum, &bytes_avail) == 
# 3033 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                       ((void *)0)
      
# 3034 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
     || bytes_avail <= 0) {
   archive_set_error(&a->archive,
       
# 3036 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      84
# 3036 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               ,
       "Truncated 7-Zip file body");
   return ((-30));
  }
...
# 3051 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 3051 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    ) {
  ...
  if (zip->uncompressed_buffer == 
# 3059 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 ((void *)0)
# 3059 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                     ) {
   archive_set_error(&a->archive, 
# 3060 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                 12
# 3060 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       ,
  ...
  if (zip->uncompressed_buffer_size < minimum) {
   ...
   if (p == 
# 3089 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
           ((void *)0)
# 3089 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
               ) {
    archive_set_error(&a->archive, 
# 3090 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  12
# 3090 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        ,
        "No memory for 7-Zip decompression");
    return ((-30));
   }
  ...
  zip->uncompressed_buffer_bytes_remaining = 0;
 zip->uncompressed_buffer_pointer = 
# 3107 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                   ((void *)0)
# 3107 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                       ;
 for (;;) {
...
# 3123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      84
# 3123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               ,
       "Truncated 7-Zip file body");
   return ((-30));
  }
  ...
  if (zip->uncompressed_buffer_bytes_remaining ==
   ...
   break;
  if (zip->codec2 == 0x03030103 && zip->odd_bcj_size &&
...
# 3200 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
     0
# 3200 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
             ))
   return ((-30));
    ...
    size_t minimum)
{
 ...
 if (zip->pack_stream_remaining == 0) {
   ...
   *buff = 
# 3261 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          ((void *)0)
# 3261 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              ;
   return (0);
  }
...
# 3302 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
       84
# 3302 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                ,
        "Truncated 7-Zip file body");
    return ((-30));
   }
    ...
    int header)
{
 ...
 for (i = 0; i < 3; i++) {
  if (zip->sub_stream_buff[i] != 
# 3333 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                ((void *)0)
# 3333 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                    )
   free(zip->sub_stream_buff[i]);
  zip->sub_stream_buff[i] = 
# 3335 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                           ((void *)0)
# 3335 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               ;
 }
 ...
 if (folder->numCoders == 2)
  ...
  coder2 = 
# 3391 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
          ((void *)0)
# 3391 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
              ;
 ...
 if (found_bcj2) {
  ...
  static const struct _7z_coder coder_copy = {0, 1, 1, 0, 
# 3400 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                                         ((void *)0)
# 3400 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                                             };
  ...
  ssize_t bytes;
  unsigned char *b[3] = {
# 3405 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                        ((void *)0)
# 3405 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                            , 
# 3405 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                              ((void *)0)
# 3405 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
...
# 3405 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
  ...
  if (folder->numCoders == 4 && fc[3].codec == 0x0303011B &&
...
# 3441 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
    if (fc[0].codec == 0 &&
        fc[1].codec == 0)
     coder1 = &(folder->coders[2]);
    else if (fc[0].codec == 0 &&
        fc[2].codec == 0)
     coder1 = &(folder->coders[1]);
    else if (fc[1].codec == 0 &&
        fc[2].codec == 0)
     coder1 = &(folder->coders[0]);
    else {
     archive_set_error(&(a->archive),
...
# 3461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                      ((void *)0) 
# 3461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                           && coder2->codec == 0x0303011B &&
      zip->pack_stream_remaining == 4 &&
  ...
  for (i = 0; i < 3; i++) {
   ...
   r = init_decompression(a, zip, coder, 
# 3497 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                        ((void *)0)
# 3497 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                            );
   if (r != 0) {
    free(b[0]); free(b[1]); free(b[2]);
    return ((-30));
   ...
   if (b[i] == 
# 3506 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
              ((void *)0)
# 3506 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                  ) {
    free(b[0]); free(b[1]); free(b[2]);
    archive_set_error(&a->archive, 
# 3508 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  12
# 3508 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        ,
        "No memory for 7-Zip decompression");
    return ((-30));
   }
  ...
  if (zip->tmp_stream_buff == 
# 3542 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                             ((void *)0)
# 3542 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                 ) {
   zip->tmp_stream_buff_size = 32 * 1024;
   zip->tmp_stream_buff =
       malloc(zip->tmp_stream_buff_size);
   if (zip->tmp_stream_buff == 
# 3546 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                              ((void *)0)
# 3546 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                  ) {
    archive_set_error(&a->archive, 
# 3547 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
                                  12
# 3547 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                                        ,
        "No memory for 7-Zip decompression");
    return ((-30));
   }
...
# 3601 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c" 3 4
      84
# 3601 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
                               ,
       "Truncated 7-Zip file body");
   return ((-30));
  }
...
# 3622 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
static void
...
# 3741 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_format_7zip.c"
static ssize_t
Bcj2_Decode(struct _7zip *zip, uint8_t *outBuf, size_t outSize)
{
 ...
 if (zip->bcj_state == 0) {
  ...
  for (i = 0;
   ...
   zip->bcj2_p[i] = (1 << 11) >> 1;
  zip->bcj2_code = 0; zip->bcj2_range = 0xFFFFFFFF; { int ii; for (ii = 0; ii < 5; ii++) { { if (buffer == bufferLim) return (-25); }; zip->bcj2_code = (zip->bcj2_code << 8) | (*buffer++); }};
  zip->bcj_state = 1;
 }
 ...
 for (;;) {
  ...
  if (zip->bcj_state == 1) {
   while (limit != 0) {
    ...
    outBuf[outPos++] = bb;
    if (((bb & 0xFE) == 0xE8 || ((zip->bcj2_prevByte) == 0x0F && ((bb) & 0xF0) == 0x80))) {
     zip->bcj_state = 2;
     break;
    }
    inPos++;
  ...
  ttt = *(prob); bound = (zip->bcj2_range >> 11) * ttt; if (zip->bcj2_code < bound) {
   zip->bcj2_range = bound; *(prob) = (uint16_t)(ttt + (((1 << 11) - ttt) >> 5)); if (zip->bcj2_range < ((uint32_t)1 << 24)) { { if (buffer == bufferLim) return (-25); }; zip->bcj2_range <<= 8; zip->bcj2_code = (zip->bcj2_code << 8) | (*buffer++); };
   zip->bcj2_prevByte = b;
  } else {
   uint32_t dest;
   const uint8_t *v;
   ...
   zip->bcj2_range -= bound; zip->bcj2_code -= bound; *(prob) = (uint16_t)(ttt - (ttt >> 5)); if (zip->bcj2_range < ((uint32_t)1 << 24)) { { if (buffer == bufferLim) return (-25); }; zip->bcj2_range <<= 8; zip->bcj2_code = (zip->bcj2_code << 8) | (*buffer++); };
   if (b == 0xE8) {
    v = buf1;
    if (size1 < 4)
     return (-25);
