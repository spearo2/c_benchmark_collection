# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
# 45 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 2
...
archive_read_support_filter_grzip(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xdeb0c5U)), (1U), ("archive_read_support_filter_grzip")); if (magic_test == (-30)) return (-30); } while (0)
                                                            ;
 ...
 reader->data = 
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 3 4
               ((void *)0)
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
                   ;
 reader->bid = grzip_bidder_bid;
 reader->init = grzip_bidder_init;
 reader->options = 
# 79 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 3 4
                  ((void *)0)
# 79 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
                      ;
    ...
    struct archive_read_filter *filter)
{
 ...
 if (p == 
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c" 3 4
         ((void *)0) 
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_support_filter_grzip.c"
              || avail == 0)
  return (0);
