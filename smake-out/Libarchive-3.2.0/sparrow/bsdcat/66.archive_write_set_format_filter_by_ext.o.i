# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 2

# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 2
...
struct { const char *name; int (*format)(struct archive *); int (*filter)(struct archive *); } names[] =
{
 ...
 { 
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
  ((void *)0)
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
      , 
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
         ((void *)0)
# 65 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
...
int cmpsuff(const char *str, const char *suffix)
{
  ...
  if ((str == 
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
             ((void *)0)
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
                 ) || (suffix == 
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
                                 ((void *)0)
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
...
static int get_array_index(const char *name)
{
  ...
  for (i = 0; names[i].name != 
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
                              ((void *)0)
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
                                  ; i++)
  {
...
archive_write_set_format_filter_by_ext(struct archive *a, const char *filename)
{
  ...
  archive_set_error(a, 
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
                      22
# 113 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
                            , "No such format '%s'", filename);
  a->state = 0x8000U;
  return ((-30));
}
...
archive_write_set_format_filter_by_ext_def(struct archive *a, const char *filename, const char * def_ext)
{
  ...
  archive_set_error(a, 
# 135 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c" 3 4
                      22
# 135 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_filter_by_ext.c"
                            , "No such format '%s'", filename);
  a->state = 0x8000U;
  return ((-30));
}
