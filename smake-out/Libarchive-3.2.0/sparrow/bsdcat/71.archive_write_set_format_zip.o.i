# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2

# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cryptor_private.h" 1
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cryptor_private.h"
int __libarchive_cryptor_build_hack(void);
# 120 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cryptor_private.h"
typedef int archive_crypto_ctx;
# 144 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_cryptor_private.h"
...
# 53 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 54 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 55 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
int _archive_entry_copy_uname_l(struct archive_entry *,
    const char *, size_t, struct archive_string_conv *);
# 56 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_hmac_private.h" 1
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_hmac_private.h"
int __libarchive_hmac_build_hack(void);
# 79 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_hmac_private.h"
typedef int archive_hmac_sha1_ctx;
# 95 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_hmac_private.h"
struct archive_hmac {
...
# 57 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random_private.h" 1
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random_private.h"
int archive_random(void *buf, size_t nbytes);
# 59 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
...
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 2
# 72 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
enum compression {
...
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
struct cd_segment {
...
cd_alloc(struct zip *zip, size_t length)
{
 ...
 if (zip->central_directory == 
# 206 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                              ((void *)0)
     
# 207 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
  ...
  if (segment == 
# 210 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                ((void *)0)
# 210 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                    )
   return 
# 211 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
         ((void *)0)
# 211 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
             ;
  segment->buff_size = 64 * 1024;
  segment->buff = malloc(segment->buff_size);
  if (segment->buff == 
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                      ((void *)0)
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                          ) {
   free(segment);
   return 
# 216 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
         ((void *)0)
# 216 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
             ;
  }
  segment->p = segment->buff;

  if (zip->central_directory == 
# 220 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                               ((void *)0)
# 220 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                   ) {
    ...
    const char *val)
{
 ...
 if (strcmp(key, "compression") == 0) {
  ...
  if (val == 
# 263 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0) 
# 263 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 || val[0] == 0) {
  ...
  if (val == 
# 281 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0) 
# 281 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 || !(val[0] >= '0' && val[0] <= '9') || val[1] != '\0') {
   return (-20);
  }
  ...
  if (val == 
# 299 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0)
# 299 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                ) {
  ...
  if (val == 
# 340 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0) 
# 340 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 || val[0] == 0) {
   zip->flags &= ~ 4;
  } else {
   zip->flags |= 4;
  ...
  if (val == 
# 351 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0) 
# 351 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 || val[0] == 0) {
  ...
  if (val == 
# 361 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0) 
# 361 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 || val[0] == 0) {
   archive_set_error(&a->archive, (-1),
   ...
   zip->opt_sconv = archive_string_conversion_to_charset(
       &a->archive, val, 0);
   if (zip->opt_sconv != 
# 368 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                        ((void *)0)
# 368 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                            )
    ret = 0;
   else
    ret = (-30);
  ...
  if (val != 
# 381 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0) 
# 381 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 && *val != '\0') {
   zip->flags |= 2;
   zip->flags &= ~1;
  } else {
...
archive_write_zip_set_compression_deflate(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U | 2U | 4U), ("archive_write_zip_set_compression_deflate")); if (magic_test == (-30)) return (-30); } while (0)

                                              ;
 if (a->archive.archive_format != 0x50000) {
  archive_set_error(&a->archive, (-1),
...
archive_write_set_format_zip(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_set_format_zip")); if (magic_test == (-30)) return (-30); } while (0)
                                                       ;


 if (a->format_free != 
# 457 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                      ((void *)0)
# 457 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                          )
  (a->format_free)(a);

 zip = (struct zip *) calloc(1, sizeof(*zip));
 if (zip == 
# 461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
           ((void *)0)
# 461 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
               ) {
  archive_set_error(&a->archive, 
# 462 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                12
# 462 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                      ,
...
# 470 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                 (-1)
# 470 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                                      ;
 ...
 if (zip->buf == 
# 477 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                ((void *)0)
# 477 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                    ) {
  free(zip);
  archive_set_error(&a->archive, 
# 479 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                12
# 479 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                      ,
...
archive_write_zip_header(struct archive_write *a, struct archive_entry *entry)
{
 ...
 const char *slink = 
# 519 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                    ((void *)0)
# 519 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                        ;
 size_t slink_size = 0;
 ...
 if (type != ((mode_t)0100000) && type != ((mode_t)0040000) && type != ((mode_t)0120000)) {
  archive_set_error(&a->archive, (-1),
 ...
 if (zip->flags & 1) {
  ...
  if (archive_entry_size_is_set(entry)
      && (archive_entry_size(entry) > 0xffffffffll)) {
   archive_set_error(&a->archive, (-1),
       "Files > 4GB require Zip64 extensions");
   return (-25);
  }

  if (zip->written_bytes > 0xffffffffll) {
   archive_set_error(&a->archive, (-1),
...
# 558 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                (9223372036854775807L)
# 558 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                         ;
 ...
 zip->entry_crc32 = zip->crc32func(0, 
# 565 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                     ((void *)0)
# 565 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                         , 0);
 zip->entry_encryption = 0;
 if (zip->entry != 
# 567 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                  ((void *)0)
# 567 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                      ) {
  archive_entry_free(zip->entry);
  zip->entry = 
# 569 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
              ((void *)0)
# 569 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                  ;
 }

 if (zip->cctx_valid)
  __archive_cryptor.encrypto_aes_ctr_release(&zip->cctx);
 if (zip->hctx_valid)
  __archive_hmac.__hmac_sha1_cleanup(&zip->hctx);
...
# 601 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
 zip->entry = archive_entry_clone(entry);

 if (zip->entry == 
# 603 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                  ((void *)0)
# 603 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                      ) {
  archive_set_error(&a->archive, 
# 604 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                12
# 604 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                      ,
 ...
 if (sconv != 
# 609 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
             ((void *)0)
# 609 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 ) {
  const char *p;
  size_t len;

  if (_archive_entry_pathname_l(entry, &p, &len, sconv) != 0) {
   if (
# 614 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
      (*__errno_location ()) 
# 614 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
            == 
# 614 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
               12
# 614 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
    ...
    archive_set_error(&a->archive, 
# 615 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                  12
# 615 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                        ,
...
# 620 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
      84
# 620 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                               ,
  ...
  if (type == ((mode_t)0120000)) {
   if (_archive_entry_symlink_l(entry, &p, &len, sconv)) {
    if (
# 636 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
       (*__errno_location ()) 
# 636 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
             == 
# 636 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                12
# 636 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
     ...
     archive_set_error(&a->archive, 
# 637 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                   12
# 637 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                         ,
 ...
 if (!is_all_ascii(archive_entry_pathname(zip->entry))) {
  if (zip->opt_sconv != 
# 650 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                       ((void *)0)
# 650 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                           ) {
   if (strcmp(archive_string_conversion_charset_name(
     zip->opt_sconv), "UTF-8") == 0)
    zip->entry_flags |= (1 << 11);

  } else if (strcmp(nl_langinfo(
# 655 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                               CODESET
# 655 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                      ), "UTF-8") == 0) {
   zip->entry_flags |= (1 << 11);
 ...
 if (type == ((mode_t)0120000)) {
  ...
  if (slink != 
# 665 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
              ((void *)0)
# 665 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                  )
...
# 731 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
  if ((zip->flags & 2)
 ...
 if (zip->entry_encryption == ENCRYPTION_WINZIP_AES128
  ...
  archive_le16enc(local_header + 8, 99);
 else
 ...
 if (zip->entry_encryption == ENCRYPTION_WINZIP_AES128
     || zip->entry_encryption == ENCRYPTION_WINZIP_AES256)
  archive_le16enc(zip->file_header + 10, 99);
 else
 ...
 *e++ = 4;
 ...
 if ((zip->entry_flags & (1<<0))
  ...
  if (archive_entry_size_is_set(zip->entry)
   ...
   archive_le16enc(e+4, 0x0002);
   zip->aes_vendor = 0x0002;
  } else
   zip->aes_vendor = 0x0001;
  e += 8;
...
# 915 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
 if (zip->entry_uses_zip64) {
 ...
 if (slink != 
# 973 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
             ((void *)0)
# 973 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                 ) {
 ...
 if (zip->entry_compression == COMPRESSION_DEFLATE) {
  zip->stream.zalloc = 
# 984 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                      0
# 984 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                            ;
  zip->stream.zfree = 
# 985 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                     0
# 985 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                           ;
  zip->stream.opaque = 
# 986 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                      0
# 986 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                            ;
  zip->stream.next_out = zip->buf;
  zip->stream.avail_out = (uInt)zip->len_buf;
  if (
# 989 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
     deflateInit2_((
# 989 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
     &zip->stream
# 989 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
     ),(
# 989 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
...
# 990 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                             != 
# 990 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                                0
# 990 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                                    ) {
   archive_set_error(&a->archive, 
# 991 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                 12
# 991 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                       ,
...
archive_write_zip_data(struct archive_write *a, const void *buff, size_t s)
{
  ...
  if (zip->tctx_valid || zip->cctx_valid) {
   ...
   while (rb < re) {
    ...
    if (zip->tctx_valid) {
     ...
     l = zip->len_buf;
     ret = __archive_cryptor.encrypto_aes_ctr_update(&zip->cctx, rb, re - rb, zip->buf, &l)
     ...
     __archive_hmac.__hmac_sha1_update(&zip->hctx, zip->buf, l)
                     ;
    }
 ...
 case COMPRESSION_DEFLATE:
  ...
  do {
   ret = deflate(&zip->stream, 
# 1085 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                              0
# 1085 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                        );
   if (ret == 
# 1086 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
             (-2)
# 1086 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                           )
    return ((-30));
   if (zip->stream.avail_out == 0) {
    if (zip->tctx_valid) {
     ...
     ret = __archive_cryptor.encrypto_aes_ctr_update(&zip->cctx, zip->buf, zip->len_buf, zip->buf, &outl)
     ...
     __archive_hmac.__hmac_sha1_update(&zip->hctx, zip->buf, zip->len_buf)
                                ;
    }
 ...
 if (!zip->cctx_valid || zip->aes_vendor != 0x0002)
  zip->entry_crc32 =
...
archive_write_zip_finish_entry(struct archive_write *a)
{
 ...
 if (zip->entry_compression == COMPRESSION_DEFLATE) {
  for (;;) {
   ...
   ret = deflate(&zip->stream, 
# 1146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                              4
# 1146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                      );
   if (ret == 
# 1147 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
             (-2)
# 1147 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                           )
    return ((-30));
   ...
   if (zip->tctx_valid) {
    ...
    ret = __archive_cryptor.encrypto_aes_ctr_update(&zip->cctx, zip->buf, remainder, zip->buf, &outl)
    ...
    __archive_hmac.__hmac_sha1_update(&zip->hctx, zip->buf, remainder)
                            ;
   }
 ...
 if (zip->hctx_valid) {
  ...
  __archive_hmac.__hmac_sha1_final(&zip->hctx, hmac, &hmac_len);
  ret = __archive_write_output(a, hmac, 10);
  if (ret != 0)
   return (ret);
  zip->entry_compressed_written += 10;
  zip->written_bytes += 10;
 }


 if ((zip->entry_flags & (1<<3)) != 0) {
  char d[24];
 ...
 if (zip->entry_compressed_written > 0xffffffffll
  ...
  if (zd == 
# 1241 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
           ((void *)0)
# 1241 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
               ) {
   archive_set_error(&a->archive, 
# 1242 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                 12
# 1242 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                       ,
    "Can't allocate zip data");
   return ((-30));
  }
 ...
 archive_le32enc(zip->file_header + 20,
  (uint32_t)((zip->entry_compressed_written) > (0xffffffffll) ? (0xffffffffll) : (zip->entry_compressed_written))
                 );
 archive_le32enc(zip->file_header + 24,
  (uint32_t)((zip->entry_uncompressed_written) > (0xffffffffll) ? (0xffffffffll) : (zip->entry_uncompressed_written))
                 );
 archive_le16enc(zip->file_header + 30,
     (uint16_t)(zip->central_directory_bytes - zip->file_header_extra_offset));
 archive_le32enc(zip->file_header + 42,
  (uint32_t)((zip->entry_offset) > (0xffffffffll) ? (0xffffffffll) : (zip->entry_offset))
                 );
...
archive_write_zip_close(struct archive_write *a)
{
 ...
 while (segment != 
# 1283 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                  ((void *)0)
# 1283 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                      ) {
 ...
 archive_le16enc(buff + 8, (uint16_t)((0xffffU) > (zip->central_directory_entries) ? (zip->central_directory_entries) : (0xffffU))
                                 );
 archive_le16enc(buff + 10, (uint16_t)((0xffffU) > (zip->central_directory_entries) ? (zip->central_directory_entries) : (0xffffU))
                                 );
 archive_le32enc(buff + 12,
  (uint32_t)((0xffffffffll) > ((offset_end - offset_start)) ? ((offset_end - offset_start)) : (0xffffffffll)));
 archive_le32enc(buff + 16,
  (uint32_t)((0xffffffffll) > (offset_start) ? (offset_start) : (0xffffffffll)));
...
# 1352 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                                 ((void *)0)
# 1352 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                                     ) {
  segment = zip->central_directory;
 ...
 free(zip);
 a->format_data = 
# 1367 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                 ((void *)0)
# 1367 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                     ;
 return (0);
}
...
path_length(struct archive_entry *entry)
{
 ...
 if (path == 
# 1411 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
            ((void *)0)
# 1411 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                )
  return (0);
 if (type == ((mode_t)0040000) &&
...
write_path(struct archive_entry *entry, struct archive_write *archive)
{
 ...
 if ((type == ((mode_t)0040000)) & (path[strlen(path) - 1] != '/')) {
...
copy_path(struct archive_entry *entry, unsigned char *p)
{
 ...
 if ((type == ((mode_t)0040000)) & (path[pathlen - 1] != '/')) {
  p[pathlen] = '/';
  p[pathlen + 1] = '\0';
 }
}
...
{
 if (zip->opt_sconv != 
# 1473 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                      ((void *)0)
# 1473 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                          )
...
is_traditional_pkware_encryption_supported(void)
{
 ...
 if (archive_random(key, sizeof(key)-1) != 0)
  return (0);
 return (1);
}
...
init_traditional_pkware_encryption(struct archive_write *a)
{
 ...
 if (passphrase == 
# 1557 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                  ((void *)0)
# 1557 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                      ) {
  archive_set_error(&a->archive, (-1),
 ...
 key[12 -1] = zip->trad_chkdat;
 trad_enc_encrypt_update(&zip->tctx, key, 12,
     key_encrypted, 12);

 ret = __archive_write_output(a, key_encrypted, 12);
 if (ret != 0)
  return (ret);
 zip->written_bytes += 12;
 zip->entry_compressed_written += 12;
 return (ret);
}
...
init_winzip_aes_encryption(struct archive_write *a)
{
 ...
 uint8_t salt[16 + 2];
 uint8_t derived_key[(32 * 2 + 2)];
 int ret;

 passphrase = __archive_write_get_passphrase(a);
 if (passphrase == 
# 1593 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c" 3 4
                  ((void *)0)
# 1593 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_format_zip.c"
                      ) {
  archive_set_error(&a->archive, (-1),
      "Encryption needs passphrase");
  return ((-25));
 ...
 if (archive_random(salt, salt_len) != 0) {
  archive_set_error(&a->archive, (-1),
      "Can't generate random number for encryption");
  return ((-30));
 }
 __archive_cryptor.pbkdf2sha1(passphrase, strlen(passphrase), salt, salt_len, 1000, derived_key, key_len * 2 + 2)
                                                        ;

 ret = __archive_cryptor.encrypto_aes_ctr_init(&zip->cctx, derived_key, key_len);
 if (ret != 0) {
  archive_set_error(&a->archive, (-1),
      "Decryption is unsupported due to lack of crypto library");
  return ((-25));
 }
 ret = __archive_hmac.__hmac_sha1_init(&zip->hctx, derived_key + key_len, key_len)
             ;
 if (ret != 0) {
  __archive_cryptor.encrypto_aes_ctr_release(&zip->cctx);
  archive_set_error(&a->archive, (-1),
...
is_winzip_aes_encryption_supported(int encryption)
{
 ...
 if (archive_random(salt, salt_len) != 0)
  return (0);
 ret = __archive_cryptor.pbkdf2sha1("p", 1, salt, salt_len, 1000, derived_key, key_len * 2 + 2)
                                  ;
 if (ret != 0)
  return (0);

 ret = __archive_cryptor.encrypto_aes_ctr_init(&cctx, derived_key, key_len);
 if (ret != 0)
  return (0);
 ret = __archive_hmac.__hmac_sha1_init(&hctx, derived_key + key_len, key_len)
             ;
 __archive_cryptor.encrypto_aes_ctr_release(&cctx);
 if (ret != 0)
  return (0);
 __archive_hmac.__hmac_sha1_cleanup(&hctx);
 return (1);
}
