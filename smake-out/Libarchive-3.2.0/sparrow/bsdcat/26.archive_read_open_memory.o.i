# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
...
# 30 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 2
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 2
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 2
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
    ...
    size_t size, size_t read_size)
{
 ...
 if (mine == 
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 3 4
            ((void *)0)
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
                ) {
  archive_set_error(a, 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 3 4
                      12
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
                            , "No memory");
  return ((-30));
 }
...
# 109 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
static ssize_t
...
memory_read_seek(struct archive *a, void *client_data, int64_t offset, int whence)
{
 ...
 switch (whence) {
 case 
# 154 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 3 4
     0
# 154 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
             :
  mine->p = mine->start + offset;
  break;
 case 
# 157 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 3 4
     1
# 157 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
             :
  mine->p += offset;
  break;
 case 
# 160 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c" 3 4
     2
# 160 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_memory.c"
             :
