# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2



# 54 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
...
# 59 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
...
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 2
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
int
archive_random(void *buf, size_t nbytes)
{
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
 arc4random_buf(buf, nbytes);
 return 0;

}
# 139 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
struct arc4_stream {
 uint8_t i;
 uint8_t j;
 uint8_t s[256];
...
static pthread_mutex_t arc4random_mtx = 
# 148 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 3 4
                                       { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 148 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
                                                                ;
...
static __inline uint8_t arc4_getbyte(void);
...
arc4_stir(void)
{
 ...
 fd = open("/dev/urandom", 
# 207 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 3 4
                     00 
# 207 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
                              | 
# 207 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 3 4
                                02000000
# 207 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
                                         , 0);
 if (fd >= 0) {
  if (read(fd, &rdat, 128) == 128)
   done = 1;
  (void)close(fd);
 }
 if (!done) {
  (void)gettimeofday(&rdat.tv, 
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c" 3 4
                              ((void *)0)
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_random.c"
                                  );
  rdat.pid = getpid();

 }

 arc4_addrandom((u_char *)&rdat, 128);
