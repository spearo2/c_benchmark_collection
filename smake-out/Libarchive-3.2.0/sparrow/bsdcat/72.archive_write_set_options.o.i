# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
...
# 30 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 2
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 2
    ...
    const char *v)
{
 return _archive_set_option(a, m, o, v,
     (0xb0c5c0deU), "archive_write_set_format_option",
...
{
 return _archive_set_option(a, m, o, v,
     (0xb0c5c0deU), "archive_write_set_filter_option",
...
{
 return _archive_set_option(a, m, o, v,
     (0xb0c5c0deU), "archive_write_set_option",
     archive_set_option);
}
...
archive_write_set_options(struct archive *a, const char *options)
{
 return _archive_set_options(a, options,
     (0xb0c5c0deU), "archive_write_set_options",
     archive_set_option);
}
    ...
    const char *v)
{
 ...
 if (a->format_name == 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
                      ((void *)0)
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
                          )
  return (m == 
# 81 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
              ((void *)0)
# 81 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
                  )?(-25):(-20) - 1;


 if (m != 
# 84 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
         ((void *)0) 
# 84 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
              && strcmp(m, a->format_name) != 0)
  return ((-20) - 1);
 if (a->format_options == 
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
                         ((void *)0)
# 86 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
                             )
  return ((-20));
    ...
    const char *v)
{
 ...
 for (filter = a->filter_first; filter != 
# 99 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
                                         ((void *)0)
# 99 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
                                             ; filter = filter->next_filter) {
  if (filter->options == 
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
                        ((void *)0)
# 100 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
                            )
   continue;
  if (m != 
# 102 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
          ((void *)0) 
# 102 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
               && strcmp(filter->name, m) != 0)
   continue;
  ...
  if (m != 
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
          ((void *)0)
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
              )
   return (r);
 ...
 if (rv == (-20) && m != 
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c" 3 4
                               ((void *)0)
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_set_options.c"
                                   )
  rv = (-20) - 1;
 return (rv);
}
