# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_string.h" 1
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
...
# 44 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 2
...
archive_write_add_filter_uuencode(struct archive *_a)
{
 ...
 if (state == 
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
             ((void *)0)
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
                 ) {
  archive_set_error(f->archive, 
# 81 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
                               12
# 81 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
                                     ,
      "Can't allocate data for uuencode filter");
  return ((-30));
 }
 (((&state->name))->length=0, archive_strncat(((&state->name)), (("-")), ((("-") == 
# 85 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
((void *)0) 
# 85 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
? 0 : strlen("-")))));
 state->mode = 0644;
    ...
    const char *value)
{
 ...
 if (strcmp(key, "mode") == 0) {
  if (value == 
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
              ((void *)0)
# 110 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
                  ) {
  ...
  if (value == 
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
              ((void *)0)
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
                  ) {
   archive_set_error(f->archive, (-1),
...
# 123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
 ((void *)0) 
# 123 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
 ? 0 : strlen(value)))));
  return (0);
 }
...
# 158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
                                                             ((void *)0)
# 158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
                                                                 ) {
  archive_set_error(f->archive, 
# 159 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c" 3 4
                               12
# 159 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_uuencode.c"
                                     ,
    ...
    size_t length)
{
 ...
 if (state->hold_len) {
  while (state->hold_len < 45 && length > 0) {
   state->hold[state->hold_len++] = *p++;
   length--;
  }
  if (state->hold_len < 45)
   return (ret);
  uu_encode(&state->encoded_buff, state->hold, 45);
  state->hold_len = 0;
 }

 for (; length >= 45; length -= 45, p += 45)
  uu_encode(&state->encoded_buff, p, 45);
