# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
...
# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2


# 29 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
# 48 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 2
...
archive_write_add_filter_bzip2(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_bzip2")); if (magic_test == (-30)) return (-30); } while (0)
                                                         ;

 data = calloc(1, sizeof(*data));
 if (data == 
# 92 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
            ((void *)0)
# 92 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
                ) {
  archive_set_error(&a->archive, 
# 93 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
                                12
# 93 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
                                      , "Out of memory");
  return ((-30));
 }
 ...
 if (data->pdata == 
# 109 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
                   ((void *)0)
# 109 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
                       ) {
  free(data);
  archive_set_error(&a->archive, 
# 111 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
                                12
# 111 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
                                      , "Out of memory");
  return ((-30));
 }
    ...
    const char *key, const char *value)
{
 ...
 if (strcmp(key, "compression-level") == 0) {
  if (value == 
# 131 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
              ((void *)0) 
# 131 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
                   || !(value[0] >= '0' && value[0] <= '9') ||
      value[1] != '\0')
   return ((-20));
...
# 358 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
static int
archive_compressor_bzip2_open(struct archive_write_filter *f)
{
 ...
 do { (&as)->s = 
# 365 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
((void *)0)
# 365 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
; (&as)->length = 0; (&as)->buffer_length = 0; } while(0);
 (((&as))->length=0, archive_strncat(((&as)), (("bzip2")), ((("bzip2") == 
# 366 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c" 3 4
((void *)0) 
# 366 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_bzip2.c"
? 0 : strlen("bzip2")))));
