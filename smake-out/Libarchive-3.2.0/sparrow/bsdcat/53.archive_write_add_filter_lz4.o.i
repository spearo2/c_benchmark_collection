# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 36 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 39 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
# 47 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
...
# 48 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 51 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_xxhash.h" 1
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_xxhash.h"
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 2
...
# 80 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
...
archive_write_add_filter_lz4(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((&a->archive), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_lz4")); if (magic_test == (-30)) return (-30); } while (0)
                                                       ;

 data = calloc(1, sizeof(*data));
 if (data == 
# 106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
            ((void *)0)
# 106 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                ) {
  archive_set_error(&a->archive, 
# 107 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                                12
# 107 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                                      , "Out of memory");
  return ((-30));
 }
 ...
 if (data->pdata == 
# 141 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                   ((void *)0)
# 141 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                       ) {
  free(data);
  archive_set_error(&a->archive, 
# 143 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                                12
# 143 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                                      , "Out of memory");
  return ((-30));
 }
    ...
    const char *key, const char *value)
{
 ...
 if (strcmp(key, "compression-level") == 0) {
  int val;
  if (value == 
# 164 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
              ((void *)0) 
# 164 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                   || !((val = value[0] - '0') >= 1 && val <= 9) ||
      value[1] != '\0')
   return ((-20));
...
# 171 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                                22
# 171 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                                                        ,
 ...
 if (strcmp(key, "stream-checksum") == 0) {
  data->stream_checksum = value != 
# 180 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                                  ((void *)0)
# 180 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                                      ;
  return (0);
 }
 if (strcmp(key, "block-checksum") == 0) {
  data->block_checksum = value != 
# 184 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                                 ((void *)0)
# 184 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                                     ;
  return (0);
 }
 if (strcmp(key, "block-size") == 0) {
  if (value == 
# 188 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
              ((void *)0) 
# 188 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                   || !(value[0] >= '4' && value[0] <= '7') ||
      value[1] != '\0')
   return ((-20));
 ...
 if (strcmp(key, "block-dependence") == 0) {
  data->block_independence = value == 
# 195 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
                                     ((void *)0)
# 195 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
                                         ;
  return (0);
 }
...
# 647 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
static int
archive_filter_lz4_open(struct archive_write_filter *f)
{
 ...
 do { (&as)->s = 
# 654 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
((void *)0)
# 654 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
; (&as)->length = 0; (&as)->buffer_length = 0; } while(0);
 (((&as))->length=0, archive_strncat(((&as)), (("lz4 -z -q -q")), ((("lz4 -z -q -q") == 
# 655 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c" 3 4
((void *)0) 
# 655 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lz4.c"
? 0 : strlen("lz4 -z -q -q")))));
