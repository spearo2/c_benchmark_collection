# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2
...
# 35 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 2
...
archive_write_add_filter_lrzip(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_lrzip")); if (magic_test == (-30)) return (-30); } while (0)
                                                         ;

 data = calloc(1, sizeof(*data));
 if (data == 
# 68 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
            ((void *)0)
# 68 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
                ) {
  archive_set_error(_a, 
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
                       12
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
                             , "Can't allocate memory");
  return ((-30));
 }
 data->pdata = __archive_write_program_allocate("lrzip");
 if (data->pdata == 
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
                   ((void *)0)
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
                       ) {
  free(data);
  archive_set_error(_a, 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
                       12
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
                             , "Can't allocate memory");
  return ((-30));
 }
    ...
    const char *value)
{
 ...
 if (strcmp(key, "compression") == 0) {
  if (value == 
# 102 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
              ((void *)0)
# 102 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
                  )
   return ((-20));
  ...
  if (value == 
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
              ((void *)0) 
# 118 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
                   || !(value[0] >= '1' && value[0] <= '9') ||
      value[1] != '\0')
   return ((-20));
...
archive_write_lrzip_open(struct archive_write_filter *f)
{
 ...
 do { (&as)->s = 
# 137 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
((void *)0)
# 137 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
; (&as)->length = 0; (&as)->buffer_length = 0; } while(0);
 (((&as))->length=0, archive_strncat(((&as)), (("lrzip -q")), ((("lrzip -q") == 
# 138 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c" 3 4
((void *)0) 
# 138 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lrzip.c"
? 0 : strlen("lrzip -q")))));
