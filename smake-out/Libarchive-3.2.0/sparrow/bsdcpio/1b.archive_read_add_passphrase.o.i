# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 2

# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_private.h" 1
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_private.h"
...
# 38 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_private.h" 2
...
# 33 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 2
 ...
 *a->passphrases.last = p;
 ...
 p->next = 
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
          ((void *)0)
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
              ;
}
...
remove_passphrases_from_head(struct archive_read *a)
{
 ...
 if (p != 
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
         ((void *)0)
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
             )
...
new_read_passphrase(struct archive_read *a, const char *passphrase)
{
 ...
 p = malloc(sizeof(*p));
 if (p == 
# 68 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
         ((void *)0)
# 68 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
             ) {
  archive_set_error(&a->archive, 
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                                12
# 69 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                                      ,
      "Can't allocate memory");
  return (
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
         ((void *)0)
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
             );
 }
 p->passphrase = strdup(passphrase);
 if (p->passphrase == 
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                     ((void *)0)
# 74 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                         ) {
  free(p);
  archive_set_error(&a->archive, 
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                                12
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                                      ,
      "Can't allocate memory");
  return (
# 78 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
         ((void *)0)
# 78 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
             );
 }
 return (p);
}
...
archive_read_add_passphrase(struct archive *_a, const char *passphrase)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xdeb0c5U)), (1U), ("archive_read_add_passphrase")); if (magic_test == (-30)) return (-30); } while (0)
                                ;

 if (passphrase == 
# 92 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                  ((void *)0) 
# 92 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                       || passphrase[0] == '\0') {
 ...
 if (p == 
# 99 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
         ((void *)0)
# 99 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
             )
  return ((-30));
    ...
    archive_passphrase_callback *cb)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xdeb0c5U)), (1U), ("archive_read_set_passphrase_callback")); if (magic_test == (-30)) return (-30); } while (0)
                                         ;
...
# 144 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                                     ((void *)0)
# 144 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                                         ; p = p->next)
   cnt++;
...
# 158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                                   ((void *)0)
# 158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                                       ) {
  ...
  p = 
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
     ((void *)0)
# 163 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
         ;
 } else
  p = 
# 165 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
     ((void *)0)
# 165 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
         ;

 if (p != 
# 167 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
         ((void *)0)
# 167 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
             )
  passphrase = p->passphrase;
 else if (a->passphrases.callback != 
# 169 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                                    ((void *)0)
# 169 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                                        ) {
  ...
  if (passphrase != 
# 175 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
                   ((void *)0)
# 175 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                       ) {
   p = new_read_passphrase(a, passphrase);
   if (p == 
# 177 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
           ((void *)0)
# 177 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
               )
    return (
# 178 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
           ((void *)0)
# 178 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
               );
  ...
  passphrase = 
# 183 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c" 3 4
              ((void *)0)
# 183 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_add_passphrase.c"
                  ;
