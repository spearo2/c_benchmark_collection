# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 2
...
# 41 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 2
...
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
                                    1
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
                                            );
  if (actual_offset != target_offset) {
   archive_set_error(a, 
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
                       (*__errno_location ())
# 60 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
                            , "Seek error");
   return ((-30));
  }
  return (0);
 ...
 while (target_offset > actual_offset) {
  ...
  if (bytes_written < 0) {
   archive_set_error(a, 
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
                       (*__errno_location ())
# 71 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
                            , "Write error");
   return ((-30));
  }
...
archive_read_data_into_fd(struct archive *a, int fd)
{
 ...
 int can_lseek;
 char *nulls = 
# 91 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
              ((void *)0)
# 91 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
                  ;
 size_t nulls_size = 16384;

 do { int magic_test = __archive_check_magic((a), ((0xdeb0c5U)), (4U), ("archive_read_data_into_fd")); if (magic_test == (-30)) return (-30); } while (0)
                                 ;

 can_lseek = (fstat(fd, &st) == 0) && 
# 97 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
                                     ((((
# 97 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
                                     st.st_mode
# 97 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
                                     )) & 0170000) == (0100000))
# 97 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
 ...
 while ((r = archive_read_data_block(a, &buff, &size, &target_offset)) ==
  ...
  while (size > 0) {
   ...
   if (bytes_written < 0) {
    archive_set_error(a, 
# 117 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c" 3 4
                        (*__errno_location ())
# 117 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_data_into_fd.c"
                             , "Write error");
    r = (-30);
    goto cleanup;
   }
 ...
 if (r == 1 && target_offset > actual_offset) {
