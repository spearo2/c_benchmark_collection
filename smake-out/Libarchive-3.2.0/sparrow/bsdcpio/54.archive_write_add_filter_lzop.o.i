# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2


# 28 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 40 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 42 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 50 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 51 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 53 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 2
...
# 73 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
...
# 136 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
int
archive_write_add_filter_lzop(struct archive *_a)
{
 ...
 do { int magic_test = __archive_check_magic((_a), ((0xb0c5c0deU)), (1U), ("archive_write_add_filter_lzop")); if (magic_test == (-30)) return (-30); } while (0)
                                                        ;

 data = calloc(1, sizeof(*data));
 if (data == 
# 146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
            ((void *)0)
# 146 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
                ) {
  archive_set_error(_a, 
# 147 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
                       12
# 147 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
...
# 176 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
 data->pdata = __archive_write_program_allocate("lzop");
 if (data->pdata == 
# 177 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
                   ((void *)0)
# 177 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
                       ) {
  free(data);
  archive_set_error(_a, 
# 179 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
                       12
# 179 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
                             , "Can't allocate memory");
  return ((-30));
 }
    ...
    const char *value)
{
 ...
 if (strcmp(key, "compression-level") == 0) {
  if (value == 
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
              ((void *)0) 
# 214 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
                   || !(value[0] >= '1' && value[0] <= '9') ||
      value[1] != '\0')
   return ((-20));
...
# 449 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
static int
archive_write_lzop_open(struct archive_write_filter *f)
{
 ...
 do { (&as)->s = 
# 456 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
((void *)0)
# 456 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
; (&as)->length = 0; (&as)->buffer_length = 0; } while(0);
 (((&as))->length=0, archive_strncat(((&as)), (("lzop")), ((("lzop") == 
# 457 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c" 3 4
((void *)0) 
# 457 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_add_filter_lzop.c"
? 0 : strlen("lzop")))));
