# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
# 37 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
# 43 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
# 46 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
# 49 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
# 52 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 2
...
archive_read_open_FILE(struct archive *a, FILE *f)
{
 ...
 b = malloc(block_size);
 if (mine == 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
            ((void *)0) 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
                 || b == 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                         ((void *)0)
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
  ...
  archive_set_error(a, 
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                      12
# 76 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
                            , "No memory");
  free(mine);
  free(b);
  return ((-30));
 ...
 if (fstat(fileno(mine->f), &st) == 0 && 
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                                        ((((
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
                                        st.st_mode
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                                        )) & 0170000) == (0100000))
# 90 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
 ...
 *buff = mine->buffer;
 ...
 if (bytes_read < mine->block_size && ferror(mine->f)) {
  archive_set_error(a, 
# 117 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                      (*__errno_location ())
# 117 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
                           , "Error reading file");
 }
 return (bytes_read);
}
...
file_skip(struct archive *a, void *client_data, int64_t request)
{
 ...
 if (fseeko(mine->f, skip, 
# 158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                          1
# 158 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
                                  ) != 0)
...
file_close(struct archive *a, void *client_data)
{
 ...
 (void)a;
 if (mine->buffer != 
# 177 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c" 3 4
                    ((void *)0)
# 177 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_read_open_file.c"
                        )
  free(mine->buffer);
 free(mine);
 return (0);
