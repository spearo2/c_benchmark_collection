# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
...
# 1 "<command-line>" 2
# 1 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
# 26 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
...
# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 2

# 27 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
...
# 30 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 2
...
# 31 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 2
...
# 32 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 2
...
# 34 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 2
...
archive_write_open_memory(struct archive *a, void *buff, size_t buffSize, size_t *used)
{
 ...
 if (mine == 
# 57 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 3 4
            ((void *)0)
# 57 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
                ) {
  archive_set_error(a, 
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 3 4
                      12
# 58 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
                            , "No memory");
  return ((-30));
 }
...
memory_write_open(struct archive *a, void *client_data)
{
 ...
 mine->used = 0;
 if (mine->client_size != 
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 3 4
                         ((void *)0)
# 75 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
                             )
...
memory_write(struct archive *a, void *client_data, const void *buff, size_t length)
{
 ...
 if (mine->used + length > mine->size) {
  archive_set_error(a, 
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 3 4
                      12
# 96 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
                            , "Buffer exhausted");
  return ((-30));
 }
 ...
 mine->used += length;
 if (mine->client_size != 
# 101 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c" 3 4
                         ((void *)0)
# 101 "/doner/libarchive/libarchive-3.2.0/libarchive/archive_write_open_memory.c"
                             )
  *mine->client_size = mine->used;
 return (length);
}
