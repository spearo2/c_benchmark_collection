# 1 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
# 1 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
# 66 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
...
# 67 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
...
# 69 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
...
# 70 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
...
# 71 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
# 1 "../../../src/libjasper/include/jasper/jas_string.h" 1
# 91 "../../../src/libjasper/include/jasper/jas_string.h"
char *jas_strdup(const char *);
# 72 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
...
# 73 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
...
# 74 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2

# 1 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.h" 1
# 87 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.h"
typedef struct {
...
# 76 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 2
...
jas_image_t *mif_decode(jas_stream_t *in, const char *optstr)
{
 ...
 for (cmptno = 0; cmptno < hdr->numcmpts; ++cmptno) {
  ...
  if (!cmpt->prec) {
   cmpt->prec = ((tmpimage)->cmpts_[0]->prec_);
  }
  if (cmpt->sgnd < 0) {
   cmpt->sgnd = ((tmpimage)->cmpts_[0]->sgnd_);
  }
  ...
  if (jas_image_addcmpt(image, ((image)->numcmpts_), &cmptparm)) {
   goto error;
  }
  ...
  if (cmpt->sgnd) {
   ...
   for (y = 0; y < cmpt->height; ++y) {
     ...
     *((&(data)->rows_[(y) - (data)->ystart_][(x) - (data)->xstart_])) -= bias;
    }
   }
  }
  if (jas_image_writecmpt(image, ((image)->numcmpts_) - 1, 0, 0,
...
int mif_encode(jas_image_t *image, jas_stream_t *out, const char *optstr)
{
 ...
 for (cmptno = 0; cmptno < hdr->numcmpts; ++cmptno) {
  ...
  if (!cmpt->data) {
   ...
   cmptparm.prec = cmpt->prec;
   cmptparm.sgnd = 
# 313 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
                  0
# 313 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                       ;
   if (jas_image_addcmpt(tmpimage, ((tmpimage)->numcmpts_),
     &cmptparm)) {
    goto error;
   }
   ((tmpimage)->clrspc_ = ((((3) << 8) | (1))));
   ((tmpimage)->cmpts_[(0)]->type_ = (((0) & 0x7fff)))
                                                   ;
   if (!(data = jas_seq2d_create(0, 0, cmpt->width, cmpt->height))) {
    goto error;
   }
...
# 378 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
((
# 378 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
16 >= 4
# 378 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
) ? (void) (0) : __assert_fail (
# 378 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
...
# 378 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
, "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c", 378, __extension__ __PRETTY_FUNCTION__))
# 378 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                                             ;



 if ((n = jas_stream_read(in, buf, 4)) < 0) {
  return -1;
 }
...
# 389 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
                                      (-1)
# 389 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                                         ) {
   return -1;
  }
 }
...
# 449 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
((
# 449 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
...
"maxcmpts >= hdr->numcmpts"
# 449 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
, "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c", 449, __extension__ __PRETTY_FUNCTION__))
# 449 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                                 ;
...
# 468 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
_Bool 
# 468 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
     done;
 jas_tvparser_t *tvp;
 int id;
 ...
 if (jas_stream_read(in, magicbuf, 4) != 4) {
  goto error;
 }
 if (magicbuf[0] != (0x4d49460a >> 24) || magicbuf[1] != ((0x4d49460a >> 16) &
   0xff) || magicbuf[2] != ((0x4d49460a >> 8) & 0xff) || magicbuf[3] !=
   (0x4d49460a & 0xff)) {
...
# 489 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
       0
# 489 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
            ;
 do {
  ...
  ((jas_getdbglevel() >= (10)) ? (jas_eprintf ("header line: len=%d; %s\n", strlen(buf), buf)) : 0);
...
# 642 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 642 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((0x4d49460a >> 24) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((0x4d49460a >> 24) & 0xff))))) : 
# 642 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 642 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
);
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, 
# 643 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 643 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((0x4d49460a >> 16) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((0x4d49460a >> 16) & 0xff))))) : 
# 643 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 643 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
);
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, 
# 644 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 644 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)((0x4d49460a >> 8) & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = ((0x4d49460a >> 8) & 0xff))))) : 
# 644 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 644 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
);
 ((!((out)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((out)->rwlimit_ >= 0 && (out)->rwcnt_ >= (out)->rwlimit_) ? (out->flags_ |= 0x0004, 
# 645 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 645 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
) : (((out)->bufmode_ |= 0x0020, --(out)->cnt_ < 0) ? jas_stream_flushbuf((out), (unsigned char)(0x4d49460a & 0xff)) : (++(out)->rwcnt_, (int)(*(out)->ptr_++ = (0x4d49460a & 0xff))))) : 
# 645 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
(-1)
# 645 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
);
...
# 668 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
((
# 668 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
cmptno >= hdr->numcmpts
# 668 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
) ? (void) (0) : __assert_fail (
# 668 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
"cmptno >= hdr->numcmpts"
# 668 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
, "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c", 668, __extension__ __PRETTY_FUNCTION__))
# 668 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                               ;
...
# 709 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
((
# 709 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
bufsize > 0
# 709 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
) ? (void) (0) : __assert_fail (
# 709 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
"bufsize > 0"
# 709 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
, "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c", 709, __extension__ __PRETTY_FUNCTION__))
# 709 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                   ;

 bufptr = buf;
 while (bufsize > 1) {
  if ((c = mif_getc(stream)) == 
# 713 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
                               (-1)
# 713 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
                                  ) {
   break;
  }
  *bufptr++ = c;
...
# 733 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
_Bool 
# 733 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
     done;

 done = 
# 735 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
       0
# 735 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
            ;
 do {
  switch (c = ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, 
# 737 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
             (-1)
# 737 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
...
# 737 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
  ...
  case 
# 738 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
      (-1)
# 738 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
         :
   done = 
# 739 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
         1
# 739 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
             ;
   break;
  case '#':
   for (;;) {
    if ((c = ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, 
# 743 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
            (-1)
# 743 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
            ) : ((--(in)->cnt_ < 0) ? jas_stream_fillbuf(in, 1) : (++(in)->rwcnt_, (int)(*(in)->ptr_++)))) : 
# 743 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
            (-1)
# 743 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
...
# 744 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
           1
# 744 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
               ;
     break;
    }
    if (c == '\n') {
     done = 
# 748 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
           1
# 748 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
               ;
     break;
    }
   }
   break;
  case '\\':
   if ((((in)->cnt_ <= 0) ? jas_stream_fillbuf(in, 0) : ((int)(*(in)->ptr_))) == '\n') {
    ((!((in)->flags_ & (0x0002 | 0x0001 | 0x0004))) ? (((in)->rwlimit_ >= 0 && (in)->rwcnt_ >= (in)->rwlimit_) ? (in->flags_ |= 0x0004, 
# 755 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
   (-1)
# 755 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
   ) : ((--(in)->cnt_ < 0) ? jas_stream_fillbuf(in, 1) : (++(in)->rwcnt_, (int)(*(in)->ptr_++)))) : 
# 755 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
   (-1)
# 755 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
...
# 759 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c" 3 4
         1
# 759 "/doner/jasper/jasper-version-1.900.30/src/libjasper/mif/mif_cod.c"
             ;
   break;
  }
 } while (!done);
...
static mif_hdr_t *mif_makehdrfromimage(jas_image_t *image)
{
 ...
 if (!(hdr = mif_hdr_create(((image)->numcmpts_)))) {
  return 0;
 }
 ...
 for (cmptno = 0; cmptno < hdr->numcmpts; ++cmptno) {
  ...
  cmpt->prec = ((image)->cmpts_[cmptno]->prec_);
  cmpt->sgnd = ((image)->cmpts_[cmptno]->sgnd_);
  cmpt->data = 0;
 }
 return hdr;
