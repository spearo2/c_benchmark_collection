# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c" 2
# 20 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
...
# 21 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c" 2
...
# 22 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c" 2
...
extern void jpeg_idct_16x16(j_decompress_ptr cinfo,
                             jpeg_component_info *compptr, JCOEFPTR coef_block,
                             JSAMPARRAY output_buf, JDIMENSION output_col);
# 23 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jsimddct.h" 1
# 12 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jsimddct.h"
...
extern void jsimd_idct_float(j_decompress_ptr cinfo,
                              ...
                              JCOEFPTR coef_block, JSAMPARRAY output_buf,
                              JDIMENSION output_col);
# 24 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c" 2
...
# 82 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
static int
flss(UINT16 val)
{
  int bit;
...
# 172 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
static int
...
# 235 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
static void
start_pass_fdctmgr(j_compress_ptr cinfo)
{
  ...
  for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components;
    ...
    case JDCT_FLOAT:
      {
# 335 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
        float *fdtbl;
        int row, col;
...
# 478 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
}
# 489 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
static void
               ...
               float *workspace)
{
  ...
  for (elemr = 0; elemr < 8; elemr++) {
    ...
    *workspaceptr++ = (float)(((int)(*elemptr++)) - 128);
    *workspaceptr++ = (float)(((int)(*elemptr++)) - 128);
# 552 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
  }
}
...
# 620 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jcdctmgr.c"
void
