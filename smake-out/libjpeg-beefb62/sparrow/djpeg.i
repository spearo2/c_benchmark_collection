# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 343 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c" 2
# 31 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
...
extern boolean jpeg_read_icc_profile(j_decompress_ptr cinfo,
                                      JOCTET **icc_data_ptr,
                                      unsigned int *icc_data_len);
# 19 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/cdjpeg.h" 2
...
JTRC_PPM,
JTRC_PPM_TEXT,
# 105 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/cderror.h"
JERR_TGA_BADCMAP,
JERR_TGA_BADPARMS,
JERR_TGA_COLORSPACE,
JTRC_TGA,
...
# 32 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jversion.h" 1
# 33 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jconfigint.h" 1
# 34 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c" 2
...
# 40 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c" 2
# 56 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
...
# 58 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c" 2
 ((void*)0)
};
# 69 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
typedef enum {
  FMT_BMP,
  FMT_GIF,
  FMT_OS2,
...
# 95 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
...
# 199 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
{
  int argn;
  char *arg;
  ...
  for (argn = 1; argn < argc; argn++) {
    ...
    if (keymatch(arg, "bmp", 1)) {
      ...
      jpeg_save_markers(cinfo, 0xE0 + 2, 0xFFFF);
...
# 436 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
static unsigned int
...
# 556 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
  file_index = parse_switches(&cinfo, argc, argv, 0, 0);
# 576 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
  ...
  case FMT_BMP:
    dest_mgr = jinit_write_bmp(&cinfo, 0, 1);
    break;
  case FMT_OS2:
    dest_mgr = jinit_write_bmp(&cinfo, 1, 1);
    break;
...
# 773 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/djpeg.c"
  if (icc_filename != ((void*)0)) {
    FILE *icc_file;
    JOCTET *icc_profile;
    unsigned int icc_len;

    if ((icc_file = fopen(icc_filename, "wb")) == ((void*)0)) {
