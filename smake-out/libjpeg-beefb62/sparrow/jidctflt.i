# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c" 2
# 44 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c"
...
# 45 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c" 2
...
# 46 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c" 2
...
extern void jpeg_idct_16x16(j_decompress_ptr cinfo,
                             jpeg_component_info *compptr, JCOEFPTR coef_block,
                             JSAMPARRAY output_buf, JDIMENSION output_col);
# 47 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c" 2
# 71 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  wsptr = workspace;
  for (ctr = 8; ctr > 0; ctr--) {
# 103 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c"
...
# 195 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctflt.c"
