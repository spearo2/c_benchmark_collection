# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 345 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c" 2
# 39 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c"
...
# 40 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c" 2
...
# 41 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c" 2
...
extern void jpeg_idct_16x16(j_decompress_ptr cinfo,
                             jpeg_component_info *compptr, JCOEFPTR coef_block,
                             JSAMPARRAY output_buf, JDIMENSION output_col);
# 42 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c" 2
# 170 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c"
void
                ...
                JDIMENSION output_col)
{
  ...
  wsptr = workspace;
  for (ctr = 8; ctr > 0; ctr--) {
# 203 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c"
...
# 296 "/doner/libjpeg/libjpeg-beefb62/libjpeg-turbo/jidctfst.c"
