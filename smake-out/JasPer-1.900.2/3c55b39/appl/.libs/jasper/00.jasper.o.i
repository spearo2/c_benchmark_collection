# 1 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
# 1 "/doner/jasper/jasper-3c55b39/src/appl//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
# 74 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
...
# 75 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 2
...
# 76 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 2
...
# 77 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 2
...
# 78 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 2
...
# 80 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 2
# 93 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
typedef struct {
...
int main(int argc, char **argv)
{
 ...
 if (!(cmdopts = cmdopts_parse(argc, argv))) {
  fprintf(
# 172 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 172 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "error: cannot parse command line\n");
  exit(
# 173 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
      1
# 173 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                  );
 }
 ...
 if (cmdopts->version) {
  printf("%s\n", "1.900.3");
  fprintf(
# 178 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 178 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "libjasper %s\n", jas_getversion());
  exit(
# 179 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
      0
# 179 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                  );
 }
 ...
 if (cmdopts->infile) {
  ...
  if (!(in = jas_stream_fopen(cmdopts->infile, "rb"))) {
   fprintf(
# 192 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
          stderr
# 192 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                , "error: cannot open input image file %s\n",
     cmdopts->infile);
   exit(
# 194 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 194 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
 } else {
  ...
  if (!(in = jas_stream_fdopen(0, "rb"))) {
   fprintf(
# 199 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
          stderr
# 199 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                , "error: cannot open standard input\n");
   exit(
# 200 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 200 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
 }
 ...
 if (cmdopts->outfile) {
  ...
  if (!(out = jas_stream_fopen(cmdopts->outfile, "w+b"))) {
   fprintf(
# 208 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
          stderr
# 208 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                , "error: cannot open output image file %s\n",
     cmdopts->outfile);
   exit(
# 210 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 210 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
 } else {
  ...
  if (!(out = jas_stream_fdopen(1, "w+b"))) {
   fprintf(
# 215 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
          stderr
# 215 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                , "error: cannot open standard output\n");
   exit(
# 216 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 216 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
 }
 ...
 if (cmdopts->infmt < 0) {
  if ((cmdopts->infmt = jas_image_getfmt(in)) < 0) {
   fprintf(
# 222 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
          stderr
# 222 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                , "error: input image has unknown format\n");
   exit(
# 223 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 223 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
 }
 ...
 if (!(image = jas_image_decode(in, cmdopts->infmt, cmdopts->inopts))) {
  fprintf(
# 230 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 230 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "error: cannot load image data\n");
  exit(
# 231 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
      1
# 231 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                  );
 }
 jas_tmr_stop(&dectmr);
 ...
 if (cmdopts->srgb) {
  ...
  if (!(outprof = jas_cmprof_createfromclrspc((((4) << 8) | (1))))) {
   ...
   exit(
# 257 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 257 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
  if (!(newimage = jas_image_chclrspc(image, outprof, 0))) {
   jas_eprintf("cannot convert to sRGB\n");
   exit(
# 261 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       1
# 261 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   );
  }
 ...
 if (jas_image_encode(image, out, cmdopts->outfmt, cmdopts->outopts)) {
  fprintf(
# 271 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 271 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "error: cannot encode image\n");
  exit(
# 272 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
      1
# 272 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                  );
 }
 ...
 if (cmdopts->verbose) {
  fprintf(
# 279 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 279 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "decoding time = %f\n", dectime);
  fprintf(
# 280 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 280 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "encoding time = %f\n", enctime);
 }
 ...
 if (jas_stream_close(out)) {
  fprintf(
# 288 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 288 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "error: cannot close output image file\n");
  exit(
# 289 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
      1
# 289 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                  );
 }
 ...
 return 
# 297 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
       0
# 297 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                   ;
}
...
cmdopts_t *cmdopts_parse(int argc, char **argv)
{
 ...
 if (!(cmdopts = malloc(sizeof(cmdopts_t)))) {
  fprintf(
# 345 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 345 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "error: insufficient memory\n");
  exit(
# 346 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
      1
# 346 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                  );
 }
...
# 363 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
                                                   (-1)
# 363 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                                                      ) {
  switch (c) {
  case CMDOPT_HELP:
   cmdusage();
  ...
  case CMDOPT_INFMT:
   if ((cmdopts->infmt = jas_image_strtofmt(jas_optarg)) < 0) {
    fprintf(
# 382 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
           stderr
# 382 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
  ...
  case CMDOPT_OUTFMT:
   if ((cmdopts->outfmt = jas_image_strtofmt(jas_optarg)) < 0) {
    fprintf(
# 396 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
           stderr
# 396 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
 ...
 while (jas_optind < argc) {
  fprintf(
# 417 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 417 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               ,
 ...
 if (cmdopts->outfmt < 0 && cmdopts->outfile) {
  if ((cmdopts->outfmt = jas_image_fmtfromname(cmdopts->outfile)) < 0) {
   fprintf(
# 429 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
          stderr
# 429 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                ,
 ...
 if (cmdopts->outfmt < 0) {
  fprintf(
# 435 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 435 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
...
{
 fprintf(
# 467 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 467 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
              , "JasPer Transcoder (Version %s).\n",
   "1.900.3");
 fprintf(
# 469 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 469 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
              , "%s\n", "Copyright (c) 2001-2006 Michael David Adams.\n" "Copyright (c) 1999-2000 Image Power, Inc. and the University of\n" "  British Columbia.\n" "All rights reserved.\n");
 fprintf(
# 470 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 470 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
...
void cmdusage()
{
 ...
 cmdinfo();
 fprintf(
# 503 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 503 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
              , "usage: %s [options]\n", cmdname);
 for (i = 0, s = helpinfo[i]; s; ++i, s = helpinfo[i]) {
  fprintf(
# 505 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 505 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "%s", s);
 }
 fprintf(
# 507 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 507 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
 ...
 for (fmtid = 0;; ++fmtid) {
  ...
  fprintf(
# 512 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
         stderr
# 512 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
               , "    %-5s    %s\n", fmtinfo->name,
    fmtinfo->desc);
 }
 exit(
# 515 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
     1
# 515 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                 );
}
...
{
 fprintf(
# 520 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 520 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
              ,
   "For more information on how to use this command, type:\n");
 fprintf(
# 522 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
        stderr
# 522 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
              , "    %s --help\n", cmdname);
 exit(
# 523 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c" 3 4
     1
# 523 "/doner/jasper/jasper-3c55b39/src/appl/jasper.c"
                 );
}
