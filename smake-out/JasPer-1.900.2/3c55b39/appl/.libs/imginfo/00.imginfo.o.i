# 1 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
...
# 1 "<command-line>" 2
# 1 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
# 72 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
...
# 73 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 2
...
# 74 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 2
...
# 75 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/9/include/float.h" 1 3 4
# 76 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 2
...
# 77 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 2
...
# 79 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 2
...
int main(int argc, char **argv)
{
 ...
 while ((id = jas_getopt(argc, argv, opts)) >= 0) {
  ...
  case OPT_VERSION:
   printf("%s\n", "1.900.3");
   exit(
# 147 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
       0
# 147 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                   );
   break;
  case OPT_INFILE:
   infile = jas_optarg;
 ...
 if (infile) {
  ...
  if (!(instream = jas_stream_fopen(infile, "rb"))) {
   fprintf(
# 163 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
          stderr
# 163 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                , "cannot open input image file %s\n", infile);
   exit(
# 164 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
       1
# 164 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                   );
  }
 } else {
  ...
  if (!(instream = jas_stream_fdopen(0, "rb"))) {
   fprintf(
# 169 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
          stderr
# 169 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                , "cannot open standard input\n");
   exit(
# 170 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
       1
# 170 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                   );
  }
 }
 ...
 if ((fmtid = jas_image_getfmt(instream)) < 0) {
  fprintf(
# 175 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
         stderr
# 175 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
 ...
 if (!(image = jas_image_decode(instream, fmtid, 0))) {
  fprintf(
# 180 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
         stderr
# 180 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
               , "cannot load image\n");
  return 
# 181 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
        1
# 181 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                    ;
 }
 ...
 return 
# 199 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
       0
# 199 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                   ;
}
...
{
 fprintf(
# 208 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
        stderr
# 208 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
              , "Image Information Utility (Version %s).\n",
   "1.900.3");
 fprintf(
# 210 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
        stderr
# 210 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
              ,
...
static void usage()
{
 cmdinfo();
 fprintf(
# 219 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
        stderr
# 219 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
              , "usage:\n");
 fprintf(
# 220 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
        stderr
# 220 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
              ,"%s ", cmdname);
 fprintf(
# 221 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
        stderr
# 221 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
              , "[-f image_file]\n");
 exit(
# 222 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c" 3 4
     1
# 222 "/doner/jasper/jasper-3c55b39/src/appl/imginfo.c"
                 );
}
