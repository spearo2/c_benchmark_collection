# 1 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
# 29 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
...
# 30 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
...
# 31 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
...
# 32 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
...
# 33 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
...
JTRC_BMP_OS2 ,
JTRC_BMP_OS2_MAPPED ,
# 76 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/cderror.h"
JERR_PPM_COLORSPACE ,
JERR_PPM_NONNUMERIC ,
JERR_PPM_TOOLARGE ,
JERR_PPM_NOT ,
...
# 34 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
# 1 "./jpeglib.h" 1
# 35 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
# 1 "./jpegint.h" 1
# 21 "./jpegint.h"
typedef enum {
  JBUF_PASS_THRU,
...
# 38 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 2
# 46 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
 ...
 if(dstpf==TJPF_CMYK)
 {
  for(row=0; row<h; row++, srcrowptr+=srcstride, dstrowptr+=dststride)
  {
    ...
    col<w; col++, srccolptr+=srcps)
   {
    ...
    double k=((((c)<(m)?(c):(m)))<(((y)<(1.0)?(y):(1.0)))?(((c)<(m)?(c):(m))):(((y)<(1.0)?(y):(1.0))));
    if(k==1.0) c=m=y=0.0;
    else
    {
     c=(c-k)/(1.0-k);
 ...
 int dstpf, int bottomup)
{
 ...
 FILE *file=
# 175 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
           ((void *)0)
# 175 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
               ;

 memset(&cinfo, 0, sizeof(struct jpeg_compress_struct));

 if(!filename || !buf || !w || !h || dstpf<0 || dstpf>=12)
  {snprintf(errStr, 200, "%s", "loadbmp(): Invalid argument"); retval=-1; goto bailout;};

 if((file=fopen(filename, "rb"))==
# 182 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                 ((void *)0)
# 182 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                     )
  {snprintf(errStr, 200, "%s\n%s", "loadbmp(): Cannot open input file", strerror(
# 183 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
 (*__errno_location ())
# 183 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
 ...
 if(
# 189 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
   _setjmp (
# 189 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
   jerr.setjmp_buffer
# 189 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
   )
# 189 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
 ...
 if((tempc=getc(file))<0 || ungetc(tempc, file)==
# 196 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                                (-1)
# 196 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                                   )
  {snprintf(errStr, 200, "%s\n%s", "loadbmp(): Could not read input file", strerror(
# 197 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
 (*__errno_location ())
# 197 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
 )); retval=-1; goto bailout;}
 else if(tempc==
# 198 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
               (-1)
# 198 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                  ) {snprintf(errStr, 200, "%s", "loadbmp(): Input file contains no data"); retval=-1; goto bailout;};

 if(tempc=='B')
 {
  if((src=jinit_read_bmp(&cinfo))==
# 202 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                  ((void *)0)
# 202 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                      )
   {snprintf(errStr, 200, "%s", "loadbmp(): Could not initialize bitmap loader"); retval=-1; goto bailout;};
 }
 else if(tempc=='P')
 {
  if((src=jinit_read_ppm(&cinfo))==
# 207 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                  ((void *)0)
# 207 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                      )
   {snprintf(errStr, 200, "%s", "loadbmp(): Could not initialize bitmap loader"); retval=-1; goto bailout;};
 }
 else {snprintf(errStr, 200, "%s", "loadbmp(): Unsupported file type"); retval=-1; goto bailout;};
 ...
 *w=cinfo.image_width; *h=cinfo.image_height;
 ...
 if((*buf=(unsigned char *)malloc((*w)*(*h)*dstps))==
# 223 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                                    ((void *)0)
# 223 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                                        )
  {snprintf(errStr, 200, "%s", "loadbmp(): Memory allocation failure"); retval=-1; goto bailout;};
 ...
 if(file) fclose(file);
 if(retval<0 && buf && *buf) {free(*buf); *buf=
# 246 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                               ((void *)0)
# 246 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                                   ;}
 return retval;
}
 ...
 int bottomup)
{
 ...
 djpeg_dest_ptr dst;
 FILE *file=
# 258 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
           ((void *)0)
# 258 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
               ;
 char *ptr=
# 259 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
          ((void *)0)
# 259 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
              ;

 memset(&dinfo, 0, sizeof(struct jpeg_decompress_struct));

 if(!filename || !buf || w<1 || h<1 || srcpf<0 || srcpf>=12)
  {snprintf(errStr, 200, "%s", "savebmp(): Invalid argument"); retval=-1; goto bailout;};

 if((file=fopen(filename, "wb"))==
# 266 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                 ((void *)0)
# 266 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                     )
  {snprintf(errStr, 200, "%s\n%s", "savebmp(): Cannot open output file", strerror(
# 267 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
 (*__errno_location ())
# 267 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
 )); retval=-1; goto bailout;};
 ...
 if(
# 273 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
   _setjmp (
# 273 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
   jerr.setjmp_buffer
# 273 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
   )
# 273 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
 ...
 jpeg_CreateDecompress((&dinfo), 62, (size_t) sizeof(struct jpeg_decompress_struct));
 if(srcpf==TJPF_GRAY)
 {
 ...
 {
  if((dst=jinit_write_bmp(&dinfo, 0))==
# 297 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                      ((void *)0)
# 297 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                          )
   {snprintf(errStr, 200, "%s", "savebmp(): Could not initialize bitmap writer"); retval=-1; goto bailout;};
 }
 else
 {
  if((dst=jinit_write_ppm(&dinfo))==
# 302 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c" 3 4
                                   ((void *)0)
# 302 "/doner/libjpeg/libjpeg-3212005/libjpeg-turbo/bmp.c"
                                       )
   {snprintf(errStr, 200, "%s", "savebmp(): Could not initialize PPM writer"); retval=-1; goto bailout;};
 }
